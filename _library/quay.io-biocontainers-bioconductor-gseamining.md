...
updated_at: "2024-01-28 02:48:40.720096"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gseamining:1.12.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gseamining/1.12.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-gseamining/1.12.0--r43hdfd78af_0
```
