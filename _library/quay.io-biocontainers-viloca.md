---
layout: container
name:  "quay.io/biocontainers/viloca"
maintainer: "@vsoch"
...
updated_at: "2025-12-29 04:44:35.185763"
...
```bash
$ shpc install quay.io/biocontainers/viloca
```
...
#### viloca-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### viloca-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/viloca
$ podman run --it --rm --entrypoint /usr/local/bin/viloca   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/viloca   -v ${PWD} -w ${PWD} <container> -c " $@"
```
