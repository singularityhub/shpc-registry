...
updated_at: "2026-07-01 07:19:19.425470"
...
```bash
$ shpc install quay.io/biocontainers/virulencefinder:3.2.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/virulencefinder/3.2.1--pyhdfd78af_0
$ module help quay.io/biocontainers/virulencefinder/3.2.1--pyhdfd78af_0
```
