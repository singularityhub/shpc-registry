...
updated_at: "2025-04-06 03:23:51.000509"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-r10kcod.db:3.4.0--r44hdfd78af_13
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-r10kcod.db/3.4.0--r44hdfd78af_13
$ module help quay.io/biocontainers/bioconductor-r10kcod.db/3.4.0--r44hdfd78af_13
```
