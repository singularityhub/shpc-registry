---
layout: container
name:  "quay.io/biocontainers/bioconductor-metadict"
maintainer: "@vsoch"
...
updated_at: "2026-02-20 05:05:34.693122"
...
singularity registry hpc automated addition for bioconductor-metadict
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/bioconductor-metadict
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-metadict:1.0.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-metadict/1.0.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-metadict/1.0.0--r45hdfd78af_0
```
...
#### bioconductor-metadict-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-metadict-inspect-deffile:
