...
updated_at: "2025-07-31 11:35:58.645913"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-edaseq:2.40.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-edaseq/2.40.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-edaseq/2.40.0--r44hdfd78af_0
```
