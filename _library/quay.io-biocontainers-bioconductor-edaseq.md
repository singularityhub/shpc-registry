...
updated_at: "2022-11-03 00:26:53.469091"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-edaseq:2.8.0--r3.4.1_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-edaseq/2.8.0--r3.4.1_0
$ module help quay.io/biocontainers/bioconductor-edaseq/2.8.0--r3.4.1_0
```
