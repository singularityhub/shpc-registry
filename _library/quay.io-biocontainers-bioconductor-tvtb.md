...
updated_at: "2024-09-29 03:13:59.472723"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-tvtb:1.28.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-tvtb/1.28.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-tvtb/1.28.0--r43hdfd78af_0
```
