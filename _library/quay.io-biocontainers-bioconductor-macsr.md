...
updated_at: "2025-12-15 04:24:35.222843"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-macsr:1.14.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-macsr/1.14.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-macsr/1.14.0--r44hdfd78af_0
```
