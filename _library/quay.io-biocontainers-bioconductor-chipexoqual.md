...
updated_at: "2023-10-20 03:26:34.292434"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-chipexoqual:1.24.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-chipexoqual/1.24.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-chipexoqual/1.24.0--r43hdfd78af_0
```
