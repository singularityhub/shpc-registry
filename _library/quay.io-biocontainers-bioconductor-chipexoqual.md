...
updated_at: "2026-03-18 04:30:04.489222"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-chipexoqual:1.34.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-chipexoqual/1.34.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-chipexoqual/1.34.0--r45hdfd78af_0
```
