...
updated_at: "2022-11-09 00:35:10.153230"
latest: "1.8.0--r36_1"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-chipexoqual:1.8.0--r36_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-chipexoqual/1.8.0--r36_1
$ module help quay.io/biocontainers/bioconductor-chipexoqual/1.8.0--r36_1
```
