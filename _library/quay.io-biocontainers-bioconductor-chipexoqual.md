...
updated_at: "2024-10-14 03:31:11.524037"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-chipexoqual:1.26.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-chipexoqual/1.26.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-chipexoqual/1.26.0--r43hdfd78af_0
```
