...
updated_at: "2026-03-25 05:05:06.246696"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-comethdmr:1.14.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-comethdmr/1.14.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-comethdmr/1.14.0--r45hdfd78af_0
```
