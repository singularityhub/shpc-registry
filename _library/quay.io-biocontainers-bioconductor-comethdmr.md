...
updated_at: "2023-12-14 02:31:50.008813"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-comethdmr:1.4.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-comethdmr/1.4.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-comethdmr/1.4.0--r43hdfd78af_0
```
