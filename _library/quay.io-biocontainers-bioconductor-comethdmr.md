...
updated_at: "2025-08-04 04:09:49.113762"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-comethdmr:1.10.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-comethdmr/1.10.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-comethdmr/1.10.0--r44hdfd78af_0
```
