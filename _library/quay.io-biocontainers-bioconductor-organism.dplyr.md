...
updated_at: "2022-10-29 05:51:20.197209"
latest: "1.22.1--r41hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-organism.dplyr:1.22.1--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-organism.dplyr/1.22.1--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-organism.dplyr/1.22.1--r41hdfd78af_0
```
