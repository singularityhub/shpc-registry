...
updated_at: "2026-09-11 07:26:28.737243"
...
```bash
$ shpc install quay.io/biocontainers/thebigbam:0.7.0--py313hec9b1f2_0
```
...
```bash
$ module load quay.io/biocontainers/thebigbam/0.7.0--py313hec9b1f2_0
$ module help quay.io/biocontainers/thebigbam/0.7.0--py313hec9b1f2_0
```
