...
updated_at: "2023-12-08 02:43:16.672620"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cn.farms:1.48.0--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cn.farms/1.48.0--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-cn.farms/1.48.0--r43hf17093f_0
```
