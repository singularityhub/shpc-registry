...
updated_at: "2024-04-25 02:45:52.871142"
...
```bash
$ shpc install quay.io/biocontainers/hiphase:1.4.0--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/hiphase/1.4.0--h9ee0642_0
$ module help quay.io/biocontainers/hiphase/1.4.0--h9ee0642_0
```
