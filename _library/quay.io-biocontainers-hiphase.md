...
updated_at: "2024-09-18 03:01:49.974995"
latest: "1.4.4--h9ee0642_0"
...
```bash
$ shpc install quay.io/biocontainers/hiphase:1.4.4--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/hiphase/1.4.4--h9ee0642_0
$ module help quay.io/biocontainers/hiphase/1.4.4--h9ee0642_0
```
