...
updated_at: "2024-10-26 03:28:59.062691"
latest: "1.4.5--h9ee0642_0"
...
```bash
$ shpc install quay.io/biocontainers/hiphase:1.4.5--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/hiphase/1.4.5--h9ee0642_0
$ module help quay.io/biocontainers/hiphase/1.4.5--h9ee0642_0
```
