...
updated_at: "2026-01-25 04:21:44.091551"
latest: "1.6.0--h9ee0642_0"
...
```bash
$ shpc install quay.io/biocontainers/hiphase:1.6.0--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/hiphase/1.6.0--h9ee0642_0
$ module help quay.io/biocontainers/hiphase/1.6.0--h9ee0642_0
```
