...
updated_at: "2024-08-19 03:40:28.534632"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-curatedbladderdata:1.38.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-curatedbladderdata/1.38.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-curatedbladderdata/1.38.0--r43hdfd78af_0
```
