...
updated_at: "2023-12-07 03:01:19.541219"
...
```bash
$ shpc install quay.io/biocontainers/geofetch:0.12.4--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/geofetch/0.12.4--pyh7cba7a3_0
$ module help quay.io/biocontainers/geofetch/0.12.4--pyh7cba7a3_0
```
