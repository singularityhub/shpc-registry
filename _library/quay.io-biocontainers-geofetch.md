...
updated_at: "2024-06-22 02:41:41.410544"
latest: "0.12.6--pyh7cba7a3_0"
...
```bash
$ shpc install quay.io/biocontainers/geofetch:0.12.6--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/geofetch/0.12.6--pyh7cba7a3_0
$ module help quay.io/biocontainers/geofetch/0.12.6--pyh7cba7a3_0
```
