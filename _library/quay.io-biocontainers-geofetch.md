...
updated_at: "2024-01-18 02:43:58.905736"
latest: "0.12.5--pyh7cba7a3_0"
...
```bash
$ shpc install quay.io/biocontainers/geofetch:0.12.5--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/geofetch/0.12.5--pyh7cba7a3_0
$ module help quay.io/biocontainers/geofetch/0.12.5--pyh7cba7a3_0
```
