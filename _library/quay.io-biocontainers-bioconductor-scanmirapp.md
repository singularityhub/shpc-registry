...
updated_at: "2024-04-01 02:59:34.347918"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-scanmirapp:1.8.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-scanmirapp/1.8.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-scanmirapp/1.8.0--r43hdfd78af_0
```
