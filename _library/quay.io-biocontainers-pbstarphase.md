...
updated_at: "2026-08-25 09:32:25.824449"
...
```bash
$ shpc install quay.io/biocontainers/pbstarphase:2.2.0--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/pbstarphase/2.2.0--h9ee0642_0
$ module help quay.io/biocontainers/pbstarphase/2.2.0--h9ee0642_0
```
