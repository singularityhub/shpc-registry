...
updated_at: "2025-04-17 03:50:16.808880"
...
```bash
$ shpc install quay.io/biocontainers/pbstarphase:1.3.1--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/pbstarphase/1.3.1--h9ee0642_0
$ module help quay.io/biocontainers/pbstarphase/1.3.1--h9ee0642_0
```
