...
updated_at: "2026-06-08 07:10:14.156759"
...
```bash
$ shpc install quay.io/biocontainers/pbstarphase:2.1.0--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/pbstarphase/2.1.0--h9ee0642_0
$ module help quay.io/biocontainers/pbstarphase/2.1.0--h9ee0642_0
```
