...
updated_at: "2025-11-16 04:02:31.030659"
...
```bash
$ shpc install quay.io/biocontainers/pbstarphase:1.5.0--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/pbstarphase/1.5.0--h9ee0642_0
$ module help quay.io/biocontainers/pbstarphase/1.5.0--h9ee0642_0
```
