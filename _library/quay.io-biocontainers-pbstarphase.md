...
updated_at: "2026-01-16 04:27:00.988662"
...
```bash
$ shpc install quay.io/biocontainers/pbstarphase:2.0.1--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/pbstarphase/2.0.1--h9ee0642_0
$ module help quay.io/biocontainers/pbstarphase/2.0.1--h9ee0642_0
```
