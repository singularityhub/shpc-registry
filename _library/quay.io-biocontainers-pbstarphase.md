...
updated_at: "2025-05-22 03:32:49.541281"
...
```bash
$ shpc install quay.io/biocontainers/pbstarphase:1.4.0--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/pbstarphase/1.4.0--h9ee0642_0
$ module help quay.io/biocontainers/pbstarphase/1.4.0--h9ee0642_0
```
