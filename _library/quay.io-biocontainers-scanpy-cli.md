---
layout: container
name:  "quay.io/biocontainers/scanpy-cli"
maintainer: "@vsoch"
...
updated_at: "2025-11-10 04:08:44.324522"
...
singularity registry hpc automated addition for scanpy-cli
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/scanpy-cli
```
...
#### scanpy-cli-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### scanpy-cli-inspect-deffile:
