---
layout: container
name:  "quay.io/biocontainers/r-scistreer"
maintainer: "@vsoch"
...
updated_at: "2025-11-22 03:50:39.689197"
...
singularity registry hpc automated addition for r-scistreer
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/r-scistreer
```
...
#### r-scistreer-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-scistreer-inspect-deffile:
