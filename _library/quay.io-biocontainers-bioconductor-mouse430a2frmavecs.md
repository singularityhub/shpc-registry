...
updated_at: "2022-11-01 03:27:27.784660"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mouse430a2frmavecs:1.3.0--r41hdfd78af_9
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mouse430a2frmavecs/1.3.0--r41hdfd78af_9
$ module help quay.io/biocontainers/bioconductor-mouse430a2frmavecs/1.3.0--r41hdfd78af_9
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-mouse430a2frmavecs-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-mouse430a2frmavecs-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-mouse430a2frmavecs-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-mouse430a2frmavecs-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-mouse430a2frmavecs-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-mouse430a2frmavecs-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
