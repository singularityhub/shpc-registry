---
layout: container
name:  "quay.io/biocontainers/enzywizard-interaction"
maintainer: "@vsoch"
...
updated_at: "2026-06-28 07:03:34.875247"
...
singularity registry hpc automated addition for enzywizard-interaction
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/enzywizard-interaction
```
...
#### enzywizard-interaction-inspect:
...
#### enzywizard-interaction-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### enzywizard-interaction-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/enzywizard-interaction
$ podman run --it --rm --entrypoint /usr/local/bin/enzywizard-interaction   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/enzywizard-interaction   -v ${PWD} -w ${PWD} <container> -c " $@"
```
