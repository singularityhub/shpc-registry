---
layout: container
name:  "quay.io/biocontainers/craq"
maintainer: "@vsoch"
...
updated_at: "2026-01-14 04:32:51.241808"
...
```bash
$ shpc install quay.io/biocontainers/craq
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/craq:1.10--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/craq/1.10--hdfd78af_0
$ module help quay.io/biocontainers/craq/1.10--hdfd78af_0
```
...
#### craq-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### craq-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/craq
$ podman run --it --rm --entrypoint /usr/local/bin/craq   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/craq   -v ${PWD} -w ${PWD} <container> -c " $@"
```
