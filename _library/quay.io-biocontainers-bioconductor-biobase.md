...
updated_at: "2024-12-18 03:15:48.517346"
latest: "2.62.0--r43ha9d7317_3"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-biobase:2.62.0--r43ha9d7317_3
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-biobase/2.62.0--r43ha9d7317_3
$ module help quay.io/biocontainers/bioconductor-biobase/2.62.0--r43ha9d7317_3
```
