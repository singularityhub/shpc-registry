...
updated_at: "2022-10-29 05:35:48.109815"
latest: "2.54.0--r41hc0cfd56_2"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-biobase:2.54.0--r41hc0cfd56_2
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-biobase/2.54.0--r41hc0cfd56_2
$ module help quay.io/biocontainers/bioconductor-biobase/2.54.0--r41hc0cfd56_2
```
