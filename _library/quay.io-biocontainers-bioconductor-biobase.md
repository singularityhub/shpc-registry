...
updated_at: "2023-10-15 03:02:42.349547"
latest: "2.60.0--r43ha9d7317_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-biobase:2.60.0--r43ha9d7317_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-biobase/2.60.0--r43ha9d7317_0
$ module help quay.io/biocontainers/bioconductor-biobase/2.60.0--r43ha9d7317_0
```
