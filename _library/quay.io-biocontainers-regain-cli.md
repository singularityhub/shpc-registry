...
updated_at: "2026-06-12 07:06:33.520343"
...
```bash
$ shpc install quay.io/biocontainers/regain-cli:1.8.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/regain-cli/1.8.0--pyhdfd78af_0
$ module help quay.io/biocontainers/regain-cli/1.8.0--pyhdfd78af_0
```
