...
updated_at: "2025-10-28 03:59:42.963959"
...
```bash
$ shpc install quay.io/biocontainers/regain-cli:1.6.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/regain-cli/1.6.2--pyhdfd78af_0
$ module help quay.io/biocontainers/regain-cli/1.6.2--pyhdfd78af_0
```
