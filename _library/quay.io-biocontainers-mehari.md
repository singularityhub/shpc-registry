...
updated_at: "2024-08-29 11:07:01.280007"
latest: "0.28.0--h7e29777_0"
...
```bash
$ shpc install quay.io/biocontainers/mehari:0.28.0--h7e29777_0
```
...
```bash
$ module load quay.io/biocontainers/mehari/0.28.0--h7e29777_0
$ module help quay.io/biocontainers/mehari/0.28.0--h7e29777_0
```
