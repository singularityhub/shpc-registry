...
updated_at: "2024-03-29 02:56:37.087317"
latest: "0.25.4--h7e29777_0"
...
```bash
$ shpc install quay.io/biocontainers/mehari:0.25.4--h7e29777_0
```
...
```bash
$ module load quay.io/biocontainers/mehari/0.25.4--h7e29777_0
$ module help quay.io/biocontainers/mehari/0.25.4--h7e29777_0
```
