...
updated_at: "2024-05-07 03:10:44.523690"
latest: "0.25.5--h7e29777_0"
...
```bash
$ shpc install quay.io/biocontainers/mehari:0.25.5--h7e29777_0
```
...
```bash
$ module load quay.io/biocontainers/mehari/0.25.5--h7e29777_0
$ module help quay.io/biocontainers/mehari/0.25.5--h7e29777_0
```
