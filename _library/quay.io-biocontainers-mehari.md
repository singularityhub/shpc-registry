...
updated_at: "2024-02-25 02:33:42.682054"
latest: "0.23.2--h7e29777_0"
...
```bash
$ shpc install quay.io/biocontainers/mehari:0.23.2--h7e29777_0
```
...
```bash
$ module load quay.io/biocontainers/mehari/0.23.2--h7e29777_0
$ module help quay.io/biocontainers/mehari/0.23.2--h7e29777_0
```
