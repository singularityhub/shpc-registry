...
updated_at: "2024-01-19 02:52:09.375312"
latest: "0.21.1--h7e29777_0"
...
```bash
$ shpc install quay.io/biocontainers/mehari:0.21.1--h7e29777_0
```
...
```bash
$ module load quay.io/biocontainers/mehari/0.21.1--h7e29777_0
$ module help quay.io/biocontainers/mehari/0.21.1--h7e29777_0
```
