...
updated_at: "2023-12-03 02:35:53.068963"
latest: "0.21.0--h7e29777_0"
...
```bash
$ shpc install quay.io/biocontainers/mehari:0.21.0--h7e29777_0
```
...
```bash
$ module load quay.io/biocontainers/mehari/0.21.0--h7e29777_0
$ module help quay.io/biocontainers/mehari/0.21.0--h7e29777_0
```
