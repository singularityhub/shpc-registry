...
updated_at: "2026-02-14 04:50:14.012131"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-dfp:1.68.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-dfp/1.68.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-dfp/1.68.0--r45hdfd78af_0
```
