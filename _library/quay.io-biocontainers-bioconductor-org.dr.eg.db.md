...
updated_at: "2025-08-25 03:54:20.861637"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-org.dr.eg.db:3.20.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-org.dr.eg.db/3.20.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-org.dr.eg.db/3.20.0--r44hdfd78af_0
```
