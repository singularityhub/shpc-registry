...
updated_at: "2026-09-04 07:41:59.727696"
latest: "0.7.5.2--r45hc52dbad_8"
...
```bash
$ shpc install quay.io/biocontainers/r-qtlseqr:0.7.5.2--r45hc52dbad_8
```
...
```bash
$ module load quay.io/biocontainers/r-qtlseqr/0.7.5.2--r45hc52dbad_8
$ module help quay.io/biocontainers/r-qtlseqr/0.7.5.2--r45hc52dbad_8
```
