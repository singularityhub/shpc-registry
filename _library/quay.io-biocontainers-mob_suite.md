...
updated_at: "2023-09-12 02:53:41.617445"
...
```bash
$ shpc install quay.io/biocontainers/mob_suite:3.1.6--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mob_suite/3.1.6--pyhdfd78af_0
$ module help quay.io/biocontainers/mob_suite/3.1.6--pyhdfd78af_0
```
