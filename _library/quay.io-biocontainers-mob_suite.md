...
updated_at: "2025-03-01 03:43:52.416402"
...
```bash
$ shpc install quay.io/biocontainers/mob_suite:3.1.9--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/mob_suite/3.1.9--pyhdfd78af_1
$ module help quay.io/biocontainers/mob_suite/3.1.9--pyhdfd78af_1
```
