...
updated_at: "2024-07-15 04:04:23.688013"
...
```bash
$ shpc install quay.io/biocontainers/mob_suite:3.1.9--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mob_suite/3.1.9--pyhdfd78af_0
$ module help quay.io/biocontainers/mob_suite/3.1.9--pyhdfd78af_0
```
