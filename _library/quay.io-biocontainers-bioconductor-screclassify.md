...
updated_at: "2023-10-09 03:29:23.867413"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-screclassify:1.6.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-screclassify/1.6.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-screclassify/1.6.0--r43hdfd78af_0
```
