...
updated_at: "2026-09-25 08:02:57.389986"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-bioconcotk:1.24.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-bioconcotk/1.24.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-bioconcotk/1.24.0--r45hdfd78af_0
```
