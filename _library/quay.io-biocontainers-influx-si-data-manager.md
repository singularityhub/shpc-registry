...
updated_at: "2025-03-21 03:24:29.918388"
...
```bash
$ shpc install quay.io/biocontainers/influx-si-data-manager:1.0.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/influx-si-data-manager/1.0.3--pyhdfd78af_0
$ module help quay.io/biocontainers/influx-si-data-manager/1.0.3--pyhdfd78af_0
```
