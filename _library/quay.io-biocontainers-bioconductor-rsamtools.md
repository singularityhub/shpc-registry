...
updated_at: "2026-04-02 05:18:17.211238"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rsamtools:2.26.0--r45ha27e39d_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rsamtools/2.26.0--r45ha27e39d_0
$ module help quay.io/biocontainers/bioconductor-rsamtools/2.26.0--r45ha27e39d_0
```
