...
updated_at: "2025-02-20 03:03:29.466056"
latest: "2.22.0--r44h77050f0_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rsamtools:2.22.0--r44h77050f0_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rsamtools/2.22.0--r44h77050f0_0
$ module help quay.io/biocontainers/bioconductor-rsamtools/2.22.0--r44h77050f0_0
```
