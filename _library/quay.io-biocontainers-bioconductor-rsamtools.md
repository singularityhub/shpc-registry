...
updated_at: "2024-09-10 03:07:15.727943"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rsamtools:2.18.0--r43hf17093f_2
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rsamtools/2.18.0--r43hf17093f_2
$ module help quay.io/biocontainers/bioconductor-rsamtools/2.18.0--r43hf17093f_2
```
