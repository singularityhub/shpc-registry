...
updated_at: "2024-02-05 02:59:36.075573"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rsamtools:2.18.0--r43hf17093f_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rsamtools/2.18.0--r43hf17093f_1
$ module help quay.io/biocontainers/bioconductor-rsamtools/2.18.0--r43hf17093f_1
```
