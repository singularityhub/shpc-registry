...
updated_at: "2025-07-27 03:53:15.805645"
...
```bash
$ shpc install quay.io/biocontainers/grz-cli:1.0.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/grz-cli/1.0.1--pyhdfd78af_0
$ module help quay.io/biocontainers/grz-cli/1.0.1--pyhdfd78af_0
```
