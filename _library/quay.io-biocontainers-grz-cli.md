...
updated_at: "2025-12-17 16:11:32.306906"
...
```bash
$ shpc install quay.io/biocontainers/grz-cli:1.5.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/grz-cli/1.5.0--pyhdfd78af_0
$ module help quay.io/biocontainers/grz-cli/1.5.0--pyhdfd78af_0
```
