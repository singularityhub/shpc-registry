...
updated_at: "2026-01-26 05:01:50.902124"
...
```bash
$ shpc install quay.io/biocontainers/grz-cli:1.5.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/grz-cli/1.5.1--pyhdfd78af_0
$ module help quay.io/biocontainers/grz-cli/1.5.1--pyhdfd78af_0
```
