...
updated_at: "2026-06-16 07:47:41.082114"
...
```bash
$ shpc install quay.io/biocontainers/grz-cli:1.7.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/grz-cli/1.7.1--pyhdfd78af_0
$ module help quay.io/biocontainers/grz-cli/1.7.1--pyhdfd78af_0
```
