...
updated_at: "2026-09-03 07:14:06.155915"
...
```bash
$ shpc install quay.io/biocontainers/grz-cli:2.0.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/grz-cli/2.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/grz-cli/2.0.0--pyhdfd78af_0
```
