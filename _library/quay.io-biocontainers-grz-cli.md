...
updated_at: "2026-07-02 06:19:46.181520"
...
```bash
$ shpc install quay.io/biocontainers/grz-cli:1.7.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/grz-cli/1.7.2--pyhdfd78af_0
$ module help quay.io/biocontainers/grz-cli/1.7.2--pyhdfd78af_0
```
