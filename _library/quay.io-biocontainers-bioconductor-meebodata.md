...
updated_at: "2022-11-19 01:53:01.125951"
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-meebodata-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-meebodata-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-meebodata-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-meebodata-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-meebodata-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-meebodata-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
