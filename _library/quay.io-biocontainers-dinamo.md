...
updated_at: "2025-10-09 04:28:43.777831"
...
```bash
$ shpc install quay.io/biocontainers/dinamo:1.0--h9948957_8
```
...
```bash
$ module load quay.io/biocontainers/dinamo/1.0--h9948957_8
$ module help quay.io/biocontainers/dinamo/1.0--h9948957_8
```
