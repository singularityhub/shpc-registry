---
layout: container
name:  "quay.io/biocontainers/perl-bioperl-run"
maintainer: "@vsoch"
...
updated_at: "2026-02-03 05:09:40.950755"
...
aliases:
 ...
 - "bp_gccalc"
versions:
 - "1.007003--pl5321hdfd78af_0"
description: "shpc-registry automated BioContainers addition for perl-bioperl-run"
config: {"url": "https://biocontainers.pro/tools/perl-bioperl-run", "maintainer": "@vsoch", "description": "shpc-registry automated BioContainers addition for perl-bioperl-run", "latest": {"1.007003--pl5321hdfd78af_0": "sha256:1c1ac1a0b102f159ab93a9566b7f8f92c3d6832e04b064929c92218e9a64b27c"}, "tags": {"1.007003--pl5321hdfd78af_0": "sha256:1c1ac1a0b102f159ab93a9566b7f8f92c3d6832e04b064929c92218e9a64b27c"}, "docker": "quay.io/biocontainers/perl-bioperl-run", "aliases": {"bp_aacomp": "/usr/local/bin/bp_aacomp", "bp_bioflat_index": "/usr/local/bin/bp_bioflat_index", "bp_biogetseq": "/usr/local/bin/bp_biogetseq", "bp_dbsplit": "/usr/local/bin/bp_dbsplit", "bp_extract_feature_seq": "/usr/local/bin/bp_extract_feature_seq", "bp_fastam9_to_table": "/usr/local/bin/bp_fastam9_to_table", "bp_fetch": "/usr/local/bin/bp_fetch", "bp_filter_search": "/usr/local/bin/bp_filter_search", "bp_find-blast-matches": "/usr/local/bin/bp_find-blast-matches", "bp_gccalc": "/usr/local/bin/bp_gccalc"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/perl-bioperl-run.
shpc-registry automated BioContainers addition for perl-bioperl-run
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/perl-bioperl-run
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/perl-bioperl-run:1.007003--pl5321hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/perl-bioperl-run/1.007003--pl5321hdfd78af_0
$ module help quay.io/biocontainers/perl-bioperl-run/1.007003--pl5321hdfd78af_0
```
...
#### perl-bioperl-run-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### perl-bioperl-run-inspect-deffile:
