...
updated_at: "2025-03-09 02:40:57.416979"
...
```bash
$ shpc install quay.io/biocontainers/singlem:0.18.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/singlem/0.18.3--pyhdfd78af_0
$ module help quay.io/biocontainers/singlem/0.18.3--pyhdfd78af_0
```
