...
updated_at: "2026-09-02 07:35:15.580311"
...
```bash
$ shpc install quay.io/biocontainers/singlem:0.21.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/singlem/0.21.4--pyhdfd78af_0
$ module help quay.io/biocontainers/singlem/0.21.4--pyhdfd78af_0
```
