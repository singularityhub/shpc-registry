...
updated_at: "2024-01-06 02:44:14.759732"
...
```bash
$ shpc install quay.io/biocontainers/singlem:0.16.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/singlem/0.16.0--pyhdfd78af_0
$ module help quay.io/biocontainers/singlem/0.16.0--pyhdfd78af_0
```
