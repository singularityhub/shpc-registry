...
updated_at: "2023-11-29 03:03:25.137845"
...
```bash
$ shpc install quay.io/biocontainers/singlem:0.15.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/singlem/0.15.0--pyhdfd78af_0
$ module help quay.io/biocontainers/singlem/0.15.0--pyhdfd78af_0
```
