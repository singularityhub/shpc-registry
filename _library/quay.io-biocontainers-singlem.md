...
updated_at: "2026-06-16 07:50:04.523831"
latest: "0.21.3--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/singlem:0.21.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/singlem/0.21.3--pyhdfd78af_0
$ module help quay.io/biocontainers/singlem/0.21.3--pyhdfd78af_0
```
