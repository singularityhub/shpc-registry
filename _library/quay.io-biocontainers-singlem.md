...
updated_at: "2024-07-15 02:53:50.080065"
...
```bash
$ shpc install quay.io/biocontainers/singlem:0.18.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/singlem/0.18.0--pyhdfd78af_0
$ module help quay.io/biocontainers/singlem/0.18.0--pyhdfd78af_0
```
