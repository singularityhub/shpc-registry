...
updated_at: "2024-08-31 02:44:20.897961"
...
```bash
$ shpc install quay.io/biocontainers/singlem:0.18.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/singlem/0.18.2--pyhdfd78af_0
$ module help quay.io/biocontainers/singlem/0.18.2--pyhdfd78af_0
```
