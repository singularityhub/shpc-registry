...
updated_at: "2024-08-31 02:47:20.194366"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-regionalpcs:1.0.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-regionalpcs/1.0.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-regionalpcs/1.0.0--r43hdfd78af_0
```
