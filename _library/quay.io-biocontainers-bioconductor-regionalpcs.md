...
updated_at: "2025-09-23 03:34:15.020835"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-regionalpcs:1.4.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-regionalpcs/1.4.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-regionalpcs/1.4.0--r44hdfd78af_0
```
