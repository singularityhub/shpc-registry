...
updated_at: "2025-10-19 03:33:51.431664"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-prodata:1.44.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-prodata/1.44.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-prodata/1.44.0--r44hdfd78af_0
```
