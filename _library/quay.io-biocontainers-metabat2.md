...
updated_at: "2025-12-06 03:16:35.777074"
latest: "2.18--h6f16272_0"
...
```bash
$ shpc install quay.io/biocontainers/metabat2:2.18--h6f16272_0
```
...
```bash
$ module load quay.io/biocontainers/metabat2/2.18--h6f16272_0
$ module help quay.io/biocontainers/metabat2/2.18--h6f16272_0
```
