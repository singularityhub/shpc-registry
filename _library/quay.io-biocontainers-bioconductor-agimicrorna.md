...
updated_at: "2026-03-25 04:42:19.686530"
latest: "2.60.0--r45hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-agimicrorna:2.60.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-agimicrorna/2.60.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-agimicrorna/2.60.0--r45hdfd78af_0
```
