...
updated_at: "2026-03-31 05:27:43.599077"
...
```bash
$ shpc install quay.io/biocontainers/discount:3.0.1--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/discount/3.0.1--hdfd78af_0
$ module help quay.io/biocontainers/discount/3.0.1--hdfd78af_0
```
