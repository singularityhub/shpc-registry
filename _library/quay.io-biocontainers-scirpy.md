...
updated_at: "2025-07-28 09:26:16.511277"
latest: "0.22.1--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/scirpy:0.22.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/scirpy/0.22.1--pyhdfd78af_0
$ module help quay.io/biocontainers/scirpy/0.22.1--pyhdfd78af_0
```
