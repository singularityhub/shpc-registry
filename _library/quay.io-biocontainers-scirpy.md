...
updated_at: "2024-11-06 02:55:17.933003"
...
```bash
$ shpc install quay.io/biocontainers/scirpy:0.18.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/scirpy/0.18.0--pyhdfd78af_0
$ module help quay.io/biocontainers/scirpy/0.18.0--pyhdfd78af_0
```
