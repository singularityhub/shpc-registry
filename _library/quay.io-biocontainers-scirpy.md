...
updated_at: "2025-08-23 03:38:55.726792"
latest: "0.22.2--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/scirpy:0.22.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/scirpy/0.22.2--pyhdfd78af_0
$ module help quay.io/biocontainers/scirpy/0.22.2--pyhdfd78af_0
```
