...
updated_at: "2025-02-24 03:17:33.572013"
...
```bash
$ shpc install quay.io/biocontainers/scirpy:0.20.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/scirpy/0.20.1--pyhdfd78af_0
$ module help quay.io/biocontainers/scirpy/0.20.1--pyhdfd78af_0
```
