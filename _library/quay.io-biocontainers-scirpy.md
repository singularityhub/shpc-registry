...
updated_at: "2023-07-11 03:14:47.490139"
latest: "0.13.0--pyhdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/scirpy:0.13.0--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/scirpy/0.13.0--pyhdfd78af_1
$ module help quay.io/biocontainers/scirpy/0.13.0--pyhdfd78af_1
```
