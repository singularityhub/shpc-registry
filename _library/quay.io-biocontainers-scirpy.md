...
updated_at: "2024-08-07 02:39:43.495819"
latest: "0.17.1--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/scirpy:0.17.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/scirpy/0.17.1--pyhdfd78af_0
$ module help quay.io/biocontainers/scirpy/0.17.1--pyhdfd78af_0
```
