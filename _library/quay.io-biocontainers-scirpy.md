...
updated_at: "2023-11-01 02:34:17.381530"
...
```bash
$ shpc install quay.io/biocontainers/scirpy:0.13.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/scirpy/0.13.1--pyhdfd78af_0
$ module help quay.io/biocontainers/scirpy/0.13.1--pyhdfd78af_0
```
