...
updated_at: "2025-05-25 03:23:10.073500"
...
```bash
$ shpc install quay.io/biocontainers/scirpy:0.22.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/scirpy/0.22.0--pyhdfd78af_0
$ module help quay.io/biocontainers/scirpy/0.22.0--pyhdfd78af_0
```
