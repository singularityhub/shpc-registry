...
updated_at: "2026-02-02 04:30:57.689900"
latest: "0.22.4--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/scirpy:0.22.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/scirpy/0.22.4--pyhdfd78af_0
$ module help quay.io/biocontainers/scirpy/0.22.4--pyhdfd78af_0
```
