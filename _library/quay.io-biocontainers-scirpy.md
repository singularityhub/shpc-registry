...
updated_at: "2024-09-24 03:37:12.909480"
...
```bash
$ shpc install quay.io/biocontainers/scirpy:0.17.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/scirpy/0.17.2--pyhdfd78af_0
$ module help quay.io/biocontainers/scirpy/0.17.2--pyhdfd78af_0
```
