...
updated_at: "2025-01-03 03:09:11.740933"
...
```bash
$ shpc install quay.io/biocontainers/scirpy:0.20.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/scirpy/0.20.0--pyhdfd78af_0
$ module help quay.io/biocontainers/scirpy/0.20.0--pyhdfd78af_0
```
