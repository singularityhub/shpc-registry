...
updated_at: "2025-03-13 05:05:31.502746"
...
```bash
$ shpc install quay.io/biocontainers/scirpy:0.21.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/scirpy/0.21.0--pyhdfd78af_0
$ module help quay.io/biocontainers/scirpy/0.21.0--pyhdfd78af_0
```
