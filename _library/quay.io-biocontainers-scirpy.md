...
updated_at: "2024-06-07 03:09:48.655798"
...
```bash
$ shpc install quay.io/biocontainers/scirpy:0.16.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/scirpy/0.16.1--pyhdfd78af_0
$ module help quay.io/biocontainers/scirpy/0.16.1--pyhdfd78af_0
```
