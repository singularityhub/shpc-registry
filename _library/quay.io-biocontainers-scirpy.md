...
updated_at: "2025-12-20 03:21:44.573160"
latest: "0.22.3--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/scirpy:0.22.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/scirpy/0.22.3--pyhdfd78af_0
$ module help quay.io/biocontainers/scirpy/0.22.3--pyhdfd78af_0
```
