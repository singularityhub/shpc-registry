...
updated_at: "2024-06-20 03:04:28.367503"
...
```bash
$ shpc install quay.io/biocontainers/scirpy:0.17.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/scirpy/0.17.0--pyhdfd78af_0
$ module help quay.io/biocontainers/scirpy/0.17.0--pyhdfd78af_0
```
