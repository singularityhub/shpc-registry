...
updated_at: "2024-11-12 03:13:14.021076"
...
```bash
$ shpc install quay.io/biocontainers/scirpy:0.19.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/scirpy/0.19.0--pyhdfd78af_0
$ module help quay.io/biocontainers/scirpy/0.19.0--pyhdfd78af_0
```
