...
updated_at: "2024-04-21 02:48:48.531624"
...
```bash
$ shpc install quay.io/biocontainers/scirpy:0.16.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/scirpy/0.16.0--pyhdfd78af_0
$ module help quay.io/biocontainers/scirpy/0.16.0--pyhdfd78af_0
```
