...
updated_at: "2026-03-19 04:35:09.050947"
latest: "1.0.7--r45h3342da4_3"
...
```bash
$ shpc install quay.io/biocontainers/r-biomartr:1.0.7--r45h3342da4_3
```
...
```bash
$ module load quay.io/biocontainers/r-biomartr/1.0.7--r45h3342da4_3
$ module help quay.io/biocontainers/r-biomartr/1.0.7--r45h3342da4_3
```
