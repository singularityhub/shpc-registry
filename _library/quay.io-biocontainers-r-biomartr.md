...
updated_at: "2025-02-03 03:34:10.260815"
...
```bash
$ shpc install quay.io/biocontainers/r-biomartr:1.0.7--r44h3342da4_2
```
...
```bash
$ module load quay.io/biocontainers/r-biomartr/1.0.7--r44h3342da4_2
$ module help quay.io/biocontainers/r-biomartr/1.0.7--r44h3342da4_2
```
