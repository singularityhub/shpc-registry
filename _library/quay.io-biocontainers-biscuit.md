...
updated_at: "2026-05-26 06:49:41.360487"
latest: "1.8.1.20260511--hdf5d79d_0"
...
```bash
$ shpc install quay.io/biocontainers/biscuit:1.8.1.20260511--hdf5d79d_0
```
...
```bash
$ module load quay.io/biocontainers/biscuit/1.8.1.20260511--hdf5d79d_0
$ module help quay.io/biocontainers/biscuit/1.8.1.20260511--hdf5d79d_0
```
