...
updated_at: "2026-09-01 07:27:57.099457"
latest: "1.10.2.20260818--hdf5d79d_0"
...
```bash
$ shpc install quay.io/biocontainers/biscuit:1.10.2.20260818--hdf5d79d_0
```
...
```bash
$ module load quay.io/biocontainers/biscuit/1.10.2.20260818--hdf5d79d_0
$ module help quay.io/biocontainers/biscuit/1.10.2.20260818--hdf5d79d_0
```
