...
updated_at: "2025-04-28 04:23:53.468029"
latest: "1.6.1.20250415--h0886490_0"
...
```bash
$ shpc install quay.io/biocontainers/biscuit:1.6.1.20250415--h0886490_0
```
...
```bash
$ module load quay.io/biocontainers/biscuit/1.6.1.20250415--h0886490_0
$ module help quay.io/biocontainers/biscuit/1.6.1.20250415--h0886490_0
```
