...
updated_at: "2024-04-09 02:36:28.971313"
latest: "2.12.0--pyh7cba7a3_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconda-utils:2.12.0--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/bioconda-utils/2.12.0--pyh7cba7a3_0
$ module help quay.io/biocontainers/bioconda-utils/2.12.0--pyh7cba7a3_0
```
