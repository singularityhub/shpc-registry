...
updated_at: "2024-10-30 02:56:41.514642"
...
```bash
$ shpc install quay.io/biocontainers/bioconda-utils:3.4.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconda-utils/3.4.0--pyhdfd78af_0
$ module help quay.io/biocontainers/bioconda-utils/3.4.0--pyhdfd78af_0
```
