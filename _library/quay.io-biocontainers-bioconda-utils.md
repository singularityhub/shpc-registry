...
updated_at: "2025-01-09 03:47:47.140628"
latest: "3.6.1--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconda-utils:3.6.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconda-utils/3.6.1--pyhdfd78af_0
$ module help quay.io/biocontainers/bioconda-utils/3.6.1--pyhdfd78af_0
```
