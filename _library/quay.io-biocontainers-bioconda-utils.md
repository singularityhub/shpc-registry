...
updated_at: "2023-12-20 03:21:25.224031"
...
```bash
$ shpc install quay.io/biocontainers/bioconda-utils:1.5.6--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconda-utils/1.5.6--pyhdfd78af_0
$ module help quay.io/biocontainers/bioconda-utils/1.5.6--pyhdfd78af_0
```
