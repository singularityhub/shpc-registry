...
updated_at: "2026-09-23 08:05:34.520127"
...
```bash
$ shpc install quay.io/biocontainers/bioconda-utils:5.0.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconda-utils/5.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/bioconda-utils/5.0.0--pyhdfd78af_0
```
