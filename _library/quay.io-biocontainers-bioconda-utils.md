...
updated_at: "2026-07-01 07:09:09.281708"
latest: "4.5.0--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconda-utils:4.5.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconda-utils/4.5.0--pyhdfd78af_0
$ module help quay.io/biocontainers/bioconda-utils/4.5.0--pyhdfd78af_0
```
