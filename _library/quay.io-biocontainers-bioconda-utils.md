...
updated_at: "2026-04-23 05:28:03.567573"
latest: "4.3.2--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconda-utils:4.3.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconda-utils/4.3.2--pyhdfd78af_0
$ module help quay.io/biocontainers/bioconda-utils/4.3.2--pyhdfd78af_0
```
