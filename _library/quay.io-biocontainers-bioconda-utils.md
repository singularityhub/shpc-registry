...
updated_at: "2026-01-23 04:08:42.568093"
latest: "3.9.2--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconda-utils:3.9.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconda-utils/3.9.2--pyhdfd78af_0
$ module help quay.io/biocontainers/bioconda-utils/3.9.2--pyhdfd78af_0
```
