...
updated_at: "2024-12-14 03:02:28.255799"
...
```bash
$ shpc install quay.io/biocontainers/bioconda-utils:3.4.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconda-utils/3.4.1--pyhdfd78af_0
$ module help quay.io/biocontainers/bioconda-utils/3.4.1--pyhdfd78af_0
```
