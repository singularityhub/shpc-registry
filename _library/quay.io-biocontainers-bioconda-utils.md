...
updated_at: "2026-06-21 07:24:15.915375"
latest: "4.4.1--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconda-utils:4.4.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconda-utils/4.4.1--pyhdfd78af_0
$ module help quay.io/biocontainers/bioconda-utils/4.4.1--pyhdfd78af_0
```
