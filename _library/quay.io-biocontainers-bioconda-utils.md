...
updated_at: "2026-03-20 04:37:29.007988"
...
```bash
$ shpc install quay.io/biocontainers/bioconda-utils:4.0.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconda-utils/4.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/bioconda-utils/4.0.0--pyhdfd78af_0
```
