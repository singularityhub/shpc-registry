...
updated_at: "2025-09-01 04:44:16.542644"
latest: "3.9.1--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconda-utils:3.9.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconda-utils/3.9.1--pyhdfd78af_0
$ module help quay.io/biocontainers/bioconda-utils/3.9.1--pyhdfd78af_0
```
