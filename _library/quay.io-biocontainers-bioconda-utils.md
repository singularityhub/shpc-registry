...
updated_at: "2024-05-06 04:45:22.792441"
...
```bash
$ shpc install quay.io/biocontainers/bioconda-utils:2.14.0--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/bioconda-utils/2.14.0--pyh7cba7a3_0
$ module help quay.io/biocontainers/bioconda-utils/2.14.0--pyh7cba7a3_0
```
