...
updated_at: "2026-03-25 04:44:53.493485"
...
```bash
$ shpc install quay.io/biocontainers/bioconda-utils:4.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconda-utils/4.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/bioconda-utils/4.1.0--pyhdfd78af_0
```
