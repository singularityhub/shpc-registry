...
updated_at: "2025-01-28 03:11:36.977575"
...
```bash
$ shpc install quay.io/biocontainers/bioconda-utils:3.7.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconda-utils/3.7.0--pyhdfd78af_0
$ module help quay.io/biocontainers/bioconda-utils/3.7.0--pyhdfd78af_0
```
