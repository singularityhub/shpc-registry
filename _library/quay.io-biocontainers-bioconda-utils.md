...
updated_at: "2025-08-01 04:06:14.428394"
...
```bash
$ shpc install quay.io/biocontainers/bioconda-utils:3.7.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconda-utils/3.7.2--pyhdfd78af_0
$ module help quay.io/biocontainers/bioconda-utils/3.7.2--pyhdfd78af_0
```
