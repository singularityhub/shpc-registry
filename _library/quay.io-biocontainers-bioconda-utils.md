...
updated_at: "2024-06-10 02:39:18.363552"
latest: "2.15.1--pyh7cba7a3_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconda-utils:2.15.1--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/bioconda-utils/2.15.1--pyh7cba7a3_0
$ module help quay.io/biocontainers/bioconda-utils/2.15.1--pyh7cba7a3_0
```
