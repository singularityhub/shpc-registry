...
updated_at: "2024-10-17 18:18:21.456035"
...
```bash
$ shpc install quay.io/biocontainers/bioconda-utils:3.3.1--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/bioconda-utils/3.3.1--pyh7cba7a3_0
$ module help quay.io/biocontainers/bioconda-utils/3.3.1--pyh7cba7a3_0
```
