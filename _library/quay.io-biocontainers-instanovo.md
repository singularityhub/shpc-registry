...
updated_at: "2025-06-05 12:53:45.378659"
...
```bash
$ shpc install quay.io/biocontainers/instanovo:1.1.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/instanovo/1.1.2--pyhdfd78af_0
$ module help quay.io/biocontainers/instanovo/1.1.2--pyhdfd78af_0
```
