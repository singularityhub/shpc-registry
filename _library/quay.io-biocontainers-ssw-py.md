---
layout: container
name:  "quay.io/biocontainers/ssw-py"
maintainer: "@vsoch"
...
updated_at: "2026-03-26 04:50:11.745465"
...
singularity registry hpc automated addition for ssw-py
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/ssw-py
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/ssw-py:1.0.1--py310h7c10099_0
```
...
```bash
$ module load quay.io/biocontainers/ssw-py/1.0.1--py310h7c10099_0
$ module help quay.io/biocontainers/ssw-py/1.0.1--py310h7c10099_0
```
...
#### ssw-py-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### ssw-py-inspect-deffile:
