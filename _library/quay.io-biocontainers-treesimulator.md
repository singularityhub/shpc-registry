...
updated_at: "2025-02-22 03:06:08.190680"
...
```bash
$ shpc install quay.io/biocontainers/treesimulator:0.2.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/treesimulator/0.2.1--pyhdfd78af_0
$ module help quay.io/biocontainers/treesimulator/0.2.1--pyhdfd78af_0
```
