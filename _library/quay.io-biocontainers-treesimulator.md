...
updated_at: "2026-08-14 07:51:52.956668"
latest: "0.2.28--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/treesimulator:0.2.28--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/treesimulator/0.2.28--pyhdfd78af_0
$ module help quay.io/biocontainers/treesimulator/0.2.28--pyhdfd78af_0
```
