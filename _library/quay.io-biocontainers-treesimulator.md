...
updated_at: "2025-12-05 03:54:58.047952"
latest: "0.2.24--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/treesimulator:0.2.24--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/treesimulator/0.2.24--pyhdfd78af_0
$ module help quay.io/biocontainers/treesimulator/0.2.24--pyhdfd78af_0
```
