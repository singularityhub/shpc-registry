...
updated_at: "2026-09-20 07:55:51.936146"
latest: "0.2.29--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/treesimulator:0.2.29--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/treesimulator/0.2.29--pyhdfd78af_0
$ module help quay.io/biocontainers/treesimulator/0.2.29--pyhdfd78af_0
```
