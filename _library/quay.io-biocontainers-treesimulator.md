...
updated_at: "2025-10-02 04:04:21.210770"
latest: "0.2.19--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/treesimulator:0.2.19--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/treesimulator/0.2.19--pyhdfd78af_0
$ module help quay.io/biocontainers/treesimulator/0.2.19--pyhdfd78af_0
```
