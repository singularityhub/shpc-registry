...
updated_at: "2025-05-15 03:59:00.899610"
latest: "0.2.17--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/treesimulator:0.2.17--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/treesimulator/0.2.17--pyhdfd78af_0
$ module help quay.io/biocontainers/treesimulator/0.2.17--pyhdfd78af_0
```
