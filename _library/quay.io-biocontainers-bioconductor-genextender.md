...
updated_at: "2024-03-08 02:53:38.167894"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-genextender:1.28.0--r43ha9d7317_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-genextender/1.28.0--r43ha9d7317_0
$ module help quay.io/biocontainers/bioconductor-genextender/1.28.0--r43ha9d7317_0
```
