...
updated_at: "2023-11-04 02:30:48.871536"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-genextender:1.26.0--r43ha9d7317_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-genextender/1.26.0--r43ha9d7317_0
$ module help quay.io/biocontainers/bioconductor-genextender/1.26.0--r43ha9d7317_0
```
