...
updated_at: "2023-08-07 03:24:20.014412"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-genextender:1.24.0--r42ha9d7317_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-genextender/1.24.0--r42ha9d7317_1
$ module help quay.io/biocontainers/bioconductor-genextender/1.24.0--r42ha9d7317_1
```
