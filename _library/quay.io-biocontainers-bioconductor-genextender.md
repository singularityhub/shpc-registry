...
updated_at: "2026-03-25 05:20:52.288809"
latest: "1.36.0--r45h01b2380_1"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-genextender:1.36.0--r45h01b2380_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-genextender/1.36.0--r45h01b2380_1
$ module help quay.io/biocontainers/bioconductor-genextender/1.36.0--r45h01b2380_1
```
