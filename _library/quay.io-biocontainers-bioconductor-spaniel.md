...
updated_at: "2024-07-27 02:54:49.509353"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-spaniel:1.16.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-spaniel/1.16.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-spaniel/1.16.0--r43hdfd78af_0
```
