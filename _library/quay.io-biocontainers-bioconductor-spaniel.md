...
updated_at: "2023-12-12 03:05:31.847691"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-spaniel:1.14.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-spaniel/1.14.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-spaniel/1.14.0--r43hdfd78af_0
```
