...
updated_at: "2023-10-14 02:29:37.025502"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rcgh:1.30.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rcgh/1.30.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rcgh/1.30.0--r43hdfd78af_0
```
