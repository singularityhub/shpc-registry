...
updated_at: "2022-11-21 13:27:35.794545"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rcgh:1.24.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rcgh/1.24.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rcgh/1.24.0--r41hdfd78af_0
```
