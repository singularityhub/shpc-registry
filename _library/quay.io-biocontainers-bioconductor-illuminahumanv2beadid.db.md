...
updated_at: "2026-04-04 05:00:21.980668"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-illuminahumanv2beadid.db:1.8.0--r45hdfd78af_14
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-illuminahumanv2beadid.db/1.8.0--r45hdfd78af_14
$ module help quay.io/biocontainers/bioconductor-illuminahumanv2beadid.db/1.8.0--r45hdfd78af_14
```
