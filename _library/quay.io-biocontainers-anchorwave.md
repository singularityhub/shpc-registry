...
updated_at: "2023-10-23 03:13:11.954900"
latest: "1.2.1--hdcf5f25_2"
...
```bash
$ shpc install quay.io/biocontainers/anchorwave:1.2.1--hdcf5f25_2
```
...
```bash
$ module load quay.io/biocontainers/anchorwave/1.2.1--hdcf5f25_2
$ module help quay.io/biocontainers/anchorwave/1.2.1--hdcf5f25_2
```
