...
updated_at: "2024-03-04 04:54:38.098745"
...
```bash
$ shpc install quay.io/biocontainers/anchorwave:1.2.2--hdcf5f25_0
```
...
```bash
$ module load quay.io/biocontainers/anchorwave/1.2.2--hdcf5f25_0
$ module help quay.io/biocontainers/anchorwave/1.2.2--hdcf5f25_0
```
