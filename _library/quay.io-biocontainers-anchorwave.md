...
updated_at: "2024-06-30 02:57:21.701338"
latest: "1.2.3--hdcf5f25_0"
...
```bash
$ shpc install quay.io/biocontainers/anchorwave:1.2.3--hdcf5f25_0
```
...
```bash
$ module load quay.io/biocontainers/anchorwave/1.2.3--hdcf5f25_0
$ module help quay.io/biocontainers/anchorwave/1.2.3--hdcf5f25_0
```
