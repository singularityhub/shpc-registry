...
updated_at: "2025-03-18 03:01:34.737274"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-nearbynding:1.16.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-nearbynding/1.16.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-nearbynding/1.16.0--r44hdfd78af_0
```
