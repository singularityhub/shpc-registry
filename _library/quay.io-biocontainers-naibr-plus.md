...
updated_at: "2026-06-15 08:10:48.728695"
...
```bash
$ shpc install quay.io/biocontainers/naibr-plus:0.5.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/naibr-plus/0.5.4--pyhdfd78af_0
$ module help quay.io/biocontainers/naibr-plus/0.5.4--pyhdfd78af_0
```
