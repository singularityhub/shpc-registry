---
layout: container
name:  "quay.io/biocontainers/naibr-plus"
maintainer: "@vsoch"
...
updated_at: "2023-12-15 02:37:31.223955"
...
```bash
$ shpc install quay.io/biocontainers/naibr-plus
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/naibr-plus:0.5.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/naibr-plus/0.5.1--pyhdfd78af_0
$ module help quay.io/biocontainers/naibr-plus/0.5.1--pyhdfd78af_0
```
...
#### naibr-plus-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### naibr-plus-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/naibr
$ podman run --it --rm --entrypoint /usr/local/bin/naibr   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/naibr   -v ${PWD} -w ${PWD} <container> -c " $@"
```
