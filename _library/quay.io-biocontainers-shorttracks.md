...
updated_at: "2023-10-20 02:30:54.866028"
...
```bash
$ shpc install quay.io/biocontainers/shorttracks:1.1--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/shorttracks/1.1--hdfd78af_0
$ module help quay.io/biocontainers/shorttracks/1.1--hdfd78af_0
```
