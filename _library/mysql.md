...
updated_at: "2024-04-07 03:09:03.328132"
latest: "8-oraclelinux8"
...
```bash
$ shpc install mysql:8-oraclelinux8
```
...
```bash
$ module load mysql/8-oraclelinux8
$ module help mysql/8-oraclelinux8
```
