...
updated_at: "2025-10-28 03:27:45.356543"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-doser:1.22.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-doser/1.22.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-doser/1.22.0--r44hdfd78af_0
```
