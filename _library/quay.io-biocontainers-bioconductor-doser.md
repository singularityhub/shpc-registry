...
updated_at: "2024-09-25 03:08:06.094363"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-doser:1.18.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-doser/1.18.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-doser/1.18.0--r43hdfd78af_0
```
