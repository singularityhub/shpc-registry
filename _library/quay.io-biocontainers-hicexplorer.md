...
updated_at: "2024-04-23 02:30:06.908125"
...
```bash
$ shpc install quay.io/biocontainers/hicexplorer:3.7.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hicexplorer/3.7.3--pyhdfd78af_0
$ module help quay.io/biocontainers/hicexplorer/3.7.3--pyhdfd78af_0
```
