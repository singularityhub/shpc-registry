...
updated_at: "2024-05-27 02:47:06.495102"
...
```bash
$ shpc install quay.io/biocontainers/hicexplorer:3.7.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hicexplorer/3.7.4--pyhdfd78af_0
$ module help quay.io/biocontainers/hicexplorer/3.7.4--pyhdfd78af_0
```
