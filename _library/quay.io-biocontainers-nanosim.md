...
updated_at: "2026-04-03 15:26:18.409369"
latest: "3.2.3--hdfd78af_2"
...
```bash
$ shpc install quay.io/biocontainers/nanosim:3.2.3--hdfd78af_2
```
...
```bash
$ module load quay.io/biocontainers/nanosim/3.2.3--hdfd78af_2
$ module help quay.io/biocontainers/nanosim/3.2.3--hdfd78af_2
```
