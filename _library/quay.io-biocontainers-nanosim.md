...
updated_at: "2024-10-14 17:36:36.727514"
...
```bash
$ shpc install quay.io/biocontainers/nanosim:3.2.1--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/nanosim/3.2.1--hdfd78af_0
$ module help quay.io/biocontainers/nanosim/3.2.1--hdfd78af_0
```
