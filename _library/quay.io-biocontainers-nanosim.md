...
updated_at: "2024-09-16 03:37:43.120897"
...
```bash
$ shpc install quay.io/biocontainers/nanosim:3.2.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/nanosim/3.2.0--hdfd78af_0
$ module help quay.io/biocontainers/nanosim/3.2.0--hdfd78af_0
```
