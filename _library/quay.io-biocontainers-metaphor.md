...
updated_at: "2024-05-02 03:08:10.539507"
latest: "1.7.11--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/metaphor:1.7.11--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/metaphor/1.7.11--pyhdfd78af_0
$ module help quay.io/biocontainers/metaphor/1.7.11--pyhdfd78af_0
```
