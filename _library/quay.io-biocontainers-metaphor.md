...
updated_at: "2025-10-24 03:34:58.267801"
...
```bash
$ shpc install quay.io/biocontainers/metaphor:1.7.14--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/metaphor/1.7.14--pyhdfd78af_0
$ module help quay.io/biocontainers/metaphor/1.7.14--pyhdfd78af_0
```
