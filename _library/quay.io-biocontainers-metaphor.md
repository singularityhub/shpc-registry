...
updated_at: "2022-11-27 23:34:27.470184"
...
```bash
$ shpc install quay.io/biocontainers/metaphor:1.6.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/metaphor/1.6.1--pyhdfd78af_0
$ module help quay.io/biocontainers/metaphor/1.6.1--pyhdfd78af_0
```
