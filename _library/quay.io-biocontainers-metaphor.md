...
updated_at: "2023-02-16 02:52:12.833330"
...
```bash
$ shpc install quay.io/biocontainers/metaphor:1.7.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/metaphor/1.7.2--pyhdfd78af_0
$ module help quay.io/biocontainers/metaphor/1.7.2--pyhdfd78af_0
```
