...
updated_at: "2023-01-14 03:02:06.544954"
...
```bash
$ shpc install quay.io/biocontainers/metaphor:1.6.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/metaphor/1.6.2--pyhdfd78af_0
$ module help quay.io/biocontainers/metaphor/1.6.2--pyhdfd78af_0
```
