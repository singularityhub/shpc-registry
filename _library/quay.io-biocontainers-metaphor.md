...
updated_at: "2024-10-16 03:33:48.298781"
latest: "1.7.13--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/metaphor:1.7.13--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/metaphor/1.7.13--pyhdfd78af_0
$ module help quay.io/biocontainers/metaphor/1.7.13--pyhdfd78af_0
```
