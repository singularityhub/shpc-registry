...
updated_at: "2023-10-22 02:43:15.051441"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-asics:2.16.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-asics/2.16.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-asics/2.16.0--r43hdfd78af_0
```
