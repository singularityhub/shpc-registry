...
updated_at: "2026-03-20 00:43:56.132021"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rrdpdata:1.30.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rrdpdata/1.30.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rrdpdata/1.30.0--r45hdfd78af_0
```
