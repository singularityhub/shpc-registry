...
updated_at: "2026-04-05 05:11:02.797427"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-m6aboost:1.16.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-m6aboost/1.16.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-m6aboost/1.16.0--r45hdfd78af_0
```
