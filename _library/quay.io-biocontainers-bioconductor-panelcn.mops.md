...
updated_at: "2026-03-25 05:05:43.736666"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-panelcn.mops:1.32.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-panelcn.mops/1.32.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-panelcn.mops/1.32.0--r45hdfd78af_0
```
