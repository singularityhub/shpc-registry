...
updated_at: "2026-03-28 16:52:14.193342"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-dapar:1.42.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-dapar/1.42.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-dapar/1.42.0--r45hdfd78af_0
```
