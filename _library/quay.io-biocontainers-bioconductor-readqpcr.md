...
updated_at: "2026-04-03 15:37:53.257747"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-readqpcr:1.56.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-readqpcr/1.56.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-readqpcr/1.56.0--r45hdfd78af_0
```
