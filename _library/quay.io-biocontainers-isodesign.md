...
updated_at: "2025-06-25 03:54:18.768481"
...
```bash
$ shpc install quay.io/biocontainers/isodesign:2.0.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/isodesign/2.0.1--pyhdfd78af_0
$ module help quay.io/biocontainers/isodesign/2.0.1--pyhdfd78af_0
```
