...
updated_at: "2025-11-12 03:40:34.684341"
...
```bash
$ shpc install quay.io/biocontainers/isodesign:2.0.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/isodesign/2.0.3--pyhdfd78af_0
$ module help quay.io/biocontainers/isodesign/2.0.3--pyhdfd78af_0
```
