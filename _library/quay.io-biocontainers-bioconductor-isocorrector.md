...
updated_at: "2025-11-06 03:59:40.532217"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-isocorrector:1.24.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-isocorrector/1.24.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-isocorrector/1.24.0--r44hdfd78af_0
```
