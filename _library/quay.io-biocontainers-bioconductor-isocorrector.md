...
updated_at: "2024-03-03 03:05:28.945865"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-isocorrector:1.20.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-isocorrector/1.20.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-isocorrector/1.20.0--r43hdfd78af_0
```
