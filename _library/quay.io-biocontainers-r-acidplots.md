...
updated_at: "2024-03-11 03:23:53.305640"
...
```bash
$ shpc install quay.io/biocontainers/r-acidplots:0.7.2--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/r-acidplots/0.7.2--r43hdfd78af_0
$ module help quay.io/biocontainers/r-acidplots/0.7.2--r43hdfd78af_0
```
