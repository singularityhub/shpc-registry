...
updated_at: "2026-09-23 07:42:03.820398"
...
```bash
$ shpc install quay.io/biocontainers/r-acidplots:0.7.5--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/r-acidplots/0.7.5--r45hdfd78af_0
$ module help quay.io/biocontainers/r-acidplots/0.7.5--r45hdfd78af_0
```
