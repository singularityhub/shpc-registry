...
updated_at: "2024-05-12 02:39:19.074801"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mbqn:2.14.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mbqn/2.14.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-mbqn/2.14.0--r43hdfd78af_0
```
