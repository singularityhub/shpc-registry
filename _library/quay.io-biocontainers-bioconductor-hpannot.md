...
updated_at: "2023-09-24 02:25:06.829572"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hpannot:1.1.0--r43hdfd78af_3
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hpannot/1.1.0--r43hdfd78af_3
$ module help quay.io/biocontainers/bioconductor-hpannot/1.1.0--r43hdfd78af_3
```
