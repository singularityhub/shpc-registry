...
updated_at: "2022-10-29 05:39:57.358945"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-odseq:1.22.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-odseq/1.22.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-odseq/1.22.0--r41hdfd78af_0
```
