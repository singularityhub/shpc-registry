...
updated_at: "2026-03-17 04:36:02.713747"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-odseq:1.38.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-odseq/1.38.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-odseq/1.38.0--r45hdfd78af_0
```
