...
updated_at: "2025-04-24 03:15:48.152967"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cellity:1.34.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cellity/1.34.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-cellity/1.34.0--r44hdfd78af_0
```
