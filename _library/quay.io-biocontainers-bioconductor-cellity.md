...
updated_at: "2023-08-28 08:54:18.776737"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cellity:1.28.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cellity/1.28.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-cellity/1.28.0--r43hdfd78af_0
```
