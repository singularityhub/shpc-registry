---
layout: container
name:  "quay.io/biocontainers/heliano"
maintainer: "@vsoch"
...
updated_at: "2025-05-26 04:02:59.558513"
...
```bash
$ shpc install quay.io/biocontainers/heliano
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/heliano:1.2.1--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/heliano/1.2.1--hdfd78af_0
$ module help quay.io/biocontainers/heliano/1.2.1--hdfd78af_0
```
...
#### heliano-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### heliano-inspect-deffile:
