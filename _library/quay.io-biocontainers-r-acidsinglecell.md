...
updated_at: "2023-10-30 03:08:02.802238"
latest: "0.4.0--r43hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/r-acidsinglecell:0.4.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/r-acidsinglecell/0.4.0--r43hdfd78af_0
$ module help quay.io/biocontainers/r-acidsinglecell/0.4.0--r43hdfd78af_0
```
