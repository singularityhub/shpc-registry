...
updated_at: "2023-10-04 02:58:47.930902"
latest: "0.3.6--r43hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/r-acidsinglecell:0.3.6--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/r-acidsinglecell/0.3.6--r43hdfd78af_0
$ module help quay.io/biocontainers/r-acidsinglecell/0.3.6--r43hdfd78af_0
```
