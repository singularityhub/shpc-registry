...
updated_at: "2026-09-17 07:58:57.334898"
latest: "0.4.5--r45hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/r-acidsinglecell:0.4.5--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/r-acidsinglecell/0.4.5--r45hdfd78af_0
$ module help quay.io/biocontainers/r-acidsinglecell/0.4.5--r45hdfd78af_0
```
