...
updated_at: "2023-04-05 03:00:20.471566"
latest: "0.3.4--r42hdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/r-acidsinglecell:0.3.4--r42hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/r-acidsinglecell/0.3.4--r42hdfd78af_1
$ module help quay.io/biocontainers/r-acidsinglecell/0.3.4--r42hdfd78af_1
```
