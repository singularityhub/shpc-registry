...
updated_at: "2023-09-03 03:05:40.967379"
latest: "0.3.5--r43hdfd78af_2"
...
```bash
$ shpc install quay.io/biocontainers/r-acidsinglecell:0.3.5--r43hdfd78af_2
```
...
```bash
$ module load quay.io/biocontainers/r-acidsinglecell/0.3.5--r43hdfd78af_2
$ module help quay.io/biocontainers/r-acidsinglecell/0.3.5--r43hdfd78af_2
```
