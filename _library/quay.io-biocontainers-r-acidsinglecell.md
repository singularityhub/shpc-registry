...
updated_at: "2023-12-20 02:52:25.261927"
...
```bash
$ shpc install quay.io/biocontainers/r-acidsinglecell:0.4.1--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/r-acidsinglecell/0.4.1--r43hdfd78af_0
$ module help quay.io/biocontainers/r-acidsinglecell/0.4.1--r43hdfd78af_0
```
