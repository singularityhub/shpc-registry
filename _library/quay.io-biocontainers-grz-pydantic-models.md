...
updated_at: "2026-01-04 04:28:33.823484"
latest: "2.5.0--pyh0648b3f_0"
...
```bash
$ shpc install quay.io/biocontainers/grz-pydantic-models:2.5.0--pyh0648b3f_0
```
...
```bash
$ module load quay.io/biocontainers/grz-pydantic-models/2.5.0--pyh0648b3f_0
$ module help quay.io/biocontainers/grz-pydantic-models/2.5.0--pyh0648b3f_0
```
