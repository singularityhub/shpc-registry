...
updated_at: "2026-09-19 07:17:22.320719"
...
```bash
$ shpc install quay.io/biocontainers/grz-pydantic-models:3.0.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/grz-pydantic-models/3.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/grz-pydantic-models/3.0.0--pyhdfd78af_0
```
