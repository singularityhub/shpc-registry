...
updated_at: "2025-09-08 03:25:22.139727"
...
```bash
$ shpc install quay.io/biocontainers/grz-pydantic-models:2.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/grz-pydantic-models/2.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/grz-pydantic-models/2.2.0--pyhdfd78af_0
```
