...
updated_at: "2026-07-02 06:40:59.351653"
...
```bash
$ shpc install quay.io/biocontainers/grz-pydantic-models:2.7.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/grz-pydantic-models/2.7.1--pyhdfd78af_0
$ module help quay.io/biocontainers/grz-pydantic-models/2.7.1--pyhdfd78af_0
```
