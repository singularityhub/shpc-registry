...
updated_at: "2023-09-14 02:24:20.544657"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-motifmatchr:1.22.0--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-motifmatchr/1.22.0--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-motifmatchr/1.22.0--r43hf17093f_0
```
