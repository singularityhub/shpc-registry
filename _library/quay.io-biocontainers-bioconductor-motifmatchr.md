...
updated_at: "2022-11-11 00:18:34.116236"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-motifmatchr:1.8.0--r36he1b5a44_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-motifmatchr/1.8.0--r36he1b5a44_0
$ module help quay.io/biocontainers/bioconductor-motifmatchr/1.8.0--r36he1b5a44_0
```
