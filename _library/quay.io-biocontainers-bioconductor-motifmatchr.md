...
updated_at: "2024-08-01 02:43:40.373044"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-motifmatchr:1.24.0--r43hf17093f_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-motifmatchr/1.24.0--r43hf17093f_1
$ module help quay.io/biocontainers/bioconductor-motifmatchr/1.24.0--r43hf17093f_1
```
