...
updated_at: "2025-11-11 03:27:41.624628"
latest: "7.5.2"
...
```bash
$ shpc install quay.io/biocontainers/dos2unix:7.5.2
```
...
```bash
$ module load quay.io/biocontainers/dos2unix/7.5.2
$ module help quay.io/biocontainers/dos2unix/7.5.2
```
