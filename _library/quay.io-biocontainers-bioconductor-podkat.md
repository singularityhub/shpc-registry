...
updated_at: "2022-11-05 00:49:22.870100"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-podkat:1.8.0--r3.4.1_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-podkat/1.8.0--r3.4.1_0
$ module help quay.io/biocontainers/bioconductor-podkat/1.8.0--r3.4.1_0
```
