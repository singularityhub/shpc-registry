...
updated_at: "2023-07-23 02:46:36.308592"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-podkat:1.30.0--r42hf17093f_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-podkat/1.30.0--r42hf17093f_1
$ module help quay.io/biocontainers/bioconductor-podkat/1.30.0--r42hf17093f_1
```
