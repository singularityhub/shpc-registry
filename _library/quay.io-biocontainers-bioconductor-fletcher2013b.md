...
updated_at: "2023-09-17 00:06:17.245558"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-fletcher2013b:1.36.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-fletcher2013b/1.36.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-fletcher2013b/1.36.0--r43hdfd78af_0
```
