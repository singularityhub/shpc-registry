...
updated_at: "2023-12-20 03:49:56.172646"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gse62944:1.28.1--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gse62944/1.28.1--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-gse62944/1.28.1--r43hdfd78af_0
```
