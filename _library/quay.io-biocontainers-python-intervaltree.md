...
updated_at: "2026-05-15 06:50:15.624801"
...
```bash
$ shpc install quay.io/biocontainers/python-intervaltree:3.2.1--pyh106432d_0
```
...
```bash
$ module load quay.io/biocontainers/python-intervaltree/3.2.1--pyh106432d_0
$ module help quay.io/biocontainers/python-intervaltree/3.2.1--pyh106432d_0
```
