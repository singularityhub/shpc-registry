...
updated_at: "2025-01-15 03:26:14.865424"
...
```bash
$ shpc install quay.io/biocontainers/ngs-tools:1.8.6--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ngs-tools/1.8.6--pyhdfd78af_0
$ module help quay.io/biocontainers/ngs-tools/1.8.6--pyhdfd78af_0
```
