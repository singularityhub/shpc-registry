...
updated_at: "2024-06-21 02:40:21.608939"
...
```bash
$ shpc install quay.io/biocontainers/ngs-tools:1.8.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ngs-tools/1.8.5--pyhdfd78af_0
$ module help quay.io/biocontainers/ngs-tools/1.8.5--pyhdfd78af_0
```
