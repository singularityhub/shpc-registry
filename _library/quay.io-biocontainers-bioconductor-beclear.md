...
updated_at: "2026-03-30 05:16:46.978678"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-beclear:2.26.0--r45ha27e39d_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-beclear/2.26.0--r45ha27e39d_0
$ module help quay.io/biocontainers/bioconductor-beclear/2.26.0--r45ha27e39d_0
```
