...
updated_at: "2025-09-01 03:39:47.791277"
latest: "0.6.6--h719ac0c_2"
...
```bash
$ shpc install quay.io/biocontainers/usher:0.6.6--h719ac0c_2
```
...
```bash
$ module load quay.io/biocontainers/usher/0.6.6--h719ac0c_2
$ module help quay.io/biocontainers/usher/0.6.6--h719ac0c_2
```
