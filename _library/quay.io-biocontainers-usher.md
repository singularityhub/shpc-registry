...
updated_at: "2025-08-03 04:09:02.946873"
latest: "0.6.6--h719ac0c_0"
...
```bash
$ shpc install quay.io/biocontainers/usher:0.6.6--h719ac0c_0
```
...
```bash
$ module load quay.io/biocontainers/usher/0.6.6--h719ac0c_0
$ module help quay.io/biocontainers/usher/0.6.6--h719ac0c_0
```
