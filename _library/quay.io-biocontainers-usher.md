...
updated_at: "2024-12-04 03:18:38.485794"
latest: "0.6.3--hb389108_1"
...
```bash
$ shpc install quay.io/biocontainers/usher:0.6.3--hb389108_1
```
...
```bash
$ module load quay.io/biocontainers/usher/0.6.3--hb389108_1
$ module help quay.io/biocontainers/usher/0.6.3--hb389108_1
```
