...
updated_at: "2025-06-30 05:03:10.551820"
latest: "0.6.4--h719ac0c_0"
...
```bash
$ shpc install quay.io/biocontainers/usher:0.6.4--h719ac0c_0
```
...
```bash
$ module load quay.io/biocontainers/usher/0.6.4--h719ac0c_0
$ module help quay.io/biocontainers/usher/0.6.4--h719ac0c_0
```
