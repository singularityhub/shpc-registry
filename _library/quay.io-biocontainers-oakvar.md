...
updated_at: "2024-12-07 03:39:51.716422"
latest: "2.12.2--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/oakvar:2.12.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/oakvar/2.12.2--pyhdfd78af_0
$ module help quay.io/biocontainers/oakvar/2.12.2--pyhdfd78af_0
```
