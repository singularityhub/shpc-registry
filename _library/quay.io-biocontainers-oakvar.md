...
updated_at: "2025-02-24 03:21:38.336385"
latest: "2.12.9--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/oakvar:2.12.9--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/oakvar/2.12.9--pyhdfd78af_0
$ module help quay.io/biocontainers/oakvar/2.12.9--pyhdfd78af_0
```
