...
updated_at: "2024-07-02 02:41:01.790367"
...
```bash
$ shpc install quay.io/biocontainers/oakvar:2.10.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/oakvar/2.10.2--pyhdfd78af_0
$ module help quay.io/biocontainers/oakvar/2.10.2--pyhdfd78af_0
```
