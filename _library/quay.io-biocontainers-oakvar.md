...
updated_at: "2024-03-05 02:24:02.389610"
latest: "2.9.87--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/oakvar:2.9.87--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/oakvar/2.9.87--pyhdfd78af_0
$ module help quay.io/biocontainers/oakvar/2.9.87--pyhdfd78af_0
```
