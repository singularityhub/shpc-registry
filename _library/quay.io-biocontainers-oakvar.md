...
updated_at: "2024-01-28 04:10:18.456695"
latest: "2.9.83--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/oakvar:2.9.83--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/oakvar/2.9.83--pyhdfd78af_0
$ module help quay.io/biocontainers/oakvar/2.9.83--pyhdfd78af_0
```
