...
updated_at: "2024-05-27 03:36:04.980186"
latest: "2.9.123--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/oakvar:2.9.123--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/oakvar/2.9.123--pyhdfd78af_0
$ module help quay.io/biocontainers/oakvar/2.9.123--pyhdfd78af_0
```
