...
updated_at: "2026-01-19 04:30:42.853442"
latest: "2.12.22--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/oakvar:2.12.22--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/oakvar/2.12.22--pyhdfd78af_0
$ module help quay.io/biocontainers/oakvar/2.12.22--pyhdfd78af_0
```
