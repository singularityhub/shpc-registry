...
updated_at: "2025-02-02 03:18:39.199456"
latest: "2.12.4--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/oakvar:2.12.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/oakvar/2.12.4--pyhdfd78af_0
$ module help quay.io/biocontainers/oakvar/2.12.4--pyhdfd78af_0
```
