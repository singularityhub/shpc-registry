...
updated_at: "2023-04-09 02:35:32.465039"
latest: "2.8.40--pyh7cba7a3_0"
...
```bash
$ shpc install quay.io/biocontainers/oakvar:2.8.40--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/oakvar/2.8.40--pyh7cba7a3_0
$ module help quay.io/biocontainers/oakvar/2.8.40--pyh7cba7a3_0
```
