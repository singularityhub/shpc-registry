...
updated_at: "2023-11-02 02:32:49.965041"
latest: "2.9.51--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/oakvar:2.9.51--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/oakvar/2.9.51--pyhdfd78af_0
$ module help quay.io/biocontainers/oakvar/2.9.51--pyhdfd78af_0
```
