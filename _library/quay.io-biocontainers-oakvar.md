...
updated_at: "2026-09-19 07:42:21.723026"
...
```bash
$ shpc install quay.io/biocontainers/oakvar:2.13.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/oakvar/2.13.1--pyhdfd78af_0
$ module help quay.io/biocontainers/oakvar/2.13.1--pyhdfd78af_0
```
