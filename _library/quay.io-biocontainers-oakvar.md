...
updated_at: "2026-05-06 06:12:24.589004"
latest: "2.13.0--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/oakvar:2.13.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/oakvar/2.13.0--pyhdfd78af_0
$ module help quay.io/biocontainers/oakvar/2.13.0--pyhdfd78af_0
```
