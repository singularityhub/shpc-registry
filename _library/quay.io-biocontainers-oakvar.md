...
updated_at: "2023-12-09 03:17:59.732541"
latest: "2.9.58--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/oakvar:2.9.58--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/oakvar/2.9.58--pyhdfd78af_0
$ module help quay.io/biocontainers/oakvar/2.9.58--pyhdfd78af_0
```
