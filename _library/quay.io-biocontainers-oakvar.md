...
updated_at: "2023-12-30 04:29:24.268564"
latest: "2.9.78--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/oakvar:2.9.78--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/oakvar/2.9.78--pyhdfd78af_0
$ module help quay.io/biocontainers/oakvar/2.9.78--pyhdfd78af_0
```
