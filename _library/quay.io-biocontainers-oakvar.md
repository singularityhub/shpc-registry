---
layout: container
name:  "quay.io/biocontainers/oakvar"
maintainer: "@vsoch"
...
updated_at: "2026-02-27 04:26:38.338244"
latest: "2.12.25--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/oakvar
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/oakvar:2.12.25--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/oakvar/2.12.25--pyhdfd78af_0
$ module help quay.io/biocontainers/oakvar/2.12.25--pyhdfd78af_0
```
...
#### oakvar-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### oakvar-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/ov
$ podman run --it --rm --entrypoint /usr/local/bin/ov   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/ov   -v ${PWD} -w ${PWD} <container> -c " $@"
```
