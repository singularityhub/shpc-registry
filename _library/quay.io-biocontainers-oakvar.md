...
updated_at: "2024-10-06 03:09:43.072331"
latest: "2.11.9--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/oakvar:2.11.9--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/oakvar/2.11.9--pyhdfd78af_0
$ module help quay.io/biocontainers/oakvar/2.11.9--pyhdfd78af_0
```
