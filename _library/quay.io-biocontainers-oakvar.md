...
updated_at: "2024-09-01 03:35:55.463954"
latest: "2.11.3--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/oakvar:2.11.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/oakvar/2.11.3--pyhdfd78af_0
$ module help quay.io/biocontainers/oakvar/2.11.3--pyhdfd78af_0
```
