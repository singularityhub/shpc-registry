...
updated_at: "2025-03-30 03:11:47.793428"
latest: "2.12.10--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/oakvar:2.12.10--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/oakvar/2.12.10--pyhdfd78af_0
$ module help quay.io/biocontainers/oakvar/2.12.10--pyhdfd78af_0
```
