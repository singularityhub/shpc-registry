...
updated_at: "2025-05-27 12:00:54.151568"
latest: "2.12.18--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/oakvar:2.12.18--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/oakvar/2.12.18--pyhdfd78af_0
$ module help quay.io/biocontainers/oakvar/2.12.18--pyhdfd78af_0
```
