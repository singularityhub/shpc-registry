...
updated_at: "2026-04-03 05:22:12.151627"
latest: "2.54.0--r45h63f16b7_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-geneselectmmd:2.54.0--r45h63f16b7_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-geneselectmmd/2.54.0--r45h63f16b7_0
$ module help quay.io/biocontainers/bioconductor-geneselectmmd/2.54.0--r45h63f16b7_0
```
