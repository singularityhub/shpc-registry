...
updated_at: "2023-06-12 04:36:33.210104"
latest: "0.10.3--hea8008d_2"
...
```bash
$ shpc install quay.io/biocontainers/wfmash:0.10.3--hea8008d_2
```
...
```bash
$ module load quay.io/biocontainers/wfmash/0.10.3--hea8008d_2
$ module help quay.io/biocontainers/wfmash/0.10.3--hea8008d_2
```
