...
updated_at: "2026-08-20 03:07:23.478711"
latest: "2.1.13--py38hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/crisprme:2.1.13--py38hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/crisprme/2.1.13--py38hdfd78af_0
$ module help quay.io/biocontainers/crisprme/2.1.13--py38hdfd78af_0
```
