...
updated_at: "2025-03-19 03:04:01.841862"
...
```bash
$ shpc install quay.io/biocontainers/crisprme:2.1.7--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/crisprme/2.1.7--hdfd78af_0
$ module help quay.io/biocontainers/crisprme/2.1.7--hdfd78af_0
```
