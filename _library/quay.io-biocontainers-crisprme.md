...
updated_at: "2026-06-21 06:58:40.261421"
latest: "2.1.10--py38hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/crisprme:2.1.10--py38hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/crisprme/2.1.10--py38hdfd78af_0
$ module help quay.io/biocontainers/crisprme/2.1.10--py38hdfd78af_0
```
