...
updated_at: "2026-08-09 04:07:34.737544"
latest: "2.1.11--py38hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/crisprme:2.1.11--py38hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/crisprme/2.1.11--py38hdfd78af_0
$ module help quay.io/biocontainers/crisprme/2.1.11--py38hdfd78af_0
```
