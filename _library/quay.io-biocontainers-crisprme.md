...
updated_at: "2026-09-20 08:07:13.012613"
latest: "2.1.14--py38hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/crisprme:2.1.14--py38hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/crisprme/2.1.14--py38hdfd78af_0
$ module help quay.io/biocontainers/crisprme/2.1.14--py38hdfd78af_0
```
