...
updated_at: "2026-02-16 05:17:23.172307"
latest: "2.1.9--py38hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/crisprme:2.1.9--py38hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/crisprme/2.1.9--py38hdfd78af_0
$ module help quay.io/biocontainers/crisprme/2.1.9--py38hdfd78af_0
```
