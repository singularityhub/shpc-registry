...
updated_at: "2025-02-12 03:21:11.534387"
latest: "2.1.6--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/crisprme:2.1.6--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/crisprme/2.1.6--hdfd78af_0
$ module help quay.io/biocontainers/crisprme/2.1.6--hdfd78af_0
```
