...
updated_at: "2024-08-22 03:20:52.399617"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-igvr:1.22.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-igvr/1.22.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-igvr/1.22.0--r43hdfd78af_0
```
