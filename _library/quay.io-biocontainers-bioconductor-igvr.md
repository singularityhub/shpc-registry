...
updated_at: "2026-04-02 04:50:37.181188"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-igvr:1.30.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-igvr/1.30.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-igvr/1.30.0--r45hdfd78af_0
```
