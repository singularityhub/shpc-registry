...
updated_at: "2025-11-29 02:43:19.675426"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-igvr:1.26.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-igvr/1.26.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-igvr/1.26.0--r44hdfd78af_0
```
