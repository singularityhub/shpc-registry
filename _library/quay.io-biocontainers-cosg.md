---
layout: container
name:  "quay.io/biocontainers/cosg"
maintainer: "@vsoch"
...
updated_at: "2026-09-04 07:13:57.355447"
...
```bash
$ shpc install quay.io/biocontainers/cosg
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/cosg:1.1.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/cosg/1.1.3--pyhdfd78af_0
$ module help quay.io/biocontainers/cosg/1.1.3--pyhdfd78af_0
```
...
#### cosg-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### cosg-inspect-deffile:
