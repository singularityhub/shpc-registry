...
updated_at: "2024-06-19 02:49:47.975637"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-sarc:1.0.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-sarc/1.0.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-sarc/1.0.0--r43hdfd78af_0
```
