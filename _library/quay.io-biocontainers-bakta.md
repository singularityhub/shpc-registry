...
updated_at: "2025-02-12 03:21:35.873220"
latest: "1.10.3--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/bakta:1.10.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bakta/1.10.3--pyhdfd78af_0
$ module help quay.io/biocontainers/bakta/1.10.3--pyhdfd78af_0
```
