...
updated_at: "2024-12-13 03:45:48.581076"
...
```bash
$ shpc install quay.io/biocontainers/bakta:1.10.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bakta/1.10.1--pyhdfd78af_0
$ module help quay.io/biocontainers/bakta/1.10.1--pyhdfd78af_0
```
