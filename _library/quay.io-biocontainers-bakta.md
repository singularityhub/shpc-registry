...
updated_at: "2025-09-16 04:38:58.850398"
latest: "1.11.3--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/bakta:1.11.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bakta/1.11.3--pyhdfd78af_0
$ module help quay.io/biocontainers/bakta/1.11.3--pyhdfd78af_0
```
