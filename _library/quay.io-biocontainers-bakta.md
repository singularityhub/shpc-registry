...
updated_at: "2026-08-24 03:42:02.813772"
...
```bash
$ shpc install quay.io/biocontainers/bakta:1.12.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bakta/1.12.1--pyhdfd78af_0
$ module help quay.io/biocontainers/bakta/1.12.1--pyhdfd78af_0
```
