...
updated_at: "2025-04-05 03:01:06.659259"
...
```bash
$ shpc install quay.io/biocontainers/bakta:1.11.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bakta/1.11.0--pyhdfd78af_0
$ module help quay.io/biocontainers/bakta/1.11.0--pyhdfd78af_0
```
