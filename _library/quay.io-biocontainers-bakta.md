...
updated_at: "2026-01-17 04:10:18.385170"
latest: "1.11.4--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/bakta:1.11.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bakta/1.11.4--pyhdfd78af_0
$ module help quay.io/biocontainers/bakta/1.11.4--pyhdfd78af_0
```
