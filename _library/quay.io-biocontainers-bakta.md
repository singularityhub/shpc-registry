...
updated_at: "2023-11-08 02:25:57.731898"
latest: "1.8.2--pyhdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/bakta:1.8.2--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/bakta/1.8.2--pyhdfd78af_1
$ module help quay.io/biocontainers/bakta/1.8.2--pyhdfd78af_1
```
