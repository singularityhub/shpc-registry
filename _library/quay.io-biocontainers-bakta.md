...
updated_at: "2026-03-01 05:07:27.695309"
...
```bash
$ shpc install quay.io/biocontainers/bakta:1.12.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bakta/1.12.0--pyhdfd78af_0
$ module help quay.io/biocontainers/bakta/1.12.0--pyhdfd78af_0
```
