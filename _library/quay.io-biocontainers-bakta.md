...
updated_at: "2025-02-27 02:56:38.574214"
latest: "1.10.4--pyhdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/bakta:1.10.4--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/bakta/1.10.4--pyhdfd78af_1
$ module help quay.io/biocontainers/bakta/1.10.4--pyhdfd78af_1
```
