...
updated_at: "2026-01-31 04:22:02.733408"
...
```bash
$ shpc install quay.io/biocontainers/ephemeris:0.10.11--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ephemeris/0.10.11--pyhdfd78af_0
$ module help quay.io/biocontainers/ephemeris/0.10.11--pyhdfd78af_0
```
