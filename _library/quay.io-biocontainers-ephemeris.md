...
updated_at: "2024-02-19 02:59:07.483371"
...
```bash
$ shpc install quay.io/biocontainers/ephemeris:0.10.10--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ephemeris/0.10.10--pyhdfd78af_0
$ module help quay.io/biocontainers/ephemeris/0.10.10--pyhdfd78af_0
```
