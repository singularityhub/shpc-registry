---
layout: container
name:  "quay.io/biocontainers/riboseqc"
maintainer: "@vsoch"
...
updated_at: "2024-03-21 02:28:12.003635"
latest: "1.1--r36_1"
...
```bash
$ shpc install quay.io/biocontainers/riboseqc
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/riboseqc:1.1--r36_1
```
...
```bash
$ module load quay.io/biocontainers/riboseqc/1.1--r36_1
$ module help quay.io/biocontainers/riboseqc/1.1--r36_1
```
...
#### riboseqc-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### riboseqc-inspect-deffile:
