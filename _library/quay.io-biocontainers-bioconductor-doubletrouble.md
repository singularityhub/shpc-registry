...
updated_at: "2025-03-28 03:16:14.108948"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-doubletrouble:1.6.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-doubletrouble/1.6.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-doubletrouble/1.6.0--r44hdfd78af_0
```
