...
updated_at: "2023-12-02 03:01:08.572093"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-doubletrouble:1.0.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-doubletrouble/1.0.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-doubletrouble/1.0.0--r43hdfd78af_0
```
