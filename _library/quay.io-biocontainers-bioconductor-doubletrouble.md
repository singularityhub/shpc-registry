...
updated_at: "2024-03-25 03:00:14.044151"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-doubletrouble:1.2.1--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-doubletrouble/1.2.1--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-doubletrouble/1.2.1--r43hdfd78af_0
```
