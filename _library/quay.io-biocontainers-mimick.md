...
updated_at: "2025-06-20 06:11:25.859564"
...
```bash
$ shpc install quay.io/biocontainers/mimick:2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mimick/2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/mimick/2.0--pyhdfd78af_0
```
