...
updated_at: "2026-06-22 02:23:57.087646"
latest: "3.1--pyh106432d_0"
...
```bash
$ shpc install quay.io/biocontainers/mimick:3.1--pyh106432d_0
```
...
```bash
$ module load quay.io/biocontainers/mimick/3.1--pyh106432d_0
$ module help quay.io/biocontainers/mimick/3.1--pyh106432d_0
```
