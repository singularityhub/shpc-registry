...
updated_at: "2026-05-23 05:47:05.702796"
latest: "3.0.4--pyh106432d_0"
...
```bash
$ shpc install quay.io/biocontainers/mimick:3.0.4--pyh106432d_0
```
...
```bash
$ module load quay.io/biocontainers/mimick/3.0.4--pyh106432d_0
$ module help quay.io/biocontainers/mimick/3.0.4--pyh106432d_0
```
