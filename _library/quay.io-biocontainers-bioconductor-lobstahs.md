...
updated_at: "2023-11-23 02:33:22.229039"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-lobstahs:1.26.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-lobstahs/1.26.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-lobstahs/1.26.0--r43hdfd78af_0
```
