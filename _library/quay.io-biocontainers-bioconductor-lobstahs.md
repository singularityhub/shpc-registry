...
updated_at: "2024-07-04 04:25:52.101198"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-lobstahs:1.28.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-lobstahs/1.28.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-lobstahs/1.28.0--r43hdfd78af_0
```
