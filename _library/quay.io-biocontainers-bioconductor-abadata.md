...
updated_at: "2022-10-29 07:50:10.720548"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-abadata:1.8.0--r3.4.1_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-abadata/1.8.0--r3.4.1_0
$ module help quay.io/biocontainers/bioconductor-abadata/1.8.0--r3.4.1_0
```
