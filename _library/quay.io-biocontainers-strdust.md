...
updated_at: "2026-03-10 04:38:12.172413"
latest: "0.16.0--hcdda2d0_0"
...
```bash
$ shpc install quay.io/biocontainers/strdust:0.16.0--hcdda2d0_0
```
...
```bash
$ module load quay.io/biocontainers/strdust/0.16.0--hcdda2d0_0
$ module help quay.io/biocontainers/strdust/0.16.0--hcdda2d0_0
```
