...
updated_at: "2025-08-09 04:00:30.987513"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cosia:1.6.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cosia/1.6.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-cosia/1.6.0--r44hdfd78af_0
```
