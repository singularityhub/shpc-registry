...
updated_at: "2024-08-19 03:18:43.907891"
...
```bash
$ shpc install quay.io/biocontainers/efishent:0.0.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/efishent/0.0.5--pyhdfd78af_0
$ module help quay.io/biocontainers/efishent/0.0.5--pyhdfd78af_0
```
