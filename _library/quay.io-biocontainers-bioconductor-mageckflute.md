...
updated_at: "2024-04-10 02:45:20.170398"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mageckflute:2.6.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mageckflute/2.6.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-mageckflute/2.6.0--r43hdfd78af_0
```
