...
updated_at: "2025-09-11 03:44:34.474950"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mageckflute:2.9.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mageckflute/2.9.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-mageckflute/2.9.0--r44hdfd78af_0
```
