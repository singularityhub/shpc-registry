...
updated_at: "2025-05-01 07:14:44.885411"
...
```bash
$ shpc install quay.io/biocontainers/dbcan:5.0.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/dbcan/5.0.4--pyhdfd78af_0
$ module help quay.io/biocontainers/dbcan/5.0.4--pyhdfd78af_0
```
