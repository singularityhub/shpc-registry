...
updated_at: "2024-02-16 02:45:45.056730"
...
```bash
$ shpc install quay.io/biocontainers/dbcan:4.1.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/dbcan/4.1.3--pyhdfd78af_0
$ module help quay.io/biocontainers/dbcan/4.1.3--pyhdfd78af_0
```
