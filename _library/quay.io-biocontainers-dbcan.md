...
updated_at: "2025-08-20 03:33:12.738829"
latest: "5.1.2--pyhdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/dbcan:5.1.2--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/dbcan/5.1.2--pyhdfd78af_1
$ module help quay.io/biocontainers/dbcan/5.1.2--pyhdfd78af_1
```
