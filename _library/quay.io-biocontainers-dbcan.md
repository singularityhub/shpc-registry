...
updated_at: "2026-02-22 04:50:28.470600"
latest: "5.2.8--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/dbcan:5.2.8--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/dbcan/5.2.8--pyhdfd78af_0
$ module help quay.io/biocontainers/dbcan/5.2.8--pyhdfd78af_0
```
