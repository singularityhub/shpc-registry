...
updated_at: "2025-08-15 03:47:13.853889"
...
```bash
$ shpc install quay.io/biocontainers/dbcan:5.1.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/dbcan/5.1.2--pyhdfd78af_0
$ module help quay.io/biocontainers/dbcan/5.1.2--pyhdfd78af_0
```
