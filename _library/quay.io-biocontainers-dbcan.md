...
updated_at: "2023-12-10 02:39:06.963204"
latest: "4.0.0--pyh7cba7a3_0"
...
```bash
$ shpc install quay.io/biocontainers/dbcan:4.0.0--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/dbcan/4.0.0--pyh7cba7a3_0
$ module help quay.io/biocontainers/dbcan/4.0.0--pyh7cba7a3_0
```
