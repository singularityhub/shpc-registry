...
updated_at: "2025-05-24 11:53:21.992098"
...
```bash
$ shpc install quay.io/biocontainers/dbcan:5.0.6--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/dbcan/5.0.6--pyhdfd78af_0
$ module help quay.io/biocontainers/dbcan/5.0.6--pyhdfd78af_0
```
