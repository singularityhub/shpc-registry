...
updated_at: "2026-06-23 16:27:26.923105"
latest: "5.2.9--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/dbcan:5.2.9--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/dbcan/5.2.9--pyhdfd78af_0
$ module help quay.io/biocontainers/dbcan/5.2.9--pyhdfd78af_0
```
