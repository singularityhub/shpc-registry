...
updated_at: "2024-04-29 02:49:08.880981"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-decontx:1.0.0--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-decontx/1.0.0--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-decontx/1.0.0--r43hf17093f_0
```
