...
updated_at: "2025-11-13 04:02:40.652017"
latest: "1.5.0--h4d20210_0"
...
```bash
$ shpc install quay.io/biocontainers/delly:1.5.0--h4d20210_0
```
...
```bash
$ module load quay.io/biocontainers/delly/1.5.0--h4d20210_0
$ module help quay.io/biocontainers/delly/1.5.0--h4d20210_0
```
