...
updated_at: "2025-02-09 03:15:10.011632"
latest: "1.3.3--h4d20210_0"
...
```bash
$ shpc install quay.io/biocontainers/delly:1.3.3--h4d20210_0
```
...
```bash
$ module load quay.io/biocontainers/delly/1.3.3--h4d20210_0
$ module help quay.io/biocontainers/delly/1.3.3--h4d20210_0
```
