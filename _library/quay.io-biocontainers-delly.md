...
updated_at: "2024-10-17 03:18:40.242030"
latest: "1.2.9--hf9970c3_0"
...
```bash
$ shpc install quay.io/biocontainers/delly:1.2.9--hf9970c3_0
```
...
```bash
$ module load quay.io/biocontainers/delly/1.2.9--hf9970c3_0
$ module help quay.io/biocontainers/delly/1.2.9--hf9970c3_0
```
