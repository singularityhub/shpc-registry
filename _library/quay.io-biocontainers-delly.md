...
updated_at: "2026-04-05 04:44:07.511281"
latest: "1.7.3--hd6466ae_0"
...
```bash
$ shpc install quay.io/biocontainers/delly:1.7.3--hd6466ae_0
```
...
```bash
$ module load quay.io/biocontainers/delly/1.7.3--hd6466ae_0
$ module help quay.io/biocontainers/delly/1.7.3--hd6466ae_0
```
