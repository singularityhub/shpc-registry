...
updated_at: "2024-01-28 03:47:24.888113"
latest: "1.2.6--hb7e2ac5_0"
...
```bash
$ shpc install quay.io/biocontainers/delly:1.2.6--hb7e2ac5_0
```
...
```bash
$ module load quay.io/biocontainers/delly/1.2.6--hb7e2ac5_0
$ module help quay.io/biocontainers/delly/1.2.6--hb7e2ac5_0
```
