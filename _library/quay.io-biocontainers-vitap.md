...
updated_at: "2026-06-30 06:24:56.333657"
...
```bash
$ shpc install quay.io/biocontainers/vitap:1.12--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/vitap/1.12--pyhdfd78af_0
$ module help quay.io/biocontainers/vitap/1.12--pyhdfd78af_0
```
