---
layout: container
name:  "quay.io/biocontainers/bioconductor-smokingmouse"
maintainer: "@vsoch"
...
updated_at: "2026-03-28 17:04:50.255175"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-smokingmouse
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-smokingmouse:1.8.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-smokingmouse/1.8.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-smokingmouse/1.8.0--r45hdfd78af_0
```
...
#### bioconductor-smokingmouse-shell:
...
#### bioconductor-smokingmouse-exec:
...
#### bioconductor-smokingmouse-inspect:
...
#### bioconductor-smokingmouse-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-smokingmouse-inspect-deffile:
