...
updated_at: "2026-08-09 04:06:45.215705"
latest: "0.16.32--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/amalgkit:0.16.32--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/amalgkit/0.16.32--pyhdfd78af_0
$ module help quay.io/biocontainers/amalgkit/0.16.32--pyhdfd78af_0
```
