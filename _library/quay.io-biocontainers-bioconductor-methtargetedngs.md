...
updated_at: "2023-10-10 02:51:09.193352"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-methtargetedngs:1.32.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-methtargetedngs/1.32.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-methtargetedngs/1.32.0--r43hdfd78af_0
```
