...
updated_at: "2026-03-29 04:51:37.940457"
latest: "0.0.2--r45hdfd78af_14"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-huexexonprobesetlocationhg18:0.0.2--r45hdfd78af_14
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-huexexonprobesetlocationhg18/0.0.2--r45hdfd78af_14
$ module help quay.io/biocontainers/bioconductor-huexexonprobesetlocationhg18/0.0.2--r45hdfd78af_14
```
