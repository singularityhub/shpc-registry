...
updated_at: "2026-04-04 04:31:48.246390"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-vulcan:1.32.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-vulcan/1.32.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-vulcan/1.32.0--r45hdfd78af_0
```
