...
updated_at: "2025-04-29 03:11:04.875471"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-vulcan:1.28.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-vulcan/1.28.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-vulcan/1.28.0--r44hdfd78af_0
```
