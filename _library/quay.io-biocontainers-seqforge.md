---
layout: container
name:  "quay.io/biocontainers/seqforge"
maintainer: "@vsoch"
...
updated_at: "2026-01-04 04:00:21.335275"
...
singularity registry hpc automated addition for seqforge
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/seqforge
```
...
#### seqforge-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### seqforge-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/seqforge
$ podman run --it --rm --entrypoint /usr/local/bin/seqforge   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/seqforge   -v ${PWD} -w ${PWD} <container> -c " $@"
```
