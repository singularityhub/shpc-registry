...
updated_at: "2024-04-08 03:03:04.455431"
latest: "1.0--py310hc8d811f_0"
...
```bash
$ shpc install quay.io/biocontainers/sneep:1.0--py310hc8d811f_0
```
...
```bash
$ module load quay.io/biocontainers/sneep/1.0--py310hc8d811f_0
$ module help quay.io/biocontainers/sneep/1.0--py310hc8d811f_0
```
