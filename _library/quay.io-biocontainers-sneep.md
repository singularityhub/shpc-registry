...
updated_at: "2024-01-26 02:44:05.571490"
latest: "0.8--py39h7cff6ad_0"
...
```bash
$ shpc install quay.io/biocontainers/sneep:0.8--py39h7cff6ad_0
```
...
```bash
$ module load quay.io/biocontainers/sneep/0.8--py39h7cff6ad_0
$ module help quay.io/biocontainers/sneep/0.8--py39h7cff6ad_0
```
