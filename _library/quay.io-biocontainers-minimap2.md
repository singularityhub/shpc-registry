...
updated_at: "2022-11-04 00:38:14.439383"
latest: "2.9--1"
...
```bash
$ shpc install quay.io/biocontainers/minimap2:2.9--1
```
...
```bash
$ module load quay.io/biocontainers/minimap2/2.9--1
$ module help quay.io/biocontainers/minimap2/2.9--1
```
