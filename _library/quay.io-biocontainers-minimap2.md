...
updated_at: "2025-05-21 03:56:49.464664"
latest: "2.29--h577a1d6_0"
...
```bash
$ shpc install quay.io/biocontainers/minimap2:2.29--h577a1d6_0
```
...
```bash
$ module load quay.io/biocontainers/minimap2/2.29--h577a1d6_0
$ module help quay.io/biocontainers/minimap2/2.29--h577a1d6_0
```
