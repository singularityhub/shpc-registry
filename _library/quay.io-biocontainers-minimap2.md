...
updated_at: "2026-07-01 15:43:46.655076"
latest: "2.31--h118bc1c_0"
...
```bash
$ shpc install quay.io/biocontainers/minimap2:2.31--h118bc1c_0
```
...
```bash
$ module load quay.io/biocontainers/minimap2/2.31--h118bc1c_0
$ module help quay.io/biocontainers/minimap2/2.31--h118bc1c_0
```
