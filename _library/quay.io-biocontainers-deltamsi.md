---
layout: container
name:  "quay.io/biocontainers/deltamsi"
maintainer: "@vsoch"
...
updated_at: "2025-08-08 04:02:55.678777"
...
versions:
 - "1.0.1--pyh7cba7a3_0"
description: "singularity registry hpc automated addition for deltamsi"
config: {"url": "https://biocontainers.pro/tools/deltamsi", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for deltamsi", "latest": {"1.0.1--pyh7cba7a3_0": "sha256:23f80a7a139ba23d521bc446afb55e595b9ca2c503bc413e80dfd0f2cdde687d"}, "tags": {"1.0.1--pyh7cba7a3_0": "sha256:23f80a7a139ba23d521bc446afb55e595b9ca2c503bc413e80dfd0f2cdde687d"}, "docker": "quay.io/biocontainers/deltamsi", "aliases": {"DeltaMSI": "/usr/local/bin/DeltaMSI", "tqdm": "/usr/local/bin/tqdm", "fonttools": "/usr/local/bin/fonttools", "pyftmerge": "/usr/local/bin/pyftmerge", "pyftsubset": "/usr/local/bin/pyftsubset", "ttx": "/usr/local/bin/ttx", "brotli": "/usr/local/bin/brotli", "normalizer": "/usr/local/bin/normalizer", "f2py3.10": "/usr/local/bin/f2py3.10", "opj_compress": "/usr/local/bin/opj_compress", "opj_decompress": "/usr/local/bin/opj_decompress", "opj_dump": "/usr/local/bin/opj_dump", "2to3-3.10": "/usr/local/bin/2to3-3.10", "idle3.10": "/usr/local/bin/idle3.10", "pydoc3.10": "/usr/local/bin/pydoc3.10", "python3.10": "/usr/local/bin/python3.10", "python3.10-config": "/usr/local/bin/python3.10-config", "python3.1": "/usr/local/bin/python3.1", "jpgicc": "/usr/local/bin/jpgicc", "linkicc": "/usr/local/bin/linkicc", "psicc": "/usr/local/bin/psicc", "tificc": "/usr/local/bin/tificc", "transicc": "/usr/local/bin/transicc"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/deltamsi.
singularity registry hpc automated addition for deltamsi
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/deltamsi
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/deltamsi:1.0.1--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/deltamsi/1.0.1--pyh7cba7a3_0
$ module help quay.io/biocontainers/deltamsi/1.0.1--pyh7cba7a3_0
```
...
#### deltamsi-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### deltamsi-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/DeltaMSI
$ podman run --it --rm --entrypoint /usr/local/bin/DeltaMSI   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/DeltaMSI   -v ${PWD} -w ${PWD} <container> -c " $@"
```
