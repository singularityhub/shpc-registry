...
updated_at: "2026-06-04 07:23:32.293997"
...
```bash
$ shpc install quay.io/biocontainers/grz-db:2.1.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/grz-db/2.1.1--pyhdfd78af_0
$ module help quay.io/biocontainers/grz-db/2.1.1--pyhdfd78af_0
```
