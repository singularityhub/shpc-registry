...
updated_at: "2026-02-03 05:09:48.835977"
...
```bash
$ shpc install quay.io/biocontainers/grz-db:1.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/grz-db/1.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/grz-db/1.2.0--pyhdfd78af_0
```
