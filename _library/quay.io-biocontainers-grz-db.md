...
updated_at: "2025-11-06 04:36:29.176038"
...
```bash
$ shpc install quay.io/biocontainers/grz-db:1.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/grz-db/1.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/grz-db/1.1.0--pyhdfd78af_0
```
