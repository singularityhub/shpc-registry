...
updated_at: "2025-10-13 04:00:32.856734"
...
```bash
$ shpc install quay.io/biocontainers/grz-db:0.6.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/grz-db/0.6.0--pyhdfd78af_0
$ module help quay.io/biocontainers/grz-db/0.6.0--pyhdfd78af_0
```
