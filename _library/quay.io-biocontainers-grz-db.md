...
updated_at: "2026-07-02 06:49:14.941375"
latest: "2.1.2--pyhdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/grz-db:2.1.2--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/grz-db/2.1.2--pyhdfd78af_1
$ module help quay.io/biocontainers/grz-db/2.1.2--pyhdfd78af_1
```
