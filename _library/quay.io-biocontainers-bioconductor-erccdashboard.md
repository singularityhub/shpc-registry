...
updated_at: "2023-10-22 02:34:43.517610"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-erccdashboard:1.34.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-erccdashboard/1.34.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-erccdashboard/1.34.0--r43hdfd78af_0
```
