...
updated_at: "2023-03-31 03:11:50.486745"
...
```bash
$ shpc install quay.io/biocontainers/ms2pip:3.11.0--py39h5371cbf_0
```
...
```bash
$ module load quay.io/biocontainers/ms2pip/3.11.0--py39h5371cbf_0
$ module help quay.io/biocontainers/ms2pip/3.11.0--py39h5371cbf_0
```
