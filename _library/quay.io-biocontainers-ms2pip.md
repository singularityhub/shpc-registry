...
updated_at: "2026-07-25 05:24:52.411994"
latest: "4.2.0--py311hc303176_0"
...
```bash
$ shpc install quay.io/biocontainers/ms2pip:4.2.0--py311hc303176_0
```
...
```bash
$ module load quay.io/biocontainers/ms2pip/4.2.0--py311hc303176_0
$ module help quay.io/biocontainers/ms2pip/4.2.0--py311hc303176_0
```
