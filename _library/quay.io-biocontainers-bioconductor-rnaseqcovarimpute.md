---
layout: container
name:  "quay.io/biocontainers/bioconductor-rnaseqcovarimpute"
maintainer: "@vsoch"
...
updated_at: "2024-09-29 03:28:04.727582"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rnaseqcovarimpute
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-rnaseqcovarimpute:1.0.2--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rnaseqcovarimpute/1.0.2--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rnaseqcovarimpute/1.0.2--r43hdfd78af_0
```
...
#### bioconductor-rnaseqcovarimpute-run:
...
#### bioconductor-rnaseqcovarimpute-shell:
...
#### bioconductor-rnaseqcovarimpute-exec:
...
#### bioconductor-rnaseqcovarimpute-inspect:
...
#### bioconductor-rnaseqcovarimpute-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-rnaseqcovarimpute-inspect-deffile:
