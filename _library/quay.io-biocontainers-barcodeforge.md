...
updated_at: "2026-04-01 05:02:21.253652"
...
```bash
$ shpc install quay.io/biocontainers/barcodeforge:1.1.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/barcodeforge/1.1.5--pyhdfd78af_0
$ module help quay.io/biocontainers/barcodeforge/1.1.5--pyhdfd78af_0
```
