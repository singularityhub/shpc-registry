...
updated_at: "2025-06-18 03:41:53.003218"
...
```bash
$ shpc install quay.io/biocontainers/barcodeforge:1.0.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/barcodeforge/1.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/barcodeforge/1.0.0--pyhdfd78af_0
```
