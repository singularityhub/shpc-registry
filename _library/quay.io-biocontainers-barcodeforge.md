...
updated_at: "2026-06-27 06:18:09.670643"
...
```bash
$ shpc install quay.io/biocontainers/barcodeforge:1.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/barcodeforge/1.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/barcodeforge/1.2.0--pyhdfd78af_0
```
