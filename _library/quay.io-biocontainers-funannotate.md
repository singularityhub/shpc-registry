...
updated_at: "2022-11-04 00:06:32.378754"
...
```bash
$ shpc install quay.io/biocontainers/funannotate:1.8.9--pyhdfd78af_3
```
...
```bash
$ module load quay.io/biocontainers/funannotate/1.8.9--pyhdfd78af_3
$ module help quay.io/biocontainers/funannotate/1.8.9--pyhdfd78af_3
```
