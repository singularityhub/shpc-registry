...
updated_at: "2024-11-25 03:27:13.522670"
...
```bash
$ shpc install quay.io/biocontainers/handyreadgenotyper:0.1.24--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/handyreadgenotyper/0.1.24--pyhdfd78af_0
$ module help quay.io/biocontainers/handyreadgenotyper/0.1.24--pyhdfd78af_0
```
