...
updated_at: "2025-09-18 03:34:03.271230"
latest: "1.6.2--haf24da9_0"
...
```bash
$ shpc install quay.io/biocontainers/matam:1.6.2--haf24da9_0
```
...
```bash
$ module load quay.io/biocontainers/matam/1.6.2--haf24da9_0
$ module help quay.io/biocontainers/matam/1.6.2--haf24da9_0
```
