...
updated_at: "2025-08-09 03:23:21.481071"
...
```bash
$ shpc install quay.io/biocontainers/matam:1.6.1--h077b44d_2
```
...
```bash
$ module load quay.io/biocontainers/matam/1.6.1--h077b44d_2
$ module help quay.io/biocontainers/matam/1.6.1--h077b44d_2
```
