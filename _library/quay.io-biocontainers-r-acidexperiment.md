...
updated_at: "2023-12-09 02:50:40.892509"
...
```bash
$ shpc install quay.io/biocontainers/r-acidexperiment:0.5.3--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/r-acidexperiment/0.5.3--r43hdfd78af_0
$ module help quay.io/biocontainers/r-acidexperiment/0.5.3--r43hdfd78af_0
```
