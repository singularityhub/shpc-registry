...
updated_at: "2023-05-15 02:51:44.253255"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-badregionfinder:1.26.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-badregionfinder/1.26.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-badregionfinder/1.26.0--r42hdfd78af_0
```
