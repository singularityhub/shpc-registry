...
updated_at: "2026-08-16 03:40:05.512870"
latest: "0.26--h3be2455_0"
...
```bash
$ shpc install quay.io/biocontainers/canopy:0.26--h3be2455_0
```
...
```bash
$ module load quay.io/biocontainers/canopy/0.26--h3be2455_0
$ module help quay.io/biocontainers/canopy/0.26--h3be2455_0
```
