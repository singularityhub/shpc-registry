...
updated_at: "2025-08-01 11:08:09.693693"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-metagxbreast:1.26.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-metagxbreast/1.26.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-metagxbreast/1.26.0--r44hdfd78af_0
```
