...
updated_at: "2026-03-19 04:48:51.122202"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-metagxbreast:1.30.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-metagxbreast/1.30.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-metagxbreast/1.30.0--r45hdfd78af_0
```
