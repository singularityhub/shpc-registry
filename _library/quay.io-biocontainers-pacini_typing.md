...
updated_at: "2026-03-30 05:58:12.589678"
...
```bash
$ shpc install quay.io/biocontainers/pacini_typing:3.0.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pacini_typing/3.0.1--pyhdfd78af_0
$ module help quay.io/biocontainers/pacini_typing/3.0.1--pyhdfd78af_0
```
