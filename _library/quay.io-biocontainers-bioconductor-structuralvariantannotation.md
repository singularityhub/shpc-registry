...
updated_at: "2026-01-18 04:19:57.534071"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-structuralvariantannotation:1.22.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-structuralvariantannotation/1.22.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-structuralvariantannotation/1.22.0--r44hdfd78af_0
```
