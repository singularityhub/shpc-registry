---
layout: container
name:  "quay.io/biocontainers/philosopher"
maintainer: "@vsoch"
...
updated_at: "2025-12-16 03:56:36.921499"
...
singularity registry hpc automated addition for philosopher
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/philosopher
```
...
#### philosopher-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### philosopher-inspect-deffile:
