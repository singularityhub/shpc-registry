---
layout: container
name:  "quay.io/biocontainers/r-mutsigextractor"
maintainer: "@vsoch"
...
updated_at: "2024-07-28 03:22:13.856925"
...
```bash
$ shpc install quay.io/biocontainers/r-mutsigextractor
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/r-mutsigextractor:1.28--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/r-mutsigextractor/1.28--r43hdfd78af_0
$ module help quay.io/biocontainers/r-mutsigextractor/1.28--r43hdfd78af_0
```
...
#### r-mutsigextractor-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-mutsigextractor-inspect-deffile:
