...
updated_at: "2024-12-05 04:00:00.702673"
latest: "1.29--r43hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/r-mutsigextractor:1.29--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/r-mutsigextractor/1.29--r43hdfd78af_0
$ module help quay.io/biocontainers/r-mutsigextractor/1.29--r43hdfd78af_0
```
