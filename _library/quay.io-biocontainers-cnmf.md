...
updated_at: "2026-06-03 07:10:40.938537"
...
```bash
$ shpc install quay.io/biocontainers/cnmf:1.7.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/cnmf/1.7.1--pyhdfd78af_0
$ module help quay.io/biocontainers/cnmf/1.7.1--pyhdfd78af_0
```
