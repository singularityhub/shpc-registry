---
layout: container
name:  "quay.io/biocontainers/cressent"
maintainer: "@vsoch"
...
updated_at: "2025-09-18 03:41:33.863793"
...
singularity registry hpc automated addition for cressent
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/cressent
```
...
#### cressent-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### cressent-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/cressent
$ podman run --it --rm --entrypoint /usr/local/bin/cressent   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/cressent   -v ${PWD} -w ${PWD} <container> -c " $@"
```
