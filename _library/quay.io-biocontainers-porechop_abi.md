...
updated_at: "2025-08-14 03:41:43.485555"
latest: "0.5.0--py312h5e9d817_5"
...
```bash
$ shpc install quay.io/biocontainers/porechop_abi:0.5.0--py312h5e9d817_5
```
...
```bash
$ module load quay.io/biocontainers/porechop_abi/0.5.0--py312h5e9d817_5
$ module help quay.io/biocontainers/porechop_abi/0.5.0--py312h5e9d817_5
```
