...
updated_at: "2026-09-23 08:05:45.589319"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-scran:1.38.1--r45h55fe1e3_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-scran/1.38.1--r45h55fe1e3_0
$ module help quay.io/biocontainers/bioconductor-scran/1.38.1--r45h55fe1e3_0
```
