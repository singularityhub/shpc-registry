...
updated_at: "2023-08-23 02:47:08.244886"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-scran:1.28.1--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-scran/1.28.1--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-scran/1.28.1--r43hf17093f_0
```
