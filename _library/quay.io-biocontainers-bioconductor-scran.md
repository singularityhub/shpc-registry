...
updated_at: "2026-03-25 04:53:55.967301"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-scran:1.38.0--r45ha27e39d_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-scran/1.38.0--r45ha27e39d_0
$ module help quay.io/biocontainers/bioconductor-scran/1.38.0--r45ha27e39d_0
```
