...
updated_at: "2026-03-30 05:34:46.018248"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rgu34aprobe:2.18.0--r45hdfd78af_14
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rgu34aprobe/2.18.0--r45hdfd78af_14
$ module help quay.io/biocontainers/bioconductor-rgu34aprobe/2.18.0--r45hdfd78af_14
```
