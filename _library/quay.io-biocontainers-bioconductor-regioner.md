...
updated_at: "2023-08-07 03:39:22.826696"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-regioner:1.32.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-regioner/1.32.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-regioner/1.32.0--r43hdfd78af_0
```
