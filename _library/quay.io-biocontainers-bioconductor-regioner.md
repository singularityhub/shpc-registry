...
updated_at: "2022-11-07 23:53:32.287718"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-regioner:1.26.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-regioner/1.26.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-regioner/1.26.0--r41hdfd78af_0
```
