...
updated_at: "2026-01-22 04:20:02.685408"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-regioner:1.38.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-regioner/1.38.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-regioner/1.38.0--r44hdfd78af_0
```
