---
layout: container
name:  "quay.io/biocontainers/bioconductor-clusterfoldsimilarity"
maintainer: "@vsoch"
github: "https://github.com/singularityhub/shpc-registry/blob/main/quay.io/biocontainers/bioconductor-clusterfoldsimilarity/container.yaml"
config_url: "https://raw.githubusercontent.com/singularityhub/shpc-registry/main/quay.io/biocontainers/bioconductor-clusterfoldsimilarity/container.yaml"
updated_at: "2025-10-04 02:54:33.828072"
latest: "1.2.0--r44hdfd78af_0"
container_url: "https://biocontainers.pro/tools/bioconductor-clusterfoldsimilarity"
aliases:
 - "pandoc-lua"
...
versions:
 - "1.2.0--r44hdfd78af_0"
description: "singularity registry hpc automated addition for bioconductor-clusterfoldsimilarity"
config: {"url": "https://biocontainers.pro/tools/bioconductor-clusterfoldsimilarity", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for bioconductor-clusterfoldsimilarity", "latest": {"1.2.0--r44hdfd78af_0": "sha256:c960d81364336cafaec54e30a3df0085d2dbf14087c2486997263c7e72b0282e"}, "tags": {"1.2.0--r44hdfd78af_0": "sha256:c960d81364336cafaec54e30a3df0085d2dbf14087c2486997263c7e72b0282e"}, "docker": "quay.io/biocontainers/bioconductor-clusterfoldsimilarity", "aliases": {"pandoc-lua": "/usr/local/bin/pandoc-lua", "x86_64-conda-linux-gnu.cfg": "/usr/local/bin/x86_64-conda-linux-gnu.cfg", "idle3.13": "/usr/local/bin/idle3.13", "pydoc3.13": "/usr/local/bin/pydoc3.13", "python3.13": "/usr/local/bin/python3.13", "python3.13-config": "/usr/local/bin/python3.13-config", "pandoc-server": "/usr/local/bin/pandoc-server", "glpsol": "/usr/local/bin/glpsol", "installBiocDataPackage.sh": "/usr/local/bin/installBiocDataPackage.sh", "tomlq": "/usr/local/bin/tomlq", "xq": "/usr/local/bin/xq", "yq": "/usr/local/bin/yq", "jq": "/usr/local/bin/jq", "onig-config": "/usr/local/bin/onig-config", "pandoc": "/usr/local/bin/pandoc", "hb-info": "/usr/local/bin/hb-info", "activate-global-python-argcomplete": "/usr/local/bin/activate-global-python-argcomplete", "python-argcomplete-check-easy-install-script": "/usr/local/bin/python-argcomplete-check-easy-install-script", "register-python-argcomplete": "/usr/local/bin/register-python-argcomplete", "tjbench": "/usr/local/bin/tjbench"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/bioconductor-clusterfoldsimilarity.
singularity registry hpc automated addition for bioconductor-clusterfoldsimilarity
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/bioconductor-clusterfoldsimilarity
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-clusterfoldsimilarity:1.2.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-clusterfoldsimilarity/1.2.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-clusterfoldsimilarity/1.2.0--r44hdfd78af_0
```
...
#### bioconductor-clusterfoldsimilarity-run:
...
#### bioconductor-clusterfoldsimilarity-shell:
...
#### bioconductor-clusterfoldsimilarity-exec:
...
#### bioconductor-clusterfoldsimilarity-inspect:
...
#### bioconductor-clusterfoldsimilarity-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-clusterfoldsimilarity-inspect-deffile:
