...
updated_at: "2026-03-28 16:40:24.558064"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-voyager:1.12.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-voyager/1.12.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-voyager/1.12.0--r45hdfd78af_0
```
