...
updated_at: "2024-03-05 02:55:43.672358"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-voyager:1.4.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-voyager/1.4.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-voyager/1.4.0--r43hdfd78af_0
```
