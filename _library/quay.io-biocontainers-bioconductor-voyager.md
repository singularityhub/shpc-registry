...
updated_at: "2025-02-12 03:01:51.683495"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-voyager:1.8.1--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-voyager/1.8.1--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-voyager/1.8.1--r44hdfd78af_0
```
