...
updated_at: "2025-02-08 03:15:27.998630"
...
```bash
$ shpc install quay.io/biocontainers/rnaquast:2.3.0--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/rnaquast/2.3.0--h9ee0642_0
$ module help quay.io/biocontainers/rnaquast/2.3.0--h9ee0642_0
```
