---
layout: container
name:  "quay.io/biocontainers/amira"
maintainer: "@vsoch"
...
updated_at: "2025-09-18 05:51:08.635621"
...
```bash
$ module load quay.io/biocontainers/amira/0.11.0--pyhdfd78af_0
$ module help quay.io/biocontainers/amira/0.11.0--pyhdfd78af_0
```
...
#### amira-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### amira-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/amira
$ podman run --it --rm --entrypoint /usr/local/bin/amira   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/amira   -v ${PWD} -w ${PWD} <container> -c " $@"
```
