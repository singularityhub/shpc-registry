...
updated_at: "2025-11-08 03:35:04.652971"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-complexheatmap:2.22.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-complexheatmap/2.22.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-complexheatmap/2.22.0--r44hdfd78af_0
```
