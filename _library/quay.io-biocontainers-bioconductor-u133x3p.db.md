...
updated_at: "2024-07-01 03:18:26.540589"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-u133x3p.db:3.2.3--r43hdfd78af_12
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-u133x3p.db/3.2.3--r43hdfd78af_12
$ module help quay.io/biocontainers/bioconductor-u133x3p.db/3.2.3--r43hdfd78af_12
```
