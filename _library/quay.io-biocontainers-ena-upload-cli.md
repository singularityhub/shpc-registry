...
updated_at: "2025-03-06 03:35:23.797429"
...
```bash
$ shpc install quay.io/biocontainers/ena-upload-cli:0.7.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ena-upload-cli/0.7.5--pyhdfd78af_0
$ module help quay.io/biocontainers/ena-upload-cli/0.7.5--pyhdfd78af_0
```
