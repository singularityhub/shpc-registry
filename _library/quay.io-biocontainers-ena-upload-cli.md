...
updated_at: "2025-11-24 04:14:57.544786"
...
```bash
$ shpc install quay.io/biocontainers/ena-upload-cli:0.9.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ena-upload-cli/0.9.0--pyhdfd78af_0
$ module help quay.io/biocontainers/ena-upload-cli/0.9.0--pyhdfd78af_0
```
