...
updated_at: "2024-03-29 03:05:33.537718"
...
```bash
$ shpc install quay.io/biocontainers/ena-upload-cli:0.7.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ena-upload-cli/0.7.1--pyhdfd78af_0
$ module help quay.io/biocontainers/ena-upload-cli/0.7.1--pyhdfd78af_0
```
