...
updated_at: "2024-08-08 03:45:05.677004"
...
```bash
$ shpc install quay.io/biocontainers/ena-upload-cli:0.7.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ena-upload-cli/0.7.3--pyhdfd78af_0
$ module help quay.io/biocontainers/ena-upload-cli/0.7.3--pyhdfd78af_0
```
