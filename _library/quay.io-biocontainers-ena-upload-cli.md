...
updated_at: "2024-12-05 03:08:43.096558"
...
```bash
$ shpc install quay.io/biocontainers/ena-upload-cli:0.7.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ena-upload-cli/0.7.4--pyhdfd78af_0
$ module help quay.io/biocontainers/ena-upload-cli/0.7.4--pyhdfd78af_0
```
