...
updated_at: "2025-11-07 04:02:38.473528"
latest: "2.4.0--hf34a1b8_9"
...
```bash
$ shpc install quay.io/biocontainers/exonerate:2.4.0--hf34a1b8_9
```
...
```bash
$ module load quay.io/biocontainers/exonerate/2.4.0--hf34a1b8_9
$ module help quay.io/biocontainers/exonerate/2.4.0--hf34a1b8_9
```
