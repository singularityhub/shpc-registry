...
updated_at: "2024-10-17 03:05:49.713045"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-moanin:1.10.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-moanin/1.10.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-moanin/1.10.0--r43hdfd78af_0
```
