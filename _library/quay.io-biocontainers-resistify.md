...
updated_at: "2024-08-27 06:04:57.454211"
...
```bash
$ shpc install quay.io/biocontainers/resistify:0.2.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/resistify/0.2.2--pyhdfd78af_0
$ module help quay.io/biocontainers/resistify/0.2.2--pyhdfd78af_0
```
