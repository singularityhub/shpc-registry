...
updated_at: "2024-09-24 03:01:14.108291"
...
```bash
$ shpc install quay.io/biocontainers/resistify:0.3.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/resistify/0.3.0--pyhdfd78af_0
$ module help quay.io/biocontainers/resistify/0.3.0--pyhdfd78af_0
```
