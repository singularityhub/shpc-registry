...
updated_at: "2026-06-27 05:59:18.321469"
...
```bash
$ shpc install quay.io/biocontainers/resistify:2.1.0--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/resistify/2.1.0--pyhdfd78af_1
$ module help quay.io/biocontainers/resistify/2.1.0--pyhdfd78af_1
```
