...
updated_at: "2025-05-17 03:40:36.466417"
...
```bash
$ shpc install quay.io/biocontainers/resistify:1.1.5--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/resistify/1.1.5--pyhdfd78af_1
$ module help quay.io/biocontainers/resistify/1.1.5--pyhdfd78af_1
```
