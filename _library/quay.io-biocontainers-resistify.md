...
updated_at: "2025-01-31 03:28:14.126237"
...
```bash
$ shpc install quay.io/biocontainers/resistify:1.0.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/resistify/1.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/resistify/1.0.0--pyhdfd78af_0
```
