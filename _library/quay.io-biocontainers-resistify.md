...
updated_at: "2025-09-06 03:31:45.057248"
...
```bash
$ shpc install quay.io/biocontainers/resistify:1.3.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/resistify/1.3.0--pyhdfd78af_0
$ module help quay.io/biocontainers/resistify/1.3.0--pyhdfd78af_0
```
