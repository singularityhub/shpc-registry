...
updated_at: "2025-03-12 04:52:47.538495"
...
```bash
$ shpc install quay.io/biocontainers/resistify:1.1.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/resistify/1.1.5--pyhdfd78af_0
$ module help quay.io/biocontainers/resistify/1.1.5--pyhdfd78af_0
```
