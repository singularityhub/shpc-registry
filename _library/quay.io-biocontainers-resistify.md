...
updated_at: "2026-04-05 04:56:03.944525"
...
```bash
$ shpc install quay.io/biocontainers/resistify:2.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/resistify/2.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/resistify/2.1.0--pyhdfd78af_0
```
