...
updated_at: "2026-07-24 05:41:42.126144"
...
```bash
$ shpc install quay.io/biocontainers/resistify:2.2.0--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/resistify/2.2.0--pyhdfd78af_1
$ module help quay.io/biocontainers/resistify/2.2.0--pyhdfd78af_1
```
