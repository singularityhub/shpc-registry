...
updated_at: "2024-06-22 02:55:36.649646"
latest: "1.1.26--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/jaeger-bio:1.1.26--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/jaeger-bio/1.1.26--pyhdfd78af_0
$ module help quay.io/biocontainers/jaeger-bio/1.1.26--pyhdfd78af_0
```
