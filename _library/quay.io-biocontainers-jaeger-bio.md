...
updated_at: "2025-12-01 05:24:11.906152"
...
```bash
$ shpc install quay.io/biocontainers/jaeger-bio:1.1.30--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/jaeger-bio/1.1.30--pyhdfd78af_0
$ module help quay.io/biocontainers/jaeger-bio/1.1.30--pyhdfd78af_0
```
