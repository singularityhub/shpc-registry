---
layout: container
name:  "quay.io/biocontainers/jaeger-bio"
maintainer: "@vsoch"
...
updated_at: "2026-09-16 08:28:43.741983"
latest: "1.26.5--pyhdfd78af_0"
...
versions:
 ...
 - "1.26.4--pyhdfd78af_0"
 - "1.26.5--pyhdfd78af_0"
description: "singularity registry hpc automated addition for jaeger-bio"
config: {"url": "https://biocontainers.pro/tools/jaeger-bio", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for jaeger-bio", "latest": {"1.26.5--pyhdfd78af_0": "sha256:24b6b2894ff4d7076edc22d453968afc243c350d0cb0e6952166c4483abf0c6d"}, "tags": {"1.1.26--pyhdfd78af_0": "sha256:c3c6e70c8654d271b6daf6f76d468fafe52cb8183cd1b2d6f0db3c605a038992", "1.1.30--pyhdfd78af_0": "sha256:b30a228830e83ad7000a4987d8dd3574d0007c9b27a5c2fa4552eea9a8c0cec3", "1.26.4--pyhdfd78af_0": "sha256:697c14917d3747b10fb4f0dd57c33189067bda76d5cd8a56146d9a3e2fb222d2", "1.26.5--pyhdfd78af_0": "sha256:24b6b2894ff4d7076edc22d453968afc243c350d0cb0e6952166c4483abf0c6d"}, "docker": "quay.io/biocontainers/jaeger-bio", "aliases": {"Jaeger": "/usr/local/bin/Jaeger", "Jaeger_parallel": "/usr/local/bin/Jaeger_parallel", "flatc": "/usr/local/bin/flatc", "h5tools_test_utils": "/usr/local/bin/h5tools_test_utils", "protoc-24.4.0": "/usr/local/bin/protoc-24.4.0", "import_pb_to_tensorboard": "/usr/local/bin/import_pb_to_tensorboard", "h5fuse.sh": "/usr/local/bin/h5fuse.sh", "estimator_ckpt_converter": "/usr/local/bin/estimator_ckpt_converter", "google-oauthlib-tool": "/usr/local/bin/google-oauthlib-tool", "tf_upgrade_v2": "/usr/local/bin/tf_upgrade_v2", "h5delete": "/usr/local/bin/h5delete", "tflite_convert": "/usr/local/bin/tflite_convert", "saved_model_cli": "/usr/local/bin/saved_model_cli", "toco": "/usr/local/bin/toco", "toco_from_protos": "/usr/local/bin/toco_from_protos", "tensorboard": "/usr/local/bin/tensorboard", "markdown_py": "/usr/local/bin/markdown_py", "grpc_cpp_plugin": "/usr/local/bin/grpc_cpp_plugin", "grpc_csharp_plugin": "/usr/local/bin/grpc_csharp_plugin", "grpc_node_plugin": "/usr/local/bin/grpc_node_plugin", "grpc_objective_c_plugin": "/usr/local/bin/grpc_objective_c_plugin", "grpc_php_plugin": "/usr/local/bin/grpc_php_plugin", "grpc_python_plugin": "/usr/local/bin/grpc_python_plugin", "grpc_ruby_plugin": "/usr/local/bin/grpc_ruby_plugin", "pyrsa-decrypt": "/usr/local/bin/pyrsa-decrypt", "pyrsa-encrypt": "/usr/local/bin/pyrsa-encrypt", "pyrsa-keygen": "/usr/local/bin/pyrsa-keygen", "pyrsa-priv2pub": "/usr/local/bin/pyrsa-priv2pub"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/jaeger-bio.
singularity registry hpc automated addition for jaeger-bio
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/jaeger-bio
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/jaeger-bio:1.26.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/jaeger-bio/1.26.5--pyhdfd78af_0
$ module help quay.io/biocontainers/jaeger-bio/1.26.5--pyhdfd78af_0
```
...
#### jaeger-bio-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### jaeger-bio-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/Jaeger
$ podman run --it --rm --entrypoint /usr/local/bin/Jaeger   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/Jaeger   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/Jaeger_parallel
$ podman run --it --rm --entrypoint /usr/local/bin/Jaeger_parallel   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/Jaeger_parallel   -v ${PWD} -w ${PWD} <container> -c " $@"
```
