...
updated_at: "2026-07-19 06:16:53.734115"
latest: "1.26.4--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/jaeger-bio:1.26.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/jaeger-bio/1.26.4--pyhdfd78af_0
$ module help quay.io/biocontainers/jaeger-bio/1.26.4--pyhdfd78af_0
```
