...
updated_at: "2026-06-30 06:46:32.152935"
...
```bash
$ shpc install quay.io/biocontainers/gtfparse:2.7.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/gtfparse/2.7.1--pyhdfd78af_0
$ module help quay.io/biocontainers/gtfparse/2.7.1--pyhdfd78af_0
```
