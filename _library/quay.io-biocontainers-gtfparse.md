...
updated_at: "2026-04-21 05:32:00.102241"
...
```bash
$ shpc install quay.io/biocontainers/gtfparse:2.6.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/gtfparse/2.6.2--pyhdfd78af_0
$ module help quay.io/biocontainers/gtfparse/2.6.2--pyhdfd78af_0
```
