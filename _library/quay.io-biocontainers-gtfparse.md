...
updated_at: "2026-06-05 06:49:13.681586"
...
```bash
$ shpc install quay.io/biocontainers/gtfparse:2.6.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/gtfparse/2.6.3--pyhdfd78af_0
$ module help quay.io/biocontainers/gtfparse/2.6.3--pyhdfd78af_0
```
