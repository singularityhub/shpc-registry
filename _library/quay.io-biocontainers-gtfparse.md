...
updated_at: "2026-08-12 04:58:43.670014"
...
```bash
$ shpc install quay.io/biocontainers/gtfparse:2.8.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/gtfparse/2.8.0--pyhdfd78af_0
$ module help quay.io/biocontainers/gtfparse/2.8.0--pyhdfd78af_0
```
