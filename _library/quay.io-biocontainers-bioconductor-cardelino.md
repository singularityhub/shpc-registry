...
updated_at: "2025-04-28 03:59:49.587523"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cardelino:1.8.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cardelino/1.8.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-cardelino/1.8.0--r44hdfd78af_0
```
