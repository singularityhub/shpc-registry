...
updated_at: "2024-08-05 04:22:50.867905"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cardelino:1.4.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cardelino/1.4.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-cardelino/1.4.0--r43hdfd78af_0
```
