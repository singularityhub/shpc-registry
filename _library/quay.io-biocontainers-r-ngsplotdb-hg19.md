...
updated_at: "2022-11-09 00:38:58.912992"
latest: "3.00--2"
container_url: "https://biocontainers.pro/tools/r-ngsplotdb-hg19"
aliases:
 - ".r-ngsplotdb-hg19-post-link.sh"
 - ".r-ngsplotdb-hg19-pre-unlink.sh"
 - "ExtractGName.R"
 - "alt_reg_cufflinks"
 - "alter2bed.pl"
 - "combine_diff.pl"
...
```bash
$ singularity exec <container> /usr/local/bin/.r-ngsplotdb-hg19-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.r-ngsplotdb-hg19-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.r-ngsplotdb-hg19-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.r-ngsplotdb-hg19-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.r-ngsplotdb-hg19-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.r-ngsplotdb-hg19-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
