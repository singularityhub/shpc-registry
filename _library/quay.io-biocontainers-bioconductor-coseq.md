...
updated_at: "2026-04-04 05:19:43.883726"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-coseq:1.34.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-coseq/1.34.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-coseq/1.34.0--r45hdfd78af_0
```
