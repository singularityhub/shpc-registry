...
updated_at: "2024-07-29 02:41:40.591385"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-coseq:1.26.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-coseq/1.26.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-coseq/1.26.0--r43hdfd78af_0
```
