---
layout: container
name:  "quay.io/biocontainers/bioconductor-hibed"
maintainer: "@vsoch"
github: "https://github.com/singularityhub/shpc-registry/blob/main/quay.io/biocontainers/bioconductor-hibed/container.yaml"
config_url: "https://raw.githubusercontent.com/singularityhub/shpc-registry/main/quay.io/biocontainers/bioconductor-hibed/container.yaml"
updated_at: "2026-03-23 05:11:31.106567"
latest: "1.8.0--r45hdfd78af_0"
container_url: "https://biocontainers.pro/tools/bioconductor-hibed"
aliases:
 - "pcre2posix_test"
 - "2to3-3.12"
 - "idle3.12"
...
versions:
 ...
 - "1.4.0--r44hdfd78af_0"
 - "1.8.0--r45hdfd78af_0"
description: "singularity registry hpc automated addition for bioconductor-hibed"
config: {"url": "https://biocontainers.pro/tools/bioconductor-hibed", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for bioconductor-hibed", "latest": {"1.8.0--r45hdfd78af_0": "sha256:2685fc5c9d5293d0b28ed5f628394c09aaadd8631c66c61415d3485dd3cd49de"}, "tags": {"1.0.0--r43hdfd78af_0": "sha256:5dc9b2450a532f2133a45521bcb4e41fbf29b1ebaaf63445956e9dc171e6518a", "1.4.0--r44hdfd78af_0": "sha256:5fd32f9dceb37886ab4d154b417beab2f30751cd4cb3d0832b648b026cf2cecc", "1.8.0--r45hdfd78af_0": "sha256:2685fc5c9d5293d0b28ed5f628394c09aaadd8631c66c61415d3485dd3cd49de"}, "docker": "quay.io/biocontainers/bioconductor-hibed", "aliases": {"pcre2posix_test": "/usr/local/bin/pcre2posix_test", "2to3-3.12": "/usr/local/bin/2to3-3.12", "idle3.12": "/usr/local/bin/idle3.12", "pydoc3.12": "/usr/local/bin/pydoc3.12", "python3.12": "/usr/local/bin/python3.12", "python3.12-config": "/usr/local/bin/python3.12-config", "hb-info": "/usr/local/bin/hb-info", "installBiocDataPackage.sh": "/usr/local/bin/installBiocDataPackage.sh", "tjbench": "/usr/local/bin/tjbench", "tomlq": "/usr/local/bin/tomlq", "xq": "/usr/local/bin/xq", "yq": "/usr/local/bin/yq", "jq": "/usr/local/bin/jq", "onig-config": "/usr/local/bin/onig-config", "activate-global-python-argcomplete": "/usr/local/bin/activate-global-python-argcomplete", "python-argcomplete-check-easy-install-script": "/usr/local/bin/python-argcomplete-check-easy-install-script", "register-python-argcomplete": "/usr/local/bin/register-python-argcomplete", "pandoc": "/usr/local/bin/pandoc"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/bioconductor-hibed.
singularity registry hpc automated addition for bioconductor-hibed
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/bioconductor-hibed
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-hibed:1.8.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hibed/1.8.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-hibed/1.8.0--r45hdfd78af_0
```
...
#### bioconductor-hibed-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-hibed-inspect-deffile:
