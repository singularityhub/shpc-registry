...
updated_at: "2025-03-10 02:43:18.987729"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hibed:1.4.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hibed/1.4.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-hibed/1.4.0--r44hdfd78af_0
```
