...
updated_at: "2024-02-29 03:03:48.056191"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hibed:1.0.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hibed/1.0.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-hibed/1.0.0--r43hdfd78af_0
```
