---
layout: container
name:  "quay.io/biocontainers/map4"
maintainer: "@vsoch"
...
updated_at: "2026-08-27 23:53:09.923019"
...
versions:
 - "1.1.3--pyh106432d_0"
description: "singularity registry hpc automated addition for map4"
config: {"url": "https://biocontainers.pro/tools/map4", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for map4", "latest": {"1.1.3--pyh106432d_0": "sha256:a55148933e7e3fd7105ae748ba3ebed89b9cd178e89a691c7e46c3b686d46d50"}, "tags": {"1.1.3--pyh106432d_0": "sha256:a55148933e7e3fd7105ae748ba3ebed89b9cd178e89a691c7e46c3b686d46d50"}, "docker": "quay.io/biocontainers/map4", "aliases": {"map4": "/usr/local/bin/map4", "ldapadd": "/usr/local/bin/ldapadd", "ldapcompare": "/usr/local/bin/ldapcompare", "ldapdelete": "/usr/local/bin/ldapdelete", "ldapexop": "/usr/local/bin/ldapexop", "ldapmodify": "/usr/local/bin/ldapmodify", "ldapmodrdn": "/usr/local/bin/ldapmodrdn", "ldappasswd": "/usr/local/bin/ldappasswd", "ldapsearch": "/usr/local/bin/ldapsearch", "ldapurl": "/usr/local/bin/ldapurl", "ldapvc": "/usr/local/bin/ldapvc", "ldapwhoami": "/usr/local/bin/ldapwhoami", "fc-genconf": "/usr/local/bin/fc-genconf", "pg_config": "/usr/local/bin/pg_config", "idle3.14": "/usr/local/bin/idle3.14", "pydoc3.14": "/usr/local/bin/pydoc3.14", "python3.14": "/usr/local/bin/python3.14", "python3.14-config": "/usr/local/bin/python3.14-config", "qconvex": "/usr/local/bin/qconvex", "qdelaunay": "/usr/local/bin/qdelaunay", "qhalf": "/usr/local/bin/qhalf", "qhull": "/usr/local/bin/qhull", "qvoronoi": "/usr/local/bin/qvoronoi", "rbox": "/usr/local/bin/rbox", "tqdm": "/usr/local/bin/tqdm", "numpy-config": "/usr/local/bin/numpy-config"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/map4.
singularity registry hpc automated addition for map4
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/map4
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/map4:1.1.3--pyh106432d_0
```
...
```bash
$ module load quay.io/biocontainers/map4/1.1.3--pyh106432d_0
$ module help quay.io/biocontainers/map4/1.1.3--pyh106432d_0
```
...
#### map4-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### map4-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/map4
$ podman run --it --rm --entrypoint /usr/local/bin/map4   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/map4   -v ${PWD} -w ${PWD} <container> -c " $@"
```
