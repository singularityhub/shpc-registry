...
updated_at: "2024-03-23 02:46:34.860348"
latest: "2.26.0--pyh7cba7a3_0"
...
```bash
$ shpc install quay.io/biocontainers/solvebio:2.26.0--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/solvebio/2.26.0--pyh7cba7a3_0
$ module help quay.io/biocontainers/solvebio/2.26.0--pyh7cba7a3_0
```
