...
updated_at: "2023-12-04 03:06:39.588098"
latest: "2.25.0--pyh7cba7a3_0"
...
```bash
$ shpc install quay.io/biocontainers/solvebio:2.25.0--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/solvebio/2.25.0--pyh7cba7a3_0
$ module help quay.io/biocontainers/solvebio/2.25.0--pyh7cba7a3_0
```
