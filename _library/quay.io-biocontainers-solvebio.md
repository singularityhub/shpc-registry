...
updated_at: "2024-07-19 03:01:07.804765"
latest: "2.27.0--pyh7cba7a3_0"
...
```bash
$ shpc install quay.io/biocontainers/solvebio:2.27.0--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/solvebio/2.27.0--pyh7cba7a3_0
$ module help quay.io/biocontainers/solvebio/2.27.0--pyh7cba7a3_0
```
