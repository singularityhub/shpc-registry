...
updated_at: "2022-10-27 00:23:45.675303"
latest: "2.9.0--py_0"
...
```bash
$ shpc install quay.io/biocontainers/solvebio:2.9.0--py_0
```
...
```bash
$ module load quay.io/biocontainers/solvebio/2.9.0--py_0
$ module help quay.io/biocontainers/solvebio/2.9.0--py_0
```
