---
layout: container
name:  "quay.io/biocontainers/bioconductor-csoa"
maintainer: "@vsoch"
github: "https://github.com/singularityhub/shpc-registry/blob/main/quay.io/biocontainers/bioconductor-csoa/container.yaml"
config_url: "https://raw.githubusercontent.com/singularityhub/shpc-registry/main/quay.io/biocontainers/bioconductor-csoa/container.yaml"
updated_at: "2026-04-05 05:02:43.758789"
latest: "1.0.0--r45hdfd78af_0"
container_url: "https://biocontainers.pro/tools/bioconductor-csoa"
aliases:
 - "hb-raster"
 - "hb-vector"
 - "pandoc-lua"
...
versions:
 - "1.0.0--r45hdfd78af_0"
description: "singularity registry hpc automated addition for bioconductor-csoa"
config: {"url": "https://biocontainers.pro/tools/bioconductor-csoa", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for bioconductor-csoa", "latest": {"1.0.0--r45hdfd78af_0": "sha256:e73374bd200530f9cb9c01b3e9054fd05d968dc7dab4b4d86f6bea5485035b1d"}, "tags": {"1.0.0--r45hdfd78af_0": "sha256:e73374bd200530f9cb9c01b3e9054fd05d968dc7dab4b4d86f6bea5485035b1d"}, "docker": "quay.io/biocontainers/bioconductor-csoa", "aliases": {"hb-raster": "/usr/local/bin/hb-raster", "hb-vector": "/usr/local/bin/hb-vector", "pandoc-lua": "/usr/local/bin/pandoc-lua", "pandoc-server": "/usr/local/bin/pandoc-server", "hwloc-gather-cpuid": "/usr/local/bin/hwloc-gather-cpuid", "hwloc-annotate": "/usr/local/bin/hwloc-annotate", "hwloc-bind": "/usr/local/bin/hwloc-bind", "hwloc-calc": "/usr/local/bin/hwloc-calc", "hwloc-compress-dir": "/usr/local/bin/hwloc-compress-dir", "hwloc-diff": "/usr/local/bin/hwloc-diff", "hwloc-distrib": "/usr/local/bin/hwloc-distrib", "hwloc-gather-topology": "/usr/local/bin/hwloc-gather-topology", "hwloc-info": "/usr/local/bin/hwloc-info", "hwloc-ls": "/usr/local/bin/hwloc-ls", "hwloc-patch": "/usr/local/bin/hwloc-patch", "hwloc-ps": "/usr/local/bin/hwloc-ps", "lstopo": "/usr/local/bin/lstopo", "lstopo-no-graphics": "/usr/local/bin/lstopo-no-graphics", "glpsol": "/usr/local/bin/glpsol", "x86_64-conda-linux-gnu.cfg": "/usr/local/bin/x86_64-conda-linux-gnu.cfg", "pandoc": "/usr/local/bin/pandoc", "hb-info": "/usr/local/bin/hb-info"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/bioconductor-csoa.
singularity registry hpc automated addition for bioconductor-csoa
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/bioconductor-csoa
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-csoa:1.0.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-csoa/1.0.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-csoa/1.0.0--r45hdfd78af_0
```
...
#### bioconductor-csoa-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-csoa-inspect-deffile:
