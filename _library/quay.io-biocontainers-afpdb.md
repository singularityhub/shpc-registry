---
layout: container
name:  "quay.io/biocontainers/afpdb"
maintainer: "@vsoch"
...
updated_at: "2024-10-14 17:10:25.900100"
...
```bash
$ shpc install quay.io/biocontainers/afpdb
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/afpdb:0.2.1--pyhcf36b3e_0
```
...
```bash
$ module load quay.io/biocontainers/afpdb/0.2.1--pyhcf36b3e_0
$ module help quay.io/biocontainers/afpdb/0.2.1--pyhcf36b3e_0
```
...
#### afpdb-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### afpdb-inspect-deffile:
