...
updated_at: "2025-06-12 03:21:28.825373"
...
```bash
$ shpc install quay.io/biocontainers/rdrpcatch:0.0.7--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/rdrpcatch/0.0.7--pyhdfd78af_0
$ module help quay.io/biocontainers/rdrpcatch/0.0.7--pyhdfd78af_0
```
