---
layout: container
name:  "quay.io/biocontainers/hybkit"
maintainer: "@vsoch"
...
updated_at: "2023-11-22 03:12:58.341693"
...
```bash
$ shpc install quay.io/biocontainers/hybkit
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/hybkit:0.3.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hybkit/0.3.3--pyhdfd78af_0
$ module help quay.io/biocontainers/hybkit/0.3.3--pyhdfd78af_0
```
...
#### hybkit-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### hybkit-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/hyb_analyze
$ podman run --it --rm --entrypoint /usr/local/bin/hyb_analyze   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/hyb_analyze   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/hyb_check
$ podman run --it --rm --entrypoint /usr/local/bin/hyb_check   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/hyb_check   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/hyb_eval
$ podman run --it --rm --entrypoint /usr/local/bin/hyb_eval   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/hyb_eval   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/hyb_filter
$ podman run --it --rm --entrypoint /usr/local/bin/hyb_filter   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/hyb_filter   -v ${PWD} -w ${PWD} <container> -c " $@"
```
