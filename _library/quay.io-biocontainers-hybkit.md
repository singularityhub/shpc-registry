...
updated_at: "2023-08-24 03:04:44.782192"
...
```bash
$ shpc install quay.io/biocontainers/hybkit:0.3.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hybkit/0.3.0--pyhdfd78af_0
$ module help quay.io/biocontainers/hybkit/0.3.0--pyhdfd78af_0
```
