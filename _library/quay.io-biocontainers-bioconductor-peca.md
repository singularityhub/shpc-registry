...
updated_at: "2023-10-23 02:47:45.125321"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-peca:1.36.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-peca/1.36.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-peca/1.36.0--r43hdfd78af_0
```
