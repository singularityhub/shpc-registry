...
updated_at: "2026-04-04 05:06:09.986983"
latest: "1.0.5--r45h9ee0642_1"
...
```bash
$ shpc install quay.io/biocontainers/r-tmae:1.0.5--r45h9ee0642_1
```
...
```bash
$ module load quay.io/biocontainers/r-tmae/1.0.5--r45h9ee0642_1
$ module help quay.io/biocontainers/r-tmae/1.0.5--r45h9ee0642_1
```
