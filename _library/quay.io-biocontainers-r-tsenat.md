---
layout: container
name:  "quay.io/biocontainers/r-tsenat"
maintainer: "@vsoch"
...
updated_at: "2026-06-24 06:39:50.270086"
...
singularity registry hpc automated addition for r-tsenat
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/r-tsenat
```
...
#### r-tsenat-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-tsenat-inspect-deffile:
