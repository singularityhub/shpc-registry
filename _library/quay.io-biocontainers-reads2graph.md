---
layout: container
name:  "quay.io/biocontainers/reads2graph"
maintainer: "@vsoch"
...
updated_at: "2025-12-16 03:29:18.207835"
...
```bash
$ shpc install quay.io/biocontainers/reads2graph
```
...
#### reads2graph-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### reads2graph-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/reads2graph
$ podman run --it --rm --entrypoint /usr/local/bin/reads2graph   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/reads2graph   -v ${PWD} -w ${PWD} <container> -c " $@"
```
