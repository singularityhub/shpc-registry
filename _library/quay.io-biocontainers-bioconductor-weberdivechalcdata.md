---
layout: container
name:  "quay.io/biocontainers/bioconductor-weberdivechalcdata"
maintainer: "@vsoch"
...
updated_at: "2023-05-08 04:09:04.229360"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-weberdivechalcdata
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-weberdivechalcdata:1.0.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-weberdivechalcdata/1.0.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-weberdivechalcdata/1.0.0--r42hdfd78af_0
```
...
#### bioconductor-weberdivechalcdata-run:
...
#### bioconductor-weberdivechalcdata-shell:
...
#### bioconductor-weberdivechalcdata-exec:
...
#### bioconductor-weberdivechalcdata-inspect:
...
#### bioconductor-weberdivechalcdata-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-weberdivechalcdata-inspect-deffile:
