...
updated_at: "2022-10-29 05:54:10.367655"
latest: "3.34.0--r41hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-safe:3.34.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-safe/3.34.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-safe/3.34.0--r41hdfd78af_0
```
