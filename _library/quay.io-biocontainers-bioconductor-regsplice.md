...
updated_at: "2026-03-27 04:58:34.450890"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-regsplice:1.36.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-regsplice/1.36.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-regsplice/1.36.0--r45hdfd78af_0
```
