...
updated_at: "2024-04-08 02:39:32.012075"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-regsplice:1.28.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-regsplice/1.28.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-regsplice/1.28.0--r43hdfd78af_0
```
