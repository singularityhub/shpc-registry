...
updated_at: "2022-12-05 03:29:21.035657"
latest: "0.14.0--h9ee0642_0"
...
```bash
$ shpc install quay.io/biocontainers/taxonkit:0.14.0--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/taxonkit/0.14.0--h9ee0642_0
$ module help quay.io/biocontainers/taxonkit/0.14.0--h9ee0642_0
```
