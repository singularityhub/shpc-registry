...
updated_at: "2025-09-18 03:45:41.089457"
...
```bash
$ shpc install quay.io/biocontainers/taxonkit:0.20.0--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/taxonkit/0.20.0--h9ee0642_0
$ module help quay.io/biocontainers/taxonkit/0.20.0--h9ee0642_0
```
