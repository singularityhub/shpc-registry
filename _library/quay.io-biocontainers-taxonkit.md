...
updated_at: "2024-06-24 02:42:57.162486"
latest: "0.16.0--h9ee0642_1"
...
```bash
$ shpc install quay.io/biocontainers/taxonkit:0.16.0--h9ee0642_1
```
...
```bash
$ module load quay.io/biocontainers/taxonkit/0.16.0--h9ee0642_1
$ module help quay.io/biocontainers/taxonkit/0.16.0--h9ee0642_1
```
