...
updated_at: "2024-04-25 02:46:12.203188"
...
```bash
$ shpc install quay.io/biocontainers/taxonkit:0.16.0--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/taxonkit/0.16.0--h9ee0642_0
$ module help quay.io/biocontainers/taxonkit/0.16.0--h9ee0642_0
```
