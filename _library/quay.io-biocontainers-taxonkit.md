...
updated_at: "2026-04-05 05:21:38.344682"
latest: "0.20.0--h9ee0642_1"
...
```bash
$ shpc install quay.io/biocontainers/taxonkit:0.20.0--h9ee0642_1
```
...
```bash
$ module load quay.io/biocontainers/taxonkit/0.20.0--h9ee0642_1
$ module help quay.io/biocontainers/taxonkit/0.20.0--h9ee0642_1
```
