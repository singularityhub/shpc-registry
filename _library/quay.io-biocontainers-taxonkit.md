...
updated_at: "2024-11-18 03:27:24.166485"
latest: "0.18.0--h9ee0642_0"
...
```bash
$ shpc install quay.io/biocontainers/taxonkit:0.18.0--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/taxonkit/0.18.0--h9ee0642_0
$ module help quay.io/biocontainers/taxonkit/0.18.0--h9ee0642_0
```
