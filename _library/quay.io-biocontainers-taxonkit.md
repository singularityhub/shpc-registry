...
updated_at: "2025-04-27 03:41:28.154883"
latest: "0.19.0--h9ee0642_0"
...
```bash
$ shpc install quay.io/biocontainers/taxonkit:0.19.0--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/taxonkit/0.19.0--h9ee0642_0
$ module help quay.io/biocontainers/taxonkit/0.19.0--h9ee0642_0
```
