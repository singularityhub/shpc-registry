---
layout: container
name:  "quay.io/biocontainers/covsnap"
maintainer: "@vsoch"
...
updated_at: "2026-07-26 06:06:07.288321"
...
```bash
$ module load quay.io/biocontainers/covsnap/0.5.0--pyhdfd78af_0
$ module help quay.io/biocontainers/covsnap/0.5.0--pyhdfd78af_0
```
...
#### covsnap-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### covsnap-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/covsnap
$ podman run --it --rm --entrypoint /usr/local/bin/covsnap   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/covsnap   -v ${PWD} -w ${PWD} <container> -c " $@"
```
