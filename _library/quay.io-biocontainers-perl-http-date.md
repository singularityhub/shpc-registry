...
updated_at: "2026-08-25 09:45:26.776950"
...
```bash
$ shpc install quay.io/biocontainers/perl-http-date:6.08--pl5321hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/perl-http-date/6.08--pl5321hdfd78af_0
$ module help quay.io/biocontainers/perl-http-date/6.08--pl5321hdfd78af_0
```
