---
layout: container
name:  "quay.io/biocontainers/vclean"
maintainer: "@vsoch"
...
updated_at: "2024-09-20 03:11:30.551964"
...
```bash
$ shpc install quay.io/biocontainers/vclean
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/vclean:0.0.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/vclean/0.0.2--pyhdfd78af_0
$ module help quay.io/biocontainers/vclean/0.0.2--pyhdfd78af_0
```
...
#### vclean-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### vclean-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/vclean
$ podman run --it --rm --entrypoint /usr/local/bin/vclean   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/vclean   -v ${PWD} -w ${PWD} <container> -c " $@"
```
