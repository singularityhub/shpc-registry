...
updated_at: "2026-03-22 04:25:55.478689"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-spsimseq:1.20.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-spsimseq/1.20.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-spsimseq/1.20.0--r45hdfd78af_0
```
