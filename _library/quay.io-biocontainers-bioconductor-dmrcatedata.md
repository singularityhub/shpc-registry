...
updated_at: "2022-10-27 01:11:33.821480"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-dmrcatedata:2.8.2--r40hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-dmrcatedata/2.8.2--r40hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-dmrcatedata/2.8.2--r40hdfd78af_0
```
