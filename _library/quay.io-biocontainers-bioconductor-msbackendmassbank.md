...
updated_at: "2022-10-29 05:31:53.138381"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-msbackendmassbank:1.2.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-msbackendmassbank/1.2.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-msbackendmassbank/1.2.0--r41hdfd78af_0
```
