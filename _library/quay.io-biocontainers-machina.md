...
updated_at: "2022-11-17 02:59:52.767175"
...
```bash
$ shpc install quay.io/biocontainers/machina:1.2--h7ff8a90_4
```
...
```bash
$ module load quay.io/biocontainers/machina/1.2--h7ff8a90_4
$ module help quay.io/biocontainers/machina/1.2--h7ff8a90_4
```
