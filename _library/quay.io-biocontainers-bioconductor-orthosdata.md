---
layout: container
name:  "quay.io/biocontainers/bioconductor-orthosdata"
maintainer: "@vsoch"
...
updated_at: "2026-04-04 05:17:07.189709"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-orthosdata
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-orthosdata:1.8.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-orthosdata/1.8.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-orthosdata/1.8.0--r45hdfd78af_0
```
...
#### bioconductor-orthosdata-inspect:
...
#### bioconductor-orthosdata-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-orthosdata-inspect-deffile:
