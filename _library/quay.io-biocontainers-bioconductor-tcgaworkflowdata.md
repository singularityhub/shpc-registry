...
updated_at: "2024-09-30 03:04:27.445207"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-tcgaworkflowdata:1.26.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-tcgaworkflowdata/1.26.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-tcgaworkflowdata/1.26.0--r43hdfd78af_0
```
