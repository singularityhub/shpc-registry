...
updated_at: "2026-03-30 05:06:57.031265"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-tcgaworkflowdata:1.34.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-tcgaworkflowdata/1.34.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-tcgaworkflowdata/1.34.0--r45hdfd78af_0
```
