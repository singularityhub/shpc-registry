...
updated_at: "2026-03-31 05:20:02.160687"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mpfe:1.46.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mpfe/1.46.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-mpfe/1.46.0--r45hdfd78af_0
```
