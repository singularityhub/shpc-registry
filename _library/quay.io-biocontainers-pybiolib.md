...
updated_at: "2023-07-27 05:40:30.246527"
latest: "1.1.1073--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/pybiolib:1.1.1073--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pybiolib/1.1.1073--pyhdfd78af_0
$ module help quay.io/biocontainers/pybiolib/1.1.1073--pyhdfd78af_0
```
