...
updated_at: "2024-11-29 03:15:12.889101"
latest: "1.2.223--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/pybiolib:1.2.223--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pybiolib/1.2.223--pyhdfd78af_0
$ module help quay.io/biocontainers/pybiolib/1.2.223--pyhdfd78af_0
```
