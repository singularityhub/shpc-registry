...
updated_at: "2025-09-04 03:01:51.869658"
latest: "1.2.1153--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/pybiolib:1.2.1153--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pybiolib/1.2.1153--pyhdfd78af_0
$ module help quay.io/biocontainers/pybiolib/1.2.1153--pyhdfd78af_0
```
