...
updated_at: "2024-05-07 02:57:59.677222"
latest: "1.1.1998--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/pybiolib:1.1.1998--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pybiolib/1.1.1998--pyhdfd78af_0
$ module help quay.io/biocontainers/pybiolib/1.1.1998--pyhdfd78af_0
```
