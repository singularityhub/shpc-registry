...
updated_at: "2025-04-07 03:27:37.856547"
latest: "1.2.582--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/pybiolib:1.2.582--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pybiolib/1.2.582--pyhdfd78af_0
$ module help quay.io/biocontainers/pybiolib/1.2.582--pyhdfd78af_0
```
