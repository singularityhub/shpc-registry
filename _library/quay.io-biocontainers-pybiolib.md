...
updated_at: "2024-10-31 03:17:31.994741"
latest: "1.2.197--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/pybiolib:1.2.197--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pybiolib/1.2.197--pyhdfd78af_0
$ module help quay.io/biocontainers/pybiolib/1.2.197--pyhdfd78af_0
```
