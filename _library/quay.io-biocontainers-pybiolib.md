...
updated_at: "2024-06-15 03:07:00.775947"
latest: "1.1.2036--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/pybiolib:1.1.2036--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pybiolib/1.1.2036--pyhdfd78af_0
$ module help quay.io/biocontainers/pybiolib/1.1.2036--pyhdfd78af_0
```
