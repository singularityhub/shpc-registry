...
updated_at: "2024-03-24 03:02:25.893716"
latest: "1.1.1879--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/pybiolib:1.1.1879--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pybiolib/1.1.1879--pyhdfd78af_0
$ module help quay.io/biocontainers/pybiolib/1.1.1879--pyhdfd78af_0
```
