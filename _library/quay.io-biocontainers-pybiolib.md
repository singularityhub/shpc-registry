...
updated_at: "2025-08-12 03:56:21.376044"
latest: "1.2.911--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/pybiolib:1.2.911--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pybiolib/1.2.911--pyhdfd78af_0
$ module help quay.io/biocontainers/pybiolib/1.2.911--pyhdfd78af_0
```
