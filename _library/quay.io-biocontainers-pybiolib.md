...
updated_at: "2024-07-28 03:17:39.044356"
latest: "1.1.2236--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/pybiolib:1.1.2236--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pybiolib/1.1.2236--pyhdfd78af_0
$ module help quay.io/biocontainers/pybiolib/1.1.2236--pyhdfd78af_0
```
