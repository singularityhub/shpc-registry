...
updated_at: "2023-11-26 02:53:35.018010"
latest: "1.1.1412--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/pybiolib:1.1.1412--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pybiolib/1.1.1412--pyhdfd78af_0
$ module help quay.io/biocontainers/pybiolib/1.1.1412--pyhdfd78af_0
```
