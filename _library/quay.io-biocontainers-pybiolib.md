...
updated_at: "2023-07-10 04:10:18.765976"
latest: "1.1.988--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/pybiolib:1.1.988--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pybiolib/1.1.988--pyhdfd78af_0
$ module help quay.io/biocontainers/pybiolib/1.1.988--pyhdfd78af_0
```
