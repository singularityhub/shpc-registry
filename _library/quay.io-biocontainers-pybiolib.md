...
updated_at: "2024-09-03 02:52:51.753630"
latest: "1.2.50--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/pybiolib:1.2.50--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pybiolib/1.2.50--pyhdfd78af_0
$ module help quay.io/biocontainers/pybiolib/1.2.50--pyhdfd78af_0
```
