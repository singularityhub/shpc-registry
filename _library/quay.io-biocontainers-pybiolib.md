...
updated_at: "2024-10-16 03:10:02.883414"
latest: "1.2.174--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/pybiolib:1.2.174--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pybiolib/1.2.174--pyhdfd78af_0
$ module help quay.io/biocontainers/pybiolib/1.2.174--pyhdfd78af_0
```
