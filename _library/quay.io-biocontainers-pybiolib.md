...
updated_at: "2025-05-23 03:19:09.165023"
latest: "1.2.783--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/pybiolib:1.2.783--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pybiolib/1.2.783--pyhdfd78af_0
$ module help quay.io/biocontainers/pybiolib/1.2.783--pyhdfd78af_0
```
