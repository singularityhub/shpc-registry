...
updated_at: "2024-07-03 02:43:34.132001"
latest: "1.1.2184--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/pybiolib:1.1.2184--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pybiolib/1.1.2184--pyhdfd78af_0
$ module help quay.io/biocontainers/pybiolib/1.1.2184--pyhdfd78af_0
```
