...
updated_at: "2025-01-17 03:30:16.398270"
latest: "1.2.257--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/pybiolib:1.2.257--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pybiolib/1.2.257--pyhdfd78af_0
$ module help quay.io/biocontainers/pybiolib/1.2.257--pyhdfd78af_0
```
