...
updated_at: "2025-03-06 03:53:08.677656"
latest: "1.2.502--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/pybiolib:1.2.502--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pybiolib/1.2.502--pyhdfd78af_0
$ module help quay.io/biocontainers/pybiolib/1.2.502--pyhdfd78af_0
```
