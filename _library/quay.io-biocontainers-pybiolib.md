...
updated_at: "2025-02-05 03:05:15.625559"
latest: "1.2.264--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/pybiolib:1.2.264--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pybiolib/1.2.264--pyhdfd78af_0
$ module help quay.io/biocontainers/pybiolib/1.2.264--pyhdfd78af_0
```
