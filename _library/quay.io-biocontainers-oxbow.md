...
updated_at: "2026-05-16 06:04:17.403737"
latest: "0.7.0--py311h5e00ca1_0"
...
```bash
$ shpc install quay.io/biocontainers/oxbow:0.7.0--py311h5e00ca1_0
```
...
```bash
$ module load quay.io/biocontainers/oxbow/0.7.0--py311h5e00ca1_0
$ module help quay.io/biocontainers/oxbow/0.7.0--py311h5e00ca1_0
```
