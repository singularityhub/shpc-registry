...
updated_at: "2025-10-15 03:26:16.690070"
...
```bash
$ shpc install quay.io/biocontainers/snakeobjects:3.1.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakeobjects/3.1.4--pyhdfd78af_0
$ module help quay.io/biocontainers/snakeobjects/3.1.4--pyhdfd78af_0
```
