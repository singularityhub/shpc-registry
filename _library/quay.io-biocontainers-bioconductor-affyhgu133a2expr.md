...
updated_at: "2026-04-02 05:15:48.014764"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-affyhgu133a2expr:1.46.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-affyhgu133a2expr/1.46.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-affyhgu133a2expr/1.46.0--r45hdfd78af_0
```
