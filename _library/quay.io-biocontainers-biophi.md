...
updated_at: "2024-07-08 03:01:04.108679"
latest: "1.0.9--pyhdfd78af_3"
...
```bash
$ shpc install quay.io/biocontainers/biophi:1.0.9--pyhdfd78af_3
```
...
```bash
$ module load quay.io/biocontainers/biophi/1.0.9--pyhdfd78af_3
$ module help quay.io/biocontainers/biophi/1.0.9--pyhdfd78af_3
```
