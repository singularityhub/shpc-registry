...
updated_at: "2024-12-27 03:30:29.573678"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ag.db:3.13.0--r43hdfd78af_4
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ag.db/3.13.0--r43hdfd78af_4
$ module help quay.io/biocontainers/bioconductor-ag.db/3.13.0--r43hdfd78af_4
```
