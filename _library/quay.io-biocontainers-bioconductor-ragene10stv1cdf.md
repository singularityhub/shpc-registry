...
updated_at: "2024-02-04 02:47:34.368671"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ragene10stv1cdf:2.18.0--r43hdfd78af_12
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ragene10stv1cdf/2.18.0--r43hdfd78af_12
$ module help quay.io/biocontainers/bioconductor-ragene10stv1cdf/2.18.0--r43hdfd78af_12
```
