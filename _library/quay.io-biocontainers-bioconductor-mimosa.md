...
updated_at: "2022-11-05 00:43:10.250662"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mimosa:1.32.0--r41hc247a5b_2
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mimosa/1.32.0--r41hc247a5b_2
$ module help quay.io/biocontainers/bioconductor-mimosa/1.32.0--r41hc247a5b_2
```
