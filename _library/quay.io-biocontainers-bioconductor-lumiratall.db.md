...
updated_at: "2026-04-04 04:50:35.599416"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-lumiratall.db:1.22.0--r45hdfd78af_14
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-lumiratall.db/1.22.0--r45hdfd78af_14
$ module help quay.io/biocontainers/bioconductor-lumiratall.db/1.22.0--r45hdfd78af_14
```
