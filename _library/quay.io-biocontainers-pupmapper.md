...
updated_at: "2025-10-07 03:03:04.155291"
...
```bash
$ shpc install quay.io/biocontainers/pupmapper:0.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pupmapper/0.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/pupmapper/0.1.0--pyhdfd78af_0
```
