...
updated_at: "2026-03-03 04:49:09.645590"
...
```bash
$ shpc install quay.io/biocontainers/pupmapper:0.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pupmapper/0.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/pupmapper/0.2.0--pyhdfd78af_0
```
