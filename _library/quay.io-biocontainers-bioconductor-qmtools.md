...
updated_at: "2024-12-05 03:58:45.688796"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-qmtools:1.6.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-qmtools/1.6.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-qmtools/1.6.0--r43hdfd78af_0
```
