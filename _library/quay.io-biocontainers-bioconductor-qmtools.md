...
updated_at: "2025-09-09 03:50:38.971515"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-qmtools:1.10.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-qmtools/1.10.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-qmtools/1.10.0--r44hdfd78af_0
```
