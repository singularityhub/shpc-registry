...
updated_at: "2023-08-11 02:25:07.962093"
latest: "2.24.1--r43hf17093f_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-linnorm:2.24.1--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-linnorm/2.24.1--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-linnorm/2.24.1--r43hf17093f_0
```
