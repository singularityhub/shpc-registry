...
updated_at: "2024-04-26 02:53:38.738591"
...
```bash
$ shpc install quay.io/biocontainers/cutesv:2.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/cutesv/2.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/cutesv/2.1.0--pyhdfd78af_0
```
