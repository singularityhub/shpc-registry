...
updated_at: "2023-11-22 02:46:33.186662"
...
```bash
$ shpc install quay.io/biocontainers/cutesv:2.0.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/cutesv/2.0.3--pyhdfd78af_0
$ module help quay.io/biocontainers/cutesv/2.0.3--pyhdfd78af_0
```
