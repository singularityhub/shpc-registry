...
updated_at: "2024-12-12 03:59:00.304282"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-katdetectr:1.4.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-katdetectr/1.4.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-katdetectr/1.4.0--r43hdfd78af_0
```
