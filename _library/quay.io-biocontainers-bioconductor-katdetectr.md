...
updated_at: "2023-11-20 02:43:45.599227"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-katdetectr:1.2.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-katdetectr/1.2.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-katdetectr/1.2.0--r43hdfd78af_0
```
