...
updated_at: "2025-10-03 03:34:13.732126"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-katdetectr:1.8.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-katdetectr/1.8.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-katdetectr/1.8.0--r44hdfd78af_0
```
