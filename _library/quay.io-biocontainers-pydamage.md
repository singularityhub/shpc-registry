...
updated_at: "2025-12-03 04:14:56.697547"
...
```bash
$ shpc install quay.io/biocontainers/pydamage:1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pydamage/1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/pydamage/1.0--pyhdfd78af_0
```
