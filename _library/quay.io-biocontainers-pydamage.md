...
updated_at: "2024-07-30 02:49:05.493349"
...
```bash
$ shpc install quay.io/biocontainers/pydamage:0.72--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pydamage/0.72--pyhdfd78af_0
$ module help quay.io/biocontainers/pydamage/0.72--pyhdfd78af_0
```
