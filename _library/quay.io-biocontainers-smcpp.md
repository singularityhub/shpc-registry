...
updated_at: "2026-05-29 06:20:52.362106"
...
```bash
$ shpc install quay.io/biocontainers/smcpp:1.15.4--py310h89ce22f_1
```
...
```bash
$ module load quay.io/biocontainers/smcpp/1.15.4--py310h89ce22f_1
$ module help quay.io/biocontainers/smcpp/1.15.4--py310h89ce22f_1
```
