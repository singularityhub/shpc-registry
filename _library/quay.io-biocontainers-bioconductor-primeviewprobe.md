...
updated_at: "2024-09-29 03:20:36.487955"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-primeviewprobe:2.18.0--r43hdfd78af_12
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-primeviewprobe/2.18.0--r43hdfd78af_12
$ module help quay.io/biocontainers/bioconductor-primeviewprobe/2.18.0--r43hdfd78af_12
```
