---
layout: container
name:  "quay.io/biocontainers/tesmall"
maintainer: "@vsoch"
...
updated_at: "2026-05-27 06:33:48.821150"
...
singularity registry hpc automated addition for tesmall
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/tesmall
```
...
#### tesmall-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### tesmall-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/TEsmall
$ podman run --it --rm --entrypoint /usr/local/bin/TEsmall   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/TEsmall   -v ${PWD} -w ${PWD} <container> -c " $@"
```
