...
updated_at: "2025-12-27 04:13:11.775219"
latest: "4.9.4--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/sourmash:4.9.4--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sourmash/4.9.4--hdfd78af_0
$ module help quay.io/biocontainers/sourmash/4.9.4--hdfd78af_0
```
