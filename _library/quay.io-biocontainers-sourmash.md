...
updated_at: "2024-07-30 02:45:35.978274"
latest: "4.8.10--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/sourmash:4.8.10--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sourmash/4.8.10--hdfd78af_0
$ module help quay.io/biocontainers/sourmash/4.8.10--hdfd78af_0
```
