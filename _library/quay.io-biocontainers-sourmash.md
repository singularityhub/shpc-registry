...
updated_at: "2025-01-27 07:21:41.148371"
latest: "4.8.12--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/sourmash:4.8.12--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sourmash/4.8.12--hdfd78af_0
$ module help quay.io/biocontainers/sourmash/4.8.12--hdfd78af_0
```
