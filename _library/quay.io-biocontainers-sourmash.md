...
updated_at: "2024-07-21 03:17:07.868874"
latest: "4.8.9--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/sourmash:4.8.9--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sourmash/4.8.9--hdfd78af_0
$ module help quay.io/biocontainers/sourmash/4.8.9--hdfd78af_0
```
