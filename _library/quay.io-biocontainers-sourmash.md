...
updated_at: "2025-03-19 03:28:56.617682"
latest: "4.8.14--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/sourmash:4.8.14--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sourmash/4.8.14--hdfd78af_0
$ module help quay.io/biocontainers/sourmash/4.8.14--hdfd78af_0
```
