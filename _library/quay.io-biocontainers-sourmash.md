...
updated_at: "2024-05-21 02:53:07.053590"
latest: "4.8.8--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/sourmash:4.8.8--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sourmash/4.8.8--hdfd78af_0
$ module help quay.io/biocontainers/sourmash/4.8.8--hdfd78af_0
```
