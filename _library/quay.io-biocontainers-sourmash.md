...
updated_at: "2025-06-02 12:58:26.114361"
latest: "4.9.0--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/sourmash:4.9.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sourmash/4.9.0--hdfd78af_0
$ module help quay.io/biocontainers/sourmash/4.9.0--hdfd78af_0
```
