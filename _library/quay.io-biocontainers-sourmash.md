...
updated_at: "2025-07-28 09:54:10.400330"
latest: "4.9.3--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/sourmash:4.9.3--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sourmash/4.9.3--hdfd78af_0
$ module help quay.io/biocontainers/sourmash/4.9.3--hdfd78af_0
```
