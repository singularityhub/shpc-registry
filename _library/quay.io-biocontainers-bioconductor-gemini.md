...
updated_at: "2026-03-15 05:23:50.084140"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gemini:1.24.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gemini/1.24.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-gemini/1.24.0--r45hdfd78af_0
```
