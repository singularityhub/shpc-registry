...
updated_at: "2024-10-16 03:01:33.299504"
...
```bash
$ shpc install quay.io/biocontainers/celltypist:1.6.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/celltypist/1.6.3--pyhdfd78af_0
$ module help quay.io/biocontainers/celltypist/1.6.3--pyhdfd78af_0
```
