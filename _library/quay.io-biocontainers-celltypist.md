...
updated_at: "2023-09-18 02:45:39.692119"
...
```bash
$ shpc install quay.io/biocontainers/celltypist:1.6.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/celltypist/1.6.0--pyhdfd78af_0
$ module help quay.io/biocontainers/celltypist/1.6.0--pyhdfd78af_0
```
