...
updated_at: "2023-07-10 03:33:46.103097"
...
```bash
$ shpc install quay.io/biocontainers/celltypist:1.5.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/celltypist/1.5.2--pyhdfd78af_0
$ module help quay.io/biocontainers/celltypist/1.5.2--pyhdfd78af_0
```
