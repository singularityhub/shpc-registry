...
updated_at: "2025-08-31 03:22:15.107448"
...
```bash
$ shpc install quay.io/biocontainers/celltypist:1.7.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/celltypist/1.7.1--pyhdfd78af_0
$ module help quay.io/biocontainers/celltypist/1.7.1--pyhdfd78af_0
```
