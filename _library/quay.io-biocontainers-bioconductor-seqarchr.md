...
updated_at: "2024-09-26 03:01:31.816640"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-seqarchr:1.6.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-seqarchr/1.6.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-seqarchr/1.6.0--r43hdfd78af_0
```
