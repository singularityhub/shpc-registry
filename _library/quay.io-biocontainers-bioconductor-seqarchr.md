...
updated_at: "2023-08-24 03:23:41.798909"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-seqarchr:1.4.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-seqarchr/1.4.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-seqarchr/1.4.0--r43hdfd78af_0
```
