...
updated_at: "2026-02-23 06:23:59.337150"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-m3dexampledata:1.36.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-m3dexampledata/1.36.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-m3dexampledata/1.36.0--r45hdfd78af_0
```
