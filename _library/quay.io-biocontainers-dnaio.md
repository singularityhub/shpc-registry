...
updated_at: "2024-07-15 03:19:45.914136"
latest: "1.2.1--py311hdad781d_1"
...
```bash
$ shpc install quay.io/biocontainers/dnaio:1.2.1--py311hdad781d_1
```
...
```bash
$ module load quay.io/biocontainers/dnaio/1.2.1--py311hdad781d_1
$ module help quay.io/biocontainers/dnaio/1.2.1--py311hdad781d_1
```
