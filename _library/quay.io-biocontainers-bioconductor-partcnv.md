...
updated_at: "2025-10-31 03:43:51.181850"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-partcnv:1.4.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-partcnv/1.4.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-partcnv/1.4.0--r44hdfd78af_0
```
