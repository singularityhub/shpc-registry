...
updated_at: "2024-12-09 03:59:00.697106"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-partcnv:1.0.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-partcnv/1.0.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-partcnv/1.0.0--r43hdfd78af_0
```
