...
updated_at: "2026-03-23 05:19:21.772678"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mafdb.1kgenomes.phase1.grch38:3.10.0--r45hdfd78af_11
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mafdb.1kgenomes.phase1.grch38/3.10.0--r45hdfd78af_11
$ module help quay.io/biocontainers/bioconductor-mafdb.1kgenomes.phase1.grch38/3.10.0--r45hdfd78af_11
```
