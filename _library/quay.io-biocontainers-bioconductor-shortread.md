...
updated_at: "2026-03-26 04:48:11.077400"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-shortread:1.68.0--r45ha27e39d_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-shortread/1.68.0--r45ha27e39d_0
$ module help quay.io/biocontainers/bioconductor-shortread/1.68.0--r45ha27e39d_0
```
