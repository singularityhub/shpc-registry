---
layout: container
name:  "quay.io/biocontainers/eastr-cpp"
maintainer: "@vsoch"
...
updated_at: "2026-02-25 05:06:07.203947"
...
singularity registry hpc automated addition for eastr-cpp
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/eastr-cpp
```
...
#### eastr-cpp-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### eastr-cpp-inspect-deffile:
