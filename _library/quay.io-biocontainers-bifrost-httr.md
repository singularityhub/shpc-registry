...
updated_at: "2025-07-04 03:43:31.346277"
...
```bash
$ shpc install quay.io/biocontainers/bifrost-httr:0.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bifrost-httr/0.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/bifrost-httr/0.2.0--pyhdfd78af_0
```
