...
updated_at: "2023-06-05 03:06:11.798618"
latest: "1.7.10--h9ee0642_0"
...
```bash
$ shpc install quay.io/biocontainers/gtotree:1.7.10--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/gtotree/1.7.10--h9ee0642_0
$ module help quay.io/biocontainers/gtotree/1.7.10--h9ee0642_0
```
