---
layout: container
name:  "quay.io/biocontainers/bigslice"
maintainer: "@vsoch"
...
updated_at: "2025-11-02 04:01:49.580900"
...
```bash
$ shpc install quay.io/biocontainers/bigslice
```
...
#### bigslice-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bigslice-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/bigslice
$ podman run --it --rm --entrypoint /usr/local/bin/bigslice   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/bigslice   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/download_bigslice_hmmdb
$ podman run --it --rm --entrypoint /usr/local/bin/download_bigslice_hmmdb   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/download_bigslice_hmmdb   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/vectorize_bgcs
$ podman run --it --rm --entrypoint /usr/local/bin/vectorize_bgcs   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/vectorize_bgcs   -v ${PWD} -w ${PWD} <container> -c " $@"
```
