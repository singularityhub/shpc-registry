...
updated_at: "2026-03-23 05:21:05.540176"
latest: "0.2.5--py313hdd269c3_0"
...
```bash
$ shpc install quay.io/biocontainers/pybigtools:0.2.5--py313hdd269c3_0
```
...
```bash
$ module load quay.io/biocontainers/pybigtools/0.2.5--py313hdd269c3_0
$ module help quay.io/biocontainers/pybigtools/0.2.5--py313hdd269c3_0
```
