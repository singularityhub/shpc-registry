...
updated_at: "2023-09-04 03:09:26.062367"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-deconrnaseq:1.42.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-deconrnaseq/1.42.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-deconrnaseq/1.42.0--r43hdfd78af_0
```
