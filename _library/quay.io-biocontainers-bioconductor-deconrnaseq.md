...
updated_at: "2022-10-29 08:23:31.039212"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-deconrnaseq:1.36.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-deconrnaseq/1.36.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-deconrnaseq/1.36.0--r41hdfd78af_0
```
