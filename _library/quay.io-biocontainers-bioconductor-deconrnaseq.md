...
updated_at: "2025-08-30 03:38:55.824302"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-deconrnaseq:1.48.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-deconrnaseq/1.48.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-deconrnaseq/1.48.0--r44hdfd78af_0
```
