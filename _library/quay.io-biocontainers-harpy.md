...
updated_at: "2025-07-31 11:24:40.323446"
...
```bash
$ shpc install quay.io/biocontainers/harpy:2.4--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/harpy/2.4--pyhdfd78af_1
$ module help quay.io/biocontainers/harpy/2.4--pyhdfd78af_1
```
