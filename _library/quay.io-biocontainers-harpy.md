...
updated_at: "2024-06-04 02:44:47.231136"
...
```bash
$ shpc install quay.io/biocontainers/harpy:0.9.1--py312h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/harpy/0.9.1--py312h9ee0642_0
$ module help quay.io/biocontainers/harpy/0.9.1--py312h9ee0642_0
```
