...
updated_at: "2024-09-09 03:21:29.180288"
latest: "1.8.0--py39h9e0f934_0"
...
```bash
$ shpc install quay.io/biocontainers/harpy:1.8.0--py39h9e0f934_0
```
...
```bash
$ module load quay.io/biocontainers/harpy/1.8.0--py39h9e0f934_0
$ module help quay.io/biocontainers/harpy/1.8.0--py39h9e0f934_0
```
