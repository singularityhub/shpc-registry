...
updated_at: "2026-01-01 04:07:03.505462"
...
```bash
$ shpc install quay.io/biocontainers/harpy:3.0.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/harpy/3.0.1--pyhdfd78af_0
$ module help quay.io/biocontainers/harpy/3.0.1--pyhdfd78af_0
```
