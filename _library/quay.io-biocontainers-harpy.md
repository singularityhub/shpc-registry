...
updated_at: "2023-09-19 03:07:27.711750"
...
```bash
$ shpc install quay.io/biocontainers/harpy:0.3.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/harpy/0.3.0--pyhdfd78af_0
$ module help quay.io/biocontainers/harpy/0.3.0--pyhdfd78af_0
```
