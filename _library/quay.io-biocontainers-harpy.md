...
updated_at: "2023-08-29 03:47:57.481956"
...
```bash
$ shpc install quay.io/biocontainers/harpy:0.2.0--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/harpy/0.2.0--h9ee0642_0
$ module help quay.io/biocontainers/harpy/0.2.0--h9ee0642_0
```
