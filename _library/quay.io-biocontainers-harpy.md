...
updated_at: "2023-05-31 03:29:47.530323"
...
```bash
$ shpc install quay.io/biocontainers/harpy:0.1.1--h9ee0642_1
```
...
```bash
$ module load quay.io/biocontainers/harpy/0.1.1--h9ee0642_1
$ module help quay.io/biocontainers/harpy/0.1.1--h9ee0642_1
```
