...
updated_at: "2026-07-02 06:55:42.312896"
...
```bash
$ shpc install quay.io/biocontainers/squigualiser:0.7.0--pyh84cbfca_0
```
...
```bash
$ module load quay.io/biocontainers/squigualiser/0.7.0--pyh84cbfca_0
$ module help quay.io/biocontainers/squigualiser/0.7.0--pyh84cbfca_0
```
