...
updated_at: "2026-04-03 04:52:39.037240"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-anaquin:2.34.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-anaquin/2.34.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-anaquin/2.34.0--r45hdfd78af_0
```
