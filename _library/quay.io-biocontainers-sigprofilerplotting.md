---
layout: container
name:  "quay.io/biocontainers/sigprofilerplotting"
maintainer: "@vsoch"
...
updated_at: "2026-02-19 04:29:58.798823"
...
```bash
$ shpc install quay.io/biocontainers/sigprofilerplotting
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/sigprofilerplotting:1.4.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sigprofilerplotting/1.4.3--pyhdfd78af_0
$ module help quay.io/biocontainers/sigprofilerplotting/1.4.3--pyhdfd78af_0
```
...
#### sigprofilerplotting-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### sigprofilerplotting-inspect-deffile:
