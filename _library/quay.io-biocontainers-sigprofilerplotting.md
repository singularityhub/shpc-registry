...
updated_at: "2025-02-03 03:28:36.416047"
latest: "1.3.24--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/sigprofilerplotting:1.3.24--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sigprofilerplotting/1.3.24--pyhdfd78af_0
$ module help quay.io/biocontainers/sigprofilerplotting/1.3.24--pyhdfd78af_0
```
