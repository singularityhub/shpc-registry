...
updated_at: "2025-04-29 03:35:41.885322"
...
```bash
$ shpc install quay.io/biocontainers/sigprofilerplotting:1.4.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sigprofilerplotting/1.4.1--pyhdfd78af_0
$ module help quay.io/biocontainers/sigprofilerplotting/1.4.1--pyhdfd78af_0
```
