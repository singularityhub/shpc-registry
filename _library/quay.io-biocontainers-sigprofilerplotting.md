...
updated_at: "2025-03-13 03:34:02.404021"
...
```bash
$ shpc install quay.io/biocontainers/sigprofilerplotting:1.4.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sigprofilerplotting/1.4.0--pyhdfd78af_0
$ module help quay.io/biocontainers/sigprofilerplotting/1.4.0--pyhdfd78af_0
```
