...
updated_at: "2026-05-31 06:52:51.019871"
latest: "1.3.2--pl5321hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/irma:1.3.2--pl5321hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/irma/1.3.2--pl5321hdfd78af_0
$ module help quay.io/biocontainers/irma/1.3.2--pl5321hdfd78af_0
```
