...
updated_at: "2025-08-06 03:56:52.936469"
...
```bash
$ shpc install quay.io/biocontainers/irma:1.2.0--pl5321hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/irma/1.2.0--pl5321hdfd78af_0
$ module help quay.io/biocontainers/irma/1.2.0--pl5321hdfd78af_0
```
