...
updated_at: "2026-03-16 05:32:23.359054"
latest: "2.30.1--r45hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rcy3:2.30.1--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rcy3/2.30.1--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rcy3/2.30.1--r45hdfd78af_0
```
