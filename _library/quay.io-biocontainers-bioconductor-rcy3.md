...
updated_at: "2025-04-21 03:34:34.120314"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rcy3:2.26.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rcy3/2.26.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rcy3/2.26.0--r44hdfd78af_0
```
