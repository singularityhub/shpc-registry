...
updated_at: "2024-01-05 02:31:26.551442"
...
```bash
$ shpc install quay.io/biocontainers/rmath4:4.3.1--py310h4b81fae_0
```
...
```bash
$ module load quay.io/biocontainers/rmath4/4.3.1--py310h4b81fae_0
$ module help quay.io/biocontainers/rmath4/4.3.1--py310h4b81fae_0
```
