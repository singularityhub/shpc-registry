...
updated_at: "2025-11-22 03:33:52.240783"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-splinetimer:1.34.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-splinetimer/1.34.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-splinetimer/1.34.0--r44hdfd78af_0
```
