...
updated_at: "2026-03-16 05:12:09.943052"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-splinetimer:1.38.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-splinetimer/1.38.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-splinetimer/1.38.0--r45hdfd78af_0
```
