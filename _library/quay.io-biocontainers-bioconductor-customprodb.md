...
updated_at: "2023-11-13 02:36:33.782398"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-customprodb:1.40.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-customprodb/1.40.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-customprodb/1.40.0--r43hdfd78af_0
```
