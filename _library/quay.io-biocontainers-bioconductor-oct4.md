...
updated_at: "2024-01-22 03:28:37.022813"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-oct4:1.18.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-oct4/1.18.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-oct4/1.18.0--r43hdfd78af_0
```
