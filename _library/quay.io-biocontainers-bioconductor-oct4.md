...
updated_at: "2023-09-22 04:06:40.426535"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-oct4:1.16.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-oct4/1.16.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-oct4/1.16.0--r43hdfd78af_0
```
