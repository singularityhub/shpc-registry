...
updated_at: "2026-03-28 05:11:35.859400"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-supersigs:1.18.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-supersigs/1.18.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-supersigs/1.18.0--r45hdfd78af_0
```
