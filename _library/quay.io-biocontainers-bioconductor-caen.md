...
updated_at: "2026-03-02 04:57:04.152916"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-caen:1.18.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-caen/1.18.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-caen/1.18.0--r45hdfd78af_0
```
