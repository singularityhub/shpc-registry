...
updated_at: "2026-03-29 05:14:32.396820"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-browserviz:2.32.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-browserviz/2.32.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-browserviz/2.32.0--r45hdfd78af_0
```
