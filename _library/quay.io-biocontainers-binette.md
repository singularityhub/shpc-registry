...
updated_at: "2026-04-05 04:54:33.093138"
latest: "1.2.1--pyh106432d_1"
...
```bash
$ shpc install quay.io/biocontainers/binette:1.2.1--pyh106432d_1
```
...
```bash
$ module load quay.io/biocontainers/binette/1.2.1--pyh106432d_1
$ module help quay.io/biocontainers/binette/1.2.1--pyh106432d_1
```
