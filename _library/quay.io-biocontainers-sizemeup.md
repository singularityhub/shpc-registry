...
updated_at: "2024-10-03 03:33:57.746527"
...
```bash
$ shpc install quay.io/biocontainers/sizemeup:1.2.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sizemeup/1.2.3--pyhdfd78af_0
$ module help quay.io/biocontainers/sizemeup/1.2.3--pyhdfd78af_0
```
