...
updated_at: "2022-11-17 03:29:01.337885"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-xina:1.8.0--r40hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-xina/1.8.0--r40hdfd78af_1
$ module help quay.io/biocontainers/bioconductor-xina/1.8.0--r40hdfd78af_1
```
