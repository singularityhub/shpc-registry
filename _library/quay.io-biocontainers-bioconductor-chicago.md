...
updated_at: "2026-03-19 05:04:09.054867"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-chicago:1.38.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-chicago/1.38.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-chicago/1.38.0--r45hdfd78af_0
```
