...
updated_at: "2024-05-15 03:15:33.296548"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-affy:1.80.0--r43ha9d7317_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-affy/1.80.0--r43ha9d7317_0
$ module help quay.io/biocontainers/bioconductor-affy/1.80.0--r43ha9d7317_0
```
