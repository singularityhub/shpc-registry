...
updated_at: "2026-03-13 16:29:19.215164"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-affy:1.88.0--r45h01b2380_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-affy/1.88.0--r45h01b2380_0
$ module help quay.io/biocontainers/bioconductor-affy/1.88.0--r45h01b2380_0
```
