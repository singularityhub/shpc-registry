...
updated_at: "2025-02-14 03:18:32.329057"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-affy:1.84.0--r44h3df3fcb_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-affy/1.84.0--r44h3df3fcb_0
$ module help quay.io/biocontainers/bioconductor-affy/1.84.0--r44h3df3fcb_0
```
