...
updated_at: "2026-06-24 06:37:56.625661"
...
```bash
$ shpc install quay.io/biocontainers/floco:1.1.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/floco/1.1.1--pyhdfd78af_0
$ module help quay.io/biocontainers/floco/1.1.1--pyhdfd78af_0
```
