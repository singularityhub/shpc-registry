...
updated_at: "2026-09-04 07:59:53.669981"
...
```bash
$ shpc install quay.io/biocontainers/floco:1.1.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/floco/1.1.2--pyhdfd78af_0
$ module help quay.io/biocontainers/floco/1.1.2--pyhdfd78af_0
```
