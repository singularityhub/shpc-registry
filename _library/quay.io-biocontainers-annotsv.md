...
updated_at: "2023-05-27 02:46:33.140083"
latest: "3.3.5--py311hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/annotsv:3.3.5--py311hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/annotsv/3.3.5--py311hdfd78af_0
$ module help quay.io/biocontainers/annotsv/3.3.5--py311hdfd78af_0
```
