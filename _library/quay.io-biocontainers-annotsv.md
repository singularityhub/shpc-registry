...
updated_at: "2026-05-05 05:49:47.251614"
latest: "3.5.8--hdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/annotsv:3.5.8--hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/annotsv/3.5.8--hdfd78af_1
$ module help quay.io/biocontainers/annotsv/3.5.8--hdfd78af_1
```
