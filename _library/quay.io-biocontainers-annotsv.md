...
updated_at: "2023-12-21 03:00:37.640078"
latest: "3.3.7--py312hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/annotsv:3.3.7--py312hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/annotsv/3.3.7--py312hdfd78af_0
$ module help quay.io/biocontainers/annotsv/3.3.7--py312hdfd78af_0
```
