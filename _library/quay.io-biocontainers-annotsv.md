...
updated_at: "2026-06-30 06:29:49.268569"
latest: "3.5.10--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/annotsv:3.5.10--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/annotsv/3.5.10--hdfd78af_0
$ module help quay.io/biocontainers/annotsv/3.5.10--hdfd78af_0
```
