...
updated_at: "2024-05-21 03:20:56.602157"
latest: "3.4--py312hdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/annotsv:3.4--py312hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/annotsv/3.4--py312hdfd78af_1
$ module help quay.io/biocontainers/annotsv/3.4--py312hdfd78af_1
```
