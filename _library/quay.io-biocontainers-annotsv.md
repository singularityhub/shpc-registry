...
updated_at: "2025-08-22 03:56:37.231864"
latest: "3.5--py313hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/annotsv:3.5--py313hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/annotsv/3.5--py313hdfd78af_0
$ module help quay.io/biocontainers/annotsv/3.5--py313hdfd78af_0
```
