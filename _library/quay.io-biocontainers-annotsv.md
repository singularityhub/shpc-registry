...
updated_at: "2024-01-17 03:02:08.291147"
latest: "3.3.8--py312hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/annotsv:3.3.8--py312hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/annotsv/3.3.8--py312hdfd78af_0
$ module help quay.io/biocontainers/annotsv/3.3.8--py312hdfd78af_0
```
