...
updated_at: "2023-12-21 02:39:35.484301"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-projectr:1.18.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-projectr/1.18.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-projectr/1.18.0--r43hdfd78af_0
```
