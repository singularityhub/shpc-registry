...
updated_at: "2025-01-15 02:47:58.371926"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-simpleseg:1.8.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-simpleseg/1.8.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-simpleseg/1.8.0--r44hdfd78af_0
```
