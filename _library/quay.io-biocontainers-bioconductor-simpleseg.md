...
updated_at: "2026-03-13 16:52:30.039836"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-simpleseg:1.12.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-simpleseg/1.12.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-simpleseg/1.12.0--r45hdfd78af_0
```
