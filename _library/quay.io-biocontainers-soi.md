---
layout: container
name:  "quay.io/biocontainers/soi"
maintainer: "@vsoch"
...
updated_at: "2026-01-06 03:44:54.641353"
...
singularity registry hpc automated addition for soi
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/soi
```
...
```bash
$ singularity exec <container> /usr/local/bin/soi
$ podman run --it --rm --entrypoint /usr/local/bin/soi   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/soi   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/soi-orth
$ podman run --it --rm --entrypoint /usr/local/bin/soi-orth   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/soi-orth   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/soi-syn
$ podman run --it --rm --entrypoint /usr/local/bin/soi-syn   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/soi-syn   -v ${PWD} -w ${PWD} <container> -c " $@"
```
