...
updated_at: "2024-04-04 03:59:24.066676"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cadd.v1.6.hg38:3.18.1--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cadd.v1.6.hg38/3.18.1--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-cadd.v1.6.hg38/3.18.1--r43hdfd78af_0
```
