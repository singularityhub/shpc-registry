...
updated_at: "2025-05-24 11:13:57.900267"
latest: "0.1.3--hc6f3cee_0"
...
```bash
$ shpc install quay.io/biocontainers/panman:0.1.3--hc6f3cee_0
```
...
```bash
$ module load quay.io/biocontainers/panman/0.1.3--hc6f3cee_0
$ module help quay.io/biocontainers/panman/0.1.3--hc6f3cee_0
```
