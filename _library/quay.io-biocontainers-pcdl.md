...
updated_at: "2025-05-24 11:35:58.728800"
latest: "3.3.6--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/pcdl:3.3.6--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pcdl/3.3.6--pyhdfd78af_0
$ module help quay.io/biocontainers/pcdl/3.3.6--pyhdfd78af_0
```
