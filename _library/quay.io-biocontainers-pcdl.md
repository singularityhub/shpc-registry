...
updated_at: "2026-05-08 05:08:28.840116"
...
```bash
$ shpc install quay.io/biocontainers/pcdl:4.1.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pcdl/4.1.5--pyhdfd78af_0
$ module help quay.io/biocontainers/pcdl/4.1.5--pyhdfd78af_0
```
