...
updated_at: "2026-09-25 07:55:49.890499"
...
```bash
$ shpc install quay.io/biocontainers/pcdl:4.1.9--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pcdl/4.1.9--pyhdfd78af_0
$ module help quay.io/biocontainers/pcdl/4.1.9--pyhdfd78af_0
```
