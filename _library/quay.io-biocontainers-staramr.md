...
updated_at: "2026-06-05 06:42:15.823224"
...
```bash
$ shpc install quay.io/biocontainers/staramr:0.12.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/staramr/0.12.2--pyhdfd78af_0
$ module help quay.io/biocontainers/staramr/0.12.2--pyhdfd78af_0
```
