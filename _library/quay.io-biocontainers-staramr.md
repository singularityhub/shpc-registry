...
updated_at: "2026-06-23 16:50:25.033369"
...
```bash
$ shpc install quay.io/biocontainers/staramr:0.12.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/staramr/0.12.3--pyhdfd78af_0
$ module help quay.io/biocontainers/staramr/0.12.3--pyhdfd78af_0
```
