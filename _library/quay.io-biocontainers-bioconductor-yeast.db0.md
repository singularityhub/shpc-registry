...
updated_at: "2026-04-03 15:32:42.951730"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-yeast.db0:3.22.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-yeast.db0/3.22.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-yeast.db0/3.22.0--r45hdfd78af_0
```
