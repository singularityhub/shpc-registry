...
updated_at: "2024-12-28 02:56:38.140272"
...
```bash
$ shpc install quay.io/biocontainers/virheat:0.7.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/virheat/0.7.3--pyhdfd78af_0
$ module help quay.io/biocontainers/virheat/0.7.3--pyhdfd78af_0
```
