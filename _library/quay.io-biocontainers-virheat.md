...
updated_at: "2024-07-26 02:39:18.189860"
...
```bash
$ shpc install quay.io/biocontainers/virheat:0.7--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/virheat/0.7--pyhdfd78af_0
$ module help quay.io/biocontainers/virheat/0.7--pyhdfd78af_0
```
