...
updated_at: "2024-11-12 03:41:59.760524"
...
```bash
$ shpc install quay.io/biocontainers/virheat:0.7.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/virheat/0.7.1--pyhdfd78af_0
$ module help quay.io/biocontainers/virheat/0.7.1--pyhdfd78af_0
```
