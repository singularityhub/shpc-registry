---
layout: container
name:  "quay.io/biocontainers/virheat"
maintainer: "@vsoch"
...
updated_at: "2023-12-16 02:58:20.571478"
...
```bash
$ shpc install quay.io/biocontainers/virheat
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/virheat:0.6--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/virheat/0.6--pyhdfd78af_0
$ module help quay.io/biocontainers/virheat/0.6--pyhdfd78af_0
```
...
#### virheat-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### virheat-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/virheat
$ podman run --it --rm --entrypoint /usr/local/bin/virheat   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/virheat   -v ${PWD} -w ${PWD} <container> -c " $@"
```
