...
updated_at: "2025-10-03 03:08:01.934771"
latest: "2.0.9--py311h8fb3dee_0"
...
```bash
$ shpc install quay.io/biocontainers/htseq:2.0.9--py311h8fb3dee_0
```
...
```bash
$ module load quay.io/biocontainers/htseq/2.0.9--py311h8fb3dee_0
$ module help quay.io/biocontainers/htseq/2.0.9--py311h8fb3dee_0
```
