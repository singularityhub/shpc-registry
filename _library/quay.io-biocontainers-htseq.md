...
updated_at: "2025-01-05 03:41:40.264749"
latest: "2.0.5--py310ha6711e0_3"
...
```bash
$ shpc install quay.io/biocontainers/htseq:2.0.5--py310ha6711e0_3
```
...
```bash
$ module load quay.io/biocontainers/htseq/2.0.5--py310ha6711e0_3
$ module help quay.io/biocontainers/htseq/2.0.5--py310ha6711e0_3
```
