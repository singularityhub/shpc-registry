...
updated_at: "2024-05-02 03:18:02.572354"
latest: "2.0.5--py310h5aa3a86_0"
...
```bash
$ shpc install quay.io/biocontainers/htseq:2.0.5--py310h5aa3a86_0
```
...
```bash
$ module load quay.io/biocontainers/htseq/2.0.5--py310h5aa3a86_0
$ module help quay.io/biocontainers/htseq/2.0.5--py310h5aa3a86_0
```
