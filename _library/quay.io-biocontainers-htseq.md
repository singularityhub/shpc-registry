...
updated_at: "2026-09-03 07:06:45.619122"
latest: "2.1.2--py311h0e292b2_3"
...
```bash
$ shpc install quay.io/biocontainers/htseq:2.1.2--py311h0e292b2_3
```
...
```bash
$ module load quay.io/biocontainers/htseq/2.1.2--py311h0e292b2_3
$ module help quay.io/biocontainers/htseq/2.1.2--py311h0e292b2_3
```
