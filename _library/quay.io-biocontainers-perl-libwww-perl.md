...
updated_at: "2025-10-03 03:05:31.932261"
latest: "6.80--pl5321hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/perl-libwww-perl:6.80--pl5321hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/perl-libwww-perl/6.80--pl5321hdfd78af_0
$ module help quay.io/biocontainers/perl-libwww-perl/6.80--pl5321hdfd78af_0
```
