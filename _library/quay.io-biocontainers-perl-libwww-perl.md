...
updated_at: "2026-05-28 06:43:25.144030"
latest: "6.82--pl5321hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/perl-libwww-perl:6.82--pl5321hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/perl-libwww-perl/6.82--pl5321hdfd78af_0
$ module help quay.io/biocontainers/perl-libwww-perl/6.82--pl5321hdfd78af_0
```
