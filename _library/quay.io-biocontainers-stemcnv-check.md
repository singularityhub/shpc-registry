...
updated_at: "2025-05-21 04:01:36.015692"
...
```bash
$ shpc install quay.io/biocontainers/stemcnv-check:0.5.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/stemcnv-check/0.5.1--pyhdfd78af_0
$ module help quay.io/biocontainers/stemcnv-check/0.5.1--pyhdfd78af_0
```
