...
updated_at: "2025-06-30 04:49:52.599542"
...
```bash
$ shpc install quay.io/biocontainers/stemcnv-check:0.5.1--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/stemcnv-check/0.5.1--pyhdfd78af_1
$ module help quay.io/biocontainers/stemcnv-check/0.5.1--pyhdfd78af_1
```
