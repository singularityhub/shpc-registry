...
updated_at: "2026-08-16 03:46:05.984551"
latest: "1.2.0--py312hfabe715_9"
...
```bash
$ shpc install quay.io/biocontainers/fastqsplitter:1.2.0--py312hfabe715_9
```
...
```bash
$ module load quay.io/biocontainers/fastqsplitter/1.2.0--py312hfabe715_9
$ module help quay.io/biocontainers/fastqsplitter/1.2.0--py312hfabe715_9
```
