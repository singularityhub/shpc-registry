...
updated_at: "2024-11-21 03:05:08.045701"
latest: "1.2.0--py312hf67a6ed_6"
...
```bash
$ shpc install quay.io/biocontainers/fastqsplitter:1.2.0--py312hf67a6ed_6
```
...
```bash
$ module load quay.io/biocontainers/fastqsplitter/1.2.0--py312hf67a6ed_6
$ module help quay.io/biocontainers/fastqsplitter/1.2.0--py312hf67a6ed_6
```
