...
updated_at: "2025-08-15 03:32:49.361757"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-progeny:1.28.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-progeny/1.28.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-progeny/1.28.0--r44hdfd78af_0
```
