...
updated_at: "2026-03-05 04:56:11.785493"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-beaddatapackr:1.62.0--r45h01b2380_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-beaddatapackr/1.62.0--r45h01b2380_0
$ module help quay.io/biocontainers/bioconductor-beaddatapackr/1.62.0--r45h01b2380_0
```
