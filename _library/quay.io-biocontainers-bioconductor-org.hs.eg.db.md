...
updated_at: "2026-04-05 05:26:44.911830"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-org.hs.eg.db:3.22.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-org.hs.eg.db/3.22.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-org.hs.eg.db/3.22.0--r45hdfd78af_0
```
