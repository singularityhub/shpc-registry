...
updated_at: "2023-07-14 03:29:41.548087"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cellid:1.6.0--r42hf17093f_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cellid/1.6.0--r42hf17093f_1
$ module help quay.io/biocontainers/bioconductor-cellid/1.6.0--r42hf17093f_1
```
