...
updated_at: "2024-01-11 03:00:08.493120"
latest: "1.1.1--py39hf95cd2a_0"
...
```bash
$ shpc install quay.io/biocontainers/ms-entropy:1.1.1--py39hf95cd2a_0
```
...
```bash
$ module load quay.io/biocontainers/ms-entropy/1.1.1--py39hf95cd2a_0
$ module help quay.io/biocontainers/ms-entropy/1.1.1--py39hf95cd2a_0
```
