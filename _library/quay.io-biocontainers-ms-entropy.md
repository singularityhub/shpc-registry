...
updated_at: "2025-03-09 03:00:24.886383"
...
```bash
$ shpc install quay.io/biocontainers/ms-entropy:1.3.4--py311h93dcfea_0
```
...
```bash
$ module load quay.io/biocontainers/ms-entropy/1.3.4--py311h93dcfea_0
$ module help quay.io/biocontainers/ms-entropy/1.3.4--py311h93dcfea_0
```
