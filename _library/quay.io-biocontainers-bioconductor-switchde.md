...
updated_at: "2026-03-05 00:55:53.534427"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-switchde:1.36.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-switchde/1.36.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-switchde/1.36.0--r45hdfd78af_0
```
