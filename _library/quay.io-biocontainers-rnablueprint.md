...
updated_at: "2025-11-26 03:59:46.358258"
...
```bash
$ shpc install quay.io/biocontainers/rnablueprint:1.3.3--py311pl5321h6accb3f_0
```
...
```bash
$ module load quay.io/biocontainers/rnablueprint/1.3.3--py311pl5321h6accb3f_0
$ module help quay.io/biocontainers/rnablueprint/1.3.3--py311pl5321h6accb3f_0
```
