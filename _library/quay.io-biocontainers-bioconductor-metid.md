...
updated_at: "2026-03-09 05:09:19.462468"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-metid:1.28.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-metid/1.28.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-metid/1.28.0--r45hdfd78af_0
```
