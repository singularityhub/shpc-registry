...
updated_at: "2022-11-12 00:45:52.008469"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-metid:1.8.0--r40hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-metid/1.8.0--r40hdfd78af_1
$ module help quay.io/biocontainers/bioconductor-metid/1.8.0--r40hdfd78af_1
```
