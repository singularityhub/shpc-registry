...
updated_at: "2024-05-05 02:33:40.743741"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-biocpkgtools:1.20.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-biocpkgtools/1.20.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-biocpkgtools/1.20.0--r43hdfd78af_0
```
