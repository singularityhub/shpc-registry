...
updated_at: "2026-04-05 05:22:32.414489"
latest: "1.28.3--r45hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-biocpkgtools:1.28.3--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-biocpkgtools/1.28.3--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-biocpkgtools/1.28.3--r45hdfd78af_0
```
