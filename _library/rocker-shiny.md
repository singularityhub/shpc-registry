...
updated_at: "2026-07-01 06:36:22.932831"
latest: "4.6.1"
...
```bash
$ shpc install rocker/shiny:4.6.1
```
...
```bash
$ module load rocker/shiny/4.6.1
$ module help rocker/shiny/4.6.1
```
