...
updated_at: "2026-06-23 06:10:02.471155"
latest: "4.6.0"
...
```bash
$ shpc install rocker/shiny:4.6.0
```
...
```bash
$ module load rocker/shiny/4.6.0
$ module help rocker/shiny/4.6.0
```
