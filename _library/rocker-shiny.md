...
updated_at: "2026-04-05 05:31:47.360988"
latest: "4.5.3"
...
```bash
$ shpc install rocker/shiny:4.5.3
```
...
```bash
$ module load rocker/shiny/4.5.3
$ module help rocker/shiny/4.5.3
```
