...
updated_at: "2025-11-29 03:12:46.635267"
latest: "4.5.2"
...
```bash
$ shpc install rocker/shiny:4.5.2
```
...
```bash
$ module load rocker/shiny/4.5.2
$ module help rocker/shiny/4.5.2
```
