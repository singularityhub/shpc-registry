---
layout: container
name:  "quay.io/biocontainers/bioconductor-centreprecomputed"
maintainer: "@vsoch"
...
updated_at: "2026-03-05 04:39:09.330721"
...
versions:
 - "1.0.0--r45hdfd78af_0"
description: "singularity registry hpc automated addition for bioconductor-centreprecomputed"
config: {"url": "https://biocontainers.pro/tools/bioconductor-centreprecomputed", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for bioconductor-centreprecomputed", "latest": {"1.0.0--r45hdfd78af_0": "sha256:14d8150f9f3cc2f72635089ef812ed73b6aa138ff535949d3907b171e80c17c4"}, "tags": {"1.0.0--r45hdfd78af_0": "sha256:14d8150f9f3cc2f72635089ef812ed73b6aa138ff535949d3907b171e80c17c4"}, "docker": "quay.io/biocontainers/bioconductor-centreprecomputed", "aliases": {"idle3.14": "/usr/local/bin/idle3.14", "pydoc3.14": "/usr/local/bin/pydoc3.14", "python3.14": "/usr/local/bin/python3.14", "python3.14-config": "/usr/local/bin/python3.14-config", "x86_64-conda-linux-gnu.cfg": "/usr/local/bin/x86_64-conda-linux-gnu.cfg", "installBiocDataPackage.sh": "/usr/local/bin/installBiocDataPackage.sh", "tomlq": "/usr/local/bin/tomlq", "xq": "/usr/local/bin/xq", "yq": "/usr/local/bin/yq", "jq": "/usr/local/bin/jq", "onig-config": "/usr/local/bin/onig-config", "activate-global-python-argcomplete": "/usr/local/bin/activate-global-python-argcomplete", "python-argcomplete-check-easy-install-script": "/usr/local/bin/python-argcomplete-check-easy-install-script", "register-python-argcomplete": "/usr/local/bin/register-python-argcomplete", "hb-info": "/usr/local/bin/hb-info", "tjbench": "/usr/local/bin/tjbench"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/bioconductor-centreprecomputed.
singularity registry hpc automated addition for bioconductor-centreprecomputed
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/bioconductor-centreprecomputed
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-centreprecomputed:1.0.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-centreprecomputed/1.0.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-centreprecomputed/1.0.0--r45hdfd78af_0
```
...
#### bioconductor-centreprecomputed-run:
...
#### bioconductor-centreprecomputed-shell:
...
#### bioconductor-centreprecomputed-exec:
...
#### bioconductor-centreprecomputed-inspect:
...
#### bioconductor-centreprecomputed-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-centreprecomputed-inspect-deffile:
