...
updated_at: "2026-03-31 04:45:49.349447"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-uniquorn:2.30.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-uniquorn/2.30.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-uniquorn/2.30.0--r45hdfd78af_0
```
