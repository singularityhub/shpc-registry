...
updated_at: "2023-11-27 02:34:53.043542"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-r3cpet:1.32.0--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-r3cpet/1.32.0--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-r3cpet/1.32.0--r43hf17093f_0
```
