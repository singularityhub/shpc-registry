...
updated_at: "2024-09-07 02:49:15.637767"
latest: "4.5.4--py310h9ee0642_1"
...
```bash
$ shpc install quay.io/biocontainers/sepp:4.5.4--py310h9ee0642_1
```
...
```bash
$ module load quay.io/biocontainers/sepp/4.5.4--py310h9ee0642_1
$ module help quay.io/biocontainers/sepp/4.5.4--py310h9ee0642_1
```
