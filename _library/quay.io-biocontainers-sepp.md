...
updated_at: "2026-06-28 06:29:52.914552"
latest: "4.5.6--py313h106432d_5"
...
```bash
$ shpc install quay.io/biocontainers/sepp:4.5.6--py313h106432d_5
```
...
```bash
$ module load quay.io/biocontainers/sepp/4.5.6--py313h106432d_5
$ module help quay.io/biocontainers/sepp/4.5.6--py313h106432d_5
```
