...
updated_at: "2023-08-05 02:37:22.890937"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mguatlas5k.db:3.2.3--r43hdfd78af_11
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mguatlas5k.db/3.2.3--r43hdfd78af_11
$ module help quay.io/biocontainers/bioconductor-mguatlas5k.db/3.2.3--r43hdfd78af_11
```
