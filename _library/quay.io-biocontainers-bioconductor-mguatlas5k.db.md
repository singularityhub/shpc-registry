...
updated_at: "2026-03-23 05:07:57.587153"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mguatlas5k.db:3.2.3--r45hdfd78af_14
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mguatlas5k.db/3.2.3--r45hdfd78af_14
$ module help quay.io/biocontainers/bioconductor-mguatlas5k.db/3.2.3--r45hdfd78af_14
```
