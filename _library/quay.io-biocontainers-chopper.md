...
updated_at: "2024-12-18 03:10:29.997617"
...
```bash
$ shpc install quay.io/biocontainers/chopper:0.9.0--hdcf5f25_1
```
...
```bash
$ module load quay.io/biocontainers/chopper/0.9.0--hdcf5f25_1
$ module help quay.io/biocontainers/chopper/0.9.0--hdcf5f25_1
```
