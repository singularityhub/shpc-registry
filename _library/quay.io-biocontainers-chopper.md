...
updated_at: "2026-07-02 06:44:32.040088"
latest: "0.13.0--h7f49ad2_0"
...
```bash
$ shpc install quay.io/biocontainers/chopper:0.13.0--h7f49ad2_0
```
...
```bash
$ module load quay.io/biocontainers/chopper/0.13.0--h7f49ad2_0
$ module help quay.io/biocontainers/chopper/0.13.0--h7f49ad2_0
```
