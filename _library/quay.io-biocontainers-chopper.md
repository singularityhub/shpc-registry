...
updated_at: "2026-04-05 05:29:22.736295"
latest: "0.12.0--hcdda2d0_0"
...
```bash
$ shpc install quay.io/biocontainers/chopper:0.12.0--hcdda2d0_0
```
...
```bash
$ module load quay.io/biocontainers/chopper/0.12.0--hcdda2d0_0
$ module help quay.io/biocontainers/chopper/0.12.0--hcdda2d0_0
```
