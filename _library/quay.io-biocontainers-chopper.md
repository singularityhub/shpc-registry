...
updated_at: "2025-04-09 03:07:05.430289"
...
```bash
$ shpc install quay.io/biocontainers/chopper:0.9.2--hcdda2d0_0
```
...
```bash
$ module load quay.io/biocontainers/chopper/0.9.2--hcdda2d0_0
$ module help quay.io/biocontainers/chopper/0.9.2--hcdda2d0_0
```
