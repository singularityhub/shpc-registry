...
updated_at: "2023-05-02 03:03:04.682883"
latest: "0.4.0--hd03093a_0"
...
```bash
$ shpc install quay.io/biocontainers/chopper:0.4.0--hd03093a_0
```
...
```bash
$ module load quay.io/biocontainers/chopper/0.4.0--hd03093a_0
$ module help quay.io/biocontainers/chopper/0.4.0--hd03093a_0
```
