...
updated_at: "2025-03-11 03:00:59.256009"
latest: "0.9.1--hcdda2d0_0"
...
```bash
$ shpc install quay.io/biocontainers/chopper:0.9.1--hcdda2d0_0
```
...
```bash
$ module load quay.io/biocontainers/chopper/0.9.1--hcdda2d0_0
$ module help quay.io/biocontainers/chopper/0.9.1--hcdda2d0_0
```
