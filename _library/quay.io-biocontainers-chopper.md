...
updated_at: "2024-10-17 18:46:30.618035"
...
```bash
$ shpc install quay.io/biocontainers/chopper:0.9.0--hdcf5f25_0
```
...
```bash
$ module load quay.io/biocontainers/chopper/0.9.0--hdcf5f25_0
$ module help quay.io/biocontainers/chopper/0.9.0--hdcf5f25_0
```
