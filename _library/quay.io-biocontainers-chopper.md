...
updated_at: "2025-10-02 04:22:35.898162"
latest: "0.10.0--hcdda2d0_0"
...
```bash
$ shpc install quay.io/biocontainers/chopper:0.10.0--hcdda2d0_0
```
...
```bash
$ module load quay.io/biocontainers/chopper/0.10.0--hcdda2d0_0
$ module help quay.io/biocontainers/chopper/0.10.0--hcdda2d0_0
```
