...
updated_at: "2025-08-21 03:22:23.757635"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-geneplast:1.32.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-geneplast/1.32.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-geneplast/1.32.0--r44hdfd78af_0
```
