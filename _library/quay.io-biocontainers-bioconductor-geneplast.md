...
updated_at: "2023-12-19 03:06:18.465184"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-geneplast:1.28.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-geneplast/1.28.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-geneplast/1.28.0--r43hdfd78af_0
```
