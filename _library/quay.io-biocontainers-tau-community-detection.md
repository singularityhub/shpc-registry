...
updated_at: "2026-08-26 03:42:30.963338"
...
```bash
$ shpc install quay.io/biocontainers/tau-community-detection:1.4.7--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/tau-community-detection/1.4.7--pyhdfd78af_0
$ module help quay.io/biocontainers/tau-community-detection/1.4.7--pyhdfd78af_0
```
