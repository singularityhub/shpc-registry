...
updated_at: "2025-03-19 03:39:52.357540"
latest: "2.8.0--r44h3df3fcb_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-targetsearch:2.8.0--r44h3df3fcb_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-targetsearch/2.8.0--r44h3df3fcb_0
$ module help quay.io/biocontainers/bioconductor-targetsearch/2.8.0--r44h3df3fcb_0
```
