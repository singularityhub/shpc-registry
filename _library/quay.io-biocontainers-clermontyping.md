...
updated_at: "2024-07-15 02:51:34.466219"
latest: "1.0.2--py312hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/clermontyping:1.0.2--py312hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/clermontyping/1.0.2--py312hdfd78af_0
$ module help quay.io/biocontainers/clermontyping/1.0.2--py312hdfd78af_0
```
