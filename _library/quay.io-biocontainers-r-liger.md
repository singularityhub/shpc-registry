...
updated_at: "2025-02-11 03:35:30.023158"
latest: "2.1.0--r44h165a49b_2"
...
```bash
$ shpc install quay.io/biocontainers/r-liger:2.1.0--r44h165a49b_2
```
...
```bash
$ module load quay.io/biocontainers/r-liger/2.1.0--r44h165a49b_2
$ module help quay.io/biocontainers/r-liger/2.1.0--r44h165a49b_2
```
