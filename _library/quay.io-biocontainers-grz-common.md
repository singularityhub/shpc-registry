...
updated_at: "2025-12-08 04:13:47.755910"
...
```bash
$ shpc install quay.io/biocontainers/grz-common:1.5.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/grz-common/1.5.0--pyhdfd78af_0
$ module help quay.io/biocontainers/grz-common/1.5.0--pyhdfd78af_0
```
