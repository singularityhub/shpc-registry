...
updated_at: "2026-08-14 04:42:49.404822"
...
```bash
$ shpc install quay.io/biocontainers/grz-common:2.1.0--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/grz-common/2.1.0--pyhdfd78af_1
$ module help quay.io/biocontainers/grz-common/2.1.0--pyhdfd78af_1
```
