...
updated_at: "2025-08-04 04:40:47.953750"
...
```bash
$ shpc install quay.io/biocontainers/grz-common:1.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/grz-common/1.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/grz-common/1.2.0--pyhdfd78af_0
```
