...
updated_at: "2026-09-04 07:19:25.539366"
...
```bash
$ shpc install quay.io/biocontainers/grz-common:3.0.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/grz-common/3.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/grz-common/3.0.0--pyhdfd78af_0
```
