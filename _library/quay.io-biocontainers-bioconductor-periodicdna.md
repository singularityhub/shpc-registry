...
updated_at: "2022-11-08 00:23:57.391487"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-periodicdna:1.4.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-periodicdna/1.4.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-periodicdna/1.4.0--r41hdfd78af_0
```
