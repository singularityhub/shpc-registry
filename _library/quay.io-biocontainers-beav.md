...
updated_at: "2024-01-18 03:07:24.727149"
...
```bash
$ shpc install quay.io/biocontainers/beav:1.0.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/beav/1.0.0--hdfd78af_0
$ module help quay.io/biocontainers/beav/1.0.0--hdfd78af_0
```
