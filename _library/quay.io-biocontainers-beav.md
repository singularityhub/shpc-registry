...
updated_at: "2024-11-29 03:19:57.069487"
...
```bash
$ shpc install quay.io/biocontainers/beav:1.4.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/beav/1.4.0--hdfd78af_0
$ module help quay.io/biocontainers/beav/1.4.0--hdfd78af_0
```
