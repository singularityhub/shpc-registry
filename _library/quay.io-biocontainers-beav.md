...
updated_at: "2024-06-24 03:12:36.604641"
...
```bash
$ shpc install quay.io/biocontainers/beav:1.3.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/beav/1.3.0--hdfd78af_0
$ module help quay.io/biocontainers/beav/1.3.0--hdfd78af_0
```
