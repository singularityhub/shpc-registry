...
updated_at: "2024-04-06 02:40:27.520389"
...
```bash
$ shpc install quay.io/biocontainers/beav:1.1.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/beav/1.1.0--hdfd78af_0
$ module help quay.io/biocontainers/beav/1.1.0--hdfd78af_0
```
