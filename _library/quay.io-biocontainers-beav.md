...
updated_at: "2023-06-20 02:55:35.589084"
latest: "0.0.13--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/beav:0.0.13--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/beav/0.0.13--hdfd78af_0
$ module help quay.io/biocontainers/beav/0.0.13--hdfd78af_0
```
