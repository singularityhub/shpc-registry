...
updated_at: "2023-11-06 03:08:57.256975"
...
```bash
$ shpc install quay.io/biocontainers/beav:0.5.2--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/beav/0.5.2--hdfd78af_0
$ module help quay.io/biocontainers/beav/0.5.2--hdfd78af_0
```
