...
updated_at: "2024-01-25 03:05:16.276020"
latest: "0.5.0--h4ac6f70_2"
...
```bash
$ shpc install quay.io/biocontainers/ncbi-fcs-gx:0.5.0--h4ac6f70_2
```
...
```bash
$ module load quay.io/biocontainers/ncbi-fcs-gx/0.5.0--h4ac6f70_2
$ module help quay.io/biocontainers/ncbi-fcs-gx/0.5.0--h4ac6f70_2
```
