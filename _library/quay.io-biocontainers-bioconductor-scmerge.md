...
updated_at: "2024-05-24 03:14:36.816874"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-scmerge:1.18.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-scmerge/1.18.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-scmerge/1.18.0--r43hdfd78af_0
```
