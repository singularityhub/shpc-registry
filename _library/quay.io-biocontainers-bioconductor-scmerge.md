...
updated_at: "2025-08-31 03:56:34.465532"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-scmerge:1.22.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-scmerge/1.22.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-scmerge/1.22.0--r44hdfd78af_0
```
