...
updated_at: "2026-04-03 05:10:37.614672"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-metabolomicsworkbenchr:1.20.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-metabolomicsworkbenchr/1.20.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-metabolomicsworkbenchr/1.20.0--r45hdfd78af_0
```
