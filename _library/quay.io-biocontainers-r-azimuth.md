---
layout: container
name:  "quay.io/biocontainers/r-azimuth"
maintainer: "@vsoch"
...
updated_at: "2024-12-11 03:21:26.089847"
...
```bash
$ shpc install quay.io/biocontainers/r-azimuth
```
...
#### r-azimuth-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-azimuth-inspect-deffile:
