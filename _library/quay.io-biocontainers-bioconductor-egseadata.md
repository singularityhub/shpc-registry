...
updated_at: "2026-04-05 04:53:08.125650"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-egseadata:1.38.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-egseadata/1.38.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-egseadata/1.38.0--r45hdfd78af_0
```
