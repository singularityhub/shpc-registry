...
updated_at: "2025-10-09 05:02:21.937495"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-egseadata:1.34.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-egseadata/1.34.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-egseadata/1.34.0--r44hdfd78af_0
```
