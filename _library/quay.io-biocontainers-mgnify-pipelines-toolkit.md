...
updated_at: "2024-04-29 02:37:49.955101"
...
```bash
$ shpc install quay.io/biocontainers/mgnify-pipelines-toolkit:0.1.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mgnify-pipelines-toolkit/0.1.2--pyhdfd78af_0
$ module help quay.io/biocontainers/mgnify-pipelines-toolkit/0.1.2--pyhdfd78af_0
```
