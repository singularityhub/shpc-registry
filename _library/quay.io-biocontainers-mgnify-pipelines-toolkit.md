...
updated_at: "2026-03-28 16:57:14.447454"
latest: "1.4.21--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/mgnify-pipelines-toolkit:1.4.21--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mgnify-pipelines-toolkit/1.4.21--pyhdfd78af_0
$ module help quay.io/biocontainers/mgnify-pipelines-toolkit/1.4.21--pyhdfd78af_0
```
