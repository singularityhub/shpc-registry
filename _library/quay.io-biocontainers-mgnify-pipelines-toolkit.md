...
updated_at: "2025-07-27 03:50:44.171631"
...
```bash
$ shpc install quay.io/biocontainers/mgnify-pipelines-toolkit:1.2.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mgnify-pipelines-toolkit/1.2.1--pyhdfd78af_0
$ module help quay.io/biocontainers/mgnify-pipelines-toolkit/1.2.1--pyhdfd78af_0
```
