...
updated_at: "2025-10-13 04:25:41.144784"
latest: "1.2.10--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/mgnify-pipelines-toolkit:1.2.10--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mgnify-pipelines-toolkit/1.2.10--pyhdfd78af_0
$ module help quay.io/biocontainers/mgnify-pipelines-toolkit/1.2.10--pyhdfd78af_0
```
