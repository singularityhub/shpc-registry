...
updated_at: "2025-11-06 04:27:48.819121"
...
```bash
$ shpc install quay.io/biocontainers/mgnify-pipelines-toolkit:1.3.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mgnify-pipelines-toolkit/1.3.0--pyhdfd78af_0
$ module help quay.io/biocontainers/mgnify-pipelines-toolkit/1.3.0--pyhdfd78af_0
```
