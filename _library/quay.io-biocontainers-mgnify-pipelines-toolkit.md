...
updated_at: "2025-08-22 03:44:35.094345"
...
```bash
$ shpc install quay.io/biocontainers/mgnify-pipelines-toolkit:1.2.7--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mgnify-pipelines-toolkit/1.2.7--pyhdfd78af_0
$ module help quay.io/biocontainers/mgnify-pipelines-toolkit/1.2.7--pyhdfd78af_0
```
