...
updated_at: "2025-08-28 03:09:49.214971"
...
```bash
$ shpc install quay.io/biocontainers/mgnify-pipelines-toolkit:1.2.8--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mgnify-pipelines-toolkit/1.2.8--pyhdfd78af_0
$ module help quay.io/biocontainers/mgnify-pipelines-toolkit/1.2.8--pyhdfd78af_0
```
