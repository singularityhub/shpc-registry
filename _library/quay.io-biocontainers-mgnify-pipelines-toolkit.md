...
updated_at: "2025-05-17 03:49:19.819318"
...
```bash
$ shpc install quay.io/biocontainers/mgnify-pipelines-toolkit:1.0.8--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mgnify-pipelines-toolkit/1.0.8--pyhdfd78af_0
$ module help quay.io/biocontainers/mgnify-pipelines-toolkit/1.0.8--pyhdfd78af_0
```
