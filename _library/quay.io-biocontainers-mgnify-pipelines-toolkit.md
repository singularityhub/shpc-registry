...
updated_at: "2026-02-04 04:55:16.203606"
latest: "1.4.15--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/mgnify-pipelines-toolkit:1.4.15--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mgnify-pipelines-toolkit/1.4.15--pyhdfd78af_0
$ module help quay.io/biocontainers/mgnify-pipelines-toolkit/1.4.15--pyhdfd78af_0
```
