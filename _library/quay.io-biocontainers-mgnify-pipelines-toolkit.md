...
updated_at: "2026-08-25 03:40:59.800265"
...
```bash
$ shpc install quay.io/biocontainers/mgnify-pipelines-toolkit:1.5.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mgnify-pipelines-toolkit/1.5.4--pyhdfd78af_0
$ module help quay.io/biocontainers/mgnify-pipelines-toolkit/1.5.4--pyhdfd78af_0
```
