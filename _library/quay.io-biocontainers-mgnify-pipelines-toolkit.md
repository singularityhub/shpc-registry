...
updated_at: "2025-06-03 03:57:45.546678"
...
```bash
$ shpc install quay.io/biocontainers/mgnify-pipelines-toolkit:1.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mgnify-pipelines-toolkit/1.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/mgnify-pipelines-toolkit/1.2.0--pyhdfd78af_0
```
