...
updated_at: "2026-05-27 06:30:11.096667"
...
```bash
$ shpc install quay.io/biocontainers/mgnify-pipelines-toolkit:1.5.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mgnify-pipelines-toolkit/1.5.1--pyhdfd78af_0
$ module help quay.io/biocontainers/mgnify-pipelines-toolkit/1.5.1--pyhdfd78af_0
```
