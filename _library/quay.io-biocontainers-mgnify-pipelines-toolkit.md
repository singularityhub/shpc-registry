...
updated_at: "2026-01-05 04:37:31.218562"
...
```bash
$ shpc install quay.io/biocontainers/mgnify-pipelines-toolkit:1.4.9--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mgnify-pipelines-toolkit/1.4.9--pyhdfd78af_0
$ module help quay.io/biocontainers/mgnify-pipelines-toolkit/1.4.9--pyhdfd78af_0
```
