...
updated_at: "2025-02-19 03:23:33.850447"
...
```bash
$ shpc install quay.io/biocontainers/mgnify-pipelines-toolkit:0.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mgnify-pipelines-toolkit/0.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/mgnify-pipelines-toolkit/0.2.0--pyhdfd78af_0
```
