...
updated_at: "2025-01-20 02:56:58.932079"
...
```bash
$ shpc install quay.io/biocontainers/mgnify-pipelines-toolkit:0.1.8--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mgnify-pipelines-toolkit/0.1.8--pyhdfd78af_0
$ module help quay.io/biocontainers/mgnify-pipelines-toolkit/0.1.8--pyhdfd78af_0
```
