...
updated_at: "2025-12-07 04:20:19.219710"
...
```bash
$ shpc install quay.io/biocontainers/mgnify-pipelines-toolkit:1.4.6--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mgnify-pipelines-toolkit/1.4.6--pyhdfd78af_0
$ module help quay.io/biocontainers/mgnify-pipelines-toolkit/1.4.6--pyhdfd78af_0
```
