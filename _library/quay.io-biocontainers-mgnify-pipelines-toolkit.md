...
updated_at: "2026-03-23 05:11:19.124653"
latest: "1.4.17--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/mgnify-pipelines-toolkit:1.4.17--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mgnify-pipelines-toolkit/1.4.17--pyhdfd78af_0
$ module help quay.io/biocontainers/mgnify-pipelines-toolkit/1.4.17--pyhdfd78af_0
```
