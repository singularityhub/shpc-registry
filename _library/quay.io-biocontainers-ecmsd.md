...
updated_at: "2026-03-29 05:11:39.227007"
...
```bash
$ shpc install quay.io/biocontainers/ecmsd:1.1.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ecmsd/1.1.0--hdfd78af_0
$ module help quay.io/biocontainers/ecmsd/1.1.0--hdfd78af_0
```
