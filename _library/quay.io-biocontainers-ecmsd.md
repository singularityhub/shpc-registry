---
layout: container
name:  "quay.io/biocontainers/ecmsd"
maintainer: "@vsoch"
github: "https://github.com/singularityhub/shpc-registry/blob/main/quay.io/biocontainers/ecmsd/container.yaml"
config_url: "https://raw.githubusercontent.com/singularityhub/shpc-registry/main/quay.io/biocontainers/ecmsd/container.yaml"
updated_at: "2026-09-25 08:10:38.169294"
latest: "1.3.2--hdfd78af_0"
container_url: "https://biocontainers.pro/tools/ecmsd"
aliases:
 - "ECMSD"
 - "alignrandom.sh"
 - "bamlinestreamer.sh"
...
```bash
$ module load quay.io/biocontainers/ecmsd/1.3.2--hdfd78af_0
$ module help quay.io/biocontainers/ecmsd/1.3.2--hdfd78af_0
```
...
#### ecmsd-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### ecmsd-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/ECMSD
$ podman run --it --rm --entrypoint /usr/local/bin/ECMSD   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/ECMSD   -v ${PWD} -w ${PWD} <container> -c " $@"
```
