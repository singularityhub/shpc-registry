...
updated_at: "2024-06-08 02:50:19.770358"
latest: "0.99.15--r43hdfd78af_4"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-genomicstate:0.99.15--r43hdfd78af_4
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-genomicstate/0.99.15--r43hdfd78af_4
$ module help quay.io/biocontainers/bioconductor-genomicstate/0.99.15--r43hdfd78af_4
```
