...
updated_at: "2024-01-22 03:02:14.186794"
...
```bash
$ shpc install quay.io/biocontainers/attotree:0.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/attotree/0.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/attotree/0.1.0--pyhdfd78af_0
```
