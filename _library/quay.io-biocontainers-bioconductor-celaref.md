...
updated_at: "2024-02-05 02:38:04.192191"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-celaref:1.20.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-celaref/1.20.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-celaref/1.20.0--r43hdfd78af_0
```
