...
updated_at: "2022-11-07 00:08:02.418485"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-celaref:1.8.0--r40hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-celaref/1.8.0--r40hdfd78af_1
$ module help quay.io/biocontainers/bioconductor-celaref/1.8.0--r40hdfd78af_1
```
