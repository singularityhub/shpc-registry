...
updated_at: "2023-11-19 02:34:29.118167"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-celaref:1.18.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-celaref/1.18.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-celaref/1.18.0--r43hdfd78af_0
```
