...
updated_at: "2024-08-11 03:17:38.626539"
...
```bash
$ shpc install quay.io/biocontainers/ntedit:2.0.2--pl5321hdcf5f25_2
```
...
```bash
$ module load quay.io/biocontainers/ntedit/2.0.2--pl5321hdcf5f25_2
$ module help quay.io/biocontainers/ntedit/2.0.2--pl5321hdcf5f25_2
```
