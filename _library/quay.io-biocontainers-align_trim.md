...
updated_at: "2026-09-03 07:29:00.597416"
...
```bash
$ shpc install quay.io/biocontainers/align_trim:1.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/align_trim/1.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/align_trim/1.2.0--pyhdfd78af_0
```
