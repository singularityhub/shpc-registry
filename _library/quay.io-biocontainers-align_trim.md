...
updated_at: "2026-06-22 02:36:54.327084"
...
```bash
$ shpc install quay.io/biocontainers/align_trim:1.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/align_trim/1.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/align_trim/1.1.0--pyhdfd78af_0
```
