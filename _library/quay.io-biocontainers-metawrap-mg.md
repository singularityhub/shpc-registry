...
updated_at: "2025-12-09 03:39:16.836254"
latest: "1.3.0--py39hdfd78af_2"
...
```bash
$ shpc install quay.io/biocontainers/metawrap-mg:1.3.0--py39hdfd78af_2
```
...
```bash
$ module load quay.io/biocontainers/metawrap-mg/1.3.0--py39hdfd78af_2
$ module help quay.io/biocontainers/metawrap-mg/1.3.0--py39hdfd78af_2
```
