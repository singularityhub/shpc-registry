...
updated_at: "2023-11-27 02:59:01.108449"
...
```bash
$ shpc install quay.io/biocontainers/fgpyo:0.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/fgpyo/0.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/fgpyo/0.1.0--pyhdfd78af_0
```
