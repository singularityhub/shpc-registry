...
updated_at: "2026-05-15 06:35:10.693527"
...
```bash
$ shpc install quay.io/biocontainers/fgpyo:1.5.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/fgpyo/1.5.1--pyhdfd78af_0
$ module help quay.io/biocontainers/fgpyo/1.5.1--pyhdfd78af_0
```
