...
updated_at: "2025-05-27 12:18:48.294949"
...
```bash
$ shpc install quay.io/biocontainers/fgpyo:1.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/fgpyo/1.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/fgpyo/1.2.0--pyhdfd78af_0
```
