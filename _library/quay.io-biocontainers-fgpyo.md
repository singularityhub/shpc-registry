...
updated_at: "2024-10-19 03:12:22.886587"
...
```bash
$ shpc install quay.io/biocontainers/fgpyo:0.7.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/fgpyo/0.7.1--pyhdfd78af_0
$ module help quay.io/biocontainers/fgpyo/0.7.1--pyhdfd78af_0
```
