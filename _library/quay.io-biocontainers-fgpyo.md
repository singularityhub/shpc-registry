...
updated_at: "2026-03-28 16:36:06.758348"
...
```bash
$ shpc install quay.io/biocontainers/fgpyo:1.5.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/fgpyo/1.5.0--pyhdfd78af_0
$ module help quay.io/biocontainers/fgpyo/1.5.0--pyhdfd78af_0
```
