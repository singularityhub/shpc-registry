...
updated_at: "2024-08-01 03:54:57.930247"
...
```bash
$ shpc install quay.io/biocontainers/fgpyo:0.4.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/fgpyo/0.4.0--pyhdfd78af_0
$ module help quay.io/biocontainers/fgpyo/0.4.0--pyhdfd78af_0
```
