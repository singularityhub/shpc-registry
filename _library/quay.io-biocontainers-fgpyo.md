...
updated_at: "2026-01-01 07:19:57.899670"
...
```bash
$ shpc install quay.io/biocontainers/fgpyo:1.4.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/fgpyo/1.4.0--pyhdfd78af_0
$ module help quay.io/biocontainers/fgpyo/1.4.0--pyhdfd78af_0
```
