...
updated_at: "2025-04-27 03:30:36.796711"
...
```bash
$ shpc install quay.io/biocontainers/fgpyo:1.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/fgpyo/1.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/fgpyo/1.1.0--pyhdfd78af_0
```
