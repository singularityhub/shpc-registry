...
updated_at: "2024-04-15 06:15:32.925216"
...
```bash
$ shpc install quay.io/biocontainers/fgpyo:0.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/fgpyo/0.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/fgpyo/0.2.0--pyhdfd78af_0
```
