...
updated_at: "2025-03-06 03:44:31.795064"
...
```bash
$ shpc install quay.io/biocontainers/fgpyo:1.0.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/fgpyo/1.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/fgpyo/1.0.0--pyhdfd78af_0
```
