...
updated_at: "2024-05-14 02:53:08.228097"
...
```bash
$ shpc install quay.io/biocontainers/fgpyo:0.3.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/fgpyo/0.3.0--pyhdfd78af_0
$ module help quay.io/biocontainers/fgpyo/0.3.0--pyhdfd78af_0
```
