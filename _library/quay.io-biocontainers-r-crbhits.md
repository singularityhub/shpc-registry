...
updated_at: "2023-07-13 03:34:24.505724"
latest: "0.0.4--r42hdbdd923_0"
...
```bash
$ shpc install quay.io/biocontainers/r-crbhits:0.0.4--r42hdbdd923_0
```
...
```bash
$ module load quay.io/biocontainers/r-crbhits/0.0.4--r42hdbdd923_0
$ module help quay.io/biocontainers/r-crbhits/0.0.4--r42hdbdd923_0
```
