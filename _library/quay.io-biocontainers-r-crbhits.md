---
layout: container
name:  "quay.io/biocontainers/r-crbhits"
maintainer: "@vsoch"
...
updated_at: "2025-12-01 05:08:10.883474"
...
```bash
$ shpc install quay.io/biocontainers/r-crbhits
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/r-crbhits:0.0.7--r44h503566f_1
```
...
```bash
$ module load quay.io/biocontainers/r-crbhits/0.0.7--r44h503566f_1
$ module help quay.io/biocontainers/r-crbhits/0.0.7--r44h503566f_1
```
...
#### r-crbhits-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-crbhits-inspect-deffile:
