---
layout: container
name:  "quay.io/biocontainers/bioconductor-regionalst"
maintainer: "@vsoch"
github: "https://github.com/singularityhub/shpc-registry/blob/main/quay.io/biocontainers/bioconductor-regionalst/container.yaml"
config_url: "https://raw.githubusercontent.com/singularityhub/shpc-registry/main/quay.io/biocontainers/bioconductor-regionalst/container.yaml"
updated_at: "2026-03-11 04:24:19.195816"
latest: "1.8.0--r45hdfd78af_0"
container_url: "https://biocontainers.pro/tools/bioconductor-regionalst"
aliases:
 - "xgboost"
 - "pcre2posix_test"
 - "2to3-3.12"
...
versions:
 - "1.0.1--r43hdfd78af_0"
 - "1.8.0--r45hdfd78af_0"
description: "singularity registry hpc automated addition for bioconductor-regionalst"
config: {"url": "https://biocontainers.pro/tools/bioconductor-regionalst", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for bioconductor-regionalst", "latest": {"1.8.0--r45hdfd78af_0": "sha256:30639b10df9675736c243fddd0cf8cf6b2cf0b12402e4a3af03367d10d5f96c4"}, "tags": {"1.0.1--r43hdfd78af_0": "sha256:3c75cf0fed5976366a41e1895519b887aa394bfab7fe4def37bb6ea915657b76", "1.8.0--r45hdfd78af_0": "sha256:30639b10df9675736c243fddd0cf8cf6b2cf0b12402e4a3af03367d10d5f96c4"}, "docker": "quay.io/biocontainers/bioconductor-regionalst", "aliases": {"xgboost": "/usr/local/bin/xgboost", "pcre2posix_test": "/usr/local/bin/pcre2posix_test", "2to3-3.12": "/usr/local/bin/2to3-3.12", "idle3.12": "/usr/local/bin/idle3.12", "pydoc3.12": "/usr/local/bin/pydoc3.12", "python3.12": "/usr/local/bin/python3.12", "python3.12-config": "/usr/local/bin/python3.12-config", "hb-info": "/usr/local/bin/hb-info", "glpsol": "/usr/local/bin/glpsol", "installBiocDataPackage.sh": "/usr/local/bin/installBiocDataPackage.sh", "tjbench": "/usr/local/bin/tjbench", "tomlq": "/usr/local/bin/tomlq", "xq": "/usr/local/bin/xq", "yq": "/usr/local/bin/yq", "jq": "/usr/local/bin/jq", "onig-config": "/usr/local/bin/onig-config", "activate-global-python-argcomplete": "/usr/local/bin/activate-global-python-argcomplete", "python-argcomplete-check-easy-install-script": "/usr/local/bin/python-argcomplete-check-easy-install-script", "register-python-argcomplete": "/usr/local/bin/register-python-argcomplete", "pandoc": "/usr/local/bin/pandoc"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/bioconductor-regionalst.
singularity registry hpc automated addition for bioconductor-regionalst
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/bioconductor-regionalst
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-regionalst:1.8.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-regionalst/1.8.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-regionalst/1.8.0--r45hdfd78af_0
```
...
#### bioconductor-regionalst-inspect:
...
#### bioconductor-regionalst-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-regionalst-inspect-deffile:
