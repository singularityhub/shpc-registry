...
updated_at: "2024-11-05 03:34:54.593134"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-regionalst:1.0.1--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-regionalst/1.0.1--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-regionalst/1.0.1--r43hdfd78af_0
```
