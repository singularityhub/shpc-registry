---
layout: container
name:  "quay.io/biocontainers/bioconductor-svmdo"
maintainer: "@vsoch"
...
updated_at: "2024-03-21 02:41:13.527062"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-svmdo
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-svmdo:1.2.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-svmdo/1.2.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-svmdo/1.2.0--r43hdfd78af_0
```
...
#### bioconductor-svmdo-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-svmdo-inspect-deffile:
