...
updated_at: "2023-11-29 03:13:07.680928"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-svmdo:1.0.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-svmdo/1.0.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-svmdo/1.0.0--r43hdfd78af_0
```
