...
updated_at: "2026-03-05 05:11:10.424913"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cogeqc:1.14.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cogeqc/1.14.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-cogeqc/1.14.0--r45hdfd78af_0
```
