...
updated_at: "2023-11-10 02:42:57.156449"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cogeqc:1.4.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cogeqc/1.4.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-cogeqc/1.4.0--r43hdfd78af_0
```
