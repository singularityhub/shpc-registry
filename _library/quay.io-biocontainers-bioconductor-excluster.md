...
updated_at: "2026-03-26 04:53:47.767414"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-excluster:1.28.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-excluster/1.28.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-excluster/1.28.0--r45hdfd78af_0
```
