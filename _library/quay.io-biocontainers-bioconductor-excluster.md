...
updated_at: "2024-04-14 03:30:16.779152"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-excluster:1.20.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-excluster/1.20.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-excluster/1.20.0--r43hdfd78af_0
```
