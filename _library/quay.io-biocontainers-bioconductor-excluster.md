...
updated_at: "2023-12-02 02:44:06.852683"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-excluster:1.18.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-excluster/1.18.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-excluster/1.18.0--r43hdfd78af_0
```
