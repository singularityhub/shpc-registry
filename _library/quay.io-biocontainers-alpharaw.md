...
updated_at: "2026-09-19 08:03:16.442875"
...
```bash
$ shpc install quay.io/biocontainers/alpharaw:0.7.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/alpharaw/0.7.1--pyhdfd78af_0
$ module help quay.io/biocontainers/alpharaw/0.7.1--pyhdfd78af_0
```
