...
updated_at: "2026-07-23 06:00:45.436174"
...
```bash
$ shpc install quay.io/biocontainers/alpharaw:0.6.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/alpharaw/0.6.1--pyhdfd78af_0
$ module help quay.io/biocontainers/alpharaw/0.6.1--pyhdfd78af_0
```
