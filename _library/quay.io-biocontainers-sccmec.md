...
updated_at: "2024-08-27 06:47:52.783021"
...
```bash
$ shpc install quay.io/biocontainers/sccmec:1.0.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sccmec/1.0.0--hdfd78af_0
$ module help quay.io/biocontainers/sccmec/1.0.0--hdfd78af_0
```
