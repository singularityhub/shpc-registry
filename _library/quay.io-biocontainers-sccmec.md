---
layout: container
name:  "quay.io/biocontainers/sccmec"
maintainer: "@vsoch"
...
updated_at: "2025-10-04 03:38:23.509236"
...
versions:
 ...
 - "1.2.0--hdfd78af_0"
 - "1.1.0--hdfd78af_0"
description: "singularity registry hpc automated addition for sccmec"
config: {"url": "https://biocontainers.pro/tools/sccmec", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for sccmec", "latest": {"1.2.0--hdfd78af_0": "sha256:6b8f6b25bd125bbc9b5997fbea9a2a61c56659594af65c47c3790b34d4c34a76"}, "tags": {"1.0.0--hdfd78af_0": "sha256:97577f965c94916197289a5e62ded34b3fdc99b8083f7de72ee32da98441fa8b", "1.2.0--hdfd78af_0": "sha256:6b8f6b25bd125bbc9b5997fbea9a2a61c56659594af65c47c3790b34d4c34a76", "1.1.0--hdfd78af_0": "sha256:4aebe4c75276ee3c2f52aec8f153a19528e0fe23ef5c50e3dadce77d25400b3a"}, "docker": "quay.io/biocontainers/sccmec", "aliases": {"archive-ncbinlp": "/usr/local/bin/archive-ncbinlp", "archive-nihocc": "/usr/local/bin/archive-nihocc", "archive-nmcds": "/usr/local/bin/archive-nmcds", "archive-pmc": "/usr/local/bin/archive-pmc", "archive-taxonomy": "/usr/local/bin/archive-taxonomy", "args2slice": "/usr/local/bin/args2slice", "asn2ref": "/usr/local/bin/asn2ref", "blst2gm": "/usr/local/bin/blst2gm", "camlhmp": "/usr/local/bin/camlhmp", "camlhmp-blast": "/usr/local/bin/camlhmp-blast", "camlhmp-extract": "/usr/local/bin/camlhmp-extract", "cit2pmid": "/usr/local/bin/cit2pmid", "combine-uid-lists": "/usr/local/bin/combine-uid-lists", "difference-uid-lists": "/usr/local/bin/difference-uid-lists", "download-pmc": "/usr/local/bin/download-pmc", "ds2pme": "/usr/local/bin/ds2pme", "fetch-local": "/usr/local/bin/fetch-local", "fetch-nmcds": "/usr/local/bin/fetch-nmcds", "fetch-pmc": "/usr/local/bin/fetch-pmc", "fetch-taxonomy": "/usr/local/bin/fetch-taxonomy", "filter-genbank": "/usr/local/bin/filter-genbank", "filter-record": "/usr/local/bin/filter-record", "gbf2fsa": "/usr/local/bin/gbf2fsa", "gbf2ref": "/usr/local/bin/gbf2ref", "gm2ranges": "/usr/local/bin/gm2ranges", "gm2segs": "/usr/local/bin/gm2segs", "ini2xml": "/usr/local/bin/ini2xml", "jsonl2xml": "/usr/local/bin/jsonl2xml", "just-first-key": "/usr/local/bin/just-first-key", "nhance.sh": "/usr/local/bin/nhance.sh", "pma2apa": "/usr/local/bin/pma2apa", "pma2pme": "/usr/local/bin/pma2pme", "pmc2bioc": "/usr/local/bin/pmc2bioc", "pmc2info": "/usr/local/bin/pmc2info", "quote-grouped-elements": "/usr/local/bin/quote-grouped-elements", "ref2pmid": "/usr/local/bin/ref2pmid", "refseq-nm-cds": "/usr/local/bin/refseq-nm-cds", "sccmec": "/usr/local/bin/sccmec", "scn2xml": "/usr/local/bin/scn2xml", "stream-local": "/usr/local/bin/stream-local", "test-pmc-index": "/usr/local/bin/test-pmc-index", "toml2xml": "/usr/local/bin/toml2xml", "yaml2xml": "/usr/local/bin/yaml2xml", "executor": "/usr/local/bin/executor", "rich-click": "/usr/local/bin/rich-click", "blastn_vdb": "/usr/local/bin/blastn_vdb", "tblastn_vdb": "/usr/local/bin/tblastn_vdb", "markdown-it": "/usr/local/bin/markdown-it", "coloredlogs": "/usr/local/bin/coloredlogs", "test_pcre": "/usr/local/bin/test_pcre", "humanfriendly": "/usr/local/bin/humanfriendly", "pigz": "/usr/local/bin/pigz", "unpigz": "/usr/local/bin/unpigz", "2to3-3.12": "/usr/local/bin/2to3-3.12", "idle3.12": "/usr/local/bin/idle3.12", "pydoc3.12": "/usr/local/bin/pydoc3.12", "python3.12": "/usr/local/bin/python3.12", "python3.12-config": "/usr/local/bin/python3.12-config", "filter-columns": "/usr/local/bin/filter-columns", "fuse-segments": "/usr/local/bin/fuse-segments", "gene2range": "/usr/local/bin/gene2range", "tbl2prod": "/usr/local/bin/tbl2prod", "uniq-table": "/usr/local/bin/uniq-table", "align-columns": "/usr/local/bin/align-columns", "blst2tkns": "/usr/local/bin/blst2tkns", "csv2xml": "/usr/local/bin/csv2xml", "disambiguate-nucleotides": "/usr/local/bin/disambiguate-nucleotides", "download-ncbi-software": "/usr/local/bin/download-ncbi-software"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/sccmec.
singularity registry hpc automated addition for sccmec
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/sccmec
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/sccmec:1.2.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sccmec/1.2.0--hdfd78af_0
$ module help quay.io/biocontainers/sccmec/1.2.0--hdfd78af_0
```
...
#### sccmec-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### sccmec-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/camlhmp-blast
$ podman run --it --rm --entrypoint /usr/local/bin/camlhmp-blast   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/camlhmp-blast   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/sccmec
$ podman run --it --rm --entrypoint /usr/local/bin/sccmec   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/sccmec   -v ${PWD} -w ${PWD} <container> -c " $@"
```
