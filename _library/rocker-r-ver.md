...
updated_at: "2026-06-02 06:45:24.019415"
latest: "4.6.0"
...
```bash
$ shpc install rocker/r-ver:4.6.0
```
...
```bash
$ module load rocker/r-ver/4.6.0
$ module help rocker/r-ver/4.6.0
```
