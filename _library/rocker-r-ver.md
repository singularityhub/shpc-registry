...
updated_at: "2025-04-05 02:58:45.928709"
latest: "4.4.3"
...
```bash
$ shpc install rocker/r-ver:4.4.3
```
...
```bash
$ module load rocker/r-ver/4.4.3
$ module help rocker/r-ver/4.4.3
```
