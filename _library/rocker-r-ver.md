...
updated_at: "2026-01-26 04:53:45.177834"
latest: "4.5.2"
...
```bash
$ shpc install rocker/r-ver:4.5.2
```
...
```bash
$ module load rocker/r-ver/4.5.2
$ module help rocker/r-ver/4.5.2
```
