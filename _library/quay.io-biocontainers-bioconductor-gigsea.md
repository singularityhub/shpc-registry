...
updated_at: "2024-12-15 04:43:33.235644"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gigsea:1.20.0--r43hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gigsea/1.20.0--r43hdfd78af_1
$ module help quay.io/biocontainers/bioconductor-gigsea/1.20.0--r43hdfd78af_1
```
