...
updated_at: "2023-10-30 04:46:53.439767"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gigsea:1.18.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gigsea/1.18.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-gigsea/1.18.0--r43hdfd78af_0
```
