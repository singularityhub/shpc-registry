...
updated_at: "2022-10-27 00:49:37.135526"
...
```bash
$ shpc install quay.io/biocontainers/anadama2:0.8.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/anadama2/0.8.0--pyhdfd78af_0
$ module help quay.io/biocontainers/anadama2/0.8.0--pyhdfd78af_0
```
