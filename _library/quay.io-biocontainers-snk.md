---
layout: container
name:  "quay.io/biocontainers/snk"
maintainer: "@vsoch"
...
updated_at: "2025-08-17 04:01:15.765612"
latest: "0.31.1--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/snk
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/snk:0.31.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snk/0.31.1--pyhdfd78af_0
$ module help quay.io/biocontainers/snk/0.31.1--pyhdfd78af_0
```
...
```bash
$ singularity exec <container> /usr/local/bin/snk
$ podman run --it --rm --entrypoint /usr/local/bin/snk   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/snk   -v ${PWD} -w ${PWD} <container> -c " $@"
```
