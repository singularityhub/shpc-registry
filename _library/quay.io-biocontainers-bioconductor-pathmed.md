---
layout: container
name:  "quay.io/biocontainers/bioconductor-pathmed"
maintainer: "@vsoch"
github: "https://github.com/singularityhub/shpc-registry/blob/main/quay.io/biocontainers/bioconductor-pathmed/container.yaml"
config_url: "https://raw.githubusercontent.com/singularityhub/shpc-registry/main/quay.io/biocontainers/bioconductor-pathmed/container.yaml"
updated_at: "2026-03-17 04:58:49.158780"
latest: "1.2.0--r45hdfd78af_0"
container_url: "https://biocontainers.pro/tools/bioconductor-pathmed"
aliases:
 - "dot_sandbox"
 - "dec265"
 - "gtk-builder-tool"
...
versions:
 - "1.2.0--r45hdfd78af_0"
description: "singularity registry hpc automated addition for bioconductor-pathmed"
config: {"url": "https://biocontainers.pro/tools/bioconductor-pathmed", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for bioconductor-pathmed", "latest": {"1.2.0--r45hdfd78af_0": "sha256:f0e6c374bb3e9c485897aed1ab2911667a7c0f3fdb1f2ef4418b113f336f3342"}, "tags": {"1.2.0--r45hdfd78af_0": "sha256:f0e6c374bb3e9c485897aed1ab2911667a7c0f3fdb1f2ef4418b113f336f3342"}, "docker": "quay.io/biocontainers/bioconductor-pathmed", "aliases": {"dot_sandbox": "/usr/local/bin/dot_sandbox", "dec265": "/usr/local/bin/dec265", "gtk-builder-tool": "/usr/local/bin/gtk-builder-tool", "gtk-encode-symbolic-svg": "/usr/local/bin/gtk-encode-symbolic-svg", "gtk-launch": "/usr/local/bin/gtk-launch", "gtk-query-immodules-3.0": "/usr/local/bin/gtk-query-immodules-3.0", "gtk-query-settings": "/usr/local/bin/gtk-query-settings", "x265": "/usr/local/bin/x265", "wayland-scanner": "/usr/local/bin/wayland-scanner", "SvtAv1EncApp": "/usr/local/bin/SvtAv1EncApp", "dav1d": "/usr/local/bin/dav1d", "gi-compile-repository": "/usr/local/bin/gi-compile-repository", "gi-decompile-typelib": "/usr/local/bin/gi-decompile-typelib", "gi-inspect-typelib": "/usr/local/bin/gi-inspect-typelib", "aomdec": "/usr/local/bin/aomdec", "aomenc": "/usr/local/bin/aomenc", "Magick++-config": "/usr/local/bin/Magick++-config", "MagickCore-config": "/usr/local/bin/MagickCore-config", "MagickWand-config": "/usr/local/bin/MagickWand-config", "animate": "/usr/local/bin/animate", "composite": "/usr/local/bin/composite", "conjure": "/usr/local/bin/conjure", "display": "/usr/local/bin/display", "identify": "/usr/local/bin/identify", "import": "/usr/local/bin/import"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/bioconductor-pathmed.
singularity registry hpc automated addition for bioconductor-pathmed
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/bioconductor-pathmed
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-pathmed:1.2.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-pathmed/1.2.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-pathmed/1.2.0--r45hdfd78af_0
```
...
#### bioconductor-pathmed-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-pathmed-inspect-deffile:
