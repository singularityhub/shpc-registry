...
updated_at: "2022-10-27 00:22:25.942751"
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-rtcga.mutations-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-rtcga.mutations-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-rtcga.mutations-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-rtcga.mutations-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-rtcga.mutations-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-rtcga.mutations-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
