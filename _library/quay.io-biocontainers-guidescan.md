...
updated_at: "2023-06-30 03:08:10.704846"
...
```bash
$ shpc install quay.io/biocontainers/guidescan:2.1.4--h4ac6f70_2
```
...
```bash
$ module load quay.io/biocontainers/guidescan/2.1.4--h4ac6f70_2
$ module help quay.io/biocontainers/guidescan/2.1.4--h4ac6f70_2
```
