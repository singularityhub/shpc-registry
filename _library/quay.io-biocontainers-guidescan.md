...
updated_at: "2023-09-04 04:18:50.695692"
latest: "2.1.5--h4ac6f70_0"
...
```bash
$ shpc install quay.io/biocontainers/guidescan:2.1.5--h4ac6f70_0
```
...
```bash
$ module load quay.io/biocontainers/guidescan/2.1.5--h4ac6f70_0
$ module help quay.io/biocontainers/guidescan/2.1.5--h4ac6f70_0
```
