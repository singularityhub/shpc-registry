...
updated_at: "2023-10-13 02:40:43.033470"
latest: "2.1.7--h4ac6f70_0"
...
```bash
$ shpc install quay.io/biocontainers/guidescan:2.1.7--h4ac6f70_0
```
...
```bash
$ module load quay.io/biocontainers/guidescan/2.1.7--h4ac6f70_0
$ module help quay.io/biocontainers/guidescan/2.1.7--h4ac6f70_0
```
