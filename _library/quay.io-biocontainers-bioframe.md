...
updated_at: "2023-05-01 03:05:42.952661"
...
```bash
$ shpc install quay.io/biocontainers/bioframe:0.4.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioframe/0.4.0--pyhdfd78af_0
$ module help quay.io/biocontainers/bioframe/0.4.0--pyhdfd78af_0
```
