...
updated_at: "2023-12-08 02:34:22.908784"
...
```bash
$ shpc install quay.io/biocontainers/bioframe:0.5.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioframe/0.5.1--pyhdfd78af_0
$ module help quay.io/biocontainers/bioframe/0.5.1--pyhdfd78af_0
```
