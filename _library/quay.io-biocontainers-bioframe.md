...
updated_at: "2023-05-22 03:23:59.039534"
...
```bash
$ shpc install quay.io/biocontainers/bioframe:0.4.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioframe/0.4.1--pyhdfd78af_0
$ module help quay.io/biocontainers/bioframe/0.4.1--pyhdfd78af_0
```
