...
updated_at: "2024-11-05 03:05:27.610340"
...
```bash
$ shpc install quay.io/biocontainers/bioframe:0.7.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioframe/0.7.2--pyhdfd78af_0
$ module help quay.io/biocontainers/bioframe/0.7.2--pyhdfd78af_0
```
