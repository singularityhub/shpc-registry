...
updated_at: "2024-06-02 02:49:37.691410"
...
```bash
$ shpc install quay.io/biocontainers/bioframe:0.6.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioframe/0.6.4--pyhdfd78af_0
$ module help quay.io/biocontainers/bioframe/0.6.4--pyhdfd78af_0
```
