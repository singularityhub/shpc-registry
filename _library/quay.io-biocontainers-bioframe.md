...
updated_at: "2023-10-23 03:17:53.861593"
...
```bash
$ shpc install quay.io/biocontainers/bioframe:0.5.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioframe/0.5.0--pyhdfd78af_0
$ module help quay.io/biocontainers/bioframe/0.5.0--pyhdfd78af_0
```
