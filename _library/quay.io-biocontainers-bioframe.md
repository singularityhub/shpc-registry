...
updated_at: "2024-06-15 02:48:30.015060"
...
```bash
$ shpc install quay.io/biocontainers/bioframe:0.7.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioframe/0.7.0--pyhdfd78af_0
$ module help quay.io/biocontainers/bioframe/0.7.0--pyhdfd78af_0
```
