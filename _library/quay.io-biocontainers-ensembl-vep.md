...
updated_at: "2025-07-31 11:20:37.328695"
latest: "114.2--pl5321h2a3209d_0"
...
```bash
$ shpc install quay.io/biocontainers/ensembl-vep:114.2--pl5321h2a3209d_0
```
...
```bash
$ module load quay.io/biocontainers/ensembl-vep/114.2--pl5321h2a3209d_0
$ module help quay.io/biocontainers/ensembl-vep/114.2--pl5321h2a3209d_0
```
