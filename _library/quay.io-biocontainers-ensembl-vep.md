...
updated_at: "2025-05-20 03:59:42.115938"
latest: "114.0--pl5321h2a3209d_0"
...
```bash
$ shpc install quay.io/biocontainers/ensembl-vep:114.0--pl5321h2a3209d_0
```
...
```bash
$ module load quay.io/biocontainers/ensembl-vep/114.0--pl5321h2a3209d_0
$ module help quay.io/biocontainers/ensembl-vep/114.0--pl5321h2a3209d_0
```
