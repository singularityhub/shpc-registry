...
updated_at: "2025-05-01 06:55:01.528656"
latest: "113.4--pl5321h2a3209d_0"
...
```bash
$ shpc install quay.io/biocontainers/ensembl-vep:113.4--pl5321h2a3209d_0
```
...
```bash
$ module load quay.io/biocontainers/ensembl-vep/113.4--pl5321h2a3209d_0
$ module help quay.io/biocontainers/ensembl-vep/113.4--pl5321h2a3209d_0
```
