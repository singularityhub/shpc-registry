...
updated_at: "2025-12-21 04:11:47.043661"
...
```bash
$ shpc install quay.io/biocontainers/ensembl-vep:115.2--pl5321h2a3209d_1
```
...
```bash
$ module load quay.io/biocontainers/ensembl-vep/115.2--pl5321h2a3209d_1
$ module help quay.io/biocontainers/ensembl-vep/115.2--pl5321h2a3209d_1
```
