...
updated_at: "2025-06-13 03:47:43.734080"
latest: "114.1--pl5321h2a3209d_0"
...
```bash
$ shpc install quay.io/biocontainers/ensembl-vep:114.1--pl5321h2a3209d_0
```
...
```bash
$ module load quay.io/biocontainers/ensembl-vep/114.1--pl5321h2a3209d_0
$ module help quay.io/biocontainers/ensembl-vep/114.1--pl5321h2a3209d_0
```
