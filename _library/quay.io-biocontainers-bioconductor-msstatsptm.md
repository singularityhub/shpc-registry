...
updated_at: "2026-03-19 04:27:33.046006"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-msstatsptm:2.12.0--r45ha27e39d_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-msstatsptm/2.12.0--r45ha27e39d_0
$ module help quay.io/biocontainers/bioconductor-msstatsptm/2.12.0--r45ha27e39d_0
```
