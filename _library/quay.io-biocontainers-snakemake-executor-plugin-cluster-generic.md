...
updated_at: "2024-02-29 02:46:25.783855"
...
```bash
$ shpc install quay.io/biocontainers/snakemake-executor-plugin-cluster-generic:1.0.7--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake-executor-plugin-cluster-generic/1.0.7--pyhdfd78af_0
$ module help quay.io/biocontainers/snakemake-executor-plugin-cluster-generic/1.0.7--pyhdfd78af_0
```
