---
layout: container
name:  "quay.io/biocontainers/bioconductor-screencounter"
maintainer: "@vsoch"
...
updated_at: "2026-03-31 04:55:18.575045"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-screencounter
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-screencounter:1.10.0--r45ha27e39d_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-screencounter/1.10.0--r45ha27e39d_0
$ module help quay.io/biocontainers/bioconductor-screencounter/1.10.0--r45ha27e39d_0
```
...
#### bioconductor-screencounter-run:
...
#### bioconductor-screencounter-shell:
...
#### bioconductor-screencounter-exec:
...
#### bioconductor-screencounter-inspect:
...
#### bioconductor-screencounter-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-screencounter-inspect-deffile:
