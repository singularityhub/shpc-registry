---
layout: container
name:  "quay.io/biocontainers/robust-bias-aware"
maintainer: "@vsoch"
...
updated_at: "2024-08-02 02:53:17.144909"
...
versions:
 - "0.0.1--pyh7cba7a3_1"
description: "singularity registry hpc automated addition for robust-bias-aware"
config: {"url": "https://biocontainers.pro/tools/robust-bias-aware", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for robust-bias-aware", "latest": {"0.0.1--pyh7cba7a3_1": "sha256:b682ee1666ba2cd017f24f3b97fcc7896edac02e99bcbc83a453a2e43a8136a7"}, "tags": {"0.0.1--pyh7cba7a3_1": "sha256:b682ee1666ba2cd017f24f3b97fcc7896edac02e99bcbc83a453a2e43a8136a7"}, "docker": "quay.io/biocontainers/robust-bias-aware", "aliases": {"robust-bias-aware": "/usr/local/bin/robust-bias-aware", "pybind11-config": "/usr/local/bin/pybind11-config", "tjbench": "/usr/local/bin/tjbench", "fonttools": "/usr/local/bin/fonttools", "pyftmerge": "/usr/local/bin/pyftmerge", "pyftsubset": "/usr/local/bin/pyftsubset", "ttx": "/usr/local/bin/ttx", "brotli": "/usr/local/bin/brotli", "opj_compress": "/usr/local/bin/opj_compress", "opj_decompress": "/usr/local/bin/opj_decompress", "opj_dump": "/usr/local/bin/opj_dump", "2to3-3.10": "/usr/local/bin/2to3-3.10", "idle3.10": "/usr/local/bin/idle3.10", "pydoc3.10": "/usr/local/bin/pydoc3.10", "python3.10": "/usr/local/bin/python3.10", "python3.10-config": "/usr/local/bin/python3.10-config", "jpgicc": "/usr/local/bin/jpgicc", "linkicc": "/usr/local/bin/linkicc", "psicc": "/usr/local/bin/psicc", "tificc": "/usr/local/bin/tificc", "transicc": "/usr/local/bin/transicc"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/robust-bias-aware.
singularity registry hpc automated addition for robust-bias-aware
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/robust-bias-aware
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/robust-bias-aware:0.0.1--pyh7cba7a3_1
```
...
```bash
$ module load quay.io/biocontainers/robust-bias-aware/0.0.1--pyh7cba7a3_1
$ module help quay.io/biocontainers/robust-bias-aware/0.0.1--pyh7cba7a3_1
```
...
#### robust-bias-aware-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### robust-bias-aware-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/robust-bias-aware
$ podman run --it --rm --entrypoint /usr/local/bin/robust-bias-aware   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/robust-bias-aware   -v ${PWD} -w ${PWD} <container> -c " $@"
```
