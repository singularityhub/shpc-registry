...
updated_at: "2024-05-09 02:38:50.695578"
...
```bash
$ shpc install quay.io/biocontainers/nextalign:2.14.0--h9ee0642_1
```
...
```bash
$ module load quay.io/biocontainers/nextalign/2.14.0--h9ee0642_1
$ module help quay.io/biocontainers/nextalign/2.14.0--h9ee0642_1
```
