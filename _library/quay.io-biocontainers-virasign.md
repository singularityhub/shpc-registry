...
updated_at: "2026-08-27 13:15:02.493478"
...
```bash
$ shpc install quay.io/biocontainers/virasign:0.0.8--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/virasign/0.0.8--pyhdfd78af_0
$ module help quay.io/biocontainers/virasign/0.0.8--pyhdfd78af_0
```
