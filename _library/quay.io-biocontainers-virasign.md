---
layout: container
name:  "quay.io/biocontainers/virasign"
maintainer: "@vsoch"
...
updated_at: "2026-06-21 07:13:43.148653"
...
```bash
$ module load quay.io/biocontainers/virasign/0.0.7--pyhdfd78af_0
$ module help quay.io/biocontainers/virasign/0.0.7--pyhdfd78af_0
```
...
#### virasign-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### virasign-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/virasign
$ podman run --it --rm --entrypoint /usr/local/bin/virasign   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/virasign   -v ${PWD} -w ${PWD} <container> -c " $@"
```
