...
updated_at: "2026-04-02 05:10:44.678843"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-bioplex:1.16.1--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-bioplex/1.16.1--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-bioplex/1.16.1--r45hdfd78af_0
```
