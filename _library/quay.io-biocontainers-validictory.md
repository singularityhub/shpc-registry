---
layout: container
name:  "quay.io/biocontainers/validictory"
maintainer: "@vsoch"
...
updated_at: "2024-12-08 03:14:03.340143"
latest: "1.0.1--py36_0"
...
```bash
$ shpc install quay.io/biocontainers/validictory
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/validictory:1.0.1--py36_0
```
...
```bash
$ module load quay.io/biocontainers/validictory/1.0.1--py36_0
$ module help quay.io/biocontainers/validictory/1.0.1--py36_0
```
...
#### validictory-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### validictory-inspect-deffile:
