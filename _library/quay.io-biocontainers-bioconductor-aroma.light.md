...
updated_at: "2026-04-04 05:07:51.796400"
latest: "3.40.0--r45hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-aroma.light:3.40.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-aroma.light/3.40.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-aroma.light/3.40.0--r45hdfd78af_0
```
