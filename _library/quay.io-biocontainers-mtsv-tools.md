...
updated_at: "2026-03-23 05:27:34.376933"
latest: "2.1.0--h54198d6_0"
...
```bash
$ shpc install quay.io/biocontainers/mtsv-tools:2.1.0--h54198d6_0
```
...
```bash
$ module load quay.io/biocontainers/mtsv-tools/2.1.0--h54198d6_0
$ module help quay.io/biocontainers/mtsv-tools/2.1.0--h54198d6_0
```
