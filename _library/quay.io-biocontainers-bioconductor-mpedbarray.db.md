...
updated_at: "2026-03-23 05:21:45.574194"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mpedbarray.db:3.2.3--r45hdfd78af_15
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mpedbarray.db/3.2.3--r45hdfd78af_15
$ module help quay.io/biocontainers/bioconductor-mpedbarray.db/3.2.3--r45hdfd78af_15
```
