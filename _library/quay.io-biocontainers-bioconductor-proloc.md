...
updated_at: "2023-09-25 03:37:20.430961"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-proloc:1.40.1--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-proloc/1.40.1--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-proloc/1.40.1--r43hf17093f_0
```
