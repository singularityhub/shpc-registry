...
updated_at: "2023-05-31 03:07:52.424432"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-proloc:1.38.0--r42hf17093f_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-proloc/1.38.0--r42hf17093f_1
$ module help quay.io/biocontainers/bioconductor-proloc/1.38.0--r42hf17093f_1
```
