...
updated_at: "2026-03-25 04:46:29.422702"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-veloviz:1.16.0--r45ha27e39d_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-veloviz/1.16.0--r45ha27e39d_0
$ module help quay.io/biocontainers/bioconductor-veloviz/1.16.0--r45ha27e39d_0
```
