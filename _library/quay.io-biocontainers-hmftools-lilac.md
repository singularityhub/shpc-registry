...
updated_at: "2026-06-26 02:13:35.166117"
...
```bash
$ shpc install quay.io/biocontainers/hmftools-lilac:2.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hmftools-lilac/2.0--hdfd78af_0
$ module help quay.io/biocontainers/hmftools-lilac/2.0--hdfd78af_0
```
