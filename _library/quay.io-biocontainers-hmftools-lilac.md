...
updated_at: "2025-09-19 03:26:59.358695"
...
```bash
$ shpc install quay.io/biocontainers/hmftools-lilac:1.7.1--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hmftools-lilac/1.7.1--hdfd78af_0
$ module help quay.io/biocontainers/hmftools-lilac/1.7.1--hdfd78af_0
```
