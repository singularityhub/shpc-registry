...
updated_at: "2024-11-25 03:23:42.949757"
...
```bash
$ shpc install quay.io/biocontainers/hmftools-lilac:1.6--hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/hmftools-lilac/1.6--hdfd78af_1
$ module help quay.io/biocontainers/hmftools-lilac/1.6--hdfd78af_1
```
