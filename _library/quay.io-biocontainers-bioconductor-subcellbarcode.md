...
updated_at: "2024-03-18 23:27:58.906840"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-subcellbarcode:1.18.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-subcellbarcode/1.18.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-subcellbarcode/1.18.0--r43hdfd78af_0
```
