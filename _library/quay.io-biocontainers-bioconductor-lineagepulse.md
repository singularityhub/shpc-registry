...
updated_at: "2023-11-15 02:48:56.728911"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-lineagepulse:1.20.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-lineagepulse/1.20.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-lineagepulse/1.20.0--r43hdfd78af_0
```
