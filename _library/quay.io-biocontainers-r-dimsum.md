...
updated_at: "2026-08-03 06:33:50.467349"
latest: "1.4--r40hdfd78af_6"
...
```bash
$ shpc install quay.io/biocontainers/r-dimsum:1.4--r40hdfd78af_6
```
...
```bash
$ module load quay.io/biocontainers/r-dimsum/1.4--r40hdfd78af_6
$ module help quay.io/biocontainers/r-dimsum/1.4--r40hdfd78af_6
```
