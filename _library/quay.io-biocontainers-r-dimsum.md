...
updated_at: "2026-01-19 05:04:23.889927"
latest: "1.4--r40hdfd78af_5"
...
```bash
$ shpc install quay.io/biocontainers/r-dimsum:1.4--r40hdfd78af_5
```
...
```bash
$ module load quay.io/biocontainers/r-dimsum/1.4--r40hdfd78af_5
$ module help quay.io/biocontainers/r-dimsum/1.4--r40hdfd78af_5
```
