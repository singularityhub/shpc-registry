...
updated_at: "2024-04-25 02:41:31.602817"
latest: "0.2.11--pyh7cba7a3_0"
...
```bash
$ shpc install quay.io/biocontainers/deeplcretrainer:0.2.11--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/deeplcretrainer/0.2.11--pyh7cba7a3_0
$ module help quay.io/biocontainers/deeplcretrainer/0.2.11--pyh7cba7a3_0
```
