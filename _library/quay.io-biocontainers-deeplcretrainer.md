...
updated_at: "2024-01-22 02:51:00.936398"
latest: "0.2.8--pyh7cba7a3_0"
...
```bash
$ shpc install quay.io/biocontainers/deeplcretrainer:0.2.8--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/deeplcretrainer/0.2.8--pyh7cba7a3_0
$ module help quay.io/biocontainers/deeplcretrainer/0.2.8--pyh7cba7a3_0
```
