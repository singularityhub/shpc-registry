...
updated_at: "2023-11-27 03:10:56.009041"
...
```bash
$ shpc install quay.io/biocontainers/deeplcretrainer:0.2.1--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/deeplcretrainer/0.2.1--pyh7cba7a3_0
$ module help quay.io/biocontainers/deeplcretrainer/0.2.1--pyh7cba7a3_0
```
