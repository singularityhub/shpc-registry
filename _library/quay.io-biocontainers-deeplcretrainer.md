...
updated_at: "2024-11-26 03:45:12.199116"
...
```bash
$ shpc install quay.io/biocontainers/deeplcretrainer:1.0.0--pyh7e72e81_0
```
...
```bash
$ module load quay.io/biocontainers/deeplcretrainer/1.0.0--pyh7e72e81_0
$ module help quay.io/biocontainers/deeplcretrainer/1.0.0--pyh7e72e81_0
```
