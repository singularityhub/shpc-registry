...
updated_at: "2026-03-29 05:24:38.947037"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-affyplm:1.86.0--r45h01b2380_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-affyplm/1.86.0--r45h01b2380_0
$ module help quay.io/biocontainers/bioconductor-affyplm/1.86.0--r45h01b2380_0
```
