...
updated_at: "2023-08-28 03:28:40.793497"
latest: "1.76.1--r43ha9d7317_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-affyplm:1.76.1--r43ha9d7317_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-affyplm/1.76.1--r43ha9d7317_0
$ module help quay.io/biocontainers/bioconductor-affyplm/1.76.1--r43ha9d7317_0
```
