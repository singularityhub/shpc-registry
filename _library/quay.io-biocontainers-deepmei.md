...
updated_at: "2024-03-17 03:05:22.114526"
...
```bash
$ shpc install quay.io/biocontainers/deepmei:1.0.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/deepmei/1.0.0--hdfd78af_0
$ module help quay.io/biocontainers/deepmei/1.0.0--hdfd78af_0
```
