...
updated_at: "2024-07-29 17:40:25.540548"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-tenxbraindata:1.22.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-tenxbraindata/1.22.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-tenxbraindata/1.22.0--r43hdfd78af_0
```
