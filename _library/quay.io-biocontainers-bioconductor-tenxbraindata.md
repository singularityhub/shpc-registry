...
updated_at: "2025-04-23 03:15:23.279266"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-tenxbraindata:1.26.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-tenxbraindata/1.26.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-tenxbraindata/1.26.0--r44hdfd78af_0
```
