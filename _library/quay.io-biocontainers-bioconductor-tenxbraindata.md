...
updated_at: "2023-05-13 02:48:20.115527"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-tenxbraindata:1.18.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-tenxbraindata/1.18.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-tenxbraindata/1.18.0--r42hdfd78af_0
```
