...
updated_at: "2026-08-13 05:00:13.497354"
...
```bash
$ shpc install quay.io/biocontainers/pvactools:7.0.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pvactools/7.0.1--pyhdfd78af_0
$ module help quay.io/biocontainers/pvactools/7.0.1--pyhdfd78af_0
```
