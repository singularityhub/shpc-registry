...
updated_at: "2026-04-02 04:45:59.300299"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cbaf:1.32.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cbaf/1.32.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-cbaf/1.32.0--r45hdfd78af_0
```
