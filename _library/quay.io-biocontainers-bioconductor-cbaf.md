...
updated_at: "2022-10-27 01:11:01.879101"
latest: "1.8.0--r36_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cbaf:1.8.0--r36_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cbaf/1.8.0--r36_0
$ module help quay.io/biocontainers/bioconductor-cbaf/1.8.0--r36_0
```
