...
updated_at: "2024-07-25 03:09:27.723629"
latest: "1.42.1--r43hf17093f_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-quasr:1.42.1--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-quasr/1.42.1--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-quasr/1.42.1--r43hf17093f_0
```
