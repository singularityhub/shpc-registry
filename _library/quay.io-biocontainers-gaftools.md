...
updated_at: "2026-02-19 04:53:45.028877"
...
```bash
$ shpc install quay.io/biocontainers/gaftools:1.3.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/gaftools/1.3.1--pyhdfd78af_0
$ module help quay.io/biocontainers/gaftools/1.3.1--pyhdfd78af_0
```
