...
updated_at: "2026-01-17 03:57:06.819744"
...
```bash
$ shpc install quay.io/biocontainers/gaftools:1.3.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/gaftools/1.3.0--pyhdfd78af_0
$ module help quay.io/biocontainers/gaftools/1.3.0--pyhdfd78af_0
```
