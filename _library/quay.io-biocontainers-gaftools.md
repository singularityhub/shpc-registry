...
updated_at: "2025-11-01 03:44:50.500491"
...
```bash
$ shpc install quay.io/biocontainers/gaftools:1.2.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/gaftools/1.2.1--pyhdfd78af_0
$ module help quay.io/biocontainers/gaftools/1.2.1--pyhdfd78af_0
```
