...
updated_at: "2025-10-01 03:36:11.913872"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-holofoodr:1.0.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-holofoodr/1.0.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-holofoodr/1.0.0--r44hdfd78af_0
```
