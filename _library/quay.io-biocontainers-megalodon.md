...
updated_at: "2025-07-31 11:04:27.449477"
...
```bash
$ shpc install quay.io/biocontainers/megalodon:2.5.0--py311hdad781d_2
```
...
```bash
$ module load quay.io/biocontainers/megalodon/2.5.0--py311hdad781d_2
$ module help quay.io/biocontainers/megalodon/2.5.0--py311hdad781d_2
```
