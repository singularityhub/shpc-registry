...
updated_at: "2025-10-06 03:44:46.855689"
latest: "2.5.0--py311haab0aaa_4"
...
```bash
$ shpc install quay.io/biocontainers/megalodon:2.5.0--py311haab0aaa_4
```
...
```bash
$ module load quay.io/biocontainers/megalodon/2.5.0--py311haab0aaa_4
$ module help quay.io/biocontainers/megalodon/2.5.0--py311haab0aaa_4
```
