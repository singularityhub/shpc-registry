...
updated_at: "2023-09-20 03:03:03.632818"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-oscope:1.30.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-oscope/1.30.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-oscope/1.30.0--r43hdfd78af_0
```
