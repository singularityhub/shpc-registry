...
updated_at: "2026-03-22 04:25:03.732642"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-oscope:1.40.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-oscope/1.40.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-oscope/1.40.0--r45hdfd78af_0
```
