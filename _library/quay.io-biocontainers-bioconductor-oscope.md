...
updated_at: "2024-02-08 08:06:45.411198"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-oscope:1.32.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-oscope/1.32.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-oscope/1.32.0--r43hdfd78af_0
```
