...
updated_at: "2026-05-30 06:31:16.088064"
...
```bash
$ shpc install quay.io/biocontainers/mtgrasp:1.1.9--py312hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mtgrasp/1.1.9--py312hdfd78af_0
$ module help quay.io/biocontainers/mtgrasp/1.1.9--py312hdfd78af_0
```
