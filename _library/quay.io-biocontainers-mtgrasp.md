...
updated_at: "2024-04-18 03:28:29.776965"
latest: "1.1.3--py310h7cba7a3_0"
...
```bash
$ shpc install quay.io/biocontainers/mtgrasp:1.1.3--py310h7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/mtgrasp/1.1.3--py310h7cba7a3_0
$ module help quay.io/biocontainers/mtgrasp/1.1.3--py310h7cba7a3_0
```
