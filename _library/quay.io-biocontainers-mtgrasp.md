...
updated_at: "2026-03-22 05:04:43.116644"
latest: "1.1.8--py312hdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/mtgrasp:1.1.8--py312hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/mtgrasp/1.1.8--py312hdfd78af_1
$ module help quay.io/biocontainers/mtgrasp/1.1.8--py312hdfd78af_1
```
