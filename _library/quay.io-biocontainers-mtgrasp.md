...
updated_at: "2026-08-21 03:41:03.461846"
latest: "1.1.10--py312hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/mtgrasp:1.1.10--py312hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mtgrasp/1.1.10--py312hdfd78af_0
$ module help quay.io/biocontainers/mtgrasp/1.1.10--py312hdfd78af_0
```
