...
updated_at: "2024-01-07 03:06:08.908623"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-apeglm:1.24.0--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-apeglm/1.24.0--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-apeglm/1.24.0--r43hf17093f_0
```
