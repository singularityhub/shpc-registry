...
updated_at: "2024-10-27 03:18:36.458444"
latest: "1.24.0--r43hf17093f_1"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-apeglm:1.24.0--r43hf17093f_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-apeglm/1.24.0--r43hf17093f_1
$ module help quay.io/biocontainers/bioconductor-apeglm/1.24.0--r43hf17093f_1
```
