...
updated_at: "2024-03-14 02:59:09.742631"
...
```bash
$ shpc install quay.io/biocontainers/plassembler:1.5.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/plassembler/1.5.1--pyhdfd78af_0
$ module help quay.io/biocontainers/plassembler/1.5.1--pyhdfd78af_0
```
