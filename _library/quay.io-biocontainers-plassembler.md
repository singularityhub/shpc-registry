...
updated_at: "2026-09-02 07:17:59.234664"
...
```bash
$ shpc install quay.io/biocontainers/plassembler:1.8.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/plassembler/1.8.3--pyhdfd78af_0
$ module help quay.io/biocontainers/plassembler/1.8.3--pyhdfd78af_0
```
