...
updated_at: "2026-09-25 08:02:15.669964"
...
```bash
$ shpc install quay.io/biocontainers/plassembler:1.8.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/plassembler/1.8.5--pyhdfd78af_0
$ module help quay.io/biocontainers/plassembler/1.8.5--pyhdfd78af_0
```
