...
updated_at: "2023-11-10 03:21:51.706045"
...
```bash
$ shpc install quay.io/biocontainers/plassembler:1.3.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/plassembler/1.3.0--pyhdfd78af_0
$ module help quay.io/biocontainers/plassembler/1.3.0--pyhdfd78af_0
```
