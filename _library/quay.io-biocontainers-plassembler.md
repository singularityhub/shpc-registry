...
updated_at: "2023-10-20 02:41:36.613716"
...
```bash
$ shpc install quay.io/biocontainers/plassembler:1.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/plassembler/1.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/plassembler/1.2.0--pyhdfd78af_0
```
