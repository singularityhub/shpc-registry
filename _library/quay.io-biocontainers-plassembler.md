...
updated_at: "2026-02-05 04:35:24.980812"
...
```bash
$ shpc install quay.io/biocontainers/plassembler:1.8.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/plassembler/1.8.2--pyhdfd78af_0
$ module help quay.io/biocontainers/plassembler/1.8.2--pyhdfd78af_0
```
