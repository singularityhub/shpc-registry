...
updated_at: "2024-01-15 04:07:43.774159"
...
```bash
$ shpc install quay.io/biocontainers/plassembler:1.5.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/plassembler/1.5.0--pyhdfd78af_0
$ module help quay.io/biocontainers/plassembler/1.5.0--pyhdfd78af_0
```
