...
updated_at: "2025-08-18 03:44:23.916704"
...
```bash
$ shpc install quay.io/biocontainers/plassembler:1.8.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/plassembler/1.8.0--pyhdfd78af_0
$ module help quay.io/biocontainers/plassembler/1.8.0--pyhdfd78af_0
```
