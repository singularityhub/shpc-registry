...
updated_at: "2025-05-25 03:41:53.997195"
latest: "1.6.2--pyhdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/plassembler:1.6.2--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/plassembler/1.6.2--pyhdfd78af_1
$ module help quay.io/biocontainers/plassembler/1.6.2--pyhdfd78af_1
```
