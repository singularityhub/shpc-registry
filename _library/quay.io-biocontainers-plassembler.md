...
updated_at: "2026-01-10 03:45:08.909696"
...
```bash
$ shpc install quay.io/biocontainers/plassembler:1.8.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/plassembler/1.8.1--pyhdfd78af_0
$ module help quay.io/biocontainers/plassembler/1.8.1--pyhdfd78af_0
```
