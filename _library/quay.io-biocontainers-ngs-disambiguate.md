...
updated_at: "2023-05-20 02:36:23.564341"
...
```bash
$ shpc install quay.io/biocontainers/ngs-disambiguate:2018.05.03--ha7703dc_6
```
...
```bash
$ module load quay.io/biocontainers/ngs-disambiguate/2018.05.03--ha7703dc_6
$ module help quay.io/biocontainers/ngs-disambiguate/2018.05.03--ha7703dc_6
```
