...
updated_at: "2026-04-01 05:39:12.928364"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-sparsesignatures:2.20.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-sparsesignatures/2.20.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-sparsesignatures/2.20.0--r45hdfd78af_0
```
