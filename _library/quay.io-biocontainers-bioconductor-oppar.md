...
updated_at: "2026-03-23 05:32:21.915272"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-oppar:1.38.0--r45h01b2380_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-oppar/1.38.0--r45h01b2380_0
$ module help quay.io/biocontainers/bioconductor-oppar/1.38.0--r45h01b2380_0
```
