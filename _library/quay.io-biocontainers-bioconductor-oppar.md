...
updated_at: "2023-06-30 03:35:19.761783"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-oppar:1.26.0--r42ha9d7317_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-oppar/1.26.0--r42ha9d7317_1
$ module help quay.io/biocontainers/bioconductor-oppar/1.26.0--r42ha9d7317_1
```
