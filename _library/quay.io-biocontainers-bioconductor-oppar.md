...
updated_at: "2025-02-10 03:36:33.871959"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-oppar:1.34.0--r44h3df3fcb_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-oppar/1.34.0--r44h3df3fcb_0
$ module help quay.io/biocontainers/bioconductor-oppar/1.34.0--r44h3df3fcb_0
```
