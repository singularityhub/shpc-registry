---
layout: container
name:  "quay.io/biocontainers/r-aroma.apd"
maintainer: "@vsoch"
...
updated_at: "2023-02-23 03:06:33.624675"
...
```bash
$ shpc install quay.io/biocontainers/r-aroma.apd
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/r-aroma.apd:0.6.0--r3.3.2_0
```
...
```bash
$ module load quay.io/biocontainers/r-aroma.apd/0.6.0--r3.3.2_0
$ module help quay.io/biocontainers/r-aroma.apd/0.6.0--r3.3.2_0
```
...
#### r-aroma.apd-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-aroma.apd-inspect-deffile:
