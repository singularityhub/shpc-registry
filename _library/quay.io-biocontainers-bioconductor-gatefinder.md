...
updated_at: "2024-09-13 03:20:47.454737"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gatefinder:1.22.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gatefinder/1.22.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-gatefinder/1.22.0--r43hdfd78af_0
```
