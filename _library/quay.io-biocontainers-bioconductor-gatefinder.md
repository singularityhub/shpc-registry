...
updated_at: "2026-04-05 04:59:10.365038"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gatefinder:1.30.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gatefinder/1.30.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-gatefinder/1.30.0--r45hdfd78af_0
```
