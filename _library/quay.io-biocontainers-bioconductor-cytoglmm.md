...
updated_at: "2022-11-01 03:58:29.029121"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cytoglmm:1.2.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cytoglmm/1.2.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-cytoglmm/1.2.0--r41hdfd78af_0
```
