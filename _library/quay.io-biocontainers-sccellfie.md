...
updated_at: "2026-09-22 07:49:06.891135"
...
```bash
$ shpc install quay.io/biocontainers/sccellfie:0.6.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sccellfie/0.6.2--pyhdfd78af_0
$ module help quay.io/biocontainers/sccellfie/0.6.2--pyhdfd78af_0
```
