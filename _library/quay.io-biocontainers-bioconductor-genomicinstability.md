...
updated_at: "2023-10-19 02:34:17.282033"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-genomicinstability:1.6.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-genomicinstability/1.6.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-genomicinstability/1.6.0--r43hdfd78af_0
```
