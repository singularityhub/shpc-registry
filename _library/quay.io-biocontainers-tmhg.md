...
updated_at: "2024-05-06 02:30:12.991659"
latest: "1.0.1--py312hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/tmhg:1.0.1--py312hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/tmhg/1.0.1--py312hdfd78af_0
$ module help quay.io/biocontainers/tmhg/1.0.1--py312hdfd78af_0
```
