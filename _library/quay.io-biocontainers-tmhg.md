...
updated_at: "2024-07-10 03:12:40.606180"
...
```bash
$ shpc install quay.io/biocontainers/tmhg:1.0.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/tmhg/1.0.2--pyhdfd78af_0
$ module help quay.io/biocontainers/tmhg/1.0.2--pyhdfd78af_0
```
