...
updated_at: "2026-03-30 05:45:54.993657"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-scone:1.34.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-scone/1.34.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-scone/1.34.0--r45hdfd78af_0
```
