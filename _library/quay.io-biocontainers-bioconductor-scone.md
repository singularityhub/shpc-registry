...
updated_at: "2025-11-18 03:20:06.560267"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-scone:1.30.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-scone/1.30.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-scone/1.30.0--r44hdfd78af_0
```
