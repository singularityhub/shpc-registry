...
updated_at: "2023-11-27 02:48:57.817455"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-scone:1.24.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-scone/1.24.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-scone/1.24.0--r43hdfd78af_0
```
