...
updated_at: "2022-11-14 01:02:11.239972"
latest: "3.39.2"
...
```bash
$ shpc install ghcr.io/autamus/sqlite:3.39.2
```
...
```bash
$ module load ghcr.io/autamus/sqlite/3.39.2
$ module help ghcr.io/autamus/sqlite/3.39.2
```
