---
layout: container
name:  "quay.io/biocontainers/bioconductor-mafdb.gnomad.r2.0.1.grch38"
maintainer: "@vsoch"
...
updated_at: "2022-11-09 00:04:36.177592"
latest: "3.9.0--r36_1"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mafdb.gnomad.r2.0.1.grch38
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-mafdb.gnomad.r2.0.1.grch38:3.9.0--r36_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mafdb.gnomad.r2.0.1.grch38/3.9.0--r36_1
$ module help quay.io/biocontainers/bioconductor-mafdb.gnomad.r2.0.1.grch38/3.9.0--r36_1
```
...
#### bioconductor-mafdb.gnomad.r2.0.1.grch38-run:
...
#### bioconductor-mafdb.gnomad.r2.0.1.grch38-shell:
...
#### bioconductor-mafdb.gnomad.r2.0.1.grch38-exec:
...
#### bioconductor-mafdb.gnomad.r2.0.1.grch38-inspect:
...
#### bioconductor-mafdb.gnomad.r2.0.1.grch38-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-mafdb.gnomad.r2.0.1.grch38-inspect-deffile:
