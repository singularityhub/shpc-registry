...
updated_at: "2024-08-27 06:11:27.103828"
latest: "9.2.0--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/snakemake-interface-executor-plugins:9.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake-interface-executor-plugins/9.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/snakemake-interface-executor-plugins/9.2.0--pyhdfd78af_0
```
