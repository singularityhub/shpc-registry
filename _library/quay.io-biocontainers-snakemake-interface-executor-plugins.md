...
updated_at: "2024-07-18 03:13:56.205878"
latest: "9.1.1--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/snakemake-interface-executor-plugins:9.1.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake-interface-executor-plugins/9.1.1--pyhdfd78af_0
$ module help quay.io/biocontainers/snakemake-interface-executor-plugins/9.1.1--pyhdfd78af_0
```
