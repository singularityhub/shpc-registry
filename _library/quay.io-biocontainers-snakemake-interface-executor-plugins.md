...
updated_at: "2025-04-07 03:41:42.426317"
latest: "9.3.5--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/snakemake-interface-executor-plugins:9.3.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake-interface-executor-plugins/9.3.5--pyhdfd78af_0
$ module help quay.io/biocontainers/snakemake-interface-executor-plugins/9.3.5--pyhdfd78af_0
```
