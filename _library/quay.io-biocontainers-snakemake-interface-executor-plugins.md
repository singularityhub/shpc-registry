...
updated_at: "2026-04-02 04:59:07.097167"
latest: "9.4.0--pyh84498cf_0"
...
```bash
$ shpc install quay.io/biocontainers/snakemake-interface-executor-plugins:9.4.0--pyh84498cf_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake-interface-executor-plugins/9.4.0--pyh84498cf_0
$ module help quay.io/biocontainers/snakemake-interface-executor-plugins/9.4.0--pyh84498cf_0
```
