...
updated_at: "2023-12-25 02:34:17.416091"
latest: "8.1.0--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/snakemake-interface-executor-plugins:8.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake-interface-executor-plugins/8.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/snakemake-interface-executor-plugins/8.1.0--pyhdfd78af_0
```
