...
updated_at: "2024-12-05 03:32:58.942761"
...
```bash
$ shpc install quay.io/biocontainers/snakemake-interface-executor-plugins:9.3.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake-interface-executor-plugins/9.3.2--pyhdfd78af_0
$ module help quay.io/biocontainers/snakemake-interface-executor-plugins/9.3.2--pyhdfd78af_0
```
