...
updated_at: "2024-04-27 02:55:44.438061"
latest: "9.1.0--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/snakemake-interface-executor-plugins:9.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake-interface-executor-plugins/9.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/snakemake-interface-executor-plugins/9.1.0--pyhdfd78af_0
```
