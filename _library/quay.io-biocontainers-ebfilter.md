---
layout: container
name:  "quay.io/biocontainers/ebfilter"
maintainer: "@vsoch"
...
updated_at: "2022-10-27 00:25:17.318350"
...
```bash
$ shpc install quay.io/biocontainers/ebfilter
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/ebfilter:0.2.2--pyh5ca1d4c_0
```
...
```bash
$ module load quay.io/biocontainers/ebfilter/0.2.2--pyh5ca1d4c_0
$ module help quay.io/biocontainers/ebfilter/0.2.2--pyh5ca1d4c_0
```
...
#### ebfilter-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### ebfilter-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/EBFilter
$ podman run --it --rm --entrypoint /usr/local/bin/EBFilter   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/EBFilter   -v ${PWD} -w ${PWD} <container> -c " $@"
```
