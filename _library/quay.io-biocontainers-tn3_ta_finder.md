---
layout: container
name:  "quay.io/biocontainers/tn3_ta_finder"
maintainer: "@vsoch"
github: "https://github.com/singularityhub/shpc-registry/blob/main/quay.io/biocontainers/tn3_ta_finder/container.yaml"
config_url: "https://raw.githubusercontent.com/singularityhub/shpc-registry/main/quay.io/biocontainers/tn3_ta_finder/container.yaml"
updated_at: "2026-02-28 04:18:37.578862"
latest: "1.0.1--hdfd78af_0"
container_url: "https://biocontainers.pro/tools/tn3_ta_finder"
aliases:
 - "Tn3+TA_finder.py"
 - "archive-nlmnlp"
 - "archive-pids"
...
```bash
$ module load quay.io/biocontainers/tn3_ta_finder/1.0.1--hdfd78af_0
$ module help quay.io/biocontainers/tn3_ta_finder/1.0.1--hdfd78af_0
```
...
#### tn3_ta_finder-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### tn3_ta_finder-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/Tn3+TA_finder.py
$ podman run --it --rm --entrypoint /usr/local/bin/Tn3+TA_finder.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/Tn3+TA_finder.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
