...
updated_at: "2026-01-14 04:05:10.235188"
...
```bash
$ shpc install quay.io/biocontainers/pasa:2.5.3--h9948957_2
```
...
```bash
$ module load quay.io/biocontainers/pasa/2.5.3--h9948957_2
$ module help quay.io/biocontainers/pasa/2.5.3--h9948957_2
```
