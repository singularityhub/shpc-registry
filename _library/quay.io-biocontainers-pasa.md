...
updated_at: "2024-10-24 10:55:40.121159"
latest: "2.5.3--h4ac6f70_1"
...
```bash
$ shpc install quay.io/biocontainers/pasa:2.5.3--h4ac6f70_1
```
...
```bash
$ module load quay.io/biocontainers/pasa/2.5.3--h4ac6f70_1
$ module help quay.io/biocontainers/pasa/2.5.3--h4ac6f70_1
```
