...
updated_at: "2023-08-20 02:55:23.189063"
latest: "2.5.2--hdbdd923_3"
...
```bash
$ shpc install quay.io/biocontainers/pasa:2.5.2--hdbdd923_3
```
...
```bash
$ module load quay.io/biocontainers/pasa/2.5.2--hdbdd923_3
$ module help quay.io/biocontainers/pasa/2.5.2--hdbdd923_3
```
