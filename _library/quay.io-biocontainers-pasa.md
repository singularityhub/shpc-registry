...
updated_at: "2023-11-12 02:39:54.436383"
latest: "2.5.3--h4ac6f70_0"
...
```bash
$ shpc install quay.io/biocontainers/pasa:2.5.3--h4ac6f70_0
```
...
```bash
$ module load quay.io/biocontainers/pasa/2.5.3--h4ac6f70_0
$ module help quay.io/biocontainers/pasa/2.5.3--h4ac6f70_0
```
