...
updated_at: "2024-05-06 04:11:24.103310"
latest: "1.5--r43hdbdd923_0"
...
```bash
$ shpc install quay.io/biocontainers/r-ldweaver:1.5--r43hdbdd923_0
```
...
```bash
$ module load quay.io/biocontainers/r-ldweaver/1.5--r43hdbdd923_0
$ module help quay.io/biocontainers/r-ldweaver/1.5--r43hdbdd923_0
```
