---
layout: container
name:  "quay.io/biocontainers/r-ldweaver"
maintainer: "@vsoch"
...
updated_at: "2024-03-23 02:24:07.228345"
...
```bash
$ shpc install quay.io/biocontainers/r-ldweaver
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/r-ldweaver:1.4--r43hdbdd923_0
```
...
```bash
$ module load quay.io/biocontainers/r-ldweaver/1.4--r43hdbdd923_0
$ module help quay.io/biocontainers/r-ldweaver/1.4--r43hdbdd923_0
```
...
#### r-ldweaver-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-ldweaver-inspect-deffile:
