...
updated_at: "2025-09-25 03:27:49.369774"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-biocartaimage:1.4.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-biocartaimage/1.4.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-biocartaimage/1.4.0--r44hdfd78af_0
```
