...
updated_at: "2024-12-05 03:31:11.682975"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-biocartaimage:1.0.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-biocartaimage/1.0.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-biocartaimage/1.0.0--r43hdfd78af_0
```
