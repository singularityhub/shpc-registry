...
updated_at: "2024-01-17 03:11:23.485767"
latest: "1.10.0--pyh7cba7a3_0"
...
```bash
$ shpc install quay.io/biocontainers/igv-reports:1.10.0--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/igv-reports/1.10.0--pyh7cba7a3_0
$ module help quay.io/biocontainers/igv-reports/1.10.0--pyh7cba7a3_0
```
