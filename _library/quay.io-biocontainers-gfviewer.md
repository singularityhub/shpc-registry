---
layout: container
name:  "quay.io/biocontainers/gfviewer"
maintainer: "@vsoch"
...
updated_at: "2025-08-02 03:46:28.988322"
...
```bash
$ shpc install quay.io/biocontainers/gfviewer
```
...
#### gfviewer-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### gfviewer-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/gfviewer
$ podman run --it --rm --entrypoint /usr/local/bin/gfviewer   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/gfviewer   -v ${PWD} -w ${PWD} <container> -c " $@"
```
