...
updated_at: "2022-11-03 01:27:52.139306"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-eudysbiome:1.8.0--r3.4.1_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-eudysbiome/1.8.0--r3.4.1_0
$ module help quay.io/biocontainers/bioconductor-eudysbiome/1.8.0--r3.4.1_0
```
