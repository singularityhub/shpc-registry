...
updated_at: "2022-11-19 02:35:46.645654"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-eudysbiome:1.24.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-eudysbiome/1.24.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-eudysbiome/1.24.0--r41hdfd78af_0
```
