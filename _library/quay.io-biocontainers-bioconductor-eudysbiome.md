...
updated_at: "2025-11-03 03:36:08.201877"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-eudysbiome:1.36.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-eudysbiome/1.36.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-eudysbiome/1.36.0--r44hdfd78af_0
```
