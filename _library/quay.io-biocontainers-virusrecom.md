...
updated_at: "2026-01-23 03:48:51.967645"
...
```bash
$ shpc install quay.io/biocontainers/virusrecom:1.4.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/virusrecom/1.4.0--pyhdfd78af_0
$ module help quay.io/biocontainers/virusrecom/1.4.0--pyhdfd78af_0
```
