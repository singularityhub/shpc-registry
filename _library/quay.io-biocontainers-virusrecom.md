...
updated_at: "2025-01-22 03:00:23.605755"
...
```bash
$ shpc install quay.io/biocontainers/virusrecom:1.3.6--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/virusrecom/1.3.6--pyhdfd78af_0
$ module help quay.io/biocontainers/virusrecom/1.3.6--pyhdfd78af_0
```
