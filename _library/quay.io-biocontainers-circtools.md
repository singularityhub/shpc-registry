...
updated_at: "2023-01-16 03:36:52.380362"
...
```bash
$ shpc install quay.io/biocontainers/circtools:1.2.1--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/circtools/1.2.1--pyh7cba7a3_0
$ module help quay.io/biocontainers/circtools/1.2.1--pyh7cba7a3_0
```
