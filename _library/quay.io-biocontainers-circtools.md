...
updated_at: "2025-12-05 03:35:16.057107"
...
```bash
$ shpc install quay.io/biocontainers/circtools:2.0.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/circtools/2.0.3--pyhdfd78af_0
$ module help quay.io/biocontainers/circtools/2.0.3--pyhdfd78af_0
```
