...
updated_at: "2023-06-15 03:03:19.016125"
...
```bash
$ shpc install quay.io/biocontainers/circtools:1.3.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/circtools/1.3.0--pyhdfd78af_0
$ module help quay.io/biocontainers/circtools/1.3.0--pyhdfd78af_0
```
