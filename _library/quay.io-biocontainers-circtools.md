...
updated_at: "2025-03-02 03:16:40.854362"
...
```bash
$ shpc install quay.io/biocontainers/circtools:1.3.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/circtools/1.3.1--pyhdfd78af_0
$ module help quay.io/biocontainers/circtools/1.3.1--pyhdfd78af_0
```
