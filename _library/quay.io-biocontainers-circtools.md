...
updated_at: "2025-08-12 03:48:54.047165"
...
```bash
$ shpc install quay.io/biocontainers/circtools:2.0.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/circtools/2.0.1--pyhdfd78af_0
$ module help quay.io/biocontainers/circtools/2.0.1--pyhdfd78af_0
```
