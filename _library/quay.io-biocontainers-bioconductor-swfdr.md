...
updated_at: "2024-04-18 03:07:12.070109"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-swfdr:1.28.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-swfdr/1.28.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-swfdr/1.28.0--r43hdfd78af_0
```
