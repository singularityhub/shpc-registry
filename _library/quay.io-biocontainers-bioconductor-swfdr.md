...
updated_at: "2023-11-18 03:00:14.022337"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-swfdr:1.26.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-swfdr/1.26.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-swfdr/1.26.0--r43hdfd78af_0
```
