...
updated_at: "2026-03-31 05:11:04.993429"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-genomicfeatures:1.62.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-genomicfeatures/1.62.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-genomicfeatures/1.62.0--r45hdfd78af_0
```
