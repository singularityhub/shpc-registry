...
updated_at: "2022-10-29 08:26:31.163856"
latest: "3.7.0--r36_2"
container_url: "https://biocontainers.pro/tools/bioconductor-mafdb.exac.r1.0.nontcga.grch38"
aliases:
 - ".bioconductor-mafdb.exac.r1.0.nontcga.grch38-post-link.sh"
 - ".bioconductor-mafdb.exac.r1.0.nontcga.grch38-pre-unlink.sh"
 - "gio-launch-desktop"
 - "c89"
 - "c99"
versions:
...
config: {"url": "https://biocontainers.pro/tools/bioconductor-mafdb.exac.r1.0.nontcga.grch38", "maintainer": "@vsoch", "description": "shpc-registry automated BioContainers addition for bioconductor-mafdb.exac.r1.0.nontcga.grch38", "latest": {"3.7.0--r36_2": "sha256:4eb7848daab45d598e9db3abe98062562db78caa86313a12aa230f05ce703800"}, "tags": {"3.7.0--r36_2": "sha256:4eb7848daab45d598e9db3abe98062562db78caa86313a12aa230f05ce703800"}, "docker": "quay.io/biocontainers/bioconductor-mafdb.exac.r1.0.nontcga.grch38", "aliases": {".bioconductor-mafdb.exac.r1.0.nontcga.grch38-post-link.sh": "/usr/local/bin/.bioconductor-mafdb.exac.r1.0.nontcga.grch38-post-link.sh", ".bioconductor-mafdb.exac.r1.0.nontcga.grch38-pre-unlink.sh": "/usr/local/bin/.bioconductor-mafdb.exac.r1.0.nontcga.grch38-pre-unlink.sh", "gio-launch-desktop": "/usr/local/bin/gio-launch-desktop", "c89": "/usr/local/bin/c89", "c99": "/usr/local/bin/c99"}}
---
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-mafdb.exac.r1.0.nontcga.grch38-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-mafdb.exac.r1.0.nontcga.grch38-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-mafdb.exac.r1.0.nontcga.grch38-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-mafdb.exac.r1.0.nontcga.grch38-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-mafdb.exac.r1.0.nontcga.grch38-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-mafdb.exac.r1.0.nontcga.grch38-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
