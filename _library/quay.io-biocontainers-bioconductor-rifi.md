...
updated_at: "2026-03-26 05:17:21.915808"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rifi:1.14.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rifi/1.14.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rifi/1.14.0--r45hdfd78af_0
```
