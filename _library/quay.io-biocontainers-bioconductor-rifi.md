...
updated_at: "2025-03-22 03:35:34.602887"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rifi:1.10.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rifi/1.10.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rifi/1.10.0--r44hdfd78af_0
```
