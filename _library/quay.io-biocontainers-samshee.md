...
updated_at: "2026-03-17 04:48:54.285668"
...
```bash
$ shpc install quay.io/biocontainers/samshee:0.2.14--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/samshee/0.2.14--pyhdfd78af_0
$ module help quay.io/biocontainers/samshee/0.2.14--pyhdfd78af_0
```
