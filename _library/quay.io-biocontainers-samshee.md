...
updated_at: "2026-03-10 04:53:02.217190"
...
```bash
$ shpc install quay.io/biocontainers/samshee:0.2.13--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/samshee/0.2.13--pyhdfd78af_0
$ module help quay.io/biocontainers/samshee/0.2.13--pyhdfd78af_0
```
