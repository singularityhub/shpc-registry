...
updated_at: "2025-04-15 03:11:20.138229"
...
```bash
$ shpc install quay.io/biocontainers/samshee:0.2.9--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/samshee/0.2.9--pyhdfd78af_0
$ module help quay.io/biocontainers/samshee/0.2.9--pyhdfd78af_0
```
