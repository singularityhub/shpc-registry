...
updated_at: "2025-10-05 03:48:46.696023"
...
```bash
$ shpc install quay.io/biocontainers/samshee:0.2.10--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/samshee/0.2.10--pyhdfd78af_0
$ module help quay.io/biocontainers/samshee/0.2.10--pyhdfd78af_0
```
