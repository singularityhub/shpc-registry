...
updated_at: "2025-01-16 03:15:20.100551"
...
```bash
$ shpc install quay.io/biocontainers/samshee:0.2.8--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/samshee/0.2.8--pyhdfd78af_0
$ module help quay.io/biocontainers/samshee/0.2.8--pyhdfd78af_0
```
