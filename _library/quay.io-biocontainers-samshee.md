...
updated_at: "2026-01-12 04:29:13.227999"
...
```bash
$ shpc install quay.io/biocontainers/samshee:0.2.12--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/samshee/0.2.12--pyhdfd78af_0
$ module help quay.io/biocontainers/samshee/0.2.12--pyhdfd78af_0
```
