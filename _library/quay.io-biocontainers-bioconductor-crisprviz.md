...
updated_at: "2024-02-27 02:22:18.895932"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-crisprviz:1.4.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-crisprviz/1.4.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-crisprviz/1.4.0--r43hdfd78af_0
```
