...
updated_at: "2025-11-30 04:24:38.139752"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-crisprviz:1.8.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-crisprviz/1.8.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-crisprviz/1.8.0--r44hdfd78af_0
```
