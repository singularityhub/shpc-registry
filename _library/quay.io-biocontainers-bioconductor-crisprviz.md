...
updated_at: "2023-11-15 02:42:55.727721"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-crisprviz:1.2.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-crisprviz/1.2.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-crisprviz/1.2.0--r43hdfd78af_0
```
