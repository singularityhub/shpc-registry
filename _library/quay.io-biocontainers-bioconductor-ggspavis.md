...
updated_at: "2023-11-18 03:11:03.696319"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ggspavis:1.6.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ggspavis/1.6.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ggspavis/1.6.0--r43hdfd78af_0
```
