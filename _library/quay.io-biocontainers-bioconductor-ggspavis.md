...
updated_at: "2022-11-02 00:53:54.939065"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ggspavis:1.0.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ggspavis/1.0.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ggspavis/1.0.0--r41hdfd78af_0
```
