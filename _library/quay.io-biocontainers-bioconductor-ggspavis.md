...
updated_at: "2026-04-04 04:36:00.278157"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ggspavis:1.16.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ggspavis/1.16.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ggspavis/1.16.0--r45hdfd78af_0
```
