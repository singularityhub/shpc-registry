...
updated_at: "2026-04-04 04:37:03.002425"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ropls:1.42.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ropls/1.42.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ropls/1.42.0--r45hdfd78af_0
```
