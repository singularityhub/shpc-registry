...
updated_at: "2024-05-09 02:41:13.786724"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ropls:1.34.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ropls/1.34.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ropls/1.34.0--r43hdfd78af_0
```
