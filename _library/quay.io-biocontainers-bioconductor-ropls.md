...
updated_at: "2022-11-03 23:55:13.936061"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ropls:1.8.0--r3.4.1_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ropls/1.8.0--r3.4.1_0
$ module help quay.io/biocontainers/bioconductor-ropls/1.8.0--r3.4.1_0
```
