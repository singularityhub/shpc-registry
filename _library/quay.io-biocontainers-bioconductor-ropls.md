...
updated_at: "2023-11-29 02:32:08.956022"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ropls:1.32.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ropls/1.32.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ropls/1.32.0--r43hdfd78af_0
```
