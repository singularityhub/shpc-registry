---
layout: container
name:  "quay.io/biocontainers/hmftools-wisp"
maintainer: "@vsoch"
...
updated_at: "2026-08-28 14:25:31.430115"
...
```bash
$ module load quay.io/biocontainers/hmftools-wisp/1.3.1--hdfd78af_0
$ module help quay.io/biocontainers/hmftools-wisp/1.3.1--hdfd78af_0
```
...
#### hmftools-wisp-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### hmftools-wisp-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/wisp
$ podman run --it --rm --entrypoint /usr/local/bin/wisp   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/wisp   -v ${PWD} -w ${PWD} <container> -c " $@"
```
