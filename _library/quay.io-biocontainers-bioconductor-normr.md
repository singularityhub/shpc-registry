...
updated_at: "2024-07-23 02:40:46.797124"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-normr:1.28.0--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-normr/1.28.0--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-normr/1.28.0--r43hf17093f_0
```
