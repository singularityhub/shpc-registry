...
updated_at: "2025-04-10 03:59:39.223137"
latest: "1.3.7.2--h5ca1c30_3"
...
```bash
$ shpc install quay.io/biocontainers/lra:1.3.7.2--h5ca1c30_3
```
...
```bash
$ module load quay.io/biocontainers/lra/1.3.7.2--h5ca1c30_3
$ module help quay.io/biocontainers/lra/1.3.7.2--h5ca1c30_3
```
