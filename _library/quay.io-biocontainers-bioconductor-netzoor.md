...
updated_at: "2023-10-19 02:47:26.842655"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-netzoor:1.2.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-netzoor/1.2.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-netzoor/1.2.0--r42hdfd78af_0
```
