...
updated_at: "2023-12-23 03:03:06.161535"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-netzoor:1.4.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-netzoor/1.4.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-netzoor/1.4.0--r43hdfd78af_0
```
