---
layout: container
name:  "quay.io/biocontainers/bioconductor-netzoor"
maintainer: "@vsoch"
...
updated_at: "2026-04-05 05:22:47.754294"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-netzoor
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-netzoor:1.14.1--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-netzoor/1.14.1--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-netzoor/1.14.1--r45hdfd78af_0
```
...
#### bioconductor-netzoor-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-netzoor-inspect-deffile:
