...
updated_at: "2026-01-14 04:16:12.227259"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-pics:2.50.0--r44h3df3fcb_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-pics/2.50.0--r44h3df3fcb_1
$ module help quay.io/biocontainers/bioconductor-pics/2.50.0--r44h3df3fcb_1
```
