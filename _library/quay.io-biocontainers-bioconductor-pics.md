...
updated_at: "2022-10-29 05:35:55.117498"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-pics:2.38.0--r41hc0cfd56_2
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-pics/2.38.0--r41hc0cfd56_2
$ module help quay.io/biocontainers/bioconductor-pics/2.38.0--r41hc0cfd56_2
```
