...
updated_at: "2025-04-09 03:39:57.087238"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-vaexprs:1.12.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-vaexprs/1.12.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-vaexprs/1.12.0--r44hdfd78af_0
```
