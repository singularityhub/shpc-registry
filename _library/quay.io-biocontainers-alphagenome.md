---
layout: container
name:  "quay.io/biocontainers/alphagenome"
maintainer: "@vsoch"
...
updated_at: "2026-02-24 04:27:09.948534"
...
```bash
$ module load quay.io/biocontainers/alphagenome/0.5.1--pyhdfd78af_0
$ module help quay.io/biocontainers/alphagenome/0.5.1--pyhdfd78af_0
```
...
#### alphagenome-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### alphagenome-inspect-deffile:
