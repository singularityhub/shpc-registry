...
updated_at: "2025-04-30 03:37:44.376814"
...
```bash
$ shpc install quay.io/biocontainers/meme:5.5.7--pl5321h1ca524f_2
```
...
```bash
$ module load quay.io/biocontainers/meme/5.5.7--pl5321h1ca524f_2
$ module help quay.io/biocontainers/meme/5.5.7--pl5321h1ca524f_2
```
