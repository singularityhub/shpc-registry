...
updated_at: "2025-09-24 03:28:38.263393"
latest: "5.5.8--pl5321h1ca524f_0"
...
```bash
$ shpc install quay.io/biocontainers/meme:5.5.8--pl5321h1ca524f_0
```
...
```bash
$ module load quay.io/biocontainers/meme/5.5.8--pl5321h1ca524f_0
$ module help quay.io/biocontainers/meme/5.5.8--pl5321h1ca524f_0
```
