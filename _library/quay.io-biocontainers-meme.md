...
updated_at: "2025-05-17 03:39:42.133217"
latest: "5.5.7--pl5321h1ca524f_3"
...
```bash
$ shpc install quay.io/biocontainers/meme:5.5.7--pl5321h1ca524f_3
```
...
```bash
$ module load quay.io/biocontainers/meme/5.5.7--pl5321h1ca524f_3
$ module help quay.io/biocontainers/meme/5.5.7--pl5321h1ca524f_3
```
