...
updated_at: "2024-12-28 03:04:30.620883"
...
```bash
$ shpc install quay.io/biocontainers/pybedlite:1.0.0--py310h1fe012e_2
```
...
```bash
$ module load quay.io/biocontainers/pybedlite/1.0.0--py310h1fe012e_2
$ module help quay.io/biocontainers/pybedlite/1.0.0--py310h1fe012e_2
```
