...
updated_at: "2024-09-02 03:08:30.770334"
latest: "1.0.0--py311hdad781d_1"
...
```bash
$ shpc install quay.io/biocontainers/pybedlite:1.0.0--py311hdad781d_1
```
...
```bash
$ module load quay.io/biocontainers/pybedlite/1.0.0--py311hdad781d_1
$ module help quay.io/biocontainers/pybedlite/1.0.0--py311hdad781d_1
```
