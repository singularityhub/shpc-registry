...
updated_at: "2022-11-21 13:20:51.444288"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-seqpattern:1.8.0--r3.4.1_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-seqpattern/1.8.0--r3.4.1_0
$ module help quay.io/biocontainers/bioconductor-seqpattern/1.8.0--r3.4.1_0
```
