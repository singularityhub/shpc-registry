...
updated_at: "2024-08-21 02:55:55.961932"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-seqpattern:1.34.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-seqpattern/1.34.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-seqpattern/1.34.0--r43hdfd78af_0
```
