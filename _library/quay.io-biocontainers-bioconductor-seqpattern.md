...
updated_at: "2026-04-03 04:33:58.193598"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-seqpattern:1.42.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-seqpattern/1.42.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-seqpattern/1.42.0--r45hdfd78af_0
```
