...
updated_at: "2026-06-23 06:16:39.511716"
latest: "1.6.11--h118bc1c_0"
...
```bash
$ shpc install quay.io/biocontainers/kma:1.6.11--h118bc1c_0
```
...
```bash
$ module load quay.io/biocontainers/kma/1.6.11--h118bc1c_0
$ module help quay.io/biocontainers/kma/1.6.11--h118bc1c_0
```
