...
updated_at: "2026-02-06 04:22:55.247771"
...
```bash
$ shpc install quay.io/biocontainers/kma:1.6.8--h577a1d6_0
```
...
```bash
$ module load quay.io/biocontainers/kma/1.6.8--h577a1d6_0
$ module help quay.io/biocontainers/kma/1.6.8--h577a1d6_0
```
