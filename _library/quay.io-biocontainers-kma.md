...
updated_at: "2026-07-22 05:55:39.917238"
latest: "1.6.13--h118bc1c_0"
...
```bash
$ shpc install quay.io/biocontainers/kma:1.6.13--h118bc1c_0
```
...
```bash
$ module load quay.io/biocontainers/kma/1.6.13--h118bc1c_0
$ module help quay.io/biocontainers/kma/1.6.13--h118bc1c_0
```
