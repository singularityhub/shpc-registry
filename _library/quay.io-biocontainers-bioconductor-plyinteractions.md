...
updated_at: "2024-07-06 02:39:48.913626"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-plyinteractions:1.0.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-plyinteractions/1.0.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-plyinteractions/1.0.0--r43hdfd78af_0
```
