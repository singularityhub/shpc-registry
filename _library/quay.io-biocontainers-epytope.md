...
updated_at: "2022-11-09 23:41:30.844795"
...
```bash
$ shpc install quay.io/biocontainers/epytope:3.1.0--pyh5e36f6f_0
```
...
```bash
$ module load quay.io/biocontainers/epytope/3.1.0--pyh5e36f6f_0
$ module help quay.io/biocontainers/epytope/3.1.0--pyh5e36f6f_0
```
