...
updated_at: "2022-11-21 13:46:24.562700"
...
```bash
$ shpc install quay.io/biocontainers/epytope:3.2.0--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/epytope/3.2.0--pyh7cba7a3_0
$ module help quay.io/biocontainers/epytope/3.2.0--pyh7cba7a3_0
```
