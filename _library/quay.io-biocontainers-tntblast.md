...
updated_at: "2024-02-22 03:33:27.666628"
...
```bash
$ shpc install quay.io/biocontainers/tntblast:2.61--hdcf5f25_0
```
...
```bash
$ module load quay.io/biocontainers/tntblast/2.61--hdcf5f25_0
$ module help quay.io/biocontainers/tntblast/2.61--hdcf5f25_0
```
