...
updated_at: "2023-11-16 02:30:50.304488"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-antiprofiles:1.40.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-antiprofiles/1.40.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-antiprofiles/1.40.0--r43hdfd78af_0
```
