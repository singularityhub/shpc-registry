...
updated_at: "2023-10-12 03:07:14.287287"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-alabaster.string:1.0.1--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-alabaster.string/1.0.1--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-alabaster.string/1.0.1--r43hdfd78af_0
```
