...
updated_at: "2024-04-12 03:09:29.200186"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-alabaster.string:1.2.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-alabaster.string/1.2.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-alabaster.string/1.2.0--r43hdfd78af_0
```
