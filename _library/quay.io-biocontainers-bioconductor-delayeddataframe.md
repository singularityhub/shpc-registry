...
updated_at: "2025-04-07 03:06:48.954759"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-delayeddataframe:1.22.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-delayeddataframe/1.22.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-delayeddataframe/1.22.0--r44hdfd78af_0
```
