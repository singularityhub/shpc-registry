...
updated_at: "2022-11-20 00:39:17.873236"
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-maqcsubset-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-maqcsubset-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-maqcsubset-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-maqcsubset-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-maqcsubset-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-maqcsubset-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
