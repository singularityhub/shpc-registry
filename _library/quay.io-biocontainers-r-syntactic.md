...
updated_at: "2023-03-11 03:10:27.568197"
latest: "0.6.4--r42hdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/r-syntactic:0.6.4--r42hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/r-syntactic/0.6.4--r42hdfd78af_1
$ module help quay.io/biocontainers/r-syntactic/0.6.4--r42hdfd78af_1
```
