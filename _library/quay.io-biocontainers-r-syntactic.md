...
updated_at: "2023-10-14 03:08:37.765068"
...
```bash
$ shpc install quay.io/biocontainers/r-syntactic:0.7.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/r-syntactic/0.7.0--r43hdfd78af_0
$ module help quay.io/biocontainers/r-syntactic/0.7.0--r43hdfd78af_0
```
