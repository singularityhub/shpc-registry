...
updated_at: "2022-10-27 00:50:24.794877"
latest: "0.5.0--py_0"
...
```bash
$ singularity exec <container> /usr/local/bin/.vega3-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.vega3-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.vega3-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.vega3-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.vega3-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.vega3-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
