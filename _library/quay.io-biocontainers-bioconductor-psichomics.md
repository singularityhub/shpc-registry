...
updated_at: "2024-10-14 03:18:01.456115"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-psichomics:1.28.0--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-psichomics/1.28.0--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-psichomics/1.28.0--r43hf17093f_0
```
