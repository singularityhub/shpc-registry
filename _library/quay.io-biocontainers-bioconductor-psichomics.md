...
updated_at: "2022-11-05 00:47:49.504140"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-psichomics:1.8.1--r351hf484d3e_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-psichomics/1.8.1--r351hf484d3e_0
$ module help quay.io/biocontainers/bioconductor-psichomics/1.8.1--r351hf484d3e_0
```
