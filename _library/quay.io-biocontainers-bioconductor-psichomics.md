...
updated_at: "2026-04-05 04:50:57.803197"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-psichomics:1.36.1--r45ha27e39d_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-psichomics/1.36.1--r45ha27e39d_0
$ module help quay.io/biocontainers/bioconductor-psichomics/1.36.1--r45ha27e39d_0
```
