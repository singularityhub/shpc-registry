...
updated_at: "2023-07-20 03:22:27.268844"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-psichomics:1.24.0--r42hf17093f_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-psichomics/1.24.0--r42hf17093f_1
$ module help quay.io/biocontainers/bioconductor-psichomics/1.24.0--r42hf17093f_1
```
