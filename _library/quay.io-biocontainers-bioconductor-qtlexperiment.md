---
layout: container
name:  "quay.io/biocontainers/bioconductor-qtlexperiment"
maintainer: "@vsoch"
...
updated_at: "2024-06-11 05:03:27.599157"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-qtlexperiment
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-qtlexperiment:1.0.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-qtlexperiment/1.0.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-qtlexperiment/1.0.0--r43hdfd78af_0
```
...
#### bioconductor-qtlexperiment-run:
...
#### bioconductor-qtlexperiment-shell:
...
#### bioconductor-qtlexperiment-exec:
...
#### bioconductor-qtlexperiment-inspect:
...
#### bioconductor-qtlexperiment-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-qtlexperiment-inspect-deffile:
