...
updated_at: "2024-04-06 02:35:58.372895"
...
```bash
$ shpc install quay.io/biocontainers/bcbio-gff:0.7.1--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/bcbio-gff/0.7.1--pyh7cba7a3_0
$ module help quay.io/biocontainers/bcbio-gff/0.7.1--pyh7cba7a3_0
```
