...
updated_at: "2023-07-27 03:05:30.985846"
latest: "0.7.0--pyh7cba7a3_0"
...
```bash
$ shpc install quay.io/biocontainers/bcbio-gff:0.7.0--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/bcbio-gff/0.7.0--pyh7cba7a3_0
$ module help quay.io/biocontainers/bcbio-gff/0.7.0--pyh7cba7a3_0
```
