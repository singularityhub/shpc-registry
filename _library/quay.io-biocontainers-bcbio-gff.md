...
updated_at: "2024-02-01 03:38:18.363436"
latest: "0.7.0--pyh7cba7a3_1"
...
```bash
$ shpc install quay.io/biocontainers/bcbio-gff:0.7.0--pyh7cba7a3_1
```
...
```bash
$ module load quay.io/biocontainers/bcbio-gff/0.7.0--pyh7cba7a3_1
$ module help quay.io/biocontainers/bcbio-gff/0.7.0--pyh7cba7a3_1
```
