...
updated_at: "2024-06-09 03:15:27.289576"
latest: "0.7.1--pyh7cba7a3_1"
...
```bash
$ shpc install quay.io/biocontainers/bcbio-gff:0.7.1--pyh7cba7a3_1
```
...
```bash
$ module load quay.io/biocontainers/bcbio-gff/0.7.1--pyh7cba7a3_1
$ module help quay.io/biocontainers/bcbio-gff/0.7.1--pyh7cba7a3_1
```
