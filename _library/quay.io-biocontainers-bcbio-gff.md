...
updated_at: "2025-10-04 03:12:15.124060"
latest: "0.7.1--pyhdfd78af_3"
...
```bash
$ shpc install quay.io/biocontainers/bcbio-gff:0.7.1--pyhdfd78af_3
```
...
```bash
$ module load quay.io/biocontainers/bcbio-gff/0.7.1--pyhdfd78af_3
$ module help quay.io/biocontainers/bcbio-gff/0.7.1--pyhdfd78af_3
```
