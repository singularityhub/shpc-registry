...
updated_at: "2024-08-12 03:44:34.111004"
latest: "1.5.5--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/pia:1.5.5--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pia/1.5.5--hdfd78af_0
$ module help quay.io/biocontainers/pia/1.5.5--hdfd78af_0
```
