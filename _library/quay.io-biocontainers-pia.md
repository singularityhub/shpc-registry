...
updated_at: "2023-12-20 02:16:31.235507"
latest: "1.4.9--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/pia:1.4.9--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pia/1.4.9--hdfd78af_0
$ module help quay.io/biocontainers/pia/1.4.9--hdfd78af_0
```
