...
updated_at: "2023-09-16 02:42:44.365824"
latest: "1.4.8--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/pia:1.4.8--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pia/1.4.8--hdfd78af_0
$ module help quay.io/biocontainers/pia/1.4.8--hdfd78af_0
```
