---
layout: container
name:  "quay.io/biocontainers/amrfior"
maintainer: "@vsoch"
...
updated_at: "2026-04-03 04:36:40.930872"
...
```bash
$ module load quay.io/biocontainers/amrfior/0.5.1--pyhdfd78af_0
$ module help quay.io/biocontainers/amrfior/0.5.1--pyhdfd78af_0
```
...
#### amrfior-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### amrfior-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/AMRfior
$ podman run --it --rm --entrypoint /usr/local/bin/AMRfior   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/AMRfior   -v ${PWD} -w ${PWD} <container> -c " $@"
```
