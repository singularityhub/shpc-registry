...
updated_at: "2026-02-27 04:54:32.234477"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mirnapath:1.70.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mirnapath/1.70.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-mirnapath/1.70.0--r45hdfd78af_0
```
