...
updated_at: "2026-09-04 07:44:14.810812"
...
```bash
$ shpc install quay.io/biocontainers/mlstudio:1.5.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mlstudio/1.5.0--pyhdfd78af_0
$ module help quay.io/biocontainers/mlstudio/1.5.0--pyhdfd78af_0
```
