...
updated_at: "2022-11-01 03:36:07.315603"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-human660quadv1acrlmm:1.0.3--r41hdfd78af_9
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-human660quadv1acrlmm/1.0.3--r41hdfd78af_9
$ module help quay.io/biocontainers/bioconductor-human660quadv1acrlmm/1.0.3--r41hdfd78af_9
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-human660quadv1acrlmm-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-human660quadv1acrlmm-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-human660quadv1acrlmm-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-human660quadv1acrlmm-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-human660quadv1acrlmm-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-human660quadv1acrlmm-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
