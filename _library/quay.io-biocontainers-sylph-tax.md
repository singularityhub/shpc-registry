...
updated_at: "2025-12-22 05:17:04.284975"
...
```bash
$ shpc install quay.io/biocontainers/sylph-tax:1.7.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sylph-tax/1.7.0--pyhdfd78af_0
$ module help quay.io/biocontainers/sylph-tax/1.7.0--pyhdfd78af_0
```
