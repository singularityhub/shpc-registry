...
updated_at: "2025-03-13 04:52:11.973941"
...
```bash
$ shpc install quay.io/biocontainers/sylph-tax:1.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sylph-tax/1.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/sylph-tax/1.2.0--pyhdfd78af_0
```
