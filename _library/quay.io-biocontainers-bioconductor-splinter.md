...
updated_at: "2026-04-03 04:43:55.585727"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-splinter:1.36.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-splinter/1.36.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-splinter/1.36.0--r45hdfd78af_0
```
