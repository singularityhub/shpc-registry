...
updated_at: "2026-04-03 15:15:44.896807"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-purecn:2.16.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-purecn/2.16.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-purecn/2.16.0--r45hdfd78af_0
```
