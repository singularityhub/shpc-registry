...
updated_at: "2025-11-05 03:41:51.150083"
latest: "1.1.19--py39h0a7431f_0"
...
```bash
$ shpc install quay.io/biocontainers/coot-headless:1.1.19--py39h0a7431f_0
```
...
```bash
$ module load quay.io/biocontainers/coot-headless/1.1.19--py39h0a7431f_0
$ module help quay.io/biocontainers/coot-headless/1.1.19--py39h0a7431f_0
```
