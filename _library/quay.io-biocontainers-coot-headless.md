...
updated_at: "2026-05-21 06:38:23.000995"
latest: "1.2--py310ha5752ae_1"
...
```bash
$ shpc install quay.io/biocontainers/coot-headless:1.2--py310ha5752ae_1
```
...
```bash
$ module load quay.io/biocontainers/coot-headless/1.2--py310ha5752ae_1
$ module help quay.io/biocontainers/coot-headless/1.2--py310ha5752ae_1
```
