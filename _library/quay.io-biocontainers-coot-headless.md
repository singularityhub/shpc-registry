...
updated_at: "2025-07-03 18:27:26.329048"
latest: "1.1.17--py310h5b8adf8_0"
...
```bash
$ shpc install quay.io/biocontainers/coot-headless:1.1.17--py310h5b8adf8_0
```
...
```bash
$ module load quay.io/biocontainers/coot-headless/1.1.17--py310h5b8adf8_0
$ module help quay.io/biocontainers/coot-headless/1.1.17--py310h5b8adf8_0
```
