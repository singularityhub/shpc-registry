...
updated_at: "2026-07-01 06:44:31.839760"
latest: "1.3.1--py311hcc144ce_0"
...
```bash
$ shpc install quay.io/biocontainers/coot-headless:1.3.1--py311hcc144ce_0
```
...
```bash
$ module load quay.io/biocontainers/coot-headless/1.3.1--py311hcc144ce_0
$ module help quay.io/biocontainers/coot-headless/1.3.1--py311hcc144ce_0
```
