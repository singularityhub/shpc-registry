...
updated_at: "2026-02-06 04:44:49.409269"
latest: "1.1.20--py39h0a7431f_0"
...
```bash
$ shpc install quay.io/biocontainers/coot-headless:1.1.20--py39h0a7431f_0
```
...
```bash
$ module load quay.io/biocontainers/coot-headless/1.1.20--py39h0a7431f_0
$ module help quay.io/biocontainers/coot-headless/1.1.20--py39h0a7431f_0
```
