...
updated_at: "2024-02-17 02:40:03.422969"
...
```bash
$ shpc install quay.io/biocontainers/seqkit:2.6.1--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/seqkit/2.6.1--h9ee0642_0
$ module help quay.io/biocontainers/seqkit/2.6.1--h9ee0642_0
```
