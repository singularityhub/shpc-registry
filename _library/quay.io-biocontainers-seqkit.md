...
updated_at: "2025-09-02 03:29:32.626353"
latest: "2.10.1--he881be0_0"
...
```bash
$ shpc install quay.io/biocontainers/seqkit:2.10.1--he881be0_0
```
...
```bash
$ module load quay.io/biocontainers/seqkit/2.10.1--he881be0_0
$ module help quay.io/biocontainers/seqkit/2.10.1--he881be0_0
```
