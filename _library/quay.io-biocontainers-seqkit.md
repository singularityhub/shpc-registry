...
updated_at: "2024-11-04 03:10:28.025450"
...
```bash
$ shpc install quay.io/biocontainers/seqkit:2.8.2--h9ee0642_1
```
...
```bash
$ module load quay.io/biocontainers/seqkit/2.8.2--h9ee0642_1
$ module help quay.io/biocontainers/seqkit/2.8.2--h9ee0642_1
```
