...
updated_at: "2026-09-25 08:04:04.376970"
...
```bash
$ shpc install quay.io/biocontainers/seqkit:2.14.0--hb192632_0
```
...
```bash
$ module load quay.io/biocontainers/seqkit/2.14.0--hb192632_0
$ module help quay.io/biocontainers/seqkit/2.14.0--hb192632_0
```
