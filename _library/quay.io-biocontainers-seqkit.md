...
updated_at: "2024-05-25 02:34:56.511974"
latest: "2.8.1--h9ee0642_0"
...
```bash
$ shpc install quay.io/biocontainers/seqkit:2.8.1--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/seqkit/2.8.1--h9ee0642_0
$ module help quay.io/biocontainers/seqkit/2.8.1--h9ee0642_0
```
