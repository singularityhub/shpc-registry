...
updated_at: "2024-03-23 03:01:52.832571"
...
```bash
$ shpc install quay.io/biocontainers/callingcardstools:1.4.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/callingcardstools/1.4.1--pyhdfd78af_0
$ module help quay.io/biocontainers/callingcardstools/1.4.1--pyhdfd78af_0
```
