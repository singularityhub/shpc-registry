...
updated_at: "2023-06-15 03:03:01.423829"
latest: "1.0.0--pyhca03a8a_0"
...
```bash
$ shpc install quay.io/biocontainers/callingcardstools:1.0.0--pyhca03a8a_0
```
...
```bash
$ module load quay.io/biocontainers/callingcardstools/1.0.0--pyhca03a8a_0
$ module help quay.io/biocontainers/callingcardstools/1.0.0--pyhca03a8a_0
```
