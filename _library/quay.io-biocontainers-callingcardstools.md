...
updated_at: "2026-01-27 04:20:34.752037"
...
```bash
$ shpc install quay.io/biocontainers/callingcardstools:1.8.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/callingcardstools/1.8.1--pyhdfd78af_0
$ module help quay.io/biocontainers/callingcardstools/1.8.1--pyhdfd78af_0
```
