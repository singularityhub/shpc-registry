...
updated_at: "2025-02-22 03:22:28.128047"
latest: "1.5.0--py39h9948957_2"
...
```bash
$ shpc install quay.io/biocontainers/tiny-count:1.5.0--py39h9948957_2
```
...
```bash
$ module load quay.io/biocontainers/tiny-count/1.5.0--py39h9948957_2
$ module help quay.io/biocontainers/tiny-count/1.5.0--py39h9948957_2
```
