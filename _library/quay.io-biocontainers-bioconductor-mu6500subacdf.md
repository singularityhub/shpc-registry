...
updated_at: "2024-04-25 03:03:49.527213"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mu6500subacdf:2.18.0--r43hdfd78af_12
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mu6500subacdf/2.18.0--r43hdfd78af_12
$ module help quay.io/biocontainers/bioconductor-mu6500subacdf/2.18.0--r43hdfd78af_12
```
