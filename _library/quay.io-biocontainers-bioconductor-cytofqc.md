...
updated_at: "2023-10-09 02:49:26.460586"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cytofqc:1.0.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cytofqc/1.0.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-cytofqc/1.0.0--r43hdfd78af_0
```
