---
layout: container
name:  "quay.io/biocontainers/phyling"
maintainer: "@vsoch"
...
updated_at: "2026-09-16 07:34:19.733770"
...
versions:
 ...
 - "2.4.0--pyhdfd78af_0"
 - "2.4.1--pyhdfd78af_0"
description: "singularity registry hpc automated addition for phyling"
config: {"url": "https://biocontainers.pro/tools/phyling", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for phyling", "latest": {"2.4.1--pyhdfd78af_0": "sha256:a8daca242ca5320ad0b9f5e0958c66d6b03b7b5bb18a81a22b79f73ed26352b8"}, "tags": {"2.3.0--pyhdfd78af_0": "sha256:aa080a8d12d9fe19fc850756fc4bbd36ecb16f5b4bc267ddea4f8a7f83e2cab7", "2.3.1--pyhdfd78af_0": "sha256:9cd10a34937b19e93fe00cf0e3fabb89860f63438dfcd9b3576f63be914382d0", "2.4.0--pyhdfd78af_0": "sha256:205ee4f5c7cad740ec9b46282d183bcf539c69f9b4ae735c7470b02c597edb38", "2.4.1--pyhdfd78af_0": "sha256:a8daca242ca5320ad0b9f5e0958c66d6b03b7b5bb18a81a22b79f73ed26352b8"}, "docker": "quay.io/biocontainers/phyling", "aliases": {"astral": "/usr/local/bin/astral", "astral-hybrid": "/usr/local/bin/astral-hybrid", "astral-pro": "/usr/local/bin/astral-pro", "astral-pro3": "/usr/local/bin/astral-pro3", "astral4": "/usr/local/bin/astral4", "caster-pair": "/usr/local/bin/caster-pair", "caster-site": "/usr/local/bin/caster-site", "caster-site_branchlength": "/usr/local/bin/caster-site_branchlength", "clipkit": "/usr/local/bin/clipkit", "dstar": "/usr/local/bin/dstar", "phykit": "/usr/local/bin/phykit", "phyling": "/usr/local/bin/phyling", "pk_al": "/usr/local/bin/pk_al", "pk_alignment_length": "/usr/local/bin/pk_alignment_length", "pk_alignment_length_no_gaps": "/usr/local/bin/pk_alignment_length_no_gaps", "pk_alignment_recoding": "/usr/local/bin/pk_alignment_recoding", "pk_aln_len": "/usr/local/bin/pk_aln_len", "pk_aln_len_no_gaps": "/usr/local/bin/pk_aln_len_no_gaps", "pk_aln_recoding": "/usr/local/bin/pk_aln_recoding", "pk_alng": "/usr/local/bin/pk_alng", "pk_bipartition_support_stats": "/usr/local/bin/pk_bipartition_support_stats", "pk_blm": "/usr/local/bin/pk_blm", "pk_branch_length_multiplier": "/usr/local/bin/pk_branch_length_multiplier", "pk_bss": "/usr/local/bin/pk_bss", "pk_cb": "/usr/local/bin/pk_cb", "pk_cbps": "/usr/local/bin/pk_cbps", "pk_cc": "/usr/local/bin/pk_cc", "pk_clan_check": "/usr/local/bin/pk_clan_check", "pk_collapse": "/usr/local/bin/pk_collapse", "pk_collapse_branches": "/usr/local/bin/pk_collapse_branches", "pk_column_score": "/usr/local/bin/pk_column_score", "pk_comp_bias_per_site": "/usr/local/bin/pk_comp_bias_per_site", "pk_compositional_bias_per_site": "/usr/local/bin/pk_compositional_bias_per_site", "pk_covarying_evolutionary_rates": "/usr/local/bin/pk_covarying_evolutionary_rates", "pk_cover": "/usr/local/bin/pk_cover", "pk_create_concat": "/usr/local/bin/pk_create_concat", "pk_create_concatenation_matrix": "/usr/local/bin/pk_create_concatenation_matrix", "pk_cs": "/usr/local/bin/pk_cs", "pk_degree_of_violation_of_a_molecular_clock": "/usr/local/bin/pk_degree_of_violation_of_a_molecular_clock", "pk_dvmc": "/usr/local/bin/pk_dvmc", "pk_erps": "/usr/local/bin/pk_erps", "pk_evo_rate": "/usr/local/bin/pk_evo_rate", "pk_evo_rate_per_site": "/usr/local/bin/pk_evo_rate_per_site", "pk_evolutionary_rate": "/usr/local/bin/pk_evolutionary_rate", "pk_evolutionary_rate_per_site": "/usr/local/bin/pk_evolutionary_rate_per_site", "pk_faidx": "/usr/local/bin/pk_faidx", "pk_gc": "/usr/local/bin/pk_gc", "pk_gc_content": "/usr/local/bin/pk_gc_content", "pk_ge": "/usr/local/bin/pk_ge", "pk_get_entry": "/usr/local/bin/pk_get_entry", "pk_hidden_paralogy_check": "/usr/local/bin/pk_hidden_paralogy_check", "pk_ibs": "/usr/local/bin/pk_ibs", "pk_il": "/usr/local/bin/pk_il", "pk_internal_branch_stats": "/usr/local/bin/pk_internal_branch_stats", "pk_internode_labeler": "/usr/local/bin/pk_internode_labeler", "pk_is_monophyletic": "/usr/local/bin/pk_is_monophyletic", "pk_labels": "/usr/local/bin/pk_labels", "pk_last_common_ancestor_subtree": "/usr/local/bin/pk_last_common_ancestor_subtree", "pk_lb_score": "/usr/local/bin/pk_lb_score", "pk_lbs": "/usr/local/bin/pk_lbs", "pk_lca_subtree": "/usr/local/bin/pk_lca_subtree", "pk_long_branch_score": "/usr/local/bin/pk_long_branch_score", "pk_monophyly_check": "/usr/local/bin/pk_monophyly_check", "pk_nearest_neighbor_interchange": "/usr/local/bin/pk_nearest_neighbor_interchange", "pk_nni": "/usr/local/bin/pk_nni", "pk_p2n": "/usr/local/bin/pk_p2n", "pk_pairwise_id": "/usr/local/bin/pk_pairwise_id", "pk_pairwise_identity": "/usr/local/bin/pk_pairwise_identity", "pk_pal2nal": "/usr/local/bin/pk_pal2nal", "pk_parsimony_informative_sites": "/usr/local/bin/pk_parsimony_informative_sites", "pk_patristic_distances": "/usr/local/bin/pk_patristic_distances", "pk_pd": "/usr/local/bin/pk_pd", "pk_pi": "/usr/local/bin/pk_pi", "pk_pis": "/usr/local/bin/pk_pis", "pk_polyt": "/usr/local/bin/pk_polyt", "pk_polyt_test": "/usr/local/bin/pk_polyt_test", "pk_polytomy_test": "/usr/local/bin/pk_polytomy_test", "pk_print": "/usr/local/bin/pk_print", "pk_print_tree": "/usr/local/bin/pk_print_tree", "pk_prune": "/usr/local/bin/pk_prune", "pk_prune_tree": "/usr/local/bin/pk_prune_tree", "pk_pt": "/usr/local/bin/pk_pt", "pk_ptt": "/usr/local/bin/pk_ptt", "pk_rcv": "/usr/local/bin/pk_rcv", "pk_rcvt": "/usr/local/bin/pk_rcvt", "pk_recode": "/usr/local/bin/pk_recode", "pk_rel_comp_var": "/usr/local/bin/pk_rel_comp_var", "pk_rel_comp_var_taxon": "/usr/local/bin/pk_rel_comp_var_taxon", "pk_relative_composition_variability": "/usr/local/bin/pk_relative_composition_variability", "pk_relative_composition_variability_taxon": "/usr/local/bin/pk_relative_composition_variability_taxon", "pk_rename_fasta": "/usr/local/bin/pk_rename_fasta", "pk_rename_fasta_entries": "/usr/local/bin/pk_rename_fasta_entries", "pk_rename_tips": "/usr/local/bin/pk_rename_tips", "pk_rename_tree": "/usr/local/bin/pk_rename_tree", "pk_rename_tree_tips": "/usr/local/bin/pk_rename_tree_tips", "pk_rf": "/usr/local/bin/pk_rf", "pk_rf_dist": "/usr/local/bin/pk_rf_dist", "pk_rf_distance": "/usr/local/bin/pk_rf_distance", "pk_robinson_foulds_distance": "/usr/local/bin/pk_robinson_foulds_distance", "pk_root": "/usr/local/bin/pk_root", "pk_root_tree": "/usr/local/bin/pk_root_tree", "pk_rt": "/usr/local/bin/pk_rt", "pk_sat": "/usr/local/bin/pk_sat", "pk_saturation": "/usr/local/bin/pk_saturation", "pk_sop": "/usr/local/bin/pk_sop", "pk_sops": "/usr/local/bin/pk_sops", "pk_spurious_seq": "/usr/local/bin/pk_spurious_seq", "pk_spurious_sequence": "/usr/local/bin/pk_spurious_sequence", "pk_ss": "/usr/local/bin/pk_ss", "pk_sum_of_pairs_score": "/usr/local/bin/pk_sum_of_pairs_score", "pk_t2t": "/usr/local/bin/pk_t2t", "pk_t2t_dist": "/usr/local/bin/pk_t2t_dist", "pk_t2t_nd": "/usr/local/bin/pk_t2t_nd", "pk_t2t_node_dist": "/usr/local/bin/pk_t2t_node_dist", "pk_tbs": "/usr/local/bin/pk_tbs", "pk_terminal_branch_stats": "/usr/local/bin/pk_terminal_branch_stats", "pk_thread_dna": "/usr/local/bin/pk_thread_dna", "pk_tip_labels": "/usr/local/bin/pk_tip_labels", "pk_tip_to_tip_distance": "/usr/local/bin/pk_tip_to_tip_distance", "pk_tip_to_tip_node_distance": "/usr/local/bin/pk_tip_to_tip_node_distance", "pk_tl": "/usr/local/bin/pk_tl", "pk_tness": "/usr/local/bin/pk_tness", "pk_tor": "/usr/local/bin/pk_tor", "pk_total_tree_length": "/usr/local/bin/pk_total_tree_length", "pk_toverr": "/usr/local/bin/pk_toverr", "pk_tree_labels": "/usr/local/bin/pk_tree_labels", "pk_tree_len": "/usr/local/bin/pk_tree_len", "pk_treeness": "/usr/local/bin/pk_treeness", "pk_treeness_over_rcv": "/usr/local/bin/pk_treeness_over_rcv", "pk_variable_sites": "/usr/local/bin/pk_variable_sites", "pk_vs": "/usr/local/bin/pk_vs", "waster": "/usr/local/bin/waster", "waster_branchlength": "/usr/local/bin/waster_branchlength", "wastral": "/usr/local/bin/wastral", "raxml-ng": "/usr/local/bin/raxml-ng", "raxml-ng-mpi": "/usr/local/bin/raxml-ng-mpi", "iqtree2": "/usr/local/bin/iqtree2", "iqtree": "/usr/local/bin/iqtree", "shmemrun": "/usr/local/bin/shmemrun", "FastTreeMP": "/usr/local/bin/FastTreeMP", "FastTree": "/usr/local/bin/FastTree", "oshCC": "/usr/local/bin/oshCC", "oshc++": "/usr/local/bin/oshc++", "oshcxx": "/usr/local/bin/oshcxx", "shmemCC": "/usr/local/bin/shmemCC", "shmemc++": "/usr/local/bin/shmemc++", "shmemcxx": "/usr/local/bin/shmemcxx", "oshcc": "/usr/local/bin/oshcc", "oshfort": "/usr/local/bin/oshfort", "oshmem_info": "/usr/local/bin/oshmem_info", "oshrun": "/usr/local/bin/oshrun", "shmemcc": "/usr/local/bin/shmemcc", "shmemfort": "/usr/local/bin/shmemfort", "fasttree": "/usr/local/bin/fasttree", "muscle": "/usr/local/bin/muscle", "aggregate_profile.pl": "/usr/local/bin/aggregate_profile.pl", "profile2mat.pl": "/usr/local/bin/profile2mat.pl", "ompi-clean": "/usr/local/bin/ompi-clean", "ompi-server": "/usr/local/bin/ompi-server"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/phyling.
singularity registry hpc automated addition for phyling
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/phyling
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/phyling:2.4.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/phyling/2.4.1--pyhdfd78af_0
$ module help quay.io/biocontainers/phyling/2.4.1--pyhdfd78af_0
```
...
#### phyling-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### phyling-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/astral-hybrid
$ podman run --it --rm --entrypoint /usr/local/bin/astral-hybrid   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/astral-hybrid   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/astral-pro3
$ podman run --it --rm --entrypoint /usr/local/bin/astral-pro3   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/astral-pro3   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/astral4
$ podman run --it --rm --entrypoint /usr/local/bin/astral4   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/astral4   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/caster-pair
$ podman run --it --rm --entrypoint /usr/local/bin/caster-pair   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/caster-pair   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/caster-site
$ podman run --it --rm --entrypoint /usr/local/bin/caster-site   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/caster-site   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/caster-site_branchlength
$ podman run --it --rm --entrypoint /usr/local/bin/caster-site_branchlength   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/caster-site_branchlength   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/dstar
$ podman run --it --rm --entrypoint /usr/local/bin/dstar   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/dstar   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/phyling
$ podman run --it --rm --entrypoint /usr/local/bin/phyling   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/phyling   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/pk_alignment_recoding
$ podman run --it --rm --entrypoint /usr/local/bin/pk_alignment_recoding   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/pk_alignment_recoding   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/pk_aln_recoding
$ podman run --it --rm --entrypoint /usr/local/bin/pk_aln_recoding   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/pk_aln_recoding   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/pk_cbps
$ podman run --it --rm --entrypoint /usr/local/bin/pk_cbps   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/pk_cbps   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/pk_comp_bias_per_site
$ podman run --it --rm --entrypoint /usr/local/bin/pk_comp_bias_per_site   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/pk_comp_bias_per_site   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/pk_compositional_bias_per_site
$ podman run --it --rm --entrypoint /usr/local/bin/pk_compositional_bias_per_site   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/pk_compositional_bias_per_site   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/pk_erps
$ podman run --it --rm --entrypoint /usr/local/bin/pk_erps   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/pk_erps   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/pk_evo_rate_per_site
$ podman run --it --rm --entrypoint /usr/local/bin/pk_evo_rate_per_site   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/pk_evo_rate_per_site   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/pk_evolutionary_rate_per_site
$ podman run --it --rm --entrypoint /usr/local/bin/pk_evolutionary_rate_per_site   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/pk_evolutionary_rate_per_site   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/pk_rcvt
$ podman run --it --rm --entrypoint /usr/local/bin/pk_rcvt   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/pk_rcvt   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/pk_recode
$ podman run --it --rm --entrypoint /usr/local/bin/pk_recode   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/pk_recode   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/pk_rel_comp_var_taxon
$ podman run --it --rm --entrypoint /usr/local/bin/pk_rel_comp_var_taxon   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/pk_rel_comp_var_taxon   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/pk_relative_composition_variability_taxon
$ podman run --it --rm --entrypoint /usr/local/bin/pk_relative_composition_variability_taxon   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/pk_relative_composition_variability_taxon   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/waster
$ podman run --it --rm --entrypoint /usr/local/bin/waster   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/waster   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/waster_branchlength
$ podman run --it --rm --entrypoint /usr/local/bin/waster_branchlength   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/waster_branchlength   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/wastral
$ podman run --it --rm --entrypoint /usr/local/bin/wastral   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/wastral   -v ${PWD} -w ${PWD} <container> -c " $@"
```
