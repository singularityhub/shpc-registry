...
updated_at: "2025-05-21 03:39:57.462861"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-paeg1aprobe:2.18.0--r44hdfd78af_14
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-paeg1aprobe/2.18.0--r44hdfd78af_14
$ module help quay.io/biocontainers/bioconductor-paeg1aprobe/2.18.0--r44hdfd78af_14
```
