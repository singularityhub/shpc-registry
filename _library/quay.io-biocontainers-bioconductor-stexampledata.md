...
updated_at: "2026-03-30 05:55:23.407017"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-stexampledata:1.18.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-stexampledata/1.18.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-stexampledata/1.18.0--r45hdfd78af_0
```
