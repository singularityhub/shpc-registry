...
updated_at: "2026-06-14 06:55:35.491998"
...
```bash
$ shpc install quay.io/biocontainers/firecloud:0.16.39--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/firecloud/0.16.39--pyhdfd78af_0
$ module help quay.io/biocontainers/firecloud/0.16.39--pyhdfd78af_0
```
