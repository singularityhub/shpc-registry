...
updated_at: "2024-01-31 02:48:45.254008"
latest: "0.16.35--pyh7cba7a3_0"
...
```bash
$ shpc install quay.io/biocontainers/firecloud:0.16.35--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/firecloud/0.16.35--pyh7cba7a3_0
$ module help quay.io/biocontainers/firecloud/0.16.35--pyh7cba7a3_0
```
