...
updated_at: "2026-03-30 05:10:51.320925"
latest: "1.3.10--py311hf552afe_1"
...
```bash
$ shpc install quay.io/biocontainers/metator:1.3.10--py311hf552afe_1
```
...
```bash
$ module load quay.io/biocontainers/metator/1.3.10--py311hf552afe_1
$ module help quay.io/biocontainers/metator/1.3.10--py311hf552afe_1
```
