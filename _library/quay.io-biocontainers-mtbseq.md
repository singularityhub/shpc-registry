...
updated_at: "2025-05-24 03:49:47.541450"
...
```bash
$ shpc install quay.io/biocontainers/mtbseq:1.1.0--hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/mtbseq/1.1.0--hdfd78af_1
$ module help quay.io/biocontainers/mtbseq/1.1.0--hdfd78af_1
```
