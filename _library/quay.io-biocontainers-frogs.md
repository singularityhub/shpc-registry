...
updated_at: "2023-05-22 03:17:06.339246"
...
```bash
$ shpc install quay.io/biocontainers/frogs:4.1.0--h9ee0642_1
```
...
```bash
$ module load quay.io/biocontainers/frogs/4.1.0--h9ee0642_1
$ module help quay.io/biocontainers/frogs/4.1.0--h9ee0642_1
```
