...
updated_at: "2022-10-27 00:27:03.369814"
latest: "1.8.0--r40_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gsean:1.8.0--r40_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gsean/1.8.0--r40_0
$ module help quay.io/biocontainers/bioconductor-gsean/1.8.0--r40_0
```
