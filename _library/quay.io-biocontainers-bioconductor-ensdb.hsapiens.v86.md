...
updated_at: "2025-05-15 03:48:21.718044"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ensdb.hsapiens.v86:2.99.0--r44hdfd78af_13
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ensdb.hsapiens.v86/2.99.0--r44hdfd78af_13
$ module help quay.io/biocontainers/bioconductor-ensdb.hsapiens.v86/2.99.0--r44hdfd78af_13
```
