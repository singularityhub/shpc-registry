...
updated_at: "2026-02-02 12:30:03.608539"
latest: "0.3.2--h3ab6199_0"
...
```bash
$ shpc install quay.io/biocontainers/savont:0.3.2--h3ab6199_0
```
...
```bash
$ module load quay.io/biocontainers/savont/0.3.2--h3ab6199_0
$ module help quay.io/biocontainers/savont/0.3.2--h3ab6199_0
```
