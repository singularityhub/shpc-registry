...
updated_at: "2026-08-14 04:12:58.229049"
latest: "0.6.2--hec9b1f2_0"
...
```bash
$ shpc install quay.io/biocontainers/savont:0.6.2--hec9b1f2_0
```
...
```bash
$ module load quay.io/biocontainers/savont/0.6.2--hec9b1f2_0
$ module help quay.io/biocontainers/savont/0.6.2--hec9b1f2_0
```
