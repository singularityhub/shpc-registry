...
updated_at: "2026-07-02 06:17:27.112681"
latest: "0.6.0--hec9b1f2_0"
...
```bash
$ shpc install quay.io/biocontainers/savont:0.6.0--hec9b1f2_0
```
...
```bash
$ module load quay.io/biocontainers/savont/0.6.0--hec9b1f2_0
$ module help quay.io/biocontainers/savont/0.6.0--hec9b1f2_0
```
