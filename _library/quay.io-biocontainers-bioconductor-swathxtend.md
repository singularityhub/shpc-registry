...
updated_at: "2022-10-29 05:46:07.774753"
latest: "2.8.0--r36_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-swathxtend:2.8.0--r36_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-swathxtend/2.8.0--r36_0
$ module help quay.io/biocontainers/bioconductor-swathxtend/2.8.0--r36_0
```
