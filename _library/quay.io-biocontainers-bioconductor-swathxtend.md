...
updated_at: "2026-04-05 05:16:17.284730"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-swathxtend:2.32.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-swathxtend/2.32.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-swathxtend/2.32.0--r45hdfd78af_0
```
