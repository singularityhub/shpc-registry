...
updated_at: "2025-02-03 03:02:59.781044"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-swathxtend:2.28.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-swathxtend/2.28.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-swathxtend/2.28.0--r44hdfd78af_0
```
