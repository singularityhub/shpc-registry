...
updated_at: "2025-11-08 03:19:24.705675"
...
```bash
$ shpc install quay.io/biocontainers/perl-dbd-mysql:5.013--pl5321h0a44790_0
```
...
```bash
$ module load quay.io/biocontainers/perl-dbd-mysql/5.013--pl5321h0a44790_0
$ module help quay.io/biocontainers/perl-dbd-mysql/5.013--pl5321h0a44790_0
```
