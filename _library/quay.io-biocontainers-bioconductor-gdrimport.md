...
updated_at: "2024-01-02 02:36:24.512201"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gdrimport:1.0.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gdrimport/1.0.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-gdrimport/1.0.0--r43hdfd78af_0
```
