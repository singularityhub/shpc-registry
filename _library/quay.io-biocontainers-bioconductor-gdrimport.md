...
updated_at: "2026-05-30 06:10:38.801771"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gdrimport:1.8.1--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gdrimport/1.8.1--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-gdrimport/1.8.1--r45hdfd78af_0
```
