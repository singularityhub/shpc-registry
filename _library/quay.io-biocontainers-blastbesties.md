...
updated_at: "2025-12-27 03:33:50.148912"
...
```bash
$ shpc install quay.io/biocontainers/blastbesties:1.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/blastbesties/1.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/blastbesties/1.2.0--pyhdfd78af_0
```
