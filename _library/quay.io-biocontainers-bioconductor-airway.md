...
updated_at: "2023-12-13 03:11:54.437693"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-airway:1.20.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-airway/1.20.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-airway/1.20.0--r43hdfd78af_0
```
