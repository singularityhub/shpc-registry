...
updated_at: "2024-11-21 03:14:03.544357"
latest: "0.2.63--h2e7e638_1"
...
```bash
$ shpc install quay.io/biocontainers/tidk:0.2.63--h2e7e638_1
```
...
```bash
$ module load quay.io/biocontainers/tidk/0.2.63--h2e7e638_1
$ module help quay.io/biocontainers/tidk/0.2.63--h2e7e638_1
```
