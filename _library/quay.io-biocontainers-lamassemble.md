...
updated_at: "2025-05-03 03:45:46.587770"
...
```bash
$ shpc install quay.io/biocontainers/lamassemble:1.7.2--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/lamassemble/1.7.2--pyh7cba7a3_0
$ module help quay.io/biocontainers/lamassemble/1.7.2--pyh7cba7a3_0
```
