...
updated_at: "2025-12-17 03:48:46.155085"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-humanomni5quadv1bcrlmm:1.0.0--r44hdfd78af_13
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-humanomni5quadv1bcrlmm/1.0.0--r44hdfd78af_13
$ module help quay.io/biocontainers/bioconductor-humanomni5quadv1bcrlmm/1.0.0--r44hdfd78af_13
```
