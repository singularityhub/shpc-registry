...
updated_at: "2022-10-27 00:26:03.533022"
...
```bash
$ shpc install quay.io/biocontainers/glimpse-bio:v1.1.1--hd3cd7f2_0
```
...
```bash
$ module load quay.io/biocontainers/glimpse-bio/v1.1.1--hd3cd7f2_0
$ module help quay.io/biocontainers/glimpse-bio/v1.1.1--hd3cd7f2_0
```
