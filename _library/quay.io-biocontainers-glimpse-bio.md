...
updated_at: "2023-05-28 03:14:45.444022"
latest: "2.0.0--h46b9e50_1"
...
```bash
$ shpc install quay.io/biocontainers/glimpse-bio:2.0.0--h46b9e50_1
```
...
```bash
$ module load quay.io/biocontainers/glimpse-bio/2.0.0--h46b9e50_1
$ module help quay.io/biocontainers/glimpse-bio/2.0.0--h46b9e50_1
```
