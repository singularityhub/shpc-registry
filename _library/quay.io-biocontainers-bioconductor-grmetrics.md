...
updated_at: "2026-04-03 15:32:17.607967"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-grmetrics:1.36.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-grmetrics/1.36.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-grmetrics/1.36.0--r45hdfd78af_0
```
