...
updated_at: "2026-03-30 05:01:45.262904"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-depmap:1.24.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-depmap/1.24.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-depmap/1.24.0--r45hdfd78af_0
```
