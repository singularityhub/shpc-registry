...
updated_at: "2024-03-25 02:29:20.882951"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-depmap:1.16.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-depmap/1.16.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-depmap/1.16.0--r43hdfd78af_0
```
