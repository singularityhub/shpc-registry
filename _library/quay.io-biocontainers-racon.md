...
updated_at: "2026-01-19 04:09:40.948749"
...
```bash
$ shpc install quay.io/biocontainers/racon:1.5.0--h077b44d_8
```
...
```bash
$ module load quay.io/biocontainers/racon/1.5.0--h077b44d_8
$ module help quay.io/biocontainers/racon/1.5.0--h077b44d_8
```
