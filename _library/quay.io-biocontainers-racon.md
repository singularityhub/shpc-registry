...
updated_at: "2023-12-24 02:38:36.081132"
latest: "1.5.0--h21ec9f0_2"
...
```bash
$ shpc install quay.io/biocontainers/racon:1.5.0--h21ec9f0_2
```
...
```bash
$ module load quay.io/biocontainers/racon/1.5.0--h21ec9f0_2
$ module help quay.io/biocontainers/racon/1.5.0--h21ec9f0_2
```
