...
updated_at: "2026-08-22 03:37:30.639439"
latest: "0.3.3--r45hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/r-acidcli:0.3.3--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/r-acidcli/0.3.3--r45hdfd78af_0
$ module help quay.io/biocontainers/r-acidcli/0.3.3--r45hdfd78af_0
```
