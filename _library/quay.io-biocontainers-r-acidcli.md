...
updated_at: "2023-10-06 03:19:03.890430"
latest: "0.2.8--r43hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/r-acidcli:0.2.8--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/r-acidcli/0.2.8--r43hdfd78af_0
$ module help quay.io/biocontainers/r-acidcli/0.2.8--r43hdfd78af_0
```
