...
updated_at: "2022-10-29 18:14:26.173421"
latest: "1.8.0--r36_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-trendy:1.8.0--r36_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-trendy/1.8.0--r36_0
$ module help quay.io/biocontainers/bioconductor-trendy/1.8.0--r36_0
```
