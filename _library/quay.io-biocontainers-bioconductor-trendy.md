...
updated_at: "2026-03-22 05:11:36.298807"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-trendy:1.32.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-trendy/1.32.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-trendy/1.32.0--r45hdfd78af_0
```
