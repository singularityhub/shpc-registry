...
updated_at: "2023-10-28 02:55:55.962842"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-trendy:1.22.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-trendy/1.22.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-trendy/1.22.0--r43hdfd78af_0
```
