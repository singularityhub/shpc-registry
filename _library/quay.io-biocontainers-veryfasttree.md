...
updated_at: "2024-12-08 03:25:19.851019"
latest: "4.0.4--h4ac6f70_0"
...
```bash
$ shpc install quay.io/biocontainers/veryfasttree:4.0.4--h4ac6f70_0
```
...
```bash
$ module load quay.io/biocontainers/veryfasttree/4.0.4--h4ac6f70_0
$ module help quay.io/biocontainers/veryfasttree/4.0.4--h4ac6f70_0
```
