...
updated_at: "2023-07-03 03:13:11.178191"
latest: "3.2.1--h4ac6f70_2"
...
```bash
$ shpc install quay.io/biocontainers/veryfasttree:3.2.1--h4ac6f70_2
```
...
```bash
$ module load quay.io/biocontainers/veryfasttree/3.2.1--h4ac6f70_2
$ module help quay.io/biocontainers/veryfasttree/3.2.1--h4ac6f70_2
```
