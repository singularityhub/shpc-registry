...
updated_at: "2025-12-08 03:58:07.023024"
latest: "4.0.5--h9948957_0"
...
```bash
$ shpc install quay.io/biocontainers/veryfasttree:4.0.5--h9948957_0
```
...
```bash
$ module load quay.io/biocontainers/veryfasttree/4.0.5--h9948957_0
$ module help quay.io/biocontainers/veryfasttree/4.0.5--h9948957_0
```
