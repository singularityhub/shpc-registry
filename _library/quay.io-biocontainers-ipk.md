...
updated_at: "2024-10-18 03:04:21.701660"
latest: "0.5.1--hdcf5f25_2"
...
```bash
$ shpc install quay.io/biocontainers/ipk:0.5.1--hdcf5f25_2
```
...
```bash
$ module load quay.io/biocontainers/ipk/0.5.1--hdcf5f25_2
$ module help quay.io/biocontainers/ipk/0.5.1--hdcf5f25_2
```
