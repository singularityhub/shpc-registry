...
updated_at: "2024-07-20 03:12:29.327682"
latest: "0.5.1--hdcf5f25_0"
...
```bash
$ shpc install quay.io/biocontainers/ipk:0.5.1--hdcf5f25_0
```
...
```bash
$ module load quay.io/biocontainers/ipk/0.5.1--hdcf5f25_0
$ module help quay.io/biocontainers/ipk/0.5.1--hdcf5f25_0
```
