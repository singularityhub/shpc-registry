...
updated_at: "2025-09-19 03:07:02.097601"
latest: "10.2.1.post1--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/nextstrain-cli:10.2.1.post1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/nextstrain-cli/10.2.1.post1--pyhdfd78af_0
$ module help quay.io/biocontainers/nextstrain-cli/10.2.1.post1--pyhdfd78af_0
```
