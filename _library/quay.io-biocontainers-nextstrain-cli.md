...
updated_at: "2023-04-20 02:40:13.302237"
...
```bash
$ shpc install quay.io/biocontainers/nextstrain-cli:6.2.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/nextstrain-cli/6.2.1--pyhdfd78af_0
$ module help quay.io/biocontainers/nextstrain-cli/6.2.1--pyhdfd78af_0
```
