...
updated_at: "2025-12-31 04:23:34.927136"
latest: "10.4.1--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/nextstrain-cli:10.4.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/nextstrain-cli/10.4.1--pyhdfd78af_0
$ module help quay.io/biocontainers/nextstrain-cli/10.4.1--pyhdfd78af_0
```
