...
updated_at: "2026-03-22 04:59:43.381058"
latest: "10.4.2--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/nextstrain-cli:10.4.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/nextstrain-cli/10.4.2--pyhdfd78af_0
$ module help quay.io/biocontainers/nextstrain-cli/10.4.2--pyhdfd78af_0
```
