...
updated_at: "2024-07-07 02:40:50.610017"
...
```bash
$ shpc install quay.io/biocontainers/nextstrain-cli:8.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/nextstrain-cli/8.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/nextstrain-cli/8.2.0--pyhdfd78af_0
```
