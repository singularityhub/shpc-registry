...
updated_at: "2025-04-20 03:11:43.810392"
latest: "9.0.0--pyhdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/nextstrain-cli:9.0.0--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/nextstrain-cli/9.0.0--pyhdfd78af_1
$ module help quay.io/biocontainers/nextstrain-cli/9.0.0--pyhdfd78af_1
```
