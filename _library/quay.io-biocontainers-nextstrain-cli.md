...
updated_at: "2024-01-08 03:13:56.912127"
latest: "7.4.0--pyhdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/nextstrain-cli:7.4.0--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/nextstrain-cli/7.4.0--pyhdfd78af_1
$ module help quay.io/biocontainers/nextstrain-cli/7.4.0--pyhdfd78af_1
```
