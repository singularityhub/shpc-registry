...
updated_at: "2023-09-25 03:13:44.662495"
latest: "7.2.0--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/nextstrain-cli:7.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/nextstrain-cli/7.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/nextstrain-cli/7.2.0--pyhdfd78af_0
```
