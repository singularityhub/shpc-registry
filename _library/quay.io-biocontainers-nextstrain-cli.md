...
updated_at: "2024-08-01 02:42:39.034345"
latest: "8.5.0--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/nextstrain-cli:8.5.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/nextstrain-cli/8.5.0--pyhdfd78af_0
$ module help quay.io/biocontainers/nextstrain-cli/8.5.0--pyhdfd78af_0
```
