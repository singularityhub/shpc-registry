...
updated_at: "2025-11-01 04:02:20.902416"
latest: "10.3.0--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/nextstrain-cli:10.3.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/nextstrain-cli/10.3.0--pyhdfd78af_0
$ module help quay.io/biocontainers/nextstrain-cli/10.3.0--pyhdfd78af_0
```
