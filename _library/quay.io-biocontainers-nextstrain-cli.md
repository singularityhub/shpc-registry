...
updated_at: "2026-04-25 05:07:26.045553"
latest: "10.5.0--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/nextstrain-cli:10.5.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/nextstrain-cli/10.5.0--pyhdfd78af_0
$ module help quay.io/biocontainers/nextstrain-cli/10.5.0--pyhdfd78af_0
```
