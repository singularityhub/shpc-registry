...
updated_at: "2024-12-09 04:18:32.476777"
...
```bash
$ shpc install quay.io/biocontainers/nextstrain-cli:8.5.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/nextstrain-cli/8.5.4--pyhdfd78af_0
$ module help quay.io/biocontainers/nextstrain-cli/8.5.4--pyhdfd78af_0
```
