...
updated_at: "2025-01-12 03:10:12.396423"
latest: "8.5.4--pyhdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/nextstrain-cli:8.5.4--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/nextstrain-cli/8.5.4--pyhdfd78af_1
$ module help quay.io/biocontainers/nextstrain-cli/8.5.4--pyhdfd78af_1
```
