...
updated_at: "2023-11-25 03:05:27.742336"
latest: "7.4.0--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/nextstrain-cli:7.4.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/nextstrain-cli/7.4.0--pyhdfd78af_0
$ module help quay.io/biocontainers/nextstrain-cli/7.4.0--pyhdfd78af_0
```
