...
updated_at: "2026-06-08 06:50:06.929138"
latest: "11.0.0--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/nextstrain-cli:11.0.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/nextstrain-cli/11.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/nextstrain-cli/11.0.0--pyhdfd78af_0
```
