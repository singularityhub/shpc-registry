...
updated_at: "2026-04-03 05:26:14.776977"
latest: "8.0.4--pyhdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/antismash:8.0.4--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/antismash/8.0.4--pyhdfd78af_1
$ module help quay.io/biocontainers/antismash/8.0.4--pyhdfd78af_1
```
