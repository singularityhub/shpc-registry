...
updated_at: "2025-09-17 03:25:00.431868"
latest: "8.0.2--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/antismash:8.0.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/antismash/8.0.2--pyhdfd78af_0
$ module help quay.io/biocontainers/antismash/8.0.2--pyhdfd78af_0
```
