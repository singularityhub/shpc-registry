...
updated_at: "2025-10-15 03:53:52.488706"
latest: "8.0.4--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/antismash:8.0.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/antismash/8.0.4--pyhdfd78af_0
$ module help quay.io/biocontainers/antismash/8.0.4--pyhdfd78af_0
```
