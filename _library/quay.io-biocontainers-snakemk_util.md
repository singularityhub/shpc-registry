---
layout: container
name:  "quay.io/biocontainers/snakemk_util"
maintainer: "@vsoch"
...
updated_at: "2026-06-04 00:33:16.863838"
...
versions:
 - "3.0.1--pyhdfd78af_0"
description: "singularity registry hpc automated addition for snakemk_util"
config: {"url": "https://biocontainers.pro/tools/snakemk_util", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for snakemk_util", "latest": {"3.0.1--pyhdfd78af_0": "sha256:450247c0694aabbb2575a386395711bd47951a512ebf5de19a51f1c33f90c624"}, "tags": {"3.0.1--pyhdfd78af_0": "sha256:450247c0694aabbb2575a386395711bd47951a512ebf5de19a51f1c33f90c624"}, "docker": "quay.io/biocontainers/snakemk_util", "aliases": {"snakemk_util": "/usr/local/bin/snakemk_util", "phc": "/usr/local/bin/phc", "eido": "/usr/local/bin/eido", "typer": "/usr/local/bin/typer", "rst2html": "/usr/local/bin/rst2html", "rst2html4": "/usr/local/bin/rst2html4", "rst2html5": "/usr/local/bin/rst2html5", "rst2latex": "/usr/local/bin/rst2latex", "rst2man": "/usr/local/bin/rst2man", "rst2odt": "/usr/local/bin/rst2odt", "rst2pseudoxml": "/usr/local/bin/rst2pseudoxml", "rst2s5": "/usr/local/bin/rst2s5", "rst2xetex": "/usr/local/bin/rst2xetex", "rst2xml": "/usr/local/bin/rst2xml", "yte": "/usr/local/bin/yte", "coloredlogs": "/usr/local/bin/coloredlogs", "pulptest": "/usr/local/bin/pulptest", "docutils": "/usr/local/bin/docutils", "snakemake": "/usr/local/bin/snakemake", "cbc": "/usr/local/bin/cbc", "clp": "/usr/local/bin/clp", "humanfriendly": "/usr/local/bin/humanfriendly", "markdown-it": "/usr/local/bin/markdown-it", "jupyter-trust": "/usr/local/bin/jupyter-trust", "tabulate": "/usr/local/bin/tabulate", "jupyter": "/usr/local/bin/jupyter"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/snakemk_util.
singularity registry hpc automated addition for snakemk_util
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/snakemk_util
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/snakemk_util:3.0.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemk_util/3.0.1--pyhdfd78af_0
$ module help quay.io/biocontainers/snakemk_util/3.0.1--pyhdfd78af_0
```
...
#### snakemk_util-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### snakemk_util-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/snakemk_util
$ podman run --it --rm --entrypoint /usr/local/bin/snakemk_util   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/snakemk_util   -v ${PWD} -w ${PWD} <container> -c " $@"
```
