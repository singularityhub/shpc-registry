...
updated_at: "2024-12-01 04:00:01.837928"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cottoncdf:2.18.0--r43hdfd78af_12
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cottoncdf/2.18.0--r43hdfd78af_12
$ module help quay.io/biocontainers/bioconductor-cottoncdf/2.18.0--r43hdfd78af_12
```
