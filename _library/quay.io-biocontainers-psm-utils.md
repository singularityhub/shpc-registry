...
updated_at: "2024-12-14 03:22:18.886740"
...
```bash
$ shpc install quay.io/biocontainers/psm-utils:1.2.0--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/psm-utils/1.2.0--pyhdfd78af_1
$ module help quay.io/biocontainers/psm-utils/1.2.0--pyhdfd78af_1
```
