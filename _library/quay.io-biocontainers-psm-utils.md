...
updated_at: "2023-10-30 02:47:05.569112"
...
```bash
$ shpc install quay.io/biocontainers/psm-utils:0.7.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/psm-utils/0.7.0--pyhdfd78af_0
$ module help quay.io/biocontainers/psm-utils/0.7.0--pyhdfd78af_0
```
