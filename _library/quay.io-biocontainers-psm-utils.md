...
updated_at: "2025-04-23 03:40:39.854329"
...
```bash
$ shpc install quay.io/biocontainers/psm-utils:1.4.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/psm-utils/1.4.0--pyhdfd78af_0
$ module help quay.io/biocontainers/psm-utils/1.4.0--pyhdfd78af_0
```
