...
updated_at: "2026-06-04 00:27:31.917298"
...
```bash
$ shpc install quay.io/biocontainers/psm-utils:1.5.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/psm-utils/1.5.4--pyhdfd78af_0
$ module help quay.io/biocontainers/psm-utils/1.5.4--pyhdfd78af_0
```
