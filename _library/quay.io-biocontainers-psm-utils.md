...
updated_at: "2023-12-12 02:35:08.913276"
...
```bash
$ shpc install quay.io/biocontainers/psm-utils:0.7.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/psm-utils/0.7.1--pyhdfd78af_0
$ module help quay.io/biocontainers/psm-utils/0.7.1--pyhdfd78af_0
```
