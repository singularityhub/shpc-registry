...
updated_at: "2025-01-28 02:55:10.516129"
...
```bash
$ shpc install quay.io/biocontainers/psm-utils:1.3.0--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/psm-utils/1.3.0--pyhdfd78af_1
$ module help quay.io/biocontainers/psm-utils/1.3.0--pyhdfd78af_1
```
