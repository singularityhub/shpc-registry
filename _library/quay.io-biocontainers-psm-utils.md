...
updated_at: "2026-01-06 04:15:27.330952"
...
```bash
$ shpc install quay.io/biocontainers/psm-utils:1.5.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/psm-utils/1.5.1--pyhdfd78af_0
$ module help quay.io/biocontainers/psm-utils/1.5.1--pyhdfd78af_0
```
