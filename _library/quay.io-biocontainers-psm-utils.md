...
updated_at: "2026-03-09 05:00:12.507632"
...
```bash
$ shpc install quay.io/biocontainers/psm-utils:1.5.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/psm-utils/1.5.2--pyhdfd78af_0
$ module help quay.io/biocontainers/psm-utils/1.5.2--pyhdfd78af_0
```
