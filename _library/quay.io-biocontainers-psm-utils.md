...
updated_at: "2024-05-12 02:44:23.991517"
...
```bash
$ shpc install quay.io/biocontainers/psm-utils:0.8.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/psm-utils/0.8.3--pyhdfd78af_0
$ module help quay.io/biocontainers/psm-utils/0.8.3--pyhdfd78af_0
```
