...
updated_at: "2025-12-16 04:01:22.145010"
latest: "1.5.0.post1--pyhdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/psm-utils:1.5.0.post1--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/psm-utils/1.5.0.post1--pyhdfd78af_1
$ module help quay.io/biocontainers/psm-utils/1.5.0.post1--pyhdfd78af_1
```
