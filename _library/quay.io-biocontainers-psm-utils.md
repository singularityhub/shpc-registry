...
updated_at: "2025-05-12 03:16:59.524002"
...
```bash
$ shpc install quay.io/biocontainers/psm-utils:1.4.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/psm-utils/1.4.1--pyhdfd78af_0
$ module help quay.io/biocontainers/psm-utils/1.4.1--pyhdfd78af_0
```
