...
updated_at: "2024-07-04 03:16:26.385103"
...
```bash
$ shpc install quay.io/biocontainers/psm-utils:0.9.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/psm-utils/0.9.0--pyhdfd78af_0
$ module help quay.io/biocontainers/psm-utils/0.9.0--pyhdfd78af_0
```
