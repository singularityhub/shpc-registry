...
updated_at: "2022-11-23 00:37:39.963801"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-compartmap:1.8.0--r40hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-compartmap/1.8.0--r40hdfd78af_1
$ module help quay.io/biocontainers/bioconductor-compartmap/1.8.0--r40hdfd78af_1
```
