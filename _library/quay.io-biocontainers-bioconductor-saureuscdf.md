...
updated_at: "2025-09-16 04:26:14.642648"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-saureuscdf:2.18.0--r44hdfd78af_13
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-saureuscdf/2.18.0--r44hdfd78af_13
$ module help quay.io/biocontainers/bioconductor-saureuscdf/2.18.0--r44hdfd78af_13
```
