...
updated_at: "2023-08-06 03:01:57.975699"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rocpai:1.12.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rocpai/1.12.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rocpai/1.12.0--r43hdfd78af_0
```
