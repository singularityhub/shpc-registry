...
updated_at: "2023-06-15 03:00:12.987771"
latest: "0.0.0--pyh7cba7a3_0"
...
```bash
$ shpc install quay.io/biocontainers/repic:0.0.0--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/repic/0.0.0--pyh7cba7a3_0
$ module help quay.io/biocontainers/repic/0.0.0--pyh7cba7a3_0
```
