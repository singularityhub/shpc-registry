---
layout: container
name:  "quay.io/biocontainers/cell2cell"
maintainer: "@vsoch"
...
updated_at: "2026-09-18 07:27:34.535525"
...
```bash
$ shpc install quay.io/biocontainers/cell2cell
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/cell2cell:0.9.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/cell2cell/0.9.0--pyhdfd78af_0
$ module help quay.io/biocontainers/cell2cell/0.9.0--pyhdfd78af_0
```
...
#### cell2cell-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### cell2cell-inspect-deffile:
