...
updated_at: "2024-10-31 03:33:22.783246"
latest: "0.7.4--py38h4ac6f70_0"
...
```bash
$ shpc install quay.io/biocontainers/cell2cell:0.7.4--py38h4ac6f70_0
```
...
```bash
$ module load quay.io/biocontainers/cell2cell/0.7.4--py38h4ac6f70_0
$ module help quay.io/biocontainers/cell2cell/0.7.4--py38h4ac6f70_0
```
