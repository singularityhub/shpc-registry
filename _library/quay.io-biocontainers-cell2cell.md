...
updated_at: "2025-10-27 04:06:06.860647"
...
```bash
$ shpc install quay.io/biocontainers/cell2cell:0.8.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/cell2cell/0.8.2--pyhdfd78af_0
$ module help quay.io/biocontainers/cell2cell/0.8.2--pyhdfd78af_0
```
