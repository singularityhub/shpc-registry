...
updated_at: "2026-02-03 05:02:54.808064"
...
```bash
$ shpc install quay.io/biocontainers/cell2cell:0.8.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/cell2cell/0.8.4--pyhdfd78af_0
$ module help quay.io/biocontainers/cell2cell/0.8.4--pyhdfd78af_0
```
