...
updated_at: "2024-08-27 02:44:33.339285"
latest: "1.0.15--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/samap:1.0.15--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/samap/1.0.15--pyhdfd78af_0
$ module help quay.io/biocontainers/samap/1.0.15--pyhdfd78af_0
```
