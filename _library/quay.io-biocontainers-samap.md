...
updated_at: "2023-02-09 03:03:28.743680"
...
```bash
$ shpc install quay.io/biocontainers/samap:1.0.13--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/samap/1.0.13--pyhdfd78af_0
$ module help quay.io/biocontainers/samap/1.0.13--pyhdfd78af_0
```
