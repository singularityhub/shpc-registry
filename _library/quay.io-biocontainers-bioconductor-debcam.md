...
updated_at: "2023-10-27 02:35:40.586971"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-debcam:1.18.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-debcam/1.18.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-debcam/1.18.0--r43hdfd78af_0
```
