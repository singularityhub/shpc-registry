...
updated_at: "2023-09-27 02:27:49.356922"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-xenopuslaeviscdf:2.18.0--r43hdfd78af_11
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-xenopuslaeviscdf/2.18.0--r43hdfd78af_11
$ module help quay.io/biocontainers/bioconductor-xenopuslaeviscdf/2.18.0--r43hdfd78af_11
```
