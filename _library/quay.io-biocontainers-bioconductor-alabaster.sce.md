---
layout: container
name:  "quay.io/biocontainers/bioconductor-alabaster.sce"
maintainer: "@vsoch"
...
updated_at: "2026-03-30 05:09:15.683330"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-alabaster.sce
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-alabaster.sce:1.10.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-alabaster.sce/1.10.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-alabaster.sce/1.10.0--r45hdfd78af_0
```
...
#### bioconductor-alabaster.sce-run:
...
#### bioconductor-alabaster.sce-shell:
...
#### bioconductor-alabaster.sce-exec:
...
#### bioconductor-alabaster.sce-inspect:
...
#### bioconductor-alabaster.sce-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-alabaster.sce-inspect-deffile:
