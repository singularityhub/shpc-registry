...
updated_at: "2025-02-07 03:13:08.798594"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-alabaster.sce:1.6.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-alabaster.sce/1.6.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-alabaster.sce/1.6.0--r44hdfd78af_0
```
