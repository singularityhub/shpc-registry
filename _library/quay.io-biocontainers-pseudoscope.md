...
updated_at: "2026-07-24 06:10:15.032388"
...
```bash
$ shpc install quay.io/biocontainers/pseudoscope:1.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pseudoscope/1.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/pseudoscope/1.1.0--pyhdfd78af_0
```
