...
updated_at: "2026-08-25 03:32:18.076563"
...
```bash
$ shpc install quay.io/biocontainers/pseudoscope:1.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pseudoscope/1.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/pseudoscope/1.2.0--pyhdfd78af_0
```
