...
updated_at: "2026-04-23 05:23:35.543686"
...
```bash
$ shpc install quay.io/biocontainers/binge:1.1.1--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/binge/1.1.1--hdfd78af_0
$ module help quay.io/biocontainers/binge/1.1.1--hdfd78af_0
```
