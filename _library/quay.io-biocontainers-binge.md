...
updated_at: "2026-02-26 04:49:45.555675"
...
```bash
$ shpc install quay.io/biocontainers/binge:1.1.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/binge/1.1.0--hdfd78af_0
$ module help quay.io/biocontainers/binge/1.1.0--hdfd78af_0
```
