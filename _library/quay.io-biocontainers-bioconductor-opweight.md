...
updated_at: "2026-03-21 05:03:19.511980"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-opweight:1.32.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-opweight/1.32.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-opweight/1.32.0--r45hdfd78af_0
```
