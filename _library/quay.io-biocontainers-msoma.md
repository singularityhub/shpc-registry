---
layout: container
name:  "quay.io/biocontainers/msoma"
maintainer: "@vsoch"
...
updated_at: "2025-12-15 04:39:34.230203"
...
singularity registry hpc automated addition for msoma
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/msoma
```
...
#### msoma-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### msoma-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/msoma
$ podman run --it --rm --entrypoint /usr/local/bin/msoma   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/msoma   -v ${PWD} -w ${PWD} <container> -c " $@"
```
