...
updated_at: "2024-06-25 02:46:18.524732"
...
```bash
$ shpc install quay.io/biocontainers/superdsm:0.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/superdsm/0.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/superdsm/0.2.0--pyhdfd78af_0
```
