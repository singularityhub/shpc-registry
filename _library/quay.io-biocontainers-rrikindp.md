...
updated_at: "2026-06-06 05:58:41.923860"
latest: "0.0.2--py312h5327adb_3"
...
```bash
$ shpc install quay.io/biocontainers/rrikindp:0.0.2--py312h5327adb_3
```
...
```bash
$ module load quay.io/biocontainers/rrikindp/0.0.2--py312h5327adb_3
$ module help quay.io/biocontainers/rrikindp/0.0.2--py312h5327adb_3
```
