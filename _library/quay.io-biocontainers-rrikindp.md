...
updated_at: "2026-08-21 03:23:14.292848"
latest: "0.0.3--py312h9b2995c_0"
...
```bash
$ shpc install quay.io/biocontainers/rrikindp:0.0.3--py312h9b2995c_0
```
...
```bash
$ module load quay.io/biocontainers/rrikindp/0.0.3--py312h9b2995c_0
$ module help quay.io/biocontainers/rrikindp/0.0.3--py312h9b2995c_0
```
