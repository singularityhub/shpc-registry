...
updated_at: "2024-02-28 02:57:57.698505"
latest: "0.0.1--py38h820c706_0"
...
```bash
$ shpc install quay.io/biocontainers/rrikindp:0.0.1--py38h820c706_0
```
...
```bash
$ module load quay.io/biocontainers/rrikindp/0.0.1--py38h820c706_0
$ module help quay.io/biocontainers/rrikindp/0.0.1--py38h820c706_0
```
