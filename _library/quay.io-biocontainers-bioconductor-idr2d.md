...
updated_at: "2023-12-23 03:03:52.807803"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-idr2d:1.16.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-idr2d/1.16.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-idr2d/1.16.0--r43hdfd78af_0
```
