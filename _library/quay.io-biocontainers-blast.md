...
updated_at: "2024-12-29 03:34:38.406863"
latest: "2.16.0--hc155240_3"
...
```bash
$ shpc install quay.io/biocontainers/blast:2.16.0--hc155240_3
```
...
```bash
$ module load quay.io/biocontainers/blast/2.16.0--hc155240_3
$ module help quay.io/biocontainers/blast/2.16.0--hc155240_3
```
