...
updated_at: "2023-08-03 02:44:23.125330"
latest: "2.14.0--h7d5a4b4_1"
...
```bash
$ shpc install quay.io/biocontainers/blast:2.14.0--h7d5a4b4_1
```
...
```bash
$ module load quay.io/biocontainers/blast/2.14.0--h7d5a4b4_1
$ module help quay.io/biocontainers/blast/2.14.0--h7d5a4b4_1
```
