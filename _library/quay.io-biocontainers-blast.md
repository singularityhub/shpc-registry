...
updated_at: "2025-03-19 03:32:44.579723"
latest: "2.16.0--h66d330f_4"
...
```bash
$ shpc install quay.io/biocontainers/blast:2.16.0--h66d330f_4
```
...
```bash
$ module load quay.io/biocontainers/blast/2.16.0--h66d330f_4
$ module help quay.io/biocontainers/blast/2.16.0--h66d330f_4
```
