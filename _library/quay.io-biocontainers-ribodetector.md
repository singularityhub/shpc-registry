...
updated_at: "2026-04-04 04:29:36.121882"
...
```bash
$ shpc install quay.io/biocontainers/ribodetector:0.3.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ribodetector/0.3.3--pyhdfd78af_0
$ module help quay.io/biocontainers/ribodetector/0.3.3--pyhdfd78af_0
```
