...
updated_at: "2024-02-22 04:53:42.052380"
...
```bash
$ shpc install quay.io/biocontainers/tracknado:0.2.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/tracknado/0.2.3--pyhdfd78af_0
$ module help quay.io/biocontainers/tracknado/0.2.3--pyhdfd78af_0
```
