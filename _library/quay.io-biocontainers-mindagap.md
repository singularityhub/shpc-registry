...
updated_at: "2023-04-02 19:16:47.468555"
...
```bash
$ shpc install quay.io/biocontainers/mindagap:0.0.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mindagap/0.0.2--pyhdfd78af_0
$ module help quay.io/biocontainers/mindagap/0.0.2--pyhdfd78af_0
```
