...
updated_at: "2022-11-14 00:14:21.822213"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gopro:1.20.0--r41hc247a5b_2
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gopro/1.20.0--r41hc247a5b_2
$ module help quay.io/biocontainers/bioconductor-gopro/1.20.0--r41hc247a5b_2
```
