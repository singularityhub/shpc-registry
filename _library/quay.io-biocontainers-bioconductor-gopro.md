...
updated_at: "2022-11-01 03:18:27.224836"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gopro:1.8.0--r351hf484d3e_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gopro/1.8.0--r351hf484d3e_0
$ module help quay.io/biocontainers/bioconductor-gopro/1.8.0--r351hf484d3e_0
```
