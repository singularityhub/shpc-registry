...
updated_at: "2026-03-23 05:34:28.931417"
...
```bash
$ shpc install quay.io/biocontainers/viralrecall:3.0.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/viralrecall/3.0.3--pyhdfd78af_0
$ module help quay.io/biocontainers/viralrecall/3.0.3--pyhdfd78af_0
```
