---
layout: container
name:  "quay.io/biocontainers/viralrecall"
maintainer: "@vsoch"
...
updated_at: "2026-08-13 04:40:41.492769"
...
```bash
$ module load quay.io/biocontainers/viralrecall/3.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/viralrecall/3.1.0--pyhdfd78af_0
```
...
#### viralrecall-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### viralrecall-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/viralrecall
$ podman run --it --rm --entrypoint /usr/local/bin/viralrecall   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/viralrecall   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/viralrecall_database
$ podman run --it --rm --entrypoint /usr/local/bin/viralrecall_database   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/viralrecall_database   -v ${PWD} -w ${PWD} <container> -c " $@"
```
