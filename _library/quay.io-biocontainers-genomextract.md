...
updated_at: "2026-06-09 08:33:12.892479"
...
```bash
$ shpc install quay.io/biocontainers/genomextract:0.2.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/genomextract/0.2.2--pyhdfd78af_0
$ module help quay.io/biocontainers/genomextract/0.2.2--pyhdfd78af_0
```
