---
layout: container
name:  "quay.io/biocontainers/echidna"
maintainer: "@vsoch"
...
updated_at: "2026-01-11 04:18:51.906519"
...
```bash
$ shpc install quay.io/biocontainers/echidna
```
...
#### echidna-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### echidna-inspect-deffile:
