---
layout: container
name:  "quay.io/biocontainers/simo-omics"
maintainer: "@vsoch"
...
updated_at: "2026-03-29 05:34:43.893083"
...
singularity registry hpc automated addition for simo-omics
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/simo-omics
```
...
#### simo-omics-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### simo-omics-inspect-deffile:
