...
updated_at: "2023-10-30 03:22:54.305919"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-bifet:1.20.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-bifet/1.20.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-bifet/1.20.0--r43hdfd78af_0
```
