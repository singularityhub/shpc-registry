...
updated_at: "2026-03-29 04:45:47.684346"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-bifet:1.30.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-bifet/1.30.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-bifet/1.30.0--r45hdfd78af_0
```
