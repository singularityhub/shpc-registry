...
updated_at: "2024-03-21 04:25:51.877843"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-phylop35way.ucsc.mm39:3.16.0--r43hdfd78af_2
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-phylop35way.ucsc.mm39/3.16.0--r43hdfd78af_2
$ module help quay.io/biocontainers/bioconductor-phylop35way.ucsc.mm39/3.16.0--r43hdfd78af_2
```
