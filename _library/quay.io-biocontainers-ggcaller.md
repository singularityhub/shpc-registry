...
updated_at: "2025-09-02 03:52:12.038656"
latest: "1.3.7--py39hd5bfb82_0"
...
```bash
$ shpc install quay.io/biocontainers/ggcaller:1.3.7--py39hd5bfb82_0
```
...
```bash
$ module load quay.io/biocontainers/ggcaller/1.3.7--py39hd5bfb82_0
$ module help quay.io/biocontainers/ggcaller/1.3.7--py39hd5bfb82_0
```
