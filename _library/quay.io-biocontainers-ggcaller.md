...
updated_at: "2024-06-26 02:56:00.016247"
latest: "1.3.5--py39h4c600e6_0"
...
```bash
$ shpc install quay.io/biocontainers/ggcaller:1.3.5--py39h4c600e6_0
```
...
```bash
$ module load quay.io/biocontainers/ggcaller/1.3.5--py39h4c600e6_0
$ module help quay.io/biocontainers/ggcaller/1.3.5--py39h4c600e6_0
```
