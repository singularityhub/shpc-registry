...
updated_at: "2024-07-22 02:45:18.352954"
latest: "1.3.6--py39h4c600e6_0"
...
```bash
$ shpc install quay.io/biocontainers/ggcaller:1.3.6--py39h4c600e6_0
```
...
```bash
$ module load quay.io/biocontainers/ggcaller/1.3.6--py39h4c600e6_0
$ module help quay.io/biocontainers/ggcaller/1.3.6--py39h4c600e6_0
```
