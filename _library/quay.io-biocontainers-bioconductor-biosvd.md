---
layout: container
name:  "quay.io/biocontainers/bioconductor-biosvd"
maintainer: "@vsoch"
...
updated_at: "2024-12-17 03:34:03.599058"
latest: "2.23.0--r40_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-biosvd
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-biosvd:2.23.0--r40_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-biosvd/2.23.0--r40_0
$ module help quay.io/biocontainers/bioconductor-biosvd/2.23.0--r40_0
```
...
#### bioconductor-biosvd-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-biosvd-inspect-deffile:
