...
updated_at: "2025-11-06 04:15:06.878394"
latest: "0.9.83--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/metabolabpy:0.9.83--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/metabolabpy/0.9.83--pyhdfd78af_0
$ module help quay.io/biocontainers/metabolabpy/0.9.83--pyhdfd78af_0
```
