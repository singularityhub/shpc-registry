...
updated_at: "2025-09-14 03:32:53.231895"
latest: "0.9.79--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/metabolabpy:0.9.79--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/metabolabpy/0.9.79--pyhdfd78af_0
$ module help quay.io/biocontainers/metabolabpy/0.9.79--pyhdfd78af_0
```
