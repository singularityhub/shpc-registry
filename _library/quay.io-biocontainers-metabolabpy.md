...
updated_at: "2025-07-27 04:32:39.146515"
latest: "0.9.78--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/metabolabpy:0.9.78--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/metabolabpy/0.9.78--pyhdfd78af_0
$ module help quay.io/biocontainers/metabolabpy/0.9.78--pyhdfd78af_0
```
