...
updated_at: "2025-03-12 03:13:46.171423"
latest: "0.9.67--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/metabolabpy:0.9.67--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/metabolabpy/0.9.67--pyhdfd78af_0
$ module help quay.io/biocontainers/metabolabpy/0.9.67--pyhdfd78af_0
```
