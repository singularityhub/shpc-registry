...
updated_at: "2026-06-27 06:22:52.118017"
...
```bash
$ shpc install quay.io/biocontainers/metabolabpy:0.9.90--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/metabolabpy/0.9.90--pyhdfd78af_0
$ module help quay.io/biocontainers/metabolabpy/0.9.90--pyhdfd78af_0
```
