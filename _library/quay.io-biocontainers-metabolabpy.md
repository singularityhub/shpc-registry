...
updated_at: "2025-12-26 03:59:00.599255"
latest: "0.9.84--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/metabolabpy:0.9.84--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/metabolabpy/0.9.84--pyhdfd78af_0
$ module help quay.io/biocontainers/metabolabpy/0.9.84--pyhdfd78af_0
```
