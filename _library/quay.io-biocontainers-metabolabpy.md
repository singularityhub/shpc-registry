...
updated_at: "2025-02-09 03:12:09.057380"
latest: "0.9.66--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/metabolabpy:0.9.66--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/metabolabpy/0.9.66--pyhdfd78af_0
$ module help quay.io/biocontainers/metabolabpy/0.9.66--pyhdfd78af_0
```
