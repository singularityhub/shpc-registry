...
updated_at: "2026-03-04 04:47:44.568011"
latest: "0.9.86--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/metabolabpy:0.9.86--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/metabolabpy/0.9.86--pyhdfd78af_0
$ module help quay.io/biocontainers/metabolabpy/0.9.86--pyhdfd78af_0
```
