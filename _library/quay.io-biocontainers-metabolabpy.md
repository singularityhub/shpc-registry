...
updated_at: "2026-01-26 04:48:44.337785"
latest: "0.9.85--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/metabolabpy:0.9.85--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/metabolabpy/0.9.85--pyhdfd78af_0
$ module help quay.io/biocontainers/metabolabpy/0.9.85--pyhdfd78af_0
```
