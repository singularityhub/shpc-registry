...
updated_at: "2024-11-25 03:02:19.785989"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-singlecellmultimodal:1.14.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-singlecellmultimodal/1.14.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-singlecellmultimodal/1.14.0--r43hdfd78af_0
```
