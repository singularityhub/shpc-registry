...
updated_at: "2022-11-05 00:16:11.699931"
latest: "1.8.0--r40_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cytodx:1.8.0--r40_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cytodx/1.8.0--r40_0
$ module help quay.io/biocontainers/bioconductor-cytodx/1.8.0--r40_0
```
