...
updated_at: "2026-03-30 06:11:37.382063"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cytodx:1.30.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cytodx/1.30.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-cytodx/1.30.0--r45hdfd78af_0
```
