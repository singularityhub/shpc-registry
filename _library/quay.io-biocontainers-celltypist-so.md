---
layout: container
name:  "quay.io/biocontainers/celltypist-so"
maintainer: "@vsoch"
github: "https://github.com/singularityhub/shpc-registry/blob/main/quay.io/biocontainers/celltypist-so/container.yaml"
config_url: "https://raw.githubusercontent.com/singularityhub/shpc-registry/main/quay.io/biocontainers/celltypist-so/container.yaml"
updated_at: "2026-04-03 05:11:32.356735"
latest: "1.6.5--pyhdfd78af_0"
container_url: "https://biocontainers.pro/tools/celltypist-so"
aliases:
 - "celltypist"
 - "session-info"
 - "session-info2"
...
versions:
 - "1.6.5--pyhdfd78af_0"
description: "singularity registry hpc automated addition for celltypist-so"
config: {"url": "https://biocontainers.pro/tools/celltypist-so", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for celltypist-so", "latest": {"1.6.5--pyhdfd78af_0": "sha256:50ea7679d76060e286c1a42b2fd020b615bca3b58fc375361cfe83a836d5adea"}, "tags": {"1.6.5--pyhdfd78af_0": "sha256:50ea7679d76060e286c1a42b2fd020b615bca3b58fc375361cfe83a836d5adea"}, "docker": "quay.io/biocontainers/celltypist-so", "aliases": {"celltypist": "/usr/local/bin/celltypist", "session-info": "/usr/local/bin/session-info", "session-info2": "/usr/local/bin/session-info2", "zarr": "/usr/local/bin/zarr", "scanpy": "/usr/local/bin/scanpy", "h5fuse": "/usr/local/bin/h5fuse", "idle3.14": "/usr/local/bin/idle3.14", "pydoc3.14": "/usr/local/bin/pydoc3.14", "python3.14": "/usr/local/bin/python3.14", "python3.14-config": "/usr/local/bin/python3.14-config", "natsort": "/usr/local/bin/natsort", "numba": "/usr/local/bin/numba", "hwloc-gather-cpuid": "/usr/local/bin/hwloc-gather-cpuid", "hwloc-annotate": "/usr/local/bin/hwloc-annotate", "hwloc-bind": "/usr/local/bin/hwloc-bind", "hwloc-calc": "/usr/local/bin/hwloc-calc", "hwloc-compress-dir": "/usr/local/bin/hwloc-compress-dir", "hwloc-diff": "/usr/local/bin/hwloc-diff", "hwloc-distrib": "/usr/local/bin/hwloc-distrib", "hwloc-gather-topology": "/usr/local/bin/hwloc-gather-topology", "hwloc-info": "/usr/local/bin/hwloc-info", "hwloc-ls": "/usr/local/bin/hwloc-ls", "hwloc-patch": "/usr/local/bin/hwloc-patch", "hwloc-ps": "/usr/local/bin/hwloc-ps", "lstopo": "/usr/local/bin/lstopo", "lstopo-no-graphics": "/usr/local/bin/lstopo-no-graphics", "qconvex": "/usr/local/bin/qconvex", "qdelaunay": "/usr/local/bin/qdelaunay"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/celltypist-so.
singularity registry hpc automated addition for celltypist-so
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/celltypist-so
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/celltypist-so:1.6.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/celltypist-so/1.6.5--pyhdfd78af_0
$ module help quay.io/biocontainers/celltypist-so/1.6.5--pyhdfd78af_0
```
...
#### celltypist-so-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### celltypist-so-inspect-deffile:
