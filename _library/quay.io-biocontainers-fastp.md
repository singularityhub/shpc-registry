...
updated_at: "2025-05-24 11:58:37.159365"
latest: "0.24.1--heae3180_0"
...
```bash
$ shpc install quay.io/biocontainers/fastp:0.24.1--heae3180_0
```
...
```bash
$ module load quay.io/biocontainers/fastp/0.24.1--heae3180_0
$ module help quay.io/biocontainers/fastp/0.24.1--heae3180_0
```
