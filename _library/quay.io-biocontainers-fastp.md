...
updated_at: "2025-06-09 04:26:56.359198"
latest: "0.25.0--heae3180_0"
...
```bash
$ shpc install quay.io/biocontainers/fastp:0.25.0--heae3180_0
```
...
```bash
$ module load quay.io/biocontainers/fastp/0.25.0--heae3180_0
$ module help quay.io/biocontainers/fastp/0.25.0--heae3180_0
```
