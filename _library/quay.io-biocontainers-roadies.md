...
updated_at: "2026-09-23 08:01:35.505015"
...
```bash
$ shpc install quay.io/biocontainers/roadies:0.2.0--py311pl5321h7654187_0
```
...
```bash
$ module load quay.io/biocontainers/roadies/0.2.0--py311pl5321h7654187_0
$ module help quay.io/biocontainers/roadies/0.2.0--py311pl5321h7654187_0
```
