---
layout: container
name:  "quay.io/biocontainers/rammappy"
maintainer: "@vsoch"
...
updated_at: "2026-08-14 08:07:07.295822"
...
singularity registry hpc automated addition for rammappy
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/rammappy
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/rammappy:0.1.3--py310h75e7593_0
```
...
```bash
$ module load quay.io/biocontainers/rammappy/0.1.3--py310h75e7593_0
$ module help quay.io/biocontainers/rammappy/0.1.3--py310h75e7593_0
```
...
#### rammappy-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### rammappy-inspect-deffile:
