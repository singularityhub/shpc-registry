...
updated_at: "2026-08-21 03:07:51.974353"
latest: "1.4.1--hdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/merqury:1.4.1--hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/merqury/1.4.1--hdfd78af_1
$ module help quay.io/biocontainers/merqury/1.4.1--hdfd78af_1
```
