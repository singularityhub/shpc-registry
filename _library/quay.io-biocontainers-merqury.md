...
updated_at: "2025-12-18 04:03:43.881351"
...
```bash
$ shpc install quay.io/biocontainers/merqury:1.3--hdfd78af_4
```
...
```bash
$ module load quay.io/biocontainers/merqury/1.3--hdfd78af_4
$ module help quay.io/biocontainers/merqury/1.3--hdfd78af_4
```
