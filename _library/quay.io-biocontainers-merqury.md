...
updated_at: "2025-09-15 03:22:03.778913"
...
```bash
$ shpc install quay.io/biocontainers/merqury:1.3--hdfd78af_3
```
...
```bash
$ module load quay.io/biocontainers/merqury/1.3--hdfd78af_3
$ module help quay.io/biocontainers/merqury/1.3--hdfd78af_3
```
