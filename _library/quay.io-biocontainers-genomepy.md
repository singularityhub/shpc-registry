...
updated_at: "2023-06-24 02:59:55.818558"
...
```bash
$ shpc install quay.io/biocontainers/genomepy:0.16.0--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/genomepy/0.16.0--pyh7cba7a3_0
$ module help quay.io/biocontainers/genomepy/0.16.0--pyh7cba7a3_0
```
