...
updated_at: "2023-03-20 02:54:53.853334"
latest: "0.15.0--pyh7cba7a3_0"
...
```bash
$ shpc install quay.io/biocontainers/genomepy:0.15.0--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/genomepy/0.15.0--pyh7cba7a3_0
$ module help quay.io/biocontainers/genomepy/0.15.0--pyh7cba7a3_0
```
