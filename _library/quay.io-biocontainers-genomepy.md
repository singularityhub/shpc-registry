...
updated_at: "2026-06-22 01:52:58.949632"
latest: "0.16.4--pyh106432d_0"
...
```bash
$ shpc install quay.io/biocontainers/genomepy:0.16.4--pyh106432d_0
```
...
```bash
$ module load quay.io/biocontainers/genomepy/0.16.4--pyh106432d_0
$ module help quay.io/biocontainers/genomepy/0.16.4--pyh106432d_0
```
