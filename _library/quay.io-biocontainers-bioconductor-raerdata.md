---
layout: container
name:  "quay.io/biocontainers/bioconductor-raerdata"
maintainer: "@vsoch"
...
updated_at: "2026-03-23 06:06:58.204438"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-raerdata
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-raerdata:1.8.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-raerdata/1.8.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-raerdata/1.8.0--r45hdfd78af_0
```
...
#### bioconductor-raerdata-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-raerdata-inspect-deffile:
