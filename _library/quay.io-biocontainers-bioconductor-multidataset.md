...
updated_at: "2026-03-28 17:27:48.786704"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-multidataset:1.38.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-multidataset/1.38.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-multidataset/1.38.0--r45hdfd78af_0
```
