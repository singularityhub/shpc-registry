...
updated_at: "2022-11-05 00:48:10.977132"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-alpine:1.8.0--r351_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-alpine/1.8.0--r351_0
$ module help quay.io/biocontainers/bioconductor-alpine/1.8.0--r351_0
```
