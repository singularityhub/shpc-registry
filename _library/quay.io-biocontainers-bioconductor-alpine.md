...
updated_at: "2022-11-13 00:34:19.426941"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-alpine:1.20.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-alpine/1.20.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-alpine/1.20.0--r41hdfd78af_0
```
