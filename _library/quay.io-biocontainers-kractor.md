...
updated_at: "2026-08-19 03:50:47.461869"
...
```bash
$ shpc install quay.io/biocontainers/kractor:5.0.0--hab7d0fd_0
```
...
```bash
$ module load quay.io/biocontainers/kractor/5.0.0--hab7d0fd_0
$ module help quay.io/biocontainers/kractor/5.0.0--hab7d0fd_0
```
