...
updated_at: "2024-05-05 02:55:01.215197"
latest: "4.1.1--h4ac6f70_0"
...
```bash
$ shpc install quay.io/biocontainers/earlgrey:4.1.1--h4ac6f70_0
```
...
```bash
$ module load quay.io/biocontainers/earlgrey/4.1.1--h4ac6f70_0
$ module help quay.io/biocontainers/earlgrey/4.1.1--h4ac6f70_0
```
