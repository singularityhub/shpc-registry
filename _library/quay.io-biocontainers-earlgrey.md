...
updated_at: "2023-12-12 02:34:41.931349"
latest: "4.0.2--h4ac6f70_0"
...
```bash
$ shpc install quay.io/biocontainers/earlgrey:4.0.2--h4ac6f70_0
```
...
```bash
$ module load quay.io/biocontainers/earlgrey/4.0.2--h4ac6f70_0
$ module help quay.io/biocontainers/earlgrey/4.0.2--h4ac6f70_0
```
