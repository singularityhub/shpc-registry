...
updated_at: "2024-08-07 03:14:57.850421"
latest: "4.3.0--h4ac6f70_0"
...
```bash
$ shpc install quay.io/biocontainers/earlgrey:4.3.0--h4ac6f70_0
```
...
```bash
$ module load quay.io/biocontainers/earlgrey/4.3.0--h4ac6f70_0
$ module help quay.io/biocontainers/earlgrey/4.3.0--h4ac6f70_0
```
