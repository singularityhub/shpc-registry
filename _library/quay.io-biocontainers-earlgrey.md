...
updated_at: "2024-04-04 02:53:43.178861"
latest: "4.1.0--h4ac6f70_0"
...
```bash
$ shpc install quay.io/biocontainers/earlgrey:4.1.0--h4ac6f70_0
```
...
```bash
$ module load quay.io/biocontainers/earlgrey/4.1.0--h4ac6f70_0
$ module help quay.io/biocontainers/earlgrey/4.1.0--h4ac6f70_0
```
