...
updated_at: "2024-10-16 03:46:24.028651"
latest: "4.5.0--h4ac6f70_1"
...
```bash
$ shpc install quay.io/biocontainers/earlgrey:4.5.0--h4ac6f70_1
```
...
```bash
$ module load quay.io/biocontainers/earlgrey/4.5.0--h4ac6f70_1
$ module help quay.io/biocontainers/earlgrey/4.5.0--h4ac6f70_1
```
