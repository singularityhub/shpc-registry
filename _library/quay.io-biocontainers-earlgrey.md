...
updated_at: "2024-11-16 03:02:49.959947"
...
```bash
$ shpc install quay.io/biocontainers/earlgrey:5.0.0--h4ac6f70_1
```
...
```bash
$ module load quay.io/biocontainers/earlgrey/5.0.0--h4ac6f70_1
$ module help quay.io/biocontainers/earlgrey/5.0.0--h4ac6f70_1
```
