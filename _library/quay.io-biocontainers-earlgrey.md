...
updated_at: "2024-07-01 04:01:57.286109"
latest: "4.2.4--h4ac6f70_1"
...
```bash
$ shpc install quay.io/biocontainers/earlgrey:4.2.4--h4ac6f70_1
```
...
```bash
$ module load quay.io/biocontainers/earlgrey/4.2.4--h4ac6f70_1
$ module help quay.io/biocontainers/earlgrey/4.2.4--h4ac6f70_1
```
