...
updated_at: "2024-10-01 03:14:10.069397"
latest: "4.4.4--h4ac6f70_0"
...
```bash
$ shpc install quay.io/biocontainers/earlgrey:4.4.4--h4ac6f70_0
```
...
```bash
$ module load quay.io/biocontainers/earlgrey/4.4.4--h4ac6f70_0
$ module help quay.io/biocontainers/earlgrey/4.4.4--h4ac6f70_0
```
