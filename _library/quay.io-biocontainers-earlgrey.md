...
updated_at: "2024-01-20 02:57:00.811428"
latest: "4.0.3--h4ac6f70_0"
...
```bash
$ shpc install quay.io/biocontainers/earlgrey:4.0.3--h4ac6f70_0
```
...
```bash
$ module load quay.io/biocontainers/earlgrey/4.0.3--h4ac6f70_0
$ module help quay.io/biocontainers/earlgrey/4.0.3--h4ac6f70_0
```
