...
updated_at: "2024-08-23 02:51:03.463747"
latest: "4.4.0--h4ac6f70_0"
...
```bash
$ shpc install quay.io/biocontainers/earlgrey:4.4.0--h4ac6f70_0
```
...
```bash
$ module load quay.io/biocontainers/earlgrey/4.4.0--h4ac6f70_0
$ module help quay.io/biocontainers/earlgrey/4.4.0--h4ac6f70_0
```
