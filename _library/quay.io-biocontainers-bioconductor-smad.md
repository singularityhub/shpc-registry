...
updated_at: "2024-02-09 02:44:39.774036"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-smad:1.18.0--r43hf17093f_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-smad/1.18.0--r43hf17093f_1
$ module help quay.io/biocontainers/bioconductor-smad/1.18.0--r43hf17093f_1
```
