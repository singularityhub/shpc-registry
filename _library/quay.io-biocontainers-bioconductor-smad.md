...
updated_at: "2023-08-03 03:39:06.965416"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-smad:1.16.0--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-smad/1.16.0--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-smad/1.16.0--r43hf17093f_0
```
