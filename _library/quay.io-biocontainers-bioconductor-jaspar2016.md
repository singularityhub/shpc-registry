...
updated_at: "2023-10-13 03:05:47.257323"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-jaspar2016:1.28.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-jaspar2016/1.28.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-jaspar2016/1.28.0--r43hdfd78af_0
```
