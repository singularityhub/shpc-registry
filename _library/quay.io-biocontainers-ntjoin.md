...
updated_at: "2026-03-29 05:30:07.400077"
latest: "1.1.5--py312h05cac1d_3"
...
```bash
$ shpc install quay.io/biocontainers/ntjoin:1.1.5--py312h05cac1d_3
```
...
```bash
$ module load quay.io/biocontainers/ntjoin/1.1.5--py312h05cac1d_3
$ module help quay.io/biocontainers/ntjoin/1.1.5--py312h05cac1d_3
```
