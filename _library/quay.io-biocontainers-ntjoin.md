...
updated_at: "2024-07-20 03:14:44.026435"
latest: "1.1.4--py312hb36dd0b_1"
...
```bash
$ shpc install quay.io/biocontainers/ntjoin:1.1.4--py312hb36dd0b_1
```
...
```bash
$ module load quay.io/biocontainers/ntjoin/1.1.4--py312hb36dd0b_1
$ module help quay.io/biocontainers/ntjoin/1.1.4--py312hb36dd0b_1
```
