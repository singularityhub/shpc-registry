...
updated_at: "2026-08-29 09:33:18.675855"
latest: "1.1.7--py312h05cac1d_0"
...
```bash
$ shpc install quay.io/biocontainers/ntjoin:1.1.7--py312h05cac1d_0
```
...
```bash
$ module load quay.io/biocontainers/ntjoin/1.1.7--py312h05cac1d_0
$ module help quay.io/biocontainers/ntjoin/1.1.7--py312h05cac1d_0
```
