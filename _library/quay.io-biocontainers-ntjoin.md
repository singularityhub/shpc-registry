...
updated_at: "2025-11-17 04:55:16.221884"
...
```bash
$ shpc install quay.io/biocontainers/ntjoin:1.1.5--py312h7896c42_2
```
...
```bash
$ module load quay.io/biocontainers/ntjoin/1.1.5--py312h7896c42_2
$ module help quay.io/biocontainers/ntjoin/1.1.5--py312h7896c42_2
```
