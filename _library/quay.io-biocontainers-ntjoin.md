...
updated_at: "2024-09-07 03:27:06.243992"
latest: "1.1.5--py312hb36dd0b_0"
...
```bash
$ shpc install quay.io/biocontainers/ntjoin:1.1.5--py312hb36dd0b_0
```
...
```bash
$ module load quay.io/biocontainers/ntjoin/1.1.5--py312hb36dd0b_0
$ module help quay.io/biocontainers/ntjoin/1.1.5--py312hb36dd0b_0
```
