...
updated_at: "2025-04-16 03:14:43.092976"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gdnainrnaseqdata:1.6.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gdnainrnaseqdata/1.6.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-gdnainrnaseqdata/1.6.0--r44hdfd78af_0
```
