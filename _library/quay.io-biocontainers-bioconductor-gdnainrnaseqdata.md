...
updated_at: "2023-11-01 02:53:22.941001"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gdnainrnaseqdata:1.0.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gdnainrnaseqdata/1.0.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-gdnainrnaseqdata/1.0.0--r43hdfd78af_0
```
