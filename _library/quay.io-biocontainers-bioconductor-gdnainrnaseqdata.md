---
layout: container
name:  "quay.io/biocontainers/bioconductor-gdnainrnaseqdata"
maintainer: "@vsoch"
...
updated_at: "2026-03-20 00:50:30.029614"
...
description: "singularity registry hpc automated addition for bioconductor-gdnainrnaseqdata"
config: {"url": "https://biocontainers.pro/tools/bioconductor-gdnainrnaseqdata", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for bioconductor-gdnainrnaseqdata", "latest": {"1.10.0--r45hdfd78af_0": "sha256:7057ea8d9ddd803717c916ef43fd61a436d200a065edc9b52603d75612c52ac1"}, "tags": {"1.0.0--r43hdfd78af_0": "sha256:236ea95c74c756b37d8814da93b84655811ce861dbbf446e3ae0d664995f8811", "1.2.0--r43hdfd78af_0": "sha256:baf35b2be846a0f55df0ec34949ae3e8de21d7d32f58ecc643cc8f9bf0fe3540", "1.6.0--r44hdfd78af_0": "sha256:5cce795ad1736df90552c4805d5b63841356ab5d37fe683f80629805c0fcd860", "1.10.0--r45hdfd78af_0": "sha256:7057ea8d9ddd803717c916ef43fd61a436d200a065edc9b52603d75612c52ac1"}, "docker": "quay.io/biocontainers/bioconductor-gdnainrnaseqdata", "aliases": {"hb-info": "/usr/local/bin/hb-info", "tjbench": "/usr/local/bin/tjbench", "2to3-3.11": "/usr/local/bin/2to3-3.11", "idle3.11": "/usr/local/bin/idle3.11", "pydoc3.11": "/usr/local/bin/pydoc3.11", "python3.11": "/usr/local/bin/python3.11", "python3.11-config": "/usr/local/bin/python3.11-config", "installBiocDataPackage.sh": "/usr/local/bin/installBiocDataPackage.sh", "tomlq": "/usr/local/bin/tomlq", "xq": "/usr/local/bin/xq", "yq": "/usr/local/bin/yq", "jq": "/usr/local/bin/jq", "onig-config": "/usr/local/bin/onig-config", "activate-global-python-argcomplete": "/usr/local/bin/activate-global-python-argcomplete", "python-argcomplete-check-easy-install-script": "/usr/local/bin/python-argcomplete-check-easy-install-script", "register-python-argcomplete": "/usr/local/bin/register-python-argcomplete", "pandoc": "/usr/local/bin/pandoc", "python3.1": "/usr/local/bin/python3.1"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/bioconductor-gdnainrnaseqdata.
singularity registry hpc automated addition for bioconductor-gdnainrnaseqdata
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/bioconductor-gdnainrnaseqdata
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-gdnainrnaseqdata:1.10.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gdnainrnaseqdata/1.10.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-gdnainrnaseqdata/1.10.0--r45hdfd78af_0
```
...
#### bioconductor-gdnainrnaseqdata-run:
...
#### bioconductor-gdnainrnaseqdata-shell:
...
#### bioconductor-gdnainrnaseqdata-exec:
...
#### bioconductor-gdnainrnaseqdata-inspect:
...
#### bioconductor-gdnainrnaseqdata-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-gdnainrnaseqdata-inspect-deffile:
