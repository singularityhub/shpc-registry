...
updated_at: "2025-01-12 03:09:00.512179"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gdnainrnaseqdata:1.2.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gdnainrnaseqdata/1.2.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-gdnainrnaseqdata/1.2.0--r43hdfd78af_0
```
