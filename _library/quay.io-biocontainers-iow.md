...
updated_at: "2025-03-23 03:19:10.251621"
latest: "1.0.5--py310h8ea774a_6"
...
```bash
$ shpc install quay.io/biocontainers/iow:1.0.5--py310h8ea774a_6
```
...
```bash
$ module load quay.io/biocontainers/iow/1.0.5--py310h8ea774a_6
$ module help quay.io/biocontainers/iow/1.0.5--py310h8ea774a_6
```
