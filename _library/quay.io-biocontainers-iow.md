...
updated_at: "2026-01-14 04:21:30.242637"
latest: "1.0.8--py310h1fe012e_1"
...
```bash
$ shpc install quay.io/biocontainers/iow:1.0.8--py310h1fe012e_1
```
...
```bash
$ module load quay.io/biocontainers/iow/1.0.8--py310h1fe012e_1
$ module help quay.io/biocontainers/iow/1.0.8--py310h1fe012e_1
```
