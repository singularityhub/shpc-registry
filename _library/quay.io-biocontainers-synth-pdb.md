---
layout: container
name:  "quay.io/biocontainers/synth-pdb"
maintainer: "@vsoch"
...
updated_at: "2026-08-20 03:19:13.027857"
latest: "1.39.0--pyhdfd78af_0"
...
```bash
$ module load quay.io/biocontainers/synth-pdb/1.39.0--pyhdfd78af_0
$ module help quay.io/biocontainers/synth-pdb/1.39.0--pyhdfd78af_0
```
...
#### synth-pdb-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### synth-pdb-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/synth-pdb
$ podman run --it --rm --entrypoint /usr/local/bin/synth-pdb   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/synth-pdb   -v ${PWD} -w ${PWD} <container> -c " $@"
```
