...
updated_at: "2026-04-02 04:39:02.917844"
latest: "33.0.1--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/augur:33.0.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/augur/33.0.1--pyhdfd78af_0
$ module help quay.io/biocontainers/augur/33.0.1--pyhdfd78af_0
```
