...
updated_at: "2025-02-07 02:52:22.016761"
latest: "28.0.0--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/augur:28.0.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/augur/28.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/augur/28.0.0--pyhdfd78af_0
```
