...
updated_at: "2025-06-08 05:34:45.565919"
latest: "31.1.0--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/augur:31.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/augur/31.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/augur/31.1.0--pyhdfd78af_0
```
