...
updated_at: "2024-12-17 03:59:08.346394"
latest: "26.2.0--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/augur:26.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/augur/26.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/augur/26.2.0--pyhdfd78af_0
```
