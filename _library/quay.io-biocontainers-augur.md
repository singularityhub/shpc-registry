...
updated_at: "2025-09-25 03:24:49.875578"
latest: "31.4.0--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/augur:31.4.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/augur/31.4.0--pyhdfd78af_0
$ module help quay.io/biocontainers/augur/31.4.0--pyhdfd78af_0
```
