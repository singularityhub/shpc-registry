...
updated_at: "2024-08-08 03:16:05.458686"
latest: "25.2.0--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/augur:25.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/augur/25.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/augur/25.2.0--pyhdfd78af_0
```
