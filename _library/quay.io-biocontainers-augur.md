...
updated_at: "2026-07-01 15:50:45.576196"
latest: "33.4.1--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/augur:33.4.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/augur/33.4.1--pyhdfd78af_0
$ module help quay.io/biocontainers/augur/33.4.1--pyhdfd78af_0
```
