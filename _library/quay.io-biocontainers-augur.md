...
updated_at: "2025-04-16 05:24:10.979347"
latest: "29.0.0--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/augur:29.0.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/augur/29.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/augur/29.0.0--pyhdfd78af_0
```
