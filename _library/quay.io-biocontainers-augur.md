...
updated_at: "2026-06-03 07:37:42.589707"
latest: "33.3.0--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/augur:33.3.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/augur/33.3.0--pyhdfd78af_0
$ module help quay.io/biocontainers/augur/33.3.0--pyhdfd78af_0
```
