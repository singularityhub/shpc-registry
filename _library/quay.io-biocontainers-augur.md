...
updated_at: "2025-11-01 03:53:00.786080"
latest: "31.5.0--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/augur:31.5.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/augur/31.5.0--pyhdfd78af_0
$ module help quay.io/biocontainers/augur/31.5.0--pyhdfd78af_0
```
