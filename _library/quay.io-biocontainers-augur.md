...
updated_at: "2026-08-10 04:01:43.926669"
latest: "34.1.1--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/augur:34.1.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/augur/34.1.1--pyhdfd78af_0
$ module help quay.io/biocontainers/augur/34.1.1--pyhdfd78af_0
```
