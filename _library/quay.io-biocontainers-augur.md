...
updated_at: "2025-08-03 04:29:52.895421"
latest: "31.3.0--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/augur:31.3.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/augur/31.3.0--pyhdfd78af_0
$ module help quay.io/biocontainers/augur/31.3.0--pyhdfd78af_0
```
