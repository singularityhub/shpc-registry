...
updated_at: "2025-01-14 03:29:23.883939"
latest: "27.0.0--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/augur:27.0.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/augur/27.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/augur/27.0.0--pyhdfd78af_0
```
