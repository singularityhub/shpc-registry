...
updated_at: "2025-07-31 11:42:00.831922"
latest: "31.2.1--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/augur:31.2.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/augur/31.2.1--pyhdfd78af_0
$ module help quay.io/biocontainers/augur/31.2.1--pyhdfd78af_0
```
