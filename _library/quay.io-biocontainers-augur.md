...
updated_at: "2025-11-16 03:59:01.807582"
latest: "32.0.0--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/augur:32.0.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/augur/32.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/augur/32.0.0--pyhdfd78af_0
```
