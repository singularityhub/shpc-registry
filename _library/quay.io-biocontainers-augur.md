...
updated_at: "2026-05-26 22:09:17.690685"
latest: "33.1.0--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/augur:33.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/augur/33.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/augur/33.1.0--pyhdfd78af_0
```
