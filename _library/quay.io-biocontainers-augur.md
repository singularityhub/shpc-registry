...
updated_at: "2025-12-27 04:04:43.882727"
latest: "32.1.0--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/augur:32.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/augur/32.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/augur/32.1.0--pyhdfd78af_0
```
