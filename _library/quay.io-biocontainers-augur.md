...
updated_at: "2025-05-14 03:42:55.814274"
latest: "30.0.1--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/augur:30.0.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/augur/30.0.1--pyhdfd78af_0
$ module help quay.io/biocontainers/augur/30.0.1--pyhdfd78af_0
```
