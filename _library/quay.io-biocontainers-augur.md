...
updated_at: "2024-10-14 17:21:53.887231"
latest: "26.0.0--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/augur:26.0.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/augur/26.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/augur/26.0.0--pyhdfd78af_0
```
