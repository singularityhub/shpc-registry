...
updated_at: "2026-02-05 04:56:51.544481"
latest: "33.0.0--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/augur:33.0.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/augur/33.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/augur/33.0.0--pyhdfd78af_0
```
