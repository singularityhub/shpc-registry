...
updated_at: "2023-08-09 03:23:47.574609"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-spatiallibd:1.12.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-spatiallibd/1.12.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-spatiallibd/1.12.0--r43hdfd78af_0
```
