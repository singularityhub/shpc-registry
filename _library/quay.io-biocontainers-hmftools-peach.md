---
layout: container
name:  "quay.io/biocontainers/hmftools-peach"
maintainer: "@vsoch"
...
updated_at: "2025-10-04 03:17:16.077166"
...
versions:
 - "2.0.0--hdfd78af_0"
description: "singularity registry hpc automated addition for hmftools-peach"
config: {"url": "https://biocontainers.pro/tools/hmftools-peach", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for hmftools-peach", "latest": {"2.0.0--hdfd78af_0": "sha256:83eb63462efdf7dd30dda980c2ba2fceee17ebe198480e8b4588adcd23d705ae"}, "tags": {"2.0.0--hdfd78af_0": "sha256:83eb63462efdf7dd30dda980c2ba2fceee17ebe198480e8b4588adcd23d705ae"}, "docker": "quay.io/biocontainers/hmftools-peach", "aliases": {"peach": "/usr/local/bin/peach", "jwebserver": "/usr/local/bin/jwebserver", "jpackage": "/usr/local/bin/jpackage", "cups-config": "/usr/local/bin/cups-config", "ippeveprinter": "/usr/local/bin/ippeveprinter", "ipptool": "/usr/local/bin/ipptool", "hb-info": "/usr/local/bin/hb-info", "jfr": "/usr/local/bin/jfr", "jdeprscan": "/usr/local/bin/jdeprscan", "jhsdb": "/usr/local/bin/jhsdb", "jimage": "/usr/local/bin/jimage", "jlink": "/usr/local/bin/jlink", "jmod": "/usr/local/bin/jmod", "jshell": "/usr/local/bin/jshell", "tjbench": "/usr/local/bin/tjbench", "aserver": "/usr/local/bin/aserver", "jdeps": "/usr/local/bin/jdeps", "jar": "/usr/local/bin/jar", "jarsigner": "/usr/local/bin/jarsigner", "java": "/usr/local/bin/java", "javac": "/usr/local/bin/javac", "javadoc": "/usr/local/bin/javadoc", "javap": "/usr/local/bin/javap", "jcmd": "/usr/local/bin/jcmd", "jconsole": "/usr/local/bin/jconsole", "jdb": "/usr/local/bin/jdb"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/hmftools-peach.
singularity registry hpc automated addition for hmftools-peach
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/hmftools-peach
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/hmftools-peach:2.0.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hmftools-peach/2.0.0--hdfd78af_0
$ module help quay.io/biocontainers/hmftools-peach/2.0.0--hdfd78af_0
```
...
#### hmftools-peach-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### hmftools-peach-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/peach
$ podman run --it --rm --entrypoint /usr/local/bin/peach   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/peach   -v ${PWD} -w ${PWD} <container> -c " $@"
```
