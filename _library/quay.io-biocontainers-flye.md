...
updated_at: "2024-09-02 02:59:29.573758"
latest: "2.9.4--py39hdf45acc_2"
...
```bash
$ shpc install quay.io/biocontainers/flye:2.9.4--py39hdf45acc_2
```
...
```bash
$ module load quay.io/biocontainers/flye/2.9.4--py39hdf45acc_2
$ module help quay.io/biocontainers/flye/2.9.4--py39hdf45acc_2
```
