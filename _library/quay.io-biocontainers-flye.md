...
updated_at: "2025-08-28 12:41:05.708352"
...
```bash
$ shpc install quay.io/biocontainers/flye:2.9.6--py310h275bdba_0
```
...
```bash
$ module load quay.io/biocontainers/flye/2.9.6--py310h275bdba_0
$ module help quay.io/biocontainers/flye/2.9.6--py310h275bdba_0
```
