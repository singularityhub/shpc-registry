...
updated_at: "2026-06-06 16:00:27.984067"
latest: "2.9.6--py313h7fbb527_1"
...
```bash
$ shpc install quay.io/biocontainers/flye:2.9.6--py313h7fbb527_1
```
...
```bash
$ module load quay.io/biocontainers/flye/2.9.6--py313h7fbb527_1
$ module help quay.io/biocontainers/flye/2.9.6--py313h7fbb527_1
```
