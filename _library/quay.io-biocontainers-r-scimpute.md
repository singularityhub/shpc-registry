...
updated_at: "2022-10-29 17:41:28.176077"
...
```bash
$ shpc install quay.io/biocontainers/r-scimpute:0.0.8--r41hdfd78af_3
```
...
```bash
$ module load quay.io/biocontainers/r-scimpute/0.0.8--r41hdfd78af_3
$ module help quay.io/biocontainers/r-scimpute/0.0.8--r41hdfd78af_3
```
