...
updated_at: "2023-12-03 02:44:13.604841"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-amplican:1.22.1--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-amplican/1.22.1--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-amplican/1.22.1--r43hf17093f_0
```
