...
updated_at: "2025-09-02 03:16:53.696209"
latest: "1.15.1--hfc9290b_0"
...
```bash
$ shpc install quay.io/biocontainers/staden_io_lib:1.15.1--hfc9290b_0
```
...
```bash
$ module load quay.io/biocontainers/staden_io_lib/1.15.1--hfc9290b_0
$ module help quay.io/biocontainers/staden_io_lib/1.15.1--hfc9290b_0
```
