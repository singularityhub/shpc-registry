...
updated_at: "2024-07-03 03:01:48.783685"
latest: "1.14.14--ha3e660a_9"
...
```bash
$ shpc install quay.io/biocontainers/staden_io_lib:1.14.14--ha3e660a_9
```
...
```bash
$ module load quay.io/biocontainers/staden_io_lib/1.14.14--ha3e660a_9
$ module help quay.io/biocontainers/staden_io_lib/1.14.14--ha3e660a_9
```
