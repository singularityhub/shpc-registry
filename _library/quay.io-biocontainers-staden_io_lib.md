...
updated_at: "2024-09-09 05:37:21.207252"
latest: "1.15.0--hbc8f6b7_0"
...
```bash
$ shpc install quay.io/biocontainers/staden_io_lib:1.15.0--hbc8f6b7_0
```
...
```bash
$ module load quay.io/biocontainers/staden_io_lib/1.15.0--hbc8f6b7_0
$ module help quay.io/biocontainers/staden_io_lib/1.15.0--hbc8f6b7_0
```
