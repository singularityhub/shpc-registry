...
updated_at: "2026-03-29 05:01:12.473070"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-human370v1ccrlmm:1.0.2--r45hdfd78af_14
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-human370v1ccrlmm/1.0.2--r45hdfd78af_14
$ module help quay.io/biocontainers/bioconductor-human370v1ccrlmm/1.0.2--r45hdfd78af_14
```
