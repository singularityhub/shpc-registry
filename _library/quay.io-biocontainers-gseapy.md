...
updated_at: "2026-03-21 04:47:14.046569"
latest: "1.1.11--py311h5e00ca1_1"
...
```bash
$ shpc install quay.io/biocontainers/gseapy:1.1.11--py311h5e00ca1_1
```
...
```bash
$ module load quay.io/biocontainers/gseapy/1.1.11--py311h5e00ca1_1
$ module help quay.io/biocontainers/gseapy/1.1.11--py311h5e00ca1_1
```
