...
updated_at: "2025-04-06 03:48:45.521700"
latest: "1.1.6--py39h5b94c0b_0"
...
```bash
$ shpc install quay.io/biocontainers/gseapy:1.1.6--py39h5b94c0b_0
```
...
```bash
$ module load quay.io/biocontainers/gseapy/1.1.6--py39h5b94c0b_0
$ module help quay.io/biocontainers/gseapy/1.1.6--py39h5b94c0b_0
```
