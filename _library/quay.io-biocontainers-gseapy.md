...
updated_at: "2026-06-30 06:24:41.357284"
latest: "1.3.0--py311heb3b1e3_0"
...
```bash
$ shpc install quay.io/biocontainers/gseapy:1.3.0--py311heb3b1e3_0
```
...
```bash
$ module load quay.io/biocontainers/gseapy/1.3.0--py311heb3b1e3_0
$ module help quay.io/biocontainers/gseapy/1.3.0--py311heb3b1e3_0
```
