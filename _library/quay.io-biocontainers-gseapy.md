...
updated_at: "2024-07-14 02:57:12.255937"
latest: "1.1.3--py311h5e00ca1_1"
...
```bash
$ shpc install quay.io/biocontainers/gseapy:1.1.3--py311h5e00ca1_1
```
...
```bash
$ module load quay.io/biocontainers/gseapy/1.1.3--py311h5e00ca1_1
$ module help quay.io/biocontainers/gseapy/1.1.3--py311h5e00ca1_1
```
