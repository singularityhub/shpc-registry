...
updated_at: "2024-12-23 03:36:51.807229"
latest: "1.1.4--py311h5e00ca1_0"
...
```bash
$ shpc install quay.io/biocontainers/gseapy:1.1.4--py311h5e00ca1_0
```
...
```bash
$ module load quay.io/biocontainers/gseapy/1.1.4--py311h5e00ca1_0
$ module help quay.io/biocontainers/gseapy/1.1.4--py311h5e00ca1_0
```
