...
updated_at: "2026-06-06 15:48:58.786540"
latest: "1.2.1--py311heb3b1e3_0"
...
```bash
$ shpc install quay.io/biocontainers/gseapy:1.2.1--py311heb3b1e3_0
```
...
```bash
$ module load quay.io/biocontainers/gseapy/1.2.1--py311heb3b1e3_0
$ module help quay.io/biocontainers/gseapy/1.2.1--py311heb3b1e3_0
```
