...
updated_at: "2026-06-22 02:07:57.504353"
latest: "2.1.17--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/jacusa2:2.1.17--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/jacusa2/2.1.17--hdfd78af_0
$ module help quay.io/biocontainers/jacusa2/2.1.17--hdfd78af_0
```
