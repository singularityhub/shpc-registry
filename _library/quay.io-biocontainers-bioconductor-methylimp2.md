...
updated_at: "2026-04-02 05:13:13.785153"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-methylimp2:1.6.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-methylimp2/1.6.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-methylimp2/1.6.0--r45hdfd78af_0
```
