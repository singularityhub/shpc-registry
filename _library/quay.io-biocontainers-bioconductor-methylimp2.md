---
layout: container
name:  "quay.io/biocontainers/bioconductor-methylimp2"
maintainer: "@vsoch"
github: "https://github.com/singularityhub/shpc-registry/blob/main/quay.io/biocontainers/bioconductor-methylimp2/container.yaml"
config_url: "https://raw.githubusercontent.com/singularityhub/shpc-registry/main/quay.io/biocontainers/bioconductor-methylimp2/container.yaml"
updated_at: "2025-05-08 05:22:07.115748"
latest: "1.2.0--r44hdfd78af_0"
container_url: "https://biocontainers.pro/tools/bioconductor-methylimp2"
aliases:
...
versions:
 - "1.2.0--r44hdfd78af_0"
description: "singularity registry hpc automated addition for bioconductor-methylimp2"
config: {"url": "https://biocontainers.pro/tools/bioconductor-methylimp2", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for bioconductor-methylimp2", "latest": {"1.2.0--r44hdfd78af_0": "sha256:42c0dec017ebcd0099712dc157a29b9056db6bbd73db2c2e366d64dbdc499377"}, "tags": {"1.2.0--r44hdfd78af_0": "sha256:42c0dec017ebcd0099712dc157a29b9056db6bbd73db2c2e366d64dbdc499377"}, "docker": "quay.io/biocontainers/bioconductor-methylimp2", "aliases": {"x86_64-conda-linux-gnu.cfg": "/usr/local/bin/x86_64-conda-linux-gnu.cfg", "idle3.13": "/usr/local/bin/idle3.13", "pydoc3.13": "/usr/local/bin/pydoc3.13", "python3.13": "/usr/local/bin/python3.13", "python3.13-config": "/usr/local/bin/python3.13-config", "installBiocDataPackage.sh": "/usr/local/bin/installBiocDataPackage.sh", "tomlq": "/usr/local/bin/tomlq", "xq": "/usr/local/bin/xq", "yq": "/usr/local/bin/yq", "jq": "/usr/local/bin/jq", "onig-config": "/usr/local/bin/onig-config", "hb-info": "/usr/local/bin/hb-info", "activate-global-python-argcomplete": "/usr/local/bin/activate-global-python-argcomplete", "python-argcomplete-check-easy-install-script": "/usr/local/bin/python-argcomplete-check-easy-install-script", "register-python-argcomplete": "/usr/local/bin/register-python-argcomplete", "tjbench": "/usr/local/bin/tjbench"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/bioconductor-methylimp2.
singularity registry hpc automated addition for bioconductor-methylimp2
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/bioconductor-methylimp2
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-methylimp2:1.2.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-methylimp2/1.2.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-methylimp2/1.2.0--r44hdfd78af_0
```
...
#### bioconductor-methylimp2-inspect:
...
#### bioconductor-methylimp2-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-methylimp2-inspect-deffile:
