...
updated_at: "2023-10-02 02:32:49.721097"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-microstasis:1.0.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-microstasis/1.0.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-microstasis/1.0.0--r43hdfd78af_0
```
