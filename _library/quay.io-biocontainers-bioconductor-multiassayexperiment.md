...
updated_at: "2024-02-24 02:43:38.633215"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-multiassayexperiment:1.28.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-multiassayexperiment/1.28.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-multiassayexperiment/1.28.0--r43hdfd78af_0
```
