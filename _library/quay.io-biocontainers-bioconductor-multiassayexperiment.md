...
updated_at: "2026-03-13 17:20:07.466713"
latest: "1.36.1--r45hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-multiassayexperiment:1.36.1--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-multiassayexperiment/1.36.1--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-multiassayexperiment/1.36.1--r45hdfd78af_0
```
