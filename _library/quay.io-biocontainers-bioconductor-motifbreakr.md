...
updated_at: "2023-10-20 02:48:00.428123"
latest: "2.13.7--r43hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-motifbreakr:2.13.7--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-motifbreakr/2.13.7--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-motifbreakr/2.13.7--r43hdfd78af_0
```
