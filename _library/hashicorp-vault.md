...
updated_at: "2023-10-04 05:25:37.795496"
latest: "1.13.2"
...
```bash
$ shpc install hashicorp/vault:1.13.2
```
...
```bash
$ module load hashicorp/vault/1.13.2
$ module help hashicorp/vault/1.13.2
```
