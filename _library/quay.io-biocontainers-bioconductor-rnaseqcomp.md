...
updated_at: "2023-12-09 03:08:19.877823"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rnaseqcomp:1.30.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rnaseqcomp/1.30.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rnaseqcomp/1.30.0--r43hdfd78af_0
```
