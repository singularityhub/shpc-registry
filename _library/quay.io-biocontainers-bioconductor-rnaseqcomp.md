...
updated_at: "2024-12-22 03:13:34.490923"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rnaseqcomp:1.32.0--r43hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rnaseqcomp/1.32.0--r43hdfd78af_1
$ module help quay.io/biocontainers/bioconductor-rnaseqcomp/1.32.0--r43hdfd78af_1
```
