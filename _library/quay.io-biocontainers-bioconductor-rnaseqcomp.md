...
updated_at: "2026-03-15 05:12:13.566372"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rnaseqcomp:1.40.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rnaseqcomp/1.40.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rnaseqcomp/1.40.0--r45hdfd78af_0
```
