...
updated_at: "2024-02-09 03:03:31.525383"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-contibait:1.30.0--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-contibait/1.30.0--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-contibait/1.30.0--r43hf17093f_0
```
