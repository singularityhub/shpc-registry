...
updated_at: "2023-10-09 02:56:42.817506"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-contibait:1.28.0--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-contibait/1.28.0--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-contibait/1.28.0--r43hf17093f_0
```
