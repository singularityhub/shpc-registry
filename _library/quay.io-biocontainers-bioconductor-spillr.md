...
updated_at: "2025-09-07 03:15:43.133891"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-spillr:1.2.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-spillr/1.2.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-spillr/1.2.0--r44hdfd78af_0
```
