...
updated_at: "2025-05-26 12:05:37.896353"
latest: "4.0.22--hf69ffd2_0"
...
```bash
$ shpc install quay.io/biocontainers/ncbi-amrfinderplus:4.0.22--hf69ffd2_0
```
...
```bash
$ module load quay.io/biocontainers/ncbi-amrfinderplus/4.0.22--hf69ffd2_0
$ module help quay.io/biocontainers/ncbi-amrfinderplus/4.0.22--hf69ffd2_0
```
