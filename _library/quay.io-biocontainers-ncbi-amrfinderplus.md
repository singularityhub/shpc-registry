...
updated_at: "2026-01-16 04:29:03.318523"
latest: "4.2.5--hf69ffd2_0"
...
```bash
$ shpc install quay.io/biocontainers/ncbi-amrfinderplus:4.2.5--hf69ffd2_0
```
...
```bash
$ module load quay.io/biocontainers/ncbi-amrfinderplus/4.2.5--hf69ffd2_0
$ module help quay.io/biocontainers/ncbi-amrfinderplus/4.2.5--hf69ffd2_0
```
