...
updated_at: "2026-02-05 05:02:31.899913"
...
```bash
$ shpc install quay.io/biocontainers/ncbi-amrfinderplus:4.2.7--hf69ffd2_0
```
...
```bash
$ module load quay.io/biocontainers/ncbi-amrfinderplus/4.2.7--hf69ffd2_0
$ module help quay.io/biocontainers/ncbi-amrfinderplus/4.2.7--hf69ffd2_0
```
