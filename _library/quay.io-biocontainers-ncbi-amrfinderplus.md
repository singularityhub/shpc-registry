...
updated_at: "2025-11-29 03:04:40.338980"
...
```bash
$ shpc install quay.io/biocontainers/ncbi-amrfinderplus:4.0.23--hf69ffd2_0
```
...
```bash
$ module load quay.io/biocontainers/ncbi-amrfinderplus/4.0.23--hf69ffd2_0
$ module help quay.io/biocontainers/ncbi-amrfinderplus/4.0.23--hf69ffd2_0
```
