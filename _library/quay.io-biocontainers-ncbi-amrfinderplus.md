...
updated_at: "2025-02-07 03:34:45.140463"
latest: "4.0.15--hf69ffd2_0"
...
```bash
$ shpc install quay.io/biocontainers/ncbi-amrfinderplus:4.0.15--hf69ffd2_0
```
...
```bash
$ module load quay.io/biocontainers/ncbi-amrfinderplus/4.0.15--hf69ffd2_0
$ module help quay.io/biocontainers/ncbi-amrfinderplus/4.0.15--hf69ffd2_0
```
