...
updated_at: "2023-05-27 02:35:03.738939"
latest: "3.11.11--h6e70893_0"
...
```bash
$ shpc install quay.io/biocontainers/ncbi-amrfinderplus:3.11.11--h6e70893_0
```
...
```bash
$ module load quay.io/biocontainers/ncbi-amrfinderplus/3.11.11--h6e70893_0
$ module help quay.io/biocontainers/ncbi-amrfinderplus/3.11.11--h6e70893_0
```
