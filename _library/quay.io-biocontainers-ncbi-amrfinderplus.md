...
updated_at: "2025-01-09 13:56:32.224624"
latest: "4.0.3--hf69ffd2_1"
...
```bash
$ shpc install quay.io/biocontainers/ncbi-amrfinderplus:4.0.3--hf69ffd2_1
```
...
```bash
$ module load quay.io/biocontainers/ncbi-amrfinderplus/4.0.3--hf69ffd2_1
$ module help quay.io/biocontainers/ncbi-amrfinderplus/4.0.3--hf69ffd2_1
```
