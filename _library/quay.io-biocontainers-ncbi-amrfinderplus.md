...
updated_at: "2025-04-25 02:29:51.171361"
latest: "4.0.19--hf69ffd2_0"
...
```bash
$ shpc install quay.io/biocontainers/ncbi-amrfinderplus:4.0.19--hf69ffd2_0
```
...
```bash
$ module load quay.io/biocontainers/ncbi-amrfinderplus/4.0.19--hf69ffd2_0
$ module help quay.io/biocontainers/ncbi-amrfinderplus/4.0.19--hf69ffd2_0
```
