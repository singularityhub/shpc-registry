...
updated_at: "2024-11-14 02:53:36.954472"
latest: "4.0.3--h283d18e_0"
...
```bash
$ shpc install quay.io/biocontainers/ncbi-amrfinderplus:4.0.3--h283d18e_0
```
...
```bash
$ module load quay.io/biocontainers/ncbi-amrfinderplus/4.0.3--h283d18e_0
$ module help quay.io/biocontainers/ncbi-amrfinderplus/4.0.3--h283d18e_0
```
