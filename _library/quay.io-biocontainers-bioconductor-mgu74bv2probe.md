...
updated_at: "2023-09-17 02:57:45.181166"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mgu74bv2probe:2.18.0--r43hdfd78af_11
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mgu74bv2probe/2.18.0--r43hdfd78af_11
$ module help quay.io/biocontainers/bioconductor-mgu74bv2probe/2.18.0--r43hdfd78af_11
```
