...
updated_at: "2023-12-07 02:33:17.306319"
latest: "3.2.4--r43hf17093f_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-bambu:3.2.4--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-bambu/3.2.4--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-bambu/3.2.4--r43hf17093f_0
```
