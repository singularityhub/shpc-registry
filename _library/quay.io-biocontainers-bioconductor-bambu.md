...
updated_at: "2023-07-06 03:30:22.144953"
latest: "3.0.8--r42hf17093f_1"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-bambu:3.0.8--r42hf17093f_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-bambu/3.0.8--r42hf17093f_1
$ module help quay.io/biocontainers/bioconductor-bambu/3.0.8--r42hf17093f_1
```
