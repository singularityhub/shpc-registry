...
updated_at: "2023-02-12 03:11:47.779193"
latest: "3.0.6--r42hc247a5b_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-bambu:3.0.6--r42hc247a5b_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-bambu/3.0.6--r42hc247a5b_0
$ module help quay.io/biocontainers/bioconductor-bambu/3.0.6--r42hc247a5b_0
```
