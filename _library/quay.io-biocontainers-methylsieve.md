---
layout: container
name:  "quay.io/biocontainers/methylsieve"
maintainer: "@vsoch"
...
updated_at: "2026-06-30 06:18:11.112531"
...
singularity registry hpc automated addition for methylsieve
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/methylsieve
```
...
#### methylsieve-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### methylsieve-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/methylsieve
$ podman run --it --rm --entrypoint /usr/local/bin/methylsieve   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/methylsieve   -v ${PWD} -w ${PWD} <container> -c " $@"
```
