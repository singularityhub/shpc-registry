...
updated_at: "2025-04-06 03:43:35.185973"
latest: "3.0.0--h29c0135_0"
...
```bash
$ shpc install quay.io/biocontainers/stringtie:3.0.0--h29c0135_0
```
...
```bash
$ module load quay.io/biocontainers/stringtie/3.0.0--h29c0135_0
$ module help quay.io/biocontainers/stringtie/3.0.0--h29c0135_0
```
