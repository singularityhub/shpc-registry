...
updated_at: "2025-08-26 03:37:24.013119"
latest: "3.0.0--h29c0135_1"
...
```bash
$ shpc install quay.io/biocontainers/stringtie:3.0.0--h29c0135_1
```
...
```bash
$ module load quay.io/biocontainers/stringtie/3.0.0--h29c0135_1
$ module help quay.io/biocontainers/stringtie/3.0.0--h29c0135_1
```
