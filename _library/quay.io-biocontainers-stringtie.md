...
updated_at: "2026-04-05 04:49:02.912020"
latest: "3.0.3--h29c0135_0"
...
```bash
$ shpc install quay.io/biocontainers/stringtie:3.0.3--h29c0135_0
```
...
```bash
$ module load quay.io/biocontainers/stringtie/3.0.3--h29c0135_0
$ module help quay.io/biocontainers/stringtie/3.0.3--h29c0135_0
```
