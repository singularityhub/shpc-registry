...
updated_at: "2024-12-15 04:23:16.837385"
...
```bash
$ shpc install quay.io/biocontainers/fgbio:2.4.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/fgbio/2.4.0--hdfd78af_0
$ module help quay.io/biocontainers/fgbio/2.4.0--hdfd78af_0
```
