...
updated_at: "2022-10-29 05:32:16.048974"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-perfect:1.8.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-perfect/1.8.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-perfect/1.8.0--r41hdfd78af_0
```
