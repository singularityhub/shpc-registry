...
updated_at: "2023-11-16 03:12:10.223796"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-bovine.db0:3.17.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-bovine.db0/3.17.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-bovine.db0/3.17.0--r43hdfd78af_0
```
