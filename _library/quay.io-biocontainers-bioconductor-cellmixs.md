...
updated_at: "2025-09-07 03:41:22.941744"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cellmixs:1.22.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cellmixs/1.22.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-cellmixs/1.22.0--r44hdfd78af_0
```
