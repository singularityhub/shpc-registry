...
updated_at: "2023-11-26 03:10:00.006337"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-miqc:1.8.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-miqc/1.8.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-miqc/1.8.0--r43hdfd78af_0
```
