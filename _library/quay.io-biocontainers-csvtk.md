...
updated_at: "2024-04-08 02:39:53.393458"
latest: "0.29.0--h9ee0642_0"
...
```bash
$ shpc install quay.io/biocontainers/csvtk:0.29.0--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/csvtk/0.29.0--h9ee0642_0
$ module help quay.io/biocontainers/csvtk/0.29.0--h9ee0642_0
```
