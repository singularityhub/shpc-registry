...
updated_at: "2025-12-03 03:55:01.760753"
...
```bash
$ shpc install quay.io/biocontainers/hmftools-purple:4.2--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hmftools-purple/4.2--hdfd78af_0
$ module help quay.io/biocontainers/hmftools-purple/4.2--hdfd78af_0
```
