...
updated_at: "2026-01-04 04:25:51.939739"
...
```bash
$ shpc install quay.io/biocontainers/hmftools-purple:4.3--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hmftools-purple/4.3--hdfd78af_0
$ module help quay.io/biocontainers/hmftools-purple/4.3--hdfd78af_0
```
