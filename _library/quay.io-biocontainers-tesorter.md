...
updated_at: "2024-09-16 03:44:19.626642"
latest: "1.4.6--pyhdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/tesorter:1.4.6--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/tesorter/1.4.6--pyhdfd78af_1
$ module help quay.io/biocontainers/tesorter/1.4.6--pyhdfd78af_1
```
