...
updated_at: "2024-12-15 03:48:37.847431"
...
```bash
$ shpc install quay.io/biocontainers/tesorter:1.4.7--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/tesorter/1.4.7--pyhdfd78af_0
$ module help quay.io/biocontainers/tesorter/1.4.7--pyhdfd78af_0
```
