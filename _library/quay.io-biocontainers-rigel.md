---
layout: container
name:  "quay.io/biocontainers/rigel"
maintainer: "@vsoch"
...
updated_at: "2026-04-01 05:40:32.763410"
...
aliases:
 ...
 - "orc-statistics"
versions:
 - "0.3.3--py312hf44d832_0"
description: "singularity registry hpc automated addition for rigel"
config: {"url": "https://biocontainers.pro/tools/rigel", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for rigel", "latest": {"0.3.3--py312hf44d832_0": "sha256:1a9849064550789e82dc2937a721c1925c27818e0b805c36aecb143ebe252398"}, "tags": {"0.3.3--py312hf44d832_0": "sha256:1a9849064550789e82dc2937a721c1925c27818e0b805c36aecb143ebe252398"}, "docker": "quay.io/biocontainers/rigel", "aliases": {"rigel": "/usr/local/bin/rigel", "protoc-33.5.0": "/usr/local/bin/protoc-33.5.0", "protoc-gen-upb-33.5.0": "/usr/local/bin/protoc-gen-upb-33.5.0", "protoc-gen-upb_minitable-33.5.0": "/usr/local/bin/protoc-gen-upb_minitable-33.5.0", "protoc-gen-upbdefs-33.5.0": "/usr/local/bin/protoc-gen-upbdefs-33.5.0", "protoc-gen-upb_minitable": "/usr/local/bin/protoc-gen-upb_minitable", "h2benchmark": "/usr/local/bin/h2benchmark", "checksum-profile": "/usr/local/bin/checksum-profile", "elastishadow": "/usr/local/bin/elastishadow", "protoc-gen-upb": "/usr/local/bin/protoc-gen-upb", "protoc-gen-upbdefs": "/usr/local/bin/protoc-gen-upbdefs", "ref-cache": "/usr/local/bin/ref-cache", "elastipubsub5": "/usr/local/bin/elastipubsub5", "mqtt5_app": "/usr/local/bin/mqtt5_app", "mqtt5_canary": "/usr/local/bin/mqtt5_canary", "mqtt5canary": "/usr/local/bin/mqtt5canary", "elasticurl": "/usr/local/bin/elasticurl", "elasticurl_cpp": "/usr/local/bin/elasticurl_cpp", "elastipubsub": "/usr/local/bin/elastipubsub", "csv-import": "/usr/local/bin/csv-import", "orc-memory": "/usr/local/bin/orc-memory", "orc-scan": "/usr/local/bin/orc-scan", "timezone-dump": "/usr/local/bin/timezone-dump", "orc-contents": "/usr/local/bin/orc-contents", "orc-metadata": "/usr/local/bin/orc-metadata", "orc-statistics": "/usr/local/bin/orc-statistics"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/rigel.
singularity registry hpc automated addition for rigel
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/rigel
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/rigel:0.3.3--py312hf44d832_0
```
...
```bash
$ module load quay.io/biocontainers/rigel/0.3.3--py312hf44d832_0
$ module help quay.io/biocontainers/rigel/0.3.3--py312hf44d832_0
```
...
#### rigel-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### rigel-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/rigel
$ podman run --it --rm --entrypoint /usr/local/bin/rigel   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/rigel   -v ${PWD} -w ${PWD} <container> -c " $@"
```
