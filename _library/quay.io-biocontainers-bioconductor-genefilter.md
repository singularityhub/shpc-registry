...
updated_at: "2023-12-30 04:24:18.285565"
latest: "1.84.0--r43ha1e849b_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-genefilter:1.84.0--r43ha1e849b_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-genefilter/1.84.0--r43ha1e849b_0
$ module help quay.io/biocontainers/bioconductor-genefilter/1.84.0--r43ha1e849b_0
```
