...
updated_at: "2024-12-12 03:46:34.015606"
...
```bash
$ shpc install quay.io/biocontainers/chromap:0.2.7--hdcf5f25_0
```
...
```bash
$ module load quay.io/biocontainers/chromap/0.2.7--hdcf5f25_0
$ module help quay.io/biocontainers/chromap/0.2.7--hdcf5f25_0
```
