...
updated_at: "2025-10-23 03:07:03.447995"
latest: "0.3.2--h077b44d_0"
...
```bash
$ shpc install quay.io/biocontainers/chromap:0.3.2--h077b44d_0
```
...
```bash
$ module load quay.io/biocontainers/chromap/0.3.2--h077b44d_0
$ module help quay.io/biocontainers/chromap/0.3.2--h077b44d_0
```
