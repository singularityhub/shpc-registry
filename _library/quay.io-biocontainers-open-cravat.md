...
updated_at: "2025-05-23 03:50:46.710137"
latest: "2.12.0--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/open-cravat:2.12.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/open-cravat/2.12.0--pyhdfd78af_0
$ module help quay.io/biocontainers/open-cravat/2.12.0--pyhdfd78af_0
```
