...
updated_at: "2023-12-26 02:29:07.201409"
...
```bash
$ shpc install quay.io/biocontainers/open-cravat:2.4.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/open-cravat/2.4.2--pyhdfd78af_0
$ module help quay.io/biocontainers/open-cravat/2.4.2--pyhdfd78af_0
```
