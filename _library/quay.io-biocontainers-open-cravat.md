...
updated_at: "2026-01-25 04:40:33.406398"
latest: "2.16.0--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/open-cravat:2.16.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/open-cravat/2.16.0--pyhdfd78af_0
$ module help quay.io/biocontainers/open-cravat/2.16.0--pyhdfd78af_0
```
