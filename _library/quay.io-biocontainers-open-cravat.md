...
updated_at: "2024-11-05 03:06:01.814837"
...
```bash
$ shpc install quay.io/biocontainers/open-cravat:2.9.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/open-cravat/2.9.1--pyhdfd78af_0
$ module help quay.io/biocontainers/open-cravat/2.9.1--pyhdfd78af_0
```
