...
updated_at: "2024-05-14 02:29:53.042514"
...
```bash
$ shpc install quay.io/biocontainers/open-cravat:2.6.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/open-cravat/2.6.0--pyhdfd78af_0
$ module help quay.io/biocontainers/open-cravat/2.6.0--pyhdfd78af_0
```
