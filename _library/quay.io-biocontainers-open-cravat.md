...
updated_at: "2024-08-21 03:11:34.285788"
...
```bash
$ shpc install quay.io/biocontainers/open-cravat:2.7.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/open-cravat/2.7.3--pyhdfd78af_0
$ module help quay.io/biocontainers/open-cravat/2.7.3--pyhdfd78af_0
```
