...
updated_at: "2025-05-05 03:51:06.161028"
...
```bash
$ shpc install quay.io/biocontainers/open-cravat:2.11.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/open-cravat/2.11.1--pyhdfd78af_0
$ module help quay.io/biocontainers/open-cravat/2.11.1--pyhdfd78af_0
```
