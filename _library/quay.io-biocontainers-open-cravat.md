...
updated_at: "2024-06-15 03:13:06.054529"
...
```bash
$ shpc install quay.io/biocontainers/open-cravat:2.7.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/open-cravat/2.7.1--pyhdfd78af_0
$ module help quay.io/biocontainers/open-cravat/2.7.1--pyhdfd78af_0
```
