...
updated_at: "2025-07-31 11:38:50.471693"
...
```bash
$ shpc install quay.io/biocontainers/open-cravat:2.13.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/open-cravat/2.13.0--pyhdfd78af_0
$ module help quay.io/biocontainers/open-cravat/2.13.0--pyhdfd78af_0
```
