...
updated_at: "2024-05-03 02:30:07.509853"
...
```bash
$ shpc install quay.io/biocontainers/open-cravat:2.5.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/open-cravat/2.5.0--pyhdfd78af_0
$ module help quay.io/biocontainers/open-cravat/2.5.0--pyhdfd78af_0
```
