...
updated_at: "2024-09-25 02:56:23.662389"
...
```bash
$ shpc install quay.io/biocontainers/open-cravat:2.8.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/open-cravat/2.8.0--pyhdfd78af_0
$ module help quay.io/biocontainers/open-cravat/2.8.0--pyhdfd78af_0
```
