...
updated_at: "2026-04-26 05:33:14.261697"
...
```bash
$ shpc install quay.io/biocontainers/open-cravat:3.1.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/open-cravat/3.1.1--pyhdfd78af_0
$ module help quay.io/biocontainers/open-cravat/3.1.1--pyhdfd78af_0
```
