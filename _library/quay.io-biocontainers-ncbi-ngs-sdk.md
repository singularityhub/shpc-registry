...
updated_at: "2023-05-22 03:45:37.821547"
latest: "3.0.1--pl5321h629fbf0_1"
...
```bash
$ shpc install quay.io/biocontainers/ncbi-ngs-sdk:3.0.1--pl5321h629fbf0_1
```
...
```bash
$ module load quay.io/biocontainers/ncbi-ngs-sdk/3.0.1--pl5321h629fbf0_1
$ module help quay.io/biocontainers/ncbi-ngs-sdk/3.0.1--pl5321h629fbf0_1
```
