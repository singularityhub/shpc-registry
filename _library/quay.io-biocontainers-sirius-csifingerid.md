...
updated_at: "2022-11-05 00:25:38.388392"
...
```bash
$ shpc install quay.io/biocontainers/sirius-csifingerid:4.9.8--hec16e2b_2
```
...
```bash
$ module load quay.io/biocontainers/sirius-csifingerid/4.9.8--hec16e2b_2
$ module help quay.io/biocontainers/sirius-csifingerid/4.9.8--hec16e2b_2
```
...
```bash
$ singularity exec <container> /usr/local/bin/.sirius-csifingerid-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.sirius-csifingerid-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.sirius-csifingerid-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
