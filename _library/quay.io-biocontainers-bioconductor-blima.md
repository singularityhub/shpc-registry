...
updated_at: "2023-12-04 03:58:23.302232"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-blima:1.34.0--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-blima/1.34.0--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-blima/1.34.0--r43hf17093f_0
```
