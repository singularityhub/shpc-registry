...
updated_at: "2022-10-29 05:54:00.200802"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-minfi:1.40.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-minfi/1.40.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-minfi/1.40.0--r41hdfd78af_0
```
