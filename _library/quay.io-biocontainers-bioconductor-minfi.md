...
updated_at: "2026-03-24 05:09:50.999852"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-minfi:1.56.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-minfi/1.56.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-minfi/1.56.0--r45hdfd78af_0
```
