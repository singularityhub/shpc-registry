...
updated_at: "2026-03-24 04:59:49.407239"
latest: "8.9.0--h6f54bf4_0"
...
```bash
$ shpc install quay.io/biocontainers/esme_esmf_psmpi_4_3_2:8.9.0--h6f54bf4_0
```
...
```bash
$ module load quay.io/biocontainers/esme_esmf_psmpi_4_3_2/8.9.0--h6f54bf4_0
$ module help quay.io/biocontainers/esme_esmf_psmpi_4_3_2/8.9.0--h6f54bf4_0
```
