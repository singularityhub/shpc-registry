...
updated_at: "2022-11-28 00:32:34.447925"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-harman:1.22.0--r41hc247a5b_2
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-harman/1.22.0--r41hc247a5b_2
$ module help quay.io/biocontainers/bioconductor-harman/1.22.0--r41hc247a5b_2
```
