...
updated_at: "2024-05-25 02:44:14.202374"
latest: "0.13.0--py38h2214202_0"
...
```bash
$ shpc install quay.io/biocontainers/mykrobe:0.13.0--py38h2214202_0
```
...
```bash
$ module load quay.io/biocontainers/mykrobe/0.13.0--py38h2214202_0
$ module help quay.io/biocontainers/mykrobe/0.13.0--py38h2214202_0
```
