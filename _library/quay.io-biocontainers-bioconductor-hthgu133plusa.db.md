...
updated_at: "2024-07-06 03:14:43.048469"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hthgu133plusa.db:3.13.0--r43hdfd78af_4
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hthgu133plusa.db/3.13.0--r43hdfd78af_4
$ module help quay.io/biocontainers/bioconductor-hthgu133plusa.db/3.13.0--r43hdfd78af_4
```
