...
updated_at: "2023-09-25 03:51:44.184878"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hthgu133plusa.db:3.13.0--r43hdfd78af_3
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hthgu133plusa.db/3.13.0--r43hdfd78af_3
$ module help quay.io/biocontainers/bioconductor-hthgu133plusa.db/3.13.0--r43hdfd78af_3
```
