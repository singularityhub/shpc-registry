---
layout: container
name:  "quay.io/biocontainers/mutamr"
maintainer: "@vsoch"
...
updated_at: "2026-06-04 00:47:24.971573"
...
```bash
$ shpc install quay.io/biocontainers/mutamr
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/mutamr:0.0.2--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/mutamr/0.0.2--pyhdfd78af_1
$ module help quay.io/biocontainers/mutamr/0.0.2--pyhdfd78af_1
```
...
#### mutamr-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### mutamr-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/mutamr
$ podman run --it --rm --entrypoint /usr/local/bin/mutamr   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/mutamr   -v ${PWD} -w ${PWD} <container> -c " $@"
```
