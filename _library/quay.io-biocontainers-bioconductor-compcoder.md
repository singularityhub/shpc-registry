...
updated_at: "2026-02-21 04:25:10.301745"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-compcoder:1.46.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-compcoder/1.46.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-compcoder/1.46.0--r45hdfd78af_0
```
