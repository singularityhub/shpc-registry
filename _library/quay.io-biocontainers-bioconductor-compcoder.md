...
updated_at: "2025-03-06 03:35:34.102174"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-compcoder:1.42.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-compcoder/1.42.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-compcoder/1.42.0--r44hdfd78af_0
```
