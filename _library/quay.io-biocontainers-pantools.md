...
updated_at: "2025-01-04 02:59:45.077164"
...
```bash
$ shpc install quay.io/biocontainers/pantools:4.3.2--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pantools/4.3.2--hdfd78af_0
$ module help quay.io/biocontainers/pantools/4.3.2--hdfd78af_0
```
