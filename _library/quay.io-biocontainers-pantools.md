...
updated_at: "2023-12-20 02:46:29.384720"
latest: "4.2.3--hdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/pantools:4.2.3--hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/pantools/4.2.3--hdfd78af_1
$ module help quay.io/biocontainers/pantools/4.2.3--hdfd78af_1
```
