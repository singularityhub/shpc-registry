...
updated_at: "2025-09-25 08:00:18.332639"
latest: "4.3.4--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/pantools:4.3.4--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pantools/4.3.4--hdfd78af_0
$ module help quay.io/biocontainers/pantools/4.3.4--hdfd78af_0
```
