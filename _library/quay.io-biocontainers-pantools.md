...
updated_at: "2023-02-03 03:30:34.503353"
...
```bash
$ shpc install quay.io/biocontainers/pantools:4.1.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pantools/4.1.0--hdfd78af_0
$ module help quay.io/biocontainers/pantools/4.1.0--hdfd78af_0
```
