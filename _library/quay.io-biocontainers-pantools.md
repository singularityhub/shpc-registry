...
updated_at: "2026-08-08 04:01:05.442395"
latest: "4.3.5--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/pantools:4.3.5--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pantools/4.3.5--hdfd78af_0
$ module help quay.io/biocontainers/pantools/4.3.5--hdfd78af_0
```
