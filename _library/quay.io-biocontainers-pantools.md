...
updated_at: "2023-11-15 02:33:39.733901"
latest: "4.2.3--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/pantools:4.2.3--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pantools/4.2.3--hdfd78af_0
$ module help quay.io/biocontainers/pantools/4.2.3--hdfd78af_0
```
