---
layout: container
name:  "quay.io/biocontainers/bioconductor-chevreulshiny"
maintainer: "@vsoch"
...
updated_at: "2026-03-27 05:09:18.861416"
...
versions:
 - "1.2.0--r45hdfd78af_0"
description: "singularity registry hpc automated addition for bioconductor-chevreulshiny"
config: {"url": "https://biocontainers.pro/tools/bioconductor-chevreulshiny", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for bioconductor-chevreulshiny", "latest": {"1.2.0--r45hdfd78af_0": "sha256:4ec1a02eb779f71ad7085eade9b7cad1cde1c6ad7e3d502591bb81ed01c4f9d4"}, "tags": {"1.2.0--r45hdfd78af_0": "sha256:4ec1a02eb779f71ad7085eade9b7cad1cde1c6ad7e3d502591bb81ed01c4f9d4"}, "docker": "quay.io/biocontainers/bioconductor-chevreulshiny", "aliases": {"git2": "/usr/local/bin/git2", "pandoc-lua": "/usr/local/bin/pandoc-lua", "pandoc-server": "/usr/local/bin/pandoc-server", "idle3.14": "/usr/local/bin/idle3.14", "pydoc3.14": "/usr/local/bin/pydoc3.14", "python3.14": "/usr/local/bin/python3.14", "python3.14-config": "/usr/local/bin/python3.14-config", "x86_64-conda-linux-gnu.cfg": "/usr/local/bin/x86_64-conda-linux-gnu.cfg", "glpsol": "/usr/local/bin/glpsol", "installBiocDataPackage.sh": "/usr/local/bin/installBiocDataPackage.sh", "tomlq": "/usr/local/bin/tomlq", "xq": "/usr/local/bin/xq", "yq": "/usr/local/bin/yq", "jq": "/usr/local/bin/jq", "onig-config": "/usr/local/bin/onig-config", "pandoc": "/usr/local/bin/pandoc", "activate-global-python-argcomplete": "/usr/local/bin/activate-global-python-argcomplete", "python-argcomplete-check-easy-install-script": "/usr/local/bin/python-argcomplete-check-easy-install-script", "register-python-argcomplete": "/usr/local/bin/register-python-argcomplete", "hb-info": "/usr/local/bin/hb-info", "tjbench": "/usr/local/bin/tjbench"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/bioconductor-chevreulshiny.
singularity registry hpc automated addition for bioconductor-chevreulshiny
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/bioconductor-chevreulshiny
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-chevreulshiny:1.2.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-chevreulshiny/1.2.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-chevreulshiny/1.2.0--r45hdfd78af_0
```
...
#### bioconductor-chevreulshiny-run:
...
#### bioconductor-chevreulshiny-shell:
...
#### bioconductor-chevreulshiny-exec:
...
#### bioconductor-chevreulshiny-inspect:
...
#### bioconductor-chevreulshiny-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-chevreulshiny-inspect-deffile:
