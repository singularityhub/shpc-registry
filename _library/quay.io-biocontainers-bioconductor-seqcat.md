...
updated_at: "2025-12-13 04:02:12.076314"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-seqcat:1.28.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-seqcat/1.28.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-seqcat/1.28.0--r44hdfd78af_0
```
