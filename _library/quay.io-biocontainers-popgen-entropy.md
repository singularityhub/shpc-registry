...
updated_at: "2025-12-13 03:36:22.322376"
...
```bash
$ shpc install quay.io/biocontainers/popgen-entropy:2.0--h1913c9f_12
```
...
```bash
$ module load quay.io/biocontainers/popgen-entropy/2.0--h1913c9f_12
$ module help quay.io/biocontainers/popgen-entropy/2.0--h1913c9f_12
```
