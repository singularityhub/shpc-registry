...
updated_at: "2026-03-20 01:08:50.375358"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-wheatprobe:2.18.0--r45hdfd78af_15
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-wheatprobe/2.18.0--r45hdfd78af_15
$ module help quay.io/biocontainers/bioconductor-wheatprobe/2.18.0--r45hdfd78af_15
```
