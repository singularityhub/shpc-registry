...
updated_at: "2026-09-03 07:30:37.202305"
latest: "26.0--h1079eea_0"
...
```bash
$ shpc install quay.io/biocontainers/entrez-direct:26.0--h1079eea_0
```
...
```bash
$ module load quay.io/biocontainers/entrez-direct/26.0--h1079eea_0
$ module help quay.io/biocontainers/entrez-direct/26.0--h1079eea_0
```
