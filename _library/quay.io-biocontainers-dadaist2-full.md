...
updated_at: "2022-10-27 01:02:18.991776"
...
```bash
$ shpc install quay.io/biocontainers/dadaist2-full:1.1--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/dadaist2-full/1.1--hdfd78af_0
$ module help quay.io/biocontainers/dadaist2-full/1.1--hdfd78af_0
```
