...
updated_at: "2025-05-05 03:26:57.424775"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-nanotube:1.12.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-nanotube/1.12.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-nanotube/1.12.0--r44hdfd78af_0
```
