---
layout: container
name:  "quay.io/biocontainers/r-dinamic.duo"
maintainer: "@vsoch"
...
updated_at: "2026-01-01 04:24:22.261548"
...
```bash
$ shpc install quay.io/biocontainers/r-dinamic.duo
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/r-dinamic.duo:1.0.4--r44heae9e1c_0
```
...
```bash
$ module load quay.io/biocontainers/r-dinamic.duo/1.0.4--r44heae9e1c_0
$ module help quay.io/biocontainers/r-dinamic.duo/1.0.4--r44heae9e1c_0
```
...
#### r-dinamic.duo-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-dinamic.duo-inspect-deffile:
