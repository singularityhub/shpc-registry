...
updated_at: "2025-05-19 03:45:36.938053"
latest: "1.0.2--r44h3121a25_3"
...
```bash
$ shpc install quay.io/biocontainers/r-dinamic.duo:1.0.2--r44h3121a25_3
```
...
```bash
$ module load quay.io/biocontainers/r-dinamic.duo/1.0.2--r44h3121a25_3
$ module help quay.io/biocontainers/r-dinamic.duo/1.0.2--r44h3121a25_3
```
