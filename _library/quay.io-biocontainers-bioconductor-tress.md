...
updated_at: "2026-03-30 04:54:08.509987"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-tress:1.16.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-tress/1.16.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-tress/1.16.0--r45hdfd78af_0
```
