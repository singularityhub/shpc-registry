...
updated_at: "2024-04-15 06:09:03.689296"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-interactivedisplaybase:1.40.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-interactivedisplaybase/1.40.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-interactivedisplaybase/1.40.0--r43hdfd78af_0
```
