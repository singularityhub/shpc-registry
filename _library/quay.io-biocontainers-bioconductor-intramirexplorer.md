...
updated_at: "2024-02-29 03:04:59.900752"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-intramirexplorer:1.24.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-intramirexplorer/1.24.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-intramirexplorer/1.24.0--r43hdfd78af_0
```
