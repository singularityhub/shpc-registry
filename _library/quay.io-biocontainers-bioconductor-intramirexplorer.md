...
updated_at: "2026-03-28 05:06:24.623618"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-intramirexplorer:1.32.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-intramirexplorer/1.32.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-intramirexplorer/1.32.0--r45hdfd78af_0
```
