...
updated_at: "2023-10-26 02:39:32.989658"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-intramirexplorer:1.22.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-intramirexplorer/1.22.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-intramirexplorer/1.22.0--r43hdfd78af_0
```
