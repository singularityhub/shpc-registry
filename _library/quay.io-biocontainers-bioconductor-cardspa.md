---
layout: container
name:  "quay.io/biocontainers/bioconductor-cardspa"
maintainer: "@vsoch"
...
updated_at: "2026-03-23 06:02:13.769443"
...
versions:
 - "1.2.1--r45ha27e39d_0"
description: "singularity registry hpc automated addition for bioconductor-cardspa"
config: {"url": "https://biocontainers.pro/tools/bioconductor-cardspa", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for bioconductor-cardspa", "latest": {"1.2.1--r45ha27e39d_0": "sha256:b084791504082fcce90b14a5b10513d85855c9a88800040fb9d25ba2cb03a8ee"}, "tags": {"1.2.1--r45ha27e39d_0": "sha256:b084791504082fcce90b14a5b10513d85855c9a88800040fb9d25ba2cb03a8ee"}, "docker": "quay.io/biocontainers/bioconductor-cardspa", "aliases": {"gdal": "/usr/local/bin/gdal", "gdal_footprint": "/usr/local/bin/gdal_footprint", "minigzip": "/usr/local/bin/minigzip", "minizip": "/usr/local/bin/minizip", "sozip": "/usr/local/bin/sozip", "hb-raster": "/usr/local/bin/hb-raster", "hb-vector": "/usr/local/bin/hb-vector", "dot_sandbox": "/usr/local/bin/dot_sandbox", "dec265": "/usr/local/bin/dec265", "bsdunzip": "/usr/local/bin/bsdunzip", "gtk-builder-tool": "/usr/local/bin/gtk-builder-tool", "gtk-encode-symbolic-svg": "/usr/local/bin/gtk-encode-symbolic-svg", "gtk-launch": "/usr/local/bin/gtk-launch", "gtk-query-immodules-3.0": "/usr/local/bin/gtk-query-immodules-3.0", "gtk-query-settings": "/usr/local/bin/gtk-query-settings", "gdal_create": "/usr/local/bin/gdal_create", "gdal_viewshed": "/usr/local/bin/gdal_viewshed", "gdalmdiminfo": "/usr/local/bin/gdalmdiminfo", "gdalmdimtranslate": "/usr/local/bin/gdalmdimtranslate", "x265": "/usr/local/bin/x265", "gnmanalyse": "/usr/local/bin/gnmanalyse", "gnmmanage": "/usr/local/bin/gnmmanage", "gdal-config": "/usr/local/bin/gdal-config", "gdal_contour": "/usr/local/bin/gdal_contour", "gdal_grid": "/usr/local/bin/gdal_grid"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/bioconductor-cardspa.
singularity registry hpc automated addition for bioconductor-cardspa
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/bioconductor-cardspa
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-cardspa:1.2.1--r45ha27e39d_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cardspa/1.2.1--r45ha27e39d_0
$ module help quay.io/biocontainers/bioconductor-cardspa/1.2.1--r45ha27e39d_0
```
...
#### bioconductor-cardspa-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-cardspa-inspect-deffile:
