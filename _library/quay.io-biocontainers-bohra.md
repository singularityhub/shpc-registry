...
updated_at: "2023-05-23 02:48:57.944733"
...
```bash
$ shpc install quay.io/biocontainers/bohra:2.2.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bohra/2.2.1--pyhdfd78af_0
$ module help quay.io/biocontainers/bohra/2.2.1--pyhdfd78af_0
```
