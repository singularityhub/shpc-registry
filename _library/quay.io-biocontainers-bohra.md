...
updated_at: "2023-03-05 03:36:38.038747"
latest: "1.2.19--py_1"
...
```bash
$ shpc install quay.io/biocontainers/bohra:1.2.19--py_1
```
...
```bash
$ module load quay.io/biocontainers/bohra/1.2.19--py_1
$ module help quay.io/biocontainers/bohra/1.2.19--py_1
```
