...
updated_at: "2024-03-10 02:39:09.397429"
latest: "2.3.6--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/bohra:2.3.6--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bohra/2.3.6--pyhdfd78af_0
$ module help quay.io/biocontainers/bohra/2.3.6--pyhdfd78af_0
```
