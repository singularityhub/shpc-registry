...
updated_at: "2025-05-22 04:04:36.981799"
...
```bash
$ shpc install quay.io/biocontainers/bohra:2.3.8--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bohra/2.3.8--pyhdfd78af_0
$ module help quay.io/biocontainers/bohra/2.3.8--pyhdfd78af_0
```
