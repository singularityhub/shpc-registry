...
updated_at: "2023-06-28 03:33:26.640246"
...
```bash
$ shpc install quay.io/biocontainers/bohra:2.3.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bohra/2.3.0--pyhdfd78af_0
$ module help quay.io/biocontainers/bohra/2.3.0--pyhdfd78af_0
```
