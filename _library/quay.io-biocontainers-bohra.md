...
updated_at: "2023-09-01 02:58:38.216887"
...
```bash
$ shpc install quay.io/biocontainers/bohra:2.3.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bohra/2.3.2--pyhdfd78af_0
$ module help quay.io/biocontainers/bohra/2.3.2--pyhdfd78af_0
```
