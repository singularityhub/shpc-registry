...
updated_at: "2023-12-12 02:50:50.973697"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rta10probeset.db:8.8.0--r43hdfd78af_3
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rta10probeset.db/8.8.0--r43hdfd78af_3
$ module help quay.io/biocontainers/bioconductor-rta10probeset.db/8.8.0--r43hdfd78af_3
```
