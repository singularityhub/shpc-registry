...
updated_at: "2024-03-07 04:00:51.811971"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rnaseqsamplesizedata:1.34.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rnaseqsamplesizedata/1.34.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rnaseqsamplesizedata/1.34.0--r43hdfd78af_0
```
