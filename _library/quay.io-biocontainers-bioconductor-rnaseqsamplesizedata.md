...
updated_at: "2023-09-17 02:49:58.517102"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rnaseqsamplesizedata:1.32.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rnaseqsamplesizedata/1.32.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rnaseqsamplesizedata/1.32.0--r43hdfd78af_0
```
