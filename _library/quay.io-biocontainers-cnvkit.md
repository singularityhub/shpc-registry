...
updated_at: "2026-06-06 06:00:46.421958"
latest: "0.9.13--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/cnvkit:0.9.13--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/cnvkit/0.9.13--pyhdfd78af_0
$ module help quay.io/biocontainers/cnvkit/0.9.13--pyhdfd78af_0
```
