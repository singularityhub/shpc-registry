...
updated_at: "2025-12-08 03:47:45.475370"
latest: "0.9.12--pyhdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/cnvkit:0.9.12--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/cnvkit/0.9.12--pyhdfd78af_1
$ module help quay.io/biocontainers/cnvkit/0.9.12--pyhdfd78af_1
```
