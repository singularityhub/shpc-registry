...
updated_at: "2024-04-15 06:17:45.693271"
...
```bash
$ shpc install quay.io/biocontainers/cnvkit:0.9.10--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/cnvkit/0.9.10--pyhdfd78af_0
$ module help quay.io/biocontainers/cnvkit/0.9.10--pyhdfd78af_0
```
