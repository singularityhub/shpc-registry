...
updated_at: "2024-10-29 03:22:58.795640"
latest: "0.9.11--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/cnvkit:0.9.11--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/cnvkit/0.9.11--pyhdfd78af_0
$ module help quay.io/biocontainers/cnvkit/0.9.11--pyhdfd78af_0
```
