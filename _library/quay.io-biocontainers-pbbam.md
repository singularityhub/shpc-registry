...
updated_at: "2023-08-07 02:45:04.163716"
latest: "2.1.0--h8db2425_5"
...
```bash
$ shpc install quay.io/biocontainers/pbbam:2.1.0--h8db2425_5
```
...
```bash
$ module load quay.io/biocontainers/pbbam/2.1.0--h8db2425_5
$ module help quay.io/biocontainers/pbbam/2.1.0--h8db2425_5
```
