...
updated_at: "2026-04-04 04:36:12.851394"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ivas:2.30.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ivas/2.30.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ivas/2.30.0--r45hdfd78af_0
```
