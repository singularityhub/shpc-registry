...
updated_at: "2023-12-09 02:42:31.332316"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ivas:2.20.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ivas/2.20.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ivas/2.20.0--r43hdfd78af_0
```
