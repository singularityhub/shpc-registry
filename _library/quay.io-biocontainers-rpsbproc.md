...
updated_at: "2026-03-29 05:08:19.501462"
latest: "0.5.1--hd6d6fdc_0"
...
```bash
$ shpc install quay.io/biocontainers/rpsbproc:0.5.1--hd6d6fdc_0
```
...
```bash
$ module load quay.io/biocontainers/rpsbproc/0.5.1--hd6d6fdc_0
$ module help quay.io/biocontainers/rpsbproc/0.5.1--hd6d6fdc_0
```
