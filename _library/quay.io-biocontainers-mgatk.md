---
layout: container
name:  "quay.io/biocontainers/mgatk"
maintainer: "@vsoch"
...
updated_at: "2026-08-10 04:30:04.973947"
...
```bash
$ shpc install quay.io/biocontainers/mgatk
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/mgatk:0.9.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mgatk/0.9.0--pyhdfd78af_0
$ module help quay.io/biocontainers/mgatk/0.9.0--pyhdfd78af_0
```
...
#### mgatk-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### mgatk-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/mgatk
$ podman run --it --rm --entrypoint /usr/local/bin/mgatk   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/mgatk   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/mgatk-del
$ podman run --it --rm --entrypoint /usr/local/bin/mgatk-del   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/mgatk-del   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/mgatk-del-find
$ podman run --it --rm --entrypoint /usr/local/bin/mgatk-del-find   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/mgatk-del-find   -v ${PWD} -w ${PWD} <container> -c " $@"
```
