---
layout: container
name:  "quay.io/biocontainers/pytest-xdist"
maintainer: "@vsoch"
...
updated_at: "2024-11-13 04:36:24.335376"
latest: "1.14--py36_0"
...
```bash
$ shpc install quay.io/biocontainers/pytest-xdist
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/pytest-xdist:1.14--py36_0
```
...
```bash
$ module load quay.io/biocontainers/pytest-xdist/1.14--py36_0
$ module help quay.io/biocontainers/pytest-xdist/1.14--py36_0
```
...
#### pytest-xdist-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### pytest-xdist-inspect-deffile:
