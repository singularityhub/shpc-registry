...
updated_at: "2026-09-02 07:24:37.251047"
latest: "0.7.2--pyh106432d_0"
...
```bash
$ shpc install quay.io/biocontainers/nebulizer:0.7.2--pyh106432d_0
```
...
```bash
$ module load quay.io/biocontainers/nebulizer/0.7.2--pyh106432d_0
$ module help quay.io/biocontainers/nebulizer/0.7.2--pyh106432d_0
```
