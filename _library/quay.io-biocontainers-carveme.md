...
updated_at: "2024-05-30 04:33:08.021078"
...
```bash
$ shpc install quay.io/biocontainers/carveme:1.6.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/carveme/1.6.1--pyhdfd78af_0
$ module help quay.io/biocontainers/carveme/1.6.1--pyhdfd78af_0
```
