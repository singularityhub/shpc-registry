...
updated_at: "2026-01-14 04:15:26.998952"
latest: "1.6.6--pyhdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/carveme:1.6.6--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/carveme/1.6.6--pyhdfd78af_1
$ module help quay.io/biocontainers/carveme/1.6.6--pyhdfd78af_1
```
