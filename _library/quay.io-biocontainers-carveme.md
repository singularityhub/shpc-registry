...
updated_at: "2025-01-03 02:55:59.261832"
...
```bash
$ shpc install quay.io/biocontainers/carveme:1.6.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/carveme/1.6.2--pyhdfd78af_0
$ module help quay.io/biocontainers/carveme/1.6.2--pyhdfd78af_0
```
