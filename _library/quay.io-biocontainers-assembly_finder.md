...
updated_at: "2025-03-27 03:53:32.768109"
...
```bash
$ shpc install quay.io/biocontainers/assembly_finder:0.8.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/assembly_finder/0.8.0--pyhdfd78af_0
$ module help quay.io/biocontainers/assembly_finder/0.8.0--pyhdfd78af_0
```
