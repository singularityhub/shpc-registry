...
updated_at: "2025-10-25 03:14:15.521983"
...
```bash
$ shpc install quay.io/biocontainers/assembly_finder:0.9.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/assembly_finder/0.9.0--pyhdfd78af_0
$ module help quay.io/biocontainers/assembly_finder/0.9.0--pyhdfd78af_0
```
