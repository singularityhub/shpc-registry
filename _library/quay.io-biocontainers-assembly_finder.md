...
updated_at: "2024-05-08 02:35:52.256881"
...
```bash
$ shpc install quay.io/biocontainers/assembly_finder:0.6.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/assembly_finder/0.6.2--pyhdfd78af_0
$ module help quay.io/biocontainers/assembly_finder/0.6.2--pyhdfd78af_0
```
