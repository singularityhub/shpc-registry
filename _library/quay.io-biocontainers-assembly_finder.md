...
updated_at: "2024-09-03 03:17:40.003103"
latest: "0.7.5--pyhdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/assembly_finder:0.7.5--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/assembly_finder/0.7.5--pyhdfd78af_1
$ module help quay.io/biocontainers/assembly_finder/0.7.5--pyhdfd78af_1
```
