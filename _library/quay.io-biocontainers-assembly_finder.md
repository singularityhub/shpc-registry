...
updated_at: "2024-03-18 04:00:43.903295"
...
```bash
$ shpc install quay.io/biocontainers/assembly_finder:0.4.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/assembly_finder/0.4.2--pyhdfd78af_0
$ module help quay.io/biocontainers/assembly_finder/0.4.2--pyhdfd78af_0
```
