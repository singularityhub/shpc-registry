...
updated_at: "2023-08-12 02:39:37.995145"
...
```bash
$ shpc install quay.io/biocontainers/curare:0.4.5--pypyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/curare/0.4.5--pypyhdfd78af_0
$ module help quay.io/biocontainers/curare/0.4.5--pypyhdfd78af_0
```
