...
updated_at: "2026-09-03 07:32:09.167663"
latest: "4.0.1--pyh106432d_0"
...
```bash
$ shpc install quay.io/biocontainers/icount-mini:4.0.1--pyh106432d_0
```
...
```bash
$ module load quay.io/biocontainers/icount-mini/4.0.1--pyh106432d_0
$ module help quay.io/biocontainers/icount-mini/4.0.1--pyh106432d_0
```
