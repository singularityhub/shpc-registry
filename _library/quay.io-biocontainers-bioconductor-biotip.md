...
updated_at: "2026-03-26 04:58:28.127809"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-biotip:1.24.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-biotip/1.24.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-biotip/1.24.0--r45hdfd78af_0
```
