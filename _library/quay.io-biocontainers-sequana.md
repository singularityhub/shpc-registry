...
updated_at: "2025-11-17 03:51:07.412350"
...
```bash
$ shpc install quay.io/biocontainers/sequana:0.19.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sequana/0.19.3--pyhdfd78af_0
$ module help quay.io/biocontainers/sequana/0.19.3--pyhdfd78af_0
```
