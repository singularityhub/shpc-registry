...
updated_at: "2026-05-12 06:24:14.798689"
...
```bash
$ shpc install quay.io/biocontainers/sequana:0.21.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sequana/0.21.2--pyhdfd78af_0
$ module help quay.io/biocontainers/sequana/0.21.2--pyhdfd78af_0
```
