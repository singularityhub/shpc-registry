...
updated_at: "2026-07-29 05:32:17.113607"
latest: "0.23.0--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/sequana:0.23.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sequana/0.23.0--pyhdfd78af_0
$ module help quay.io/biocontainers/sequana/0.23.0--pyhdfd78af_0
```
