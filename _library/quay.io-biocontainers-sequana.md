...
updated_at: "2026-02-07 04:42:57.373724"
latest: "0.19.6--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/sequana:0.19.6--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sequana/0.19.6--pyhdfd78af_0
$ module help quay.io/biocontainers/sequana/0.19.6--pyhdfd78af_0
```
