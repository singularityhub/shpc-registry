...
updated_at: "2026-04-04 05:19:39.014989"
...
```bash
$ shpc install quay.io/biocontainers/sequana:0.21.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sequana/0.21.0--pyhdfd78af_0
$ module help quay.io/biocontainers/sequana/0.21.0--pyhdfd78af_0
```
