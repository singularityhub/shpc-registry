...
updated_at: "2026-06-28 06:38:11.889581"
...
```bash
$ shpc install quay.io/biocontainers/sequana:0.22.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sequana/0.22.0--pyhdfd78af_0
$ module help quay.io/biocontainers/sequana/0.22.0--pyhdfd78af_0
```
