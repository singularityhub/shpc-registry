...
updated_at: "2025-12-20 03:49:51.152297"
latest: "0.19.5--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/sequana:0.19.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sequana/0.19.5--pyhdfd78af_0
$ module help quay.io/biocontainers/sequana/0.19.5--pyhdfd78af_0
```
