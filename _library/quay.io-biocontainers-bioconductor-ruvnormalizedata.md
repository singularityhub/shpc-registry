...
updated_at: "2025-08-13 04:02:31.542481"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ruvnormalizedata:1.26.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ruvnormalizedata/1.26.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ruvnormalizedata/1.26.0--r44hdfd78af_0
```
