...
updated_at: "2026-03-10 04:52:22.511460"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ruvnormalizedata:1.30.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ruvnormalizedata/1.30.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ruvnormalizedata/1.30.0--r45hdfd78af_0
```
