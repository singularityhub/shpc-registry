...
updated_at: "2025-03-10 02:50:19.700337"
latest: "2.003004--pl5321hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/perl-math-bigint:2.003004--pl5321hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/perl-math-bigint/2.003004--pl5321hdfd78af_0
$ module help quay.io/biocontainers/perl-math-bigint/2.003004--pl5321hdfd78af_0
```
