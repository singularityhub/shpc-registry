...
updated_at: "2026-09-05 07:33:57.646742"
...
```bash
$ shpc install quay.io/biocontainers/panorama:1.0.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/panorama/1.0.4--pyhdfd78af_0
$ module help quay.io/biocontainers/panorama/1.0.4--pyhdfd78af_0
```
