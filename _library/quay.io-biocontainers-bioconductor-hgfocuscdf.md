...
updated_at: "2024-11-04 03:32:41.076775"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hgfocuscdf:2.18.0--r43hdfd78af_12
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hgfocuscdf/2.18.0--r43hdfd78af_12
$ module help quay.io/biocontainers/bioconductor-hgfocuscdf/2.18.0--r43hdfd78af_12
```
