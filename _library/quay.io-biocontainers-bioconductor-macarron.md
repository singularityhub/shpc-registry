...
updated_at: "2023-11-22 02:57:20.606214"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-macarron:1.4.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-macarron/1.4.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-macarron/1.4.0--r43hdfd78af_0
```
