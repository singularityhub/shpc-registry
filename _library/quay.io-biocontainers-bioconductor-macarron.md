...
updated_at: "2025-09-23 03:40:30.225995"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-macarron:1.6.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-macarron/1.6.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-macarron/1.6.0--r43hdfd78af_0
```
