---
layout: container
name:  "quay.io/biocontainers/cytosnake"
maintainer: "@vsoch"
github: "https://github.com/singularityhub/shpc-registry/blob/main/quay.io/biocontainers/cytosnake/container.yaml"
config_url: "https://raw.githubusercontent.com/singularityhub/shpc-registry/main/quay.io/biocontainers/cytosnake/container.yaml"
updated_at: "2024-12-11 03:10:56.150094"
latest: "0.0.2--pyhdfd78af_0"
container_url: "https://biocontainers.pro/tools/cytosnake"
aliases:
 - "cytosnake"
 - "eido"
 - "jsondiff"
...
versions:
 - "0.0.2--pyhdfd78af_0"
description: "singularity registry hpc automated addition for cytosnake"
config: {"url": "https://biocontainers.pro/tools/cytosnake", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for cytosnake", "latest": {"0.0.2--pyhdfd78af_0": "sha256:c8bdb1461b7faf7333f3295bf7743b59ef3d6d5a11d6a14d3f9e4cc1603e4f7f"}, "tags": {"0.0.2--pyhdfd78af_0": "sha256:c8bdb1461b7faf7333f3295bf7743b59ef3d6d5a11d6a14d3f9e4cc1603e4f7f"}, "docker": "quay.io/biocontainers/cytosnake", "aliases": {"cytosnake": "/usr/local/bin/cytosnake", "eido": "/usr/local/bin/eido", "jsondiff": "/usr/local/bin/jsondiff", "jsonpatch": "/usr/local/bin/jsonpatch", "jsonpointer": "/usr/local/bin/jsonpointer", "protoc-23.4.0": "/usr/local/bin/protoc-23.4.0", "mamba-package": "/usr/local/bin/mamba-package", "conda2solv": "/usr/local/bin/conda2solv", "dumpsolv": "/usr/local/bin/dumpsolv", "installcheck": "/usr/local/bin/installcheck", "mamba": "/usr/local/bin/mamba", "mergesolv": "/usr/local/bin/mergesolv", "repo2solv": "/usr/local/bin/repo2solv", "testsolv": "/usr/local/bin/testsolv", "markdown-it": "/usr/local/bin/markdown-it", "bsdcat": "/usr/local/bin/bsdcat", "bsdcpio": "/usr/local/bin/bsdcpio", "bsdtar": "/usr/local/bin/bsdtar", "conda-env": "/usr/local/bin/conda-env", "cph": "/usr/local/bin/cph", "stone": "/usr/local/bin/stone", "yte": "/usr/local/bin/yte", "plac_runner.py": "/usr/local/bin/plac_runner.py", "docutils": "/usr/local/bin/docutils", "pulptest": "/usr/local/bin/pulptest", "cbc": "/usr/local/bin/cbc", "clp": "/usr/local/bin/clp", "humanfriendly": "/usr/local/bin/humanfriendly", "snakemake": "/usr/local/bin/snakemake", "snakemake-bash-completion": "/usr/local/bin/snakemake-bash-completion", "jp.py": "/usr/local/bin/jp.py"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/cytosnake.
singularity registry hpc automated addition for cytosnake
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/cytosnake
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/cytosnake:0.0.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/cytosnake/0.0.2--pyhdfd78af_0
$ module help quay.io/biocontainers/cytosnake/0.0.2--pyhdfd78af_0
```
...
#### cytosnake-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### cytosnake-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/cytosnake
$ podman run --it --rm --entrypoint /usr/local/bin/cytosnake   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/cytosnake   -v ${PWD} -w ${PWD} <container> -c " $@"
```
