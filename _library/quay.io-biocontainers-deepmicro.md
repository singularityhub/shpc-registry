...
updated_at: "2023-03-31 02:52:39.959197"
...
```bash
$ shpc install quay.io/biocontainers/deepmicro:1.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/deepmicro/1.2--pyhdfd78af_0
$ module help quay.io/biocontainers/deepmicro/1.2--pyhdfd78af_0
```
