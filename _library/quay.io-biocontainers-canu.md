...
updated_at: "2026-08-24 03:17:13.146840"
latest: "2.3--h636b4d1_3"
...
```bash
$ shpc install quay.io/biocontainers/canu:2.3--h636b4d1_3
```
...
```bash
$ module load quay.io/biocontainers/canu/2.3--h636b4d1_3
$ module help quay.io/biocontainers/canu/2.3--h636b4d1_3
```
