...
updated_at: "2025-10-21 03:11:56.973341"
...
```bash
$ shpc install quay.io/biocontainers/massdash:0.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/massdash/0.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/massdash/0.1.0--pyhdfd78af_0
```
