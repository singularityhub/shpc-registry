...
updated_at: "2026-02-02 05:02:55.498385"
...
```bash
$ shpc install quay.io/biocontainers/hybracter:0.12.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hybracter/0.12.0--pyhdfd78af_0
$ module help quay.io/biocontainers/hybracter/0.12.0--pyhdfd78af_0
```
