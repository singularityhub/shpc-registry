...
updated_at: "2026-07-01 15:46:32.600790"
...
```bash
$ shpc install quay.io/biocontainers/hybracter:0.13.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hybracter/0.13.0--pyhdfd78af_0
$ module help quay.io/biocontainers/hybracter/0.13.0--pyhdfd78af_0
```
