...
updated_at: "2025-11-22 03:42:29.583312"
...
```bash
$ shpc install quay.io/biocontainers/hybracter:0.11.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hybracter/0.11.2--pyhdfd78af_0
$ module help quay.io/biocontainers/hybracter/0.11.2--pyhdfd78af_0
```
