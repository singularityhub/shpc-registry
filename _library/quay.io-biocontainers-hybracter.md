...
updated_at: "2024-11-27 03:11:05.796518"
...
```bash
$ shpc install quay.io/biocontainers/hybracter:0.10.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hybracter/0.10.0--pyhdfd78af_0
$ module help quay.io/biocontainers/hybracter/0.10.0--pyhdfd78af_0
```
