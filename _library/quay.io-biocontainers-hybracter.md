...
updated_at: "2024-10-31 00:28:14.048661"
...
```bash
$ shpc install quay.io/biocontainers/hybracter:0.9.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hybracter/0.9.0--pyhdfd78af_0
$ module help quay.io/biocontainers/hybracter/0.9.0--pyhdfd78af_0
```
