...
updated_at: "2024-09-08 03:31:19.995809"
...
```bash
$ shpc install quay.io/biocontainers/hybracter:0.7.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hybracter/0.7.3--pyhdfd78af_0
$ module help quay.io/biocontainers/hybracter/0.7.3--pyhdfd78af_0
```
