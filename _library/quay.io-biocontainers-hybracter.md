...
updated_at: "2026-08-08 04:07:35.536081"
...
```bash
$ shpc install quay.io/biocontainers/hybracter:0.14.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hybracter/0.14.0--pyhdfd78af_0
$ module help quay.io/biocontainers/hybracter/0.14.0--pyhdfd78af_0
```
