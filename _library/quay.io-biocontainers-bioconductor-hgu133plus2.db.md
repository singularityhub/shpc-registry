...
updated_at: "2025-11-20 03:50:37.377677"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hgu133plus2.db:3.13.0--r44hdfd78af_5
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hgu133plus2.db/3.13.0--r44hdfd78af_5
$ module help quay.io/biocontainers/bioconductor-hgu133plus2.db/3.13.0--r44hdfd78af_5
```
