...
updated_at: "2026-03-20 01:02:40.827606"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hgu133plus2.db:3.13.0--r45hdfd78af_6
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hgu133plus2.db/3.13.0--r45hdfd78af_6
$ module help quay.io/biocontainers/bioconductor-hgu133plus2.db/3.13.0--r45hdfd78af_6
```
