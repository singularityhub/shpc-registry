...
updated_at: "2024-05-04 02:45:10.668675"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mgu74c.db:3.13.0--r43hdfd78af_4
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mgu74c.db/3.13.0--r43hdfd78af_4
$ module help quay.io/biocontainers/bioconductor-mgu74c.db/3.13.0--r43hdfd78af_4
```
