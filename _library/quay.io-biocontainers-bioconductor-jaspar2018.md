...
updated_at: "2022-11-05 00:47:28.906024"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-jaspar2018:1.1.1--r41hdfd78af_9
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-jaspar2018/1.1.1--r41hdfd78af_9
$ module help quay.io/biocontainers/bioconductor-jaspar2018/1.1.1--r41hdfd78af_9
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-jaspar2018-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-jaspar2018-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-jaspar2018-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-jaspar2018-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-jaspar2018-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-jaspar2018-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
