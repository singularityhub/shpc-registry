...
updated_at: "2025-05-16 03:58:04.053138"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-sparsenetgls:1.24.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-sparsenetgls/1.24.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-sparsenetgls/1.24.0--r44hdfd78af_0
```
