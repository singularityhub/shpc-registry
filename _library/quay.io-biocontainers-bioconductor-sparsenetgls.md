...
updated_at: "2026-03-02 04:42:23.948734"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-sparsenetgls:1.28.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-sparsenetgls/1.28.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-sparsenetgls/1.28.0--r45hdfd78af_0
```
