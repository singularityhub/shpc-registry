...
updated_at: "2023-11-23 03:54:47.596364"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-sparsenetgls:1.18.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-sparsenetgls/1.18.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-sparsenetgls/1.18.0--r43hdfd78af_0
```
