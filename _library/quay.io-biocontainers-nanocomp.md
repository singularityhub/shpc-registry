...
updated_at: "2026-01-12 04:06:22.050771"
...
```bash
$ shpc install quay.io/biocontainers/nanocomp:1.25.6--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/nanocomp/1.25.6--pyhdfd78af_0
$ module help quay.io/biocontainers/nanocomp/1.25.6--pyhdfd78af_0
```
