...
updated_at: "2025-04-26 03:03:43.640126"
...
```bash
$ shpc install quay.io/biocontainers/nanocomp:1.25.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/nanocomp/1.25.2--pyhdfd78af_0
$ module help quay.io/biocontainers/nanocomp/1.25.2--pyhdfd78af_0
```
