...
updated_at: "2025-07-31 11:34:55.065992"
...
```bash
$ shpc install quay.io/biocontainers/nanocomp:1.25.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/nanocomp/1.25.3--pyhdfd78af_0
$ module help quay.io/biocontainers/nanocomp/1.25.3--pyhdfd78af_0
```
