...
updated_at: "2023-04-02 03:09:25.065574"
...
```bash
$ shpc install quay.io/biocontainers/nanocomp:1.21.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/nanocomp/1.21.0--pyhdfd78af_0
$ module help quay.io/biocontainers/nanocomp/1.21.0--pyhdfd78af_0
```
