...
updated_at: "2025-12-13 03:32:25.924128"
latest: "1.25.4--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/nanocomp:1.25.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/nanocomp/1.25.4--pyhdfd78af_0
$ module help quay.io/biocontainers/nanocomp/1.25.4--pyhdfd78af_0
```
