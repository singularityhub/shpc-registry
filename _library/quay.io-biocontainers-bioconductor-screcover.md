...
updated_at: "2026-03-09 04:37:49.750569"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-screcover:1.26.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-screcover/1.26.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-screcover/1.26.0--r45hdfd78af_0
```
