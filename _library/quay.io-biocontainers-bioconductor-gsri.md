...
updated_at: "2022-10-29 05:50:51.499460"
latest: "2.42.0--r41hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gsri:2.42.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gsri/2.42.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-gsri/2.42.0--r41hdfd78af_0
```
