...
updated_at: "2026-04-05 04:47:20.915913"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gsri:2.58.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gsri/2.58.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-gsri/2.58.0--r45hdfd78af_0
```
