...
updated_at: "2025-08-16 03:35:03.908526"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-tenxio:1.8.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-tenxio/1.8.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-tenxio/1.8.0--r44hdfd78af_0
```
