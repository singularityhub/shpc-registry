...
updated_at: "2024-02-15 03:02:10.781696"
latest: "2.34.0--r43ha9d7317_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-edge:2.34.0--r43ha9d7317_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-edge/2.34.0--r43ha9d7317_0
$ module help quay.io/biocontainers/bioconductor-edge/2.34.0--r43ha9d7317_0
```
