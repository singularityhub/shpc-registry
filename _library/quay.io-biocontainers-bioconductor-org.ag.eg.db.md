...
updated_at: "2023-11-17 03:05:32.514059"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-org.ag.eg.db:3.17.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-org.ag.eg.db/3.17.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-org.ag.eg.db/3.17.0--r43hdfd78af_0
```
