...
updated_at: "2026-08-01 05:42:45.528508"
...
```bash
$ shpc install quay.io/biocontainers/sc-musketeers:0.7.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sc-musketeers/0.7.0--pyhdfd78af_0
$ module help quay.io/biocontainers/sc-musketeers/0.7.0--pyhdfd78af_0
```
