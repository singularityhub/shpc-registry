...
updated_at: "2025-10-14 03:09:48.910990"
...
```bash
$ shpc install quay.io/biocontainers/sc-musketeers:0.4.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sc-musketeers/0.4.2--pyhdfd78af_0
$ module help quay.io/biocontainers/sc-musketeers/0.4.2--pyhdfd78af_0
```
