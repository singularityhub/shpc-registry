...
updated_at: "2025-08-12 03:55:19.824009"
...
```bash
$ shpc install quay.io/biocontainers/biobb_adapters:5.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_adapters/5.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/biobb_adapters/5.1.0--pyhdfd78af_0
```
