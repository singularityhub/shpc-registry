...
updated_at: "2025-09-16 03:28:39.088516"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hd2013sgi:1.46.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hd2013sgi/1.46.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-hd2013sgi/1.46.0--r44hdfd78af_0
```
