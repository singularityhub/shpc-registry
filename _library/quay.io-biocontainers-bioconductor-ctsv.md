...
updated_at: "2025-10-05 03:26:46.153629"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ctsv:1.8.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ctsv/1.8.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ctsv/1.8.0--r44hdfd78af_0
```
