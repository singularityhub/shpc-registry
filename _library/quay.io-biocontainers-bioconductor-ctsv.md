---
layout: container
name:  "quay.io/biocontainers/bioconductor-ctsv"
maintainer: "@vsoch"
...
updated_at: "2026-06-10 06:30:50.199180"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ctsv
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-ctsv:1.12.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ctsv/1.12.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ctsv/1.12.0--r45hdfd78af_0
```
...
#### bioconductor-ctsv-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-ctsv-inspect-deffile:
