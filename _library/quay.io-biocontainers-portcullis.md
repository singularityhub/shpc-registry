...
updated_at: "2025-05-08 05:15:47.481926"
latest: "1.2.4--py39hc12ff1f_3"
...
```bash
$ shpc install quay.io/biocontainers/portcullis:1.2.4--py39hc12ff1f_3
```
...
```bash
$ module load quay.io/biocontainers/portcullis/1.2.4--py39hc12ff1f_3
$ module help quay.io/biocontainers/portcullis/1.2.4--py39hc12ff1f_3
```
