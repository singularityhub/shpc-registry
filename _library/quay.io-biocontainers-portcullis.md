...
updated_at: "2025-10-18 03:15:30.326301"
...
```bash
$ shpc install quay.io/biocontainers/portcullis:1.2.4--py39hc87ae8a_4
```
...
```bash
$ module load quay.io/biocontainers/portcullis/1.2.4--py39hc87ae8a_4
$ module help quay.io/biocontainers/portcullis/1.2.4--py39hc87ae8a_4
```
