...
updated_at: "2026-03-05 01:02:38.681228"
latest: "26.1.0--h9ee0642_0"
...
```bash
$ shpc install quay.io/biocontainers/pbmm2:26.1.0--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/pbmm2/26.1.0--h9ee0642_0
$ module help quay.io/biocontainers/pbmm2/26.1.0--h9ee0642_0
```
