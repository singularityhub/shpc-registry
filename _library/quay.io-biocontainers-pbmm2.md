...
updated_at: "2026-03-23 06:02:48.621099"
latest: "26.1.99--h9ee0642_0"
...
```bash
$ shpc install quay.io/biocontainers/pbmm2:26.1.99--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/pbmm2/26.1.99--h9ee0642_0
$ module help quay.io/biocontainers/pbmm2/26.1.99--h9ee0642_0
```
