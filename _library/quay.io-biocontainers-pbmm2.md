...
updated_at: "2024-07-12 03:01:49.599761"
latest: "1.14.99--h9ee0642_0"
...
```bash
$ shpc install quay.io/biocontainers/pbmm2:1.14.99--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/pbmm2/1.14.99--h9ee0642_0
$ module help quay.io/biocontainers/pbmm2/1.14.99--h9ee0642_0
```
