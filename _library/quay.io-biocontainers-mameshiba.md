...
updated_at: "2025-08-04 04:46:05.082727"
...
```bash
$ shpc install quay.io/biocontainers/mameshiba:0.6.2--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mameshiba/0.6.2--hdfd78af_0
$ module help quay.io/biocontainers/mameshiba/0.6.2--hdfd78af_0
```
