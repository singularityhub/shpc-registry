...
updated_at: "2025-05-21 03:26:03.524728"
...
```bash
$ shpc install quay.io/biocontainers/mameshiba:0.6.1--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mameshiba/0.6.1--hdfd78af_0
$ module help quay.io/biocontainers/mameshiba/0.6.1--hdfd78af_0
```
