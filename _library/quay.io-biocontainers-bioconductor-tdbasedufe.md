---
layout: container
name:  "quay.io/biocontainers/bioconductor-tdbasedufe"
maintainer: "@vsoch"
...
updated_at: "2025-04-27 04:01:18.482556"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-tdbasedufe
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-tdbasedufe:1.6.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-tdbasedufe/1.6.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-tdbasedufe/1.6.0--r44hdfd78af_0
```
...
#### bioconductor-tdbasedufe-inspect:
...
#### bioconductor-tdbasedufe-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-tdbasedufe-inspect-deffile:
