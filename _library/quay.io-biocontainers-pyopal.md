...
updated_at: "2024-04-03 02:30:32.023521"
...
```bash
$ shpc install quay.io/biocontainers/pyopal:0.5.2--py38hcbe9525_0
```
...
```bash
$ module load quay.io/biocontainers/pyopal/0.5.2--py38hcbe9525_0
$ module help quay.io/biocontainers/pyopal/0.5.2--py38hcbe9525_0
```
