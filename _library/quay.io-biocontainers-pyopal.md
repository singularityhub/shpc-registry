...
updated_at: "2024-03-08 02:22:39.544562"
latest: "0.5.1--py310h068649b_0"
...
```bash
$ shpc install quay.io/biocontainers/pyopal:0.5.1--py310h068649b_0
```
...
```bash
$ module load quay.io/biocontainers/pyopal/0.5.1--py310h068649b_0
$ module help quay.io/biocontainers/pyopal/0.5.1--py310h068649b_0
```
