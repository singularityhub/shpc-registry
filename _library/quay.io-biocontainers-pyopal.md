...
updated_at: "2024-05-19 02:58:39.127411"
...
```bash
$ shpc install quay.io/biocontainers/pyopal:0.6.0--py38hcbe9525_0
```
...
```bash
$ module load quay.io/biocontainers/pyopal/0.6.0--py38hcbe9525_0
$ module help quay.io/biocontainers/pyopal/0.6.0--py38hcbe9525_0
```
