...
updated_at: "2025-08-14 03:35:17.784888"
latest: "0.7.2--py312h9c9b0c2_0"
...
```bash
$ shpc install quay.io/biocontainers/pyopal:0.7.2--py312h9c9b0c2_0
```
...
```bash
$ module load quay.io/biocontainers/pyopal/0.7.2--py312h9c9b0c2_0
$ module help quay.io/biocontainers/pyopal/0.7.2--py312h9c9b0c2_0
```
