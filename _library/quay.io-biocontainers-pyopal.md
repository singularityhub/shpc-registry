...
updated_at: "2024-08-01 02:57:16.505493"
latest: "0.6.1--py312h719dbc0_1"
...
```bash
$ shpc install quay.io/biocontainers/pyopal:0.6.1--py312h719dbc0_1
```
...
```bash
$ module load quay.io/biocontainers/pyopal/0.6.1--py312h719dbc0_1
$ module help quay.io/biocontainers/pyopal/0.6.1--py312h719dbc0_1
```
