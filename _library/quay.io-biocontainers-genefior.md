---
layout: container
name:  "quay.io/biocontainers/genefior"
maintainer: "@vsoch"
...
updated_at: "2026-09-24 07:48:21.870662"
...
```bash
$ module load quay.io/biocontainers/genefior/0.11.0--pyhdfd78af_0
$ module help quay.io/biocontainers/genefior/0.11.0--pyhdfd78af_0
```
...
#### genefior-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### genefior-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/GeneFior
$ podman run --it --rm --entrypoint /usr/local/bin/GeneFior   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/GeneFior   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/GeneFior-Gene-Stats
$ podman run --it --rm --entrypoint /usr/local/bin/GeneFior-Gene-Stats   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/GeneFior-Gene-Stats   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/GeneFior-Recompute
$ podman run --it --rm --entrypoint /usr/local/bin/GeneFior-Recompute   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/GeneFior-Recompute   -v ${PWD} -w ${PWD} <container> -c " $@"
```
