...
updated_at: "2026-03-05 04:44:41.660367"
...
```bash
$ shpc install quay.io/biocontainers/genefior:0.6.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/genefior/0.6.0--pyhdfd78af_0
$ module help quay.io/biocontainers/genefior/0.6.0--pyhdfd78af_0
```
