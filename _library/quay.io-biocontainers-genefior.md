...
updated_at: "2026-07-31 06:28:04.625559"
...
```bash
$ shpc install quay.io/biocontainers/genefior:0.10.1--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/genefior/0.10.1--pyhdfd78af_1
$ module help quay.io/biocontainers/genefior/0.10.1--pyhdfd78af_1
```
