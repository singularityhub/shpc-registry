...
updated_at: "2026-08-13 05:07:04.109467"
...
```bash
$ shpc install quay.io/biocontainers/genefior:0.10.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/genefior/0.10.2--pyhdfd78af_0
$ module help quay.io/biocontainers/genefior/0.10.2--pyhdfd78af_0
```
