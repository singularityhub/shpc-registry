...
updated_at: "2025-12-11 04:22:35.537298"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-netactivity:1.8.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-netactivity/1.8.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-netactivity/1.8.0--r44hdfd78af_0
```
