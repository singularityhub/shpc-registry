...
updated_at: "2025-06-29 03:44:58.796751"
latest: "0.16.1--h1520f10_0"
...
```bash
$ shpc install quay.io/biocontainers/alignoth:0.16.1--h1520f10_0
```
...
```bash
$ module load quay.io/biocontainers/alignoth/0.16.1--h1520f10_0
$ module help quay.io/biocontainers/alignoth/0.16.1--h1520f10_0
```
