...
updated_at: "2026-01-13 04:05:12.619763"
latest: "1.4.1--h1520f10_0"
...
```bash
$ shpc install quay.io/biocontainers/alignoth:1.4.1--h1520f10_0
```
...
```bash
$ module load quay.io/biocontainers/alignoth/1.4.1--h1520f10_0
$ module help quay.io/biocontainers/alignoth/1.4.1--h1520f10_0
```
