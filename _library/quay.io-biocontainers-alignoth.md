...
updated_at: "2026-08-02 05:32:43.724402"
latest: "1.6.0--h9e2517d_0"
...
```bash
$ shpc install quay.io/biocontainers/alignoth:1.6.0--h9e2517d_0
```
...
```bash
$ module load quay.io/biocontainers/alignoth/1.6.0--h9e2517d_0
$ module help quay.io/biocontainers/alignoth/1.6.0--h9e2517d_0
```
