...
updated_at: "2025-12-11 03:49:14.104250"
latest: "1.4.0--h1520f10_0"
...
```bash
$ shpc install quay.io/biocontainers/alignoth:1.4.0--h1520f10_0
```
...
```bash
$ module load quay.io/biocontainers/alignoth/1.4.0--h1520f10_0
$ module help quay.io/biocontainers/alignoth/1.4.0--h1520f10_0
```
