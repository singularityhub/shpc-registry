...
updated_at: "2024-06-29 02:49:29.447602"
latest: "0.12.0--hb27afe3_1"
...
```bash
$ shpc install quay.io/biocontainers/alignoth:0.12.0--hb27afe3_1
```
...
```bash
$ module load quay.io/biocontainers/alignoth/0.12.0--hb27afe3_1
$ module help quay.io/biocontainers/alignoth/0.12.0--hb27afe3_1
```
