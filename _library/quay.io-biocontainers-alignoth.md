...
updated_at: "2026-04-03 05:09:45.743536"
latest: "1.5.1--hcdf5fec_0"
...
```bash
$ shpc install quay.io/biocontainers/alignoth:1.5.1--hcdf5fec_0
```
...
```bash
$ module load quay.io/biocontainers/alignoth/1.5.1--hcdf5fec_0
$ module help quay.io/biocontainers/alignoth/1.5.1--hcdf5fec_0
```
