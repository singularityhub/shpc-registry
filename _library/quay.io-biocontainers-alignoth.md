...
updated_at: "2026-08-17 03:52:38.824608"
latest: "1.10.1--h9e2517d_0"
...
```bash
$ shpc install quay.io/biocontainers/alignoth:1.10.1--h9e2517d_0
```
...
```bash
$ module load quay.io/biocontainers/alignoth/1.10.1--h9e2517d_0
$ module help quay.io/biocontainers/alignoth/1.10.1--h9e2517d_0
```
