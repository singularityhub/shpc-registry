...
updated_at: "2025-05-15 04:21:21.675155"
latest: "0.14.1--h1520f10_0"
...
```bash
$ shpc install quay.io/biocontainers/alignoth:0.14.1--h1520f10_0
```
...
```bash
$ module load quay.io/biocontainers/alignoth/0.14.1--h1520f10_0
$ module help quay.io/biocontainers/alignoth/0.14.1--h1520f10_0
```
