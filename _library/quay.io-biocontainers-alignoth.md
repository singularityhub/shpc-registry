...
updated_at: "2026-03-06 04:17:28.264431"
latest: "1.4.6--h1520f10_0"
...
```bash
$ shpc install quay.io/biocontainers/alignoth:1.4.6--h1520f10_0
```
...
```bash
$ module load quay.io/biocontainers/alignoth/1.4.6--h1520f10_0
$ module help quay.io/biocontainers/alignoth/1.4.6--h1520f10_0
```
