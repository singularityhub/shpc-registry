...
updated_at: "2024-08-29 11:32:27.680339"
latest: "0.12.1--hb27afe3_0"
...
```bash
$ shpc install quay.io/biocontainers/alignoth:0.12.1--hb27afe3_0
```
...
```bash
$ module load quay.io/biocontainers/alignoth/0.12.1--hb27afe3_0
$ module help quay.io/biocontainers/alignoth/0.12.1--hb27afe3_0
```
