...
updated_at: "2024-11-06 03:05:44.826451"
...
```bash
$ shpc install quay.io/biocontainers/alignoth:0.13.0--hb27afe3_0
```
...
```bash
$ module load quay.io/biocontainers/alignoth/0.13.0--hb27afe3_0
$ module help quay.io/biocontainers/alignoth/0.13.0--hb27afe3_0
```
