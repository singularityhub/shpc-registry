...
updated_at: "2024-03-26 02:22:19.675053"
latest: "0.12.0--hb27afe3_0"
...
```bash
$ shpc install quay.io/biocontainers/alignoth:0.12.0--hb27afe3_0
```
...
```bash
$ module load quay.io/biocontainers/alignoth/0.12.0--hb27afe3_0
$ module help quay.io/biocontainers/alignoth/0.12.0--hb27afe3_0
```
