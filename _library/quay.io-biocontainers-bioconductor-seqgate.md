...
updated_at: "2024-07-18 02:54:36.631977"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-seqgate:1.12.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-seqgate/1.12.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-seqgate/1.12.0--r43hdfd78af_0
```
