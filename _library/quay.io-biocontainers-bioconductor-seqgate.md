...
updated_at: "2023-11-18 02:53:32.458962"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-seqgate:1.10.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-seqgate/1.10.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-seqgate/1.10.0--r43hdfd78af_0
```
