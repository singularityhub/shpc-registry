...
updated_at: "2022-11-02 19:31:03.222775"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-seqgate:1.4.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-seqgate/1.4.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-seqgate/1.4.0--r41hdfd78af_0
```
