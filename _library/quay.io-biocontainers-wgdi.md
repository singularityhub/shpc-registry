...
updated_at: "2022-10-27 00:36:43.002639"
...
```bash
$ shpc install quay.io/biocontainers/wgdi:0.6.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/wgdi/0.6.1--pyhdfd78af_0
$ module help quay.io/biocontainers/wgdi/0.6.1--pyhdfd78af_0
```
