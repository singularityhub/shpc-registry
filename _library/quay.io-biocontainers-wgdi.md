...
updated_at: "2025-01-17 03:10:13.824897"
...
```bash
$ shpc install quay.io/biocontainers/wgdi:0.72--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/wgdi/0.72--pyhdfd78af_0
$ module help quay.io/biocontainers/wgdi/0.72--pyhdfd78af_0
```
