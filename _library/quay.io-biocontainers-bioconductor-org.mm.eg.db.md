...
updated_at: "2026-03-26 05:26:54.645083"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-org.mm.eg.db:3.22.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-org.mm.eg.db/3.22.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-org.mm.eg.db/3.22.0--r45hdfd78af_0
```
