...
updated_at: "2026-01-11 04:29:37.321783"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-org.mm.eg.db:3.20.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-org.mm.eg.db/3.20.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-org.mm.eg.db/3.20.0--r44hdfd78af_0
```
