...
updated_at: "2022-11-04 00:18:16.720122"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gmrp:1.8.1--r341_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gmrp/1.8.1--r341_0
$ module help quay.io/biocontainers/bioconductor-gmrp/1.8.1--r341_0
```
