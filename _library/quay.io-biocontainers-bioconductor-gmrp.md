...
updated_at: "2022-11-15 00:33:42.440401"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gmrp:1.22.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gmrp/1.22.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-gmrp/1.22.0--r41hdfd78af_0
```
