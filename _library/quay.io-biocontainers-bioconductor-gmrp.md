...
updated_at: "2026-04-05 05:09:07.460884"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gmrp:1.38.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gmrp/1.38.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-gmrp/1.38.0--r45hdfd78af_0
```
