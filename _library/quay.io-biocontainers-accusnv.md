...
updated_at: "2026-09-26 07:36:44.108268"
...
```bash
$ shpc install quay.io/biocontainers/accusnv:1.1.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/accusnv/1.1.1--pyhdfd78af_0
$ module help quay.io/biocontainers/accusnv/1.1.1--pyhdfd78af_0
```
