...
updated_at: "2022-11-03 01:07:47.149139"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hgu95dprobe:2.18.0--r41hdfd78af_9
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hgu95dprobe/2.18.0--r41hdfd78af_9
$ module help quay.io/biocontainers/bioconductor-hgu95dprobe/2.18.0--r41hdfd78af_9
```
