...
updated_at: "2024-08-14 02:55:18.148315"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hgu95dprobe:2.18.0--r43hdfd78af_13
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hgu95dprobe/2.18.0--r43hdfd78af_13
$ module help quay.io/biocontainers/bioconductor-hgu95dprobe/2.18.0--r43hdfd78af_13
```
