...
updated_at: "2026-04-05 05:16:04.703414"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hgu95dprobe:2.18.0--r45hdfd78af_15
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hgu95dprobe/2.18.0--r45hdfd78af_15
$ module help quay.io/biocontainers/bioconductor-hgu95dprobe/2.18.0--r45hdfd78af_15
```
