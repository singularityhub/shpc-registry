---
layout: container
name:  "quay.io/biocontainers/snipe"
maintainer: "@vsoch"
...
updated_at: "2025-09-23 05:10:50.277410"
...
```bash
$ shpc install quay.io/biocontainers/snipe
```
...
#### snipe-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### snipe-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/snipe
$ podman run --it --rm --entrypoint /usr/local/bin/snipe   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/snipe   -v ${PWD} -w ${PWD} <container> -c " $@"
```
