...
updated_at: "2026-08-22 03:04:29.877469"
...
```bash
$ shpc install quay.io/biocontainers/ervmancer:1.0.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ervmancer/1.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/ervmancer/1.0.0--pyhdfd78af_0
```
