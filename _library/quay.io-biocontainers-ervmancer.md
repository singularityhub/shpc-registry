...
updated_at: "2025-07-29 04:26:37.416168"
...
```bash
$ shpc install quay.io/biocontainers/ervmancer:0.0.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ervmancer/0.0.3--pyhdfd78af_0
$ module help quay.io/biocontainers/ervmancer/0.0.3--pyhdfd78af_0
```
