...
updated_at: "2023-01-24 03:15:11.566111"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-granie:1.2.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-granie/1.2.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-granie/1.2.0--r42hdfd78af_0
```
