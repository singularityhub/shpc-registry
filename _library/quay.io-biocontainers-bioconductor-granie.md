...
updated_at: "2023-12-05 02:42:48.635019"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-granie:1.4.1--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-granie/1.4.1--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-granie/1.4.1--r43hdfd78af_0
```
