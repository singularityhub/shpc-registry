...
updated_at: "2026-01-11 04:40:33.000921"
latest: "0.6.10--hdfd78af_2"
...
```bash
$ shpc install quay.io/biocontainers/trim-galore:0.6.10--hdfd78af_2
```
...
```bash
$ module load quay.io/biocontainers/trim-galore/0.6.10--hdfd78af_2
$ module help quay.io/biocontainers/trim-galore/0.6.10--hdfd78af_2
```
