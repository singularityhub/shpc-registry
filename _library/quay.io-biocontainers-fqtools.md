...
updated_at: "2023-04-10 03:17:08.870371"
latest: "2.0--hc88714e_11"
...
```bash
$ shpc install quay.io/biocontainers/fqtools:2.0--hc88714e_11
```
...
```bash
$ module load quay.io/biocontainers/fqtools/2.0--hc88714e_11
$ module help quay.io/biocontainers/fqtools/2.0--hc88714e_11
```
