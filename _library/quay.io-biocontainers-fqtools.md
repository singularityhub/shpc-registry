...
updated_at: "2022-10-29 17:56:28.076153"
...
```bash
$ shpc install quay.io/biocontainers/fqtools:2.0--h6233b05_9
```
...
```bash
$ module load quay.io/biocontainers/fqtools/2.0--h6233b05_9
$ module help quay.io/biocontainers/fqtools/2.0--h6233b05_9
```
