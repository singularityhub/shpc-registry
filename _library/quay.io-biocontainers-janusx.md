---
layout: container
name:  "quay.io/biocontainers/janusx"
maintainer: "@vsoch"
...
updated_at: "2026-08-07 04:53:43.000838"
latest: "1.0.25--py310h9fb556b_0"
...
```bash
$ module load quay.io/biocontainers/janusx/1.0.25--py310h9fb556b_0
$ module help quay.io/biocontainers/janusx/1.0.25--py310h9fb556b_0
```
...
#### janusx-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### janusx-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/jx
$ podman run --it --rm --entrypoint /usr/local/bin/jx   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/jx   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/jxpy
$ podman run --it --rm --entrypoint /usr/local/bin/jxpy   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/jxpy   -v ${PWD} -w ${PWD} <container> -c " $@"
```
