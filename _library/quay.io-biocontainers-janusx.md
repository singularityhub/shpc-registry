...
updated_at: "2026-08-27 12:33:39.667326"
...
```bash
$ shpc install quay.io/biocontainers/janusx:1.0.27--py310h9fb556b_0
```
...
```bash
$ module load quay.io/biocontainers/janusx/1.0.27--py310h9fb556b_0
$ module help quay.io/biocontainers/janusx/1.0.27--py310h9fb556b_0
```
