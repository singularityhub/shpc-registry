...
updated_at: "2025-10-13 03:13:20.559037"
...
```bash
$ shpc install quay.io/biocontainers/get_pangenes:1.3--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/get_pangenes/1.3--hdfd78af_0
$ module help quay.io/biocontainers/get_pangenes/1.3--hdfd78af_0
```
