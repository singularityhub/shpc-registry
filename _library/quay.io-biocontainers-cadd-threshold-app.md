...
updated_at: "2026-09-01 08:12:29.861685"
...
```bash
$ shpc install quay.io/biocontainers/cadd-threshold-app:0.0.9--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/cadd-threshold-app/0.0.9--pyhdfd78af_0
$ module help quay.io/biocontainers/cadd-threshold-app/0.0.9--pyhdfd78af_0
```
