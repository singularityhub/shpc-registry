...
updated_at: "2026-06-27 06:41:50.381996"
...
```bash
$ shpc install quay.io/biocontainers/cadd-threshold-app:0.0.7--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/cadd-threshold-app/0.0.7--pyhdfd78af_0
$ module help quay.io/biocontainers/cadd-threshold-app/0.0.7--pyhdfd78af_0
```
