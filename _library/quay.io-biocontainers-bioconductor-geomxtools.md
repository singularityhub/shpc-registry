...
updated_at: "2022-10-29 05:47:30.181196"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-geomxtools:2.0.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-geomxtools/2.0.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-geomxtools/2.0.0--r41hdfd78af_0
```
