...
updated_at: "2023-12-02 02:33:56.526051"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-zebrafish.db:3.13.0--r43hdfd78af_3
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-zebrafish.db/3.13.0--r43hdfd78af_3
$ module help quay.io/biocontainers/bioconductor-zebrafish.db/3.13.0--r43hdfd78af_3
```
