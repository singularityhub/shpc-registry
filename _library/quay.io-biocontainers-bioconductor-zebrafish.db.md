...
updated_at: "2024-04-15 06:00:52.898879"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-zebrafish.db:3.13.0--r43hdfd78af_4
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-zebrafish.db/3.13.0--r43hdfd78af_4
$ module help quay.io/biocontainers/bioconductor-zebrafish.db/3.13.0--r43hdfd78af_4
```
