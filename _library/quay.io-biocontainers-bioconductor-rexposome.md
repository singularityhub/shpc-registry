...
updated_at: "2026-04-05 05:27:15.752059"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rexposome:1.32.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rexposome/1.32.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rexposome/1.32.0--r45hdfd78af_0
```
