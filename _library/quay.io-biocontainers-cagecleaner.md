...
updated_at: "2025-05-12 03:46:02.757440"
...
```bash
$ shpc install quay.io/biocontainers/cagecleaner:1.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/cagecleaner/1.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/cagecleaner/1.2.0--pyhdfd78af_0
```
