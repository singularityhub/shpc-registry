...
updated_at: "2026-07-14 05:10:15.492987"
...
```bash
$ shpc install quay.io/biocontainers/cagecleaner:1.5.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/cagecleaner/1.5.2--pyhdfd78af_0
$ module help quay.io/biocontainers/cagecleaner/1.5.2--pyhdfd78af_0
```
