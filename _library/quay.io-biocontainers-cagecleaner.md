...
updated_at: "2025-10-14 03:38:24.201676"
...
```bash
$ shpc install quay.io/biocontainers/cagecleaner:1.4.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/cagecleaner/1.4.3--pyhdfd78af_0
$ module help quay.io/biocontainers/cagecleaner/1.4.3--pyhdfd78af_0
```
