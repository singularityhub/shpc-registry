...
updated_at: "2025-10-02 03:34:14.820901"
...
```bash
$ shpc install quay.io/biocontainers/cagecleaner:1.4.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/cagecleaner/1.4.2--pyhdfd78af_0
$ module help quay.io/biocontainers/cagecleaner/1.4.2--pyhdfd78af_0
```
