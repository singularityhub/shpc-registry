...
updated_at: "2026-06-23 06:29:46.989116"
...
```bash
$ shpc install quay.io/biocontainers/cagecleaner:1.5.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/cagecleaner/1.5.1--pyhdfd78af_0
$ module help quay.io/biocontainers/cagecleaner/1.5.1--pyhdfd78af_0
```
