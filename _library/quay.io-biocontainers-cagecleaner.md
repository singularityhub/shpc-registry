...
updated_at: "2026-05-28 15:40:40.195906"
...
```bash
$ shpc install quay.io/biocontainers/cagecleaner:1.5.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/cagecleaner/1.5.0--pyhdfd78af_0
$ module help quay.io/biocontainers/cagecleaner/1.5.0--pyhdfd78af_0
```
