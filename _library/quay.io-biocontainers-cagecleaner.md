---
layout: container
name:  "quay.io/biocontainers/cagecleaner"
maintainer: "@vsoch"
...
updated_at: "2026-09-19 07:55:53.554018"
...
```bash
$ module load quay.io/biocontainers/cagecleaner/1.5.2--pyhdfd78af_1
$ module help quay.io/biocontainers/cagecleaner/1.5.2--pyhdfd78af_1
```
...
#### cagecleaner-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### cagecleaner-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/dereplicate_assemblies.sh
$ podman run --it --rm --entrypoint /usr/local/bin/dereplicate_assemblies.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/dereplicate_assemblies.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/download_assemblies.sh
$ podman run --it --rm --entrypoint /usr/local/bin/download_assemblies.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/download_assemblies.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/get_accessions.sh
$ podman run --it --rm --entrypoint /usr/local/bin/get_accessions.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/get_accessions.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
