...
updated_at: "2023-10-02 03:17:52.511671"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-swath2stats:1.30.1--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-swath2stats/1.30.1--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-swath2stats/1.30.1--r43hdfd78af_0
```
