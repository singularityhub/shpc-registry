...
updated_at: "2026-04-05 04:41:39.918300"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-swath2stats:1.40.1--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-swath2stats/1.40.1--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-swath2stats/1.40.1--r45hdfd78af_0
```
