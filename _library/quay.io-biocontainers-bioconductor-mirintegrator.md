...
updated_at: "2023-11-30 02:55:56.971939"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mirintegrator:1.30.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mirintegrator/1.30.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-mirintegrator/1.30.0--r43hdfd78af_0
```
