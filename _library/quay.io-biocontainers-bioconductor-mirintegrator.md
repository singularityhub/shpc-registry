...
updated_at: "2024-08-04 03:24:32.487939"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mirintegrator:1.32.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mirintegrator/1.32.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-mirintegrator/1.32.0--r43hdfd78af_0
```
