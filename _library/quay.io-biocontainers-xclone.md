...
updated_at: "2024-10-14 03:32:22.691945"
...
```bash
$ shpc install quay.io/biocontainers/xclone:0.3.8--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/xclone/0.3.8--pyhdfd78af_0
$ module help quay.io/biocontainers/xclone/0.3.8--pyhdfd78af_0
```
