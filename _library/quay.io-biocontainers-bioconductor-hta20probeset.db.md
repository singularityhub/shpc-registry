...
updated_at: "2023-11-27 03:32:56.790288"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hta20probeset.db:8.8.0--r43hdfd78af_3
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hta20probeset.db/8.8.0--r43hdfd78af_3
$ module help quay.io/biocontainers/bioconductor-hta20probeset.db/8.8.0--r43hdfd78af_3
```
