...
updated_at: "2026-03-21 04:29:38.231929"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-scale4c:1.32.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-scale4c/1.32.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-scale4c/1.32.0--r45hdfd78af_0
```
