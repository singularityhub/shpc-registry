...
updated_at: "2023-09-11 03:11:49.323077"
...
```bash
$ shpc install quay.io/biocontainers/trackplot:0.3.4--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/trackplot/0.3.4--pyh7cba7a3_0
$ module help quay.io/biocontainers/trackplot/0.3.4--pyh7cba7a3_0
```
