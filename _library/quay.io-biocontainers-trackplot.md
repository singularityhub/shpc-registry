...
updated_at: "2026-04-05 04:46:28.561285"
...
```bash
$ shpc install quay.io/biocontainers/trackplot:0.5.7--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/trackplot/0.5.7--pyhdfd78af_0
$ module help quay.io/biocontainers/trackplot/0.5.7--pyhdfd78af_0
```
