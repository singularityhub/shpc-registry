...
updated_at: "2024-09-16 03:39:36.866031"
...
```bash
$ shpc install quay.io/biocontainers/trackplot:0.5.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/trackplot/0.5.1--pyhdfd78af_0
$ module help quay.io/biocontainers/trackplot/0.5.1--pyhdfd78af_0
```
