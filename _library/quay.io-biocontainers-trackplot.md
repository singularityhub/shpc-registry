...
updated_at: "2025-03-06 03:26:00.744764"
...
```bash
$ shpc install quay.io/biocontainers/trackplot:0.5.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/trackplot/0.5.2--pyhdfd78af_0
$ module help quay.io/biocontainers/trackplot/0.5.2--pyhdfd78af_0
```
