...
updated_at: "2024-08-25 02:46:47.101394"
...
```bash
$ shpc install quay.io/biocontainers/trackplot:0.4.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/trackplot/0.4.0--pyhdfd78af_0
$ module help quay.io/biocontainers/trackplot/0.4.0--pyhdfd78af_0
```
