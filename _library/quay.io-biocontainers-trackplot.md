...
updated_at: "2025-05-06 03:42:25.350351"
...
```bash
$ shpc install quay.io/biocontainers/trackplot:0.5.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/trackplot/0.5.3--pyhdfd78af_0
$ module help quay.io/biocontainers/trackplot/0.5.3--pyhdfd78af_0
```
