...
updated_at: "2026-07-08 06:05:19.566050"
...
```bash
$ shpc install quay.io/biocontainers/trackplot:0.6.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/trackplot/0.6.4--pyhdfd78af_0
$ module help quay.io/biocontainers/trackplot/0.6.4--pyhdfd78af_0
```
