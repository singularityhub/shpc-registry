...
updated_at: "2024-12-14 02:59:45.532381"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-paeg1acdf:2.18.0--r43hdfd78af_12
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-paeg1acdf/2.18.0--r43hdfd78af_12
$ module help quay.io/biocontainers/bioconductor-paeg1acdf/2.18.0--r43hdfd78af_12
```
