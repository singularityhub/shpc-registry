...
updated_at: "2026-04-03 15:46:29.225054"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-paeg1acdf:2.18.0--r45hdfd78af_14
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-paeg1acdf/2.18.0--r45hdfd78af_14
$ module help quay.io/biocontainers/bioconductor-paeg1acdf/2.18.0--r45hdfd78af_14
```
