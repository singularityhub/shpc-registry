...
updated_at: "2022-10-29 17:36:49.853118"
latest: "0.9.9--r351_0"
...
```bash
$ shpc install quay.io/biocontainers/r-basejump:0.9.9--r351_0
```
...
```bash
$ module load quay.io/biocontainers/r-basejump/0.9.9--r351_0
$ module help quay.io/biocontainers/r-basejump/0.9.9--r351_0
```
