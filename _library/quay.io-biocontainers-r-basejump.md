...
updated_at: "2026-09-17 07:52:34.623938"
latest: "0.18.2--r45hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/r-basejump:0.18.2--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/r-basejump/0.18.2--r45hdfd78af_0
$ module help quay.io/biocontainers/r-basejump/0.18.2--r45hdfd78af_0
```
