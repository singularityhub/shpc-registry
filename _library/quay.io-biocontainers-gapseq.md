...
updated_at: "2026-06-20 06:32:14.883081"
...
```bash
$ shpc install quay.io/biocontainers/gapseq:2.1.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/gapseq/2.1.0--hdfd78af_0
$ module help quay.io/biocontainers/gapseq/2.1.0--hdfd78af_0
```
