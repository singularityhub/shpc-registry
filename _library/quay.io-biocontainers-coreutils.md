...
updated_at: "2026-09-04 07:49:25.737248"
latest: "9.11"
...
```bash
$ shpc install quay.io/biocontainers/coreutils:9.11
```
...
```bash
$ module load quay.io/biocontainers/coreutils/9.11
$ module help quay.io/biocontainers/coreutils/9.11
```
