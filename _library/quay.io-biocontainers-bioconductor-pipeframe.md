...
updated_at: "2023-09-28 02:55:38.943717"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-pipeframe:1.16.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-pipeframe/1.16.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-pipeframe/1.16.0--r43hdfd78af_0
```
