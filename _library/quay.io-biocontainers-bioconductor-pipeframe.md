...
updated_at: "2026-03-26 05:01:42.007613"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-pipeframe:1.26.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-pipeframe/1.26.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-pipeframe/1.26.0--r45hdfd78af_0
```
