---
layout: container
name:  "quay.io/biocontainers/synth-saxs"
maintainer: "@vsoch"
...
updated_at: "2026-06-26 01:29:35.385981"
...
singularity registry hpc automated addition for synth-saxs
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/synth-saxs
```
...
#### synth-saxs-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### synth-saxs-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/synth-saxs
$ podman run --it --rm --entrypoint /usr/local/bin/synth-saxs   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/synth-saxs   -v ${PWD} -w ${PWD} <container> -c " $@"
```
