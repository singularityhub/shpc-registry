...
updated_at: "2023-12-01 02:36:23.925635"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hiccompare:1.22.1--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hiccompare/1.22.1--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-hiccompare/1.22.1--r43hdfd78af_0
```
