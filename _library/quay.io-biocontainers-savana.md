...
updated_at: "2025-03-05 03:23:03.590197"
...
```bash
$ shpc install quay.io/biocontainers/savana:1.3.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/savana/1.3.1--pyhdfd78af_0
$ module help quay.io/biocontainers/savana/1.3.1--pyhdfd78af_0
```
