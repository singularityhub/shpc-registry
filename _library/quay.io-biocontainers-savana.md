...
updated_at: "2023-08-24 02:55:35.310473"
...
```bash
$ shpc install quay.io/biocontainers/savana:1.0.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/savana/1.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/savana/1.0.0--pyhdfd78af_0
```
