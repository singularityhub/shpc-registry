...
updated_at: "2024-08-09 02:53:33.405962"
...
```bash
$ shpc install quay.io/biocontainers/savana:1.2.0--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/savana/1.2.0--pyhdfd78af_1
$ module help quay.io/biocontainers/savana/1.2.0--pyhdfd78af_1
```
