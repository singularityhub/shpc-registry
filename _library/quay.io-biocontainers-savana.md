...
updated_at: "2024-12-24 02:59:19.369124"
...
```bash
$ shpc install quay.io/biocontainers/savana:1.2.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/savana/1.2.5--pyhdfd78af_0
$ module help quay.io/biocontainers/savana/1.2.5--pyhdfd78af_0
```
