...
updated_at: "2023-09-29 02:49:19.896673"
...
```bash
$ shpc install quay.io/biocontainers/savana:1.0.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/savana/1.0.3--pyhdfd78af_0
$ module help quay.io/biocontainers/savana/1.0.3--pyhdfd78af_0
```
