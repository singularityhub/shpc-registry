...
updated_at: "2026-04-05 05:14:59.021828"
...
```bash
$ shpc install quay.io/biocontainers/savana:1.3.7--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/savana/1.3.7--pyhdfd78af_0
$ module help quay.io/biocontainers/savana/1.3.7--pyhdfd78af_0
```
