...
updated_at: "2025-05-06 03:57:35.004307"
...
```bash
$ shpc install quay.io/biocontainers/savana:1.3.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/savana/1.3.4--pyhdfd78af_0
$ module help quay.io/biocontainers/savana/1.3.4--pyhdfd78af_0
```
