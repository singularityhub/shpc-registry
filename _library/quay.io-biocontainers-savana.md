...
updated_at: "2025-04-10 03:50:04.283821"
...
```bash
$ shpc install quay.io/biocontainers/savana:1.3.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/savana/1.3.3--pyhdfd78af_0
$ module help quay.io/biocontainers/savana/1.3.3--pyhdfd78af_0
```
