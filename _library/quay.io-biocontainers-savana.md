...
updated_at: "2024-11-06 03:33:59.014655"
...
```bash
$ shpc install quay.io/biocontainers/savana:1.2.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/savana/1.2.3--pyhdfd78af_0
$ module help quay.io/biocontainers/savana/1.2.3--pyhdfd78af_0
```
