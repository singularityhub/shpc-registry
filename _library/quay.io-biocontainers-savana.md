...
updated_at: "2026-07-02 06:41:28.569667"
...
```bash
$ shpc install quay.io/biocontainers/savana:1.3.8--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/savana/1.3.8--pyhdfd78af_0
$ module help quay.io/biocontainers/savana/1.3.8--pyhdfd78af_0
```
