...
updated_at: "2024-03-16 02:43:54.836630"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-org.ecsakai.eg.db:3.18.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-org.ecsakai.eg.db/3.18.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-org.ecsakai.eg.db/3.18.0--r43hdfd78af_0
```
