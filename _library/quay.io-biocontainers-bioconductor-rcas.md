...
updated_at: "2023-04-08 02:54:33.451565"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rcas:1.24.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rcas/1.24.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rcas/1.24.0--r42hdfd78af_0
```
