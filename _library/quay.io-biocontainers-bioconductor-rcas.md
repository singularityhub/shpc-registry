...
updated_at: "2025-01-03 03:37:04.668011"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rcas:1.28.2--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rcas/1.28.2--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rcas/1.28.2--r43hdfd78af_0
```
