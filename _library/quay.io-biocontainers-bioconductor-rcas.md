...
updated_at: "2022-11-19 02:01:08.879649"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rcas:1.20.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rcas/1.20.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rcas/1.20.0--r41hdfd78af_0
```
