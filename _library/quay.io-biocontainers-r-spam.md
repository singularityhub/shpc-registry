---
layout: container
name:  "quay.io/biocontainers/r-spam"
maintainer: "@vsoch"
...
updated_at: "2022-10-29 05:41:38.359049"
...
```bash
$ shpc install quay.io/biocontainers/r-spam
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/r-spam:1.4_0--r3.3.2_0
```
...
```bash
$ module load quay.io/biocontainers/r-spam/1.4_0--r3.3.2_0
$ module help quay.io/biocontainers/r-spam/1.4_0--r3.3.2_0
```
...
#### r-spam-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-spam-inspect-deffile:
