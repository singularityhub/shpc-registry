...
updated_at: "2024-08-23 02:49:53.933310"
latest: "1.2.0--h56e2c18_1"
...
```bash
$ shpc install quay.io/biocontainers/slow5tools:1.2.0--h56e2c18_1
```
...
```bash
$ module load quay.io/biocontainers/slow5tools/1.2.0--h56e2c18_1
$ module help quay.io/biocontainers/slow5tools/1.2.0--h56e2c18_1
```
