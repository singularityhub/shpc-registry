...
updated_at: "2026-03-15 05:30:46.065991"
latest: "1.4.0--hee927d3_0"
...
```bash
$ shpc install quay.io/biocontainers/slow5tools:1.4.0--hee927d3_0
```
...
```bash
$ module load quay.io/biocontainers/slow5tools/1.4.0--hee927d3_0
$ module help quay.io/biocontainers/slow5tools/1.4.0--hee927d3_0
```
