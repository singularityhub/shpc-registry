...
updated_at: "2024-10-31 03:10:58.504144"
...
```bash
$ shpc install quay.io/biocontainers/slow5tools:1.3.0--h56e2c18_0
```
...
```bash
$ module load quay.io/biocontainers/slow5tools/1.3.0--h56e2c18_0
$ module help quay.io/biocontainers/slow5tools/1.3.0--h56e2c18_0
```
