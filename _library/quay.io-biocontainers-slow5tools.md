...
updated_at: "2026-09-26 07:40:38.299895"
latest: "1.5.0--hc820af4_0"
...
```bash
$ shpc install quay.io/biocontainers/slow5tools:1.5.0--hc820af4_0
```
...
```bash
$ module load quay.io/biocontainers/slow5tools/1.5.0--hc820af4_0
$ module help quay.io/biocontainers/slow5tools/1.5.0--hc820af4_0
```
