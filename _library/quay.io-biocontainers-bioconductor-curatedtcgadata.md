...
updated_at: "2025-04-10 03:34:00.025490"
latest: "1.28.1--r44hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-curatedtcgadata:1.28.1--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-curatedtcgadata/1.28.1--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-curatedtcgadata/1.28.1--r44hdfd78af_0
```
