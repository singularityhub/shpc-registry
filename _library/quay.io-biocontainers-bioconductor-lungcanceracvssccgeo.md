...
updated_at: "2026-02-18 04:43:49.798573"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-lungcanceracvssccgeo:1.46.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-lungcanceracvssccgeo/1.46.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-lungcanceracvssccgeo/1.46.0--r45hdfd78af_0
```
