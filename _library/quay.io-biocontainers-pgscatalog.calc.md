...
updated_at: "2026-02-06 04:59:08.644351"
...
```bash
$ shpc install quay.io/biocontainers/pgscatalog.calc:0.3.1--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/pgscatalog.calc/0.3.1--pyhdfd78af_1
$ module help quay.io/biocontainers/pgscatalog.calc/0.3.1--pyhdfd78af_1
```
