...
updated_at: "2025-12-17 16:12:20.374524"
...
```bash
$ shpc install quay.io/biocontainers/pgscatalog.calc:0.3.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pgscatalog.calc/0.3.1--pyhdfd78af_0
$ module help quay.io/biocontainers/pgscatalog.calc/0.3.1--pyhdfd78af_0
```
