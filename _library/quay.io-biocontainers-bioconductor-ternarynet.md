...
updated_at: "2026-04-05 05:04:29.771195"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ternarynet:1.54.0--r45ha27e39d_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ternarynet/1.54.0--r45ha27e39d_0
$ module help quay.io/biocontainers/bioconductor-ternarynet/1.54.0--r45ha27e39d_0
```
