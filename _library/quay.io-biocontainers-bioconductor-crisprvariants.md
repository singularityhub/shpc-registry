...
updated_at: "2022-11-16 00:02:21.039206"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-crisprvariants:1.22.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-crisprvariants/1.22.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-crisprvariants/1.22.0--r41hdfd78af_0
```
