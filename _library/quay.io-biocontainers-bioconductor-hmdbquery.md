...
updated_at: "2026-04-05 05:21:36.460448"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hmdbquery:1.30.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hmdbquery/1.30.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-hmdbquery/1.30.0--r45hdfd78af_0
```
