...
updated_at: "2026-01-12 03:58:10.431321"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-beer:1.10.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-beer/1.10.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-beer/1.10.0--r44hdfd78af_0
```
