...
updated_at: "2024-07-11 03:12:11.419241"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gse159526:1.8.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gse159526/1.8.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-gse159526/1.8.0--r43hdfd78af_0
```
