...
updated_at: "2024-10-21 03:31:17.135963"
...
```bash
$ shpc install quay.io/biocontainers/pgscatalog.match:0.3.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pgscatalog.match/0.3.2--pyhdfd78af_0
$ module help quay.io/biocontainers/pgscatalog.match/0.3.2--pyhdfd78af_0
```
