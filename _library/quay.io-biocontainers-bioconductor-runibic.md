...
updated_at: "2026-03-22 04:34:08.403547"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-runibic:1.32.0--r45ha27e39d_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-runibic/1.32.0--r45ha27e39d_0
$ module help quay.io/biocontainers/bioconductor-runibic/1.32.0--r45ha27e39d_0
```
