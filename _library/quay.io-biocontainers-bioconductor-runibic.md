...
updated_at: "2023-11-04 02:36:17.065497"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-runibic:1.22.0--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-runibic/1.22.0--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-runibic/1.22.0--r43hf17093f_0
```
