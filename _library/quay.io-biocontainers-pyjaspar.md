...
updated_at: "2023-02-05 03:50:42.479732"
...
```bash
$ shpc install quay.io/biocontainers/pyjaspar:2.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pyjaspar/2.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/pyjaspar/2.1.0--pyhdfd78af_0
```
