...
updated_at: "2023-08-29 03:49:00.552644"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-flowcore:2.10.0--r42hf17093f_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-flowcore/2.10.0--r42hf17093f_1
$ module help quay.io/biocontainers/bioconductor-flowcore/2.10.0--r42hf17093f_1
```
