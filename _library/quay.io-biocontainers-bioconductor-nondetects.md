...
updated_at: "2026-07-01 07:29:35.583076"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-nondetects:2.40.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-nondetects/2.40.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-nondetects/2.40.0--r45hdfd78af_0
```
