...
updated_at: "2023-05-24 03:13:05.578171"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-nondetects:2.28.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-nondetects/2.28.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-nondetects/2.28.0--r42hdfd78af_0
```
