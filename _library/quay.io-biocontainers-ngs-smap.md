...
updated_at: "2026-07-01 15:15:45.273350"
...
```bash
$ shpc install quay.io/biocontainers/ngs-smap:5.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ngs-smap/5.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/ngs-smap/5.1.0--pyhdfd78af_0
```
