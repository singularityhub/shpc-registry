...
updated_at: "2022-11-13 00:22:20.322412"
latest: "1.18.0--r41hc247a5b_2"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cydar:1.18.0--r41hc247a5b_2
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cydar/1.18.0--r41hc247a5b_2
$ module help quay.io/biocontainers/bioconductor-cydar/1.18.0--r41hc247a5b_2
```
