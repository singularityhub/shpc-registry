...
updated_at: "2023-06-15 03:45:07.544514"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cydar:1.22.0--r42hf17093f_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cydar/1.22.0--r42hf17093f_1
$ module help quay.io/biocontainers/bioconductor-cydar/1.22.0--r42hf17093f_1
```
