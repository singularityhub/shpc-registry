...
updated_at: "2022-11-05 00:36:28.187433"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cydar:1.8.0--r36he1b5a44_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cydar/1.8.0--r36he1b5a44_1
$ module help quay.io/biocontainers/bioconductor-cydar/1.8.0--r36he1b5a44_1
```
