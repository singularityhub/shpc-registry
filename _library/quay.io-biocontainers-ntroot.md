---
layout: container
name:  "quay.io/biocontainers/ntroot"
maintainer: "@vsoch"
...
updated_at: "2024-11-07 03:23:48.354923"
latest: "1.1.5--py313pl5321hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/ntroot
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/ntroot:1.1.5--py313pl5321hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ntroot/1.1.5--py313pl5321hdfd78af_0
$ module help quay.io/biocontainers/ntroot/1.1.5--py313pl5321hdfd78af_0
```
...
#### ntroot-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### ntroot-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/make_genome_bf
$ podman run --it --rm --entrypoint /usr/local/bin/make_genome_bf   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/make_genome_bf   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/ntRootAncestryPredictor.pl
$ podman run --it --rm --entrypoint /usr/local/bin/ntRootAncestryPredictor.pl   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/ntRootAncestryPredictor.pl   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/ntedit_run_pipeline.smk
$ podman run --it --rm --entrypoint /usr/local/bin/ntedit_run_pipeline.smk   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/ntedit_run_pipeline.smk   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/nthits-bfq
$ podman run --it --rm --entrypoint /usr/local/bin/nthits-bfq   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/nthits-bfq   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/ntroot
$ podman run --it --rm --entrypoint /usr/local/bin/ntroot   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/ntroot   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/ntroot_run_pipeline.smk
$ podman run --it --rm --entrypoint /usr/local/bin/ntroot_run_pipeline.smk   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/ntroot_run_pipeline.smk   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/run-ntedit
$ podman run --it --rm --entrypoint /usr/local/bin/run-ntedit   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/run-ntedit   -v ${PWD} -w ${PWD} <container> -c " $@"
```
