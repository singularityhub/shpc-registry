...
updated_at: "2024-12-26 03:14:33.892286"
...
```bash
$ shpc install quay.io/biocontainers/ntroot:1.1.6--py313pl5321hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ntroot/1.1.6--py313pl5321hdfd78af_0
$ module help quay.io/biocontainers/ntroot/1.1.6--py313pl5321hdfd78af_0
```
