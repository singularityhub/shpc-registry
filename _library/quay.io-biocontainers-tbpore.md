...
updated_at: "2024-05-09 02:46:09.868071"
...
```bash
$ shpc install quay.io/biocontainers/tbpore:0.7.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/tbpore/0.7.0--pyhdfd78af_0
$ module help quay.io/biocontainers/tbpore/0.7.0--pyhdfd78af_0
```
