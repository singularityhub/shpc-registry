...
updated_at: "2026-08-16 04:06:09.148988"
latest: "1.4.1--h7f5d12c_0"
...
```bash
$ shpc install quay.io/biocontainers/dfast:1.4.1--h7f5d12c_0
```
...
```bash
$ module load quay.io/biocontainers/dfast/1.4.1--h7f5d12c_0
$ module help quay.io/biocontainers/dfast/1.4.1--h7f5d12c_0
```
