...
updated_at: "2025-02-26 02:55:40.648281"
latest: "1.3.5--h5ca1c30_0"
...
```bash
$ shpc install quay.io/biocontainers/dfast:1.3.5--h5ca1c30_0
```
...
```bash
$ module load quay.io/biocontainers/dfast/1.3.5--h5ca1c30_0
$ module help quay.io/biocontainers/dfast/1.3.5--h5ca1c30_0
```
