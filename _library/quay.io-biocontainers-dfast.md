...
updated_at: "2026-08-30 08:53:43.735805"
...
```bash
$ shpc install quay.io/biocontainers/dfast:1.4.2--h7f5d12c_0
```
...
```bash
$ module load quay.io/biocontainers/dfast/1.4.2--h7f5d12c_0
$ module help quay.io/biocontainers/dfast/1.4.2--h7f5d12c_0
```
