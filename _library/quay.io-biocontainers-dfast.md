...
updated_at: "2022-11-05 00:42:23.196876"
latest: "1.2.7--h8b12597_0"
...
config: {"url": "https://biocontainers.pro/tools/dfast", "maintainer": "@vsoch", "description": "shpc-registry automated BioContainers addition for dfast", "latest": {"1.2.7--h8b12597_0": "sha256:0359598d2542ec3b6fc6718e3524190d7ddfcec81e6a72097e29ebb4a2540bc7"}, "tags": {"1.2.7--h8b12597_0": "sha256:0359598d2542ec3b6fc6718e3524190d7ddfcec81e6a72097e29ebb4a2540bc7"}, "docker": "quay.io/biocontainers/dfast", "aliases": {".dfast-pre-unlink.sh": "/usr/local/bin/.dfast-pre-unlink.sh", "dfast": "/usr/local/bin/dfast", "dfast_file_downloader.py": "/usr/local/bin/dfast_file_downloader.py", "file_downloader.py": "/usr/local/bin/file_downloader.py", "ghostx": "/usr/local/bin/ghostx", "mga": "/usr/local/bin/mga", "blast_report": "/usr/local/bin/blast_report", "blastdb_convert": "/usr/local/bin/blastdb_convert", "blastdb_path": "/usr/local/bin/blastdb_path", "aragorn": "/usr/local/bin/aragorn", "barrnap": "/usr/local/bin/barrnap", "certtool": "/usr/local/bin/certtool", "gnutls-cli": "/usr/local/bin/gnutls-cli", "gnutls-cli-debug": "/usr/local/bin/gnutls-cli-debug", "gnutls-serv": "/usr/local/bin/gnutls-serv", "nettle-hash": "/usr/local/bin/nettle-hash"}}
---
...
```bash
$ shpc install quay.io/biocontainers/dfast:1.2.7--h8b12597_0
```
...
```bash
$ module load quay.io/biocontainers/dfast/1.2.7--h8b12597_0
$ module help quay.io/biocontainers/dfast/1.2.7--h8b12597_0
```
...
```bash
$ singularity exec <container> /usr/local/bin/.dfast-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.dfast-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.dfast-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
