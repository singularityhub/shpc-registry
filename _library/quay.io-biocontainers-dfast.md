...
updated_at: "2026-04-22 05:25:23.780373"
latest: "1.3.9--h7f5d12c_0"
...
```bash
$ shpc install quay.io/biocontainers/dfast:1.3.9--h7f5d12c_0
```
...
```bash
$ module load quay.io/biocontainers/dfast/1.3.9--h7f5d12c_0
$ module help quay.io/biocontainers/dfast/1.3.9--h7f5d12c_0
```
