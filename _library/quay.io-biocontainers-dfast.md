...
updated_at: "2023-09-24 02:59:47.464992"
latest: "1.2.20--h43eeafb_0"
...
```bash
$ shpc install quay.io/biocontainers/dfast:1.2.20--h43eeafb_0
```
...
```bash
$ module load quay.io/biocontainers/dfast/1.2.20--h43eeafb_0
$ module help quay.io/biocontainers/dfast/1.2.20--h43eeafb_0
```
