...
updated_at: "2025-04-25 02:53:50.954611"
latest: "1.3.6--h5ca1c30_0"
...
```bash
$ shpc install quay.io/biocontainers/dfast:1.3.6--h5ca1c30_0
```
...
```bash
$ module load quay.io/biocontainers/dfast/1.3.6--h5ca1c30_0
$ module help quay.io/biocontainers/dfast/1.3.6--h5ca1c30_0
```
