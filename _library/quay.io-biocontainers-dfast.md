...
updated_at: "2026-04-03 15:58:13.623575"
latest: "1.3.8--h5ca1c30_0"
...
```bash
$ shpc install quay.io/biocontainers/dfast:1.3.8--h5ca1c30_0
```
...
```bash
$ module load quay.io/biocontainers/dfast/1.3.8--h5ca1c30_0
$ module help quay.io/biocontainers/dfast/1.3.8--h5ca1c30_0
```
