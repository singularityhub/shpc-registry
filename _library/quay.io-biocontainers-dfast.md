...
updated_at: "2026-07-02 06:20:11.739105"
latest: "1.4.0--h7f5d12c_0"
...
```bash
$ shpc install quay.io/biocontainers/dfast:1.4.0--h7f5d12c_0
```
...
```bash
$ module load quay.io/biocontainers/dfast/1.4.0--h7f5d12c_0
$ module help quay.io/biocontainers/dfast/1.4.0--h7f5d12c_0
```
