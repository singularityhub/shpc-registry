---
layout: container
name:  "quay.io/biocontainers/bioconductor-doremitra"
maintainer: "@vsoch"
...
updated_at: "2026-03-30 05:56:36.902738"
...
versions:
 - "1.0.0--r45hdfd78af_0"
description: "singularity registry hpc automated addition for bioconductor-doremitra"
config: {"url": "https://biocontainers.pro/tools/bioconductor-doremitra", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for bioconductor-doremitra", "latest": {"1.0.0--r45hdfd78af_0": "sha256:979973f16ae5ebe4cb8ae449714cff20206d34c662f2ee36b37f5e87cc19e408"}, "tags": {"1.0.0--r45hdfd78af_0": "sha256:979973f16ae5ebe4cb8ae449714cff20206d34c662f2ee36b37f5e87cc19e408"}, "docker": "quay.io/biocontainers/bioconductor-doremitra", "aliases": {"idle3.14": "/usr/local/bin/idle3.14", "pydoc3.14": "/usr/local/bin/pydoc3.14", "python3.14": "/usr/local/bin/python3.14", "python3.14-config": "/usr/local/bin/python3.14-config", "x86_64-conda-linux-gnu.cfg": "/usr/local/bin/x86_64-conda-linux-gnu.cfg", "installBiocDataPackage.sh": "/usr/local/bin/installBiocDataPackage.sh", "tomlq": "/usr/local/bin/tomlq", "xq": "/usr/local/bin/xq", "yq": "/usr/local/bin/yq", "jq": "/usr/local/bin/jq", "onig-config": "/usr/local/bin/onig-config", "activate-global-python-argcomplete": "/usr/local/bin/activate-global-python-argcomplete", "python-argcomplete-check-easy-install-script": "/usr/local/bin/python-argcomplete-check-easy-install-script", "register-python-argcomplete": "/usr/local/bin/register-python-argcomplete", "hb-info": "/usr/local/bin/hb-info", "tjbench": "/usr/local/bin/tjbench"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/bioconductor-doremitra.
singularity registry hpc automated addition for bioconductor-doremitra
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/bioconductor-doremitra
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-doremitra:1.0.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-doremitra/1.0.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-doremitra/1.0.0--r45hdfd78af_0
```
...
#### bioconductor-doremitra-inspect:
...
#### bioconductor-doremitra-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-doremitra-inspect-deffile:
