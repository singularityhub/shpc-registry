...
updated_at: "2025-02-15 03:30:50.763063"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-crisprscore:1.10.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-crisprscore/1.10.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-crisprscore/1.10.0--r44hdfd78af_0
```
