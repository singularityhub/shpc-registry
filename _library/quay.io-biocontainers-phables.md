...
updated_at: "2024-07-11 03:09:25.497917"
...
```bash
$ shpc install quay.io/biocontainers/phables:1.4.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/phables/1.4.0--pyhdfd78af_0
$ module help quay.io/biocontainers/phables/1.4.0--pyhdfd78af_0
```
