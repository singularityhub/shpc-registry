...
updated_at: "2024-10-03 03:08:01.744180"
latest: "1.4.1--py310h9ee0642_0"
...
```bash
$ shpc install quay.io/biocontainers/phables:1.4.1--py310h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/phables/1.4.1--py310h9ee0642_0
$ module help quay.io/biocontainers/phables/1.4.1--py310h9ee0642_0
```
