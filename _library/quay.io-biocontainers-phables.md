...
updated_at: "2023-11-08 03:18:11.128990"
...
```bash
$ shpc install quay.io/biocontainers/phables:1.2.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/phables/1.2.1--pyhdfd78af_0
$ module help quay.io/biocontainers/phables/1.2.1--pyhdfd78af_0
```
