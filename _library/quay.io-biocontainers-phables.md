...
updated_at: "2025-12-22 03:51:49.198817"
latest: "1.4.1--pyhdfd78af_2"
...
```bash
$ shpc install quay.io/biocontainers/phables:1.4.1--pyhdfd78af_2
```
...
```bash
$ module load quay.io/biocontainers/phables/1.4.1--pyhdfd78af_2
$ module help quay.io/biocontainers/phables/1.4.1--pyhdfd78af_2
```
