...
updated_at: "2023-11-02 02:43:41.440227"
...
```bash
$ shpc install quay.io/biocontainers/phables:1.2.0--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/phables/1.2.0--pyh7cba7a3_0
$ module help quay.io/biocontainers/phables/1.2.0--pyh7cba7a3_0
```
