...
updated_at: "2026-01-21 03:53:07.761994"
...
```bash
$ shpc install quay.io/biocontainers/phables:1.5.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/phables/1.5.0--pyhdfd78af_0
$ module help quay.io/biocontainers/phables/1.5.0--pyhdfd78af_0
```
