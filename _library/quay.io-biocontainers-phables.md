...
updated_at: "2023-02-28 02:52:56.481220"
...
```bash
$ shpc install quay.io/biocontainers/phables:0.1.1--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/phables/0.1.1--pyh7cba7a3_0
$ module help quay.io/biocontainers/phables/0.1.1--pyh7cba7a3_0
```
