...
updated_at: "2026-06-06 16:10:01.186537"
...
```bash
$ shpc install quay.io/biocontainers/atol-genome-launcher:0.13.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/atol-genome-launcher/0.13.3--pyhdfd78af_0
$ module help quay.io/biocontainers/atol-genome-launcher/0.13.3--pyhdfd78af_0
```
