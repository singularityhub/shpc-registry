...
updated_at: "2026-07-01 07:03:21.290861"
...
```bash
$ shpc install quay.io/biocontainers/atol-genome-launcher:0.14.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/atol-genome-launcher/0.14.0--pyhdfd78af_0
$ module help quay.io/biocontainers/atol-genome-launcher/0.14.0--pyhdfd78af_0
```
