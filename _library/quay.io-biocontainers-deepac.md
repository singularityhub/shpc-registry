...
updated_at: "2022-11-28 03:49:28.346221"
...
```bash
$ shpc install quay.io/biocontainers/deepac:0.14.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/deepac/0.14.0--pyhdfd78af_0
$ module help quay.io/biocontainers/deepac/0.14.0--pyhdfd78af_0
```
