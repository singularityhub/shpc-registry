...
updated_at: "2026-03-25 05:08:37.863054"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hgu95ecdf:2.18.0--r45hdfd78af_14
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hgu95ecdf/2.18.0--r45hdfd78af_14
$ module help quay.io/biocontainers/bioconductor-hgu95ecdf/2.18.0--r45hdfd78af_14
```
