...
updated_at: "2025-07-31 11:18:12.528651"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-tcgabiolinks:2.34.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-tcgabiolinks/2.34.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-tcgabiolinks/2.34.0--r44hdfd78af_0
```
