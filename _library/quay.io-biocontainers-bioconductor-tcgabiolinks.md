...
updated_at: "2026-04-01 04:59:15.366488"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-tcgabiolinks:2.38.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-tcgabiolinks/2.38.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-tcgabiolinks/2.38.0--r45hdfd78af_0
```
