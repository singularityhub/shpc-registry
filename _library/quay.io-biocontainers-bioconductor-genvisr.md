...
updated_at: "2026-03-30 05:00:06.927626"
latest: "1.42.2--r45hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-genvisr:1.42.2--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-genvisr/1.42.2--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-genvisr/1.42.2--r45hdfd78af_0
```
