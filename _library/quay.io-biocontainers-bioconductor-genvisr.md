...
updated_at: "2024-09-23 03:14:19.929325"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-genvisr:1.34.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-genvisr/1.34.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-genvisr/1.34.0--r43hdfd78af_0
```
