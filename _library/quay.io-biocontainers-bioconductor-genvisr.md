...
updated_at: "2025-11-04 03:46:11.480569"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-genvisr:1.38.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-genvisr/1.38.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-genvisr/1.38.0--r44hdfd78af_0
```
