...
updated_at: "2024-12-31 02:59:08.170820"
...
```bash
$ shpc install quay.io/biocontainers/thapbi-pict:1.0.19--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/thapbi-pict/1.0.19--pyhdfd78af_0
$ module help quay.io/biocontainers/thapbi-pict/1.0.19--pyhdfd78af_0
```
