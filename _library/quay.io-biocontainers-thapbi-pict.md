...
updated_at: "2024-11-13 03:10:15.190539"
latest: "1.0.16--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/thapbi-pict:1.0.16--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/thapbi-pict/1.0.16--pyhdfd78af_0
$ module help quay.io/biocontainers/thapbi-pict/1.0.16--pyhdfd78af_0
```
