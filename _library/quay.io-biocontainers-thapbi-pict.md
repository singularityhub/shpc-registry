...
updated_at: "2025-02-10 03:21:41.892516"
latest: "1.0.20--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/thapbi-pict:1.0.20--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/thapbi-pict/1.0.20--pyhdfd78af_0
$ module help quay.io/biocontainers/thapbi-pict/1.0.20--pyhdfd78af_0
```
