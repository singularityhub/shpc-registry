...
updated_at: "2026-06-25 06:26:19.830755"
latest: "1.0.24--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/thapbi-pict:1.0.24--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/thapbi-pict/1.0.24--pyhdfd78af_0
$ module help quay.io/biocontainers/thapbi-pict/1.0.24--pyhdfd78af_0
```
