...
updated_at: "2024-12-15 04:15:43.760776"
...
```bash
$ shpc install quay.io/biocontainers/thapbi-pict:1.0.17--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/thapbi-pict/1.0.17--pyhdfd78af_0
$ module help quay.io/biocontainers/thapbi-pict/1.0.17--pyhdfd78af_0
```
