...
updated_at: "2026-03-23 05:00:34.958773"
...
```bash
$ shpc install quay.io/biocontainers/thapbi-pict:1.0.22--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/thapbi-pict/1.0.22--pyhdfd78af_0
$ module help quay.io/biocontainers/thapbi-pict/1.0.22--pyhdfd78af_0
```
