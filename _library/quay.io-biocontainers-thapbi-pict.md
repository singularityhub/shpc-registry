...
updated_at: "2026-01-26 04:46:53.849859"
...
```bash
$ shpc install quay.io/biocontainers/thapbi-pict:1.0.21--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/thapbi-pict/1.0.21--pyhdfd78af_0
$ module help quay.io/biocontainers/thapbi-pict/1.0.21--pyhdfd78af_0
```
