...
updated_at: "2026-05-26 22:12:50.468590"
latest: "1.0.1--pyh106432d_0"
...
```bash
$ shpc install quay.io/biocontainers/netsyn:1.0.1--pyh106432d_0
```
...
```bash
$ module load quay.io/biocontainers/netsyn/1.0.1--pyh106432d_0
$ module help quay.io/biocontainers/netsyn/1.0.1--pyh106432d_0
```
