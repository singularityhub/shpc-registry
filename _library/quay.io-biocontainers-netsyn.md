...
updated_at: "2026-08-27 12:56:51.513217"
...
```bash
$ shpc install quay.io/biocontainers/netsyn:1.0.3--pyh106432d_0
```
...
```bash
$ module load quay.io/biocontainers/netsyn/1.0.3--pyh106432d_0
$ module help quay.io/biocontainers/netsyn/1.0.3--pyh106432d_0
```
