...
updated_at: "2025-04-10 03:34:18.550492"
latest: "3.1.0--hbbc3ce4_0"
...
```bash
$ shpc install quay.io/biocontainers/jbrowse2:3.1.0--hbbc3ce4_0
```
...
```bash
$ module load quay.io/biocontainers/jbrowse2/3.1.0--hbbc3ce4_0
$ module help quay.io/biocontainers/jbrowse2/3.1.0--hbbc3ce4_0
```
