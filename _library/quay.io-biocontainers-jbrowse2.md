...
updated_at: "2025-02-17 03:26:59.957493"
latest: "2.18.0--hbbc3ce4_1"
...
```bash
$ shpc install quay.io/biocontainers/jbrowse2:2.18.0--hbbc3ce4_1
```
...
```bash
$ module load quay.io/biocontainers/jbrowse2/2.18.0--hbbc3ce4_1
$ module help quay.io/biocontainers/jbrowse2/2.18.0--hbbc3ce4_1
```
