...
updated_at: "2025-06-29 04:17:39.659101"
latest: "3.5.1--hbbc3ce4_0"
...
```bash
$ shpc install quay.io/biocontainers/jbrowse2:3.5.1--hbbc3ce4_0
```
...
```bash
$ module load quay.io/biocontainers/jbrowse2/3.5.1--hbbc3ce4_0
$ module help quay.io/biocontainers/jbrowse2/3.5.1--hbbc3ce4_0
```
