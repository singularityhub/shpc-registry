...
updated_at: "2024-03-29 02:36:16.073665"
latest: "2.10.3--hd6180af_0"
...
```bash
$ shpc install quay.io/biocontainers/jbrowse2:2.10.3--hd6180af_0
```
...
```bash
$ module load quay.io/biocontainers/jbrowse2/2.10.3--hd6180af_0
$ module help quay.io/biocontainers/jbrowse2/2.10.3--hd6180af_0
```
