...
updated_at: "2025-05-21 04:05:58.903334"
latest: "3.4.0--hbbc3ce4_0"
...
```bash
$ shpc install quay.io/biocontainers/jbrowse2:3.4.0--hbbc3ce4_0
```
...
```bash
$ module load quay.io/biocontainers/jbrowse2/3.4.0--hbbc3ce4_0
$ module help quay.io/biocontainers/jbrowse2/3.4.0--hbbc3ce4_0
```
