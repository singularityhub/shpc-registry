...
updated_at: "2024-07-24 03:08:10.643180"
latest: "2.12.3--hbbc3ce4_0"
...
```bash
$ shpc install quay.io/biocontainers/jbrowse2:2.12.3--hbbc3ce4_0
```
...
```bash
$ module load quay.io/biocontainers/jbrowse2/2.12.3--hbbc3ce4_0
$ module help quay.io/biocontainers/jbrowse2/2.12.3--hbbc3ce4_0
```
