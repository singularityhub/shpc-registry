...
updated_at: "2025-08-15 03:29:03.020892"
latest: "3.6.3--hbbc3ce4_0"
...
```bash
$ shpc install quay.io/biocontainers/jbrowse2:3.6.3--hbbc3ce4_0
```
...
```bash
$ module load quay.io/biocontainers/jbrowse2/3.6.3--hbbc3ce4_0
$ module help quay.io/biocontainers/jbrowse2/3.6.3--hbbc3ce4_0
```
