...
updated_at: "2026-02-06 04:41:31.441339"
...
```bash
$ shpc install quay.io/biocontainers/ezcharts:0.15.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ezcharts/0.15.2--pyhdfd78af_0
$ module help quay.io/biocontainers/ezcharts/0.15.2--pyhdfd78af_0
```
