...
updated_at: "2026-06-16 07:49:38.529466"
...
```bash
$ shpc install quay.io/biocontainers/ezcharts:0.16.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ezcharts/0.16.1--pyhdfd78af_0
$ module help quay.io/biocontainers/ezcharts/0.16.1--pyhdfd78af_0
```
