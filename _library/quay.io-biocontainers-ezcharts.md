...
updated_at: "2026-09-01 08:05:12.943841"
latest: "0.16.2--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/ezcharts:0.16.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ezcharts/0.16.2--pyhdfd78af_0
$ module help quay.io/biocontainers/ezcharts/0.16.2--pyhdfd78af_0
```
