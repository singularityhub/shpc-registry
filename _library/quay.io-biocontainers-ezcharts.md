...
updated_at: "2025-05-26 12:12:07.808445"
...
```bash
$ shpc install quay.io/biocontainers/ezcharts:0.14.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ezcharts/0.14.0--pyhdfd78af_0
$ module help quay.io/biocontainers/ezcharts/0.14.0--pyhdfd78af_0
```
