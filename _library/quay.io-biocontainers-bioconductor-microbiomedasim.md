...
updated_at: "2023-11-06 03:30:20.304328"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-microbiomedasim:1.14.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-microbiomedasim/1.14.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-microbiomedasim/1.14.0--r43hdfd78af_0
```
