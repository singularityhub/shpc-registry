...
updated_at: "2023-02-28 03:33:34.753677"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mslp:1.0.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mslp/1.0.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-mslp/1.0.0--r42hdfd78af_0
```
