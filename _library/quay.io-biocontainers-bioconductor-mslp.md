...
updated_at: "2023-12-16 02:53:49.693521"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mslp:1.2.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mslp/1.2.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-mslp/1.2.0--r43hdfd78af_0
```
