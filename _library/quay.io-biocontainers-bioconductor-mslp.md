---
layout: container
name:  "quay.io/biocontainers/bioconductor-mslp"
maintainer: "@vsoch"
...
updated_at: "2026-03-13 16:26:11.959663"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mslp
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-mslp:1.12.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mslp/1.12.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-mslp/1.12.0--r45hdfd78af_0
```
...
#### bioconductor-mslp-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-mslp-inspect-deffile:
