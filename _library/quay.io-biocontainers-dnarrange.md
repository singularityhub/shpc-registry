...
updated_at: "2023-12-26 02:56:13.426267"
...
```bash
$ shpc install quay.io/biocontainers/dnarrange:1.6.1--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/dnarrange/1.6.1--pyh7cba7a3_0
$ module help quay.io/biocontainers/dnarrange/1.6.1--pyh7cba7a3_0
```
