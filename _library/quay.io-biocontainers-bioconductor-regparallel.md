...
updated_at: "2022-11-17 03:44:50.201203"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-regparallel:1.15.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-regparallel/1.15.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-regparallel/1.15.0--r42hdfd78af_0
```
