...
updated_at: "2022-10-27 01:15:31.472354"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-regparallel:1.8.0--r40hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-regparallel/1.8.0--r40hdfd78af_1
$ module help quay.io/biocontainers/bioconductor-regparallel/1.8.0--r40hdfd78af_1
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-regparallel-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-regparallel-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-regparallel-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-regparallel-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-regparallel-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-regparallel-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
