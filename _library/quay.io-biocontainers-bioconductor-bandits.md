...
updated_at: "2023-06-15 03:49:53.802613"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-bandits:1.14.0--r42hf17093f_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-bandits/1.14.0--r42hf17093f_1
$ module help quay.io/biocontainers/bioconductor-bandits/1.14.0--r42hf17093f_1
```
