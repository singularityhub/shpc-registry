...
updated_at: "2023-08-19 02:39:18.884810"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-bandits:1.16.1--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-bandits/1.16.1--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-bandits/1.16.1--r43hf17093f_0
```
