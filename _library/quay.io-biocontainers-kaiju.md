...
updated_at: "2026-09-04 07:45:27.663036"
latest: "1.10.2--h5814d7d_0"
...
```bash
$ shpc install quay.io/biocontainers/kaiju:1.10.2--h5814d7d_0
```
...
```bash
$ module load quay.io/biocontainers/kaiju/1.10.2--h5814d7d_0
$ module help quay.io/biocontainers/kaiju/1.10.2--h5814d7d_0
```
