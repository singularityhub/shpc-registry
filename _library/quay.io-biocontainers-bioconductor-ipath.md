...
updated_at: "2022-10-29 17:39:05.888564"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ipath:1.0.0--r41hc247a5b_2
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ipath/1.0.0--r41hc247a5b_2
$ module help quay.io/biocontainers/bioconductor-ipath/1.0.0--r41hc247a5b_2
```
