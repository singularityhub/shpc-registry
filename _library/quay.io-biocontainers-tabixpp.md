...
updated_at: "2025-09-08 03:29:17.226992"
...
```bash
$ shpc install quay.io/biocontainers/tabixpp:1.1.2--hbefcdb2_4
```
...
```bash
$ module load quay.io/biocontainers/tabixpp/1.1.2--hbefcdb2_4
$ module help quay.io/biocontainers/tabixpp/1.1.2--hbefcdb2_4
```
