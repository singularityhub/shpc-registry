...
updated_at: "2023-09-04 02:56:20.150818"
latest: "1.1.2--hd68fcf3_0"
...
```bash
$ shpc install quay.io/biocontainers/tabixpp:1.1.2--hd68fcf3_0
```
...
```bash
$ module load quay.io/biocontainers/tabixpp/1.1.2--hd68fcf3_0
$ module help quay.io/biocontainers/tabixpp/1.1.2--hd68fcf3_0
```
