...
updated_at: "2024-02-09 02:53:30.099385"
latest: "1.1.2--hd68fcf3_1"
...
```bash
$ shpc install quay.io/biocontainers/tabixpp:1.1.2--hd68fcf3_1
```
...
```bash
$ module load quay.io/biocontainers/tabixpp/1.1.2--hd68fcf3_1
$ module help quay.io/biocontainers/tabixpp/1.1.2--hd68fcf3_1
```
