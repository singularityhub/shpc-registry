...
updated_at: "2024-03-02 02:34:24.385633"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-granulator:1.10.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-granulator/1.10.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-granulator/1.10.0--r43hdfd78af_0
```
