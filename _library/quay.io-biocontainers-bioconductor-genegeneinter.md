...
updated_at: "2022-10-29 18:26:09.805723"
latest: "1.8.0--r351_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-genegeneinter:1.8.0--r351_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-genegeneinter/1.8.0--r351_0
$ module help quay.io/biocontainers/bioconductor-genegeneinter/1.8.0--r351_0
```
