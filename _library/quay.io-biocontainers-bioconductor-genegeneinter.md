...
updated_at: "2023-11-15 02:48:26.222214"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-genegeneinter:1.26.0--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-genegeneinter/1.26.0--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-genegeneinter/1.26.0--r43hf17093f_0
```
