...
updated_at: "2022-10-27 00:59:36.106838"
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-humanstemcell-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-humanstemcell-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-humanstemcell-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-humanstemcell-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-humanstemcell-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-humanstemcell-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
