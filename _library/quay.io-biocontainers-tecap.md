---
layout: container
name:  "quay.io/biocontainers/tecap"
maintainer: "@vsoch"
...
updated_at: "2026-07-01 06:36:43.959574"
...
singularity registry hpc automated addition for tecap
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/tecap
```
...
#### tecap-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### tecap-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/tecap
$ podman run --it --rm --entrypoint /usr/local/bin/tecap   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/tecap   -v ${PWD} -w ${PWD} <container> -c " $@"
```
