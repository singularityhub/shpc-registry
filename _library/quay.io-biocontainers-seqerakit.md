...
updated_at: "2025-07-30 03:54:17.384036"
...
```bash
$ shpc install quay.io/biocontainers/seqerakit:0.5.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/seqerakit/0.5.5--pyhdfd78af_0
$ module help quay.io/biocontainers/seqerakit/0.5.5--pyhdfd78af_0
```
