...
updated_at: "2025-05-25 03:37:08.397678"
...
```bash
$ shpc install quay.io/biocontainers/seqerakit:0.5.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/seqerakit/0.5.4--pyhdfd78af_0
$ module help quay.io/biocontainers/seqerakit/0.5.4--pyhdfd78af_0
```
