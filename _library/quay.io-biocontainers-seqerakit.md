...
updated_at: "2025-10-30 03:16:24.883906"
...
```bash
$ shpc install quay.io/biocontainers/seqerakit:0.5.6--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/seqerakit/0.5.6--pyhdfd78af_0
$ module help quay.io/biocontainers/seqerakit/0.5.6--pyhdfd78af_0
```
