...
updated_at: "2025-05-12 04:04:37.361611"
...
```bash
$ shpc install quay.io/biocontainers/seqerakit:0.5.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/seqerakit/0.5.3--pyhdfd78af_0
$ module help quay.io/biocontainers/seqerakit/0.5.3--pyhdfd78af_0
```
