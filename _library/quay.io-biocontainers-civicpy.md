...
updated_at: "2026-01-22 03:56:36.721207"
...
```bash
$ shpc install quay.io/biocontainers/civicpy:5.1.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/civicpy/5.1.1--pyhdfd78af_0
$ module help quay.io/biocontainers/civicpy/5.1.1--pyhdfd78af_0
```
