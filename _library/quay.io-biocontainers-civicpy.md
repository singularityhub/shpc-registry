...
updated_at: "2026-06-14 07:35:47.946576"
...
```bash
$ shpc install quay.io/biocontainers/civicpy:5.4.0--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/civicpy/5.4.0--pyhdfd78af_1
$ module help quay.io/biocontainers/civicpy/5.4.0--pyhdfd78af_1
```
