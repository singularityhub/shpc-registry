...
updated_at: "2026-04-01 04:53:25.041470"
...
```bash
$ shpc install quay.io/biocontainers/civicpy:5.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/civicpy/5.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/civicpy/5.2.0--pyhdfd78af_0
```
