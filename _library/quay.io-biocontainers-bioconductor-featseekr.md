---
layout: container
name:  "quay.io/biocontainers/bioconductor-featseekr"
maintainer: "@vsoch"
...
updated_at: "2026-03-27 05:06:58.158919"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-featseekr
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-featseekr:1.10.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-featseekr/1.10.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-featseekr/1.10.0--r45hdfd78af_0
```
...
#### bioconductor-featseekr-inspect:
...
#### bioconductor-featseekr-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-featseekr-inspect-deffile:
