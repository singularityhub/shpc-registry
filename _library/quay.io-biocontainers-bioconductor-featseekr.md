...
updated_at: "2023-07-13 03:50:57.679866"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-featseekr:1.0.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-featseekr/1.0.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-featseekr/1.0.0--r43hdfd78af_0
```
