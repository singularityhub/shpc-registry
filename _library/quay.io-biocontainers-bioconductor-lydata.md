...
updated_at: "2024-09-29 03:34:18.585242"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-lydata:1.28.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-lydata/1.28.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-lydata/1.28.0--r43hdfd78af_0
```
