---
layout: container
name:  "quay.io/biocontainers/bioconductor-stpipe"
maintainer: "@vsoch"
github: "https://github.com/singularityhub/shpc-registry/blob/main/quay.io/biocontainers/bioconductor-stpipe/container.yaml"
config_url: "https://raw.githubusercontent.com/singularityhub/shpc-registry/main/quay.io/biocontainers/bioconductor-stpipe/container.yaml"
updated_at: "2026-03-22 04:25:13.483833"
latest: "1.0.1--r45ha27e39d_0"
container_url: "https://biocontainers.pro/tools/bioconductor-stpipe"
aliases:
 - "dot_sandbox"
 - "dec265"
 - "gtk-builder-tool"
...
versions:
 - "1.0.1--r45ha27e39d_0"
description: "singularity registry hpc automated addition for bioconductor-stpipe"
config: {"url": "https://biocontainers.pro/tools/bioconductor-stpipe", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for bioconductor-stpipe", "latest": {"1.0.1--r45ha27e39d_0": "sha256:28b1cdd4d77dd71c2019475764104edafb40b206714846c0bd706693c9a92957"}, "tags": {"1.0.1--r45ha27e39d_0": "sha256:28b1cdd4d77dd71c2019475764104edafb40b206714846c0bd706693c9a92957"}, "docker": "quay.io/biocontainers/bioconductor-stpipe", "aliases": {"dot_sandbox": "/usr/local/bin/dot_sandbox", "dec265": "/usr/local/bin/dec265", "gtk-builder-tool": "/usr/local/bin/gtk-builder-tool", "gtk-encode-symbolic-svg": "/usr/local/bin/gtk-encode-symbolic-svg", "gtk-launch": "/usr/local/bin/gtk-launch", "gtk-query-immodules-3.0": "/usr/local/bin/gtk-query-immodules-3.0", "gtk-query-settings": "/usr/local/bin/gtk-query-settings", "x265": "/usr/local/bin/x265", "wayland-scanner": "/usr/local/bin/wayland-scanner", "SvtAv1EncApp": "/usr/local/bin/SvtAv1EncApp", "dav1d": "/usr/local/bin/dav1d", "gi-compile-repository": "/usr/local/bin/gi-compile-repository", "gi-decompile-typelib": "/usr/local/bin/gi-decompile-typelib", "gi-inspect-typelib": "/usr/local/bin/gi-inspect-typelib", "aomdec": "/usr/local/bin/aomdec", "aomenc": "/usr/local/bin/aomenc", "Magick++-config": "/usr/local/bin/Magick++-config", "MagickCore-config": "/usr/local/bin/MagickCore-config", "MagickWand-config": "/usr/local/bin/MagickWand-config", "animate": "/usr/local/bin/animate", "composite": "/usr/local/bin/composite", "conjure": "/usr/local/bin/conjure", "display": "/usr/local/bin/display", "identify": "/usr/local/bin/identify", "import": "/usr/local/bin/import"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/bioconductor-stpipe.
singularity registry hpc automated addition for bioconductor-stpipe
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/bioconductor-stpipe
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-stpipe:1.0.1--r45ha27e39d_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-stpipe/1.0.1--r45ha27e39d_0
$ module help quay.io/biocontainers/bioconductor-stpipe/1.0.1--r45ha27e39d_0
```
...
#### bioconductor-stpipe-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-stpipe-inspect-deffile:
