...
updated_at: "2026-03-31 04:41:39.705799"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-simbu:1.12.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-simbu/1.12.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-simbu/1.12.0--r45hdfd78af_0
```
