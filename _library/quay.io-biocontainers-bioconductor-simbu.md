...
updated_at: "2026-01-26 04:39:04.620380"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-simbu:1.8.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-simbu/1.8.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-simbu/1.8.0--r44hdfd78af_0
```
