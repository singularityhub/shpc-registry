...
updated_at: "2023-09-15 02:26:19.967262"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-simbu:1.2.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-simbu/1.2.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-simbu/1.2.0--r43hdfd78af_0
```
