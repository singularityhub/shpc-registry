...
updated_at: "2024-02-07 03:03:34.125197"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-simbu:1.4.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-simbu/1.4.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-simbu/1.4.0--r43hdfd78af_0
```
