...
updated_at: "2024-05-12 02:36:05.623723"
latest: "1.0.4"
...
config: {"url": "https://biocontainers.pro/tools/cnv-vcf2json", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for cnv-vcf2json", "latest": {"1.0.4": "sha256:7398abd792c02982d30227a0ac8989f973aff38a38128f4a3359e1453e70006a"}, "tags": {"1.0.4": "sha256:7398abd792c02982d30227a0ac8989f973aff38a38128f4a3359e1453e70006a"}, "docker": "quay.io/biocontainers/cnv-vcf2json", "aliases": {"cnv-vcf2json": "/usr/local/bin/cnv-vcf2json", "2to3-3.12": "/usr/local/bin/2to3-3.12", "idle3.12": "/usr/local/bin/idle3.12", "pydoc3.12": "/usr/local/bin/pydoc3.12", "python3.12": "/usr/local/bin/python3.12", "python3.12-config": "/usr/local/bin/python3.12-config", "jsonschema": "/usr/local/bin/jsonschema"}}
---
...
```bash
$ shpc install quay.io/biocontainers/cnv-vcf2json:1.0.4
```
...
```bash
$ module load quay.io/biocontainers/cnv-vcf2json/1.0.4
$ module help quay.io/biocontainers/cnv-vcf2json/1.0.4
```
