...
updated_at: "2026-08-28 14:08:12.155988"
...
```bash
$ shpc install quay.io/biocontainers/cryptkeeper:1.0.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/cryptkeeper/1.0.3--pyhdfd78af_0
$ module help quay.io/biocontainers/cryptkeeper/1.0.3--pyhdfd78af_0
```
