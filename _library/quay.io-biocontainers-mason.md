...
updated_at: "2024-09-18 03:03:11.243407"
latest: "2.0.9--hdcf5f25_3"
...
```bash
$ shpc install quay.io/biocontainers/mason:2.0.9--hdcf5f25_3
```
...
```bash
$ module load quay.io/biocontainers/mason/2.0.9--hdcf5f25_3
$ module help quay.io/biocontainers/mason/2.0.9--hdcf5f25_3
```
