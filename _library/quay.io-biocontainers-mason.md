...
updated_at: "2025-05-14 03:30:19.996301"
...
```bash
$ shpc install quay.io/biocontainers/mason:2.0.9--h077b44d_4
```
...
```bash
$ module load quay.io/biocontainers/mason/2.0.9--h077b44d_4
$ module help quay.io/biocontainers/mason/2.0.9--h077b44d_4
```
