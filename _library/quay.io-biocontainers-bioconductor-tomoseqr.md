...
updated_at: "2026-03-30 05:00:42.641681"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-tomoseqr:1.14.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-tomoseqr/1.14.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-tomoseqr/1.14.0--r45hdfd78af_0
```
