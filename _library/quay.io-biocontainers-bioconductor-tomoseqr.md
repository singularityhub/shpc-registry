...
updated_at: "2023-12-09 03:38:09.727429"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-tomoseqr:1.4.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-tomoseqr/1.4.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-tomoseqr/1.4.0--r43hdfd78af_0
```
