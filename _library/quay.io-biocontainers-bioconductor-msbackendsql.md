...
updated_at: "2025-10-02 03:19:53.641957"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-msbackendsql:1.6.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-msbackendsql/1.6.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-msbackendsql/1.6.0--r44hdfd78af_0
```
