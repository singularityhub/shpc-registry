...
updated_at: "2025-08-08 04:11:08.572160"
latest: "0.17.1--py39hff726c5_1"
...
```bash
$ shpc install quay.io/biocontainers/tobias:0.17.1--py39hff726c5_1
```
...
```bash
$ module load quay.io/biocontainers/tobias/0.17.1--py39hff726c5_1
$ module help quay.io/biocontainers/tobias/0.17.1--py39hff726c5_1
```
