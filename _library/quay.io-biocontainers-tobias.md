...
updated_at: "2024-08-13 02:49:27.311862"
latest: "0.16.1--py312h1f1cfbb_1"
...
```bash
$ shpc install quay.io/biocontainers/tobias:0.16.1--py312h1f1cfbb_1
```
...
```bash
$ module load quay.io/biocontainers/tobias/0.16.1--py312h1f1cfbb_1
$ module help quay.io/biocontainers/tobias/0.16.1--py312h1f1cfbb_1
```
