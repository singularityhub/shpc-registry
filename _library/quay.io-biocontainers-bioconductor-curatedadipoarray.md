...
updated_at: "2024-03-11 02:27:05.829631"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-curatedadipoarray:1.14.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-curatedadipoarray/1.14.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-curatedadipoarray/1.14.0--r43hdfd78af_0
```
