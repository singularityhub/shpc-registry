...
updated_at: "2022-11-07 00:55:01.992498"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-polyphen.hsapiens.dbsnp131:1.0.2--r41hdfd78af_9
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-polyphen.hsapiens.dbsnp131/1.0.2--r41hdfd78af_9
$ module help quay.io/biocontainers/bioconductor-polyphen.hsapiens.dbsnp131/1.0.2--r41hdfd78af_9
```
