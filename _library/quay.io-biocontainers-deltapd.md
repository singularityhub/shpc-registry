...
updated_at: "2024-10-02 03:14:29.731878"
latest: "0.1.5--py310h1fbdaaf_5"
...
```bash
$ shpc install quay.io/biocontainers/deltapd:0.1.5--py310h1fbdaaf_5
```
...
```bash
$ module load quay.io/biocontainers/deltapd/0.1.5--py310h1fbdaaf_5
$ module help quay.io/biocontainers/deltapd/0.1.5--py310h1fbdaaf_5
```
