---
layout: container
name:  "quay.io/biocontainers/esme_netcdf-c_psmpi_5_10_0"
maintainer: "@vsoch"
...
updated_at: "2025-09-01 04:59:00.483202"
...
versions:
 - "4.9.2--h74334ff_0"
description: "singularity registry hpc automated addition for esme_netcdf-c_psmpi_5_10_0"
config: {"url": "https://biocontainers.pro/tools/esme_netcdf-c_psmpi_5_10_0", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for esme_netcdf-c_psmpi_5_10_0", "latest": {"4.9.2--h74334ff_0": "sha256:ad6fc457eb9ad71a0c0d4f17824ec1cb769dadd212dd0e52e8eba9d8d9dff1d7"}, "tags": {"4.9.2--h74334ff_0": "sha256:ad6fc457eb9ad71a0c0d4f17824ec1cb769dadd212dd0e52e8eba9d8d9dff1d7"}, "docker": "quay.io/biocontainers/esme_netcdf-c_psmpi_5_10_0", "aliases": {"nc4print": "/usr/local/bin/nc4print", "ocprint": "/usr/local/bin/ocprint", "ucx_perftest_daemon": "/usr/local/bin/ucx_perftest_daemon", "mpichversion": "/usr/local/bin/mpichversion", "mpivars": "/usr/local/bin/mpivars", "genl-ctrl-list": "/usr/local/bin/genl-ctrl-list", "idiag-socket-details": "/usr/local/bin/idiag-socket-details", "nf-ct-add": "/usr/local/bin/nf-ct-add", "nf-ct-events": "/usr/local/bin/nf-ct-events", "nf-ct-list": "/usr/local/bin/nf-ct-list", "nf-exp-add": "/usr/local/bin/nf-exp-add", "nf-exp-delete": "/usr/local/bin/nf-exp-delete", "nf-exp-list": "/usr/local/bin/nf-exp-list", "nf-log": "/usr/local/bin/nf-log", "nf-monitor": "/usr/local/bin/nf-monitor", "nf-queue": "/usr/local/bin/nf-queue", "nl-addr-add": "/usr/local/bin/nl-addr-add", "nl-addr-delete": "/usr/local/bin/nl-addr-delete", "nl-addr-list": "/usr/local/bin/nl-addr-list", "nl-class-add": "/usr/local/bin/nl-class-add", "nl-class-delete": "/usr/local/bin/nl-class-delete", "nl-class-list": "/usr/local/bin/nl-class-list", "nl-classid-lookup": "/usr/local/bin/nl-classid-lookup", "nl-cls-add": "/usr/local/bin/nl-cls-add", "nl-cls-delete": "/usr/local/bin/nl-cls-delete"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/esme_netcdf-c_psmpi_5_10_0.
singularity registry hpc automated addition for esme_netcdf-c_psmpi_5_10_0
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/esme_netcdf-c_psmpi_5_10_0
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/esme_netcdf-c_psmpi_5_10_0:4.9.2--h74334ff_0
```
...
```bash
$ module load quay.io/biocontainers/esme_netcdf-c_psmpi_5_10_0/4.9.2--h74334ff_0
$ module help quay.io/biocontainers/esme_netcdf-c_psmpi_5_10_0/4.9.2--h74334ff_0
```
...
#### esme_netcdf-c_psmpi_5_10_0-run:
...
#### esme_netcdf-c_psmpi_5_10_0-shell:
...
#### esme_netcdf-c_psmpi_5_10_0-exec:
...
#### esme_netcdf-c_psmpi_5_10_0-inspect:
...
#### esme_netcdf-c_psmpi_5_10_0-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### esme_netcdf-c_psmpi_5_10_0-inspect-deffile:
