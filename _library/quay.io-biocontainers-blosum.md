...
updated_at: "2023-03-20 03:12:34.174567"
...
```bash
$ shpc install quay.io/biocontainers/blosum:2.0.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/blosum/2.0.1--pyhdfd78af_0
$ module help quay.io/biocontainers/blosum/2.0.1--pyhdfd78af_0
```
