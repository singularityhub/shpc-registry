...
updated_at: "2026-04-03 15:17:15.980192"
latest: "2.0.2--h2a744bc_0"
...
```bash
$ shpc install quay.io/biocontainers/atlas:2.0.2--h2a744bc_0
```
...
```bash
$ module load quay.io/biocontainers/atlas/2.0.2--h2a744bc_0
$ module help quay.io/biocontainers/atlas/2.0.2--h2a744bc_0
```
