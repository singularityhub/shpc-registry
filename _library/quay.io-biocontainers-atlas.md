...
updated_at: "2026-06-03 06:58:21.989872"
latest: "2.0.3--h2a744bc_0"
...
```bash
$ shpc install quay.io/biocontainers/atlas:2.0.3--h2a744bc_0
```
...
```bash
$ module load quay.io/biocontainers/atlas/2.0.3--h2a744bc_0
$ module help quay.io/biocontainers/atlas/2.0.3--h2a744bc_0
```
