...
updated_at: "2026-08-26 03:11:09.142160"
...
```bash
$ shpc install quay.io/biocontainers/atlas:2.0.4--h2a744bc_0
```
...
```bash
$ module load quay.io/biocontainers/atlas/2.0.4--h2a744bc_0
$ module help quay.io/biocontainers/atlas/2.0.4--h2a744bc_0
```
