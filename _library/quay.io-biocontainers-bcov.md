...
updated_at: "2025-10-25 03:32:55.931003"
...
```bash
$ shpc install quay.io/biocontainers/bcov:1.0--h67df5e2_11
```
...
```bash
$ module load quay.io/biocontainers/bcov/1.0--h67df5e2_11
$ module help quay.io/biocontainers/bcov/1.0--h67df5e2_11
```
