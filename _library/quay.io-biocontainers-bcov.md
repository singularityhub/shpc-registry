...
updated_at: "2024-09-25 03:11:58.190046"
latest: "1.0--ha16aae7_9"
...
```bash
$ shpc install quay.io/biocontainers/bcov:1.0--ha16aae7_9
```
...
```bash
$ module load quay.io/biocontainers/bcov/1.0--ha16aae7_9
$ module help quay.io/biocontainers/bcov/1.0--ha16aae7_9
```
