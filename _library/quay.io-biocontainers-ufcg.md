...
updated_at: "2023-11-29 03:05:00.715467"
...
```bash
$ shpc install quay.io/biocontainers/ufcg:1.0.5--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ufcg/1.0.5--hdfd78af_0
$ module help quay.io/biocontainers/ufcg/1.0.5--hdfd78af_0
```
