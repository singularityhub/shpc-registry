...
updated_at: "2025-09-16 03:15:24.510201"
...
```bash
$ shpc install quay.io/biocontainers/artic:1.8.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/artic/1.8.1--pyhdfd78af_0
$ module help quay.io/biocontainers/artic/1.8.1--pyhdfd78af_0
```
