...
updated_at: "2025-03-14 03:23:30.903544"
...
```bash
$ shpc install quay.io/biocontainers/artic:1.6.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/artic/1.6.1--pyhdfd78af_0
$ module help quay.io/biocontainers/artic/1.6.1--pyhdfd78af_0
```
