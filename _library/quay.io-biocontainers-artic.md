...
updated_at: "2025-04-23 03:50:28.289947"
...
```bash
$ shpc install quay.io/biocontainers/artic:1.6.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/artic/1.6.2--pyhdfd78af_0
$ module help quay.io/biocontainers/artic/1.6.2--pyhdfd78af_0
```
