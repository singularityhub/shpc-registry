...
updated_at: "2025-10-23 03:38:29.475744"
...
```bash
$ shpc install quay.io/biocontainers/artic:1.8.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/artic/1.8.4--pyhdfd78af_0
$ module help quay.io/biocontainers/artic/1.8.4--pyhdfd78af_0
```
