...
updated_at: "2024-12-22 03:12:23.200874"
...
```bash
$ shpc install quay.io/biocontainers/artic:1.5.7--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/artic/1.5.7--pyhdfd78af_0
$ module help quay.io/biocontainers/artic/1.5.7--pyhdfd78af_0
```
