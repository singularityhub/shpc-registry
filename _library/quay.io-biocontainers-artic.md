...
updated_at: "2025-01-29 03:00:53.831210"
...
```bash
$ shpc install quay.io/biocontainers/artic:1.6.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/artic/1.6.0--pyhdfd78af_0
$ module help quay.io/biocontainers/artic/1.6.0--pyhdfd78af_0
```
