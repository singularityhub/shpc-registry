...
updated_at: "2025-08-09 03:39:48.989473"
...
```bash
$ shpc install quay.io/biocontainers/artic:1.7.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/artic/1.7.5--pyhdfd78af_0
$ module help quay.io/biocontainers/artic/1.7.5--pyhdfd78af_0
```
