...
updated_at: "2025-08-07 04:00:33.141923"
...
```bash
$ shpc install quay.io/biocontainers/artic:1.7.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/artic/1.7.3--pyhdfd78af_0
$ module help quay.io/biocontainers/artic/1.7.3--pyhdfd78af_0
```
