---
layout: container
name:  "quay.io/biocontainers/cytotrace2-python"
maintainer: "@vsoch"
...
updated_at: "2025-10-13 03:57:26.612542"
...
```bash
$ shpc install quay.io/biocontainers/cytotrace2-python
```
...
#### cytotrace2-python-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### cytotrace2-python-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/cytotrace2
$ podman run --it --rm --entrypoint /usr/local/bin/cytotrace2   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/cytotrace2   -v ${PWD} -w ${PWD} <container> -c " $@"
```
