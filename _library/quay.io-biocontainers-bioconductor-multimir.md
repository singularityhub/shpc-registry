...
updated_at: "2025-12-16 03:48:59.920620"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-multimir:1.28.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-multimir/1.28.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-multimir/1.28.0--r44hdfd78af_0
```
