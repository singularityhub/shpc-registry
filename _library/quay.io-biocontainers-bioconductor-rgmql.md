...
updated_at: "2023-11-18 03:01:41.615006"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rgmql:1.20.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rgmql/1.20.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rgmql/1.20.0--r43hdfd78af_0
```
