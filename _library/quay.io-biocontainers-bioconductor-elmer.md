...
updated_at: "2023-08-25 02:59:59.959895"
latest: "2.24.1--r43hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-elmer:2.24.1--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-elmer/2.24.1--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-elmer/2.24.1--r43hdfd78af_0
```
