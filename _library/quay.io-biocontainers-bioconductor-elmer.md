...
updated_at: "2026-03-26 04:52:06.203601"
latest: "2.33.1--r45hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-elmer:2.33.1--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-elmer/2.33.1--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-elmer/2.33.1--r45hdfd78af_0
```
