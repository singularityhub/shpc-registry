...
updated_at: "2026-03-27 04:59:13.266537"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hugene.1.0.st.v1frmavecs:1.1.0--r45hdfd78af_14
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hugene.1.0.st.v1frmavecs/1.1.0--r45hdfd78af_14
$ module help quay.io/biocontainers/bioconductor-hugene.1.0.st.v1frmavecs/1.1.0--r45hdfd78af_14
```
