...
updated_at: "2025-08-24 03:34:58.615161"
...
```bash
$ shpc install quay.io/biocontainers/phykit:2.0.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/phykit/2.0.2--pyhdfd78af_0
$ module help quay.io/biocontainers/phykit/2.0.2--pyhdfd78af_0
```
