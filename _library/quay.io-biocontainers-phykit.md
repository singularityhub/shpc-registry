...
updated_at: "2025-04-24 03:41:44.407697"
...
```bash
$ shpc install quay.io/biocontainers/phykit:2.0.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/phykit/2.0.1--pyhdfd78af_0
$ module help quay.io/biocontainers/phykit/2.0.1--pyhdfd78af_0
```
