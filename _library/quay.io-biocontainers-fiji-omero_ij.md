...
updated_at: "2023-08-22 02:51:41.505985"
latest: "5.8.0--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/fiji-omero_ij:5.8.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/fiji-omero_ij/5.8.0--hdfd78af_0
$ module help quay.io/biocontainers/fiji-omero_ij/5.8.0--hdfd78af_0
```
