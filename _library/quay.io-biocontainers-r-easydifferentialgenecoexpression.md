...
updated_at: "2025-04-08 03:13:47.914078"
latest: "1.4--r44h3121a25_1"
...
```bash
$ shpc install quay.io/biocontainers/r-easydifferentialgenecoexpression:1.4--r44h3121a25_1
```
...
```bash
$ module load quay.io/biocontainers/r-easydifferentialgenecoexpression/1.4--r44h3121a25_1
$ module help quay.io/biocontainers/r-easydifferentialgenecoexpression/1.4--r44h3121a25_1
```
