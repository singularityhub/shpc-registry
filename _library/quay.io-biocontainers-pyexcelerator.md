---
layout: container
name:  "quay.io/biocontainers/pyexcelerator"
maintainer: "@vsoch"
...
updated_at: "2024-03-16 02:52:21.338264"
...
```bash
$ shpc install quay.io/biocontainers/pyexcelerator
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/pyexcelerator:0.6.4a--py27_2
```
...
```bash
$ module load quay.io/biocontainers/pyexcelerator/0.6.4a--py27_2
$ module help quay.io/biocontainers/pyexcelerator/0.6.4a--py27_2
```
...
#### pyexcelerator-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### pyexcelerator-inspect-deffile:
