...
updated_at: "2026-02-04 05:01:35.692834"
latest: "1.3.3--py312h2973bf2_0"
...
```bash
$ shpc install quay.io/biocontainers/centrosome:1.3.3--py312h2973bf2_0
```
...
```bash
$ module load quay.io/biocontainers/centrosome/1.3.3--py312h2973bf2_0
$ module help quay.io/biocontainers/centrosome/1.3.3--py312h2973bf2_0
```
