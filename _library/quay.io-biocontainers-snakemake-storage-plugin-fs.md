...
updated_at: "2024-04-25 03:09:52.451829"
...
```bash
$ shpc install quay.io/biocontainers/snakemake-storage-plugin-fs:1.0.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake-storage-plugin-fs/1.0.3--pyhdfd78af_0
$ module help quay.io/biocontainers/snakemake-storage-plugin-fs/1.0.3--pyhdfd78af_0
```
