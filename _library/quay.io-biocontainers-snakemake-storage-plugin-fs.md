...
updated_at: "2025-07-26 04:08:53.867187"
...
```bash
$ shpc install quay.io/biocontainers/snakemake-storage-plugin-fs:1.1.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake-storage-plugin-fs/1.1.2--pyhdfd78af_0
$ module help quay.io/biocontainers/snakemake-storage-plugin-fs/1.1.2--pyhdfd78af_0
```
