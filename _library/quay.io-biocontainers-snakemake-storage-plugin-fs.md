...
updated_at: "2024-01-01 02:34:07.820982"
...
```bash
$ shpc install quay.io/biocontainers/snakemake-storage-plugin-fs:0.1.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake-storage-plugin-fs/0.1.5--pyhdfd78af_0
$ module help quay.io/biocontainers/snakemake-storage-plugin-fs/0.1.5--pyhdfd78af_0
```
