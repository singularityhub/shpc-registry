...
updated_at: "2026-03-28 17:22:37.662337"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ipo:1.36.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ipo/1.36.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ipo/1.36.0--r45hdfd78af_0
```
