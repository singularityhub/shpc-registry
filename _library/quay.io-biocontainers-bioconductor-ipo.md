...
updated_at: "2022-11-21 12:54:36.153952"
latest: "1.8.1--r351_1"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ipo:1.8.1--r351_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ipo/1.8.1--r351_1
$ module help quay.io/biocontainers/bioconductor-ipo/1.8.1--r351_1
```
