...
updated_at: "2024-09-06 03:28:30.926302"
latest: "2.3.5--h4ac6f70_1"
...
```bash
$ shpc install quay.io/biocontainers/wfa2-lib:2.3.5--h4ac6f70_1
```
...
```bash
$ module load quay.io/biocontainers/wfa2-lib/2.3.5--h4ac6f70_1
$ module help quay.io/biocontainers/wfa2-lib/2.3.5--h4ac6f70_1
```
