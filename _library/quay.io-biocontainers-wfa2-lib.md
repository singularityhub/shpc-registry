...
updated_at: "2026-04-03 15:26:41.630606"
...
```bash
$ shpc install quay.io/biocontainers/wfa2-lib:2.3.6--hd63eeec_0
```
...
```bash
$ module load quay.io/biocontainers/wfa2-lib/2.3.6--hd63eeec_0
$ module help quay.io/biocontainers/wfa2-lib/2.3.6--hd63eeec_0
```
