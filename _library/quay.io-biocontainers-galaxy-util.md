...
updated_at: "2023-12-13 02:39:48.744444"
latest: "23.1"
...
```bash
$ shpc install quay.io/biocontainers/galaxy-util:23.1
```
...
```bash
$ module load quay.io/biocontainers/galaxy-util/23.1
$ module help quay.io/biocontainers/galaxy-util/23.1
```
