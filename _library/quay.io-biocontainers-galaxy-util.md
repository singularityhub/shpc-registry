...
updated_at: "2025-04-05 03:22:54.906227"
latest: "23.2.1"
...
```bash
$ shpc install quay.io/biocontainers/galaxy-util:23.2.1
```
...
```bash
$ module load quay.io/biocontainers/galaxy-util/23.2.1
$ module help quay.io/biocontainers/galaxy-util/23.2.1
```
