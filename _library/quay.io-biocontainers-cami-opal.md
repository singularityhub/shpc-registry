...
updated_at: "2024-02-12 02:59:14.398864"
...
```bash
$ shpc install quay.io/biocontainers/cami-opal:1.0.12--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/cami-opal/1.0.12--pyhdfd78af_0
$ module help quay.io/biocontainers/cami-opal/1.0.12--pyhdfd78af_0
```
