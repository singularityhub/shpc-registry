...
updated_at: "2024-03-21 02:33:18.025638"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-motif2site:1.6.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-motif2site/1.6.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-motif2site/1.6.0--r43hdfd78af_0
```
