...
updated_at: "2023-12-14 03:41:13.445415"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-motif2site:1.4.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-motif2site/1.4.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-motif2site/1.4.0--r43hdfd78af_0
```
