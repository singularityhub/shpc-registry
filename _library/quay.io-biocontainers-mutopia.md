...
updated_at: "2026-09-02 07:12:42.133004"
...
```bash
$ shpc install quay.io/biocontainers/mutopia:1.0.9--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mutopia/1.0.9--pyhdfd78af_0
$ module help quay.io/biocontainers/mutopia/1.0.9--pyhdfd78af_0
```
