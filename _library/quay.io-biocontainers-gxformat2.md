...
updated_at: "2026-03-20 00:38:24.580245"
...
```bash
$ shpc install quay.io/biocontainers/gxformat2:0.22.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/gxformat2/0.22.0--pyhdfd78af_0
$ module help quay.io/biocontainers/gxformat2/0.22.0--pyhdfd78af_0
```
