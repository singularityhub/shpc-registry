...
updated_at: "2024-10-08 03:35:00.319301"
latest: "0.20.0--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/gxformat2:0.20.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/gxformat2/0.20.0--pyhdfd78af_0
$ module help quay.io/biocontainers/gxformat2/0.20.0--pyhdfd78af_0
```
