...
updated_at: "2026-07-01 15:10:54.888642"
...
```bash
$ shpc install quay.io/biocontainers/gxformat2:0.27.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/gxformat2/0.27.0--pyhdfd78af_0
$ module help quay.io/biocontainers/gxformat2/0.27.0--pyhdfd78af_0
```
