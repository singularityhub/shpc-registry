...
updated_at: "2026-04-19 05:42:52.351681"
latest: "0.24.0--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/gxformat2:0.24.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/gxformat2/0.24.0--pyhdfd78af_0
$ module help quay.io/biocontainers/gxformat2/0.24.0--pyhdfd78af_0
```
