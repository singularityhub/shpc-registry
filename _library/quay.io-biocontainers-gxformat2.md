...
updated_at: "2024-09-16 03:09:32.625700"
...
```bash
$ shpc install quay.io/biocontainers/gxformat2:0.19.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/gxformat2/0.19.0--pyhdfd78af_0
$ module help quay.io/biocontainers/gxformat2/0.19.0--pyhdfd78af_0
```
