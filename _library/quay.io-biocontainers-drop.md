...
updated_at: "2026-06-23 16:24:30.607997"
...
```bash
$ shpc install quay.io/biocontainers/drop:1.6.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/drop/1.6.1--pyhdfd78af_0
$ module help quay.io/biocontainers/drop/1.6.1--pyhdfd78af_0
```
