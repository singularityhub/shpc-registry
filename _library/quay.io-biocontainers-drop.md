...
updated_at: "2026-04-03 16:07:16.875028"
...
```bash
$ shpc install quay.io/biocontainers/drop:1.6.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/drop/1.6.0--pyhdfd78af_0
$ module help quay.io/biocontainers/drop/1.6.0--pyhdfd78af_0
```
