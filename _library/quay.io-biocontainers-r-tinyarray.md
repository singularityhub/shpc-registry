...
updated_at: "2024-05-15 02:33:42.786314"
latest: "2.3.3--r43h3121a25_0"
...
```bash
$ shpc install quay.io/biocontainers/r-tinyarray:2.3.3--r43h3121a25_0
```
...
```bash
$ module load quay.io/biocontainers/r-tinyarray/2.3.3--r43h3121a25_0
$ module help quay.io/biocontainers/r-tinyarray/2.3.3--r43h3121a25_0
```
