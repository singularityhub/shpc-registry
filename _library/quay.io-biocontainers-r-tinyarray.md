...
updated_at: "2023-02-24 02:54:34.085043"
latest: "2.2.7--r42h3121a25_1"
...
```bash
$ shpc install quay.io/biocontainers/r-tinyarray:2.2.7--r42h3121a25_1
```
...
```bash
$ module load quay.io/biocontainers/r-tinyarray/2.2.7--r42h3121a25_1
$ module help quay.io/biocontainers/r-tinyarray/2.2.7--r42h3121a25_1
```
