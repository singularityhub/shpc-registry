...
updated_at: "2024-07-04 04:27:10.213731"
...
```bash
$ shpc install quay.io/biocontainers/r-tinyarray:2.4.1--r43h3121a25_0
```
...
```bash
$ module load quay.io/biocontainers/r-tinyarray/2.4.1--r43h3121a25_0
$ module help quay.io/biocontainers/r-tinyarray/2.4.1--r43h3121a25_0
```
