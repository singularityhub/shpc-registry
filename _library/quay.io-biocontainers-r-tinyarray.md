...
updated_at: "2024-01-10 23:30:25.479613"
latest: "2.3.1--r43h3121a25_1"
...
```bash
$ shpc install quay.io/biocontainers/r-tinyarray:2.3.1--r43h3121a25_1
```
...
```bash
$ module load quay.io/biocontainers/r-tinyarray/2.3.1--r43h3121a25_1
$ module help quay.io/biocontainers/r-tinyarray/2.3.1--r43h3121a25_1
```
