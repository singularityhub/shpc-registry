...
updated_at: "2024-03-26 02:42:22.153785"
latest: "2.3.2--r43h3121a25_0"
...
```bash
$ shpc install quay.io/biocontainers/r-tinyarray:2.3.2--r43h3121a25_0
```
...
```bash
$ module load quay.io/biocontainers/r-tinyarray/2.3.2--r43h3121a25_0
$ module help quay.io/biocontainers/r-tinyarray/2.3.2--r43h3121a25_0
```
