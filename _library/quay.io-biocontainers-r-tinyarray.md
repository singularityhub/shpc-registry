...
updated_at: "2023-11-25 02:30:08.102581"
latest: "2.3.1--r43h3121a25_0"
...
```bash
$ shpc install quay.io/biocontainers/r-tinyarray:2.3.1--r43h3121a25_0
```
...
```bash
$ module load quay.io/biocontainers/r-tinyarray/2.3.1--r43h3121a25_0
$ module help quay.io/biocontainers/r-tinyarray/2.3.1--r43h3121a25_0
```
