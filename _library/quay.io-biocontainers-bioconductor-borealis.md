...
updated_at: "2026-01-20 04:07:39.665395"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-borealis:1.10.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-borealis/1.10.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-borealis/1.10.0--r44hdfd78af_0
```
