...
updated_at: "2024-09-05 03:23:17.834960"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-borealis:1.4.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-borealis/1.4.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-borealis/1.4.0--r43hdfd78af_0
```
