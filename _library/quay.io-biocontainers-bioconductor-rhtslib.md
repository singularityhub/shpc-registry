...
updated_at: "2026-03-18 05:11:58.346106"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rhtslib:3.6.0--r45h01b2380_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rhtslib/3.6.0--r45h01b2380_0
$ module help quay.io/biocontainers/bioconductor-rhtslib/3.6.0--r45h01b2380_0
```
