...
updated_at: "2026-04-05 05:14:02.963672"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-findit2:1.16.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-findit2/1.16.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-findit2/1.16.0--r45hdfd78af_0
```
