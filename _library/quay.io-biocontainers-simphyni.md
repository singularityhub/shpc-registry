...
updated_at: "2026-06-28 06:28:42.837968"
...
```bash
$ shpc install quay.io/biocontainers/simphyni:2.0.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/simphyni/2.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/simphyni/2.0.0--pyhdfd78af_0
```
