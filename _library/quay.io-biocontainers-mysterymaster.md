---
layout: container
name:  "quay.io/biocontainers/mysterymaster"
maintainer: "@vsoch"
...
updated_at: "2025-04-28 04:20:10.708856"
...
singularity registry hpc automated addition for mysterymaster
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/mysterymaster
```
...
#### mysterymaster-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### mysterymaster-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/FindBarcodes
$ podman run --it --rm --entrypoint /usr/local/bin/FindBarcodes   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/FindBarcodes   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/mysterymaster
$ podman run --it --rm --entrypoint /usr/local/bin/mysterymaster   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/mysterymaster   -v ${PWD} -w ${PWD} <container> -c " $@"
```
