...
updated_at: "2026-03-10 05:05:53.570547"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-seqcombo:1.32.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-seqcombo/1.32.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-seqcombo/1.32.0--r45hdfd78af_0
```
