---
layout: container
name:  "quay.io/biocontainers/perl-bio-bpwrapper"
maintainer: "@vsoch"
...
updated_at: "2024-08-14 02:40:51.347734"
...
description: "singularity registry hpc automated addition for perl-bio-bpwrapper"
config: {"url": "https://biocontainers.pro/tools/perl-bio-bpwrapper", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for perl-bio-bpwrapper", "latest": {"1.15--pl5321hdfd78af_0": "sha256:c8a67ab6720fdadec9d1d0f9b49db6487b84ee1e1266153b2ac04b1d528db494"}, "tags": {"1.15--pl5321hdfd78af_0": "sha256:c8a67ab6720fdadec9d1d0f9b49db6487b84ee1e1266153b2ac04b1d528db494"}, "docker": "quay.io/biocontainers/perl-bio-bpwrapper", "aliases": {"DrawGram.jar": "/usr/local/bin/DrawGram.jar", "DrawTree.jar": "/usr/local/bin/DrawTree.jar", "TMscore": "/usr/local/bin/TMscore", "bioaln": "/usr/local/bin/bioaln", "bioseq": "/usr/local/bin/bioseq", "biotree": "/usr/local/bin/biotree", "bstats": "/usr/local/bin/bstats", "clique": "/usr/local/bin/clique", "comppair": "/usr/local/bin/comppair", "consense": "/usr/local/bin/consense", "contml": "/usr/local/bin/contml", "contrast": "/usr/local/bin/contrast", "conus_compare": "/usr/local/bin/conus_compare", "conus_train": "/usr/local/bin/conus_train", "dca": "/usr/local/bin/dca", "dialign-tx": "/usr/local/bin/dialign-tx", "dnacomp": "/usr/local/bin/dnacomp", "dnadist": "/usr/local/bin/dnadist", "dnainvar": "/usr/local/bin/dnainvar", "dnaml": "/usr/local/bin/dnaml", "dnamlk": "/usr/local/bin/dnamlk", "dnamove": "/usr/local/bin/dnamove", "dnapars": "/usr/local/bin/dnapars", "dnapenny": "/usr/local/bin/dnapenny", "dollop": "/usr/local/bin/dollop", "dolmove": "/usr/local/bin/dolmove", "dolpenny": "/usr/local/bin/dolpenny", "drawgram": "/usr/local/bin/drawgram", "drawgram_gui": "/usr/local/bin/drawgram_gui", "drawtree": "/usr/local/bin/drawtree", "drawtree_gui": "/usr/local/bin/drawtree_gui", "fakealigner": "/usr/local/bin/fakealigner", "faketree": "/usr/local/bin/faketree", "famsa": "/usr/local/bin/famsa", "fasttreeMP": "/usr/local/bin/fasttreeMP", "fitch": "/usr/local/bin/fitch", "gendist": "/usr/local/bin/gendist", "hmmeralign": "/usr/local/bin/hmmeralign", "hmmerbuild": "/usr/local/bin/hmmerbuild", "hyperopt-mongo-worker": "/usr/local/bin/hyperopt-mongo-worker", "kalign": "/usr/local/bin/kalign", "kitsch": "/usr/local/bin/kitsch", "matplotlib": "/usr/local/bin/matplotlib", "mix": "/usr/local/bin/mix", "move": "/usr/local/bin/move", "mustang": "/usr/local/bin/mustang", "neighbor": "/usr/local/bin/neighbor", "opal.jar": "/usr/local/bin/opal.jar", "pModel": "/usr/local/bin/pModel", "padaligner": "/usr/local/bin/padaligner", "pars": "/usr/local/bin/pars", "penny": "/usr/local/bin/penny", "phylip": "/usr/local/bin/phylip", "probcons": "/usr/local/bin/probcons", "probconsRNA": "/usr/local/bin/probconsRNA", "proml": "/usr/local/bin/proml", "promlk": "/usr/local/bin/promlk", "protdist": "/usr/local/bin/protdist", "protpars": "/usr/local/bin/protpars", "randtree": "/usr/local/bin/randtree", "raxml": "/usr/local/bin/raxml", "raxmlp": "/usr/local/bin/raxmlp", "rbs": "/usr/local/bin/rbs", "rdbg": "/usr/local/bin/rdbg", "restdist": "/usr/local/bin/restdist", "restml": "/usr/local/bin/restml", "retree": "/usr/local/bin/retree", "run_pasta.py": "/usr/local/bin/run_pasta.py", "run_pasta_gui.py": "/usr/local/bin/run_pasta_gui.py", "run_seqtools.py": "/usr/local/bin/run_seqtools.py", "sap": "/usr/local/bin/sap", "scalar": "/usr/local/bin/scalar", "scompare": "/usr/local/bin/scompare", "seqboot": "/usr/local/bin/seqboot", "sfold": "/usr/local/bin/sfold", "strain_ml": "/usr/local/bin/strain_ml", "treedist": "/usr/local/bin/treedist", "typeprof": "/usr/local/bin/typeprof", "TMalign": "/usr/local/bin/TMalign", "dunamai": "/usr/local/bin/dunamai", "racc": "/usr/local/bin/racc", "make_pscores.pl": "/usr/local/bin/make_pscores.pl", "poa": "/usr/local/bin/poa", "bundle": "/usr/local/bin/bundle", "bundler": "/usr/local/bin/bundler", "prank": "/usr/local/bin/prank", "gdbm_dump": "/usr/local/bin/gdbm_dump", "gdbm_load": "/usr/local/bin/gdbm_load", "gdbmtool": "/usr/local/bin/gdbmtool", "clustalo": "/usr/local/bin/clustalo", "git": "/usr/local/bin/git", "git-cvsserver": "/usr/local/bin/git-cvsserver", "git-receive-pack": "/usr/local/bin/git-receive-pack", "git-shell": "/usr/local/bin/git-shell", "git-upload-archive": "/usr/local/bin/git-upload-archive", "git-upload-pack": "/usr/local/bin/git-upload-pack", "gitk": "/usr/local/bin/gitk", "bl2seq": "/usr/local/bin/bl2seq", "blastall": "/usr/local/bin/blastall", "blastclust": "/usr/local/bin/blastclust", "blastpgp": "/usr/local/bin/blastpgp", "copymat": "/usr/local/bin/copymat", "erb": "/usr/local/bin/erb"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/perl-bio-bpwrapper.
singularity registry hpc automated addition for perl-bio-bpwrapper
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/perl-bio-bpwrapper
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/perl-bio-bpwrapper:1.15--pl5321hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/perl-bio-bpwrapper/1.15--pl5321hdfd78af_0
$ module help quay.io/biocontainers/perl-bio-bpwrapper/1.15--pl5321hdfd78af_0
```
...
#### perl-bio-bpwrapper-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### perl-bio-bpwrapper-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/bioaln
$ podman run --it --rm --entrypoint /usr/local/bin/bioaln   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/bioaln   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/bioseq
$ podman run --it --rm --entrypoint /usr/local/bin/bioseq   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/bioseq   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/biotree
$ podman run --it --rm --entrypoint /usr/local/bin/biotree   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/biotree   -v ${PWD} -w ${PWD} <container> -c " $@"
```
