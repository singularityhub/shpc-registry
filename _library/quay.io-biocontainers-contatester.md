...
updated_at: "2024-10-30 15:57:10.447262"
...
```bash
$ shpc install quay.io/biocontainers/contatester:1.0.0--py311r43h1a4d1c9_3
```
...
```bash
$ module load quay.io/biocontainers/contatester/1.0.0--py311r43h1a4d1c9_3
$ module help quay.io/biocontainers/contatester/1.0.0--py311r43h1a4d1c9_3
```
