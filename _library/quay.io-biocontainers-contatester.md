...
updated_at: "2023-06-28 03:20:29.716870"
latest: "1.0.0--py39r42h235072b_2"
...
```bash
$ shpc install quay.io/biocontainers/contatester:1.0.0--py39r42h235072b_2
```
...
```bash
$ module load quay.io/biocontainers/contatester/1.0.0--py39r42h235072b_2
$ module help quay.io/biocontainers/contatester/1.0.0--py39r42h235072b_2
```
