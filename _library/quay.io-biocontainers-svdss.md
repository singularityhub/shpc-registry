---
layout: container
name:  "quay.io/biocontainers/svdss"
maintainer: "@vsoch"
...
updated_at: "2025-09-18 03:40:49.778970"
...
```bash
$ shpc install quay.io/biocontainers/svdss
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/svdss:2.1.0--h9013031_0
```
...
```bash
$ module load quay.io/biocontainers/svdss/2.1.0--h9013031_0
$ module help quay.io/biocontainers/svdss/2.1.0--h9013031_0
```
...
#### svdss-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### svdss-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/SVDSS
$ podman run --it --rm --entrypoint /usr/local/bin/SVDSS   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/SVDSS   -v ${PWD} -w ${PWD} <container> -c " $@"
```
