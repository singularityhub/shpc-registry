...
updated_at: "2025-05-01 07:08:34.255875"
latest: "2.0.0--h9013031_1"
...
```bash
$ shpc install quay.io/biocontainers/svdss:2.0.0--h9013031_1
```
...
```bash
$ module load quay.io/biocontainers/svdss/2.0.0--h9013031_1
$ module help quay.io/biocontainers/svdss/2.0.0--h9013031_1
```
