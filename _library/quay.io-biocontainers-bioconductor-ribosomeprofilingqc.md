...
updated_at: "2026-04-05 05:01:12.858659"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ribosomeprofilingqc:1.22.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ribosomeprofilingqc/1.22.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ribosomeprofilingqc/1.22.0--r45hdfd78af_0
```
