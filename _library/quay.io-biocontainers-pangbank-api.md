...
updated_at: "2026-09-22 07:30:26.687494"
...
```bash
$ shpc install quay.io/biocontainers/pangbank-api:0.7.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pangbank-api/0.7.0--pyhdfd78af_0
$ module help quay.io/biocontainers/pangbank-api/0.7.0--pyhdfd78af_0
```
