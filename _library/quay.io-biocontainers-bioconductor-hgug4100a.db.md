...
updated_at: "2022-10-27 00:36:58.747087"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hgug4100a.db:3.2.3--r41hdfd78af_9
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hgug4100a.db/3.2.3--r41hdfd78af_9
$ module help quay.io/biocontainers/bioconductor-hgug4100a.db/3.2.3--r41hdfd78af_9
```
