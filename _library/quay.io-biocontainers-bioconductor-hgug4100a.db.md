...
updated_at: "2022-11-12 00:30:14.777114"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hgug4100a.db:3.2.3--r41hdfd78af_10
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hgug4100a.db/3.2.3--r41hdfd78af_10
$ module help quay.io/biocontainers/bioconductor-hgug4100a.db/3.2.3--r41hdfd78af_10
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-hgug4100a.db-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-hgug4100a.db-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-hgug4100a.db-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-hgug4100a.db-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-hgug4100a.db-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-hgug4100a.db-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
