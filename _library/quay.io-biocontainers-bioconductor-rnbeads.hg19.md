...
updated_at: "2022-10-29 18:14:34.350856"
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-rnbeads.hg19-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-rnbeads.hg19-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-rnbeads.hg19-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-rnbeads.hg19-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-rnbeads.hg19-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-rnbeads.hg19-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
