...
updated_at: "2025-07-03 18:43:47.050346"
latest: "1.8.2--r44h64f727c_0"
...
```bash
$ shpc install quay.io/biocontainers/r-stitch:1.8.2--r44h64f727c_0
```
...
```bash
$ module load quay.io/biocontainers/r-stitch/1.8.2--r44h64f727c_0
$ module help quay.io/biocontainers/r-stitch/1.8.2--r44h64f727c_0
```
