...
updated_at: "2026-03-08 05:05:32.223045"
latest: "1.8.5--r44h64f727c_0"
...
```bash
$ shpc install quay.io/biocontainers/r-stitch:1.8.5--r44h64f727c_0
```
...
```bash
$ module load quay.io/biocontainers/r-stitch/1.8.5--r44h64f727c_0
$ module help quay.io/biocontainers/r-stitch/1.8.5--r44h64f727c_0
```
