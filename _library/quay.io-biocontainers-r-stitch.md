...
updated_at: "2025-01-21 03:08:49.554958"
latest: "1.7.2--r44h64f727c_1"
...
```bash
$ shpc install quay.io/biocontainers/r-stitch:1.7.2--r44h64f727c_1
```
...
```bash
$ module load quay.io/biocontainers/r-stitch/1.7.2--r44h64f727c_1
$ module help quay.io/biocontainers/r-stitch/1.7.2--r44h64f727c_1
```
