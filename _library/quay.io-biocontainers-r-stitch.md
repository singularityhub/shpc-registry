...
updated_at: "2025-03-25 03:21:31.140652"
latest: "1.7.3--r44h64f727c_0"
...
```bash
$ shpc install quay.io/biocontainers/r-stitch:1.7.3--r44h64f727c_0
```
...
```bash
$ module load quay.io/biocontainers/r-stitch/1.7.3--r44h64f727c_0
$ module help quay.io/biocontainers/r-stitch/1.7.3--r44h64f727c_0
```
