...
updated_at: "2023-10-26 03:50:20.902453"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-planttfhunter:1.0.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-planttfhunter/1.0.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-planttfhunter/1.0.0--r43hdfd78af_0
```
