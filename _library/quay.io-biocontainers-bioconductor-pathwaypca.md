...
updated_at: "2023-10-19 02:53:49.454033"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-pathwaypca:1.16.1--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-pathwaypca/1.16.1--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-pathwaypca/1.16.1--r43hdfd78af_0
```
