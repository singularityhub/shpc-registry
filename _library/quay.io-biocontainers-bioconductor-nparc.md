...
updated_at: "2023-12-02 03:04:53.360755"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-nparc:1.12.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-nparc/1.12.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-nparc/1.12.0--r43hdfd78af_0
```
