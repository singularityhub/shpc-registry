...
updated_at: "2023-10-24 02:57:12.626009"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gemma.r:1.2.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gemma.r/1.2.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-gemma.r/1.2.0--r43hdfd78af_0
```
