...
updated_at: "2024-08-25 02:45:33.435424"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-carnival:2.12.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-carnival/2.12.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-carnival/2.12.0--r43hdfd78af_0
```
