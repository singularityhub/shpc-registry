...
updated_at: "2023-12-12 02:59:44.162915"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ramwas:1.24.0--r43ha9d7317_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ramwas/1.24.0--r43ha9d7317_0
$ module help quay.io/biocontainers/bioconductor-ramwas/1.24.0--r43ha9d7317_0
```
