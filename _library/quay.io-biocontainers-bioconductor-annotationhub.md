...
updated_at: "2025-09-07 03:32:28.144543"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-annotationhub:3.14.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-annotationhub/3.14.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-annotationhub/3.14.0--r44hdfd78af_0
```
