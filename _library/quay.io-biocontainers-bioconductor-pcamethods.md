...
updated_at: "2026-03-23 05:36:50.585706"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-pcamethods:2.2.0--r45ha27e39d_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-pcamethods/2.2.0--r45ha27e39d_0
$ module help quay.io/biocontainers/bioconductor-pcamethods/2.2.0--r45ha27e39d_0
```
