...
updated_at: "2022-10-29 17:51:29.884193"
latest: "0.9--py_1"
...
```bash
$ shpc install quay.io/biocontainers/gffutils:0.9--py_1
```
...
```bash
$ module load quay.io/biocontainers/gffutils/0.9--py_1
$ module help quay.io/biocontainers/gffutils/0.9--py_1
```
