...
updated_at: "2025-08-23 03:51:03.755204"
...
```bash
$ shpc install quay.io/biocontainers/sigprofilerassignment:0.2.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sigprofilerassignment/0.2.3--pyhdfd78af_0
$ module help quay.io/biocontainers/sigprofilerassignment/0.2.3--pyhdfd78af_0
```
