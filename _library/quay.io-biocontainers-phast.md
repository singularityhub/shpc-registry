...
updated_at: "2026-09-04 07:23:41.793460"
...
```bash
$ shpc install quay.io/biocontainers/phast:1.9.9--h3ffd07f_0
```
...
```bash
$ module load quay.io/biocontainers/phast/1.9.9--h3ffd07f_0
$ module help quay.io/biocontainers/phast/1.9.9--h3ffd07f_0
```
