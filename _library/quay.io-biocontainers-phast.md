...
updated_at: "2026-03-13 04:53:35.965408"
latest: "1.9.7--h7eac25e_0"
...
```bash
$ shpc install quay.io/biocontainers/phast:1.9.7--h7eac25e_0
```
...
```bash
$ module load quay.io/biocontainers/phast/1.9.7--h7eac25e_0
$ module help quay.io/biocontainers/phast/1.9.7--h7eac25e_0
```
