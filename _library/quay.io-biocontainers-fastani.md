...
updated_at: "2024-12-13 03:35:00.628178"
latest: "1.34--h4dfc31f_4"
...
```bash
$ shpc install quay.io/biocontainers/fastani:1.34--h4dfc31f_4
```
...
```bash
$ module load quay.io/biocontainers/fastani/1.34--h4dfc31f_4
$ module help quay.io/biocontainers/fastani/1.34--h4dfc31f_4
```
