...
updated_at: "2025-12-05 03:34:15.812415"
...
```bash
$ shpc install quay.io/biocontainers/orthologer:3.8.2--py312hf097cbd_0
```
...
```bash
$ module load quay.io/biocontainers/orthologer/3.8.2--py312hf097cbd_0
$ module help quay.io/biocontainers/orthologer/3.8.2--py312hf097cbd_0
```
