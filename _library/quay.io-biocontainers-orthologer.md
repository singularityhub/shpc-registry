...
updated_at: "2024-09-14 03:27:43.657359"
latest: "3.3.2--hdbdd923_0"
...
```bash
$ shpc install quay.io/biocontainers/orthologer:3.3.2--hdbdd923_0
```
...
```bash
$ module load quay.io/biocontainers/orthologer/3.3.2--hdbdd923_0
$ module help quay.io/biocontainers/orthologer/3.3.2--hdbdd923_0
```
