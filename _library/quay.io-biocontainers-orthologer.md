...
updated_at: "2024-10-01 03:44:30.758623"
latest: "3.4.1--hdbdd923_0"
...
```bash
$ shpc install quay.io/biocontainers/orthologer:3.4.1--hdbdd923_0
```
...
```bash
$ module load quay.io/biocontainers/orthologer/3.4.1--hdbdd923_0
$ module help quay.io/biocontainers/orthologer/3.4.1--hdbdd923_0
```
