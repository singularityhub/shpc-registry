...
updated_at: "2025-10-27 03:34:47.966755"
latest: "3.8.1--py312hf097cbd_0"
...
```bash
$ shpc install quay.io/biocontainers/orthologer:3.8.1--py312hf097cbd_0
```
...
```bash
$ module load quay.io/biocontainers/orthologer/3.8.1--py312hf097cbd_0
$ module help quay.io/biocontainers/orthologer/3.8.1--py312hf097cbd_0
```
