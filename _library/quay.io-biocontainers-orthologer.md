...
updated_at: "2026-02-04 04:25:51.410080"
latest: "3.9.0--py312hf097cbd_0"
...
```bash
$ shpc install quay.io/biocontainers/orthologer:3.9.0--py312hf097cbd_0
```
...
```bash
$ module load quay.io/biocontainers/orthologer/3.9.0--py312hf097cbd_0
$ module help quay.io/biocontainers/orthologer/3.9.0--py312hf097cbd_0
```
