...
updated_at: "2026-08-29 09:17:51.563449"
latest: "3.9.1--py312h9a2b161_1"
...
```bash
$ shpc install quay.io/biocontainers/orthologer:3.9.1--py312h9a2b161_1
```
...
```bash
$ module load quay.io/biocontainers/orthologer/3.9.1--py312h9a2b161_1
$ module help quay.io/biocontainers/orthologer/3.9.1--py312h9a2b161_1
```
