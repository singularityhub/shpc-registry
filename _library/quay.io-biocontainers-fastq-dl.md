...
updated_at: "2025-03-07 02:59:06.004901"
...
```bash
$ shpc install quay.io/biocontainers/fastq-dl:3.0.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/fastq-dl/3.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/fastq-dl/3.0.0--pyhdfd78af_0
```
