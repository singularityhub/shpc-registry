...
updated_at: "2025-10-11 03:04:36.527429"
...
```bash
$ shpc install quay.io/biocontainers/fastq-dl:3.0.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/fastq-dl/3.0.1--pyhdfd78af_0
$ module help quay.io/biocontainers/fastq-dl/3.0.1--pyhdfd78af_0
```
