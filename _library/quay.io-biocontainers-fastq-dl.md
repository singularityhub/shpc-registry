...
updated_at: "2023-08-14 03:19:52.742146"
...
```bash
$ shpc install quay.io/biocontainers/fastq-dl:2.0.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/fastq-dl/2.0.2--pyhdfd78af_0
$ module help quay.io/biocontainers/fastq-dl/2.0.2--pyhdfd78af_0
```
