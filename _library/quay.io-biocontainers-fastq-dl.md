...
updated_at: "2023-05-23 02:58:38.524210"
...
```bash
$ shpc install quay.io/biocontainers/fastq-dl:2.0.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/fastq-dl/2.0.1--pyhdfd78af_0
$ module help quay.io/biocontainers/fastq-dl/2.0.1--pyhdfd78af_0
```
