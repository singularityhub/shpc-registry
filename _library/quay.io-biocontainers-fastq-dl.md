...
updated_at: "2023-04-10 02:57:42.709895"
...
```bash
$ shpc install quay.io/biocontainers/fastq-dl:2.0.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/fastq-dl/2.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/fastq-dl/2.0.0--pyhdfd78af_0
```
