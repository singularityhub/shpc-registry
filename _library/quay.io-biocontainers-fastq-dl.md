...
updated_at: "2024-03-18 03:31:11.416964"
...
```bash
$ shpc install quay.io/biocontainers/fastq-dl:2.0.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/fastq-dl/2.0.4--pyhdfd78af_0
$ module help quay.io/biocontainers/fastq-dl/2.0.4--pyhdfd78af_0
```
