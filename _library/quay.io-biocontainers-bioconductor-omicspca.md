...
updated_at: "2026-03-25 04:38:11.388784"
latest: "1.28.0--r45h575d39b_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-omicspca:1.28.0--r45h575d39b_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-omicspca/1.28.0--r45h575d39b_0
$ module help quay.io/biocontainers/bioconductor-omicspca/1.28.0--r45h575d39b_0
```
