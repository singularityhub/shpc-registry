...
updated_at: "2025-09-11 05:07:13.689741"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-omicspca:1.24.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-omicspca/1.24.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-omicspca/1.24.0--r44hdfd78af_0
```
