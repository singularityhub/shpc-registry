...
updated_at: "2025-06-26 03:49:32.457579"
latest: "2.2.3--hbcbf7aa_0"
...
```bash
$ shpc install quay.io/biocontainers/ppanggolin:2.2.3--hbcbf7aa_0
```
...
```bash
$ module load quay.io/biocontainers/ppanggolin/2.2.3--hbcbf7aa_0
$ module help quay.io/biocontainers/ppanggolin/2.2.3--hbcbf7aa_0
```
