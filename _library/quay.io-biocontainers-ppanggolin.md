...
updated_at: "2025-09-12 03:05:48.197209"
latest: "2.2.5--py311haab0aaa_0"
...
```bash
$ shpc install quay.io/biocontainers/ppanggolin:2.2.5--py311haab0aaa_0
```
...
```bash
$ module load quay.io/biocontainers/ppanggolin/2.2.5--py311haab0aaa_0
$ module help quay.io/biocontainers/ppanggolin/2.2.5--py311haab0aaa_0
```
