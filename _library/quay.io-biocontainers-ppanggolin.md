...
updated_at: "2024-09-25 03:12:36.473460"
latest: "2.1.1--py39hff71179_0"
...
```bash
$ shpc install quay.io/biocontainers/ppanggolin:2.1.1--py39hff71179_0
```
...
```bash
$ module load quay.io/biocontainers/ppanggolin/2.1.1--py39hff71179_0
$ module help quay.io/biocontainers/ppanggolin/2.1.1--py39hff71179_0
```
