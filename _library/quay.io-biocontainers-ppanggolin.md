...
updated_at: "2025-01-07 03:04:46.923531"
latest: "2.2.1--py310h1fe012e_1"
...
```bash
$ shpc install quay.io/biocontainers/ppanggolin:2.2.1--py310h1fe012e_1
```
...
```bash
$ module load quay.io/biocontainers/ppanggolin/2.2.1--py310h1fe012e_1
$ module help quay.io/biocontainers/ppanggolin/2.2.1--py310h1fe012e_1
```
