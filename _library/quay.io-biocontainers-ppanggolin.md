...
updated_at: "2025-04-24 03:55:37.020764"
latest: "2.2.2--py311haab0aaa_0"
...
```bash
$ shpc install quay.io/biocontainers/ppanggolin:2.2.2--py311haab0aaa_0
```
...
```bash
$ module load quay.io/biocontainers/ppanggolin/2.2.2--py311haab0aaa_0
$ module help quay.io/biocontainers/ppanggolin/2.2.2--py311haab0aaa_0
```
