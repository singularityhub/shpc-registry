...
updated_at: "2026-01-15 04:20:43.449198"
latest: "2.2.5--py311haab0aaa_1"
...
```bash
$ shpc install quay.io/biocontainers/ppanggolin:2.2.5--py311haab0aaa_1
```
...
```bash
$ module load quay.io/biocontainers/ppanggolin/2.2.5--py311haab0aaa_1
$ module help quay.io/biocontainers/ppanggolin/2.2.5--py311haab0aaa_1
```
