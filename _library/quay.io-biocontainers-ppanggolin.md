...
updated_at: "2025-08-18 04:03:25.604530"
latest: "2.2.4--h1fe012e_0"
...
```bash
$ shpc install quay.io/biocontainers/ppanggolin:2.2.4--h1fe012e_0
```
...
```bash
$ module load quay.io/biocontainers/ppanggolin/2.2.4--h1fe012e_0
$ module help quay.io/biocontainers/ppanggolin/2.2.4--h1fe012e_0
```
