...
updated_at: "2022-11-28 03:58:21.923362"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-categorycompare:1.38.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-categorycompare/1.38.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-categorycompare/1.38.0--r41hdfd78af_0
```
