...
updated_at: "2022-11-05 00:43:54.103139"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-bgeedb:2.8.0--r351_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-bgeedb/2.8.0--r351_0
$ module help quay.io/biocontainers/bioconductor-bgeedb/2.8.0--r351_0
```
