...
updated_at: "2023-09-11 02:29:20.272044"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-bgeedb:2.26.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-bgeedb/2.26.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-bgeedb/2.26.0--r43hdfd78af_0
```
