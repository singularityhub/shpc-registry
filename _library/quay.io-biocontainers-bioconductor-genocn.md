...
updated_at: "2023-07-05 03:31:46.233243"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-genocn:1.50.0--r42ha9d7317_2
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-genocn/1.50.0--r42ha9d7317_2
$ module help quay.io/biocontainers/bioconductor-genocn/1.50.0--r42ha9d7317_2
```
