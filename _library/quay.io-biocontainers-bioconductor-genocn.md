...
updated_at: "2022-10-29 18:30:20.438517"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-genocn:1.46.0--r41hc0cfd56_2
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-genocn/1.46.0--r41hc0cfd56_2
$ module help quay.io/biocontainers/bioconductor-genocn/1.46.0--r41hc0cfd56_2
```
