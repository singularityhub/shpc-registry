...
updated_at: "2024-11-12 02:50:19.977353"
latest: "0.16.12--h919a2d8_0"
...
```bash
$ shpc install quay.io/biocontainers/locityper:0.16.12--h919a2d8_0
```
...
```bash
$ module load quay.io/biocontainers/locityper/0.16.12--h919a2d8_0
$ module help quay.io/biocontainers/locityper/0.16.12--h919a2d8_0
```
