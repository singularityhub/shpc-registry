...
updated_at: "2025-09-05 03:32:24.207359"
...
```bash
$ shpc install quay.io/biocontainers/locityper:1.0.0--ha6fb395_0
```
...
```bash
$ module load quay.io/biocontainers/locityper/1.0.0--ha6fb395_0
$ module help quay.io/biocontainers/locityper/1.0.0--ha6fb395_0
```
