...
updated_at: "2024-04-14 03:31:04.711746"
latest: "0.13.4--h919a2d8_0"
...
```bash
$ shpc install quay.io/biocontainers/locityper:0.13.4--h919a2d8_0
```
...
```bash
$ module load quay.io/biocontainers/locityper/0.13.4--h919a2d8_0
$ module help quay.io/biocontainers/locityper/0.13.4--h919a2d8_0
```
