...
updated_at: "2024-05-03 02:46:50.525003"
latest: "0.14.5--h919a2d8_0"
...
```bash
$ shpc install quay.io/biocontainers/locityper:0.14.5--h919a2d8_0
```
...
```bash
$ module load quay.io/biocontainers/locityper/0.14.5--h919a2d8_0
$ module help quay.io/biocontainers/locityper/0.14.5--h919a2d8_0
```
