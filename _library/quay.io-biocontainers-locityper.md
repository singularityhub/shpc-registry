...
updated_at: "2024-08-20 03:24:58.436646"
latest: "0.16.10--h919a2d8_0"
...
```bash
$ shpc install quay.io/biocontainers/locityper:0.16.10--h919a2d8_0
```
...
```bash
$ module load quay.io/biocontainers/locityper/0.16.10--h919a2d8_0
$ module help quay.io/biocontainers/locityper/0.16.10--h919a2d8_0
```
