...
updated_at: "2024-11-22 03:57:28.052482"
latest: "0.17.3--h919a2d8_0"
...
```bash
$ shpc install quay.io/biocontainers/locityper:0.17.3--h919a2d8_0
```
...
```bash
$ module load quay.io/biocontainers/locityper/0.17.3--h919a2d8_0
$ module help quay.io/biocontainers/locityper/0.17.3--h919a2d8_0
```
