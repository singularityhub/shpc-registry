...
updated_at: "2026-08-26 03:27:18.781511"
...
```bash
$ shpc install quay.io/biocontainers/locityper:1.7.2--hd612981_0
```
...
```bash
$ module load quay.io/biocontainers/locityper/1.7.2--hd612981_0
$ module help quay.io/biocontainers/locityper/1.7.2--hd612981_0
```
