...
updated_at: "2026-06-20 06:37:40.019657"
latest: "1.5.4--hd612981_0"
...
```bash
$ shpc install quay.io/biocontainers/locityper:1.5.4--hd612981_0
```
...
```bash
$ module load quay.io/biocontainers/locityper/1.5.4--hd612981_0
$ module help quay.io/biocontainers/locityper/1.5.4--hd612981_0
```
