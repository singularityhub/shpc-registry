...
updated_at: "2024-10-14 02:59:18.818452"
latest: "0.16.11--h919a2d8_0"
...
```bash
$ shpc install quay.io/biocontainers/locityper:0.16.11--h919a2d8_0
```
...
```bash
$ module load quay.io/biocontainers/locityper/0.16.11--h919a2d8_0
$ module help quay.io/biocontainers/locityper/0.16.11--h919a2d8_0
```
