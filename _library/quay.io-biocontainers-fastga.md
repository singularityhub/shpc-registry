...
updated_at: "2026-04-03 05:29:35.770438"
...
```bash
$ shpc install quay.io/biocontainers/fastga:1.5--hb7acf71_0
```
...
```bash
$ module load quay.io/biocontainers/fastga/1.5--hb7acf71_0
$ module help quay.io/biocontainers/fastga/1.5--hb7acf71_0
```
