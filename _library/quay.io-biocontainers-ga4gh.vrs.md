---
layout: container
name:  "quay.io/biocontainers/ga4gh.vrs"
maintainer: "@vsoch"
...
updated_at: "2026-06-17 07:17:31.384415"
...
singularity registry hpc automated addition for ga4gh.vrs
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/ga4gh.vrs
```
...
#### ga4gh.vrs-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### ga4gh.vrs-inspect-deffile:
