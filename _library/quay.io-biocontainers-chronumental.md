...
updated_at: "2024-07-14 02:54:56.571879"
latest: "0.0.63--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/chronumental:0.0.63--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/chronumental/0.0.63--pyhdfd78af_0
$ module help quay.io/biocontainers/chronumental/0.0.63--pyhdfd78af_0
```
