...
updated_at: "2026-07-02 06:53:04.903802"
latest: "2.1.1--py313hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/beacon2-ri-tools:2.1.1--py313hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/beacon2-ri-tools/2.1.1--py313hdfd78af_0
$ module help quay.io/biocontainers/beacon2-ri-tools/2.1.1--py313hdfd78af_0
```
