...
updated_at: "2026-07-29 06:10:42.304534"
...
```bash
$ shpc install quay.io/biocontainers/beacon2-ri-tools:2.1.2--py313hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/beacon2-ri-tools/2.1.2--py313hdfd78af_0
$ module help quay.io/biocontainers/beacon2-ri-tools/2.1.2--py313hdfd78af_0
```
