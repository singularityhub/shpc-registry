...
updated_at: "2026-08-10 04:45:36.037371"
...
```bash
$ shpc install quay.io/biocontainers/beacon2-ri-tools:2.2.0--py313hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/beacon2-ri-tools/2.2.0--py313hdfd78af_0
$ module help quay.io/biocontainers/beacon2-ri-tools/2.2.0--py313hdfd78af_0
```
