...
updated_at: "2023-07-17 03:32:18.204219"
...
```bash
$ shpc install quay.io/biocontainers/nanometa-live:0.1.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/nanometa-live/0.1.1--pyhdfd78af_0
$ module help quay.io/biocontainers/nanometa-live/0.1.1--pyhdfd78af_0
```
