...
updated_at: "2023-12-09 03:02:46.142190"
...
```bash
$ shpc install quay.io/biocontainers/nanometa-live:0.3.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/nanometa-live/0.3.1--pyhdfd78af_0
$ module help quay.io/biocontainers/nanometa-live/0.3.1--pyhdfd78af_0
```
