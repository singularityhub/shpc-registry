...
updated_at: "2024-10-05 03:17:40.624050"
...
```bash
$ shpc install quay.io/biocontainers/galaxy-files:24.1.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/galaxy-files/24.1.1--pyhdfd78af_0
$ module help quay.io/biocontainers/galaxy-files/24.1.1--pyhdfd78af_0
```
