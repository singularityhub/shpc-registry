...
updated_at: "2025-10-01 03:38:34.338186"
...
```bash
$ shpc install quay.io/biocontainers/galaxy-files:25.0.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/galaxy-files/25.0.2--pyhdfd78af_0
$ module help quay.io/biocontainers/galaxy-files/25.0.2--pyhdfd78af_0
```
