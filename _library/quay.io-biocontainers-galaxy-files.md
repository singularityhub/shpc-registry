...
updated_at: "2025-04-06 03:19:21.662374"
latest: "24.2.1--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/galaxy-files:24.2.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/galaxy-files/24.2.1--pyhdfd78af_0
$ module help quay.io/biocontainers/galaxy-files/24.2.1--pyhdfd78af_0
```
