...
updated_at: "2023-11-11 02:56:01.307104"
...
```bash
$ shpc install quay.io/biocontainers/galaxy-files:23.1.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/galaxy-files/23.1.1--pyhdfd78af_0
$ module help quay.io/biocontainers/galaxy-files/23.1.1--pyhdfd78af_0
```
