...
updated_at: "2025-04-17 03:03:53.436000"
...
```bash
$ shpc install quay.io/biocontainers/galaxy-files:24.2.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/galaxy-files/24.2.3--pyhdfd78af_0
$ module help quay.io/biocontainers/galaxy-files/24.2.3--pyhdfd78af_0
```
