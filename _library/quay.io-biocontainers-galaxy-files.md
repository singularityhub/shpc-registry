...
updated_at: "2025-08-24 03:46:25.590409"
...
```bash
$ shpc install quay.io/biocontainers/galaxy-files:25.0.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/galaxy-files/25.0.1--pyhdfd78af_0
$ module help quay.io/biocontainers/galaxy-files/25.0.1--pyhdfd78af_0
```
