...
updated_at: "2025-02-06 03:30:27.267048"
...
```bash
$ shpc install quay.io/biocontainers/galaxy-files:24.1.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/galaxy-files/24.1.4--pyhdfd78af_0
$ module help quay.io/biocontainers/galaxy-files/24.1.4--pyhdfd78af_0
```
