...
updated_at: "2026-01-01 07:27:58.886859"
...
```bash
$ shpc install quay.io/biocontainers/galaxy-files:25.0.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/galaxy-files/25.0.3--pyhdfd78af_0
$ module help quay.io/biocontainers/galaxy-files/25.0.3--pyhdfd78af_0
```
