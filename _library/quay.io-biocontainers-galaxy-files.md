...
updated_at: "2024-03-23 02:51:48.529979"
...
```bash
$ shpc install quay.io/biocontainers/galaxy-files:23.2.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/galaxy-files/23.2.1--pyhdfd78af_0
$ module help quay.io/biocontainers/galaxy-files/23.2.1--pyhdfd78af_0
```
