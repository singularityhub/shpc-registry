...
updated_at: "2024-08-01 03:53:32.746223"
...
```bash
$ shpc install quay.io/biocontainers/galaxy-files:24.0.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/galaxy-files/24.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/galaxy-files/24.0.0--pyhdfd78af_0
```
