...
updated_at: "2026-06-26 06:18:39.169493"
...
```bash
$ shpc install quay.io/biocontainers/snakemake-executor-plugin-slurm-jobstep:0.6.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake-executor-plugin-slurm-jobstep/0.6.1--pyhdfd78af_0
$ module help quay.io/biocontainers/snakemake-executor-plugin-slurm-jobstep/0.6.1--pyhdfd78af_0
```
