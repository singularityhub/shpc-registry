...
updated_at: "2024-03-02 02:50:27.776481"
...
```bash
$ shpc install quay.io/biocontainers/snakemake-executor-plugin-slurm-jobstep:0.1.10--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake-executor-plugin-slurm-jobstep/0.1.10--pyhdfd78af_0
$ module help quay.io/biocontainers/snakemake-executor-plugin-slurm-jobstep/0.1.10--pyhdfd78af_0
```
