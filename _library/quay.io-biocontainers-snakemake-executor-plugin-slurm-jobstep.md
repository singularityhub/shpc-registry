...
updated_at: "2025-01-24 03:16:15.166420"
...
```bash
$ shpc install quay.io/biocontainers/snakemake-executor-plugin-slurm-jobstep:0.2.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake-executor-plugin-slurm-jobstep/0.2.1--pyhdfd78af_0
$ module help quay.io/biocontainers/snakemake-executor-plugin-slurm-jobstep/0.2.1--pyhdfd78af_0
```
