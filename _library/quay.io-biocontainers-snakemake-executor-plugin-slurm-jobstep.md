...
updated_at: "2024-04-05 02:51:43.981721"
...
```bash
$ shpc install quay.io/biocontainers/snakemake-executor-plugin-slurm-jobstep:0.1.11--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake-executor-plugin-slurm-jobstep/0.1.11--pyhdfd78af_0
$ module help quay.io/biocontainers/snakemake-executor-plugin-slurm-jobstep/0.1.11--pyhdfd78af_0
```
