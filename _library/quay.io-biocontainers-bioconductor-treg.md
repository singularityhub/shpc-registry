...
updated_at: "2023-11-17 02:42:40.367305"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-treg:1.4.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-treg/1.4.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-treg/1.4.0--r43hdfd78af_0
```
