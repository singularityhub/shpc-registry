...
updated_at: "2025-02-03 03:32:36.325767"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-iseeindex:1.4.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-iseeindex/1.4.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-iseeindex/1.4.0--r44hdfd78af_0
```
