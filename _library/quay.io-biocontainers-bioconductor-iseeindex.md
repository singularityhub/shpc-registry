...
updated_at: "2024-01-27 02:32:08.441432"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-iseeindex:1.0.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-iseeindex/1.0.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-iseeindex/1.0.0--r43hdfd78af_0
```
