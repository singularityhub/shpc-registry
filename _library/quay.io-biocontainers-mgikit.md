...
updated_at: "2025-08-27 03:45:25.569582"
latest: "2.0.1--h3ab6199_0"
...
```bash
$ shpc install quay.io/biocontainers/mgikit:2.0.1--h3ab6199_0
```
...
```bash
$ module load quay.io/biocontainers/mgikit/2.0.1--h3ab6199_0
$ module help quay.io/biocontainers/mgikit/2.0.1--h3ab6199_0
```
