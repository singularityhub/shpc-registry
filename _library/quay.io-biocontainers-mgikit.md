...
updated_at: "2026-01-29 04:11:50.633119"
latest: "2.1.1--h3ab6199_0"
...
```bash
$ shpc install quay.io/biocontainers/mgikit:2.1.1--h3ab6199_0
```
...
```bash
$ module load quay.io/biocontainers/mgikit/2.1.1--h3ab6199_0
$ module help quay.io/biocontainers/mgikit/2.1.1--h3ab6199_0
```
