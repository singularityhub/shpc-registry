...
updated_at: "2026-03-15 05:27:25.970210"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-spiat:1.12.1--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-spiat/1.12.1--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-spiat/1.12.1--r45hdfd78af_0
```
