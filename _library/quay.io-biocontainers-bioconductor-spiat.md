...
updated_at: "2025-02-08 02:46:05.798828"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-spiat:1.8.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-spiat/1.8.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-spiat/1.8.0--r44hdfd78af_0
```
