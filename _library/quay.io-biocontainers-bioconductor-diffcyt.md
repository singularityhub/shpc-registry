...
updated_at: "2025-08-21 06:25:38.354618"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-diffcyt:1.26.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-diffcyt/1.26.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-diffcyt/1.26.0--r44hdfd78af_0
```
