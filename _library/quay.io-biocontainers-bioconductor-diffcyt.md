...
updated_at: "2022-11-02 19:41:41.057396"
latest: "1.8.6--r40_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-diffcyt:1.8.6--r40_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-diffcyt/1.8.6--r40_0
$ module help quay.io/biocontainers/bioconductor-diffcyt/1.8.6--r40_0
```
