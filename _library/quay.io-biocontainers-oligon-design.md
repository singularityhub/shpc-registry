...
updated_at: "2026-03-25 04:52:59.856803"
...
```bash
$ shpc install quay.io/biocontainers/oligon-design:1.1.0--py314hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/oligon-design/1.1.0--py314hdfd78af_0
$ module help quay.io/biocontainers/oligon-design/1.1.0--py314hdfd78af_0
```
