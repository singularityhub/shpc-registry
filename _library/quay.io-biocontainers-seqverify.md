...
updated_at: "2024-06-30 02:39:00.206752"
...
```bash
$ shpc install quay.io/biocontainers/seqverify:1.2.1--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/seqverify/1.2.1--hdfd78af_0
$ module help quay.io/biocontainers/seqverify/1.2.1--hdfd78af_0
```
