...
updated_at: "2024-06-04 02:53:27.922095"
...
```bash
$ shpc install quay.io/biocontainers/seqverify:1.2.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/seqverify/1.2.0--hdfd78af_0
$ module help quay.io/biocontainers/seqverify/1.2.0--hdfd78af_0
```
