...
updated_at: "2025-05-18 03:46:04.947906"
...
```bash
$ shpc install quay.io/biocontainers/seqverify:1.3.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/seqverify/1.3.0--hdfd78af_0
$ module help quay.io/biocontainers/seqverify/1.3.0--hdfd78af_0
```
