...
updated_at: "2023-10-15 03:16:23.716232"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-getdee2:1.10.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-getdee2/1.10.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-getdee2/1.10.0--r43hdfd78af_0
```
