...
updated_at: "2023-12-24 02:29:49.451296"
latest: "3.48.0--r43ha9d7317_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-sva:3.48.0--r43ha9d7317_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-sva/3.48.0--r43ha9d7317_0
$ module help quay.io/biocontainers/bioconductor-sva/3.48.0--r43ha9d7317_0
```
