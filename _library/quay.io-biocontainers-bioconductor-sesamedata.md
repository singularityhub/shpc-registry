...
updated_at: "2022-11-15 01:05:12.990422"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-sesamedata:1.8.1--r40hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-sesamedata/1.8.1--r40hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-sesamedata/1.8.1--r40hdfd78af_0
```
