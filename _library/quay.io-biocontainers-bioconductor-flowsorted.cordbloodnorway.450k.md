...
updated_at: "2023-12-30 04:28:23.573857"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-flowsorted.cordbloodnorway.450k:1.26.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-flowsorted.cordbloodnorway.450k/1.26.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-flowsorted.cordbloodnorway.450k/1.26.0--r43hdfd78af_0
```
