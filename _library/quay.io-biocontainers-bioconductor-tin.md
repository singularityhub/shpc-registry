...
updated_at: "2023-07-31 03:23:45.185291"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-tin:1.32.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-tin/1.32.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-tin/1.32.0--r43hdfd78af_0
```
