---
layout: container
name:  "quay.io/biocontainers/esme_netcdf-c_mpich_4_3_1"
maintainer: "@vsoch"
github: "https://github.com/singularityhub/shpc-registry/blob/main/quay.io/biocontainers/esme_netcdf-c_mpich_4_3_1/container.yaml"
config_url: "https://raw.githubusercontent.com/singularityhub/shpc-registry/main/quay.io/biocontainers/esme_netcdf-c_mpich_4_3_1/container.yaml"
updated_at: "2025-12-27 03:56:21.485469"
latest: "4.9.3--hf8030cc_0"
container_url: "https://biocontainers.pro/tools/esme_netcdf-c_mpich_4_3_1"
aliases:
 - "mpiexec.gforker"
 - "nc4print"
 - "ocprint"
...
versions:
 - "4.9.3--hf8030cc_0"
description: "singularity registry hpc automated addition for esme_netcdf-c_mpich_4_3_1"
config: {"url": "https://biocontainers.pro/tools/esme_netcdf-c_mpich_4_3_1", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for esme_netcdf-c_mpich_4_3_1", "latest": {"4.9.3--hf8030cc_0": "sha256:edd6053249d82a1d70473db182d1bf03e180afb7069545bdebe11bf8f064ae18"}, "tags": {"4.9.3--hf8030cc_0": "sha256:edd6053249d82a1d70473db182d1bf03e180afb7069545bdebe11bf8f064ae18"}, "docker": "quay.io/biocontainers/esme_netcdf-c_mpich_4_3_1", "aliases": {"mpiexec.gforker": "/usr/local/bin/mpiexec.gforker", "nc4print": "/usr/local/bin/nc4print", "ocprint": "/usr/local/bin/ocprint", "ucx_perftest_daemon": "/usr/local/bin/ucx_perftest_daemon", "parkill": "/usr/local/bin/parkill", "hydra_nameserver": "/usr/local/bin/hydra_nameserver", "hydra_persist": "/usr/local/bin/hydra_persist", "hydra_pmi_proxy": "/usr/local/bin/hydra_pmi_proxy", "mpiexec.hydra": "/usr/local/bin/mpiexec.hydra", "mpichversion": "/usr/local/bin/mpichversion", "mpivars": "/usr/local/bin/mpivars", "genl-ctrl-list": "/usr/local/bin/genl-ctrl-list", "idiag-socket-details": "/usr/local/bin/idiag-socket-details", "nf-ct-add": "/usr/local/bin/nf-ct-add", "nf-ct-events": "/usr/local/bin/nf-ct-events", "nf-ct-list": "/usr/local/bin/nf-ct-list", "nf-exp-add": "/usr/local/bin/nf-exp-add", "nf-exp-delete": "/usr/local/bin/nf-exp-delete", "nf-exp-list": "/usr/local/bin/nf-exp-list", "nf-log": "/usr/local/bin/nf-log", "nf-monitor": "/usr/local/bin/nf-monitor", "nf-queue": "/usr/local/bin/nf-queue", "nl-addr-add": "/usr/local/bin/nl-addr-add", "nl-addr-delete": "/usr/local/bin/nl-addr-delete", "nl-addr-list": "/usr/local/bin/nl-addr-list"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/esme_netcdf-c_mpich_4_3_1.
singularity registry hpc automated addition for esme_netcdf-c_mpich_4_3_1
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/esme_netcdf-c_mpich_4_3_1
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/esme_netcdf-c_mpich_4_3_1:4.9.3--hf8030cc_0
```
...
```bash
$ module load quay.io/biocontainers/esme_netcdf-c_mpich_4_3_1/4.9.3--hf8030cc_0
$ module help quay.io/biocontainers/esme_netcdf-c_mpich_4_3_1/4.9.3--hf8030cc_0
```
...
#### esme_netcdf-c_mpich_4_3_1-shell:
...
#### esme_netcdf-c_mpich_4_3_1-exec:
...
#### esme_netcdf-c_mpich_4_3_1-inspect:
...
#### esme_netcdf-c_mpich_4_3_1-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### esme_netcdf-c_mpich_4_3_1-inspect-deffile:
