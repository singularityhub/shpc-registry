...
updated_at: "2023-11-02 02:50:47.522934"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hiiragi2013:1.36.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hiiragi2013/1.36.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-hiiragi2013/1.36.0--r43hdfd78af_0
```
