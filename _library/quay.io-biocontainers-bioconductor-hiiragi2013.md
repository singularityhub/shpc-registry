...
updated_at: "2024-04-13 02:37:56.474037"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hiiragi2013:1.38.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hiiragi2013/1.38.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-hiiragi2013/1.38.0--r43hdfd78af_0
```
