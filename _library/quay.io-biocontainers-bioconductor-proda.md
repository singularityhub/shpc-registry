...
updated_at: "2023-08-17 03:32:27.797943"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-proda:1.14.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-proda/1.14.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-proda/1.14.0--r43hdfd78af_0
```
