...
updated_at: "2022-11-07 00:14:51.249941"
...
```bash
$ shpc install quay.io/biocontainers/mokapot:0.8.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mokapot/0.8.3--pyhdfd78af_0
$ module help quay.io/biocontainers/mokapot/0.8.3--pyhdfd78af_0
```
