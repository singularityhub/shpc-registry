...
updated_at: "2026-06-23 16:30:25.336024"
latest: "1.14.0--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/crabs:1.14.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/crabs/1.14.0--pyhdfd78af_0
$ module help quay.io/biocontainers/crabs/1.14.0--pyhdfd78af_0
```
