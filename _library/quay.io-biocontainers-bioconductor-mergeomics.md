...
updated_at: "2026-04-03 04:38:58.636855"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mergeomics:1.38.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mergeomics/1.38.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-mergeomics/1.38.0--r45hdfd78af_0
```
