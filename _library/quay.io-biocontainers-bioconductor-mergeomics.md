...
updated_at: "2023-07-31 03:05:57.235591"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mergeomics:1.28.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mergeomics/1.28.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-mergeomics/1.28.0--r43hdfd78af_0
```
