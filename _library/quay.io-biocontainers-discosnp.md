...
updated_at: "2025-11-06 04:33:52.019562"
latest: "2.6.2--h5ca1c30_6"
...
```bash
$ shpc install quay.io/biocontainers/discosnp:2.6.2--h5ca1c30_6
```
...
```bash
$ module load quay.io/biocontainers/discosnp/2.6.2--h5ca1c30_6
$ module help quay.io/biocontainers/discosnp/2.6.2--h5ca1c30_6
```
