...
updated_at: "2026-06-26 06:37:20.658222"
latest: "4.2--py314hf0d9b2b_0"
...
```bash
$ shpc install quay.io/biocontainers/bali-phy:4.2--py314hf0d9b2b_0
```
...
```bash
$ module load quay.io/biocontainers/bali-phy/4.2--py314hf0d9b2b_0
$ module help quay.io/biocontainers/bali-phy/4.2--py314hf0d9b2b_0
```
