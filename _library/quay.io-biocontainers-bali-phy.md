...
updated_at: "2024-10-08 03:28:58.155116"
latest: "4.0beta15--py312h8a9285e_1"
...
```bash
$ shpc install quay.io/biocontainers/bali-phy:4.0beta15--py312h8a9285e_1
```
...
```bash
$ module load quay.io/biocontainers/bali-phy/4.0beta15--py312h8a9285e_1
$ module help quay.io/biocontainers/bali-phy/4.0beta15--py312h8a9285e_1
```
