...
updated_at: "2024-05-30 02:39:55.852891"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-melissa:1.18.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-melissa/1.18.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-melissa/1.18.0--r43hdfd78af_0
```
