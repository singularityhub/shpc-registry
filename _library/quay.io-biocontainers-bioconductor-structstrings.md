...
updated_at: "2026-09-03 07:21:10.049274"
latest: "1.26.0--r45h01b2380_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-structstrings:1.26.0--r45h01b2380_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-structstrings/1.26.0--r45h01b2380_0
$ module help quay.io/biocontainers/bioconductor-structstrings/1.26.0--r45h01b2380_0
```
