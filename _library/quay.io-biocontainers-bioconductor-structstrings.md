...
updated_at: "2022-11-04 00:04:16.015150"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-structstrings:1.8.0--r41hd029910_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-structstrings/1.8.0--r41hd029910_0
$ module help quay.io/biocontainers/bioconductor-structstrings/1.8.0--r41hd029910_0
```
