...
updated_at: "2023-10-21 03:08:57.986813"
latest: "1.16.0--r43ha9d7317_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-structstrings:1.16.0--r43ha9d7317_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-structstrings/1.16.0--r43ha9d7317_0
$ module help quay.io/biocontainers/bioconductor-structstrings/1.16.0--r43ha9d7317_0
```
