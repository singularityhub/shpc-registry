...
updated_at: "2025-02-10 03:01:19.609469"
...
```bash
$ shpc install quay.io/biocontainers/autobigs-engine:0.8.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/autobigs-engine/0.8.0--pyhdfd78af_0
$ module help quay.io/biocontainers/autobigs-engine/0.8.0--pyhdfd78af_0
```
