...
updated_at: "2022-11-17 03:34:25.939138"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rrbsdata:1.14.0--r41hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rrbsdata/1.14.0--r41hdfd78af_1
$ module help quay.io/biocontainers/bioconductor-rrbsdata/1.14.0--r41hdfd78af_1
```
