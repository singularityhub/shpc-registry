...
updated_at: "2026-06-27 06:16:29.321221"
...
```bash
$ shpc install quay.io/biocontainers/snakemake-logger-plugin-snkmt:0.1.7--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake-logger-plugin-snkmt/0.1.7--pyhdfd78af_0
$ module help quay.io/biocontainers/snakemake-logger-plugin-snkmt/0.1.7--pyhdfd78af_0
```
