...
updated_at: "2026-03-31 05:10:19.347702"
...
```bash
$ shpc install quay.io/biocontainers/pyrle:0.0.43--py311haab0aaa_0
```
...
```bash
$ module load quay.io/biocontainers/pyrle/0.0.43--py311haab0aaa_0
$ module help quay.io/biocontainers/pyrle/0.0.43--py311haab0aaa_0
```
