...
updated_at: "2024-05-01 02:46:57.212778"
latest: "0.0.39--py39hf95cd2a_0"
...
```bash
$ shpc install quay.io/biocontainers/pyrle:0.0.39--py39hf95cd2a_0
```
...
```bash
$ module load quay.io/biocontainers/pyrle/0.0.39--py39hf95cd2a_0
$ module help quay.io/biocontainers/pyrle/0.0.39--py39hf95cd2a_0
```
