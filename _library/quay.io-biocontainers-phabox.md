...
updated_at: "2025-08-14 03:49:17.398331"
...
```bash
$ shpc install quay.io/biocontainers/phabox:2.1.12--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/phabox/2.1.12--pyhdfd78af_0
$ module help quay.io/biocontainers/phabox/2.1.12--pyhdfd78af_0
```
