...
updated_at: "2025-05-11 03:52:53.266620"
...
```bash
$ shpc install quay.io/biocontainers/phabox:2.1.11--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/phabox/2.1.11--pyhdfd78af_0
$ module help quay.io/biocontainers/phabox/2.1.11--pyhdfd78af_0
```
