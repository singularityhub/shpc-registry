...
updated_at: "2024-11-13 03:06:16.903965"
...
```bash
$ shpc install quay.io/biocontainers/phabox:2.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/phabox/2.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/phabox/2.1.0--pyhdfd78af_0
```
