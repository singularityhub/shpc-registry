...
updated_at: "2022-11-03 00:50:52.474656"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hgu133a2frmavecs:1.2.0--r41hdfd78af_9
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hgu133a2frmavecs/1.2.0--r41hdfd78af_9
$ module help quay.io/biocontainers/bioconductor-hgu133a2frmavecs/1.2.0--r41hdfd78af_9
```
