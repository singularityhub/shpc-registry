...
updated_at: "2025-07-28 09:47:16.519352"
latest: "2.0.2--h577a1d6_0"
...
```bash
$ shpc install quay.io/biocontainers/enhjoerning:2.0.2--h577a1d6_0
```
...
```bash
$ module load quay.io/biocontainers/enhjoerning/2.0.2--h577a1d6_0
$ module help quay.io/biocontainers/enhjoerning/2.0.2--h577a1d6_0
```
