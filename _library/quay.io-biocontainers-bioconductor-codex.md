...
updated_at: "2025-08-26 03:26:23.601625"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-codex:1.38.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-codex/1.38.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-codex/1.38.0--r44hdfd78af_0
```
