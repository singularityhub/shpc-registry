...
updated_at: "2024-05-30 04:48:44.235473"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-deseq2:1.42.0--r43hf17093f_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-deseq2/1.42.0--r43hf17093f_1
$ module help quay.io/biocontainers/bioconductor-deseq2/1.42.0--r43hf17093f_1
```
