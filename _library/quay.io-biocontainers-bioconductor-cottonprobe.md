...
updated_at: "2026-04-04 04:27:17.307058"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cottonprobe:2.18.0--r45hdfd78af_14
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cottonprobe/2.18.0--r45hdfd78af_14
$ module help quay.io/biocontainers/bioconductor-cottonprobe/2.18.0--r45hdfd78af_14
```
