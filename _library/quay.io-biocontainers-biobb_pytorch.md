...
updated_at: "2026-03-21 04:48:50.797733"
latest: "5.2.3--pyha658751_0"
...
```bash
$ shpc install quay.io/biocontainers/biobb_pytorch:5.2.3--pyha658751_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_pytorch/5.2.3--pyha658751_0
$ module help quay.io/biocontainers/biobb_pytorch/5.2.3--pyha658751_0
```
