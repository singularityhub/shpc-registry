...
updated_at: "2026-08-25 09:55:47.180908"
latest: "5.3.0--pyha658751_0"
...
```bash
$ shpc install quay.io/biocontainers/biobb_pytorch:5.3.0--pyha658751_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_pytorch/5.3.0--pyha658751_0
$ module help quay.io/biocontainers/biobb_pytorch/5.3.0--pyha658751_0
```
