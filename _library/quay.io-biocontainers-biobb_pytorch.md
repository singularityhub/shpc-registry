...
updated_at: "2026-02-23 05:12:53.633779"
latest: "5.2.1--pyh5a0a8d1_0"
...
```bash
$ shpc install quay.io/biocontainers/biobb_pytorch:5.2.1--pyh5a0a8d1_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_pytorch/5.2.1--pyh5a0a8d1_0
$ module help quay.io/biocontainers/biobb_pytorch/5.2.1--pyh5a0a8d1_0
```
