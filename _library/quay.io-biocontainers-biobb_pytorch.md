...
updated_at: "2024-06-22 03:12:51.411346"
latest: "4.2.1--pyhad2cae4_0"
...
```bash
$ shpc install quay.io/biocontainers/biobb_pytorch:4.2.1--pyhad2cae4_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_pytorch/4.2.1--pyhad2cae4_0
$ module help quay.io/biocontainers/biobb_pytorch/4.2.1--pyhad2cae4_0
```
