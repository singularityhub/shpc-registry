...
updated_at: "2025-03-12 03:31:02.698417"
...
```bash
$ shpc install quay.io/biocontainers/hisat2-pipeline:1.0.8--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hisat2-pipeline/1.0.8--pyhdfd78af_0
$ module help quay.io/biocontainers/hisat2-pipeline/1.0.8--pyhdfd78af_0
```
