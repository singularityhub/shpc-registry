---
layout: container
name:  "quay.io/biocontainers/hisat2-pipeline"
maintainer: "@vsoch"
...
updated_at: "2025-07-29 03:53:04.689279"
...
```bash
$ shpc install quay.io/biocontainers/hisat2-pipeline
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/hisat2-pipeline:1.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hisat2-pipeline/1.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/hisat2-pipeline/1.1.0--pyhdfd78af_0
```
...
#### hisat2-pipeline-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### hisat2-pipeline-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/hisat2-pipeline
$ podman run --it --rm --entrypoint /usr/local/bin/hisat2-pipeline   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/hisat2-pipeline   -v ${PWD} -w ${PWD} <container> -c " $@"
```
