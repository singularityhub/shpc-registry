...
updated_at: "2025-11-13 03:46:03.717815"
...
```bash
$ shpc install quay.io/biocontainers/hisat2-pipeline:1.1.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hisat2-pipeline/1.1.1--pyhdfd78af_0
$ module help quay.io/biocontainers/hisat2-pipeline/1.1.1--pyhdfd78af_0
```
