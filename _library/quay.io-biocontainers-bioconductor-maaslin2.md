...
updated_at: "2026-09-04 07:05:12.986406"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-maaslin2:1.22.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-maaslin2/1.22.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-maaslin2/1.22.0--r45hdfd78af_0
```
