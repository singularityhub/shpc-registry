...
updated_at: "2024-03-09 03:01:16.169057"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-maaslin2:1.16.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-maaslin2/1.16.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-maaslin2/1.16.0--r43hdfd78af_0
```
