---
layout: container
name:  "quay.io/biocontainers/r-smvar"
maintainer: "@vsoch"
...
updated_at: "2024-12-09 03:32:41.894416"
...
```bash
$ shpc install quay.io/biocontainers/r-smvar
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/r-smvar:1.3.3--r3.4.1_0
```
...
```bash
$ module load quay.io/biocontainers/r-smvar/1.3.3--r3.4.1_0
$ module help quay.io/biocontainers/r-smvar/1.3.3--r3.4.1_0
```
...
#### r-smvar-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-smvar-inspect-deffile:
