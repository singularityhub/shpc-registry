...
updated_at: "2024-10-02 02:53:50.920752"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rcyjs:2.24.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rcyjs/2.24.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rcyjs/2.24.0--r43hdfd78af_0
```
