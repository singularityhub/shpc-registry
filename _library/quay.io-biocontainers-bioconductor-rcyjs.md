...
updated_at: "2026-03-28 04:37:54.351450"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rcyjs:2.32.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rcyjs/2.32.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rcyjs/2.32.0--r45hdfd78af_0
```
