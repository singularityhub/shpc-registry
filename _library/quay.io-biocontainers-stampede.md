---
layout: container
name:  "quay.io/biocontainers/stampede"
maintainer: "@vsoch"
...
updated_at: "2026-06-25 06:24:02.088414"
...
versions:
 - "0.2.0--pyhdfd78af_0"
description: "singularity registry hpc automated addition for stampede"
config: {"url": "https://biocontainers.pro/tools/stampede", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for stampede", "latest": {"0.2.0--pyhdfd78af_0": "sha256:7417ed73d24afa15c7dc7d2d4c00ef11781ca04e230875c7b806d1279f8f23af"}, "tags": {"0.2.0--pyhdfd78af_0": "sha256:7417ed73d24afa15c7dc7d2d4c00ef11781ca04e230875c7b806d1279f8f23af"}, "docker": "quay.io/biocontainers/stampede", "aliases": {"session-info2": "/usr/local/bin/session-info2", "session-info": "/usr/local/bin/session-info", "fc-genconf": "/usr/local/bin/fc-genconf", "zarr": "/usr/local/bin/zarr", "igraph": "/usr/local/bin/igraph", "h2benchmark": "/usr/local/bin/h2benchmark", "hb-raster": "/usr/local/bin/hb-raster", "hb-vector": "/usr/local/bin/hb-vector", "scanpy": "/usr/local/bin/scanpy", "checksum-profile": "/usr/local/bin/checksum-profile", "elasticurl": "/usr/local/bin/elasticurl", "numba": "/usr/local/bin/numba", "natsort": "/usr/local/bin/natsort", "hwloc-gather-cpuid": "/usr/local/bin/hwloc-gather-cpuid", "hwloc-annotate": "/usr/local/bin/hwloc-annotate", "hwloc-bind": "/usr/local/bin/hwloc-bind", "hwloc-calc": "/usr/local/bin/hwloc-calc", "hwloc-compress-dir": "/usr/local/bin/hwloc-compress-dir", "hwloc-diff": "/usr/local/bin/hwloc-diff", "hwloc-distrib": "/usr/local/bin/hwloc-distrib", "hwloc-gather-topology": "/usr/local/bin/hwloc-gather-topology", "hwloc-info": "/usr/local/bin/hwloc-info", "hwloc-ls": "/usr/local/bin/hwloc-ls", "hwloc-patch": "/usr/local/bin/hwloc-patch", "hwloc-ps": "/usr/local/bin/hwloc-ps"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/stampede.
singularity registry hpc automated addition for stampede
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/stampede
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/stampede:0.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/stampede/0.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/stampede/0.2.0--pyhdfd78af_0
```
...
#### stampede-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### stampede-inspect-deffile:
