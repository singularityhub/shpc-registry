...
updated_at: "2026-03-22 05:20:59.923282"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-codelink:1.78.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-codelink/1.78.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-codelink/1.78.0--r45hdfd78af_0
```
