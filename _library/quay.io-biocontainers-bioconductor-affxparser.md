...
updated_at: "2024-01-17 02:49:08.406157"
latest: "1.74.0--r43hf17093f_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-affxparser:1.74.0--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-affxparser/1.74.0--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-affxparser/1.74.0--r43hf17093f_0
```
