...
updated_at: "2026-08-28 14:02:58.791904"
latest: "0.11.0--h1f77f1e_0"
...
```bash
$ shpc install quay.io/biocontainers/ferro-hgvs:0.11.0--h1f77f1e_0
```
...
```bash
$ module load quay.io/biocontainers/ferro-hgvs/0.11.0--h1f77f1e_0
$ module help quay.io/biocontainers/ferro-hgvs/0.11.0--h1f77f1e_0
```
