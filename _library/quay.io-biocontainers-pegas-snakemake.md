---
layout: container
name:  "quay.io/biocontainers/pegas-snakemake"
maintainer: "@vsoch"
...
updated_at: "2026-03-30 05:57:09.208060"
...
versions:
 - "1.2.4--pyhdfd78af_0"
description: "singularity registry hpc automated addition for pegas-snakemake"
config: {"url": "https://biocontainers.pro/tools/pegas-snakemake", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for pegas-snakemake", "latest": {"1.2.4--pyhdfd78af_0": "sha256:6aa8db00d9873409e8900e0d7ed7a2f48bcb1f02a61e018e67fa461c36d77272"}, "tags": {"1.2.4--pyhdfd78af_0": "sha256:6aa8db00d9873409e8900e0d7ed7a2f48bcb1f02a61e018e67fa461c36d77272"}, "docker": "quay.io/biocontainers/pegas-snakemake", "aliases": {"menuinst": "/usr/local/bin/menuinst", "pegas": "/usr/local/bin/pegas", "pegas-lite": "/usr/local/bin/pegas-lite", "distro": "/usr/local/bin/distro", "jsondiff": "/usr/local/bin/jsondiff", "jsonpatch": "/usr/local/bin/jsonpatch", "jsonpointer": "/usr/local/bin/jsonpointer", "mamba-package": "/usr/local/bin/mamba-package", "archspec": "/usr/local/bin/archspec", "conda2solv": "/usr/local/bin/conda2solv", "dumpsolv": "/usr/local/bin/dumpsolv", "installcheck": "/usr/local/bin/installcheck", "mergesolv": "/usr/local/bin/mergesolv", "repo2solv": "/usr/local/bin/repo2solv", "testsolv": "/usr/local/bin/testsolv", "conda-env": "/usr/local/bin/conda-env", "cph": "/usr/local/bin/cph", "bsdunzip": "/usr/local/bin/bsdunzip", "rst2html": "/usr/local/bin/rst2html", "rst2html4": "/usr/local/bin/rst2html4", "rst2html5": "/usr/local/bin/rst2html5", "rst2latex": "/usr/local/bin/rst2latex", "rst2man": "/usr/local/bin/rst2man", "rst2odt": "/usr/local/bin/rst2odt", "rst2pseudoxml": "/usr/local/bin/rst2pseudoxml", "rst2s5": "/usr/local/bin/rst2s5", "rst2xetex": "/usr/local/bin/rst2xetex", "rst2xml": "/usr/local/bin/rst2xml"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/pegas-snakemake.
singularity registry hpc automated addition for pegas-snakemake
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/pegas-snakemake
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/pegas-snakemake:1.2.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pegas-snakemake/1.2.4--pyhdfd78af_0
$ module help quay.io/biocontainers/pegas-snakemake/1.2.4--pyhdfd78af_0
```
...
#### pegas-snakemake-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### pegas-snakemake-inspect-deffile:
