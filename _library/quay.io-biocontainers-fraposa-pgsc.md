---
layout: container
name:  "quay.io/biocontainers/fraposa-pgsc"
maintainer: "@vsoch"
...
updated_at: "2024-12-07 01:36:17.717896"
...
```bash
$ shpc install quay.io/biocontainers/fraposa-pgsc
```
...
#### fraposa-pgsc-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### fraposa-pgsc-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/fraposa
$ podman run --it --rm --entrypoint /usr/local/bin/fraposa   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/fraposa   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/fraposa_plot
$ podman run --it --rm --entrypoint /usr/local/bin/fraposa_plot   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/fraposa_plot   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/fraposa_pred
$ podman run --it --rm --entrypoint /usr/local/bin/fraposa_pred   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/fraposa_pred   -v ${PWD} -w ${PWD} <container> -c " $@"
```
