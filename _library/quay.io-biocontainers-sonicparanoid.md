...
updated_at: "2025-12-17 04:13:24.734008"
...
```bash
$ shpc install quay.io/biocontainers/sonicparanoid:2.0.9--py312hc9302aa_0
```
...
```bash
$ module load quay.io/biocontainers/sonicparanoid/2.0.9--py312hc9302aa_0
$ module help quay.io/biocontainers/sonicparanoid/2.0.9--py312hc9302aa_0
```
