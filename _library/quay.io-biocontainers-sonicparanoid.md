...
updated_at: "2025-08-07 03:54:21.926541"
latest: "2.0.8--py310h20b60a1_1"
...
```bash
$ shpc install quay.io/biocontainers/sonicparanoid:2.0.8--py310h20b60a1_1
```
...
```bash
$ module load quay.io/biocontainers/sonicparanoid/2.0.8--py310h20b60a1_1
$ module help quay.io/biocontainers/sonicparanoid/2.0.8--py310h20b60a1_1
```
