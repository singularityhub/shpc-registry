...
updated_at: "2024-07-07 02:52:43.802845"
latest: "1.3.8--py39h0dd7abe_4"
...
```bash
$ shpc install quay.io/biocontainers/sonicparanoid:1.3.8--py39h0dd7abe_4
```
...
```bash
$ module load quay.io/biocontainers/sonicparanoid/1.3.8--py39h0dd7abe_4
$ module help quay.io/biocontainers/sonicparanoid/1.3.8--py39h0dd7abe_4
```
