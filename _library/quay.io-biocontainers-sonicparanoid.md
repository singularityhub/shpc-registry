...
updated_at: "2024-08-01 03:54:23.085835"
latest: "2.0.7--py311h1abe8b6_0"
...
```bash
$ shpc install quay.io/biocontainers/sonicparanoid:2.0.7--py311h1abe8b6_0
```
...
```bash
$ module load quay.io/biocontainers/sonicparanoid/2.0.7--py311h1abe8b6_0
$ module help quay.io/biocontainers/sonicparanoid/2.0.7--py311h1abe8b6_0
```
