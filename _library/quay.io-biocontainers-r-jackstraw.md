...
updated_at: "2026-06-23 06:57:21.120892"
latest: "1.3.21--r45h3342da4_0"
...
```bash
$ shpc install quay.io/biocontainers/r-jackstraw:1.3.21--r45h3342da4_0
```
...
```bash
$ module load quay.io/biocontainers/r-jackstraw/1.3.21--r45h3342da4_0
$ module help quay.io/biocontainers/r-jackstraw/1.3.21--r45h3342da4_0
```
