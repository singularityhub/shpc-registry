...
updated_at: "2023-08-12 02:23:23.645030"
latest: "1.2.2.1--py39hf95cd2a_0"
...
```bash
$ shpc install quay.io/biocontainers/expam:1.2.2.1--py39hf95cd2a_0
```
...
```bash
$ module load quay.io/biocontainers/expam/1.2.2.1--py39hf95cd2a_0
$ module help quay.io/biocontainers/expam/1.2.2.1--py39hf95cd2a_0
```
