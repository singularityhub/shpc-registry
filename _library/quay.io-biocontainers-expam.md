...
updated_at: "2025-05-24 11:52:01.708236"
...
```bash
$ shpc install quay.io/biocontainers/expam:1.4.0.6--py311haab0aaa_0
```
...
```bash
$ module load quay.io/biocontainers/expam/1.4.0.6--py311haab0aaa_0
$ module help quay.io/biocontainers/expam/1.4.0.6--py311haab0aaa_0
```
