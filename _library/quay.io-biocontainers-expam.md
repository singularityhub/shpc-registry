...
updated_at: "2024-12-03 03:40:37.639876"
latest: "1.4.0.5--py310h7c593f9_0"
...
```bash
$ shpc install quay.io/biocontainers/expam:1.4.0.5--py310h7c593f9_0
```
...
```bash
$ module load quay.io/biocontainers/expam/1.4.0.5--py310h7c593f9_0
$ module help quay.io/biocontainers/expam/1.4.0.5--py310h7c593f9_0
```
