...
updated_at: "2024-06-30 03:05:11.679143"
latest: "1.2.2.5--py310h7c593f9_1"
...
```bash
$ shpc install quay.io/biocontainers/expam:1.2.2.5--py310h7c593f9_1
```
...
```bash
$ module load quay.io/biocontainers/expam/1.2.2.5--py310h7c593f9_1
$ module help quay.io/biocontainers/expam/1.2.2.5--py310h7c593f9_1
```
