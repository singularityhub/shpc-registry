...
updated_at: "2025-11-08 03:42:00.932939"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-annotatr:1.32.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-annotatr/1.32.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-annotatr/1.32.0--r44hdfd78af_0
```
