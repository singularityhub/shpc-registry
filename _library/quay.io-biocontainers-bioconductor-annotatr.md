...
updated_at: "2026-03-24 04:39:45.071727"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-annotatr:1.36.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-annotatr/1.36.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-annotatr/1.36.0--r45hdfd78af_0
```
