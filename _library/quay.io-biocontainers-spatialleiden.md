---
layout: container
name:  "quay.io/biocontainers/spatialleiden"
maintainer: "@vsoch"
...
updated_at: "2026-02-07 04:20:01.651327"
...
```bash
$ shpc install quay.io/biocontainers/spatialleiden
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/spatialleiden:0.4.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/spatialleiden/0.4.0--pyhdfd78af_0
$ module help quay.io/biocontainers/spatialleiden/0.4.0--pyhdfd78af_0
```
...
#### spatialleiden-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### spatialleiden-inspect-deffile:
