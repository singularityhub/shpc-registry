...
updated_at: "2024-09-12 16:59:11.715060"
...
```bash
$ shpc install quay.io/biocontainers/spatialleiden:0.1.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/spatialleiden/0.1.1--pyhdfd78af_0
$ module help quay.io/biocontainers/spatialleiden/0.1.1--pyhdfd78af_0
```
