...
updated_at: "2023-09-23 02:38:41.584186"
latest: "0.21.0--pyh7cba7a3_0"
...
```bash
$ shpc install quay.io/biocontainers/pypgx:0.21.0--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/pypgx/0.21.0--pyh7cba7a3_0
$ module help quay.io/biocontainers/pypgx/0.21.0--pyh7cba7a3_0
```
