...
updated_at: "2023-12-26 02:35:28.490078"
latest: "0.22.0--pyh7cba7a3_0"
...
```bash
$ shpc install quay.io/biocontainers/pypgx:0.22.0--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/pypgx/0.22.0--pyh7cba7a3_0
$ module help quay.io/biocontainers/pypgx/0.22.0--pyh7cba7a3_0
```
