...
updated_at: "2026-06-27 06:42:40.110654"
latest: "0.27.0--pyh106432d_0"
...
```bash
$ shpc install quay.io/biocontainers/pypgx:0.27.0--pyh106432d_0
```
...
```bash
$ module load quay.io/biocontainers/pypgx/0.27.0--pyh106432d_0
$ module help quay.io/biocontainers/pypgx/0.27.0--pyh106432d_0
```
