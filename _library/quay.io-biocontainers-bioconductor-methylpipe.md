...
updated_at: "2024-09-01 03:41:06.409920"
latest: "1.36.0--r43ha9d7317_1"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-methylpipe:1.36.0--r43ha9d7317_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-methylpipe/1.36.0--r43ha9d7317_1
$ module help quay.io/biocontainers/bioconductor-methylpipe/1.36.0--r43ha9d7317_1
```
