...
updated_at: "2024-02-27 02:25:42.737588"
...
```bash
$ shpc install quay.io/biocontainers/cgelib:0.7.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/cgelib/0.7.4--pyhdfd78af_0
$ module help quay.io/biocontainers/cgelib/0.7.4--pyhdfd78af_0
```
