...
updated_at: "2025-08-11 04:19:19.810571"
...
```bash
$ shpc install quay.io/biocontainers/novae:0.2.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/novae/0.2.4--pyhdfd78af_0
$ module help quay.io/biocontainers/novae/0.2.4--pyhdfd78af_0
```
