...
updated_at: "2026-04-04 04:35:40.012961"
...
```bash
$ shpc install quay.io/biocontainers/novae:1.0.3--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/novae/1.0.3--pyhdfd78af_1
$ module help quay.io/biocontainers/novae/1.0.3--pyhdfd78af_1
```
