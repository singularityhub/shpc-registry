...
updated_at: "2026-03-23 04:52:09.516031"
...
```bash
$ shpc install quay.io/biocontainers/novae:1.0.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/novae/1.0.3--pyhdfd78af_0
$ module help quay.io/biocontainers/novae/1.0.3--pyhdfd78af_0
```
