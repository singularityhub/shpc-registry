...
updated_at: "2025-12-05 03:48:37.010054"
...
```bash
$ shpc install quay.io/biocontainers/novae:1.0.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/novae/1.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/novae/1.0.0--pyhdfd78af_0
```
