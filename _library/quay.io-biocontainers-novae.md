...
updated_at: "2026-05-30 06:20:17.555757"
...
```bash
$ shpc install quay.io/biocontainers/novae:1.0.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/novae/1.0.5--pyhdfd78af_0
$ module help quay.io/biocontainers/novae/1.0.5--pyhdfd78af_0
```
