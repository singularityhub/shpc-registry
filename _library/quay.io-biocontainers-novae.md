---
layout: container
name:  "quay.io/biocontainers/novae"
maintainer: "@vsoch"
...
updated_at: "2026-07-02 06:28:03.381132"
...
```bash
$ module load quay.io/biocontainers/novae/1.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/novae/1.1.0--pyhdfd78af_0
```
...
#### novae-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### novae-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/lightning
$ podman run --it --rm --entrypoint /usr/local/bin/lightning   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/lightning   -v ${PWD} -w ${PWD} <container> -c " $@"
```
