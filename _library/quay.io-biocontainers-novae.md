...
updated_at: "2026-08-06 05:42:58.760847"
...
```bash
$ shpc install quay.io/biocontainers/novae:1.1.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/novae/1.1.1--pyhdfd78af_0
$ module help quay.io/biocontainers/novae/1.1.1--pyhdfd78af_0
```
