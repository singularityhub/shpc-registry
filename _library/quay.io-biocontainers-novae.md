...
updated_at: "2026-06-28 06:46:50.399890"
...
```bash
$ shpc install quay.io/biocontainers/novae:1.0.5--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/novae/1.0.5--pyhdfd78af_1
$ module help quay.io/biocontainers/novae/1.0.5--pyhdfd78af_1
```
