...
updated_at: "2025-03-27 04:05:29.221383"
...
```bash
$ shpc install quay.io/biocontainers/novae:0.2.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/novae/0.2.2--pyhdfd78af_0
$ module help quay.io/biocontainers/novae/0.2.2--pyhdfd78af_0
```
