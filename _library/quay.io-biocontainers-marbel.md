---
layout: container
name:  "quay.io/biocontainers/marbel"
maintainer: "@vsoch"
...
updated_at: "2025-10-23 03:32:31.831797"
...
singularity registry hpc automated addition for marbel
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/marbel
```
...
#### marbel-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### marbel-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/marbel
$ podman run --it --rm --entrypoint /usr/local/bin/marbel   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/marbel   -v ${PWD} -w ${PWD} <container> -c " $@"
```
