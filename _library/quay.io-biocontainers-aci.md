---
layout: container
name:  "quay.io/biocontainers/aci"
maintainer: "@vsoch"
...
updated_at: "2025-12-19 05:36:59.923548"
latest: "1.45.251125--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/aci
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/aci:1.45.251125--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/aci/1.45.251125--pyhdfd78af_0
$ module help quay.io/biocontainers/aci/1.45.251125--pyhdfd78af_0
```
...
```bash
$ singularity exec <container> /usr/local/bin/aci
$ podman run --it --rm --entrypoint /usr/local/bin/aci   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/aci   -v ${PWD} -w ${PWD} <container> -c " $@"
```
