...
updated_at: "2025-09-22 03:18:01.110672"
...
```bash
$ shpc install quay.io/biocontainers/neofox:1.2.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/neofox/1.2.3--pyhdfd78af_0
$ module help quay.io/biocontainers/neofox/1.2.3--pyhdfd78af_0
```
