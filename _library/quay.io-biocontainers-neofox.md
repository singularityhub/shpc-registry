...
updated_at: "2025-03-26 03:45:11.751460"
...
```bash
$ shpc install quay.io/biocontainers/neofox:1.2.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/neofox/1.2.2--pyhdfd78af_0
$ module help quay.io/biocontainers/neofox/1.2.2--pyhdfd78af_0
```
