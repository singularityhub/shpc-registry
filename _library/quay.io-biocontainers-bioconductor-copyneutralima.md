...
updated_at: "2023-10-29 03:05:22.258042"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-copyneutralima:1.18.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-copyneutralima/1.18.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-copyneutralima/1.18.0--r43hdfd78af_0
```
