...
updated_at: "2022-11-21 13:09:13.465138"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-copyneutralima:1.12.0--r41hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-copyneutralima/1.12.0--r41hdfd78af_1
$ module help quay.io/biocontainers/bioconductor-copyneutralima/1.12.0--r41hdfd78af_1
```
