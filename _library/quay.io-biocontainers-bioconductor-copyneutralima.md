...
updated_at: "2024-09-29 03:11:25.069316"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-copyneutralima:1.20.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-copyneutralima/1.20.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-copyneutralima/1.20.0--r43hdfd78af_0
```
