...
updated_at: "2025-07-26 04:16:35.935013"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-copyneutralima:1.24.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-copyneutralima/1.24.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-copyneutralima/1.24.0--r44hdfd78af_0
```
