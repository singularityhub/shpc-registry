...
updated_at: "2023-09-27 03:09:15.057573"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-methylclock:1.6.0--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-methylclock/1.6.0--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-methylclock/1.6.0--r43hf17093f_0
```
