...
updated_at: "2026-08-21 15:57:22.122439"
...
```bash
$ shpc install quay.io/biocontainers/biobb_gromacs:5.3.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_gromacs/5.3.1--pyhdfd78af_0
$ module help quay.io/biocontainers/biobb_gromacs/5.3.1--pyhdfd78af_0
```
