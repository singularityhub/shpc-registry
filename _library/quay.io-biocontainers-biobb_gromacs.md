...
updated_at: "2026-03-28 05:00:17.164815"
...
```bash
$ shpc install quay.io/biocontainers/biobb_gromacs:5.2.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_gromacs/5.2.1--pyhdfd78af_0
$ module help quay.io/biocontainers/biobb_gromacs/5.2.1--pyhdfd78af_0
```
