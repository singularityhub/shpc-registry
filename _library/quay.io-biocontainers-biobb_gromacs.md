...
updated_at: "2026-02-02 12:55:43.860028"
...
```bash
$ shpc install quay.io/biocontainers/biobb_gromacs:5.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_gromacs/5.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/biobb_gromacs/5.2.0--pyhdfd78af_0
```
