...
updated_at: "2025-12-29 04:43:11.816939"
...
```bash
$ shpc install quay.io/biocontainers/biobb_gromacs:5.1.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_gromacs/5.1.2--pyhdfd78af_0
$ module help quay.io/biocontainers/biobb_gromacs/5.1.2--pyhdfd78af_0
```
