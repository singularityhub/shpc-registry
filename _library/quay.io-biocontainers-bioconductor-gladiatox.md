...
updated_at: "2025-01-08 06:35:20.645888"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gladiatox:1.22.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gladiatox/1.22.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-gladiatox/1.22.0--r44hdfd78af_0
```
