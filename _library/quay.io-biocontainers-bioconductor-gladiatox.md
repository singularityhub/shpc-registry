...
updated_at: "2026-02-23 06:09:39.609809"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gladiatox:1.26.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gladiatox/1.26.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-gladiatox/1.26.0--r45hdfd78af_0
```
