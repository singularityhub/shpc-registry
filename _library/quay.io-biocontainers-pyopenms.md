...
updated_at: "2026-08-25 03:35:00.422747"
latest: "3.5.0--py310h546f850_1"
...
```bash
$ shpc install quay.io/biocontainers/pyopenms:3.5.0--py310h546f850_1
```
...
```bash
$ module load quay.io/biocontainers/pyopenms/3.5.0--py310h546f850_1
$ module help quay.io/biocontainers/pyopenms/3.5.0--py310h546f850_1
```
