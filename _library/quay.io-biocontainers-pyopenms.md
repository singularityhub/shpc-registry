...
updated_at: "2025-04-21 05:11:07.424868"
latest: "3.3.0--py39h85de438_5"
...
```bash
$ shpc install quay.io/biocontainers/pyopenms:3.3.0--py39h85de438_5
```
...
```bash
$ module load quay.io/biocontainers/pyopenms/3.3.0--py39h85de438_5
$ module help quay.io/biocontainers/pyopenms/3.3.0--py39h85de438_5
```
