...
updated_at: "2025-08-21 06:43:47.779174"
latest: "3.4.1--py311he9bd0e4_0"
...
```bash
$ shpc install quay.io/biocontainers/pyopenms:3.4.1--py311he9bd0e4_0
```
...
```bash
$ module load quay.io/biocontainers/pyopenms/3.4.1--py311he9bd0e4_0
$ module help quay.io/biocontainers/pyopenms/3.4.1--py311he9bd0e4_0
```
