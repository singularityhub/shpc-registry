...
updated_at: "2023-07-24 05:13:36.558126"
latest: "2.9.1--py311h9b8898c_3"
...
```bash
$ shpc install quay.io/biocontainers/pyopenms:2.9.1--py311h9b8898c_3
```
...
```bash
$ module load quay.io/biocontainers/pyopenms/2.9.1--py311h9b8898c_3
$ module help quay.io/biocontainers/pyopenms/2.9.1--py311h9b8898c_3
```
