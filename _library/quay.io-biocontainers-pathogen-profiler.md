...
updated_at: "2022-11-27 12:12:52.144099"
latest: "2.0.2--pyh7cba7a3_0"
...
```bash
$ shpc install quay.io/biocontainers/pathogen-profiler:2.0.2--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/pathogen-profiler/2.0.2--pyh7cba7a3_0
$ module help quay.io/biocontainers/pathogen-profiler/2.0.2--pyh7cba7a3_0
```
