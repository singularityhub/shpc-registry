...
updated_at: "2022-11-03 01:01:30.206338"
latest: "2.0.1--pypyh5e36f6f_0"
...
```bash
$ shpc install quay.io/biocontainers/pathogen-profiler:2.0.1--pypyh5e36f6f_0
```
...
```bash
$ module load quay.io/biocontainers/pathogen-profiler/2.0.1--pypyh5e36f6f_0
$ module help quay.io/biocontainers/pathogen-profiler/2.0.1--pypyh5e36f6f_0
```
