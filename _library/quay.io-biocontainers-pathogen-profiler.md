...
updated_at: "2023-02-05 03:07:16.329269"
latest: "2.0.2--pyh7cba7a3_1"
...
```bash
$ shpc install quay.io/biocontainers/pathogen-profiler:2.0.2--pyh7cba7a3_1
```
...
```bash
$ module load quay.io/biocontainers/pathogen-profiler/2.0.2--pyh7cba7a3_1
$ module help quay.io/biocontainers/pathogen-profiler/2.0.2--pyh7cba7a3_1
```
