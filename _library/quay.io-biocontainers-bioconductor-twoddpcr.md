...
updated_at: "2023-09-28 03:01:09.455786"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-twoddpcr:1.24.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-twoddpcr/1.24.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-twoddpcr/1.24.0--r43hdfd78af_0
```
