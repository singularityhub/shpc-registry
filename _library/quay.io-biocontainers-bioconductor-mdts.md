...
updated_at: "2023-12-21 03:04:17.379845"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mdts:1.20.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mdts/1.20.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-mdts/1.20.0--r43hdfd78af_0
```
