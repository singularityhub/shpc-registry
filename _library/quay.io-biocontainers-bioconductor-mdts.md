...
updated_at: "2023-06-15 03:48:44.303802"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mdts:1.18.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mdts/1.18.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-mdts/1.18.0--r42hdfd78af_0
```
