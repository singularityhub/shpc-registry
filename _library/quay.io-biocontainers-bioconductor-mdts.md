...
updated_at: "2026-04-05 05:17:16.313922"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mdts:1.30.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mdts/1.30.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-mdts/1.30.0--r45hdfd78af_0
```
