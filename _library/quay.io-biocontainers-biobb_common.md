...
updated_at: "2026-03-30 06:21:54.267132"
...
```bash
$ shpc install quay.io/biocontainers/biobb_common:5.2.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_common/5.2.2--pyhdfd78af_0
$ module help quay.io/biocontainers/biobb_common/5.2.2--pyhdfd78af_0
```
