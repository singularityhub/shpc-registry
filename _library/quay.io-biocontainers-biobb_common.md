...
updated_at: "2025-01-07 03:02:35.261016"
...
```bash
$ shpc install quay.io/biocontainers/biobb_common:5.0.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_common/5.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/biobb_common/5.0.0--pyhdfd78af_0
```
