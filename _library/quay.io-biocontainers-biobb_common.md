...
updated_at: "2026-06-22 08:15:06.292099"
...
```bash
$ shpc install quay.io/biocontainers/biobb_common:5.3.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_common/5.3.1--pyhdfd78af_0
$ module help quay.io/biocontainers/biobb_common/5.3.1--pyhdfd78af_0
```
