...
updated_at: "2025-07-31 04:12:02.625879"
...
```bash
$ shpc install quay.io/biocontainers/biobb_common:5.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_common/5.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/biobb_common/5.1.0--pyhdfd78af_0
```
