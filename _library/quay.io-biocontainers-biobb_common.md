...
updated_at: "2025-05-22 03:50:45.148177"
...
```bash
$ shpc install quay.io/biocontainers/biobb_common:5.0.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_common/5.0.1--pyhdfd78af_0
$ module help quay.io/biocontainers/biobb_common/5.0.1--pyhdfd78af_0
```
