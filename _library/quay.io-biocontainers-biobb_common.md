...
updated_at: "2024-10-15 03:32:42.458186"
...
```bash
$ shpc install quay.io/biocontainers/biobb_common:4.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_common/4.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/biobb_common/4.2.0--pyhdfd78af_0
```
