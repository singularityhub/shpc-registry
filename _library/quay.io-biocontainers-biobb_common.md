...
updated_at: "2026-03-01 05:06:26.166085"
...
```bash
$ shpc install quay.io/biocontainers/biobb_common:5.2.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_common/5.2.1--pyhdfd78af_0
$ module help quay.io/biocontainers/biobb_common/5.2.1--pyhdfd78af_0
```
