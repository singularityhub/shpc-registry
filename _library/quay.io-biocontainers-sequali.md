...
updated_at: "2024-06-08 03:09:01.938680"
latest: "0.10.0--py312hf67a6ed_1"
...
```bash
$ shpc install quay.io/biocontainers/sequali:0.10.0--py312hf67a6ed_1
```
...
```bash
$ module load quay.io/biocontainers/sequali/0.10.0--py312hf67a6ed_1
$ module help quay.io/biocontainers/sequali/0.10.0--py312hf67a6ed_1
```
