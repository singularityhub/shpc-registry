...
updated_at: "2025-03-25 03:35:45.318564"
latest: "0.12.0--py311haab0aaa_1"
...
```bash
$ shpc install quay.io/biocontainers/sequali:0.12.0--py311haab0aaa_1
```
...
```bash
$ module load quay.io/biocontainers/sequali/0.12.0--py311haab0aaa_1
$ module help quay.io/biocontainers/sequali/0.12.0--py311haab0aaa_1
```
