...
updated_at: "2025-10-06 06:17:15.091651"
latest: "1.0.2--py310h1fe012e_0"
...
```bash
$ shpc install quay.io/biocontainers/sequali:1.0.2--py310h1fe012e_0
```
...
```bash
$ module load quay.io/biocontainers/sequali/1.0.2--py310h1fe012e_0
$ module help quay.io/biocontainers/sequali/1.0.2--py310h1fe012e_0
```
