...
updated_at: "2024-04-02 03:02:04.380471"
...
```bash
$ shpc install quay.io/biocontainers/trtools:6.0.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/trtools/6.0.1--pyhdfd78af_0
$ module help quay.io/biocontainers/trtools/6.0.1--pyhdfd78af_0
```
