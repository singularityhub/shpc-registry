...
updated_at: "2024-03-15 02:58:30.708949"
latest: "6.0.0--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/trtools:6.0.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/trtools/6.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/trtools/6.0.0--pyhdfd78af_0
```
