---
layout: container
name:  "quay.io/biocontainers/r-survey"
maintainer: "@vsoch"
...
updated_at: "2025-10-20 03:28:07.626232"
...
```bash
$ shpc install quay.io/biocontainers/r-survey
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/r-survey:3.31_5--r3.3.1_0
```
...
```bash
$ module load quay.io/biocontainers/r-survey/3.31_5--r3.3.1_0
$ module help quay.io/biocontainers/r-survey/3.31_5--r3.3.1_0
```
...
#### r-survey-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-survey-inspect-deffile:
