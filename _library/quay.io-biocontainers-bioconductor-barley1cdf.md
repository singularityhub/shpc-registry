...
updated_at: "2022-10-29 18:29:35.035386"
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-barley1cdf-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-barley1cdf-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-barley1cdf-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-barley1cdf-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-barley1cdf-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-barley1cdf-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
