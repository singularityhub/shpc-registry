...
updated_at: "2023-08-12 02:23:30.310508"
...
```bash
$ shpc install quay.io/biocontainers/metasnek:0.0.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/metasnek/0.0.5--pyhdfd78af_0
$ module help quay.io/biocontainers/metasnek/0.0.5--pyhdfd78af_0
```
