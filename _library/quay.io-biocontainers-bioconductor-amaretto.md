...
updated_at: "2022-10-27 00:53:14.238316"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-amaretto:1.8.0--r41h399db7b_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-amaretto/1.8.0--r41h399db7b_0
$ module help quay.io/biocontainers/bioconductor-amaretto/1.8.0--r41h399db7b_0
```
