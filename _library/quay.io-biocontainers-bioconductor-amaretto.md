...
updated_at: "2023-07-29 03:25:26.710058"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-amaretto:1.16.0--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-amaretto/1.16.0--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-amaretto/1.16.0--r43hf17093f_0
```
