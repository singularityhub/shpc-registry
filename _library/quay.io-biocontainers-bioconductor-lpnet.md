...
updated_at: "2026-03-05 00:47:18.584700"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-lpnet:2.42.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-lpnet/2.42.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-lpnet/2.42.0--r45hdfd78af_0
```
