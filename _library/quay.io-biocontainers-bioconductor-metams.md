...
updated_at: "2026-04-21 05:38:02.734218"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-metams:1.46.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-metams/1.46.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-metams/1.46.0--r45hdfd78af_0
```
