---
layout: container
name:  "quay.io/biocontainers/bioconductor-tdbasedufeadv"
maintainer: "@vsoch"
...
updated_at: "2026-03-30 06:17:28.579266"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-tdbasedufeadv
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-tdbasedufeadv:1.10.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-tdbasedufeadv/1.10.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-tdbasedufeadv/1.10.0--r45hdfd78af_0
```
...
#### bioconductor-tdbasedufeadv-run:
...
#### bioconductor-tdbasedufeadv-shell:
...
#### bioconductor-tdbasedufeadv-exec:
...
#### bioconductor-tdbasedufeadv-inspect:
...
#### bioconductor-tdbasedufeadv-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-tdbasedufeadv-inspect-deffile:
