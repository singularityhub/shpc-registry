...
updated_at: "2022-11-03 00:43:43.104778"
...
```bash
$ shpc install quay.io/biocontainers/gatk:3.8--9
```
...
```bash
$ module load quay.io/biocontainers/gatk/3.8--9
$ module help quay.io/biocontainers/gatk/3.8--9
```
