...
updated_at: "2025-03-22 03:00:59.166973"
...
```bash
$ shpc install quay.io/biocontainers/cleanifier:0.1.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/cleanifier/0.1.3--pyhdfd78af_0
$ module help quay.io/biocontainers/cleanifier/0.1.3--pyhdfd78af_0
```
