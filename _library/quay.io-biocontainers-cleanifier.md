...
updated_at: "2025-11-09 04:03:41.992264"
...
```bash
$ shpc install quay.io/biocontainers/cleanifier:1.1.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/cleanifier/1.1.4--pyhdfd78af_0
$ module help quay.io/biocontainers/cleanifier/1.1.4--pyhdfd78af_0
```
