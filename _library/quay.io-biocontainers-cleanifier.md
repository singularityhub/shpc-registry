...
updated_at: "2025-05-17 03:54:52.987268"
...
```bash
$ shpc install quay.io/biocontainers/cleanifier:1.0.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/cleanifier/1.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/cleanifier/1.0.0--pyhdfd78af_0
```
