...
updated_at: "2025-09-28 03:55:45.735433"
...
```bash
$ shpc install quay.io/biocontainers/cleanifier:1.1.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/cleanifier/1.1.3--pyhdfd78af_0
$ module help quay.io/biocontainers/cleanifier/1.1.3--pyhdfd78af_0
```
