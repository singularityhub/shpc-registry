...
updated_at: "2025-08-05 03:53:50.882300"
...
```bash
$ shpc install quay.io/biocontainers/cleanifier:1.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/cleanifier/1.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/cleanifier/1.1.0--pyhdfd78af_0
```
