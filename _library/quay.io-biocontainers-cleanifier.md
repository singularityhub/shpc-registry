...
updated_at: "2025-08-28 12:00:48.735879"
...
```bash
$ shpc install quay.io/biocontainers/cleanifier:1.1.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/cleanifier/1.1.2--pyhdfd78af_0
$ module help quay.io/biocontainers/cleanifier/1.1.2--pyhdfd78af_0
```
