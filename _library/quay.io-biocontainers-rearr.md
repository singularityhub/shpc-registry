...
updated_at: "2026-06-22 08:13:56.034529"
latest: "1.0.15--hd63eeec_0"
...
```bash
$ shpc install quay.io/biocontainers/rearr:1.0.15--hd63eeec_0
```
...
```bash
$ module load quay.io/biocontainers/rearr/1.0.15--hd63eeec_0
$ module help quay.io/biocontainers/rearr/1.0.15--hd63eeec_0
```
