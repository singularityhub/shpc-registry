...
updated_at: "2026-06-27 06:41:35.190803"
...
```bash
$ shpc install quay.io/biocontainers/busco:6.1.0--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/busco/6.1.0--pyhdfd78af_1
$ module help quay.io/biocontainers/busco/6.1.0--pyhdfd78af_1
```
