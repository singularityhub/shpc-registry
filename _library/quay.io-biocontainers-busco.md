...
updated_at: "2025-05-25 03:26:09.674215"
latest: "5.8.3--pyhdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/busco:5.8.3--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/busco/5.8.3--pyhdfd78af_1
$ module help quay.io/biocontainers/busco/5.8.3--pyhdfd78af_1
```
