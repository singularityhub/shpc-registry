...
updated_at: "2024-03-22 03:02:16.973192"
latest: "5.7.0--pyhdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/busco:5.7.0--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/busco/5.7.0--pyhdfd78af_1
$ module help quay.io/biocontainers/busco/5.7.0--pyhdfd78af_1
```
