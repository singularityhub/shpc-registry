...
updated_at: "2024-09-10 02:58:38.221450"
latest: "5.7.1--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/busco:5.7.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/busco/5.7.1--pyhdfd78af_0
$ module help quay.io/biocontainers/busco/5.7.1--pyhdfd78af_0
```
