...
updated_at: "2024-09-22 03:24:16.800861"
latest: "5.7.1--pyhdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/busco:5.7.1--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/busco/5.7.1--pyhdfd78af_1
$ module help quay.io/biocontainers/busco/5.7.1--pyhdfd78af_1
```
