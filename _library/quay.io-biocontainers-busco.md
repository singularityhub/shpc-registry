...
updated_at: "2025-10-31 03:25:07.403979"
latest: "6.0.0--pyhdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/busco:6.0.0--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/busco/6.0.0--pyhdfd78af_1
$ module help quay.io/biocontainers/busco/6.0.0--pyhdfd78af_1
```
