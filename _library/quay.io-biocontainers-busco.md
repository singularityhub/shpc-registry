...
updated_at: "2026-08-26 03:14:42.092526"
latest: "6.1.0--pyhdfd78af_2"
...
```bash
$ shpc install quay.io/biocontainers/busco:6.1.0--pyhdfd78af_2
```
...
```bash
$ module load quay.io/biocontainers/busco/6.1.0--pyhdfd78af_2
$ module help quay.io/biocontainers/busco/6.1.0--pyhdfd78af_2
```
