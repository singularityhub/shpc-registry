...
updated_at: "2026-05-11 06:32:03.273543"
latest: "6.0.0--pyhdfd78af_3"
...
```bash
$ shpc install quay.io/biocontainers/busco:6.0.0--pyhdfd78af_3
```
...
```bash
$ module load quay.io/biocontainers/busco/6.0.0--pyhdfd78af_3
$ module help quay.io/biocontainers/busco/6.0.0--pyhdfd78af_3
```
