...
updated_at: "2026-01-23 03:58:32.248952"
latest: "6.0.0--pyhdfd78af_2"
...
```bash
$ shpc install quay.io/biocontainers/busco:6.0.0--pyhdfd78af_2
```
...
```bash
$ module load quay.io/biocontainers/busco/6.0.0--pyhdfd78af_2
$ module help quay.io/biocontainers/busco/6.0.0--pyhdfd78af_2
```
