...
updated_at: "2025-09-05 03:19:43.369917"
...
```bash
$ shpc install quay.io/biocontainers/busco:6.0.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/busco/6.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/busco/6.0.0--pyhdfd78af_0
```
