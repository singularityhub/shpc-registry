...
updated_at: "2024-12-12 03:39:48.902164"
latest: "5.8.0--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/busco:5.8.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/busco/5.8.0--pyhdfd78af_0
$ module help quay.io/biocontainers/busco/5.8.0--pyhdfd78af_0
```
