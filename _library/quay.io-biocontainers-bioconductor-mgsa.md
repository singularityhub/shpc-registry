...
updated_at: "2024-04-18 02:56:38.765649"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mgsa:1.50.0--r43ha9d7317_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mgsa/1.50.0--r43ha9d7317_1
$ module help quay.io/biocontainers/bioconductor-mgsa/1.50.0--r43ha9d7317_1
```
