...
updated_at: "2026-09-25 07:58:18.684785"
...
```bash
$ shpc install quay.io/biocontainers/unimeth:0.3.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/unimeth/0.3.1--pyhdfd78af_0
$ module help quay.io/biocontainers/unimeth/0.3.1--pyhdfd78af_0
```
