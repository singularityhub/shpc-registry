...
updated_at: "2025-04-22 03:27:09.007923"
latest: "4.28.0--r44hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-teqc:4.28.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-teqc/4.28.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-teqc/4.28.0--r44hdfd78af_0
```
