...
updated_at: "2023-12-14 02:36:35.154652"
latest: "4.22.0--r43hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-teqc:4.22.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-teqc/4.22.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-teqc/4.22.0--r43hdfd78af_0
```
