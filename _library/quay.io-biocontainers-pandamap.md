---
layout: container
name:  "quay.io/biocontainers/pandamap"
maintainer: "@vsoch"
...
updated_at: "2026-02-19 05:15:16.200366"
...
```bash
$ module load quay.io/biocontainers/pandamap/4.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/pandamap/4.1.0--pyhdfd78af_0
```
...
#### pandamap-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### pandamap-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/pandamap
$ podman run --it --rm --entrypoint /usr/local/bin/pandamap   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/pandamap   -v ${PWD} -w ${PWD} <container> -c " $@"
```
