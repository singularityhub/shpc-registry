...
updated_at: "2026-01-15 03:58:26.344541"
...
```bash
$ shpc install quay.io/biocontainers/sdrf-pipelines:0.0.33--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sdrf-pipelines/0.0.33--pyhdfd78af_0
$ module help quay.io/biocontainers/sdrf-pipelines/0.0.33--pyhdfd78af_0
```
