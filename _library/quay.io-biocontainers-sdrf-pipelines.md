...
updated_at: "2025-01-04 02:57:43.464435"
...
```bash
$ shpc install quay.io/biocontainers/sdrf-pipelines:0.0.31--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sdrf-pipelines/0.0.31--pyhdfd78af_0
$ module help quay.io/biocontainers/sdrf-pipelines/0.0.31--pyhdfd78af_0
```
