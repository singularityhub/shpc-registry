...
updated_at: "2026-06-29 07:35:41.408739"
...
```bash
$ shpc install quay.io/biocontainers/sdrf-pipelines:0.1.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sdrf-pipelines/0.1.5--pyhdfd78af_0
$ module help quay.io/biocontainers/sdrf-pipelines/0.1.5--pyhdfd78af_0
```
