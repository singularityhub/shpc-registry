...
updated_at: "2026-03-26 05:17:31.910406"
...
```bash
$ shpc install quay.io/biocontainers/sdrf-pipelines:0.1.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sdrf-pipelines/0.1.1--pyhdfd78af_0
$ module help quay.io/biocontainers/sdrf-pipelines/0.1.1--pyhdfd78af_0
```
