...
updated_at: "2026-03-10 04:23:19.849800"
...
```bash
$ shpc install quay.io/biocontainers/sdrf-pipelines:0.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sdrf-pipelines/0.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/sdrf-pipelines/0.1.0--pyhdfd78af_0
```
