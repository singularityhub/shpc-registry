...
updated_at: "2026-06-04 00:14:58.804701"
...
```bash
$ shpc install quay.io/biocontainers/sdrf-pipelines:0.1.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sdrf-pipelines/0.1.4--pyhdfd78af_0
$ module help quay.io/biocontainers/sdrf-pipelines/0.1.4--pyhdfd78af_0
```
