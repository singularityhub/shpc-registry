...
updated_at: "2026-05-05 05:22:53.701158"
...
```bash
$ shpc install quay.io/biocontainers/sdrf-pipelines:0.1.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sdrf-pipelines/0.1.2--pyhdfd78af_0
$ module help quay.io/biocontainers/sdrf-pipelines/0.1.2--pyhdfd78af_0
```
