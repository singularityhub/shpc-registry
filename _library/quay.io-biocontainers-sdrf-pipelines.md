...
updated_at: "2024-08-12 03:34:42.770493"
latest: "0.0.27--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/sdrf-pipelines:0.0.27--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sdrf-pipelines/0.0.27--pyhdfd78af_0
$ module help quay.io/biocontainers/sdrf-pipelines/0.0.27--pyhdfd78af_0
```
