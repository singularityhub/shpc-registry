...
updated_at: "2025-12-15 04:36:29.927357"
...
```bash
$ shpc install quay.io/biocontainers/cmappy:4.0.1--py39h2de1943_8
```
...
```bash
$ module load quay.io/biocontainers/cmappy/4.0.1--py39h2de1943_8
$ module help quay.io/biocontainers/cmappy/4.0.1--py39h2de1943_8
```
