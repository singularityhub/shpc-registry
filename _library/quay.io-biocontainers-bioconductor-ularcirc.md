...
updated_at: "2026-03-21 04:50:09.134696"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ularcirc:1.28.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ularcirc/1.28.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ularcirc/1.28.0--r45hdfd78af_0
```
