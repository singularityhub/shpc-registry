...
updated_at: "2024-02-22 03:02:44.216310"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ularcirc:1.20.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ularcirc/1.20.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ularcirc/1.20.0--r43hdfd78af_0
```
