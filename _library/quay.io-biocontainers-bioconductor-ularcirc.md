...
updated_at: "2025-09-14 03:45:36.361566"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ularcirc:1.24.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ularcirc/1.24.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ularcirc/1.24.0--r44hdfd78af_0
```
