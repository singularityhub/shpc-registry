...
updated_at: "2025-02-14 02:56:24.904322"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-intansv:1.46.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-intansv/1.46.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-intansv/1.46.0--r44hdfd78af_0
```
