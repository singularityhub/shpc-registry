...
updated_at: "2026-03-05 05:12:55.656264"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-all:1.52.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-all/1.52.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-all/1.52.0--r45hdfd78af_0
```
