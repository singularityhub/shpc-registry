...
updated_at: "2024-12-15 03:24:32.938688"
latest: "2.32.1--r43hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rtcgatoolbox:2.32.1--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rtcgatoolbox/2.32.1--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rtcgatoolbox/2.32.1--r43hdfd78af_0
```
