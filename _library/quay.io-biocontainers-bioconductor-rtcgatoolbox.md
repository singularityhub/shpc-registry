...
updated_at: "2022-11-21 13:18:56.103255"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rtcgatoolbox:2.8.0--r3.4.1_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rtcgatoolbox/2.8.0--r3.4.1_0
$ module help quay.io/biocontainers/bioconductor-rtcgatoolbox/2.8.0--r3.4.1_0
```
