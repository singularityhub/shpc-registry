...
updated_at: "2026-03-26 05:06:25.129503"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-arraymvout:1.68.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-arraymvout/1.68.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-arraymvout/1.68.0--r45hdfd78af_0
```
