...
updated_at: "2023-12-01 02:51:42.162969"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-celda:1.16.1--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-celda/1.16.1--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-celda/1.16.1--r43hf17093f_0
```
