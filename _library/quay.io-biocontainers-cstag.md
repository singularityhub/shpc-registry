...
updated_at: "2025-11-15 03:21:31.471215"
...
```bash
$ shpc install quay.io/biocontainers/cstag:1.1.0--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/cstag/1.1.0--pyhdfd78af_1
$ module help quay.io/biocontainers/cstag/1.1.0--pyhdfd78af_1
```
