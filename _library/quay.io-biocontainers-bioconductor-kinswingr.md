...
updated_at: "2026-04-04 05:03:41.047683"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-kinswingr:1.28.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-kinswingr/1.28.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-kinswingr/1.28.0--r45hdfd78af_0
```
