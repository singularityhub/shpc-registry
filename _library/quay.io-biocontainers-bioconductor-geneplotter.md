...
updated_at: "2026-03-16 05:27:47.029660"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-geneplotter:1.88.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-geneplotter/1.88.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-geneplotter/1.88.0--r45hdfd78af_0
```
