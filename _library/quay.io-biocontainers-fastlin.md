...
updated_at: "2025-06-06 12:49:33.147197"
latest: "0.4.2--h4349ce8_0"
...
```bash
$ shpc install quay.io/biocontainers/fastlin:0.4.2--h4349ce8_0
```
...
```bash
$ module load quay.io/biocontainers/fastlin/0.4.2--h4349ce8_0
$ module help quay.io/biocontainers/fastlin/0.4.2--h4349ce8_0
```
