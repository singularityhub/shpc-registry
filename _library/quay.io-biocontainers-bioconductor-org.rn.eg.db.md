...
updated_at: "2025-08-09 03:29:42.967017"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-org.rn.eg.db:3.20.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-org.rn.eg.db/3.20.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-org.rn.eg.db/3.20.0--r44hdfd78af_0
```
