---
layout: container
name:  "quay.io/biocontainers/perl-xml-dom-xpath"
maintainer: "@vsoch"
...
updated_at: "2024-12-05 03:42:17.569635"
...
```bash
$ shpc install quay.io/biocontainers/perl-xml-dom-xpath
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/perl-xml-dom-xpath:0.14--pl5321hdfd78af_2
```
...
```bash
$ module load quay.io/biocontainers/perl-xml-dom-xpath/0.14--pl5321hdfd78af_2
$ module help quay.io/biocontainers/perl-xml-dom-xpath/0.14--pl5321hdfd78af_2
```
...
#### perl-xml-dom-xpath-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### perl-xml-dom-xpath-inspect-deffile:
