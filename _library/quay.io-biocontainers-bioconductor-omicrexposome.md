...
updated_at: "2026-04-01 05:10:22.737418"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-omicrexposome:1.32.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-omicrexposome/1.32.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-omicrexposome/1.32.0--r45hdfd78af_0
```
