...
updated_at: "2025-02-14 03:35:39.344491"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-omicrexposome:1.28.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-omicrexposome/1.28.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-omicrexposome/1.28.0--r44hdfd78af_0
```
