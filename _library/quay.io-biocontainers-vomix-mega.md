---
layout: container
name:  "quay.io/biocontainers/vomix-mega"
maintainer: "@vsoch"
github: "https://github.com/singularityhub/shpc-registry/blob/main/quay.io/biocontainers/vomix-mega/container.yaml"
config_url: "https://raw.githubusercontent.com/singularityhub/shpc-registry/main/quay.io/biocontainers/vomix-mega/container.yaml"
updated_at: "2026-09-04 07:55:50.077330"
latest: "0.1.0--pyhdfd78af_0"
container_url: "https://biocontainers.pro/tools/vomix-mega"
aliases:
 - "vomix"
 - "phc"
 - "eido"
...
versions:
 - "0.1.0--pyhdfd78af_0"
description: "singularity registry hpc automated addition for vomix-mega"
config: {"url": "https://biocontainers.pro/tools/vomix-mega", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for vomix-mega", "latest": {"0.1.0--pyhdfd78af_0": "sha256:d6dcf336e0a6cf06d43a9aa196b997e74250e2914d9b795c3abdc491c5352021"}, "tags": {"0.1.0--pyhdfd78af_0": "sha256:d6dcf336e0a6cf06d43a9aa196b997e74250e2914d9b795c3abdc491c5352021"}, "docker": "quay.io/biocontainers/vomix-mega", "aliases": {"vomix": "/usr/local/bin/vomix", "phc": "/usr/local/bin/phc", "eido": "/usr/local/bin/eido", "rich-click": "/usr/local/bin/rich-click", "idna": "/usr/local/bin/idna", "rst2html": "/usr/local/bin/rst2html", "rst2html4": "/usr/local/bin/rst2html4", "rst2html5": "/usr/local/bin/rst2html5", "rst2latex": "/usr/local/bin/rst2latex", "rst2man": "/usr/local/bin/rst2man", "rst2odt": "/usr/local/bin/rst2odt", "rst2pseudoxml": "/usr/local/bin/rst2pseudoxml", "rst2s5": "/usr/local/bin/rst2s5", "rst2xetex": "/usr/local/bin/rst2xetex", "rst2xml": "/usr/local/bin/rst2xml", "typer": "/usr/local/bin/typer", "yte": "/usr/local/bin/yte", "coloredlogs": "/usr/local/bin/coloredlogs", "pulptest": "/usr/local/bin/pulptest", "docutils": "/usr/local/bin/docutils", "snakemake": "/usr/local/bin/snakemake", "cbc": "/usr/local/bin/cbc", "clp": "/usr/local/bin/clp", "humanfriendly": "/usr/local/bin/humanfriendly", "jupyter-trust": "/usr/local/bin/jupyter-trust", "tabulate": "/usr/local/bin/tabulate"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/vomix-mega.
singularity registry hpc automated addition for vomix-mega
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/vomix-mega
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/vomix-mega:0.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/vomix-mega/0.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/vomix-mega/0.1.0--pyhdfd78af_0
```
...
#### vomix-mega-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### vomix-mega-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/vomix
$ podman run --it --rm --entrypoint /usr/local/bin/vomix   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/vomix   -v ${PWD} -w ${PWD} <container> -c " $@"
```
