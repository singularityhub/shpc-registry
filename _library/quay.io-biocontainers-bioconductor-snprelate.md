...
updated_at: "2026-02-26 04:36:11.785428"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-snprelate:1.44.0--r45ha27e39d_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-snprelate/1.44.0--r45ha27e39d_0
$ module help quay.io/biocontainers/bioconductor-snprelate/1.44.0--r45ha27e39d_0
```
