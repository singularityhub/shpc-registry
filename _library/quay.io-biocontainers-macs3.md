...
updated_at: "2026-03-19 04:31:56.371466"
...
```bash
$ shpc install quay.io/biocontainers/macs3:3.0.4--py310h5a5e57a_0
```
...
```bash
$ module load quay.io/biocontainers/macs3/3.0.4--py310h5a5e57a_0
$ module help quay.io/biocontainers/macs3/3.0.4--py310h5a5e57a_0
```
