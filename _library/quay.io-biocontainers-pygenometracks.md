...
updated_at: "2025-09-18 03:03:48.661023"
...
```bash
$ shpc install quay.io/biocontainers/pygenometracks:3.9--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pygenometracks/3.9--pyhdfd78af_0
$ module help quay.io/biocontainers/pygenometracks/3.9--pyhdfd78af_0
```
