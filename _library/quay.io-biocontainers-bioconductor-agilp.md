...
updated_at: "2026-03-01 04:32:56.994340"
latest: "3.42.0--r45hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-agilp:3.42.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-agilp/3.42.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-agilp/3.42.0--r45hdfd78af_0
```
