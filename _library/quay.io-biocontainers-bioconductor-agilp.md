...
updated_at: "2023-08-29 03:50:34.339913"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-agilp:3.32.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-agilp/3.32.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-agilp/3.32.0--r43hdfd78af_0
```
