...
updated_at: "2025-10-14 03:18:11.363383"
latest: "3.38.0--r44hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-agilp:3.38.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-agilp/3.38.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-agilp/3.38.0--r44hdfd78af_0
```
