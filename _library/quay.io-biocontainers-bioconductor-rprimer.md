...
updated_at: "2023-11-03 02:56:54.869601"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rprimer:1.4.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rprimer/1.4.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rprimer/1.4.0--r43hdfd78af_0
```
