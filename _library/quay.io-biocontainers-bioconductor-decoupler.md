...
updated_at: "2026-03-28 04:59:37.832474"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-decoupler:2.16.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-decoupler/2.16.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-decoupler/2.16.0--r45hdfd78af_0
```
