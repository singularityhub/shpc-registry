...
updated_at: "2022-11-07 23:50:35.681025"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-qsea:1.8.0--r351h14c3975_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-qsea/1.8.0--r351h14c3975_0
$ module help quay.io/biocontainers/bioconductor-qsea/1.8.0--r351h14c3975_0
```
