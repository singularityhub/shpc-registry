...
updated_at: "2023-09-18 03:19:06.025463"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-scgps:1.14.1--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-scgps/1.14.1--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-scgps/1.14.1--r43hf17093f_0
```
