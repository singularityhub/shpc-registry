...
updated_at: "2024-11-03 03:05:20.980020"
latest: "8.24.0--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/snakemake:8.24.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake/8.24.0--hdfd78af_0
$ module help quay.io/biocontainers/snakemake/8.24.0--hdfd78af_0
```
