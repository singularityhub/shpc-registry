...
updated_at: "2024-12-18 03:05:11.566924"
latest: "8.25.3--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/snakemake:8.25.3--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake/8.25.3--hdfd78af_0
$ module help quay.io/biocontainers/snakemake/8.25.3--hdfd78af_0
```
