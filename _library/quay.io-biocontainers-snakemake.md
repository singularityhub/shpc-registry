...
updated_at: "2026-04-26 05:15:36.677559"
latest: "9.19.0--hdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/snakemake:9.19.0--hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/snakemake/9.19.0--hdfd78af_1
$ module help quay.io/biocontainers/snakemake/9.19.0--hdfd78af_1
```
