...
updated_at: "2025-12-15 04:20:37.537257"
latest: "9.13.7--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/snakemake:9.13.7--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake/9.13.7--hdfd78af_0
$ module help quay.io/biocontainers/snakemake/9.13.7--hdfd78af_0
```
