...
updated_at: "2024-10-13 10:39:48.300479"
latest: "8.20.4--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/snakemake:8.20.4--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake/8.20.4--hdfd78af_0
$ module help quay.io/biocontainers/snakemake/8.20.4--hdfd78af_0
```
