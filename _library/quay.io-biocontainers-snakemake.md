...
updated_at: "2025-01-20 02:56:04.501519"
latest: "8.25.5--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/snakemake:8.25.5--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake/8.25.5--hdfd78af_0
$ module help quay.io/biocontainers/snakemake/8.25.5--hdfd78af_0
```
