...
updated_at: "2026-05-22 06:35:35.460451"
latest: "9.21.0--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/snakemake:9.21.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake/9.21.0--hdfd78af_0
$ module help quay.io/biocontainers/snakemake/9.21.0--hdfd78af_0
```
