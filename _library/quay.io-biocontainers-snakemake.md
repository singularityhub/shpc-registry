...
updated_at: "2024-08-03 03:09:01.289538"
latest: "8.16.0--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/snakemake:8.16.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake/8.16.0--hdfd78af_0
$ module help quay.io/biocontainers/snakemake/8.16.0--hdfd78af_0
```
