...
updated_at: "2026-01-19 04:27:40.576228"
latest: "9.14.5--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/snakemake:9.14.5--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake/9.14.5--hdfd78af_0
$ module help quay.io/biocontainers/snakemake/9.14.5--hdfd78af_0
```
