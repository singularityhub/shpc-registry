...
updated_at: "2024-07-22 03:30:07.101617"
latest: "8.14.0--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/snakemake:8.14.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake/8.14.0--hdfd78af_0
$ module help quay.io/biocontainers/snakemake/8.14.0--hdfd78af_0
```
