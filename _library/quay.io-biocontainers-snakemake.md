...
updated_at: "2025-07-02 03:30:36.707897"
latest: "9.6.1--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/snakemake:9.6.1--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake/9.6.1--hdfd78af_0
$ module help quay.io/biocontainers/snakemake/9.6.1--hdfd78af_0
```
