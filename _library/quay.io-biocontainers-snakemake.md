...
updated_at: "2026-07-01 07:13:35.403772"
latest: "9.23.1--hdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/snakemake:9.23.1--hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/snakemake/9.23.1--hdfd78af_1
$ module help quay.io/biocontainers/snakemake/9.23.1--hdfd78af_1
```
