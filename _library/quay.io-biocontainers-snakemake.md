...
updated_at: "2026-04-04 05:09:14.014809"
latest: "9.17.2--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/snakemake:9.17.2--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake/9.17.2--hdfd78af_0
$ module help quay.io/biocontainers/snakemake/9.17.2--hdfd78af_0
```
