...
updated_at: "2026-01-31 04:42:47.884942"
latest: "9.15.0--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/snakemake:9.15.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake/9.15.0--hdfd78af_0
$ module help quay.io/biocontainers/snakemake/9.15.0--hdfd78af_0
```
