...
updated_at: "2025-05-26 12:00:50.722840"
latest: "9.5.0--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/snakemake:9.5.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake/9.5.0--hdfd78af_0
$ module help quay.io/biocontainers/snakemake/9.5.0--hdfd78af_0
```
