...
updated_at: "2026-09-05 06:52:13.295551"
latest: "9.25.2--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/snakemake:9.25.2--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake/9.25.2--hdfd78af_0
$ module help quay.io/biocontainers/snakemake/9.25.2--hdfd78af_0
```
