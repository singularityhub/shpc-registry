...
updated_at: "2026-07-23 06:09:46.080190"
latest: "9.23.1--hdfd78af_2"
...
```bash
$ shpc install quay.io/biocontainers/snakemake:9.23.1--hdfd78af_2
```
...
```bash
$ module load quay.io/biocontainers/snakemake/9.23.1--hdfd78af_2
$ module help quay.io/biocontainers/snakemake/9.23.1--hdfd78af_2
```
