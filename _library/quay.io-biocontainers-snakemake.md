...
updated_at: "2025-04-06 03:05:50.933694"
latest: "9.1.1--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/snakemake:9.1.1--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake/9.1.1--hdfd78af_0
$ module help quay.io/biocontainers/snakemake/9.1.1--hdfd78af_0
```
