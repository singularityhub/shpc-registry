...
updated_at: "2026-03-06 04:46:25.862921"
latest: "9.16.3--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/snakemake:9.16.3--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake/9.16.3--hdfd78af_0
$ module help quay.io/biocontainers/snakemake/9.16.3--hdfd78af_0
```
