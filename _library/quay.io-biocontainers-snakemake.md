...
updated_at: "2026-09-22 07:32:09.234031"
latest: "9.26.1--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/snakemake:9.26.1--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake/9.26.1--hdfd78af_0
$ module help quay.io/biocontainers/snakemake/9.26.1--hdfd78af_0
```
