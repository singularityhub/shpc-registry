...
updated_at: "2025-03-09 02:34:35.824013"
latest: "8.28.0--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/snakemake:8.28.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake/8.28.0--hdfd78af_0
$ module help quay.io/biocontainers/snakemake/8.28.0--hdfd78af_0
```
