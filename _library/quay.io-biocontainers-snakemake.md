...
updated_at: "2025-10-28 03:44:33.830186"
latest: "9.13.4--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/snakemake:9.13.4--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake/9.13.4--hdfd78af_0
$ module help quay.io/biocontainers/snakemake/9.13.4--hdfd78af_0
```
