...
updated_at: "2025-10-09 03:35:02.316783"
latest: "9.11.4--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/snakemake:9.11.4--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake/9.11.4--hdfd78af_0
$ module help quay.io/biocontainers/snakemake/9.11.4--hdfd78af_0
```
