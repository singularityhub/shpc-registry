...
updated_at: "2025-09-16 03:27:10.489844"
latest: "9.9.0--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/snakemake:9.9.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake/9.9.0--hdfd78af_0
$ module help quay.io/biocontainers/snakemake/9.9.0--hdfd78af_0
```
