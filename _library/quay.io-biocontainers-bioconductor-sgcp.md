...
updated_at: "2024-01-05 03:05:26.488497"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-sgcp:1.2.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-sgcp/1.2.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-sgcp/1.2.0--r43hdfd78af_0
```
