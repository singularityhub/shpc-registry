...
updated_at: "2023-12-14 02:33:42.163775"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-sgcp:1.0.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-sgcp/1.0.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-sgcp/1.0.0--r43hdfd78af_0
```
