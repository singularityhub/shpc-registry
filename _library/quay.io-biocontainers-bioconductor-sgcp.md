---
layout: container
name:  "quay.io/biocontainers/bioconductor-sgcp"
maintainer: "@vsoch"
github: "https://github.com/singularityhub/shpc-registry/blob/main/quay.io/biocontainers/bioconductor-sgcp/container.yaml"
config_url: "https://raw.githubusercontent.com/singularityhub/shpc-registry/main/quay.io/biocontainers/bioconductor-sgcp/container.yaml"
updated_at: "2026-01-21 03:59:32.282151"
latest: "1.6.0--r44hdfd78af_0"
container_url: "https://biocontainers.pro/tools/bioconductor-sgcp"
aliases:
 - "hb-info"
 - "tjbench"
 - "2to3-3.11"
...
versions:
 ...
 - "1.2.0--r43hdfd78af_0"
 - "1.6.0--r44hdfd78af_0"
description: "singularity registry hpc automated addition for bioconductor-sgcp"
config: {"url": "https://biocontainers.pro/tools/bioconductor-sgcp", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for bioconductor-sgcp", "latest": {"1.6.0--r44hdfd78af_0": "sha256:cdc2b317f8bf10e649c91e5803f134b6871be3fcbb81f25247ff63d7ef874796"}, "tags": {"1.0.0--r43hdfd78af_0": "sha256:2c973d0c0a117ab77d8d7968d8dd592b383cb70cf50c59dd5ed8e62a5179509b", "1.2.0--r43hdfd78af_0": "sha256:95320069154d0284acf26fa38853a2231cc626c6e56c5078da61e20021fe65e3", "1.6.0--r44hdfd78af_0": "sha256:cdc2b317f8bf10e649c91e5803f134b6871be3fcbb81f25247ff63d7ef874796"}, "docker": "quay.io/biocontainers/bioconductor-sgcp", "aliases": {"hb-info": "/usr/local/bin/hb-info", "tjbench": "/usr/local/bin/tjbench", "2to3-3.11": "/usr/local/bin/2to3-3.11", "idle3.11": "/usr/local/bin/idle3.11", "pydoc3.11": "/usr/local/bin/pydoc3.11", "python3.11": "/usr/local/bin/python3.11", "python3.11-config": "/usr/local/bin/python3.11-config", "installBiocDataPackage.sh": "/usr/local/bin/installBiocDataPackage.sh", "tomlq": "/usr/local/bin/tomlq", "xq": "/usr/local/bin/xq", "yq": "/usr/local/bin/yq", "jq": "/usr/local/bin/jq", "onig-config": "/usr/local/bin/onig-config", "activate-global-python-argcomplete": "/usr/local/bin/activate-global-python-argcomplete", "python-argcomplete-check-easy-install-script": "/usr/local/bin/python-argcomplete-check-easy-install-script", "register-python-argcomplete": "/usr/local/bin/register-python-argcomplete", "python3.1": "/usr/local/bin/python3.1"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/bioconductor-sgcp.
singularity registry hpc automated addition for bioconductor-sgcp
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/bioconductor-sgcp
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-sgcp:1.6.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-sgcp/1.6.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-sgcp/1.6.0--r44hdfd78af_0
```
...
#### bioconductor-sgcp-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-sgcp-inspect-deffile:
