...
updated_at: "2025-08-19 03:38:55.047135"
latest: "13.30--pl5321hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/perl-image-exiftool:13.30--pl5321hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/perl-image-exiftool/13.30--pl5321hdfd78af_0
$ module help quay.io/biocontainers/perl-image-exiftool/13.30--pl5321hdfd78af_0
```
