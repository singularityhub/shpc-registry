...
updated_at: "2026-01-19 05:20:45.752806"
...
```bash
$ shpc install quay.io/biocontainers/gpsw:0.9.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/gpsw/0.9.1--pyhdfd78af_0
$ module help quay.io/biocontainers/gpsw/0.9.1--pyhdfd78af_0
```
