...
updated_at: "2025-06-02 12:54:59.716540"
...
```bash
$ shpc install quay.io/biocontainers/gpsw:0.6.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/gpsw/0.6.3--pyhdfd78af_0
$ module help quay.io/biocontainers/gpsw/0.6.3--pyhdfd78af_0
```
