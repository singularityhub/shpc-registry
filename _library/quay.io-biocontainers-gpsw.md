...
updated_at: "2026-06-21 07:32:24.194077"
...
```bash
$ shpc install quay.io/biocontainers/gpsw:0.9.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/gpsw/0.9.2--pyhdfd78af_0
$ module help quay.io/biocontainers/gpsw/0.9.2--pyhdfd78af_0
```
