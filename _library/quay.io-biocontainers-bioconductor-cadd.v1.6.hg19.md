---
layout: container
name:  "quay.io/biocontainers/bioconductor-cadd.v1.6.hg19"
maintainer: "@vsoch"
...
updated_at: "2026-03-31 04:49:00.962207"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cadd.v1.6.hg19
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-cadd.v1.6.hg19:3.18.1--r45hdfd78af_2
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cadd.v1.6.hg19/3.18.1--r45hdfd78af_2
$ module help quay.io/biocontainers/bioconductor-cadd.v1.6.hg19/3.18.1--r45hdfd78af_2
```
...
#### bioconductor-cadd.v1.6.hg19-run:
...
#### bioconductor-cadd.v1.6.hg19-shell:
...
#### bioconductor-cadd.v1.6.hg19-exec:
...
#### bioconductor-cadd.v1.6.hg19-inspect:
...
#### bioconductor-cadd.v1.6.hg19-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-cadd.v1.6.hg19-inspect-deffile:
