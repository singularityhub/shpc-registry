...
updated_at: "2026-03-26 05:12:48.968053"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-epimutacionsdata:1.14.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-epimutacionsdata/1.14.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-epimutacionsdata/1.14.0--r45hdfd78af_0
```
