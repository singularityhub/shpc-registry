...
updated_at: "2023-12-09 03:10:23.562368"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-epimutacionsdata:1.4.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-epimutacionsdata/1.4.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-epimutacionsdata/1.4.0--r43hdfd78af_0
```
