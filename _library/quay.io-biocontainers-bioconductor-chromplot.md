...
updated_at: "2023-10-24 02:43:40.227431"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-chromplot:1.28.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-chromplot/1.28.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-chromplot/1.28.0--r43hdfd78af_0
```
