...
updated_at: "2024-04-11 02:36:11.775484"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-chromplot:1.30.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-chromplot/1.30.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-chromplot/1.30.0--r43hdfd78af_0
```
