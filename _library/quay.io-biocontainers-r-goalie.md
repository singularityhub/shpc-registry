...
updated_at: "2026-06-30 06:36:38.405606"
latest: "0.7.10--r45hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/r-goalie:0.7.10--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/r-goalie/0.7.10--r45hdfd78af_0
$ module help quay.io/biocontainers/r-goalie/0.7.10--r45hdfd78af_0
```
