...
updated_at: "2025-08-09 03:36:27.901651"
...
```bash
$ shpc install quay.io/biocontainers/mumemto:1.3.2--py311he264feb_0
```
...
```bash
$ module load quay.io/biocontainers/mumemto/1.3.2--py311he264feb_0
$ module help quay.io/biocontainers/mumemto/1.3.2--py311he264feb_0
```
