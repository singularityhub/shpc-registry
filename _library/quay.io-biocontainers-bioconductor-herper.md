...
updated_at: "2023-08-07 03:25:20.279471"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-herper:1.10.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-herper/1.10.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-herper/1.10.0--r43hdfd78af_0
```
