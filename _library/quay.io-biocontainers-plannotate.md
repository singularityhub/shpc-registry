...
updated_at: "2026-08-21 03:10:56.034914"
...
```bash
$ shpc install quay.io/biocontainers/plannotate:2.0.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/plannotate/2.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/plannotate/2.0.0--pyhdfd78af_0
```
