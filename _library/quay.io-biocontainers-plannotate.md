...
updated_at: "2025-04-22 03:45:51.242823"
latest: "1.2.3--pypyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/plannotate:1.2.3--pypyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/plannotate/1.2.3--pypyhdfd78af_0
$ module help quay.io/biocontainers/plannotate/1.2.3--pypyhdfd78af_0
```
