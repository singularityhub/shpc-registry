...
updated_at: "2025-10-06 06:34:01.137565"
...
```bash
$ shpc install quay.io/biocontainers/plannotate:1.2.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/plannotate/1.2.4--pyhdfd78af_0
$ module help quay.io/biocontainers/plannotate/1.2.4--pyhdfd78af_0
```
