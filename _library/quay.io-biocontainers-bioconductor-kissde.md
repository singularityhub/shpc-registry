...
updated_at: "2026-03-28 17:19:53.331608"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-kissde:1.30.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-kissde/1.30.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-kissde/1.30.0--r45hdfd78af_0
```
