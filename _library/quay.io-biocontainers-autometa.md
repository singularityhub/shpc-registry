...
updated_at: "2024-04-10 02:24:30.293294"
latest: "2.2.1--pyh7cba7a3_0"
...
```bash
$ shpc install quay.io/biocontainers/autometa:2.2.1--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/autometa/2.2.1--pyh7cba7a3_0
$ module help quay.io/biocontainers/autometa/2.2.1--pyh7cba7a3_0
```
