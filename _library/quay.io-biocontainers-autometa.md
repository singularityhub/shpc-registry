...
updated_at: "2024-06-19 02:38:46.177643"
latest: "2.2.2--pyh7cba7a3_0"
...
```bash
$ shpc install quay.io/biocontainers/autometa:2.2.2--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/autometa/2.2.2--pyh7cba7a3_0
$ module help quay.io/biocontainers/autometa/2.2.2--pyh7cba7a3_0
```
