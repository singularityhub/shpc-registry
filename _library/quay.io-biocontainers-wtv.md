...
updated_at: "2026-09-04 07:54:08.814372"
...
```bash
$ shpc install quay.io/biocontainers/wtv:0.2.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/wtv/0.2.1--pyhdfd78af_0
$ module help quay.io/biocontainers/wtv/0.2.1--pyhdfd78af_0
```
