---
layout: container
name:  "quay.io/biocontainers/bioconductor-iscream"
maintainer: "@vsoch"
...
updated_at: "2026-03-02 04:49:08.090090"
...
versions:
 - "1.0.0--r45ha27e39d_0"
description: "singularity registry hpc automated addition for bioconductor-iscream"
config: {"url": "https://biocontainers.pro/tools/bioconductor-iscream", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for bioconductor-iscream", "latest": {"1.0.0--r45ha27e39d_0": "sha256:79080a85c6614749cb08abda90fc256cb45270b0f22f08222949970277c5f161"}, "tags": {"1.0.0--r45ha27e39d_0": "sha256:79080a85c6614749cb08abda90fc256cb45270b0f22f08222949970277c5f161"}, "docker": "quay.io/biocontainers/bioconductor-iscream", "aliases": {"x86_64-conda-linux-gnu.cfg": "/usr/local/bin/x86_64-conda-linux-gnu.cfg", "hwloc-gather-cpuid": "/usr/local/bin/hwloc-gather-cpuid", "hwloc-annotate": "/usr/local/bin/hwloc-annotate", "hwloc-bind": "/usr/local/bin/hwloc-bind", "hwloc-calc": "/usr/local/bin/hwloc-calc", "hwloc-compress-dir": "/usr/local/bin/hwloc-compress-dir", "hwloc-diff": "/usr/local/bin/hwloc-diff", "hwloc-distrib": "/usr/local/bin/hwloc-distrib", "hwloc-gather-topology": "/usr/local/bin/hwloc-gather-topology", "hwloc-info": "/usr/local/bin/hwloc-info", "hwloc-ls": "/usr/local/bin/hwloc-ls", "hwloc-patch": "/usr/local/bin/hwloc-patch", "hwloc-ps": "/usr/local/bin/hwloc-ps", "lstopo": "/usr/local/bin/lstopo", "lstopo-no-graphics": "/usr/local/bin/lstopo-no-graphics", "hb-info": "/usr/local/bin/hb-info", "tjbench": "/usr/local/bin/tjbench"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/bioconductor-iscream.
singularity registry hpc automated addition for bioconductor-iscream
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/bioconductor-iscream
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-iscream:1.0.0--r45ha27e39d_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-iscream/1.0.0--r45ha27e39d_0
$ module help quay.io/biocontainers/bioconductor-iscream/1.0.0--r45ha27e39d_0
```
...
#### bioconductor-iscream-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-iscream-inspect-deffile:
