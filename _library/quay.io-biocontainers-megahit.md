...
updated_at: "2024-05-09 03:13:51.977516"
latest: "1.2.9--h43eeafb_5"
...
```bash
$ shpc install quay.io/biocontainers/megahit:1.2.9--h43eeafb_5
```
...
```bash
$ module load quay.io/biocontainers/megahit/1.2.9--h43eeafb_5
$ module help quay.io/biocontainers/megahit/1.2.9--h43eeafb_5
```
