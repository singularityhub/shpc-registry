...
updated_at: "2023-11-24 03:09:54.714065"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hicdatahumanimr90:1.20.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hicdatahumanimr90/1.20.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-hicdatahumanimr90/1.20.0--r43hdfd78af_0
```
