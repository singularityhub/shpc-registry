...
updated_at: "2024-01-22 03:36:32.621967"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hicdatahumanimr90:1.22.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hicdatahumanimr90/1.22.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-hicdatahumanimr90/1.22.0--r43hdfd78af_0
```
