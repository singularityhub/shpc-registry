...
updated_at: "2026-02-19 07:43:05.604227"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hicdatahumanimr90:1.30.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hicdatahumanimr90/1.30.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-hicdatahumanimr90/1.30.0--r45hdfd78af_0
```
