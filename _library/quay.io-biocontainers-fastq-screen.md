...
updated_at: "2022-11-13 00:08:20.618758"
latest: "0.5.2--1"
...
```bash
$ shpc install quay.io/biocontainers/fastq-screen:0.5.2--1
```
...
```bash
$ module load quay.io/biocontainers/fastq-screen/0.5.2--1
$ module help quay.io/biocontainers/fastq-screen/0.5.2--1
```
