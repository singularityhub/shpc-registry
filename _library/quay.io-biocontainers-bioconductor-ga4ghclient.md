...
updated_at: "2025-12-12 03:58:17.717519"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ga4ghclient:1.30.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ga4ghclient/1.30.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ga4ghclient/1.30.0--r44hdfd78af_0
```
