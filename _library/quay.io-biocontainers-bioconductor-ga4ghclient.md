...
updated_at: "2026-04-05 04:53:04.768796"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ga4ghclient:1.34.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ga4ghclient/1.34.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ga4ghclient/1.34.0--r45hdfd78af_0
```
