...
updated_at: "2025-11-17 03:25:06.256271"
latest: "1.2.0--h5ca1c30_3"
...
```bash
$ shpc install quay.io/biocontainers/short-read-connector:1.2.0--h5ca1c30_3
```
...
```bash
$ module load quay.io/biocontainers/short-read-connector/1.2.0--h5ca1c30_3
$ module help quay.io/biocontainers/short-read-connector/1.2.0--h5ca1c30_3
```
