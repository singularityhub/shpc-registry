...
updated_at: "2023-01-13 03:32:40.226633"
latest: "16--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/hicmatrix:16--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hicmatrix/16--pyhdfd78af_0
$ module help quay.io/biocontainers/hicmatrix/16--pyhdfd78af_0
```
