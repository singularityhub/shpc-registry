...
updated_at: "2022-10-27 00:22:47.632057"
...
```bash
$ shpc install quay.io/biocontainers/primalscheme:1.3.2--pyh3252c3a_0
```
...
```bash
$ module load quay.io/biocontainers/primalscheme/1.3.2--pyh3252c3a_0
$ module help quay.io/biocontainers/primalscheme/1.3.2--pyh3252c3a_0
```
