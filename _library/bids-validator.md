...
updated_at: "2025-10-21 04:00:01.931254"
latest: "2.1.0"
...
```bash
$ shpc install bids/validator:2.1.0
```
...
```bash
$ module load bids/validator/2.1.0
$ module help bids/validator/2.1.0
```
