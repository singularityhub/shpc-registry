...
updated_at: "2025-11-18 04:08:20.199015"
latest: "2.2.0"
...
```bash
$ shpc install bids/validator:2.2.0
```
...
```bash
$ module load bids/validator/2.2.0
$ module help bids/validator/2.2.0
```
