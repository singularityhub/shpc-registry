...
updated_at: "2026-04-04 04:38:25.269385"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-davidtiling:1.50.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-davidtiling/1.50.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-davidtiling/1.50.0--r45hdfd78af_0
```
