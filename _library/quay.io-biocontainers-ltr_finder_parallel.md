...
updated_at: "2026-04-04 04:42:45.576322"
...
```bash
$ shpc install quay.io/biocontainers/ltr_finder_parallel:1.4--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ltr_finder_parallel/1.4--hdfd78af_0
$ module help quay.io/biocontainers/ltr_finder_parallel/1.4--hdfd78af_0
```
