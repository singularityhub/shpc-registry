...
updated_at: "2024-02-29 02:59:08.577091"
...
```bash
$ shpc install quay.io/biocontainers/ltr_finder_parallel:1.1--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ltr_finder_parallel/1.1--hdfd78af_0
$ module help quay.io/biocontainers/ltr_finder_parallel/1.1--hdfd78af_0
```
