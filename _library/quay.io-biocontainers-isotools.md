---
layout: container
name:  "quay.io/biocontainers/isotools"
maintainer: "@vsoch"
...
updated_at: "2025-07-31 11:18:35.139987"
...
singularity registry hpc automated addition for isotools
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/isotools
```
...
#### isotools-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### isotools-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/cpat
$ podman run --it --rm --entrypoint /usr/local/bin/cpat   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/cpat   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/make_hexamer_tab
$ podman run --it --rm --entrypoint /usr/local/bin/make_hexamer_tab   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/make_hexamer_tab   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/make_logitModel
$ podman run --it --rm --entrypoint /usr/local/bin/make_logitModel   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/make_logitModel   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/run_isotools
$ podman run --it --rm --entrypoint /usr/local/bin/run_isotools   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/run_isotools   -v ${PWD} -w ${PWD} <container> -c " $@"
```
