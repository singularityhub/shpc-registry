...
updated_at: "2026-08-27 12:47:00.440311"
...
```bash
$ shpc install quay.io/biocontainers/kleboscope:1.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/kleboscope/1.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/kleboscope/1.2.0--pyhdfd78af_0
```
