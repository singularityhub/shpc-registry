...
updated_at: "2026-06-25 06:37:48.681522"
...
```bash
$ shpc install quay.io/biocontainers/kleboscope:1.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/kleboscope/1.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/kleboscope/1.1.0--pyhdfd78af_0
```
