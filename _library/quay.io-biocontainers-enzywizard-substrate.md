---
layout: container
name:  "quay.io/biocontainers/enzywizard-substrate"
maintainer: "@vsoch"
...
updated_at: "2026-07-02 06:42:35.311915"
...
singularity registry hpc automated addition for enzywizard-substrate
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/enzywizard-substrate
```
...
#### enzywizard-substrate-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### enzywizard-substrate-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/enzywizard-substrate
$ podman run --it --rm --entrypoint /usr/local/bin/enzywizard-substrate   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/enzywizard-substrate   -v ${PWD} -w ${PWD} <container> -c " $@"
```
