---
layout: container
name:  "quay.io/biocontainers/bioconductor-cbnplot"
maintainer: "@vsoch"
...
updated_at: "2026-04-03 15:35:48.561503"
...
config: {"url": "https://biocontainers.pro/tools/bioconductor-cbnplot", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for bioconductor-cbnplot", "latest": {"1.10.0--r45hdfd78af_0": "sha256:0d371f3e1a28fb94848cc3dc669d5fe773ba44e74c9aa3ab0d44614de4d64e87"}, "tags": {"1.0.0--r43hdfd78af_0": "sha256:65e1d7e76b656ce3a68624c170036f42136d877be6d4f79123d5adfa39249e2b", "1.2.0--r43hdfd78af_0": "sha256:799d454a9d8cbaed098534a1220abc6f2c4dd498271a05cecc04056797cd621d", "1.6.0--r44hdfd78af_0": "sha256:50e926dac75cf1f830a33983c53a29d5e9897d7a4aecc241ef943e98ad5ff896", "1.10.0--r45hdfd78af_0": "sha256:0d371f3e1a28fb94848cc3dc669d5fe773ba44e74c9aa3ab0d44614de4d64e87"}, "docker": "quay.io/biocontainers/bioconductor-cbnplot", "aliases": {"hb-info": "/usr/local/bin/hb-info", "tjbench": "/usr/local/bin/tjbench", "glpsol": "/usr/local/bin/glpsol", "2to3-3.11": "/usr/local/bin/2to3-3.11", "idle3.11": "/usr/local/bin/idle3.11", "pydoc3.11": "/usr/local/bin/pydoc3.11", "python3.11": "/usr/local/bin/python3.11", "python3.11-config": "/usr/local/bin/python3.11-config", "installBiocDataPackage.sh": "/usr/local/bin/installBiocDataPackage.sh", "tomlq": "/usr/local/bin/tomlq", "xq": "/usr/local/bin/xq", "yq": "/usr/local/bin/yq", "jq": "/usr/local/bin/jq", "onig-config": "/usr/local/bin/onig-config", "activate-global-python-argcomplete": "/usr/local/bin/activate-global-python-argcomplete", "python-argcomplete-check-easy-install-script": "/usr/local/bin/python-argcomplete-check-easy-install-script", "register-python-argcomplete": "/usr/local/bin/register-python-argcomplete", "pandoc": "/usr/local/bin/pandoc", "python3.1": "/usr/local/bin/python3.1"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/bioconductor-cbnplot.
singularity registry hpc automated addition for bioconductor-cbnplot
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/bioconductor-cbnplot
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-cbnplot:1.10.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cbnplot/1.10.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-cbnplot/1.10.0--r45hdfd78af_0
```
...
#### bioconductor-cbnplot-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-cbnplot-inspect-deffile:
