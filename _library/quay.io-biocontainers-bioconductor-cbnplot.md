...
updated_at: "2025-04-12 03:43:51.272560"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cbnplot:1.6.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cbnplot/1.6.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-cbnplot/1.6.0--r44hdfd78af_0
```
