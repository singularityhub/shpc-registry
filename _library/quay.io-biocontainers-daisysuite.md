...
updated_at: "2025-11-30 03:59:50.733122"
...
```bash
$ shpc install quay.io/biocontainers/daisysuite:1.3.0--hdfd78af_3
```
...
```bash
$ module load quay.io/biocontainers/daisysuite/1.3.0--hdfd78af_3
$ module help quay.io/biocontainers/daisysuite/1.3.0--hdfd78af_3
```
