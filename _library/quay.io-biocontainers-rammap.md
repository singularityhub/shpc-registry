---
layout: container
name:  "quay.io/biocontainers/rammap"
maintainer: "@vsoch"
...
updated_at: "2026-06-28 06:32:43.123066"
...
singularity registry hpc automated addition for rammap
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/rammap
```
...
#### rammap-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### rammap-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/rammap
$ podman run --it --rm --entrypoint /usr/local/bin/rammap   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/rammap   -v ${PWD} -w ${PWD} <container> -c " $@"
```
