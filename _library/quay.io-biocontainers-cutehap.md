---
layout: container
name:  "quay.io/biocontainers/cutehap"
maintainer: "@vsoch"
...
updated_at: "2026-03-30 05:40:14.554314"
...
singularity registry hpc automated addition for cutehap
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/cutehap
```
...
#### cutehap-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### cutehap-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/cuteHap
$ podman run --it --rm --entrypoint /usr/local/bin/cuteHap   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/cuteHap   -v ${PWD} -w ${PWD} <container> -c " $@"
```
