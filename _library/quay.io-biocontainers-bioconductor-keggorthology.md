...
updated_at: "2024-10-18 03:05:07.784608"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-keggorthology:2.54.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-keggorthology/2.54.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-keggorthology/2.54.0--r43hdfd78af_0
```
