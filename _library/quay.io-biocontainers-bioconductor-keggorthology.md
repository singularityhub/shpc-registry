...
updated_at: "2022-10-29 05:54:57.840009"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-keggorthology:2.46.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-keggorthology/2.46.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-keggorthology/2.46.0--r41hdfd78af_0
```
