...
updated_at: "2026-08-19 03:12:20.242932"
...
```bash
$ shpc install quay.io/biocontainers/nbitk:0.7.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/nbitk/0.7.4--pyhdfd78af_0
$ module help quay.io/biocontainers/nbitk/0.7.4--pyhdfd78af_0
```
