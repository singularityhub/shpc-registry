...
updated_at: "2025-03-25 03:42:39.089745"
...
```bash
$ shpc install quay.io/biocontainers/nbitk:0.5.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/nbitk/0.5.0--pyhdfd78af_0
$ module help quay.io/biocontainers/nbitk/0.5.0--pyhdfd78af_0
```
