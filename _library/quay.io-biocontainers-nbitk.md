...
updated_at: "2025-05-12 03:45:12.238866"
...
```bash
$ shpc install quay.io/biocontainers/nbitk:0.5.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/nbitk/0.5.1--pyhdfd78af_0
$ module help quay.io/biocontainers/nbitk/0.5.1--pyhdfd78af_0
```
