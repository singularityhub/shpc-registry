...
updated_at: "2025-05-27 12:11:19.512435"
...
```bash
$ shpc install quay.io/biocontainers/nbitk:0.5.7--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/nbitk/0.5.7--pyhdfd78af_0
$ module help quay.io/biocontainers/nbitk/0.5.7--pyhdfd78af_0
```
