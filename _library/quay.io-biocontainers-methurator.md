...
updated_at: "2026-01-19 05:21:03.583874"
...
```bash
$ shpc install quay.io/biocontainers/methurator:0.1.8--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/methurator/0.1.8--pyhdfd78af_0
$ module help quay.io/biocontainers/methurator/0.1.8--pyhdfd78af_0
```
