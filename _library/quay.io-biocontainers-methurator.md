...
updated_at: "2026-08-25 03:29:39.656197"
...
```bash
$ shpc install quay.io/biocontainers/methurator:2.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/methurator/2.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/methurator/2.2.0--pyhdfd78af_0
```
