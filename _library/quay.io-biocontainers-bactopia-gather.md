...
updated_at: "2026-08-25 09:41:45.055201"
...
```bash
$ shpc install quay.io/biocontainers/bactopia-gather:1.2.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bactopia-gather/1.2.0--hdfd78af_0
$ module help quay.io/biocontainers/bactopia-gather/1.2.0--hdfd78af_0
```
