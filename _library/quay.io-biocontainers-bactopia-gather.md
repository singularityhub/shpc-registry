...
updated_at: "2026-06-09 06:24:47.697556"
...
```bash
$ shpc install quay.io/biocontainers/bactopia-gather:1.1.1--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bactopia-gather/1.1.1--hdfd78af_0
$ module help quay.io/biocontainers/bactopia-gather/1.1.1--hdfd78af_0
```
