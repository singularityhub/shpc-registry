...
updated_at: "2023-06-21 03:02:33.428719"
...
```bash
$ shpc install quay.io/biocontainers/bactopia-gather:1.0.2--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bactopia-gather/1.0.2--hdfd78af_0
$ module help quay.io/biocontainers/bactopia-gather/1.0.2--hdfd78af_0
```
