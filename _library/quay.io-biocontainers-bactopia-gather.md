...
updated_at: "2023-08-07 04:14:56.326242"
...
```bash
$ shpc install quay.io/biocontainers/bactopia-gather:1.0.3--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bactopia-gather/1.0.3--hdfd78af_0
$ module help quay.io/biocontainers/bactopia-gather/1.0.3--hdfd78af_0
```
