...
updated_at: "2026-02-27 04:38:08.240441"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-flowclean:1.48.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-flowclean/1.48.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-flowclean/1.48.0--r45hdfd78af_0
```
