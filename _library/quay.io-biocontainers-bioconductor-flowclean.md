...
updated_at: "2025-12-04 03:37:42.262427"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-flowclean:1.44.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-flowclean/1.44.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-flowclean/1.44.0--r44hdfd78af_0
```
