...
updated_at: "2026-03-23 05:06:05.675632"
...
```bash
$ shpc install quay.io/biocontainers/gencove:4.2.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/gencove/4.2.1--pyhdfd78af_0
$ module help quay.io/biocontainers/gencove/4.2.1--pyhdfd78af_0
```
