...
updated_at: "2025-11-17 04:02:52.389066"
...
```bash
$ shpc install quay.io/biocontainers/gencove:4.0.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/gencove/4.0.1--pyhdfd78af_0
$ module help quay.io/biocontainers/gencove/4.0.1--pyhdfd78af_0
```
