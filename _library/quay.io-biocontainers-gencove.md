...
updated_at: "2025-01-11 03:28:36.497048"
latest: "2.24.3--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/gencove:2.24.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/gencove/2.24.3--pyhdfd78af_0
$ module help quay.io/biocontainers/gencove/2.24.3--pyhdfd78af_0
```
