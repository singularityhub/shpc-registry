...
updated_at: "2023-06-24 03:27:15.235421"
...
```bash
$ shpc install quay.io/biocontainers/gencove:2.5.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/gencove/2.5.0--pyhdfd78af_0
$ module help quay.io/biocontainers/gencove/2.5.0--pyhdfd78af_0
```
