...
updated_at: "2026-01-26 04:45:13.946700"
...
```bash
$ shpc install quay.io/biocontainers/gencove:4.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/gencove/4.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/gencove/4.2.0--pyhdfd78af_0
```
