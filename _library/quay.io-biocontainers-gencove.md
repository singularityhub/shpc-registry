...
updated_at: "2026-08-18 03:25:14.894638"
...
```bash
$ shpc install quay.io/biocontainers/gencove:4.3.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/gencove/4.3.0--pyhdfd78af_0
$ module help quay.io/biocontainers/gencove/4.3.0--pyhdfd78af_0
```
