...
updated_at: "2023-10-05 03:25:50.066529"
...
```bash
$ shpc install quay.io/biocontainers/gencove:2.7.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/gencove/2.7.2--pyhdfd78af_0
$ module help quay.io/biocontainers/gencove/2.7.2--pyhdfd78af_0
```
