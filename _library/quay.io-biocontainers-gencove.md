...
updated_at: "2025-12-08 05:29:09.833657"
...
```bash
$ shpc install quay.io/biocontainers/gencove:4.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/gencove/4.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/gencove/4.1.0--pyhdfd78af_0
```
