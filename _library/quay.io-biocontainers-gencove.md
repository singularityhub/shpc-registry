...
updated_at: "2023-08-28 03:33:01.760539"
...
```bash
$ shpc install quay.io/biocontainers/gencove:2.6.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/gencove/2.6.0--pyhdfd78af_0
$ module help quay.io/biocontainers/gencove/2.6.0--pyhdfd78af_0
```
