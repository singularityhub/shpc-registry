...
updated_at: "2023-10-26 02:25:55.813410"
...
```bash
$ shpc install quay.io/biocontainers/gencove:2.8.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/gencove/2.8.0--pyhdfd78af_0
$ module help quay.io/biocontainers/gencove/2.8.0--pyhdfd78af_0
```
