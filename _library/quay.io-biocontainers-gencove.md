...
updated_at: "2024-10-21 03:47:59.902127"
latest: "2.21.0--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/gencove:2.21.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/gencove/2.21.0--pyhdfd78af_0
$ module help quay.io/biocontainers/gencove/2.21.0--pyhdfd78af_0
```
