...
updated_at: "2025-02-11 03:37:12.977242"
...
```bash
$ shpc install quay.io/biocontainers/gencove:3.0.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/gencove/3.0.1--pyhdfd78af_0
$ module help quay.io/biocontainers/gencove/3.0.1--pyhdfd78af_0
```
