...
updated_at: "2024-09-19 02:48:11.408179"
latest: "2.18.5--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/gencove:2.18.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/gencove/2.18.5--pyhdfd78af_0
$ module help quay.io/biocontainers/gencove/2.18.5--pyhdfd78af_0
```
