...
updated_at: "2024-12-18 03:36:28.303731"
latest: "2.24.2--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/gencove:2.24.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/gencove/2.24.2--pyhdfd78af_0
$ module help quay.io/biocontainers/gencove/2.24.2--pyhdfd78af_0
```
