...
updated_at: "2024-08-05 04:30:59.662035"
latest: "2.18.1--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/gencove:2.18.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/gencove/2.18.1--pyhdfd78af_0
$ module help quay.io/biocontainers/gencove/2.18.1--pyhdfd78af_0
```
