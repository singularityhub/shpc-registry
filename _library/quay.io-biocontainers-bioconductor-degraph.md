...
updated_at: "2024-05-07 03:05:55.357452"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-degraph:1.54.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-degraph/1.54.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-degraph/1.54.0--r43hdfd78af_0
```
