...
updated_at: "2025-09-22 03:42:16.082835"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-degraph:1.58.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-degraph/1.58.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-degraph/1.58.0--r44hdfd78af_0
```
