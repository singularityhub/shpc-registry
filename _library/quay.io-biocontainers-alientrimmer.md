---
layout: container
name:  "quay.io/biocontainers/alientrimmer"
maintainer: "@vsoch"
...
updated_at: "2026-01-07 04:33:36.951660"
...
versions:
 - "2.1--hdfd78af_0"
description: "singularity registry hpc automated addition for alientrimmer"
config: {"url": "https://biocontainers.pro/tools/alientrimmer", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for alientrimmer", "latest": {"2.1--hdfd78af_0": "sha256:91a567bb7e0dbd0aebacdda11d8fcbd903dcb96c230d8766373283bd5cc6f86e"}, "tags": {"2.1--hdfd78af_0": "sha256:91a567bb7e0dbd0aebacdda11d8fcbd903dcb96c230d8766373283bd5cc6f86e"}, "docker": "quay.io/biocontainers/alientrimmer", "aliases": {"alientrimmer": "/usr/local/bin/alientrimmer", "jwebserver": "/usr/local/bin/jwebserver", "jpackage": "/usr/local/bin/jpackage", "cups-config": "/usr/local/bin/cups-config", "ippeveprinter": "/usr/local/bin/ippeveprinter", "ipptool": "/usr/local/bin/ipptool", "hb-info": "/usr/local/bin/hb-info", "jfr": "/usr/local/bin/jfr", "jdeprscan": "/usr/local/bin/jdeprscan", "jhsdb": "/usr/local/bin/jhsdb", "jimage": "/usr/local/bin/jimage", "jlink": "/usr/local/bin/jlink", "jmod": "/usr/local/bin/jmod", "jshell": "/usr/local/bin/jshell", "aserver": "/usr/local/bin/aserver", "jdeps": "/usr/local/bin/jdeps", "jar": "/usr/local/bin/jar", "jarsigner": "/usr/local/bin/jarsigner", "java": "/usr/local/bin/java", "javac": "/usr/local/bin/javac", "javadoc": "/usr/local/bin/javadoc", "javap": "/usr/local/bin/javap", "jcmd": "/usr/local/bin/jcmd", "jconsole": "/usr/local/bin/jconsole", "jdb": "/usr/local/bin/jdb", "jinfo": "/usr/local/bin/jinfo"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/alientrimmer.
singularity registry hpc automated addition for alientrimmer
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/alientrimmer
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/alientrimmer:2.1--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/alientrimmer/2.1--hdfd78af_0
$ module help quay.io/biocontainers/alientrimmer/2.1--hdfd78af_0
```
...
#### alientrimmer-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### alientrimmer-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/alientrimmer
$ podman run --it --rm --entrypoint /usr/local/bin/alientrimmer   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/alientrimmer   -v ${PWD} -w ${PWD} <container> -c " $@"
```
