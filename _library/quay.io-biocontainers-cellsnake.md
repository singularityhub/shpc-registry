...
updated_at: "2023-05-04 03:05:57.745884"
latest: "0.2.0.dev9--pyh7cba7a3_0"
...
```bash
$ shpc install quay.io/biocontainers/cellsnake:0.2.0.dev9--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/cellsnake/0.2.0.dev9--pyh7cba7a3_0
$ module help quay.io/biocontainers/cellsnake/0.2.0.dev9--pyh7cba7a3_0
```
