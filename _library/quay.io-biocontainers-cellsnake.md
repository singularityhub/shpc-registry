---
layout: container
name:  "quay.io/biocontainers/cellsnake"
maintainer: "@vsoch"
...
updated_at: "2023-10-29 03:11:21.358118"
latest: "0.2.0.11--pyh7cba7a3_0"
...
```bash
$ shpc install quay.io/biocontainers/cellsnake
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/cellsnake:0.2.0.11--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/cellsnake/0.2.0.11--pyh7cba7a3_0
$ module help quay.io/biocontainers/cellsnake/0.2.0.11--pyh7cba7a3_0
```
...
#### cellsnake-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### cellsnake-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/cellsnake
$ podman run --it --rm --entrypoint /usr/local/bin/cellsnake   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/cellsnake   -v ${PWD} -w ${PWD} <container> -c " $@"
```
