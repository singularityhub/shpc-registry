...
updated_at: "2026-01-11 04:13:29.991815"
...
```bash
$ shpc install quay.io/biocontainers/bamdash:0.4.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bamdash/0.4.5--pyhdfd78af_0
$ module help quay.io/biocontainers/bamdash/0.4.5--pyhdfd78af_0
```
