...
updated_at: "2023-12-28 03:06:14.495164"
...
```bash
$ shpc install quay.io/biocontainers/bamdash:0.2.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bamdash/0.2.2--pyhdfd78af_0
$ module help quay.io/biocontainers/bamdash/0.2.2--pyhdfd78af_0
```
