...
updated_at: "2024-07-22 03:19:48.781480"
...
```bash
$ shpc install quay.io/biocontainers/bamdash:0.2.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bamdash/0.2.4--pyhdfd78af_0
$ module help quay.io/biocontainers/bamdash/0.2.4--pyhdfd78af_0
```
