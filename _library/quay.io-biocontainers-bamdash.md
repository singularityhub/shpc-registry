...
updated_at: "2024-01-28 02:44:18.796650"
...
```bash
$ shpc install quay.io/biocontainers/bamdash:0.2.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bamdash/0.2.3--pyhdfd78af_0
$ module help quay.io/biocontainers/bamdash/0.2.3--pyhdfd78af_0
```
