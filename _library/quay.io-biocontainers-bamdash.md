...
updated_at: "2026-09-03 07:07:42.660637"
...
```bash
$ shpc install quay.io/biocontainers/bamdash:0.5.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bamdash/0.5.0--pyhdfd78af_0
$ module help quay.io/biocontainers/bamdash/0.5.0--pyhdfd78af_0
```
