...
updated_at: "2026-03-05 04:50:26.855332"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-breastcancernki:1.48.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-breastcancernki/1.48.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-breastcancernki/1.48.0--r45hdfd78af_0
```
