...
updated_at: "2022-10-29 08:32:55.695997"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-bufferedmatrixmethods:1.58.0--r41hc0cfd56_2
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-bufferedmatrixmethods/1.58.0--r41hc0cfd56_2
$ module help quay.io/biocontainers/bioconductor-bufferedmatrixmethods/1.58.0--r41hc0cfd56_2
```
