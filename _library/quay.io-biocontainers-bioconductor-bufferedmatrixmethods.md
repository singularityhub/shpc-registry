...
updated_at: "2023-11-23 03:07:51.840997"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-bufferedmatrixmethods:1.64.0--r43ha9d7317_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-bufferedmatrixmethods/1.64.0--r43ha9d7317_0
$ module help quay.io/biocontainers/bioconductor-bufferedmatrixmethods/1.64.0--r43ha9d7317_0
```
