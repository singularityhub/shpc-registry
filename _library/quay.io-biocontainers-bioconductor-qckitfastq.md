...
updated_at: "2024-08-10 03:24:48.868979"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-qckitfastq:1.18.0--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-qckitfastq/1.18.0--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-qckitfastq/1.18.0--r43hf17093f_0
```
