---
layout: container
name:  "quay.io/biocontainers/barbell"
maintainer: "@vsoch"
...
updated_at: "2026-01-08 04:06:28.405464"
...
singularity registry hpc automated addition for barbell
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/barbell
```
...
#### barbell-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### barbell-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/barbell
$ podman run --it --rm --entrypoint /usr/local/bin/barbell   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/barbell   -v ${PWD} -w ${PWD} <container> -c " $@"
```
