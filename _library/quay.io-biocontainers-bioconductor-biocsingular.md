...
updated_at: "2023-08-15 02:48:38.249012"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-biocsingular:1.16.0--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-biocsingular/1.16.0--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-biocsingular/1.16.0--r43hf17093f_0
```
