...
updated_at: "2023-07-11 03:40:13.035682"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-biocsingular:1.14.0--r42hf17093f_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-biocsingular/1.14.0--r42hf17093f_1
$ module help quay.io/biocontainers/bioconductor-biocsingular/1.14.0--r42hf17093f_1
```
