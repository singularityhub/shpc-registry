...
updated_at: "2026-08-19 03:13:00.397739"
...
```bash
$ shpc install quay.io/biocontainers/vartracker:2.3.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/vartracker/2.3.0--pyhdfd78af_0
$ module help quay.io/biocontainers/vartracker/2.3.0--pyhdfd78af_0
```
