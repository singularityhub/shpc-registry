...
updated_at: "2024-02-28 02:57:03.057209"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-brgedata:1.24.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-brgedata/1.24.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-brgedata/1.24.0--r43hdfd78af_0
```
