...
updated_at: "2025-09-29 03:49:55.567343"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hicdoc:1.8.0--r44h77050f0_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hicdoc/1.8.0--r44h77050f0_0
$ module help quay.io/biocontainers/bioconductor-hicdoc/1.8.0--r44h77050f0_0
```
