...
updated_at: "2023-07-24 04:36:23.365070"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hicdoc:1.0.0--r42hf17093f_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hicdoc/1.0.0--r42hf17093f_1
$ module help quay.io/biocontainers/bioconductor-hicdoc/1.0.0--r42hf17093f_1
```
