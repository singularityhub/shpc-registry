...
updated_at: "2024-11-12 03:34:56.062608"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hicdoc:1.4.0--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hicdoc/1.4.0--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-hicdoc/1.4.0--r43hf17093f_0
```
