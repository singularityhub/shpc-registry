...
updated_at: "2026-03-28 05:08:55.471239"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-chipseqr:1.64.0--r45h01b2380_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-chipseqr/1.64.0--r45h01b2380_0
$ module help quay.io/biocontainers/bioconductor-chipseqr/1.64.0--r45h01b2380_0
```
