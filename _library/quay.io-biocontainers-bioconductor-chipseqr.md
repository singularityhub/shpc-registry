...
updated_at: "2024-09-30 03:39:29.853263"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-chipseqr:1.56.0--r43ha9d7317_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-chipseqr/1.56.0--r43ha9d7317_1
$ module help quay.io/biocontainers/bioconductor-chipseqr/1.56.0--r43ha9d7317_1
```
