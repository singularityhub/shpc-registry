...
updated_at: "2023-09-06 03:00:42.577137"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-msnid:1.34.0--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-msnid/1.34.0--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-msnid/1.34.0--r43hf17093f_0
```
