...
updated_at: "2023-06-19 03:11:29.392698"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-msnid:1.32.0--r42hf17093f_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-msnid/1.32.0--r42hf17093f_1
$ module help quay.io/biocontainers/bioconductor-msnid/1.32.0--r42hf17093f_1
```
