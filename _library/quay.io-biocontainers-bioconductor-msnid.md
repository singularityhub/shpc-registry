...
updated_at: "2023-12-28 02:59:31.624262"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-msnid:1.36.0--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-msnid/1.36.0--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-msnid/1.36.0--r43hf17093f_0
```
