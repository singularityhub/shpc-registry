...
updated_at: "2024-08-10 02:58:22.128421"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-tfutils:1.22.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-tfutils/1.22.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-tfutils/1.22.0--r43hdfd78af_0
```
