...
updated_at: "2025-09-16 03:13:07.820679"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-tfutils:1.26.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-tfutils/1.26.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-tfutils/1.26.0--r44hdfd78af_0
```
