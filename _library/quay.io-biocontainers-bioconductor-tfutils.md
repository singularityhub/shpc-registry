...
updated_at: "2026-04-01 04:56:02.044357"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-tfutils:1.30.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-tfutils/1.30.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-tfutils/1.30.0--r45hdfd78af_0
```
