...
updated_at: "2026-02-26 04:25:01.533129"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-celarefdata:1.28.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-celarefdata/1.28.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-celarefdata/1.28.0--r45hdfd78af_0
```
