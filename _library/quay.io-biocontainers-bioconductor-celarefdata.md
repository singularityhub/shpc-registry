...
updated_at: "2024-03-15 02:44:54.211220"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-celarefdata:1.20.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-celarefdata/1.20.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-celarefdata/1.20.0--r43hdfd78af_0
```
