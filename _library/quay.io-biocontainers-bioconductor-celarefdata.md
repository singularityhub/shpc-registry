...
updated_at: "2025-02-09 02:58:40.937340"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-celarefdata:1.24.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-celarefdata/1.24.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-celarefdata/1.24.0--r44hdfd78af_0
```
