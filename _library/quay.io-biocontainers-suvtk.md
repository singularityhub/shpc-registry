...
updated_at: "2025-08-02 03:57:38.050815"
...
```bash
$ shpc install quay.io/biocontainers/suvtk:0.1.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/suvtk/0.1.3--pyhdfd78af_0
$ module help quay.io/biocontainers/suvtk/0.1.3--pyhdfd78af_0
```
