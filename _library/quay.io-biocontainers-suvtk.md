...
updated_at: "2026-06-20 06:34:08.967878"
...
```bash
$ shpc install quay.io/biocontainers/suvtk:0.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/suvtk/0.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/suvtk/0.2.0--pyhdfd78af_0
```
