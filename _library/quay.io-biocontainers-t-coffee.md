...
updated_at: "2025-03-06 04:12:39.495384"
latest: "13.46.0.919e8c6b--h4b263cb_2"
...
```bash
$ shpc install quay.io/biocontainers/t-coffee:13.46.0.919e8c6b--h4b263cb_2
```
...
```bash
$ module load quay.io/biocontainers/t-coffee/13.46.0.919e8c6b--h4b263cb_2
$ module help quay.io/biocontainers/t-coffee/13.46.0.919e8c6b--h4b263cb_2
```
