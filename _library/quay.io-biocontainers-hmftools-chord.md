...
updated_at: "2025-08-03 04:19:34.029094"
...
```bash
$ shpc install quay.io/biocontainers/hmftools-chord:2.1.1--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hmftools-chord/2.1.1--hdfd78af_0
$ module help quay.io/biocontainers/hmftools-chord/2.1.1--hdfd78af_0
```
