...
updated_at: "2024-12-07 02:04:42.481734"
latest: "2.1.0_beta--r43hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/hmftools-chord:2.1.0_beta--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hmftools-chord/2.1.0_beta--r43hdfd78af_0
$ module help quay.io/biocontainers/hmftools-chord/2.1.0_beta--r43hdfd78af_0
```
