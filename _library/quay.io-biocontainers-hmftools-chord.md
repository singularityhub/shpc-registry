...
updated_at: "2025-12-22 04:09:13.250574"
...
```bash
$ shpc install quay.io/biocontainers/hmftools-chord:2.1.2--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hmftools-chord/2.1.2--hdfd78af_0
$ module help quay.io/biocontainers/hmftools-chord/2.1.2--hdfd78af_0
```
