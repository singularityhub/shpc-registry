...
updated_at: "2025-01-09 13:51:21.332383"
latest: "1.1--h077b44d_1"
...
```bash
$ shpc install quay.io/biocontainers/metamdbg:1.1--h077b44d_1
```
...
```bash
$ module load quay.io/biocontainers/metamdbg/1.1--h077b44d_1
$ module help quay.io/biocontainers/metamdbg/1.1--h077b44d_1
```
