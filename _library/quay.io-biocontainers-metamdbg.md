...
updated_at: "2025-03-01 03:03:48.798329"
latest: "1.1--h077b44d_2"
...
```bash
$ shpc install quay.io/biocontainers/metamdbg:1.1--h077b44d_2
```
...
```bash
$ module load quay.io/biocontainers/metamdbg/1.1--h077b44d_2
$ module help quay.io/biocontainers/metamdbg/1.1--h077b44d_2
```
