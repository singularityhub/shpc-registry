---
layout: container
name:  "quay.io/biocontainers/metamdbg"
maintainer: "@vsoch"
...
updated_at: "2025-10-02 03:35:38.441640"
latest: "1.2--h077b44d_0"
...
```bash
$ shpc install quay.io/biocontainers/metamdbg
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/metamdbg:1.2--h077b44d_0
```
...
```bash
$ module load quay.io/biocontainers/metamdbg/1.2--h077b44d_0
$ module help quay.io/biocontainers/metamdbg/1.2--h077b44d_0
```
...
#### metamdbg-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### metamdbg-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/metaMDBG
$ podman run --it --rm --entrypoint /usr/local/bin/metaMDBG   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/metaMDBG   -v ${PWD} -w ${PWD} <container> -c " $@"
```
