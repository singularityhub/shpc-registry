...
updated_at: "2024-05-24 02:48:15.032708"
...
```bash
$ shpc install quay.io/biocontainers/dnmtools:1.4.2--h0432e7c_0
```
...
```bash
$ module load quay.io/biocontainers/dnmtools/1.4.2--h0432e7c_0
$ module help quay.io/biocontainers/dnmtools/1.4.2--h0432e7c_0
```
