...
updated_at: "2024-11-12 03:19:43.664363"
latest: "3.1.5--h4ac6f70_1"
...
```bash
$ shpc install quay.io/biocontainers/swarm:3.1.5--h4ac6f70_1
```
...
```bash
$ module load quay.io/biocontainers/swarm/3.1.5--h4ac6f70_1
$ module help quay.io/biocontainers/swarm/3.1.5--h4ac6f70_1
```
