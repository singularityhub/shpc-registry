...
updated_at: "2024-05-06 02:38:18.706438"
latest: "3.1.5--h4ac6f70_0"
...
```bash
$ shpc install quay.io/biocontainers/swarm:3.1.5--h4ac6f70_0
```
...
```bash
$ module load quay.io/biocontainers/swarm/3.1.5--h4ac6f70_0
$ module help quay.io/biocontainers/swarm/3.1.5--h4ac6f70_0
```
