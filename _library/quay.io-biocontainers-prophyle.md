...
updated_at: "2024-05-07 02:38:18.383415"
latest: "0.3.3.1--py39h4e691d4_0"
...
```bash
$ shpc install quay.io/biocontainers/prophyle:0.3.3.1--py39h4e691d4_0
```
...
```bash
$ module load quay.io/biocontainers/prophyle/0.3.3.1--py39h4e691d4_0
$ module help quay.io/biocontainers/prophyle/0.3.3.1--py39h4e691d4_0
```
