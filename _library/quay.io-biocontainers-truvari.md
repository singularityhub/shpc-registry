...
updated_at: "2025-08-12 03:47:01.199823"
...
```bash
$ shpc install quay.io/biocontainers/truvari:5.3.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/truvari/5.3.0--pyhdfd78af_0
$ module help quay.io/biocontainers/truvari/5.3.0--pyhdfd78af_0
```
