...
updated_at: "2024-07-03 02:39:51.440255"
latest: "4.1.0--pyhdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/truvari:4.1.0--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/truvari/4.1.0--pyhdfd78af_1
$ module help quay.io/biocontainers/truvari/4.1.0--pyhdfd78af_1
```
