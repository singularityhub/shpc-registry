...
updated_at: "2023-09-14 02:24:35.738391"
...
```bash
$ shpc install quay.io/biocontainers/truvari:4.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/truvari/4.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/truvari/4.1.0--pyhdfd78af_0
```
