...
updated_at: "2025-01-31 03:28:45.776040"
...
```bash
$ shpc install quay.io/biocontainers/truvari:5.0.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/truvari/5.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/truvari/5.0.0--pyhdfd78af_0
```
