...
updated_at: "2024-07-18 04:37:34.751594"
...
```bash
$ shpc install quay.io/biocontainers/truvari:4.2.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/truvari/4.2.2--pyhdfd78af_0
$ module help quay.io/biocontainers/truvari/4.2.2--pyhdfd78af_0
```
