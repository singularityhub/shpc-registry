...
updated_at: "2025-12-05 03:40:12.859597"
...
```bash
$ shpc install quay.io/biocontainers/truvari:5.4.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/truvari/5.4.0--pyhdfd78af_0
$ module help quay.io/biocontainers/truvari/5.4.0--pyhdfd78af_0
```
