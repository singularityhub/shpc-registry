...
updated_at: "2025-03-03 03:24:24.547638"
...
```bash
$ shpc install quay.io/biocontainers/truvari:5.1.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/truvari/5.1.1--pyhdfd78af_0
$ module help quay.io/biocontainers/truvari/5.1.1--pyhdfd78af_0
```
