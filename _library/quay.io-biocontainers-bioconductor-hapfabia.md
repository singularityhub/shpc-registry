...
updated_at: "2022-10-29 05:46:51.187463"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hapfabia:1.36.0--r41hc0cfd56_2
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hapfabia/1.36.0--r41hc0cfd56_2
$ module help quay.io/biocontainers/bioconductor-hapfabia/1.36.0--r41hc0cfd56_2
```
