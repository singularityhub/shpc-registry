...
updated_at: "2025-06-30 05:13:16.671787"
...
```bash
$ shpc install quay.io/biocontainers/bamdam:0.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bamdam/0.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/bamdam/0.2.0--pyhdfd78af_0
```
