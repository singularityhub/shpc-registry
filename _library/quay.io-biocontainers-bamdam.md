---
layout: container
name:  "quay.io/biocontainers/bamdam"
maintainer: "@vsoch"
...
updated_at: "2026-01-23 04:04:43.412428"
...
```bash
$ module load quay.io/biocontainers/bamdam/0.4.3--pyhdfd78af_0
$ module help quay.io/biocontainers/bamdam/0.4.3--pyhdfd78af_0
```
...
#### bamdam-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bamdam-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/bamdam
$ podman run --it --rm --entrypoint /usr/local/bin/bamdam   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/bamdam   -v ${PWD} -w ${PWD} <container> -c " $@"
```
