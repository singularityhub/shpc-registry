...
updated_at: "2024-09-30 04:22:57.257948"
...
```bash
$ shpc install quay.io/biocontainers/hsdfinder:1.0.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hsdfinder/1.0.0--hdfd78af_0
$ module help quay.io/biocontainers/hsdfinder/1.0.0--hdfd78af_0
```
