...
updated_at: "2026-03-27 04:55:24.726043"
latest: "0.56.0--r45hdfd78af_2"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-biocgenerics:0.56.0--r45hdfd78af_2
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-biocgenerics/0.56.0--r45hdfd78af_2
$ module help quay.io/biocontainers/bioconductor-biocgenerics/0.56.0--r45hdfd78af_2
```
