...
updated_at: "2026-06-22 02:32:08.292381"
...
```bash
$ shpc install quay.io/biocontainers/pyseer:1.4.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pyseer/1.4.1--pyhdfd78af_0
$ module help quay.io/biocontainers/pyseer/1.4.1--pyhdfd78af_0
```
