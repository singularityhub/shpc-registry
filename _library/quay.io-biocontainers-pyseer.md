...
updated_at: "2026-01-20 03:48:19.620486"
...
```bash
$ shpc install quay.io/biocontainers/pyseer:1.4.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pyseer/1.4.0--pyhdfd78af_0
$ module help quay.io/biocontainers/pyseer/1.4.0--pyhdfd78af_0
```
