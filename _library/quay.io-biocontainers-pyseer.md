...
updated_at: "2026-08-21 15:41:35.348459"
...
```bash
$ shpc install quay.io/biocontainers/pyseer:1.4.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pyseer/1.4.2--pyhdfd78af_0
$ module help quay.io/biocontainers/pyseer/1.4.2--pyhdfd78af_0
```
