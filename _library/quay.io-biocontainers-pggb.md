...
updated_at: "2025-03-06 03:37:33.003069"
latest: "0.7.2--h9ee0642_0"
...
```bash
$ shpc install quay.io/biocontainers/pggb:0.7.2--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/pggb/0.7.2--h9ee0642_0
$ module help quay.io/biocontainers/pggb/0.7.2--h9ee0642_0
```
