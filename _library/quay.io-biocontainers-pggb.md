...
updated_at: "2023-01-14 03:00:11.310015"
...
```bash
$ shpc install quay.io/biocontainers/pggb:0.5.2--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pggb/0.5.2--hdfd78af_0
$ module help quay.io/biocontainers/pggb/0.5.2--hdfd78af_0
```
