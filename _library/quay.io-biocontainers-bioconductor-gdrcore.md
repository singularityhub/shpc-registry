...
updated_at: "2024-03-29 03:03:40.802645"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gdrcore:1.0.0--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gdrcore/1.0.0--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-gdrcore/1.0.0--r43hf17093f_0
```
