...
updated_at: "2025-11-15 03:12:53.973949"
...
```bash
$ shpc install quay.io/biocontainers/bismark:0.25.1--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bismark/0.25.1--hdfd78af_0
$ module help quay.io/biocontainers/bismark/0.25.1--hdfd78af_0
```
