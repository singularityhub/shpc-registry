...
updated_at: "2026-03-17 04:49:47.402450"
latest: "3.36.0--r45hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rankprod:3.36.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rankprod/3.36.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rankprod/3.36.0--r45hdfd78af_0
```
