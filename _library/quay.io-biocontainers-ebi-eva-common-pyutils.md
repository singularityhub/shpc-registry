...
updated_at: "2024-06-19 02:45:34.866277"
latest: "0.6.7--pyh7cba7a3_0"
...
```bash
$ shpc install quay.io/biocontainers/ebi-eva-common-pyutils:0.6.7--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/ebi-eva-common-pyutils/0.6.7--pyh7cba7a3_0
$ module help quay.io/biocontainers/ebi-eva-common-pyutils/0.6.7--pyh7cba7a3_0
```
