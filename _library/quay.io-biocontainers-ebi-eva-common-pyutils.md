...
updated_at: "2026-03-30 05:46:42.133757"
latest: "0.8.3--pyh106432d_0"
...
```bash
$ shpc install quay.io/biocontainers/ebi-eva-common-pyutils:0.8.3--pyh106432d_0
```
...
```bash
$ module load quay.io/biocontainers/ebi-eva-common-pyutils/0.8.3--pyh106432d_0
$ module help quay.io/biocontainers/ebi-eva-common-pyutils/0.8.3--pyh106432d_0
```
