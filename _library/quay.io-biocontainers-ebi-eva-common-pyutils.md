...
updated_at: "2026-07-02 06:41:10.280989"
...
```bash
$ shpc install quay.io/biocontainers/ebi-eva-common-pyutils:1.0.0--pyh106432d_0
```
...
```bash
$ module load quay.io/biocontainers/ebi-eva-common-pyutils/1.0.0--pyh106432d_0
$ module help quay.io/biocontainers/ebi-eva-common-pyutils/1.0.0--pyh106432d_0
```
