...
updated_at: "2025-04-03 03:14:42.471292"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rnu34.db:3.13.0--r44hdfd78af_5
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rnu34.db/3.13.0--r44hdfd78af_5
$ module help quay.io/biocontainers/bioconductor-rnu34.db/3.13.0--r44hdfd78af_5
```
