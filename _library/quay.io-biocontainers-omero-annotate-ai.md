...
updated_at: "2026-06-30 06:20:49.380956"
...
```bash
$ shpc install quay.io/biocontainers/omero-annotate-ai:0.3.0--pyh106432d_0
```
...
```bash
$ module load quay.io/biocontainers/omero-annotate-ai/0.3.0--pyh106432d_0
$ module help quay.io/biocontainers/omero-annotate-ai/0.3.0--pyh106432d_0
```
