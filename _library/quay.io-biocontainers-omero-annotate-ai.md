...
updated_at: "2026-08-10 04:26:00.676651"
...
```bash
$ shpc install quay.io/biocontainers/omero-annotate-ai:0.3.2--pyh106432d_0
```
...
```bash
$ module load quay.io/biocontainers/omero-annotate-ai/0.3.2--pyh106432d_0
$ module help quay.io/biocontainers/omero-annotate-ai/0.3.2--pyh106432d_0
```
