...
updated_at: "2026-03-28 17:09:45.600265"
latest: "0.2.1--pyh106432d_0"
...
```bash
$ shpc install quay.io/biocontainers/omero-annotate-ai:0.2.1--pyh106432d_0
```
...
```bash
$ module load quay.io/biocontainers/omero-annotate-ai/0.2.1--pyh106432d_0
$ module help quay.io/biocontainers/omero-annotate-ai/0.2.1--pyh106432d_0
```
