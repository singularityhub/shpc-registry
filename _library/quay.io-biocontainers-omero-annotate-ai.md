...
updated_at: "2026-05-07 06:16:43.931620"
...
```bash
$ shpc install quay.io/biocontainers/omero-annotate-ai:0.2.8--pyh106432d_0
```
...
```bash
$ module load quay.io/biocontainers/omero-annotate-ai/0.2.8--pyh106432d_0
$ module help quay.io/biocontainers/omero-annotate-ai/0.2.8--pyh106432d_0
```
