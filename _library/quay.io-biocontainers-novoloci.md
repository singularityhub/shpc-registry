...
updated_at: "2026-06-22 02:06:11.685106"
...
```bash
$ shpc install quay.io/biocontainers/novoloci:0.7--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/novoloci/0.7--hdfd78af_0
$ module help quay.io/biocontainers/novoloci/0.7--hdfd78af_0
```
