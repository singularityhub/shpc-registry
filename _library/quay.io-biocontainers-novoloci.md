...
updated_at: "2025-12-17 16:01:16.962079"
...
```bash
$ shpc install quay.io/biocontainers/novoloci:0.5--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/novoloci/0.5--hdfd78af_0
$ module help quay.io/biocontainers/novoloci/0.5--hdfd78af_0
```
