---
layout: container
name:  "quay.io/biocontainers/novoloci"
maintainer: "@vsoch"
...
updated_at: "2026-08-31 08:52:42.133407"
...
```bash
$ module load quay.io/biocontainers/novoloci/0.8--hdfd78af_0
$ module help quay.io/biocontainers/novoloci/0.8--hdfd78af_0
```
...
#### novoloci-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### novoloci-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/novoloci
$ podman run --it --rm --entrypoint /usr/local/bin/novoloci   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/novoloci   -v ${PWD} -w ${PWD} <container> -c " $@"
```
