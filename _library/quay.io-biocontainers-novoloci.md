...
updated_at: "2026-09-17 07:37:12.084715"
...
```bash
$ shpc install quay.io/biocontainers/novoloci:0.9--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/novoloci/0.9--hdfd78af_0
$ module help quay.io/biocontainers/novoloci/0.9--hdfd78af_0
```
