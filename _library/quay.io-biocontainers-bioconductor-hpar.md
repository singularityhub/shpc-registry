...
updated_at: "2025-08-17 03:48:25.263736"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hpar:1.48.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hpar/1.48.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-hpar/1.48.0--r44hdfd78af_0
```
