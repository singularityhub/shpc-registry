...
updated_at: "2025-10-12 03:18:15.195038"
...
```bash
$ shpc install quay.io/biocontainers/r-lme4qtl:0.1.10--r44hdfd78af_8
```
...
```bash
$ module load quay.io/biocontainers/r-lme4qtl/0.1.10--r44hdfd78af_8
$ module help quay.io/biocontainers/r-lme4qtl/0.1.10--r44hdfd78af_8
```
