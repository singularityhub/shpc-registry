...
updated_at: "2026-08-09 04:16:31.519563"
latest: "0.16.1--r45hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/r-pipette:0.16.1--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/r-pipette/0.16.1--r45hdfd78af_0
$ module help quay.io/biocontainers/r-pipette/0.16.1--r45hdfd78af_0
```
