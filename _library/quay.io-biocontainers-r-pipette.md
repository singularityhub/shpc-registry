...
updated_at: "2024-08-30 02:46:00.988157"
latest: "0.15.2--r43hdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/r-pipette:0.15.2--r43hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/r-pipette/0.15.2--r43hdfd78af_1
$ module help quay.io/biocontainers/r-pipette/0.15.2--r43hdfd78af_1
```
