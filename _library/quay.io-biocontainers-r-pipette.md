...
updated_at: "2026-08-29 09:22:57.285422"
latest: "0.16.2--r45hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/r-pipette:0.16.2--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/r-pipette/0.16.2--r45hdfd78af_0
$ module help quay.io/biocontainers/r-pipette/0.16.2--r45hdfd78af_0
```
