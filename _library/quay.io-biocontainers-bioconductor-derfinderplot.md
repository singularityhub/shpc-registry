...
updated_at: "2023-08-14 02:37:18.377606"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-derfinderplot:1.34.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-derfinderplot/1.34.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-derfinderplot/1.34.0--r43hdfd78af_0
```
