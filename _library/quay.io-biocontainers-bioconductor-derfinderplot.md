...
updated_at: "2026-03-27 05:27:27.329159"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-derfinderplot:1.44.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-derfinderplot/1.44.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-derfinderplot/1.44.0--r45hdfd78af_0
```
