...
updated_at: "2026-04-02 05:22:09.043349"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-iseehub:1.12.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-iseehub/1.12.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-iseehub/1.12.0--r45hdfd78af_0
```
