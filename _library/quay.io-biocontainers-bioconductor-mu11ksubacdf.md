...
updated_at: "2024-06-21 03:17:08.505096"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mu11ksubacdf:2.18.0--r43hdfd78af_12
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mu11ksubacdf/2.18.0--r43hdfd78af_12
$ module help quay.io/biocontainers/bioconductor-mu11ksubacdf/2.18.0--r43hdfd78af_12
```
