...
updated_at: "2025-09-01 04:09:31.035994"
...
```bash
$ shpc install quay.io/biocontainers/octopusv:0.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/octopusv/0.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/octopusv/0.2.0--pyhdfd78af_0
```
