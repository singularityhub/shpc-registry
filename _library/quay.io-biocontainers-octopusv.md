...
updated_at: "2025-01-30 03:56:24.564900"
...
```bash
$ shpc install quay.io/biocontainers/octopusv:0.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/octopusv/0.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/octopusv/0.1.0--pyhdfd78af_0
```
