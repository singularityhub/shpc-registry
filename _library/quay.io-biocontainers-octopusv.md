---
layout: container
name:  "quay.io/biocontainers/octopusv"
maintainer: "@vsoch"
...
updated_at: "2026-02-07 04:32:53.245045"
...
```bash
$ module load quay.io/biocontainers/octopusv/0.2.4--pyhdfd78af_0
$ module help quay.io/biocontainers/octopusv/0.2.4--pyhdfd78af_0
```
...
#### octopusv-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### octopusv-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/octopusv
$ podman run --it --rm --entrypoint /usr/local/bin/octopusv   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/octopusv   -v ${PWD} -w ${PWD} <container> -c " $@"
```
