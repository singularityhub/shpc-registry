...
updated_at: "2022-10-27 01:02:36.115943"
latest: "2.5.3--hdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/igvtools:2.5.3--hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/igvtools/2.5.3--hdfd78af_1
$ module help quay.io/biocontainers/igvtools/2.5.3--hdfd78af_1
```
