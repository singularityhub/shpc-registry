...
updated_at: "2023-08-25 02:52:29.901747"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ncigraphdata:1.36.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ncigraphdata/1.36.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ncigraphdata/1.36.0--r43hdfd78af_0
```
