...
updated_at: "2025-10-13 03:46:55.916112"
latest: "1.6.11--r45hb7dc0eb_0"
...
```bash
$ shpc install quay.io/biocontainers/r-rphast:1.6.11--r45hb7dc0eb_0
```
...
```bash
$ module load quay.io/biocontainers/r-rphast/1.6.11--r45hb7dc0eb_0
$ module help quay.io/biocontainers/r-rphast/1.6.11--r45hb7dc0eb_0
```
