...
updated_at: "2022-10-29 05:43:26.903350"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-lipidr:2.8.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-lipidr/2.8.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-lipidr/2.8.0--r41hdfd78af_0
```
