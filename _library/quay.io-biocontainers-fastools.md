---
layout: container
name:  "quay.io/biocontainers/fastools"
maintainer: "@vsoch"
...
updated_at: "2025-09-30 03:37:30.287554"
...
```bash
$ shpc install quay.io/biocontainers/fastools
```
...
#### fastools-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### fastools-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/split_fasta
$ podman run --it --rm --entrypoint /usr/local/bin/split_fasta   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/split_fasta   -v ${PWD} -w ${PWD} <container> -c " $@"
```
