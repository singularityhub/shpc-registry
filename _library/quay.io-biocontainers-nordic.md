...
updated_at: "2026-09-04 07:53:34.836191"
...
```bash
$ shpc install quay.io/biocontainers/nordic:2.8.0--py312h8471819_0
```
...
```bash
$ module load quay.io/biocontainers/nordic/2.8.0--py312h8471819_0
$ module help quay.io/biocontainers/nordic/2.8.0--py312h8471819_0
```
