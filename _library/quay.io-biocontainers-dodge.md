...
updated_at: "2024-05-10 02:49:59.096788"
...
```bash
$ shpc install quay.io/biocontainers/dodge:1.0.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/dodge/1.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/dodge/1.0.0--pyhdfd78af_0
```
