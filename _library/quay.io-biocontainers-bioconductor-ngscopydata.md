...
updated_at: "2026-05-02 05:42:59.368272"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ngscopydata:1.30.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ngscopydata/1.30.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ngscopydata/1.30.0--r45hdfd78af_0
```
