...
updated_at: "2025-08-19 04:01:51.066965"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ngscopydata:1.26.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ngscopydata/1.26.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ngscopydata/1.26.0--r44hdfd78af_0
```
