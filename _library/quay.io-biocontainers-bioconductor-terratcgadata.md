---
layout: container
name:  "quay.io/biocontainers/bioconductor-terratcgadata"
maintainer: "@vsoch"
...
updated_at: "2023-11-08 03:03:03.619913"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-terratcgadata
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-terratcgadata:1.4.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-terratcgadata/1.4.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-terratcgadata/1.4.0--r43hdfd78af_0
```
...
#### bioconductor-terratcgadata-run:
...
#### bioconductor-terratcgadata-shell:
...
#### bioconductor-terratcgadata-exec:
...
#### bioconductor-terratcgadata-inspect:
...
#### bioconductor-terratcgadata-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-terratcgadata-inspect-deffile:
