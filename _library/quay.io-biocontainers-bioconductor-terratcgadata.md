...
updated_at: "2023-07-15 03:28:55.741877"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-terratcgadata:1.2.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-terratcgadata/1.2.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-terratcgadata/1.2.0--r42hdfd78af_0
```
