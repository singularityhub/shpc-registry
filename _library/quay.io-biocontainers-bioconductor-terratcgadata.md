...
updated_at: "2026-04-03 15:48:25.116719"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-terratcgadata:1.14.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-terratcgadata/1.14.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-terratcgadata/1.14.0--r45hdfd78af_0
```
