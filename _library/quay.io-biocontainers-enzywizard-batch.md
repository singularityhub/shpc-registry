...
updated_at: "2026-09-23 07:40:56.260675"
...
```bash
$ shpc install quay.io/biocontainers/enzywizard-batch:1.0.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/enzywizard-batch/1.0.3--pyhdfd78af_0
$ module help quay.io/biocontainers/enzywizard-batch/1.0.3--pyhdfd78af_0
```
