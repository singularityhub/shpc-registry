---
layout: container
name:  "quay.io/biocontainers/bioconductor-dnazoodata"
maintainer: "@vsoch"
...
updated_at: "2026-03-23 05:30:31.217434"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-dnazoodata
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-dnazoodata:1.10.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-dnazoodata/1.10.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-dnazoodata/1.10.0--r45hdfd78af_0
```
...
#### bioconductor-dnazoodata-inspect:
...
#### bioconductor-dnazoodata-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-dnazoodata-inspect-deffile:
