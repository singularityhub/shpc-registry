...
updated_at: "2025-10-02 04:18:47.205006"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-dnazoodata:1.6.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-dnazoodata/1.6.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-dnazoodata/1.6.0--r44hdfd78af_0
```
