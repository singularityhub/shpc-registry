...
updated_at: "2026-03-11 04:50:25.800337"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rots:2.2.0--r45ha27e39d_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rots/2.2.0--r45ha27e39d_0
$ module help quay.io/biocontainers/bioconductor-rots/2.2.0--r45ha27e39d_0
```
