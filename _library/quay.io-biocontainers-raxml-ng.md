...
updated_at: "2026-05-24 06:52:00.333833"
latest: "2.0.1--h870a6a7_0"
...
```bash
$ shpc install quay.io/biocontainers/raxml-ng:2.0.1--h870a6a7_0
```
...
```bash
$ module load quay.io/biocontainers/raxml-ng/2.0.1--h870a6a7_0
$ module help quay.io/biocontainers/raxml-ng/2.0.1--h870a6a7_0
```
