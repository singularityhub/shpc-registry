...
updated_at: "2023-08-28 03:27:34.512642"
latest: "1.2.0--h6d1f11b_1"
...
```bash
$ shpc install quay.io/biocontainers/raxml-ng:1.2.0--h6d1f11b_1
```
...
```bash
$ module load quay.io/biocontainers/raxml-ng/1.2.0--h6d1f11b_1
$ module help quay.io/biocontainers/raxml-ng/1.2.0--h6d1f11b_1
```
