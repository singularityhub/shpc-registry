...
updated_at: "2026-06-10 06:42:59.936887"
latest: "2.0.2--h870a6a7_0"
...
```bash
$ shpc install quay.io/biocontainers/raxml-ng:2.0.2--h870a6a7_0
```
...
```bash
$ module load quay.io/biocontainers/raxml-ng/2.0.2--h870a6a7_0
$ module help quay.io/biocontainers/raxml-ng/2.0.2--h870a6a7_0
```
