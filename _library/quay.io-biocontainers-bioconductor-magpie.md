...
updated_at: "2025-12-13 03:39:36.296348"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-magpie:1.6.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-magpie/1.6.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-magpie/1.6.0--r44hdfd78af_0
```
