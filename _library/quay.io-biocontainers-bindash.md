...
updated_at: "2025-05-12 03:54:43.593120"
latest: "2.4--h077b44d_0"
...
```bash
$ shpc install quay.io/biocontainers/bindash:2.4--h077b44d_0
```
...
```bash
$ module load quay.io/biocontainers/bindash/2.4--h077b44d_0
$ module help quay.io/biocontainers/bindash/2.4--h077b44d_0
```
