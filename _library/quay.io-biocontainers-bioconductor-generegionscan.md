...
updated_at: "2026-03-31 04:56:23.360596"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-generegionscan:1.66.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-generegionscan/1.66.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-generegionscan/1.66.0--r45hdfd78af_0
```
