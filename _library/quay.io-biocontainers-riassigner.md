...
updated_at: "2026-04-03 15:23:58.941421"
...
```bash
$ shpc install quay.io/biocontainers/riassigner:0.6.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/riassigner/0.6.1--pyhdfd78af_0
$ module help quay.io/biocontainers/riassigner/0.6.1--pyhdfd78af_0
```
