...
updated_at: "2023-10-30 03:07:13.053958"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rgu34b.db:3.13.0--r43hdfd78af_3
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rgu34b.db/3.13.0--r43hdfd78af_3
$ module help quay.io/biocontainers/bioconductor-rgu34b.db/3.13.0--r43hdfd78af_3
```
