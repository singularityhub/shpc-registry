...
updated_at: "2025-10-19 03:48:51.374535"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-nucler:2.38.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-nucler/2.38.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-nucler/2.38.0--r44hdfd78af_0
```
