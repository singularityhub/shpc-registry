...
updated_at: "2022-10-29 08:10:59.207802"
latest: "2.8.0--r3.3.2_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-nucler:2.8.0--r3.3.2_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-nucler/2.8.0--r3.3.2_0
$ module help quay.io/biocontainers/bioconductor-nucler/2.8.0--r3.3.2_0
```
