...
updated_at: "2024-11-28 04:27:34.183400"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-nucler:2.34.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-nucler/2.34.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-nucler/2.34.0--r43hdfd78af_0
```
