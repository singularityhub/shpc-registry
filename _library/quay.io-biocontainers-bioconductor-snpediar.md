...
updated_at: "2026-03-26 04:52:49.277995"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-snpediar:1.36.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-snpediar/1.36.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-snpediar/1.36.0--r45hdfd78af_0
```
