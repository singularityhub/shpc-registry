...
updated_at: "2025-01-07 03:21:27.299321"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-snpediar:1.32.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-snpediar/1.32.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-snpediar/1.32.0--r44hdfd78af_0
```
