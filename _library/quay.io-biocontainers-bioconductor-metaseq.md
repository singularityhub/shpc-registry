...
updated_at: "2023-10-04 03:11:06.337402"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-metaseq:1.40.0--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-metaseq/1.40.0--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-metaseq/1.40.0--r43hf17093f_0
```
