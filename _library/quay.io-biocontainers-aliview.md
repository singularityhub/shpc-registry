---
layout: container
name:  "quay.io/biocontainers/aliview"
maintainer: "@vsoch"
...
updated_at: "2026-08-17 03:25:57.676822"
latest: "1.32--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/aliview
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/aliview:1.32--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/aliview/1.32--hdfd78af_0
$ module help quay.io/biocontainers/aliview/1.32--hdfd78af_0
```
...
#### aliview-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### aliview-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/aliview
$ podman run --it --rm --entrypoint /usr/local/bin/aliview   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/aliview   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/aliview-test
$ podman run --it --rm --entrypoint /usr/local/bin/aliview-test   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/aliview-test   -v ${PWD} -w ${PWD} <container> -c " $@"
```
