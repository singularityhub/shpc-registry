...
updated_at: "2026-04-04 04:56:05.008271"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-icobra:1.38.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-icobra/1.38.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-icobra/1.38.0--r45hdfd78af_0
```
