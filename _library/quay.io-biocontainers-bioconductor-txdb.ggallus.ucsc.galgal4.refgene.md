...
updated_at: "2024-01-01 02:56:16.485331"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-txdb.ggallus.ucsc.galgal4.refgene:3.12.0--r43hdfd78af_7
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-txdb.ggallus.ucsc.galgal4.refgene/3.12.0--r43hdfd78af_7
$ module help quay.io/biocontainers/bioconductor-txdb.ggallus.ucsc.galgal4.refgene/3.12.0--r43hdfd78af_7
```
