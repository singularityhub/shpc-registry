...
updated_at: "2025-12-10 03:54:16.154685"
latest: "3.7.4--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/get_homologues:3.7.4--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/get_homologues/3.7.4--hdfd78af_0
$ module help quay.io/biocontainers/get_homologues/3.7.4--hdfd78af_0
```
