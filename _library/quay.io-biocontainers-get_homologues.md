...
updated_at: "2023-06-16 03:16:39.214901"
...
```bash
$ shpc install quay.io/biocontainers/get_homologues:3.6.1--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/get_homologues/3.6.1--hdfd78af_0
$ module help quay.io/biocontainers/get_homologues/3.6.1--hdfd78af_0
```
