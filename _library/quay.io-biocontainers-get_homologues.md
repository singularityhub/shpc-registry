...
updated_at: "2025-04-18 03:41:39.477885"
latest: "3.7.2--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/get_homologues:3.7.2--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/get_homologues/3.7.2--hdfd78af_0
$ module help quay.io/biocontainers/get_homologues/3.7.2--hdfd78af_0
```
