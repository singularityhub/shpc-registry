...
updated_at: "2024-07-11 02:57:59.008302"
...
```bash
$ shpc install quay.io/biocontainers/get_homologues:3.6.3--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/get_homologues/3.6.3--hdfd78af_0
$ module help quay.io/biocontainers/get_homologues/3.6.3--hdfd78af_0
```
