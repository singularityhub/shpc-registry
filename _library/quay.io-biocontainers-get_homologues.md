...
updated_at: "2026-03-15 04:48:56.155436"
...
```bash
$ shpc install quay.io/biocontainers/get_homologues:3.8.1--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/get_homologues/3.8.1--hdfd78af_0
$ module help quay.io/biocontainers/get_homologues/3.8.1--hdfd78af_0
```
