...
updated_at: "2023-06-12 03:35:29.411308"
...
```bash
$ shpc install quay.io/biocontainers/get_homologues:3.5.5--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/get_homologues/3.5.5--hdfd78af_0
$ module help quay.io/biocontainers/get_homologues/3.5.5--hdfd78af_0
```
