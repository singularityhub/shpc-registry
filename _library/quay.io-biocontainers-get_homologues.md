...
updated_at: "2025-10-27 03:52:25.572818"
latest: "3.7.3--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/get_homologues:3.7.3--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/get_homologues/3.7.3--hdfd78af_0
$ module help quay.io/biocontainers/get_homologues/3.7.3--hdfd78af_0
```
