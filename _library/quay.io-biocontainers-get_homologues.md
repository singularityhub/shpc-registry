...
updated_at: "2025-12-16 03:56:55.002816"
latest: "3.7.5--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/get_homologues:3.7.5--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/get_homologues/3.7.5--hdfd78af_0
$ module help quay.io/biocontainers/get_homologues/3.7.5--hdfd78af_0
```
