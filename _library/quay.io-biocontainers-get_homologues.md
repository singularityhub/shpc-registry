...
updated_at: "2024-09-09 03:21:42.158254"
...
```bash
$ shpc install quay.io/biocontainers/get_homologues:3.7.1--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/get_homologues/3.7.1--hdfd78af_0
$ module help quay.io/biocontainers/get_homologues/3.7.1--hdfd78af_0
```
