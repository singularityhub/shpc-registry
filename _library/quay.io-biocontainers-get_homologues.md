...
updated_at: "2026-01-30 04:41:48.872396"
...
```bash
$ shpc install quay.io/biocontainers/get_homologues:3.8--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/get_homologues/3.8--hdfd78af_0
$ module help quay.io/biocontainers/get_homologues/3.8--hdfd78af_0
```
