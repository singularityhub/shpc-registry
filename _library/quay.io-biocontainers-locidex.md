...
updated_at: "2025-01-31 02:49:40.184482"
...
```bash
$ shpc install quay.io/biocontainers/locidex:0.1.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/locidex/0.1.2--pyhdfd78af_0
$ module help quay.io/biocontainers/locidex/0.1.2--pyhdfd78af_0
```
