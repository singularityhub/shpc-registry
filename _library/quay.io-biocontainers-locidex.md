---
layout: container
name:  "quay.io/biocontainers/locidex"
maintainer: "@vsoch"
...
updated_at: "2025-08-18 03:48:33.423151"
...
versions:
 ...
 - "0.1.2--pyhdfd78af_0"
 - "0.3.0--pyhdfd78af_0"
description: "singularity registry hpc automated addition for locidex"
config: {"url": "https://biocontainers.pro/tools/locidex", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for locidex", "latest": {"0.3.0--pyhdfd78af_0": "sha256:0d5c8e87a98f1a1460a693d4f3d1d09942b69ec4afef8a0a7cdaa735b37fc873"}, "tags": {"0.1.1--pyhdfd78af_1": "sha256:e4d7a7f22c8635632d0eeed7b0e901eaa9cbdbf9b99c6454f47778102d9de53e", "0.1.2--pyhdfd78af_0": "sha256:c409b70c0df08ae8fff1c3601c57cba0bbabc211a781b55055b2ea86a07ba4dd", "0.3.0--pyhdfd78af_0": "sha256:0d5c8e87a98f1a1460a693d4f3d1d09942b69ec4afef8a0a7cdaa735b37fc873"}, "docker": "quay.io/biocontainers/locidex", "aliases": {"archive-ncbinlp": "/usr/local/bin/archive-ncbinlp", "archive-nihocc": "/usr/local/bin/archive-nihocc", "archive-nmcds": "/usr/local/bin/archive-nmcds", "archive-pmc": "/usr/local/bin/archive-pmc", "archive-taxonomy": "/usr/local/bin/archive-taxonomy", "archspec": "/usr/local/bin/archspec", "args2slice": "/usr/local/bin/args2slice", "asn2ref": "/usr/local/bin/asn2ref", "blst2gm": "/usr/local/bin/blst2gm", "cit2pmid": "/usr/local/bin/cit2pmid", "combine-uid-lists": "/usr/local/bin/combine-uid-lists", "difference-uid-lists": "/usr/local/bin/difference-uid-lists", "download-pmc": "/usr/local/bin/download-pmc", "ds2pme": "/usr/local/bin/ds2pme", "fetch-local": "/usr/local/bin/fetch-local", "fetch-nmcds": "/usr/local/bin/fetch-nmcds", "fetch-pmc": "/usr/local/bin/fetch-pmc", "fetch-taxonomy": "/usr/local/bin/fetch-taxonomy", "filter-genbank": "/usr/local/bin/filter-genbank", "filter-record": "/usr/local/bin/filter-record", "gawk-5.3.0": "/usr/local/bin/gawk-5.3.0", "gawkbug": "/usr/local/bin/gawkbug", "gbf2fsa": "/usr/local/bin/gbf2fsa", "gbf2ref": "/usr/local/bin/gbf2ref", "gm2ranges": "/usr/local/bin/gm2ranges", "gm2segs": "/usr/local/bin/gm2segs", "ini2xml": "/usr/local/bin/ini2xml", "jsonl2xml": "/usr/local/bin/jsonl2xml", "just-first-key": "/usr/local/bin/just-first-key", "locidex": "/usr/local/bin/locidex", "nhance.sh": "/usr/local/bin/nhance.sh", "pma2apa": "/usr/local/bin/pma2apa", "pma2pme": "/usr/local/bin/pma2pme", "pmc2bioc": "/usr/local/bin/pmc2bioc", "pmc2info": "/usr/local/bin/pmc2info", "quote-grouped-elements": "/usr/local/bin/quote-grouped-elements", "ref2pmid": "/usr/local/bin/ref2pmid", "refseq-nm-cds": "/usr/local/bin/refseq-nm-cds", "scn2xml": "/usr/local/bin/scn2xml", "stream-local": "/usr/local/bin/stream-local", "test-pmc-index": "/usr/local/bin/test-pmc-index", "toml2xml": "/usr/local/bin/toml2xml", "yaml2xml": "/usr/local/bin/yaml2xml", "pyrodigal": "/usr/local/bin/pyrodigal", "cpuinfo": "/usr/local/bin/cpuinfo", "h5tools_test_utils": "/usr/local/bin/h5tools_test_utils", "blastn_vdb": "/usr/local/bin/blastn_vdb", "tblastn_vdb": "/usr/local/bin/tblastn_vdb", "h5fuse.sh": "/usr/local/bin/h5fuse.sh", "uuid": "/usr/local/bin/uuid", "uuid-config": "/usr/local/bin/uuid-config", "h5delete": "/usr/local/bin/h5delete", "test_pcre": "/usr/local/bin/test_pcre", "pt2to3": "/usr/local/bin/pt2to3", "ptdump": "/usr/local/bin/ptdump", "ptrepack": "/usr/local/bin/ptrepack", "pttree": "/usr/local/bin/pttree", "awk": "/usr/local/bin/awk", "gawk": "/usr/local/bin/gawk", "mafft-sparsecore.rb": "/usr/local/bin/mafft-sparsecore.rb", "einsi": "/usr/local/bin/einsi", "fftns": "/usr/local/bin/fftns", "fftnsi": "/usr/local/bin/fftnsi", "ginsi": "/usr/local/bin/ginsi", "linsi": "/usr/local/bin/linsi", "mafft-distance": "/usr/local/bin/mafft-distance", "mafft-einsi": "/usr/local/bin/mafft-einsi", "mafft-fftns": "/usr/local/bin/mafft-fftns"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/locidex.
singularity registry hpc automated addition for locidex
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/locidex
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/locidex:0.3.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/locidex/0.3.0--pyhdfd78af_0
$ module help quay.io/biocontainers/locidex/0.3.0--pyhdfd78af_0
```
...
#### locidex-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### locidex-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/locidex
$ podman run --it --rm --entrypoint /usr/local/bin/locidex   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/locidex   -v ${PWD} -w ${PWD} <container> -c " $@"
```
