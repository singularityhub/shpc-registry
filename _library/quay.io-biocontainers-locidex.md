...
updated_at: "2024-07-06 02:37:42.544385"
...
```bash
$ shpc install quay.io/biocontainers/locidex:0.1.1--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/locidex/0.1.1--pyhdfd78af_1
$ module help quay.io/biocontainers/locidex/0.1.1--pyhdfd78af_1
```
