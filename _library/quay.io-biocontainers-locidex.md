...
updated_at: "2025-12-12 04:09:42.693052"
...
```bash
$ shpc install quay.io/biocontainers/locidex:0.4.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/locidex/0.4.0--pyhdfd78af_0
$ module help quay.io/biocontainers/locidex/0.4.0--pyhdfd78af_0
```
