...
updated_at: "2022-11-27 23:29:45.339983"
latest: "22.10-tf2-py3"
...
```bash
$ shpc install nvcr.io/nvidia/tensorflow:22.10-tf2-py3
```
...
```bash
$ module load nvcr.io/nvidia/tensorflow/22.10-tf2-py3
$ module help nvcr.io/nvidia/tensorflow/22.10-tf2-py3
```
