...
updated_at: "2023-09-28 02:22:44.888809"
latest: "23.08-tf2-py3"
...
```bash
$ shpc install nvcr.io/nvidia/tensorflow:23.08-tf2-py3
```
...
```bash
$ module load nvcr.io/nvidia/tensorflow/23.08-tf2-py3
$ module help nvcr.io/nvidia/tensorflow/23.08-tf2-py3
```
