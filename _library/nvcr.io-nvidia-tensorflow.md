...
updated_at: "2024-02-20 02:21:10.564817"
latest: "24.01-tf2-py3-igpu"
...
```bash
$ shpc install nvcr.io/nvidia/tensorflow:24.01-tf2-py3-igpu
```
...
```bash
$ module load nvcr.io/nvidia/tensorflow/24.01-tf2-py3-igpu
$ module help nvcr.io/nvidia/tensorflow/24.01-tf2-py3-igpu
```
