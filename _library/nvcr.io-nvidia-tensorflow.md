...
updated_at: "2023-01-14 02:35:47.468071"
latest: "22.11-tf2-py3"
...
```bash
$ shpc install nvcr.io/nvidia/tensorflow:22.11-tf2-py3
```
...
```bash
$ module load nvcr.io/nvidia/tensorflow/22.11-tf2-py3
$ module help nvcr.io/nvidia/tensorflow/22.11-tf2-py3
```
