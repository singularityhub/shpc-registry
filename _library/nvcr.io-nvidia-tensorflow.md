...
updated_at: "2024-04-15 04:52:55.185900"
latest: "24.02-tf2-py3-igpu"
...
```bash
$ shpc install nvcr.io/nvidia/tensorflow:24.02-tf2-py3-igpu
```
...
```bash
$ module load nvcr.io/nvidia/tensorflow/24.02-tf2-py3-igpu
$ module help nvcr.io/nvidia/tensorflow/24.02-tf2-py3-igpu
```
