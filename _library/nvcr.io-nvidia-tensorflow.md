...
updated_at: "2023-06-03 02:48:19.459857"
...
```bash
$ shpc install nvcr.io/nvidia/tensorflow:23.04-tf2-py3
```
...
```bash
$ module load nvcr.io/nvidia/tensorflow/23.04-tf2-py3
$ module help nvcr.io/nvidia/tensorflow/23.04-tf2-py3
```
