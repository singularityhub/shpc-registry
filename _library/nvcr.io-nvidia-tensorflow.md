...
updated_at: "2023-09-11 03:39:03.485907"
latest: "23.07-tf2-py3"
...
```bash
$ shpc install nvcr.io/nvidia/tensorflow:23.07-tf2-py3
```
...
```bash
$ module load nvcr.io/nvidia/tensorflow/23.07-tf2-py3
$ module help nvcr.io/nvidia/tensorflow/23.07-tf2-py3
```
