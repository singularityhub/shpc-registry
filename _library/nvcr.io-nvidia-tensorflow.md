...
updated_at: "2024-04-29 03:12:05.492237"
latest: "24.03-tf2-py3-igpu"
...
```bash
$ shpc install nvcr.io/nvidia/tensorflow:24.03-tf2-py3-igpu
```
...
```bash
$ module load nvcr.io/nvidia/tensorflow/24.03-tf2-py3-igpu
$ module help nvcr.io/nvidia/tensorflow/24.03-tf2-py3-igpu
```
