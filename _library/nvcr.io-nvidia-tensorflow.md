...
updated_at: "2023-08-13 03:30:05.152053"
latest: "23.06-tf2-py3"
...
```bash
$ shpc install nvcr.io/nvidia/tensorflow:23.06-tf2-py3
```
...
```bash
$ module load nvcr.io/nvidia/tensorflow/23.06-tf2-py3
$ module help nvcr.io/nvidia/tensorflow/23.06-tf2-py3
```
