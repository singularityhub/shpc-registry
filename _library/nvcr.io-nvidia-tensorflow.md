...
updated_at: "2023-07-02 03:05:10.669601"
latest: "23.05-tf2-py3"
...
```bash
$ shpc install nvcr.io/nvidia/tensorflow:23.05-tf2-py3
```
...
```bash
$ module load nvcr.io/nvidia/tensorflow/23.05-tf2-py3
$ module help nvcr.io/nvidia/tensorflow/23.05-tf2-py3
```
