...
updated_at: "2023-02-09 17:45:31.484400"
latest: "22.12-tf2-py3"
...
```bash
$ shpc install nvcr.io/nvidia/tensorflow:22.12-tf2-py3
```
...
```bash
$ module load nvcr.io/nvidia/tensorflow/22.12-tf2-py3
$ module help nvcr.io/nvidia/tensorflow/22.12-tf2-py3
```
