...
updated_at: "2023-05-01 03:08:15.950913"
latest: "23.03-tf2-py3"
...
```bash
$ shpc install nvcr.io/nvidia/tensorflow:23.03-tf2-py3
```
...
```bash
$ module load nvcr.io/nvidia/tensorflow/23.03-tf2-py3
$ module help nvcr.io/nvidia/tensorflow/23.03-tf2-py3
```
