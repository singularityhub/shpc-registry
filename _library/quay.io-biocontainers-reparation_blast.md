...
updated_at: "2022-10-27 00:45:43.207930"
latest: "v1.0.7--pl526_1"
...
```bash
$ shpc install quay.io/biocontainers/reparation_blast:v1.0.7--pl526_1
```
...
```bash
$ module load quay.io/biocontainers/reparation_blast/v1.0.7--pl526_1
$ module help quay.io/biocontainers/reparation_blast/v1.0.7--pl526_1
```
