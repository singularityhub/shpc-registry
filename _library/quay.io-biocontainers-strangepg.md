...
updated_at: "2026-05-18 06:56:22.033845"
latest: "0.9.5--hb53d2d8_0"
...
```bash
$ shpc install quay.io/biocontainers/strangepg:0.9.5--hb53d2d8_0
```
...
```bash
$ module load quay.io/biocontainers/strangepg/0.9.5--hb53d2d8_0
$ module help quay.io/biocontainers/strangepg/0.9.5--hb53d2d8_0
```
