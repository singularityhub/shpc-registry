...
updated_at: "2026-06-23 06:15:45.031397"
...
```bash
$ shpc install quay.io/biocontainers/strangepg:0.9.6--hb53d2d8_0
```
...
```bash
$ module load quay.io/biocontainers/strangepg/0.9.6--hb53d2d8_0
$ module help quay.io/biocontainers/strangepg/0.9.6--hb53d2d8_0
```
