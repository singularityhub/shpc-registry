...
updated_at: "2025-09-11 05:47:54.315244"
latest: "0.8.20--h0ac75b0_0"
...
```bash
$ shpc install quay.io/biocontainers/strangepg:0.8.20--h0ac75b0_0
```
...
```bash
$ module load quay.io/biocontainers/strangepg/0.8.20--h0ac75b0_0
$ module help quay.io/biocontainers/strangepg/0.8.20--h0ac75b0_0
```
