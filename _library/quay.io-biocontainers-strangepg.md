...
updated_at: "2025-05-10 03:55:51.780775"
latest: "0.8.19.3--h0ac75b0_0"
...
```bash
$ shpc install quay.io/biocontainers/strangepg:0.8.19.3--h0ac75b0_0
```
...
```bash
$ module load quay.io/biocontainers/strangepg/0.8.19.3--h0ac75b0_0
$ module help quay.io/biocontainers/strangepg/0.8.19.3--h0ac75b0_0
```
