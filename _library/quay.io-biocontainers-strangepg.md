...
updated_at: "2026-01-22 04:16:17.737702"
latest: "0.9.4--h0ac75b0_0"
...
```bash
$ shpc install quay.io/biocontainers/strangepg:0.9.4--h0ac75b0_0
```
...
```bash
$ module load quay.io/biocontainers/strangepg/0.9.4--h0ac75b0_0
$ module help quay.io/biocontainers/strangepg/0.9.4--h0ac75b0_0
```
