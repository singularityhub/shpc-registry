...
updated_at: "2025-08-19 03:47:55.360235"
...
```bash
$ shpc install quay.io/biocontainers/twilight:0.1.4--h6bb9b41_0
```
...
```bash
$ module load quay.io/biocontainers/twilight/0.1.4--h6bb9b41_0
$ module help quay.io/biocontainers/twilight/0.1.4--h6bb9b41_0
```
