...
updated_at: "2026-02-03 04:20:15.975378"
...
```bash
$ shpc install quay.io/biocontainers/alfred:0.5.1--h4d20210_0
```
...
```bash
$ module load quay.io/biocontainers/alfred/0.5.1--h4d20210_0
$ module help quay.io/biocontainers/alfred/0.5.1--h4d20210_0
```
