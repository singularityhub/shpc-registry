...
updated_at: "2026-04-03 15:40:36.335571"
latest: "0.5.3--hd6466ae_0"
...
```bash
$ shpc install quay.io/biocontainers/alfred:0.5.3--hd6466ae_0
```
...
```bash
$ module load quay.io/biocontainers/alfred/0.5.3--hd6466ae_0
$ module help quay.io/biocontainers/alfred/0.5.3--hd6466ae_0
```
