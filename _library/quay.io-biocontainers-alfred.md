...
updated_at: "2024-02-22 03:28:31.776557"
...
```bash
$ shpc install quay.io/biocontainers/alfred:0.2.8--h0d5efe1_0
```
...
```bash
$ module load quay.io/biocontainers/alfred/0.2.8--h0d5efe1_0
$ module help quay.io/biocontainers/alfred/0.2.8--h0d5efe1_0
```
