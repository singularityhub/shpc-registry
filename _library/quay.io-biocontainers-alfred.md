...
updated_at: "2024-04-30 02:47:04.873883"
...
```bash
$ shpc install quay.io/biocontainers/alfred:0.3.1--h0d5efe1_0
```
...
```bash
$ module load quay.io/biocontainers/alfred/0.3.1--h0d5efe1_0
$ module help quay.io/biocontainers/alfred/0.3.1--h0d5efe1_0
```
