...
updated_at: "2024-12-26 03:06:15.457992"
latest: "0.3.2--hf9970c3_0"
...
```bash
$ shpc install quay.io/biocontainers/alfred:0.3.2--hf9970c3_0
```
...
```bash
$ module load quay.io/biocontainers/alfred/0.3.2--hf9970c3_0
$ module help quay.io/biocontainers/alfred/0.3.2--hf9970c3_0
```
