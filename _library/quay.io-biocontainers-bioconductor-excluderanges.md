...
updated_at: "2022-11-01 03:31:35.356559"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-excluderanges:0.99.6--r41hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-excluderanges/0.99.6--r41hdfd78af_1
$ module help quay.io/biocontainers/bioconductor-excluderanges/0.99.6--r41hdfd78af_1
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-excluderanges-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-excluderanges-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-excluderanges-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-excluderanges-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-excluderanges-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-excluderanges-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
