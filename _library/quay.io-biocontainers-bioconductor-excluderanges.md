...
updated_at: "2026-04-05 05:06:07.529811"
latest: "0.99.10--r45hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-excluderanges:0.99.10--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-excluderanges/0.99.10--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-excluderanges/0.99.10--r45hdfd78af_0
```
