...
updated_at: "2026-03-25 04:33:17.056868"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-genomicdistributionsdata:1.18.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-genomicdistributionsdata/1.18.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-genomicdistributionsdata/1.18.0--r45hdfd78af_0
```
