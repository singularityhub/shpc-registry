...
updated_at: "2022-11-15 00:06:34.051955"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-chic.data:1.14.0--r41hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-chic.data/1.14.0--r41hdfd78af_1
$ module help quay.io/biocontainers/bioconductor-chic.data/1.14.0--r41hdfd78af_1
```
