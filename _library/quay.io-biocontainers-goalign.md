...
updated_at: "2026-09-02 07:00:18.003921"
latest: "0.4.1--h9ee0642_0"
...
```bash
$ shpc install quay.io/biocontainers/goalign:0.4.1--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/goalign/0.4.1--h9ee0642_0
$ module help quay.io/biocontainers/goalign/0.4.1--h9ee0642_0
```
