...
updated_at: "2025-07-01 03:53:57.724522"
latest: "0.3.8--h9ee0642_0"
...
```bash
$ shpc install quay.io/biocontainers/goalign:0.3.8--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/goalign/0.3.8--h9ee0642_0
$ module help quay.io/biocontainers/goalign/0.3.8--h9ee0642_0
```
