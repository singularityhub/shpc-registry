...
updated_at: "2022-11-15 01:12:27.641973"
latest: "3.16.3"
...
```bash
$ shpc install ghcr.io/autamus/py-petsc4py:3.16.3
```
...
```bash
$ module load ghcr.io/autamus/py-petsc4py/3.16.3
$ module help ghcr.io/autamus/py-petsc4py/3.16.3
```
