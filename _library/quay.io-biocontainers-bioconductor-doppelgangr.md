...
updated_at: "2022-11-07 23:56:44.178493"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-doppelgangr:1.22.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-doppelgangr/1.22.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-doppelgangr/1.22.0--r41hdfd78af_0
```
