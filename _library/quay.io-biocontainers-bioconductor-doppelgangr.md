...
updated_at: "2023-08-19 02:39:52.166652"
latest: "1.28.1--r43hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-doppelgangr:1.28.1--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-doppelgangr/1.28.1--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-doppelgangr/1.28.1--r43hdfd78af_0
```
