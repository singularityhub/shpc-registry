...
updated_at: "2024-09-01 03:00:05.258701"
...
```bash
$ shpc install quay.io/biocontainers/lollipop:0.4.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/lollipop/0.4.1--pyhdfd78af_0
$ module help quay.io/biocontainers/lollipop/0.4.1--pyhdfd78af_0
```
