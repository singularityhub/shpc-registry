...
updated_at: "2025-05-15 03:55:10.633585"
...
```bash
$ shpc install quay.io/biocontainers/lollipop:0.5.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/lollipop/0.5.2--pyhdfd78af_0
$ module help quay.io/biocontainers/lollipop/0.5.2--pyhdfd78af_0
```
