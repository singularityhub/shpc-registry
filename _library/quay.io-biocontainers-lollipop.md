...
updated_at: "2025-02-07 03:25:25.698119"
...
```bash
$ shpc install quay.io/biocontainers/lollipop:0.5.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/lollipop/0.5.1--pyhdfd78af_0
$ module help quay.io/biocontainers/lollipop/0.5.1--pyhdfd78af_0
```
