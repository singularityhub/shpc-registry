...
updated_at: "2024-12-15 04:47:26.447165"
...
```bash
$ shpc install quay.io/biocontainers/lollipop:0.5.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/lollipop/0.5.0--pyhdfd78af_0
$ module help quay.io/biocontainers/lollipop/0.5.0--pyhdfd78af_0
```
