...
updated_at: "2026-08-20 03:53:02.662695"
...
```bash
$ shpc install quay.io/biocontainers/pybarrnap:0.5.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pybarrnap/0.5.2--pyhdfd78af_0
$ module help quay.io/biocontainers/pybarrnap/0.5.2--pyhdfd78af_0
```
