---
layout: container
name:  "quay.io/biocontainers/filechunkio"
maintainer: "@vsoch"
...
updated_at: "2024-07-29 17:49:46.731746"
latest: "1.6--py35_0"
...
```bash
$ shpc install quay.io/biocontainers/filechunkio
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/filechunkio:1.6--py35_0
```
...
```bash
$ module load quay.io/biocontainers/filechunkio/1.6--py35_0
$ module help quay.io/biocontainers/filechunkio/1.6--py35_0
```
...
#### filechunkio-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### filechunkio-inspect-deffile:
