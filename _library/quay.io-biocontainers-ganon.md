...
updated_at: "2025-02-05 03:09:43.179098"
latest: "2.1.0--py312hf7d24d3_2"
...
```bash
$ shpc install quay.io/biocontainers/ganon:2.1.0--py312hf7d24d3_2
```
...
```bash
$ module load quay.io/biocontainers/ganon/2.1.0--py312hf7d24d3_2
$ module help quay.io/biocontainers/ganon/2.1.0--py312hf7d24d3_2
```
