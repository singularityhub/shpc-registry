...
updated_at: "2026-06-01 07:44:07.033030"
latest: "2.4.1--py312h88d62d1_0"
...
```bash
$ shpc install quay.io/biocontainers/ganon:2.4.1--py312h88d62d1_0
```
...
```bash
$ module load quay.io/biocontainers/ganon/2.4.1--py312h88d62d1_0
$ module help quay.io/biocontainers/ganon/2.4.1--py312h88d62d1_0
```
