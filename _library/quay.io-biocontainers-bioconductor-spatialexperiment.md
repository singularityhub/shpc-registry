...
updated_at: "2025-10-31 03:56:58.757122"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-spatialexperiment:1.16.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-spatialexperiment/1.16.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-spatialexperiment/1.16.0--r44hdfd78af_0
```
