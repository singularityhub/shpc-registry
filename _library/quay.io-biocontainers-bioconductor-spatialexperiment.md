...
updated_at: "2026-04-01 05:08:45.617235"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-spatialexperiment:1.20.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-spatialexperiment/1.20.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-spatialexperiment/1.20.0--r45hdfd78af_0
```
