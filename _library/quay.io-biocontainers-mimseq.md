...
updated_at: "2026-04-14 05:04:07.611357"
...
```bash
$ shpc install quay.io/biocontainers/mimseq:1.3.11--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mimseq/1.3.11--pyhdfd78af_0
$ module help quay.io/biocontainers/mimseq/1.3.11--pyhdfd78af_0
```
