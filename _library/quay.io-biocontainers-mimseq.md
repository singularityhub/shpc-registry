...
updated_at: "2023-07-28 02:35:41.068429"
...
```bash
$ shpc install quay.io/biocontainers/mimseq:1.3.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mimseq/1.3.5--pyhdfd78af_0
$ module help quay.io/biocontainers/mimseq/1.3.5--pyhdfd78af_0
```
