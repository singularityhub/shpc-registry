...
updated_at: "2023-05-25 03:06:13.610074"
...
```bash
$ shpc install quay.io/biocontainers/mimseq:1.3.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mimseq/1.3.3--pyhdfd78af_0
$ module help quay.io/biocontainers/mimseq/1.3.3--pyhdfd78af_0
```
