...
updated_at: "2024-02-16 03:03:03.250320"
...
```bash
$ shpc install quay.io/biocontainers/mimseq:1.3.8--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mimseq/1.3.8--pyhdfd78af_0
$ module help quay.io/biocontainers/mimseq/1.3.8--pyhdfd78af_0
```
