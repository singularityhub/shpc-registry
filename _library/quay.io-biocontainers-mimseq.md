...
updated_at: "2025-08-07 09:54:29.833658"
...
```bash
$ shpc install quay.io/biocontainers/mimseq:1.3.9--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mimseq/1.3.9--pyhdfd78af_0
$ module help quay.io/biocontainers/mimseq/1.3.9--pyhdfd78af_0
```
