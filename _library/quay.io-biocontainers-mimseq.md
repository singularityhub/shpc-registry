...
updated_at: "2023-12-09 03:05:40.381197"
...
```bash
$ shpc install quay.io/biocontainers/mimseq:1.3.7--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mimseq/1.3.7--pyhdfd78af_0
$ module help quay.io/biocontainers/mimseq/1.3.7--pyhdfd78af_0
```
