...
updated_at: "2023-08-15 02:55:23.562022"
...
```bash
$ shpc install quay.io/biocontainers/mimseq:1.3.6--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mimseq/1.3.6--pyhdfd78af_0
$ module help quay.io/biocontainers/mimseq/1.3.6--pyhdfd78af_0
```
