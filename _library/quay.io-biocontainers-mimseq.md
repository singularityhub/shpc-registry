...
updated_at: "2026-03-05 05:11:39.248178"
...
```bash
$ shpc install quay.io/biocontainers/mimseq:1.3.10--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mimseq/1.3.10--pyhdfd78af_0
$ module help quay.io/biocontainers/mimseq/1.3.10--pyhdfd78af_0
```
