...
updated_at: "2023-12-13 02:56:18.010357"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mogene11stprobeset.db:8.8.0--r43hdfd78af_3
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mogene11stprobeset.db/8.8.0--r43hdfd78af_3
$ module help quay.io/biocontainers/bioconductor-mogene11stprobeset.db/8.8.0--r43hdfd78af_3
```
