...
updated_at: "2023-11-06 02:57:41.884241"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-delocal:1.0.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-delocal/1.0.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-delocal/1.0.0--r43hdfd78af_0
```
