...
updated_at: "2023-10-09 02:36:14.174038"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-lmdme:1.42.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-lmdme/1.42.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-lmdme/1.42.0--r43hdfd78af_0
```
