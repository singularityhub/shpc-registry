...
updated_at: "2024-03-17 02:55:26.669615"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ri16cod.db:3.4.0--r43hdfd78af_12
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ri16cod.db/3.4.0--r43hdfd78af_12
$ module help quay.io/biocontainers/bioconductor-ri16cod.db/3.4.0--r43hdfd78af_12
```
