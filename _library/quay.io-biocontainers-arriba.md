...
updated_at: "2025-08-29 03:13:00.556507"
latest: "2.5.0--h87b9561_1"
...
```bash
$ shpc install quay.io/biocontainers/arriba:2.5.0--h87b9561_1
```
...
```bash
$ module load quay.io/biocontainers/arriba/2.5.0--h87b9561_1
$ module help quay.io/biocontainers/arriba/2.5.0--h87b9561_1
```
