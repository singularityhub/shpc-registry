...
updated_at: "2025-04-25 02:17:38.304955"
latest: "2.5.0--h432159b_0"
...
```bash
$ shpc install quay.io/biocontainers/arriba:2.5.0--h432159b_0
```
...
```bash
$ module load quay.io/biocontainers/arriba/2.5.0--h432159b_0
$ module help quay.io/biocontainers/arriba/2.5.0--h432159b_0
```
