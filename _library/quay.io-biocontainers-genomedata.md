...
updated_at: "2026-05-27 07:16:14.085964"
latest: "1.7.4--py311hc60a32c_1"
...
```bash
$ shpc install quay.io/biocontainers/genomedata:1.7.4--py311hc60a32c_1
```
...
```bash
$ module load quay.io/biocontainers/genomedata/1.7.4--py311hc60a32c_1
$ module help quay.io/biocontainers/genomedata/1.7.4--py311hc60a32c_1
```
