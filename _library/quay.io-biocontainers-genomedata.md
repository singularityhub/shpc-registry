...
updated_at: "2025-01-08 06:35:31.573539"
latest: "1.7.3--py39h41d699a_1"
...
```bash
$ shpc install quay.io/biocontainers/genomedata:1.7.3--py39h41d699a_1
```
...
```bash
$ module load quay.io/biocontainers/genomedata/1.7.3--py39h41d699a_1
$ module help quay.io/biocontainers/genomedata/1.7.3--py39h41d699a_1
```
