...
updated_at: "2026-01-19 04:47:05.956496"
latest: "1.7.4--py311h87bb1fd_0"
...
```bash
$ shpc install quay.io/biocontainers/genomedata:1.7.4--py311h87bb1fd_0
```
...
```bash
$ module load quay.io/biocontainers/genomedata/1.7.4--py311h87bb1fd_0
$ module help quay.io/biocontainers/genomedata/1.7.4--py311h87bb1fd_0
```
