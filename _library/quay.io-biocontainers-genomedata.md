...
updated_at: "2024-09-01 03:41:41.214943"
latest: "1.7.2--py312h2f6fde3_2"
...
```bash
$ shpc install quay.io/biocontainers/genomedata:1.7.2--py312h2f6fde3_2
```
...
```bash
$ module load quay.io/biocontainers/genomedata/1.7.2--py312h2f6fde3_2
$ module help quay.io/biocontainers/genomedata/1.7.2--py312h2f6fde3_2
```
