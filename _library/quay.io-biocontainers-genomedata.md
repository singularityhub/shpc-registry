...
updated_at: "2025-09-02 03:57:36.286413"
latest: "1.7.3--py311h87bb1fd_2"
...
```bash
$ shpc install quay.io/biocontainers/genomedata:1.7.3--py311h87bb1fd_2
```
...
```bash
$ module load quay.io/biocontainers/genomedata/1.7.3--py311h87bb1fd_2
$ module help quay.io/biocontainers/genomedata/1.7.3--py311h87bb1fd_2
```
