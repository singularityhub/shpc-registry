...
updated_at: "2024-07-10 02:45:11.993030"
latest: "1.7.2--py312h2f6fde3_1"
...
```bash
$ shpc install quay.io/biocontainers/genomedata:1.7.2--py312h2f6fde3_1
```
...
```bash
$ module load quay.io/biocontainers/genomedata/1.7.2--py312h2f6fde3_1
$ module help quay.io/biocontainers/genomedata/1.7.2--py312h2f6fde3_1
```
