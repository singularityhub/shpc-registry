...
updated_at: "2023-10-28 02:40:31.800371"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cexor:1.38.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cexor/1.38.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-cexor/1.38.0--r43hdfd78af_0
```
