...
updated_at: "2026-03-05 01:04:34.950978"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hicbricks:1.28.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hicbricks/1.28.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-hicbricks/1.28.0--r45hdfd78af_0
```
