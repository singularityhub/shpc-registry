...
updated_at: "2023-09-28 03:25:51.497103"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hicbricks:1.18.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hicbricks/1.18.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-hicbricks/1.18.0--r43hdfd78af_0
```
