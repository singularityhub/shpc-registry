...
updated_at: "2025-12-01 05:52:23.048734"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hicbricks:1.24.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hicbricks/1.24.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-hicbricks/1.24.0--r44hdfd78af_0
```
