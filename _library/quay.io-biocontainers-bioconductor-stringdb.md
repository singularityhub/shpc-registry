...
updated_at: "2024-02-01 03:17:57.503112"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-stringdb:2.14.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-stringdb/2.14.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-stringdb/2.14.0--r43hdfd78af_0
```
