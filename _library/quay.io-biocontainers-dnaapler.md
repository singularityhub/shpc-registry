...
updated_at: "2024-09-03 03:12:58.613143"
...
```bash
$ shpc install quay.io/biocontainers/dnaapler:0.8.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/dnaapler/0.8.0--pyhdfd78af_0
$ module help quay.io/biocontainers/dnaapler/0.8.0--pyhdfd78af_0
```
