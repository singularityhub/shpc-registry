...
updated_at: "2024-11-28 03:57:57.355323"
...
```bash
$ shpc install quay.io/biocontainers/dnaapler:1.0.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/dnaapler/1.0.1--pyhdfd78af_0
$ module help quay.io/biocontainers/dnaapler/1.0.1--pyhdfd78af_0
```
