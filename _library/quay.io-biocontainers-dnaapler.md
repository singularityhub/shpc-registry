...
updated_at: "2024-02-28 02:24:17.896059"
...
```bash
$ shpc install quay.io/biocontainers/dnaapler:0.7.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/dnaapler/0.7.0--pyhdfd78af_0
$ module help quay.io/biocontainers/dnaapler/0.7.0--pyhdfd78af_0
```
