...
updated_at: "2023-12-31 02:31:22.844329"
...
```bash
$ shpc install quay.io/biocontainers/dnaapler:0.5.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/dnaapler/0.5.0--pyhdfd78af_0
$ module help quay.io/biocontainers/dnaapler/0.5.0--pyhdfd78af_0
```
