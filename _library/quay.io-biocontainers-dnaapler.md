...
updated_at: "2025-02-09 03:16:19.219321"
...
```bash
$ shpc install quay.io/biocontainers/dnaapler:1.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/dnaapler/1.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/dnaapler/1.1.0--pyhdfd78af_0
```
