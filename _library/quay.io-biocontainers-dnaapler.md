...
updated_at: "2024-02-01 02:26:57.355230"
...
```bash
$ shpc install quay.io/biocontainers/dnaapler:0.5.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/dnaapler/0.5.1--pyhdfd78af_0
$ module help quay.io/biocontainers/dnaapler/0.5.1--pyhdfd78af_0
```
