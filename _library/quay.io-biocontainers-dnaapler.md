...
updated_at: "2026-08-18 03:18:17.917424"
...
```bash
$ shpc install quay.io/biocontainers/dnaapler:1.4.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/dnaapler/1.4.0--pyhdfd78af_0
$ module help quay.io/biocontainers/dnaapler/1.4.0--pyhdfd78af_0
```
