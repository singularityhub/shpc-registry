...
updated_at: "2024-10-08 03:12:19.788061"
...
```bash
$ shpc install quay.io/biocontainers/dnaapler:0.8.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/dnaapler/0.8.1--pyhdfd78af_0
$ module help quay.io/biocontainers/dnaapler/0.8.1--pyhdfd78af_0
```
