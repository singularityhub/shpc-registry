...
updated_at: "2025-05-06 03:38:37.592176"
...
```bash
$ shpc install quay.io/biocontainers/r-floral:0.4.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/r-floral/0.4.0--r44hdfd78af_0
$ module help quay.io/biocontainers/r-floral/0.4.0--r44hdfd78af_0
```
