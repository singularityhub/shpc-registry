...
updated_at: "2025-03-16 03:27:53.974780"
...
```bash
$ shpc install quay.io/biocontainers/galaxy-schema:24.2.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/galaxy-schema/24.2.2--pyhdfd78af_0
$ module help quay.io/biocontainers/galaxy-schema/24.2.2--pyhdfd78af_0
```
