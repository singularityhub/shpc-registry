---
layout: container
name:  "quay.io/biocontainers/galaxy-schema"
maintainer: "@vsoch"
...
updated_at: "2026-01-16 03:48:11.698239"
latest: "25.0.4--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/galaxy-schema
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/galaxy-schema:25.0.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/galaxy-schema/25.0.4--pyhdfd78af_0
$ module help quay.io/biocontainers/galaxy-schema/25.0.4--pyhdfd78af_0
```
...
#### galaxy-schema-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### galaxy-schema-inspect-deffile:
