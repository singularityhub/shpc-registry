...
updated_at: "2024-10-03 02:52:55.548960"
...
```bash
$ shpc install quay.io/biocontainers/galaxy-schema:24.1.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/galaxy-schema/24.1.1--pyhdfd78af_0
$ module help quay.io/biocontainers/galaxy-schema/24.1.1--pyhdfd78af_0
```
