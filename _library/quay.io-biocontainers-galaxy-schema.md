...
updated_at: "2025-01-17 02:46:02.908979"
latest: "24.1.4--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/galaxy-schema:24.1.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/galaxy-schema/24.1.4--pyhdfd78af_0
$ module help quay.io/biocontainers/galaxy-schema/24.1.4--pyhdfd78af_0
```
