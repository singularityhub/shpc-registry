...
updated_at: "2025-08-10 04:07:10.392986"
...
```bash
$ shpc install quay.io/biocontainers/galaxy-schema:25.0.1--pyh7e72e81_0
```
...
```bash
$ module load quay.io/biocontainers/galaxy-schema/25.0.1--pyh7e72e81_0
$ module help quay.io/biocontainers/galaxy-schema/25.0.1--pyh7e72e81_0
```
