...
updated_at: "2025-05-05 03:38:17.198464"
...
```bash
$ shpc install quay.io/biocontainers/galaxy-schema:24.2.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/galaxy-schema/24.2.3--pyhdfd78af_0
$ module help quay.io/biocontainers/galaxy-schema/24.2.3--pyhdfd78af_0
```
