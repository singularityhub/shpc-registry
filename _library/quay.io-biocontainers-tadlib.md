...
updated_at: "2024-06-24 03:00:27.428921"
...
```bash
$ shpc install quay.io/biocontainers/tadlib:0.4.5.post1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/tadlib/0.4.5.post1--pyhdfd78af_0
$ module help quay.io/biocontainers/tadlib/0.4.5.post1--pyhdfd78af_0
```
