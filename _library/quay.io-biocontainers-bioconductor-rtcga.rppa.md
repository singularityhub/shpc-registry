...
updated_at: "2026-03-06 04:51:50.808636"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rtcga.rppa:1.38.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rtcga.rppa/1.38.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rtcga.rppa/1.38.0--r45hdfd78af_0
```
