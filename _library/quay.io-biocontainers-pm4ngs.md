...
updated_at: "2026-01-31 04:47:19.932372"
...
```bash
$ shpc install quay.io/biocontainers/pm4ngs:0.1.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pm4ngs/0.1.2--pyhdfd78af_0
$ module help quay.io/biocontainers/pm4ngs/0.1.2--pyhdfd78af_0
```
