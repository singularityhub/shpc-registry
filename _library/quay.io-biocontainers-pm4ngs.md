...
updated_at: "2026-04-01 05:20:28.932487"
...
```bash
$ shpc install quay.io/biocontainers/pm4ngs:0.1.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pm4ngs/0.1.3--pyhdfd78af_0
$ module help quay.io/biocontainers/pm4ngs/0.1.3--pyhdfd78af_0
```
