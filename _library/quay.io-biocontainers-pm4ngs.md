...
updated_at: "2026-04-30 06:14:26.525040"
...
```bash
$ shpc install quay.io/biocontainers/pm4ngs:0.1.6--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pm4ngs/0.1.6--pyhdfd78af_0
$ module help quay.io/biocontainers/pm4ngs/0.1.6--pyhdfd78af_0
```
