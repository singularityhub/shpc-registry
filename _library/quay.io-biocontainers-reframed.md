...
updated_at: "2025-08-15 05:16:11.984523"
...
```bash
$ shpc install quay.io/biocontainers/reframed:1.6.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/reframed/1.6.0--pyhdfd78af_0
$ module help quay.io/biocontainers/reframed/1.6.0--pyhdfd78af_0
```
