...
updated_at: "2025-04-24 03:38:56.227388"
...
```bash
$ shpc install quay.io/biocontainers/reframed:1.5.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/reframed/1.5.4--pyhdfd78af_0
$ module help quay.io/biocontainers/reframed/1.5.4--pyhdfd78af_0
```
