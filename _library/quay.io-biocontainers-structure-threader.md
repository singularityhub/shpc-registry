---
layout: container
name:  "quay.io/biocontainers/structure-threader"
maintainer: "@vsoch"
...
updated_at: "2025-08-11 03:53:54.757908"
...
singularity registry hpc automated addition for structure-threader
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/structure-threader
```
...
#### structure-threader-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### structure-threader-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/alstructure_wrapper.R
$ podman run --it --rm --entrypoint /usr/local/bin/alstructure_wrapper.R   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/alstructure_wrapper.R   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/fastStructure
$ podman run --it --rm --entrypoint /usr/local/bin/fastStructure   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/fastStructure   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/structure_threader
$ podman run --it --rm --entrypoint /usr/local/bin/structure_threader   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/structure_threader   -v ${PWD} -w ${PWD} <container> -c " $@"
```
