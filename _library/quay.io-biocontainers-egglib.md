...
updated_at: "2024-12-28 02:53:21.282554"
latest: "3.3.4--py39h0dd7abe_0"
...
```bash
$ shpc install quay.io/biocontainers/egglib:3.3.4--py39h0dd7abe_0
```
...
```bash
$ module load quay.io/biocontainers/egglib/3.3.4--py39h0dd7abe_0
$ module help quay.io/biocontainers/egglib/3.3.4--py39h0dd7abe_0
```
