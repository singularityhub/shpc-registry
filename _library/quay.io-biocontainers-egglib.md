...
updated_at: "2024-03-28 03:10:47.563101"
...
```bash
$ shpc install quay.io/biocontainers/egglib:3.3.2--py38hcbe9525_0
```
...
```bash
$ module load quay.io/biocontainers/egglib/3.3.2--py38hcbe9525_0
$ module help quay.io/biocontainers/egglib/3.3.2--py38hcbe9525_0
```
