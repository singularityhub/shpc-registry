...
updated_at: "2025-01-08 02:57:42.788641"
latest: "3.3.4--py311h8ddd9a4_1"
...
```bash
$ shpc install quay.io/biocontainers/egglib:3.3.4--py311h8ddd9a4_1
```
...
```bash
$ module load quay.io/biocontainers/egglib/3.3.4--py311h8ddd9a4_1
$ module help quay.io/biocontainers/egglib/3.3.4--py311h8ddd9a4_1
```
