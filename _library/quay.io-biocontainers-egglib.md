...
updated_at: "2024-02-15 03:04:34.284171"
latest: "3.3.1--py310h068649b_0"
...
```bash
$ shpc install quay.io/biocontainers/egglib:3.3.1--py310h068649b_0
```
...
```bash
$ module load quay.io/biocontainers/egglib/3.3.1--py310h068649b_0
$ module help quay.io/biocontainers/egglib/3.3.1--py310h068649b_0
```
