...
updated_at: "2024-03-14 02:40:40.836866"
latest: "1.26.0--r43h7c4fd5e_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rjmcmcnucleosomes:1.26.0--r43h7c4fd5e_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rjmcmcnucleosomes/1.26.0--r43h7c4fd5e_0
$ module help quay.io/biocontainers/bioconductor-rjmcmcnucleosomes/1.26.0--r43h7c4fd5e_0
```
