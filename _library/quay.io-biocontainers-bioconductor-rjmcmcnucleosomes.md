...
updated_at: "2026-04-03 15:16:26.823558"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rjmcmcnucleosomes:1.34.0--r45ha27e39d_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rjmcmcnucleosomes/1.34.0--r45ha27e39d_0
$ module help quay.io/biocontainers/bioconductor-rjmcmcnucleosomes/1.34.0--r45ha27e39d_0
```
