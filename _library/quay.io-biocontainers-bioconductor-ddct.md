...
updated_at: "2026-03-05 01:07:58.484111"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ddct:1.66.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ddct/1.66.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ddct/1.66.0--r45hdfd78af_0
```
