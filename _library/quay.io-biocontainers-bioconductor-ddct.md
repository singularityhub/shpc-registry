...
updated_at: "2024-02-08 08:02:48.044971"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ddct:1.58.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ddct/1.58.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ddct/1.58.0--r43hdfd78af_0
```
