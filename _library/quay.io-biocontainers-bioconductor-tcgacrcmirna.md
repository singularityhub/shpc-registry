...
updated_at: "2026-03-02 04:58:03.538547"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-tcgacrcmirna:1.30.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-tcgacrcmirna/1.30.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-tcgacrcmirna/1.30.0--r45hdfd78af_0
```
