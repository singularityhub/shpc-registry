...
updated_at: "2023-12-20 03:49:33.568033"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-tcgacrcmirna:1.20.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-tcgacrcmirna/1.20.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-tcgacrcmirna/1.20.0--r43hdfd78af_0
```
