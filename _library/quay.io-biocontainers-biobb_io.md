...
updated_at: "2026-01-30 04:48:34.480725"
...
```bash
$ shpc install quay.io/biocontainers/biobb_io:5.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_io/5.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/biobb_io/5.2.0--pyhdfd78af_0
```
