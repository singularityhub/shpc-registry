...
updated_at: "2026-03-11 04:22:20.392790"
...
```bash
$ shpc install quay.io/biocontainers/biobb_io:5.2.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_io/5.2.2--pyhdfd78af_0
$ module help quay.io/biocontainers/biobb_io/5.2.2--pyhdfd78af_0
```
