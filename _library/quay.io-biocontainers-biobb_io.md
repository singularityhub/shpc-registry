...
updated_at: "2026-09-23 07:52:42.901157"
...
```bash
$ shpc install quay.io/biocontainers/biobb_io:5.3.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_io/5.3.1--pyhdfd78af_0
$ module help quay.io/biocontainers/biobb_io/5.3.1--pyhdfd78af_0
```
