...
updated_at: "2024-08-08 04:04:09.672171"
...
```bash
$ shpc install quay.io/biocontainers/biobb_io:4.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_io/4.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/biobb_io/4.2.0--pyhdfd78af_0
```
