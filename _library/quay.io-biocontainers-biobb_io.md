...
updated_at: "2023-12-13 03:07:43.610778"
...
```bash
$ shpc install quay.io/biocontainers/biobb_io:4.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_io/4.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/biobb_io/4.1.0--pyhdfd78af_0
```
