...
updated_at: "2024-05-19 03:17:37.912630"
...
```bash
$ shpc install quay.io/biocontainers/biobb_io:4.1.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_io/4.1.1--pyhdfd78af_0
$ module help quay.io/biocontainers/biobb_io/4.1.1--pyhdfd78af_0
```
