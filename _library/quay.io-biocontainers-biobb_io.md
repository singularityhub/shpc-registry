...
updated_at: "2025-12-29 04:29:57.715137"
...
```bash
$ shpc install quay.io/biocontainers/biobb_io:5.1.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_io/5.1.1--pyhdfd78af_0
$ module help quay.io/biocontainers/biobb_io/5.1.1--pyhdfd78af_0
```
