...
updated_at: "2022-10-29 05:33:34.185895"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-scanmir:1.0.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-scanmir/1.0.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-scanmir/1.0.0--r41hdfd78af_0
```
