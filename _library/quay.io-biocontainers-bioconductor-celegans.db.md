...
updated_at: "2022-11-03 23:51:36.783963"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-celegans.db:3.2.3--r41hdfd78af_7
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-celegans.db/3.2.3--r41hdfd78af_7
$ module help quay.io/biocontainers/bioconductor-celegans.db/3.2.3--r41hdfd78af_7
```
