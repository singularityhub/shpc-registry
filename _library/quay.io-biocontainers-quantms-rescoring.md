...
updated_at: "2025-05-07 03:39:57.083238"
...
```bash
$ shpc install quay.io/biocontainers/quantms-rescoring:0.0.9--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/quantms-rescoring/0.0.9--pyhdfd78af_0
$ module help quay.io/biocontainers/quantms-rescoring/0.0.9--pyhdfd78af_0
```
