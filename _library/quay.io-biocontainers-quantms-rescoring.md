...
updated_at: "2025-01-07 03:29:01.454866"
...
```bash
$ shpc install quay.io/biocontainers/quantms-rescoring:0.0.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/quantms-rescoring/0.0.1--pyhdfd78af_0
$ module help quay.io/biocontainers/quantms-rescoring/0.0.1--pyhdfd78af_0
```
