...
updated_at: "2025-05-10 03:10:43.022485"
latest: "2.14.1--hdb21ba3_2"
...
```bash
$ shpc install quay.io/biocontainers/rmblast:2.14.1--hdb21ba3_2
```
...
```bash
$ module load quay.io/biocontainers/rmblast/2.14.1--hdb21ba3_2
$ module help quay.io/biocontainers/rmblast/2.14.1--hdb21ba3_2
```
