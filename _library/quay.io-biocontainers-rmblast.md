...
updated_at: "2026-06-25 06:39:53.659924"
latest: "2.17.0--hbfc2172_0"
...
```bash
$ shpc install quay.io/biocontainers/rmblast:2.17.0--hbfc2172_0
```
...
```bash
$ module load quay.io/biocontainers/rmblast/2.17.0--hbfc2172_0
$ module help quay.io/biocontainers/rmblast/2.17.0--hbfc2172_0
```
