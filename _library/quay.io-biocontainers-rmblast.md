...
updated_at: "2023-08-24 02:22:59.910919"
latest: "2.14.0--h21a3994_1"
...
```bash
$ shpc install quay.io/biocontainers/rmblast:2.14.0--h21a3994_1
```
...
```bash
$ module load quay.io/biocontainers/rmblast/2.14.0--h21a3994_1
$ module help quay.io/biocontainers/rmblast/2.14.0--h21a3994_1
```
