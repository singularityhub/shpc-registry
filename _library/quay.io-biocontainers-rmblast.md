...
updated_at: "2022-11-07 00:39:02.711906"
latest: "2.9.0--h2d02072_0"
...
```bash
$ shpc install quay.io/biocontainers/rmblast:2.9.0--h2d02072_0
```
...
```bash
$ module load quay.io/biocontainers/rmblast/2.9.0--h2d02072_0
$ module help quay.io/biocontainers/rmblast/2.9.0--h2d02072_0
```
