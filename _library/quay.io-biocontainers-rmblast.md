...
updated_at: "2026-08-10 04:19:09.348377"
latest: "2.17.0--hbfc2172_1"
...
```bash
$ shpc install quay.io/biocontainers/rmblast:2.17.0--hbfc2172_1
```
...
```bash
$ module load quay.io/biocontainers/rmblast/2.17.0--hbfc2172_1
$ module help quay.io/biocontainers/rmblast/2.17.0--hbfc2172_1
```
