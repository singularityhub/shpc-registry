...
updated_at: "2022-11-14 00:22:03.027606"
...
```bash
$ shpc install quay.io/biocontainers/msproteomicstools:0.8.0--py27h6d73bfa_1
```
...
```bash
$ module load quay.io/biocontainers/msproteomicstools/0.8.0--py27h6d73bfa_1
$ module help quay.io/biocontainers/msproteomicstools/0.8.0--py27h6d73bfa_1
```
