...
updated_at: "2025-08-26 03:14:20.122300"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-epivizrchart:1.28.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-epivizrchart/1.28.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-epivizrchart/1.28.0--r44hdfd78af_0
```
