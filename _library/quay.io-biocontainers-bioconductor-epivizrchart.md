...
updated_at: "2024-04-04 03:53:20.214125"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-epivizrchart:1.24.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-epivizrchart/1.24.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-epivizrchart/1.24.0--r43hdfd78af_0
```
