...
updated_at: "2025-06-23 03:52:35.432349"
latest: "5.0.8--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/dendropy:5.0.8--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/dendropy/5.0.8--pyhdfd78af_0
$ module help quay.io/biocontainers/dendropy/5.0.8--pyhdfd78af_0
```
