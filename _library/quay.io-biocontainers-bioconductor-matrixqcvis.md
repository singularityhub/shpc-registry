...
updated_at: "2024-08-22 02:43:58.220052"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-matrixqcvis:1.10.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-matrixqcvis/1.10.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-matrixqcvis/1.10.0--r43hdfd78af_0
```
