---
layout: container
name:  "quay.io/biocontainers/bioconductor-seraster"
maintainer: "@vsoch"
github: "https://github.com/singularityhub/shpc-registry/blob/main/quay.io/biocontainers/bioconductor-seraster/container.yaml"
config_url: "https://raw.githubusercontent.com/singularityhub/shpc-registry/main/quay.io/biocontainers/bioconductor-seraster/container.yaml"
updated_at: "2026-03-28 17:10:29.261833"
latest: "1.2.0--r45hdfd78af_0"
container_url: "https://biocontainers.pro/tools/bioconductor-seraster"
aliases:
 - "gdal"
 - "gdal_footprint"
 - "minigzip"
...
versions:
 - "1.2.0--r45hdfd78af_0"
description: "singularity registry hpc automated addition for bioconductor-seraster"
config: {"url": "https://biocontainers.pro/tools/bioconductor-seraster", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for bioconductor-seraster", "latest": {"1.2.0--r45hdfd78af_0": "sha256:63b9f3200725b34ceb6639216b7d748803d450e5ef797cfedb35ac03033ac5c3"}, "tags": {"1.2.0--r45hdfd78af_0": "sha256:63b9f3200725b34ceb6639216b7d748803d450e5ef797cfedb35ac03033ac5c3"}, "docker": "quay.io/biocontainers/bioconductor-seraster", "aliases": {"gdal": "/usr/local/bin/gdal", "gdal_footprint": "/usr/local/bin/gdal_footprint", "minigzip": "/usr/local/bin/minigzip", "minizip": "/usr/local/bin/minizip", "sozip": "/usr/local/bin/sozip", "dot_sandbox": "/usr/local/bin/dot_sandbox", "dec265": "/usr/local/bin/dec265", "bsdunzip": "/usr/local/bin/bsdunzip", "gtk-builder-tool": "/usr/local/bin/gtk-builder-tool", "gtk-encode-symbolic-svg": "/usr/local/bin/gtk-encode-symbolic-svg", "gtk-launch": "/usr/local/bin/gtk-launch", "gtk-query-immodules-3.0": "/usr/local/bin/gtk-query-immodules-3.0", "gtk-query-settings": "/usr/local/bin/gtk-query-settings", "gdal_create": "/usr/local/bin/gdal_create", "gdal_viewshed": "/usr/local/bin/gdal_viewshed", "gdalmdiminfo": "/usr/local/bin/gdalmdiminfo", "gdalmdimtranslate": "/usr/local/bin/gdalmdimtranslate", "x265": "/usr/local/bin/x265", "gnmanalyse": "/usr/local/bin/gnmanalyse", "gnmmanage": "/usr/local/bin/gnmmanage", "gdal-config": "/usr/local/bin/gdal-config", "gdal_contour": "/usr/local/bin/gdal_contour", "gdal_grid": "/usr/local/bin/gdal_grid", "gdal_rasterize": "/usr/local/bin/gdal_rasterize", "gdal_translate": "/usr/local/bin/gdal_translate"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/bioconductor-seraster.
singularity registry hpc automated addition for bioconductor-seraster
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/bioconductor-seraster
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-seraster:1.2.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-seraster/1.2.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-seraster/1.2.0--r45hdfd78af_0
```
...
#### bioconductor-seraster-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-seraster-inspect-deffile:
