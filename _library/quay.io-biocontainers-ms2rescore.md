...
updated_at: "2026-08-25 03:30:59.169849"
...
```bash
$ shpc install quay.io/biocontainers/ms2rescore:3.2.1--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/ms2rescore/3.2.1--pyhdfd78af_1
$ module help quay.io/biocontainers/ms2rescore/3.2.1--pyhdfd78af_1
```
