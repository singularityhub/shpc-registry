...
updated_at: "2024-07-22 03:43:13.426529"
...
```bash
$ shpc install quay.io/biocontainers/ms2rescore:3.0.1--pyhdfd78af_2
```
...
```bash
$ module load quay.io/biocontainers/ms2rescore/3.0.1--pyhdfd78af_2
$ module help quay.io/biocontainers/ms2rescore/3.0.1--pyhdfd78af_2
```
