...
updated_at: "2023-10-29 02:43:08.528107"
...
```bash
$ shpc install quay.io/biocontainers/ms2rescore:3.0.0b1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ms2rescore/3.0.0b1--pyhdfd78af_0
$ module help quay.io/biocontainers/ms2rescore/3.0.0b1--pyhdfd78af_0
```
