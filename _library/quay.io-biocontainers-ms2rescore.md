...
updated_at: "2026-02-01 04:33:34.345350"
latest: "3.2.0.post1--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/ms2rescore:3.2.0.post1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ms2rescore/3.2.0.post1--pyhdfd78af_0
$ module help quay.io/biocontainers/ms2rescore/3.2.0.post1--pyhdfd78af_0
```
