...
updated_at: "2025-11-23 03:40:45.358155"
...
```bash
$ shpc install quay.io/biocontainers/ms2rescore:3.1.5--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/ms2rescore/3.1.5--pyhdfd78af_1
$ module help quay.io/biocontainers/ms2rescore/3.1.5--pyhdfd78af_1
```
