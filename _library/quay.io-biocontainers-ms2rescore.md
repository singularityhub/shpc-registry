...
updated_at: "2026-02-23 05:55:04.862506"
...
```bash
$ shpc install quay.io/biocontainers/ms2rescore:3.2.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ms2rescore/3.2.1--pyhdfd78af_0
$ module help quay.io/biocontainers/ms2rescore/3.2.1--pyhdfd78af_0
```
