...
updated_at: "2025-01-20 03:36:45.826988"
...
```bash
$ shpc install quay.io/biocontainers/ms2rescore:3.0.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ms2rescore/3.0.3--pyhdfd78af_0
$ module help quay.io/biocontainers/ms2rescore/3.0.3--pyhdfd78af_0
```
