...
updated_at: "2026-03-24 05:14:14.405681"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-awfisher:1.24.0--r45ha27e39d_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-awfisher/1.24.0--r45ha27e39d_0
$ module help quay.io/biocontainers/bioconductor-awfisher/1.24.0--r45ha27e39d_0
```
