...
updated_at: "2023-10-23 03:20:36.406878"
latest: "23.04.4--h2a3209d_0"
...
```bash
$ shpc install quay.io/biocontainers/nextflow:23.04.4--h2a3209d_0
```
...
```bash
$ module load quay.io/biocontainers/nextflow/23.04.4--h2a3209d_0
$ module help quay.io/biocontainers/nextflow/23.04.4--h2a3209d_0
```
