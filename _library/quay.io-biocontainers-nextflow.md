...
updated_at: "2024-08-10 02:53:58.230656"
latest: "24.04.3--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/nextflow:24.04.3--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/nextflow/24.04.3--hdfd78af_0
$ module help quay.io/biocontainers/nextflow/24.04.3--hdfd78af_0
```
