...
updated_at: "2025-12-19 04:14:35.962726"
latest: "25.10.2--h2a3209d_0"
...
```bash
$ shpc install quay.io/biocontainers/nextflow:25.10.2--h2a3209d_0
```
...
```bash
$ module load quay.io/biocontainers/nextflow/25.10.2--h2a3209d_0
$ module help quay.io/biocontainers/nextflow/25.10.2--h2a3209d_0
```
