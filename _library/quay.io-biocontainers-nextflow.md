...
updated_at: "2024-06-20 03:03:01.624012"
latest: "24.04.2--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/nextflow:24.04.2--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/nextflow/24.04.2--hdfd78af_0
$ module help quay.io/biocontainers/nextflow/24.04.2--hdfd78af_0
```
