...
updated_at: "2025-11-24 04:17:30.613720"
latest: "25.10.0--h2a3209d_0"
...
```bash
$ shpc install quay.io/biocontainers/nextflow:25.10.0--h2a3209d_0
```
...
```bash
$ module load quay.io/biocontainers/nextflow/25.10.0--h2a3209d_0
$ module help quay.io/biocontainers/nextflow/25.10.0--h2a3209d_0
```
