...
updated_at: "2026-07-24 05:29:59.089678"
latest: "26.04.6--h2a3209d_0"
...
```bash
$ shpc install quay.io/biocontainers/nextflow:26.04.6--h2a3209d_0
```
...
```bash
$ module load quay.io/biocontainers/nextflow/26.04.6--h2a3209d_0
$ module help quay.io/biocontainers/nextflow/26.04.6--h2a3209d_0
```
