...
updated_at: "2025-05-23 03:35:36.314018"
latest: "25.04.2--h2a3209d_0"
...
```bash
$ shpc install quay.io/biocontainers/nextflow:25.04.2--h2a3209d_0
```
...
```bash
$ module load quay.io/biocontainers/nextflow/25.04.2--h2a3209d_0
$ module help quay.io/biocontainers/nextflow/25.04.2--h2a3209d_0
```
