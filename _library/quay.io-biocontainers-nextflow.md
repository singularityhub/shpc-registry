...
updated_at: "2025-07-03 03:40:48.673565"
latest: "25.04.3--h2a3209d_0"
...
```bash
$ shpc install quay.io/biocontainers/nextflow:25.04.3--h2a3209d_0
```
...
```bash
$ module load quay.io/biocontainers/nextflow/25.04.3--h2a3209d_0
$ module help quay.io/biocontainers/nextflow/25.04.3--h2a3209d_0
```
