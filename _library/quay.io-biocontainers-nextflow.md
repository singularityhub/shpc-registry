...
updated_at: "2025-01-28 03:35:49.261545"
latest: "24.10.3--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/nextflow:24.10.3--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/nextflow/24.10.3--hdfd78af_0
$ module help quay.io/biocontainers/nextflow/24.10.3--hdfd78af_0
```
