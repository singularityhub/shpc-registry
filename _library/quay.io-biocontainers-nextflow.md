...
updated_at: "2025-10-16 04:04:09.263950"
latest: "25.04.8--h2a3209d_0"
...
```bash
$ shpc install quay.io/biocontainers/nextflow:25.04.8--h2a3209d_0
```
...
```bash
$ module load quay.io/biocontainers/nextflow/25.04.8--h2a3209d_0
$ module help quay.io/biocontainers/nextflow/25.04.8--h2a3209d_0
```
