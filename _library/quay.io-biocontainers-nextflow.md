...
updated_at: "2024-05-06 18:50:58.679894"
latest: "23.10.1--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/nextflow:23.10.1--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/nextflow/23.10.1--hdfd78af_0
$ module help quay.io/biocontainers/nextflow/23.10.1--hdfd78af_0
```
