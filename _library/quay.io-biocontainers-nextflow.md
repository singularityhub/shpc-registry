...
updated_at: "2026-06-17 07:27:46.883252"
latest: "26.04.3--h2a3209d_0"
...
```bash
$ shpc install quay.io/biocontainers/nextflow:26.04.3--h2a3209d_0
```
...
```bash
$ module load quay.io/biocontainers/nextflow/26.04.3--h2a3209d_0
$ module help quay.io/biocontainers/nextflow/26.04.3--h2a3209d_0
```
