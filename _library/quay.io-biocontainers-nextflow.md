...
updated_at: "2025-04-17 04:21:21.108705"
latest: "24.10.5--h2a3209d_1"
...
```bash
$ shpc install quay.io/biocontainers/nextflow:24.10.5--h2a3209d_1
```
...
```bash
$ module load quay.io/biocontainers/nextflow/24.10.5--h2a3209d_1
$ module help quay.io/biocontainers/nextflow/24.10.5--h2a3209d_1
```
