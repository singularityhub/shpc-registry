...
updated_at: "2026-04-03 04:46:37.806890"
latest: "25.10.4--h2a3209d_0"
...
```bash
$ shpc install quay.io/biocontainers/nextflow:25.10.4--h2a3209d_0
```
...
```bash
$ module load quay.io/biocontainers/nextflow/25.10.4--h2a3209d_0
$ module help quay.io/biocontainers/nextflow/25.10.4--h2a3209d_0
```
