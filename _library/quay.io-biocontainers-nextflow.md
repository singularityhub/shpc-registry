...
updated_at: "2024-12-14 03:02:21.874345"
latest: "24.10.0--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/nextflow:24.10.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/nextflow/24.10.0--hdfd78af_0
$ module help quay.io/biocontainers/nextflow/24.10.0--hdfd78af_0
```
