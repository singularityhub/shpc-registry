...
updated_at: "2023-06-15 03:19:26.768127"
latest: "23.04.1--h4a94de4_2"
...
```bash
$ shpc install quay.io/biocontainers/nextflow:23.04.1--h4a94de4_2
```
...
```bash
$ module load quay.io/biocontainers/nextflow/23.04.1--h4a94de4_2
$ module help quay.io/biocontainers/nextflow/23.04.1--h4a94de4_2
```
