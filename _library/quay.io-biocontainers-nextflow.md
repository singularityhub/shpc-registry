...
updated_at: "2025-09-11 03:16:35.450506"
latest: "25.04.6--h2a3209d_0"
...
```bash
$ shpc install quay.io/biocontainers/nextflow:25.04.6--h2a3209d_0
```
...
```bash
$ module load quay.io/biocontainers/nextflow/25.04.6--h2a3209d_0
$ module help quay.io/biocontainers/nextflow/25.04.6--h2a3209d_0
```
