...
updated_at: "2025-10-15 03:56:11.224680"
latest: "25.04.7--h2a3209d_0"
...
```bash
$ shpc install quay.io/biocontainers/nextflow:25.04.7--h2a3209d_0
```
...
```bash
$ module load quay.io/biocontainers/nextflow/25.04.7--h2a3209d_0
$ module help quay.io/biocontainers/nextflow/25.04.7--h2a3209d_0
```
