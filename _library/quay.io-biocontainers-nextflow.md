...
updated_at: "2025-01-12 03:21:48.431530"
latest: "24.10.2--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/nextflow:24.10.2--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/nextflow/24.10.2--hdfd78af_0
$ module help quay.io/biocontainers/nextflow/24.10.2--hdfd78af_0
```
