...
updated_at: "2024-08-23 02:54:22.048051"
latest: "24.04.4--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/nextflow:24.04.4--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/nextflow/24.04.4--hdfd78af_0
$ module help quay.io/biocontainers/nextflow/24.04.4--hdfd78af_0
```
