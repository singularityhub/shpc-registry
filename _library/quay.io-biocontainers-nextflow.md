...
updated_at: "2026-05-24 06:29:54.867646"
latest: "26.04.1--h2a3209d_0"
...
```bash
$ shpc install quay.io/biocontainers/nextflow:26.04.1--h2a3209d_0
```
...
```bash
$ module load quay.io/biocontainers/nextflow/26.04.1--h2a3209d_0
$ module help quay.io/biocontainers/nextflow/26.04.1--h2a3209d_0
```
