...
updated_at: "2026-03-25 05:15:09.184193"
latest: "2.4.4--r45h01b2380_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gsva:2.4.4--r45h01b2380_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gsva/2.4.4--r45h01b2380_0
$ module help quay.io/biocontainers/bioconductor-gsva/2.4.4--r45h01b2380_0
```
