...
updated_at: "2024-08-23 02:46:19.792060"
latest: "3.0--h4ac6f70_0"
...
```bash
$ shpc install quay.io/biocontainers/bracken:3.0--h4ac6f70_0
```
...
```bash
$ module load quay.io/biocontainers/bracken/3.0--h4ac6f70_0
$ module help quay.io/biocontainers/bracken/3.0--h4ac6f70_0
```
