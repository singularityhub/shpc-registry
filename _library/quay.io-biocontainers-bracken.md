...
updated_at: "2024-12-23 03:34:16.143335"
latest: "3.0--h4ac6f70_1"
...
```bash
$ shpc install quay.io/biocontainers/bracken:3.0--h4ac6f70_1
```
...
```bash
$ module load quay.io/biocontainers/bracken/3.0--h4ac6f70_1
$ module help quay.io/biocontainers/bracken/3.0--h4ac6f70_1
```
