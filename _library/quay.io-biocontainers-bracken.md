...
updated_at: "2026-08-29 09:26:35.099856"
latest: "3.1p1--hc52dbad_0"
...
```bash
$ shpc install quay.io/biocontainers/bracken:3.1p1--hc52dbad_0
```
...
```bash
$ module load quay.io/biocontainers/bracken/3.1p1--hc52dbad_0
$ module help quay.io/biocontainers/bracken/3.1p1--hc52dbad_0
```
