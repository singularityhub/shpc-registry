...
updated_at: "2024-04-15 04:09:48.215989"
...
```bash
$ shpc install quay.io/biocontainers/tissuumaps:3.2.1.3--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/tissuumaps/3.2.1.3--pyh7cba7a3_0
$ module help quay.io/biocontainers/tissuumaps/3.2.1.3--pyh7cba7a3_0
```
