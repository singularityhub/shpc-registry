...
updated_at: "2024-04-20 02:47:04.129400"
latest: "3.2.1.6--pyh7cba7a3_0"
...
```bash
$ shpc install quay.io/biocontainers/tissuumaps:3.2.1.6--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/tissuumaps/3.2.1.6--pyh7cba7a3_0
$ module help quay.io/biocontainers/tissuumaps/3.2.1.6--pyh7cba7a3_0
```
