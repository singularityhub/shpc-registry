...
updated_at: "2024-05-23 02:43:24.552198"
latest: "3.2.1.8--pyh7cba7a3_0"
...
```bash
$ shpc install quay.io/biocontainers/tissuumaps:3.2.1.8--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/tissuumaps/3.2.1.8--pyh7cba7a3_0
$ module help quay.io/biocontainers/tissuumaps/3.2.1.8--pyh7cba7a3_0
```
