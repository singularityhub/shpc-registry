...
updated_at: "2024-07-21 03:22:31.567448"
latest: "3.2.1.9--pyh7cba7a3_0"
...
```bash
$ shpc install quay.io/biocontainers/tissuumaps:3.2.1.9--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/tissuumaps/3.2.1.9--pyh7cba7a3_0
$ module help quay.io/biocontainers/tissuumaps/3.2.1.9--pyh7cba7a3_0
```
