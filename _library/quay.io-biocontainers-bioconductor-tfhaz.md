...
updated_at: "2026-01-20 03:50:03.380775"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-tfhaz:1.28.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-tfhaz/1.28.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-tfhaz/1.28.0--r44hdfd78af_0
```
