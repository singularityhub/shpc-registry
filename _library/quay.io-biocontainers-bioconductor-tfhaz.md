...
updated_at: "2025-01-18 03:12:22.716976"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-tfhaz:1.24.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-tfhaz/1.24.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-tfhaz/1.24.0--r43hdfd78af_0
```
