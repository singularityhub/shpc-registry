...
updated_at: "2025-11-26 04:05:14.418061"
...
```bash
$ shpc install quay.io/biocontainers/freyja:2.0.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/freyja/2.0.1--pyhdfd78af_0
$ module help quay.io/biocontainers/freyja/2.0.1--pyhdfd78af_0
```
