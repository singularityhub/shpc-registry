...
updated_at: "2024-12-21 03:15:40.707535"
...
```bash
$ shpc install quay.io/biocontainers/freyja:1.5.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/freyja/1.5.2--pyhdfd78af_0
$ module help quay.io/biocontainers/freyja/1.5.2--pyhdfd78af_0
```
