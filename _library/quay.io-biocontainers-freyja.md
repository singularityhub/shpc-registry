...
updated_at: "2023-09-25 03:51:46.490560"
...
```bash
$ shpc install quay.io/biocontainers/freyja:1.4.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/freyja/1.4.3--pyhdfd78af_0
$ module help quay.io/biocontainers/freyja/1.4.3--pyhdfd78af_0
```
