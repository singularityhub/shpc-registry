...
updated_at: "2024-01-10 08:58:40.484602"
latest: "1.4.8--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/freyja:1.4.8--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/freyja/1.4.8--pyhdfd78af_0
$ module help quay.io/biocontainers/freyja/1.4.8--pyhdfd78af_0
```
