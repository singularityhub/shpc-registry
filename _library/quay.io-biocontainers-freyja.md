...
updated_at: "2025-04-12 03:08:58.172024"
latest: "1.5.3--pyhdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/freyja:1.5.3--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/freyja/1.5.3--pyhdfd78af_1
$ module help quay.io/biocontainers/freyja/1.5.3--pyhdfd78af_1
```
