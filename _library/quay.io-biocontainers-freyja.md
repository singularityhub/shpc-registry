...
updated_at: "2026-02-05 05:02:52.594167"
...
```bash
$ shpc install quay.io/biocontainers/freyja:2.0.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/freyja/2.0.3--pyhdfd78af_0
$ module help quay.io/biocontainers/freyja/2.0.3--pyhdfd78af_0
```
