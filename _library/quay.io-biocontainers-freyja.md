...
updated_at: "2026-01-24 04:24:26.007657"
...
```bash
$ shpc install quay.io/biocontainers/freyja:2.0.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/freyja/2.0.2--pyhdfd78af_0
$ module help quay.io/biocontainers/freyja/2.0.2--pyhdfd78af_0
```
