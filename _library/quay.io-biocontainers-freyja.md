...
updated_at: "2024-07-07 02:47:23.512700"
...
```bash
$ shpc install quay.io/biocontainers/freyja:1.5.1--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/freyja/1.5.1--pyhdfd78af_1
$ module help quay.io/biocontainers/freyja/1.5.1--pyhdfd78af_1
```
