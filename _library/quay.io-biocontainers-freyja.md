...
updated_at: "2023-12-07 03:06:53.237577"
...
```bash
$ shpc install quay.io/biocontainers/freyja:1.4.7--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/freyja/1.4.7--pyhdfd78af_0
$ module help quay.io/biocontainers/freyja/1.4.7--pyhdfd78af_0
```
