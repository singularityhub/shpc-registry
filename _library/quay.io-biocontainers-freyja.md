...
updated_at: "2025-07-31 03:51:13.807841"
latest: "1.5.3--py311h9ee0642_3"
...
```bash
$ shpc install quay.io/biocontainers/freyja:1.5.3--py311h9ee0642_3
```
...
```bash
$ module load quay.io/biocontainers/freyja/1.5.3--py311h9ee0642_3
$ module help quay.io/biocontainers/freyja/1.5.3--py311h9ee0642_3
```
