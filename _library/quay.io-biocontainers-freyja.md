...
updated_at: "2025-08-09 03:54:19.620850"
latest: "2.0.0--py311h9ee0642_0"
...
```bash
$ shpc install quay.io/biocontainers/freyja:2.0.0--py311h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/freyja/2.0.0--py311h9ee0642_0
$ module help quay.io/biocontainers/freyja/2.0.0--py311h9ee0642_0
```
