...
updated_at: "2024-04-01 04:16:36.864032"
...
```bash
$ shpc install quay.io/biocontainers/freyja:1.4.9--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/freyja/1.4.9--pyhdfd78af_0
$ module help quay.io/biocontainers/freyja/1.4.9--pyhdfd78af_0
```
