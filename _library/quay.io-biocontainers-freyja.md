...
updated_at: "2025-03-30 03:16:59.492209"
...
```bash
$ shpc install quay.io/biocontainers/freyja:1.5.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/freyja/1.5.3--pyhdfd78af_0
$ module help quay.io/biocontainers/freyja/1.5.3--pyhdfd78af_0
```
