...
updated_at: "2025-12-17 16:20:53.820230"
...
```bash
$ shpc install quay.io/biocontainers/grabix:0.1.8--h077b44d_12
```
...
```bash
$ module load quay.io/biocontainers/grabix/0.1.8--h077b44d_12
$ module help quay.io/biocontainers/grabix/0.1.8--h077b44d_12
```
