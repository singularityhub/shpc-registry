...
updated_at: "2023-09-04 04:20:13.823656"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-flowgraph:1.8.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-flowgraph/1.8.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-flowgraph/1.8.0--r43hdfd78af_0
```
