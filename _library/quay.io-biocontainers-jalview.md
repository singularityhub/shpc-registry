...
updated_at: "2025-09-03 03:19:28.133590"
latest: "2.11.4.1--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/jalview:2.11.4.1--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/jalview/2.11.4.1--hdfd78af_0
$ module help quay.io/biocontainers/jalview/2.11.4.1--hdfd78af_0
```
