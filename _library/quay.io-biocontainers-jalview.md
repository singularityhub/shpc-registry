...
updated_at: "2026-01-14 04:05:33.211671"
...
```bash
$ shpc install quay.io/biocontainers/jalview:2.11.5.1--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/jalview/2.11.5.1--hdfd78af_0
$ module help quay.io/biocontainers/jalview/2.11.5.1--hdfd78af_0
```
