---
layout: container
name:  "quay.io/biocontainers/bioconductor-seqarchrplus"
maintainer: "@vsoch"
github: "https://github.com/singularityhub/shpc-registry/blob/main/quay.io/biocontainers/bioconductor-seqarchrplus/container.yaml"
config_url: "https://raw.githubusercontent.com/singularityhub/shpc-registry/main/quay.io/biocontainers/bioconductor-seqarchrplus/container.yaml"
updated_at: "2025-08-29 03:32:39.472057"
latest: "1.2.0--r43hdfd78af_0"
container_url: "https://biocontainers.pro/tools/bioconductor-seqarchrplus"
aliases:
 - "f2py3.11"
 - "hb-info"
 - "tjbench"
...
config: {"url": "https://biocontainers.pro/tools/bioconductor-seqarchrplus", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for bioconductor-seqarchrplus", "latest": {"1.2.0--r43hdfd78af_0": "sha256:7580226eed190929524902857d3a9e4fc1d8885db1df9f9e30d9bf288c29cf45"}, "tags": {"1.0.0--r43hdfd78af_0": "sha256:58632c882731971c8223e2f2b4da4cecfa812b079746d1786b35aab8397d22e3", "1.2.0--r43hdfd78af_0": "sha256:7580226eed190929524902857d3a9e4fc1d8885db1df9f9e30d9bf288c29cf45"}, "docker": "quay.io/biocontainers/bioconductor-seqarchrplus", "aliases": {"f2py3.11": "/usr/local/bin/f2py3.11", "hb-info": "/usr/local/bin/hb-info", "tjbench": "/usr/local/bin/tjbench", "fftw-wisdom": "/usr/local/bin/fftw-wisdom", "fftw-wisdom-to-conf": "/usr/local/bin/fftw-wisdom-to-conf", "fftwf-wisdom": "/usr/local/bin/fftwf-wisdom", "fftwl-wisdom": "/usr/local/bin/fftwl-wisdom", "glpsol": "/usr/local/bin/glpsol", "2to3-3.11": "/usr/local/bin/2to3-3.11", "idle3.11": "/usr/local/bin/idle3.11", "pydoc3.11": "/usr/local/bin/pydoc3.11", "python3.11": "/usr/local/bin/python3.11", "python3.11-config": "/usr/local/bin/python3.11-config", "installBiocDataPackage.sh": "/usr/local/bin/installBiocDataPackage.sh", "tomlq": "/usr/local/bin/tomlq", "xq": "/usr/local/bin/xq", "yq": "/usr/local/bin/yq", "jq": "/usr/local/bin/jq", "onig-config": "/usr/local/bin/onig-config", "activate-global-python-argcomplete": "/usr/local/bin/activate-global-python-argcomplete", "python-argcomplete-check-easy-install-script": "/usr/local/bin/python-argcomplete-check-easy-install-script", "register-python-argcomplete": "/usr/local/bin/register-python-argcomplete", "pandoc": "/usr/local/bin/pandoc", "python3.1": "/usr/local/bin/python3.1"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/bioconductor-seqarchrplus.
singularity registry hpc automated addition for bioconductor-seqarchrplus
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/bioconductor-seqarchrplus
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-seqarchrplus:1.2.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-seqarchrplus/1.2.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-seqarchrplus/1.2.0--r43hdfd78af_0
```
...
#### bioconductor-seqarchrplus-shell:
...
#### bioconductor-seqarchrplus-exec:
...
#### bioconductor-seqarchrplus-inspect:
...
#### bioconductor-seqarchrplus-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-seqarchrplus-inspect-deffile:
