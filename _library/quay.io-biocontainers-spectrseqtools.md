---
layout: container
name:  "quay.io/biocontainers/spectrseqtools"
maintainer: "@vsoch"
...
updated_at: "2026-09-22 08:12:39.815848"
latest: "0.3.0--py313hab7d0fd_0"
...
```bash
$ module load quay.io/biocontainers/spectrseqtools/0.3.0--py313hab7d0fd_0
$ module help quay.io/biocontainers/spectrseqtools/0.3.0--py313hab7d0fd_0
```
...
#### spectrseqtools-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### spectrseqtools-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/idzip
$ podman run --it --rm --entrypoint /usr/local/bin/idzip   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/idzip   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/ms-deisotope
$ podman run --it --rm --entrypoint /usr/local/bin/ms-deisotope   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/ms-deisotope   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/ms-index
$ podman run --it --rm --entrypoint /usr/local/bin/ms-index   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/ms-index   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/ms-view
$ podman run --it --rm --entrypoint /usr/local/bin/ms-view   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/ms-view   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/spectrseqtools
$ podman run --it --rm --entrypoint /usr/local/bin/spectrseqtools   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/spectrseqtools   -v ${PWD} -w ${PWD} <container> -c " $@"
```
