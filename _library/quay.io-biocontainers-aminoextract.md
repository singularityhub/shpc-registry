...
updated_at: "2026-01-08 04:34:03.932580"
...
```bash
$ shpc install quay.io/biocontainers/aminoextract:0.4.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/aminoextract/0.4.1--pyhdfd78af_0
$ module help quay.io/biocontainers/aminoextract/0.4.1--pyhdfd78af_0
```
