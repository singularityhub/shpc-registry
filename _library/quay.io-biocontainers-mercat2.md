...
updated_at: "2024-01-21 02:37:35.342325"
...
```bash
$ shpc install quay.io/biocontainers/mercat2:1.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mercat2/1.3--pyhdfd78af_0
$ module help quay.io/biocontainers/mercat2/1.3--pyhdfd78af_0
```
