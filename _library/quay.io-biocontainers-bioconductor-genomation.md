...
updated_at: "2023-06-28 03:44:22.350030"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-genomation:1.30.0--r42hf17093f_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-genomation/1.30.0--r42hf17093f_1
$ module help quay.io/biocontainers/bioconductor-genomation/1.30.0--r42hf17093f_1
```
