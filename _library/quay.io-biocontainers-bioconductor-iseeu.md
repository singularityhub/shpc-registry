...
updated_at: "2023-10-24 02:56:10.584052"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-iseeu:1.12.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-iseeu/1.12.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-iseeu/1.12.0--r43hdfd78af_0
```
