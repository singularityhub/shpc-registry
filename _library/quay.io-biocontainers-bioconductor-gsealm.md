...
updated_at: "2024-12-08 03:51:09.732953"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gsealm:1.62.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gsealm/1.62.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-gsealm/1.62.0--r43hdfd78af_0
```
