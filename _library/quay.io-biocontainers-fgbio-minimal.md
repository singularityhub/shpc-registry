...
updated_at: "2026-06-18 07:05:04.853122"
...
```bash
$ shpc install quay.io/biocontainers/fgbio-minimal:4.0.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/fgbio-minimal/4.0.0--hdfd78af_0
$ module help quay.io/biocontainers/fgbio-minimal/4.0.0--hdfd78af_0
```
