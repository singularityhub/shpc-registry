...
updated_at: "2026-06-30 06:24:10.719162"
...
```bash
$ shpc install quay.io/biocontainers/fgbio-minimal:4.1.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/fgbio-minimal/4.1.0--hdfd78af_0
$ module help quay.io/biocontainers/fgbio-minimal/4.1.0--hdfd78af_0
```
