...
updated_at: "2025-03-20 04:44:24.512146"
...
```bash
$ shpc install quay.io/biocontainers/fgbio-minimal:2.4.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/fgbio-minimal/2.4.0--hdfd78af_0
$ module help quay.io/biocontainers/fgbio-minimal/2.4.0--hdfd78af_0
```
