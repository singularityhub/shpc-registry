...
updated_at: "2023-12-24 02:51:44.209799"
...
```bash
$ shpc install quay.io/biocontainers/fgbio-minimal:2.2.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/fgbio-minimal/2.2.0--hdfd78af_0
$ module help quay.io/biocontainers/fgbio-minimal/2.2.0--hdfd78af_0
```
