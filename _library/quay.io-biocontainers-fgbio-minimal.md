...
updated_at: "2025-12-14 04:18:46.921000"
...
```bash
$ shpc install quay.io/biocontainers/fgbio-minimal:3.1.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/fgbio-minimal/3.1.0--hdfd78af_0
$ module help quay.io/biocontainers/fgbio-minimal/3.1.0--hdfd78af_0
```
