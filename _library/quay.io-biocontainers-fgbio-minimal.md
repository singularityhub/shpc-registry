...
updated_at: "2026-08-29 09:08:44.049168"
...
```bash
$ shpc install quay.io/biocontainers/fgbio-minimal:4.1.1--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/fgbio-minimal/4.1.1--hdfd78af_0
$ module help quay.io/biocontainers/fgbio-minimal/4.1.1--hdfd78af_0
```
