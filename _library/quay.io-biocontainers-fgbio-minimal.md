...
updated_at: "2025-03-23 03:48:08.962183"
...
```bash
$ shpc install quay.io/biocontainers/fgbio-minimal:2.5.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/fgbio-minimal/2.5.0--hdfd78af_0
$ module help quay.io/biocontainers/fgbio-minimal/2.5.0--hdfd78af_0
```
