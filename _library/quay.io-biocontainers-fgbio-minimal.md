...
updated_at: "2026-03-28 17:10:50.732149"
latest: "3.1.2--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/fgbio-minimal:3.1.2--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/fgbio-minimal/3.1.2--hdfd78af_0
$ module help quay.io/biocontainers/fgbio-minimal/3.1.2--hdfd78af_0
```
