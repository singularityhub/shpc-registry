...
updated_at: "2026-01-19 05:24:22.961865"
...
```bash
$ shpc install quay.io/biocontainers/fgbio-minimal:3.1.1--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/fgbio-minimal/3.1.1--hdfd78af_0
$ module help quay.io/biocontainers/fgbio-minimal/3.1.1--hdfd78af_0
```
