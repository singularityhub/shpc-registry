...
updated_at: "2024-10-17 18:27:11.044660"
...
```bash
$ shpc install quay.io/biocontainers/rbpbench:1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/rbpbench/1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/rbpbench/1.0--pyhdfd78af_0
```
