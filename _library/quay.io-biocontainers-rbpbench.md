...
updated_at: "2026-01-30 04:38:37.545618"
...
```bash
$ shpc install quay.io/biocontainers/rbpbench:1.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/rbpbench/1.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/rbpbench/1.1.0--pyhdfd78af_0
```
