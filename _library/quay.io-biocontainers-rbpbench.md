...
updated_at: "2024-07-01 04:18:51.945648"
...
```bash
$ shpc install quay.io/biocontainers/rbpbench:0.9--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/rbpbench/0.9--pyhdfd78af_0
$ module help quay.io/biocontainers/rbpbench/0.9--pyhdfd78af_0
```
