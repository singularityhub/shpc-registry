...
updated_at: "2025-02-20 03:03:53.272852"
...
```bash
$ shpc install quay.io/biocontainers/rbpbench:1.0.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/rbpbench/1.0.2--pyhdfd78af_0
$ module help quay.io/biocontainers/rbpbench/1.0.2--pyhdfd78af_0
```
