...
updated_at: "2024-03-04 03:37:57.380628"
...
```bash
$ shpc install quay.io/biocontainers/rbpbench:0.8.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/rbpbench/0.8.1--pyhdfd78af_0
$ module help quay.io/biocontainers/rbpbench/0.8.1--pyhdfd78af_0
```
