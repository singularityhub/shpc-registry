...
updated_at: "2026-05-28 06:43:43.238152"
...
```bash
$ shpc install quay.io/biocontainers/rbpbench:1.1.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/rbpbench/1.1.2--pyhdfd78af_0
$ module help quay.io/biocontainers/rbpbench/1.1.2--pyhdfd78af_0
```
