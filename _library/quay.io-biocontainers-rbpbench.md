...
updated_at: "2025-11-14 05:02:09.007037"
...
```bash
$ shpc install quay.io/biocontainers/rbpbench:1.0.6--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/rbpbench/1.0.6--pyhdfd78af_0
$ module help quay.io/biocontainers/rbpbench/1.0.6--pyhdfd78af_0
```
