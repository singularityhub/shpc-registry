...
updated_at: "2025-05-27 12:15:49.391221"
...
```bash
$ shpc install quay.io/biocontainers/rbpbench:1.0.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/rbpbench/1.0.4--pyhdfd78af_0
$ module help quay.io/biocontainers/rbpbench/1.0.4--pyhdfd78af_0
```
