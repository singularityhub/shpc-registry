---
layout: container
name:  "quay.io/biocontainers/sharedmem"
maintainer: "@vsoch"
...
updated_at: "2024-07-11 03:24:35.112192"
latest: "0.3.6--py_0"
...
```bash
$ shpc install quay.io/biocontainers/sharedmem
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/sharedmem:0.3.6--py_0
```
...
```bash
$ module load quay.io/biocontainers/sharedmem/0.3.6--py_0
$ module help quay.io/biocontainers/sharedmem/0.3.6--py_0
```
...
#### sharedmem-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### sharedmem-inspect-deffile:
