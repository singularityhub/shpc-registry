...
updated_at: "2025-08-30 03:43:58.877181"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-epimix.data:1.8.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-epimix.data/1.8.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-epimix.data/1.8.0--r44hdfd78af_0
```
