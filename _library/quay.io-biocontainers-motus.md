...
updated_at: "2026-08-14 08:17:06.731388"
...
```bash
$ shpc install quay.io/biocontainers/motus:4.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/motus/4.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/motus/4.1.0--pyhdfd78af_0
```
