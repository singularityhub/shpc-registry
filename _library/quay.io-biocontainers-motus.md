...
updated_at: "2026-03-27 05:14:12.590972"
...
```bash
$ shpc install quay.io/biocontainers/motus:4.0.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/motus/4.0.4--pyhdfd78af_0
$ module help quay.io/biocontainers/motus/4.0.4--pyhdfd78af_0
```
