...
updated_at: "2022-10-27 01:07:18.355233"
...
```bash
$ shpc install quay.io/biocontainers/pbiotools:2.0.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pbiotools/2.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/pbiotools/2.0.0--pyhdfd78af_0
```
