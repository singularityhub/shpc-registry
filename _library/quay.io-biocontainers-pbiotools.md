...
updated_at: "2025-10-24 03:33:17.708680"
...
```bash
$ shpc install quay.io/biocontainers/pbiotools:5.0.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pbiotools/5.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/pbiotools/5.0.0--pyhdfd78af_0
```
