...
updated_at: "2023-02-07 03:24:16.803720"
...
```bash
$ shpc install quay.io/biocontainers/pbiotools:3.0.0--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/pbiotools/3.0.0--pyh7cba7a3_0
$ module help quay.io/biocontainers/pbiotools/3.0.0--pyh7cba7a3_0
```
