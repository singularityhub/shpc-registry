...
updated_at: "2025-10-31 03:57:17.464032"
latest: "2.7.0--py39h2de1943_0"
...
```bash
$ shpc install quay.io/biocontainers/crispritz:2.7.0--py39h2de1943_0
```
...
```bash
$ module load quay.io/biocontainers/crispritz/2.7.0--py39h2de1943_0
$ module help quay.io/biocontainers/crispritz/2.7.0--py39h2de1943_0
```
