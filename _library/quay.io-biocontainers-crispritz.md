...
updated_at: "2025-03-18 03:06:51.384985"
...
```bash
$ shpc install quay.io/biocontainers/crispritz:2.6.6--py39h2de1943_3
```
...
```bash
$ module load quay.io/biocontainers/crispritz/2.6.6--py39h2de1943_3
$ module help quay.io/biocontainers/crispritz/2.6.6--py39h2de1943_3
```
