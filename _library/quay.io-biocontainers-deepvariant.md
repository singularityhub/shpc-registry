...
updated_at: "2026-03-29 05:16:10.671702"
...
```bash
$ shpc install quay.io/biocontainers/deepvariant:1.10.0--pyh697b589_0
```
...
```bash
$ module load quay.io/biocontainers/deepvariant/1.10.0--pyh697b589_0
$ module help quay.io/biocontainers/deepvariant/1.10.0--pyh697b589_0
```
