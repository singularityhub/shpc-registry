...
updated_at: "2022-11-02 19:41:28.757271"
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-ricecdf-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-ricecdf-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-ricecdf-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-ricecdf-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-ricecdf-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-ricecdf-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
