---
layout: container
name:  "quay.io/biocontainers/aacon"
maintainer: "@vsoch"
...
updated_at: "2025-04-08 03:10:18.383113"
...
```bash
$ module load quay.io/biocontainers/aacon/1.1--hdfd78af_0
$ module help quay.io/biocontainers/aacon/1.1--hdfd78af_0
```
...
#### aacon-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### aacon-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/aacon
$ podman run --it --rm --entrypoint /usr/local/bin/aacon   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/aacon   -v ${PWD} -w ${PWD} <container> -c " $@"
```
