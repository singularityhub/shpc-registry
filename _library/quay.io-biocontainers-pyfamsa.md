...
updated_at: "2024-11-13 02:56:51.969169"
latest: "0.5.2--py310hc31ed2c_0"
...
```bash
$ shpc install quay.io/biocontainers/pyfamsa:0.5.2--py310hc31ed2c_0
```
...
```bash
$ module load quay.io/biocontainers/pyfamsa/0.5.2--py310hc31ed2c_0
$ module help quay.io/biocontainers/pyfamsa/0.5.2--py310hc31ed2c_0
```
