...
updated_at: "2024-09-10 02:44:58.880614"
...
```bash
$ shpc install quay.io/biocontainers/pyfamsa:0.5.1--py312h719dbc0_0
```
...
```bash
$ module load quay.io/biocontainers/pyfamsa/0.5.1--py312h719dbc0_0
$ module help quay.io/biocontainers/pyfamsa/0.5.1--py312h719dbc0_0
```
