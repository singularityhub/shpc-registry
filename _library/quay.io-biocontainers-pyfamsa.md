...
updated_at: "2024-12-26 03:25:46.976134"
latest: "0.5.3--py38hfe239e1_0"
...
```bash
$ shpc install quay.io/biocontainers/pyfamsa:0.5.3--py38hfe239e1_0
```
...
```bash
$ module load quay.io/biocontainers/pyfamsa/0.5.3--py38hfe239e1_0
$ module help quay.io/biocontainers/pyfamsa/0.5.3--py38hfe239e1_0
```
