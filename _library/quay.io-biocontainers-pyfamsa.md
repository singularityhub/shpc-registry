...
updated_at: "2024-08-10 03:23:17.328153"
latest: "0.4.0--py312h719dbc0_1"
...
```bash
$ shpc install quay.io/biocontainers/pyfamsa:0.4.0--py312h719dbc0_1
```
...
```bash
$ module load quay.io/biocontainers/pyfamsa/0.4.0--py312h719dbc0_1
$ module help quay.io/biocontainers/pyfamsa/0.4.0--py312h719dbc0_1
```
