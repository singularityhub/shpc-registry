...
updated_at: "2024-06-30 03:05:20.342321"
latest: "0.4.0--py38hcbe9525_0"
...
```bash
$ shpc install quay.io/biocontainers/pyfamsa:0.4.0--py38hcbe9525_0
```
...
```bash
$ module load quay.io/biocontainers/pyfamsa/0.4.0--py38hcbe9525_0
$ module help quay.io/biocontainers/pyfamsa/0.4.0--py38hcbe9525_0
```
