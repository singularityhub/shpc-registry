...
updated_at: "2026-06-19 07:37:09.772815"
...
```bash
$ shpc install quay.io/biocontainers/bowtie:1.3.1--hb82490e_11
```
...
```bash
$ module load quay.io/biocontainers/bowtie/1.3.1--hb82490e_11
$ module help quay.io/biocontainers/bowtie/1.3.1--hb82490e_11
```
