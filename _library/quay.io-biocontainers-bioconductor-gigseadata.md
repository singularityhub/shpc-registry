...
updated_at: "2022-10-27 00:44:17.595663"
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-gigseadata-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-gigseadata-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-gigseadata-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-gigseadata-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-gigseadata-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-gigseadata-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
