...
updated_at: "2024-05-21 02:59:26.264986"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gigseadata:1.20.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gigseadata/1.20.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-gigseadata/1.20.0--r43hdfd78af_0
```
