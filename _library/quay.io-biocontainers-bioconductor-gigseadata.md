...
updated_at: "2023-08-10 02:52:52.995529"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gigseadata:1.18.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gigseadata/1.18.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-gigseadata/1.18.0--r43hdfd78af_0
```
