...
updated_at: "2022-11-16 00:13:56.942821"
...
aliases:
 ...
 - ".bioconductor-brainimagerdata-pre-unlink.sh"
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-brainimagerdata-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-brainimagerdata-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-brainimagerdata-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-brainimagerdata-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-brainimagerdata-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-brainimagerdata-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
