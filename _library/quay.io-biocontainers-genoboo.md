...
updated_at: "2023-11-18 02:36:18.649671"
latest: "0.4.9--h4ac6f70_0"
...
```bash
$ shpc install quay.io/biocontainers/genoboo:0.4.9--h4ac6f70_0
```
...
```bash
$ module load quay.io/biocontainers/genoboo/0.4.9--h4ac6f70_0
$ module help quay.io/biocontainers/genoboo/0.4.9--h4ac6f70_0
```
