...
updated_at: "2023-04-25 02:52:37.441414"
latest: "0.4.2--h9f5acd7_0"
...
```bash
$ shpc install quay.io/biocontainers/genoboo:0.4.2--h9f5acd7_0
```
...
```bash
$ module load quay.io/biocontainers/genoboo/0.4.2--h9f5acd7_0
$ module help quay.io/biocontainers/genoboo/0.4.2--h9f5acd7_0
```
