...
updated_at: "2026-03-27 05:27:33.759236"
...
```bash
$ shpc install quay.io/biocontainers/genoboo:0.4.19--hd63eeec_0
```
...
```bash
$ module load quay.io/biocontainers/genoboo/0.4.19--hd63eeec_0
$ module help quay.io/biocontainers/genoboo/0.4.19--hd63eeec_0
```
