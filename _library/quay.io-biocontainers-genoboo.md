...
updated_at: "2023-04-15 02:51:25.157336"
latest: "0.4.1--h9f5acd7_0"
...
```bash
$ shpc install quay.io/biocontainers/genoboo:0.4.1--h9f5acd7_0
```
...
```bash
$ module load quay.io/biocontainers/genoboo/0.4.1--h9f5acd7_0
$ module help quay.io/biocontainers/genoboo/0.4.1--h9f5acd7_0
```
