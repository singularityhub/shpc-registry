...
updated_at: "2023-10-23 02:49:39.856789"
latest: "0.4.7--h4ac6f70_0"
...
```bash
$ shpc install quay.io/biocontainers/genoboo:0.4.7--h4ac6f70_0
```
...
```bash
$ module load quay.io/biocontainers/genoboo/0.4.7--h4ac6f70_0
$ module help quay.io/biocontainers/genoboo/0.4.7--h4ac6f70_0
```
