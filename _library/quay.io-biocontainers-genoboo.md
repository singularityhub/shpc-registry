---
layout: container
name:  "quay.io/biocontainers/genoboo"
maintainer: "@vsoch"
...
updated_at: "2025-06-20 03:59:04.816287"
latest: "0.4.17--h9948957_0"
...
```bash
$ shpc install quay.io/biocontainers/genoboo
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/genoboo:0.4.17--h9948957_0
```
...
```bash
$ module load quay.io/biocontainers/genoboo/0.4.17--h9948957_0
$ module help quay.io/biocontainers/genoboo/0.4.17--h9948957_0
```
...
#### genoboo-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### genoboo-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/genoboo
$ podman run --it --rm --entrypoint /usr/local/bin/genoboo   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/genoboo   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/meteor
$ podman run --it --rm --entrypoint /usr/local/bin/meteor   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/meteor   -v ${PWD} -w ${PWD} <container> -c " $@"
```
