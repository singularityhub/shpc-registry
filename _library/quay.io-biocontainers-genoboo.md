...
updated_at: "2023-09-03 02:27:05.104575"
latest: "0.4.4--h4ac6f70_0"
...
```bash
$ shpc install quay.io/biocontainers/genoboo:0.4.4--h4ac6f70_0
```
...
```bash
$ module load quay.io/biocontainers/genoboo/0.4.4--h4ac6f70_0
$ module help quay.io/biocontainers/genoboo/0.4.4--h4ac6f70_0
```
