...
updated_at: "2024-05-27 03:12:41.496974"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-pepstat:1.36.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-pepstat/1.36.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-pepstat/1.36.0--r43hdfd78af_0
```
