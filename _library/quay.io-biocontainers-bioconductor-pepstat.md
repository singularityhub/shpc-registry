...
updated_at: "2024-01-01 03:34:21.104131"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-pepstat:1.34.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-pepstat/1.34.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-pepstat/1.34.0--r43hdfd78af_0
```
