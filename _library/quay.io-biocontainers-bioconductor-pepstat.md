...
updated_at: "2026-04-05 05:08:31.320843"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-pepstat:1.44.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-pepstat/1.44.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-pepstat/1.44.0--r45hdfd78af_0
```
