...
updated_at: "2025-08-24 04:11:26.188290"
latest: "6.35.2--hedafe93_0"
...
```bash
$ shpc install quay.io/biocontainers/heasoft:6.35.2--hedafe93_0
```
...
```bash
$ module load quay.io/biocontainers/heasoft/6.35.2--hedafe93_0
$ module help quay.io/biocontainers/heasoft/6.35.2--hedafe93_0
```
