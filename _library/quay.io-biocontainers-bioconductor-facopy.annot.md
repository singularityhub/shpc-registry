...
updated_at: "2022-11-22 01:15:36.264953"
latest: "1.6.0--r36_0"
container_url: "https://biocontainers.pro/tools/bioconductor-facopy.annot"
aliases:
 - ".bioconductor-facopy.annot-post-link.sh"
 - ".bioconductor-facopy.annot-pre-unlink.sh"
 - "gio-launch-desktop"
 - "c89"
 - "c99"
versions:
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-facopy.annot-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-facopy.annot-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-facopy.annot-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-facopy.annot-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-facopy.annot-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-facopy.annot-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
