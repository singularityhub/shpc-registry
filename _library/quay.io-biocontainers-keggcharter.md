...
updated_at: "2023-12-04 03:59:16.151037"
...
```bash
$ shpc install quay.io/biocontainers/keggcharter:0.7.1--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/keggcharter/0.7.1--hdfd78af_0
$ module help quay.io/biocontainers/keggcharter/0.7.1--hdfd78af_0
```
