...
updated_at: "2026-03-28 04:45:09.667437"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-dexseq:1.56.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-dexseq/1.56.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-dexseq/1.56.0--r45hdfd78af_0
```
