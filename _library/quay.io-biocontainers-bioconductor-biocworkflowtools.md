...
updated_at: "2023-12-30 03:00:24.594409"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-biocworkflowtools:1.28.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-biocworkflowtools/1.28.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-biocworkflowtools/1.28.0--r43hdfd78af_0
```
