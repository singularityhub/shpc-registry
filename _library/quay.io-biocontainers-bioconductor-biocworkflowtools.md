...
updated_at: "2026-04-05 05:30:30.651258"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-biocworkflowtools:1.36.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-biocworkflowtools/1.36.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-biocworkflowtools/1.36.0--r45hdfd78af_0
```
