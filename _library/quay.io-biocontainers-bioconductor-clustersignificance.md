...
updated_at: "2026-02-27 04:37:37.925587"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-clustersignificance:1.38.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-clustersignificance/1.38.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-clustersignificance/1.38.0--r45hdfd78af_0
```
