...
updated_at: "2025-04-06 03:49:50.407705"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-maizeprobe:2.18.0--r44hdfd78af_13
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-maizeprobe/2.18.0--r44hdfd78af_13
$ module help quay.io/biocontainers/bioconductor-maizeprobe/2.18.0--r44hdfd78af_13
```
