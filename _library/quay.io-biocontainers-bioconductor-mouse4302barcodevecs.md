...
updated_at: "2026-03-30 05:15:52.475257"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mouse4302barcodevecs:1.48.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mouse4302barcodevecs/1.48.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-mouse4302barcodevecs/1.48.0--r45hdfd78af_0
```
