...
updated_at: "2026-01-07 04:14:59.859819"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-iwtomics:1.30.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-iwtomics/1.30.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-iwtomics/1.30.0--r44hdfd78af_0
```
