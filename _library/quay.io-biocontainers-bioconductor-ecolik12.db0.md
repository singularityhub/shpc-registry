...
updated_at: "2023-10-25 02:51:44.682133"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ecolik12.db0:3.17.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ecolik12.db0/3.17.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ecolik12.db0/3.17.0--r43hdfd78af_0
```
