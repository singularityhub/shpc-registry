...
updated_at: "2026-03-15 05:29:47.031076"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cellbaser:1.34.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cellbaser/1.34.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-cellbaser/1.34.0--r45hdfd78af_0
```
