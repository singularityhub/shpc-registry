...
updated_at: "2025-10-05 03:43:30.045507"
...
```bash
$ shpc install quay.io/biocontainers/crossmap:0.7.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/crossmap/0.7.3--pyhdfd78af_0
$ module help quay.io/biocontainers/crossmap/0.7.3--pyhdfd78af_0
```
