...
updated_at: "2026-08-29 09:36:01.831644"
...
```bash
$ shpc install quay.io/biocontainers/crossmap:0.7.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/crossmap/0.7.4--pyhdfd78af_0
$ module help quay.io/biocontainers/crossmap/0.7.4--pyhdfd78af_0
```
