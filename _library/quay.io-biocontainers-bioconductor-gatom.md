---
layout: container
name:  "quay.io/biocontainers/bioconductor-gatom"
maintainer: "@vsoch"
...
updated_at: "2025-12-27 03:27:44.890479"
...
versions:
 - "1.4.0--r44hdfd78af_0"
description: "singularity registry hpc automated addition for bioconductor-gatom"
config: {"url": "https://biocontainers.pro/tools/bioconductor-gatom", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for bioconductor-gatom", "latest": {"1.4.0--r44hdfd78af_0": "sha256:d94d480956a548ccef313fa90e9141ea146a06a05b496d835fb5a786596b58e7"}, "tags": {"1.4.0--r44hdfd78af_0": "sha256:d94d480956a548ccef313fa90e9141ea146a06a05b496d835fb5a786596b58e7"}, "docker": "quay.io/biocontainers/bioconductor-gatom", "aliases": {"pandoc-lua": "/usr/local/bin/pandoc-lua", "x86_64-conda-linux-gnu.cfg": "/usr/local/bin/x86_64-conda-linux-gnu.cfg", "idle3.13": "/usr/local/bin/idle3.13", "pydoc3.13": "/usr/local/bin/pydoc3.13", "python3.13": "/usr/local/bin/python3.13", "python3.13-config": "/usr/local/bin/python3.13-config", "pandoc-server": "/usr/local/bin/pandoc-server", "glpsol": "/usr/local/bin/glpsol", "installBiocDataPackage.sh": "/usr/local/bin/installBiocDataPackage.sh", "tomlq": "/usr/local/bin/tomlq", "xq": "/usr/local/bin/xq", "yq": "/usr/local/bin/yq", "jq": "/usr/local/bin/jq", "onig-config": "/usr/local/bin/onig-config", "pandoc": "/usr/local/bin/pandoc", "hb-info": "/usr/local/bin/hb-info", "activate-global-python-argcomplete": "/usr/local/bin/activate-global-python-argcomplete", "python-argcomplete-check-easy-install-script": "/usr/local/bin/python-argcomplete-check-easy-install-script", "register-python-argcomplete": "/usr/local/bin/register-python-argcomplete", "tjbench": "/usr/local/bin/tjbench"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/bioconductor-gatom.
singularity registry hpc automated addition for bioconductor-gatom
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/bioconductor-gatom
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-gatom:1.4.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gatom/1.4.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-gatom/1.4.0--r44hdfd78af_0
```
...
#### bioconductor-gatom-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-gatom-inspect-deffile:
