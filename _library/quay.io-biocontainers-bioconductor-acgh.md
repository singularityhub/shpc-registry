...
updated_at: "2024-11-14 04:50:07.461853"
latest: "1.80.0--r43hf17093f_1"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-acgh:1.80.0--r43hf17093f_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-acgh/1.80.0--r43hf17093f_1
$ module help quay.io/biocontainers/bioconductor-acgh/1.80.0--r43hf17093f_1
```
