...
updated_at: "2023-04-19 02:42:15.293846"
latest: "1.10.1--h7e5ed60_0"
...
```bash
$ shpc install quay.io/biocontainers/salmon:1.10.1--h7e5ed60_0
```
...
```bash
$ module load quay.io/biocontainers/salmon/1.10.1--h7e5ed60_0
$ module help quay.io/biocontainers/salmon/1.10.1--h7e5ed60_0
```
