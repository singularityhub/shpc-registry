...
updated_at: "2026-03-30 04:51:52.450089"
latest: "1.11.4--h7f96273_0"
...
```bash
$ shpc install quay.io/biocontainers/salmon:1.11.4--h7f96273_0
```
...
```bash
$ module load quay.io/biocontainers/salmon/1.11.4--h7f96273_0
$ module help quay.io/biocontainers/salmon/1.11.4--h7f96273_0
```
