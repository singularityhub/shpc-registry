...
updated_at: "2024-10-30 15:38:09.184493"
latest: "1.10.3--h6dccd9a_2"
...
```bash
$ shpc install quay.io/biocontainers/salmon:1.10.3--h6dccd9a_2
```
...
```bash
$ module load quay.io/biocontainers/salmon/1.10.3--h6dccd9a_2
$ module help quay.io/biocontainers/salmon/1.10.3--h6dccd9a_2
```
