...
updated_at: "2026-06-27 06:17:12.827143"
latest: "1.12.0--h017bda4_0"
...
```bash
$ shpc install quay.io/biocontainers/salmon:1.12.0--h017bda4_0
```
...
```bash
$ module load quay.io/biocontainers/salmon/1.12.0--h017bda4_0
$ module help quay.io/biocontainers/salmon/1.12.0--h017bda4_0
```
