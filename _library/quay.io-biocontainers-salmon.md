...
updated_at: "2025-11-04 03:35:30.132746"
latest: "1.10.3--h45fbf2d_5"
...
```bash
$ shpc install quay.io/biocontainers/salmon:1.10.3--h45fbf2d_5
```
...
```bash
$ module load quay.io/biocontainers/salmon/1.10.3--h45fbf2d_5
$ module help quay.io/biocontainers/salmon/1.10.3--h45fbf2d_5
```
