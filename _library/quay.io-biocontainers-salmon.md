...
updated_at: "2023-06-12 04:42:50.401648"
latest: "1.10.1--h7e5ed60_1"
...
```bash
$ shpc install quay.io/biocontainers/salmon:1.10.1--h7e5ed60_1
```
...
```bash
$ module load quay.io/biocontainers/salmon/1.10.1--h7e5ed60_1
$ module help quay.io/biocontainers/salmon/1.10.1--h7e5ed60_1
```
