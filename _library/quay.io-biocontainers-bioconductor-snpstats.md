...
updated_at: "2026-03-08 04:53:51.418166"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-snpstats:1.60.0--r45h01b2380_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-snpstats/1.60.0--r45h01b2380_0
$ module help quay.io/biocontainers/bioconductor-snpstats/1.60.0--r45h01b2380_0
```
