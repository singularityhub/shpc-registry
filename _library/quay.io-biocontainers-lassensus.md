...
updated_at: "2026-01-27 04:35:45.648763"
...
```bash
$ shpc install quay.io/biocontainers/lassensus:0.0.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/lassensus/0.0.5--pyhdfd78af_0
$ module help quay.io/biocontainers/lassensus/0.0.5--pyhdfd78af_0
```
