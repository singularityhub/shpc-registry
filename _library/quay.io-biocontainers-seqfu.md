...
updated_at: "2024-11-22 03:13:41.235813"
latest: "1.22.3--h1eb128b_0"
...
```bash
$ shpc install quay.io/biocontainers/seqfu:1.22.3--h1eb128b_0
```
...
```bash
$ module load quay.io/biocontainers/seqfu/1.22.3--h1eb128b_0
$ module help quay.io/biocontainers/seqfu/1.22.3--h1eb128b_0
```
