...
updated_at: "2026-04-03 04:41:49.473884"
latest: "1.25.1--h41da26b_0"
...
```bash
$ shpc install quay.io/biocontainers/seqfu:1.25.1--h41da26b_0
```
...
```bash
$ module load quay.io/biocontainers/seqfu/1.25.1--h41da26b_0
$ module help quay.io/biocontainers/seqfu/1.25.1--h41da26b_0
```
