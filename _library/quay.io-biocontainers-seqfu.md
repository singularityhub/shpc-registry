...
updated_at: "2026-04-28 06:28:19.043782"
latest: "1.26.0--h41da26b_0"
...
```bash
$ shpc install quay.io/biocontainers/seqfu:1.26.0--h41da26b_0
```
...
```bash
$ module load quay.io/biocontainers/seqfu/1.26.0--h41da26b_0
$ module help quay.io/biocontainers/seqfu/1.26.0--h41da26b_0
```
