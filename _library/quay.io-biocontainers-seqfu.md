...
updated_at: "2024-09-05 04:32:04.550671"
latest: "1.20.3--h1eb128b_2"
...
```bash
$ shpc install quay.io/biocontainers/seqfu:1.20.3--h1eb128b_2
```
...
```bash
$ module load quay.io/biocontainers/seqfu/1.20.3--h1eb128b_2
$ module help quay.io/biocontainers/seqfu/1.20.3--h1eb128b_2
```
