...
updated_at: "2026-09-26 07:15:42.676114"
latest: "1.28.0--h41da26b_0"
...
```bash
$ shpc install quay.io/biocontainers/seqfu:1.28.0--h41da26b_0
```
...
```bash
$ module load quay.io/biocontainers/seqfu/1.28.0--h41da26b_0
$ module help quay.io/biocontainers/seqfu/1.28.0--h41da26b_0
```
