...
updated_at: "2024-05-13 02:48:28.776773"
latest: "1.20.3--h1eb128b_1"
...
```bash
$ shpc install quay.io/biocontainers/seqfu:1.20.3--h1eb128b_1
```
...
```bash
$ module load quay.io/biocontainers/seqfu/1.20.3--h1eb128b_1
$ module help quay.io/biocontainers/seqfu/1.20.3--h1eb128b_1
```
