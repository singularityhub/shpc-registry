...
updated_at: "2024-10-14 03:10:27.829924"
latest: "1.22.0--h1eb128b_0"
...
```bash
$ shpc install quay.io/biocontainers/seqfu:1.22.0--h1eb128b_0
```
...
```bash
$ module load quay.io/biocontainers/seqfu/1.22.0--h1eb128b_0
$ module help quay.io/biocontainers/seqfu/1.22.0--h1eb128b_0
```
