...
updated_at: "2024-05-12 02:49:25.538158"
...
```bash
$ shpc install quay.io/biocontainers/snakemake-storage-plugin-gcs:1.0.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake-storage-plugin-gcs/1.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/snakemake-storage-plugin-gcs/1.0.0--pyhdfd78af_0
```
