...
updated_at: "2024-10-05 03:28:46.034130"
...
```bash
$ shpc install quay.io/biocontainers/snakemake-storage-plugin-gcs:1.1.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake-storage-plugin-gcs/1.1.1--pyhdfd78af_0
$ module help quay.io/biocontainers/snakemake-storage-plugin-gcs/1.1.1--pyhdfd78af_0
```
