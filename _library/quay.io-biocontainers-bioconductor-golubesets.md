...
updated_at: "2024-05-10 02:35:42.430991"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-golubesets:1.44.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-golubesets/1.44.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-golubesets/1.44.0--r43hdfd78af_0
```
