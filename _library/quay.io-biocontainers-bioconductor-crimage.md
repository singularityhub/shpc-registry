...
updated_at: "2023-11-02 02:44:19.727873"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-crimage:1.48.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-crimage/1.48.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-crimage/1.48.0--r43hdfd78af_0
```
