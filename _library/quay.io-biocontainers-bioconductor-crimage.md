...
updated_at: "2026-03-02 04:41:52.298921"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-crimage:1.58.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-crimage/1.58.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-crimage/1.58.0--r45hdfd78af_0
```
