...
updated_at: "2023-08-26 02:24:31.047044"
latest: "1.68.1--r43hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-biocviews:1.68.1--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-biocviews/1.68.1--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-biocviews/1.68.1--r43hdfd78af_0
```
