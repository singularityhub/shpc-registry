---
layout: container
name:  "quay.io/biocontainers/mydbfinder"
maintainer: "@vsoch"
...
updated_at: "2024-02-19 02:56:09.635758"
...
versions:
 - "1.0.5--hdfd78af_0"
description: "singularity registry hpc automated addition for mydbfinder"
config: {"url": "https://biocontainers.pro/tools/mydbfinder", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for mydbfinder", "latest": {"1.0.5--hdfd78af_0": "sha256:c6cba933ac6348f1cb532533a060f16debc740a86c604dd7d14da09ef6b86d42"}, "tags": {"1.0.5--hdfd78af_0": "sha256:c6cba933ac6348f1cb532533a060f16debc740a86c604dd7d14da09ef6b86d42"}, "docker": "quay.io/biocontainers/mydbfinder", "aliases": {"curate_database.py": "/usr/local/bin/curate_database.py", "kma": "/usr/local/bin/kma", "kma_index": "/usr/local/bin/kma_index", "kma_shm": "/usr/local/bin/kma_shm", "kma_update": "/usr/local/bin/kma_update", "mydbfinder.py": "/usr/local/bin/mydbfinder.py", "tabulate": "/usr/local/bin/tabulate", "edirect.py": "/usr/local/bin/edirect.py", "filter-columns": "/usr/local/bin/filter-columns", "fuse-segments": "/usr/local/bin/fuse-segments", "gene2range": "/usr/local/bin/gene2range", "tbl2prod": "/usr/local/bin/tbl2prod", "uniq-table": "/usr/local/bin/uniq-table", "align-columns": "/usr/local/bin/align-columns", "blst2tkns": "/usr/local/bin/blst2tkns", "csv2xml": "/usr/local/bin/csv2xml", "disambiguate-nucleotides": "/usr/local/bin/disambiguate-nucleotides", "download-ncbi-software": "/usr/local/bin/download-ncbi-software", "ecommon.sh": "/usr/local/bin/ecommon.sh", "find-in-gene": "/usr/local/bin/find-in-gene", "fuse-ranges": "/usr/local/bin/fuse-ranges", "hgvs2spdi": "/usr/local/bin/hgvs2spdi", "json2xml": "/usr/local/bin/json2xml", "print-columns": "/usr/local/bin/print-columns", "snp2hgvs": "/usr/local/bin/snp2hgvs", "snp2tbl": "/usr/local/bin/snp2tbl", "sort-table": "/usr/local/bin/sort-table", "spdi2tbl": "/usr/local/bin/spdi2tbl", "split-at-intron": "/usr/local/bin/split-at-intron", "tbl2xml": "/usr/local/bin/tbl2xml", "transmute.Linux": "/usr/local/bin/transmute.Linux"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/mydbfinder.
singularity registry hpc automated addition for mydbfinder
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/mydbfinder
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/mydbfinder:1.0.5--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mydbfinder/1.0.5--hdfd78af_0
$ module help quay.io/biocontainers/mydbfinder/1.0.5--hdfd78af_0
```
...
#### mydbfinder-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### mydbfinder-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/curate_database.py
$ podman run --it --rm --entrypoint /usr/local/bin/curate_database.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/curate_database.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/mydbfinder.py
$ podman run --it --rm --entrypoint /usr/local/bin/mydbfinder.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/mydbfinder.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
