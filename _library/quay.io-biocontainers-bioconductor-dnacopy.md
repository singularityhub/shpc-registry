...
updated_at: "2022-10-29 05:37:06.844715"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-dnacopy:1.68.0--r41hefde4a7_2
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-dnacopy/1.68.0--r41hefde4a7_2
$ module help quay.io/biocontainers/bioconductor-dnacopy/1.68.0--r41hefde4a7_2
```
