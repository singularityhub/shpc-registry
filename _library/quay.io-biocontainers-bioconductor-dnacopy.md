...
updated_at: "2025-11-15 03:21:50.113662"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-dnacopy:1.80.0--r44h4d5c4aa_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-dnacopy/1.80.0--r44h4d5c4aa_1
$ module help quay.io/biocontainers/bioconductor-dnacopy/1.80.0--r44h4d5c4aa_1
```
