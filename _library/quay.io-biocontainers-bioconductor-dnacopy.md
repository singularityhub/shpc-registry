...
updated_at: "2023-07-10 04:08:04.213990"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-dnacopy:1.72.0--r42h9913872_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-dnacopy/1.72.0--r42h9913872_1
$ module help quay.io/biocontainers/bioconductor-dnacopy/1.72.0--r42h9913872_1
```
