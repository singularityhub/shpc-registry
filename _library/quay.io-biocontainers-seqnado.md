...
updated_at: "2026-06-03 07:00:58.499452"
...
```bash
$ shpc install quay.io/biocontainers/seqnado:1.0.6--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/seqnado/1.0.6--pyhdfd78af_0
$ module help quay.io/biocontainers/seqnado/1.0.6--pyhdfd78af_0
```
