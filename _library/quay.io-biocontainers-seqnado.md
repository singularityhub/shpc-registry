...
updated_at: "2025-08-01 10:42:37.712257"
...
```bash
$ shpc install quay.io/biocontainers/seqnado:0.7.6--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/seqnado/0.7.6--pyhdfd78af_0
$ module help quay.io/biocontainers/seqnado/0.7.6--pyhdfd78af_0
```
