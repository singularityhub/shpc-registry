...
updated_at: "2024-08-22 19:58:50.666626"
...
```bash
$ shpc install quay.io/biocontainers/seqnado:0.5.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/seqnado/0.5.2--pyhdfd78af_0
$ module help quay.io/biocontainers/seqnado/0.5.2--pyhdfd78af_0
```
