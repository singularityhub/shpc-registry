---
layout: container
name:  "quay.io/biocontainers/seqnado"
maintainer: "@vsoch"
...
updated_at: "2026-08-19 03:47:24.974108"
...
```bash
$ shpc install quay.io/biocontainers/seqnado
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/seqnado:1.0.7--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/seqnado/1.0.7--pyhdfd78af_0
$ module help quay.io/biocontainers/seqnado/1.0.7--pyhdfd78af_0
```
...
#### seqnado-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### seqnado-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/protoc-25.2.0
$ podman run --it --rm --entrypoint /usr/local/bin/protoc-25.2.0   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/protoc-25.2.0   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/seqnado
$ podman run --it --rm --entrypoint /usr/local/bin/seqnado   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/seqnado   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/seqnado-config
$ podman run --it --rm --entrypoint /usr/local/bin/seqnado-config   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/seqnado-config   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/seqnado-design
$ podman run --it --rm --entrypoint /usr/local/bin/seqnado-design   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/seqnado-design   -v ${PWD} -w ${PWD} <container> -c " $@"
```
