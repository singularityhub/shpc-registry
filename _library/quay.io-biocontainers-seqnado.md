...
updated_at: "2026-04-05 04:47:25.299497"
...
```bash
$ shpc install quay.io/biocontainers/seqnado:1.0.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/seqnado/1.0.5--pyhdfd78af_0
$ module help quay.io/biocontainers/seqnado/1.0.5--pyhdfd78af_0
```
