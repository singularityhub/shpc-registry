...
updated_at: "2025-05-27 12:19:12.440586"
...
```bash
$ shpc install quay.io/biocontainers/seqnado:0.7.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/seqnado/0.7.2--pyhdfd78af_0
$ module help quay.io/biocontainers/seqnado/0.7.2--pyhdfd78af_0
```
