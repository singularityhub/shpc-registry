...
updated_at: "2024-03-07 02:34:58.137151"
...
```bash
$ shpc install quay.io/biocontainers/seqnado:0.4.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/seqnado/0.4.1--pyhdfd78af_0
$ module help quay.io/biocontainers/seqnado/0.4.1--pyhdfd78af_0
```
