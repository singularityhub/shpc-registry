...
updated_at: "2024-11-13 02:51:25.654507"
...
```bash
$ shpc install quay.io/biocontainers/seqnado:0.5.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/seqnado/0.5.4--pyhdfd78af_0
$ module help quay.io/biocontainers/seqnado/0.5.4--pyhdfd78af_0
```
