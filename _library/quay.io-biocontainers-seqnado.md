...
updated_at: "2024-04-11 02:38:16.733436"
...
```bash
$ shpc install quay.io/biocontainers/seqnado:0.4.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/seqnado/0.4.3--pyhdfd78af_0
$ module help quay.io/biocontainers/seqnado/0.4.3--pyhdfd78af_0
```
