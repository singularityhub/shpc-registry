...
updated_at: "2025-07-20 04:12:55.474845"
...
```bash
$ shpc install quay.io/biocontainers/seqnado:0.7.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/seqnado/0.7.3--pyhdfd78af_0
$ module help quay.io/biocontainers/seqnado/0.7.3--pyhdfd78af_0
```
