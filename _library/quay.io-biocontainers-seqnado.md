...
updated_at: "2026-03-02 05:21:50.513167"
...
```bash
$ shpc install quay.io/biocontainers/seqnado:1.0.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/seqnado/1.0.4--pyhdfd78af_0
$ module help quay.io/biocontainers/seqnado/1.0.4--pyhdfd78af_0
```
