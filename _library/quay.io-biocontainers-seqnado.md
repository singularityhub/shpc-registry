...
updated_at: "2025-02-23 03:42:34.428798"
...
```bash
$ shpc install quay.io/biocontainers/seqnado:0.6.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/seqnado/0.6.3--pyhdfd78af_0
$ module help quay.io/biocontainers/seqnado/0.6.3--pyhdfd78af_0
```
