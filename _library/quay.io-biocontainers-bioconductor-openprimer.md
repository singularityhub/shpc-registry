...
updated_at: "2026-03-20 00:57:10.566436"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-openprimer:1.32.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-openprimer/1.32.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-openprimer/1.32.0--r45hdfd78af_0
```
