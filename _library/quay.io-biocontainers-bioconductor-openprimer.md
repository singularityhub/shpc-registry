...
updated_at: "2023-12-04 03:49:47.554231"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-openprimer:1.22.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-openprimer/1.22.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-openprimer/1.22.0--r43hdfd78af_0
```
