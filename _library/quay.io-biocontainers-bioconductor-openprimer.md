...
updated_at: "2024-06-07 02:55:02.390038"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-openprimer:1.24.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-openprimer/1.24.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-openprimer/1.24.0--r43hdfd78af_0
```
