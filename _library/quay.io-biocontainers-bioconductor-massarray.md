...
updated_at: "2026-03-04 05:05:15.230916"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-massarray:1.62.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-massarray/1.62.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-massarray/1.62.0--r45hdfd78af_0
```
