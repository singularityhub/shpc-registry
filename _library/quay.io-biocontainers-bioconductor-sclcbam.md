...
updated_at: "2023-09-05 03:07:26.044193"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-sclcbam:1.32.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-sclcbam/1.32.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-sclcbam/1.32.0--r43hdfd78af_0
```
