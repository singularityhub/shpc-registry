...
updated_at: "2023-07-12 03:38:39.468617"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-scmap:1.20.0--r42hf17093f_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-scmap/1.20.0--r42hf17093f_1
$ module help quay.io/biocontainers/bioconductor-scmap/1.20.0--r42hf17093f_1
```
