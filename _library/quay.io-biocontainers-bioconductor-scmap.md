...
updated_at: "2023-07-30 03:08:46.789838"
latest: "1.22.3--r43hf17093f_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-scmap:1.22.3--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-scmap/1.22.3--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-scmap/1.22.3--r43hf17093f_0
```
