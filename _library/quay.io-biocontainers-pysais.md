...
updated_at: "2024-05-04 02:53:52.607832"
...
```bash
$ shpc install quay.io/biocontainers/pysais:1.1.0--py310hd6be1da_0
```
...
```bash
$ module load quay.io/biocontainers/pysais/1.1.0--py310hd6be1da_0
$ module help quay.io/biocontainers/pysais/1.1.0--py310hd6be1da_0
```
