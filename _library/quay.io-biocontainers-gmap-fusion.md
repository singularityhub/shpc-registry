...
updated_at: "2026-05-04 06:28:32.300055"
...
```bash
$ shpc install quay.io/biocontainers/gmap-fusion:0.4.2--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/gmap-fusion/0.4.2--hdfd78af_0
$ module help quay.io/biocontainers/gmap-fusion/0.4.2--hdfd78af_0
```
