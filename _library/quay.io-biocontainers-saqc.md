---
layout: container
name:  "quay.io/biocontainers/saqc"
maintainer: "@vsoch"
...
updated_at: "2025-02-07 02:59:02.149286"
latest: "2.4.1"
...
```bash
$ module load quay.io/biocontainers/saqc/2.4.1
$ module help quay.io/biocontainers/saqc/2.4.1
```
...
#### saqc-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### saqc-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/saqc
$ podman run --it --rm --entrypoint /usr/local/bin/saqc   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/saqc   -v ${PWD} -w ${PWD} <container> -c " $@"
```
