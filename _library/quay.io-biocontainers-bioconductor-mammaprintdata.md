...
updated_at: "2023-10-14 02:19:45.705515"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mammaprintdata:1.36.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mammaprintdata/1.36.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-mammaprintdata/1.36.0--r43hdfd78af_0
```
