...
updated_at: "2025-10-15 03:55:04.019414"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-zfpkm:1.28.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-zfpkm/1.28.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-zfpkm/1.28.0--r44hdfd78af_0
```
