...
updated_at: "2023-11-06 03:27:10.207820"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-msexperiment:1.2.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-msexperiment/1.2.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-msexperiment/1.2.0--r43hdfd78af_0
```
