...
updated_at: "2026-04-03 16:04:52.869060"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-msexperiment:1.12.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-msexperiment/1.12.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-msexperiment/1.12.0--r45hdfd78af_0
```
