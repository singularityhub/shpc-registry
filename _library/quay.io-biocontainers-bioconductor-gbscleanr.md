---
layout: container
name:  "quay.io/biocontainers/bioconductor-gbscleanr"
maintainer: "@vsoch"
...
updated_at: "2026-03-17 05:12:06.089971"
latest: "2.4.4--r45ha27e39d_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gbscleanr
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-gbscleanr:2.4.4--r45ha27e39d_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gbscleanr/2.4.4--r45ha27e39d_0
$ module help quay.io/biocontainers/bioconductor-gbscleanr/2.4.4--r45ha27e39d_0
```
...
#### bioconductor-gbscleanr-inspect:
...
#### bioconductor-gbscleanr-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-gbscleanr-inspect-deffile:
