...
updated_at: "2026-01-17 03:45:22.225543"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-remp:1.30.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-remp/1.30.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-remp/1.30.0--r44hdfd78af_0
```
