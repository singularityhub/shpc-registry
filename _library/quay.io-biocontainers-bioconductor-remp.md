...
updated_at: "2026-03-25 04:30:44.331922"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-remp:1.34.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-remp/1.34.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-remp/1.34.0--r45hdfd78af_0
```
