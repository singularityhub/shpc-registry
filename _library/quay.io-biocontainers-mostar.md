...
updated_at: "2026-08-14 04:42:01.132894"
...
```bash
$ shpc install quay.io/biocontainers/mostar:1.0.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mostar/1.0.4--pyhdfd78af_0
$ module help quay.io/biocontainers/mostar/1.0.4--pyhdfd78af_0
```
