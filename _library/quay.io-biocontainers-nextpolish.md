...
updated_at: "2026-04-28 06:15:42.583519"
...
```bash
$ shpc install quay.io/biocontainers/nextpolish:1.4.1--h3952c39_7
```
...
```bash
$ module load quay.io/biocontainers/nextpolish/1.4.1--h3952c39_7
$ module help quay.io/biocontainers/nextpolish/1.4.1--h3952c39_7
```
