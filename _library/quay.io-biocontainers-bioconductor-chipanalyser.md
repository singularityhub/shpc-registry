...
updated_at: "2025-12-07 04:12:58.377131"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-chipanalyser:1.28.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-chipanalyser/1.28.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-chipanalyser/1.28.0--r44hdfd78af_0
```
