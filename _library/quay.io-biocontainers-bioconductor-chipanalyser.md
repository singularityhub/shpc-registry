...
updated_at: "2026-04-03 04:57:27.930330"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-chipanalyser:1.32.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-chipanalyser/1.32.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-chipanalyser/1.32.0--r45hdfd78af_0
```
