...
updated_at: "2022-10-29 05:53:46.827384"
latest: "1.8.0--r36_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-chipanalyser:1.8.0--r36_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-chipanalyser/1.8.0--r36_0
$ module help quay.io/biocontainers/bioconductor-chipanalyser/1.8.0--r36_0
```
