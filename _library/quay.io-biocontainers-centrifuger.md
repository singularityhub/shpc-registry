...
updated_at: "2026-06-20 06:46:13.275420"
latest: "1.1.2--h3be2455_0"
...
```bash
$ shpc install quay.io/biocontainers/centrifuger:1.1.2--h3be2455_0
```
...
```bash
$ module load quay.io/biocontainers/centrifuger/1.1.2--h3be2455_0
$ module help quay.io/biocontainers/centrifuger/1.1.2--h3be2455_0
```
