...
updated_at: "2026-09-15 07:54:45.344890"
latest: "1.1.3--h3be2455_0"
...
```bash
$ shpc install quay.io/biocontainers/centrifuger:1.1.3--h3be2455_0
```
...
```bash
$ module load quay.io/biocontainers/centrifuger/1.1.3--h3be2455_0
$ module help quay.io/biocontainers/centrifuger/1.1.3--h3be2455_0
```
