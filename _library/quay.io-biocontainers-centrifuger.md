...
updated_at: "2024-06-01 03:04:34.732959"
latest: "1.0.2--hdcf5f25_0"
...
```bash
$ shpc install quay.io/biocontainers/centrifuger:1.0.2--hdcf5f25_0
```
...
```bash
$ module load quay.io/biocontainers/centrifuger/1.0.2--hdcf5f25_0
$ module help quay.io/biocontainers/centrifuger/1.0.2--hdcf5f25_0
```
