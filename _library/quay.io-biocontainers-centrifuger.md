...
updated_at: "2025-10-24 03:12:45.875420"
latest: "1.0.11--h077b44d_0"
...
```bash
$ shpc install quay.io/biocontainers/centrifuger:1.0.11--h077b44d_0
```
...
```bash
$ module load quay.io/biocontainers/centrifuger/1.0.11--h077b44d_0
$ module help quay.io/biocontainers/centrifuger/1.0.11--h077b44d_0
```
