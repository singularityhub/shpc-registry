...
updated_at: "2025-08-04 04:35:15.365669"
latest: "1.0.10--h077b44d_0"
...
```bash
$ shpc install quay.io/biocontainers/centrifuger:1.0.10--h077b44d_0
```
...
```bash
$ module load quay.io/biocontainers/centrifuger/1.0.10--h077b44d_0
$ module help quay.io/biocontainers/centrifuger/1.0.10--h077b44d_0
```
