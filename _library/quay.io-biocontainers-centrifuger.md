...
updated_at: "2026-05-22 06:17:29.755943"
...
```bash
$ shpc install quay.io/biocontainers/centrifuger:1.1.1--h3be2455_0
```
...
```bash
$ module load quay.io/biocontainers/centrifuger/1.1.1--h3be2455_0
$ module help quay.io/biocontainers/centrifuger/1.1.1--h3be2455_0
```
