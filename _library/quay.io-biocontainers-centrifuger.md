...
updated_at: "2025-03-08 03:04:09.488770"
latest: "1.0.6--h077b44d_2"
...
```bash
$ shpc install quay.io/biocontainers/centrifuger:1.0.6--h077b44d_2
```
...
```bash
$ module load quay.io/biocontainers/centrifuger/1.0.6--h077b44d_2
$ module help quay.io/biocontainers/centrifuger/1.0.6--h077b44d_2
```
