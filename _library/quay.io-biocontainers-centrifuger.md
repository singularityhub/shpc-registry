...
updated_at: "2024-07-04 04:10:40.053382"
latest: "1.0.3--hdcf5f25_0"
...
```bash
$ shpc install quay.io/biocontainers/centrifuger:1.0.3--hdcf5f25_0
```
...
```bash
$ module load quay.io/biocontainers/centrifuger/1.0.3--hdcf5f25_0
$ module help quay.io/biocontainers/centrifuger/1.0.3--hdcf5f25_0
```
