...
updated_at: "2025-12-30 03:51:31.887707"
...
```bash
$ shpc install quay.io/biocontainers/centrifuger:1.0.12--h077b44d_0
```
...
```bash
$ module load quay.io/biocontainers/centrifuger/1.0.12--h077b44d_0
$ module help quay.io/biocontainers/centrifuger/1.0.12--h077b44d_0
```
