...
updated_at: "2023-07-21 03:23:59.461512"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hgu95av2probe:2.18.0--r43hdfd78af_11
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hgu95av2probe/2.18.0--r43hdfd78af_11
$ module help quay.io/biocontainers/bioconductor-hgu95av2probe/2.18.0--r43hdfd78af_11
```
