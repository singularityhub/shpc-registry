...
updated_at: "2025-01-09 13:44:00.247305"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-curatedadiporna:1.22.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-curatedadiporna/1.22.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-curatedadiporna/1.22.0--r44hdfd78af_0
```
