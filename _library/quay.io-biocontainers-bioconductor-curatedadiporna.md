...
```bash
$ shpc install quay.io/biocontainers/bioconductor-curatedadiporna:1.8.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-curatedadiporna/1.8.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-curatedadiporna/1.8.0--r41hdfd78af_0
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-curatedadiporna-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-curatedadiporna-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-curatedadiporna-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-curatedadiporna-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-curatedadiporna-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-curatedadiporna-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
