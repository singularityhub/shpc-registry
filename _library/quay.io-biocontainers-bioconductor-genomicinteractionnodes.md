...
updated_at: "2023-10-07 03:02:27.714824"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-genomicinteractionnodes:1.4.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-genomicinteractionnodes/1.4.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-genomicinteractionnodes/1.4.0--r43hdfd78af_0
```
