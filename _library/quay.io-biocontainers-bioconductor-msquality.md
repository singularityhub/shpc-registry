...
updated_at: "2023-10-02 02:44:17.842721"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-msquality:1.0.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-msquality/1.0.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-msquality/1.0.0--r43hdfd78af_0
```
