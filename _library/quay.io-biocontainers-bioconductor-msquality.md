---
layout: container
name:  "quay.io/biocontainers/bioconductor-msquality"
maintainer: "@vsoch"
...
updated_at: "2026-03-09 05:02:01.304438"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-msquality
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-msquality:1.10.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-msquality/1.10.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-msquality/1.10.0--r45hdfd78af_0
```
...
#### bioconductor-msquality-inspect:
...
#### bioconductor-msquality-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-msquality-inspect-deffile:
