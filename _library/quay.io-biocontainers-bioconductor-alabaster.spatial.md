---
layout: container
name:  "quay.io/biocontainers/bioconductor-alabaster.spatial"
maintainer: "@vsoch"
...
updated_at: "2026-04-03 05:02:19.254939"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-alabaster.spatial
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-alabaster.spatial:1.10.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-alabaster.spatial/1.10.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-alabaster.spatial/1.10.0--r45hdfd78af_0
```
...
#### bioconductor-alabaster.spatial-run:
...
#### bioconductor-alabaster.spatial-shell:
...
#### bioconductor-alabaster.spatial-exec:
...
#### bioconductor-alabaster.spatial-inspect:
...
#### bioconductor-alabaster.spatial-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-alabaster.spatial-inspect-deffile:
