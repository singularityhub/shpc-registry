...
updated_at: "2025-10-18 03:31:43.848319"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-alabaster.spatial:1.6.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-alabaster.spatial/1.6.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-alabaster.spatial/1.6.0--r44hdfd78af_0
```
