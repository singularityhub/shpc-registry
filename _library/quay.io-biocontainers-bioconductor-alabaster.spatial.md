...
updated_at: "2026-01-15 04:37:08.578031"
latest: "1.6.1--r44hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-alabaster.spatial:1.6.1--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-alabaster.spatial/1.6.1--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-alabaster.spatial/1.6.1--r44hdfd78af_0
```
