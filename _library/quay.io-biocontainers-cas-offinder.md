...
updated_at: "2025-10-11 03:33:13.217233"
...
```bash
$ shpc install quay.io/biocontainers/cas-offinder:2.4.1--h503566f_0
```
...
```bash
$ module load quay.io/biocontainers/cas-offinder/2.4.1--h503566f_0
$ module help quay.io/biocontainers/cas-offinder/2.4.1--h503566f_0
```
