...
updated_at: "2023-06-01 03:47:29.920836"
latest: "1.2.7--py310h30d9df9_0"
...
```bash
$ shpc install quay.io/biocontainers/zol:1.2.7--py310h30d9df9_0
```
...
```bash
$ module load quay.io/biocontainers/zol/1.2.7--py310h30d9df9_0
$ module help quay.io/biocontainers/zol/1.2.7--py310h30d9df9_0
```
