...
updated_at: "2023-11-05 02:27:03.264161"
latest: "1.3.10--py310h0dbaff4_0"
...
```bash
$ shpc install quay.io/biocontainers/zol:1.3.10--py310h0dbaff4_0
```
...
```bash
$ module load quay.io/biocontainers/zol/1.3.10--py310h0dbaff4_0
$ module help quay.io/biocontainers/zol/1.3.10--py310h0dbaff4_0
```
