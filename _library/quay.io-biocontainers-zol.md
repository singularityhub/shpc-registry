...
updated_at: "2024-04-21 03:08:50.932183"
latest: "1.3.19--py310h0dbaff4_0"
...
```bash
$ shpc install quay.io/biocontainers/zol:1.3.19--py310h0dbaff4_0
```
...
```bash
$ module load quay.io/biocontainers/zol/1.3.19--py310h0dbaff4_0
$ module help quay.io/biocontainers/zol/1.3.19--py310h0dbaff4_0
```
