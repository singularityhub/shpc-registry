...
updated_at: "2023-12-01 02:36:52.441869"
latest: "1.3.11--py310h0dbaff4_0"
...
```bash
$ shpc install quay.io/biocontainers/zol:1.3.11--py310h0dbaff4_0
```
...
```bash
$ module load quay.io/biocontainers/zol/1.3.11--py310h0dbaff4_0
$ module help quay.io/biocontainers/zol/1.3.11--py310h0dbaff4_0
```
