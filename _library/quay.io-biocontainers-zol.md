...
updated_at: "2026-06-30 06:30:58.576873"
latest: "1.6.19--py312h9b2995c_0"
...
```bash
$ shpc install quay.io/biocontainers/zol:1.6.19--py312h9b2995c_0
```
...
```bash
$ module load quay.io/biocontainers/zol/1.6.19--py312h9b2995c_0
$ module help quay.io/biocontainers/zol/1.6.19--py312h9b2995c_0
```
