...
updated_at: "2024-03-10 02:44:04.955312"
latest: "1.3.18--py310h0dbaff4_0"
...
```bash
$ shpc install quay.io/biocontainers/zol:1.3.18--py310h0dbaff4_0
```
...
```bash
$ module load quay.io/biocontainers/zol/1.3.18--py310h0dbaff4_0
$ module help quay.io/biocontainers/zol/1.3.18--py310h0dbaff4_0
```
