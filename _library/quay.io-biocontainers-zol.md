...
updated_at: "2024-07-08 03:09:39.270808"
latest: "1.4.5--py310h0dbaff4_0"
...
```bash
$ shpc install quay.io/biocontainers/zol:1.4.5--py310h0dbaff4_0
```
...
```bash
$ module load quay.io/biocontainers/zol/1.4.5--py310h0dbaff4_0
$ module help quay.io/biocontainers/zol/1.4.5--py310h0dbaff4_0
```
