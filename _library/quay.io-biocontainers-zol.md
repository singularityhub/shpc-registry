...
updated_at: "2026-09-21 08:01:52.790284"
latest: "1.7.0--py310hd766df8_1"
...
```bash
$ shpc install quay.io/biocontainers/zol:1.7.0--py310hd766df8_1
```
...
```bash
$ module load quay.io/biocontainers/zol/1.7.0--py310hd766df8_1
$ module help quay.io/biocontainers/zol/1.7.0--py310hd766df8_1
```
