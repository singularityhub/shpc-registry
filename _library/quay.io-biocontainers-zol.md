...
updated_at: "2024-06-09 02:40:26.142314"
latest: "1.3.20--py310h0dbaff4_0"
...
```bash
$ shpc install quay.io/biocontainers/zol:1.3.20--py310h0dbaff4_0
```
...
```bash
$ module load quay.io/biocontainers/zol/1.3.20--py310h0dbaff4_0
$ module help quay.io/biocontainers/zol/1.3.20--py310h0dbaff4_0
```
