...
updated_at: "2026-08-26 03:46:15.449331"
latest: "1.7.0--py312h9b2995c_0"
...
```bash
$ shpc install quay.io/biocontainers/zol:1.7.0--py312h9b2995c_0
```
...
```bash
$ module load quay.io/biocontainers/zol/1.7.0--py312h9b2995c_0
$ module help quay.io/biocontainers/zol/1.7.0--py312h9b2995c_0
```
