...
updated_at: "2024-12-03 03:12:02.329513"
latest: "1.5.5--py310h84f13bb_0"
...
```bash
$ shpc install quay.io/biocontainers/zol:1.5.5--py310h84f13bb_0
```
...
```bash
$ module load quay.io/biocontainers/zol/1.5.5--py310h84f13bb_0
$ module help quay.io/biocontainers/zol/1.5.5--py310h84f13bb_0
```
