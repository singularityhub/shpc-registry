...
updated_at: "2026-03-16 05:01:58.169269"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-a4preproc:1.58.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-a4preproc/1.58.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-a4preproc/1.58.0--r45hdfd78af_0
```
