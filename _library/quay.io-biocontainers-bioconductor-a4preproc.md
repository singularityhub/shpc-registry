...
updated_at: "2023-10-23 02:38:49.646242"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-a4preproc:1.48.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-a4preproc/1.48.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-a4preproc/1.48.0--r43hdfd78af_0
```
