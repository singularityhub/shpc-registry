...
updated_at: "2026-04-03 05:17:56.328505"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-msstatsbig:1.8.1--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-msstatsbig/1.8.1--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-msstatsbig/1.8.1--r45hdfd78af_0
```
