...
updated_at: "2025-12-21 04:18:02.279666"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-msstatsbig:1.4.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-msstatsbig/1.4.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-msstatsbig/1.4.0--r44hdfd78af_0
```
