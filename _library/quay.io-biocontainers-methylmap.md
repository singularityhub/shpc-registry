...
updated_at: "2023-04-21 03:12:59.269035"
...
```bash
$ shpc install quay.io/biocontainers/methylmap:0.3.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/methylmap/0.3.5--pyhdfd78af_0
$ module help quay.io/biocontainers/methylmap/0.3.5--pyhdfd78af_0
```
