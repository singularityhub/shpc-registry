...
updated_at: "2025-08-13 03:29:32.486349"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-celltrails:1.24.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-celltrails/1.24.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-celltrails/1.24.0--r44hdfd78af_0
```
