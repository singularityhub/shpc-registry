...
updated_at: "2023-07-28 02:46:46.381816"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-celltrails:1.18.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-celltrails/1.18.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-celltrails/1.18.0--r43hdfd78af_0
```
