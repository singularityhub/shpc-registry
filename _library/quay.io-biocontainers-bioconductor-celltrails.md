...
updated_at: "2026-04-03 04:40:04.163712"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-celltrails:1.28.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-celltrails/1.28.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-celltrails/1.28.0--r45hdfd78af_0
```
