...
updated_at: "2025-02-15 02:49:12.759622"
latest: "0.1.28--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/amplicontyper:0.1.28--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/amplicontyper/0.1.28--pyhdfd78af_0
$ module help quay.io/biocontainers/amplicontyper/0.1.28--pyhdfd78af_0
```
