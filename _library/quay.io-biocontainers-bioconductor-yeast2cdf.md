...
updated_at: "2025-08-25 03:58:18.684117"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-yeast2cdf:2.18.0--r44hdfd78af_13
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-yeast2cdf/2.18.0--r44hdfd78af_13
$ module help quay.io/biocontainers/bioconductor-yeast2cdf/2.18.0--r44hdfd78af_13
```
