...
updated_at: "2023-03-06 03:20:20.996093"
...
```bash
$ shpc install quay.io/biocontainers/metacoag:1.1--pyhfa5458b_0
```
...
```bash
$ module load quay.io/biocontainers/metacoag/1.1--pyhfa5458b_0
$ module help quay.io/biocontainers/metacoag/1.1--pyhfa5458b_0
```
