---
layout: container
name:  "quay.io/biocontainers/a-liner"
maintainer: "@vsoch"
...
updated_at: "2026-02-27 04:20:09.199177"
...
singularity registry hpc automated addition for a-liner
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/a-liner
```
...
#### a-liner-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### a-liner-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/a-liner
$ podman run --it --rm --entrypoint /usr/local/bin/a-liner   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/a-liner   -v ${PWD} -w ${PWD} <container> -c " $@"
```
