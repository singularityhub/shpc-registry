...
updated_at: "2024-11-14 03:01:28.220296"
latest: "2.2.3--h4ac6f70_0"
...
```bash
$ shpc install quay.io/biocontainers/famsa:2.2.3--h4ac6f70_0
```
...
```bash
$ module load quay.io/biocontainers/famsa/2.2.3--h4ac6f70_0
$ module help quay.io/biocontainers/famsa/2.2.3--h4ac6f70_0
```
