...
updated_at: "2024-03-27 03:05:54.189967"
latest: "1.19--h8b25389_1"
...
```bash
$ shpc install quay.io/biocontainers/bcftools:1.19--h8b25389_1
```
...
```bash
$ module load quay.io/biocontainers/bcftools/1.19--h8b25389_1
$ module help quay.io/biocontainers/bcftools/1.19--h8b25389_1
```
