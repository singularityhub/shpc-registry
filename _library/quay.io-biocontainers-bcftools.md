...
updated_at: "2024-08-09 02:42:52.968284"
latest: "1.20--h8b25389_1"
...
```bash
$ shpc install quay.io/biocontainers/bcftools:1.20--h8b25389_1
```
...
```bash
$ module load quay.io/biocontainers/bcftools/1.20--h8b25389_1
$ module help quay.io/biocontainers/bcftools/1.20--h8b25389_1
```
