...
updated_at: "2024-12-19 03:23:51.854492"
latest: "1.21--h8b25389_0"
...
```bash
$ shpc install quay.io/biocontainers/bcftools:1.21--h8b25389_0
```
...
```bash
$ module load quay.io/biocontainers/bcftools/1.21--h8b25389_0
$ module help quay.io/biocontainers/bcftools/1.21--h8b25389_0
```
