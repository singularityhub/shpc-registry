...
updated_at: "2024-04-22 03:14:46.898283"
latest: "1.20--h8b25389_0"
...
```bash
$ shpc install quay.io/biocontainers/bcftools:1.20--h8b25389_0
```
...
```bash
$ module load quay.io/biocontainers/bcftools/1.20--h8b25389_0
$ module help quay.io/biocontainers/bcftools/1.20--h8b25389_0
```
