...
updated_at: "2022-11-02 18:41:46.026297"
latest: "1.8.0--r36_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-vulcandata:1.8.0--r36_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-vulcandata/1.8.0--r36_0
$ module help quay.io/biocontainers/bioconductor-vulcandata/1.8.0--r36_0
```
