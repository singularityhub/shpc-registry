...
updated_at: "2026-09-05 07:33:34.591149"
...
```bash
$ shpc install quay.io/biocontainers/perl-http-message:7.04--pl5321hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/perl-http-message/7.04--pl5321hdfd78af_0
$ module help quay.io/biocontainers/perl-http-message/7.04--pl5321hdfd78af_0
```
