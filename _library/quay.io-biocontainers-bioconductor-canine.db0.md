...
updated_at: "2024-11-02 03:36:20.222620"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-canine.db0:3.18.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-canine.db0/3.18.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-canine.db0/3.18.0--r43hdfd78af_0
```
