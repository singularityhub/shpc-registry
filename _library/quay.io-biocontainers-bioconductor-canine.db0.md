...
updated_at: "2023-09-08 02:28:09.644352"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-canine.db0:3.17.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-canine.db0/3.17.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-canine.db0/3.17.0--r43hdfd78af_0
```
