---
layout: container
name:  "quay.io/biocontainers/gtdb-gtranslate"
maintainer: "@vsoch"
...
updated_at: "2026-06-16 07:33:18.553068"
...
singularity registry hpc automated addition for gtdb-gtranslate
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/gtdb-gtranslate
```
...
#### gtdb-gtranslate-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### gtdb-gtranslate-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/gtranslate
$ podman run --it --rm --entrypoint /usr/local/bin/gtranslate   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/gtranslate   -v ${PWD} -w ${PWD} <container> -c " $@"
```
