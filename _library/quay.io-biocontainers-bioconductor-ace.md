...
updated_at: "2026-05-28 07:06:46.757416"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ace:1.28.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ace/1.28.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ace/1.28.0--r45hdfd78af_0
```
