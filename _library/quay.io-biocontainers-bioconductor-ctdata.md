---
layout: container
name:  "quay.io/biocontainers/bioconductor-ctdata"
maintainer: "@vsoch"
github: "https://github.com/singularityhub/shpc-registry/blob/main/quay.io/biocontainers/bioconductor-ctdata/container.yaml"
config_url: "https://raw.githubusercontent.com/singularityhub/shpc-registry/main/quay.io/biocontainers/bioconductor-ctdata/container.yaml"
updated_at: "2026-03-25 04:43:18.029491"
latest: "1.10.0--r45hdfd78af_0"
container_url: "https://biocontainers.pro/tools/bioconductor-ctdata"
aliases:
 - "hb-info"
 - "tjbench"
 - "2to3-3.11"
...
description: "singularity registry hpc automated addition for bioconductor-ctdata"
config: {"url": "https://biocontainers.pro/tools/bioconductor-ctdata", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for bioconductor-ctdata", "latest": {"1.10.0--r45hdfd78af_0": "sha256:8528065a44a2b5b5cce3e2fa87d707c8b5db9f92a1d3cbf080ae86cd5e94328e"}, "tags": {"1.0.2--r43hdfd78af_0": "sha256:6373d3dfb8af3b817df178ecffc8cf182cfb527da7a1aa12d472b9f0428b65fd", "1.2.0--r43hdfd78af_0": "sha256:08c678a4a915fb5ba425a2a19e3a6689207193125fcaf6cace3c232f43e6e15c", "1.6.0--r44hdfd78af_0": "sha256:50f03233e2aac11663a0a4110fe6ed4228b11532c78a8ab3875d758271a9b6b5", "1.10.0--r45hdfd78af_0": "sha256:8528065a44a2b5b5cce3e2fa87d707c8b5db9f92a1d3cbf080ae86cd5e94328e"}, "docker": "quay.io/biocontainers/bioconductor-ctdata", "aliases": {"hb-info": "/usr/local/bin/hb-info", "tjbench": "/usr/local/bin/tjbench", "2to3-3.11": "/usr/local/bin/2to3-3.11", "idle3.11": "/usr/local/bin/idle3.11", "pydoc3.11": "/usr/local/bin/pydoc3.11", "python3.11": "/usr/local/bin/python3.11", "python3.11-config": "/usr/local/bin/python3.11-config", "installBiocDataPackage.sh": "/usr/local/bin/installBiocDataPackage.sh", "tomlq": "/usr/local/bin/tomlq", "xq": "/usr/local/bin/xq", "yq": "/usr/local/bin/yq", "jq": "/usr/local/bin/jq", "onig-config": "/usr/local/bin/onig-config", "activate-global-python-argcomplete": "/usr/local/bin/activate-global-python-argcomplete", "python-argcomplete-check-easy-install-script": "/usr/local/bin/python-argcomplete-check-easy-install-script", "register-python-argcomplete": "/usr/local/bin/register-python-argcomplete", "pandoc": "/usr/local/bin/pandoc", "python3.1": "/usr/local/bin/python3.1"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/bioconductor-ctdata.
singularity registry hpc automated addition for bioconductor-ctdata
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/bioconductor-ctdata
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-ctdata:1.10.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ctdata/1.10.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ctdata/1.10.0--r45hdfd78af_0
```
...
#### bioconductor-ctdata-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-ctdata-inspect-deffile:
