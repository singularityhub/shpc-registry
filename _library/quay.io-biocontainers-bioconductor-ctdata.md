...
updated_at: "2025-02-25 03:11:15.106215"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ctdata:1.6.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ctdata/1.6.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ctdata/1.6.0--r44hdfd78af_0
```
