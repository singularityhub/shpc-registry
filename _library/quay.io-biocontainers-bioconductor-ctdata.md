...
updated_at: "2024-11-05 03:26:10.288350"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ctdata:1.2.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ctdata/1.2.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ctdata/1.2.0--r43hdfd78af_0
```
