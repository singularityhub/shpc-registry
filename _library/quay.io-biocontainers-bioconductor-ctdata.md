...
updated_at: "2023-07-25 02:54:26.740600"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ctdata:1.0.2--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ctdata/1.0.2--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ctdata/1.0.2--r43hdfd78af_0
```
