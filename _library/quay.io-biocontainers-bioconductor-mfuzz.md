...
updated_at: "2026-03-19 04:38:50.269264"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mfuzz:2.70.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mfuzz/2.70.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-mfuzz/2.70.0--r45hdfd78af_0
```
