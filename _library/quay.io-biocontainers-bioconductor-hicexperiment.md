...
updated_at: "2023-08-24 03:28:07.522333"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hicexperiment:1.0.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hicexperiment/1.0.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-hicexperiment/1.0.0--r43hdfd78af_0
```
