---
layout: container
name:  "quay.io/biocontainers/bioconductor-hicexperiment"
maintainer: "@vsoch"
...
updated_at: "2024-06-03 02:52:00.090289"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hicexperiment
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-hicexperiment:1.2.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hicexperiment/1.2.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-hicexperiment/1.2.0--r43hdfd78af_0
```
...
#### bioconductor-hicexperiment-run:
...
#### bioconductor-hicexperiment-shell:
...
#### bioconductor-hicexperiment-exec:
...
#### bioconductor-hicexperiment-inspect:
...
#### bioconductor-hicexperiment-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-hicexperiment-inspect-deffile:
