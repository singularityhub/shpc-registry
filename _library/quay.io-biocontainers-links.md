...
updated_at: "2026-04-01 04:54:21.857792"
...
```bash
$ shpc install quay.io/biocontainers/links:2.0.1--hd63eeec_8
```
...
```bash
$ module load quay.io/biocontainers/links/2.0.1--hd63eeec_8
$ module help quay.io/biocontainers/links/2.0.1--hd63eeec_8
```
