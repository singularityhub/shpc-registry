...
updated_at: "2025-10-18 03:32:07.120143"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mbecs:1.10.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mbecs/1.10.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-mbecs/1.10.0--r44hdfd78af_0
```
