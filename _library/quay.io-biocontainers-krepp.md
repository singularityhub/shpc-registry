...
updated_at: "2026-05-28 16:06:49.993085"
latest: "0.8.0--h6675a95_0"
...
```bash
$ shpc install quay.io/biocontainers/krepp:0.8.0--h6675a95_0
```
...
```bash
$ module load quay.io/biocontainers/krepp/0.8.0--h6675a95_0
$ module help quay.io/biocontainers/krepp/0.8.0--h6675a95_0
```
