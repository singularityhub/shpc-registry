...
updated_at: "2026-04-04 04:50:36.876295"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mu19ksubb.db:3.13.0--r45hdfd78af_6
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mu19ksubb.db/3.13.0--r45hdfd78af_6
$ module help quay.io/biocontainers/bioconductor-mu19ksubb.db/3.13.0--r45hdfd78af_6
```
