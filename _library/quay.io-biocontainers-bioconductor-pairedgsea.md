...
updated_at: "2023-08-11 02:41:30.151553"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-pairedgsea:1.0.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-pairedgsea/1.0.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-pairedgsea/1.0.0--r43hdfd78af_0
```
