...
updated_at: "2025-01-24 03:23:20.643189"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-pairedgsea:1.2.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-pairedgsea/1.2.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-pairedgsea/1.2.0--r43hdfd78af_0
```
