...
updated_at: "2025-11-03 03:57:59.247369"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-pairedgsea:1.6.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-pairedgsea/1.6.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-pairedgsea/1.6.0--r44hdfd78af_0
```
