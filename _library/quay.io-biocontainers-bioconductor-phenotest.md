...
updated_at: "2023-09-09 02:25:17.581101"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-phenotest:1.48.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-phenotest/1.48.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-phenotest/1.48.0--r43hdfd78af_0
```
