...
updated_at: "2022-10-29 05:44:15.240554"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-phenotest:1.42.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-phenotest/1.42.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-phenotest/1.42.0--r41hdfd78af_0
```
