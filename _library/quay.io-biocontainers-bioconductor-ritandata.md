...
updated_at: "2024-12-17 03:27:51.867730"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ritandata:1.26.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ritandata/1.26.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ritandata/1.26.0--r43hdfd78af_0
```
