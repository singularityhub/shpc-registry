...
updated_at: "2026-03-08 04:38:40.223229"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ritandata:1.34.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ritandata/1.34.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ritandata/1.34.0--r45hdfd78af_0
```
