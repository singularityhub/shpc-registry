...
updated_at: "2026-01-15 04:31:26.368809"
...
```bash
$ shpc install quay.io/biocontainers/macsyfinder:2.1.6--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/macsyfinder/2.1.6--pyhdfd78af_0
$ module help quay.io/biocontainers/macsyfinder/2.1.6--pyhdfd78af_0
```
