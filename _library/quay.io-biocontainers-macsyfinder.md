...
updated_at: "2025-12-05 04:08:31.412720"
...
```bash
$ shpc install quay.io/biocontainers/macsyfinder:2.1.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/macsyfinder/2.1.5--pyhdfd78af_0
$ module help quay.io/biocontainers/macsyfinder/2.1.5--pyhdfd78af_0
```
