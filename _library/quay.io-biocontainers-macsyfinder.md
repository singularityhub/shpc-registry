...
updated_at: "2023-11-30 02:53:28.289895"
latest: "2.1.2--pyh7cba7a3_0"
...
```bash
$ shpc install quay.io/biocontainers/macsyfinder:2.1.2--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/macsyfinder/2.1.2--pyh7cba7a3_0
$ module help quay.io/biocontainers/macsyfinder/2.1.2--pyh7cba7a3_0
```
