...
updated_at: "2026-05-30 06:32:09.048048"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-breastcancertransbig:1.48.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-breastcancertransbig/1.48.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-breastcancertransbig/1.48.0--r45hdfd78af_0
```
