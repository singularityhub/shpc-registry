...
updated_at: "2026-03-28 04:40:11.359785"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mudata:1.14.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mudata/1.14.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-mudata/1.14.0--r45hdfd78af_0
```
