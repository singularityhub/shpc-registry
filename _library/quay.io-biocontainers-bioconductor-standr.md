...
updated_at: "2026-03-25 05:17:07.007598"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-standr:1.14.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-standr/1.14.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-standr/1.14.0--r45hdfd78af_0
```
