...
updated_at: "2022-10-29 05:55:55.324457"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-biocdockermanager:1.6.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-biocdockermanager/1.6.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-biocdockermanager/1.6.0--r41hdfd78af_0
```
