...
updated_at: "2025-09-18 03:32:36.797109"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hgu133plus2cellscore:1.26.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hgu133plus2cellscore/1.26.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-hgu133plus2cellscore/1.26.0--r44hdfd78af_0
```
