...
updated_at: "2025-08-26 03:41:35.864555"
latest: "1.3.5--h5ca1c30_3"
...
```bash
$ shpc install quay.io/biocontainers/bifrost:1.3.5--h5ca1c30_3
```
...
```bash
$ module load quay.io/biocontainers/bifrost/1.3.5--h5ca1c30_3
$ module help quay.io/biocontainers/bifrost/1.3.5--h5ca1c30_3
```
