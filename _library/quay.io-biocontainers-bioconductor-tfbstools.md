...
updated_at: "2023-09-09 02:25:28.000285"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-tfbstools:1.38.0--r43ha9d7317_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-tfbstools/1.38.0--r43ha9d7317_0
$ module help quay.io/biocontainers/bioconductor-tfbstools/1.38.0--r43ha9d7317_0
```
