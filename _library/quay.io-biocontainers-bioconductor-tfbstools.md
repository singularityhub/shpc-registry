...
updated_at: "2024-01-16 02:43:14.083054"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-tfbstools:1.40.0--r43ha9d7317_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-tfbstools/1.40.0--r43ha9d7317_0
$ module help quay.io/biocontainers/bioconductor-tfbstools/1.40.0--r43ha9d7317_0
```
