---
layout: container
name:  "quay.io/biocontainers/quick-variants"
maintainer: "@vsoch"
...
updated_at: "2026-01-08 03:46:51.616348"
...
singularity registry hpc automated addition for quick-variants
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/quick-variants
```
...
#### quick-variants-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### quick-variants-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/quick-variants
$ podman run --it --rm --entrypoint /usr/local/bin/quick-variants   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/quick-variants   -v ${PWD} -w ${PWD} <container> -c " $@"
```
