...
updated_at: "2026-03-05 04:22:28.966657"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gsca:2.40.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gsca/2.40.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-gsca/2.40.0--r45hdfd78af_0
```
