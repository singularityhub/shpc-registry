...
updated_at: "2025-01-19 03:19:10.131298"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gsca:2.36.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gsca/2.36.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-gsca/2.36.0--r44hdfd78af_0
```
