---
layout: container
name:  "quay.io/biocontainers/r-flanders"
maintainer: "@vsoch"
...
updated_at: "2025-12-28 03:57:50.624175"
...
singularity registry hpc automated addition for r-flanders
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/r-flanders
```
...
#### r-flanders-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-flanders-inspect-deffile:
