...
updated_at: "2025-02-13 03:09:17.768198"
latest: "2.2.0--py39h0699b22_0"
...
```bash
$ shpc install quay.io/biocontainers/pyfastx:2.2.0--py39h0699b22_0
```
...
```bash
$ module load quay.io/biocontainers/pyfastx/2.2.0--py39h0699b22_0
$ module help quay.io/biocontainers/pyfastx/2.2.0--py39h0699b22_0
```
