...
updated_at: "2026-03-24 04:42:29.550161"
latest: "2.3.0--py311hbd8efe9_2"
...
```bash
$ shpc install quay.io/biocontainers/pyfastx:2.3.0--py311hbd8efe9_2
```
...
```bash
$ module load quay.io/biocontainers/pyfastx/2.3.0--py311hbd8efe9_2
$ module help quay.io/biocontainers/pyfastx/2.3.0--py311hbd8efe9_2
```
