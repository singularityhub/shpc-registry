...
updated_at: "2026-01-21 04:10:22.508740"
...
```bash
$ shpc install quay.io/biocontainers/iphop:1.4.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/iphop/1.4.2--pyhdfd78af_0
$ module help quay.io/biocontainers/iphop/1.4.2--pyhdfd78af_0
```
