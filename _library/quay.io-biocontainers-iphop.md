...
updated_at: "2023-06-12 05:09:04.094624"
...
```bash
$ shpc install quay.io/biocontainers/iphop:1.3.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/iphop/1.3.1--pyhdfd78af_0
$ module help quay.io/biocontainers/iphop/1.3.1--pyhdfd78af_0
```
