...
updated_at: "2023-04-21 02:40:01.693420"
...
```bash
$ shpc install quay.io/biocontainers/iphop:1.3.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/iphop/1.3.0--pyhdfd78af_0
$ module help quay.io/biocontainers/iphop/1.3.0--pyhdfd78af_0
```
