...
updated_at: "2023-10-18 02:48:53.333374"
...
```bash
$ shpc install quay.io/biocontainers/iphop:1.3.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/iphop/1.3.2--pyhdfd78af_0
$ module help quay.io/biocontainers/iphop/1.3.2--pyhdfd78af_0
```
