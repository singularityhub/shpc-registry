...
updated_at: "2024-11-16 03:43:13.050810"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-metaneighbor:1.22.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-metaneighbor/1.22.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-metaneighbor/1.22.0--r43hdfd78af_0
```
