...
updated_at: "2025-02-26 03:20:38.252771"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-metaneighbor:1.26.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-metaneighbor/1.26.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-metaneighbor/1.26.0--r44hdfd78af_0
```
