...
updated_at: "2022-11-21 13:43:16.160928"
...
```bash
$ shpc install quay.io/biocontainers/bioconvert:0.6.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconvert/0.6.1--pyhdfd78af_0
$ module help quay.io/biocontainers/bioconvert/0.6.1--pyhdfd78af_0
```
