...
updated_at: "2023-04-10 02:55:05.646001"
latest: "1.0.0.post0--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconvert:1.0.0.post0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconvert/1.0.0.post0--pyhdfd78af_0
$ module help quay.io/biocontainers/bioconvert/1.0.0.post0--pyhdfd78af_0
```
