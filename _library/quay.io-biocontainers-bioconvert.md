...
updated_at: "2026-06-24 06:49:42.991180"
...
```bash
$ shpc install quay.io/biocontainers/bioconvert:1.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconvert/1.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/bioconvert/1.2.0--pyhdfd78af_0
```
