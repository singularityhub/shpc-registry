...
updated_at: "2023-07-31 02:50:44.321629"
...
```bash
$ shpc install quay.io/biocontainers/bioconvert:1.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconvert/1.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/bioconvert/1.1.0--pyhdfd78af_0
```
