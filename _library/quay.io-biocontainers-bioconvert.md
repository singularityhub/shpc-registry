...
updated_at: "2025-08-02 03:41:59.169182"
...
```bash
$ shpc install quay.io/biocontainers/bioconvert:1.1.1--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/bioconvert/1.1.1--pyhdfd78af_1
$ module help quay.io/biocontainers/bioconvert/1.1.1--pyhdfd78af_1
```
