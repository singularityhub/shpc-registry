...
updated_at: "2024-10-16 03:08:34.211927"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-myvariant:1.32.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-myvariant/1.32.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-myvariant/1.32.0--r43hdfd78af_0
```
