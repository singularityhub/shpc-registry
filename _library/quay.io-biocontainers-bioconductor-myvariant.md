...
updated_at: "2023-10-04 04:48:16.730847"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-myvariant:1.30.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-myvariant/1.30.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-myvariant/1.30.0--r43hdfd78af_0
```
