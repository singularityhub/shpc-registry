...
updated_at: "2023-12-04 02:35:19.338320"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ecoli2probe:2.18.0--r43hdfd78af_11
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ecoli2probe/2.18.0--r43hdfd78af_11
$ module help quay.io/biocontainers/bioconductor-ecoli2probe/2.18.0--r43hdfd78af_11
```
