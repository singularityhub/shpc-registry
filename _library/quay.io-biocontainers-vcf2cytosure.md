...
updated_at: "2026-09-03 07:24:48.407129"
latest: "0.10.0--pyh106432d_0"
...
```bash
$ shpc install quay.io/biocontainers/vcf2cytosure:0.10.0--pyh106432d_0
```
...
```bash
$ module load quay.io/biocontainers/vcf2cytosure/0.10.0--pyh106432d_0
$ module help quay.io/biocontainers/vcf2cytosure/0.10.0--pyh106432d_0
```
