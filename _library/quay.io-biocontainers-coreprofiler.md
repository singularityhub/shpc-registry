...
updated_at: "2025-08-12 04:06:34.142179"
...
```bash
$ shpc install quay.io/biocontainers/coreprofiler:1.1.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/coreprofiler/1.1.3--pyhdfd78af_0
$ module help quay.io/biocontainers/coreprofiler/1.1.3--pyhdfd78af_0
```
