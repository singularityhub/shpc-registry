...
updated_at: "2025-11-14 04:40:12.469038"
...
```bash
$ shpc install quay.io/biocontainers/coreprofiler:1.1.6--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/coreprofiler/1.1.6--pyhdfd78af_0
$ module help quay.io/biocontainers/coreprofiler/1.1.6--pyhdfd78af_0
```
