...
updated_at: "2025-07-27 04:34:27.578582"
...
```bash
$ shpc install quay.io/biocontainers/coreprofiler:1.1.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/coreprofiler/1.1.1--pyhdfd78af_0
$ module help quay.io/biocontainers/coreprofiler/1.1.1--pyhdfd78af_0
```
