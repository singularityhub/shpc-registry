...
updated_at: "2025-12-07 03:44:24.880623"
latest: "1.1.8--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/coreprofiler:1.1.8--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/coreprofiler/1.1.8--pyhdfd78af_0
$ module help quay.io/biocontainers/coreprofiler/1.1.8--pyhdfd78af_0
```
