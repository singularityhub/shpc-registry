...
updated_at: "2026-01-03 03:30:23.926957"
...
```bash
$ shpc install quay.io/biocontainers/coreprofiler:2.0.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/coreprofiler/2.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/coreprofiler/2.0.0--pyhdfd78af_0
```
