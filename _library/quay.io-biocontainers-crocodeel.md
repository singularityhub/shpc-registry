...
updated_at: "2026-01-19 03:58:26.095061"
...
```bash
$ shpc install quay.io/biocontainers/crocodeel:1.0.8--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/crocodeel/1.0.8--pyhdfd78af_0
$ module help quay.io/biocontainers/crocodeel/1.0.8--pyhdfd78af_0
```
