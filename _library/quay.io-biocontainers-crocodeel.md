...
updated_at: "2025-08-05 03:59:54.814047"
...
```bash
$ shpc install quay.io/biocontainers/crocodeel:1.0.7--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/crocodeel/1.0.7--pyhdfd78af_0
$ module help quay.io/biocontainers/crocodeel/1.0.7--pyhdfd78af_0
```
