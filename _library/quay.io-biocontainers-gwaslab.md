...
updated_at: "2026-09-19 07:34:50.131906"
...
```bash
$ shpc install quay.io/biocontainers/gwaslab:4.2.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/gwaslab/4.2.2--pyhdfd78af_0
$ module help quay.io/biocontainers/gwaslab/4.2.2--pyhdfd78af_0
```
