...
updated_at: "2026-04-19 05:26:59.317140"
...
```bash
$ shpc install quay.io/biocontainers/gwaslab:4.1.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/gwaslab/4.1.5--pyhdfd78af_0
$ module help quay.io/biocontainers/gwaslab/4.1.5--pyhdfd78af_0
```
