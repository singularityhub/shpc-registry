...
updated_at: "2026-09-02 07:24:22.805654"
...
```bash
$ shpc install quay.io/biocontainers/gwaslab:4.2.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/gwaslab/4.2.1--pyhdfd78af_0
$ module help quay.io/biocontainers/gwaslab/4.2.1--pyhdfd78af_0
```
