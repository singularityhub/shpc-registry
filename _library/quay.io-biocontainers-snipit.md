...
updated_at: "2026-02-07 04:34:11.246883"
...
```bash
$ shpc install quay.io/biocontainers/snipit:1.7--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snipit/1.7--pyhdfd78af_0
$ module help quay.io/biocontainers/snipit/1.7--pyhdfd78af_0
```
