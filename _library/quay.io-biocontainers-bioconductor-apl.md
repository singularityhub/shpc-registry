...
updated_at: "2023-06-23 03:47:26.119239"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-apl:1.2.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-apl/1.2.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-apl/1.2.0--r42hdfd78af_0
```
