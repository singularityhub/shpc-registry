...
updated_at: "2025-01-09 03:38:52.758166"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rificomparative:1.6.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rificomparative/1.6.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rificomparative/1.6.0--r44hdfd78af_0
```
