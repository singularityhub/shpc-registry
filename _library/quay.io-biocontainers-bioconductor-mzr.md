...
updated_at: "2023-07-27 05:19:32.698985"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mzr:2.34.1--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mzr/2.34.1--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-mzr/2.34.1--r43hf17093f_0
```
