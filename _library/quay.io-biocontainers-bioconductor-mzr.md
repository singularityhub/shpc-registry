...
updated_at: "2024-05-09 03:08:03.641774"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mzr:2.36.0--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mzr/2.36.0--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-mzr/2.36.0--r43hf17093f_0
```
