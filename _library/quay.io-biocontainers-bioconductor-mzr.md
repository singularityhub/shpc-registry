...
updated_at: "2024-08-25 03:04:31.697736"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mzr:2.36.0--r43hf17093f_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mzr/2.36.0--r43hf17093f_1
$ module help quay.io/biocontainers/bioconductor-mzr/2.36.0--r43hf17093f_1
```
