...
updated_at: "2023-04-30 03:13:32.391861"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-sqldataframe:1.12.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-sqldataframe/1.12.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-sqldataframe/1.12.0--r42hdfd78af_0
```
