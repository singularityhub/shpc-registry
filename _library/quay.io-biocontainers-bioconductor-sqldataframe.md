...
updated_at: "2022-10-29 05:54:28.490147"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-sqldataframe:1.8.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-sqldataframe/1.8.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-sqldataframe/1.8.0--r41hdfd78af_0
```
