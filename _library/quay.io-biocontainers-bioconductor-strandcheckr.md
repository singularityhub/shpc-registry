...
updated_at: "2026-03-28 04:56:24.765646"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-strandcheckr:1.28.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-strandcheckr/1.28.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-strandcheckr/1.28.0--r45hdfd78af_0
```
