...
updated_at: "2025-12-29 04:10:35.261088"
latest: "2.8.11--r44hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/r-ampvis2:2.8.11--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/r-ampvis2/2.8.11--r44hdfd78af_0
$ module help quay.io/biocontainers/r-ampvis2/2.8.11--r44hdfd78af_0
```
