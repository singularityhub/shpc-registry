...
updated_at: "2025-11-06 03:34:55.263863"
latest: "2.8.10--r44hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/r-ampvis2:2.8.10--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/r-ampvis2/2.8.10--r44hdfd78af_0
$ module help quay.io/biocontainers/r-ampvis2/2.8.10--r44hdfd78af_0
```
