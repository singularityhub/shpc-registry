...
updated_at: "2024-04-08 03:07:27.242470"
latest: "2.8.6--r43hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/r-ampvis2:2.8.6--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/r-ampvis2/2.8.6--r43hdfd78af_0
$ module help quay.io/biocontainers/r-ampvis2/2.8.6--r43hdfd78af_0
```
