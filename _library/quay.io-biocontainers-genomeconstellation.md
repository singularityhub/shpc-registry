...
updated_at: "2025-11-10 03:46:43.454434"
latest: "0.21.1--h077b44d_7"
...
```bash
$ shpc install quay.io/biocontainers/genomeconstellation:0.21.1--h077b44d_7
```
...
```bash
$ module load quay.io/biocontainers/genomeconstellation/0.21.1--h077b44d_7
$ module help quay.io/biocontainers/genomeconstellation/0.21.1--h077b44d_7
```
