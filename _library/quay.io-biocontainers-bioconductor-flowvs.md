...
updated_at: "2022-11-03 01:25:16.225603"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-flowvs:1.26.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-flowvs/1.26.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-flowvs/1.26.0--r41hdfd78af_0
```
