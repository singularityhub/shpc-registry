...
updated_at: "2025-11-14 04:43:59.161681"
latest: "4.04--pl5321h9948957_0"
...
```bash
$ shpc install quay.io/biocontainers/perl-json-xs:4.04--pl5321h9948957_0
```
...
```bash
$ module load quay.io/biocontainers/perl-json-xs/4.04--pl5321h9948957_0
$ module help quay.io/biocontainers/perl-json-xs/4.04--pl5321h9948957_0
```
