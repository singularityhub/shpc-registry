...
updated_at: "2023-07-21 02:51:05.263787"
latest: "4.03--pl5321h4ac6f70_2"
...
```bash
$ shpc install quay.io/biocontainers/perl-json-xs:4.03--pl5321h4ac6f70_2
```
...
```bash
$ module load quay.io/biocontainers/perl-json-xs/4.03--pl5321h4ac6f70_2
$ module help quay.io/biocontainers/perl-json-xs/4.03--pl5321h4ac6f70_2
```
