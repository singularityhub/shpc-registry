...
updated_at: "2026-01-31 04:30:25.922320"
...
```bash
$ shpc install quay.io/biocontainers/squirrel:1.3.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/squirrel/1.3.1--pyhdfd78af_0
$ module help quay.io/biocontainers/squirrel/1.3.1--pyhdfd78af_0
```
