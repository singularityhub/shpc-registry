...
updated_at: "2024-11-05 03:06:57.729408"
...
```bash
$ shpc install quay.io/biocontainers/squirrel:1.0.11--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/squirrel/1.0.11--pyhdfd78af_0
$ module help quay.io/biocontainers/squirrel/1.0.11--pyhdfd78af_0
```
