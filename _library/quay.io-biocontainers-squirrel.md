...
updated_at: "2024-12-13 03:22:16.149078"
...
```bash
$ shpc install quay.io/biocontainers/squirrel:1.0.12--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/squirrel/1.0.12--pyhdfd78af_0
$ module help quay.io/biocontainers/squirrel/1.0.12--pyhdfd78af_0
```
