...
updated_at: "2025-05-03 03:15:00.789718"
...
```bash
$ shpc install quay.io/biocontainers/squirrel:1.1.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/squirrel/1.1.2--pyhdfd78af_0
$ module help quay.io/biocontainers/squirrel/1.1.2--pyhdfd78af_0
```
