...
updated_at: "2025-07-26 03:52:01.596410"
latest: "1.1.7--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/squirrel:1.1.7--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/squirrel/1.1.7--pyhdfd78af_0
$ module help quay.io/biocontainers/squirrel/1.1.7--pyhdfd78af_0
```
