...
updated_at: "2025-03-03 03:27:51.204119"
...
```bash
$ shpc install quay.io/biocontainers/squirrel:1.0.13--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/squirrel/1.0.13--pyhdfd78af_0
$ module help quay.io/biocontainers/squirrel/1.0.13--pyhdfd78af_0
```
