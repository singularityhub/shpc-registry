...
updated_at: "2026-04-05 05:16:21.470621"
...
```bash
$ shpc install quay.io/biocontainers/squirrel:1.3.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/squirrel/1.3.2--pyhdfd78af_0
$ module help quay.io/biocontainers/squirrel/1.3.2--pyhdfd78af_0
```
