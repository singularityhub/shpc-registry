...
updated_at: "2024-04-17 02:37:53.391679"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-scdesign3:1.0.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-scdesign3/1.0.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-scdesign3/1.0.0--r43hdfd78af_0
```
