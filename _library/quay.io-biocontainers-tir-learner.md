...
updated_at: "2024-11-23 02:59:05.131066"
...
```bash
$ shpc install quay.io/biocontainers/tir-learner:3.0.3--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/tir-learner/3.0.3--hdfd78af_0
$ module help quay.io/biocontainers/tir-learner/3.0.3--hdfd78af_0
```
