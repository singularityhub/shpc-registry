...
updated_at: "2025-02-12 03:38:06.396408"
...
```bash
$ shpc install quay.io/biocontainers/tir-learner:3.0.5--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/tir-learner/3.0.5--hdfd78af_0
$ module help quay.io/biocontainers/tir-learner/3.0.5--hdfd78af_0
```
