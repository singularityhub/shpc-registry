...
updated_at: "2024-08-13 03:24:33.074713"
...
```bash
$ shpc install quay.io/biocontainers/ont-modkit:0.3.1--h5c23e0d_1
```
...
```bash
$ module load quay.io/biocontainers/ont-modkit/0.3.1--h5c23e0d_1
$ module help quay.io/biocontainers/ont-modkit/0.3.1--h5c23e0d_1
```
