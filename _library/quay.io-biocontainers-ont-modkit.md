...
updated_at: "2025-08-03 04:26:36.874850"
latest: "0.5.0--hcdda2d0_0"
...
```bash
$ shpc install quay.io/biocontainers/ont-modkit:0.5.0--hcdda2d0_0
```
...
```bash
$ module load quay.io/biocontainers/ont-modkit/0.5.0--hcdda2d0_0
$ module help quay.io/biocontainers/ont-modkit/0.5.0--hcdda2d0_0
```
