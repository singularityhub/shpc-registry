...
updated_at: "2023-11-26 02:57:49.562016"
latest: "0.2.2--hdcf5f25_0"
...
```bash
$ shpc install quay.io/biocontainers/ont-modkit:0.2.2--hdcf5f25_0
```
...
```bash
$ module load quay.io/biocontainers/ont-modkit/0.2.2--hdcf5f25_0
$ module help quay.io/biocontainers/ont-modkit/0.2.2--hdcf5f25_0
```
