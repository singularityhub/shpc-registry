...
updated_at: "2025-01-02 02:54:29.623124"
latest: "0.4.1--hcdda2d0_1"
...
```bash
$ shpc install quay.io/biocontainers/ont-modkit:0.4.1--hcdda2d0_1
```
...
```bash
$ module load quay.io/biocontainers/ont-modkit/0.4.1--hcdda2d0_1
$ module help quay.io/biocontainers/ont-modkit/0.4.1--hcdda2d0_1
```
