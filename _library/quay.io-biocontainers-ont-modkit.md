...
updated_at: "2025-12-04 04:11:46.010911"
latest: "0.5.0--hcdda2d0_2"
...
```bash
$ shpc install quay.io/biocontainers/ont-modkit:0.5.0--hcdda2d0_2
```
...
```bash
$ module load quay.io/biocontainers/ont-modkit/0.5.0--hcdda2d0_2
$ module help quay.io/biocontainers/ont-modkit/0.5.0--hcdda2d0_2
```
