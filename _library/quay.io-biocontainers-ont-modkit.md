...
updated_at: "2026-01-29 05:00:33.992314"
latest: "0.6.1--hcdda2d0_0"
...
```bash
$ shpc install quay.io/biocontainers/ont-modkit:0.6.1--hcdda2d0_0
```
...
```bash
$ module load quay.io/biocontainers/ont-modkit/0.6.1--hcdda2d0_0
$ module help quay.io/biocontainers/ont-modkit/0.6.1--hcdda2d0_0
```
