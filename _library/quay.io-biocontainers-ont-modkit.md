...
updated_at: "2025-08-26 03:36:49.752755"
latest: "0.5.0--hcdda2d0_1"
...
```bash
$ shpc install quay.io/biocontainers/ont-modkit:0.5.0--hcdda2d0_1
```
...
```bash
$ module load quay.io/biocontainers/ont-modkit/0.5.0--hcdda2d0_1
$ module help quay.io/biocontainers/ont-modkit/0.5.0--hcdda2d0_1
```
