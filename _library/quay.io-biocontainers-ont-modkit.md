...
updated_at: "2026-01-11 04:42:00.804286"
latest: "0.6.0--hcdda2d0_0"
...
```bash
$ shpc install quay.io/biocontainers/ont-modkit:0.6.0--hcdda2d0_0
```
...
```bash
$ module load quay.io/biocontainers/ont-modkit/0.6.0--hcdda2d0_0
$ module help quay.io/biocontainers/ont-modkit/0.6.0--hcdda2d0_0
```
