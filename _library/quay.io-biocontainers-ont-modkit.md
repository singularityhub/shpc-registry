...
updated_at: "2024-04-28 02:52:01.274448"
latest: "0.2.7--hdcf5f25_0"
...
```bash
$ shpc install quay.io/biocontainers/ont-modkit:0.2.7--hdcf5f25_0
```
...
```bash
$ module load quay.io/biocontainers/ont-modkit/0.2.7--hdcf5f25_0
$ module help quay.io/biocontainers/ont-modkit/0.2.7--hdcf5f25_0
```
