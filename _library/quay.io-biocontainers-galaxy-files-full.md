...
updated_at: "2026-09-04 07:55:28.666269"
latest: "26.1.1--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/galaxy-files-full:26.1.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/galaxy-files-full/26.1.1--pyhdfd78af_0
$ module help quay.io/biocontainers/galaxy-files-full/26.1.1--pyhdfd78af_0
```
