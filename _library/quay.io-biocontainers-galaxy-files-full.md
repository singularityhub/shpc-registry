...
updated_at: "2026-04-05 04:51:17.358494"
...
```bash
$ shpc install quay.io/biocontainers/galaxy-files-full:25.1.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/galaxy-files-full/25.1.2--pyhdfd78af_0
$ module help quay.io/biocontainers/galaxy-files-full/25.1.2--pyhdfd78af_0
```
