...
updated_at: "2026-08-21 16:11:01.263898"
...
```bash
$ shpc install quay.io/biocontainers/galaxy-files-full:26.0.1--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/galaxy-files-full/26.0.1--pyhdfd78af_1
$ module help quay.io/biocontainers/galaxy-files-full/26.0.1--pyhdfd78af_1
```
