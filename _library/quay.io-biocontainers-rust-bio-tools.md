...
updated_at: "2025-10-01 03:40:03.881473"
latest: "0.42.2--h5c46d4b_3"
...
```bash
$ shpc install quay.io/biocontainers/rust-bio-tools:0.42.2--h5c46d4b_3
```
...
```bash
$ module load quay.io/biocontainers/rust-bio-tools/0.42.2--h5c46d4b_3
$ module help quay.io/biocontainers/rust-bio-tools/0.42.2--h5c46d4b_3
```
