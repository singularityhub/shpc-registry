...
updated_at: "2023-05-29 03:54:37.561653"
...
```bash
$ shpc install quay.io/biocontainers/vembrane:1.0.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/vembrane/1.0.1--pyhdfd78af_0
$ module help quay.io/biocontainers/vembrane/1.0.1--pyhdfd78af_0
```
