...
updated_at: "2023-05-17 02:48:07.821588"
...
```bash
$ shpc install quay.io/biocontainers/vembrane:1.0.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/vembrane/1.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/vembrane/1.0.0--pyhdfd78af_0
```
