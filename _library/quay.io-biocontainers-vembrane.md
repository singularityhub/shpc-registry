...
updated_at: "2025-07-29 04:43:22.207856"
...
```bash
$ shpc install quay.io/biocontainers/vembrane:2.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/vembrane/2.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/vembrane/2.1.0--pyhdfd78af_0
```
