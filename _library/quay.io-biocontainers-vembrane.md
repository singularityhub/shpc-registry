...
updated_at: "2024-08-23 02:47:16.934788"
...
```bash
$ shpc install quay.io/biocontainers/vembrane:1.0.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/vembrane/1.0.5--pyhdfd78af_0
$ module help quay.io/biocontainers/vembrane/1.0.5--pyhdfd78af_0
```
