...
updated_at: "2023-08-13 02:43:17.026717"
...
```bash
$ shpc install quay.io/biocontainers/vembrane:1.0.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/vembrane/1.0.2--pyhdfd78af_0
$ module help quay.io/biocontainers/vembrane/1.0.2--pyhdfd78af_0
```
