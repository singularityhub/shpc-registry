...
updated_at: "2026-01-21 04:03:35.829655"
...
```bash
$ shpc install quay.io/biocontainers/vembrane:2.4.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/vembrane/2.4.0--pyhdfd78af_0
$ module help quay.io/biocontainers/vembrane/2.4.0--pyhdfd78af_0
```
