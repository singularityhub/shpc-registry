...
updated_at: "2023-04-14 03:13:49.450056"
...
```bash
$ shpc install quay.io/biocontainers/vembrane:0.14.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/vembrane/0.14.0--pyhdfd78af_0
$ module help quay.io/biocontainers/vembrane/0.14.0--pyhdfd78af_0
```
