...
updated_at: "2024-02-10 02:42:36.636081"
...
```bash
$ shpc install quay.io/biocontainers/vembrane:1.0.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/vembrane/1.0.4--pyhdfd78af_0
$ module help quay.io/biocontainers/vembrane/1.0.4--pyhdfd78af_0
```
