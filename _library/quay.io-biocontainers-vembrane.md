...
updated_at: "2025-08-27 03:48:57.778335"
...
```bash
$ shpc install quay.io/biocontainers/vembrane:2.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/vembrane/2.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/vembrane/2.2.0--pyhdfd78af_0
```
