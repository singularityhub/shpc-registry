...
updated_at: "2026-03-24 05:01:08.896520"
...
```bash
$ shpc install quay.io/biocontainers/vembrane:2.5.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/vembrane/2.5.0--pyhdfd78af_0
$ module help quay.io/biocontainers/vembrane/2.5.0--pyhdfd78af_0
```
