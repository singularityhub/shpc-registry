...
updated_at: "2023-11-02 03:43:40.708482"
...
```bash
$ shpc install quay.io/biocontainers/vembrane:1.0.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/vembrane/1.0.3--pyhdfd78af_0
$ module help quay.io/biocontainers/vembrane/1.0.3--pyhdfd78af_0
```
