...
updated_at: "2022-11-20 00:02:41.546778"
...
```bash
$ shpc install quay.io/biocontainers/vembrane:0.8.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/vembrane/0.8.0--pyhdfd78af_0
$ module help quay.io/biocontainers/vembrane/0.8.0--pyhdfd78af_0
```
