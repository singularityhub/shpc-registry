...
updated_at: "2025-09-30 03:15:22.698124"
...
```bash
$ shpc install quay.io/biocontainers/vembrane:2.3.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/vembrane/2.3.4--pyhdfd78af_0
$ module help quay.io/biocontainers/vembrane/2.3.4--pyhdfd78af_0
```
