...
updated_at: "2026-06-27 06:22:57.134876"
...
```bash
$ shpc install quay.io/biocontainers/vembrane:2.6.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/vembrane/2.6.0--pyhdfd78af_0
$ module help quay.io/biocontainers/vembrane/2.6.0--pyhdfd78af_0
```
