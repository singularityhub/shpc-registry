...
updated_at: "2024-09-19 03:29:20.836401"
...
```bash
$ shpc install quay.io/biocontainers/vembrane:1.0.6--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/vembrane/1.0.6--pyhdfd78af_0
$ module help quay.io/biocontainers/vembrane/1.0.6--pyhdfd78af_0
```
