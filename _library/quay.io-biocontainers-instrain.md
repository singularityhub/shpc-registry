...
updated_at: "2025-05-07 04:04:02.549545"
...
```bash
$ shpc install quay.io/biocontainers/instrain:1.9.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/instrain/1.9.1--pyhdfd78af_0
$ module help quay.io/biocontainers/instrain/1.9.1--pyhdfd78af_0
```
