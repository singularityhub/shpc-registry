...
updated_at: "2025-10-24 03:15:20.798296"
...
```bash
$ shpc install quay.io/biocontainers/instrain:1.10.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/instrain/1.10.0--pyhdfd78af_0
$ module help quay.io/biocontainers/instrain/1.10.0--pyhdfd78af_0
```
