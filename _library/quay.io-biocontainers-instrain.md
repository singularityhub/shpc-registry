...
updated_at: "2023-08-10 02:52:33.708389"
...
```bash
$ shpc install quay.io/biocontainers/instrain:1.7.6--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/instrain/1.7.6--pyhdfd78af_0
$ module help quay.io/biocontainers/instrain/1.7.6--pyhdfd78af_0
```
