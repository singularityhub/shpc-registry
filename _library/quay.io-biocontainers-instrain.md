...
updated_at: "2024-04-01 02:37:50.355952"
...
```bash
$ shpc install quay.io/biocontainers/instrain:1.8.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/instrain/1.8.0--pyhdfd78af_0
$ module help quay.io/biocontainers/instrain/1.8.0--pyhdfd78af_0
```
