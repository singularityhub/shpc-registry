...
updated_at: "2023-07-02 03:33:29.773432"
latest: "0.1.18--pyhdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/evofr:0.1.18--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/evofr/0.1.18--pyhdfd78af_1
$ module help quay.io/biocontainers/evofr/0.1.18--pyhdfd78af_1
```
