...
updated_at: "2024-12-21 03:10:47.467931"
latest: "0.1.25--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/evofr:0.1.25--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/evofr/0.1.25--pyhdfd78af_0
$ module help quay.io/biocontainers/evofr/0.1.25--pyhdfd78af_0
```
