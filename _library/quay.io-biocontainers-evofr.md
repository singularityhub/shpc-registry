...
updated_at: "2025-08-24 03:57:41.014278"
latest: "0.1.27--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/evofr:0.1.27--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/evofr/0.1.27--pyhdfd78af_0
$ module help quay.io/biocontainers/evofr/0.1.27--pyhdfd78af_0
```
