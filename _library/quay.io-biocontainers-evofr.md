...
updated_at: "2026-02-24 04:47:17.805757"
...
```bash
$ shpc install quay.io/biocontainers/evofr:0.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/evofr/0.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/evofr/0.2.0--pyhdfd78af_0
```
