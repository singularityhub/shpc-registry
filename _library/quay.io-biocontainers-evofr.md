...
updated_at: "2024-07-06 02:47:25.346993"
...
```bash
$ shpc install quay.io/biocontainers/evofr:0.1.23--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/evofr/0.1.23--pyhdfd78af_0
$ module help quay.io/biocontainers/evofr/0.1.23--pyhdfd78af_0
```
