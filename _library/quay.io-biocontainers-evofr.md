...
updated_at: "2025-05-10 03:47:57.660105"
latest: "0.1.26--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/evofr:0.1.26--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/evofr/0.1.26--pyhdfd78af_0
$ module help quay.io/biocontainers/evofr/0.1.26--pyhdfd78af_0
```
