...
updated_at: "2026-04-04 04:22:50.983730"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-varianttoolsdata:1.34.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-varianttoolsdata/1.34.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-varianttoolsdata/1.34.0--r45hdfd78af_0
```
