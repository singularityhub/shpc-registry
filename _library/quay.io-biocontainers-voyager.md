...
updated_at: "2024-12-18 03:05:21.459924"
...
```bash
$ shpc install quay.io/biocontainers/voyager:0.1.3--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/voyager/0.1.3--hdfd78af_0
$ module help quay.io/biocontainers/voyager/0.1.3--hdfd78af_0
```
