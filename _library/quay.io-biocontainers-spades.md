...
updated_at: "2025-03-23 03:46:29.411812"
latest: "4.1.0--haf24da9_0"
...
```bash
$ shpc install quay.io/biocontainers/spades:4.1.0--haf24da9_0
```
...
```bash
$ module load quay.io/biocontainers/spades/4.1.0--haf24da9_0
$ module help quay.io/biocontainers/spades/4.1.0--haf24da9_0
```
