...
updated_at: "2025-01-25 03:18:16.591977"
latest: "4.0.0--haf24da9_4"
...
```bash
$ shpc install quay.io/biocontainers/spades:4.0.0--haf24da9_4
```
...
```bash
$ module load quay.io/biocontainers/spades/4.0.0--haf24da9_4
$ module help quay.io/biocontainers/spades/4.0.0--haf24da9_4
```
