...
updated_at: "2025-11-12 03:38:53.782268"
latest: "4.2.0--h8d6e82b_2"
...
```bash
$ shpc install quay.io/biocontainers/spades:4.2.0--h8d6e82b_2
```
...
```bash
$ module load quay.io/biocontainers/spades/4.2.0--h8d6e82b_2
$ module help quay.io/biocontainers/spades/4.2.0--h8d6e82b_2
```
