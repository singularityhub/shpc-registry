...
updated_at: "2026-09-01 08:03:26.953146"
...
```bash
$ shpc install quay.io/biocontainers/spades:4.3.0--hde4eca7_1
```
...
```bash
$ module load quay.io/biocontainers/spades/4.3.0--hde4eca7_1
$ module help quay.io/biocontainers/spades/4.3.0--hde4eca7_1
```
