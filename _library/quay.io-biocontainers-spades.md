...
updated_at: "2026-07-01 15:53:47.259167"
latest: "4.3.0--hde4eca7_0"
...
```bash
$ shpc install quay.io/biocontainers/spades:4.3.0--hde4eca7_0
```
...
```bash
$ module load quay.io/biocontainers/spades/4.3.0--hde4eca7_0
$ module help quay.io/biocontainers/spades/4.3.0--hde4eca7_0
```
