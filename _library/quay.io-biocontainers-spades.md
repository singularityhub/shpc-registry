...
updated_at: "2025-09-21 03:45:28.864411"
latest: "4.2.0--h8d6e82b_1"
...
```bash
$ shpc install quay.io/biocontainers/spades:4.2.0--h8d6e82b_1
```
...
```bash
$ module load quay.io/biocontainers/spades/4.2.0--h8d6e82b_1
$ module help quay.io/biocontainers/spades/4.2.0--h8d6e82b_1
```
