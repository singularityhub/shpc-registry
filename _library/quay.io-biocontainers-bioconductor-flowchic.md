...
updated_at: "2024-07-01 03:19:02.420231"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-flowchic:1.36.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-flowchic/1.36.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-flowchic/1.36.0--r43hdfd78af_0
```
