...
updated_at: "2022-11-26 00:33:52.236413"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-flowchic:1.28.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-flowchic/1.28.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-flowchic/1.28.0--r41hdfd78af_0
```
