...
updated_at: "2026-01-20 04:12:23.993378"
latest: "1.24.0--r44h77050f0_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rmmquant:1.24.0--r44h77050f0_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rmmquant/1.24.0--r44h77050f0_0
$ module help quay.io/biocontainers/bioconductor-rmmquant/1.24.0--r44h77050f0_0
```
