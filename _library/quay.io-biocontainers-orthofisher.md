...
updated_at: "2026-04-03 05:18:56.977997"
...
```bash
$ shpc install quay.io/biocontainers/orthofisher:1.1.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/orthofisher/1.1.2--pyhdfd78af_0
$ module help quay.io/biocontainers/orthofisher/1.1.2--pyhdfd78af_0
```
