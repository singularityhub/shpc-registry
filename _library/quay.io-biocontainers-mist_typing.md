...
updated_at: "2026-09-05 07:22:35.480081"
...
```bash
$ shpc install quay.io/biocontainers/mist_typing:1.4.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mist_typing/1.4.0--pyhdfd78af_0
$ module help quay.io/biocontainers/mist_typing/1.4.0--pyhdfd78af_0
```
