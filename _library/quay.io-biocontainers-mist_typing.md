...
updated_at: "2025-10-06 03:41:47.838457"
...
```bash
$ shpc install quay.io/biocontainers/mist_typing:0.0.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mist_typing/0.0.3--pyhdfd78af_0
$ module help quay.io/biocontainers/mist_typing/0.0.3--pyhdfd78af_0
```
