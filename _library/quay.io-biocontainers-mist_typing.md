...
updated_at: "2025-11-08 03:45:23.983347"
...
```bash
$ shpc install quay.io/biocontainers/mist_typing:0.0.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mist_typing/0.0.5--pyhdfd78af_0
$ module help quay.io/biocontainers/mist_typing/0.0.5--pyhdfd78af_0
```
