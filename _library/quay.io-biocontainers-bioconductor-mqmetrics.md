...
updated_at: "2023-10-26 03:06:54.692159"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mqmetrics:1.8.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mqmetrics/1.8.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-mqmetrics/1.8.0--r43hdfd78af_0
```
