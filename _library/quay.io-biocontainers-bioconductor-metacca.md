...
updated_at: "2023-11-27 02:30:04.628610"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-metacca:1.28.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-metacca/1.28.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-metacca/1.28.0--r43hdfd78af_0
```
