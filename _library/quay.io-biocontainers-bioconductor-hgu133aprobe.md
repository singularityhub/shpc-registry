...
updated_at: "2023-12-25 03:08:56.756112"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hgu133aprobe:2.18.0--r43hdfd78af_11
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hgu133aprobe/2.18.0--r43hdfd78af_11
$ module help quay.io/biocontainers/bioconductor-hgu133aprobe/2.18.0--r43hdfd78af_11
```
