...
updated_at: "2026-04-03 05:13:38.303426"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hgu133aprobe:2.18.0--r45hdfd78af_14
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hgu133aprobe/2.18.0--r45hdfd78af_14
$ module help quay.io/biocontainers/bioconductor-hgu133aprobe/2.18.0--r45hdfd78af_14
```
