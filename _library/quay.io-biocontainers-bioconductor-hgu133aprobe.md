...
updated_at: "2024-01-12 03:13:04.517833"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hgu133aprobe:2.18.0--r43hdfd78af_12
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hgu133aprobe/2.18.0--r43hdfd78af_12
$ module help quay.io/biocontainers/bioconductor-hgu133aprobe/2.18.0--r43hdfd78af_12
```
