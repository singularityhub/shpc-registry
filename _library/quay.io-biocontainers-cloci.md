...
updated_at: "2025-05-16 03:39:36.910468"
...
```bash
$ shpc install quay.io/biocontainers/cloci:0.3.1--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/cloci/0.3.1--pyhdfd78af_1
$ module help quay.io/biocontainers/cloci/0.3.1--pyhdfd78af_1
```
