...
updated_at: "2024-07-29 17:17:14.279959"
...
```bash
$ shpc install quay.io/biocontainers/cloci:0.3.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/cloci/0.3.0--pyhdfd78af_0
$ module help quay.io/biocontainers/cloci/0.3.0--pyhdfd78af_0
```
