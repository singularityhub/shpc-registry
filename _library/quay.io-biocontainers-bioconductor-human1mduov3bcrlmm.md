...
updated_at: "2023-10-30 03:45:17.117029"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-human1mduov3bcrlmm:1.0.4--r43hdfd78af_11
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-human1mduov3bcrlmm/1.0.4--r43hdfd78af_11
$ module help quay.io/biocontainers/bioconductor-human1mduov3bcrlmm/1.0.4--r43hdfd78af_11
```
