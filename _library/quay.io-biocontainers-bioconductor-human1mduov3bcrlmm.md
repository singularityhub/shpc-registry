...
updated_at: "2024-12-04 03:46:25.325524"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-human1mduov3bcrlmm:1.0.4--r43hdfd78af_12
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-human1mduov3bcrlmm/1.0.4--r43hdfd78af_12
$ module help quay.io/biocontainers/bioconductor-human1mduov3bcrlmm/1.0.4--r43hdfd78af_12
```
