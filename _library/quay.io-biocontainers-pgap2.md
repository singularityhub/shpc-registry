...
updated_at: "2026-03-30 05:38:52.792084"
...
```bash
$ shpc install quay.io/biocontainers/pgap2:2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pgap2/2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/pgap2/2.0--pyhdfd78af_0
```
