...
updated_at: "2026-06-29 06:57:28.235045"
...
```bash
$ shpc install quay.io/biocontainers/pgap2:2.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pgap2/2.2--pyhdfd78af_0
$ module help quay.io/biocontainers/pgap2/2.2--pyhdfd78af_0
```
