...
updated_at: "2026-02-05 04:31:41.042512"
...
```bash
$ shpc install quay.io/biocontainers/pgap2:1.0.8--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pgap2/1.0.8--pyhdfd78af_0
$ module help quay.io/biocontainers/pgap2/1.0.8--pyhdfd78af_0
```
