...
updated_at: "2026-07-19 06:03:06.947413"
...
```bash
$ shpc install quay.io/biocontainers/pgap2:2.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pgap2/2.3--pyhdfd78af_0
$ module help quay.io/biocontainers/pgap2/2.3--pyhdfd78af_0
```
