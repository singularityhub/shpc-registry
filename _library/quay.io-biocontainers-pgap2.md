...
updated_at: "2026-03-05 04:53:05.341932"
...
```bash
$ shpc install quay.io/biocontainers/pgap2:1.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pgap2/1.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/pgap2/1.1.0--pyhdfd78af_0
```
