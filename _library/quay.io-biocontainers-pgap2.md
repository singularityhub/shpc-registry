...
updated_at: "2025-05-15 03:48:32.970928"
...
```bash
$ shpc install quay.io/biocontainers/pgap2:1.0.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pgap2/1.0.3--pyhdfd78af_0
$ module help quay.io/biocontainers/pgap2/1.0.3--pyhdfd78af_0
```
