...
updated_at: "2026-08-29 09:26:39.432699"
...
```bash
$ shpc install quay.io/biocontainers/pgap2:2.4.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pgap2/2.4.1--pyhdfd78af_0
$ module help quay.io/biocontainers/pgap2/2.4.1--pyhdfd78af_0
```
