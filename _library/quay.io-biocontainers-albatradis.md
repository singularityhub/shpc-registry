...
updated_at: "2026-02-02 04:33:43.793838"
latest: "1.1.2--py39hbcbf7aa_0"
...
```bash
$ shpc install quay.io/biocontainers/albatradis:1.1.2--py39hbcbf7aa_0
```
...
```bash
$ module load quay.io/biocontainers/albatradis/1.1.2--py39hbcbf7aa_0
$ module help quay.io/biocontainers/albatradis/1.1.2--py39hbcbf7aa_0
```
