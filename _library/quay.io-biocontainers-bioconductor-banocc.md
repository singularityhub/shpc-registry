...
updated_at: "2022-11-05 00:39:05.772210"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-banocc:1.8.0--r36_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-banocc/1.8.0--r36_1
$ module help quay.io/biocontainers/bioconductor-banocc/1.8.0--r36_1
```
