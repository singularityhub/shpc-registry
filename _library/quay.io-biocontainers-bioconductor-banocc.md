...
updated_at: "2022-11-11 00:50:45.590866"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-banocc:1.18.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-banocc/1.18.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-banocc/1.18.0--r41hdfd78af_0
```
