...
updated_at: "2024-01-10 02:34:23.830214"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-banocc:1.26.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-banocc/1.26.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-banocc/1.26.0--r43hdfd78af_0
```
