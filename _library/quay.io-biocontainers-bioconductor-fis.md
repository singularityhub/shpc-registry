...
updated_at: "2024-12-29 03:18:32.525975"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-fis:1.34.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-fis/1.34.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-fis/1.34.0--r44hdfd78af_0
```
