...
updated_at: "2026-03-31 04:54:26.526924"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-fis:1.38.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-fis/1.38.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-fis/1.38.0--r45hdfd78af_0
```
