...
updated_at: "2022-10-29 07:48:55.054903"
latest: "1.8.0--r341_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-fis:1.8.0--r341_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-fis/1.8.0--r341_0
$ module help quay.io/biocontainers/bioconductor-fis/1.8.0--r341_0
```
