...
updated_at: "2023-12-08 02:35:44.609197"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-fis:1.28.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-fis/1.28.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-fis/1.28.0--r43hdfd78af_0
```
