...
updated_at: "2023-12-02 02:48:41.460131"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-summarizedbenchmark:2.18.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-summarizedbenchmark/2.18.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-summarizedbenchmark/2.18.0--r43hdfd78af_0
```
