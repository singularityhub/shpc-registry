...
updated_at: "2026-03-29 04:51:40.735608"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-chemminedrugs:1.0.2--r45hdfd78af_14
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-chemminedrugs/1.0.2--r45hdfd78af_14
$ module help quay.io/biocontainers/bioconductor-chemminedrugs/1.0.2--r45hdfd78af_14
```
