...
updated_at: "2026-01-05 04:10:34.105924"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-chemminedrugs:1.0.2--r44hdfd78af_13
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-chemminedrugs/1.0.2--r44hdfd78af_13
$ module help quay.io/biocontainers/bioconductor-chemminedrugs/1.0.2--r44hdfd78af_13
```
