...
updated_at: "2026-03-04 04:31:58.012711"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cohcapanno:1.46.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cohcapanno/1.46.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-cohcapanno/1.46.0--r45hdfd78af_0
```
