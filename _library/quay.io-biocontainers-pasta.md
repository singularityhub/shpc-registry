...
updated_at: "2024-01-20 03:02:40.190966"
...
```bash
$ shpc install quay.io/biocontainers/pasta:1.9.0--py39hf48a03f_0
```
...
```bash
$ module load quay.io/biocontainers/pasta/1.9.0--py39hf48a03f_0
$ module help quay.io/biocontainers/pasta/1.9.0--py39hf48a03f_0
```
