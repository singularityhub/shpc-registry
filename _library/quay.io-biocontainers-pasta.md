...
updated_at: "2025-11-14 03:48:58.223107"
...
```bash
$ shpc install quay.io/biocontainers/pasta:1.9.3--py312hccd54bf_0
```
...
```bash
$ module load quay.io/biocontainers/pasta/1.9.3--py312hccd54bf_0
$ module help quay.io/biocontainers/pasta/1.9.3--py312hccd54bf_0
```
