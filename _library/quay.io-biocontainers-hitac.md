...
updated_at: "2025-03-11 03:15:22.764235"
latest: "2.2.2--pyhdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/hitac:2.2.2--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/hitac/2.2.2--pyhdfd78af_1
$ module help quay.io/biocontainers/hitac/2.2.2--pyhdfd78af_1
```
