...
updated_at: "2025-01-15 03:23:09.372336"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-phantasus:1.26.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-phantasus/1.26.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-phantasus/1.26.0--r44hdfd78af_0
```
