...
updated_at: "2022-11-08 23:53:32.581265"
latest: "1.8.0--r40_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-phantasus:1.8.0--r40_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-phantasus/1.8.0--r40_0
$ module help quay.io/biocontainers/bioconductor-phantasus/1.8.0--r40_0
```
