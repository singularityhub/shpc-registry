...
updated_at: "2026-03-24 04:30:56.969725"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-phantasus:1.30.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-phantasus/1.30.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-phantasus/1.30.0--r45hdfd78af_0
```
