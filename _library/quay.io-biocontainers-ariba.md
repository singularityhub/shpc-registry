...
updated_at: "2026-01-28 03:53:58.970170"
...
```bash
$ shpc install quay.io/biocontainers/ariba:2.14.7--py310h5140242_0
```
...
```bash
$ module load quay.io/biocontainers/ariba/2.14.7--py310h5140242_0
$ module help quay.io/biocontainers/ariba/2.14.7--py310h5140242_0
```
