...
updated_at: "2026-05-26 22:06:50.892766"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rontotools:2.38.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rontotools/2.38.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rontotools/2.38.0--r45hdfd78af_0
```
