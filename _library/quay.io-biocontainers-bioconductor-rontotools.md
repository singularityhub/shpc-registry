...
updated_at: "2022-11-06 00:53:50.975787"
latest: "2.8.0--r351_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rontotools:2.8.0--r351_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rontotools/2.8.0--r351_0
$ module help quay.io/biocontainers/bioconductor-rontotools/2.8.0--r351_0
```
