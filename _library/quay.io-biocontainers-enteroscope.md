---
layout: container
name:  "quay.io/biocontainers/enteroscope"
maintainer: "@vsoch"
github: "https://github.com/singularityhub/shpc-registry/blob/main/quay.io/biocontainers/enteroscope/container.yaml"
config_url: "https://raw.githubusercontent.com/singularityhub/shpc-registry/main/quay.io/biocontainers/enteroscope/container.yaml"
updated_at: "2026-06-26 02:11:29.479004"
latest: "1.0.0--pyhdfd78af_0"
container_url: "https://biocontainers.pro/tools/enteroscope"
aliases:
 - "enteroscope"
 - "gawk-5.4.0"
 - "ds"
...
```bash
$ module load quay.io/biocontainers/enteroscope/1.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/enteroscope/1.0.0--pyhdfd78af_0
```
...
#### enteroscope-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### enteroscope-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/enteroscope
$ podman run --it --rm --entrypoint /usr/local/bin/enteroscope   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/enteroscope   -v ${PWD} -w ${PWD} <container> -c " $@"
```
