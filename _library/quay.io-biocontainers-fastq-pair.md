...
updated_at: "2025-02-14 03:34:34.006847"
...
```bash
$ shpc install quay.io/biocontainers/fastq-pair:1.0--h503566f_6
```
...
```bash
$ module load quay.io/biocontainers/fastq-pair/1.0--h503566f_6
$ module help quay.io/biocontainers/fastq-pair/1.0--h503566f_6
```
