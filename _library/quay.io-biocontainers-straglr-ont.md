---
layout: container
name:  "quay.io/biocontainers/straglr-ont"
maintainer: "@vsoch"
github: "https://github.com/singularityhub/shpc-registry/blob/main/quay.io/biocontainers/straglr-ont/container.yaml"
config_url: "https://raw.githubusercontent.com/singularityhub/shpc-registry/main/quay.io/biocontainers/straglr-ont/container.yaml"
updated_at: "2026-06-29 07:33:58.103677"
latest: "1.4.5--pyhdfd78af_0"
container_url: "https://biocontainers.pro/tools/straglr-ont"
aliases:
 - "pathos_connect"
 - "portpicker"
 - "pox"
...
versions:
 - "1.4.5--pyhdfd78af_0"
description: "singularity registry hpc automated addition for straglr-ont"
config: {"url": "https://biocontainers.pro/tools/straglr-ont", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for straglr-ont", "latest": {"1.4.5--pyhdfd78af_0": "sha256:d8857f24c0e89c5c72e29b801a5aba54840750ebee692abeb2ec8d6a34253b4e"}, "tags": {"1.4.5--pyhdfd78af_0": "sha256:d8857f24c0e89c5c72e29b801a5aba54840750ebee692abeb2ec8d6a34253b4e"}, "docker": "quay.io/biocontainers/straglr-ont", "aliases": {"pathos_connect": "/usr/local/bin/pathos_connect", "portpicker": "/usr/local/bin/portpicker", "pox": "/usr/local/bin/pox", "ppserver": "/usr/local/bin/ppserver", "straglr-genotype": "/usr/local/bin/straglr-genotype", "trf": "/usr/local/bin/trf", "get_gprof": "/usr/local/bin/get_gprof", "archive-nlmnlp": "/usr/local/bin/archive-nlmnlp", "archive-pids": "/usr/local/bin/archive-pids", "download-flatfile": "/usr/local/bin/download-flatfile", "ecollect": "/usr/local/bin/ecollect", "gbf2facds": "/usr/local/bin/gbf2facds", "gbf2tbl": "/usr/local/bin/gbf2tbl", "gff-sort": "/usr/local/bin/gff-sort", "gff2xml": "/usr/local/bin/gff2xml", "pair-at-a-time": "/usr/local/bin/pair-at-a-time", "print-missing-subranges": "/usr/local/bin/print-missing-subranges", "sort-by-length": "/usr/local/bin/sort-by-length", "xcommon.sh": "/usr/local/bin/xcommon.sh", "xfetch": "/usr/local/bin/xfetch", "xfetch.ini": "/usr/local/bin/xfetch.ini", "xfilter": "/usr/local/bin/xfilter", "xinfo": "/usr/local/bin/xinfo", "xlink": "/usr/local/bin/xlink", "xlink.ini": "/usr/local/bin/xlink.ini", "xsearch": "/usr/local/bin/xsearch", "get_objgraph": "/usr/local/bin/get_objgraph", "undill": "/usr/local/bin/undill", "bsmp2info": "/usr/local/bin/bsmp2info", "fsa2xml": "/usr/local/bin/fsa2xml"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/straglr-ont.
singularity registry hpc automated addition for straglr-ont
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/straglr-ont
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/straglr-ont:1.4.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/straglr-ont/1.4.5--pyhdfd78af_0
$ module help quay.io/biocontainers/straglr-ont/1.4.5--pyhdfd78af_0
```
...
#### straglr-ont-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### straglr-ont-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/straglr-genotype
$ podman run --it --rm --entrypoint /usr/local/bin/straglr-genotype   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/straglr-genotype   -v ${PWD} -w ${PWD} <container> -c " $@"
```
