...
updated_at: "2025-10-26 03:53:50.747237"
...
```bash
$ shpc install quay.io/biocontainers/biobb_flexdyn:5.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_flexdyn/5.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/biobb_flexdyn/5.1.0--pyhdfd78af_0
```
