...
updated_at: "2024-11-27 03:09:42.115198"
...
```bash
$ shpc install quay.io/biocontainers/biobb_flexdyn:5.0.0--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/biobb_flexdyn/5.0.0--pyhdfd78af_1
$ module help quay.io/biocontainers/biobb_flexdyn/5.0.0--pyhdfd78af_1
```
