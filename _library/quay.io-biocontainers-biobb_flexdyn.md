...
updated_at: "2026-04-05 05:14:32.401972"
...
```bash
$ shpc install quay.io/biocontainers/biobb_flexdyn:5.2.2--py311h362c646_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_flexdyn/5.2.2--py311h362c646_0
$ module help quay.io/biocontainers/biobb_flexdyn/5.2.2--py311h362c646_0
```
