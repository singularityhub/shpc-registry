...
updated_at: "2024-10-27 03:05:00.952162"
...
```bash
$ shpc install quay.io/biocontainers/biobb_flexdyn:4.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_flexdyn/4.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/biobb_flexdyn/4.2.0--pyhdfd78af_0
```
