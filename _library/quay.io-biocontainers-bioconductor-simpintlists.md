...
updated_at: "2022-11-17 03:44:00.068182"
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-simpintlists-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-simpintlists-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-simpintlists-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-simpintlists-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-simpintlists-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-simpintlists-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
