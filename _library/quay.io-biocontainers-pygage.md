---
layout: container
name:  "quay.io/biocontainers/pygage"
maintainer: "@vsoch"
...
updated_at: "2026-05-01 06:32:00.464945"
latest: "1.0.0--pyhdfd78af_0"
container_url: "https://biocontainers.pro/tools/pygage"
aliases:
 - "pygage-core.py"
 - "pygage-data_processing_utils.py"
 - "pygage-gene_id_utils.py"
 - "pygage-pathway_database_utils.py"
 - "pygage-results_analysis.py"
 - "pygage-tests.py"
 - "pygage-visualization_utils.py"
 - "protoc-33.5.0"
...
versions:
 - "1.0.0--pyhdfd78af_0"
description: "singularity registry hpc automated addition for pygage"
config: {"url": "https://biocontainers.pro/tools/pygage", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for pygage", "latest": {"1.0.0--pyhdfd78af_0": "sha256:ab1412bf0f050207c1eeeaf8e89a4ec13443d1334899640a2bc6125906441877"}, "tags": {"1.0.0--pyhdfd78af_0": "sha256:ab1412bf0f050207c1eeeaf8e89a4ec13443d1334899640a2bc6125906441877"}, "docker": "quay.io/biocontainers/pygage", "aliases": {"pygage-core.py": "/usr/local/bin/pygage-core.py", "pygage-data_processing_utils.py": "/usr/local/bin/pygage-data_processing_utils.py", "pygage-gene_id_utils.py": "/usr/local/bin/pygage-gene_id_utils.py", "pygage-pathway_database_utils.py": "/usr/local/bin/pygage-pathway_database_utils.py", "pygage-results_analysis.py": "/usr/local/bin/pygage-results_analysis.py", "pygage-tests.py": "/usr/local/bin/pygage-tests.py", "pygage-visualization_utils.py": "/usr/local/bin/pygage-visualization_utils.py", "protoc-33.5.0": "/usr/local/bin/protoc-33.5.0", "protoc-gen-upb-33.5.0": "/usr/local/bin/protoc-gen-upb-33.5.0", "protoc-gen-upb_minitable-33.5.0": "/usr/local/bin/protoc-gen-upb_minitable-33.5.0", "protoc-gen-upbdefs-33.5.0": "/usr/local/bin/protoc-gen-upbdefs-33.5.0", "protoc-gen-upb_minitable": "/usr/local/bin/protoc-gen-upb_minitable", "h2benchmark": "/usr/local/bin/h2benchmark", "elastishadow": "/usr/local/bin/elastishadow", "checksum-profile": "/usr/local/bin/checksum-profile", "protoc-gen-upb": "/usr/local/bin/protoc-gen-upb", "protoc-gen-upbdefs": "/usr/local/bin/protoc-gen-upbdefs", "elastipubsub5": "/usr/local/bin/elastipubsub5", "mqtt5_app": "/usr/local/bin/mqtt5_app", "mqtt5_canary": "/usr/local/bin/mqtt5_canary", "mqtt5canary": "/usr/local/bin/mqtt5canary", "elasticurl_cpp": "/usr/local/bin/elasticurl_cpp", "elastipubsub": "/usr/local/bin/elastipubsub", "elasticurl": "/usr/local/bin/elasticurl", "csv-import": "/usr/local/bin/csv-import", "orc-memory": "/usr/local/bin/orc-memory", "orc-scan": "/usr/local/bin/orc-scan", "timezone-dump": "/usr/local/bin/timezone-dump", "orc-contents": "/usr/local/bin/orc-contents", "orc-metadata": "/usr/local/bin/orc-metadata", "orc-statistics": "/usr/local/bin/orc-statistics", "gflags_completions.sh": "/usr/local/bin/gflags_completions.sh"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/pygage.
singularity registry hpc automated addition for pygage
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/pygage
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/pygage:1.0.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pygage/1.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/pygage/1.0.0--pyhdfd78af_0
```
...
#### pygage-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### pygage-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/pygage-core.py
$ podman run --it --rm --entrypoint /usr/local/bin/pygage-core.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/pygage-core.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/pygage-data_processing_utils.py
$ podman run --it --rm --entrypoint /usr/local/bin/pygage-data_processing_utils.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/pygage-data_processing_utils.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/pygage-gene_id_utils.py
$ podman run --it --rm --entrypoint /usr/local/bin/pygage-gene_id_utils.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/pygage-gene_id_utils.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/pygage-pathway_database_utils.py
$ podman run --it --rm --entrypoint /usr/local/bin/pygage-pathway_database_utils.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/pygage-pathway_database_utils.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/pygage-results_analysis.py
$ podman run --it --rm --entrypoint /usr/local/bin/pygage-results_analysis.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/pygage-results_analysis.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/pygage-tests.py
$ podman run --it --rm --entrypoint /usr/local/bin/pygage-tests.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/pygage-tests.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/pygage-visualization_utils.py
$ podman run --it --rm --entrypoint /usr/local/bin/pygage-visualization_utils.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/pygage-visualization_utils.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
