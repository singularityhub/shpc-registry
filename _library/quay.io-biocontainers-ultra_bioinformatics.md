...
updated_at: "2023-06-24 03:00:24.882057"
...
```bash
$ shpc install quay.io/biocontainers/ultra_bioinformatics:0.1--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/ultra_bioinformatics/0.1--pyh7cba7a3_0
$ module help quay.io/biocontainers/ultra_bioinformatics/0.1--pyh7cba7a3_0
```
