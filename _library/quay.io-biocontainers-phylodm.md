...
updated_at: "2024-11-03 03:28:08.214857"
latest: "3.2.0--py311h5e00ca1_0"
...
```bash
$ shpc install quay.io/biocontainers/phylodm:3.2.0--py311h5e00ca1_0
```
...
```bash
$ module load quay.io/biocontainers/phylodm/3.2.0--py311h5e00ca1_0
$ module help quay.io/biocontainers/phylodm/3.2.0--py311h5e00ca1_0
```
