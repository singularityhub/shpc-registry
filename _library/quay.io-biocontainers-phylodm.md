...
updated_at: "2024-08-17 03:07:27.821302"
latest: "3.1.0--py310hec43fc7_0"
...
```bash
$ shpc install quay.io/biocontainers/phylodm:3.1.0--py310hec43fc7_0
```
...
```bash
$ module load quay.io/biocontainers/phylodm/3.1.0--py310hec43fc7_0
$ module help quay.io/biocontainers/phylodm/3.1.0--py310hec43fc7_0
```
