...
updated_at: "2025-12-20 03:58:59.630339"
...
```bash
$ shpc install quay.io/biocontainers/gottcha2:2.1.10--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/gottcha2/2.1.10--pyhdfd78af_0
$ module help quay.io/biocontainers/gottcha2/2.1.10--pyhdfd78af_0
```
