...
updated_at: "2026-05-27 07:04:30.782562"
...
```bash
$ shpc install quay.io/biocontainers/gottcha2:2.4.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/gottcha2/2.4.0--pyhdfd78af_0
$ module help quay.io/biocontainers/gottcha2/2.4.0--pyhdfd78af_0
```
