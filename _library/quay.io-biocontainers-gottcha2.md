...
updated_at: "2026-03-29 05:04:00.601458"
...
```bash
$ shpc install quay.io/biocontainers/gottcha2:2.3.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/gottcha2/2.3.0--pyhdfd78af_0
$ module help quay.io/biocontainers/gottcha2/2.3.0--pyhdfd78af_0
```
