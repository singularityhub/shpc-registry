...
updated_at: "2025-05-11 03:27:25.483113"
...
```bash
$ shpc install quay.io/biocontainers/gottcha2:2.1.9--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/gottcha2/2.1.9--pyhdfd78af_0
$ module help quay.io/biocontainers/gottcha2/2.1.9--pyhdfd78af_0
```
