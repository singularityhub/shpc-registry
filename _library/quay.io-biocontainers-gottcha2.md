...
updated_at: "2026-06-25 06:50:37.306183"
...
```bash
$ shpc install quay.io/biocontainers/gottcha2:2.4.0--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/gottcha2/2.4.0--pyhdfd78af_1
$ module help quay.io/biocontainers/gottcha2/2.4.0--pyhdfd78af_1
```
