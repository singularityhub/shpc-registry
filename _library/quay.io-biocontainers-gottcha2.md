...
updated_at: "2026-09-23 07:37:44.884309"
...
```bash
$ shpc install quay.io/biocontainers/gottcha2:2.5.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/gottcha2/2.5.0--pyhdfd78af_0
$ module help quay.io/biocontainers/gottcha2/2.5.0--pyhdfd78af_0
```
