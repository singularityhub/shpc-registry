...
updated_at: "2026-02-25 05:05:32.534034"
...
```bash
$ shpc install quay.io/biocontainers/gottcha2:2.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/gottcha2/2.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/gottcha2/2.2.0--pyhdfd78af_0
```
