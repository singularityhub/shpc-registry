...
updated_at: "2026-08-31 08:53:01.177181"
...
```bash
$ shpc install quay.io/biocontainers/pathogen-embed:4.0.0--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/pathogen-embed/4.0.0--pyhdfd78af_1
$ module help quay.io/biocontainers/pathogen-embed/4.0.0--pyhdfd78af_1
```
