...
updated_at: "2026-08-20 03:48:29.618496"
latest: "3.1.0--pyhdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/pathogen-embed:3.1.0--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/pathogen-embed/3.1.0--pyhdfd78af_1
$ module help quay.io/biocontainers/pathogen-embed/3.1.0--pyhdfd78af_1
```
