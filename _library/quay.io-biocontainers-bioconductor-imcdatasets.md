...
updated_at: "2022-10-27 00:54:46.353128"
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-imcdatasets-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-imcdatasets-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-imcdatasets-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-imcdatasets-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-imcdatasets-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-imcdatasets-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
