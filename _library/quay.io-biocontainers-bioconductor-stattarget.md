...
updated_at: "2025-09-06 03:02:11.468644"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-stattarget:1.36.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-stattarget/1.36.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-stattarget/1.36.0--r44hdfd78af_0
```
