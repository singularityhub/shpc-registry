...
updated_at: "2023-09-27 03:11:14.002120"
...
```bash
$ shpc install quay.io/biocontainers/itolapi:4.1.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/itolapi/4.1.2--pyhdfd78af_0
$ module help quay.io/biocontainers/itolapi/4.1.2--pyhdfd78af_0
```
