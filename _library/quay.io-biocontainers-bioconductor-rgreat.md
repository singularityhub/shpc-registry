...
updated_at: "2023-10-27 03:10:19.490596"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rgreat:2.2.0--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rgreat/2.2.0--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-rgreat/2.2.0--r43hf17093f_0
```
