---
layout: container
name:  "quay.io/biocontainers/vartovcf"
maintainer: "@vsoch"
...
updated_at: "2025-11-12 03:43:40.330043"
...
singularity registry hpc automated addition for vartovcf
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/vartovcf
```
...
#### vartovcf-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### vartovcf-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/vartovcf
$ podman run --it --rm --entrypoint /usr/local/bin/vartovcf   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/vartovcf   -v ${PWD} -w ${PWD} <container> -c " $@"
```
