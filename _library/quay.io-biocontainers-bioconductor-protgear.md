...
updated_at: "2025-12-17 03:53:39.482785"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-protgear:1.10.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-protgear/1.10.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-protgear/1.10.0--r44hdfd78af_0
```
