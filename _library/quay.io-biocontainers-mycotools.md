...
updated_at: "2025-11-21 15:57:36.267580"
...
```bash
$ shpc install quay.io/biocontainers/mycotools:1.0.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mycotools/1.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/mycotools/1.0.0--pyhdfd78af_0
```
