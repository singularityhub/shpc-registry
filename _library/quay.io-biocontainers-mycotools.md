...
updated_at: "2024-11-01 03:01:53.052283"
latest: "0.32.3--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/mycotools:0.32.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mycotools/0.32.3--pyhdfd78af_0
$ module help quay.io/biocontainers/mycotools/0.32.3--pyhdfd78af_0
```
