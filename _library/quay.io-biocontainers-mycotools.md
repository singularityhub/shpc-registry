...
updated_at: "2024-09-20 02:48:01.561361"
...
```bash
$ shpc install quay.io/biocontainers/mycotools:0.32.1--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/mycotools/0.32.1--pyhdfd78af_1
$ module help quay.io/biocontainers/mycotools/0.32.1--pyhdfd78af_1
```
