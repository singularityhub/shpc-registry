...
updated_at: "2024-12-20 03:40:55.890112"
latest: "0.32.6--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/mycotools:0.32.6--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mycotools/0.32.6--pyhdfd78af_0
$ module help quay.io/biocontainers/mycotools/0.32.6--pyhdfd78af_0
```
