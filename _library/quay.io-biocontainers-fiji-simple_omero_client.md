...
updated_at: "2024-08-22 19:32:56.320004"
...
```bash
$ shpc install quay.io/biocontainers/fiji-simple_omero_client:5.18.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/fiji-simple_omero_client/5.18.0--hdfd78af_0
$ module help quay.io/biocontainers/fiji-simple_omero_client/5.18.0--hdfd78af_0
```
