...
updated_at: "2024-04-16 02:54:13.792485"
latest: "5.17.0--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/fiji-simple_omero_client:5.17.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/fiji-simple_omero_client/5.17.0--hdfd78af_0
$ module help quay.io/biocontainers/fiji-simple_omero_client/5.17.0--hdfd78af_0
```
