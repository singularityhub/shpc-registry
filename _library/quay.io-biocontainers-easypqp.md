...
updated_at: "2025-04-25 03:45:26.606730"
latest: "0.1.51--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/easypqp:0.1.51--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/easypqp/0.1.51--pyhdfd78af_0
$ module help quay.io/biocontainers/easypqp/0.1.51--pyhdfd78af_0
```
