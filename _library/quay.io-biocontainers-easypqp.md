...
updated_at: "2024-07-22 03:01:39.612195"
latest: "0.1.47--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/easypqp:0.1.47--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/easypqp/0.1.47--pyhdfd78af_0
$ module help quay.io/biocontainers/easypqp/0.1.47--pyhdfd78af_0
```
