...
updated_at: "2025-10-09 03:40:21.952943"
latest: "0.1.53--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/easypqp:0.1.53--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/easypqp/0.1.53--pyhdfd78af_0
$ module help quay.io/biocontainers/easypqp/0.1.53--pyhdfd78af_0
```
