...
updated_at: "2025-02-20 02:57:22.760688"
latest: "0.1.50--pyhdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/easypqp:0.1.50--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/easypqp/0.1.50--pyhdfd78af_1
$ module help quay.io/biocontainers/easypqp/0.1.50--pyhdfd78af_1
```
