...
updated_at: "2024-11-02 03:26:42.488951"
latest: "0.1.50--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/easypqp:0.1.50--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/easypqp/0.1.50--pyhdfd78af_0
$ module help quay.io/biocontainers/easypqp/0.1.50--pyhdfd78af_0
```
