...
updated_at: "2024-08-25 03:07:36.195009"
latest: "0.1.49--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/easypqp:0.1.49--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/easypqp/0.1.49--pyhdfd78af_0
$ module help quay.io/biocontainers/easypqp/0.1.49--pyhdfd78af_0
```
