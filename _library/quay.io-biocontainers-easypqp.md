...
updated_at: "2024-01-22 04:01:41.820613"
latest: "0.1.42--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/easypqp:0.1.42--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/easypqp/0.1.42--pyhdfd78af_0
$ module help quay.io/biocontainers/easypqp/0.1.42--pyhdfd78af_0
```
