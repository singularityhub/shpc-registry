...
updated_at: "2024-01-08 03:14:31.420376"
latest: "0.1.41--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/easypqp:0.1.41--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/easypqp/0.1.41--pyhdfd78af_0
$ module help quay.io/biocontainers/easypqp/0.1.41--pyhdfd78af_0
```
