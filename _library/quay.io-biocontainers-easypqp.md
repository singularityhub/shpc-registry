...
updated_at: "2026-03-20 04:57:53.421387"
latest: "0.1.58--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/easypqp:0.1.58--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/easypqp/0.1.58--pyhdfd78af_0
$ module help quay.io/biocontainers/easypqp/0.1.58--pyhdfd78af_0
```
