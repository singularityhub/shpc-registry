...
updated_at: "2026-05-19 06:22:11.299813"
latest: "0.1.59--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/easypqp:0.1.59--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/easypqp/0.1.59--pyhdfd78af_0
$ module help quay.io/biocontainers/easypqp/0.1.59--pyhdfd78af_0
```
