...
updated_at: "2023-12-12 03:12:33.066492"
latest: "0.1.40--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/easypqp:0.1.40--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/easypqp/0.1.40--pyhdfd78af_0
$ module help quay.io/biocontainers/easypqp/0.1.40--pyhdfd78af_0
```
