...
updated_at: "2026-02-24 04:56:33.349700"
latest: "0.1.55--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/easypqp:0.1.55--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/easypqp/0.1.55--pyhdfd78af_0
$ module help quay.io/biocontainers/easypqp/0.1.55--pyhdfd78af_0
```
