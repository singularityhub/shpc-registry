...
updated_at: "2023-04-26 02:49:03.505423"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-syntenet:1.0.0--r42hc247a5b_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-syntenet/1.0.0--r42hc247a5b_0
$ module help quay.io/biocontainers/bioconductor-syntenet/1.0.0--r42hc247a5b_0
```
