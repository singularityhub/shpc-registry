...
updated_at: "2023-08-22 02:57:50.427236"
latest: "1.2.4--r43hf17093f_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-syntenet:1.2.4--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-syntenet/1.2.4--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-syntenet/1.2.4--r43hf17093f_0
```
