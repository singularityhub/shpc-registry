...
updated_at: "2023-07-08 03:38:54.958428"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-syntenet:1.0.0--r42hf17093f_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-syntenet/1.0.0--r42hf17093f_1
$ module help quay.io/biocontainers/bioconductor-syntenet/1.0.0--r42hf17093f_1
```
