...
updated_at: "2026-04-05 04:44:00.331700"
latest: "3.20.0--pl5321h9afa7ea_0"
...
```bash
$ shpc install quay.io/biocontainers/perl-dbd-pg:3.20.0--pl5321h9afa7ea_0
```
...
```bash
$ module load quay.io/biocontainers/perl-dbd-pg/3.20.0--pl5321h9afa7ea_0
$ module help quay.io/biocontainers/perl-dbd-pg/3.20.0--pl5321h9afa7ea_0
```
