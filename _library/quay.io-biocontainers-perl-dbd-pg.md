...
updated_at: "2024-11-06 02:52:14.568746"
latest: "3.18.0--pl5321hbeff08c_0"
...
```bash
$ shpc install quay.io/biocontainers/perl-dbd-pg:3.18.0--pl5321hbeff08c_0
```
...
```bash
$ module load quay.io/biocontainers/perl-dbd-pg/3.18.0--pl5321hbeff08c_0
$ module help quay.io/biocontainers/perl-dbd-pg/3.18.0--pl5321hbeff08c_0
```
