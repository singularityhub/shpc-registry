...
updated_at: "2025-09-11 05:03:27.196071"
latest: "3.18.0--pl5321h3a0becb_3"
...
```bash
$ shpc install quay.io/biocontainers/perl-dbd-pg:3.18.0--pl5321h3a0becb_3
```
...
```bash
$ module load quay.io/biocontainers/perl-dbd-pg/3.18.0--pl5321h3a0becb_3
$ module help quay.io/biocontainers/perl-dbd-pg/3.18.0--pl5321h3a0becb_3
```
