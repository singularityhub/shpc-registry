---
layout: container
name:  "quay.io/biocontainers/dnamarkmaker"
maintainer: "@vsoch"
...
updated_at: "2024-05-13 02:48:22.192435"
...
```bash
$ module load quay.io/biocontainers/dnamarkmaker/1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/dnamarkmaker/1.0--pyhdfd78af_0
```
...
#### dnamarkmaker-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### dnamarkmaker-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/DNAMarkMaker
$ podman run --it --rm --entrypoint /usr/local/bin/DNAMarkMaker   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/DNAMarkMaker   -v ${PWD} -w ${PWD} <container> -c " $@"
```
