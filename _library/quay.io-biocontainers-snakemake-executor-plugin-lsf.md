...
updated_at: "2026-04-01 05:05:57.741736"
...
```bash
$ shpc install quay.io/biocontainers/snakemake-executor-plugin-lsf:0.3.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake-executor-plugin-lsf/0.3.2--pyhdfd78af_0
$ module help quay.io/biocontainers/snakemake-executor-plugin-lsf/0.3.2--pyhdfd78af_0
```
