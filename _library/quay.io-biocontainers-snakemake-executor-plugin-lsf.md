...
updated_at: "2026-06-22 08:08:02.218525"
...
```bash
$ shpc install quay.io/biocontainers/snakemake-executor-plugin-lsf:0.3.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake-executor-plugin-lsf/0.3.3--pyhdfd78af_0
$ module help quay.io/biocontainers/snakemake-executor-plugin-lsf/0.3.3--pyhdfd78af_0
```
