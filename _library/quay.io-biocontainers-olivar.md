...
updated_at: "2025-05-24 11:28:46.637720"
...
```bash
$ shpc install quay.io/biocontainers/olivar:1.3.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/olivar/1.3.1--pyhdfd78af_0
$ module help quay.io/biocontainers/olivar/1.3.1--pyhdfd78af_0
```
