...
updated_at: "2026-01-26 04:37:59.204815"
latest: "1.3.3--pyhdfd78af_2"
...
```bash
$ shpc install quay.io/biocontainers/olivar:1.3.3--pyhdfd78af_2
```
...
```bash
$ module load quay.io/biocontainers/olivar/1.3.3--pyhdfd78af_2
$ module help quay.io/biocontainers/olivar/1.3.3--pyhdfd78af_2
```
