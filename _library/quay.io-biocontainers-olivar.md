...
updated_at: "2024-07-27 03:19:58.544829"
...
```bash
$ shpc install quay.io/biocontainers/olivar:1.1.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/olivar/1.1.5--pyhdfd78af_0
$ module help quay.io/biocontainers/olivar/1.1.5--pyhdfd78af_0
```
