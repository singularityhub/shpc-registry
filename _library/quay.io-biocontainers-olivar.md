...
updated_at: "2023-02-24 03:26:41.467687"
...
```bash
$ shpc install quay.io/biocontainers/olivar:1.1.0--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/olivar/1.1.0--pyh7cba7a3_0
$ module help quay.io/biocontainers/olivar/1.1.0--pyh7cba7a3_0
```
