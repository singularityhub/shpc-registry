...
updated_at: "2023-12-02 02:27:41.772858"
...
```bash
$ shpc install quay.io/biocontainers/olivar:1.1.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/olivar/1.1.3--pyhdfd78af_0
$ module help quay.io/biocontainers/olivar/1.1.3--pyhdfd78af_0
```
