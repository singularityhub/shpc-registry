...
updated_at: "2024-05-16 02:56:10.343870"
...
```bash
$ shpc install quay.io/biocontainers/olivar:1.1.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/olivar/1.1.4--pyhdfd78af_0
$ module help quay.io/biocontainers/olivar/1.1.4--pyhdfd78af_0
```
