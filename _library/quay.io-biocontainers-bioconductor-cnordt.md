...
updated_at: "2024-07-13 02:41:45.487455"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cnordt:1.44.0--r43ha9d7317_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cnordt/1.44.0--r43ha9d7317_0
$ module help quay.io/biocontainers/bioconductor-cnordt/1.44.0--r43ha9d7317_0
```
