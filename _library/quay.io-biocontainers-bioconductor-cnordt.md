...
updated_at: "2023-09-07 02:35:52.357093"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cnordt:1.42.0--r43ha9d7317_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cnordt/1.42.0--r43ha9d7317_0
$ module help quay.io/biocontainers/bioconductor-cnordt/1.42.0--r43ha9d7317_0
```
