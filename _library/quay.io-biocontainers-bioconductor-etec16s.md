...
```bash
$ shpc install quay.io/biocontainers/bioconductor-etec16s:1.22.0--r41hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-etec16s/1.22.0--r41hdfd78af_1
$ module help quay.io/biocontainers/bioconductor-etec16s/1.22.0--r41hdfd78af_1
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-etec16s-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-etec16s-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-etec16s-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-etec16s-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-etec16s-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-etec16s-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
