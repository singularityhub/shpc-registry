...
updated_at: "2026-03-31 05:29:18.706217"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-graphalignment:1.74.0--r45h01b2380_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-graphalignment/1.74.0--r45h01b2380_0
$ module help quay.io/biocontainers/bioconductor-graphalignment/1.74.0--r45h01b2380_0
```
