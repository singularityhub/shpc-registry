...
updated_at: "2025-07-29 04:20:07.379878"
...
```bash
$ shpc install quay.io/biocontainers/coolbox:0.3.9--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/coolbox/0.3.9--pyhdfd78af_0
$ module help quay.io/biocontainers/coolbox/0.3.9--pyhdfd78af_0
```
