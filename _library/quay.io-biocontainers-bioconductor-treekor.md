...
updated_at: "2022-10-29 05:47:26.924014"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-treekor:1.2.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-treekor/1.2.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-treekor/1.2.0--r41hdfd78af_0
```
