...
updated_at: "2026-03-24 04:35:40.451459"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-treekor:1.18.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-treekor/1.18.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-treekor/1.18.0--r45hdfd78af_0
```
