...
updated_at: "2026-09-04 07:51:37.796884"
...
```bash
$ shpc install quay.io/biocontainers/optitype:1.5.0--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/optitype/1.5.0--pyhdfd78af_1
$ module help quay.io/biocontainers/optitype/1.5.0--pyhdfd78af_1
```
