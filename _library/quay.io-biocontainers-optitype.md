...
updated_at: "2026-06-17 08:04:09.020541"
...
```bash
$ shpc install quay.io/biocontainers/optitype:1.5.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/optitype/1.5.0--pyhdfd78af_0
$ module help quay.io/biocontainers/optitype/1.5.0--pyhdfd78af_0
```
