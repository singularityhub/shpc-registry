...
updated_at: "2025-04-19 03:18:59.775865"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ipddb:1.24.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ipddb/1.24.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ipddb/1.24.0--r44hdfd78af_0
```
