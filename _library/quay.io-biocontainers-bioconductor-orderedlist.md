...
updated_at: "2026-03-24 04:44:22.973739"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-orderedlist:1.82.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-orderedlist/1.82.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-orderedlist/1.82.0--r45hdfd78af_0
```
