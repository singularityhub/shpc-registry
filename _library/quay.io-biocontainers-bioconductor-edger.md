...
updated_at: "2022-10-29 05:58:10.747247"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-edger:3.36.0--r41hc247a5b_2
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-edger/3.36.0--r41hc247a5b_2
$ module help quay.io/biocontainers/bioconductor-edger/3.36.0--r41hc247a5b_2
```
