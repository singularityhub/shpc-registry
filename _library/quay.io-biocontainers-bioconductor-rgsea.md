...
updated_at: "2026-04-03 04:42:49.394979"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rgsea:1.44.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rgsea/1.44.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rgsea/1.44.0--r45hdfd78af_0
```
