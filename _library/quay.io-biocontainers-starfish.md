...
updated_at: "2026-03-02 04:44:27.506093"
...
```bash
$ shpc install quay.io/biocontainers/starfish:0.4.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/starfish/0.4.0--pyhdfd78af_0
$ module help quay.io/biocontainers/starfish/0.4.0--pyhdfd78af_0
```
