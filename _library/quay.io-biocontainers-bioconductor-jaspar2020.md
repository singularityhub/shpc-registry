...
updated_at: "2026-03-02 05:23:43.185294"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-jaspar2020:0.99.10--r45hdfd78af_9
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-jaspar2020/0.99.10--r45hdfd78af_9
$ module help quay.io/biocontainers/bioconductor-jaspar2020/0.99.10--r45hdfd78af_9
```
