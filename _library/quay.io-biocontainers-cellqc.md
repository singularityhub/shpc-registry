...
updated_at: "2026-09-03 07:28:35.135158"
...
```bash
$ shpc install quay.io/biocontainers/cellqc:0.3.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/cellqc/0.3.2--pyhdfd78af_0
$ module help quay.io/biocontainers/cellqc/0.3.2--pyhdfd78af_0
```
