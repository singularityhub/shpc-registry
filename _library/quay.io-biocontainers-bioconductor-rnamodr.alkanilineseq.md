...
updated_at: "2022-11-05 00:28:11.052016"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rnamodr.alkanilineseq:1.8.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rnamodr.alkanilineseq/1.8.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rnamodr.alkanilineseq/1.8.0--r41hdfd78af_0
```
