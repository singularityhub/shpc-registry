...
updated_at: "2025-05-09 03:18:20.004845"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rnamodr.ribomethseq:1.20.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rnamodr.ribomethseq/1.20.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rnamodr.ribomethseq/1.20.0--r44hdfd78af_0
```
