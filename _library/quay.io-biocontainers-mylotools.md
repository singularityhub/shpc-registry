---
layout: container
name:  "quay.io/biocontainers/mylotools"
maintainer: "@vsoch"
...
updated_at: "2025-12-19 03:57:46.263384"
...
singularity registry hpc automated addition for mylotools
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/mylotools
```
...
#### mylotools-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### mylotools-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/mylotools
$ podman run --it --rm --entrypoint /usr/local/bin/mylotools   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/mylotools   -v ${PWD} -w ${PWD} <container> -c " $@"
```
