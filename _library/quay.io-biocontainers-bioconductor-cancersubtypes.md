...
updated_at: "2022-11-05 00:11:54.507415"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cancersubtypes:1.8.0--r351_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cancersubtypes/1.8.0--r351_0
$ module help quay.io/biocontainers/bioconductor-cancersubtypes/1.8.0--r351_0
```
