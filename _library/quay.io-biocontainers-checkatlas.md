...
updated_at: "2026-06-29 07:05:45.753139"
...
```bash
$ shpc install quay.io/biocontainers/checkatlas:0.8.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/checkatlas/0.8.2--pyhdfd78af_0
$ module help quay.io/biocontainers/checkatlas/0.8.2--pyhdfd78af_0
```
