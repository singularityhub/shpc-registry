...
updated_at: "2025-08-06 04:05:53.321420"
...
```bash
$ shpc install quay.io/biocontainers/checkatlas:0.5.6--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/checkatlas/0.5.6--pyhdfd78af_0
$ module help quay.io/biocontainers/checkatlas/0.5.6--pyhdfd78af_0
```
