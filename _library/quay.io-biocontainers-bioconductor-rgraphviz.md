...
updated_at: "2026-03-05 01:03:39.549447"
latest: "2.54.0--r45h68012da_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rgraphviz:2.54.0--r45h68012da_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rgraphviz/2.54.0--r45h68012da_0
$ module help quay.io/biocontainers/bioconductor-rgraphviz/2.54.0--r45h68012da_0
```
