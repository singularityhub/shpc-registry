...
updated_at: "2022-11-20 00:13:56.813721"
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-curatedovariandata-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-curatedovariandata-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-curatedovariandata-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-curatedovariandata-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-curatedovariandata-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-curatedovariandata-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
