...
updated_at: "2024-08-25 02:48:45.621982"
...
```bash
$ shpc install quay.io/biocontainers/biobb_haddock:4.2.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_haddock/4.2.1--pyhdfd78af_0
$ module help quay.io/biocontainers/biobb_haddock/4.2.1--pyhdfd78af_0
```
