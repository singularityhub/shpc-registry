...
updated_at: "2026-03-28 17:19:16.602452"
...
```bash
$ shpc install quay.io/biocontainers/biobb_haddock:5.2.0--pyh106432d_1
```
...
```bash
$ module load quay.io/biocontainers/biobb_haddock/5.2.0--pyh106432d_1
$ module help quay.io/biocontainers/biobb_haddock/5.2.0--pyh106432d_1
```
