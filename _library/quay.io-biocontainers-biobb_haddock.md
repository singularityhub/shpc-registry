...
updated_at: "2026-01-24 04:20:33.051980"
...
```bash
$ shpc install quay.io/biocontainers/biobb_haddock:5.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_haddock/5.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/biobb_haddock/5.2.0--pyhdfd78af_0
```
