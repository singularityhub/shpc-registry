...
updated_at: "2024-06-28 02:41:37.063837"
latest: "3.0.9--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/ncbi-vdb-py:3.0.9--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ncbi-vdb-py/3.0.9--hdfd78af_0
$ module help quay.io/biocontainers/ncbi-vdb-py/3.0.9--hdfd78af_0
```
