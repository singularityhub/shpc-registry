...
updated_at: "2025-07-31 11:21:54.555467"
...
```bash
$ shpc install quay.io/biocontainers/ncbi-vdb-py:3.2.1--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ncbi-vdb-py/3.2.1--hdfd78af_0
$ module help quay.io/biocontainers/ncbi-vdb-py/3.2.1--hdfd78af_0
```
