---
layout: container
name:  "quay.io/biocontainers/bioconductor-scfeatures"
maintainer: "@vsoch"
...
updated_at: "2025-10-19 04:08:40.859387"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-scfeatures
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-scfeatures:1.6.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-scfeatures/1.6.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-scfeatures/1.6.0--r44hdfd78af_0
```
...
#### bioconductor-scfeatures-inspect:
...
#### bioconductor-scfeatures-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-scfeatures-inspect-deffile:
