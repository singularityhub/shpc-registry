...
updated_at: "2022-10-29 05:45:41.518409"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-iloreg:1.4.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-iloreg/1.4.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-iloreg/1.4.0--r41hdfd78af_0
```
