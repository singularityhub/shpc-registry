...
updated_at: "2023-09-04 03:48:31.895692"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-moe430b.db:3.13.0--r43hdfd78af_3
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-moe430b.db/3.13.0--r43hdfd78af_3
$ module help quay.io/biocontainers/bioconductor-moe430b.db/3.13.0--r43hdfd78af_3
```
