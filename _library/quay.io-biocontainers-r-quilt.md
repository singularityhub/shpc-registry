...
updated_at: "2024-12-24 02:54:18.565505"
latest: "2.0.1--r43hdbdd923_0"
...
```bash
$ shpc install quay.io/biocontainers/r-quilt:2.0.1--r43hdbdd923_0
```
...
```bash
$ module load quay.io/biocontainers/r-quilt/2.0.1--r43hdbdd923_0
$ module help quay.io/biocontainers/r-quilt/2.0.1--r43hdbdd923_0
```
