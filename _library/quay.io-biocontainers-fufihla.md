...
updated_at: "2026-04-03 05:18:28.282795"
...
```bash
$ shpc install quay.io/biocontainers/fufihla:0.2.4--hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/fufihla/0.2.4--hdfd78af_1
$ module help quay.io/biocontainers/fufihla/0.2.4--hdfd78af_1
```
