...
updated_at: "2026-03-09 04:26:02.283640"
latest: "0.2.4--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/fufihla:0.2.4--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/fufihla/0.2.4--hdfd78af_0
$ module help quay.io/biocontainers/fufihla/0.2.4--hdfd78af_0
```
