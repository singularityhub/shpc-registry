...
updated_at: "2025-12-21 03:48:37.972197"
...
```bash
$ shpc install quay.io/biocontainers/hmftools-cobalt:2.2--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hmftools-cobalt/2.2--hdfd78af_0
$ module help quay.io/biocontainers/hmftools-cobalt/2.2--hdfd78af_0
```
