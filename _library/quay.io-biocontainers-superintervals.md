...
updated_at: "2026-09-05 07:43:20.703510"
latest: "1.0.0--py310h96c7dba_0"
...
```bash
$ shpc install quay.io/biocontainers/superintervals:1.0.0--py310h96c7dba_0
```
...
```bash
$ module load quay.io/biocontainers/superintervals/1.0.0--py310h96c7dba_0
$ module help quay.io/biocontainers/superintervals/1.0.0--py310h96c7dba_0
```
