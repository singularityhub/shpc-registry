...
updated_at: "2025-05-15 04:09:44.519425"
latest: "0.2.10--py311h8ddd9a4_1"
...
```bash
$ shpc install quay.io/biocontainers/superintervals:0.2.10--py311h8ddd9a4_1
```
...
```bash
$ module load quay.io/biocontainers/superintervals/0.2.10--py311h8ddd9a4_1
$ module help quay.io/biocontainers/superintervals/0.2.10--py311h8ddd9a4_1
```
