...
updated_at: "2024-08-06 02:44:32.605080"
latest: "0.12.3--py38hda86a2d_2"
...
```bash
$ shpc install quay.io/biocontainers/fastobo:0.12.3--py38hda86a2d_2
```
...
```bash
$ module load quay.io/biocontainers/fastobo/0.12.3--py38hda86a2d_2
$ module help quay.io/biocontainers/fastobo/0.12.3--py38hda86a2d_2
```
