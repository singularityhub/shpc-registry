...
updated_at: "2023-07-17 03:56:28.174717"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-chromvar:1.20.0--r42hf17093f_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-chromvar/1.20.0--r42hf17093f_1
$ module help quay.io/biocontainers/bioconductor-chromvar/1.20.0--r42hf17093f_1
```
