...
updated_at: "2022-11-21 13:41:32.970201"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-chromvar:1.8.0--r36he1b5a44_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-chromvar/1.8.0--r36he1b5a44_0
$ module help quay.io/biocontainers/bioconductor-chromvar/1.8.0--r36he1b5a44_0
```
