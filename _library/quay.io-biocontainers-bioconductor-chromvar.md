...
updated_at: "2023-09-22 03:03:50.085771"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-chromvar:1.22.1--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-chromvar/1.22.1--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-chromvar/1.22.1--r43hf17093f_0
```
