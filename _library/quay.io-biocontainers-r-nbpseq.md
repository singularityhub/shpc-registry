...
updated_at: "2026-04-04 05:16:34.242825"
latest: "0.3.1--r45hf7ecca6_5"
...
```bash
$ shpc install quay.io/biocontainers/r-nbpseq:0.3.1--r45hf7ecca6_5
```
...
```bash
$ module load quay.io/biocontainers/r-nbpseq/0.3.1--r45hf7ecca6_5
$ module help quay.io/biocontainers/r-nbpseq/0.3.1--r45hf7ecca6_5
```
