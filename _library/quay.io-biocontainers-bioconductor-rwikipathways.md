...
updated_at: "2022-11-03 01:09:38.598561"
latest: "1.8.2--r40_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rwikipathways:1.8.2--r40_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rwikipathways/1.8.2--r40_0
$ module help quay.io/biocontainers/bioconductor-rwikipathways/1.8.2--r40_0
```
