...
updated_at: "2026-02-26 04:46:31.102945"
latest: "1.30.0--r45hdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rwikipathways:1.30.0--r45hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rwikipathways/1.30.0--r45hdfd78af_1
$ module help quay.io/biocontainers/bioconductor-rwikipathways/1.30.0--r45hdfd78af_1
```
