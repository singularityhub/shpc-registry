...
updated_at: "2024-03-17 02:56:16.735221"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rwikipathways:1.22.1--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rwikipathways/1.22.1--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rwikipathways/1.22.1--r43hdfd78af_0
```
