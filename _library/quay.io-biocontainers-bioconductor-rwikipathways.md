...
updated_at: "2025-10-02 03:47:39.064363"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rwikipathways:1.26.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rwikipathways/1.26.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rwikipathways/1.26.0--r44hdfd78af_0
```
