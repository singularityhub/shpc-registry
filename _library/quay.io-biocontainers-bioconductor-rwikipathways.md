...
updated_at: "2026-02-06 04:32:13.708691"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rwikipathways:1.30.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rwikipathways/1.30.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rwikipathways/1.30.0--r44hdfd78af_0
```
