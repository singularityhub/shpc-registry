...
updated_at: "2022-11-03 00:45:26.773808"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-path2ppi:1.8.0--r3.4.1_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-path2ppi/1.8.0--r3.4.1_0
$ module help quay.io/biocontainers/bioconductor-path2ppi/1.8.0--r3.4.1_0
```
