...
updated_at: "2026-04-01 05:36:50.084883"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-path2ppi:1.40.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-path2ppi/1.40.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-path2ppi/1.40.0--r45hdfd78af_0
```
