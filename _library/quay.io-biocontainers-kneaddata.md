...
updated_at: "2026-01-15 03:47:56.257838"
latest: "0.12.4--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/kneaddata:0.12.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/kneaddata/0.12.4--pyhdfd78af_0
$ module help quay.io/biocontainers/kneaddata/0.12.4--pyhdfd78af_0
```
