...
updated_at: "2025-10-12 03:07:48.024784"
...
```bash
$ shpc install quay.io/biocontainers/kneaddata:0.12.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/kneaddata/0.12.3--pyhdfd78af_0
$ module help quay.io/biocontainers/kneaddata/0.12.3--pyhdfd78af_0
```
