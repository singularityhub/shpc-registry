...
updated_at: "2025-02-22 03:07:32.410435"
...
```bash
$ shpc install quay.io/biocontainers/kneaddata:0.12.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/kneaddata/0.12.1--pyhdfd78af_0
$ module help quay.io/biocontainers/kneaddata/0.12.1--pyhdfd78af_0
```
