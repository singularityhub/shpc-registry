...
updated_at: "2025-10-27 03:27:53.824344"
latest: "4.7.29--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/mzmine:4.7.29--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mzmine/4.7.29--hdfd78af_0
$ module help quay.io/biocontainers/mzmine/4.7.29--hdfd78af_0
```
