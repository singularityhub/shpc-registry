...
updated_at: "2023-09-28 03:03:16.686183"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-microbiomebenchmarkdata:1.2.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-microbiomebenchmarkdata/1.2.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-microbiomebenchmarkdata/1.2.0--r43hdfd78af_0
```
