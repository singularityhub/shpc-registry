...
updated_at: "2023-05-30 03:13:55.926814"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-microbiomebenchmarkdata:1.0.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-microbiomebenchmarkdata/1.0.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-microbiomebenchmarkdata/1.0.0--r42hdfd78af_0
```
