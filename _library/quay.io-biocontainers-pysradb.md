...
updated_at: "2023-06-13 03:18:18.044495"
...
```bash
$ shpc install quay.io/biocontainers/pysradb:2.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pysradb/2.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/pysradb/2.1.0--pyhdfd78af_0
```
