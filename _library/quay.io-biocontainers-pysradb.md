...
updated_at: "2024-05-04 02:40:08.126167"
...
```bash
$ shpc install quay.io/biocontainers/pysradb:2.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pysradb/2.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/pysradb/2.2.0--pyhdfd78af_0
```
