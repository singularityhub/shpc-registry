...
updated_at: "2024-10-22 02:53:58.066374"
...
```bash
$ shpc install quay.io/biocontainers/pysradb:2.2.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pysradb/2.2.1--pyhdfd78af_0
$ module help quay.io/biocontainers/pysradb/2.2.1--pyhdfd78af_0
```
