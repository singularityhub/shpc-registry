...
updated_at: "2025-09-26 03:26:27.915357"
...
```bash
$ shpc install quay.io/biocontainers/pysradb:2.2.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pysradb/2.2.2--pyhdfd78af_0
$ module help quay.io/biocontainers/pysradb/2.2.2--pyhdfd78af_0
```
