...
updated_at: "2022-11-09 00:26:04.374033"
latest: "3.8.0--r351_0"
container_url: "https://biocontainers.pro/tools/bioconductor-mafdb.gnomadex.r2.0.1.hs37d5"
aliases:
 - ".bioconductor-mafdb.gnomadex.r2.0.1.hs37d5-post-link.sh"
 - ".bioconductor-mafdb.gnomadex.r2.0.1.hs37d5-pre-unlink.sh"
 - "wget"
 - "c89"
 - "c99"
versions:
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-mafdb.gnomadex.r2.0.1.hs37d5-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-mafdb.gnomadex.r2.0.1.hs37d5-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-mafdb.gnomadex.r2.0.1.hs37d5-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-mafdb.gnomadex.r2.0.1.hs37d5-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-mafdb.gnomadex.r2.0.1.hs37d5-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-mafdb.gnomadex.r2.0.1.hs37d5-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
