...
updated_at: "2023-03-18 03:18:50.511641"
latest: "1.34.8--r42hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-genomeinfodb:1.34.8--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-genomeinfodb/1.34.8--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-genomeinfodb/1.34.8--r42hdfd78af_0
```
