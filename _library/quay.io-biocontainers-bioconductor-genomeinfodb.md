...
updated_at: "2026-04-05 04:46:03.703048"
latest: "1.46.2--r45hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-genomeinfodb:1.46.2--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-genomeinfodb/1.46.2--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-genomeinfodb/1.46.2--r45hdfd78af_0
```
