...
updated_at: "2025-01-25 03:00:46.900006"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-genomeinfodb:1.42.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-genomeinfodb/1.42.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-genomeinfodb/1.42.0--r44hdfd78af_0
```
