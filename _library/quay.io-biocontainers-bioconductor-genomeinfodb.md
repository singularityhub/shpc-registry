...
updated_at: "2025-12-05 03:24:55.951286"
latest: "1.42.0--r44hdfd78af_2"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-genomeinfodb:1.42.0--r44hdfd78af_2
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-genomeinfodb/1.42.0--r44hdfd78af_2
$ module help quay.io/biocontainers/bioconductor-genomeinfodb/1.42.0--r44hdfd78af_2
```
