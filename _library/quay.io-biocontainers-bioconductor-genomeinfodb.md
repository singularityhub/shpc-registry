...
updated_at: "2022-11-03 01:05:45.442426"
latest: "1.6.3--0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-genomeinfodb:1.6.3--0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-genomeinfodb/1.6.3--0
$ module help quay.io/biocontainers/bioconductor-genomeinfodb/1.6.3--0
```
