...
updated_at: "2023-09-16 03:03:15.895215"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-genomeinfodb:1.36.1--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-genomeinfodb/1.36.1--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-genomeinfodb/1.36.1--r43hdfd78af_0
```
