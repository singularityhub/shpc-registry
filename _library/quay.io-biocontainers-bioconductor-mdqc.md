...
updated_at: "2026-02-22 04:49:08.722359"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mdqc:1.72.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mdqc/1.72.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-mdqc/1.72.0--r45hdfd78af_0
```
