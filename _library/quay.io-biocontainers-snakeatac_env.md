...
updated_at: "2025-08-30 03:23:43.509401"
...
```bash
$ shpc install quay.io/biocontainers/snakeatac_env:0.1.1--pyha70a07d_0
```
...
```bash
$ module load quay.io/biocontainers/snakeatac_env/0.1.1--pyha70a07d_0
$ module help quay.io/biocontainers/snakeatac_env/0.1.1--pyha70a07d_0
```
