...
updated_at: "2022-10-27 01:12:36.046158"
latest: "0.0.2--py_1"
...
```bash
$ singularity exec <container> /usr/local/bin/manual.md
$ podman run --it --rm --entrypoint /usr/local/bin/manual.md   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/manual.md   -v ${PWD} -w ${PWD} <container> -c " $@"
```
