...
updated_at: "2024-05-22 03:06:06.910155"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-bsseqdata:0.40.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-bsseqdata/0.40.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-bsseqdata/0.40.0--r43hdfd78af_0
```
