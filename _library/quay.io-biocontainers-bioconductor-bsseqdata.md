...
updated_at: "2026-03-20 05:09:52.420790"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-bsseqdata:0.48.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-bsseqdata/0.48.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-bsseqdata/0.48.0--r45hdfd78af_0
```
