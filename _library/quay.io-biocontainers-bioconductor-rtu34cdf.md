...
updated_at: "2026-03-05 00:15:04.012227"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rtu34cdf:2.18.0--r45hdfd78af_14
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rtu34cdf/2.18.0--r45hdfd78af_14
$ module help quay.io/biocontainers/bioconductor-rtu34cdf/2.18.0--r45hdfd78af_14
```
