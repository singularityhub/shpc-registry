...
updated_at: "2024-04-07 02:29:42.226408"
latest: "1.3.9--py310hf270fc4_4"
...
```bash
$ shpc install quay.io/biocontainers/ntlink:1.3.9--py310hf270fc4_4
```
...
```bash
$ module load quay.io/biocontainers/ntlink/1.3.9--py310hf270fc4_4
$ module help quay.io/biocontainers/ntlink/1.3.9--py310hf270fc4_4
```
