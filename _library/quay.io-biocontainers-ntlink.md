...
updated_at: "2026-04-05 04:49:54.697907"
...
```bash
$ shpc install quay.io/biocontainers/ntlink:1.3.11--py313h380480a_2
```
...
```bash
$ module load quay.io/biocontainers/ntlink/1.3.11--py313h380480a_2
$ module help quay.io/biocontainers/ntlink/1.3.11--py313h380480a_2
```
