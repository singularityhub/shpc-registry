...
updated_at: "2024-06-27 02:35:54.080068"
latest: "1.3.10--py310hf270fc4_0"
...
```bash
$ shpc install quay.io/biocontainers/ntlink:1.3.10--py310hf270fc4_0
```
...
```bash
$ module load quay.io/biocontainers/ntlink/1.3.10--py310hf270fc4_0
$ module help quay.io/biocontainers/ntlink/1.3.10--py310hf270fc4_0
```
