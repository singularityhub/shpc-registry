...
updated_at: "2022-11-02 19:07:13.728322"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-dta:2.40.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-dta/2.40.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-dta/2.40.0--r41hdfd78af_0
```
