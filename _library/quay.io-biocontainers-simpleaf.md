...
updated_at: "2023-05-07 02:51:55.483954"
latest: "0.13.0--h9f5acd7_0"
...
```bash
$ shpc install quay.io/biocontainers/simpleaf:0.13.0--h9f5acd7_0
```
...
```bash
$ module load quay.io/biocontainers/simpleaf/0.13.0--h9f5acd7_0
$ module help quay.io/biocontainers/simpleaf/0.13.0--h9f5acd7_0
```
