...
updated_at: "2024-12-07 03:07:14.106882"
latest: "0.17.4--h919a2d8_0"
...
```bash
$ shpc install quay.io/biocontainers/simpleaf:0.17.4--h919a2d8_0
```
...
```bash
$ module load quay.io/biocontainers/simpleaf/0.17.4--h919a2d8_0
$ module help quay.io/biocontainers/simpleaf/0.17.4--h919a2d8_0
```
