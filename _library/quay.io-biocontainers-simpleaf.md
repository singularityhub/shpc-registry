...
updated_at: "2025-02-24 03:18:17.496098"
...
```bash
$ shpc install quay.io/biocontainers/simpleaf:0.19.1--ha6fb395_0
```
...
```bash
$ module load quay.io/biocontainers/simpleaf/0.19.1--ha6fb395_0
$ module help quay.io/biocontainers/simpleaf/0.19.1--ha6fb395_0
```
