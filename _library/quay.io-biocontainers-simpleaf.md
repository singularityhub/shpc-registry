...
updated_at: "2024-08-01 04:00:26.898422"
latest: "0.17.0--h919a2d8_1"
...
```bash
$ shpc install quay.io/biocontainers/simpleaf:0.17.0--h919a2d8_1
```
...
```bash
$ module load quay.io/biocontainers/simpleaf/0.17.0--h919a2d8_1
$ module help quay.io/biocontainers/simpleaf/0.17.0--h919a2d8_1
```
