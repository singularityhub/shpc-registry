...
updated_at: "2023-08-28 02:58:07.092841"
latest: "0.14.1--h4ac6f70_0"
...
```bash
$ shpc install quay.io/biocontainers/simpleaf:0.14.1--h4ac6f70_0
```
...
```bash
$ module load quay.io/biocontainers/simpleaf/0.14.1--h4ac6f70_0
$ module help quay.io/biocontainers/simpleaf/0.14.1--h4ac6f70_0
```
