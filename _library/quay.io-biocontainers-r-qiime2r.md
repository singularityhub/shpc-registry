...
updated_at: "2026-03-23 05:33:51.603106"
latest: "0.99.20--r45hdfd78af_2"
...
```bash
$ shpc install quay.io/biocontainers/r-qiime2r:0.99.20--r45hdfd78af_2
```
...
```bash
$ module load quay.io/biocontainers/r-qiime2r/0.99.20--r45hdfd78af_2
$ module help quay.io/biocontainers/r-qiime2r/0.99.20--r45hdfd78af_2
```
