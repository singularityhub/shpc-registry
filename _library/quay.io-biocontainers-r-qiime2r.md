...
updated_at: "2025-10-24 03:48:00.502759"
...
```bash
$ shpc install quay.io/biocontainers/r-qiime2r:0.99.20--r43hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/r-qiime2r/0.99.20--r43hdfd78af_1
$ module help quay.io/biocontainers/r-qiime2r/0.99.20--r43hdfd78af_1
```
