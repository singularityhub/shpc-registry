---
layout: container
name:  "quay.io/biocontainers/cospar"
maintainer: "@vsoch"
...
updated_at: "2026-04-23 05:15:57.925073"
...
```bash
$ shpc install quay.io/biocontainers/cospar
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/cospar:0.5.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/cospar/0.5.0--pyhdfd78af_0
$ module help quay.io/biocontainers/cospar/0.5.0--pyhdfd78af_0
```
...
#### cospar-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### cospar-inspect-deffile:
