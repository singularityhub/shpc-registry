...
updated_at: "2022-11-01 03:20:50.451239"
latest: "1.9.2--r40_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-tcgabiolinksgui.data:1.9.2--r40_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-tcgabiolinksgui.data/1.9.2--r40_0
$ module help quay.io/biocontainers/bioconductor-tcgabiolinksgui.data/1.9.2--r40_0
```
