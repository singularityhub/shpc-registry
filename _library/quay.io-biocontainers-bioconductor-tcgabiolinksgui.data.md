...
updated_at: "2026-04-03 04:55:16.655129"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-tcgabiolinksgui.data:1.30.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-tcgabiolinksgui.data/1.30.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-tcgabiolinksgui.data/1.30.0--r45hdfd78af_0
```
