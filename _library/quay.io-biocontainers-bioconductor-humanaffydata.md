...
updated_at: "2025-08-04 04:37:39.919909"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-humanaffydata:1.32.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-humanaffydata/1.32.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-humanaffydata/1.32.0--r44hdfd78af_0
```
