...
updated_at: "2026-04-28 05:37:05.091427"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-humanaffydata:1.36.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-humanaffydata/1.36.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-humanaffydata/1.36.0--r45hdfd78af_0
```
