...
updated_at: "2024-10-02 03:30:55.906801"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-humanaffydata:1.28.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-humanaffydata/1.28.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-humanaffydata/1.28.0--r43hdfd78af_0
```
