...
updated_at: "2022-11-03 00:26:48.172992"
latest: "1.8.0--r351_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-humanaffydata:1.8.0--r351_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-humanaffydata/1.8.0--r351_0
$ module help quay.io/biocontainers/bioconductor-humanaffydata/1.8.0--r351_0
```
