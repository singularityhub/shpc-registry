...
updated_at: "2023-11-16 03:27:50.147509"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-humanaffydata:1.26.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-humanaffydata/1.26.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-humanaffydata/1.26.0--r43hdfd78af_0
```
