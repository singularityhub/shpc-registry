...
updated_at: "2025-10-31 04:23:16.123677"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-siamcat:2.10.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-siamcat/2.10.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-siamcat/2.10.0--r44hdfd78af_0
```
