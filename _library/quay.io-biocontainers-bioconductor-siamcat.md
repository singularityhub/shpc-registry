...
updated_at: "2026-03-22 05:00:04.980358"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-siamcat:2.14.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-siamcat/2.14.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-siamcat/2.14.0--r45hdfd78af_0
```
