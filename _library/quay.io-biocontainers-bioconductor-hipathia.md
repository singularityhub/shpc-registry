...
updated_at: "2022-10-29 08:21:45.079888"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hipathia:2.8.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hipathia/2.8.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-hipathia/2.8.0--r41hdfd78af_0
```
