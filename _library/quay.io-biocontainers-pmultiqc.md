...
updated_at: "2026-01-30 04:31:44.283419"
...
```bash
$ shpc install quay.io/biocontainers/pmultiqc:0.0.40--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pmultiqc/0.0.40--pyhdfd78af_0
$ module help quay.io/biocontainers/pmultiqc/0.0.40--pyhdfd78af_0
```
