...
updated_at: "2024-12-03 03:36:22.230282"
...
```bash
$ shpc install quay.io/biocontainers/pmultiqc:0.0.25--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pmultiqc/0.0.25--pyhdfd78af_0
$ module help quay.io/biocontainers/pmultiqc/0.0.25--pyhdfd78af_0
```
