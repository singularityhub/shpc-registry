...
updated_at: "2024-02-16 02:29:19.845422"
...
```bash
$ shpc install quay.io/biocontainers/pmultiqc:0.0.23--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pmultiqc/0.0.23--pyhdfd78af_0
$ module help quay.io/biocontainers/pmultiqc/0.0.23--pyhdfd78af_0
```
