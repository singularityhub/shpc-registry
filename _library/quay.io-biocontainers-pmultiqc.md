...
updated_at: "2024-07-31 02:40:37.580931"
...
```bash
$ shpc install quay.io/biocontainers/pmultiqc:0.0.24--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pmultiqc/0.0.24--pyhdfd78af_0
$ module help quay.io/biocontainers/pmultiqc/0.0.24--pyhdfd78af_0
```
