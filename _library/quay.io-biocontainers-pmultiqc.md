...
updated_at: "2026-06-04 07:25:50.202046"
...
```bash
$ shpc install quay.io/biocontainers/pmultiqc:0.0.44--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pmultiqc/0.0.44--pyhdfd78af_0
$ module help quay.io/biocontainers/pmultiqc/0.0.44--pyhdfd78af_0
```
