---
layout: container
name:  "quay.io/biocontainers/bioconductor-mgnifyr"
maintainer: "@vsoch"
...
updated_at: "2025-08-16 03:23:05.496340"
...
versions:
 - "1.2.0--r44hdfd78af_0"
description: "singularity registry hpc automated addition for bioconductor-mgnifyr"
config: {"url": "https://biocontainers.pro/tools/bioconductor-mgnifyr", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for bioconductor-mgnifyr", "latest": {"1.2.0--r44hdfd78af_0": "sha256:a31d45b2f4408b083de7201a5666a644e4b7299de83da0652372146c5557f221"}, "tags": {"1.2.0--r44hdfd78af_0": "sha256:a31d45b2f4408b083de7201a5666a644e4b7299de83da0652372146c5557f221"}, "docker": "quay.io/biocontainers/bioconductor-mgnifyr", "aliases": {"pandoc-lua": "/usr/local/bin/pandoc-lua", "x86_64-conda-linux-gnu.cfg": "/usr/local/bin/x86_64-conda-linux-gnu.cfg", "idle3.13": "/usr/local/bin/idle3.13", "pydoc3.13": "/usr/local/bin/pydoc3.13", "python3.13": "/usr/local/bin/python3.13", "python3.13-config": "/usr/local/bin/python3.13-config", "pandoc-server": "/usr/local/bin/pandoc-server", "numpy-config": "/usr/local/bin/numpy-config", "glpsol": "/usr/local/bin/glpsol", "installBiocDataPackage.sh": "/usr/local/bin/installBiocDataPackage.sh", "tomlq": "/usr/local/bin/tomlq", "xq": "/usr/local/bin/xq", "yq": "/usr/local/bin/yq", "jq": "/usr/local/bin/jq", "onig-config": "/usr/local/bin/onig-config", "pandoc": "/usr/local/bin/pandoc", "hb-info": "/usr/local/bin/hb-info", "activate-global-python-argcomplete": "/usr/local/bin/activate-global-python-argcomplete", "python-argcomplete-check-easy-install-script": "/usr/local/bin/python-argcomplete-check-easy-install-script", "register-python-argcomplete": "/usr/local/bin/register-python-argcomplete", "tjbench": "/usr/local/bin/tjbench"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/bioconductor-mgnifyr.
singularity registry hpc automated addition for bioconductor-mgnifyr
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/bioconductor-mgnifyr
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-mgnifyr:1.2.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mgnifyr/1.2.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-mgnifyr/1.2.0--r44hdfd78af_0
```
...
#### bioconductor-mgnifyr-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-mgnifyr-inspect-deffile:
