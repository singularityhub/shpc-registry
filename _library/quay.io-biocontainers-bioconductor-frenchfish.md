...
updated_at: "2024-09-07 02:52:55.601171"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-frenchfish:1.14.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-frenchfish/1.14.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-frenchfish/1.14.0--r43hdfd78af_0
```
