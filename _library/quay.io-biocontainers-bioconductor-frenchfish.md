...
updated_at: "2023-02-28 03:27:17.846890"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-frenchfish:1.10.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-frenchfish/1.10.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-frenchfish/1.10.0--r42hdfd78af_0
```
