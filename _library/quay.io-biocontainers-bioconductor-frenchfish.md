...
updated_at: "2026-03-29 05:30:58.890266"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-frenchfish:1.22.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-frenchfish/1.22.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-frenchfish/1.22.0--r45hdfd78af_0
```
