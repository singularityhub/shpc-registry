...
updated_at: "2022-11-09 00:17:32.212123"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-famat:1.4.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-famat/1.4.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-famat/1.4.0--r41hdfd78af_0
```
