...
updated_at: "2023-11-06 02:35:14.723106"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-simffpe:1.12.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-simffpe/1.12.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-simffpe/1.12.0--r43hdfd78af_0
```
