...
updated_at: "2022-10-29 05:35:00.589474"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-simffpe:1.6.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-simffpe/1.6.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-simffpe/1.6.0--r41hdfd78af_0
```
