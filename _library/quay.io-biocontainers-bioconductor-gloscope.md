...
updated_at: "2024-04-09 02:29:55.420425"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gloscope:1.0.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gloscope/1.0.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-gloscope/1.0.0--r43hdfd78af_0
```
