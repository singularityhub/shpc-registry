...
updated_at: "2026-03-30 05:55:36.309931"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gloscope:2.0.1--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gloscope/2.0.1--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-gloscope/2.0.1--r45hdfd78af_0
```
