...
updated_at: "2024-04-20 02:33:49.048097"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-trajectoryutils:1.10.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-trajectoryutils/1.10.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-trajectoryutils/1.10.0--r43hdfd78af_0
```
