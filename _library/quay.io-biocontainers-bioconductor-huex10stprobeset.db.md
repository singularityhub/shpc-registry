...
updated_at: "2024-04-15 04:29:57.074963"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-huex10stprobeset.db:8.8.0--r43hdfd78af_4
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-huex10stprobeset.db/8.8.0--r43hdfd78af_4
$ module help quay.io/biocontainers/bioconductor-huex10stprobeset.db/8.8.0--r43hdfd78af_4
```
