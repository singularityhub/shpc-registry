...
updated_at: "2022-11-02 00:42:20.241773"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-paxtoolsr:1.28.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-paxtoolsr/1.28.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-paxtoolsr/1.28.0--r41hdfd78af_0
```
