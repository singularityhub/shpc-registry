...
updated_at: "2026-06-22 02:11:29.621511"
...
```bash
$ shpc install quay.io/biocontainers/anospp-analysis:0.5.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/anospp-analysis/0.5.0--pyhdfd78af_0
$ module help quay.io/biocontainers/anospp-analysis/0.5.0--pyhdfd78af_0
```
