...
updated_at: "2025-10-22 04:06:12.196294"
...
```bash
$ shpc install quay.io/biocontainers/anospp-analysis:0.4.0--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/anospp-analysis/0.4.0--pyhdfd78af_1
$ module help quay.io/biocontainers/anospp-analysis/0.4.0--pyhdfd78af_1
```
