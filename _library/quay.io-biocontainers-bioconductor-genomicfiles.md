...
updated_at: "2022-11-07 00:39:38.747576"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-genomicfiles:1.30.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-genomicfiles/1.30.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-genomicfiles/1.30.0--r41hdfd78af_0
```
