---
layout: container
name:  "quay.io/biocontainers/enzywizard-mut-integrate"
maintainer: "@vsoch"
...
updated_at: "2026-06-26 06:29:35.828108"
...
singularity registry hpc automated addition for enzywizard-mut-integrate
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/enzywizard-mut-integrate
```
...
#### enzywizard-mut-integrate-shell:
...
#### enzywizard-mut-integrate-inspect:
...
#### enzywizard-mut-integrate-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### enzywizard-mut-integrate-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/enzywizard-mut_integrate
$ podman run --it --rm --entrypoint /usr/local/bin/enzywizard-mut_integrate   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/enzywizard-mut_integrate   -v ${PWD} -w ${PWD} <container> -c " $@"
```
