...
updated_at: "2024-03-15 02:29:12.369019"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-scvir:1.2.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-scvir/1.2.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-scvir/1.2.0--r43hdfd78af_0
```
