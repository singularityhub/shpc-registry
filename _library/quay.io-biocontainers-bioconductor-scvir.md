...
updated_at: "2023-12-14 02:45:11.250814"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-scvir:1.0.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-scvir/1.0.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-scvir/1.0.0--r43hdfd78af_0
```
