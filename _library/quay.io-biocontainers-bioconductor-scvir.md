...
updated_at: "2025-10-16 03:41:44.126988"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-scvir:1.6.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-scvir/1.6.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-scvir/1.6.0--r44hdfd78af_0
```
