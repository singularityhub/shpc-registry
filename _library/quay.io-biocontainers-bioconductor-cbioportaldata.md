...
updated_at: "2023-11-27 03:04:54.382756"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cbioportaldata:2.12.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cbioportaldata/2.12.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-cbioportaldata/2.12.0--r43hdfd78af_0
```
