...
updated_at: "2026-03-29 04:54:22.760757"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mapscape:1.34.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mapscape/1.34.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-mapscape/1.34.0--r45hdfd78af_0
```
