...
updated_at: "2022-11-17 03:04:29.733601"
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-yeastgsdata-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-yeastgsdata-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-yeastgsdata-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-yeastgsdata-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-yeastgsdata-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-yeastgsdata-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
