...
updated_at: "2024-08-03 03:14:27.540686"
...
```bash
$ shpc install quay.io/biocontainers/resfinder:4.5.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/resfinder/4.5.0--pyhdfd78af_0
$ module help quay.io/biocontainers/resfinder/4.5.0--pyhdfd78af_0
```
