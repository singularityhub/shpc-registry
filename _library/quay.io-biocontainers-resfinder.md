...
updated_at: "2025-09-26 03:43:47.991194"
latest: "4.7.2--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/resfinder:4.7.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/resfinder/4.7.2--pyhdfd78af_0
$ module help quay.io/biocontainers/resfinder/4.7.2--pyhdfd78af_0
```
