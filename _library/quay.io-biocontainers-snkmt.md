...
updated_at: "2026-04-03 04:55:18.477825"
...
```bash
$ shpc install quay.io/biocontainers/snkmt:0.4.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snkmt/0.4.0--pyhdfd78af_0
$ module help quay.io/biocontainers/snkmt/0.4.0--pyhdfd78af_0
```
