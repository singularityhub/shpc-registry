...
updated_at: "2023-11-23 02:50:33.115691"
latest: "1.14--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/virstrain:1.14--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/virstrain/1.14--pyhdfd78af_0
$ module help quay.io/biocontainers/virstrain/1.14--pyhdfd78af_0
```
