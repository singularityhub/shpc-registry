...
updated_at: "2026-04-05 05:01:57.039390"
...
```bash
$ shpc install quay.io/biocontainers/metafun:1.0.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/metafun/1.0.0--hdfd78af_0
$ module help quay.io/biocontainers/metafun/1.0.0--hdfd78af_0
```
