...
updated_at: "2024-12-17 03:24:52.026371"
latest: "0.20.0--h43eeafb_0"
...
```bash
$ shpc install quay.io/biocontainers/hifiasm:0.20.0--h43eeafb_0
```
...
```bash
$ module load quay.io/biocontainers/hifiasm/0.20.0--h43eeafb_0
$ module help quay.io/biocontainers/hifiasm/0.20.0--h43eeafb_0
```
