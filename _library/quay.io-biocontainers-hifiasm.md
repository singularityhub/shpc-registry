...
updated_at: "2025-02-14 03:23:42.751197"
latest: "0.24.0--h5ca1c30_0"
...
```bash
$ shpc install quay.io/biocontainers/hifiasm:0.24.0--h5ca1c30_0
```
...
```bash
$ module load quay.io/biocontainers/hifiasm/0.24.0--h5ca1c30_0
$ module help quay.io/biocontainers/hifiasm/0.24.0--h5ca1c30_0
```
