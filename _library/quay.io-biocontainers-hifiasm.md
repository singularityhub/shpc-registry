...
updated_at: "2023-09-10 02:34:49.941853"
latest: "0.19.6--h43eeafb_0"
...
```bash
$ shpc install quay.io/biocontainers/hifiasm:0.19.6--h43eeafb_0
```
...
```bash
$ module load quay.io/biocontainers/hifiasm/0.19.6--h43eeafb_0
$ module help quay.io/biocontainers/hifiasm/0.19.6--h43eeafb_0
```
