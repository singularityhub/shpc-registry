...
updated_at: "2022-12-08 03:06:23.237538"
latest: "0.16.1--h5b5514e_1"
...
```bash
$ shpc install quay.io/biocontainers/hifiasm:0.16.1--h5b5514e_1
```
...
```bash
$ module load quay.io/biocontainers/hifiasm/0.16.1--h5b5514e_1
$ module help quay.io/biocontainers/hifiasm/0.16.1--h5b5514e_1
```
