...
updated_at: "2023-08-18 02:43:52.184512"
latest: "0.19.5--h43eeafb_2"
...
```bash
$ shpc install quay.io/biocontainers/hifiasm:0.19.5--h43eeafb_2
```
...
```bash
$ module load quay.io/biocontainers/hifiasm/0.19.5--h43eeafb_2
$ module help quay.io/biocontainers/hifiasm/0.19.5--h43eeafb_2
```
