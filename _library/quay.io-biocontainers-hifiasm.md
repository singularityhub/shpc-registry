...
updated_at: "2023-10-26 02:35:04.111534"
latest: "0.19.7--h43eeafb_0"
...
```bash
$ shpc install quay.io/biocontainers/hifiasm:0.19.7--h43eeafb_0
```
...
```bash
$ module load quay.io/biocontainers/hifiasm/0.19.7--h43eeafb_0
$ module help quay.io/biocontainers/hifiasm/0.19.7--h43eeafb_0
```
