...
updated_at: "2024-10-05 02:49:44.124555"
latest: "0.19.9--h43eeafb_0"
...
```bash
$ shpc install quay.io/biocontainers/hifiasm:0.19.9--h43eeafb_0
```
...
```bash
$ module load quay.io/biocontainers/hifiasm/0.19.9--h43eeafb_0
$ module help quay.io/biocontainers/hifiasm/0.19.9--h43eeafb_0
```
