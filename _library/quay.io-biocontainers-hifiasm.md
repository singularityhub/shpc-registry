...
updated_at: "2023-04-12 02:36:48.290943"
latest: "0.19.2--h5b5514e_0"
...
```bash
$ shpc install quay.io/biocontainers/hifiasm:0.19.2--h5b5514e_0
```
...
```bash
$ module load quay.io/biocontainers/hifiasm/0.19.2--h5b5514e_0
$ module help quay.io/biocontainers/hifiasm/0.19.2--h5b5514e_0
```
