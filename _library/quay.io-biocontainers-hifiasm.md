...
updated_at: "2023-05-01 03:08:11.716822"
latest: "0.19.5--h5b5514e_0"
...
```bash
$ shpc install quay.io/biocontainers/hifiasm:0.19.5--h5b5514e_0
```
...
```bash
$ module load quay.io/biocontainers/hifiasm/0.19.5--h5b5514e_0
$ module help quay.io/biocontainers/hifiasm/0.19.5--h5b5514e_0
```
