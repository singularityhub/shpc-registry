...
updated_at: "2025-04-01 03:31:04.037996"
latest: "1.2.3--py312hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/pathphynder:1.2.3--py312hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pathphynder/1.2.3--py312hdfd78af_0
$ module help quay.io/biocontainers/pathphynder/1.2.3--py312hdfd78af_0
```
