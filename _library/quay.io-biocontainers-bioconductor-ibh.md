...
updated_at: "2025-07-30 04:14:04.841123"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ibh:1.54.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ibh/1.54.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ibh/1.54.0--r44hdfd78af_0
```
