...
updated_at: "2023-11-30 02:40:34.947358"
...
```bash
$ shpc install quay.io/biocontainers/r-ramclustr:1.3.1--r43h3342da4_0
```
...
```bash
$ module load quay.io/biocontainers/r-ramclustr/1.3.1--r43h3342da4_0
$ module help quay.io/biocontainers/r-ramclustr/1.3.1--r43h3342da4_0
```
