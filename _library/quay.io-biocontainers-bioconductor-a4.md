...
updated_at: "2024-08-17 02:47:20.662561"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-a4:1.50.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-a4/1.50.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-a4/1.50.0--r43hdfd78af_0
```
