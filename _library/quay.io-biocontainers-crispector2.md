...
updated_at: "2023-11-08 02:42:21.097603"
...
```bash
$ shpc install quay.io/biocontainers/crispector2:2.0.6--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/crispector2/2.0.6--pyhdfd78af_0
$ module help quay.io/biocontainers/crispector2/2.0.6--pyhdfd78af_0
```
