---
layout: container
name:  "quay.io/biocontainers/crispector2"
maintainer: "@vsoch"
...
updated_at: "2023-09-03 02:55:34.188397"
...
```bash
$ shpc install quay.io/biocontainers/crispector2
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/crispector2:2.0.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/crispector2/2.0.4--pyhdfd78af_0
$ module help quay.io/biocontainers/crispector2/2.0.4--pyhdfd78af_0
```
...
#### crispector2-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### crispector2-inspect-deffile:
