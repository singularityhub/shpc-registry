...
updated_at: "2025-11-28 03:33:02.278416"
...
```bash
$ shpc install quay.io/biocontainers/prodigal-gv:2.11.0--h577a1d6_5
```
...
```bash
$ module load quay.io/biocontainers/prodigal-gv/2.11.0--h577a1d6_5
$ module help quay.io/biocontainers/prodigal-gv/2.11.0--h577a1d6_5
```
