...
updated_at: "2026-04-03 04:33:03.119560"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gagedata:2.48.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gagedata/2.48.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-gagedata/2.48.0--r45hdfd78af_0
```
