...
updated_at: "2026-03-20 05:03:29.736224"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-human1mv1ccrlmm:1.0.3--r45hdfd78af_14
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-human1mv1ccrlmm/1.0.3--r45hdfd78af_14
$ module help quay.io/biocontainers/bioconductor-human1mv1ccrlmm/1.0.3--r45hdfd78af_14
```
