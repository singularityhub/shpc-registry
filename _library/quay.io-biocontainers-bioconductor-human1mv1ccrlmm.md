...
```bash
$ shpc install quay.io/biocontainers/bioconductor-human1mv1ccrlmm:1.0.3--r41hdfd78af_9
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-human1mv1ccrlmm/1.0.3--r41hdfd78af_9
$ module help quay.io/biocontainers/bioconductor-human1mv1ccrlmm/1.0.3--r41hdfd78af_9
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-human1mv1ccrlmm-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-human1mv1ccrlmm-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-human1mv1ccrlmm-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-human1mv1ccrlmm-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-human1mv1ccrlmm-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-human1mv1ccrlmm-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
