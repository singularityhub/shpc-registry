...
updated_at: "2022-10-27 00:21:15.364171"
latest: "3.2.2--r40_9"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-txdb.hsapiens.ucsc.hg18.knowngene:3.2.2--r40_9
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-txdb.hsapiens.ucsc.hg18.knowngene/3.2.2--r40_9
$ module help quay.io/biocontainers/bioconductor-txdb.hsapiens.ucsc.hg18.knowngene/3.2.2--r40_9
```
