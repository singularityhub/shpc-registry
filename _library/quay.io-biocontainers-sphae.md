...
updated_at: "2025-04-04 03:26:03.403671"
...
```bash
$ shpc install quay.io/biocontainers/sphae:1.4.8--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sphae/1.4.8--pyhdfd78af_0
$ module help quay.io/biocontainers/sphae/1.4.8--pyhdfd78af_0
```
