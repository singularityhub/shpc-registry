...
updated_at: "2024-06-12 03:18:45.437999"
...
```bash
$ shpc install quay.io/biocontainers/sphae:1.3.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sphae/1.3.4--pyhdfd78af_0
$ module help quay.io/biocontainers/sphae/1.3.4--pyhdfd78af_0
```
