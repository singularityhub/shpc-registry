...
updated_at: "2026-03-17 05:01:28.649081"
...
```bash
$ shpc install quay.io/biocontainers/sphae:1.5.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sphae/1.5.4--pyhdfd78af_0
$ module help quay.io/biocontainers/sphae/1.5.4--pyhdfd78af_0
```
