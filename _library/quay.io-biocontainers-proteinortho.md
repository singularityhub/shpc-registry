...
updated_at: "2025-05-27 12:21:45.302111"
latest: "6.3.5--h2b77389_1"
...
```bash
$ shpc install quay.io/biocontainers/proteinortho:6.3.5--h2b77389_1
```
...
```bash
$ module load quay.io/biocontainers/proteinortho/6.3.5--h2b77389_1
$ module help quay.io/biocontainers/proteinortho/6.3.5--h2b77389_1
```
