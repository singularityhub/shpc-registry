...
updated_at: "2025-04-28 04:05:55.618666"
latest: "6.3.5--h749629c_0"
...
```bash
$ shpc install quay.io/biocontainers/proteinortho:6.3.5--h749629c_0
```
...
```bash
$ module load quay.io/biocontainers/proteinortho/6.3.5--h749629c_0
$ module help quay.io/biocontainers/proteinortho/6.3.5--h749629c_0
```
