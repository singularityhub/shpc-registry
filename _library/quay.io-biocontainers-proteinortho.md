...
updated_at: "2025-08-07 10:09:40.340614"
latest: "6.3.6--h2b77389_0"
...
```bash
$ shpc install quay.io/biocontainers/proteinortho:6.3.6--h2b77389_0
```
...
```bash
$ module load quay.io/biocontainers/proteinortho/6.3.6--h2b77389_0
$ module help quay.io/biocontainers/proteinortho/6.3.6--h2b77389_0
```
