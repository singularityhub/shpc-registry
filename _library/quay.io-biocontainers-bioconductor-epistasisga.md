...
updated_at: "2023-10-02 02:50:37.345922"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-epistasisga:1.2.1--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-epistasisga/1.2.1--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-epistasisga/1.2.1--r43hf17093f_0
```
