...
updated_at: "2023-09-24 02:52:11.809288"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-yeastcc:1.40.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-yeastcc/1.40.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-yeastcc/1.40.0--r43hdfd78af_0
```
