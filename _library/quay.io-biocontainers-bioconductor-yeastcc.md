...
updated_at: "2026-04-05 04:58:26.041567"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-yeastcc:1.50.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-yeastcc/1.50.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-yeastcc/1.50.0--r45hdfd78af_0
```
