---
layout: container
name:  "quay.io/biocontainers/alerax"
maintainer: "@vsoch"
...
updated_at: "2026-05-09 06:01:18.931091"
...
versions:
 - "1.4.0--heeb98d5_0"
description: "singularity registry hpc automated addition for alerax"
config: {"url": "https://biocontainers.pro/tools/alerax", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for alerax", "latest": {"1.4.0--heeb98d5_0": "sha256:ee860250199614b26b6e23196b7fbff11a9e697cd50ea62ce3200558066efe0f"}, "tags": {"1.4.0--heeb98d5_0": "sha256:ee860250199614b26b6e23196b7fbff11a9e697cd50ea62ce3200558066efe0f"}, "docker": "quay.io/biocontainers/alerax", "aliases": {"alerax": "/usr/local/bin/alerax", "shmemrun": "/usr/local/bin/shmemrun", "oshCC": "/usr/local/bin/oshCC", "oshc++": "/usr/local/bin/oshc++", "oshcxx": "/usr/local/bin/oshcxx", "shmemCC": "/usr/local/bin/shmemCC", "shmemc++": "/usr/local/bin/shmemc++", "shmemcxx": "/usr/local/bin/shmemcxx", "oshcc": "/usr/local/bin/oshcc", "oshfort": "/usr/local/bin/oshfort", "oshmem_info": "/usr/local/bin/oshmem_info", "oshrun": "/usr/local/bin/oshrun", "shmemcc": "/usr/local/bin/shmemcc", "shmemfort": "/usr/local/bin/shmemfort", "aggregate_profile.pl": "/usr/local/bin/aggregate_profile.pl", "profile2mat.pl": "/usr/local/bin/profile2mat.pl", "ompi-clean": "/usr/local/bin/ompi-clean", "ompi-server": "/usr/local/bin/ompi-server", "orte-clean": "/usr/local/bin/orte-clean", "orte-info": "/usr/local/bin/orte-info", "orte-server": "/usr/local/bin/orte-server", "ortecc": "/usr/local/bin/ortecc", "orted": "/usr/local/bin/orted", "orterun": "/usr/local/bin/orterun", "mpiCC": "/usr/local/bin/mpiCC", "ompi_info": "/usr/local/bin/ompi_info"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/alerax.
singularity registry hpc automated addition for alerax
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/alerax
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/alerax:1.4.0--heeb98d5_0
```
...
```bash
$ module load quay.io/biocontainers/alerax/1.4.0--heeb98d5_0
$ module help quay.io/biocontainers/alerax/1.4.0--heeb98d5_0
```
...
#### alerax-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### alerax-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/alerax
$ podman run --it --rm --entrypoint /usr/local/bin/alerax   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/alerax   -v ${PWD} -w ${PWD} <container> -c " $@"
```
