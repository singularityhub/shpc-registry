...
updated_at: "2024-01-09 02:34:37.125462"
...
```bash
$ shpc install quay.io/biocontainers/monsda:1.2.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/monsda/1.2.2--pyhdfd78af_0
$ module help quay.io/biocontainers/monsda/1.2.2--pyhdfd78af_0
```
