...
updated_at: "2026-04-22 05:02:12.952730"
...
```bash
$ shpc install quay.io/biocontainers/monsda:1.3.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/monsda/1.3.0--pyhdfd78af_0
$ module help quay.io/biocontainers/monsda/1.3.0--pyhdfd78af_0
```
