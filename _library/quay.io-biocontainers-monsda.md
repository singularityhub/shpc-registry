...
updated_at: "2026-06-16 07:42:05.744915"
...
```bash
$ shpc install quay.io/biocontainers/monsda:1.4.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/monsda/1.4.0--pyhdfd78af_0
$ module help quay.io/biocontainers/monsda/1.4.0--pyhdfd78af_0
```
