...
updated_at: "2024-05-05 02:48:20.382337"
...
```bash
$ shpc install quay.io/biocontainers/monsda:1.2.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/monsda/1.2.4--pyhdfd78af_0
$ module help quay.io/biocontainers/monsda/1.2.4--pyhdfd78af_0
```
