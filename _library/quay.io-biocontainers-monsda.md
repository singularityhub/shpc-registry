...
updated_at: "2024-03-14 03:03:11.207658"
...
```bash
$ shpc install quay.io/biocontainers/monsda:1.2.2--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/monsda/1.2.2--pyhdfd78af_1
$ module help quay.io/biocontainers/monsda/1.2.2--pyhdfd78af_1
```
