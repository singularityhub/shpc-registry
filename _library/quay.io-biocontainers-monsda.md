...
updated_at: "2024-08-11 03:05:58.071584"
...
```bash
$ shpc install quay.io/biocontainers/monsda:1.2.7--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/monsda/1.2.7--pyhdfd78af_0
$ module help quay.io/biocontainers/monsda/1.2.7--pyhdfd78af_0
```
