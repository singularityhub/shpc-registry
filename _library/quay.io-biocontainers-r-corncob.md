...
updated_at: "2025-10-09 03:20:48.156314"
...
```bash
$ shpc install quay.io/biocontainers/r-corncob:0.4.2--r44h3342da4_0
```
...
```bash
$ module load quay.io/biocontainers/r-corncob/0.4.2--r44h3342da4_0
$ module help quay.io/biocontainers/r-corncob/0.4.2--r44h3342da4_0
```
