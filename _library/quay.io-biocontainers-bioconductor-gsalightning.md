...
updated_at: "2026-02-17 05:20:42.992819"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gsalightning:1.38.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gsalightning/1.38.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-gsalightning/1.38.0--r45hdfd78af_0
```
