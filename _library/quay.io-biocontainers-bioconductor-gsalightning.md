...
updated_at: "2023-10-08 03:17:20.025917"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gsalightning:1.28.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gsalightning/1.28.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-gsalightning/1.28.0--r43hdfd78af_0
```
