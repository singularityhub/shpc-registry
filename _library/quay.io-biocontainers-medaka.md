...
updated_at: "2026-03-31 05:07:11.952404"
latest: "2.2.0--py312h3050eb1_1"
...
```bash
$ shpc install quay.io/biocontainers/medaka:2.2.0--py312h3050eb1_1
```
...
```bash
$ module load quay.io/biocontainers/medaka/2.2.0--py312h3050eb1_1
$ module help quay.io/biocontainers/medaka/2.2.0--py312h3050eb1_1
```
