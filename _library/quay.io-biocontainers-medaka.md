...
updated_at: "2026-03-14 04:51:39.480836"
latest: "2.2.0--py311h1d3aea1_0"
...
```bash
$ shpc install quay.io/biocontainers/medaka:2.2.0--py311h1d3aea1_0
```
...
```bash
$ module load quay.io/biocontainers/medaka/2.2.0--py311h1d3aea1_0
$ module help quay.io/biocontainers/medaka/2.2.0--py311h1d3aea1_0
```
