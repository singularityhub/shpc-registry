...
updated_at: "2025-09-11 05:26:44.225047"
latest: "2.1.1--py310h5713b5a_0"
...
```bash
$ shpc install quay.io/biocontainers/medaka:2.1.1--py310h5713b5a_0
```
...
```bash
$ module load quay.io/biocontainers/medaka/2.1.1--py310h5713b5a_0
$ module help quay.io/biocontainers/medaka/2.1.1--py310h5713b5a_0
```
