...
updated_at: "2026-07-02 06:12:33.420082"
...
```bash
$ shpc install quay.io/biocontainers/medaka:2.2.2--py312h3050eb1_0
```
...
```bash
$ module load quay.io/biocontainers/medaka/2.2.2--py312h3050eb1_0
$ module help quay.io/biocontainers/medaka/2.2.2--py312h3050eb1_0
```
