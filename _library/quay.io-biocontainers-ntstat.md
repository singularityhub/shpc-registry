...
updated_at: "2026-06-24 07:02:32.341518"
latest: "1.0.1--py313hcd54142_3"
...
```bash
$ shpc install quay.io/biocontainers/ntstat:1.0.1--py313hcd54142_3
```
...
```bash
$ module load quay.io/biocontainers/ntstat/1.0.1--py313hcd54142_3
$ module help quay.io/biocontainers/ntstat/1.0.1--py313hcd54142_3
```
