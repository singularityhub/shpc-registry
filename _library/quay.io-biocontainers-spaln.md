...
updated_at: "2024-01-10 02:59:35.907447"
...
```bash
$ shpc install quay.io/biocontainers/spaln:3.0.1--pl5321h4ac6f70_0
```
...
```bash
$ module load quay.io/biocontainers/spaln/3.0.1--pl5321h4ac6f70_0
$ module help quay.io/biocontainers/spaln/3.0.1--pl5321h4ac6f70_0
```
