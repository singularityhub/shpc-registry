...
updated_at: "2026-03-13 05:07:51.346151"
latest: "1.4.4--pyh106432d_0"
...
```bash
$ shpc install quay.io/biocontainers/palantir:1.4.4--pyh106432d_0
```
...
```bash
$ module load quay.io/biocontainers/palantir/1.4.4--pyh106432d_0
$ module help quay.io/biocontainers/palantir/1.4.4--pyh106432d_0
```
