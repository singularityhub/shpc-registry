---
layout: container
name:  "quay.io/biocontainers/palantir"
maintainer: "@vsoch"
...
updated_at: "2026-08-17 03:45:08.953726"
latest: "1.4.5--pyh106432d_0"
...
```bash
$ shpc install quay.io/biocontainers/palantir
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/palantir:1.4.5--pyh106432d_0
```
...
```bash
$ module load quay.io/biocontainers/palantir/1.4.5--pyh106432d_0
$ module help quay.io/biocontainers/palantir/1.4.5--pyh106432d_0
```
...
#### palantir-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### palantir-inspect-deffile:
