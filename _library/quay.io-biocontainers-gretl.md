...
updated_at: "2024-12-03 03:36:38.134086"
latest: "0.1.0--h715e4b3_0"
...
```bash
$ shpc install quay.io/biocontainers/gretl:0.1.0--h715e4b3_0
```
...
```bash
$ module load quay.io/biocontainers/gretl/0.1.0--h715e4b3_0
$ module help quay.io/biocontainers/gretl/0.1.0--h715e4b3_0
```
