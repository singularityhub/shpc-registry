...
updated_at: "2022-11-01 04:02:40.941694"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-enhancerhomologsearch:1.0.1--r41hc247a5b_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-enhancerhomologsearch/1.0.1--r41hc247a5b_0
$ module help quay.io/biocontainers/bioconductor-enhancerhomologsearch/1.0.1--r41hc247a5b_0
```
