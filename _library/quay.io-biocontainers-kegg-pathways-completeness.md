...
updated_at: "2026-06-12 06:54:30.951932"
...
```bash
$ shpc install quay.io/biocontainers/kegg-pathways-completeness:1.4.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/kegg-pathways-completeness/1.4.3--pyhdfd78af_0
$ module help quay.io/biocontainers/kegg-pathways-completeness/1.4.3--pyhdfd78af_0
```
