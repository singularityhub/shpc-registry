...
updated_at: "2026-08-24 03:43:04.946603"
...
```bash
$ shpc install quay.io/biocontainers/kegg-pathways-completeness:1.4.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/kegg-pathways-completeness/1.4.4--pyhdfd78af_0
$ module help quay.io/biocontainers/kegg-pathways-completeness/1.4.4--pyhdfd78af_0
```
