...
updated_at: "2022-11-09 23:34:44.890629"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-enhancedvolcano:1.8.0--r40hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-enhancedvolcano/1.8.0--r40hdfd78af_1
$ module help quay.io/biocontainers/bioconductor-enhancedvolcano/1.8.0--r40hdfd78af_1
```
