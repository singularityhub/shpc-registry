...
updated_at: "2026-02-21 04:42:47.327367"
latest: "1.28.2--r45hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-enhancedvolcano:1.28.2--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-enhancedvolcano/1.28.2--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-enhancedvolcano/1.28.2--r45hdfd78af_0
```
