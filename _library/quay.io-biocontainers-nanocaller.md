...
updated_at: "2023-06-13 03:23:33.359825"
...
```bash
$ shpc install quay.io/biocontainers/nanocaller:3.2.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/nanocaller/3.2.0--hdfd78af_0
$ module help quay.io/biocontainers/nanocaller/3.2.0--hdfd78af_0
```
