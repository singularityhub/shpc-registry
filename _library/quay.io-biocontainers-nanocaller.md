...
updated_at: "2023-09-02 02:21:35.136794"
...
```bash
$ shpc install quay.io/biocontainers/nanocaller:3.4.1--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/nanocaller/3.4.1--hdfd78af_0
$ module help quay.io/biocontainers/nanocaller/3.4.1--hdfd78af_0
```
