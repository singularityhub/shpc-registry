...
updated_at: "2023-08-05 03:27:09.025235"
...
```bash
$ shpc install quay.io/biocontainers/nanocaller:3.3.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/nanocaller/3.3.0--hdfd78af_0
$ module help quay.io/biocontainers/nanocaller/3.3.0--hdfd78af_0
```
