...
updated_at: "2025-01-05 03:05:36.912364"
...
```bash
$ shpc install quay.io/biocontainers/nanocaller:3.6.0--h42286b9_2
```
...
```bash
$ module load quay.io/biocontainers/nanocaller/3.6.0--h42286b9_2
$ module help quay.io/biocontainers/nanocaller/3.6.0--h42286b9_2
```
