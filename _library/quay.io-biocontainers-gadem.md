...
updated_at: "2026-06-03 07:07:37.407564"
latest: "1.3.1--hab16a5f_9"
...
```bash
$ shpc install quay.io/biocontainers/gadem:1.3.1--hab16a5f_9
```
...
```bash
$ module load quay.io/biocontainers/gadem/1.3.1--hab16a5f_9
$ module help quay.io/biocontainers/gadem/1.3.1--hab16a5f_9
```
