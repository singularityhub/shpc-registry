...
updated_at: "2022-10-29 05:53:17.124150"
latest: "1.8.0--r36_1"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mcbiclust:1.8.0--r36_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mcbiclust/1.8.0--r36_1
$ module help quay.io/biocontainers/bioconductor-mcbiclust/1.8.0--r36_1
```
