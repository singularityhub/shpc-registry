...
updated_at: "2023-09-12 03:12:03.037502"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-eegc:1.26.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-eegc/1.26.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-eegc/1.26.0--r43hdfd78af_0
```
