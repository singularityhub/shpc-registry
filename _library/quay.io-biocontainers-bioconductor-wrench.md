...
updated_at: "2026-01-09 04:30:14.008626"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-wrench:1.24.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-wrench/1.24.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-wrench/1.24.0--r44hdfd78af_0
```
