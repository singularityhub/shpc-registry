...
updated_at: "2026-03-08 04:47:09.129478"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-wrench:1.28.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-wrench/1.28.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-wrench/1.28.0--r45hdfd78af_0
```
