...
updated_at: "2024-11-30 03:22:01.577669"
latest: "1.5.3--py310h1af8fb7_0"
...
```bash
$ shpc install quay.io/biocontainers/pyabpoa:1.5.3--py310h1af8fb7_0
```
...
```bash
$ module load quay.io/biocontainers/pyabpoa/1.5.3--py310h1af8fb7_0
$ module help quay.io/biocontainers/pyabpoa/1.5.3--py310h1af8fb7_0
```
