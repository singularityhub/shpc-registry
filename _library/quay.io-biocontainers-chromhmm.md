...
updated_at: "2026-01-07 03:46:33.920363"
...
```bash
$ shpc install quay.io/biocontainers/chromhmm:1.27--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/chromhmm/1.27--hdfd78af_0
$ module help quay.io/biocontainers/chromhmm/1.27--hdfd78af_0
```
