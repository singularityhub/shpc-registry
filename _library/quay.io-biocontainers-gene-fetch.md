...
updated_at: "2025-11-07 03:57:41.053178"
latest: "1.0.17--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/gene-fetch:1.0.17--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/gene-fetch/1.0.17--pyhdfd78af_0
$ module help quay.io/biocontainers/gene-fetch/1.0.17--pyhdfd78af_0
```
