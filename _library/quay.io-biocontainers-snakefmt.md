...
updated_at: "2026-08-02 06:23:15.413964"
...
```bash
$ shpc install quay.io/biocontainers/snakefmt:2.0.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakefmt/2.0.3--pyhdfd78af_0
$ module help quay.io/biocontainers/snakefmt/2.0.3--pyhdfd78af_0
```
