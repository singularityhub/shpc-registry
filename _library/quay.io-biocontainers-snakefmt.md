...
updated_at: "2025-03-01 03:31:59.444766"
...
```bash
$ shpc install quay.io/biocontainers/snakefmt:0.10.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakefmt/0.10.2--pyhdfd78af_0
$ module help quay.io/biocontainers/snakefmt/0.10.2--pyhdfd78af_0
```
