...
updated_at: "2026-06-09 09:00:10.060798"
...
```bash
$ shpc install quay.io/biocontainers/snakefmt:1.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakefmt/1.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/snakefmt/1.1.0--pyhdfd78af_0
```
