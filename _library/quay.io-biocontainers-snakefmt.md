...
updated_at: "2025-05-16 03:16:03.880883"
...
```bash
$ shpc install quay.io/biocontainers/snakefmt:0.11.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakefmt/0.11.0--pyhdfd78af_0
$ module help quay.io/biocontainers/snakefmt/0.11.0--pyhdfd78af_0
```
