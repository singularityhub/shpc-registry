...
updated_at: "2026-06-26 06:16:12.812197"
...
```bash
$ shpc install quay.io/biocontainers/snakefmt:2.0.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakefmt/2.0.1--pyhdfd78af_0
$ module help quay.io/biocontainers/snakefmt/2.0.1--pyhdfd78af_0
```
