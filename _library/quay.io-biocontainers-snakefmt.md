...
updated_at: "2026-02-17 05:10:17.756561"
latest: "0.11.4--pyha6daafd_0"
...
```bash
$ shpc install quay.io/biocontainers/snakefmt:0.11.4--pyha6daafd_0
```
...
```bash
$ module load quay.io/biocontainers/snakefmt/0.11.4--pyha6daafd_0
$ module help quay.io/biocontainers/snakefmt/0.11.4--pyha6daafd_0
```
