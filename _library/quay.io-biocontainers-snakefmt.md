...
updated_at: "2026-08-31 08:19:38.862096"
latest: "2.0.3--pyhdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/snakefmt:2.0.3--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/snakefmt/2.0.3--pyhdfd78af_1
$ module help quay.io/biocontainers/snakefmt/2.0.3--pyhdfd78af_1
```
