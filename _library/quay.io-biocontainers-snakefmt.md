...
updated_at: "2024-03-20 02:44:02.235997"
...
```bash
$ shpc install quay.io/biocontainers/snakefmt:0.10.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakefmt/0.10.0--pyhdfd78af_0
$ module help quay.io/biocontainers/snakefmt/0.10.0--pyhdfd78af_0
```
