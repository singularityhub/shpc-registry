...
updated_at: "2026-04-05 04:57:22.980089"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mircompdata:1.40.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mircompdata/1.40.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-mircompdata/1.40.0--r45hdfd78af_0
```
