...
updated_at: "2025-08-24 03:34:35.288315"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ggtreeextra:1.16.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ggtreeextra/1.16.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ggtreeextra/1.16.0--r44hdfd78af_0
```
