...
updated_at: "2022-10-29 05:41:40.529867"
latest: "0.7.0--r41hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/r-bcbiobase:0.7.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/r-bcbiobase/0.7.0--r41hdfd78af_0
$ module help quay.io/biocontainers/r-bcbiobase/0.7.0--r41hdfd78af_0
```
