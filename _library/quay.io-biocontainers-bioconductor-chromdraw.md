...
updated_at: "2023-09-16 02:54:48.474007"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-chromdraw:2.30.0--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-chromdraw/2.30.0--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-chromdraw/2.30.0--r43hf17093f_0
```
