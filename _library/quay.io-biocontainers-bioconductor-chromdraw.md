...
updated_at: "2024-11-28 03:03:39.782379"
latest: "2.32.0--r43hf17093f_1"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-chromdraw:2.32.0--r43hf17093f_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-chromdraw/2.32.0--r43hf17093f_1
$ module help quay.io/biocontainers/bioconductor-chromdraw/2.32.0--r43hf17093f_1
```
