...
updated_at: "2023-06-24 03:11:18.160116"
latest: "2.28.0--r42hf17093f_1"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-chromdraw:2.28.0--r42hf17093f_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-chromdraw/2.28.0--r42hf17093f_1
$ module help quay.io/biocontainers/bioconductor-chromdraw/2.28.0--r42hf17093f_1
```
