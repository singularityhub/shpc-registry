...
updated_at: "2026-03-05 05:26:02.074754"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-pepsnmrdata:1.28.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-pepsnmrdata/1.28.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-pepsnmrdata/1.28.0--r45hdfd78af_0
```
