...
updated_at: "2025-04-17 03:31:52.447809"
latest: "1.0.0--pyhdfd78af_4"
...
```bash
$ shpc install quay.io/biocontainers/arborator:1.0.0--pyhdfd78af_4
```
...
```bash
$ module load quay.io/biocontainers/arborator/1.0.0--pyhdfd78af_4
$ module help quay.io/biocontainers/arborator/1.0.0--pyhdfd78af_4
```
