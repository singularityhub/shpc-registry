...
updated_at: "2025-12-16 03:42:28.093497"
...
```bash
$ shpc install quay.io/biocontainers/arborator:1.2.0--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/arborator/1.2.0--pyhdfd78af_1
$ module help quay.io/biocontainers/arborator/1.2.0--pyhdfd78af_1
```
