...
updated_at: "2025-05-27 12:01:35.771788"
latest: "1.0.0--pyhdfd78af_5"
...
```bash
$ shpc install quay.io/biocontainers/arborator:1.0.0--pyhdfd78af_5
```
...
```bash
$ module load quay.io/biocontainers/arborator/1.0.0--pyhdfd78af_5
$ module help quay.io/biocontainers/arborator/1.0.0--pyhdfd78af_5
```
