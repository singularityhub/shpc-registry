...
updated_at: "2025-06-25 03:36:45.398987"
...
```bash
$ shpc install quay.io/biocontainers/arborator:1.0.6--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/arborator/1.0.6--pyhdfd78af_0
$ module help quay.io/biocontainers/arborator/1.0.6--pyhdfd78af_0
```
