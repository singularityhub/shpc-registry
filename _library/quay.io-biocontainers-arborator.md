...
updated_at: "2026-03-05 00:16:57.931084"
...
```bash
$ shpc install quay.io/biocontainers/arborator:1.2.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/arborator/1.2.2--pyhdfd78af_0
$ module help quay.io/biocontainers/arborator/1.2.2--pyhdfd78af_0
```
