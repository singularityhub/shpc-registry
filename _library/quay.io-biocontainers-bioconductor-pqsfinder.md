...
updated_at: "2023-12-01 03:11:31.010720"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-pqsfinder:2.16.0--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-pqsfinder/2.16.0--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-pqsfinder/2.16.0--r43hf17093f_0
```
