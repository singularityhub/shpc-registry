...
updated_at: "2026-03-26 05:27:35.957276"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-pqsfinder:2.26.0--r45ha27e39d_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-pqsfinder/2.26.0--r45ha27e39d_1
$ module help quay.io/biocontainers/bioconductor-pqsfinder/2.26.0--r45ha27e39d_1
```
