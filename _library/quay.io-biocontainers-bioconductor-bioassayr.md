...
updated_at: "2022-11-01 03:37:55.808108"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-bioassayr:1.32.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-bioassayr/1.32.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-bioassayr/1.32.0--r41hdfd78af_0
```
