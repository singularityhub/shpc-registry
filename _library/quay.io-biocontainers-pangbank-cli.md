...
updated_at: "2026-09-26 07:27:34.914177"
...
```bash
$ shpc install quay.io/biocontainers/pangbank-cli:0.3.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pangbank-cli/0.3.0--pyhdfd78af_0
$ module help quay.io/biocontainers/pangbank-cli/0.3.0--pyhdfd78af_0
```
