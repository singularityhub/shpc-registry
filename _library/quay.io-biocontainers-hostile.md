...
updated_at: "2025-11-09 03:47:04.307015"
...
```bash
$ shpc install quay.io/biocontainers/hostile:2.0.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hostile/2.0.2--pyhdfd78af_0
$ module help quay.io/biocontainers/hostile/2.0.2--pyhdfd78af_0
```
