...
updated_at: "2023-12-24 02:37:18.103859"
...
```bash
$ shpc install quay.io/biocontainers/hostile:0.4.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hostile/0.4.0--pyhdfd78af_0
$ module help quay.io/biocontainers/hostile/0.4.0--pyhdfd78af_0
```
