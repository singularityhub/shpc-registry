...
updated_at: "2024-02-01 02:48:36.964822"
...
```bash
$ shpc install quay.io/biocontainers/hostile:1.0.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hostile/1.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/hostile/1.0.0--pyhdfd78af_0
```
