...
updated_at: "2022-12-01 01:44:48.007116"
latest: "3.4.0--r41hc247a5b_2"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rmassbank:3.4.0--r41hc247a5b_2
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rmassbank/3.4.0--r41hc247a5b_2
$ module help quay.io/biocontainers/bioconductor-rmassbank/3.4.0--r41hc247a5b_2
```
