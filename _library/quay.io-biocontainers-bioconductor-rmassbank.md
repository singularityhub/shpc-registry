...
updated_at: "2023-11-06 02:40:23.647706"
latest: "3.10.0--r43hf17093f_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rmassbank:3.10.0--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rmassbank/3.10.0--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-rmassbank/3.10.0--r43hf17093f_0
```
