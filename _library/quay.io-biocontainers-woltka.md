...
updated_at: "2025-01-01 02:59:58.829697"
...
```bash
$ shpc install quay.io/biocontainers/woltka:0.1.7--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/woltka/0.1.7--pyhdfd78af_0
$ module help quay.io/biocontainers/woltka/0.1.7--pyhdfd78af_0
```
