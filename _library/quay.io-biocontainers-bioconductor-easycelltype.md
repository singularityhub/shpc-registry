...
updated_at: "2023-07-17 04:14:03.015123"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-easycelltype:1.0.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-easycelltype/1.0.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-easycelltype/1.0.0--r42hdfd78af_0
```
