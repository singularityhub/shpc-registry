...
updated_at: "2026-02-01 04:52:13.875749"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-easycelltype:1.8.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-easycelltype/1.8.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-easycelltype/1.8.0--r44hdfd78af_0
```
