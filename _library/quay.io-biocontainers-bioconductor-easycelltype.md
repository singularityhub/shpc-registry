...
updated_at: "2024-05-06 04:21:45.019613"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-easycelltype:1.2.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-easycelltype/1.2.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-easycelltype/1.2.0--r43hdfd78af_0
```
