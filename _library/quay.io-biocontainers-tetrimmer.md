...
updated_at: "2025-10-13 04:13:27.496653"
latest: "1.5.4--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/tetrimmer:1.5.4--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/tetrimmer/1.5.4--hdfd78af_0
$ module help quay.io/biocontainers/tetrimmer/1.5.4--hdfd78af_0
```
