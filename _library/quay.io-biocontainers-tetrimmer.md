...
updated_at: "2025-11-28 03:42:42.349186"
...
```bash
$ shpc install quay.io/biocontainers/tetrimmer:1.6.1--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/tetrimmer/1.6.1--hdfd78af_0
$ module help quay.io/biocontainers/tetrimmer/1.6.1--hdfd78af_0
```
