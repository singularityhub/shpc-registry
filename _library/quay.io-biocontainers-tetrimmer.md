...
updated_at: "2026-05-19 06:39:29.596769"
...
```bash
$ shpc install quay.io/biocontainers/tetrimmer:1.7.2--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/tetrimmer/1.7.2--hdfd78af_0
$ module help quay.io/biocontainers/tetrimmer/1.7.2--hdfd78af_0
```
