...
updated_at: "2025-12-24 03:55:39.544522"
...
```bash
$ shpc install quay.io/biocontainers/tetrimmer:1.6.2--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/tetrimmer/1.6.2--hdfd78af_0
$ module help quay.io/biocontainers/tetrimmer/1.6.2--hdfd78af_0
```
