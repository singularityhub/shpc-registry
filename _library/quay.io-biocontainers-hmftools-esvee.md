...
updated_at: "2026-01-30 04:23:31.462913"
...
```bash
$ shpc install quay.io/biocontainers/hmftools-esvee:1.2--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hmftools-esvee/1.2--hdfd78af_0
$ module help quay.io/biocontainers/hmftools-esvee/1.2--hdfd78af_0
```
