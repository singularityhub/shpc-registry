...
updated_at: "2026-09-02 07:20:22.780002"
...
```bash
$ shpc install quay.io/biocontainers/hicberg:1.0.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hicberg/1.0.2--pyhdfd78af_0
$ module help quay.io/biocontainers/hicberg/1.0.2--pyhdfd78af_0
```
