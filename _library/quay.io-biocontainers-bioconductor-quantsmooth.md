...
updated_at: "2026-03-16 04:48:36.349178"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-quantsmooth:1.76.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-quantsmooth/1.76.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-quantsmooth/1.76.0--r45hdfd78af_0
```
