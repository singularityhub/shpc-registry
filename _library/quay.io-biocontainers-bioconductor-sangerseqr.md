...
updated_at: "2023-11-05 03:07:54.704463"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-sangerseqr:1.36.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-sangerseqr/1.36.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-sangerseqr/1.36.0--r43hdfd78af_0
```
