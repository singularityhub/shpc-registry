...
updated_at: "2023-11-11 03:27:47.969796"
...
```bash
$ shpc install quay.io/biocontainers/regenie:3.2.9--h90dfdf2_0
```
...
```bash
$ module load quay.io/biocontainers/regenie/3.2.9--h90dfdf2_0
$ module help quay.io/biocontainers/regenie/3.2.9--h90dfdf2_0
```
