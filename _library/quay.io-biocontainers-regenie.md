...
updated_at: "2026-09-19 07:35:24.866035"
latest: "4.1.3--h9a87a4f_0"
...
```bash
$ shpc install quay.io/biocontainers/regenie:4.1.3--h9a87a4f_0
```
...
```bash
$ module load quay.io/biocontainers/regenie/4.1.3--h9a87a4f_0
$ module help quay.io/biocontainers/regenie/4.1.3--h9a87a4f_0
```
