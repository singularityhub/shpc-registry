...
updated_at: "2023-06-03 03:27:52.889207"
latest: "3.2.6--h2b233e7_1"
...
```bash
$ shpc install quay.io/biocontainers/regenie:3.2.6--h2b233e7_1
```
...
```bash
$ module load quay.io/biocontainers/regenie/3.2.6--h2b233e7_1
$ module help quay.io/biocontainers/regenie/3.2.6--h2b233e7_1
```
