...
updated_at: "2022-12-12 03:15:15.231751"
latest: "3.2.2.1--h2b233e7_0"
...
```bash
$ shpc install quay.io/biocontainers/regenie:3.2.2.1--h2b233e7_0
```
...
```bash
$ module load quay.io/biocontainers/regenie/3.2.2.1--h2b233e7_0
$ module help quay.io/biocontainers/regenie/3.2.2.1--h2b233e7_0
```
