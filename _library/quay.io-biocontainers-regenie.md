...
updated_at: "2023-01-31 18:14:35.590012"
latest: "3.2.5--h2b233e7_0"
...
```bash
$ shpc install quay.io/biocontainers/regenie:3.2.5--h2b233e7_0
```
...
```bash
$ module load quay.io/biocontainers/regenie/3.2.5--h2b233e7_0
$ module help quay.io/biocontainers/regenie/3.2.5--h2b233e7_0
```
