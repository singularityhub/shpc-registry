...
updated_at: "2023-12-14 02:51:08.254102"
latest: "3.3--h90dfdf2_0"
...
```bash
$ shpc install quay.io/biocontainers/regenie:3.3--h90dfdf2_0
```
...
```bash
$ module load quay.io/biocontainers/regenie/3.3--h90dfdf2_0
$ module help quay.io/biocontainers/regenie/3.3--h90dfdf2_0
```
