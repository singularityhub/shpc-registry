...
updated_at: "2023-07-19 03:50:40.896054"
latest: "3.2.7--h2b233e7_0"
...
```bash
$ shpc install quay.io/biocontainers/regenie:3.2.7--h2b233e7_0
```
...
```bash
$ module load quay.io/biocontainers/regenie/3.2.7--h2b233e7_0
$ module help quay.io/biocontainers/regenie/3.2.7--h2b233e7_0
```
