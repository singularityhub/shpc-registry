...
updated_at: "2026-09-20 07:44:36.470960"
...
```bash
$ shpc install quay.io/biocontainers/r-monocle3:1.4.27--r45hc52dbad_0
```
...
```bash
$ module load quay.io/biocontainers/r-monocle3/1.4.27--r45hc52dbad_0
$ module help quay.io/biocontainers/r-monocle3/1.4.27--r45hc52dbad_0
```
