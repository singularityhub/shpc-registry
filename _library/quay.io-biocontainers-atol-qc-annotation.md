...
updated_at: "2025-12-17 04:07:57.850600"
...
```bash
$ shpc install quay.io/biocontainers/atol-qc-annotation:0.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/atol-qc-annotation/0.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/atol-qc-annotation/0.1.0--pyhdfd78af_0
```
