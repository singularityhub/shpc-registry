...
updated_at: "2023-08-22 02:27:33.891985"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rimmport:1.28.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rimmport/1.28.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rimmport/1.28.0--r43hdfd78af_0
```
