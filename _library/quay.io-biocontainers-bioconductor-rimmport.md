...
updated_at: "2024-10-18 03:04:13.807704"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rimmport:1.30.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rimmport/1.30.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rimmport/1.30.0--r43hdfd78af_0
```
