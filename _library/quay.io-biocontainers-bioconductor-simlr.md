...
updated_at: "2024-06-03 02:35:03.307994"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-simlr:1.28.0--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-simlr/1.28.0--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-simlr/1.28.0--r43hf17093f_0
```
