...
updated_at: "2023-11-21 03:10:17.829977"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-simlr:1.26.1--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-simlr/1.26.1--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-simlr/1.26.1--r43hf17093f_0
```
