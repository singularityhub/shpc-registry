...
updated_at: "2024-09-09 02:59:16.140517"
latest: "1.3.7--h6a68c12_2"
...
```bash
$ shpc install quay.io/biocontainers/freebayes:1.3.7--h6a68c12_2
```
...
```bash
$ module load quay.io/biocontainers/freebayes/1.3.7--h6a68c12_2
$ module help quay.io/biocontainers/freebayes/1.3.7--h6a68c12_2
```
