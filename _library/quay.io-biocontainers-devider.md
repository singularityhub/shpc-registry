...
updated_at: "2024-11-16 03:07:12.790897"
latest: "0.0.1--h919a2d8_1"
...
```bash
$ shpc install quay.io/biocontainers/devider:0.0.1--h919a2d8_1
```
...
```bash
$ module load quay.io/biocontainers/devider/0.0.1--h919a2d8_1
$ module help quay.io/biocontainers/devider/0.0.1--h919a2d8_1
```
