...
updated_at: "2023-09-25 04:14:17.975548"
...
```bash
$ shpc install quay.io/biocontainers/ngs-chew:0.8.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ngs-chew/0.8.1--pyhdfd78af_0
$ module help quay.io/biocontainers/ngs-chew/0.8.1--pyhdfd78af_0
```
