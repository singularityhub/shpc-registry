...
updated_at: "2026-05-16 05:47:06.609116"
...
```bash
$ shpc install quay.io/biocontainers/badread:0.4.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/badread/0.4.2--pyhdfd78af_0
$ module help quay.io/biocontainers/badread/0.4.2--pyhdfd78af_0
```
