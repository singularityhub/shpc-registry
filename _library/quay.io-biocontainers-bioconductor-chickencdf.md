...
updated_at: "2026-06-06 06:08:32.407728"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-chickencdf:2.18.0--r45hdfd78af_15
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-chickencdf/2.18.0--r45hdfd78af_15
$ module help quay.io/biocontainers/bioconductor-chickencdf/2.18.0--r45hdfd78af_15
```
