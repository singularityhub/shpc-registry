...
updated_at: "2023-07-23 02:58:53.781587"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-nanotubes:1.16.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-nanotubes/1.16.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-nanotubes/1.16.0--r43hdfd78af_0
```
