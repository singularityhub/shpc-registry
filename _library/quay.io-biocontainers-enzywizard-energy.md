---
layout: container
name:  "quay.io/biocontainers/enzywizard-energy"
maintainer: "@vsoch"
...
updated_at: "2026-07-01 07:04:17.176568"
...
singularity registry hpc automated addition for enzywizard-energy
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/enzywizard-energy
```
...
#### enzywizard-energy-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### enzywizard-energy-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/enzywizard-energy
$ podman run --it --rm --entrypoint /usr/local/bin/enzywizard-energy   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/enzywizard-energy   -v ${PWD} -w ${PWD} <container> -c " $@"
```
