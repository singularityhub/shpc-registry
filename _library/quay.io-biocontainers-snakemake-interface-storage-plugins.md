...
updated_at: "2024-08-03 02:39:30.784156"
...
```bash
$ shpc install quay.io/biocontainers/snakemake-interface-storage-plugins:3.2.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake-interface-storage-plugins/3.2.2--pyhdfd78af_0
$ module help quay.io/biocontainers/snakemake-interface-storage-plugins/3.2.2--pyhdfd78af_0
```
