...
updated_at: "2025-04-30 03:13:10.741517"
...
```bash
$ shpc install quay.io/biocontainers/snakemake-interface-storage-plugins:4.2.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake-interface-storage-plugins/4.2.1--pyhdfd78af_0
$ module help quay.io/biocontainers/snakemake-interface-storage-plugins/4.2.1--pyhdfd78af_0
```
