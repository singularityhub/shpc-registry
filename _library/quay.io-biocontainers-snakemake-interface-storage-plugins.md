...
updated_at: "2024-08-09 02:50:15.998728"
...
```bash
$ shpc install quay.io/biocontainers/snakemake-interface-storage-plugins:3.2.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake-interface-storage-plugins/3.2.3--pyhdfd78af_0
$ module help quay.io/biocontainers/snakemake-interface-storage-plugins/3.2.3--pyhdfd78af_0
```
