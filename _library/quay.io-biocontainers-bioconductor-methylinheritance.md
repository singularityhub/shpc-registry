...
updated_at: "2024-12-29 02:59:36.397439"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-methylinheritance:1.26.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-methylinheritance/1.26.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-methylinheritance/1.26.0--r43hdfd78af_0
```
