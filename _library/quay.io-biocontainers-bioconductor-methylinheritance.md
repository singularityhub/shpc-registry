...
updated_at: "2023-09-03 03:01:30.337758"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-methylinheritance:1.24.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-methylinheritance/1.24.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-methylinheritance/1.24.0--r43hdfd78af_0
```
