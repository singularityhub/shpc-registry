...
updated_at: "2022-10-29 08:11:57.727809"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-waddr:1.8.0--r41hc247a5b_2
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-waddr/1.8.0--r41hc247a5b_2
$ module help quay.io/biocontainers/bioconductor-waddr/1.8.0--r41hc247a5b_2
```
