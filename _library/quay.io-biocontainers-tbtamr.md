...
updated_at: "2026-06-22 02:30:04.756779"
...
```bash
$ shpc install quay.io/biocontainers/tbtamr:1.0.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/tbtamr/1.0.4--pyhdfd78af_0
$ module help quay.io/biocontainers/tbtamr/1.0.4--pyhdfd78af_0
```
