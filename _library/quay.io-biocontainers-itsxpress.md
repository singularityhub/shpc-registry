...
updated_at: "2025-02-17 03:33:28.929380"
...
```bash
$ shpc install quay.io/biocontainers/itsxpress:2.1.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/itsxpress/2.1.4--pyhdfd78af_0
$ module help quay.io/biocontainers/itsxpress/2.1.4--pyhdfd78af_0
```
