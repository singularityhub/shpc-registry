...
updated_at: "2024-11-13 03:08:58.735674"
...
```bash
$ shpc install quay.io/biocontainers/itsxpress:2.1.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/itsxpress/2.1.2--pyhdfd78af_0
$ module help quay.io/biocontainers/itsxpress/2.1.2--pyhdfd78af_0
```
