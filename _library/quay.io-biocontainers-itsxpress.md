...
updated_at: "2023-11-02 03:25:04.629272"
...
```bash
$ shpc install quay.io/biocontainers/itsxpress:2.0.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/itsxpress/2.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/itsxpress/2.0.0--pyhdfd78af_0
```
