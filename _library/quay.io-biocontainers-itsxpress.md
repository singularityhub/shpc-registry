...
updated_at: "2025-01-06 03:09:33.653985"
...
```bash
$ shpc install quay.io/biocontainers/itsxpress:2.1.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/itsxpress/2.1.3--pyhdfd78af_0
$ module help quay.io/biocontainers/itsxpress/2.1.3--pyhdfd78af_0
```
