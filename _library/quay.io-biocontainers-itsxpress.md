...
updated_at: "2024-01-01 03:08:39.051142"
...
```bash
$ shpc install quay.io/biocontainers/itsxpress:2.0.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/itsxpress/2.0.1--pyhdfd78af_0
$ module help quay.io/biocontainers/itsxpress/2.0.1--pyhdfd78af_0
```
