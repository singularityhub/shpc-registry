...
updated_at: "2026-08-27 23:19:00.503355"
...
```bash
$ shpc install quay.io/biocontainers/itsxpress:2.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/itsxpress/2.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/itsxpress/2.2.0--pyhdfd78af_0
```
