...
updated_at: "2025-05-01 06:59:26.139751"
latest: "1.0.1"
...
```bash
$ shpc install quay.io/biocontainers/geopandas:1.0.1
```
...
```bash
$ module load quay.io/biocontainers/geopandas/1.0.1
$ module help quay.io/biocontainers/geopandas/1.0.1
```
