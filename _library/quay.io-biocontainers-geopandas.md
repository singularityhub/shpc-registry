...
updated_at: "2026-05-09 07:01:48.753170"
latest: "1.1.3"
...
```bash
$ shpc install quay.io/biocontainers/geopandas:1.1.3
```
...
```bash
$ module load quay.io/biocontainers/geopandas/1.1.3
$ module help quay.io/biocontainers/geopandas/1.1.3
```
