...
updated_at: "2026-08-20 03:54:26.977220"
latest: "1.1.4"
...
```bash
$ shpc install quay.io/biocontainers/geopandas:1.1.4
```
...
```bash
$ module load quay.io/biocontainers/geopandas/1.1.4
$ module help quay.io/biocontainers/geopandas/1.1.4
```
