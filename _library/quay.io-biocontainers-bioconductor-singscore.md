...
updated_at: "2026-03-27 04:43:12.484087"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-singscore:1.30.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-singscore/1.30.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-singscore/1.30.0--r45hdfd78af_0
```
