...
updated_at: "2023-08-04 03:09:33.497781"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-singscore:1.20.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-singscore/1.20.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-singscore/1.20.0--r43hdfd78af_0
```
