...
updated_at: "2024-06-10 02:35:18.988005"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-singscore:1.22.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-singscore/1.22.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-singscore/1.22.0--r43hdfd78af_0
```
