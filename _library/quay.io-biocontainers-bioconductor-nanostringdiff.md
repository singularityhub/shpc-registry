...
updated_at: "2022-11-03 01:14:21.936412"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-nanostringdiff:1.24.0--r41hc247a5b_2
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-nanostringdiff/1.24.0--r41hc247a5b_2
$ module help quay.io/biocontainers/bioconductor-nanostringdiff/1.24.0--r41hc247a5b_2
```
