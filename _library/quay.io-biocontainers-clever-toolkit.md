...
updated_at: "2022-10-27 00:52:37.424971"
latest: "2.4--py35_boost1.64_0"
...
```bash
$ shpc install quay.io/biocontainers/clever-toolkit:2.4--py35_boost1.64_0
```
...
```bash
$ module load quay.io/biocontainers/clever-toolkit/2.4--py35_boost1.64_0
$ module help quay.io/biocontainers/clever-toolkit/2.4--py35_boost1.64_0
```
