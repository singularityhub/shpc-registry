...
updated_at: "2022-10-29 07:46:27.832070"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-decomplexdisease:1.8.0--r40h5f743cb_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-decomplexdisease/1.8.0--r40h5f743cb_0
$ module help quay.io/biocontainers/bioconductor-decomplexdisease/1.8.0--r40h5f743cb_0
```
