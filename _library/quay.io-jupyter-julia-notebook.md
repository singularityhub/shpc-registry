...
updated_at: "2025-08-03 03:53:52.936211"
latest: "2025-06-30"
...
config: {"docker": "quay.io/jupyter/julia-notebook", "url": "https://quay.io/repository/jupyter/julia-notebook", "maintainer": "@HasseJohansen", "description": "Jupyter Julia Notebook from https://github.com/jupyter/docker-stacks", "latest": {"2025-06-30": "sha256:85812ed3ee9b29a3937f95314abd427bdf904f1cd21e4de1d0696e48c5786caf"}, "tags": {"latest": "sha256:85812ed3ee9b29a3937f95314abd427bdf904f1cd21e4de1d0696e48c5786caf", "2025-05-30": "sha256:9792324e1f10544aa7c56b79852129f131a09e86ce40cd64d7bcf63dc6e588ee", "2025-06-30": "sha256:85812ed3ee9b29a3937f95314abd427bdf904f1cd21e4de1d0696e48c5786caf"}, "aliases": [{"name": "run-notebook", "command": "jupyter notebook --no-browser --port=$(shuf -i 2000-65000 -n 1) --ip 0.0.0.0"}]}
---
...
```bash
$ shpc install quay.io/jupyter/julia-notebook:2025-06-30
```
...
```bash
$ module load quay.io/jupyter/julia-notebook/2025-06-30
$ module help quay.io/jupyter/julia-notebook/2025-06-30
```
