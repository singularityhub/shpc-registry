...
updated_at: "2026-03-25 04:29:19.320530"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-scarray:1.18.0--r45ha27e39d_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-scarray/1.18.0--r45ha27e39d_0
$ module help quay.io/biocontainers/bioconductor-scarray/1.18.0--r45ha27e39d_0
```
