...
updated_at: "2023-08-10 03:15:13.838060"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-scarray:1.8.2--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-scarray/1.8.2--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-scarray/1.8.2--r43hf17093f_0
```
