...
updated_at: "2023-09-11 03:37:35.492581"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-coveb:1.26.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-coveb/1.26.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-coveb/1.26.0--r43hdfd78af_0
```
