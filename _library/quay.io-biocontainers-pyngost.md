---
layout: container
name:  "quay.io/biocontainers/pyngost"
maintainer: "@vsoch"
...
updated_at: "2025-12-21 04:35:36.596976"
...
```bash
$ module load quay.io/biocontainers/pyngost/1.1.3--pyh7e72e81_0
$ module help quay.io/biocontainers/pyngost/1.1.3--pyh7e72e81_0
```
...
#### pyngost-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### pyngost-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/pyngoST.py
$ podman run --it --rm --entrypoint /usr/local/bin/pyngoST.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/pyngoST.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/pyngoST_utils.py
$ podman run --it --rm --entrypoint /usr/local/bin/pyngoST_utils.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/pyngoST_utils.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
