...
updated_at: "2024-04-25 02:42:50.091309"
...
```bash
$ shpc install quay.io/biocontainers/galitime:0.1.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/galitime/0.1.2--pyhdfd78af_0
$ module help quay.io/biocontainers/galitime/0.1.2--pyhdfd78af_0
```
