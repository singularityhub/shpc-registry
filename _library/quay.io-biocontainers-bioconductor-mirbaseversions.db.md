...
updated_at: "2023-09-27 03:14:31.653456"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mirbaseversions.db:1.1.0--r43hdfd78af_12
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mirbaseversions.db/1.1.0--r43hdfd78af_12
$ module help quay.io/biocontainers/bioconductor-mirbaseversions.db/1.1.0--r43hdfd78af_12
```
