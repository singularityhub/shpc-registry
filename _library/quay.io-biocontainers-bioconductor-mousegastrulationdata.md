...
updated_at: "2022-11-02 19:44:09.933803"
latest: "1.8.0--r41hdfd78af_1"
container_url: "https://biocontainers.pro/tools/bioconductor-mousegastrulationdata"
aliases:
 - ".bioconductor-mousegastrulationdata-post-link.sh"
 - ".bioconductor-mousegastrulationdata-pre-unlink.sh"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mousegastrulationdata:1.8.0--r41hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mousegastrulationdata/1.8.0--r41hdfd78af_1
$ module help quay.io/biocontainers/bioconductor-mousegastrulationdata/1.8.0--r41hdfd78af_1
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-mousegastrulationdata-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-mousegastrulationdata-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-mousegastrulationdata-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-mousegastrulationdata-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-mousegastrulationdata-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-mousegastrulationdata-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
