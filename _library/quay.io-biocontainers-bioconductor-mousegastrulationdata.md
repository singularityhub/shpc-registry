...
updated_at: "2026-04-29 06:21:51.572917"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mousegastrulationdata:1.24.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mousegastrulationdata/1.24.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-mousegastrulationdata/1.24.0--r45hdfd78af_0
```
