...
updated_at: "2024-06-10 03:19:43.954409"
...
```bash
$ shpc install quay.io/biocontainers/peaks2utr:1.2.6--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/peaks2utr/1.2.6--pyhdfd78af_0
$ module help quay.io/biocontainers/peaks2utr/1.2.6--pyhdfd78af_0
```
