...
updated_at: "2026-09-24 08:11:00.289062"
...
```bash
$ shpc install quay.io/biocontainers/peaks2utr:1.5.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/peaks2utr/1.5.2--pyhdfd78af_0
$ module help quay.io/biocontainers/peaks2utr/1.5.2--pyhdfd78af_0
```
