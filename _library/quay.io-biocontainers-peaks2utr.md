...
updated_at: "2026-03-24 04:53:04.383351"
...
```bash
$ shpc install quay.io/biocontainers/peaks2utr:1.5.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/peaks2utr/1.5.0--pyhdfd78af_0
$ module help quay.io/biocontainers/peaks2utr/1.5.0--pyhdfd78af_0
```
