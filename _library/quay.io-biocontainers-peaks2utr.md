...
updated_at: "2025-10-13 04:18:43.189230"
...
```bash
$ shpc install quay.io/biocontainers/peaks2utr:1.4.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/peaks2utr/1.4.1--pyhdfd78af_0
$ module help quay.io/biocontainers/peaks2utr/1.4.1--pyhdfd78af_0
```
