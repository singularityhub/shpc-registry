...
updated_at: "2023-12-05 03:06:17.965358"
...
```bash
$ shpc install quay.io/biocontainers/peaks2utr:1.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/peaks2utr/1.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/peaks2utr/1.2.0--pyhdfd78af_0
```
