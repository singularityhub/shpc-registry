...
updated_at: "2026-05-27 07:18:15.429919"
...
```bash
$ shpc install quay.io/biocontainers/peaks2utr:1.5.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/peaks2utr/1.5.1--pyhdfd78af_0
$ module help quay.io/biocontainers/peaks2utr/1.5.1--pyhdfd78af_0
```
