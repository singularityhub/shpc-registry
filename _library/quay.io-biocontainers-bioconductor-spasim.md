...
updated_at: "2026-04-05 04:47:08.651376"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-spasim:1.12.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-spasim/1.12.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-spasim/1.12.0--r45hdfd78af_0
```
