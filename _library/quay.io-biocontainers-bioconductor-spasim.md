...
updated_at: "2025-12-22 05:45:15.503445"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-spasim:1.8.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-spasim/1.8.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-spasim/1.8.0--r44hdfd78af_0
```
