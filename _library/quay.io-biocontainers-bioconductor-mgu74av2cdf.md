...
updated_at: "2024-07-05 03:04:14.176918"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mgu74av2cdf:2.18.0--r43hdfd78af_12
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mgu74av2cdf/2.18.0--r43hdfd78af_12
$ module help quay.io/biocontainers/bioconductor-mgu74av2cdf/2.18.0--r43hdfd78af_12
```
