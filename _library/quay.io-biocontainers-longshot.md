...
updated_at: "2024-10-31 03:29:20.860449"
latest: "1.0.0--hd4f2111_2"
...
```bash
$ shpc install quay.io/biocontainers/longshot:1.0.0--hd4f2111_2
```
...
```bash
$ module load quay.io/biocontainers/longshot/1.0.0--hd4f2111_2
$ module help quay.io/biocontainers/longshot/1.0.0--hd4f2111_2
```
