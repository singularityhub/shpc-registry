...
updated_at: "2026-01-08 04:27:06.035091"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gdsarray:1.26.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gdsarray/1.26.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-gdsarray/1.26.0--r44hdfd78af_0
```
