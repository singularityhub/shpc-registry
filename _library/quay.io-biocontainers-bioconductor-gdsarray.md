...
updated_at: "2026-03-27 04:59:52.308948"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gdsarray:1.30.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gdsarray/1.30.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-gdsarray/1.30.0--r45hdfd78af_0
```
