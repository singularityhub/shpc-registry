...
updated_at: "2023-09-22 02:35:54.738998"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gdsarray:1.20.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gdsarray/1.20.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-gdsarray/1.20.0--r43hdfd78af_0
```
