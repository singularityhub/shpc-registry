...
updated_at: "2025-08-07 09:41:17.843609"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-qvalue:2.38.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-qvalue/2.38.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-qvalue/2.38.0--r44hdfd78af_0
```
