...
updated_at: "2026-03-24 05:00:54.862987"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ibmq:1.50.0--r45h57f0213_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ibmq/1.50.0--r45h57f0213_0
$ module help quay.io/biocontainers/bioconductor-ibmq/1.50.0--r45h57f0213_0
```
