...
updated_at: "2024-12-07 03:13:35.994347"
latest: "0.6.5--h43eeafb_3"
...
```bash
$ shpc install quay.io/biocontainers/psmc:0.6.5--h43eeafb_3
```
...
```bash
$ module load quay.io/biocontainers/psmc/0.6.5--h43eeafb_3
$ module help quay.io/biocontainers/psmc/0.6.5--h43eeafb_3
```
