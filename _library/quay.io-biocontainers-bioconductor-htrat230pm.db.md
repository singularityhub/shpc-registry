...
updated_at: "2026-04-02 04:34:12.041626"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-htrat230pm.db:3.13.0--r45hdfd78af_6
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-htrat230pm.db/3.13.0--r45hdfd78af_6
$ module help quay.io/biocontainers/bioconductor-htrat230pm.db/3.13.0--r45hdfd78af_6
```
