...
updated_at: "2026-01-06 04:05:12.374673"
latest: "2.2"
...
```bash
$ shpc install quay.io/biocontainers/bamcmp:2.2
```
...
```bash
$ module load quay.io/biocontainers/bamcmp/2.2
$ module help quay.io/biocontainers/bamcmp/2.2
```
