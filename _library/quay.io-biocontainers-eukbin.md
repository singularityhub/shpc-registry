---
layout: container
name:  "quay.io/biocontainers/eukbin"
maintainer: "@vsoch"
...
updated_at: "2026-03-23 05:24:33.765981"
...
aliases:
 ...
 - "lstopo"
versions:
 - "0.1.0--py314hdfd78af_0"
description: "singularity registry hpc automated addition for eukbin"
config: {"url": "https://biocontainers.pro/tools/eukbin", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for eukbin", "latest": {"0.1.0--py314hdfd78af_0": "sha256:dc42f1b9b68e6536df1edca41a720e09d38d33ab943d4d96296981e0d42c0b18"}, "tags": {"0.1.0--py314hdfd78af_0": "sha256:dc42f1b9b68e6536df1edca41a720e09d38d33ab943d4d96296981e0d42c0b18"}, "docker": "quay.io/biocontainers/eukbin", "aliases": {"eukbin": "/usr/local/bin/eukbin", "protoc-33.5.0": "/usr/local/bin/protoc-33.5.0", "protoc-gen-upb-33.5.0": "/usr/local/bin/protoc-gen-upb-33.5.0", "protoc-gen-upb_minitable-33.5.0": "/usr/local/bin/protoc-gen-upb_minitable-33.5.0", "protoc-gen-upbdefs-33.5.0": "/usr/local/bin/protoc-gen-upbdefs-33.5.0", "protoc-gen-upb_minitable": "/usr/local/bin/protoc-gen-upb_minitable", "torchfrtrace": "/usr/local/bin/torchfrtrace", "pybind11-config": "/usr/local/bin/pybind11-config", "protoc-gen-upb": "/usr/local/bin/protoc-gen-upb", "protoc-gen-upbdefs": "/usr/local/bin/protoc-gen-upbdefs", "torch_shm_manager": "/usr/local/bin/torch_shm_manager", "isympy": "/usr/local/bin/isympy", "torchrun": "/usr/local/bin/torchrun", "idle3.14": "/usr/local/bin/idle3.14", "pydoc3.14": "/usr/local/bin/pydoc3.14", "python3.14": "/usr/local/bin/python3.14", "python3.14-config": "/usr/local/bin/python3.14-config", "hwloc-gather-cpuid": "/usr/local/bin/hwloc-gather-cpuid", "hwloc-annotate": "/usr/local/bin/hwloc-annotate", "hwloc-bind": "/usr/local/bin/hwloc-bind", "hwloc-calc": "/usr/local/bin/hwloc-calc", "hwloc-compress-dir": "/usr/local/bin/hwloc-compress-dir", "hwloc-diff": "/usr/local/bin/hwloc-diff", "hwloc-distrib": "/usr/local/bin/hwloc-distrib", "hwloc-gather-topology": "/usr/local/bin/hwloc-gather-topology", "hwloc-info": "/usr/local/bin/hwloc-info", "hwloc-ls": "/usr/local/bin/hwloc-ls", "hwloc-patch": "/usr/local/bin/hwloc-patch", "hwloc-ps": "/usr/local/bin/hwloc-ps", "lstopo": "/usr/local/bin/lstopo"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/eukbin.
singularity registry hpc automated addition for eukbin
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/eukbin
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/eukbin:0.1.0--py314hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/eukbin/0.1.0--py314hdfd78af_0
$ module help quay.io/biocontainers/eukbin/0.1.0--py314hdfd78af_0
```
...
#### eukbin-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### eukbin-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/eukbin
$ podman run --it --rm --entrypoint /usr/local/bin/eukbin   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/eukbin   -v ${PWD} -w ${PWD} <container> -c " $@"
```
