...
updated_at: "2025-11-15 03:32:48.308300"
...
```bash
$ shpc install quay.io/biocontainers/mapsplice:2.2.1--py39hc2f06e3_2
```
...
```bash
$ module load quay.io/biocontainers/mapsplice/2.2.1--py39hc2f06e3_2
$ module help quay.io/biocontainers/mapsplice/2.2.1--py39hc2f06e3_2
```
