...
updated_at: "2024-02-09 03:38:17.353981"
...
```bash
$ shpc install quay.io/biocontainers/pymlst:2.1.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pymlst/2.1.5--pyhdfd78af_0
$ module help quay.io/biocontainers/pymlst/2.1.5--pyhdfd78af_0
```
