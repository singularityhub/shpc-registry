...
updated_at: "2023-10-05 04:07:22.360244"
...
```bash
$ shpc install quay.io/biocontainers/pymlst:2.1.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pymlst/2.1.4--pyhdfd78af_0
$ module help quay.io/biocontainers/pymlst/2.1.4--pyhdfd78af_0
```
