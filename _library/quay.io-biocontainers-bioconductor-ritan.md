...
updated_at: "2026-03-28 04:31:25.051351"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ritan:1.34.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ritan/1.34.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ritan/1.34.0--r45hdfd78af_0
```
