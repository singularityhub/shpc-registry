...
updated_at: "2022-10-29 05:45:32.165421"
latest: "1.8.1--r351_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-chronos:1.8.1--r351_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-chronos/1.8.1--r351_0
$ module help quay.io/biocontainers/bioconductor-chronos/1.8.1--r351_0
```
