...
updated_at: "2025-08-08 03:49:51.646147"
...
```bash
$ shpc install quay.io/biocontainers/sincei:0.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sincei/0.5--pyhdfd78af_0
$ module help quay.io/biocontainers/sincei/0.5--pyhdfd78af_0
```
