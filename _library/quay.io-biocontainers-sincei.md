...
updated_at: "2026-01-20 04:01:01.151719"
...
```bash
$ shpc install quay.io/biocontainers/sincei:0.5.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sincei/0.5.2--pyhdfd78af_0
$ module help quay.io/biocontainers/sincei/0.5.2--pyhdfd78af_0
```
