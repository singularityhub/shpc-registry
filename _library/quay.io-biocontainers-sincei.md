...
updated_at: "2025-10-13 03:58:35.599028"
...
```bash
$ shpc install quay.io/biocontainers/sincei:0.5.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sincei/0.5.1--pyhdfd78af_0
$ module help quay.io/biocontainers/sincei/0.5.1--pyhdfd78af_0
```
