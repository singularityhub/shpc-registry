...
updated_at: "2024-05-15 03:09:52.175826"
...
```bash
$ shpc install quay.io/biocontainers/sincei:0.3.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sincei/0.3.1--pyhdfd78af_0
$ module help quay.io/biocontainers/sincei/0.3.1--pyhdfd78af_0
```
