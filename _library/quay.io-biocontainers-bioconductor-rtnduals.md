...
updated_at: "2023-11-07 03:02:38.174619"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rtnduals:1.24.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rtnduals/1.24.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rtnduals/1.24.0--r43hdfd78af_0
```
