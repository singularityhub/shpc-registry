...
updated_at: "2023-10-16 03:13:43.180514"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-micrornaome:1.22.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-micrornaome/1.22.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-micrornaome/1.22.0--r43hdfd78af_0
```
