...
updated_at: "2024-11-13 03:33:28.197011"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-micrornaome:1.24.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-micrornaome/1.24.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-micrornaome/1.24.0--r43hdfd78af_0
```
