...
updated_at: "2025-03-25 03:14:00.721876"
latest: "6.25.10--h9ee0642_0"
...
```bash
$ shpc install quay.io/biocontainers/megan:6.25.10--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/megan/6.25.10--h9ee0642_0
$ module help quay.io/biocontainers/megan/6.25.10--h9ee0642_0
```
