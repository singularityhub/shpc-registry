...
updated_at: "2026-03-31 05:00:16.933419"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mogsa:1.44.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mogsa/1.44.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-mogsa/1.44.0--r45hdfd78af_0
```
