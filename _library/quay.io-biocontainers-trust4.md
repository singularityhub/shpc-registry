...
updated_at: "2026-01-26 04:11:05.315982"
latest: "1.1.8--h5ca1c30_0"
...
```bash
$ shpc install quay.io/biocontainers/trust4:1.1.8--h5ca1c30_0
```
...
```bash
$ module load quay.io/biocontainers/trust4/1.1.8--h5ca1c30_0
$ module help quay.io/biocontainers/trust4/1.1.8--h5ca1c30_0
```
