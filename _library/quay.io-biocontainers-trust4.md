...
updated_at: "2024-01-13 02:36:21.825482"
latest: "1.0.13--h43eeafb_0"
...
```bash
$ shpc install quay.io/biocontainers/trust4:1.0.13--h43eeafb_0
```
...
```bash
$ module load quay.io/biocontainers/trust4/1.0.13--h43eeafb_0
$ module help quay.io/biocontainers/trust4/1.0.13--h43eeafb_0
```
