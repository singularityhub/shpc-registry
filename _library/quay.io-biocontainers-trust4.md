...
updated_at: "2024-10-21 02:59:02.494561"
...
```bash
$ shpc install quay.io/biocontainers/trust4:1.1.4--h43eeafb_0
```
...
```bash
$ module load quay.io/biocontainers/trust4/1.1.4--h43eeafb_0
$ module help quay.io/biocontainers/trust4/1.1.4--h43eeafb_0
```
