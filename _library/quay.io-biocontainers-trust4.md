...
updated_at: "2026-04-03 15:15:43.676669"
latest: "1.1.9--h7f5d12c_0"
...
```bash
$ shpc install quay.io/biocontainers/trust4:1.1.9--h7f5d12c_0
```
...
```bash
$ module load quay.io/biocontainers/trust4/1.1.9--h7f5d12c_0
$ module help quay.io/biocontainers/trust4/1.1.9--h7f5d12c_0
```
