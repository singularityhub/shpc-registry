...
updated_at: "2026-09-23 07:36:13.001312"
latest: "1.1.10--h5814d7d_0"
...
```bash
$ shpc install quay.io/biocontainers/trust4:1.1.10--h5814d7d_0
```
...
```bash
$ module load quay.io/biocontainers/trust4/1.1.10--h5814d7d_0
$ module help quay.io/biocontainers/trust4/1.1.10--h5814d7d_0
```
