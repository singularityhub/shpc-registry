...
updated_at: "2024-07-23 03:00:53.870464"
latest: "1.1.2--h43eeafb_1"
...
```bash
$ shpc install quay.io/biocontainers/trust4:1.1.2--h43eeafb_1
```
...
```bash
$ module load quay.io/biocontainers/trust4/1.1.2--h43eeafb_1
$ module help quay.io/biocontainers/trust4/1.1.2--h43eeafb_1
```
