...
updated_at: "2026-04-01 05:01:22.909730"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-trnadbimport:1.28.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-trnadbimport/1.28.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-trnadbimport/1.28.0--r45hdfd78af_0
```
