...
updated_at: "2025-08-13 03:43:59.550463"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-trnadbimport:1.24.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-trnadbimport/1.24.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-trnadbimport/1.24.0--r44hdfd78af_0
```
