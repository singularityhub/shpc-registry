...
updated_at: "2026-08-29 09:18:28.787857"
...
```bash
$ shpc install quay.io/biocontainers/ibridges:2.1.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ibridges/2.1.1--pyhdfd78af_0
$ module help quay.io/biocontainers/ibridges/2.1.1--pyhdfd78af_0
```
