...
updated_at: "2025-10-08 03:20:15.393891"
...
```bash
$ shpc install quay.io/biocontainers/ibridges:1.5.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ibridges/1.5.1--pyhdfd78af_0
$ module help quay.io/biocontainers/ibridges/1.5.1--pyhdfd78af_0
```
