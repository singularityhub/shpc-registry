...
updated_at: "2026-05-23 05:54:46.394817"
...
```bash
$ shpc install quay.io/biocontainers/ibridges:2.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ibridges/2.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/ibridges/2.1.0--pyhdfd78af_0
```
