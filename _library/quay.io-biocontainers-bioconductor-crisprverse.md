...
updated_at: "2026-03-28 04:38:26.838810"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-crisprverse:1.12.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-crisprverse/1.12.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-crisprverse/1.12.0--r45hdfd78af_0
```
