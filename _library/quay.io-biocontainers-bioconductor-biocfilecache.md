...
updated_at: "2026-03-27 05:05:32.713901"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-biocfilecache:3.0.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-biocfilecache/3.0.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-biocfilecache/3.0.0--r45hdfd78af_0
```
