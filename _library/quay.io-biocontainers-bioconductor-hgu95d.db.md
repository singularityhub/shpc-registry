...
updated_at: "2025-08-02 04:13:34.685770"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hgu95d.db:3.13.0--r44hdfd78af_5
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hgu95d.db/3.13.0--r44hdfd78af_5
$ module help quay.io/biocontainers/bioconductor-hgu95d.db/3.13.0--r44hdfd78af_5
```
