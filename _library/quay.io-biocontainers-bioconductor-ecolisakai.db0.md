...
updated_at: "2024-06-05 03:09:52.899970"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ecolisakai.db0:3.18.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ecolisakai.db0/3.18.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ecolisakai.db0/3.18.0--r43hdfd78af_0
```
