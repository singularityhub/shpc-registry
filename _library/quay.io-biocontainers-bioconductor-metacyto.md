...
updated_at: "2026-04-05 05:13:31.364522"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-metacyto:1.32.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-metacyto/1.32.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-metacyto/1.32.0--r45hdfd78af_0
```
