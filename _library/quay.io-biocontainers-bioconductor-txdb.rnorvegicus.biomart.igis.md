...
updated_at: "2026-03-28 04:49:33.514589"
latest: "2.3.2--r45hdfd78af_14"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-txdb.rnorvegicus.biomart.igis:2.3.2--r45hdfd78af_14
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-txdb.rnorvegicus.biomart.igis/2.3.2--r45hdfd78af_14
$ module help quay.io/biocontainers/bioconductor-txdb.rnorvegicus.biomart.igis/2.3.2--r45hdfd78af_14
```
