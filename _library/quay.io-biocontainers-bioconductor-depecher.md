...
updated_at: "2023-05-25 03:21:07.305818"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-depecher:1.14.0--r42hf17093f_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-depecher/1.14.0--r42hf17093f_1
$ module help quay.io/biocontainers/bioconductor-depecher/1.14.0--r42hf17093f_1
```
