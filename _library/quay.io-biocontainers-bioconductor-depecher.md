...
updated_at: "2026-02-22 04:37:35.501121"
latest: "1.26.0--r45h617649d_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-depecher:1.26.0--r45h617649d_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-depecher/1.26.0--r45h617649d_0
$ module help quay.io/biocontainers/bioconductor-depecher/1.26.0--r45h617649d_0
```
