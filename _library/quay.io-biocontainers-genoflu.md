...
updated_at: "2023-06-12 03:43:08.607242"
...
```bash
$ shpc install quay.io/biocontainers/genoflu:1.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/genoflu/1.0--hdfd78af_0
$ module help quay.io/biocontainers/genoflu/1.0--hdfd78af_0
```
