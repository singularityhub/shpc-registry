...
updated_at: "2026-09-22 07:39:10.648729"
...
```bash
$ shpc install quay.io/biocontainers/genoflu:1.08--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/genoflu/1.08--hdfd78af_0
$ module help quay.io/biocontainers/genoflu/1.08--hdfd78af_0
```
