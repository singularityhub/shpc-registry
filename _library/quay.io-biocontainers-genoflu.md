...
updated_at: "2026-04-05 05:05:39.477207"
latest: "1.07--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/genoflu:1.07--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/genoflu/1.07--hdfd78af_0
$ module help quay.io/biocontainers/genoflu/1.07--hdfd78af_0
```
