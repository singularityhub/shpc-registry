...
updated_at: "2024-07-27 03:08:25.587629"
...
```bash
$ shpc install quay.io/biocontainers/genoflu:1.03--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/genoflu/1.03--hdfd78af_0
$ module help quay.io/biocontainers/genoflu/1.03--hdfd78af_0
```
