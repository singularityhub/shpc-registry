...
updated_at: "2024-12-22 03:04:10.941811"
...
```bash
$ shpc install quay.io/biocontainers/genoflu:1.05--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/genoflu/1.05--hdfd78af_0
$ module help quay.io/biocontainers/genoflu/1.05--hdfd78af_0
```
