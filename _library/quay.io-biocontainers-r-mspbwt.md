---
layout: container
name:  "quay.io/biocontainers/r-mspbwt"
maintainer: "@vsoch"
...
updated_at: "2024-09-01 03:31:00.753730"
...
```bash
$ shpc install quay.io/biocontainers/r-mspbwt
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/r-mspbwt:0.1.0--r43hdbdd923_1
```
...
```bash
$ module load quay.io/biocontainers/r-mspbwt/0.1.0--r43hdbdd923_1
$ module help quay.io/biocontainers/r-mspbwt/0.1.0--r43hdbdd923_1
```
...
#### r-mspbwt-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-mspbwt-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/STITCH.R
$ podman run --it --rm --entrypoint /usr/local/bin/STITCH.R   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/STITCH.R   -v ${PWD} -w ${PWD} <container> -c " $@"
```
