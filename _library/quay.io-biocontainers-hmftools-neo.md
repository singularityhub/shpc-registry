...
updated_at: "2026-06-26 06:36:32.540728"
...
```bash
$ shpc install quay.io/biocontainers/hmftools-neo:1.3--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hmftools-neo/1.3--hdfd78af_0
$ module help quay.io/biocontainers/hmftools-neo/1.3--hdfd78af_0
```
