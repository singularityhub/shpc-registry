...
updated_at: "2022-11-04 00:32:36.136091"
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-mosaicsexample-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-mosaicsexample-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-mosaicsexample-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-mosaicsexample-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-mosaicsexample-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-mosaicsexample-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
