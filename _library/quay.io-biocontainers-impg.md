...
updated_at: "2026-08-29 08:51:47.362959"
latest: "0.5.0--h57f8f1b_0"
...
```bash
$ shpc install quay.io/biocontainers/impg:0.5.0--h57f8f1b_0
```
...
```bash
$ module load quay.io/biocontainers/impg/0.5.0--h57f8f1b_0
$ module help quay.io/biocontainers/impg/0.5.0--h57f8f1b_0
```
