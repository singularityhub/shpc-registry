...
updated_at: "2024-05-07 02:38:15.081011"
...
```bash
$ shpc install quay.io/biocontainers/camlhmp:0.0.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/camlhmp/0.0.1--pyhdfd78af_0
$ module help quay.io/biocontainers/camlhmp/0.0.1--pyhdfd78af_0
```
