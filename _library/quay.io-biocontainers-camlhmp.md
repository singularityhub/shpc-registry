...
updated_at: "2024-10-28 03:01:44.176205"
...
```bash
$ shpc install quay.io/biocontainers/camlhmp:1.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/camlhmp/1.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/camlhmp/1.1.0--pyhdfd78af_0
```
