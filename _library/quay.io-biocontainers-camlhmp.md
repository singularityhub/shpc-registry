...
updated_at: "2024-05-25 03:01:18.170234"
...
```bash
$ shpc install quay.io/biocontainers/camlhmp:0.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/camlhmp/0.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/camlhmp/0.1.0--pyhdfd78af_0
```
