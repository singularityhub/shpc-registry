...
updated_at: "2024-08-27 06:50:22.833793"
...
```bash
$ shpc install quay.io/biocontainers/camlhmp:1.0.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/camlhmp/1.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/camlhmp/1.0.0--pyhdfd78af_0
```
