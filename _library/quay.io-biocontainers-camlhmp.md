...
updated_at: "2026-03-30 04:55:52.655575"
...
```bash
$ shpc install quay.io/biocontainers/camlhmp:1.1.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/camlhmp/1.1.4--pyhdfd78af_0
$ module help quay.io/biocontainers/camlhmp/1.1.4--pyhdfd78af_0
```
