...
updated_at: "2023-07-06 06:41:26.090886"
latest: "1.32.0--r42ha9d7317_2"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cosnet:1.32.0--r42ha9d7317_2
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cosnet/1.32.0--r42ha9d7317_2
$ module help quay.io/biocontainers/bioconductor-cosnet/1.32.0--r42ha9d7317_2
```
