...
updated_at: "2022-10-27 00:32:18.831978"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-dmelsgi:1.26.0--r41hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-dmelsgi/1.26.0--r41hdfd78af_1
$ module help quay.io/biocontainers/bioconductor-dmelsgi/1.26.0--r41hdfd78af_1
```
