...
updated_at: "2026-06-21 07:02:34.471163"
latest: "2.1.3--pyh8506780_0"
...
```bash
$ shpc install quay.io/biocontainers/amulety:2.1.3--pyh8506780_0
```
...
```bash
$ module load quay.io/biocontainers/amulety/2.1.3--pyh8506780_0
$ module help quay.io/biocontainers/amulety/2.1.3--pyh8506780_0
```
