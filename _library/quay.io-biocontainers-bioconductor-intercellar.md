...
updated_at: "2025-01-19 03:33:08.098934"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-intercellar:2.12.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-intercellar/2.12.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-intercellar/2.12.0--r44hdfd78af_0
```
