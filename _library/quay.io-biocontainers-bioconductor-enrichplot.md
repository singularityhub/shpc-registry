...
updated_at: "2023-10-15 02:53:47.128807"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-enrichplot:1.20.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-enrichplot/1.20.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-enrichplot/1.20.0--r43hdfd78af_0
```
