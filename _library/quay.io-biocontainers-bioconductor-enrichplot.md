...
updated_at: "2026-03-31 05:32:21.257165"
latest: "1.30.4--r45hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-enrichplot:1.30.4--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-enrichplot/1.30.4--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-enrichplot/1.30.4--r45hdfd78af_0
```
