...
updated_at: "2023-10-23 03:09:15.402823"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-genestructuretools:1.20.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-genestructuretools/1.20.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-genestructuretools/1.20.0--r43hdfd78af_0
```
