...
updated_at: "2025-03-28 03:26:22.160275"
latest: "1.4.0--h503566f_0"
...
```bash
$ shpc install quay.io/biocontainers/illumina-interop:1.4.0--h503566f_0
```
...
```bash
$ module load quay.io/biocontainers/illumina-interop/1.4.0--h503566f_0
$ module help quay.io/biocontainers/illumina-interop/1.4.0--h503566f_0
```
