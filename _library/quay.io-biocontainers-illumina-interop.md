...
updated_at: "2025-03-12 04:57:20.731888"
...
```bash
$ shpc install quay.io/biocontainers/illumina-interop:1.3.2--h503566f_1
```
...
```bash
$ module load quay.io/biocontainers/illumina-interop/1.3.2--h503566f_1
$ module help quay.io/biocontainers/illumina-interop/1.3.2--h503566f_1
```
