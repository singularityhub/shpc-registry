...
updated_at: "2022-11-02 00:35:48.247662"
latest: "1.1.9--he1b5a44_0"
...
```bash
$ shpc install quay.io/biocontainers/illumina-interop:1.1.9--he1b5a44_0
```
...
```bash
$ module load quay.io/biocontainers/illumina-interop/1.1.9--he1b5a44_0
$ module help quay.io/biocontainers/illumina-interop/1.1.9--he1b5a44_0
```
