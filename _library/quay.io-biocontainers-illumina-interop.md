...
updated_at: "2023-08-26 02:44:02.685210"
latest: "1.2.4--hdbdd923_2"
...
```bash
$ shpc install quay.io/biocontainers/illumina-interop:1.2.4--hdbdd923_2
```
...
```bash
$ module load quay.io/biocontainers/illumina-interop/1.2.4--hdbdd923_2
$ module help quay.io/biocontainers/illumina-interop/1.2.4--hdbdd923_2
```
