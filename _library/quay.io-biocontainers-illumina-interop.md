...
updated_at: "2023-05-10 02:47:17.485255"
latest: "1.2.3--h87f3376_0"
...
```bash
$ shpc install quay.io/biocontainers/illumina-interop:1.2.3--h87f3376_0
```
...
```bash
$ module load quay.io/biocontainers/illumina-interop/1.2.3--h87f3376_0
$ module help quay.io/biocontainers/illumina-interop/1.2.3--h87f3376_0
```
