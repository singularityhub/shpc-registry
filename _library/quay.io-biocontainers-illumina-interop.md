...
updated_at: "2025-12-23 03:46:42.320212"
latest: "1.9.0--h503566f_0"
...
```bash
$ shpc install quay.io/biocontainers/illumina-interop:1.9.0--h503566f_0
```
...
```bash
$ module load quay.io/biocontainers/illumina-interop/1.9.0--h503566f_0
$ module help quay.io/biocontainers/illumina-interop/1.9.0--h503566f_0
```
