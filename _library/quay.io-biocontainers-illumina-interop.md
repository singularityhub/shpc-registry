...
updated_at: "2023-04-12 03:16:44.183607"
latest: "1.2.2--h87f3376_0"
...
```bash
$ shpc install quay.io/biocontainers/illumina-interop:1.2.2--h87f3376_0
```
...
```bash
$ module load quay.io/biocontainers/illumina-interop/1.2.2--h87f3376_0
$ module help quay.io/biocontainers/illumina-interop/1.2.2--h87f3376_0
```
