...
updated_at: "2024-01-05 02:42:15.223610"
...
```bash
$ shpc install quay.io/biocontainers/illumina-interop:1.3.1--hdbdd923_0
```
...
```bash
$ module load quay.io/biocontainers/illumina-interop/1.3.1--hdbdd923_0
$ module help quay.io/biocontainers/illumina-interop/1.3.1--hdbdd923_0
```
