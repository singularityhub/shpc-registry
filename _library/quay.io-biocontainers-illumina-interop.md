...
updated_at: "2025-09-12 03:18:49.621732"
latest: "1.5.0--h503566f_0"
...
```bash
$ shpc install quay.io/biocontainers/illumina-interop:1.5.0--h503566f_0
```
...
```bash
$ module load quay.io/biocontainers/illumina-interop/1.5.0--h503566f_0
$ module help quay.io/biocontainers/illumina-interop/1.5.0--h503566f_0
```
