...
updated_at: "2026-04-05 04:58:42.592425"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-blimatestingdata:1.30.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-blimatestingdata/1.30.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-blimatestingdata/1.30.0--r45hdfd78af_0
```
