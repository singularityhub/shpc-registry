...
updated_at: "2022-11-01 03:06:37.927578"
latest: "1.9.0--r40_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-blimatestingdata:1.9.0--r40_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-blimatestingdata/1.9.0--r40_0
$ module help quay.io/biocontainers/bioconductor-blimatestingdata/1.9.0--r40_0
```
