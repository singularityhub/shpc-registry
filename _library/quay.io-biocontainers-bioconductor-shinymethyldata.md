...
updated_at: "2026-02-24 04:39:20.252607"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-shinymethyldata:1.30.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-shinymethyldata/1.30.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-shinymethyldata/1.30.0--r45hdfd78af_0
```
