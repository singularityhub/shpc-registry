...
updated_at: "2024-11-01 03:06:23.073469"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hgu133afrmavecs:1.5.0--r43hdfd78af_13
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hgu133afrmavecs/1.5.0--r43hdfd78af_13
$ module help quay.io/biocontainers/bioconductor-hgu133afrmavecs/1.5.0--r43hdfd78af_13
```
