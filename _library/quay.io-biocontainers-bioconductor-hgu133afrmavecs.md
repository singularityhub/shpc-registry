...
updated_at: "2026-03-20 00:56:30.108362"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hgu133afrmavecs:1.5.0--r45hdfd78af_15
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hgu133afrmavecs/1.5.0--r45hdfd78af_15
$ module help quay.io/biocontainers/bioconductor-hgu133afrmavecs/1.5.0--r45hdfd78af_15
```
