...
updated_at: "2023-09-17 03:05:08.153284"
...
```bash
$ shpc install quay.io/biocontainers/r-panther:0.4.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/r-panther/0.4.0--r43hdfd78af_0
$ module help quay.io/biocontainers/r-panther/0.4.0--r43hdfd78af_0
```
