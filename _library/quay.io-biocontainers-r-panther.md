---
layout: container
name:  "quay.io/biocontainers/r-panther"
maintainer: "@vsoch"
...
updated_at: "2026-09-25 08:01:26.699551"
latest: "0.5.2--r45hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/r-panther
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/r-panther:0.5.2--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/r-panther/0.5.2--r45hdfd78af_0
$ module help quay.io/biocontainers/r-panther/0.5.2--r45hdfd78af_0
```
...
#### r-panther-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-panther-inspect-deffile:
