...
updated_at: "2026-01-08 03:45:49.036894"
...
```bash
$ shpc install quay.io/biocontainers/generax:2.1.3--hf316886_3
```
...
```bash
$ module load quay.io/biocontainers/generax/2.1.3--hf316886_3
$ module help quay.io/biocontainers/generax/2.1.3--hf316886_3
```
