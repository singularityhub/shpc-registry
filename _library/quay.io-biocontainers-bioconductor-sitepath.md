...
updated_at: "2026-04-03 15:40:11.841867"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-sitepath:1.26.0--r45ha27e39d_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-sitepath/1.26.0--r45ha27e39d_0
$ module help quay.io/biocontainers/bioconductor-sitepath/1.26.0--r45ha27e39d_0
```
