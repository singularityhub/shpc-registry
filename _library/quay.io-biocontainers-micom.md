...
updated_at: "2023-11-18 03:00:16.239770"
latest: "0.33.0--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/micom:0.33.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/micom/0.33.0--pyhdfd78af_0
$ module help quay.io/biocontainers/micom/0.33.0--pyhdfd78af_0
```
