...
updated_at: "2024-05-06 02:38:24.397629"
latest: "0.34.1--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/micom:0.34.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/micom/0.34.1--pyhdfd78af_0
$ module help quay.io/biocontainers/micom/0.34.1--pyhdfd78af_0
```
