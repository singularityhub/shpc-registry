...
updated_at: "2024-10-17 18:23:19.139895"
latest: "0.37.0--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/micom:0.37.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/micom/0.37.0--pyhdfd78af_0
$ module help quay.io/biocontainers/micom/0.37.0--pyhdfd78af_0
```
