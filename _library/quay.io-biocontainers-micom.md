...
updated_at: "2024-09-14 03:31:01.150179"
latest: "0.36.3--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/micom:0.36.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/micom/0.36.3--pyhdfd78af_0
$ module help quay.io/biocontainers/micom/0.36.3--pyhdfd78af_0
```
