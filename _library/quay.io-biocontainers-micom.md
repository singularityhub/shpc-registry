...
updated_at: "2024-05-26 03:16:49.517956"
latest: "0.35.0--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/micom:0.35.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/micom/0.35.0--pyhdfd78af_0
$ module help quay.io/biocontainers/micom/0.35.0--pyhdfd78af_0
```
