...
updated_at: "2025-03-05 03:20:10.422998"
latest: "2.3--pyhdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/gdc-client:2.3--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/gdc-client/2.3--pyhdfd78af_1
$ module help quay.io/biocontainers/gdc-client/2.3--pyhdfd78af_1
```
