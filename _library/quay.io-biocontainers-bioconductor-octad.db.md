...
updated_at: "2023-08-20 02:58:05.234111"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-octad.db:1.2.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-octad.db/1.2.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-octad.db/1.2.0--r43hdfd78af_0
```
