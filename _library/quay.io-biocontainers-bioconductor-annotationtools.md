...
updated_at: "2024-12-19 03:37:58.109829"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-annotationtools:1.80.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-annotationtools/1.80.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-annotationtools/1.80.0--r44hdfd78af_0
```
