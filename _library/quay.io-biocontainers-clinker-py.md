...
updated_at: "2024-12-05 03:50:29.865452"
latest: "0.0.31--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/clinker-py:0.0.31--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/clinker-py/0.0.31--pyhdfd78af_0
$ module help quay.io/biocontainers/clinker-py/0.0.31--pyhdfd78af_0
```
