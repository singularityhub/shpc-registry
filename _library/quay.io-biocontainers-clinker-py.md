...
updated_at: "2026-04-05 05:09:49.210490"
...
```bash
$ shpc install quay.io/biocontainers/clinker-py:0.0.32--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/clinker-py/0.0.32--pyhdfd78af_0
$ module help quay.io/biocontainers/clinker-py/0.0.32--pyhdfd78af_0
```
