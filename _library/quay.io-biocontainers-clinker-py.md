...
updated_at: "2023-01-14 03:09:43.126337"
latest: "0.0.26--pyh7cba7a3_0"
...
```bash
$ shpc install quay.io/biocontainers/clinker-py:0.0.26--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/clinker-py/0.0.26--pyh7cba7a3_0
$ module help quay.io/biocontainers/clinker-py/0.0.26--pyh7cba7a3_0
```
