...
updated_at: "2026-05-02 05:41:35.976962"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rcistarget:1.29.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rcistarget/1.29.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rcistarget/1.29.0--r45hdfd78af_0
```
