...
updated_at: "2025-12-17 16:11:59.470885"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rcistarget:1.26.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rcistarget/1.26.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rcistarget/1.26.0--r44hdfd78af_0
```
