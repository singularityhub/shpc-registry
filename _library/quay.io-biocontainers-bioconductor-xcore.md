...
updated_at: "2025-07-26 04:19:13.443022"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-xcore:1.10.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-xcore/1.10.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-xcore/1.10.0--r44hdfd78af_0
```
