...
updated_at: "2022-10-29 05:49:05.295400"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gtrellis:1.26.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gtrellis/1.26.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-gtrellis/1.26.0--r41hdfd78af_0
```
