...
updated_at: "2025-05-04 03:31:02.051776"
latest: "0.3.0--r44h89edbeb_0"
...
```bash
$ shpc install quay.io/biocontainers/r-bpcells:0.3.0--r44h89edbeb_0
```
...
```bash
$ module load quay.io/biocontainers/r-bpcells/0.3.0--r44h89edbeb_0
$ module help quay.io/biocontainers/r-bpcells/0.3.0--r44h89edbeb_0
```
