...
updated_at: "2026-02-26 04:34:10.615804"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-measurementerror.cor:1.82.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-measurementerror.cor/1.82.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-measurementerror.cor/1.82.0--r45hdfd78af_0
```
