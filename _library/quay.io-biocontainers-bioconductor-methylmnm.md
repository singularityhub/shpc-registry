...
updated_at: "2024-02-13 02:54:13.086794"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-methylmnm:1.40.0--r43ha9d7317_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-methylmnm/1.40.0--r43ha9d7317_0
$ module help quay.io/biocontainers/bioconductor-methylmnm/1.40.0--r43ha9d7317_0
```
