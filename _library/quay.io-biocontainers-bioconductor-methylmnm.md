...
updated_at: "2023-07-04 03:35:24.874746"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-methylmnm:1.36.0--r42ha9d7317_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-methylmnm/1.36.0--r42ha9d7317_1
$ module help quay.io/biocontainers/bioconductor-methylmnm/1.36.0--r42ha9d7317_1
```
