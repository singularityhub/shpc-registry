...
updated_at: "2024-04-01 03:07:46.830767"
...
```bash
$ shpc install quay.io/biocontainers/pegasuspy:1.9.0--py39hf95cd2a_0
```
...
```bash
$ module load quay.io/biocontainers/pegasuspy/1.9.0--py39hf95cd2a_0
$ module help quay.io/biocontainers/pegasuspy/1.9.0--py39hf95cd2a_0
```
