...
updated_at: "2025-11-29 02:51:44.060649"
latest: "1.10.2--py311haab0aaa_0"
...
```bash
$ shpc install quay.io/biocontainers/pegasuspy:1.10.2--py311haab0aaa_0
```
...
```bash
$ module load quay.io/biocontainers/pegasuspy/1.10.2--py311haab0aaa_0
$ module help quay.io/biocontainers/pegasuspy/1.10.2--py311haab0aaa_0
```
