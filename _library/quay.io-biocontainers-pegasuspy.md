...
updated_at: "2024-05-27 03:12:02.403830"
latest: "1.9.1.post1--py310h4b81fae_0"
...
```bash
$ shpc install quay.io/biocontainers/pegasuspy:1.9.1.post1--py310h4b81fae_0
```
...
```bash
$ module load quay.io/biocontainers/pegasuspy/1.9.1.post1--py310h4b81fae_0
$ module help quay.io/biocontainers/pegasuspy/1.9.1.post1--py310h4b81fae_0
```
