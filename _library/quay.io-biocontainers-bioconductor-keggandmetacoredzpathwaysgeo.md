...
updated_at: "2024-09-09 02:59:02.950102"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-keggandmetacoredzpathwaysgeo:1.22.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-keggandmetacoredzpathwaysgeo/1.22.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-keggandmetacoredzpathwaysgeo/1.22.0--r43hdfd78af_0
```
