...
updated_at: "2025-02-21 03:12:15.430514"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cordon:1.24.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cordon/1.24.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-cordon/1.24.0--r44hdfd78af_0
```
