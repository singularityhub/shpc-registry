...
updated_at: "2026-04-01 05:45:55.610850"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cordon:1.28.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cordon/1.28.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-cordon/1.28.0--r45hdfd78af_0
```
