...
updated_at: "2022-11-02 00:52:46.164227"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-specond:1.48.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-specond/1.48.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-specond/1.48.0--r41hdfd78af_0
```
