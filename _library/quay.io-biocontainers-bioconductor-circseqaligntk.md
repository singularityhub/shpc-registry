...
updated_at: "2026-03-24 04:48:00.023583"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-circseqaligntk:1.12.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-circseqaligntk/1.12.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-circseqaligntk/1.12.0--r45hdfd78af_0
```
