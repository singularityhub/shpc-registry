...
updated_at: "2024-08-29 02:52:55.620159"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-circseqaligntk:1.4.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-circseqaligntk/1.4.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-circseqaligntk/1.4.0--r43hdfd78af_0
```
