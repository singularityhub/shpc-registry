...
updated_at: "2023-11-15 03:00:45.019850"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-circseqaligntk:1.2.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-circseqaligntk/1.2.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-circseqaligntk/1.2.0--r43hdfd78af_0
```
