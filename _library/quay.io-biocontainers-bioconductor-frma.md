...
updated_at: "2026-03-24 05:08:22.887884"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-frma:1.62.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-frma/1.62.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-frma/1.62.0--r45hdfd78af_0
```
