...
updated_at: "2026-08-28 14:11:07.345555"
...
```bash
$ shpc install quay.io/biocontainers/cellbender:0.4.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/cellbender/0.4.0--pyhdfd78af_0
$ module help quay.io/biocontainers/cellbender/0.4.0--pyhdfd78af_0
```
