...
updated_at: "2026-04-04 05:06:01.235423"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-chippeakanno:3.44.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-chippeakanno/3.44.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-chippeakanno/3.44.0--r45hdfd78af_0
```
