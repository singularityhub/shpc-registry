...
updated_at: "2025-10-28 03:17:57.868081"
...
```bash
$ shpc install quay.io/biocontainers/iobrpy:0.1.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/iobrpy/0.1.3--pyhdfd78af_0
$ module help quay.io/biocontainers/iobrpy/0.1.3--pyhdfd78af_0
```
