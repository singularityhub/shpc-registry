...
updated_at: "2026-06-04 00:33:23.976653"
latest: "0.1.8--py312hc5e4ab4_1"
...
```bash
$ shpc install quay.io/biocontainers/iobrpy:0.1.8--py312hc5e4ab4_1
```
...
```bash
$ module load quay.io/biocontainers/iobrpy/0.1.8--py312hc5e4ab4_1
$ module help quay.io/biocontainers/iobrpy/0.1.8--py312hc5e4ab4_1
```
