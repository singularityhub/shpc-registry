...
updated_at: "2025-12-25 03:45:38.621472"
...
```bash
$ shpc install quay.io/biocontainers/iobrpy:0.1.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/iobrpy/0.1.4--pyhdfd78af_0
$ module help quay.io/biocontainers/iobrpy/0.1.4--pyhdfd78af_0
```
