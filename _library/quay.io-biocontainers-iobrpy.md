...
updated_at: "2026-01-07 03:50:39.185413"
...
```bash
$ shpc install quay.io/biocontainers/iobrpy:0.1.7--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/iobrpy/0.1.7--pyhdfd78af_0
$ module help quay.io/biocontainers/iobrpy/0.1.7--pyhdfd78af_0
```
