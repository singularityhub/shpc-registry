...
updated_at: "2026-08-10 04:17:48.445685"
latest: "0.2.0--py312hc5e4ab4_0"
...
```bash
$ shpc install quay.io/biocontainers/iobrpy:0.2.0--py312hc5e4ab4_0
```
...
```bash
$ module load quay.io/biocontainers/iobrpy/0.2.0--py312hc5e4ab4_0
$ module help quay.io/biocontainers/iobrpy/0.2.0--py312hc5e4ab4_0
```
