...
updated_at: "2025-12-24 04:13:26.399558"
...
```bash
$ shpc install quay.io/biocontainers/pronto:2.6.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pronto/2.6.0--pyhdfd78af_0
$ module help quay.io/biocontainers/pronto/2.6.0--pyhdfd78af_0
```
