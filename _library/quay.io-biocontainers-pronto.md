...
updated_at: "2023-09-07 02:52:30.831822"
latest: "2.5.4--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/pronto:2.5.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pronto/2.5.4--pyhdfd78af_0
$ module help quay.io/biocontainers/pronto/2.5.4--pyhdfd78af_0
```
