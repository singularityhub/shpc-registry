...
updated_at: "2025-02-14 02:50:25.534204"
latest: "2.5.8--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/pronto:2.5.8--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pronto/2.5.8--pyhdfd78af_0
$ module help quay.io/biocontainers/pronto/2.5.8--pyhdfd78af_0
```
