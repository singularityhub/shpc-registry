...
updated_at: "2022-11-16 00:04:10.370695"
...
```bash
$ shpc install quay.io/biocontainers/pronto:2.5.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pronto/2.5.1--pyhdfd78af_0
$ module help quay.io/biocontainers/pronto/2.5.1--pyhdfd78af_0
```
