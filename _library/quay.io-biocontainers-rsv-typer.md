...
updated_at: "2023-08-07 03:29:35.229788"
...
```bash
$ shpc install quay.io/biocontainers/rsv-typer:0.1.0--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/rsv-typer/0.1.0--pyh7cba7a3_0
$ module help quay.io/biocontainers/rsv-typer/0.1.0--pyh7cba7a3_0
```
