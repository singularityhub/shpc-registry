---
layout: container
name:  "quay.io/biocontainers/s4pred"
maintainer: "@vsoch"
...
updated_at: "2025-09-14 03:37:42.027426"
...
```bash
$ module load quay.io/biocontainers/s4pred/1.2.1--pyhdfd78af_1
$ module help quay.io/biocontainers/s4pred/1.2.1--pyhdfd78af_1
```
...
#### s4pred-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### s4pred-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/network.py
$ podman run --it --rm --entrypoint /usr/local/bin/network.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/network.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/run_model.py
$ podman run --it --rm --entrypoint /usr/local/bin/run_model.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/run_model.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/utilities.py
$ podman run --it --rm --entrypoint /usr/local/bin/utilities.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/utilities.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
