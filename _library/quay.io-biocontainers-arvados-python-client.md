...
updated_at: "2025-04-13 04:24:38.407022"
...
```bash
$ shpc install quay.io/biocontainers/arvados-python-client:3.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/arvados-python-client/3.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/arvados-python-client/3.1.0--pyhdfd78af_0
```
