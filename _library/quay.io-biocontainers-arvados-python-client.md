...
updated_at: "2025-03-26 03:15:37.081093"
latest: "3.0.0--pyhdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/arvados-python-client:3.0.0--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/arvados-python-client/3.0.0--pyhdfd78af_1
$ module help quay.io/biocontainers/arvados-python-client/3.0.0--pyhdfd78af_1
```
