...
updated_at: "2026-02-02 12:42:57.200292"
...
```bash
$ shpc install quay.io/biocontainers/arvados-python-client:3.2.0--pyh7e72e81_0
```
...
```bash
$ module load quay.io/biocontainers/arvados-python-client/3.2.0--pyh7e72e81_0
$ module help quay.io/biocontainers/arvados-python-client/3.2.0--pyh7e72e81_0
```
