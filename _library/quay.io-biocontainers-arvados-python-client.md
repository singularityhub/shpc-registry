...
updated_at: "2026-03-28 16:50:21.405014"
latest: "3.2.1--pyh106432d_0"
...
```bash
$ shpc install quay.io/biocontainers/arvados-python-client:3.2.1--pyh106432d_0
```
...
```bash
$ module load quay.io/biocontainers/arvados-python-client/3.2.1--pyh106432d_0
$ module help quay.io/biocontainers/arvados-python-client/3.2.1--pyh106432d_0
```
