...
updated_at: "2025-05-15 04:20:13.673620"
...
```bash
$ shpc install quay.io/biocontainers/arvados-python-client:3.1.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/arvados-python-client/3.1.1--pyhdfd78af_0
$ module help quay.io/biocontainers/arvados-python-client/3.1.1--pyhdfd78af_0
```
