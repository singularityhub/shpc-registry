...
updated_at: "2026-06-30 06:39:20.308681"
...
```bash
$ shpc install quay.io/biocontainers/scxmatch:0.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/scxmatch/0.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/scxmatch/0.2.0--pyhdfd78af_0
```
