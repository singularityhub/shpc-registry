...
updated_at: "2025-05-24 11:56:48.308215"
...
```bash
$ shpc install quay.io/biocontainers/scxmatch:0.0.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/scxmatch/0.0.2--pyhdfd78af_0
$ module help quay.io/biocontainers/scxmatch/0.0.2--pyhdfd78af_0
```
