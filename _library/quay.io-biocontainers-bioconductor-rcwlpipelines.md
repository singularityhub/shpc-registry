...
updated_at: "2026-04-05 05:17:53.319632"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rcwlpipelines:1.26.0--r45hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rcwlpipelines/1.26.0--r45hdfd78af_1
$ module help quay.io/biocontainers/bioconductor-rcwlpipelines/1.26.0--r45hdfd78af_1
```
