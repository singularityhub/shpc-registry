---
layout: container
name:  "quay.io/biocontainers/perl-biosails"
maintainer: "@vsoch"
...
updated_at: "2024-02-09 02:44:09.215266"
...
```bash
$ shpc install quay.io/biocontainers/perl-biosails
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/perl-biosails:0.02--pl5321hdfd78af_3
```
...
```bash
$ module load quay.io/biocontainers/perl-biosails/0.02--pl5321hdfd78af_3
$ module help quay.io/biocontainers/perl-biosails/0.02--pl5321hdfd78af_3
```
...
#### perl-biosails-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### perl-biosails-inspect-deffile:
