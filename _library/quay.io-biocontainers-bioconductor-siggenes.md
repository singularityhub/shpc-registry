...
updated_at: "2026-03-20 05:10:07.381773"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-siggenes:1.84.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-siggenes/1.84.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-siggenes/1.84.0--r45hdfd78af_0
```
