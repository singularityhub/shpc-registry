...
updated_at: "2023-02-26 03:41:44.708580"
...
```bash
$ shpc install quay.io/biocontainers/r-netcomi:1.1.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/r-netcomi/1.1.0--r42hdfd78af_0
$ module help quay.io/biocontainers/r-netcomi/1.1.0--r42hdfd78af_0
```
