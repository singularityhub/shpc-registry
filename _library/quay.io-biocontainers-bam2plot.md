---
layout: container
name:  "quay.io/biocontainers/bam2plot"
maintainer: "@vsoch"
...
updated_at: "2026-03-03 04:21:08.642966"
...
```bash
$ shpc install quay.io/biocontainers/bam2plot
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bam2plot:0.4.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bam2plot/0.4.0--pyhdfd78af_0
$ module help quay.io/biocontainers/bam2plot/0.4.0--pyhdfd78af_0
```
...
#### bam2plot-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bam2plot-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/bam2plot
$ podman run --it --rm --entrypoint /usr/local/bin/bam2plot   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/bam2plot   -v ${PWD} -w ${PWD} <container> -c " $@"
```
