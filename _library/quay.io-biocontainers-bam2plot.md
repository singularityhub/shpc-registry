...
updated_at: "2026-03-29 05:35:27.084315"
...
```bash
$ shpc install quay.io/biocontainers/bam2plot:0.4.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bam2plot/0.4.1--pyhdfd78af_0
$ module help quay.io/biocontainers/bam2plot/0.4.1--pyhdfd78af_0
```
