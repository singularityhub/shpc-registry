...
updated_at: "2026-02-01 04:53:59.395721"
latest: "1.2--h71df26d_0"
...
```bash
$ shpc install quay.io/biocontainers/fastk:1.2--h71df26d_0
```
...
```bash
$ module load quay.io/biocontainers/fastk/1.2--h71df26d_0
$ module help quay.io/biocontainers/fastk/1.2--h71df26d_0
```
