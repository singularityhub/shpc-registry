...
updated_at: "2026-02-28 04:34:15.040266"
...
```bash
$ shpc install quay.io/biocontainers/fastk:1.2--h71df26d_1
```
...
```bash
$ module load quay.io/biocontainers/fastk/1.2--h71df26d_1
$ module help quay.io/biocontainers/fastk/1.2--h71df26d_1
```
