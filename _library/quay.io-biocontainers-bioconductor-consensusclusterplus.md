...
updated_at: "2025-02-07 03:15:44.778790"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-consensusclusterplus:1.70.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-consensusclusterplus/1.70.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-consensusclusterplus/1.70.0--r44hdfd78af_0
```
