...
updated_at: "2023-08-09 03:16:02.409231"
...
```bash
$ shpc install quay.io/biocontainers/f5c:1.2--h500492e_2
```
...
```bash
$ module load quay.io/biocontainers/f5c/1.2--h500492e_2
$ module help quay.io/biocontainers/f5c/1.2--h500492e_2
```
