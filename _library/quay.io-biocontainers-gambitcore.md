---
layout: container
name:  "quay.io/biocontainers/gambitcore"
maintainer: "@vsoch"
...
updated_at: "2026-01-11 04:01:01.271810"
...
aliases:
 ...
 - "h5dump"
versions:
 - "0.0.2--py310h1fe012e_0"
description: "singularity registry hpc automated addition for gambitcore"
config: {"url": "https://biocontainers.pro/tools/gambitcore", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for gambitcore", "latest": {"0.0.2--py310h1fe012e_0": "sha256:4541cc7838cd694d0aeafc9ae4c2d2a81a43463416c46d397058f4fef8c6181c"}, "tags": {"0.0.2--py310h1fe012e_0": "sha256:4541cc7838cd694d0aeafc9ae4c2d2a81a43463416c46d397058f4fef8c6181c"}, "docker": "quay.io/biocontainers/gambitcore", "aliases": {"gambit": "/usr/local/bin/gambit", "gambitcore": "/usr/local/bin/gambitcore", "gambitcore-species": "/usr/local/bin/gambitcore-species", "h5tools_test_utils": "/usr/local/bin/h5tools_test_utils", "h5fuse.sh": "/usr/local/bin/h5fuse.sh", "h5delete": "/usr/local/bin/h5delete", "h5fc": "/usr/local/bin/h5fc", "h5clear": "/usr/local/bin/h5clear", "h5format_convert": "/usr/local/bin/h5format_convert", "h5watch": "/usr/local/bin/h5watch", "gif2h5": "/usr/local/bin/gif2h5", "h52gif": "/usr/local/bin/h52gif", "h5c++": "/usr/local/bin/h5c++", "h5cc": "/usr/local/bin/h5cc", "h5copy": "/usr/local/bin/h5copy", "h5debug": "/usr/local/bin/h5debug", "h5diff": "/usr/local/bin/h5diff", "h5import": "/usr/local/bin/h5import", "h5jam": "/usr/local/bin/h5jam", "h5ls": "/usr/local/bin/h5ls", "h5mkgrp": "/usr/local/bin/h5mkgrp", "h5perf_serial": "/usr/local/bin/h5perf_serial", "h5redeploy": "/usr/local/bin/h5redeploy", "h5repack": "/usr/local/bin/h5repack", "h5repart": "/usr/local/bin/h5repart", "h5stat": "/usr/local/bin/h5stat", "h5unjam": "/usr/local/bin/h5unjam", "h5dump": "/usr/local/bin/h5dump"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/gambitcore.
singularity registry hpc automated addition for gambitcore
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/gambitcore
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/gambitcore:0.0.2--py310h1fe012e_0
```
...
```bash
$ module load quay.io/biocontainers/gambitcore/0.0.2--py310h1fe012e_0
$ module help quay.io/biocontainers/gambitcore/0.0.2--py310h1fe012e_0
```
...
#### gambitcore-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### gambitcore-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/gambitcore
$ podman run --it --rm --entrypoint /usr/local/bin/gambitcore   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/gambitcore   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/gambitcore-species
$ podman run --it --rm --entrypoint /usr/local/bin/gambitcore-species   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/gambitcore-species   -v ${PWD} -w ${PWD} <container> -c " $@"
```
