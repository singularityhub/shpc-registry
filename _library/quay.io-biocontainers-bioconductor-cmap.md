...
updated_at: "2022-10-27 00:51:24.210874"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cmap:1.15.1--r40hdfd78af_9
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cmap/1.15.1--r40hdfd78af_9
$ module help quay.io/biocontainers/bioconductor-cmap/1.15.1--r40hdfd78af_9
```
