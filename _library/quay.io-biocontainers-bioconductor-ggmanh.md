...
updated_at: "2026-03-20 00:45:21.396564"
latest: "1.14.0--r45h575d39b_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ggmanh:1.14.0--r45h575d39b_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ggmanh/1.14.0--r45h575d39b_0
$ module help quay.io/biocontainers/bioconductor-ggmanh/1.14.0--r45h575d39b_0
```
