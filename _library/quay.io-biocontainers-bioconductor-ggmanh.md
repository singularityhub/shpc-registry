...
updated_at: "2023-03-29 00:20:56.094677"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ggmanh:1.2.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ggmanh/1.2.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ggmanh/1.2.0--r42hdfd78af_0
```
