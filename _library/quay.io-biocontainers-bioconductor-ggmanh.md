---
layout: container
name:  "quay.io/biocontainers/bioconductor-ggmanh"
maintainer: "@vsoch"
...
updated_at: "2023-12-17 03:11:06.371118"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ggmanh
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-ggmanh:1.4.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ggmanh/1.4.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ggmanh/1.4.0--r43hdfd78af_0
```
...
#### bioconductor-ggmanh-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-ggmanh-inspect-deffile:
