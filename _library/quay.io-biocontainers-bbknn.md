...
updated_at: "2025-03-25 03:48:43.041587"
...
```bash
$ shpc install quay.io/biocontainers/bbknn:1.6.0--py311haab0aaa_4
```
...
```bash
$ module load quay.io/biocontainers/bbknn/1.6.0--py311haab0aaa_4
$ module help quay.io/biocontainers/bbknn/1.6.0--py311haab0aaa_4
```
