...
updated_at: "2024-11-13 04:11:46.616844"
latest: "1.6.0--py312hf67a6ed_3"
...
```bash
$ shpc install quay.io/biocontainers/bbknn:1.6.0--py312hf67a6ed_3
```
...
```bash
$ module load quay.io/biocontainers/bbknn/1.6.0--py312hf67a6ed_3
$ module help quay.io/biocontainers/bbknn/1.6.0--py312hf67a6ed_3
```
