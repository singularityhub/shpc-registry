...
updated_at: "2024-03-22 03:00:08.688411"
...
```bash
$ shpc install quay.io/biocontainers/arcas-hla:0.6.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/arcas-hla/0.6.0--hdfd78af_0
$ module help quay.io/biocontainers/arcas-hla/0.6.0--hdfd78af_0
```
