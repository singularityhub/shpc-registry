...
updated_at: "2026-03-08 04:43:21.929729"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-asset:2.28.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-asset/2.28.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-asset/2.28.0--r45hdfd78af_0
```
