---
layout: container
name:  "quay.io/biocontainers/bioconductor-gdrtestdata"
maintainer: "@vsoch"
...
updated_at: "2024-12-07 01:41:50.965982"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gdrtestdata
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-gdrtestdata:1.0.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gdrtestdata/1.0.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-gdrtestdata/1.0.0--r43hdfd78af_0
```
...
#### bioconductor-gdrtestdata-shell:
...
#### bioconductor-gdrtestdata-inspect:
...
#### bioconductor-gdrtestdata-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-gdrtestdata-inspect-deffile:
