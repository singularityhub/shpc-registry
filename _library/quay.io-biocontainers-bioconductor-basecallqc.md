...
updated_at: "2026-04-03 05:12:21.949673"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-basecallqc:1.34.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-basecallqc/1.34.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-basecallqc/1.34.0--r45hdfd78af_0
```
