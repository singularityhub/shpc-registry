...
updated_at: "2025-12-28 03:54:50.804523"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-basecallqc:1.30.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-basecallqc/1.30.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-basecallqc/1.30.0--r44hdfd78af_0
```
