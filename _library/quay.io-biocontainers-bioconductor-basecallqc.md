...
updated_at: "2022-11-14 00:56:27.126451"
latest: "1.8.0--r36_1"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-basecallqc:1.8.0--r36_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-basecallqc/1.8.0--r36_1
$ module help quay.io/biocontainers/bioconductor-basecallqc/1.8.0--r36_1
```
