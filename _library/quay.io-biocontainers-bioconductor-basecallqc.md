...
updated_at: "2024-10-17 18:54:19.553476"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-basecallqc:1.26.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-basecallqc/1.26.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-basecallqc/1.26.0--r43hdfd78af_0
```
