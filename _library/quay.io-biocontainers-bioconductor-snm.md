...
updated_at: "2026-03-26 04:56:31.894715"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-snm:1.58.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-snm/1.58.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-snm/1.58.0--r45hdfd78af_0
```
