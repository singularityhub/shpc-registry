...
updated_at: "2023-04-15 02:41:55.765525"
latest: "3.0.1--py38h4a32c8e_0"
...
```bash
$ shpc install quay.io/biocontainers/rpbp:3.0.1--py38h4a32c8e_0
```
...
```bash
$ module load quay.io/biocontainers/rpbp/3.0.1--py38h4a32c8e_0
$ module help quay.io/biocontainers/rpbp/3.0.1--py38h4a32c8e_0
```
