...
updated_at: "2024-03-09 02:26:23.250733"
latest: "3.0.2--py310h0dbaff4_1"
...
```bash
$ shpc install quay.io/biocontainers/rpbp:3.0.2--py310h0dbaff4_1
```
...
```bash
$ module load quay.io/biocontainers/rpbp/3.0.2--py310h0dbaff4_1
$ module help quay.io/biocontainers/rpbp/3.0.2--py310h0dbaff4_1
```
