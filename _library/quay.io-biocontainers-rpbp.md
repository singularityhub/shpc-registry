...
updated_at: "2024-08-17 03:00:02.648049"
latest: "3.0.4--py39h9e0f934_1"
...
```bash
$ shpc install quay.io/biocontainers/rpbp:3.0.4--py39h9e0f934_1
```
...
```bash
$ module load quay.io/biocontainers/rpbp/3.0.4--py39h9e0f934_1
$ module help quay.io/biocontainers/rpbp/3.0.4--py39h9e0f934_1
```
