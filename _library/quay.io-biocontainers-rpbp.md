...
updated_at: "2024-07-04 02:57:22.269345"
latest: "3.0.4--py310h0dbaff4_0"
...
```bash
$ shpc install quay.io/biocontainers/rpbp:3.0.4--py310h0dbaff4_0
```
...
```bash
$ module load quay.io/biocontainers/rpbp/3.0.4--py310h0dbaff4_0
$ module help quay.io/biocontainers/rpbp/3.0.4--py310h0dbaff4_0
```
