...
updated_at: "2022-11-28 00:47:23.808482"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ygs98cdf:2.18.0--r42hdfd78af_10
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ygs98cdf/2.18.0--r42hdfd78af_10
$ module help quay.io/biocontainers/bioconductor-ygs98cdf/2.18.0--r42hdfd78af_10
```
