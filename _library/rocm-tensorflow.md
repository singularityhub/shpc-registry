...
updated_at: "2025-01-15 03:34:45.149705"
...
```bash
$ shpc install rocm/tensorflow:rocm6.3-py3.12-tf2.17-dev
```
...
```bash
$ module load rocm/tensorflow/rocm6.3-py3.12-tf2.17-dev
$ module help rocm/tensorflow/rocm6.3-py3.12-tf2.17-dev
```
