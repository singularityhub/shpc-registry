...
updated_at: "2026-02-05 04:17:23.862393"
latest: "rocm7.2-py3.12-tf2.20-dev"
...
```bash
$ shpc install rocm/tensorflow:rocm7.2-py3.12-tf2.20-dev
```
...
```bash
$ module load rocm/tensorflow/rocm7.2-py3.12-tf2.20-dev
$ module help rocm/tensorflow/rocm7.2-py3.12-tf2.20-dev
```
