...
updated_at: "2025-12-18 03:23:20.969994"
latest: "rocm7.1-py3.12-tf2.20-dev"
...
```bash
$ shpc install rocm/tensorflow:rocm7.1-py3.12-tf2.20-dev
```
...
```bash
$ module load rocm/tensorflow/rocm7.1-py3.12-tf2.20-dev
$ module help rocm/tensorflow/rocm7.1-py3.12-tf2.20-dev
```
