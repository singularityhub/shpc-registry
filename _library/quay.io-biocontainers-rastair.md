...
updated_at: "2026-09-25 07:23:45.292213"
...
```bash
$ shpc install quay.io/biocontainers/rastair:2.2.0--hd9d0f32_0
```
...
```bash
$ module load quay.io/biocontainers/rastair/2.2.0--hd9d0f32_0
$ module help quay.io/biocontainers/rastair/2.2.0--hd9d0f32_0
```
