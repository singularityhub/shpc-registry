...
updated_at: "2026-05-29 06:21:18.641975"
...
```bash
$ shpc install quay.io/biocontainers/rastair:2.1.1--h03e3cfe_0
```
...
```bash
$ module load quay.io/biocontainers/rastair/2.1.1--h03e3cfe_0
$ module help quay.io/biocontainers/rastair/2.1.1--h03e3cfe_0
```
