...
updated_at: "2025-09-11 03:13:09.832011"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-fccac:1.32.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-fccac/1.32.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-fccac/1.32.0--r44hdfd78af_0
```
