---
layout: container
name:  "quay.io/biocontainers/varvamp"
maintainer: "@vsoch"
...
updated_at: "2026-04-02 05:18:53.569535"
...
```bash
$ shpc install quay.io/biocontainers/varvamp
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/varvamp:1.3.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/varvamp/1.3.1--pyhdfd78af_0
$ module help quay.io/biocontainers/varvamp/1.3.1--pyhdfd78af_0
```
...
#### varvamp-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### varvamp-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/varvamp
$ podman run --it --rm --entrypoint /usr/local/bin/varvamp   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/varvamp   -v ${PWD} -w ${PWD} <container> -c " $@"
```
