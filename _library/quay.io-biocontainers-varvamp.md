...
updated_at: "2026-03-06 04:58:48.504160"
...
```bash
$ shpc install quay.io/biocontainers/varvamp:1.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/varvamp/1.3--pyhdfd78af_0
$ module help quay.io/biocontainers/varvamp/1.3--pyhdfd78af_0
```
