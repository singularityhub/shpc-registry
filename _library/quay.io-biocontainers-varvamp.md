...
updated_at: "2024-02-08 02:52:33.935699"
...
```bash
$ shpc install quay.io/biocontainers/varvamp:1.0.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/varvamp/1.0.1--pyhdfd78af_0
$ module help quay.io/biocontainers/varvamp/1.0.1--pyhdfd78af_0
```
