...
updated_at: "2024-01-09 02:31:55.642903"
...
```bash
$ shpc install quay.io/biocontainers/varvamp:1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/varvamp/1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/varvamp/1.0--pyhdfd78af_0
```
