...
updated_at: "2024-11-10 03:11:56.590224"
...
```bash
$ shpc install quay.io/biocontainers/varvamp:1.2.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/varvamp/1.2.1--pyhdfd78af_0
$ module help quay.io/biocontainers/varvamp/1.2.1--pyhdfd78af_0
```
