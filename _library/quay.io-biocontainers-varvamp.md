...
updated_at: "2025-10-01 03:38:01.859506"
...
```bash
$ shpc install quay.io/biocontainers/varvamp:1.2.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/varvamp/1.2.2--pyhdfd78af_0
$ module help quay.io/biocontainers/varvamp/1.2.2--pyhdfd78af_0
```
