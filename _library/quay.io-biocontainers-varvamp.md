...
updated_at: "2026-05-24 06:23:26.637471"
...
```bash
$ shpc install quay.io/biocontainers/varvamp:1.3.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/varvamp/1.3.2--pyhdfd78af_0
$ module help quay.io/biocontainers/varvamp/1.3.2--pyhdfd78af_0
```
