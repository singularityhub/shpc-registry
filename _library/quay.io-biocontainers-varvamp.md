...
updated_at: "2023-11-15 02:54:58.330077"
...
```bash
$ shpc install quay.io/biocontainers/varvamp:0.9.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/varvamp/0.9.4--pyhdfd78af_0
$ module help quay.io/biocontainers/varvamp/0.9.4--pyhdfd78af_0
```
