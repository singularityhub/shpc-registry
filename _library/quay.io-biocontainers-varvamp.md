...
updated_at: "2023-09-11 02:36:50.694168"
...
```bash
$ shpc install quay.io/biocontainers/varvamp:0.9.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/varvamp/0.9.2--pyhdfd78af_0
$ module help quay.io/biocontainers/varvamp/0.9.2--pyhdfd78af_0
```
