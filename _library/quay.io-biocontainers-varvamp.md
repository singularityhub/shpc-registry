...
updated_at: "2024-02-25 02:44:27.057990"
...
```bash
$ shpc install quay.io/biocontainers/varvamp:1.1.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/varvamp/1.1.1--pyhdfd78af_0
$ module help quay.io/biocontainers/varvamp/1.1.1--pyhdfd78af_0
```
