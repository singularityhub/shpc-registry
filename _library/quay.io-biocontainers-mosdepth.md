...
updated_at: "2026-04-02 04:50:43.610899"
latest: "0.3.13--hba6dcaf_0"
...
```bash
$ shpc install quay.io/biocontainers/mosdepth:0.3.13--hba6dcaf_0
```
...
```bash
$ module load quay.io/biocontainers/mosdepth/0.3.13--hba6dcaf_0
$ module help quay.io/biocontainers/mosdepth/0.3.13--hba6dcaf_0
```
