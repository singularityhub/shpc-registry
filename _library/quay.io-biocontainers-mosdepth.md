...
updated_at: "2026-02-06 04:51:46.328640"
latest: "0.3.12--h0ec343a_0"
...
```bash
$ shpc install quay.io/biocontainers/mosdepth:0.3.12--h0ec343a_0
```
...
```bash
$ module load quay.io/biocontainers/mosdepth/0.3.12--h0ec343a_0
$ module help quay.io/biocontainers/mosdepth/0.3.12--h0ec343a_0
```
