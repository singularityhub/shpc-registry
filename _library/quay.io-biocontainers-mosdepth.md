...
updated_at: "2026-09-04 07:19:54.192400"
latest: "0.3.14--h87be163_2"
...
```bash
$ shpc install quay.io/biocontainers/mosdepth:0.3.14--h87be163_2
```
...
```bash
$ module load quay.io/biocontainers/mosdepth/0.3.14--h87be163_2
$ module help quay.io/biocontainers/mosdepth/0.3.14--h87be163_2
```
