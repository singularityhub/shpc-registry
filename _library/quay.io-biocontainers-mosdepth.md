...
updated_at: "2024-06-11 03:09:15.715194"
...
```bash
$ shpc install quay.io/biocontainers/mosdepth:0.3.8--hd299d5a_0
```
...
```bash
$ module load quay.io/biocontainers/mosdepth/0.3.8--hd299d5a_0
$ module help quay.io/biocontainers/mosdepth/0.3.8--hd299d5a_0
```
