...
updated_at: "2024-12-28 03:26:11.938490"
latest: "0.3.10--hd299d5a_0"
...
```bash
$ shpc install quay.io/biocontainers/mosdepth:0.3.10--hd299d5a_0
```
...
```bash
$ module load quay.io/biocontainers/mosdepth/0.3.10--hd299d5a_0
$ module help quay.io/biocontainers/mosdepth/0.3.10--hd299d5a_0
```
