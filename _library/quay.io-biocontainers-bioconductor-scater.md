...
updated_at: "2026-03-15 05:09:51.574771"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-scater:1.38.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-scater/1.38.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-scater/1.38.0--r45hdfd78af_0
```
