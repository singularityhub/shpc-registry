---
layout: container
name:  "quay.io/biocontainers/bin2cell"
maintainer: "@vsoch"
...
updated_at: "2025-11-18 04:07:30.851773"
...
singularity registry hpc automated addition for bin2cell
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/bin2cell
```
...
#### bin2cell-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bin2cell-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/care_predict
$ podman run --it --rm --entrypoint /usr/local/bin/care_predict   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/care_predict   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/stardist-predict2d
$ podman run --it --rm --entrypoint /usr/local/bin/stardist-predict2d   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/stardist-predict2d   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/stardist-predict3d
$ podman run --it --rm --entrypoint /usr/local/bin/stardist-predict3d   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/stardist-predict3d   -v ${PWD} -w ${PWD} <container> -c " $@"
```
