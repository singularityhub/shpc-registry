...
updated_at: "2026-03-20 05:07:38.357625"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-artms:1.28.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-artms/1.28.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-artms/1.28.0--r45hdfd78af_0
```
