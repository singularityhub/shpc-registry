...
updated_at: "2022-11-07 00:48:14.933237"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-artms:1.8.2--r40hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-artms/1.8.2--r40hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-artms/1.8.2--r40hdfd78af_0
```
