...
updated_at: "2025-11-11 03:47:25.660971"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-artms:1.24.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-artms/1.24.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-artms/1.24.0--r44hdfd78af_0
```
