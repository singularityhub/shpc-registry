...
updated_at: "2024-10-25 03:07:25.450129"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-artms:1.20.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-artms/1.20.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-artms/1.20.0--r43hdfd78af_0
```
