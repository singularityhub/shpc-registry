...
updated_at: "2026-04-04 04:31:01.839989"
latest: "4.29--pl5321hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/perl-mojo-pg:4.29--pl5321hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/perl-mojo-pg/4.29--pl5321hdfd78af_0
$ module help quay.io/biocontainers/perl-mojo-pg/4.29--pl5321hdfd78af_0
```
