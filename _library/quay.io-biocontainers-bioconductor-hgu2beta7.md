...
updated_at: "2023-10-27 03:07:28.906790"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hgu2beta7:1.40.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hgu2beta7/1.40.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-hgu2beta7/1.40.0--r43hdfd78af_0
```
