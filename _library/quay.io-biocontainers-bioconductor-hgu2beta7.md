...
updated_at: "2026-03-15 04:39:56.853400"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hgu2beta7:1.50.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hgu2beta7/1.50.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-hgu2beta7/1.50.0--r45hdfd78af_0
```
