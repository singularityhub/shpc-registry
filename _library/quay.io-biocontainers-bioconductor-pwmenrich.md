...
updated_at: "2026-04-05 05:23:17.590478"
latest: "4.46.0--r45hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-pwmenrich:4.46.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-pwmenrich/4.46.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-pwmenrich/4.46.0--r45hdfd78af_0
```
