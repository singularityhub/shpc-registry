...
updated_at: "2023-02-02 03:36:33.804056"
...
```bash
$ shpc install quay.io/biocontainers/drep:3.4.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/drep/3.4.1--pyhdfd78af_0
$ module help quay.io/biocontainers/drep/3.4.1--pyhdfd78af_0
```
