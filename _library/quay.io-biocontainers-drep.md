...
updated_at: "2026-09-04 07:06:09.493725"
...
```bash
$ shpc install quay.io/biocontainers/drep:3.7.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/drep/3.7.1--pyhdfd78af_0
$ module help quay.io/biocontainers/drep/3.7.1--pyhdfd78af_0
```
