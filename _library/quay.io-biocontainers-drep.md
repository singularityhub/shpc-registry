...
updated_at: "2025-05-18 03:27:25.100772"
latest: "3.6.2--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/drep:3.6.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/drep/3.6.2--pyhdfd78af_0
$ module help quay.io/biocontainers/drep/3.6.2--pyhdfd78af_0
```
