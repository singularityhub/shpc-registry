...
updated_at: "2023-02-07 03:21:18.184931"
latest: "1.4.1--ha8f3691_0"
...
```bash
$ shpc install quay.io/biocontainers/thermorawfileparser:1.4.1--ha8f3691_0
```
...
```bash
$ module load quay.io/biocontainers/thermorawfileparser/1.4.1--ha8f3691_0
$ module help quay.io/biocontainers/thermorawfileparser/1.4.1--ha8f3691_0
```
