...
updated_at: "2026-02-23 04:44:02.893543"
...
```bash
$ shpc install quay.io/biocontainers/thermorawfileparser:2.0.0.dev--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/thermorawfileparser/2.0.0.dev--h9ee0642_0
$ module help quay.io/biocontainers/thermorawfileparser/2.0.0.dev--h9ee0642_0
```
