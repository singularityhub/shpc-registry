...
updated_at: "2026-06-04 06:49:57.639028"
...
```bash
$ shpc install quay.io/biocontainers/thermorawfileparser:2.0.0.dev--h9ee0642_1
```
...
```bash
$ module load quay.io/biocontainers/thermorawfileparser/2.0.0.dev--h9ee0642_1
$ module help quay.io/biocontainers/thermorawfileparser/2.0.0.dev--h9ee0642_1
```
