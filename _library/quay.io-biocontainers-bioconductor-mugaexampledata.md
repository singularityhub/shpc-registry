...
updated_at: "2023-08-14 03:05:03.678858"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mugaexampledata:1.20.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mugaexampledata/1.20.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-mugaexampledata/1.20.0--r43hdfd78af_0
```
