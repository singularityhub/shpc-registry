...
updated_at: "2026-02-17 05:40:47.087761"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mugaexampledata:1.30.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mugaexampledata/1.30.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-mugaexampledata/1.30.0--r45hdfd78af_0
```
