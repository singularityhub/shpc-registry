---
layout: container
name:  "quay.io/biocontainers/panfeed"
maintainer: "@vsoch"
...
updated_at: "2024-06-27 03:43:36.540524"
...
```bash
$ shpc install quay.io/biocontainers/panfeed
```
...
#### panfeed-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### panfeed-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/panfeed
$ podman run --it --rm --entrypoint /usr/local/bin/panfeed   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/panfeed   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/panfeed-get-clusters
$ podman run --it --rm --entrypoint /usr/local/bin/panfeed-get-clusters   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/panfeed-get-clusters   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/panfeed-get-kmers
$ podman run --it --rm --entrypoint /usr/local/bin/panfeed-get-kmers   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/panfeed-get-kmers   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/panfeed-plot
$ podman run --it --rm --entrypoint /usr/local/bin/panfeed-plot   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/panfeed-plot   -v ${PWD} -w ${PWD} <container> -c " $@"
```
