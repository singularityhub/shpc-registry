...
updated_at: "2026-03-29 05:19:53.295198"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-phenopath:1.34.0--r45ha27e39d_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-phenopath/1.34.0--r45ha27e39d_0
$ module help quay.io/biocontainers/bioconductor-phenopath/1.34.0--r45ha27e39d_0
```
