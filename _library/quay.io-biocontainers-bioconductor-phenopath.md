...
updated_at: "2024-06-19 02:41:18.127569"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-phenopath:1.26.0--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-phenopath/1.26.0--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-phenopath/1.26.0--r43hf17093f_0
```
