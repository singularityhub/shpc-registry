...
updated_at: "2025-11-17 03:33:35.877744"
latest: "1.6.2--pl5321hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/damidseq_pipeline:1.6.2--pl5321hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/damidseq_pipeline/1.6.2--pl5321hdfd78af_0
$ module help quay.io/biocontainers/damidseq_pipeline/1.6.2--pl5321hdfd78af_0
```
