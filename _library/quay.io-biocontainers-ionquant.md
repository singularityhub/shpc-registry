---
layout: container
name:  "quay.io/biocontainers/ionquant"
maintainer: "@vsoch"
...
updated_at: "2025-08-05 04:37:11.228487"
latest: "1.11.9--py311hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/ionquant
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/ionquant:1.11.9--py311hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ionquant/1.11.9--py311hdfd78af_0
$ module help quay.io/biocontainers/ionquant/1.11.9--py311hdfd78af_0
```
...
#### ionquant-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### ionquant-inspect-deffile:
