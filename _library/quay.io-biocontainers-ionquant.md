...
updated_at: "2024-03-05 02:50:34.459716"
latest: "1.10.12--py312hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/ionquant:1.10.12--py312hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ionquant/1.10.12--py312hdfd78af_0
$ module help quay.io/biocontainers/ionquant/1.10.12--py312hdfd78af_0
```
