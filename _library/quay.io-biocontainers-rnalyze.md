...
updated_at: "2026-05-28 16:05:50.942758"
...
```bash
$ shpc install quay.io/biocontainers/rnalyze:1.0.2--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/rnalyze/1.0.2--hdfd78af_0
$ module help quay.io/biocontainers/rnalyze/1.0.2--hdfd78af_0
```
