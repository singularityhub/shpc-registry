...
updated_at: "2024-12-21 03:20:44.904425"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-philr:1.32.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-philr/1.32.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-philr/1.32.0--r44hdfd78af_0
```
