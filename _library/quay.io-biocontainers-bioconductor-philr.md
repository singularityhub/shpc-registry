...
updated_at: "2026-03-23 05:26:00.660730"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-philr:1.36.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-philr/1.36.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-philr/1.36.0--r45hdfd78af_0
```
