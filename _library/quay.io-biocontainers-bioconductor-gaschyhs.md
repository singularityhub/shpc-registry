...
updated_at: "2023-09-20 02:39:11.442232"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gaschyhs:1.38.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gaschyhs/1.38.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-gaschyhs/1.38.0--r43hdfd78af_0
```
