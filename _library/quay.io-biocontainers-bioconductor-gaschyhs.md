...
updated_at: "2022-11-21 13:14:28.364901"
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-gaschyhs-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-gaschyhs-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-gaschyhs-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-gaschyhs-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-gaschyhs-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-gaschyhs-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
