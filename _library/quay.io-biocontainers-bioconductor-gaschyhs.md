...
updated_at: "2026-02-23 04:33:28.934729"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gaschyhs:1.48.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gaschyhs/1.48.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-gaschyhs/1.48.0--r45hdfd78af_0
```
