...
updated_at: "2023-03-19 14:01:37.420972"
...
```bash
$ shpc install quay.io/biocontainers/hocort:1.2.0--py39hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hocort/1.2.0--py39hdfd78af_0
$ module help quay.io/biocontainers/hocort/1.2.0--py39hdfd78af_0
```
