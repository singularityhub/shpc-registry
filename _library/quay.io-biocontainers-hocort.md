...
updated_at: "2024-09-29 03:01:22.123562"
...
```bash
$ shpc install quay.io/biocontainers/hocort:1.2.2--py39hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hocort/1.2.2--py39hdfd78af_0
$ module help quay.io/biocontainers/hocort/1.2.2--py39hdfd78af_0
```
