...
updated_at: "2024-12-01 03:21:33.363386"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-correp:1.68.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-correp/1.68.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-correp/1.68.0--r43hdfd78af_0
```
