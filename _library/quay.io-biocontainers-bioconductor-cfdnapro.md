...
updated_at: "2026-04-02 04:49:49.225920"
latest: "1.16.1--r45hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cfdnapro:1.16.1--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cfdnapro/1.16.1--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-cfdnapro/1.16.1--r45hdfd78af_0
```
