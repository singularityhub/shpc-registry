...
updated_at: "2025-10-16 03:44:51.306079"
...
```bash
$ shpc install quay.io/biocontainers/stranger:0.9.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/stranger/0.9.5--pyhdfd78af_0
$ module help quay.io/biocontainers/stranger/0.9.5--pyhdfd78af_0
```
