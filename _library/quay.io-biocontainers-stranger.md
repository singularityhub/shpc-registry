...
updated_at: "2025-05-25 03:42:50.026003"
...
```bash
$ shpc install quay.io/biocontainers/stranger:0.9.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/stranger/0.9.4--pyhdfd78af_0
$ module help quay.io/biocontainers/stranger/0.9.4--pyhdfd78af_0
```
