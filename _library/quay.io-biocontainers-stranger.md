...
updated_at: "2026-01-13 04:16:07.048532"
...
```bash
$ shpc install quay.io/biocontainers/stranger:0.10.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/stranger/0.10.0--pyhdfd78af_0
$ module help quay.io/biocontainers/stranger/0.10.0--pyhdfd78af_0
```
