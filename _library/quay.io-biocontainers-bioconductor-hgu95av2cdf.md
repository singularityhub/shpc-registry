...
updated_at: "2026-04-01 05:40:49.602517"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hgu95av2cdf:2.18.0--r45hdfd78af_14
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hgu95av2cdf/2.18.0--r45hdfd78af_14
$ module help quay.io/biocontainers/bioconductor-hgu95av2cdf/2.18.0--r45hdfd78af_14
```
