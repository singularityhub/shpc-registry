...
updated_at: "2024-03-05 03:05:38.114628"
latest: "1.5.1--r43h21a89ab_0"
...
```bash
$ shpc install quay.io/biocontainers/r-conos:1.5.1--r43h21a89ab_0
```
...
```bash
$ module load quay.io/biocontainers/r-conos/1.5.1--r43h21a89ab_0
$ module help quay.io/biocontainers/r-conos/1.5.1--r43h21a89ab_0
```
