...
updated_at: "2023-09-20 02:52:12.949682"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-kboost:1.8.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-kboost/1.8.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-kboost/1.8.0--r43hdfd78af_0
```
