...
updated_at: "2022-10-29 05:44:44.976315"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rtpca:1.4.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rtpca/1.4.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rtpca/1.4.0--r41hdfd78af_0
```
