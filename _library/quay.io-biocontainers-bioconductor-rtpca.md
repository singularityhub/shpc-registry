...
updated_at: "2023-12-04 03:00:07.258850"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rtpca:1.10.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rtpca/1.10.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rtpca/1.10.0--r43hdfd78af_0
```
