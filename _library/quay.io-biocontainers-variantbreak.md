---
layout: container
name:  "quay.io/biocontainers/variantbreak"
maintainer: "@vsoch"
...
updated_at: "2024-11-21 03:27:47.336865"
latest: "1.0.4--py_0"
...
versions:
 - "1.0.4--py_0"
description: "shpc-registry automated BioContainers addition for variantbreak"
config: {"url": "https://biocontainers.pro/tools/variantbreak", "maintainer": "@vsoch", "description": "shpc-registry automated BioContainers addition for variantbreak", "latest": {"1.0.4--py_0": "sha256:6e257a6c8d51c1dc5becc0d29ba8dc78eb9eb50ef30eeec48975515ba9790946"}, "tags": {"1.0.4--py_0": "sha256:6e257a6c8d51c1dc5becc0d29ba8dc78eb9eb50ef30eeec48975515ba9790946"}, "docker": "quay.io/biocontainers/variantbreak", "aliases": {"variantbreak": "/usr/local/bin/variantbreak", "intersection_matrix.py": "/usr/local/bin/intersection_matrix.py", "intron_exon_reads.py": "/usr/local/bin/intron_exon_reads.py", "pbt_plotting_example.py": "/usr/local/bin/pbt_plotting_example.py", "peak_pie.py": "/usr/local/bin/peak_pie.py", "pybedtools": "/usr/local/bin/pybedtools", "venn_gchart.py": "/usr/local/bin/venn_gchart.py", "venn_mpl.py": "/usr/local/bin/venn_mpl.py", "annotate.py": "/usr/local/bin/annotate.py", "pt2to3": "/usr/local/bin/pt2to3", "ptdump": "/usr/local/bin/ptdump"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/variantbreak.
shpc-registry automated BioContainers addition for variantbreak
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/variantbreak
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/variantbreak:1.0.4--py_0
```
...
```bash
$ module load quay.io/biocontainers/variantbreak/1.0.4--py_0
$ module help quay.io/biocontainers/variantbreak/1.0.4--py_0
```
...
#### variantbreak-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### variantbreak-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/variantbreak
$ podman run --it --rm --entrypoint /usr/local/bin/variantbreak   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/variantbreak   -v ${PWD} -w ${PWD} <container> -c " $@"
```
