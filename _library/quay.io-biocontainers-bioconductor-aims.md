...
updated_at: "2026-03-05 04:35:28.237175"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-aims:1.42.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-aims/1.42.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-aims/1.42.0--r45hdfd78af_0
```
