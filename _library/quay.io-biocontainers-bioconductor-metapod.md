...
updated_at: "2026-03-03 05:03:23.879655"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-metapod:1.18.0--r45ha27e39d_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-metapod/1.18.0--r45ha27e39d_0
$ module help quay.io/biocontainers/bioconductor-metapod/1.18.0--r45ha27e39d_0
```
