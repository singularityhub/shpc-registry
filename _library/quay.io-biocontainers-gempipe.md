...
updated_at: "2024-08-20 03:24:54.171499"
latest: "1.33.4--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/gempipe:1.33.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/gempipe/1.33.4--pyhdfd78af_0
$ module help quay.io/biocontainers/gempipe/1.33.4--pyhdfd78af_0
```
