...
updated_at: "2024-10-01 03:23:53.162011"
latest: "1.34.2--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/gempipe:1.34.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/gempipe/1.34.2--pyhdfd78af_0
$ module help quay.io/biocontainers/gempipe/1.34.2--pyhdfd78af_0
```
