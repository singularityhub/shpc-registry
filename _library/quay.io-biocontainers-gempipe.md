...
updated_at: "2025-12-05 03:31:57.640472"
latest: "1.38.4--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/gempipe:1.38.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/gempipe/1.38.4--pyhdfd78af_0
$ module help quay.io/biocontainers/gempipe/1.38.4--pyhdfd78af_0
```
