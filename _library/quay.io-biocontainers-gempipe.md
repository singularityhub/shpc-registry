...
updated_at: "2025-10-06 03:14:18.493190"
...
```bash
$ shpc install quay.io/biocontainers/gempipe:1.38.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/gempipe/1.38.3--pyhdfd78af_0
$ module help quay.io/biocontainers/gempipe/1.38.3--pyhdfd78af_0
```
