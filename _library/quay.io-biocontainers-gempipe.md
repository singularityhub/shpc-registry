...
updated_at: "2025-02-06 03:09:07.920599"
latest: "1.37.6--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/gempipe:1.37.6--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/gempipe/1.37.6--pyhdfd78af_0
$ module help quay.io/biocontainers/gempipe/1.37.6--pyhdfd78af_0
```
