...
updated_at: "2026-01-10 03:38:28.482152"
latest: "1.38.5--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/gempipe:1.38.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/gempipe/1.38.5--pyhdfd78af_0
$ module help quay.io/biocontainers/gempipe/1.38.5--pyhdfd78af_0
```
