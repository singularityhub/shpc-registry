...
updated_at: "2024-11-17 03:05:00.764344"
latest: "1.37.0--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/gempipe:1.37.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/gempipe/1.37.0--pyhdfd78af_0
$ module help quay.io/biocontainers/gempipe/1.37.0--pyhdfd78af_0
```
