...
updated_at: "2025-01-25 03:01:03.854507"
latest: "1.37.4--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/gempipe:1.37.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/gempipe/1.37.4--pyhdfd78af_0
$ module help quay.io/biocontainers/gempipe/1.37.4--pyhdfd78af_0
```
