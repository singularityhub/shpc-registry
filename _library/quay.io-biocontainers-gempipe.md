...
updated_at: "2024-10-16 03:57:24.588444"
latest: "1.35.3--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/gempipe:1.35.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/gempipe/1.35.3--pyhdfd78af_0
$ module help quay.io/biocontainers/gempipe/1.35.3--pyhdfd78af_0
```
