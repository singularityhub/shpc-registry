...
updated_at: "2023-12-02 02:34:15.326779"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-pvac:1.48.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-pvac/1.48.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-pvac/1.48.0--r43hdfd78af_0
```
