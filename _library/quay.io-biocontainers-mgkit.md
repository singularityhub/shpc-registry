...
updated_at: "2022-10-27 01:12:36.920907"
latest: "0.5.6--py36h91eb985_1"
...
```bash
$ shpc install quay.io/biocontainers/mgkit:0.5.6--py36h91eb985_1
```
...
```bash
$ module load quay.io/biocontainers/mgkit/0.5.6--py36h91eb985_1
$ module help quay.io/biocontainers/mgkit/0.5.6--py36h91eb985_1
```
