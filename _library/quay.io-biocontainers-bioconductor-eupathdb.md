...
updated_at: "2026-03-28 04:50:44.356392"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-eupathdb:1.0.1--r45hdfd78af_14
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-eupathdb/1.0.1--r45hdfd78af_14
$ module help quay.io/biocontainers/bioconductor-eupathdb/1.0.1--r45hdfd78af_14
```
