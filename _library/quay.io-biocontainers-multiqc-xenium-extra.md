---
layout: container
name:  "quay.io/biocontainers/multiqc-xenium-extra"
maintainer: "@vsoch"
...
updated_at: "2025-11-25 03:25:26.766397"
...
singularity registry hpc automated addition for multiqc-xenium-extra
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/multiqc-xenium-extra
```
...
#### multiqc-xenium-extra-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### multiqc-xenium-extra-inspect-deffile:
