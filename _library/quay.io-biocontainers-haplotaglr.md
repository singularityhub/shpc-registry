---
layout: container
name:  "quay.io/biocontainers/haplotaglr"
maintainer: "@vsoch"
...
updated_at: "2025-11-08 03:44:22.296279"
latest: "1.1.13--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/haplotaglr
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/haplotaglr:1.1.13--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/haplotaglr/1.1.13--pyhdfd78af_0
$ module help quay.io/biocontainers/haplotaglr/1.1.13--pyhdfd78af_0
```
...
#### haplotaglr-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### haplotaglr-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/HaplotagLR
$ podman run --it --rm --entrypoint /usr/local/bin/HaplotagLR   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/HaplotagLR   -v ${PWD} -w ${PWD} <container> -c " $@"
```
