...
updated_at: "2023-12-09 03:08:35.488794"
...
```bash
$ shpc install quay.io/biocontainers/haplotaglr:1.1.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/haplotaglr/1.1.4--pyhdfd78af_0
$ module help quay.io/biocontainers/haplotaglr/1.1.4--pyhdfd78af_0
```
