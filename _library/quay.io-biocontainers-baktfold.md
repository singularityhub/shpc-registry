...
updated_at: "2026-06-05 07:19:11.820285"
...
```bash
$ shpc install quay.io/biocontainers/baktfold:0.3.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/baktfold/0.3.0--pyhdfd78af_0
$ module help quay.io/biocontainers/baktfold/0.3.0--pyhdfd78af_0
```
