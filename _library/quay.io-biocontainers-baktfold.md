...
updated_at: "2026-05-09 05:31:52.218053"
...
```bash
$ shpc install quay.io/biocontainers/baktfold:0.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/baktfold/0.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/baktfold/0.2.0--pyhdfd78af_0
```
