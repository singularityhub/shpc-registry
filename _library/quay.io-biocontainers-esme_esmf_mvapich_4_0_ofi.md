---
layout: container
name:  "quay.io/biocontainers/esme_esmf_mvapich_4_0_ofi"
maintainer: "@vsoch"
github: "https://github.com/singularityhub/shpc-registry/blob/main/quay.io/biocontainers/esme_esmf_mvapich_4_0_ofi/container.yaml"
config_url: "https://raw.githubusercontent.com/singularityhub/shpc-registry/main/quay.io/biocontainers/esme_esmf_mvapich_4_0_ofi/container.yaml"
updated_at: "2025-12-28 04:25:38.003257"
latest: "8.8.1--h437bdb2_0"
container_url: "https://biocontainers.pro/tools/esme_esmf_mvapich_4_0_ofi"
aliases:
 - "fi_info"
 - "fi_pingpong"
 - "fi_strerror"
...
versions:
 - "8.8.1--h437bdb2_0"
description: "singularity registry hpc automated addition for esme_esmf_mvapich_4_0_ofi"
config: {"url": "https://biocontainers.pro/tools/esme_esmf_mvapich_4_0_ofi", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for esme_esmf_mvapich_4_0_ofi", "latest": {"8.8.1--h437bdb2_0": "sha256:bfd4b9fc9af5639a7099b355cf9d25709a20473e942de21c96d190bd80c1c912"}, "tags": {"8.8.1--h437bdb2_0": "sha256:bfd4b9fc9af5639a7099b355cf9d25709a20473e942de21c96d190bd80c1c912"}, "docker": "quay.io/biocontainers/esme_esmf_mvapich_4_0_ofi", "aliases": {"fi_info": "/usr/local/bin/fi_info", "fi_pingpong": "/usr/local/bin/fi_pingpong", "fi_strerror": "/usr/local/bin/fi_strerror", "ESMF_PrintInfo": "/usr/local/bin/ESMF_PrintInfo", "ESMF_PrintInfoC": "/usr/local/bin/ESMF_PrintInfoC", "ESMF_Regrid": "/usr/local/bin/ESMF_Regrid", "ESMF_RegridWeightGen": "/usr/local/bin/ESMF_RegridWeightGen", "ESMF_Scrip2Unstruct": "/usr/local/bin/ESMF_Scrip2Unstruct", "ESMF_WebServController": "/usr/local/bin/ESMF_WebServController", "ESMX_Builder": "/usr/local/bin/ESMX_Builder", "nc4print": "/usr/local/bin/nc4print", "ocprint": "/usr/local/bin/ocprint", "chacl": "/usr/local/bin/chacl", "getfacl": "/usr/local/bin/getfacl", "setfacl": "/usr/local/bin/setfacl", "cdfdiff": "/usr/local/bin/cdfdiff", "ncmpidiff": "/usr/local/bin/ncmpidiff", "ncmpidump": "/usr/local/bin/ncmpidump", "ncmpigen": "/usr/local/bin/ncmpigen", "ncoffsets": "/usr/local/bin/ncoffsets", "ncvalidator": "/usr/local/bin/ncvalidator", "pnetcdf-config": "/usr/local/bin/pnetcdf-config", "pnetcdf_version": "/usr/local/bin/pnetcdf_version", "h5pcc": "/usr/local/bin/h5pcc", "h5perf": "/usr/local/bin/h5perf", "h5pfc": "/usr/local/bin/h5pfc", "ph5diff": "/usr/local/bin/ph5diff", "nf-config": "/usr/local/bin/nf-config"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/esme_esmf_mvapich_4_0_ofi.
singularity registry hpc automated addition for esme_esmf_mvapich_4_0_ofi
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/esme_esmf_mvapich_4_0_ofi
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/esme_esmf_mvapich_4_0_ofi:8.8.1--h437bdb2_0
```
...
```bash
$ module load quay.io/biocontainers/esme_esmf_mvapich_4_0_ofi/8.8.1--h437bdb2_0
$ module help quay.io/biocontainers/esme_esmf_mvapich_4_0_ofi/8.8.1--h437bdb2_0
```
...
#### esme_esmf_mvapich_4_0_ofi-shell:
...
#### esme_esmf_mvapich_4_0_ofi-exec:
...
#### esme_esmf_mvapich_4_0_ofi-inspect:
...
#### esme_esmf_mvapich_4_0_ofi-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### esme_esmf_mvapich_4_0_ofi-inspect-deffile:
