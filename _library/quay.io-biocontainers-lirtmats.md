---
layout: container
name:  "quay.io/biocontainers/lirtmats"
maintainer: "@vsoch"
github: "https://github.com/singularityhub/shpc-registry/blob/main/quay.io/biocontainers/lirtmats/container.yaml"
config_url: "https://raw.githubusercontent.com/singularityhub/shpc-registry/main/quay.io/biocontainers/lirtmats/container.yaml"
updated_at: "2026-01-26 04:32:49.899240"
latest: "1.0.0--pyhdfd78af_0"
container_url: "https://biocontainers.pro/tools/lirtmats"
aliases:
 - "android_deploy.py"
 - "androiddeployqt6"
 - "assistant6"
...
versions:
 - "1.0.0--pyhdfd78af_0"
description: "singularity registry hpc automated addition for lirtmats"
config: {"url": "https://biocontainers.pro/tools/lirtmats", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for lirtmats", "latest": {"1.0.0--pyhdfd78af_0": "sha256:a4b02c3e698afeca87bd84ce0cdaf2f553b7462b0de8bde42dad769ccdd0ee67"}, "tags": {"1.0.0--pyhdfd78af_0": "sha256:a4b02c3e698afeca87bd84ce0cdaf2f553b7462b0de8bde42dad769ccdd0ee67"}, "docker": "quay.io/biocontainers/lirtmats", "aliases": {"android_deploy.py": "/usr/local/bin/android_deploy.py", "androiddeployqt6": "/usr/local/bin/androiddeployqt6", "assistant6": "/usr/local/bin/assistant6", "deploy.py": "/usr/local/bin/deploy.py", "designer6": "/usr/local/bin/designer6", "lamp": "/usr/local/bin/lamp", "linguist6": "/usr/local/bin/linguist6", "lirtmats": "/usr/local/bin/lirtmats", "metaobjectdump.py": "/usr/local/bin/metaobjectdump.py", "pixeltool6": "/usr/local/bin/pixeltool6", "project.py": "/usr/local/bin/project.py", "pyside6-rcc": "/usr/local/bin/pyside6-rcc", "pyside6-uic": "/usr/local/bin/pyside6-uic", "qdbus6": "/usr/local/bin/qdbus6", "qdbusviewer6": "/usr/local/bin/qdbusviewer6", "qdistancefieldgenerator6": "/usr/local/bin/qdistancefieldgenerator6", "qdoc6": "/usr/local/bin/qdoc6", "qmake6": "/usr/local/bin/qmake6", "qml.py": "/usr/local/bin/qml.py", "qml6": "/usr/local/bin/qml6", "qmleasing6": "/usr/local/bin/qmleasing6", "qmlls6": "/usr/local/bin/qmlls6", "qmlpreview6": "/usr/local/bin/qmlpreview6", "qmlscene6": "/usr/local/bin/qmlscene6", "qt6.conf": "/usr/local/bin/qt6.conf", "qtdiag6": "/usr/local/bin/qtdiag6", "qtplugininfo6": "/usr/local/bin/qtplugininfo6", "qtpy2cpp.py": "/usr/local/bin/qtpy2cpp.py", "requirements-android.txt": "/usr/local/bin/requirements-android.txt", "shiboken6": "/usr/local/bin/shiboken6", "shiboken_tool.py": "/usr/local/bin/shiboken_tool.py", "ldapadd": "/usr/local/bin/ldapadd", "ldapcompare": "/usr/local/bin/ldapcompare", "ldapdelete": "/usr/local/bin/ldapdelete", "ldapexop": "/usr/local/bin/ldapexop", "ldapmodify": "/usr/local/bin/ldapmodify", "ldapmodrdn": "/usr/local/bin/ldapmodrdn", "ldappasswd": "/usr/local/bin/ldappasswd", "ldapsearch": "/usr/local/bin/ldapsearch", "ldapurl": "/usr/local/bin/ldapurl", "ldapvc": "/usr/local/bin/ldapvc", "ldapwhoami": "/usr/local/bin/ldapwhoami", "runxlrd.py": "/usr/local/bin/runxlrd.py", "wayland-scanner": "/usr/local/bin/wayland-scanner", "idle3.14": "/usr/local/bin/idle3.14", "pydoc3.14": "/usr/local/bin/pydoc3.14", "python3.14": "/usr/local/bin/python3.14", "python3.14-config": "/usr/local/bin/python3.14-config", "xkbcli": "/usr/local/bin/xkbcli", "pg_config": "/usr/local/bin/pg_config", "natsort": "/usr/local/bin/natsort", "cups-config": "/usr/local/bin/cups-config", "ippeveprinter": "/usr/local/bin/ippeveprinter", "ipptool": "/usr/local/bin/ipptool", "xslt-config": "/usr/local/bin/xslt-config", "xsltproc": "/usr/local/bin/xsltproc"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/lirtmats.
singularity registry hpc automated addition for lirtmats
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/lirtmats
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/lirtmats:1.0.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/lirtmats/1.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/lirtmats/1.0.0--pyhdfd78af_0
```
...
#### lirtmats-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### lirtmats-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/lirtmats
$ podman run --it --rm --entrypoint /usr/local/bin/lirtmats   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/lirtmats   -v ${PWD} -w ${PWD} <container> -c " $@"
```
