...
updated_at: "2023-10-06 02:53:40.105711"
...
```bash
$ shpc install quay.io/biocontainers/flams:1.0.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/flams/1.0.1--pyhdfd78af_0
$ module help quay.io/biocontainers/flams/1.0.1--pyhdfd78af_0
```
