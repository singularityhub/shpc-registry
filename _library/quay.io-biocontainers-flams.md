...
updated_at: "2025-07-29 04:16:46.806389"
...
```bash
$ shpc install quay.io/biocontainers/flams:1.1.5--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/flams/1.1.5--pyhdfd78af_1
$ module help quay.io/biocontainers/flams/1.1.5--pyhdfd78af_1
```
