...
updated_at: "2025-09-23 03:33:25.045714"
...
```bash
$ shpc install quay.io/biocontainers/flams:1.1.6--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/flams/1.1.6--pyhdfd78af_0
$ module help quay.io/biocontainers/flams/1.1.6--pyhdfd78af_0
```
