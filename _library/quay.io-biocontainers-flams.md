...
updated_at: "2026-03-10 04:45:30.821237"
...
```bash
$ shpc install quay.io/biocontainers/flams:1.1.7--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/flams/1.1.7--pyhdfd78af_0
$ module help quay.io/biocontainers/flams/1.1.7--pyhdfd78af_0
```
