...
updated_at: "2023-12-14 02:57:09.454133"
...
```bash
$ shpc install quay.io/biocontainers/flams:1.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/flams/1.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/flams/1.1.0--pyhdfd78af_0
```
