...
updated_at: "2026-01-19 05:35:26.942125"
...
```bash
$ shpc install quay.io/biocontainers/qcatch:0.2.7--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/qcatch/0.2.7--pyhdfd78af_0
$ module help quay.io/biocontainers/qcatch/0.2.7--pyhdfd78af_0
```
