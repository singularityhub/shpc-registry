...
updated_at: "2026-01-27 04:39:04.991958"
...
```bash
$ shpc install quay.io/biocontainers/qcatch:0.2.8--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/qcatch/0.2.8--pyhdfd78af_0
$ module help quay.io/biocontainers/qcatch/0.2.8--pyhdfd78af_0
```
