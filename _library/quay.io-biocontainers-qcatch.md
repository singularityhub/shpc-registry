---
layout: container
name:  "quay.io/biocontainers/qcatch"
maintainer: "@vsoch"
...
updated_at: "2026-09-26 07:23:22.130882"
...
```bash
$ module load quay.io/biocontainers/qcatch/0.2.14--pyhdfd78af_0
$ module help quay.io/biocontainers/qcatch/0.2.14--pyhdfd78af_0
```
...
#### qcatch-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### qcatch-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/qcatch
$ podman run --it --rm --entrypoint /usr/local/bin/qcatch   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/qcatch   -v ${PWD} -w ${PWD} <container> -c " $@"
```
