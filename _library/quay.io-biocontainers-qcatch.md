...
updated_at: "2026-06-06 06:01:46.123183"
...
```bash
$ shpc install quay.io/biocontainers/qcatch:0.2.12--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/qcatch/0.2.12--pyhdfd78af_0
$ module help quay.io/biocontainers/qcatch/0.2.12--pyhdfd78af_0
```
