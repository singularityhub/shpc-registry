...
updated_at: "2026-03-23 05:10:41.862841"
...
```bash
$ shpc install quay.io/biocontainers/qcatch:0.2.10--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/qcatch/0.2.10--pyhdfd78af_0
$ module help quay.io/biocontainers/qcatch/0.2.10--pyhdfd78af_0
```
