...
updated_at: "2026-04-03 15:53:41.256452"
...
```bash
$ shpc install quay.io/biocontainers/qcatch:0.2.11--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/qcatch/0.2.11--pyhdfd78af_0
$ module help quay.io/biocontainers/qcatch/0.2.11--pyhdfd78af_0
```
