...
updated_at: "2026-08-27 23:36:59.703984"
...
```bash
$ shpc install quay.io/biocontainers/qcatch:0.2.13--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/qcatch/0.2.13--pyhdfd78af_0
$ module help quay.io/biocontainers/qcatch/0.2.13--pyhdfd78af_0
```
