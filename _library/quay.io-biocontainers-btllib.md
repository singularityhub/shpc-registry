...
updated_at: "2024-07-08 03:23:53.663458"
latest: "1.7.2--py38h2123bcc_2"
...
```bash
$ shpc install quay.io/biocontainers/btllib:1.7.2--py38h2123bcc_2
```
...
```bash
$ module load quay.io/biocontainers/btllib/1.7.2--py38h2123bcc_2
$ module help quay.io/biocontainers/btllib/1.7.2--py38h2123bcc_2
```
