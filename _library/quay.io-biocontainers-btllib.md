...
updated_at: "2023-05-08 02:38:49.055575"
latest: "1.5.1--py39hc16433a_0"
...
```bash
$ shpc install quay.io/biocontainers/btllib:1.5.1--py39hc16433a_0
```
...
```bash
$ module load quay.io/biocontainers/btllib/1.5.1--py39hc16433a_0
$ module help quay.io/biocontainers/btllib/1.5.1--py39hc16433a_0
```
