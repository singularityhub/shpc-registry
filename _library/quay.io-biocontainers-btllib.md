...
updated_at: "2024-11-19 03:17:00.626754"
latest: "1.7.3--py310h84f13bb_0"
...
```bash
$ shpc install quay.io/biocontainers/btllib:1.7.3--py310h84f13bb_0
```
...
```bash
$ module load quay.io/biocontainers/btllib/1.7.3--py310h84f13bb_0
$ module help quay.io/biocontainers/btllib/1.7.3--py310h84f13bb_0
```
