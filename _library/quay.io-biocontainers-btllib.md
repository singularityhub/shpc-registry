...
updated_at: "2026-06-08 06:53:35.168727"
latest: "1.7.8--py310hafc527e_0"
...
```bash
$ shpc install quay.io/biocontainers/btllib:1.7.8--py310hafc527e_0
```
...
```bash
$ module load quay.io/biocontainers/btllib/1.7.8--py310hafc527e_0
$ module help quay.io/biocontainers/btllib/1.7.8--py310hafc527e_0
```
