...
updated_at: "2025-04-01 03:40:34.954438"
latest: "1.7.3--py39h2de1943_1"
...
```bash
$ shpc install quay.io/biocontainers/btllib:1.7.3--py39h2de1943_1
```
...
```bash
$ module load quay.io/biocontainers/btllib/1.7.3--py39h2de1943_1
$ module help quay.io/biocontainers/btllib/1.7.3--py39h2de1943_1
```
