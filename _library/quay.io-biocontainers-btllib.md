...
updated_at: "2026-04-04 04:39:17.940875"
latest: "1.7.7--py313hfab59de_0"
...
```bash
$ shpc install quay.io/biocontainers/btllib:1.7.7--py313hfab59de_0
```
...
```bash
$ module load quay.io/biocontainers/btllib/1.7.7--py313hfab59de_0
$ module help quay.io/biocontainers/btllib/1.7.7--py313hfab59de_0
```
