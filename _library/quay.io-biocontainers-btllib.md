...
updated_at: "2023-02-24 03:05:19.069011"
latest: "1.4.8--py39hc16433a_0"
...
```bash
$ shpc install quay.io/biocontainers/btllib:1.4.8--py39hc16433a_0
```
...
```bash
$ module load quay.io/biocontainers/btllib/1.4.8--py39hc16433a_0
$ module help quay.io/biocontainers/btllib/1.4.8--py39hc16433a_0
```
