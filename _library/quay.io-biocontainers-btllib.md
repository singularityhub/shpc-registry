...
updated_at: "2023-06-30 03:43:42.856957"
latest: "1.6.0--py38h4a32c8e_0"
...
```bash
$ shpc install quay.io/biocontainers/btllib:1.6.0--py38h4a32c8e_0
```
...
```bash
$ module load quay.io/biocontainers/btllib/1.6.0--py38h4a32c8e_0
$ module help quay.io/biocontainers/btllib/1.6.0--py38h4a32c8e_0
```
