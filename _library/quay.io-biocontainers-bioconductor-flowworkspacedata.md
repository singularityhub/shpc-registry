...
updated_at: "2025-08-29 03:27:09.276866"
latest: "3.18.0--r44hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-flowworkspacedata:3.18.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-flowworkspacedata/3.18.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-flowworkspacedata/3.18.0--r44hdfd78af_0
```
