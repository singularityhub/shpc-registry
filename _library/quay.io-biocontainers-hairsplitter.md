...
updated_at: "2024-06-28 02:44:04.117161"
latest: "1.8.0--h8b7377a_0"
...
```bash
$ shpc install quay.io/biocontainers/hairsplitter:1.8.0--h8b7377a_0
```
...
```bash
$ module load quay.io/biocontainers/hairsplitter/1.8.0--h8b7377a_0
$ module help quay.io/biocontainers/hairsplitter/1.8.0--h8b7377a_0
```
