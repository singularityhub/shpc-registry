---
layout: container
name:  "quay.io/biocontainers/hairsplitter"
maintainer: "@vsoch"
...
updated_at: "2025-12-28 04:04:31.064877"
...
```bash
$ shpc install quay.io/biocontainers/hairsplitter
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/hairsplitter:1.9.10--h8b7377a_1
```
...
```bash
$ module load quay.io/biocontainers/hairsplitter/1.9.10--h8b7377a_1
$ module help quay.io/biocontainers/hairsplitter/1.9.10--h8b7377a_1
```
...
#### hairsplitter-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### hairsplitter-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/hairsplitter.py
$ podman run --it --rm --entrypoint /usr/local/bin/hairsplitter.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/hairsplitter.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
