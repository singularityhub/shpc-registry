...
updated_at: "2026-03-05 00:44:53.287059"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rbsurv:2.68.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rbsurv/2.68.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rbsurv/2.68.0--r45hdfd78af_0
```
