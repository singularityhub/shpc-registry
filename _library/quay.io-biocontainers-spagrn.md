...
updated_at: "2023-08-27 03:09:20.218112"
...
```bash
$ shpc install quay.io/biocontainers/spagrn:1.0.4--pyhca03a8a_0
```
...
```bash
$ module load quay.io/biocontainers/spagrn/1.0.4--pyhca03a8a_0
$ module help quay.io/biocontainers/spagrn/1.0.4--pyhca03a8a_0
```
