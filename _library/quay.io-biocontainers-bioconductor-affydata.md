...
updated_at: "2025-02-27 03:41:32.636026"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-affydata:1.54.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-affydata/1.54.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-affydata/1.54.0--r44hdfd78af_0
```
