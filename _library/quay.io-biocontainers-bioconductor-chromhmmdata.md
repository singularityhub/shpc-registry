...
updated_at: "2026-03-15 04:46:28.778496"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-chromhmmdata:0.99.2--r45hdfd78af_6
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-chromhmmdata/0.99.2--r45hdfd78af_6
$ module help quay.io/biocontainers/bioconductor-chromhmmdata/0.99.2--r45hdfd78af_6
```
