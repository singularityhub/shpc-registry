...
updated_at: "2024-11-28 03:37:03.944681"
...
```bash
$ shpc install quay.io/biocontainers/influx_si:7.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/influx_si/7.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/influx_si/7.1.0--pyhdfd78af_0
```
