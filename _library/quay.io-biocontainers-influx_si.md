...
updated_at: "2025-01-12 03:27:43.711958"
latest: "7.2.1--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/influx_si:7.2.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/influx_si/7.2.1--pyhdfd78af_0
$ module help quay.io/biocontainers/influx_si/7.2.1--pyhdfd78af_0
```
