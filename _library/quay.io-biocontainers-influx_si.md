...
updated_at: "2025-05-18 04:05:07.845475"
latest: "7.2.4--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/influx_si:7.2.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/influx_si/7.2.4--pyhdfd78af_0
$ module help quay.io/biocontainers/influx_si/7.2.4--pyhdfd78af_0
```
