...
updated_at: "2024-07-15 02:47:18.875884"
latest: "7.0.4--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/influx_si:7.0.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/influx_si/7.0.4--pyhdfd78af_0
$ module help quay.io/biocontainers/influx_si/7.0.4--pyhdfd78af_0
```
