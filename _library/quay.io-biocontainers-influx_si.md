...
updated_at: "2025-03-08 03:00:50.417142"
latest: "7.2.3--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/influx_si:7.2.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/influx_si/7.2.3--pyhdfd78af_0
$ module help quay.io/biocontainers/influx_si/7.2.3--pyhdfd78af_0
```
