...
updated_at: "2026-03-08 04:34:27.958255"
latest: "7.4.3--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/influx_si:7.4.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/influx_si/7.4.3--pyhdfd78af_0
$ module help quay.io/biocontainers/influx_si/7.4.3--pyhdfd78af_0
```
