...
updated_at: "2023-11-18 02:41:18.402158"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-convert:1.76.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-convert/1.76.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-convert/1.76.0--r43hdfd78af_0
```
