...
updated_at: "2026-03-29 05:05:03.572453"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-consensus:1.28.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-consensus/1.28.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-consensus/1.28.0--r45hdfd78af_0
```
