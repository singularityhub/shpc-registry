...
updated_at: "2025-12-16 03:37:06.979691"
...
```bash
$ shpc install quay.io/biocontainers/paidiverpy:0.2.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/paidiverpy/0.2.1--pyhdfd78af_0
$ module help quay.io/biocontainers/paidiverpy/0.2.1--pyhdfd78af_0
```
