---
layout: container
name:  "quay.io/biocontainers/paidiverpy"
maintainer: "@vsoch"
...
updated_at: "2026-06-06 06:23:13.090930"
...
versions:
 ...
 - "0.2.1--pyhdfd78af_0"
 - "0.3.1--pyhdfd78af_0"
description: "singularity registry hpc automated addition for paidiverpy"
config: {"url": "https://biocontainers.pro/tools/paidiverpy", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for paidiverpy", "latest": {"0.3.1--pyhdfd78af_0": "sha256:d88e6d8e30350c81e8723dbf5ebe4ec835a815a17a1beba0f5ec2b1f6f607888"}, "tags": {"0.1.4--pyh7e72e81_0": "sha256:6318e81d690e14ed2a4cd20527b50a48fcd79be790031b02598609999d61a29e", "0.2.1--pyhdfd78af_0": "sha256:1e0a94d4f48474651586fd972de021f4595b38341305529068f84048a6c4a01c", "0.3.1--pyhdfd78af_0": "sha256:d88e6d8e30350c81e8723dbf5ebe4ec835a815a17a1beba0f5ec2b1f6f607888"}, "docker": "quay.io/biocontainers/paidiverpy", "aliases": {"4channels": "/usr/local/bin/4channels", "androiddeployqt6": "/usr/local/bin/androiddeployqt6", "assistant6": "/usr/local/bin/assistant6", "dcraw_emu": "/usr/local/bin/dcraw_emu", "dcraw_half": "/usr/local/bin/dcraw_half", "designer6": "/usr/local/bin/designer6", "exr2aces": "/usr/local/bin/exr2aces", "exrenvmap": "/usr/local/bin/exrenvmap", "exrheader": "/usr/local/bin/exrheader", "exrinfo": "/usr/local/bin/exrinfo", "exrmakepreview": "/usr/local/bin/exrmakepreview", "exrmaketiled": "/usr/local/bin/exrmaketiled", "exrmanifest": "/usr/local/bin/exrmanifest", "exrmetrics": "/usr/local/bin/exrmetrics", "exrmultipart": "/usr/local/bin/exrmultipart", "exrmultiview": "/usr/local/bin/exrmultiview", "exrstdattr": "/usr/local/bin/exrstdattr", "ffplay": "/usr/local/bin/ffplay", "gdal": "/usr/local/bin/gdal", "h2benchmark": "/usr/local/bin/h2benchmark", "half_mt": "/usr/local/bin/half_mt", "imgcmp": "/usr/local/bin/imgcmp", "imginfo": "/usr/local/bin/imginfo", "jasper": "/usr/local/bin/jasper", "jiv": "/usr/local/bin/jiv", "linguist6": "/usr/local/bin/linguist6", "mem_image": "/usr/local/bin/mem_image", "multirender_test": "/usr/local/bin/multirender_test", "opencv_annotation": "/usr/local/bin/opencv_annotation", "opencv_interactive-calibration": "/usr/local/bin/opencv_interactive-calibration", "opencv_model_diagnostics": "/usr/local/bin/opencv_model_diagnostics", "opencv_version": "/usr/local/bin/opencv_version", "opencv_visualisation": "/usr/local/bin/opencv_visualisation", "opencv_waldboost_detector": "/usr/local/bin/opencv_waldboost_detector", "paidiverpy": "/usr/local/bin/paidiverpy", "pixeltool6": "/usr/local/bin/pixeltool6", "postprocessing_benchmark": "/usr/local/bin/postprocessing_benchmark", "pyproj": "/usr/local/bin/pyproj", "qdbus6": "/usr/local/bin/qdbus6", "qdbusviewer6": "/usr/local/bin/qdbusviewer6", "qdistancefieldgenerator6": "/usr/local/bin/qdistancefieldgenerator6", "qdoc6": "/usr/local/bin/qdoc6", "qmake6": "/usr/local/bin/qmake6", "qml6": "/usr/local/bin/qml6", "qmleasing6": "/usr/local/bin/qmleasing6", "qmlls6": "/usr/local/bin/qmlls6", "qmlpreview6": "/usr/local/bin/qmlpreview6", "qmlscene6": "/usr/local/bin/qmlscene6", "qt6.conf": "/usr/local/bin/qt6.conf", "qtdiag6": "/usr/local/bin/qtdiag6", "qtplugininfo6": "/usr/local/bin/qtplugininfo6", "raw-identify": "/usr/local/bin/raw-identify", "rawtextdump": "/usr/local/bin/rawtextdump", "sdl2-config": "/usr/local/bin/sdl2-config", "setup_vars_opencv4.sh": "/usr/local/bin/setup_vars_opencv4.sh", "simple_dcraw": "/usr/local/bin/simple_dcraw", "unprocessed_raw": "/usr/local/bin/unprocessed_raw", "gdal_footprint": "/usr/local/bin/gdal_footprint", "minigzip": "/usr/local/bin/minigzip", "minizip": "/usr/local/bin/minizip", "pax11publish": "/usr/local/bin/pax11publish", "protoc-29.3.0": "/usr/local/bin/protoc-29.3.0", "protoc-gen-upb": "/usr/local/bin/protoc-gen-upb", "protoc-gen-upb-29.3.0": "/usr/local/bin/protoc-gen-upb-29.3.0", "protoc-gen-upb_minitable": "/usr/local/bin/protoc-gen-upb_minitable", "protoc-gen-upb_minitable-29.3.0": "/usr/local/bin/protoc-gen-upb_minitable-29.3.0", "protoc-gen-upbdefs": "/usr/local/bin/protoc-gen-upbdefs", "protoc-gen-upbdefs-29.3.0": "/usr/local/bin/protoc-gen-upbdefs-29.3.0", "cllayerinfo": "/usr/local/bin/cllayerinfo", "sozip": "/usr/local/bin/sozip", "ldapadd": "/usr/local/bin/ldapadd", "ldapcompare": "/usr/local/bin/ldapcompare", "ldapdelete": "/usr/local/bin/ldapdelete", "ldapexop": "/usr/local/bin/ldapexop", "ldapmodify": "/usr/local/bin/ldapmodify", "ldapmodrdn": "/usr/local/bin/ldapmodrdn", "ldappasswd": "/usr/local/bin/ldappasswd", "ldapsearch": "/usr/local/bin/ldapsearch", "ldapurl": "/usr/local/bin/ldapurl", "ldapvc": "/usr/local/bin/ldapvc", "ldapwhoami": "/usr/local/bin/ldapwhoami", "vpxdec": "/usr/local/bin/vpxdec"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/paidiverpy.
singularity registry hpc automated addition for paidiverpy
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/paidiverpy
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/paidiverpy:0.3.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/paidiverpy/0.3.1--pyhdfd78af_0
$ module help quay.io/biocontainers/paidiverpy/0.3.1--pyhdfd78af_0
```
...
#### paidiverpy-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### paidiverpy-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/paidiverpy
$ podman run --it --rm --entrypoint /usr/local/bin/paidiverpy   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/paidiverpy   -v ${PWD} -w ${PWD} <container> -c " $@"
```
