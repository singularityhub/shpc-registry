...
updated_at: "2026-08-28 14:27:15.152338"
...
```bash
$ shpc install quay.io/biocontainers/irida-uploader:0.9.6--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/irida-uploader/0.9.6--pyhdfd78af_0
$ module help quay.io/biocontainers/irida-uploader/0.9.6--pyhdfd78af_0
```
