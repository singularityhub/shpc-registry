...
updated_at: "2025-08-21 03:51:35.486232"
...
```bash
$ shpc install quay.io/biocontainers/irida-uploader:0.9.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/irida-uploader/0.9.5--pyhdfd78af_0
$ module help quay.io/biocontainers/irida-uploader/0.9.5--pyhdfd78af_0
```
