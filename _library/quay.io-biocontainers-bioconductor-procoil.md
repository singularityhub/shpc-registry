...
updated_at: "2026-03-21 05:07:53.008200"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-procoil:2.38.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-procoil/2.38.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-procoil/2.38.0--r45hdfd78af_0
```
