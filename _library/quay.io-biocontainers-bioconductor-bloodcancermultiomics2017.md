...
updated_at: "2024-05-29 03:13:42.503163"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-bloodcancermultiomics2017:1.22.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-bloodcancermultiomics2017/1.22.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-bloodcancermultiomics2017/1.22.0--r43hdfd78af_0
```
