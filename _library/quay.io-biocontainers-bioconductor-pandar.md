...
updated_at: "2025-05-01 06:49:19.663319"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-pandar:1.38.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-pandar/1.38.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-pandar/1.38.0--r44hdfd78af_0
```
