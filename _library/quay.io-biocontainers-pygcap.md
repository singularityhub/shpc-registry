---
layout: container
name:  "quay.io/biocontainers/pygcap"
maintainer: "@vsoch"
...
updated_at: "2024-06-29 03:18:23.321672"
...
```bash
$ shpc install quay.io/biocontainers/pygcap
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/pygcap:0.0.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pygcap/0.0.5--pyhdfd78af_0
$ module help quay.io/biocontainers/pygcap/0.0.5--pyhdfd78af_0
```
...
#### pygcap-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### pygcap-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/pygcap
$ podman run --it --rm --entrypoint /usr/local/bin/pygcap   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/pygcap   -v ${PWD} -w ${PWD} <container> -c " $@"
```
