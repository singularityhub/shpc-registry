...
updated_at: "2026-04-03 15:42:47.868050"
...
```bash
$ shpc install quay.io/biocontainers/mutmap:2.4.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mutmap/2.4.0--pyhdfd78af_0
$ module help quay.io/biocontainers/mutmap/2.4.0--pyhdfd78af_0
```
