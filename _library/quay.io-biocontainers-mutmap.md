...
updated_at: "2024-11-22 03:24:56.049609"
...
```bash
$ shpc install quay.io/biocontainers/mutmap:2.3.8--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mutmap/2.3.8--pyhdfd78af_0
$ module help quay.io/biocontainers/mutmap/2.3.8--pyhdfd78af_0
```
