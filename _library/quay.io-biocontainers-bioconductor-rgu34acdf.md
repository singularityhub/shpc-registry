...
updated_at: "2026-03-24 04:32:04.667513"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rgu34acdf:2.18.0--r45hdfd78af_14
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rgu34acdf/2.18.0--r45hdfd78af_14
$ module help quay.io/biocontainers/bioconductor-rgu34acdf/2.18.0--r45hdfd78af_14
```
