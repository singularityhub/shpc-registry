...
updated_at: "2026-06-16 08:13:55.429841"
...
```bash
$ shpc install quay.io/biocontainers/atol-qc-raw-shortread:0.3.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/atol-qc-raw-shortread/0.3.1--pyhdfd78af_0
$ module help quay.io/biocontainers/atol-qc-raw-shortread/0.3.1--pyhdfd78af_0
```
