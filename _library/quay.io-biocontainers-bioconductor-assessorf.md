...
updated_at: "2026-03-23 05:24:51.799791"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-assessorf:1.28.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-assessorf/1.28.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-assessorf/1.28.0--r45hdfd78af_0
```
