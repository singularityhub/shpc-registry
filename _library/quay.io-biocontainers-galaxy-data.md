...
updated_at: "2026-03-20 00:14:16.788993"
latest: "25.1.2--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/galaxy-data:25.1.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/galaxy-data/25.1.2--pyhdfd78af_0
$ module help quay.io/biocontainers/galaxy-data/25.1.2--pyhdfd78af_0
```
