...
updated_at: "2026-02-01 04:41:38.007545"
...
```bash
$ shpc install quay.io/biocontainers/galaxy-data:25.0.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/galaxy-data/25.0.4--pyhdfd78af_0
$ module help quay.io/biocontainers/galaxy-data/25.0.4--pyhdfd78af_0
```
