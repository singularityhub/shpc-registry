...
updated_at: "2024-10-29 03:15:59.620013"
...
```bash
$ shpc install quay.io/biocontainers/galaxy-data:24.1.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/galaxy-data/24.1.2--pyhdfd78af_0
$ module help quay.io/biocontainers/galaxy-data/24.1.2--pyhdfd78af_0
```
