...
updated_at: "2025-09-27 03:05:08.575742"
...
```bash
$ shpc install quay.io/biocontainers/galaxy-data:25.0.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/galaxy-data/25.0.2--pyhdfd78af_0
$ module help quay.io/biocontainers/galaxy-data/25.0.2--pyhdfd78af_0
```
