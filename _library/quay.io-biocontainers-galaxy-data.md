...
updated_at: "2024-12-03 04:21:03.741097"
...
```bash
$ shpc install quay.io/biocontainers/galaxy-data:24.1.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/galaxy-data/24.1.3--pyhdfd78af_0
$ module help quay.io/biocontainers/galaxy-data/24.1.3--pyhdfd78af_0
```
