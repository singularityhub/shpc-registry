...
updated_at: "2026-06-28 06:35:51.516488"
...
```bash
$ shpc install quay.io/biocontainers/galaxy-data:26.0.1--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/galaxy-data/26.0.1--pyhdfd78af_1
$ module help quay.io/biocontainers/galaxy-data/26.0.1--pyhdfd78af_1
```
