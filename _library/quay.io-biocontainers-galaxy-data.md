...
updated_at: "2025-01-28 02:53:06.428915"
...
```bash
$ shpc install quay.io/biocontainers/galaxy-data:24.1.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/galaxy-data/24.1.4--pyhdfd78af_0
$ module help quay.io/biocontainers/galaxy-data/24.1.4--pyhdfd78af_0
```
