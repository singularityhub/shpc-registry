...
updated_at: "2025-10-25 03:13:44.513681"
...
```bash
$ shpc install quay.io/biocontainers/galaxy-data:25.0.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/galaxy-data/25.0.3--pyhdfd78af_0
$ module help quay.io/biocontainers/galaxy-data/25.0.3--pyhdfd78af_0
```
