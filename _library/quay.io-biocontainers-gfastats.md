...
updated_at: "2024-12-06 03:40:01.202304"
latest: "1.3.9--hdcf5f25_0"
...
```bash
$ shpc install quay.io/biocontainers/gfastats:1.3.9--hdcf5f25_0
```
...
```bash
$ module load quay.io/biocontainers/gfastats/1.3.9--hdcf5f25_0
$ module help quay.io/biocontainers/gfastats/1.3.9--hdcf5f25_0
```
