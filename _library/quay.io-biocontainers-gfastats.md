...
updated_at: "2025-04-12 03:47:54.970503"
latest: "1.3.10--h077b44d_0"
...
```bash
$ shpc install quay.io/biocontainers/gfastats:1.3.10--h077b44d_0
```
...
```bash
$ module load quay.io/biocontainers/gfastats/1.3.10--h077b44d_0
$ module help quay.io/biocontainers/gfastats/1.3.10--h077b44d_0
```
