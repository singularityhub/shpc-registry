...
updated_at: "2022-10-29 05:35:50.330873"
latest: "1.6--r41h3342da4_2"
...
```bash
$ shpc install quay.io/biocontainers/r-ontologyplot:1.6--r41h3342da4_2
```
...
```bash
$ module load quay.io/biocontainers/r-ontologyplot/1.6--r41h3342da4_2
$ module help quay.io/biocontainers/r-ontologyplot/1.6--r41h3342da4_2
```
