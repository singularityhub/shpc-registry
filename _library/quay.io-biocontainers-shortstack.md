...
updated_at: "2024-05-01 03:14:33.651356"
...
```bash
$ shpc install quay.io/biocontainers/shortstack:4.0.3--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/shortstack/4.0.3--hdfd78af_0
$ module help quay.io/biocontainers/shortstack/4.0.3--hdfd78af_0
```
