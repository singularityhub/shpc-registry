...
updated_at: "2023-12-07 03:09:33.732503"
latest: "4.0.2--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/shortstack:4.0.2--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/shortstack/4.0.2--hdfd78af_0
$ module help quay.io/biocontainers/shortstack/4.0.2--hdfd78af_0
```
