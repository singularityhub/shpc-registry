...
updated_at: "2023-09-07 03:25:42.351107"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-consica:1.2.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-consica/1.2.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-consica/1.2.0--r43hdfd78af_0
```
