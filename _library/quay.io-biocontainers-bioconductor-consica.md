...
updated_at: "2025-04-06 03:25:06.932446"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-consica:2.4.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-consica/2.4.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-consica/2.4.0--r44hdfd78af_0
```
