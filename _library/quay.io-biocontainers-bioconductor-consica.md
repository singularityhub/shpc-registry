...
updated_at: "2024-01-26 02:47:30.901789"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-consica:2.0.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-consica/2.0.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-consica/2.0.0--r43hdfd78af_0
```
