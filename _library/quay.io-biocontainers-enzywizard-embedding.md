---
layout: container
name:  "quay.io/biocontainers/enzywizard-embedding"
maintainer: "@vsoch"
...
updated_at: "2026-07-01 16:00:21.339326"
...
singularity registry hpc automated addition for enzywizard-embedding
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/enzywizard-embedding
```
...
#### enzywizard-embedding-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### enzywizard-embedding-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/enzywizard-embedding
$ podman run --it --rm --entrypoint /usr/local/bin/enzywizard-embedding   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/enzywizard-embedding   -v ${PWD} -w ${PWD} <container> -c " $@"
```
