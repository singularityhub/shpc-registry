...
updated_at: "2025-01-22 03:14:13.083703"
...
```bash
$ shpc install quay.io/biocontainers/somaticseq:3.10.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/somaticseq/3.10.0--pyhdfd78af_0
$ module help quay.io/biocontainers/somaticseq/3.10.0--pyhdfd78af_0
```
