...
updated_at: "2025-08-20 03:19:31.644561"
latest: "3.11.1--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/somaticseq:3.11.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/somaticseq/3.11.1--pyhdfd78af_0
$ module help quay.io/biocontainers/somaticseq/3.11.1--pyhdfd78af_0
```
