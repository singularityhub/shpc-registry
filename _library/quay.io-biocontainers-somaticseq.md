...
updated_at: "2025-05-18 03:28:49.522214"
...
```bash
$ shpc install quay.io/biocontainers/somaticseq:3.11.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/somaticseq/3.11.0--pyhdfd78af_0
$ module help quay.io/biocontainers/somaticseq/3.11.0--pyhdfd78af_0
```
