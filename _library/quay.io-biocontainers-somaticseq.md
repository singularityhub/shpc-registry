...
updated_at: "2026-05-14 06:04:00.109650"
latest: "3.12.0--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/somaticseq:3.12.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/somaticseq/3.12.0--pyhdfd78af_0
$ module help quay.io/biocontainers/somaticseq/3.12.0--pyhdfd78af_0
```
