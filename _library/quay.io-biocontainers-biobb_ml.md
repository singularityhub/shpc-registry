...
updated_at: "2022-10-27 01:12:41.664517"
...
```bash
$ shpc install quay.io/biocontainers/biobb_ml:3.8.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_ml/3.8.0--pyhdfd78af_0
$ module help quay.io/biocontainers/biobb_ml/3.8.0--pyhdfd78af_0
```
