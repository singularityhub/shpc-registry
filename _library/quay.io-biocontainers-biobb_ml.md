...
updated_at: "2023-12-13 02:55:30.795110"
...
```bash
$ shpc install quay.io/biocontainers/biobb_ml:4.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_ml/4.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/biobb_ml/4.1.0--pyhdfd78af_0
```
