...
updated_at: "2023-12-03 02:57:48.427523"
latest: "3.8.2--pyhdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/checkqc:3.8.2--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/checkqc/3.8.2--pyhdfd78af_1
$ module help quay.io/biocontainers/checkqc/3.8.2--pyhdfd78af_1
```
