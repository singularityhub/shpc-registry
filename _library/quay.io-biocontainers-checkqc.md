...
updated_at: "2024-08-31 03:24:54.736705"
...
```bash
$ shpc install quay.io/biocontainers/checkqc:4.0.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/checkqc/4.0.4--pyhdfd78af_0
$ module help quay.io/biocontainers/checkqc/4.0.4--pyhdfd78af_0
```
