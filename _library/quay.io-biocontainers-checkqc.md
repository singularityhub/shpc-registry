...
updated_at: "2024-07-14 02:42:25.090497"
...
```bash
$ shpc install quay.io/biocontainers/checkqc:4.0.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/checkqc/4.0.1--pyhdfd78af_0
$ module help quay.io/biocontainers/checkqc/4.0.1--pyhdfd78af_0
```
