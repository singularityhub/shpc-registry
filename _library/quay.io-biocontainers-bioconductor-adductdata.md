...
updated_at: "2023-10-11 02:51:21.014420"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-adductdata:1.16.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-adductdata/1.16.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-adductdata/1.16.0--r43hdfd78af_0
```
