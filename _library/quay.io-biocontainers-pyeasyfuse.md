---
layout: container
name:  "quay.io/biocontainers/pyeasyfuse"
maintainer: "@vsoch"
...
updated_at: "2025-08-14 03:32:38.441886"
...
```bash
$ module load quay.io/biocontainers/pyeasyfuse/2.0.3--py37r42hdfd78af_0
$ module help quay.io/biocontainers/pyeasyfuse/2.0.3--py37r42hdfd78af_0
```
...
#### pyeasyfuse-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### pyeasyfuse-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/easy-fuse
$ podman run --it --rm --entrypoint /usr/local/bin/easy-fuse   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/easy-fuse   -v ${PWD} -w ${PWD} <container> -c " $@"
```
