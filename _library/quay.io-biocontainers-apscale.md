...
updated_at: "2025-12-22 04:33:00.182973"
...
```bash
$ shpc install quay.io/biocontainers/apscale:4.2.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/apscale/4.2.3--pyhdfd78af_0
$ module help quay.io/biocontainers/apscale/4.2.3--pyhdfd78af_0
```
