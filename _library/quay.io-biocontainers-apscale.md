...
updated_at: "2025-08-08 03:50:06.919370"
...
```bash
$ shpc install quay.io/biocontainers/apscale:3.0.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/apscale/3.0.2--pyhdfd78af_0
$ module help quay.io/biocontainers/apscale/3.0.2--pyhdfd78af_0
```
