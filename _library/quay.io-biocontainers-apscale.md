...
updated_at: "2024-09-30 04:37:37.172497"
...
```bash
$ shpc install quay.io/biocontainers/apscale:2.0.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/apscale/2.0.2--pyhdfd78af_0
$ module help quay.io/biocontainers/apscale/2.0.2--pyhdfd78af_0
```
