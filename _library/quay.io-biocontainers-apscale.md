...
updated_at: "2026-08-21 03:35:47.325893"
latest: "4.3.3--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/apscale:4.3.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/apscale/4.3.3--pyhdfd78af_0
$ module help quay.io/biocontainers/apscale/4.3.3--pyhdfd78af_0
```
