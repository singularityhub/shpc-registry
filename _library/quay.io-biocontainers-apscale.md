...
updated_at: "2026-04-01 05:41:56.598840"
...
```bash
$ shpc install quay.io/biocontainers/apscale:4.3.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/apscale/4.3.0--pyhdfd78af_0
$ module help quay.io/biocontainers/apscale/4.3.0--pyhdfd78af_0
```
