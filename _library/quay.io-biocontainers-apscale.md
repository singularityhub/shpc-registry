...
updated_at: "2026-05-09 06:16:43.775464"
...
```bash
$ shpc install quay.io/biocontainers/apscale:4.3.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/apscale/4.3.2--pyhdfd78af_0
$ module help quay.io/biocontainers/apscale/4.3.2--pyhdfd78af_0
```
