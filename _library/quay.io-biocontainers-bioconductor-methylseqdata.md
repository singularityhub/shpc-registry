...
updated_at: "2026-04-01 05:32:44.213932"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-methylseqdata:1.20.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-methylseqdata/1.20.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-methylseqdata/1.20.0--r45hdfd78af_0
```
