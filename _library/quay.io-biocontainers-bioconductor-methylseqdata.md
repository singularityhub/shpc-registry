...
updated_at: "2023-09-07 02:45:33.132569"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-methylseqdata:1.10.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-methylseqdata/1.10.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-methylseqdata/1.10.0--r43hdfd78af_0
```
