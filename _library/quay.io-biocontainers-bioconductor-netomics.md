...
updated_at: "2023-11-05 02:27:29.335176"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-netomics:1.6.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-netomics/1.6.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-netomics/1.6.0--r43hdfd78af_0
```
