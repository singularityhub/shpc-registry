...
updated_at: "2025-03-02 03:43:12.852750"
...
```bash
$ shpc install quay.io/biocontainers/idba_subasm:1.1.3a2--py311pl5321h8ddd9a4_9
```
...
```bash
$ module load quay.io/biocontainers/idba_subasm/1.1.3a2--py311pl5321h8ddd9a4_9
$ module help quay.io/biocontainers/idba_subasm/1.1.3a2--py311pl5321h8ddd9a4_9
```
