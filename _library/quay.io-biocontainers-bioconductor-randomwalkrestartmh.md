...
updated_at: "2022-11-16 00:06:58.580806"
latest: "1.8.0--r40_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-randomwalkrestartmh:1.8.0--r40_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-randomwalkrestartmh/1.8.0--r40_0
$ module help quay.io/biocontainers/bioconductor-randomwalkrestartmh/1.8.0--r40_0
```
