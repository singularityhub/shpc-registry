...
updated_at: "2025-04-21 05:16:04.646933"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-randomwalkrestartmh:1.22.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-randomwalkrestartmh/1.22.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-randomwalkrestartmh/1.22.0--r43hdfd78af_0
```
