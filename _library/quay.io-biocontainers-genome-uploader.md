...
updated_at: "2026-08-09 04:14:48.037321"
...
```bash
$ shpc install quay.io/biocontainers/genome-uploader:3.0.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/genome-uploader/3.0.3--pyhdfd78af_0
$ module help quay.io/biocontainers/genome-uploader/3.0.3--pyhdfd78af_0
```
