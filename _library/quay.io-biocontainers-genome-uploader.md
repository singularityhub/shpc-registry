...
updated_at: "2026-06-23 06:36:50.706989"
...
```bash
$ shpc install quay.io/biocontainers/genome-uploader:3.0.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/genome-uploader/3.0.1--pyhdfd78af_0
$ module help quay.io/biocontainers/genome-uploader/3.0.1--pyhdfd78af_0
```
