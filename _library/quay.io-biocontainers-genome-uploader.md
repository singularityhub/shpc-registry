...
updated_at: "2026-08-29 09:26:51.196356"
...
```bash
$ shpc install quay.io/biocontainers/genome-uploader:3.0.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/genome-uploader/3.0.4--pyhdfd78af_0
$ module help quay.io/biocontainers/genome-uploader/3.0.4--pyhdfd78af_0
```
