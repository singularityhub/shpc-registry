...
updated_at: "2024-01-26 02:37:28.581686"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cardinal:3.4.3--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cardinal/3.4.3--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-cardinal/3.4.3--r43hf17093f_0
```
