...
updated_at: "2026-03-10 04:31:47.052488"
latest: "3.12.0--r45hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cardinal:3.12.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cardinal/3.12.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-cardinal/3.12.0--r45hdfd78af_0
```
