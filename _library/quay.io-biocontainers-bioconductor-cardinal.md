...
updated_at: "2025-03-27 03:33:28.984056"
latest: "3.8.0--r44hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cardinal:3.8.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cardinal/3.8.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-cardinal/3.8.0--r44hdfd78af_0
```
