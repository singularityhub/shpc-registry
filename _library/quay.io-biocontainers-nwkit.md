...
updated_at: "2026-09-04 07:24:40.646098"
...
```bash
$ shpc install quay.io/biocontainers/nwkit:0.27.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/nwkit/0.27.0--pyhdfd78af_0
$ module help quay.io/biocontainers/nwkit/0.27.0--pyhdfd78af_0
```
