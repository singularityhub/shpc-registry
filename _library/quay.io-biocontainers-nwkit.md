...
updated_at: "2026-03-04 05:01:47.945853"
latest: "0.21.1--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/nwkit:0.21.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/nwkit/0.21.1--pyhdfd78af_0
$ module help quay.io/biocontainers/nwkit/0.21.1--pyhdfd78af_0
```
