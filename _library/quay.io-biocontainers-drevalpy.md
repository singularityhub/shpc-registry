...
updated_at: "2026-06-28 06:38:56.619500"
...
```bash
$ shpc install quay.io/biocontainers/drevalpy:1.5.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/drevalpy/1.5.0--pyhdfd78af_0
$ module help quay.io/biocontainers/drevalpy/1.5.0--pyhdfd78af_0
```
