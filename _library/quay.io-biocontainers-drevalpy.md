...
updated_at: "2026-09-05 07:21:44.415762"
...
```bash
$ shpc install quay.io/biocontainers/drevalpy:1.5.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/drevalpy/1.5.1--pyhdfd78af_0
$ module help quay.io/biocontainers/drevalpy/1.5.1--pyhdfd78af_0
```
