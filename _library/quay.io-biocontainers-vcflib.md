...
updated_at: "2025-04-10 03:30:35.875936"
latest: "1.0.12--hbefcdb2_2"
...
```bash
$ shpc install quay.io/biocontainers/vcflib:1.0.12--hbefcdb2_2
```
...
```bash
$ module load quay.io/biocontainers/vcflib/1.0.12--hbefcdb2_2
$ module help quay.io/biocontainers/vcflib/1.0.12--hbefcdb2_2
```
