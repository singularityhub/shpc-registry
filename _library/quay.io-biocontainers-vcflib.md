...
updated_at: "2025-03-12 05:01:53.438609"
...
```bash
$ shpc install quay.io/biocontainers/vcflib:1.0.12--hbefcdb2_1
```
...
```bash
$ module load quay.io/biocontainers/vcflib/1.0.12--hbefcdb2_1
$ module help quay.io/biocontainers/vcflib/1.0.12--hbefcdb2_1
```
