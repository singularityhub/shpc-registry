...
updated_at: "2025-05-05 03:57:45.810288"
latest: "1.0.13--h34261f4_0"
...
```bash
$ shpc install quay.io/biocontainers/vcflib:1.0.13--h34261f4_0
```
...
```bash
$ module load quay.io/biocontainers/vcflib/1.0.13--h34261f4_0
$ module help quay.io/biocontainers/vcflib/1.0.13--h34261f4_0
```
