...
updated_at: "2024-05-30 04:25:02.157212"
...
```bash
$ shpc install quay.io/biocontainers/syny:1.1a--py310pl5321h7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/syny/1.1a--py310pl5321h7cba7a3_0
$ module help quay.io/biocontainers/syny/1.1a--py310pl5321h7cba7a3_0
```
