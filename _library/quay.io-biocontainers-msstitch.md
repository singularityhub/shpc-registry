...
updated_at: "2023-10-11 02:43:34.606245"
latest: "3.14--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/msstitch:3.14--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/msstitch/3.14--pyhdfd78af_0
$ module help quay.io/biocontainers/msstitch/3.14--pyhdfd78af_0
```
