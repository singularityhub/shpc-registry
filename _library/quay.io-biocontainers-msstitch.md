...
updated_at: "2026-05-06 06:09:31.611750"
latest: "3.20--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/msstitch:3.20--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/msstitch/3.20--pyhdfd78af_0
$ module help quay.io/biocontainers/msstitch/3.20--pyhdfd78af_0
```
