...
updated_at: "2024-02-12 03:14:44.750417"
latest: "3.15--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/msstitch:3.15--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/msstitch/3.15--pyhdfd78af_0
$ module help quay.io/biocontainers/msstitch/3.15--pyhdfd78af_0
```
