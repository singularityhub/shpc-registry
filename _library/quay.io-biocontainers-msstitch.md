...
updated_at: "2026-03-04 05:04:14.918080"
latest: "3.18--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/msstitch:3.18--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/msstitch/3.18--pyhdfd78af_0
$ module help quay.io/biocontainers/msstitch/3.18--pyhdfd78af_0
```
