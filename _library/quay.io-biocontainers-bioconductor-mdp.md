...
updated_at: "2022-10-29 05:41:36.700860"
latest: "1.8.0--r40_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mdp:1.8.0--r40_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mdp/1.8.0--r40_0
$ module help quay.io/biocontainers/bioconductor-mdp/1.8.0--r40_0
```
