...
updated_at: "2026-06-24 06:42:57.802529"
latest: "1.35--pyhdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/multiqc:1.35--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/multiqc/1.35--pyhdfd78af_1
$ module help quay.io/biocontainers/multiqc/1.35--pyhdfd78af_1
```
