...
updated_at: "2024-07-20 02:56:54.492438"
latest: "1.22.3--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/multiqc:1.22.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/multiqc/1.22.3--pyhdfd78af_0
$ module help quay.io/biocontainers/multiqc/1.22.3--pyhdfd78af_0
```
