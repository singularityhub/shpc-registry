...
updated_at: "2026-04-28 06:05:23.114598"
latest: "1.34--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/multiqc:1.34--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/multiqc/1.34--pyhdfd78af_0
$ module help quay.io/biocontainers/multiqc/1.34--pyhdfd78af_0
```
