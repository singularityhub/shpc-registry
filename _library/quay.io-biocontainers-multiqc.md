...
updated_at: "2024-06-05 02:47:23.823500"
latest: "1.22.1--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/multiqc:1.22.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/multiqc/1.22.1--pyhdfd78af_0
$ module help quay.io/biocontainers/multiqc/1.22.1--pyhdfd78af_0
```
