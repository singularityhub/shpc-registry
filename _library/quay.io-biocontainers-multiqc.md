...
updated_at: "2024-08-15 03:30:35.355971"
latest: "1.23--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/multiqc:1.23--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/multiqc/1.23--pyhdfd78af_0
$ module help quay.io/biocontainers/multiqc/1.23--pyhdfd78af_0
```
