...
updated_at: "2025-03-18 03:25:31.200753"
latest: "1.27.1--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/multiqc:1.27.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/multiqc/1.27.1--pyhdfd78af_0
$ module help quay.io/biocontainers/multiqc/1.27.1--pyhdfd78af_0
```
