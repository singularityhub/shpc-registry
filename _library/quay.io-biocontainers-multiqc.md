...
updated_at: "2024-12-08 03:29:05.680865"
latest: "1.25.2--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/multiqc:1.25.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/multiqc/1.25.2--pyhdfd78af_0
$ module help quay.io/biocontainers/multiqc/1.25.2--pyhdfd78af_0
```
