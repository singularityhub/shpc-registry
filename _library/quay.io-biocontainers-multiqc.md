...
updated_at: "2025-01-08 02:52:25.702494"
latest: "1.26--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/multiqc:1.26--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/multiqc/1.26--pyhdfd78af_0
$ module help quay.io/biocontainers/multiqc/1.26--pyhdfd78af_0
```
