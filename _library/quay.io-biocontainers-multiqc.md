...
updated_at: "2025-01-30 03:27:00.764553"
latest: "1.27--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/multiqc:1.27--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/multiqc/1.27--pyhdfd78af_0
$ module help quay.io/biocontainers/multiqc/1.27--pyhdfd78af_0
```
