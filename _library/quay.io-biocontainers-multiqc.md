...
updated_at: "2025-04-20 03:36:27.761150"
latest: "1.28--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/multiqc:1.28--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/multiqc/1.28--pyhdfd78af_0
$ module help quay.io/biocontainers/multiqc/1.28--pyhdfd78af_0
```
