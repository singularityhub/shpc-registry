...
updated_at: "2024-05-23 02:44:36.237707"
latest: "1.21--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/multiqc:1.21--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/multiqc/1.21--pyhdfd78af_0
$ module help quay.io/biocontainers/multiqc/1.21--pyhdfd78af_0
```
