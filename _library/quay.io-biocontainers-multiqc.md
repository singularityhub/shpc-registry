...
updated_at: "2026-02-02 12:25:37.897250"
latest: "1.33--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/multiqc:1.33--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/multiqc/1.33--pyhdfd78af_0
$ module help quay.io/biocontainers/multiqc/1.33--pyhdfd78af_0
```
