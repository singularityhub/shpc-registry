...
updated_at: "2025-07-31 04:22:50.101154"
latest: "1.30--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/multiqc:1.30--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/multiqc/1.30--pyhdfd78af_0
$ module help quay.io/biocontainers/multiqc/1.30--pyhdfd78af_0
```
