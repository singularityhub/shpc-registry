...
updated_at: "2025-11-28 03:32:59.710836"
...
```bash
$ shpc install quay.io/biocontainers/multiqc:1.32--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/multiqc/1.32--pyhdfd78af_1
$ module help quay.io/biocontainers/multiqc/1.32--pyhdfd78af_1
```
