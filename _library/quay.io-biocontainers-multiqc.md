...
updated_at: "2026-09-26 07:18:01.356150"
latest: "1.35--pyhdfd78af_2"
...
```bash
$ shpc install quay.io/biocontainers/multiqc:1.35--pyhdfd78af_2
```
...
```bash
$ module load quay.io/biocontainers/multiqc/1.35--pyhdfd78af_2
$ module help quay.io/biocontainers/multiqc/1.35--pyhdfd78af_2
```
