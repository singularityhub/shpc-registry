...
updated_at: "2024-10-23 03:11:04.027611"
latest: "1.25--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/multiqc:1.25--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/multiqc/1.25--pyhdfd78af_0
$ module help quay.io/biocontainers/multiqc/1.25--pyhdfd78af_0
```
