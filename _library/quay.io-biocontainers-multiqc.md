...
updated_at: "2024-11-22 03:18:12.187637"
latest: "1.25.1--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/multiqc:1.25.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/multiqc/1.25.1--pyhdfd78af_0
$ module help quay.io/biocontainers/multiqc/1.25.1--pyhdfd78af_0
```
