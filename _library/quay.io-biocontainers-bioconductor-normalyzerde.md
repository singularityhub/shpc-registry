...
updated_at: "2022-11-03 01:34:24.262661"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-normalyzerde:1.8.0--r40hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-normalyzerde/1.8.0--r40hdfd78af_1
$ module help quay.io/biocontainers/bioconductor-normalyzerde/1.8.0--r40hdfd78af_1
```
