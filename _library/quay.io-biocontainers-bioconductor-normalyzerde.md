...
updated_at: "2026-03-17 04:51:22.513170"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-normalyzerde:1.28.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-normalyzerde/1.28.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-normalyzerde/1.28.0--r45hdfd78af_0
```
