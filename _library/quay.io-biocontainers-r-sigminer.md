...
updated_at: "2024-07-03 02:55:35.973512"
latest: "2.3.1--r43h21a89ab_0"
...
```bash
$ shpc install quay.io/biocontainers/r-sigminer:2.3.1--r43h21a89ab_0
```
...
```bash
$ module load quay.io/biocontainers/r-sigminer/2.3.1--r43h21a89ab_0
$ module help quay.io/biocontainers/r-sigminer/2.3.1--r43h21a89ab_0
```
