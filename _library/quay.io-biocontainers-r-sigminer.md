...
updated_at: "2024-05-13 03:30:11.699656"
latest: "2.3.0--r43h21a89ab_0"
...
```bash
$ shpc install quay.io/biocontainers/r-sigminer:2.3.0--r43h21a89ab_0
```
...
```bash
$ module load quay.io/biocontainers/r-sigminer/2.3.0--r43h21a89ab_0
$ module help quay.io/biocontainers/r-sigminer/2.3.0--r43h21a89ab_0
```
