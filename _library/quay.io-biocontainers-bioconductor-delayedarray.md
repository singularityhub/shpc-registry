...
updated_at: "2025-02-10 03:37:40.153608"
latest: "0.32.0--r44h3df3fcb_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-delayedarray:0.32.0--r44h3df3fcb_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-delayedarray/0.32.0--r44h3df3fcb_0
$ module help quay.io/biocontainers/bioconductor-delayedarray/0.32.0--r44h3df3fcb_0
```
