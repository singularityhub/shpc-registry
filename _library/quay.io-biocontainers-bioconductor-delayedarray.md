...
updated_at: "2026-09-20 08:18:16.068904"
latest: "0.36.1--r45h262fe30_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-delayedarray:0.36.1--r45h262fe30_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-delayedarray/0.36.1--r45h262fe30_0
$ module help quay.io/biocontainers/bioconductor-delayedarray/0.36.1--r45h262fe30_0
```
