---
layout: container
name:  "quay.io/biocontainers/bioconductor-dreamlet"
maintainer: "@vsoch"
...
updated_at: "2026-01-05 04:44:04.811828"
...
singularity registry hpc automated addition for bioconductor-dreamlet
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/bioconductor-dreamlet
```
...
#### bioconductor-dreamlet-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-dreamlet-inspect-deffile:
