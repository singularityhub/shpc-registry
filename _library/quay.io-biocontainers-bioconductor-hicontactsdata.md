...
updated_at: "2023-09-16 02:47:59.397701"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hicontactsdata:1.2.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hicontactsdata/1.2.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-hicontactsdata/1.2.0--r43hdfd78af_0
```
