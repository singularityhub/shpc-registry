...
updated_at: "2024-04-16 02:35:47.506125"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hicontactsdata:1.4.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hicontactsdata/1.4.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-hicontactsdata/1.4.0--r43hdfd78af_0
```
