...
updated_at: "2025-05-19 04:05:06.423425"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hicontactsdata:1.8.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hicontactsdata/1.8.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-hicontactsdata/1.8.0--r44hdfd78af_0
```
