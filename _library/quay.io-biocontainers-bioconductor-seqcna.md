...
updated_at: "2024-07-11 03:15:51.950076"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-seqcna:1.48.0--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-seqcna/1.48.0--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-seqcna/1.48.0--r43hf17093f_0
```
