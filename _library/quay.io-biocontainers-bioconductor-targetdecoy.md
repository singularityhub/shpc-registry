...
updated_at: "2026-04-05 05:04:36.903116"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-targetdecoy:1.16.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-targetdecoy/1.16.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-targetdecoy/1.16.0--r45hdfd78af_0
```
