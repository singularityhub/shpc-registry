...
updated_at: "2025-05-07 03:16:29.073845"
latest: "2.2.5--py310h1fe012e_4"
...
```bash
$ shpc install quay.io/biocontainers/pyprophet:2.2.5--py310h1fe012e_4
```
...
```bash
$ module load quay.io/biocontainers/pyprophet/2.2.5--py310h1fe012e_4
$ module help quay.io/biocontainers/pyprophet/2.2.5--py310h1fe012e_4
```
