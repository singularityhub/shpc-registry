...
updated_at: "2023-10-04 02:56:47.423375"
latest: "1.1.1--pyhca03a8a_0"
...
```bash
$ shpc install quay.io/biocontainers/tsebra:1.1.1--pyhca03a8a_0
```
...
```bash
$ module load quay.io/biocontainers/tsebra/1.1.1--pyhca03a8a_0
$ module help quay.io/biocontainers/tsebra/1.1.1--pyhca03a8a_0
```
