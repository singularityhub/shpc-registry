...
updated_at: "2026-03-23 05:28:22.231492"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-isoformswitchanalyzer:2.10.0--r45h01b2380_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-isoformswitchanalyzer/2.10.0--r45h01b2380_0
$ module help quay.io/biocontainers/bioconductor-isoformswitchanalyzer/2.10.0--r45h01b2380_0
```
