...
updated_at: "2026-09-04 07:35:42.335960"
latest: "2.12.0--r45hd2fad28_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-isoformswitchanalyzer:2.12.0--r45hd2fad28_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-isoformswitchanalyzer/2.12.0--r45hd2fad28_0
$ module help quay.io/biocontainers/bioconductor-isoformswitchanalyzer/2.12.0--r45hd2fad28_0
```
