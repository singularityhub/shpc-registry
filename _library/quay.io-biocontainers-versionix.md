...
updated_at: "2026-03-27 05:07:28.021999"
latest: "0.99.4--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/versionix:0.99.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/versionix/0.99.4--pyhdfd78af_0
$ module help quay.io/biocontainers/versionix/0.99.4--pyhdfd78af_0
```
