...
updated_at: "2025-12-06 03:51:43.725317"
latest: "0.99.3--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/versionix:0.99.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/versionix/0.99.3--pyhdfd78af_0
$ module help quay.io/biocontainers/versionix/0.99.3--pyhdfd78af_0
```
