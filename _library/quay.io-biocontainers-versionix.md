...
updated_at: "2026-06-21 07:01:02.089329"
latest: "0.99.5--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/versionix:0.99.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/versionix/0.99.5--pyhdfd78af_0
$ module help quay.io/biocontainers/versionix/0.99.5--pyhdfd78af_0
```
