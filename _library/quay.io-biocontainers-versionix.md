...
updated_at: "2024-07-14 02:59:33.386697"
...
```bash
$ shpc install quay.io/biocontainers/versionix:0.2.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/versionix/0.2.4--pyhdfd78af_0
$ module help quay.io/biocontainers/versionix/0.2.4--pyhdfd78af_0
```
