...
updated_at: "2025-03-06 03:53:44.603949"
latest: "0.99.2--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/versionix:0.99.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/versionix/0.99.2--pyhdfd78af_0
$ module help quay.io/biocontainers/versionix/0.99.2--pyhdfd78af_0
```
