...
updated_at: "2024-09-26 03:10:26.000552"
latest: "2.0.0--r43hf17093f_3"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ebseq:2.0.0--r43hf17093f_3
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ebseq/2.0.0--r43hf17093f_3
$ module help quay.io/biocontainers/bioconductor-ebseq/2.0.0--r43hf17093f_3
```
