...
updated_at: "2024-03-29 02:37:56.283300"
latest: "2.2--py310h0dbaff4_0"
...
```bash
$ shpc install quay.io/biocontainers/whatshap:2.2--py310h0dbaff4_0
```
...
```bash
$ module load quay.io/biocontainers/whatshap/2.2--py310h0dbaff4_0
$ module help quay.io/biocontainers/whatshap/2.2--py310h0dbaff4_0
```
