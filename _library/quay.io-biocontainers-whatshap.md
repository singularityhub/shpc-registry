...
updated_at: "2024-04-13 02:49:27.707469"
latest: "2.2--py39h1f90b4d_1"
...
```bash
$ shpc install quay.io/biocontainers/whatshap:2.2--py39h1f90b4d_1
```
...
```bash
$ module load quay.io/biocontainers/whatshap/2.2--py39h1f90b4d_1
$ module help quay.io/biocontainers/whatshap/2.2--py39h1f90b4d_1
```
