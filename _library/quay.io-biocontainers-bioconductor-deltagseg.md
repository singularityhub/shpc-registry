...
updated_at: "2026-03-14 04:18:14.239397"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-deltagseg:1.50.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-deltagseg/1.50.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-deltagseg/1.50.0--r45hdfd78af_0
```
