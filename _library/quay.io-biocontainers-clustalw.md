...
updated_at: "2023-05-21 03:02:49.031052"
latest: "2.1--h9f5acd7_8"
...
```bash
$ shpc install quay.io/biocontainers/clustalw:2.1--h9f5acd7_8
```
...
```bash
$ module load quay.io/biocontainers/clustalw/2.1--h9f5acd7_8
$ module help quay.io/biocontainers/clustalw/2.1--h9f5acd7_8
```
