...
updated_at: "2026-08-21 15:59:09.523575"
latest: "2.1--hc52dbad_13"
...
```bash
$ shpc install quay.io/biocontainers/clustalw:2.1--hc52dbad_13
```
...
```bash
$ module load quay.io/biocontainers/clustalw/2.1--hc52dbad_13
$ module help quay.io/biocontainers/clustalw/2.1--hc52dbad_13
```
