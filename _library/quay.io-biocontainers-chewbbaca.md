...
updated_at: "2024-11-18 16:53:08.306212"
latest: "3.3.10--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/chewbbaca:3.3.10--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/chewbbaca/3.3.10--pyhdfd78af_0
$ module help quay.io/biocontainers/chewbbaca/3.3.10--pyhdfd78af_0
```
