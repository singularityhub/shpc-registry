...
updated_at: "2026-04-03 15:47:30.577734"
latest: "3.5.3--pyh106432d_1"
...
```bash
$ shpc install quay.io/biocontainers/chewbbaca:3.5.3--pyh106432d_1
```
...
```bash
$ module load quay.io/biocontainers/chewbbaca/3.5.3--pyh106432d_1
$ module help quay.io/biocontainers/chewbbaca/3.5.3--pyh106432d_1
```
