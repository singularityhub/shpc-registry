...
updated_at: "2024-07-13 03:17:06.221334"
...
```bash
$ shpc install quay.io/biocontainers/chewbbaca:3.3.7--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/chewbbaca/3.3.7--pyhdfd78af_0
$ module help quay.io/biocontainers/chewbbaca/3.3.7--pyhdfd78af_0
```
