...
updated_at: "2024-02-22 02:52:20.426440"
...
```bash
$ shpc install quay.io/biocontainers/chewbbaca:3.3.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/chewbbaca/3.3.2--pyhdfd78af_0
$ module help quay.io/biocontainers/chewbbaca/3.3.2--pyhdfd78af_0
```
