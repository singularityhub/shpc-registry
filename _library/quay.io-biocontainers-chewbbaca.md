...
updated_at: "2023-11-30 02:57:12.871517"
latest: "3.3.0--pyhdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/chewbbaca:3.3.0--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/chewbbaca/3.3.0--pyhdfd78af_1
$ module help quay.io/biocontainers/chewbbaca/3.3.0--pyhdfd78af_1
```
