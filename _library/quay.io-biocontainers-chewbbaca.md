...
updated_at: "2024-08-05 03:24:09.706476"
latest: "3.3.9--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/chewbbaca:3.3.9--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/chewbbaca/3.3.9--pyhdfd78af_0
$ module help quay.io/biocontainers/chewbbaca/3.3.9--pyhdfd78af_0
```
