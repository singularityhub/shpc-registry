...
updated_at: "2025-12-05 03:49:23.113218"
...
```bash
$ shpc install quay.io/biocontainers/chewbbaca:3.4.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/chewbbaca/3.4.2--pyhdfd78af_0
$ module help quay.io/biocontainers/chewbbaca/3.4.2--pyhdfd78af_0
```
