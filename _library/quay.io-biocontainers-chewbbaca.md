...
updated_at: "2024-04-11 02:46:33.619704"
...
```bash
$ shpc install quay.io/biocontainers/chewbbaca:3.3.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/chewbbaca/3.3.4--pyhdfd78af_0
$ module help quay.io/biocontainers/chewbbaca/3.3.4--pyhdfd78af_0
```
