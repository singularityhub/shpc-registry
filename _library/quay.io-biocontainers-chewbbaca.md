...
updated_at: "2024-01-23 02:48:38.571796"
...
```bash
$ shpc install quay.io/biocontainers/chewbbaca:3.3.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/chewbbaca/3.3.1--pyhdfd78af_0
$ module help quay.io/biocontainers/chewbbaca/3.3.1--pyhdfd78af_0
```
