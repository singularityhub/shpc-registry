...
updated_at: "2026-06-18 07:35:58.924064"
...
```bash
$ shpc install quay.io/biocontainers/chewbbaca:3.5.4--pyh106432d_0
```
...
```bash
$ module load quay.io/biocontainers/chewbbaca/3.5.4--pyh106432d_0
$ module help quay.io/biocontainers/chewbbaca/3.5.4--pyh106432d_0
```
