...
updated_at: "2026-01-17 03:53:19.288254"
...
```bash
$ shpc install quay.io/biocontainers/chewbbaca:3.5.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/chewbbaca/3.5.0--pyhdfd78af_0
$ module help quay.io/biocontainers/chewbbaca/3.5.0--pyhdfd78af_0
```
