...
updated_at: "2024-03-06 02:54:59.102994"
...
```bash
$ shpc install quay.io/biocontainers/bed2gff:0.1.3--h4ac6f70_0
```
...
```bash
$ module load quay.io/biocontainers/bed2gff/0.1.3--h4ac6f70_0
$ module help quay.io/biocontainers/bed2gff/0.1.3--h4ac6f70_0
```
