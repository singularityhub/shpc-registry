...
updated_at: "2024-12-11 03:26:03.488573"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mmdiff2:1.30.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mmdiff2/1.30.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-mmdiff2/1.30.0--r43hdfd78af_0
```
