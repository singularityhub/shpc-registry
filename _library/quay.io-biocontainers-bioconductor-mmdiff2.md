...
updated_at: "2026-04-04 05:01:38.540689"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mmdiff2:1.38.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mmdiff2/1.38.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-mmdiff2/1.38.0--r45hdfd78af_0
```
