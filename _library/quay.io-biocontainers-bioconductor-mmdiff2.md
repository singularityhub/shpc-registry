...
updated_at: "2022-11-02 19:39:03.822180"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mmdiff2:1.8.0--r341_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mmdiff2/1.8.0--r341_0
$ module help quay.io/biocontainers/bioconductor-mmdiff2/1.8.0--r341_0
```
