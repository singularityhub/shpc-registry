...
updated_at: "2022-11-27 13:07:15.751523"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mmdiff2:1.22.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mmdiff2/1.22.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-mmdiff2/1.22.0--r41hdfd78af_0
```
