...
updated_at: "2025-01-03 03:33:46.818634"
latest: "0.7.3--r44hdfd78af_2"
...
```bash
$ shpc install quay.io/biocontainers/r-acidbase:0.7.3--r44hdfd78af_2
```
...
```bash
$ module load quay.io/biocontainers/r-acidbase/0.7.3--r44hdfd78af_2
$ module help quay.io/biocontainers/r-acidbase/0.7.3--r44hdfd78af_2
```
