...
updated_at: "2026-07-25 07:25:04.230815"
latest: "0.7.7--r45hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/r-acidbase:0.7.7--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/r-acidbase/0.7.7--r45hdfd78af_0
$ module help quay.io/biocontainers/r-acidbase/0.7.7--r45hdfd78af_0
```
