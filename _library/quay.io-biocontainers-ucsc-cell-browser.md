...
updated_at: "2025-05-13 03:17:41.645005"
...
```bash
$ shpc install quay.io/biocontainers/ucsc-cell-browser:1.2.14--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ucsc-cell-browser/1.2.14--pyhdfd78af_0
$ module help quay.io/biocontainers/ucsc-cell-browser/1.2.14--pyhdfd78af_0
```
