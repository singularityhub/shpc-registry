...
updated_at: "2024-08-19 03:13:06.942494"
...
```bash
$ shpc install quay.io/biocontainers/ucsc-cell-browser:1.2.8--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ucsc-cell-browser/1.2.8--pyhdfd78af_0
$ module help quay.io/biocontainers/ucsc-cell-browser/1.2.8--pyhdfd78af_0
```
