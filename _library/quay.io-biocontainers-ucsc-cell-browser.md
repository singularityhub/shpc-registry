...
updated_at: "2025-04-13 04:13:56.715837"
...
```bash
$ shpc install quay.io/biocontainers/ucsc-cell-browser:1.2.12--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ucsc-cell-browser/1.2.12--pyhdfd78af_0
$ module help quay.io/biocontainers/ucsc-cell-browser/1.2.12--pyhdfd78af_0
```
