...
updated_at: "2024-07-07 03:18:01.534235"
...
```bash
$ shpc install quay.io/biocontainers/ucsc-cell-browser:1.2.6--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ucsc-cell-browser/1.2.6--pyhdfd78af_0
$ module help quay.io/biocontainers/ucsc-cell-browser/1.2.6--pyhdfd78af_0
```
