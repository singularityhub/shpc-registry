...
updated_at: "2026-08-28 14:03:24.787873"
...
```bash
$ shpc install quay.io/biocontainers/ucsc-cell-browser:1.2.20--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ucsc-cell-browser/1.2.20--pyhdfd78af_0
$ module help quay.io/biocontainers/ucsc-cell-browser/1.2.20--pyhdfd78af_0
```
