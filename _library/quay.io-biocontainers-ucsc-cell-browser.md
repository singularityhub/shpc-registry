...
updated_at: "2023-04-26 02:42:21.709618"
...
```bash
$ shpc install quay.io/biocontainers/ucsc-cell-browser:1.2.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ucsc-cell-browser/1.2.2--pyhdfd78af_0
$ module help quay.io/biocontainers/ucsc-cell-browser/1.2.2--pyhdfd78af_0
```
