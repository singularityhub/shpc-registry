...
updated_at: "2026-07-02 06:37:16.352624"
latest: "1.2.19.1--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/ucsc-cell-browser:1.2.19.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ucsc-cell-browser/1.2.19.1--pyhdfd78af_0
$ module help quay.io/biocontainers/ucsc-cell-browser/1.2.19.1--pyhdfd78af_0
```
