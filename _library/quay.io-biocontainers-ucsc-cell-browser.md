...
updated_at: "2024-03-03 02:27:29.824494"
...
```bash
$ shpc install quay.io/biocontainers/ucsc-cell-browser:1.2.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ucsc-cell-browser/1.2.4--pyhdfd78af_0
$ module help quay.io/biocontainers/ucsc-cell-browser/1.2.4--pyhdfd78af_0
```
