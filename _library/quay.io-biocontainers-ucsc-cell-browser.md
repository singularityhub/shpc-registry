...
updated_at: "2026-07-28 05:53:10.742210"
latest: "1.2.19.2--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/ucsc-cell-browser:1.2.19.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ucsc-cell-browser/1.2.19.2--pyhdfd78af_0
$ module help quay.io/biocontainers/ucsc-cell-browser/1.2.19.2--pyhdfd78af_0
```
