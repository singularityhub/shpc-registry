...
updated_at: "2024-03-21 04:14:11.212979"
...
```bash
$ shpc install quay.io/biocontainers/ucsc-cell-browser:1.2.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ucsc-cell-browser/1.2.5--pyhdfd78af_0
$ module help quay.io/biocontainers/ucsc-cell-browser/1.2.5--pyhdfd78af_0
```
