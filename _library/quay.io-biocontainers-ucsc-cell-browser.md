...
updated_at: "2026-05-27 06:55:32.754615"
latest: "1.2.17.3--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/ucsc-cell-browser:1.2.17.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ucsc-cell-browser/1.2.17.3--pyhdfd78af_0
$ module help quay.io/biocontainers/ucsc-cell-browser/1.2.17.3--pyhdfd78af_0
```
