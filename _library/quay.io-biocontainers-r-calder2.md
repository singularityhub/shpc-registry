...
updated_at: "2022-11-21 13:56:11.074634"
...
```bash
$ shpc install quay.io/biocontainers/r-calder2:0.3--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/r-calder2/0.3--r41hdfd78af_0
$ module help quay.io/biocontainers/r-calder2/0.3--r41hdfd78af_0
```
