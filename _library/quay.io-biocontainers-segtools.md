...
updated_at: "2024-11-04 08:29:40.459300"
...
```bash
$ shpc install quay.io/biocontainers/segtools:1.3.0--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/segtools/1.3.0--pyh7cba7a3_0
$ module help quay.io/biocontainers/segtools/1.3.0--pyh7cba7a3_0
```
