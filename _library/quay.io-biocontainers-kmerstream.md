...
updated_at: "2025-10-04 03:05:26.579263"
...
```bash
$ shpc install quay.io/biocontainers/kmerstream:1.1--h077b44d_6
```
...
```bash
$ module load quay.io/biocontainers/kmerstream/1.1--h077b44d_6
$ module help quay.io/biocontainers/kmerstream/1.1--h077b44d_6
```
