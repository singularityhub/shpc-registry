...
updated_at: "2023-12-14 02:36:33.492912"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cntools:1.56.0--r43ha9d7317_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cntools/1.56.0--r43ha9d7317_0
$ module help quay.io/biocontainers/bioconductor-cntools/1.56.0--r43ha9d7317_0
```
