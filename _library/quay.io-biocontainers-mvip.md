...
updated_at: "2024-12-08 03:19:18.820183"
...
```bash
$ shpc install quay.io/biocontainers/mvip:1.1.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mvip/1.1.5--pyhdfd78af_0
$ module help quay.io/biocontainers/mvip/1.1.5--pyhdfd78af_0
```
