...
updated_at: "2024-09-23 15:22:49.594913"
...
```bash
$ shpc install quay.io/biocontainers/mvip:1.1.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mvip/1.1.4--pyhdfd78af_0
$ module help quay.io/biocontainers/mvip/1.1.4--pyhdfd78af_0
```
