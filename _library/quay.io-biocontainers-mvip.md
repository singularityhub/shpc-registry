...
updated_at: "2024-08-27 06:30:45.717963"
...
```bash
$ shpc install quay.io/biocontainers/mvip:1.1.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mvip/1.1.2--pyhdfd78af_0
$ module help quay.io/biocontainers/mvip/1.1.2--pyhdfd78af_0
```
