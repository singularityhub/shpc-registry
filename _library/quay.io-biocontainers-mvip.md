...
updated_at: "2024-07-05 02:39:15.736004"
...
```bash
$ shpc install quay.io/biocontainers/mvip:1.0.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mvip/1.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/mvip/1.0.0--pyhdfd78af_0
```
