...
updated_at: "2026-04-05 05:15:48.968766"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-scdd:1.34.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-scdd/1.34.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-scdd/1.34.0--r45hdfd78af_0
```
