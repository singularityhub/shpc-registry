...
updated_at: "2022-10-29 05:43:06.489277"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-iterativebmasurv:1.52.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-iterativebmasurv/1.52.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-iterativebmasurv/1.52.0--r41hdfd78af_0
```
