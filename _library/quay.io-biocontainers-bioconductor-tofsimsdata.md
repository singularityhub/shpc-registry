...
updated_at: "2025-08-28 03:52:05.660831"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-tofsimsdata:1.34.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-tofsimsdata/1.34.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-tofsimsdata/1.34.0--r44hdfd78af_0
```
