...
updated_at: "2026-04-04 04:57:44.144631"
...
```bash
$ shpc install quay.io/biocontainers/epicore:0.1.8--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/epicore/0.1.8--pyhdfd78af_0
$ module help quay.io/biocontainers/epicore/0.1.8--pyhdfd78af_0
```
