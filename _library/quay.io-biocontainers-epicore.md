...
updated_at: "2025-05-24 11:29:47.002762"
...
```bash
$ shpc install quay.io/biocontainers/epicore:0.1.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/epicore/0.1.3--pyhdfd78af_0
$ module help quay.io/biocontainers/epicore/0.1.3--pyhdfd78af_0
```
