...
updated_at: "2025-11-22 03:31:48.762519"
...
```bash
$ shpc install quay.io/biocontainers/epicore:0.1.7--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/epicore/0.1.7--pyhdfd78af_0
$ module help quay.io/biocontainers/epicore/0.1.7--pyhdfd78af_0
```
