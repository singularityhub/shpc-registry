...
updated_at: "2026-05-24 06:26:35.564865"
...
```bash
$ shpc install quay.io/biocontainers/epicore:1.0.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/epicore/1.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/epicore/1.0.0--pyhdfd78af_0
```
