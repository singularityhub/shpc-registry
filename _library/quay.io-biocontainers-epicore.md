---
layout: container
name:  "quay.io/biocontainers/epicore"
maintainer: "@vsoch"
...
updated_at: "2026-06-28 07:08:32.111968"
...
```bash
$ module load quay.io/biocontainers/epicore/1.0.1--pyhdfd78af_0
$ module help quay.io/biocontainers/epicore/1.0.1--pyhdfd78af_0
```
...
#### epicore-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### epicore-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/epicore
$ podman run --it --rm --entrypoint /usr/local/bin/epicore   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/epicore   -v ${PWD} -w ${PWD} <container> -c " $@"
```
