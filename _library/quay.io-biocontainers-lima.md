...
updated_at: "2026-06-30 06:47:01.852186"
...
```bash
$ shpc install quay.io/biocontainers/lima:26.2.1--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/lima/26.2.1--h9ee0642_0
$ module help quay.io/biocontainers/lima/26.2.1--h9ee0642_0
```
