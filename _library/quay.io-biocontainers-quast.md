...
updated_at: "2024-12-18 03:19:24.881101"
latest: "5.3.0--py39pl5321heaaa4ec_0"
...
```bash
$ shpc install quay.io/biocontainers/quast:5.3.0--py39pl5321heaaa4ec_0
```
...
```bash
$ module load quay.io/biocontainers/quast/5.3.0--py39pl5321heaaa4ec_0
$ module help quay.io/biocontainers/quast/5.3.0--py39pl5321heaaa4ec_0
```
