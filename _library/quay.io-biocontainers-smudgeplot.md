...
updated_at: "2024-07-02 02:39:46.633911"
...
```bash
$ shpc install quay.io/biocontainers/smudgeplot:0.2.5--py311r43hdad781d_4
```
...
```bash
$ module load quay.io/biocontainers/smudgeplot/0.2.5--py311r43hdad781d_4
$ module help quay.io/biocontainers/smudgeplot/0.2.5--py311r43hdad781d_4
```
