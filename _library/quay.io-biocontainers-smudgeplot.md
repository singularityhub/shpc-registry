...
updated_at: "2026-01-15 03:56:01.735396"
latest: "0.5.3--py314h577a1d6_0"
...
```bash
$ shpc install quay.io/biocontainers/smudgeplot:0.5.3--py314h577a1d6_0
```
...
```bash
$ module load quay.io/biocontainers/smudgeplot/0.5.3--py314h577a1d6_0
$ module help quay.io/biocontainers/smudgeplot/0.5.3--py314h577a1d6_0
```
