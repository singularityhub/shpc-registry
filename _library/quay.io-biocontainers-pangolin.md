...
updated_at: "2025-12-23 03:56:55.709652"
...
```bash
$ shpc install quay.io/biocontainers/pangolin:4.3.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pangolin/4.3.4--pyhdfd78af_0
$ module help quay.io/biocontainers/pangolin/4.3.4--pyhdfd78af_0
```
