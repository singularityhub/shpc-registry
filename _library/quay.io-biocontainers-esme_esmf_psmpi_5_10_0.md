---
layout: container
name:  "quay.io/biocontainers/esme_esmf_psmpi_5_10_0"
maintainer: "@vsoch"
github: "https://github.com/singularityhub/shpc-registry/blob/main/quay.io/biocontainers/esme_esmf_psmpi_5_10_0/container.yaml"
config_url: "https://raw.githubusercontent.com/singularityhub/shpc-registry/main/quay.io/biocontainers/esme_esmf_psmpi_5_10_0/container.yaml"
updated_at: "2025-11-07 03:41:27.413583"
latest: "8.8.0--ha6a134a_0"
container_url: "https://biocontainers.pro/tools/esme_esmf_psmpi_5_10_0"
aliases:
 - "ESMF_PrintInfo"
 - "ESMF_PrintInfoC"
 - "ESMF_Regrid"
...
versions:
 - "8.8.0--ha6a134a_0"
description: "singularity registry hpc automated addition for esme_esmf_psmpi_5_10_0"
config: {"url": "https://biocontainers.pro/tools/esme_esmf_psmpi_5_10_0", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for esme_esmf_psmpi_5_10_0", "latest": {"8.8.0--ha6a134a_0": "sha256:8e120010f0e657fc178ecc9cfb542fe92517632ecebe77de020a3fbd6a882261"}, "tags": {"8.8.0--ha6a134a_0": "sha256:8e120010f0e657fc178ecc9cfb542fe92517632ecebe77de020a3fbd6a882261"}, "docker": "quay.io/biocontainers/esme_esmf_psmpi_5_10_0", "aliases": {"ESMF_PrintInfo": "/usr/local/bin/ESMF_PrintInfo", "ESMF_PrintInfoC": "/usr/local/bin/ESMF_PrintInfoC", "ESMF_Regrid": "/usr/local/bin/ESMF_Regrid", "ESMF_RegridWeightGen": "/usr/local/bin/ESMF_RegridWeightGen", "ESMF_Scrip2Unstruct": "/usr/local/bin/ESMF_Scrip2Unstruct", "ESMF_WebServController": "/usr/local/bin/ESMF_WebServController", "ESMX_Builder": "/usr/local/bin/ESMX_Builder", "nc4print": "/usr/local/bin/nc4print", "ocprint": "/usr/local/bin/ocprint", "chacl": "/usr/local/bin/chacl", "getfacl": "/usr/local/bin/getfacl", "setfacl": "/usr/local/bin/setfacl", "cdfdiff": "/usr/local/bin/cdfdiff", "ncmpidiff": "/usr/local/bin/ncmpidiff", "ncmpidump": "/usr/local/bin/ncmpidump", "ncmpigen": "/usr/local/bin/ncmpigen", "ncoffsets": "/usr/local/bin/ncoffsets", "ncvalidator": "/usr/local/bin/ncvalidator", "pnetcdf-config": "/usr/local/bin/pnetcdf-config", "pnetcdf_version": "/usr/local/bin/pnetcdf_version", "h5pcc": "/usr/local/bin/h5pcc", "h5perf": "/usr/local/bin/h5perf", "h5pfc": "/usr/local/bin/h5pfc", "ph5diff": "/usr/local/bin/ph5diff", "h5fuse": "/usr/local/bin/h5fuse", "nf-config": "/usr/local/bin/nf-config", "ucx_perftest_daemon": "/usr/local/bin/ucx_perftest_daemon", "mpichversion": "/usr/local/bin/mpichversion", "mpivars": "/usr/local/bin/mpivars", "genl-ctrl-list": "/usr/local/bin/genl-ctrl-list", "idiag-socket-details": "/usr/local/bin/idiag-socket-details", "nf-ct-add": "/usr/local/bin/nf-ct-add"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/esme_esmf_psmpi_5_10_0.
singularity registry hpc automated addition for esme_esmf_psmpi_5_10_0
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/esme_esmf_psmpi_5_10_0
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/esme_esmf_psmpi_5_10_0:8.8.0--ha6a134a_0
```
...
```bash
$ module load quay.io/biocontainers/esme_esmf_psmpi_5_10_0/8.8.0--ha6a134a_0
$ module help quay.io/biocontainers/esme_esmf_psmpi_5_10_0/8.8.0--ha6a134a_0
```
...
#### esme_esmf_psmpi_5_10_0-inspect:
...
#### esme_esmf_psmpi_5_10_0-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### esme_esmf_psmpi_5_10_0-inspect-deffile:
