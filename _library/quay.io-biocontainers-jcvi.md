...
updated_at: "2025-05-27 12:31:10.457830"
latest: "1.5.4--py310h20b60a1_0"
...
```bash
$ shpc install quay.io/biocontainers/jcvi:1.5.4--py310h20b60a1_0
```
...
```bash
$ module load quay.io/biocontainers/jcvi/1.5.4--py310h20b60a1_0
$ module help quay.io/biocontainers/jcvi/1.5.4--py310h20b60a1_0
```
