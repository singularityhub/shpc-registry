...
updated_at: "2026-01-14 03:51:52.023575"
latest: "1.5.11--py310h20b60a1_0"
...
```bash
$ shpc install quay.io/biocontainers/jcvi:1.5.11--py310h20b60a1_0
```
...
```bash
$ module load quay.io/biocontainers/jcvi/1.5.11--py310h20b60a1_0
$ module help quay.io/biocontainers/jcvi/1.5.11--py310h20b60a1_0
```
