...
updated_at: "2025-12-19 03:27:48.324995"
latest: "1.5.8--py311h93dcfea_0"
...
```bash
$ shpc install quay.io/biocontainers/jcvi:1.5.8--py311h93dcfea_0
```
...
```bash
$ module load quay.io/biocontainers/jcvi/1.5.8--py311h93dcfea_0
$ module help quay.io/biocontainers/jcvi/1.5.8--py311h93dcfea_0
```
