...
updated_at: "2026-06-24 06:33:46.156810"
...
```bash
$ shpc install quay.io/biocontainers/jcvi:1.6.6--py310h3479294_0
```
...
```bash
$ module load quay.io/biocontainers/jcvi/1.6.6--py310h3479294_0
$ module help quay.io/biocontainers/jcvi/1.6.6--py310h3479294_0
```
