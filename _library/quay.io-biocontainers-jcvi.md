...
updated_at: "2025-08-28 12:15:29.403438"
latest: "1.5.6--py39hff726c5_0"
...
```bash
$ shpc install quay.io/biocontainers/jcvi:1.5.6--py39hff726c5_0
```
...
```bash
$ module load quay.io/biocontainers/jcvi/1.5.6--py39hff726c5_0
$ module help quay.io/biocontainers/jcvi/1.5.6--py39hff726c5_0
```
