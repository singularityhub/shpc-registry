...
updated_at: "2026-09-23 07:31:08.382884"
...
```bash
$ shpc install quay.io/biocontainers/jcvi:1.6.7--py312hfcd9dac_0
```
...
```bash
$ module load quay.io/biocontainers/jcvi/1.6.7--py312hfcd9dac_0
$ module help quay.io/biocontainers/jcvi/1.6.7--py312hfcd9dac_0
```
