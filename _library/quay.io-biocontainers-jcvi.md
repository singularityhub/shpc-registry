...
updated_at: "2025-09-26 03:03:02.785183"
latest: "1.5.7--py310h20b60a1_0"
...
```bash
$ shpc install quay.io/biocontainers/jcvi:1.5.7--py310h20b60a1_0
```
...
```bash
$ module load quay.io/biocontainers/jcvi/1.5.7--py310h20b60a1_0
$ module help quay.io/biocontainers/jcvi/1.5.7--py310h20b60a1_0
```
