...
updated_at: "2023-07-15 03:30:11.399734"
...
```bash
$ shpc install quay.io/biocontainers/t1dgrs2:0.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/t1dgrs2/0.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/t1dgrs2/0.1.0--pyhdfd78af_0
```
