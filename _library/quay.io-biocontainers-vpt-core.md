...
updated_at: "2025-05-20 03:17:07.294875"
...
```bash
$ shpc install quay.io/biocontainers/vpt-core:1.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/vpt-core/1.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/vpt-core/1.2.0--pyhdfd78af_0
```
