---
layout: container
name:  "quay.io/biocontainers/regional"
maintainer: "@vsoch"
...
updated_at: "2023-08-19 02:43:32.929525"
...
versions:
 - "1.1.2--pyh864c0ab_1"
description: "shpc-registry automated BioContainers addition for regional"
config: {"url": "https://biocontainers.pro/tools/regional", "maintainer": "@vsoch", "description": "shpc-registry automated BioContainers addition for regional", "latest": {"1.1.2--pyh864c0ab_1": "sha256:4abc0cddb46e39197371bfd5edd865103d1f38a90a8aa399bd34b5ca98d2ca6e"}, "tags": {"1.1.2--pyh864c0ab_1": "sha256:4abc0cddb46e39197371bfd5edd865103d1f38a90a8aa399bd34b5ca98d2ca6e"}, "docker": "quay.io/biocontainers/regional", "aliases": {"f2py3.8": "/usr/local/bin/f2py3.8", "2to3-3.8": "/usr/local/bin/2to3-3.8", "idle3.8": "/usr/local/bin/idle3.8", "pydoc3.8": "/usr/local/bin/pydoc3.8", "python3.8": "/usr/local/bin/python3.8", "python3.8-config": "/usr/local/bin/python3.8-config", "jpgicc": "/usr/local/bin/jpgicc", "linkicc": "/usr/local/bin/linkicc", "psicc": "/usr/local/bin/psicc", "tificc": "/usr/local/bin/tificc"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/regional.
shpc-registry automated BioContainers addition for regional
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/regional
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/regional:1.1.2--pyh864c0ab_1
```
...
```bash
$ module load quay.io/biocontainers/regional/1.1.2--pyh864c0ab_1
$ module help quay.io/biocontainers/regional/1.1.2--pyh864c0ab_1
```
...
#### regional-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### regional-inspect-deffile:
