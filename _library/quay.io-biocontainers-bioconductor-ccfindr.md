...
updated_at: "2026-03-27 04:40:55.283656"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ccfindr:1.30.0--r45ha27e39d_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ccfindr/1.30.0--r45ha27e39d_0
$ module help quay.io/biocontainers/bioconductor-ccfindr/1.30.0--r45ha27e39d_0
```
