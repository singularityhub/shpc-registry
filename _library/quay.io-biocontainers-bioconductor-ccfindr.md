...
updated_at: "2022-11-13 00:24:00.650839"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ccfindr:1.8.0--r40h5f743cb_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ccfindr/1.8.0--r40h5f743cb_0
$ module help quay.io/biocontainers/bioconductor-ccfindr/1.8.0--r40h5f743cb_0
```
