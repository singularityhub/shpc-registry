...
updated_at: "2023-06-12 03:38:06.063272"
latest: "2.1.6.1--hec16e2b_2"
...
```bash
$ shpc install quay.io/biocontainers/fastme:2.1.6.1--hec16e2b_2
```
...
```bash
$ module load quay.io/biocontainers/fastme/2.1.6.1--hec16e2b_2
$ module help quay.io/biocontainers/fastme/2.1.6.1--hec16e2b_2
```
