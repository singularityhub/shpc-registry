...
updated_at: "2024-07-15 03:59:11.650328"
...
```bash
$ shpc install quay.io/biocontainers/haptools:0.4.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/haptools/0.4.2--pyhdfd78af_0
$ module help quay.io/biocontainers/haptools/0.4.2--pyhdfd78af_0
```
