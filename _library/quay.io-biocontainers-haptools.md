...
updated_at: "2024-01-18 03:04:16.057303"
...
```bash
$ shpc install quay.io/biocontainers/haptools:0.4.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/haptools/0.4.0--pyhdfd78af_0
$ module help quay.io/biocontainers/haptools/0.4.0--pyhdfd78af_0
```
