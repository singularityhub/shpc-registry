...
updated_at: "2025-09-15 03:25:58.412134"
...
```bash
$ shpc install quay.io/biocontainers/haptools:0.5.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/haptools/0.5.0--pyhdfd78af_0
$ module help quay.io/biocontainers/haptools/0.5.0--pyhdfd78af_0
```
