...
updated_at: "2026-01-28 03:53:14.682760"
...
```bash
$ shpc install quay.io/biocontainers/haptools:0.6.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/haptools/0.6.2--pyhdfd78af_0
$ module help quay.io/biocontainers/haptools/0.6.2--pyhdfd78af_0
```
