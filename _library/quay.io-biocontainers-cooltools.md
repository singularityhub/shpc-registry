...
updated_at: "2024-10-25 03:42:09.064887"
latest: "0.7.0--py311h1abe8b6_2"
...
```bash
$ shpc install quay.io/biocontainers/cooltools:0.7.0--py311h1abe8b6_2
```
...
```bash
$ module load quay.io/biocontainers/cooltools/0.7.0--py311h1abe8b6_2
$ module help quay.io/biocontainers/cooltools/0.7.0--py311h1abe8b6_2
```
