...
updated_at: "2025-01-05 03:18:36.856268"
latest: "0.7.1--py311h1abe8b6_0"
...
```bash
$ shpc install quay.io/biocontainers/cooltools:0.7.1--py311h1abe8b6_0
```
...
```bash
$ module load quay.io/biocontainers/cooltools/0.7.1--py311h1abe8b6_0
$ module help quay.io/biocontainers/cooltools/0.7.1--py311h1abe8b6_0
```
