...
updated_at: "2025-01-18 03:03:38.401237"
...
```bash
$ shpc install quay.io/biocontainers/cooltools:0.7.1--py310h20b60a1_1
```
...
```bash
$ module load quay.io/biocontainers/cooltools/0.7.1--py310h20b60a1_1
$ module help quay.io/biocontainers/cooltools/0.7.1--py310h20b60a1_1
```
