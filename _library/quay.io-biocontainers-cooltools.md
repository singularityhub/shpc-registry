...
updated_at: "2025-12-25 04:15:21.381655"
latest: "0.7.1--py311h93dcfea_3"
...
```bash
$ shpc install quay.io/biocontainers/cooltools:0.7.1--py311h93dcfea_3
```
...
```bash
$ module load quay.io/biocontainers/cooltools/0.7.1--py311h93dcfea_3
$ module help quay.io/biocontainers/cooltools/0.7.1--py311h93dcfea_3
```
