...
updated_at: "2024-05-23 02:44:37.083353"
latest: "0.7.0--py310hd6be1da_1"
...
```bash
$ shpc install quay.io/biocontainers/cooltools:0.7.0--py310hd6be1da_1
```
...
```bash
$ module load quay.io/biocontainers/cooltools/0.7.0--py310hd6be1da_1
$ module help quay.io/biocontainers/cooltools/0.7.0--py310hd6be1da_1
```
