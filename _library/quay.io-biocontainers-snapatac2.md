...
updated_at: "2026-03-30 05:37:31.668567"
latest: "2.8.0--py310ha7160b9_2"
...
```bash
$ shpc install quay.io/biocontainers/snapatac2:2.8.0--py310ha7160b9_2
```
...
```bash
$ module load quay.io/biocontainers/snapatac2/2.8.0--py310ha7160b9_2
$ module help quay.io/biocontainers/snapatac2/2.8.0--py310ha7160b9_2
```
