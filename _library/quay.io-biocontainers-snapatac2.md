...
updated_at: "2025-04-21 05:07:23.034908"
...
```bash
$ shpc install quay.io/biocontainers/snapatac2:2.8.0--py310h9e9ef0c_1
```
...
```bash
$ module load quay.io/biocontainers/snapatac2/2.8.0--py310h9e9ef0c_1
$ module help quay.io/biocontainers/snapatac2/2.8.0--py310h9e9ef0c_1
```
