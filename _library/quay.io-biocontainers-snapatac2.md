...
updated_at: "2026-06-01 07:48:30.791687"
latest: "2.9.0--py312h91a5aaa_1"
...
```bash
$ shpc install quay.io/biocontainers/snapatac2:2.9.0--py312h91a5aaa_1
```
...
```bash
$ module load quay.io/biocontainers/snapatac2/2.9.0--py312h91a5aaa_1
$ module help quay.io/biocontainers/snapatac2/2.9.0--py312h91a5aaa_1
```
