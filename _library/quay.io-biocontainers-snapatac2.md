...
updated_at: "2025-01-06 03:28:13.383134"
latest: "2.8.0--py312h98724fc_0"
...
```bash
$ shpc install quay.io/biocontainers/snapatac2:2.8.0--py312h98724fc_0
```
...
```bash
$ module load quay.io/biocontainers/snapatac2/2.8.0--py312h98724fc_0
$ module help quay.io/biocontainers/snapatac2/2.8.0--py312h98724fc_0
```
