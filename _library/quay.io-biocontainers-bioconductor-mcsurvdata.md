...
updated_at: "2024-05-06 04:39:59.464196"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mcsurvdata:1.20.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mcsurvdata/1.20.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-mcsurvdata/1.20.0--r43hdfd78af_0
```
