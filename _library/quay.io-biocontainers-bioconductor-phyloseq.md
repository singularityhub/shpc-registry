...
updated_at: "2022-10-29 05:56:57.618583"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-phyloseq:1.38.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-phyloseq/1.38.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-phyloseq/1.38.0--r41hdfd78af_0
```
