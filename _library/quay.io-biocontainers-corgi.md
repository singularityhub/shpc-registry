...
updated_at: "2025-10-10 03:12:54.433650"
...
```bash
$ shpc install quay.io/biocontainers/corgi:0.4.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/corgi/0.4.3--pyhdfd78af_0
$ module help quay.io/biocontainers/corgi/0.4.3--pyhdfd78af_0
```
