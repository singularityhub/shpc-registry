...
updated_at: "2023-11-22 02:51:53.594151"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-multimodalexperiment:1.0.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-multimodalexperiment/1.0.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-multimodalexperiment/1.0.0--r43hdfd78af_0
```
