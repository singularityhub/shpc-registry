---
layout: container
name:  "quay.io/biocontainers/bioconductor-multimodalexperiment"
maintainer: "@vsoch"
...
updated_at: "2026-04-01 05:26:37.514654"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-multimodalexperiment
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-multimodalexperiment:1.10.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-multimodalexperiment/1.10.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-multimodalexperiment/1.10.0--r45hdfd78af_0
```
...
#### bioconductor-multimodalexperiment-run:
...
#### bioconductor-multimodalexperiment-shell:
...
#### bioconductor-multimodalexperiment-exec:
...
#### bioconductor-multimodalexperiment-inspect:
...
#### bioconductor-multimodalexperiment-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-multimodalexperiment-inspect-deffile:
