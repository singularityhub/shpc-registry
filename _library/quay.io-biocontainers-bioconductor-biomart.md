...
updated_at: "2023-09-17 02:59:55.027615"
latest: "2.56.1--r43hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-biomart:2.56.1--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-biomart/2.56.1--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-biomart/2.56.1--r43hdfd78af_0
```
