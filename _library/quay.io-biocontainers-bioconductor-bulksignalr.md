---
layout: container
name:  "quay.io/biocontainers/bioconductor-bulksignalr"
maintainer: "@vsoch"
...
updated_at: "2026-03-21 04:46:51.944653"
...
singularity registry hpc automated addition for bioconductor-bulksignalr
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/bioconductor-bulksignalr
```
...
#### bioconductor-bulksignalr-shell:
...
#### bioconductor-bulksignalr-inspect:
...
#### bioconductor-bulksignalr-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-bulksignalr-inspect-deffile:
