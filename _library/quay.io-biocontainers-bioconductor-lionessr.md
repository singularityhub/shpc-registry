...
updated_at: "2023-08-23 02:38:00.183998"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-lionessr:1.14.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-lionessr/1.14.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-lionessr/1.14.0--r43hdfd78af_0
```
