...
updated_at: "2022-10-29 18:12:37.063988"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-igc:1.24.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-igc/1.24.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-igc/1.24.0--r41hdfd78af_0
```
