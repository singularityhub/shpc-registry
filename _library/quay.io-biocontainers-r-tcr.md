...
updated_at: "2022-10-29 05:46:09.409048"
latest: "2.3.2--r41hecf12ef_3"
...
```bash
$ shpc install quay.io/biocontainers/r-tcr:2.3.2--r41hecf12ef_3
```
...
```bash
$ module load quay.io/biocontainers/r-tcr/2.3.2--r41hecf12ef_3
$ module help quay.io/biocontainers/r-tcr/2.3.2--r41hecf12ef_3
```
