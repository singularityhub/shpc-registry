...
updated_at: "2024-11-17 03:40:52.335472"
...
```bash
$ shpc install quay.io/biocontainers/snakedeploy:0.10.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakedeploy/0.10.2--pyhdfd78af_0
$ module help quay.io/biocontainers/snakedeploy/0.10.2--pyhdfd78af_0
```
