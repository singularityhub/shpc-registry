...
updated_at: "2025-02-02 03:04:37.378351"
...
```bash
$ shpc install quay.io/biocontainers/snakedeploy:0.10.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakedeploy/0.10.3--pyhdfd78af_0
$ module help quay.io/biocontainers/snakedeploy/0.10.3--pyhdfd78af_0
```
