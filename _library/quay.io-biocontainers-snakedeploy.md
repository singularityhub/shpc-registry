...
updated_at: "2025-08-31 03:36:05.100555"
...
```bash
$ shpc install quay.io/biocontainers/snakedeploy:0.11.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakedeploy/0.11.0--pyhdfd78af_0
$ module help quay.io/biocontainers/snakedeploy/0.11.0--pyhdfd78af_0
```
