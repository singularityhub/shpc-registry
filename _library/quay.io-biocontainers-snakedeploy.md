...
updated_at: "2026-03-07 04:29:31.294398"
...
```bash
$ shpc install quay.io/biocontainers/snakedeploy:0.16.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakedeploy/0.16.0--pyhdfd78af_0
$ module help quay.io/biocontainers/snakedeploy/0.16.0--pyhdfd78af_0
```
