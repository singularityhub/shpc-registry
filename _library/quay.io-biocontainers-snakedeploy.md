...
updated_at: "2025-10-31 04:00:31.768245"
...
```bash
$ shpc install quay.io/biocontainers/snakedeploy:0.14.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakedeploy/0.14.0--pyhdfd78af_0
$ module help quay.io/biocontainers/snakedeploy/0.14.0--pyhdfd78af_0
```
