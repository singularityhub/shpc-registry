...
updated_at: "2026-01-11 04:05:25.376478"
...
```bash
$ shpc install quay.io/biocontainers/snakedeploy:0.15.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakedeploy/0.15.0--pyhdfd78af_0
$ module help quay.io/biocontainers/snakedeploy/0.15.0--pyhdfd78af_0
```
