...
updated_at: "2024-06-24 03:22:49.018424"
latest: "3.7.4--h9ee0642_0"
...
```bash
$ shpc install quay.io/biocontainers/nextclade:3.7.4--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/nextclade/3.7.4--h9ee0642_0
$ module help quay.io/biocontainers/nextclade/3.7.4--h9ee0642_0
```
