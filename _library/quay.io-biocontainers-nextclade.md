...
updated_at: "2024-02-01 03:33:21.574753"
...
```bash
$ shpc install quay.io/biocontainers/nextclade:3.0.0--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/nextclade/3.0.0--h9ee0642_0
$ module help quay.io/biocontainers/nextclade/3.0.0--h9ee0642_0
```
