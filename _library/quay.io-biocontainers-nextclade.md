...
updated_at: "2026-05-09 05:26:09.408884"
latest: "3.21.1--h9ee0642_0"
...
```bash
$ shpc install quay.io/biocontainers/nextclade:3.21.1--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/nextclade/3.21.1--h9ee0642_0
$ module help quay.io/biocontainers/nextclade/3.21.1--h9ee0642_0
```
