...
updated_at: "2025-05-27 11:28:04.980076"
latest: "3.13.3--h9ee0642_0"
...
```bash
$ shpc install quay.io/biocontainers/nextclade:3.13.3--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/nextclade/3.13.3--h9ee0642_0
$ module help quay.io/biocontainers/nextclade/3.13.3--h9ee0642_0
```
