...
updated_at: "2025-10-24 03:50:17.126488"
latest: "3.18.0--h9ee0642_0"
...
```bash
$ shpc install quay.io/biocontainers/nextclade:3.18.0--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/nextclade/3.18.0--h9ee0642_0
$ module help quay.io/biocontainers/nextclade/3.18.0--h9ee0642_0
```
