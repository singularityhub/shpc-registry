...
updated_at: "2025-03-16 03:43:56.532122"
latest: "3.10.1--h9ee0642_0"
...
```bash
$ shpc install quay.io/biocontainers/nextclade:3.10.1--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/nextclade/3.10.1--h9ee0642_0
$ module help quay.io/biocontainers/nextclade/3.10.1--h9ee0642_0
```
