...
updated_at: "2026-03-28 17:09:10.000479"
latest: "3.21.0--h9ee0642_0"
...
```bash
$ shpc install quay.io/biocontainers/nextclade:3.21.0--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/nextclade/3.21.0--h9ee0642_0
$ module help quay.io/biocontainers/nextclade/3.21.0--h9ee0642_0
```
