...
updated_at: "2026-06-07 07:16:32.713571"
latest: "3.21.2--h9ee0642_0"
...
```bash
$ shpc install quay.io/biocontainers/nextclade:3.21.2--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/nextclade/3.21.2--h9ee0642_0
$ module help quay.io/biocontainers/nextclade/3.21.2--h9ee0642_0
```
