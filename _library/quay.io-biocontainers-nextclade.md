...
updated_at: "2024-08-15 04:03:46.722171"
...
```bash
$ shpc install quay.io/biocontainers/nextclade:3.8.2--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/nextclade/3.8.2--h9ee0642_0
$ module help quay.io/biocontainers/nextclade/3.8.2--h9ee0642_0
```
