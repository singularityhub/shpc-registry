...
updated_at: "2026-09-05 07:27:49.060422"
latest: "3.23.0--h9ee0642_0"
...
```bash
$ shpc install quay.io/biocontainers/nextclade:3.23.0--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/nextclade/3.23.0--h9ee0642_0
$ module help quay.io/biocontainers/nextclade/3.23.0--h9ee0642_0
```
