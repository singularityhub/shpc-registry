...
updated_at: "2025-09-07 03:24:08.116904"
latest: "3.16.0--h9ee0642_0"
...
```bash
$ shpc install quay.io/biocontainers/nextclade:3.16.0--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/nextclade/3.16.0--h9ee0642_0
$ module help quay.io/biocontainers/nextclade/3.16.0--h9ee0642_0
```
