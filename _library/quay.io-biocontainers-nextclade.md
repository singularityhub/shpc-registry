...
updated_at: "2023-05-20 02:40:11.306422"
...
```bash
$ shpc install quay.io/biocontainers/nextclade:2.13.1--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/nextclade/2.13.1--h9ee0642_0
$ module help quay.io/biocontainers/nextclade/2.13.1--h9ee0642_0
```
