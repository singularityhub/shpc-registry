...
updated_at: "2025-10-09 05:03:04.408904"
latest: "3.17.0--h9ee0642_0"
...
```bash
$ shpc install quay.io/biocontainers/nextclade:3.17.0--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/nextclade/3.17.0--h9ee0642_0
$ module help quay.io/biocontainers/nextclade/3.17.0--h9ee0642_0
```
