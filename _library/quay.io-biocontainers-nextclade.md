...
updated_at: "2024-01-06 02:44:30.618770"
...
```bash
$ shpc install quay.io/biocontainers/nextclade:2.14.0--h9ee0642_2
```
...
```bash
$ module load quay.io/biocontainers/nextclade/2.14.0--h9ee0642_2
$ module help quay.io/biocontainers/nextclade/2.14.0--h9ee0642_2
```
