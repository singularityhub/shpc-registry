...
updated_at: "2025-04-22 03:48:54.971183"
latest: "3.11.0--h9ee0642_0"
...
```bash
$ shpc install quay.io/biocontainers/nextclade:3.11.0--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/nextclade/3.11.0--h9ee0642_0
$ module help quay.io/biocontainers/nextclade/3.11.0--h9ee0642_0
```
