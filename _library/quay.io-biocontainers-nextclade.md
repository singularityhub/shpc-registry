...
updated_at: "2026-01-21 04:39:27.479254"
latest: "3.18.1--h9ee0642_0"
...
```bash
$ shpc install quay.io/biocontainers/nextclade:3.18.1--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/nextclade/3.18.1--h9ee0642_0
$ module help quay.io/biocontainers/nextclade/3.18.1--h9ee0642_0
```
