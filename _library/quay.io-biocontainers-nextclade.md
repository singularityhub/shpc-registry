...
updated_at: "2024-05-27 03:06:10.589981"
latest: "3.4.0--h9ee0642_0"
...
```bash
$ shpc install quay.io/biocontainers/nextclade:3.4.0--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/nextclade/3.4.0--h9ee0642_0
$ module help quay.io/biocontainers/nextclade/3.4.0--h9ee0642_0
```
