...
updated_at: "2025-09-12 03:16:03.596731"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-msmstests:1.44.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-msmstests/1.44.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-msmstests/1.44.0--r44hdfd78af_0
```
