...
updated_at: "2025-02-21 03:11:12.495644"
latest: "4.0.2--h9dc3d2a_2"
...
```bash
$ shpc install quay.io/biocontainers/relion:4.0.2--h9dc3d2a_2
```
...
```bash
$ module load quay.io/biocontainers/relion/4.0.2--h9dc3d2a_2
$ module help quay.io/biocontainers/relion/4.0.2--h9dc3d2a_2
```
