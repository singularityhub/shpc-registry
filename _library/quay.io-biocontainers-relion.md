...
updated_at: "2026-01-16 04:06:07.702003"
latest: "5.0.1--h6e3b700_0"
...
```bash
$ shpc install quay.io/biocontainers/relion:5.0.1--h6e3b700_0
```
...
```bash
$ module load quay.io/biocontainers/relion/5.0.1--h6e3b700_0
$ module help quay.io/biocontainers/relion/5.0.1--h6e3b700_0
```
