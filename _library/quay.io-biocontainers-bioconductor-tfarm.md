...
updated_at: "2026-03-17 04:38:43.628885"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-tfarm:1.32.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-tfarm/1.32.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-tfarm/1.32.0--r45hdfd78af_0
```
