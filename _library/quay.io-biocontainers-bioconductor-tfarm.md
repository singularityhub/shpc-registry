...
updated_at: "2022-11-04 00:23:32.814691"
latest: "1.6.0--r36_1"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-tfarm:1.6.0--r36_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-tfarm/1.6.0--r36_1
$ module help quay.io/biocontainers/bioconductor-tfarm/1.6.0--r36_1
```
