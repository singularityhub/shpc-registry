...
updated_at: "2023-11-17 02:42:38.437177"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-tfarm:1.22.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-tfarm/1.22.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-tfarm/1.22.0--r43hdfd78af_0
```
