...
updated_at: "2022-11-02 18:44:05.373060"
...
```bash
$ shpc install quay.io/biocontainers/phispy:4.2.6--py36hae55d0a_1
```
...
```bash
$ module load quay.io/biocontainers/phispy/4.2.6--py36hae55d0a_1
$ module help quay.io/biocontainers/phispy/4.2.6--py36hae55d0a_1
```
