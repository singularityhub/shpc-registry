...
updated_at: "2026-05-22 06:29:09.398338"
latest: "5.0.10--py312h4a53a30_0"
...
```bash
$ shpc install quay.io/biocontainers/phispy:5.0.10--py312h4a53a30_0
```
...
```bash
$ module load quay.io/biocontainers/phispy/5.0.10--py312h4a53a30_0
$ module help quay.io/biocontainers/phispy/5.0.10--py312h4a53a30_0
```
