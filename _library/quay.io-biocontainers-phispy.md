...
updated_at: "2026-03-29 05:26:38.669387"
...
```bash
$ shpc install quay.io/biocontainers/phispy:5.0.6--py312hcca0f9f_0
```
...
```bash
$ module load quay.io/biocontainers/phispy/5.0.6--py312hcca0f9f_0
$ module help quay.io/biocontainers/phispy/5.0.6--py312hcca0f9f_0
```
