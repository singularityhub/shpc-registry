...
updated_at: "2022-10-29 05:34:14.060765"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-tiledbarray:1.4.0--r41hc247a5b_2
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-tiledbarray/1.4.0--r41hc247a5b_2
$ module help quay.io/biocontainers/bioconductor-tiledbarray/1.4.0--r41hc247a5b_2
```
