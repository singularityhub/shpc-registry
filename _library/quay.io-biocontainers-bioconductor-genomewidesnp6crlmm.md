...
updated_at: "2026-03-30 05:12:42.518369"
latest: "1.0.7--r45hdfd78af_14"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-genomewidesnp6crlmm:1.0.7--r45hdfd78af_14
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-genomewidesnp6crlmm/1.0.7--r45hdfd78af_14
$ module help quay.io/biocontainers/bioconductor-genomewidesnp6crlmm/1.0.7--r45hdfd78af_14
```
