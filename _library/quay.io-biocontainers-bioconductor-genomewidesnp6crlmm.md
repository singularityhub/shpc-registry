...
updated_at: "2025-11-22 03:17:47.724891"
latest: "1.0.7--r44hdfd78af_13"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-genomewidesnp6crlmm:1.0.7--r44hdfd78af_13
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-genomewidesnp6crlmm/1.0.7--r44hdfd78af_13
$ module help quay.io/biocontainers/bioconductor-genomewidesnp6crlmm/1.0.7--r44hdfd78af_13
```
