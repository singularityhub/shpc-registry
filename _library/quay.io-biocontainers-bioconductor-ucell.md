---
layout: container
name:  "quay.io/biocontainers/bioconductor-ucell"
maintainer: "@vsoch"
...
updated_at: "2023-05-25 02:57:44.380401"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ucell
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-ucell:2.2.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ucell/2.2.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ucell/2.2.0--r42hdfd78af_0
```
...
#### bioconductor-ucell-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-ucell-inspect-deffile:
