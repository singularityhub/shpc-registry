...
updated_at: "2023-09-17 00:23:26.557965"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ucell:2.4.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ucell/2.4.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ucell/2.4.0--r43hdfd78af_0
```
