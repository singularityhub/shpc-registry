...
updated_at: "2022-12-05 03:47:56.148819"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-genelendatabase:1.30.0--r41hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-genelendatabase/1.30.0--r41hdfd78af_1
$ module help quay.io/biocontainers/bioconductor-genelendatabase/1.30.0--r41hdfd78af_1
```
