...
updated_at: "2025-03-22 03:35:49.621894"
latest: "0.16.0--h3dc2dae_0"
...
```bash
$ shpc install quay.io/biocontainers/cramino:0.16.0--h3dc2dae_0
```
...
```bash
$ module load quay.io/biocontainers/cramino/0.16.0--h3dc2dae_0
$ module help quay.io/biocontainers/cramino/0.16.0--h3dc2dae_0
```
