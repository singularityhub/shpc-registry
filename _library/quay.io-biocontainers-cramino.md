...
updated_at: "2025-12-09 03:24:08.192401"
latest: "1.2.0--h3dc2dae_0"
...
```bash
$ shpc install quay.io/biocontainers/cramino:1.2.0--h3dc2dae_0
```
...
```bash
$ module load quay.io/biocontainers/cramino/1.2.0--h3dc2dae_0
$ module help quay.io/biocontainers/cramino/1.2.0--h3dc2dae_0
```
