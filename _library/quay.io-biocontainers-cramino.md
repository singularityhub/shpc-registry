...
updated_at: "2026-01-06 03:44:19.285510"
latest: "1.3.0--h3dc2dae_0"
...
```bash
$ shpc install quay.io/biocontainers/cramino:1.3.0--h3dc2dae_0
```
...
```bash
$ module load quay.io/biocontainers/cramino/1.3.0--h3dc2dae_0
$ module help quay.io/biocontainers/cramino/1.3.0--h3dc2dae_0
```
