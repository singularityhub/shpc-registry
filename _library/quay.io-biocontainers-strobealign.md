...
updated_at: "2024-07-07 03:06:02.588461"
latest: "0.13.0--h43eeafb_0"
...
```bash
$ shpc install quay.io/biocontainers/strobealign:0.13.0--h43eeafb_0
```
...
```bash
$ module load quay.io/biocontainers/strobealign/0.13.0--h43eeafb_0
$ module help quay.io/biocontainers/strobealign/0.13.0--h43eeafb_0
```
