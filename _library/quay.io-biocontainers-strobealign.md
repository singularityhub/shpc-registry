...
updated_at: "2026-09-20 07:45:24.810255"
latest: "0.18.0--hab7d0fd_0"
...
```bash
$ shpc install quay.io/biocontainers/strobealign:0.18.0--hab7d0fd_0
```
...
```bash
$ module load quay.io/biocontainers/strobealign/0.18.0--hab7d0fd_0
$ module help quay.io/biocontainers/strobealign/0.18.0--hab7d0fd_0
```
