...
updated_at: "2023-12-30 02:49:20.847061"
latest: "0.12.0--h43eeafb_0"
...
```bash
$ shpc install quay.io/biocontainers/strobealign:0.12.0--h43eeafb_0
```
...
```bash
$ module load quay.io/biocontainers/strobealign/0.12.0--h43eeafb_0
$ module help quay.io/biocontainers/strobealign/0.12.0--h43eeafb_0
```
