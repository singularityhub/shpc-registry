...
updated_at: "2024-11-09 03:02:02.577181"
latest: "0.14.0--h43eeafb_0"
...
```bash
$ shpc install quay.io/biocontainers/strobealign:0.14.0--h43eeafb_0
```
...
```bash
$ module load quay.io/biocontainers/strobealign/0.14.0--h43eeafb_0
$ module help quay.io/biocontainers/strobealign/0.14.0--h43eeafb_0
```
