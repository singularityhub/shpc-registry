---
layout: container
name:  "quay.io/biocontainers/wordcloud"
maintainer: "@vsoch"
...
updated_at: "2025-12-09 04:02:15.681627"
latest: "1.9.4"
...
singularity registry hpc automated addition for wordcloud
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/wordcloud
```
...
#### wordcloud-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### wordcloud-inspect-deffile:
