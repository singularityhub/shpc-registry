...
updated_at: "2023-09-19 02:43:46.528776"
latest: "0.75.10--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/planemo:0.75.10--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/planemo/0.75.10--pyhdfd78af_0
$ module help quay.io/biocontainers/planemo/0.75.10--pyhdfd78af_0
```
