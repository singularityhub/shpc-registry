...
updated_at: "2025-10-30 04:05:13.717086"
latest: "0.75.32--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/planemo:0.75.32--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/planemo/0.75.32--pyhdfd78af_0
$ module help quay.io/biocontainers/planemo/0.75.32--pyhdfd78af_0
```
