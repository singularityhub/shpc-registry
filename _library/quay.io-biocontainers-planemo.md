...
updated_at: "2023-09-02 02:54:53.426602"
latest: "0.75.9--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/planemo:0.75.9--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/planemo/0.75.9--pyhdfd78af_0
$ module help quay.io/biocontainers/planemo/0.75.9--pyhdfd78af_0
```
