...
updated_at: "2025-02-26 03:04:34.724521"
...
```bash
$ shpc install quay.io/biocontainers/planemo:0.75.26--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/planemo/0.75.26--pyhdfd78af_0
$ module help quay.io/biocontainers/planemo/0.75.26--pyhdfd78af_0
```
