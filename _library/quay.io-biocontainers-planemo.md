...
updated_at: "2026-09-17 07:50:22.143770"
...
```bash
$ shpc install quay.io/biocontainers/planemo:0.75.47--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/planemo/0.75.47--pyhdfd78af_0
$ module help quay.io/biocontainers/planemo/0.75.47--pyhdfd78af_0
```
