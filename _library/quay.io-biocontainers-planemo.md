...
updated_at: "2022-11-04 00:22:21.263565"
latest: "0.74.9--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/planemo:0.74.9--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/planemo/0.74.9--pyhdfd78af_0
$ module help quay.io/biocontainers/planemo/0.74.9--pyhdfd78af_0
```
