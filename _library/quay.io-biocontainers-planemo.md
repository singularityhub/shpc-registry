...
updated_at: "2025-05-17 03:54:45.123052"
latest: "0.75.30--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/planemo:0.75.30--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/planemo/0.75.30--pyhdfd78af_0
$ module help quay.io/biocontainers/planemo/0.75.30--pyhdfd78af_0
```
