...
updated_at: "2025-12-14 04:36:09.408857"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-clusterstab:1.78.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-clusterstab/1.78.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-clusterstab/1.78.0--r44hdfd78af_0
```
