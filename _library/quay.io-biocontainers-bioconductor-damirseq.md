...
updated_at: "2025-05-19 03:44:35.935385"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-damirseq:2.18.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-damirseq/2.18.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-damirseq/2.18.0--r44hdfd78af_0
```
