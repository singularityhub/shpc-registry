...
updated_at: "2026-02-26 05:28:17.914466"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gdsfmt:1.46.0--r45h093b6e0_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gdsfmt/1.46.0--r45h093b6e0_0
$ module help quay.io/biocontainers/bioconductor-gdsfmt/1.46.0--r45h093b6e0_0
```
