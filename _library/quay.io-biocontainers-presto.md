...
updated_at: "2025-09-05 03:37:50.797046"
...
```bash
$ shpc install quay.io/biocontainers/presto:0.7.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/presto/0.7.5--pyhdfd78af_0
$ module help quay.io/biocontainers/presto/0.7.5--pyhdfd78af_0
```
