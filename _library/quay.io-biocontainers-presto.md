...
updated_at: "2026-04-04 04:47:25.215070"
...
```bash
$ shpc install quay.io/biocontainers/presto:0.7.8--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/presto/0.7.8--pyhdfd78af_0
$ module help quay.io/biocontainers/presto/0.7.8--pyhdfd78af_0
```
