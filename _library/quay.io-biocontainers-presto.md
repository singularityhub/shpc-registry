...
updated_at: "2025-05-26 03:48:46.781948"
...
```bash
$ shpc install quay.io/biocontainers/presto:0.7.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/presto/0.7.4--pyhdfd78af_0
$ module help quay.io/biocontainers/presto/0.7.4--pyhdfd78af_0
```
