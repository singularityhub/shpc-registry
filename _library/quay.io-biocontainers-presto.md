...
updated_at: "2026-05-14 06:09:46.105171"
latest: "0.7.9--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/presto:0.7.9--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/presto/0.7.9--pyhdfd78af_0
$ module help quay.io/biocontainers/presto/0.7.9--pyhdfd78af_0
```
