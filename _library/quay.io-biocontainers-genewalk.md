...
updated_at: "2024-05-15 02:34:57.744845"
...
```bash
$ shpc install quay.io/biocontainers/genewalk:1.6.1--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/genewalk/1.6.1--pyh7cba7a3_0
$ module help quay.io/biocontainers/genewalk/1.6.1--pyh7cba7a3_0
```
