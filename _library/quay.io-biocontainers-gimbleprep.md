...
updated_at: "2023-09-18 02:30:22.271747"
latest: "0.0.2b3--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/gimbleprep:0.0.2b3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/gimbleprep/0.0.2b3--pyhdfd78af_0
$ module help quay.io/biocontainers/gimbleprep/0.0.2b3--pyhdfd78af_0
```
