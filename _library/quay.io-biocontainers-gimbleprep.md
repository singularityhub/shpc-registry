...
updated_at: "2023-10-26 03:11:06.145006"
latest: "0.0.2b4--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/gimbleprep:0.0.2b4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/gimbleprep/0.0.2b4--pyhdfd78af_0
$ module help quay.io/biocontainers/gimbleprep/0.0.2b4--pyhdfd78af_0
```
