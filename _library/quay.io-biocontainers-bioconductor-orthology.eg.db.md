...
updated_at: "2026-04-03 15:28:21.484895"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-orthology.eg.db:3.22.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-orthology.eg.db/3.22.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-orthology.eg.db/3.22.0--r45hdfd78af_0
```
