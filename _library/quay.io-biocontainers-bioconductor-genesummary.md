...
updated_at: "2026-02-21 04:52:29.182028"
latest: "0.99.6--r45hdfd78af_2"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-genesummary:0.99.6--r45hdfd78af_2
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-genesummary/0.99.6--r45hdfd78af_2
$ module help quay.io/biocontainers/bioconductor-genesummary/0.99.6--r45hdfd78af_2
```
