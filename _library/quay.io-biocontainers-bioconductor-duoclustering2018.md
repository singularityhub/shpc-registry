...
updated_at: "2026-03-25 04:37:08.985138"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-duoclustering2018:1.28.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-duoclustering2018/1.28.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-duoclustering2018/1.28.0--r45hdfd78af_0
```
