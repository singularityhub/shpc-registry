...
updated_at: "2026-04-05 05:06:00.099207"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-org.eck12.eg.db:3.22.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-org.eck12.eg.db/3.22.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-org.eck12.eg.db/3.22.0--r45hdfd78af_0
```
