...
updated_at: "2024-11-14 04:26:44.122515"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-fission:1.22.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-fission/1.22.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-fission/1.22.0--r43hdfd78af_0
```
