...
updated_at: "2024-12-24 03:08:51.019602"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-fission:1.26.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-fission/1.26.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-fission/1.26.0--r44hdfd78af_0
```
