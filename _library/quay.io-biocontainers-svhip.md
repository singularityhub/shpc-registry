...
updated_at: "2023-05-10 03:04:50.307516"
...
```bash
$ shpc install quay.io/biocontainers/svhip:1.0.8--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/svhip/1.0.8--hdfd78af_0
$ module help quay.io/biocontainers/svhip/1.0.8--hdfd78af_0
```
