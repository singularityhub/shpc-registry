---
layout: container
name:  "quay.io/biocontainers/bioconductor-gdrutils"
maintainer: "@vsoch"
...
updated_at: "2025-05-14 03:23:50.894120"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gdrutils
```
...
#### bioconductor-gdrutils-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-gdrutils-inspect-deffile:
