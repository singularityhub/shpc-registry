...
updated_at: "2023-11-04 02:49:59.433836"
...
```bash
$ shpc install quay.io/biocontainers/nf-test:0.8.1--h2a3209d_0
```
...
```bash
$ module load quay.io/biocontainers/nf-test/0.8.1--h2a3209d_0
$ module help quay.io/biocontainers/nf-test/0.8.1--h2a3209d_0
```
