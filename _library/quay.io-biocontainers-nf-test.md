...
updated_at: "2024-01-27 02:19:56.308253"
latest: "0.8.3--h2a3209d_0"
...
```bash
$ shpc install quay.io/biocontainers/nf-test:0.8.3--h2a3209d_0
```
...
```bash
$ module load quay.io/biocontainers/nf-test/0.8.3--h2a3209d_0
$ module help quay.io/biocontainers/nf-test/0.8.3--h2a3209d_0
```
