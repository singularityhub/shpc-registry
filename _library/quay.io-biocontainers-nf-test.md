...
updated_at: "2025-08-13 03:54:33.712724"
latest: "0.9.2--h2a3209d_0"
...
```bash
$ shpc install quay.io/biocontainers/nf-test:0.9.2--h2a3209d_0
```
...
```bash
$ module load quay.io/biocontainers/nf-test/0.9.2--h2a3209d_0
$ module help quay.io/biocontainers/nf-test/0.9.2--h2a3209d_0
```
