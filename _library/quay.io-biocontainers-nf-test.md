...
updated_at: "2026-05-19 06:37:16.579728"
latest: "0.9.5--h2a3209d_0"
...
```bash
$ shpc install quay.io/biocontainers/nf-test:0.9.5--h2a3209d_0
```
...
```bash
$ module load quay.io/biocontainers/nf-test/0.9.5--h2a3209d_0
$ module help quay.io/biocontainers/nf-test/0.9.5--h2a3209d_0
```
