...
updated_at: "2025-11-13 03:30:38.451158"
latest: "0.9.3--h2a3209d_0"
...
```bash
$ shpc install quay.io/biocontainers/nf-test:0.9.3--h2a3209d_0
```
...
```bash
$ module load quay.io/biocontainers/nf-test/0.9.3--h2a3209d_0
$ module help quay.io/biocontainers/nf-test/0.9.3--h2a3209d_0
```
