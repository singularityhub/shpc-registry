...
updated_at: "2023-12-26 02:26:41.742238"
latest: "0.8.2--h2a3209d_0"
...
```bash
$ shpc install quay.io/biocontainers/nf-test:0.8.2--h2a3209d_0
```
...
```bash
$ module load quay.io/biocontainers/nf-test/0.8.2--h2a3209d_0
$ module help quay.io/biocontainers/nf-test/0.8.2--h2a3209d_0
```
