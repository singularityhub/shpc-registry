...
updated_at: "2026-03-28 04:47:14.523957"
latest: "0.9.4--h2a3209d_0"
...
```bash
$ shpc install quay.io/biocontainers/nf-test:0.9.4--h2a3209d_0
```
...
```bash
$ module load quay.io/biocontainers/nf-test/0.9.4--h2a3209d_0
$ module help quay.io/biocontainers/nf-test/0.9.4--h2a3209d_0
```
