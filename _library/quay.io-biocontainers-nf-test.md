...
updated_at: "2024-09-17 02:32:16.646932"
latest: "0.9.0--h2a3209d_0"
...
```bash
$ shpc install quay.io/biocontainers/nf-test:0.9.0--h2a3209d_0
```
...
```bash
$ module load quay.io/biocontainers/nf-test/0.9.0--h2a3209d_0
$ module help quay.io/biocontainers/nf-test/0.9.0--h2a3209d_0
```
