...
updated_at: "2026-01-12 04:39:00.447223"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-annotationfilter:1.30.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-annotationfilter/1.30.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-annotationfilter/1.30.0--r44hdfd78af_0
```
