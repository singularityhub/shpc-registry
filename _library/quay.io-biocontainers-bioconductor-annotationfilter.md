...
updated_at: "2026-04-01 05:05:58.353946"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-annotationfilter:1.34.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-annotationfilter/1.34.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-annotationfilter/1.34.0--r45hdfd78af_0
```
