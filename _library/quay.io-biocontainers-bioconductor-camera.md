...
updated_at: "2023-12-05 02:53:46.347669"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-camera:1.56.0--r43ha9d7317_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-camera/1.56.0--r43ha9d7317_0
$ module help quay.io/biocontainers/bioconductor-camera/1.56.0--r43ha9d7317_0
```
