...
updated_at: "2026-04-04 05:06:36.338694"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-camera:1.66.0--r45h01b2380_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-camera/1.66.0--r45h01b2380_0
$ module help quay.io/biocontainers/bioconductor-camera/1.66.0--r45h01b2380_0
```
