...
updated_at: "2025-10-11 03:06:49.150182"
latest: "1.62.0--r44h3df3fcb_1"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-camera:1.62.0--r44h3df3fcb_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-camera/1.62.0--r44h3df3fcb_1
$ module help quay.io/biocontainers/bioconductor-camera/1.62.0--r44h3df3fcb_1
```
