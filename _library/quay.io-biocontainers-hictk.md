...
updated_at: "2025-07-03 18:31:32.204600"
latest: "2.1.2--hd7cfe1a_0"
...
```bash
$ shpc install quay.io/biocontainers/hictk:2.1.2--hd7cfe1a_0
```
...
```bash
$ module load quay.io/biocontainers/hictk/2.1.2--hd7cfe1a_0
$ module help quay.io/biocontainers/hictk/2.1.2--hd7cfe1a_0
```
