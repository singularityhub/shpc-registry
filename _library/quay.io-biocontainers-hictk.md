...
updated_at: "2025-04-12 03:44:05.395808"
latest: "2.0.2--hd7cfe1a_1"
...
```bash
$ shpc install quay.io/biocontainers/hictk:2.0.2--hd7cfe1a_1
```
...
```bash
$ module load quay.io/biocontainers/hictk/2.0.2--hd7cfe1a_1
$ module help quay.io/biocontainers/hictk/2.0.2--hd7cfe1a_1
```
