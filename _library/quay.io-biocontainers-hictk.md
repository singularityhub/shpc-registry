...
updated_at: "2024-08-01 03:23:03.646843"
latest: "1.0.0--h636cda1_1"
...
```bash
$ shpc install quay.io/biocontainers/hictk:1.0.0--h636cda1_1
```
...
```bash
$ module load quay.io/biocontainers/hictk/1.0.0--h636cda1_1
$ module help quay.io/biocontainers/hictk/1.0.0--h636cda1_1
```
