...
updated_at: "2024-06-20 03:06:41.578732"
latest: "0.0.12--h636cda1_1"
...
```bash
$ shpc install quay.io/biocontainers/hictk:0.0.12--h636cda1_1
```
...
```bash
$ module load quay.io/biocontainers/hictk/0.0.12--h636cda1_1
$ module help quay.io/biocontainers/hictk/0.0.12--h636cda1_1
```
