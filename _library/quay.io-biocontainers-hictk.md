...
updated_at: "2025-09-25 03:33:47.710659"
latest: "2.1.4--h061aaa5_0"
...
```bash
$ shpc install quay.io/biocontainers/hictk:2.1.4--h061aaa5_0
```
...
```bash
$ module load quay.io/biocontainers/hictk/2.1.4--h061aaa5_0
$ module help quay.io/biocontainers/hictk/2.1.4--h061aaa5_0
```
