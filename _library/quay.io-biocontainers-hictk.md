...
updated_at: "2025-05-15 03:14:40.292631"
...
```bash
$ shpc install quay.io/biocontainers/hictk:2.1.1--hd7cfe1a_0
```
...
```bash
$ module load quay.io/biocontainers/hictk/2.1.1--hd7cfe1a_0
$ module help quay.io/biocontainers/hictk/2.1.1--hd7cfe1a_0
```
