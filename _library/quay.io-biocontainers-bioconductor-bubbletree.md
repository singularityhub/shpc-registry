...
updated_at: "2023-08-24 02:24:15.636286"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-bubbletree:2.30.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-bubbletree/2.30.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-bubbletree/2.30.0--r43hdfd78af_0
```
