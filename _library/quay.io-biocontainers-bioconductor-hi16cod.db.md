...
updated_at: "2025-01-14 02:53:34.647972"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hi16cod.db:3.4.0--r43hdfd78af_12
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hi16cod.db/3.4.0--r43hdfd78af_12
$ module help quay.io/biocontainers/bioconductor-hi16cod.db/3.4.0--r43hdfd78af_12
```
