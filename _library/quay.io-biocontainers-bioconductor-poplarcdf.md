...
updated_at: "2026-03-29 05:26:24.010046"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-poplarcdf:2.18.0--r45hdfd78af_14
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-poplarcdf/2.18.0--r45hdfd78af_14
$ module help quay.io/biocontainers/bioconductor-poplarcdf/2.18.0--r45hdfd78af_14
```
