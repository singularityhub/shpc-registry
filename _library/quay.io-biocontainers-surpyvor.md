...
updated_at: "2023-04-01 03:05:23.530110"
...
```bash
$ shpc install quay.io/biocontainers/surpyvor:0.12.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/surpyvor/0.12.0--pyhdfd78af_0
$ module help quay.io/biocontainers/surpyvor/0.12.0--pyhdfd78af_0
```
