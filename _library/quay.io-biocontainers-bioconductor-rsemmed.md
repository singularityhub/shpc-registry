...
updated_at: "2026-04-05 05:22:31.859531"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rsemmed:1.20.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rsemmed/1.20.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rsemmed/1.20.0--r45hdfd78af_0
```
