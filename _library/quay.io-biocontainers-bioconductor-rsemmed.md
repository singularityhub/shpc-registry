...
updated_at: "2022-11-02 01:11:11.185995"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rsemmed:1.4.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rsemmed/1.4.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rsemmed/1.4.0--r41hdfd78af_0
```
