...
updated_at: "2022-11-02 19:33:08.561515"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-confess:1.22.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-confess/1.22.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-confess/1.22.0--r41hdfd78af_0
```
