...
updated_at: "2026-04-03 05:19:55.959980"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-degnorm:1.20.0--r45ha27e39d_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-degnorm/1.20.0--r45ha27e39d_0
$ module help quay.io/biocontainers/bioconductor-degnorm/1.20.0--r45ha27e39d_0
```
