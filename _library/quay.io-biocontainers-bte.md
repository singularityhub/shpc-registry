...
updated_at: "2023-05-18 04:54:21.361624"
latest: "0.9.0--py39h243b37b_1"
...
```bash
$ shpc install quay.io/biocontainers/bte:0.9.0--py39h243b37b_1
```
...
```bash
$ module load quay.io/biocontainers/bte/0.9.0--py39h243b37b_1
$ module help quay.io/biocontainers/bte/0.9.0--py39h243b37b_1
```
