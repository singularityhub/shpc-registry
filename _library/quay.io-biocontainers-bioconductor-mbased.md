...
updated_at: "2023-11-03 02:44:44.959073"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mbased:1.34.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mbased/1.34.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-mbased/1.34.0--r43hdfd78af_0
```
