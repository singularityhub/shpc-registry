...
updated_at: "2022-11-27 23:54:00.615452"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-annotationhubdata:1.24.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-annotationhubdata/1.24.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-annotationhubdata/1.24.0--r41hdfd78af_0
```
