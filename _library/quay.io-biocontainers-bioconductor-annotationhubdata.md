...
updated_at: "2026-04-03 15:51:08.774475"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-annotationhubdata:1.40.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-annotationhubdata/1.40.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-annotationhubdata/1.40.0--r45hdfd78af_0
```
