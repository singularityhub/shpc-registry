...
updated_at: "2024-11-17 03:09:00.866135"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-annotationhubdata:1.32.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-annotationhubdata/1.32.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-annotationhubdata/1.32.0--r43hdfd78af_0
```
