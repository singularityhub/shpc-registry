...
updated_at: "2023-09-18 02:46:39.459028"
latest: "1.1.8--r43hdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ahensdbs:1.1.8--r43hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ahensdbs/1.1.8--r43hdfd78af_1
$ module help quay.io/biocontainers/bioconductor-ahensdbs/1.1.8--r43hdfd78af_1
```
