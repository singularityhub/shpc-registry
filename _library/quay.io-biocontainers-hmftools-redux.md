...
updated_at: "2026-01-02 04:32:46.497846"
...
```bash
$ shpc install quay.io/biocontainers/hmftools-redux:1.2.2--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hmftools-redux/1.2.2--hdfd78af_0
$ module help quay.io/biocontainers/hmftools-redux/1.2.2--hdfd78af_0
```
