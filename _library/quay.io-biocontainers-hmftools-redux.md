...
updated_at: "2026-07-02 06:44:29.595367"
...
```bash
$ shpc install quay.io/biocontainers/hmftools-redux:2.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hmftools-redux/2.0--hdfd78af_0
$ module help quay.io/biocontainers/hmftools-redux/2.0--hdfd78af_0
```
