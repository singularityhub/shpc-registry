...
updated_at: "2026-08-24 03:20:10.681352"
...
```bash
$ shpc install quay.io/biocontainers/hmftools-redux:2.0.3--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hmftools-redux/2.0.3--hdfd78af_0
$ module help quay.io/biocontainers/hmftools-redux/2.0.3--hdfd78af_0
```
