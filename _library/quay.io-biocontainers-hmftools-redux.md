...
updated_at: "2026-02-02 12:56:10.953098"
...
```bash
$ shpc install quay.io/biocontainers/hmftools-redux:1.2.3--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hmftools-redux/1.2.3--hdfd78af_0
$ module help quay.io/biocontainers/hmftools-redux/1.2.3--hdfd78af_0
```
