---
layout: container
name:  "quay.io/biocontainers/hmftools-redux"
maintainer: "@vsoch"
...
updated_at: "2026-09-02 07:05:27.585204"
...
```bash
$ shpc install quay.io/biocontainers/hmftools-redux
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/hmftools-redux:2.0.5--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hmftools-redux/2.0.5--hdfd78af_0
$ module help quay.io/biocontainers/hmftools-redux/2.0.5--hdfd78af_0
```
...
#### hmftools-redux-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### hmftools-redux-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/redux
$ podman run --it --rm --entrypoint /usr/local/bin/redux   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/redux   -v ${PWD} -w ${PWD} <container> -c " $@"
```
