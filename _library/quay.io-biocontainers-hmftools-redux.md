...
updated_at: "2026-04-03 16:03:49.113928"
latest: "1.2.3--hdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/hmftools-redux:1.2.3--hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/hmftools-redux/1.2.3--hdfd78af_1
$ module help quay.io/biocontainers/hmftools-redux/1.2.3--hdfd78af_1
```
