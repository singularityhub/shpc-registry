...
updated_at: "2026-03-25 04:56:17.649968"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-norway981.db:3.2.3--r45hdfd78af_14
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-norway981.db/3.2.3--r45hdfd78af_14
$ module help quay.io/biocontainers/bioconductor-norway981.db/3.2.3--r45hdfd78af_14
```
