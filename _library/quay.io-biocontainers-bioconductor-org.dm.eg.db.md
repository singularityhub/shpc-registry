...
updated_at: "2026-03-28 17:09:15.090969"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-org.dm.eg.db:3.22.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-org.dm.eg.db/3.22.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-org.dm.eg.db/3.22.0--r45hdfd78af_0
```
