...
updated_at: "2024-03-15 02:36:51.901636"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-org.dm.eg.db:3.18.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-org.dm.eg.db/3.18.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-org.dm.eg.db/3.18.0--r43hdfd78af_0
```
