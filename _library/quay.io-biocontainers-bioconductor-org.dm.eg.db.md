...
updated_at: "2023-08-05 03:03:40.529523"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-org.dm.eg.db:3.17.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-org.dm.eg.db/3.17.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-org.dm.eg.db/3.17.0--r43hdfd78af_0
```
