...
updated_at: "2026-09-04 07:42:04.048237"
...
```bash
$ shpc install quay.io/biocontainers/sigprofilerextractor:1.4.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sigprofilerextractor/1.4.1--pyhdfd78af_0
$ module help quay.io/biocontainers/sigprofilerextractor/1.4.1--pyhdfd78af_0
```
