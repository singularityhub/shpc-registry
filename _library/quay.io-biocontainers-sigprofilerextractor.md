...
updated_at: "2026-06-25 06:25:55.858831"
...
```bash
$ shpc install quay.io/biocontainers/sigprofilerextractor:1.4.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sigprofilerextractor/1.4.0--pyhdfd78af_0
$ module help quay.io/biocontainers/sigprofilerextractor/1.4.0--pyhdfd78af_0
```
