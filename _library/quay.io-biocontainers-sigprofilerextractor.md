...
updated_at: "2025-09-29 04:48:33.748335"
...
```bash
$ shpc install quay.io/biocontainers/sigprofilerextractor:1.2.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sigprofilerextractor/1.2.3--pyhdfd78af_0
$ module help quay.io/biocontainers/sigprofilerextractor/1.2.3--pyhdfd78af_0
```
