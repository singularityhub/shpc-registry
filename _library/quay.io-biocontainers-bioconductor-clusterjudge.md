...
updated_at: "2023-08-18 02:52:36.698485"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-clusterjudge:1.22.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-clusterjudge/1.22.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-clusterjudge/1.22.0--r43hdfd78af_0
```
