...
updated_at: "2025-11-08 03:12:11.672548"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-clusterjudge:1.28.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-clusterjudge/1.28.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-clusterjudge/1.28.0--r44hdfd78af_0
```
