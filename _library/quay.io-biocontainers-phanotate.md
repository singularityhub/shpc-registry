...
updated_at: "2024-10-29 02:58:31.017593"
latest: "1.6.6--py312h28adbb1_0"
...
```bash
$ shpc install quay.io/biocontainers/phanotate:1.6.6--py312h28adbb1_0
```
...
```bash
$ module load quay.io/biocontainers/phanotate/1.6.6--py312h28adbb1_0
$ module help quay.io/biocontainers/phanotate/1.6.6--py312h28adbb1_0
```
