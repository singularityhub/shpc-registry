...
updated_at: "2026-03-06 04:39:13.113537"
...
```bash
$ shpc install quay.io/biocontainers/phanotate:1.6.7--py311hf552afe_2
```
...
```bash
$ module load quay.io/biocontainers/phanotate/1.6.7--py311hf552afe_2
$ module help quay.io/biocontainers/phanotate/1.6.7--py311hf552afe_2
```
