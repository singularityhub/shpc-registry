...
updated_at: "2024-09-20 03:28:49.230434"
latest: "1.6.5--py38h2123bcc_1"
...
```bash
$ shpc install quay.io/biocontainers/phanotate:1.6.5--py38h2123bcc_1
```
...
```bash
$ module load quay.io/biocontainers/phanotate/1.6.5--py38h2123bcc_1
$ module help quay.io/biocontainers/phanotate/1.6.5--py38h2123bcc_1
```
