---
layout: container
name:  "quay.io/biocontainers/bioconductor-biomartgogenesets"
maintainer: "@vsoch"
...
updated_at: "2024-02-13 03:03:58.436380"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-biomartgogenesets
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-biomartgogenesets:0.99.11--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-biomartgogenesets/0.99.11--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-biomartgogenesets/0.99.11--r43hdfd78af_0
```
...
#### bioconductor-biomartgogenesets-run:
...
#### bioconductor-biomartgogenesets-shell:
...
#### bioconductor-biomartgogenesets-exec:
...
#### bioconductor-biomartgogenesets-inspect:
...
#### bioconductor-biomartgogenesets-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-biomartgogenesets-inspect-deffile:
