...
updated_at: "2024-04-29 03:01:02.568571"
latest: "0.14.0--h773013f_3"
...
```bash
$ shpc install quay.io/biocontainers/nanopolish:0.14.0--h773013f_3
```
...
```bash
$ module load quay.io/biocontainers/nanopolish/0.14.0--h773013f_3
$ module help quay.io/biocontainers/nanopolish/0.14.0--h773013f_3
```
