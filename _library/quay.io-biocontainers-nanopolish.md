...
updated_at: "2025-08-07 09:34:18.940592"
latest: "0.14.0--hee927d3_5"
...
```bash
$ shpc install quay.io/biocontainers/nanopolish:0.14.0--hee927d3_5
```
...
```bash
$ module load quay.io/biocontainers/nanopolish/0.14.0--hee927d3_5
$ module help quay.io/biocontainers/nanopolish/0.14.0--hee927d3_5
```
