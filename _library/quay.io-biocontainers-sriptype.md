---
layout: container
name:  "quay.io/biocontainers/sriptype"
maintainer: "@vsoch"
github: "https://github.com/singularityhub/shpc-registry/blob/main/quay.io/biocontainers/sriptype/container.yaml"
config_url: "https://raw.githubusercontent.com/singularityhub/shpc-registry/main/quay.io/biocontainers/sriptype/container.yaml"
updated_at: "2026-05-04 06:21:16.103625"
latest: "0.1.0--pyhdfd78af_0"
container_url: "https://biocontainers.pro/tools/sriptype"
aliases:
 - "sriptype"
 - "flash"
 - "archive-nlmnlp"
...
```bash
$ module load quay.io/biocontainers/sriptype/0.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/sriptype/0.1.0--pyhdfd78af_0
```
...
#### sriptype-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### sriptype-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/sriptype
$ podman run --it --rm --entrypoint /usr/local/bin/sriptype   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/sriptype   -v ${PWD} -w ${PWD} <container> -c " $@"
```
