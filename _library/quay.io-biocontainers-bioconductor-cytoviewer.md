...
updated_at: "2026-04-05 04:59:30.200724"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cytoviewer:1.10.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cytoviewer/1.10.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-cytoviewer/1.10.0--r45hdfd78af_0
```
