---
layout: container
name:  "quay.io/biocontainers/bioconductor-cytoviewer"
maintainer: "@vsoch"
...
updated_at: "2023-08-02 03:21:02.243632"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cytoviewer
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-cytoviewer:1.0.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cytoviewer/1.0.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-cytoviewer/1.0.0--r43hdfd78af_0
```
...
#### bioconductor-cytoviewer-inspect:
...
#### bioconductor-cytoviewer-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-cytoviewer-inspect-deffile:
