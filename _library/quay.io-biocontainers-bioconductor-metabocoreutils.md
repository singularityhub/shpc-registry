...
updated_at: "2022-10-29 05:42:07.315901"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-metabocoreutils:1.2.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-metabocoreutils/1.2.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-metabocoreutils/1.2.0--r41hdfd78af_0
```
