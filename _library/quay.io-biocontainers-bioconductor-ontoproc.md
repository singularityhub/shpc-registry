...
updated_at: "2026-03-30 06:22:16.881526"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ontoproc:2.4.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ontoproc/2.4.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ontoproc/2.4.0--r45hdfd78af_0
```
