...
updated_at: "2023-12-07 03:00:36.595944"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-aneufinderdata:1.28.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-aneufinderdata/1.28.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-aneufinderdata/1.28.0--r43hdfd78af_0
```
