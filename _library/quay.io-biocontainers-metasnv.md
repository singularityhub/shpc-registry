...
updated_at: "2025-04-15 03:43:12.408981"
...
```bash
$ shpc install quay.io/biocontainers/metasnv:2.0.4--py311h13b32c1_9
```
...
```bash
$ module load quay.io/biocontainers/metasnv/2.0.4--py311h13b32c1_9
$ module help quay.io/biocontainers/metasnv/2.0.4--py311h13b32c1_9
```
