...
updated_at: "2025-03-26 03:24:48.573190"
latest: "1.15.1--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/recentrifuge:1.15.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/recentrifuge/1.15.1--pyhdfd78af_0
$ module help quay.io/biocontainers/recentrifuge/1.15.1--pyhdfd78af_0
```
