...
updated_at: "2022-11-14 00:09:25.362248"
...
```bash
$ shpc install quay.io/biocontainers/recentrifuge:1.9.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/recentrifuge/1.9.1--pyhdfd78af_0
$ module help quay.io/biocontainers/recentrifuge/1.9.1--pyhdfd78af_0
```
