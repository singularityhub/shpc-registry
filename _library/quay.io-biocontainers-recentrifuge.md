...
updated_at: "2026-03-08 04:42:46.840456"
...
```bash
$ shpc install quay.io/biocontainers/recentrifuge:2.1.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/recentrifuge/2.1.1--pyhdfd78af_0
$ module help quay.io/biocontainers/recentrifuge/2.1.1--pyhdfd78af_0
```
