...
updated_at: "2026-08-20 03:37:15.001199"
...
```bash
$ shpc install quay.io/biocontainers/recentrifuge:2.1.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/recentrifuge/2.1.2--pyhdfd78af_0
$ module help quay.io/biocontainers/recentrifuge/2.1.2--pyhdfd78af_0
```
