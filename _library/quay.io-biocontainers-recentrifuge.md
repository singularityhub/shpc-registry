...
updated_at: "2023-12-24 03:09:37.799352"
latest: "1.12.2--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/recentrifuge:1.12.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/recentrifuge/1.12.2--pyhdfd78af_0
$ module help quay.io/biocontainers/recentrifuge/1.12.2--pyhdfd78af_0
```
