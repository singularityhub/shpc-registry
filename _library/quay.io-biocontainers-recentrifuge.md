...
updated_at: "2025-04-29 03:15:27.630356"
...
```bash
$ shpc install quay.io/biocontainers/recentrifuge:1.16.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/recentrifuge/1.16.0--pyhdfd78af_0
$ module help quay.io/biocontainers/recentrifuge/1.16.0--pyhdfd78af_0
```
