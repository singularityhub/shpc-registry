...
updated_at: "2022-11-03 00:40:56.828604"
latest: "1.8.4--r351_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-pathostat:1.8.4--r351_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-pathostat/1.8.4--r351_0
$ module help quay.io/biocontainers/bioconductor-pathostat/1.8.4--r351_0
```
