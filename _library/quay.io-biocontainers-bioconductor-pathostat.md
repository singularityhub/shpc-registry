...
updated_at: "2023-11-09 02:30:54.781609"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-pathostat:1.26.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-pathostat/1.26.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-pathostat/1.26.0--r43hdfd78af_0
```
