...
updated_at: "2026-03-28 04:38:36.648598"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-pathostat:1.36.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-pathostat/1.36.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-pathostat/1.36.0--r45hdfd78af_0
```
