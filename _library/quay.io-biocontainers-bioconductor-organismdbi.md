...
updated_at: "2026-03-31 05:15:32.330392"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-organismdbi:1.52.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-organismdbi/1.52.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-organismdbi/1.52.0--r45hdfd78af_0
```
