...
updated_at: "2025-09-08 04:53:49.239073"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-yarn:1.32.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-yarn/1.32.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-yarn/1.32.0--r44hdfd78af_0
```
