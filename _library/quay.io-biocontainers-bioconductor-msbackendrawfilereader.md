...
updated_at: "2026-04-03 16:04:21.870533"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-msbackendrawfilereader:1.16.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-msbackendrawfilereader/1.16.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-msbackendrawfilereader/1.16.0--r45hdfd78af_0
```
