...
updated_at: "2025-06-30 05:21:23.937754"
...
```bash
$ shpc install quay.io/biocontainers/psosp:1.1.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/psosp/1.1.1--pyhdfd78af_0
$ module help quay.io/biocontainers/psosp/1.1.1--pyhdfd78af_0
```
