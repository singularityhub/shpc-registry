...
updated_at: "2025-04-08 03:48:01.201375"
...
```bash
$ shpc install quay.io/biocontainers/plasann:1.0.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/plasann/1.0.1--pyhdfd78af_0
$ module help quay.io/biocontainers/plasann/1.0.1--pyhdfd78af_0
```
