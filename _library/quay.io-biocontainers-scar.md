...
updated_at: "2024-01-19 02:47:50.330327"
...
```bash
$ shpc install quay.io/biocontainers/scar:0.5.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/scar/0.5.2--pyhdfd78af_0
$ module help quay.io/biocontainers/scar/0.5.2--pyhdfd78af_0
```
