...
updated_at: "2026-08-06 05:36:18.906047"
latest: "2.3.0.5--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/cazy_webscraper:2.3.0.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/cazy_webscraper/2.3.0.5--pyhdfd78af_0
$ module help quay.io/biocontainers/cazy_webscraper/2.3.0.5--pyhdfd78af_0
```
