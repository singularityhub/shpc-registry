...
updated_at: "2023-02-09 17:57:27.787965"
...
```bash
$ shpc install quay.io/biocontainers/cazy_webscraper:2.2.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/cazy_webscraper/2.2.2--pyhdfd78af_0
$ module help quay.io/biocontainers/cazy_webscraper/2.2.2--pyhdfd78af_0
```
