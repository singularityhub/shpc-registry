...
updated_at: "2022-10-27 00:53:46.294286"
...
```bash
$ shpc install quay.io/biocontainers/cazy_webscraper:2.2.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/cazy_webscraper/2.2.1--pyhdfd78af_0
$ module help quay.io/biocontainers/cazy_webscraper/2.2.1--pyhdfd78af_0
```
