...
updated_at: "2026-04-01 05:12:36.785138"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mu19ksubc.db:3.13.0--r45hdfd78af_6
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mu19ksubc.db/3.13.0--r45hdfd78af_6
$ module help quay.io/biocontainers/bioconductor-mu19ksubc.db/3.13.0--r45hdfd78af_6
```
