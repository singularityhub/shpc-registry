...
updated_at: "2023-10-26 03:54:56.023210"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-sincell:1.32.0--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-sincell/1.32.0--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-sincell/1.32.0--r43hf17093f_0
```
