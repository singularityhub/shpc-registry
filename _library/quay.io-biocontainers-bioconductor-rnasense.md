...
updated_at: "2026-03-30 06:15:44.523914"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rnasense:1.24.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rnasense/1.24.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rnasense/1.24.0--r45hdfd78af_0
```
