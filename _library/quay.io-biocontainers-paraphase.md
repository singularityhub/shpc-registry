...
updated_at: "2026-03-23 05:24:00.339369"
...
```bash
$ shpc install quay.io/biocontainers/paraphase:3.5.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/paraphase/3.5.0--pyhdfd78af_0
$ module help quay.io/biocontainers/paraphase/3.5.0--pyhdfd78af_0
```
