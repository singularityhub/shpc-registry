...
updated_at: "2025-12-31 04:12:03.017767"
...
```bash
$ shpc install quay.io/biocontainers/paraphase:3.4.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/paraphase/3.4.0--pyhdfd78af_0
$ module help quay.io/biocontainers/paraphase/3.4.0--pyhdfd78af_0
```
