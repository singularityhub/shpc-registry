...
updated_at: "2025-05-27 11:23:58.854218"
...
```bash
$ shpc install quay.io/biocontainers/paraphase:3.3.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/paraphase/3.3.1--pyhdfd78af_0
$ module help quay.io/biocontainers/paraphase/3.3.1--pyhdfd78af_0
```
