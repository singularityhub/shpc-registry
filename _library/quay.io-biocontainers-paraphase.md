...
updated_at: "2026-06-28 06:52:38.187942"
...
```bash
$ shpc install quay.io/biocontainers/paraphase:4.0.0--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/paraphase/4.0.0--h9ee0642_0
$ module help quay.io/biocontainers/paraphase/4.0.0--h9ee0642_0
```
