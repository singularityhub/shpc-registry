...
updated_at: "2023-04-09 02:49:21.700463"
...
```bash
$ shpc install quay.io/biocontainers/paraphase:2.0.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/paraphase/2.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/paraphase/2.0.0--pyhdfd78af_0
```
