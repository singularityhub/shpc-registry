...
updated_at: "2025-03-31 03:34:17.336392"
...
```bash
$ shpc install quay.io/biocontainers/paraphase:3.2.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/paraphase/3.2.1--pyhdfd78af_0
$ module help quay.io/biocontainers/paraphase/3.2.1--pyhdfd78af_0
```
