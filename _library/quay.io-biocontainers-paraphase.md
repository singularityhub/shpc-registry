...
updated_at: "2025-08-06 04:11:41.995450"
...
```bash
$ shpc install quay.io/biocontainers/paraphase:3.3.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/paraphase/3.3.2--pyhdfd78af_0
$ module help quay.io/biocontainers/paraphase/3.3.2--pyhdfd78af_0
```
