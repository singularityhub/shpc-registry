...
updated_at: "2025-08-23 03:51:22.474242"
...
```bash
$ shpc install quay.io/biocontainers/paraphase:3.3.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/paraphase/3.3.4--pyhdfd78af_0
$ module help quay.io/biocontainers/paraphase/3.3.4--pyhdfd78af_0
```
