...
updated_at: "2023-09-04 03:21:49.466389"
...
```bash
$ shpc install quay.io/biocontainers/paraphase:2.2.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/paraphase/2.2.3--pyhdfd78af_0
$ module help quay.io/biocontainers/paraphase/2.2.3--pyhdfd78af_0
```
