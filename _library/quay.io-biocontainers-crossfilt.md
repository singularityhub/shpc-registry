...
updated_at: "2025-06-08 05:57:10.125249"
...
```bash
$ shpc install quay.io/biocontainers/crossfilt:0.1.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/crossfilt/0.1.3--pyhdfd78af_0
$ module help quay.io/biocontainers/crossfilt/0.1.3--pyhdfd78af_0
```
