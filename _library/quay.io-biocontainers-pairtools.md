...
updated_at: "2025-02-03 03:13:30.941491"
...
```bash
$ shpc install quay.io/biocontainers/pairtools:1.1.2--py312h5219090_0
```
...
```bash
$ module load quay.io/biocontainers/pairtools/1.1.2--py312h5219090_0
$ module help quay.io/biocontainers/pairtools/1.1.2--py312h5219090_0
```
