...
updated_at: "2025-11-25 03:22:24.652075"
latest: "1.12.2--r44h3121a25_0"
...
```bash
$ shpc install quay.io/biocontainers/r-tidyheatmap:1.12.2--r44h3121a25_0
```
...
```bash
$ module load quay.io/biocontainers/r-tidyheatmap/1.12.2--r44h3121a25_0
$ module help quay.io/biocontainers/r-tidyheatmap/1.12.2--r44h3121a25_0
```
