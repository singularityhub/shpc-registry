...
updated_at: "2025-12-29 04:21:22.388900"
latest: "1.13.1--r44h3121a25_0"
...
```bash
$ shpc install quay.io/biocontainers/r-tidyheatmap:1.13.1--r44h3121a25_0
```
...
```bash
$ module load quay.io/biocontainers/r-tidyheatmap/1.13.1--r44h3121a25_0
$ module help quay.io/biocontainers/r-tidyheatmap/1.13.1--r44h3121a25_0
```
