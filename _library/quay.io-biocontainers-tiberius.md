...
updated_at: "2025-01-26 03:01:28.706427"
...
```bash
$ shpc install quay.io/biocontainers/tiberius:1.1.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/tiberius/1.1.1--pyhdfd78af_0
$ module help quay.io/biocontainers/tiberius/1.1.1--pyhdfd78af_0
```
