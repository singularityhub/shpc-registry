...
updated_at: "2025-11-12 03:49:11.195810"
...
```bash
$ shpc install quay.io/biocontainers/tiberius:1.1.6--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/tiberius/1.1.6--pyhdfd78af_0
$ module help quay.io/biocontainers/tiberius/1.1.6--pyhdfd78af_0
```
