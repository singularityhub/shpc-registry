...
updated_at: "2026-02-06 04:50:54.152348"
...
```bash
$ shpc install quay.io/biocontainers/tiberius:1.1.8--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/tiberius/1.1.8--pyhdfd78af_0
$ module help quay.io/biocontainers/tiberius/1.1.8--pyhdfd78af_0
```
