...
updated_at: "2026-06-26 06:43:18.806107"
...
```bash
$ shpc install quay.io/biocontainers/tiberius:2.0.6--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/tiberius/2.0.6--pyhdfd78af_0
$ module help quay.io/biocontainers/tiberius/2.0.6--pyhdfd78af_0
```
