...
updated_at: "2026-02-05 04:19:16.257887"
latest: "2.6.0--h077b44d_0"
...
```bash
$ shpc install quay.io/biocontainers/metacache:2.6.0--h077b44d_0
```
...
```bash
$ module load quay.io/biocontainers/metacache/2.6.0--h077b44d_0
$ module help quay.io/biocontainers/metacache/2.6.0--h077b44d_0
```
