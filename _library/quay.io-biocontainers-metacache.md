...
updated_at: "2025-03-04 03:18:25.624377"
latest: "2.5.0--h077b44d_0"
...
```bash
$ shpc install quay.io/biocontainers/metacache:2.5.0--h077b44d_0
```
...
```bash
$ module load quay.io/biocontainers/metacache/2.5.0--h077b44d_0
$ module help quay.io/biocontainers/metacache/2.5.0--h077b44d_0
```
