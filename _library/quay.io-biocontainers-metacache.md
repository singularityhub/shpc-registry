...
updated_at: "2024-11-13 03:32:53.608263"
latest: "2.4.3--hdcf5f25_1"
...
```bash
$ shpc install quay.io/biocontainers/metacache:2.4.3--hdcf5f25_1
```
...
```bash
$ module load quay.io/biocontainers/metacache/2.4.3--hdcf5f25_1
$ module help quay.io/biocontainers/metacache/2.4.3--hdcf5f25_1
```
