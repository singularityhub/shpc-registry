...
updated_at: "2025-02-07 03:19:33.874169"
latest: "2.4.3--h077b44d_2"
...
```bash
$ shpc install quay.io/biocontainers/metacache:2.4.3--h077b44d_2
```
...
```bash
$ module load quay.io/biocontainers/metacache/2.4.3--h077b44d_2
$ module help quay.io/biocontainers/metacache/2.4.3--h077b44d_2
```
