...
updated_at: "2022-10-27 00:39:07.019263"
...
```bash
$ shpc install quay.io/biocontainers/metacache:2.2.3--hd03093a_1
```
...
```bash
$ module load quay.io/biocontainers/metacache/2.2.3--hd03093a_1
$ module help quay.io/biocontainers/metacache/2.2.3--hd03093a_1
```
