...
updated_at: "2025-04-10 03:13:38.220293"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-pth2o2lipids:1.32.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-pth2o2lipids/1.32.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-pth2o2lipids/1.32.0--r44hdfd78af_0
```
