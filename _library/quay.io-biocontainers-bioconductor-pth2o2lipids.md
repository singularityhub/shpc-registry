...
updated_at: "2024-06-28 03:15:15.490326"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-pth2o2lipids:1.28.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-pth2o2lipids/1.28.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-pth2o2lipids/1.28.0--r43hdfd78af_0
```
