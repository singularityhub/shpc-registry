...
updated_at: "2023-06-05 03:54:24.836866"
latest: "0.12.0--hec16e2b_1"
...
```bash
$ shpc install quay.io/biocontainers/sage-proteomics:0.12.0--hec16e2b_1
```
...
```bash
$ module load quay.io/biocontainers/sage-proteomics/0.12.0--hec16e2b_1
$ module help quay.io/biocontainers/sage-proteomics/0.12.0--hec16e2b_1
```
