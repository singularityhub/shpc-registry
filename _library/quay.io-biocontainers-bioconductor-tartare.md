...
updated_at: "2026-03-30 05:18:21.212204"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-tartare:1.24.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-tartare/1.24.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-tartare/1.24.0--r45hdfd78af_0
```
