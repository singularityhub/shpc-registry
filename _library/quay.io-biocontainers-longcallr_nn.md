---
layout: container
name:  "quay.io/biocontainers/longcallr_nn"
maintainer: "@vsoch"
...
updated_at: "2025-12-30 03:55:37.171614"
...
```bash
$ shpc install quay.io/biocontainers/longcallr_nn
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/longcallr_nn:0.0.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/longcallr_nn/0.0.2--pyhdfd78af_0
$ module help quay.io/biocontainers/longcallr_nn/0.0.2--pyhdfd78af_0
```
...
#### longcallr_nn-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### longcallr_nn-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/longcallR_nn
$ podman run --it --rm --entrypoint /usr/local/bin/longcallR_nn   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/longcallR_nn   -v ${PWD} -w ${PWD} <container> -c " $@"
```
