...
updated_at: "2026-09-24 07:36:09.889118"
latest: "3.9.6--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/vitessce-python:3.9.6--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/vitessce-python/3.9.6--pyhdfd78af_0
$ module help quay.io/biocontainers/vitessce-python/3.9.6--pyhdfd78af_0
```
