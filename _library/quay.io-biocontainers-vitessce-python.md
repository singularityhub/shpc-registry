...
updated_at: "2025-12-09 04:06:59.384441"
latest: "3.7.7--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/vitessce-python:3.7.7--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/vitessce-python/3.7.7--pyhdfd78af_0
$ module help quay.io/biocontainers/vitessce-python/3.7.7--pyhdfd78af_0
```
