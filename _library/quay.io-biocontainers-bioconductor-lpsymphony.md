...
updated_at: "2025-04-17 02:53:56.225229"
latest: "1.34.0--r44h81e381d_1"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-lpsymphony:1.34.0--r44h81e381d_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-lpsymphony/1.34.0--r44h81e381d_1
$ module help quay.io/biocontainers/bioconductor-lpsymphony/1.34.0--r44h81e381d_1
```
