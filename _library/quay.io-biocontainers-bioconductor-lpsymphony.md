...
updated_at: "2022-11-23 00:46:54.232080"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-lpsymphony:1.22.0--r41hc247a5b_2
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-lpsymphony/1.22.0--r41hc247a5b_2
$ module help quay.io/biocontainers/bioconductor-lpsymphony/1.22.0--r41hc247a5b_2
```
