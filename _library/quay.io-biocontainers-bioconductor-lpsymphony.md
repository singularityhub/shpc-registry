...
updated_at: "2026-03-30 05:30:56.216589"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-lpsymphony:1.38.0--r45ha27e39d_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-lpsymphony/1.38.0--r45ha27e39d_0
$ module help quay.io/biocontainers/bioconductor-lpsymphony/1.38.0--r45ha27e39d_0
```
