---
layout: container
name:  "quay.io/biocontainers/dosage_score"
maintainer: "@vsoch"
...
updated_at: "2025-05-19 04:15:20.750803"
...
versions:
 - "1.0.0--pyhdfd78af_0"
description: "singularity registry hpc automated addition for dosage_score"
config: {"url": "https://biocontainers.pro/tools/dosage_score", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for dosage_score", "latest": {"1.0.0--pyhdfd78af_0": "sha256:be3d45111cd73763039c83a10938a4cc8d96c85b6edf8877ee32f7706cbab084"}, "tags": {"1.0.0--pyhdfd78af_0": "sha256:be3d45111cd73763039c83a10938a4cc8d96c85b6edf8877ee32f7706cbab084"}, "docker": "quay.io/biocontainers/dosage_score", "aliases": {"dosage_score": "/usr/local/bin/dosage_score", "dosage_score_plot": "/usr/local/bin/dosage_score_plot", "annot-tsv": "/usr/local/bin/annot-tsv", "fasta-sanitize.pl": "/usr/local/bin/fasta-sanitize.pl", "plot-ampliconstats": "/usr/local/bin/plot-ampliconstats", "tjbench": "/usr/local/bin/tjbench", "fonttools": "/usr/local/bin/fonttools", "pyftmerge": "/usr/local/bin/pyftmerge", "pyftsubset": "/usr/local/bin/pyftsubset", "ttx": "/usr/local/bin/ttx", "brotli": "/usr/local/bin/brotli", "ace2sam": "/usr/local/bin/ace2sam", "blast2sam.pl": "/usr/local/bin/blast2sam.pl", "bowtie2sam.pl": "/usr/local/bin/bowtie2sam.pl", "export2sam.pl": "/usr/local/bin/export2sam.pl", "interpolate_sam.pl": "/usr/local/bin/interpolate_sam.pl", "maq2sam-long": "/usr/local/bin/maq2sam-long", "maq2sam-short": "/usr/local/bin/maq2sam-short", "md5fa": "/usr/local/bin/md5fa", "md5sum-lite": "/usr/local/bin/md5sum-lite", "plot-bamstats": "/usr/local/bin/plot-bamstats", "psl2sam.pl": "/usr/local/bin/psl2sam.pl", "sam2vcf.pl": "/usr/local/bin/sam2vcf.pl", "samtools.pl": "/usr/local/bin/samtools.pl", "seq_cache_populate.pl": "/usr/local/bin/seq_cache_populate.pl", "soap2sam.pl": "/usr/local/bin/soap2sam.pl", "zoom2sam.pl": "/usr/local/bin/zoom2sam.pl"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/dosage_score.
singularity registry hpc automated addition for dosage_score
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/dosage_score
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/dosage_score:1.0.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/dosage_score/1.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/dosage_score/1.0.0--pyhdfd78af_0
```
...
#### dosage_score-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### dosage_score-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/dosage_score
$ podman run --it --rm --entrypoint /usr/local/bin/dosage_score   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/dosage_score   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/dosage_score_plot
$ podman run --it --rm --entrypoint /usr/local/bin/dosage_score_plot   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/dosage_score_plot   -v ${PWD} -w ${PWD} <container> -c " $@"
```
