...
updated_at: "2026-03-07 04:54:23.051829"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rlmm:1.72.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rlmm/1.72.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rlmm/1.72.0--r45hdfd78af_0
```
