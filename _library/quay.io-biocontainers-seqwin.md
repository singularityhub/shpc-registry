...
updated_at: "2026-06-26 07:00:55.744052"
...
```bash
$ shpc install quay.io/biocontainers/seqwin:0.4.1--py310hd766df8_0
```
...
```bash
$ module load quay.io/biocontainers/seqwin/0.4.1--py310hd766df8_0
$ module help quay.io/biocontainers/seqwin/0.4.1--py310hd766df8_0
```
