...
updated_at: "2025-10-09 03:52:25.740491"
...
```bash
$ shpc install quay.io/biocontainers/seqwin:0.1.0--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/seqwin/0.1.0--pyhdfd78af_1
$ module help quay.io/biocontainers/seqwin/0.1.0--pyhdfd78af_1
```
