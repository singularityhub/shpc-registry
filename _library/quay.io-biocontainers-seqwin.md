...
updated_at: "2026-05-01 06:19:02.655172"
...
```bash
$ shpc install quay.io/biocontainers/seqwin:0.3.1--py311h93bbee8_0
```
...
```bash
$ module load quay.io/biocontainers/seqwin/0.3.1--py311h93bbee8_0
$ module help quay.io/biocontainers/seqwin/0.3.1--py311h93bbee8_0
```
