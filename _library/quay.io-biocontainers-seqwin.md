...
updated_at: "2026-05-17 06:42:48.783643"
latest: "0.3.2--py310hd766df8_0"
...
```bash
$ shpc install quay.io/biocontainers/seqwin:0.3.2--py310hd766df8_0
```
...
```bash
$ module load quay.io/biocontainers/seqwin/0.3.2--py310hd766df8_0
$ module help quay.io/biocontainers/seqwin/0.3.2--py310hd766df8_0
```
