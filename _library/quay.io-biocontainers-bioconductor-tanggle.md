...
updated_at: "2026-06-13 06:31:26.977940"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-tanggle:1.16.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-tanggle/1.16.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-tanggle/1.16.0--r45hdfd78af_0
```
