...
updated_at: "2023-06-23 03:41:21.653129"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ncgtw:1.12.0--r42hf17093f_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ncgtw/1.12.0--r42hf17093f_1
$ module help quay.io/biocontainers/bioconductor-ncgtw/1.12.0--r42hf17093f_1
```
