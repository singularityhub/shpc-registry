...
updated_at: "2022-10-29 05:34:32.715279"
...
```bash
$ shpc install quay.io/biocontainers/r-ddir:0.0.3--r41hdfd78af_3
```
...
```bash
$ module load quay.io/biocontainers/r-ddir/0.0.3--r41hdfd78af_3
$ module help quay.io/biocontainers/r-ddir/0.0.3--r41hdfd78af_3
```
