...
updated_at: "2025-05-01 03:23:33.023376"
latest: "0.44.1--ha96b9cd_0"
...
```bash
$ shpc install quay.io/biocontainers/mapad:0.44.1--ha96b9cd_0
```
...
```bash
$ module load quay.io/biocontainers/mapad/0.44.1--ha96b9cd_0
$ module help quay.io/biocontainers/mapad/0.44.1--ha96b9cd_0
```
