...
updated_at: "2025-05-27 11:22:51.325124"
...
```bash
$ shpc install quay.io/biocontainers/quota_anchor:1.0.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/quota_anchor/1.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/quota_anchor/1.0.0--pyhdfd78af_0
```
