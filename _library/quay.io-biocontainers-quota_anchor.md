...
updated_at: "2026-01-15 04:16:23.715776"
...
```bash
$ shpc install quay.io/biocontainers/quota_anchor:1.0.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/quota_anchor/1.0.2--pyhdfd78af_0
$ module help quay.io/biocontainers/quota_anchor/1.0.2--pyhdfd78af_0
```
