---
layout: container
name:  "quay.io/biocontainers/eider"
maintainer: "@vsoch"
...
updated_at: "2025-04-30 03:57:46.560801"
...
```bash
$ shpc install quay.io/biocontainers/eider
```
...
#### eider-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### eider-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/eider
$ podman run --it --rm --entrypoint /usr/local/bin/eider   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/eider   -v ${PWD} -w ${PWD} <container> -c " $@"
```
