...
updated_at: "2024-11-02 03:24:18.396442"
...
```bash
$ shpc install quay.io/biocontainers/hmftools-linx:2.0_beta--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hmftools-linx/2.0_beta--hdfd78af_0
$ module help quay.io/biocontainers/hmftools-linx/2.0_beta--hdfd78af_0
```
