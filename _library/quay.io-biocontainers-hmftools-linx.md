...
updated_at: "2024-08-30 03:22:05.301903"
...
```bash
$ shpc install quay.io/biocontainers/hmftools-linx:1.25--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hmftools-linx/1.25--hdfd78af_0
$ module help quay.io/biocontainers/hmftools-linx/1.25--hdfd78af_0
```
