...
updated_at: "2026-07-02 06:35:05.904305"
...
```bash
$ shpc install quay.io/biocontainers/hmftools-linx:2.3--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hmftools-linx/2.3--hdfd78af_0
$ module help quay.io/biocontainers/hmftools-linx/2.3--hdfd78af_0
```
