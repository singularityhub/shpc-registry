...
updated_at: "2025-05-11 03:31:52.140086"
...
```bash
$ shpc install quay.io/biocontainers/hmftools-linx:2.0.3--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hmftools-linx/2.0.3--hdfd78af_0
$ module help quay.io/biocontainers/hmftools-linx/2.0.3--hdfd78af_0
```
