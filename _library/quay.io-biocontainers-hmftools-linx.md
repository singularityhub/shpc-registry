...
updated_at: "2025-03-27 03:44:57.921085"
latest: "2.0_beta--hdfd78af_2"
...
```bash
$ shpc install quay.io/biocontainers/hmftools-linx:2.0_beta--hdfd78af_2
```
...
```bash
$ module load quay.io/biocontainers/hmftools-linx/2.0_beta--hdfd78af_2
$ module help quay.io/biocontainers/hmftools-linx/2.0_beta--hdfd78af_2
```
