---
layout: container
name:  "quay.io/biocontainers/bioconductor-escher"
maintainer: "@vsoch"
...
updated_at: "2024-12-08 03:56:50.724285"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-escher
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-escher:1.2.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-escher/1.2.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-escher/1.2.0--r43hdfd78af_0
```
...
#### bioconductor-escher-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-escher-inspect-deffile:
