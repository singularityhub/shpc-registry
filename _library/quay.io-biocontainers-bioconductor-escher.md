...
updated_at: "2023-07-26 03:23:36.335070"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-escher:1.0.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-escher/1.0.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-escher/1.0.0--r43hdfd78af_0
```
