...
updated_at: "2024-01-21 03:18:14.956966"
latest: "0.5.3--r43hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/r-acidplyr:0.5.3--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/r-acidplyr/0.5.3--r43hdfd78af_0
$ module help quay.io/biocontainers/r-acidplyr/0.5.3--r43hdfd78af_0
```
