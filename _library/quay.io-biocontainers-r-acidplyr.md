...
updated_at: "2024-01-06 03:10:44.244678"
latest: "0.5.2--r43hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/r-acidplyr:0.5.2--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/r-acidplyr/0.5.2--r43hdfd78af_0
$ module help quay.io/biocontainers/r-acidplyr/0.5.2--r43hdfd78af_0
```
