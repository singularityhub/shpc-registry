...
updated_at: "2025-01-15 03:30:55.116532"
...
```bash
$ shpc install quay.io/biocontainers/r-bulkanalyser:1.1.0--r44h3121a25_3
```
...
```bash
$ module load quay.io/biocontainers/r-bulkanalyser/1.1.0--r44h3121a25_3
$ module help quay.io/biocontainers/r-bulkanalyser/1.1.0--r44h3121a25_3
```
