...
updated_at: "2026-03-23 05:17:52.784611"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mouse4302probe:2.18.0--r45hdfd78af_14
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mouse4302probe/2.18.0--r45hdfd78af_14
$ module help quay.io/biocontainers/bioconductor-mouse4302probe/2.18.0--r45hdfd78af_14
```
