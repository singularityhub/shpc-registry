...
updated_at: "2024-03-18 03:34:59.502572"
...
```bash
$ shpc install quay.io/biocontainers/pyega3:5.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pyega3/5.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/pyega3/5.1.0--pyhdfd78af_0
```
