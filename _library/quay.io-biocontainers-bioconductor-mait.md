---
layout: container
name:  "quay.io/biocontainers/bioconductor-mait"
maintainer: "@vsoch"
...
updated_at: "2025-04-21 04:55:07.358794"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mait
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-mait:1.40.0--r44he5774e6_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mait/1.40.0--r44he5774e6_0
$ module help quay.io/biocontainers/bioconductor-mait/1.40.0--r44he5774e6_0
```
...
#### bioconductor-mait-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-mait-inspect-deffile:
