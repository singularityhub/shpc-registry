...
updated_at: "2022-10-29 08:12:30.000583"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mait:1.28.0--r41hc247a5b_2
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mait/1.28.0--r41hc247a5b_2
$ module help quay.io/biocontainers/bioconductor-mait/1.28.0--r41hc247a5b_2
```
