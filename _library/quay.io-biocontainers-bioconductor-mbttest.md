...
updated_at: "2026-02-06 04:31:17.601478"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mbttest:1.38.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mbttest/1.38.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-mbttest/1.38.0--r45hdfd78af_0
```
