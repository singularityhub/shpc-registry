...
updated_at: "2025-01-11 03:33:08.602915"
...
```bash
$ shpc install quay.io/biocontainers/kinex:1.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/kinex/1.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/kinex/1.2.0--pyhdfd78af_0
```
