---
layout: container
name:  "quay.io/biocontainers/kinex"
maintainer: "@vsoch"
...
updated_at: "2023-12-09 03:07:29.104128"
...
```bash
$ shpc install quay.io/biocontainers/kinex
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/kinex:1.0.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/kinex/1.0.1--pyhdfd78af_0
$ module help quay.io/biocontainers/kinex/1.0.1--pyhdfd78af_0
```
...
#### kinex-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### kinex-inspect-deffile:
