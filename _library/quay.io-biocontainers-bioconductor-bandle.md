...
updated_at: "2025-05-14 03:16:52.618540"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-bandle:1.6.0--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-bandle/1.6.0--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-bandle/1.6.0--r43hf17093f_0
```
