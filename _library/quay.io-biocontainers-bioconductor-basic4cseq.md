...
updated_at: "2022-11-03 00:26:37.950278"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-basic4cseq:1.6.0--r3.4.1_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-basic4cseq/1.6.0--r3.4.1_0
$ module help quay.io/biocontainers/bioconductor-basic4cseq/1.6.0--r3.4.1_0
```
