...
updated_at: "2026-04-03 15:25:05.492425"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-basic4cseq:1.46.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-basic4cseq/1.46.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-basic4cseq/1.46.0--r45hdfd78af_0
```
