...
updated_at: "2026-03-06 05:04:40.508917"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-lungexpression:0.48.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-lungexpression/0.48.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-lungexpression/0.48.0--r45hdfd78af_0
```
