...
updated_at: "2023-12-21 03:04:48.491021"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-sechm:1.8.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-sechm/1.8.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-sechm/1.8.0--r43hdfd78af_0
```
