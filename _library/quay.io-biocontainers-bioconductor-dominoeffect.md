...
updated_at: "2025-04-13 04:20:36.622831"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-dominoeffect:1.26.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-dominoeffect/1.26.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-dominoeffect/1.26.0--r44hdfd78af_0
```
