...
updated_at: "2024-08-12 03:39:32.575579"
...
```bash
$ shpc install quay.io/biocontainers/sqt:0.8.0--py310h4b81fae_5
```
...
```bash
$ module load quay.io/biocontainers/sqt/0.8.0--py310h4b81fae_5
$ module help quay.io/biocontainers/sqt/0.8.0--py310h4b81fae_5
```
