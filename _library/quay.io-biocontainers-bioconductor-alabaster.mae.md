...
updated_at: "2025-01-16 02:55:52.987306"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-alabaster.mae:1.2.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-alabaster.mae/1.2.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-alabaster.mae/1.2.0--r43hdfd78af_0
```
