...
updated_at: "2023-12-07 03:08:38.416039"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-alabaster.mae:1.0.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-alabaster.mae/1.0.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-alabaster.mae/1.0.0--r43hdfd78af_0
```
