...
updated_at: "2025-11-07 03:24:45.791792"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-alabaster.mae:1.6.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-alabaster.mae/1.6.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-alabaster.mae/1.6.0--r44hdfd78af_0
```
