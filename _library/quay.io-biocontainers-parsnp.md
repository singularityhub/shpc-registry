...
updated_at: "2025-01-05 03:03:44.560774"
latest: "2.1.1--h077b44d_1"
...
```bash
$ shpc install quay.io/biocontainers/parsnp:2.1.1--h077b44d_1
```
...
```bash
$ module load quay.io/biocontainers/parsnp/2.1.1--h077b44d_1
$ module help quay.io/biocontainers/parsnp/2.1.1--h077b44d_1
```
