...
updated_at: "2026-01-31 04:47:45.425114"
...
```bash
$ shpc install quay.io/biocontainers/parsnp:2.1.5--h077b44d_0
```
...
```bash
$ module load quay.io/biocontainers/parsnp/2.1.5--h077b44d_0
$ module help quay.io/biocontainers/parsnp/2.1.5--h077b44d_0
```
