...
updated_at: "2025-05-12 03:51:34.248217"
latest: "2.1.3--h077b44d_0"
...
```bash
$ shpc install quay.io/biocontainers/parsnp:2.1.3--h077b44d_0
```
...
```bash
$ module load quay.io/biocontainers/parsnp/2.1.3--h077b44d_0
$ module help quay.io/biocontainers/parsnp/2.1.3--h077b44d_0
```
