...
updated_at: "2024-04-22 03:10:34.834925"
latest: "2.0.4--hdcf5f25_0"
...
```bash
$ shpc install quay.io/biocontainers/parsnp:2.0.4--hdcf5f25_0
```
...
```bash
$ module load quay.io/biocontainers/parsnp/2.0.4--hdcf5f25_0
$ module help quay.io/biocontainers/parsnp/2.0.4--hdcf5f25_0
```
