...
updated_at: "2026-09-26 07:27:50.547360"
...
```bash
$ shpc install quay.io/biocontainers/parsnp:2.1.6--h3be2455_0
```
...
```bash
$ module load quay.io/biocontainers/parsnp/2.1.6--h3be2455_0
$ module help quay.io/biocontainers/parsnp/2.1.6--h3be2455_0
```
