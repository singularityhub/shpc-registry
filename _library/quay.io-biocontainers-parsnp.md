...
updated_at: "2024-12-09 03:23:40.896765"
latest: "2.1.1--hdcf5f25_0"
...
```bash
$ shpc install quay.io/biocontainers/parsnp:2.1.1--hdcf5f25_0
```
...
```bash
$ module load quay.io/biocontainers/parsnp/2.1.1--hdcf5f25_0
$ module help quay.io/biocontainers/parsnp/2.1.1--hdcf5f25_0
```
