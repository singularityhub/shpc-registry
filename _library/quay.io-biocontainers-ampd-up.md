---
layout: container
name:  "quay.io/biocontainers/ampd-up"
maintainer: "@vsoch"
...
updated_at: "2025-01-24 03:14:40.094865"
...
```bash
$ shpc install quay.io/biocontainers/ampd-up
```
...
#### ampd-up-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### ampd-up-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/AMPd-Up
$ podman run --it --rm --entrypoint /usr/local/bin/AMPd-Up   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/AMPd-Up   -v ${PWD} -w ${PWD} <container> -c " $@"
```
