...
updated_at: "2023-11-23 04:02:28.778219"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-river:1.24.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-river/1.24.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-river/1.24.0--r43hdfd78af_0
```
