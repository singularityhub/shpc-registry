...
updated_at: "2024-09-13 02:47:27.237404"
latest: "1.3.44"
...
```bash
$ shpc install quay.io/biocontainers/graphicsmagick:1.3.44
```
...
```bash
$ module load quay.io/biocontainers/graphicsmagick/1.3.44
$ module help quay.io/biocontainers/graphicsmagick/1.3.44
```
