...
updated_at: "2022-11-01 03:37:57.031554"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-seventygenedata:1.30.0--r41hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-seventygenedata/1.30.0--r41hdfd78af_1
$ module help quay.io/biocontainers/bioconductor-seventygenedata/1.30.0--r41hdfd78af_1
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-seventygenedata-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-seventygenedata-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-seventygenedata-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-seventygenedata-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-seventygenedata-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-seventygenedata-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
