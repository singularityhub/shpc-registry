...
updated_at: "2025-12-24 04:04:48.050530"
latest: "0.17.3--h13c227e_0"
...
```bash
$ shpc install quay.io/biocontainers/varfish-server-worker:0.17.3--h13c227e_0
```
...
```bash
$ module load quay.io/biocontainers/varfish-server-worker/0.17.3--h13c227e_0
$ module help quay.io/biocontainers/varfish-server-worker/0.17.3--h13c227e_0
```
