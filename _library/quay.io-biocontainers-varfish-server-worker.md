...
updated_at: "2026-07-02 06:46:11.566011"
latest: "0.17.3--h3628714_1"
...
```bash
$ shpc install quay.io/biocontainers/varfish-server-worker:0.17.3--h3628714_1
```
...
```bash
$ module load quay.io/biocontainers/varfish-server-worker/0.17.3--h3628714_1
$ module help quay.io/biocontainers/varfish-server-worker/0.17.3--h3628714_1
```
