...
updated_at: "2024-08-22 19:58:14.471340"
latest: "0.13.0--hb3cd794_0"
...
```bash
$ shpc install quay.io/biocontainers/varfish-server-worker:0.13.0--hb3cd794_0
```
...
```bash
$ module load quay.io/biocontainers/varfish-server-worker/0.13.0--hb3cd794_0
$ module help quay.io/biocontainers/varfish-server-worker/0.13.0--hb3cd794_0
```
