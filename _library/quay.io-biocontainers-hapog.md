...
updated_at: "2026-01-31 04:52:17.155294"
...
```bash
$ shpc install quay.io/biocontainers/hapog:1.3.8--py39hb49fbdb_3
```
...
```bash
$ module load quay.io/biocontainers/hapog/1.3.8--py39hb49fbdb_3
$ module help quay.io/biocontainers/hapog/1.3.8--py39hb49fbdb_3
```
