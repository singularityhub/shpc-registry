...
updated_at: "2024-04-21 03:01:38.348424"
latest: "1.3.8--py310h83093d7_0"
...
```bash
$ shpc install quay.io/biocontainers/hapog:1.3.8--py310h83093d7_0
```
...
```bash
$ module load quay.io/biocontainers/hapog/1.3.8--py310h83093d7_0
$ module help quay.io/biocontainers/hapog/1.3.8--py310h83093d7_0
```
