...
updated_at: "2025-08-11 03:53:57.019966"
latest: "0.14.0--h090f6cf_0"
...
```bash
$ shpc install quay.io/biocontainers/piscem:0.14.0--h090f6cf_0
```
...
```bash
$ module load quay.io/biocontainers/piscem/0.14.0--h090f6cf_0
$ module help quay.io/biocontainers/piscem/0.14.0--h090f6cf_0
```
