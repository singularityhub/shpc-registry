...
updated_at: "2026-06-04 06:56:23.584805"
latest: "0.20.0--h79c2db1_0"
...
```bash
$ shpc install quay.io/biocontainers/piscem:0.20.0--h79c2db1_0
```
...
```bash
$ module load quay.io/biocontainers/piscem/0.20.0--h79c2db1_0
$ module help quay.io/biocontainers/piscem/0.20.0--h79c2db1_0
```
