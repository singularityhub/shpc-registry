...
updated_at: "2025-08-28 12:16:05.951770"
latest: "0.14.2--h090f6cf_0"
...
```bash
$ shpc install quay.io/biocontainers/piscem:0.14.2--h090f6cf_0
```
...
```bash
$ module load quay.io/biocontainers/piscem/0.14.2--h090f6cf_0
$ module help quay.io/biocontainers/piscem/0.14.2--h090f6cf_0
```
