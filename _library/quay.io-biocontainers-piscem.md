...
updated_at: "2026-07-30 05:30:30.152569"
latest: "0.21.1--h79c2db1_0"
...
```bash
$ shpc install quay.io/biocontainers/piscem:0.21.1--h79c2db1_0
```
...
```bash
$ module load quay.io/biocontainers/piscem/0.21.1--h79c2db1_0
$ module help quay.io/biocontainers/piscem/0.21.1--h79c2db1_0
```
