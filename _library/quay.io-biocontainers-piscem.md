...
updated_at: "2026-04-30 08:31:41.052315"
latest: "0.18.0--h79c2db1_0"
...
```bash
$ shpc install quay.io/biocontainers/piscem:0.18.0--h79c2db1_0
```
...
```bash
$ module load quay.io/biocontainers/piscem/0.18.0--h79c2db1_0
$ module help quay.io/biocontainers/piscem/0.18.0--h79c2db1_0
```
