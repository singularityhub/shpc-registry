...
updated_at: "2024-04-09 02:24:33.626804"
latest: "0.8.0--h7c313c4_0"
...
```bash
$ shpc install quay.io/biocontainers/piscem:0.8.0--h7c313c4_0
```
...
```bash
$ module load quay.io/biocontainers/piscem/0.8.0--h7c313c4_0
$ module help quay.io/biocontainers/piscem/0.8.0--h7c313c4_0
```
