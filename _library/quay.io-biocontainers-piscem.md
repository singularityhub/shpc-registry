...
updated_at: "2026-03-28 16:38:42.980328"
latest: "0.16.2--h79c2db1_0"
...
```bash
$ shpc install quay.io/biocontainers/piscem:0.16.2--h79c2db1_0
```
...
```bash
$ module load quay.io/biocontainers/piscem/0.16.2--h79c2db1_0
$ module help quay.io/biocontainers/piscem/0.16.2--h79c2db1_0
```
