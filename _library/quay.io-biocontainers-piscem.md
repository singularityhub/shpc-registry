...
updated_at: "2025-07-03 18:54:56.692949"
latest: "0.13.0--h090f6cf_0"
...
```bash
$ shpc install quay.io/biocontainers/piscem:0.13.0--h090f6cf_0
```
...
```bash
$ module load quay.io/biocontainers/piscem/0.13.0--h090f6cf_0
$ module help quay.io/biocontainers/piscem/0.13.0--h090f6cf_0
```
