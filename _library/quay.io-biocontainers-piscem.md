...
updated_at: "2026-08-27 23:51:39.410360"
latest: "0.22.1--h79c2db1_0"
...
```bash
$ shpc install quay.io/biocontainers/piscem:0.22.1--h79c2db1_0
```
...
```bash
$ module load quay.io/biocontainers/piscem/0.22.1--h79c2db1_0
$ module help quay.io/biocontainers/piscem/0.22.1--h79c2db1_0
```
