...
updated_at: "2026-09-13 07:36:40.409621"
latest: "0.23.0--h79c2db1_0"
...
```bash
$ shpc install quay.io/biocontainers/piscem:0.23.0--h79c2db1_0
```
...
```bash
$ module load quay.io/biocontainers/piscem/0.23.0--h79c2db1_0
$ module help quay.io/biocontainers/piscem/0.23.0--h79c2db1_0
```
