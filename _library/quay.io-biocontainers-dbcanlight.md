...
updated_at: "2025-09-21 03:46:01.324906"
...
```bash
$ shpc install quay.io/biocontainers/dbcanlight:1.1.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/dbcanlight/1.1.1--pyhdfd78af_0
$ module help quay.io/biocontainers/dbcanlight/1.1.1--pyhdfd78af_0
```
