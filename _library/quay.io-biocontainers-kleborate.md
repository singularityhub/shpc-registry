...
updated_at: "2024-12-18 03:20:31.040767"
...
```bash
$ shpc install quay.io/biocontainers/kleborate:3.1.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/kleborate/3.1.2--pyhdfd78af_0
$ module help quay.io/biocontainers/kleborate/3.1.2--pyhdfd78af_0
```
