...
updated_at: "2024-08-29 03:08:12.875503"
...
```bash
$ shpc install quay.io/biocontainers/kleborate:3.0.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/kleborate/3.0.5--pyhdfd78af_0
$ module help quay.io/biocontainers/kleborate/3.0.5--pyhdfd78af_0
```
