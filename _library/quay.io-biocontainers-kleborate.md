...
updated_at: "2025-02-19 03:31:54.419496"
latest: "3.1.3--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/kleborate:3.1.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/kleborate/3.1.3--pyhdfd78af_0
$ module help quay.io/biocontainers/kleborate/3.1.3--pyhdfd78af_0
```
