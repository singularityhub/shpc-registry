...
updated_at: "2025-08-13 03:27:32.459775"
...
```bash
$ shpc install quay.io/biocontainers/cooler:0.10.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/cooler/0.10.3--pyhdfd78af_0
$ module help quay.io/biocontainers/cooler/0.10.3--pyhdfd78af_0
```
