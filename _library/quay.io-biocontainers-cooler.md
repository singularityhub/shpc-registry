...
updated_at: "2025-01-18 02:57:19.932312"
...
```bash
$ shpc install quay.io/biocontainers/cooler:0.10.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/cooler/0.10.2--pyhdfd78af_0
$ module help quay.io/biocontainers/cooler/0.10.2--pyhdfd78af_0
```
