...
updated_at: "2022-11-12 00:52:11.568051"
latest: "2.9--py36_1"
...
```bash
$ shpc install quay.io/biocontainers/mappy:2.9--py36_1
```
...
```bash
$ module load quay.io/biocontainers/mappy/2.9--py36_1
$ module help quay.io/biocontainers/mappy/2.9--py36_1
```
