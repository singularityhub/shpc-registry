...
updated_at: "2024-04-14 03:19:30.004731"
latest: "2.27--py310h83093d7_0"
...
```bash
$ shpc install quay.io/biocontainers/mappy:2.27--py310h83093d7_0
```
...
```bash
$ module load quay.io/biocontainers/mappy/2.27--py310h83093d7_0
$ module help quay.io/biocontainers/mappy/2.27--py310h83093d7_0
```
