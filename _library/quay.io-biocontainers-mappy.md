...
updated_at: "2026-08-21 18:37:32.442205"
latest: "2.31--py313hfeada96_0"
...
```bash
$ shpc install quay.io/biocontainers/mappy:2.31--py313hfeada96_0
```
...
```bash
$ module load quay.io/biocontainers/mappy/2.31--py313hfeada96_0
$ module help quay.io/biocontainers/mappy/2.31--py313hfeada96_0
```
