...
updated_at: "2026-04-02 04:54:13.524029"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-nadfinder:1.34.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-nadfinder/1.34.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-nadfinder/1.34.0--r45hdfd78af_0
```
