...
updated_at: "2025-10-10 03:55:06.317646"
...
```bash
$ shpc install quay.io/biocontainers/defense-finder:2.0.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/defense-finder/2.0.1--pyhdfd78af_0
$ module help quay.io/biocontainers/defense-finder/2.0.1--pyhdfd78af_0
```
