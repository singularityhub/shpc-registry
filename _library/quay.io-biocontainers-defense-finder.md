...
updated_at: "2023-12-10 02:36:22.000309"
...
```bash
$ shpc install quay.io/biocontainers/defense-finder:1.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/defense-finder/1.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/defense-finder/1.2.0--pyhdfd78af_0
```
