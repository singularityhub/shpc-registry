...
updated_at: "2026-05-26 21:50:08.461573"
...
```bash
$ shpc install quay.io/biocontainers/defense-finder:3.0.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/defense-finder/3.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/defense-finder/3.0.0--pyhdfd78af_0
```
