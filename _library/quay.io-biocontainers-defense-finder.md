...
updated_at: "2024-03-07 00:06:27.671232"
...
```bash
$ shpc install quay.io/biocontainers/defense-finder:1.2.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/defense-finder/1.2.1--pyhdfd78af_0
$ module help quay.io/biocontainers/defense-finder/1.2.1--pyhdfd78af_0
```
