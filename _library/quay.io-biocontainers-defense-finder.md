...
updated_at: "2025-05-19 03:53:36.925968"
...
```bash
$ shpc install quay.io/biocontainers/defense-finder:2.0.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/defense-finder/2.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/defense-finder/2.0.0--pyhdfd78af_0
```
