...
updated_at: "2026-02-03 04:57:44.916684"
...
```bash
$ shpc install quay.io/biocontainers/reduce:4.15--py39h2de1943_4
```
...
```bash
$ module load quay.io/biocontainers/reduce/4.15--py39h2de1943_4
$ module help quay.io/biocontainers/reduce/4.15--py39h2de1943_4
```
