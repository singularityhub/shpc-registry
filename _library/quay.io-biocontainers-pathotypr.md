---
layout: container
name:  "quay.io/biocontainers/pathotypr"
maintainer: "@vsoch"
...
updated_at: "2026-04-05 04:47:52.897513"
...
singularity registry hpc automated addition for pathotypr
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/pathotypr
```
...
#### pathotypr-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### pathotypr-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/pathotypr
$ podman run --it --rm --entrypoint /usr/local/bin/pathotypr   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/pathotypr   -v ${PWD} -w ${PWD} <container> -c " $@"
```
