...
updated_at: "2024-02-22 02:35:32.487529"
latest: "0.1.15--pyh7cba7a3_0"
...
```bash
$ shpc install quay.io/biocontainers/nanomotif:0.1.15--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/nanomotif/0.1.15--pyh7cba7a3_0
$ module help quay.io/biocontainers/nanomotif/0.1.15--pyh7cba7a3_0
```
