...
updated_at: "2024-02-05 03:00:28.304860"
...
```bash
$ shpc install quay.io/biocontainers/nanomotif:0.1.13--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/nanomotif/0.1.13--pyh7cba7a3_0
$ module help quay.io/biocontainers/nanomotif/0.1.13--pyh7cba7a3_0
```
