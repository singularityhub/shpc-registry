---
layout: container
name:  "quay.io/biocontainers/gpatch"
maintainer: "@vsoch"
...
updated_at: "2025-03-21 03:20:53.193009"
...
```bash
$ module load quay.io/biocontainers/gpatch/0.3.6--pyhdfd78af_0
$ module help quay.io/biocontainers/gpatch/0.3.6--pyhdfd78af_0
```
...
#### gpatch-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### gpatch-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/GPatch
$ podman run --it --rm --entrypoint /usr/local/bin/GPatch   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/GPatch   -v ${PWD} -w ${PWD} <container> -c " $@"
```
