---
layout: container
name:  "quay.io/biocontainers/bioconductor-goatea"
maintainer: "@vsoch"
...
updated_at: "2026-03-28 17:19:26.180429"
...
versions:
 - "1.0.2--r45hdfd78af_0"
description: "singularity registry hpc automated addition for bioconductor-goatea"
config: {"url": "https://biocontainers.pro/tools/bioconductor-goatea", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for bioconductor-goatea", "latest": {"1.0.2--r45hdfd78af_0": "sha256:7bfac2a10d1067fc65bfe295725e5fa4ad69038af7a004845bf203cda38b6c2b"}, "tags": {"1.0.2--r45hdfd78af_0": "sha256:7bfac2a10d1067fc65bfe295725e5fa4ad69038af7a004845bf203cda38b6c2b"}, "docker": "quay.io/biocontainers/bioconductor-goatea", "aliases": {"protoc-33.5.0": "/usr/local/bin/protoc-33.5.0", "protoc-gen-upb-33.5.0": "/usr/local/bin/protoc-gen-upb-33.5.0", "protoc-gen-upb_minitable-33.5.0": "/usr/local/bin/protoc-gen-upb_minitable-33.5.0", "protoc-gen-upbdefs-33.5.0": "/usr/local/bin/protoc-gen-upbdefs-33.5.0", "hb-raster": "/usr/local/bin/hb-raster", "hb-vector": "/usr/local/bin/hb-vector", "protoc-gen-upb_minitable": "/usr/local/bin/protoc-gen-upb_minitable", "h2benchmark": "/usr/local/bin/h2benchmark", "checksum-profile": "/usr/local/bin/checksum-profile", "elastishadow": "/usr/local/bin/elastishadow", "protoc-gen-upb": "/usr/local/bin/protoc-gen-upb", "protoc-gen-upbdefs": "/usr/local/bin/protoc-gen-upbdefs", "elastipubsub5": "/usr/local/bin/elastipubsub5", "mqtt5_app": "/usr/local/bin/mqtt5_app", "mqtt5_canary": "/usr/local/bin/mqtt5_canary", "mqtt5canary": "/usr/local/bin/mqtt5canary", "pandoc-lua": "/usr/local/bin/pandoc-lua", "elasticurl": "/usr/local/bin/elasticurl", "elasticurl_cpp": "/usr/local/bin/elasticurl_cpp", "elastipubsub": "/usr/local/bin/elastipubsub", "csv-import": "/usr/local/bin/csv-import", "orc-memory": "/usr/local/bin/orc-memory", "orc-scan": "/usr/local/bin/orc-scan", "timezone-dump": "/usr/local/bin/timezone-dump", "orc-contents": "/usr/local/bin/orc-contents"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/bioconductor-goatea.
singularity registry hpc automated addition for bioconductor-goatea
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/bioconductor-goatea
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-goatea:1.0.2--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-goatea/1.0.2--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-goatea/1.0.2--r45hdfd78af_0
```
...
#### bioconductor-goatea-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-goatea-inspect-deffile:
