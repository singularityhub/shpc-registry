...
updated_at: "2023-10-26 03:32:51.841167"
latest: "1.13.0--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/snakemake-interface-common:1.13.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake-interface-common/1.13.0--pyhdfd78af_0
$ module help quay.io/biocontainers/snakemake-interface-common/1.13.0--pyhdfd78af_0
```
