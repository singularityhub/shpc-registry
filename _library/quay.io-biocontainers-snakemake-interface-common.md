...
updated_at: "2026-06-28 06:51:14.030309"
latest: "1.23.0--pyhdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/snakemake-interface-common:1.23.0--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/snakemake-interface-common/1.23.0--pyhdfd78af_1
$ module help quay.io/biocontainers/snakemake-interface-common/1.23.0--pyhdfd78af_1
```
