...
updated_at: "2025-06-23 04:08:01.640424"
...
```bash
$ shpc install quay.io/biocontainers/snakemake-interface-common:1.18.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake-interface-common/1.18.0--pyhdfd78af_0
$ module help quay.io/biocontainers/snakemake-interface-common/1.18.0--pyhdfd78af_0
```
