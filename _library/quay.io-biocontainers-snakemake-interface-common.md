...
updated_at: "2024-10-05 03:23:22.962790"
latest: "1.17.3--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/snakemake-interface-common:1.17.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake-interface-common/1.17.3--pyhdfd78af_0
$ module help quay.io/biocontainers/snakemake-interface-common/1.17.3--pyhdfd78af_0
```
