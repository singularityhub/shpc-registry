...
updated_at: "2026-09-25 07:29:15.010294"
...
```bash
$ shpc install quay.io/biocontainers/snakemake-interface-common:1.23.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake-interface-common/1.23.1--pyhdfd78af_0
$ module help quay.io/biocontainers/snakemake-interface-common/1.23.1--pyhdfd78af_0
```
