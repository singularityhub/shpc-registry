...
updated_at: "2024-03-19 02:49:09.617537"
latest: "1.17.1--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/snakemake-interface-common:1.17.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake-interface-common/1.17.1--pyhdfd78af_0
$ module help quay.io/biocontainers/snakemake-interface-common/1.17.1--pyhdfd78af_0
```
