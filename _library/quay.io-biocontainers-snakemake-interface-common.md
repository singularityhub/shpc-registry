...
updated_at: "2025-08-25 03:45:23.201535"
latest: "1.21.0--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/snakemake-interface-common:1.21.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake-interface-common/1.21.0--pyhdfd78af_0
$ module help quay.io/biocontainers/snakemake-interface-common/1.21.0--pyhdfd78af_0
```
