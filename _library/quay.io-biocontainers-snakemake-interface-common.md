...
updated_at: "2025-03-22 03:33:23.293525"
latest: "1.17.4--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/snakemake-interface-common:1.17.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake-interface-common/1.17.4--pyhdfd78af_0
$ module help quay.io/biocontainers/snakemake-interface-common/1.17.4--pyhdfd78af_0
```
