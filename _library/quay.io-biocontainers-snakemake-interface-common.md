...
updated_at: "2026-03-31 04:43:29.958369"
latest: "1.23.0--pyh84498cf_0"
...
```bash
$ shpc install quay.io/biocontainers/snakemake-interface-common:1.23.0--pyh84498cf_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake-interface-common/1.23.0--pyh84498cf_0
$ module help quay.io/biocontainers/snakemake-interface-common/1.23.0--pyh84498cf_0
```
