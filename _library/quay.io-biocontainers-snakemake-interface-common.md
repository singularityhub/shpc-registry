...
updated_at: "2025-08-12 03:48:17.353882"
latest: "1.20.1--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/snakemake-interface-common:1.20.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake-interface-common/1.20.1--pyhdfd78af_0
$ module help quay.io/biocontainers/snakemake-interface-common/1.20.1--pyhdfd78af_0
```
