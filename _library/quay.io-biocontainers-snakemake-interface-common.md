...
updated_at: "2024-02-01 02:49:38.919367"
latest: "1.15.0--pyhdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/snakemake-interface-common:1.15.0--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/snakemake-interface-common/1.15.0--pyhdfd78af_1
$ module help quay.io/biocontainers/snakemake-interface-common/1.15.0--pyhdfd78af_1
```
