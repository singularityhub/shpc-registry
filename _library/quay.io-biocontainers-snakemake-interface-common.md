...
updated_at: "2024-03-14 02:48:33.505135"
...
```bash
$ shpc install quay.io/biocontainers/snakemake-interface-common:1.16.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake-interface-common/1.16.0--pyhdfd78af_0
$ module help quay.io/biocontainers/snakemake-interface-common/1.16.0--pyhdfd78af_0
```
