...
updated_at: "2026-04-01 05:46:32.178624"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-flowsorted.dlpfc.450k:1.46.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-flowsorted.dlpfc.450k/1.46.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-flowsorted.dlpfc.450k/1.46.0--r45hdfd78af_0
```
