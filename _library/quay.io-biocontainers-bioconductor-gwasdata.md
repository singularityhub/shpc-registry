...
updated_at: "2024-04-02 02:47:46.333403"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gwasdata:1.40.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gwasdata/1.40.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-gwasdata/1.40.0--r43hdfd78af_0
```
