...
updated_at: "2025-03-27 03:41:44.200475"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gwasdata:1.44.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gwasdata/1.44.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-gwasdata/1.44.0--r44hdfd78af_0
```
