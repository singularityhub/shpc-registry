...
updated_at: "2022-11-21 14:42:08.416205"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-chimeraviz:1.20.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-chimeraviz/1.20.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-chimeraviz/1.20.0--r41hdfd78af_0
```
