...
updated_at: "2023-06-29 03:44:47.958348"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-chimeraviz:1.24.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-chimeraviz/1.24.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-chimeraviz/1.24.0--r42hdfd78af_0
```
