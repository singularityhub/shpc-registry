---
layout: container
name:  "quay.io/biocontainers/quickbam"
maintainer: "@vsoch"
...
updated_at: "2024-12-09 03:20:56.118777"
...
versions:
 - "1.0.0--h4f9202f_1"
description: "singularity registry hpc automated addition for quickbam"
config: {"url": "https://biocontainers.pro/tools/quickbam", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for quickbam", "latest": {"1.0.0--h4f9202f_1": "sha256:44ea701b2fc72a8eadb45737d4be3fbdf831021adc0050337b62d5dac1c95bef"}, "tags": {"1.0.0--h4f9202f_1": "sha256:44ea701b2fc72a8eadb45737d4be3fbdf831021adc0050337b62d5dac1c95bef"}, "docker": "quay.io/biocontainers/quickbam", "aliases": {"flagstats-quickbam": "/usr/local/bin/flagstats-quickbam", "readcount-quickbam": "/usr/local/bin/readcount-quickbam", "snp-pileup-quickbam": "/usr/local/bin/snp-pileup-quickbam", "hwloc-gather-cpuid": "/usr/local/bin/hwloc-gather-cpuid", "hwloc-annotate": "/usr/local/bin/hwloc-annotate", "hwloc-bind": "/usr/local/bin/hwloc-bind", "hwloc-calc": "/usr/local/bin/hwloc-calc", "hwloc-compress-dir": "/usr/local/bin/hwloc-compress-dir", "hwloc-diff": "/usr/local/bin/hwloc-diff", "hwloc-distrib": "/usr/local/bin/hwloc-distrib", "hwloc-gather-topology": "/usr/local/bin/hwloc-gather-topology", "hwloc-info": "/usr/local/bin/hwloc-info", "hwloc-ls": "/usr/local/bin/hwloc-ls", "hwloc-patch": "/usr/local/bin/hwloc-patch", "hwloc-ps": "/usr/local/bin/hwloc-ps", "lstopo": "/usr/local/bin/lstopo", "lstopo-no-graphics": "/usr/local/bin/lstopo-no-graphics"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/quickbam.
singularity registry hpc automated addition for quickbam
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/quickbam
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/quickbam:1.0.0--h4f9202f_1
```
...
```bash
$ module load quay.io/biocontainers/quickbam/1.0.0--h4f9202f_1
$ module help quay.io/biocontainers/quickbam/1.0.0--h4f9202f_1
```
...
#### quickbam-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### quickbam-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/flagstats-quickbam
$ podman run --it --rm --entrypoint /usr/local/bin/flagstats-quickbam   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/flagstats-quickbam   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/readcount-quickbam
$ podman run --it --rm --entrypoint /usr/local/bin/readcount-quickbam   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/readcount-quickbam   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/snp-pileup-quickbam
$ podman run --it --rm --entrypoint /usr/local/bin/snp-pileup-quickbam   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/snp-pileup-quickbam   -v ${PWD} -w ${PWD} <container> -c " $@"
```
