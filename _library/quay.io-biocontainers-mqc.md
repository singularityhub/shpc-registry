...
updated_at: "2025-05-21 03:51:47.243426"
...
```bash
$ shpc install quay.io/biocontainers/mqc:1.10--py27pl5.22.0r3.4.1_1
```
...
```bash
$ module load quay.io/biocontainers/mqc/1.10--py27pl5.22.0r3.4.1_1
$ module help quay.io/biocontainers/mqc/1.10--py27pl5.22.0r3.4.1_1
```
