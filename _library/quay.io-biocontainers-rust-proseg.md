...
updated_at: "2026-08-30 08:17:45.623316"
...
```bash
$ shpc install quay.io/biocontainers/rust-proseg:3.2.0--hec9b1f2_0
```
...
```bash
$ module load quay.io/biocontainers/rust-proseg/3.2.0--hec9b1f2_0
$ module help quay.io/biocontainers/rust-proseg/3.2.0--hec9b1f2_0
```
