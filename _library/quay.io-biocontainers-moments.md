...
updated_at: "2025-05-07 03:42:22.235980"
latest: "1.3.1--py39hbcbf7aa_0"
...
```bash
$ shpc install quay.io/biocontainers/moments:1.3.1--py39hbcbf7aa_0
```
...
```bash
$ module load quay.io/biocontainers/moments/1.3.1--py39hbcbf7aa_0
$ module help quay.io/biocontainers/moments/1.3.1--py39hbcbf7aa_0
```
