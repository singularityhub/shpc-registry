...
updated_at: "2025-06-27 03:59:46.918028"
latest: "1.4.3--py310h1fe012e_0"
...
```bash
$ shpc install quay.io/biocontainers/moments:1.4.3--py310h1fe012e_0
```
...
```bash
$ module load quay.io/biocontainers/moments/1.4.3--py310h1fe012e_0
$ module help quay.io/biocontainers/moments/1.4.3--py310h1fe012e_0
```
