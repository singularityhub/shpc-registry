---
layout: container
name:  "quay.io/biocontainers/bioconductor-cardinalio"
maintainer: "@vsoch"
...
updated_at: "2023-12-13 02:31:52.694897"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cardinalio
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-cardinalio:1.0.0--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cardinalio/1.0.0--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-cardinalio/1.0.0--r43hf17093f_0
```
...
#### bioconductor-cardinalio-inspect:
...
#### bioconductor-cardinalio-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-cardinalio-inspect-deffile:
