...
updated_at: "2024-01-02 03:03:05.301125"
...
```bash
$ shpc install quay.io/biocontainers/degenotate:1.2.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/degenotate/1.2.4--pyhdfd78af_0
$ module help quay.io/biocontainers/degenotate/1.2.4--pyhdfd78af_0
```
