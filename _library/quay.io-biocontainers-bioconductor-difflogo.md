...
updated_at: "2025-12-24 04:01:50.944383"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-difflogo:2.30.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-difflogo/2.30.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-difflogo/2.30.0--r44hdfd78af_0
```
