...
updated_at: "2023-12-23 02:58:49.025802"
latest: "3.15.2--r43hdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ucscrepeatmasker:3.15.2--r43hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ucscrepeatmasker/3.15.2--r43hdfd78af_1
$ module help quay.io/biocontainers/bioconductor-ucscrepeatmasker/3.15.2--r43hdfd78af_1
```
