...
updated_at: "2026-04-05 04:49:45.725497"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ucscrepeatmasker:3.22.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ucscrepeatmasker/3.22.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ucscrepeatmasker/3.22.0--r45hdfd78af_0
```
