...
updated_at: "2023-12-01 02:47:55.634106"
latest: "2.6.3--r43hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-systempiper:2.6.3--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-systempiper/2.6.3--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-systempiper/2.6.3--r43hdfd78af_0
```
