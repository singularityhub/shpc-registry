...
updated_at: "2025-11-05 03:19:51.075236"
latest: "1.6.0--h44aa6d8_0"
...
```bash
$ shpc install quay.io/biocontainers/paladin:1.6.0--h44aa6d8_0
```
...
```bash
$ module load quay.io/biocontainers/paladin/1.6.0--h44aa6d8_0
$ module help quay.io/biocontainers/paladin/1.6.0--h44aa6d8_0
```
