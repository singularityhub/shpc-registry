...
updated_at: "2026-04-05 04:54:35.013979"
latest: "1.20.0--r45ha27e39d_1"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-msstatsconvert:1.20.0--r45ha27e39d_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-msstatsconvert/1.20.0--r45ha27e39d_1
$ module help quay.io/biocontainers/bioconductor-msstatsconvert/1.20.0--r45ha27e39d_1
```
