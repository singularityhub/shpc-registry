...
updated_at: "2026-05-09 06:27:01.009361"
latest: "1.15--h900cec7_0"
...
```bash
$ shpc install quay.io/biocontainers/andi:1.15--h900cec7_0
```
...
```bash
$ module load quay.io/biocontainers/andi/1.15--h900cec7_0
$ module help quay.io/biocontainers/andi/1.15--h900cec7_0
```
