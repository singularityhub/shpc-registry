...
updated_at: "2025-10-16 03:39:42.899105"
...
```bash
$ shpc install quay.io/biocontainers/tomm40_wgs:1.0.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/tomm40_wgs/1.0.0--hdfd78af_0
$ module help quay.io/biocontainers/tomm40_wgs/1.0.0--hdfd78af_0
```
