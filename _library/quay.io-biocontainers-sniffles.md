...
updated_at: "2025-03-30 03:55:02.155446"
...
```bash
$ shpc install quay.io/biocontainers/sniffles:2.6.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sniffles/2.6.1--pyhdfd78af_0
$ module help quay.io/biocontainers/sniffles/2.6.1--pyhdfd78af_0
```
