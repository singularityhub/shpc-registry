...
updated_at: "2025-09-27 03:37:20.785598"
...
```bash
$ shpc install quay.io/biocontainers/sniffles:2.6.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sniffles/2.6.3--pyhdfd78af_0
$ module help quay.io/biocontainers/sniffles/2.6.3--pyhdfd78af_0
```
