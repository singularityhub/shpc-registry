...
updated_at: "2026-01-21 04:31:37.182327"
...
```bash
$ shpc install quay.io/biocontainers/sniffles:2.7.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sniffles/2.7.2--pyhdfd78af_0
$ module help quay.io/biocontainers/sniffles/2.7.2--pyhdfd78af_0
```
