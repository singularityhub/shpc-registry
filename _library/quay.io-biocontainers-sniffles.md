...
updated_at: "2025-05-10 03:15:02.161221"
...
```bash
$ shpc install quay.io/biocontainers/sniffles:2.6.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sniffles/2.6.2--pyhdfd78af_0
$ module help quay.io/biocontainers/sniffles/2.6.2--pyhdfd78af_0
```
