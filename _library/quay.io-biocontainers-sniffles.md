...
updated_at: "2025-12-09 04:05:36.003874"
...
```bash
$ shpc install quay.io/biocontainers/sniffles:2.7.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sniffles/2.7.1--pyhdfd78af_0
$ module help quay.io/biocontainers/sniffles/2.7.1--pyhdfd78af_0
```
