...
updated_at: "2026-07-01 15:04:59.209405"
...
```bash
$ shpc install quay.io/biocontainers/sniffles:2.8.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sniffles/2.8.0--pyhdfd78af_0
$ module help quay.io/biocontainers/sniffles/2.8.0--pyhdfd78af_0
```
