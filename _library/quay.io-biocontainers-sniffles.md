...
updated_at: "2026-04-02 04:47:48.464108"
...
```bash
$ shpc install quay.io/biocontainers/sniffles:2.7.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sniffles/2.7.3--pyhdfd78af_0
$ module help quay.io/biocontainers/sniffles/2.7.3--pyhdfd78af_0
```
