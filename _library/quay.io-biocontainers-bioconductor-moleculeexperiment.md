...
updated_at: "2026-03-25 04:54:40.177600"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-moleculeexperiment:1.10.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-moleculeexperiment/1.10.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-moleculeexperiment/1.10.0--r45hdfd78af_0
```
