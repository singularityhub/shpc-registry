...
updated_at: "2023-12-15 02:30:24.124179"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-moleculeexperiment:1.0.1--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-moleculeexperiment/1.0.1--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-moleculeexperiment/1.0.1--r43hdfd78af_0
```
