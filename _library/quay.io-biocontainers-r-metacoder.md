...
updated_at: "2025-01-21 02:49:27.301799"
latest: "0.3.7--r44h40dc89f_1"
...
```bash
$ shpc install quay.io/biocontainers/r-metacoder:0.3.7--r44h40dc89f_1
```
...
```bash
$ module load quay.io/biocontainers/r-metacoder/0.3.7--r44h40dc89f_1
$ module help quay.io/biocontainers/r-metacoder/0.3.7--r44h40dc89f_1
```
