...
updated_at: "2026-06-16 08:10:46.735144"
latest: "0.3.9--r45h0df16ae_0"
...
```bash
$ shpc install quay.io/biocontainers/r-metacoder:0.3.9--r45h0df16ae_0
```
...
```bash
$ module load quay.io/biocontainers/r-metacoder/0.3.9--r45h0df16ae_0
$ module help quay.io/biocontainers/r-metacoder/0.3.9--r45h0df16ae_0
```
