...
updated_at: "2026-03-30 04:56:20.549232"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-spatialheatmap:2.16.3--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-spatialheatmap/2.16.3--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-spatialheatmap/2.16.3--r45hdfd78af_0
```
