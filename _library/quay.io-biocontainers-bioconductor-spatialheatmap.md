...
updated_at: "2026-01-10 04:11:31.618075"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-spatialheatmap:2.12.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-spatialheatmap/2.12.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-spatialheatmap/2.12.0--r44hdfd78af_0
```
