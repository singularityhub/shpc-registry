...
updated_at: "2024-05-02 02:57:39.906755"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-spatialheatmap:2.8.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-spatialheatmap/2.8.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-spatialheatmap/2.8.0--r43hdfd78af_0
```
