---
layout: container
name:  "quay.io/biocontainers/bioconductor-tenxxeniumdata"
maintainer: "@vsoch"
github: "https://github.com/singularityhub/shpc-registry/blob/main/quay.io/biocontainers/bioconductor-tenxxeniumdata/container.yaml"
config_url: "https://raw.githubusercontent.com/singularityhub/shpc-registry/main/quay.io/biocontainers/bioconductor-tenxxeniumdata/container.yaml"
updated_at: "2026-03-24 05:13:14.744982"
latest: "1.6.0--r45hdfd78af_0"
container_url: "https://biocontainers.pro/tools/bioconductor-tenxxeniumdata"
aliases:
 - "gdal"
 - "gdal_footprint"
 - "minigzip"
...
```bash
$ module load quay.io/biocontainers/bioconductor-tenxxeniumdata/1.6.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-tenxxeniumdata/1.6.0--r45hdfd78af_0
```
...
#### bioconductor-tenxxeniumdata-run:
...
#### bioconductor-tenxxeniumdata-shell:
...
#### bioconductor-tenxxeniumdata-exec:
...
#### bioconductor-tenxxeniumdata-inspect:
...
#### bioconductor-tenxxeniumdata-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-tenxxeniumdata-inspect-deffile:
