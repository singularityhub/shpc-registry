...
updated_at: "2023-11-04 02:33:45.500842"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-spatialomicsoverlay:1.0.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-spatialomicsoverlay/1.0.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-spatialomicsoverlay/1.0.0--r43hdfd78af_0
```
