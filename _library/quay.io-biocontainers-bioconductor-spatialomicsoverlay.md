...
updated_at: "2026-03-18 05:15:33.990877"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-spatialomicsoverlay:1.10.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-spatialomicsoverlay/1.10.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-spatialomicsoverlay/1.10.0--r45hdfd78af_0
```
