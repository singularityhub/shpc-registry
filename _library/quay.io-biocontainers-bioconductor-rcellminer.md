...
updated_at: "2026-03-16 05:36:35.786837"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rcellminer:2.32.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rcellminer/2.32.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rcellminer/2.32.0--r45hdfd78af_0
```
