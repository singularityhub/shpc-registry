...
updated_at: "2026-05-02 06:05:03.493694"
latest: "1.11.10--py310h7e8219e_1"
...
```bash
$ shpc install quay.io/biocontainers/csubst:1.11.10--py310h7e8219e_1
```
...
```bash
$ module load quay.io/biocontainers/csubst/1.11.10--py310h7e8219e_1
$ module help quay.io/biocontainers/csubst/1.11.10--py310h7e8219e_1
```
