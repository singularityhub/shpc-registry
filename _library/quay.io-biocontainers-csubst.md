...
updated_at: "2026-08-21 18:28:28.098514"
latest: "1.12.1--py313h534650d_0"
...
```bash
$ shpc install quay.io/biocontainers/csubst:1.12.1--py313h534650d_0
```
...
```bash
$ module load quay.io/biocontainers/csubst/1.12.1--py313h534650d_0
$ module help quay.io/biocontainers/csubst/1.12.1--py313h534650d_0
```
