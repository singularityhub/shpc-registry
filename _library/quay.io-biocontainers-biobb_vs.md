...
updated_at: "2026-06-04 06:52:11.733837"
latest: "5.2.1--pyhdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/biobb_vs:5.2.1--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/biobb_vs/5.2.1--pyhdfd78af_1
$ module help quay.io/biocontainers/biobb_vs/5.2.1--pyhdfd78af_1
```
