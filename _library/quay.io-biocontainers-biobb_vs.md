...
updated_at: "2023-05-25 03:03:14.568930"
latest: "4.0.0--pyhdfd78af_2"
...
```bash
$ shpc install quay.io/biocontainers/biobb_vs:4.0.0--pyhdfd78af_2
```
...
```bash
$ module load quay.io/biocontainers/biobb_vs/4.0.0--pyhdfd78af_2
$ module help quay.io/biocontainers/biobb_vs/4.0.0--pyhdfd78af_2
```
