...
updated_at: "2026-02-05 04:31:51.639897"
...
```bash
$ shpc install quay.io/biocontainers/biobb_vs:5.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_vs/5.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/biobb_vs/5.2.0--pyhdfd78af_0
```
