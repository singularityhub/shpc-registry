...
updated_at: "2026-09-02 07:35:09.029116"
...
```bash
$ shpc install quay.io/biocontainers/biobb_vs:5.3.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_vs/5.3.0--pyhdfd78af_0
$ module help quay.io/biocontainers/biobb_vs/5.3.0--pyhdfd78af_0
```
