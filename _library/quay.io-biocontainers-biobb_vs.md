...
updated_at: "2026-04-05 05:18:14.617087"
...
```bash
$ shpc install quay.io/biocontainers/biobb_vs:5.2.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_vs/5.2.1--pyhdfd78af_0
$ module help quay.io/biocontainers/biobb_vs/5.2.1--pyhdfd78af_0
```
