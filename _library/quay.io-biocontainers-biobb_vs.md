...
updated_at: "2025-09-01 04:44:29.564552"
...
```bash
$ shpc install quay.io/biocontainers/biobb_vs:5.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_vs/5.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/biobb_vs/5.1.0--pyhdfd78af_0
```
