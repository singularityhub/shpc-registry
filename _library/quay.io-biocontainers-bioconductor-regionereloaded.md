...
updated_at: "2024-02-23 02:36:52.412240"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-regionereloaded:1.4.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-regionereloaded/1.4.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-regionereloaded/1.4.0--r43hdfd78af_0
```
