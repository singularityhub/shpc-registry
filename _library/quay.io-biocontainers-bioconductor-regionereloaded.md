...
updated_at: "2023-05-03 02:59:52.063638"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-regionereloaded:1.0.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-regionereloaded/1.0.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-regionereloaded/1.0.0--r42hdfd78af_0
```
