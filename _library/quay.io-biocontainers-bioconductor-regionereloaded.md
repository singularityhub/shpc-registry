...
updated_at: "2025-11-04 03:22:16.243972"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-regionereloaded:1.8.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-regionereloaded/1.8.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-regionereloaded/1.8.0--r44hdfd78af_0
```
