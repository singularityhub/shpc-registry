...
updated_at: "2023-12-06 03:11:30.626326"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-regionereloaded:1.2.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-regionereloaded/1.2.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-regionereloaded/1.2.0--r43hdfd78af_0
```
