...
updated_at: "2026-03-04 04:18:34.940684"
...
```bash
$ shpc install quay.io/biocontainers/sr2silo:1.8.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sr2silo/1.8.0--pyhdfd78af_0
$ module help quay.io/biocontainers/sr2silo/1.8.0--pyhdfd78af_0
```
