...
updated_at: "2026-02-03 04:53:57.195759"
...
```bash
$ shpc install quay.io/biocontainers/sr2silo:1.7.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sr2silo/1.7.0--pyhdfd78af_0
$ module help quay.io/biocontainers/sr2silo/1.7.0--pyhdfd78af_0
```
