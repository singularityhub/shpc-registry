...
updated_at: "2025-10-23 03:40:26.953494"
...
```bash
$ shpc install quay.io/biocontainers/sr2silo:1.5.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sr2silo/1.5.0--pyhdfd78af_0
$ module help quay.io/biocontainers/sr2silo/1.5.0--pyhdfd78af_0
```
