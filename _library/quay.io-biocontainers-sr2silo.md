...
updated_at: "2025-12-22 05:39:02.032035"
...
```bash
$ shpc install quay.io/biocontainers/sr2silo:1.6.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sr2silo/1.6.1--pyhdfd78af_0
$ module help quay.io/biocontainers/sr2silo/1.6.1--pyhdfd78af_0
```
