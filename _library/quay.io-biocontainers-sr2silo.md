...
updated_at: "2025-12-15 04:22:01.167994"
...
```bash
$ shpc install quay.io/biocontainers/sr2silo:1.6.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sr2silo/1.6.0--pyhdfd78af_0
$ module help quay.io/biocontainers/sr2silo/1.6.0--pyhdfd78af_0
```
