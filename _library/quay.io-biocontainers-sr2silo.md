...
updated_at: "2025-09-29 03:39:01.348086"
...
```bash
$ shpc install quay.io/biocontainers/sr2silo:1.4.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sr2silo/1.4.0--pyhdfd78af_0
$ module help quay.io/biocontainers/sr2silo/1.4.0--pyhdfd78af_0
```
