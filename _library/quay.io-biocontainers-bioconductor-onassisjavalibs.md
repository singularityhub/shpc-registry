...
updated_at: "2022-10-29 18:00:04.127487"
latest: "1.8.0--r36_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-onassisjavalibs:1.8.0--r36_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-onassisjavalibs/1.8.0--r36_0
$ module help quay.io/biocontainers/bioconductor-onassisjavalibs/1.8.0--r36_0
```
