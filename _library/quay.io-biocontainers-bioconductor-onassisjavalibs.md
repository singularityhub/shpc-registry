...
updated_at: "2025-05-14 03:40:44.043775"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-onassisjavalibs:1.28.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-onassisjavalibs/1.28.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-onassisjavalibs/1.28.0--r44hdfd78af_0
```
