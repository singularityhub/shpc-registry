...
updated_at: "2025-05-06 03:28:21.892029"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-bioccheck:1.42.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-bioccheck/1.42.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-bioccheck/1.42.0--r44hdfd78af_0
```
