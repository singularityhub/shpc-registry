...
updated_at: "2023-05-23 02:59:02.769990"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ensdb.hsapiens.v79:2.99.0--r42hdfd78af_10
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ensdb.hsapiens.v79/2.99.0--r42hdfd78af_10
$ module help quay.io/biocontainers/bioconductor-ensdb.hsapiens.v79/2.99.0--r42hdfd78af_10
```
