...
updated_at: "2025-11-17 04:15:05.886463"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-geneclassifiers:1.30.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-geneclassifiers/1.30.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-geneclassifiers/1.30.0--r44hdfd78af_0
```
