...
updated_at: "2024-04-24 02:32:00.030713"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-geneclassifiers:1.26.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-geneclassifiers/1.26.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-geneclassifiers/1.26.0--r43hdfd78af_0
```
