...
updated_at: "2026-03-13 16:54:47.148629"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-geneclassifiers:1.34.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-geneclassifiers/1.34.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-geneclassifiers/1.34.0--r45hdfd78af_0
```
