...
updated_at: "2023-11-09 02:56:22.265607"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-test2cdf:2.18.0--r43hdfd78af_11
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-test2cdf/2.18.0--r43hdfd78af_11
$ module help quay.io/biocontainers/bioconductor-test2cdf/2.18.0--r43hdfd78af_11
```
