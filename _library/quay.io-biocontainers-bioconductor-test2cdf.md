...
updated_at: "2022-11-05 00:05:35.297061"
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-test2cdf-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-test2cdf-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-test2cdf-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-test2cdf-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-test2cdf-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-test2cdf-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
