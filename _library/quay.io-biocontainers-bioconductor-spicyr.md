...
updated_at: "2026-03-25 04:48:25.995992"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-spicyr:1.22.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-spicyr/1.22.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-spicyr/1.22.0--r45hdfd78af_0
```
