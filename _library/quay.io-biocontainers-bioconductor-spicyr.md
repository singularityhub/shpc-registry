...
updated_at: "2023-11-10 02:46:13.833715"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-spicyr:1.12.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-spicyr/1.12.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-spicyr/1.12.0--r43hdfd78af_0
```
