...
updated_at: "2023-11-28 02:34:45.479917"
latest: "0.99.1--r43hdfd78af_3"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ahcytobands:0.99.1--r43hdfd78af_3
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ahcytobands/0.99.1--r43hdfd78af_3
$ module help quay.io/biocontainers/bioconductor-ahcytobands/0.99.1--r43hdfd78af_3
```
