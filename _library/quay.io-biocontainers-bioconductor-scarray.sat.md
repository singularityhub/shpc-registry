...
updated_at: "2025-04-25 02:48:30.629158"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-scarray.sat:1.6.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-scarray.sat/1.6.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-scarray.sat/1.6.0--r44hdfd78af_0
```
