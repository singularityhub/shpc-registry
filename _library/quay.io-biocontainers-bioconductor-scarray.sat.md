---
layout: container
name:  "quay.io/biocontainers/bioconductor-scarray.sat"
maintainer: "@vsoch"
...
updated_at: "2026-04-02 05:24:59.685981"
latest: "1.9.0--r45hdfd78af_0"
...
versions:
 ...
 - "1.6.0--r44hdfd78af_0"
 - "1.9.0--r45hdfd78af_0"
description: "singularity registry hpc automated addition for bioconductor-scarray.sat"
config: {"url": "https://biocontainers.pro/tools/bioconductor-scarray.sat", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for bioconductor-scarray.sat", "latest": {"1.9.0--r45hdfd78af_0": "sha256:44b04184727889de1807326efdc2ea31282a358c87cf2a49820eb3c56d4dc37f"}, "tags": {"1.0.2--r43hdfd78af_0": "sha256:1c4cb00668ed99e023c69a05f63b5a8ca2b5da8adae26d95222594f59a2a82fa", "1.2.0--r43hdfd78af_0": "sha256:76bfd1e1535df9f1c2b2d6505e7f476c9b802c60ad7defb5df51c34b320f394c", "1.6.0--r44hdfd78af_0": "sha256:94516822074bfae0c47c05c18b47fe670489ab11713c09779d8a97ead2a1deec", "1.9.0--r45hdfd78af_0": "sha256:44b04184727889de1807326efdc2ea31282a358c87cf2a49820eb3c56d4dc37f"}, "docker": "quay.io/biocontainers/bioconductor-scarray.sat", "aliases": {"geosop": "/usr/local/bin/geosop", "geos-config": "/usr/local/bin/geos-config", "hb-info": "/usr/local/bin/hb-info", "tjbench": "/usr/local/bin/tjbench", "glpsol": "/usr/local/bin/glpsol", "2to3-3.11": "/usr/local/bin/2to3-3.11", "idle3.11": "/usr/local/bin/idle3.11", "pydoc3.11": "/usr/local/bin/pydoc3.11", "python3.11": "/usr/local/bin/python3.11", "python3.11-config": "/usr/local/bin/python3.11-config", "installBiocDataPackage.sh": "/usr/local/bin/installBiocDataPackage.sh", "tomlq": "/usr/local/bin/tomlq", "xq": "/usr/local/bin/xq", "yq": "/usr/local/bin/yq", "jq": "/usr/local/bin/jq", "onig-config": "/usr/local/bin/onig-config", "activate-global-python-argcomplete": "/usr/local/bin/activate-global-python-argcomplete", "python-argcomplete-check-easy-install-script": "/usr/local/bin/python-argcomplete-check-easy-install-script", "register-python-argcomplete": "/usr/local/bin/register-python-argcomplete", "pandoc": "/usr/local/bin/pandoc", "python3.1": "/usr/local/bin/python3.1"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/bioconductor-scarray.sat.
singularity registry hpc automated addition for bioconductor-scarray.sat
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/bioconductor-scarray.sat
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-scarray.sat:1.9.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-scarray.sat/1.9.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-scarray.sat/1.9.0--r45hdfd78af_0
```
...
#### bioconductor-scarray.sat-shell:
...
#### bioconductor-scarray.sat-inspect:
...
#### bioconductor-scarray.sat-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-scarray.sat-inspect-deffile:
