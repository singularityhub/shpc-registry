...
updated_at: "2024-06-17 02:59:39.939443"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-methinheritsim:1.24.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-methinheritsim/1.24.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-methinheritsim/1.24.0--r43hdfd78af_0
```
