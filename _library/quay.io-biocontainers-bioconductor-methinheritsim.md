...
updated_at: "2026-04-03 15:48:38.169190"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-methinheritsim:1.32.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-methinheritsim/1.32.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-methinheritsim/1.32.0--r45hdfd78af_0
```
