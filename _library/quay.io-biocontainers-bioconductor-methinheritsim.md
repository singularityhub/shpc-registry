...
updated_at: "2022-11-23 00:20:02.882540"
latest: "1.8.0--r36_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-methinheritsim:1.8.0--r36_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-methinheritsim/1.8.0--r36_0
$ module help quay.io/biocontainers/bioconductor-methinheritsim/1.8.0--r36_0
```
