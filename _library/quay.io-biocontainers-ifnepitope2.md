---
layout: container
name:  "quay.io/biocontainers/ifnepitope2"
maintainer: "@vsoch"
...
updated_at: "2026-06-20 06:31:58.225729"
...
```bash
$ module load quay.io/biocontainers/ifnepitope2/1.2--pyh106432d_0
$ module help quay.io/biocontainers/ifnepitope2/1.2--pyh106432d_0
```
...
#### ifnepitope2-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### ifnepitope2-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/ifnepitope2
$ podman run --it --rm --entrypoint /usr/local/bin/ifnepitope2   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/ifnepitope2   -v ${PWD} -w ${PWD} <container> -c " $@"
```
