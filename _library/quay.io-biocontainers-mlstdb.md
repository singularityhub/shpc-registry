...
updated_at: "2026-06-01 07:44:41.277290"
...
```bash
$ shpc install quay.io/biocontainers/mlstdb:1.2.0--pyh106432d_0
```
...
```bash
$ module load quay.io/biocontainers/mlstdb/1.2.0--pyh106432d_0
$ module help quay.io/biocontainers/mlstdb/1.2.0--pyh106432d_0
```
