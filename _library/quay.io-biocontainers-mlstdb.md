...
updated_at: "2026-05-05 05:21:10.643443"
...
```bash
$ shpc install quay.io/biocontainers/mlstdb:1.1.1--pyh106432d_0
```
...
```bash
$ module load quay.io/biocontainers/mlstdb/1.1.1--pyh106432d_0
$ module help quay.io/biocontainers/mlstdb/1.1.1--pyh106432d_0
```
