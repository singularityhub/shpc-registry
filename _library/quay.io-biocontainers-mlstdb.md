...
updated_at: "2026-06-28 06:33:15.446969"
latest: "1.3.0--pyh106432d_0"
...
```bash
$ shpc install quay.io/biocontainers/mlstdb:1.3.0--pyh106432d_0
```
...
```bash
$ module load quay.io/biocontainers/mlstdb/1.3.0--pyh106432d_0
$ module help quay.io/biocontainers/mlstdb/1.3.0--pyh106432d_0
```
