...
updated_at: "2026-04-03 04:55:44.855637"
...
```bash
$ shpc install quay.io/biocontainers/mlstdb:1.1.0--pyh106432d_0
```
...
```bash
$ module load quay.io/biocontainers/mlstdb/1.1.0--pyh106432d_0
$ module help quay.io/biocontainers/mlstdb/1.1.0--pyh106432d_0
```
