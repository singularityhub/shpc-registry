...
updated_at: "2022-10-29 08:22:35.740154"
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-curatedmetagenomicdata-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-curatedmetagenomicdata-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-curatedmetagenomicdata-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-curatedmetagenomicdata-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-curatedmetagenomicdata-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-curatedmetagenomicdata-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
