...
updated_at: "2026-04-03 16:07:03.547072"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-huo22.db:3.2.3--r45hdfd78af_14
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-huo22.db/3.2.3--r45hdfd78af_14
$ module help quay.io/biocontainers/bioconductor-huo22.db/3.2.3--r45hdfd78af_14
```
