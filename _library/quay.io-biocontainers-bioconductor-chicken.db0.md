...
updated_at: "2025-12-04 03:55:22.545177"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-chicken.db0:3.20.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-chicken.db0/3.20.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-chicken.db0/3.20.0--r44hdfd78af_0
```
