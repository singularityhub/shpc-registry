...
updated_at: "2022-10-29 05:59:00.954400"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rnainteract:1.42.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rnainteract/1.42.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rnainteract/1.42.0--r41hdfd78af_0
```
