...
updated_at: "2022-11-03 23:42:06.072531"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-clusterexperiment:2.8.0--r40h5f743cb_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-clusterexperiment/2.8.0--r40h5f743cb_0
$ module help quay.io/biocontainers/bioconductor-clusterexperiment/2.8.0--r40h5f743cb_0
```
