...
updated_at: "2023-09-20 03:17:13.737945"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-clusterexperiment:2.20.0--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-clusterexperiment/2.20.0--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-clusterexperiment/2.20.0--r43hf17093f_0
```
