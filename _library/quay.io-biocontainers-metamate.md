...
updated_at: "2026-06-06 16:09:47.316145"
latest: "0.5.4--pyr45h106432d_0"
...
```bash
$ shpc install quay.io/biocontainers/metamate:0.5.4--pyr45h106432d_0
```
...
```bash
$ module load quay.io/biocontainers/metamate/0.5.4--pyr45h106432d_0
$ module help quay.io/biocontainers/metamate/0.5.4--pyr45h106432d_0
```
