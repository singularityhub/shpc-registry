...
updated_at: "2026-06-26 07:03:33.246559"
latest: "0.5.7--pyr45h106432d_0"
...
```bash
$ shpc install quay.io/biocontainers/metamate:0.5.7--pyr45h106432d_0
```
...
```bash
$ module load quay.io/biocontainers/metamate/0.5.7--pyr45h106432d_0
$ module help quay.io/biocontainers/metamate/0.5.7--pyr45h106432d_0
```
