...
updated_at: "2026-04-03 15:30:50.401378"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-isolde:1.38.0--r45h01b2380_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-isolde/1.38.0--r45h01b2380_0
$ module help quay.io/biocontainers/bioconductor-isolde/1.38.0--r45h01b2380_0
```
