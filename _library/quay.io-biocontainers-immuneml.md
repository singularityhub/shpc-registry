...
updated_at: "2025-05-20 03:43:06.366099"
latest: "3.0.14--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/immuneml:3.0.14--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/immuneml/3.0.14--pyhdfd78af_0
$ module help quay.io/biocontainers/immuneml/3.0.14--pyhdfd78af_0
```
