...
updated_at: "2023-03-22 02:52:47.719989"
latest: "2.2.3--py37h8902056_0"
...
```bash
$ shpc install quay.io/biocontainers/immuneml:2.2.3--py37h8902056_0
```
...
```bash
$ module load quay.io/biocontainers/immuneml/2.2.3--py37h8902056_0
$ module help quay.io/biocontainers/immuneml/2.2.3--py37h8902056_0
```
