...
updated_at: "2025-12-12 03:33:26.216126"
latest: "0.3.14--pyhdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/capcruncher:0.3.14--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/capcruncher/0.3.14--pyhdfd78af_1
$ module help quay.io/biocontainers/capcruncher/0.3.14--pyhdfd78af_1
```
