...
updated_at: "2024-02-01 02:41:17.979678"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gnet2:1.18.0--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gnet2/1.18.0--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-gnet2/1.18.0--r43hf17093f_0
```
