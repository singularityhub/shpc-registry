...
updated_at: "2023-07-03 03:47:28.336932"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gnet2:1.14.0--r42hf17093f_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gnet2/1.14.0--r42hf17093f_1
$ module help quay.io/biocontainers/bioconductor-gnet2/1.14.0--r42hf17093f_1
```
