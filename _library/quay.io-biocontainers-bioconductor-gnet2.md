...
updated_at: "2025-01-23 02:56:34.831657"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gnet2:1.18.0--r43hf17093f_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gnet2/1.18.0--r43hf17093f_1
$ module help quay.io/biocontainers/bioconductor-gnet2/1.18.0--r43hf17093f_1
```
