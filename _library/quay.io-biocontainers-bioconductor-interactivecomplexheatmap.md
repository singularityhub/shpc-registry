...
updated_at: "2026-03-25 04:38:30.039118"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-interactivecomplexheatmap:1.18.1--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-interactivecomplexheatmap/1.18.1--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-interactivecomplexheatmap/1.18.1--r45hdfd78af_0
```
