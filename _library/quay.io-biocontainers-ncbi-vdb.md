...
updated_at: "2026-01-30 04:56:14.742055"
latest: "3.3.0--h9948957_0"
...
```bash
$ shpc install quay.io/biocontainers/ncbi-vdb:3.3.0--h9948957_0
```
...
```bash
$ module load quay.io/biocontainers/ncbi-vdb/3.3.0--h9948957_0
$ module help quay.io/biocontainers/ncbi-vdb/3.3.0--h9948957_0
```
