...
updated_at: "2024-04-28 03:00:31.146053"
latest: "3.1.0--h4ac6f70_2"
...
```bash
$ shpc install quay.io/biocontainers/ncbi-vdb:3.1.0--h4ac6f70_2
```
...
```bash
$ module load quay.io/biocontainers/ncbi-vdb/3.1.0--h4ac6f70_2
$ module help quay.io/biocontainers/ncbi-vdb/3.1.0--h4ac6f70_2
```
