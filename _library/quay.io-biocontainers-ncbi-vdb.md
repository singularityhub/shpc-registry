...
updated_at: "2025-02-15 03:24:37.858121"
latest: "3.2.0--h9948957_0"
...
```bash
$ shpc install quay.io/biocontainers/ncbi-vdb:3.2.0--h9948957_0
```
...
```bash
$ module load quay.io/biocontainers/ncbi-vdb/3.2.0--h9948957_0
$ module help quay.io/biocontainers/ncbi-vdb/3.2.0--h9948957_0
```
