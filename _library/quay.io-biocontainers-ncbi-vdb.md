...
updated_at: "2024-12-11 03:32:09.414397"
latest: "3.1.1--h4ac6f70_2"
...
```bash
$ shpc install quay.io/biocontainers/ncbi-vdb:3.1.1--h4ac6f70_2
```
...
```bash
$ module load quay.io/biocontainers/ncbi-vdb/3.1.1--h4ac6f70_2
$ module help quay.io/biocontainers/ncbi-vdb/3.1.1--h4ac6f70_2
```
