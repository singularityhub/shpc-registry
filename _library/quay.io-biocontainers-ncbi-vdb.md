...
updated_at: "2026-06-16 07:36:15.616259"
latest: "3.4.1--hd63eeec_0"
...
```bash
$ shpc install quay.io/biocontainers/ncbi-vdb:3.4.1--hd63eeec_0
```
...
```bash
$ module load quay.io/biocontainers/ncbi-vdb/3.4.1--hd63eeec_0
$ module help quay.io/biocontainers/ncbi-vdb/3.4.1--hd63eeec_0
```
