...
updated_at: "2025-04-08 03:21:25.119572"
...
```bash
$ shpc install quay.io/biocontainers/prymer:3.0.2--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/prymer/3.0.2--pyhdfd78af_1
$ module help quay.io/biocontainers/prymer/3.0.2--pyhdfd78af_1
```
