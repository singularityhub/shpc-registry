...
updated_at: "2025-03-11 03:17:01.558975"
...
```bash
$ shpc install quay.io/biocontainers/prymer:3.0.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/prymer/3.0.2--pyhdfd78af_0
$ module help quay.io/biocontainers/prymer/3.0.2--pyhdfd78af_0
```
