...
updated_at: "2025-01-27 02:59:28.697467"
...
```bash
$ shpc install quay.io/biocontainers/prymer:3.0.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/prymer/3.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/prymer/3.0.0--pyhdfd78af_0
```
