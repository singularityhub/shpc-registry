...
updated_at: "2026-01-16 03:47:01.248349"
latest: "1.0--h7b50bb2_4"
...
```bash
$ shpc install quay.io/biocontainers/emvc-2:1.0--h7b50bb2_4
```
...
```bash
$ module load quay.io/biocontainers/emvc-2/1.0--h7b50bb2_4
$ module help quay.io/biocontainers/emvc-2/1.0--h7b50bb2_4
```
