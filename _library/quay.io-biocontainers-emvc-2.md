...
updated_at: "2025-01-28 02:51:12.021294"
latest: "1.0--h7b50bb2_3"
...
```bash
$ shpc install quay.io/biocontainers/emvc-2:1.0--h7b50bb2_3
```
...
```bash
$ module load quay.io/biocontainers/emvc-2/1.0--h7b50bb2_3
$ module help quay.io/biocontainers/emvc-2/1.0--h7b50bb2_3
```
