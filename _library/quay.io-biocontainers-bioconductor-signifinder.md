...
updated_at: "2023-09-11 03:04:29.600521"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-signifinder:1.2.1--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-signifinder/1.2.1--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-signifinder/1.2.1--r43hdfd78af_0
```
