---
layout: container
name:  "quay.io/biocontainers/chemap"
maintainer: "@vsoch"
...
updated_at: "2026-08-29 09:04:46.660254"
...
versions:
 - "0.3.7--pyh106432d_0"
description: "singularity registry hpc automated addition for chemap"
config: {"url": "https://biocontainers.pro/tools/chemap", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for chemap", "latest": {"0.3.7--pyh106432d_0": "sha256:3a5cdd21bb8c1fddb54545e0947ca2aece6aadf6cbd6511bb9045266c80884e6"}, "tags": {"0.3.7--pyh106432d_0": "sha256:3a5cdd21bb8c1fddb54545e0947ca2aece6aadf6cbd6511bb9045266c80884e6"}, "docker": "quay.io/biocontainers/chemap", "aliases": {"e3fp-conformer": "/usr/local/bin/e3fp-conformer", "e3fp-fingerprint": "/usr/local/bin/e3fp-fingerprint", "map4": "/usr/local/bin/map4", "storus": "/usr/local/bin/storus", "storus-validate": "/usr/local/bin/storus-validate", "hf": "/usr/local/bin/hf", "tiny-agents": "/usr/local/bin/tiny-agents", "huggingface-cli": "/usr/local/bin/huggingface-cli", "idna": "/usr/local/bin/idna", "ldapadd": "/usr/local/bin/ldapadd", "ldapcompare": "/usr/local/bin/ldapcompare", "ldapdelete": "/usr/local/bin/ldapdelete", "ldapexop": "/usr/local/bin/ldapexop", "ldapmodify": "/usr/local/bin/ldapmodify", "ldapmodrdn": "/usr/local/bin/ldapmodrdn", "ldappasswd": "/usr/local/bin/ldappasswd", "ldapsearch": "/usr/local/bin/ldapsearch", "ldapurl": "/usr/local/bin/ldapurl", "ldapvc": "/usr/local/bin/ldapvc", "ldapwhoami": "/usr/local/bin/ldapwhoami", "httpx": "/usr/local/bin/httpx", "fc-genconf": "/usr/local/bin/fc-genconf", "pg_config": "/usr/local/bin/pg_config", "numba": "/usr/local/bin/numba", "idle3.13": "/usr/local/bin/idle3.13", "pydoc3.13": "/usr/local/bin/pydoc3.13", "python3.13": "/usr/local/bin/python3.13", "python3.13-config": "/usr/local/bin/python3.13-config", "qconvex": "/usr/local/bin/qconvex", "qdelaunay": "/usr/local/bin/qdelaunay"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/chemap.
singularity registry hpc automated addition for chemap
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/chemap
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/chemap:0.3.7--pyh106432d_0
```
...
```bash
$ module load quay.io/biocontainers/chemap/0.3.7--pyh106432d_0
$ module help quay.io/biocontainers/chemap/0.3.7--pyh106432d_0
```
...
#### chemap-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### chemap-inspect-deffile:
