...
updated_at: "2026-03-27 05:19:11.884100"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cemitool:1.34.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cemitool/1.34.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-cemitool/1.34.0--r45hdfd78af_0
```
