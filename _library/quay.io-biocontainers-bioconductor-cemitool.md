...
updated_at: "2023-08-29 04:06:04.443577"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cemitool:1.24.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cemitool/1.24.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-cemitool/1.24.0--r43hdfd78af_0
```
