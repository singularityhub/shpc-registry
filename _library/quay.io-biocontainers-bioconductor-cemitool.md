...
updated_at: "2024-11-04 08:26:50.805685"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cemitool:1.26.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cemitool/1.26.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-cemitool/1.26.0--r43hdfd78af_0
```
