...
updated_at: "2026-04-17 05:29:04.204578"
...
```bash
$ shpc install quay.io/biocontainers/hifi_trimmer:3.0.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hifi_trimmer/3.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/hifi_trimmer/3.0.0--pyhdfd78af_0
```
