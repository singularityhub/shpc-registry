...
updated_at: "2025-10-17 03:15:58.135411"
...
```bash
$ shpc install quay.io/biocontainers/hifi_trimmer:1.2.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hifi_trimmer/1.2.3--pyhdfd78af_0
$ module help quay.io/biocontainers/hifi_trimmer/1.2.3--pyhdfd78af_0
```
