...
updated_at: "2025-10-08 03:18:13.425108"
...
```bash
$ shpc install quay.io/biocontainers/hifi_trimmer:1.2.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hifi_trimmer/1.2.2--pyhdfd78af_0
$ module help quay.io/biocontainers/hifi_trimmer/1.2.2--pyhdfd78af_0
```
