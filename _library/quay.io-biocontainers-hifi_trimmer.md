...
updated_at: "2026-05-24 06:46:29.450745"
...
```bash
$ shpc install quay.io/biocontainers/hifi_trimmer:4.0.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hifi_trimmer/4.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/hifi_trimmer/4.0.0--pyhdfd78af_0
```
