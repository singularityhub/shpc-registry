...
updated_at: "2022-10-29 05:48:51.234609"
latest: "2.66.0--r41hc0cfd56_2"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gcrma:2.66.0--r41hc0cfd56_2
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gcrma/2.66.0--r41hc0cfd56_2
$ module help quay.io/biocontainers/bioconductor-gcrma/2.66.0--r41hc0cfd56_2
```
