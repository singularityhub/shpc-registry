---
layout: container
name:  "quay.io/biocontainers/snakemake-executor-plugin-drmaa"
maintainer: "@vsoch"
...
updated_at: "2024-01-07 02:43:42.413127"
...
```bash
$ shpc install quay.io/biocontainers/snakemake-executor-plugin-drmaa
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/snakemake-executor-plugin-drmaa:0.1.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake-executor-plugin-drmaa/0.1.3--pyhdfd78af_0
$ module help quay.io/biocontainers/snakemake-executor-plugin-drmaa/0.1.3--pyhdfd78af_0
```
...
#### snakemake-executor-plugin-drmaa-run:
...
#### snakemake-executor-plugin-drmaa-shell:
...
#### snakemake-executor-plugin-drmaa-exec:
...
#### snakemake-executor-plugin-drmaa-inspect:
...
#### snakemake-executor-plugin-drmaa-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### snakemake-executor-plugin-drmaa-inspect-deffile:
