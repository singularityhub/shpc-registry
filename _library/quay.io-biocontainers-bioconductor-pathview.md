...
updated_at: "2022-11-17 02:56:14.588528"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-pathview:1.9.0--r3.3.1_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-pathview/1.9.0--r3.3.1_0
$ module help quay.io/biocontainers/bioconductor-pathview/1.9.0--r3.3.1_0
```
