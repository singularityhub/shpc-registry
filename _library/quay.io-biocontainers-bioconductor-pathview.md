...
updated_at: "2026-04-01 05:07:15.566945"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-pathview:1.50.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-pathview/1.50.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-pathview/1.50.0--r45hdfd78af_0
```
