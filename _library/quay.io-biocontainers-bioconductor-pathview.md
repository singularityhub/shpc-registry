...
updated_at: "2023-09-22 04:32:23.272359"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-pathview:1.40.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-pathview/1.40.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-pathview/1.40.0--r43hdfd78af_0
```
