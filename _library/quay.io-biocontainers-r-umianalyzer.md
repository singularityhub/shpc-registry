---
layout: container
name:  "quay.io/biocontainers/r-umianalyzer"
maintainer: "@vsoch"
...
updated_at: "2024-06-27 03:37:07.809598"
...
```bash
$ shpc install quay.io/biocontainers/r-umianalyzer
```
...
#### r-umianalyzer-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-umianalyzer-inspect-deffile:
