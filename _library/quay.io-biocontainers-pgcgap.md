...
updated_at: "2022-10-27 00:57:01.685603"
latest: "1.0.9--2"
...
```bash
$ shpc install quay.io/biocontainers/pgcgap:1.0.9--2
```
...
```bash
$ module load quay.io/biocontainers/pgcgap/1.0.9--2
$ module help quay.io/biocontainers/pgcgap/1.0.9--2
```
