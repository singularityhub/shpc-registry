...
updated_at: "2025-05-13 03:25:01.125393"
latest: "0.9.22--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/marti:0.9.22--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/marti/0.9.22--hdfd78af_0
$ module help quay.io/biocontainers/marti/0.9.22--hdfd78af_0
```
