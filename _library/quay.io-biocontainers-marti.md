...
updated_at: "2026-08-02 06:17:30.696026"
...
```bash
$ shpc install quay.io/biocontainers/marti:0.9.33--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/marti/0.9.33--hdfd78af_0
$ module help quay.io/biocontainers/marti/0.9.33--hdfd78af_0
```
