...
updated_at: "2023-07-06 03:22:18.630650"
latest: "1.48.0--r42ha9d7317_1"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-chipseq:1.48.0--r42ha9d7317_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-chipseq/1.48.0--r42ha9d7317_1
$ module help quay.io/biocontainers/bioconductor-chipseq/1.48.0--r42ha9d7317_1
```
