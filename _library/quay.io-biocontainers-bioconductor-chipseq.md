...
updated_at: "2022-10-29 05:56:41.350336"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-chipseq:1.44.0--r41hc0cfd56_2
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-chipseq/1.44.0--r41hc0cfd56_2
$ module help quay.io/biocontainers/bioconductor-chipseq/1.44.0--r41hc0cfd56_2
```
