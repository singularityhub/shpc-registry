---
layout: container
name:  "quay.io/biocontainers/itsxrust"
maintainer: "@vsoch"
...
updated_at: "2026-08-22 03:54:52.911472"
...
```bash
$ module load quay.io/biocontainers/itsxrust/0.3.0--h70df5c0_0
$ module help quay.io/biocontainers/itsxrust/0.3.0--h70df5c0_0
```
...
#### itsxrust-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### itsxrust-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/itsxrust
$ podman run --it --rm --entrypoint /usr/local/bin/itsxrust   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/itsxrust   -v ${PWD} -w ${PWD} <container> -c " $@"
```
