...
updated_at: "2026-05-23 06:25:26.665869"
latest: "1.73.0--h9ee0642_0"
...
```bash
$ shpc install quay.io/biocontainers/vg:1.73.0--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/vg/1.73.0--h9ee0642_0
$ module help quay.io/biocontainers/vg/1.73.0--h9ee0642_0
```
