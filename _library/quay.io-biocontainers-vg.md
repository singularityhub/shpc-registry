...
updated_at: "2024-12-03 03:07:53.416371"
latest: "1.60.0--h9ee0642_0"
...
```bash
$ shpc install quay.io/biocontainers/vg:1.60.0--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/vg/1.60.0--h9ee0642_0
$ module help quay.io/biocontainers/vg/1.60.0--h9ee0642_0
```
