...
updated_at: "2025-04-21 03:16:16.313537"
latest: "1.63.1--h9ee0642_0"
...
```bash
$ shpc install quay.io/biocontainers/vg:1.63.1--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/vg/1.63.1--h9ee0642_0
$ module help quay.io/biocontainers/vg/1.63.1--h9ee0642_0
```
