...
updated_at: "2023-07-29 02:34:56.473753"
latest: "1.49.0--h9ee0642_0"
...
```bash
$ shpc install quay.io/biocontainers/vg:1.49.0--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/vg/1.49.0--h9ee0642_0
$ module help quay.io/biocontainers/vg/1.49.0--h9ee0642_0
```
