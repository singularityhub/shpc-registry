...
updated_at: "2025-09-21 03:32:54.554221"
latest: "1.67.0--h9ee0642_0"
...
```bash
$ shpc install quay.io/biocontainers/vg:1.67.0--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/vg/1.67.0--h9ee0642_0
$ module help quay.io/biocontainers/vg/1.67.0--h9ee0642_0
```
