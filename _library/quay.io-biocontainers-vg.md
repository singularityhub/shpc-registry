...
updated_at: "2024-03-25 02:52:18.381596"
latest: "1.55.0--h9ee0642_0"
...
```bash
$ shpc install quay.io/biocontainers/vg:1.55.0--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/vg/1.55.0--h9ee0642_0
$ module help quay.io/biocontainers/vg/1.55.0--h9ee0642_0
```
