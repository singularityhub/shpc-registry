...
updated_at: "2023-08-24 03:03:49.083089"
latest: "1.50.1--h9ee0642_0"
...
```bash
$ shpc install quay.io/biocontainers/vg:1.50.1--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/vg/1.50.1--h9ee0642_0
$ module help quay.io/biocontainers/vg/1.50.1--h9ee0642_0
```
