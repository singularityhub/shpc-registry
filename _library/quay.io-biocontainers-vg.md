...
updated_at: "2024-03-07 02:43:25.049321"
latest: "1.54.0--h9ee0642_0"
...
```bash
$ shpc install quay.io/biocontainers/vg:1.54.0--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/vg/1.54.0--h9ee0642_0
$ module help quay.io/biocontainers/vg/1.54.0--h9ee0642_0
```
