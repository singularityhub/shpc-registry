...
updated_at: "2025-05-19 03:55:31.828252"
latest: "1.65.0--h9ee0642_0"
...
```bash
$ shpc install quay.io/biocontainers/vg:1.65.0--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/vg/1.65.0--h9ee0642_0
$ module help quay.io/biocontainers/vg/1.65.0--h9ee0642_0
```
