...
updated_at: "2024-10-15 03:35:09.539292"
latest: "1.59.0--h9ee0642_0"
...
```bash
$ shpc install quay.io/biocontainers/vg:1.59.0--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/vg/1.59.0--h9ee0642_0
$ module help quay.io/biocontainers/vg/1.59.0--h9ee0642_0
```
