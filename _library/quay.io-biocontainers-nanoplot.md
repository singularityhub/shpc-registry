...
updated_at: "2026-09-19 07:14:22.063730"
...
```bash
$ shpc install quay.io/biocontainers/nanoplot:1.48.0--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/nanoplot/1.48.0--pyhdfd78af_1
$ module help quay.io/biocontainers/nanoplot/1.48.0--pyhdfd78af_1
```
