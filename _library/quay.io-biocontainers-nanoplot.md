...
updated_at: "2026-07-31 05:56:45.045331"
latest: "1.47.1--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/nanoplot:1.47.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/nanoplot/1.47.1--pyhdfd78af_0
$ module help quay.io/biocontainers/nanoplot/1.47.1--pyhdfd78af_0
```
