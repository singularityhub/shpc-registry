...
updated_at: "2026-02-01 05:06:24.397403"
latest: "1.46.2--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/nanoplot:1.46.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/nanoplot/1.46.2--pyhdfd78af_0
$ module help quay.io/biocontainers/nanoplot/1.46.2--pyhdfd78af_0
```
