...
updated_at: "2026-06-24 06:14:57.204943"
latest: "1.47.0--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/nanoplot:1.47.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/nanoplot/1.47.0--pyhdfd78af_0
$ module help quay.io/biocontainers/nanoplot/1.47.0--pyhdfd78af_0
```
