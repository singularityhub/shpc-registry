...
updated_at: "2026-04-03 15:41:05.900234"
latest: "1.46.2--pyhdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/nanoplot:1.46.2--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/nanoplot/1.46.2--pyhdfd78af_1
$ module help quay.io/biocontainers/nanoplot/1.46.2--pyhdfd78af_1
```
