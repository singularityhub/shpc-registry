...
updated_at: "2025-09-20 03:20:54.225554"
latest: "5.1.0--pypl5321hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/biobb_flexserv:5.1.0--pypl5321hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_flexserv/5.1.0--pypl5321hdfd78af_0
$ module help quay.io/biocontainers/biobb_flexserv/5.1.0--pypl5321hdfd78af_0
```
