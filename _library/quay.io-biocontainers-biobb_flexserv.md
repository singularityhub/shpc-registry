...
updated_at: "2023-05-13 03:12:32.913959"
...
```bash
$ shpc install quay.io/biocontainers/biobb_flexserv:4.0.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_flexserv/4.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/biobb_flexserv/4.0.0--pyhdfd78af_0
```
