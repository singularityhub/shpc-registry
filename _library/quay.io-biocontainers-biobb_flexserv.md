...
updated_at: "2023-07-19 04:33:20.647436"
latest: "4.0.2--pypl5321hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/biobb_flexserv:4.0.2--pypl5321hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_flexserv/4.0.2--pypl5321hdfd78af_0
$ module help quay.io/biocontainers/biobb_flexserv/4.0.2--pypl5321hdfd78af_0
```
