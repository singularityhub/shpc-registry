...
updated_at: "2023-11-13 02:48:02.506611"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-inpower:1.36.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-inpower/1.36.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-inpower/1.36.0--r43hdfd78af_0
```
