...
updated_at: "2023-09-03 02:46:59.961332"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-pedbarrayv10.db:3.2.3--r43hdfd78af_11
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-pedbarrayv10.db/3.2.3--r43hdfd78af_11
$ module help quay.io/biocontainers/bioconductor-pedbarrayv10.db/3.2.3--r43hdfd78af_11
```
