...
updated_at: "2024-08-27 03:20:52.403256"
...
```bash
$ shpc install quay.io/biocontainers/seqchromloader:0.7.7--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/seqchromloader/0.7.7--pyhdfd78af_0
$ module help quay.io/biocontainers/seqchromloader/0.7.7--pyhdfd78af_0
```
