...
updated_at: "2025-09-24 03:46:18.339390"
...
```bash
$ shpc install quay.io/biocontainers/seqchromloader:0.8.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/seqchromloader/0.8.3--pyhdfd78af_0
$ module help quay.io/biocontainers/seqchromloader/0.8.3--pyhdfd78af_0
```
