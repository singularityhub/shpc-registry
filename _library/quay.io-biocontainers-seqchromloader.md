...
updated_at: "2025-11-17 04:35:18.596536"
...
```bash
$ shpc install quay.io/biocontainers/seqchromloader:0.9.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/seqchromloader/0.9.1--pyhdfd78af_0
$ module help quay.io/biocontainers/seqchromloader/0.9.1--pyhdfd78af_0
```
