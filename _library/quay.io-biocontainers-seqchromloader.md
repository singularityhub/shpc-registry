...
updated_at: "2025-10-26 03:37:02.750885"
...
```bash
$ shpc install quay.io/biocontainers/seqchromloader:0.8.6--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/seqchromloader/0.8.6--pyhdfd78af_0
$ module help quay.io/biocontainers/seqchromloader/0.8.6--pyhdfd78af_0
```
