...
updated_at: "2024-07-21 03:19:10.794852"
...
```bash
$ shpc install quay.io/biocontainers/seqchromloader:0.7.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/seqchromloader/0.7.5--pyhdfd78af_0
$ module help quay.io/biocontainers/seqchromloader/0.7.5--pyhdfd78af_0
```
