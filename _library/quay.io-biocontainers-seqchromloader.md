...
updated_at: "2026-05-28 06:48:35.209268"
...
```bash
$ shpc install quay.io/biocontainers/seqchromloader:0.12.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/seqchromloader/0.12.4--pyhdfd78af_0
$ module help quay.io/biocontainers/seqchromloader/0.12.4--pyhdfd78af_0
```
