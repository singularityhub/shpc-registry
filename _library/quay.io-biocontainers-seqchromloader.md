...
updated_at: "2024-05-31 02:34:22.505358"
...
```bash
$ shpc install quay.io/biocontainers/seqchromloader:0.7.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/seqchromloader/0.7.3--pyhdfd78af_0
$ module help quay.io/biocontainers/seqchromloader/0.7.3--pyhdfd78af_0
```
