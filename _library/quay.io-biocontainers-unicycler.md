...
updated_at: "2024-07-25 03:10:28.506146"
latest: "0.5.0--py39heaaa4ec_5"
...
```bash
$ shpc install quay.io/biocontainers/unicycler:0.5.0--py39heaaa4ec_5
```
...
```bash
$ module load quay.io/biocontainers/unicycler/0.5.0--py39heaaa4ec_5
$ module help quay.io/biocontainers/unicycler/0.5.0--py39heaaa4ec_5
```
