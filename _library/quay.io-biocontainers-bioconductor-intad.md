...
updated_at: "2025-04-07 03:29:29.455218"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-intad:1.26.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-intad/1.26.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-intad/1.26.0--r44hdfd78af_0
```
