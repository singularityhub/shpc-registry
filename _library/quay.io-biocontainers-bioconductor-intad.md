...
updated_at: "2022-11-28 00:02:26.082193"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-intad:1.14.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-intad/1.14.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-intad/1.14.0--r41hdfd78af_0
```
