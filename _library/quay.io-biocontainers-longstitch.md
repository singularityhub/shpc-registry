...
updated_at: "2023-08-06 03:00:06.172222"
...
```bash
$ shpc install quay.io/biocontainers/longstitch:1.0.4--hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/longstitch/1.0.4--hdfd78af_1
$ module help quay.io/biocontainers/longstitch/1.0.4--hdfd78af_1
```
