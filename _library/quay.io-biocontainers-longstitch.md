...
updated_at: "2026-06-06 06:26:09.100609"
...
```bash
$ shpc install quay.io/biocontainers/longstitch:1.0.5--hdfd78af_2
```
...
```bash
$ module load quay.io/biocontainers/longstitch/1.0.5--hdfd78af_2
$ module help quay.io/biocontainers/longstitch/1.0.5--hdfd78af_2
```
