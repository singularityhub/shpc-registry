---
layout: container
name:  "quay.io/biocontainers/khipu-metabolomics"
maintainer: "@vsoch"
...
updated_at: "2025-11-13 03:30:57.756157"
...
```bash
$ shpc install quay.io/biocontainers/khipu-metabolomics
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/khipu-metabolomics:2.0.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/khipu-metabolomics/2.0.4--pyhdfd78af_0
$ module help quay.io/biocontainers/khipu-metabolomics/2.0.4--pyhdfd78af_0
```
...
#### khipu-metabolomics-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### khipu-metabolomics-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/khipu
$ podman run --it --rm --entrypoint /usr/local/bin/khipu   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/khipu   -v ${PWD} -w ${PWD} <container> -c " $@"
```
