...
updated_at: "2022-10-29 05:42:39.581893"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-targetscore:1.32.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-targetscore/1.32.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-targetscore/1.32.0--r41hdfd78af_0
```
