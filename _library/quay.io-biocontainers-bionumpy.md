...
updated_at: "2025-03-17 03:16:30.769084"
latest: "1.0.13--pyh05cac1d_0"
...
```bash
$ shpc install quay.io/biocontainers/bionumpy:1.0.13--pyh05cac1d_0
```
...
```bash
$ module load quay.io/biocontainers/bionumpy/1.0.13--pyh05cac1d_0
$ module help quay.io/biocontainers/bionumpy/1.0.13--pyh05cac1d_0
```
