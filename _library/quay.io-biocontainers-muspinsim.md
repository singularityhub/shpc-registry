...
updated_at: "2023-04-26 02:53:47.591561"
latest: "2.2.1"
...
```bash
$ shpc install quay.io/biocontainers/muspinsim:2.2.1
```
...
```bash
$ module load quay.io/biocontainers/muspinsim/2.2.1
$ module help quay.io/biocontainers/muspinsim/2.2.1
```
