...
updated_at: "2023-04-08 02:41:32.299166"
latest: "2.2.0"
...
```bash
$ shpc install quay.io/biocontainers/muspinsim:2.2.0
```
...
```bash
$ module load quay.io/biocontainers/muspinsim/2.2.0
$ module help quay.io/biocontainers/muspinsim/2.2.0
```
