...
updated_at: "2026-03-13 04:49:55.438408"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-bufferedmatrix:1.74.0--r45h01b2380_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-bufferedmatrix/1.74.0--r45h01b2380_0
$ module help quay.io/biocontainers/bioconductor-bufferedmatrix/1.74.0--r45h01b2380_0
```
