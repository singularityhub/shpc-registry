---
layout: container
name:  "quay.io/biocontainers/iseq"
maintainer: "@vsoch"
github: "https://github.com/singularityhub/shpc-registry/blob/main/quay.io/biocontainers/iseq/container.yaml"
config_url: "https://raw.githubusercontent.com/singularityhub/shpc-registry/main/quay.io/biocontainers/iseq/container.yaml"
updated_at: "2025-11-08 03:44:42.445777"
latest: "1.9.5--hdfd78af_0"
container_url: "https://biocontainers.pro/tools/iseq"
aliases:
 - "abi-dump.2.11.0"
 - "abi-load.2"
 - "abi-load.2.11.0"
...
versions:
 ...
 - "1.9.4--hdfd78af_0"
 - "1.9.5--hdfd78af_0"
description: "singularity registry hpc automated addition for iseq"
config: {"url": "https://biocontainers.pro/tools/iseq", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for iseq", "latest": {"1.9.5--hdfd78af_0": "sha256:2235e0746bfd58b386b405b263e67839be14b4440e3f3ef0e69b5a95b6182e7c"}, "tags": {"1.0.0--hdfd78af_0": "sha256:e4fec9ddb37d5445eba0fc2e5cd45e03d910fa56b406f2b7329055f101ed860e", "1.1.0--hdfd78af_0": "sha256:4f83d76a233222a8b644a59138149d581230e3aa077f32e2af865692af9fc968", "1.2.0--hdfd78af_1": "sha256:69272c86565a0f420d7d8781a6891de092d2dc60114ffe6747f705bc46fab98f", "1.3.0--hdfd78af_0": "sha256:45f763ba9289c62929c4a12de9c9dea7bba06e5a16995086cc11f1f4716ac242", "1.5.0--hdfd78af_0": "sha256:563049c8fd25bd8fc5e2db13760719f93a9732a6da65a2c45d957b5db82f182a", "1.4.0--hdfd78af_0": "sha256:578e1f3e7ce0c9d1553af81807f7ad8101e18b7218113e214f875a2d521773c6", "1.8.0--hdfd78af_0": "sha256:369289a98183604c8e84e8b1b17ac8ccfddcb574ab05a413da847afc6dad722f", "1.7.0--hdfd78af_0": "sha256:e7c3b580c3a024c000d99464fbe0bd54f96fa12574535792f14bfd0fa7cc5956", "1.6.0--hdfd78af_0": "sha256:bdad463dc15e5be8efe7cf08fcc556e127c245e5081c2414f0fb6054a002e3cf", "1.9.1--hdfd78af_0": "sha256:30a0bc54538890d12f3a2755239642a152d3320d178bc95d08ce29b0e849f64a", "1.9.3--hdfd78af_0": "sha256:31176c29a5ef61e3fcae6b3d0e8a81e3a5e4e53ae9a67374cfb3936b1847e571", "1.9.4--hdfd78af_0": "sha256:7e203a6e4e408d64273263fe1c5048cd5032f611c212a8c8bf9e5d8b1e103b16", "1.9.5--hdfd78af_0": "sha256:2235e0746bfd58b386b405b263e67839be14b4440e3f3ef0e69b5a95b6182e7c"}, "docker": "quay.io/biocontainers/iseq", "aliases": {"abi-dump.2.11.0": "/usr/local/bin/abi-dump.2.11.0", "abi-load.2": "/usr/local/bin/abi-load.2", "abi-load.2.11.0": "/usr/local/bin/abi-load.2.11.0", "align-cache.2.11.0": "/usr/local/bin/align-cache.2.11.0", "align-info.2.11.0": "/usr/local/bin/align-info.2.11.0", "ascli": "/usr/local/bin/ascli", "ascp": "/usr/local/bin/ascp", "asession": "/usr/local/bin/asession", "aspera-license": "/usr/local/bin/aspera-license", "axel": "/usr/local/bin/axel", "bam-load.2.11.0": "/usr/local/bin/bam-load.2.11.0", "cache-mgr.2.11.0": "/usr/local/bin/cache-mgr.2.11.0", "ccextract.2": "/usr/local/bin/ccextract.2", "ccextract.2.11.0": "/usr/local/bin/ccextract.2.11.0", "cg-load.2.11.0": "/usr/local/bin/cg-load.2.11.0", "fasterq-dump-orig.2.11.0": "/usr/local/bin/fasterq-dump-orig.2.11.0", "fasterq-dump.2.11.0": "/usr/local/bin/fasterq-dump.2.11.0", "fastq-dump-orig.2.11.0": "/usr/local/bin/fastq-dump-orig.2.11.0", "fastq-dump.2.11.0": "/usr/local/bin/fastq-dump.2.11.0", "fastq-load.2": "/usr/local/bin/fastq-load.2", "fastq-load.2.11.0": "/usr/local/bin/fastq-load.2.11.0", "helicos-load.2": "/usr/local/bin/helicos-load.2", "helicos-load.2.11.0": "/usr/local/bin/helicos-load.2.11.0", "illumina-dump.2.11.0": "/usr/local/bin/illumina-dump.2.11.0", "illumina-load.2": "/usr/local/bin/illumina-load.2", "illumina-load.2.11.0": "/usr/local/bin/illumina-load.2.11.0", "iseq": "/usr/local/bin/iseq", "kar.2.11.0": "/usr/local/bin/kar.2.11.0", "kdbmeta.2.11.0": "/usr/local/bin/kdbmeta.2.11.0", "kget.2.11.0": "/usr/local/bin/kget.2.11.0", "latf-load.2.11.0": "/usr/local/bin/latf-load.2.11.0", "md5cp.2.11.0": "/usr/local/bin/md5cp.2.11.0", "pacbio-load.2": "/usr/local/bin/pacbio-load.2", "pacbio-load.2.11.0": "/usr/local/bin/pacbio-load.2.11.0", "pacbio-loadxml.2": "/usr/local/bin/pacbio-loadxml.2", "pacbio-loadxml.2.11.0": "/usr/local/bin/pacbio-loadxml.2.11.0", "prefetch-orig.2.11.0": "/usr/local/bin/prefetch-orig.2.11.0", "prefetch.2.11.0": "/usr/local/bin/prefetch.2.11.0", "rbs": "/usr/local/bin/rbs", "rcexplain.2.11.0": "/usr/local/bin/rcexplain.2.11.0", "rdbg": "/usr/local/bin/rdbg", "read-filter-redact.2.11.0": "/usr/local/bin/read-filter-redact.2.11.0", "sam-dump-orig.2.11.0": "/usr/local/bin/sam-dump-orig.2.11.0", "sam-dump.2.11.0": "/usr/local/bin/sam-dump.2.11.0", "sff-dump.2.11.0": "/usr/local/bin/sff-dump.2.11.0", "sff-load.2": "/usr/local/bin/sff-load.2", "sff-load.2.11.0": "/usr/local/bin/sff-load.2.11.0", "sra-pileup-orig.2.11.0": "/usr/local/bin/sra-pileup-orig.2.11.0", "sra-pileup.2.11.0": "/usr/local/bin/sra-pileup.2.11.0", "sra-sort-cg.2.11.0": "/usr/local/bin/sra-sort-cg.2.11.0", "sra-sort.2.11.0": "/usr/local/bin/sra-sort.2.11.0", "sra-stat.2.11.0": "/usr/local/bin/sra-stat.2.11.0", "srapath-orig.2.11.0": "/usr/local/bin/srapath-orig.2.11.0", "srapath.2.11.0": "/usr/local/bin/srapath.2.11.0", "sratools.2.11.0": "/usr/local/bin/sratools.2.11.0", "srf-load.2": "/usr/local/bin/srf-load.2", "srf-load.2.11.0": "/usr/local/bin/srf-load.2.11.0", "test-sra.2.11.0": "/usr/local/bin/test-sra.2.11.0", "typeprof": "/usr/local/bin/typeprof", "vdb-config.2.11.0": "/usr/local/bin/vdb-config.2.11.0", "vdb-copy.2.11.0": "/usr/local/bin/vdb-copy.2.11.0", "vdb-decrypt.2.11.0": "/usr/local/bin/vdb-decrypt.2.11.0", "vdb-diff.2.11.0": "/usr/local/bin/vdb-diff.2.11.0", "vdb-dump-orig.2.11.0": "/usr/local/bin/vdb-dump-orig.2.11.0", "vdb-dump.2.11.0": "/usr/local/bin/vdb-dump.2.11.0", "vdb-encrypt.2.11.0": "/usr/local/bin/vdb-encrypt.2.11.0", "vdb-lock.2.11.0": "/usr/local/bin/vdb-lock.2.11.0", "vdb-passwd.2.11.0": "/usr/local/bin/vdb-passwd.2.11.0", "vdb-unlock.2.11.0": "/usr/local/bin/vdb-unlock.2.11.0", "vdb-validate.2.11.0": "/usr/local/bin/vdb-validate.2.11.0", "abi-load": "/usr/local/bin/abi-load", "ccextract": "/usr/local/bin/ccextract", "fastq-load": "/usr/local/bin/fastq-load", "helicos-load": "/usr/local/bin/helicos-load", "illumina-load": "/usr/local/bin/illumina-load", "pacbio-load": "/usr/local/bin/pacbio-load", "pacbio-loadxml": "/usr/local/bin/pacbio-loadxml", "sff-load": "/usr/local/bin/sff-load", "srf-load": "/usr/local/bin/srf-load", "align-cache.2": "/usr/local/bin/align-cache.2", "md5cp.2": "/usr/local/bin/md5cp.2", "racc": "/usr/local/bin/racc", "read-filter-redact.2": "/usr/local/bin/read-filter-redact.2", "sra-sort-cg.2": "/usr/local/bin/sra-sort-cg.2", "vdb-diff.2": "/usr/local/bin/vdb-diff.2", "sratools.2": "/usr/local/bin/sratools.2", "abi-dump.2": "/usr/local/bin/abi-dump.2", "align-cache": "/usr/local/bin/align-cache", "align-info.2": "/usr/local/bin/align-info.2", "bam-load.2": "/usr/local/bin/bam-load.2", "cache-mgr.2": "/usr/local/bin/cache-mgr.2", "cg-load.2": "/usr/local/bin/cg-load.2", "fasterq-dump.2": "/usr/local/bin/fasterq-dump.2", "fastq-dump.2": "/usr/local/bin/fastq-dump.2", "illumina-dump.2": "/usr/local/bin/illumina-dump.2"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/iseq.
singularity registry hpc automated addition for iseq
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/iseq
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/iseq:1.9.5--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/iseq/1.9.5--hdfd78af_0
$ module help quay.io/biocontainers/iseq/1.9.5--hdfd78af_0
```
...
#### iseq-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### iseq-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/iseq
$ podman run --it --rm --entrypoint /usr/local/bin/iseq   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/iseq   -v ${PWD} -w ${PWD} <container> -c " $@"
```
