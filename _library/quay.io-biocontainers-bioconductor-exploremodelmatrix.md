...
updated_at: "2025-04-17 04:14:49.695170"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-exploremodelmatrix:1.18.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-exploremodelmatrix/1.18.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-exploremodelmatrix/1.18.0--r44hdfd78af_0
```
