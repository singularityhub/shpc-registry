...
updated_at: "2023-11-06 02:33:22.369620"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-tcgautils:1.20.2--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-tcgautils/1.20.2--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-tcgautils/1.20.2--r43hdfd78af_0
```
