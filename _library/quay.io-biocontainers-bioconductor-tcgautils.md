...
updated_at: "2026-05-28 06:34:18.494811"
latest: "1.30.2--r45hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-tcgautils:1.30.2--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-tcgautils/1.30.2--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-tcgautils/1.30.2--r45hdfd78af_0
```
