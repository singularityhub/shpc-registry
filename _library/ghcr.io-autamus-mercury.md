...
config: "https://raw.githubusercontent.com//singularityhub/shpc-registry/main/ghcr.io/autamus/mercury/container.yaml"
updated_at: "2022-08-01 14:20:00.945709"
...
```bash
$ shpc install ghcr.io/autamus/mercury:2.0.1
```
...
```bash
$ module load ghcr.io/autamus/mercury/2.0.1
$ module help ghcr.io/autamus/mercury/2.0.1
```
