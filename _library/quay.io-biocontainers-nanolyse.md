...
updated_at: "2022-11-05 00:16:13.291091"
...
```bash
$ shpc install quay.io/biocontainers/nanolyse:1.2.0--py_0
```
...
```bash
$ module load quay.io/biocontainers/nanolyse/1.2.0--py_0
$ module help quay.io/biocontainers/nanolyse/1.2.0--py_0
```
