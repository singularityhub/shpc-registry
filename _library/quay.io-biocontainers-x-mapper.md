---
layout: container
name:  "quay.io/biocontainers/x-mapper"
maintainer: "@vsoch"
...
updated_at: "2026-06-29 07:03:00.511427"
...
```bash
$ module load quay.io/biocontainers/x-mapper/1.2.2--hdfd78af_0
$ module help quay.io/biocontainers/x-mapper/1.2.2--hdfd78af_0
```
...
#### x-mapper-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### x-mapper-inspect-deffile:
