---
layout: container
name:  "quay.io/biocontainers/mutyper"
maintainer: "@vsoch"
...
updated_at: "2026-04-05 05:22:36.471577"
...
```bash
$ shpc install quay.io/biocontainers/mutyper
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/mutyper:1.0.2--py311h26ae33e_3
```
...
```bash
$ module load quay.io/biocontainers/mutyper/1.0.2--py311h26ae33e_3
$ module help quay.io/biocontainers/mutyper/1.0.2--py311h26ae33e_3
```
...
#### mutyper-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### mutyper-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/mutyper
$ podman run --it --rm --entrypoint /usr/local/bin/mutyper   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/mutyper   -v ${PWD} -w ${PWD} <container> -c " $@"
```
