...
updated_at: "2025-11-26 03:54:34.079373"
latest: "0.14.4--pyhdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/cdskit:0.14.4--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/cdskit/0.14.4--pyhdfd78af_1
$ module help quay.io/biocontainers/cdskit/0.14.4--pyhdfd78af_1
```
