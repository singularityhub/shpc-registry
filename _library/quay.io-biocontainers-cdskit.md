...
updated_at: "2026-08-25 09:47:37.537035"
...
```bash
$ shpc install quay.io/biocontainers/cdskit:0.26.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/cdskit/0.26.0--pyhdfd78af_0
$ module help quay.io/biocontainers/cdskit/0.26.0--pyhdfd78af_0
```
