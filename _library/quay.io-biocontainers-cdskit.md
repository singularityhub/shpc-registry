...
updated_at: "2026-09-11 07:26:32.166792"
...
```bash
$ shpc install quay.io/biocontainers/cdskit:0.27.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/cdskit/0.27.0--pyhdfd78af_0
$ module help quay.io/biocontainers/cdskit/0.27.0--pyhdfd78af_0
```
