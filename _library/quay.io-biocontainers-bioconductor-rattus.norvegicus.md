...
updated_at: "2026-03-31 04:46:50.202245"
latest: "1.3.1--r45hdfd78af_13"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rattus.norvegicus:1.3.1--r45hdfd78af_13
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rattus.norvegicus/1.3.1--r45hdfd78af_13
$ module help quay.io/biocontainers/bioconductor-rattus.norvegicus/1.3.1--r45hdfd78af_13
```
