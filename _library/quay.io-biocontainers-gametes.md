---
layout: container
name:  "quay.io/biocontainers/gametes"
maintainer: "@vsoch"
...
updated_at: "2024-04-09 03:02:20.118356"
...
```bash
$ shpc install quay.io/biocontainers/gametes
```
...
#### gametes-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### gametes-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/gametes
$ podman run --it --rm --entrypoint /usr/local/bin/gametes   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/gametes   -v ${PWD} -w ${PWD} <container> -c " $@"
```
