...
updated_at: "2024-11-11 03:37:56.002171"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-protgenerics:1.38.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-protgenerics/1.38.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-protgenerics/1.38.0--r43hdfd78af_0
```
