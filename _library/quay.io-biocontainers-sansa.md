...
updated_at: "2025-11-13 03:23:51.016062"
...
```bash
$ shpc install quay.io/biocontainers/sansa:0.2.5--h4d20210_0
```
...
```bash
$ module load quay.io/biocontainers/sansa/0.2.5--h4d20210_0
$ module help quay.io/biocontainers/sansa/0.2.5--h4d20210_0
```
