...
updated_at: "2026-03-23 04:39:09.071637"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-genproseq:1.14.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-genproseq/1.14.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-genproseq/1.14.0--r45hdfd78af_0
```
