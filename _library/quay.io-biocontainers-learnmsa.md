...
updated_at: "2024-12-05 03:08:43.962451"
...
```bash
$ shpc install quay.io/biocontainers/learnmsa:2.0.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/learnmsa/2.0.1--pyhdfd78af_0
$ module help quay.io/biocontainers/learnmsa/2.0.1--pyhdfd78af_0
```
