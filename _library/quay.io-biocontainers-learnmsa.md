...
updated_at: "2024-03-18 03:05:10.724681"
...
```bash
$ shpc install quay.io/biocontainers/learnmsa:1.3.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/learnmsa/1.3.4--pyhdfd78af_0
$ module help quay.io/biocontainers/learnmsa/1.3.4--pyhdfd78af_0
```
