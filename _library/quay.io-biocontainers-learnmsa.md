...
updated_at: "2025-12-22 04:28:18.593604"
latest: "2.0.15--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/learnmsa:2.0.15--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/learnmsa/2.0.15--pyhdfd78af_0
$ module help quay.io/biocontainers/learnmsa/2.0.15--pyhdfd78af_0
```
