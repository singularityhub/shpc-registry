...
updated_at: "2023-08-09 03:19:44.091654"
...
```bash
$ shpc install quay.io/biocontainers/learnmsa:1.2.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/learnmsa/1.2.4--pyhdfd78af_0
$ module help quay.io/biocontainers/learnmsa/1.2.4--pyhdfd78af_0
```
