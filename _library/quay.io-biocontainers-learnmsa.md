...
updated_at: "2023-09-11 03:01:29.920089"
...
```bash
$ shpc install quay.io/biocontainers/learnmsa:1.3.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/learnmsa/1.3.2--pyhdfd78af_0
$ module help quay.io/biocontainers/learnmsa/1.3.2--pyhdfd78af_0
```
