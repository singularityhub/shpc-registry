...
updated_at: "2025-08-25 03:59:53.243599"
...
```bash
$ shpc install quay.io/biocontainers/learnmsa:2.0.12--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/learnmsa/2.0.12--pyhdfd78af_0
$ module help quay.io/biocontainers/learnmsa/2.0.12--pyhdfd78af_0
```
