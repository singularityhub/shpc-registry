...
updated_at: "2026-04-05 04:51:55.426280"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-heron:1.8.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-heron/1.8.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-heron/1.8.0--r45hdfd78af_0
```
