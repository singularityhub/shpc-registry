---
layout: container
name:  "quay.io/biocontainers/ctxcore"
maintainer: "@vsoch"
...
updated_at: "2025-04-17 03:47:24.691488"
...
```bash
$ shpc install quay.io/biocontainers/ctxcore
```
...
#### ctxcore-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### ctxcore-inspect-deffile:
