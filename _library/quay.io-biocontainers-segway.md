...
updated_at: "2024-12-18 03:23:41.548405"
latest: "3.0.4--pyh7cba7a3_1"
...
```bash
$ shpc install quay.io/biocontainers/segway:3.0.4--pyh7cba7a3_1
```
...
```bash
$ module load quay.io/biocontainers/segway/3.0.4--pyh7cba7a3_1
$ module help quay.io/biocontainers/segway/3.0.4--pyh7cba7a3_1
```
