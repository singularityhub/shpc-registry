...
updated_at: "2026-08-13 04:24:48.503577"
...
```bash
$ shpc install quay.io/biocontainers/segway:3.0.7--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/segway/3.0.7--pyhdfd78af_0
$ module help quay.io/biocontainers/segway/3.0.7--pyhdfd78af_0
```
