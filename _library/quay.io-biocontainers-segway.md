...
updated_at: "2026-06-07 06:55:37.585954"
...
```bash
$ shpc install quay.io/biocontainers/segway:3.0.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/segway/3.0.5--pyhdfd78af_0
$ module help quay.io/biocontainers/segway/3.0.5--pyhdfd78af_0
```
