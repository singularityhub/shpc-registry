...
updated_at: "2025-08-16 03:25:08.408319"
...
```bash
$ shpc install quay.io/biocontainers/genome2tree:1.0.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/genome2tree/1.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/genome2tree/1.0.0--pyhdfd78af_0
```
