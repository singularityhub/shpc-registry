---
layout: container
name:  "quay.io/biocontainers/genome2tree"
maintainer: "@vsoch"
...
updated_at: "2025-09-25 03:54:05.717312"
...
```bash
$ module load quay.io/biocontainers/genome2tree/1.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/genome2tree/1.1.0--pyhdfd78af_0
```
...
#### genome2tree-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### genome2tree-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/Genome2Tree.py
$ podman run --it --rm --entrypoint /usr/local/bin/Genome2Tree.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/Genome2Tree.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
