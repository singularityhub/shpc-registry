...
updated_at: "2026-03-02 04:48:27.690585"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rhdf5lib:1.32.0--r45h01b2380_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rhdf5lib/1.32.0--r45h01b2380_0
$ module help quay.io/biocontainers/bioconductor-rhdf5lib/1.32.0--r45h01b2380_0
```
