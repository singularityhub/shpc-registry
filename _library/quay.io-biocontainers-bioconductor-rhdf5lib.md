...
updated_at: "2023-09-28 02:57:23.297685"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rhdf5lib:1.22.0--r43ha9d7317_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rhdf5lib/1.22.0--r43ha9d7317_0
$ module help quay.io/biocontainers/bioconductor-rhdf5lib/1.22.0--r43ha9d7317_0
```
