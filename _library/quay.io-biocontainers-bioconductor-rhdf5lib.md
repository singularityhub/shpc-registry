...
updated_at: "2023-12-10 03:14:16.659737"
latest: "1.22.0--r43h217d67c_1"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rhdf5lib:1.22.0--r43h217d67c_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rhdf5lib/1.22.0--r43h217d67c_1
$ module help quay.io/biocontainers/bioconductor-rhdf5lib/1.22.0--r43h217d67c_1
```
