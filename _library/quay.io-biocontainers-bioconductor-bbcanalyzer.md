...
updated_at: "2025-09-06 03:47:11.825871"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-bbcanalyzer:1.36.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-bbcanalyzer/1.36.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-bbcanalyzer/1.36.0--r44hdfd78af_0
```
