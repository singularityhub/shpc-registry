...
updated_at: "2026-04-01 05:42:43.709146"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-anopheles.db0:3.22.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-anopheles.db0/3.22.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-anopheles.db0/3.22.0--r45hdfd78af_0
```
