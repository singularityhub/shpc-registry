...
updated_at: "2026-09-05 07:05:27.308160"
...
```bash
$ shpc install quay.io/biocontainers/genome_updater:0.8.2--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/genome_updater/0.8.2--hdfd78af_0
$ module help quay.io/biocontainers/genome_updater/0.8.2--hdfd78af_0
```
