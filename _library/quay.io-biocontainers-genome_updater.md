...
updated_at: "2025-12-22 05:31:51.424149"
latest: "0.7.0--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/genome_updater:0.7.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/genome_updater/0.7.0--hdfd78af_0
$ module help quay.io/biocontainers/genome_updater/0.7.0--hdfd78af_0
```
