...
updated_at: "2026-06-22 02:29:19.358619"
...
```bash
$ shpc install quay.io/biocontainers/genome_updater:0.8.1--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/genome_updater/0.8.1--hdfd78af_0
$ module help quay.io/biocontainers/genome_updater/0.8.1--hdfd78af_0
```
