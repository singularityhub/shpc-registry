...
updated_at: "2026-03-06 04:59:41.388477"
...
```bash
$ shpc install quay.io/biocontainers/genome_updater:0.7.1--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/genome_updater/0.7.1--hdfd78af_0
$ module help quay.io/biocontainers/genome_updater/0.7.1--hdfd78af_0
```
