...
updated_at: "2026-05-09 06:54:29.735130"
...
```bash
$ shpc install quay.io/biocontainers/genome_updater:0.7.2--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/genome_updater/0.7.2--hdfd78af_0
$ module help quay.io/biocontainers/genome_updater/0.7.2--hdfd78af_0
```
