...
updated_at: "2024-04-01 03:58:24.397968"
latest: "0.6.3--hdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/genome_updater:0.6.3--hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/genome_updater/0.6.3--hdfd78af_1
$ module help quay.io/biocontainers/genome_updater/0.6.3--hdfd78af_1
```
