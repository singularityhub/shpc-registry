...
updated_at: "2022-10-29 08:17:17.074590"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-moe430a.db:3.2.3--r41hdfd78af_7
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-moe430a.db/3.2.3--r41hdfd78af_7
$ module help quay.io/biocontainers/bioconductor-moe430a.db/3.2.3--r41hdfd78af_7
```
