...
updated_at: "2022-11-13 00:24:59.065697"
...
aliases:
 ...
 - ".bioconductor-moe430a.db-pre-unlink.sh"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-moe430a.db:3.13.0--r41hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-moe430a.db/3.13.0--r41hdfd78af_1
$ module help quay.io/biocontainers/bioconductor-moe430a.db/3.13.0--r41hdfd78af_1
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-moe430a.db-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-moe430a.db-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-moe430a.db-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-moe430a.db-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-moe430a.db-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-moe430a.db-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
