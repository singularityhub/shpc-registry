...
updated_at: "2026-03-05 04:37:34.880168"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-moe430a.db:3.13.0--r45hdfd78af_6
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-moe430a.db/3.13.0--r45hdfd78af_6
$ module help quay.io/biocontainers/bioconductor-moe430a.db/3.13.0--r45hdfd78af_6
```
