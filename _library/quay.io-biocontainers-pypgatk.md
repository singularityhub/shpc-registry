...
updated_at: "2026-01-27 04:11:04.811497"
...
```bash
$ shpc install quay.io/biocontainers/pypgatk:0.0.24--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pypgatk/0.0.24--pyhdfd78af_0
$ module help quay.io/biocontainers/pypgatk/0.0.24--pyhdfd78af_0
```
