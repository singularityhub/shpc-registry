...
updated_at: "2025-03-24 03:40:51.485058"
...
```bash
$ shpc install quay.io/biocontainers/profile_dists:1.0.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/profile_dists/1.0.3--pyhdfd78af_0
$ module help quay.io/biocontainers/profile_dists/1.0.3--pyhdfd78af_0
```
