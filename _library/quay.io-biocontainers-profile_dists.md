...
updated_at: "2025-12-20 04:09:13.419987"
...
```bash
$ shpc install quay.io/biocontainers/profile_dists:1.0.10--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/profile_dists/1.0.10--pyhdfd78af_0
$ module help quay.io/biocontainers/profile_dists/1.0.10--pyhdfd78af_0
```
