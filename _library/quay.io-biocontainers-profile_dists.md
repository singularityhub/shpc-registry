...
updated_at: "2025-09-26 03:51:06.723683"
...
```bash
$ shpc install quay.io/biocontainers/profile_dists:1.0.8--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/profile_dists/1.0.8--pyhdfd78af_0
$ module help quay.io/biocontainers/profile_dists/1.0.8--pyhdfd78af_0
```
