...
updated_at: "2023-08-04 03:11:27.679232"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-go.db:3.17.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-go.db/3.17.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-go.db/3.17.0--r43hdfd78af_0
```
