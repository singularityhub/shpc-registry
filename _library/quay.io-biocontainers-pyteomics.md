...
updated_at: "2023-03-14 03:37:40.850795"
latest: "4.5.6--pyh7cba7a3_0"
...
```bash
$ shpc install quay.io/biocontainers/pyteomics:4.5.6--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/pyteomics/4.5.6--pyh7cba7a3_0
$ module help quay.io/biocontainers/pyteomics/4.5.6--pyh7cba7a3_0
```
