...
updated_at: "2023-11-11 03:42:44.487025"
latest: "4.6.3--pyh7cba7a3_0"
...
```bash
$ shpc install quay.io/biocontainers/pyteomics:4.6.3--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/pyteomics/4.6.3--pyh7cba7a3_0
$ module help quay.io/biocontainers/pyteomics/4.6.3--pyh7cba7a3_0
```
