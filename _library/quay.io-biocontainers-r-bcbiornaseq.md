...
updated_at: "2024-04-05 02:24:42.991288"
...
```bash
$ shpc install quay.io/biocontainers/r-bcbiornaseq:0.6.1--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/r-bcbiornaseq/0.6.1--r43hdfd78af_0
$ module help quay.io/biocontainers/r-bcbiornaseq/0.6.1--r43hdfd78af_0
```
