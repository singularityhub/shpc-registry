...
updated_at: "2023-09-13 02:45:00.570233"
latest: "0.5.4--r43hdfd78af_2"
...
```bash
$ shpc install quay.io/biocontainers/r-bcbiornaseq:0.5.4--r43hdfd78af_2
```
...
```bash
$ module load quay.io/biocontainers/r-bcbiornaseq/0.5.4--r43hdfd78af_2
$ module help quay.io/biocontainers/r-bcbiornaseq/0.5.4--r43hdfd78af_2
```
