...
updated_at: "2023-04-24 03:22:36.496489"
...
```bash
$ shpc install quay.io/biocontainers/r-bcbiornaseq:0.5.3--r42hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/r-bcbiornaseq/0.5.3--r42hdfd78af_1
$ module help quay.io/biocontainers/r-bcbiornaseq/0.5.3--r42hdfd78af_1
```
