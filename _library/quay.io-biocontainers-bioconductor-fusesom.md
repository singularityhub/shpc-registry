---
layout: container
name:  "quay.io/biocontainers/bioconductor-fusesom"
maintainer: "@vsoch"
...
updated_at: "2025-11-06 03:46:38.642215"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-fusesom
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-fusesom:1.8.0--r44he5774e6_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-fusesom/1.8.0--r44he5774e6_0
$ module help quay.io/biocontainers/bioconductor-fusesom/1.8.0--r44he5774e6_0
```
...
#### bioconductor-fusesom-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-fusesom-inspect-deffile:
