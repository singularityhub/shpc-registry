...
updated_at: "2025-11-07 03:40:38.924469"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-sdams:1.26.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-sdams/1.26.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-sdams/1.26.0--r44hdfd78af_0
```
