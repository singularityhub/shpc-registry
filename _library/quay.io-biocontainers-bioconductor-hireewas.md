...
updated_at: "2023-09-25 03:24:43.853217"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hireewas:1.18.0--r43ha9d7317_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hireewas/1.18.0--r43ha9d7317_0
$ module help quay.io/biocontainers/bioconductor-hireewas/1.18.0--r43ha9d7317_0
```
