...
updated_at: "2022-11-11 00:45:49.227617"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hgu133plus2cdf:2.18.0--r41hdfd78af_10
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hgu133plus2cdf/2.18.0--r41hdfd78af_10
$ module help quay.io/biocontainers/bioconductor-hgu133plus2cdf/2.18.0--r41hdfd78af_10
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-hgu133plus2cdf-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-hgu133plus2cdf-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-hgu133plus2cdf-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-hgu133plus2cdf-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-hgu133plus2cdf-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-hgu133plus2cdf-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
