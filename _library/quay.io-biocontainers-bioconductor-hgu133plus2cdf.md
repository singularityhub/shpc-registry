...
updated_at: "2026-01-10 04:16:52.961766"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hgu133plus2cdf:2.18.0--r44hdfd78af_14
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hgu133plus2cdf/2.18.0--r44hdfd78af_14
$ module help quay.io/biocontainers/bioconductor-hgu133plus2cdf/2.18.0--r44hdfd78af_14
```
