...
updated_at: "2022-10-29 18:11:05.072761"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hgu133plus2cdf:2.18.0--r41hdfd78af_9
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hgu133plus2cdf/2.18.0--r41hdfd78af_9
$ module help quay.io/biocontainers/bioconductor-hgu133plus2cdf/2.18.0--r41hdfd78af_9
```
