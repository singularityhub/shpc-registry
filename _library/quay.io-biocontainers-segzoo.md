...
updated_at: "2024-03-21 04:14:45.829121"
...
```bash
$ shpc install quay.io/biocontainers/segzoo:1.0.12--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/segzoo/1.0.12--pyhdfd78af_0
$ module help quay.io/biocontainers/segzoo/1.0.12--pyhdfd78af_0
```
