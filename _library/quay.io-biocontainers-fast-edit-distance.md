...
updated_at: "2024-08-22 20:02:46.047394"
...
```bash
$ shpc install quay.io/biocontainers/fast-edit-distance:1.2.1--py310h7c593f9_1
```
...
```bash
$ module load quay.io/biocontainers/fast-edit-distance/1.2.1--py310h7c593f9_1
$ module help quay.io/biocontainers/fast-edit-distance/1.2.1--py310h7c593f9_1
```
