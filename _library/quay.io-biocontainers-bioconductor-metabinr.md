...
updated_at: "2026-02-23 06:18:46.168228"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-metabinr:1.12.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-metabinr/1.12.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-metabinr/1.12.0--r45hdfd78af_0
```
