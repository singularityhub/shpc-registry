...
updated_at: "2025-09-02 03:15:05.869512"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-metabinr:1.8.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-metabinr/1.8.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-metabinr/1.8.0--r44hdfd78af_0
```
