---
layout: container
name:  "quay.io/biocontainers/rnavigate"
maintainer: "@vsoch"
...
updated_at: "2026-06-19 07:32:28.967773"
...
singularity registry hpc automated addition for rnavigate
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/rnavigate
```
...
#### rnavigate-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### rnavigate-inspect-deffile:
