...
updated_at: "2023-10-12 03:01:28.710008"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-plasmodiumanophelescdf:2.18.0--r43hdfd78af_11
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-plasmodiumanophelescdf/2.18.0--r43hdfd78af_11
$ module help quay.io/biocontainers/bioconductor-plasmodiumanophelescdf/2.18.0--r43hdfd78af_11
```
