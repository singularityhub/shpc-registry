...
updated_at: "2026-03-27 05:12:22.591312"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-precisetad:1.20.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-precisetad/1.20.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-precisetad/1.20.0--r45hdfd78af_0
```
