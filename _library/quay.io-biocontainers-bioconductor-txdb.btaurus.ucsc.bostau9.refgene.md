...
updated_at: "2022-11-19 02:29:58.276672"
latest: "3.10.0--r41hdfd78af_6"
container_url: "https://biocontainers.pro/tools/bioconductor-txdb.btaurus.ucsc.bostau9.refgene"
aliases:
 - ".bioconductor-txdb.btaurus.ucsc.bostau9.refgene-post-link.sh"
 - ".bioconductor-txdb.btaurus.ucsc.bostau9.refgene-pre-unlink.sh"
versions:
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-txdb.btaurus.ucsc.bostau9.refgene-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-txdb.btaurus.ucsc.bostau9.refgene-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-txdb.btaurus.ucsc.bostau9.refgene-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-txdb.btaurus.ucsc.bostau9.refgene-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-txdb.btaurus.ucsc.bostau9.refgene-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-txdb.btaurus.ucsc.bostau9.refgene-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
