...
updated_at: "2024-01-05 02:32:36.153723"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-streamer:1.48.0--r43ha9d7317_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-streamer/1.48.0--r43ha9d7317_0
$ module help quay.io/biocontainers/bioconductor-streamer/1.48.0--r43ha9d7317_0
```
