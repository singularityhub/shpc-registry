...
updated_at: "2025-05-13 03:17:47.625615"
...
```bash
$ shpc install quay.io/biocontainers/repeatmasker:4.1.8--pl5321hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/repeatmasker/4.1.8--pl5321hdfd78af_0
$ module help quay.io/biocontainers/repeatmasker/4.1.8--pl5321hdfd78af_0
```
