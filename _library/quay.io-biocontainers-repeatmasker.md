...
updated_at: "2026-08-08 03:37:32.326166"
latest: "4.2.4--pl5321hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/repeatmasker:4.2.4--pl5321hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/repeatmasker/4.2.4--pl5321hdfd78af_0
$ module help quay.io/biocontainers/repeatmasker/4.2.4--pl5321hdfd78af_0
```
