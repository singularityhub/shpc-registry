...
updated_at: "2026-05-02 05:42:00.719022"
latest: "0.7.2--py313hdd269c3_0"
...
```bash
$ shpc install quay.io/biocontainers/needletail:0.7.2--py313hdd269c3_0
```
...
```bash
$ module load quay.io/biocontainers/needletail/0.7.2--py313hdd269c3_0
$ module help quay.io/biocontainers/needletail/0.7.2--py313hdd269c3_0
```
