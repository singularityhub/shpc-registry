...
updated_at: "2025-05-05 03:17:29.450413"
latest: "0.6.3--py39hfa26904_0"
...
```bash
$ shpc install quay.io/biocontainers/needletail:0.6.3--py39hfa26904_0
```
...
```bash
$ module load quay.io/biocontainers/needletail/0.6.3--py39hfa26904_0
$ module help quay.io/biocontainers/needletail/0.6.3--py39hfa26904_0
```
