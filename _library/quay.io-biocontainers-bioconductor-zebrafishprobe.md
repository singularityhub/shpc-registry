...
updated_at: "2024-10-21 03:16:25.013760"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-zebrafishprobe:2.18.0--r43hdfd78af_12
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-zebrafishprobe/2.18.0--r43hdfd78af_12
$ module help quay.io/biocontainers/bioconductor-zebrafishprobe/2.18.0--r43hdfd78af_12
```
