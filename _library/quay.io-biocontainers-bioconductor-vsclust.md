...
updated_at: "2024-07-08 03:22:08.167731"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-vsclust:1.4.0--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-vsclust/1.4.0--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-vsclust/1.4.0--r43hf17093f_0
```
