...
updated_at: "2025-10-04 03:03:42.351139"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-tximport:1.34.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-tximport/1.34.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-tximport/1.34.0--r44hdfd78af_0
```
