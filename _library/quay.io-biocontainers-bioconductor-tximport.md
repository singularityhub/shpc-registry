...
updated_at: "2026-03-21 04:17:51.305332"
latest: "1.38.2--r45hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-tximport:1.38.2--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-tximport/1.38.2--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-tximport/1.38.2--r45hdfd78af_0
```
