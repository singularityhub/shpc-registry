...
updated_at: "2022-11-03 00:52:21.574732"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gatingmldata:2.34.0--r41hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gatingmldata/2.34.0--r41hdfd78af_1
$ module help quay.io/biocontainers/bioconductor-gatingmldata/2.34.0--r41hdfd78af_1
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-gatingmldata-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-gatingmldata-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-gatingmldata-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-gatingmldata-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-gatingmldata-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-gatingmldata-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
