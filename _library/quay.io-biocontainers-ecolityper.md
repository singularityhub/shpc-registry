...
updated_at: "2026-06-25 06:20:50.614807"
...
```bash
$ shpc install quay.io/biocontainers/ecolityper:1.2.0--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/ecolityper/1.2.0--pyhdfd78af_1
$ module help quay.io/biocontainers/ecolityper/1.2.0--pyhdfd78af_1
```
