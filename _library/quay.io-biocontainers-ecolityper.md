---
layout: container
name:  "quay.io/biocontainers/ecolityper"
maintainer: "@vsoch"
...
updated_at: "2026-08-12 04:24:24.089453"
...
```bash
$ module load quay.io/biocontainers/ecolityper/1.2.1--pyhdfd78af_0
$ module help quay.io/biocontainers/ecolityper/1.2.1--pyhdfd78af_0
```
...
#### ecolityper-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### ecolityper-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/ecolityper
$ podman run --it --rm --entrypoint /usr/local/bin/ecolityper   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/ecolityper   -v ${PWD} -w ${PWD} <container> -c " $@"
```
