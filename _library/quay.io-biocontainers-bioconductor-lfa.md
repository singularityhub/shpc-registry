...
updated_at: "2023-07-06 03:41:04.325633"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-lfa:1.28.0--r42ha9d7317_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-lfa/1.28.0--r42ha9d7317_1
$ module help quay.io/biocontainers/bioconductor-lfa/1.28.0--r42ha9d7317_1
```
