...
updated_at: "2022-10-29 08:28:16.003279"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-grasp2db:1.1.0--r41hdfd78af_9
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-grasp2db/1.1.0--r41hdfd78af_9
$ module help quay.io/biocontainers/bioconductor-grasp2db/1.1.0--r41hdfd78af_9
```
