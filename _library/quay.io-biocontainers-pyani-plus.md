...
updated_at: "2026-08-16 03:33:55.893504"
...
```bash
$ shpc install quay.io/biocontainers/pyani-plus:1.0.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pyani-plus/1.0.1--pyhdfd78af_0
$ module help quay.io/biocontainers/pyani-plus/1.0.1--pyhdfd78af_0
```
