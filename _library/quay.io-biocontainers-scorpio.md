...
updated_at: "2022-11-06 00:27:30.797346"
...
```bash
$ shpc install quay.io/biocontainers/scorpio:0.3.9--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/scorpio/0.3.9--pyhdfd78af_0
$ module help quay.io/biocontainers/scorpio/0.3.9--pyhdfd78af_0
```
