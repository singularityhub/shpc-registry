...
updated_at: "2022-10-27 00:35:25.621380"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rtcga.cnv:1.22.0--r41hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rtcga.cnv/1.22.0--r41hdfd78af_1
$ module help quay.io/biocontainers/bioconductor-rtcga.cnv/1.22.0--r41hdfd78af_1
```
