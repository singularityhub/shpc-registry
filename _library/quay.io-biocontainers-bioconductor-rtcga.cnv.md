...
updated_at: "2025-08-04 04:48:56.269708"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rtcga.cnv:1.34.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rtcga.cnv/1.34.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rtcga.cnv/1.34.0--r44hdfd78af_0
```
