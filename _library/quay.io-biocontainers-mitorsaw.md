...
updated_at: "2026-09-03 07:03:33.660225"
latest: "0.2.14--h9ee0642_0"
...
```bash
$ shpc install quay.io/biocontainers/mitorsaw:0.2.14--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/mitorsaw/0.2.14--h9ee0642_0
$ module help quay.io/biocontainers/mitorsaw/0.2.14--h9ee0642_0
```
