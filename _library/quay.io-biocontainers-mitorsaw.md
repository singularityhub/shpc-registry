...
updated_at: "2025-12-06 03:27:04.819121"
...
```bash
$ shpc install quay.io/biocontainers/mitorsaw:0.2.6--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/mitorsaw/0.2.6--h9ee0642_0
$ module help quay.io/biocontainers/mitorsaw/0.2.6--h9ee0642_0
```
