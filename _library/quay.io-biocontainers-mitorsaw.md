...
updated_at: "2026-06-29 07:10:39.791347"
latest: "0.2.10--h9ee0642_0"
...
```bash
$ shpc install quay.io/biocontainers/mitorsaw:0.2.10--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/mitorsaw/0.2.10--h9ee0642_0
$ module help quay.io/biocontainers/mitorsaw/0.2.10--h9ee0642_0
```
