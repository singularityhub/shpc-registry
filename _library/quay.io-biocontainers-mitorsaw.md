...
updated_at: "2026-07-27 05:55:43.444442"
latest: "0.2.11--h9ee0642_0"
...
```bash
$ shpc install quay.io/biocontainers/mitorsaw:0.2.11--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/mitorsaw/0.2.11--h9ee0642_0
$ module help quay.io/biocontainers/mitorsaw/0.2.11--h9ee0642_0
```
