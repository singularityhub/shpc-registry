...
updated_at: "2024-12-28 02:56:18.941484"
...
```bash
$ shpc install quay.io/biocontainers/gmsc-mapper:0.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/gmsc-mapper/0.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/gmsc-mapper/0.1.0--pyhdfd78af_0
```
