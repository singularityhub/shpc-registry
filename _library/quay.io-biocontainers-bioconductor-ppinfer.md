...
updated_at: "2024-07-01 03:23:04.111795"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ppinfer:1.28.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ppinfer/1.28.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ppinfer/1.28.0--r43hdfd78af_0
```
