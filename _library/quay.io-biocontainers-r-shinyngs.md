...
updated_at: "2024-06-11 05:06:32.779672"
latest: "1.8.8--r43hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/r-shinyngs:1.8.8--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/r-shinyngs/1.8.8--r43hdfd78af_0
$ module help quay.io/biocontainers/r-shinyngs/1.8.8--r43hdfd78af_0
```
