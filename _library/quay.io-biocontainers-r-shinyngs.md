...
updated_at: "2025-09-05 03:19:26.235718"
latest: "2.2.4--r44hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/r-shinyngs:2.2.4--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/r-shinyngs/2.2.4--r44hdfd78af_0
$ module help quay.io/biocontainers/r-shinyngs/2.2.4--r44hdfd78af_0
```
