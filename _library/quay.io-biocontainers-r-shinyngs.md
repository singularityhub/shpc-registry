...
updated_at: "2023-12-16 02:45:46.783659"
...
```bash
$ shpc install quay.io/biocontainers/r-shinyngs:1.8.4--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/r-shinyngs/1.8.4--r43hdfd78af_0
$ module help quay.io/biocontainers/r-shinyngs/1.8.4--r43hdfd78af_0
```
