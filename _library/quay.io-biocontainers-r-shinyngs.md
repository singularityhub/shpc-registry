...
updated_at: "2025-04-02 03:09:20.918004"
latest: "2.0.0--r44hdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/r-shinyngs:2.0.0--r44hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/r-shinyngs/2.0.0--r44hdfd78af_1
$ module help quay.io/biocontainers/r-shinyngs/2.0.0--r44hdfd78af_1
```
