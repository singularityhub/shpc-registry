...
updated_at: "2026-05-29 06:47:14.076601"
...
```bash
$ shpc install quay.io/biocontainers/r-shinyngs:2.4.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/r-shinyngs/2.4.0--r45hdfd78af_0
$ module help quay.io/biocontainers/r-shinyngs/2.4.0--r45hdfd78af_0
```
