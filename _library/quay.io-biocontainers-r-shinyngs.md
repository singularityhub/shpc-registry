...
updated_at: "2026-08-13 04:41:27.926295"
...
```bash
$ shpc install quay.io/biocontainers/r-shinyngs:3.2.1--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/r-shinyngs/3.2.1--r45hdfd78af_0
$ module help quay.io/biocontainers/r-shinyngs/3.2.1--r45hdfd78af_0
```
