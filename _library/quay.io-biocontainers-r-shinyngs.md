...
updated_at: "2023-10-21 02:32:10.982929"
...
```bash
$ shpc install quay.io/biocontainers/r-shinyngs:1.8.2--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/r-shinyngs/1.8.2--r43hdfd78af_0
$ module help quay.io/biocontainers/r-shinyngs/1.8.2--r43hdfd78af_0
```
