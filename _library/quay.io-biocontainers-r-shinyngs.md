...
updated_at: "2023-07-13 03:45:01.876623"
latest: "1.7.2--r42hdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/r-shinyngs:1.7.2--r42hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/r-shinyngs/1.7.2--r42hdfd78af_1
$ module help quay.io/biocontainers/r-shinyngs/1.7.2--r42hdfd78af_1
```
