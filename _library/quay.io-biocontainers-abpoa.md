...
updated_at: "2025-12-18 04:01:53.318761"
latest: "1.5.5--h577a1d6_0"
...
```bash
$ shpc install quay.io/biocontainers/abpoa:1.5.5--h577a1d6_0
```
...
```bash
$ module load quay.io/biocontainers/abpoa/1.5.5--h577a1d6_0
$ module help quay.io/biocontainers/abpoa/1.5.5--h577a1d6_0
```
