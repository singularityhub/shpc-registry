...
updated_at: "2026-03-23 05:20:11.320214"
latest: "1.5.6--hb7acf71_0"
...
```bash
$ shpc install quay.io/biocontainers/abpoa:1.5.6--hb7acf71_0
```
...
```bash
$ module load quay.io/biocontainers/abpoa/1.5.6--hb7acf71_0
$ module help quay.io/biocontainers/abpoa/1.5.6--hb7acf71_0
```
