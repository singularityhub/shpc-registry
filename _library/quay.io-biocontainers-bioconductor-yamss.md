...
updated_at: "2023-08-11 02:20:37.355840"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-yamss:1.26.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-yamss/1.26.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-yamss/1.26.0--r43hdfd78af_0
```
