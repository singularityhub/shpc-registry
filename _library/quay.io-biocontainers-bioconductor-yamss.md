...
updated_at: "2024-06-02 02:40:53.959895"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-yamss:1.28.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-yamss/1.28.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-yamss/1.28.0--r43hdfd78af_0
```
