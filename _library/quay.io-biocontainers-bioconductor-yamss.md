...
updated_at: "2022-11-14 00:23:01.641749"
latest: "1.8.1--r351_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-yamss:1.8.1--r351_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-yamss/1.8.1--r351_0
$ module help quay.io/biocontainers/bioconductor-yamss/1.8.1--r351_0
```
