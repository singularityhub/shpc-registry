...
updated_at: "2026-03-27 05:02:12.412466"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-yamss:1.36.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-yamss/1.36.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-yamss/1.36.0--r45hdfd78af_0
```
