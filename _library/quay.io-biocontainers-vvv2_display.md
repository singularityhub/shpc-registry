...
updated_at: "2026-03-18 05:00:24.564742"
latest: "0.2.5.0--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/vvv2_display:0.2.5.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/vvv2_display/0.2.5.0--pyhdfd78af_0
$ module help quay.io/biocontainers/vvv2_display/0.2.5.0--pyhdfd78af_0
```
