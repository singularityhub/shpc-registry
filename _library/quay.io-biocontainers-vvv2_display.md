...
updated_at: "2025-05-17 03:56:13.728741"
latest: "0.2.3.9--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/vvv2_display:0.2.3.9--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/vvv2_display/0.2.3.9--pyhdfd78af_0
$ module help quay.io/biocontainers/vvv2_display/0.2.3.9--pyhdfd78af_0
```
