...
updated_at: "2026-08-28 14:10:57.076068"
latest: "0.2.5.2--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/vvv2_display:0.2.5.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/vvv2_display/0.2.5.2--pyhdfd78af_0
$ module help quay.io/biocontainers/vvv2_display/0.2.5.2--pyhdfd78af_0
```
