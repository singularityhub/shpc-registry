...
updated_at: "2024-07-06 03:05:53.124657"
latest: "1.0.8--pyh7cba7a3_0"
...
```bash
$ shpc install quay.io/biocontainers/beacon2-import:1.0.8--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/beacon2-import/1.0.8--pyh7cba7a3_0
$ module help quay.io/biocontainers/beacon2-import/1.0.8--pyh7cba7a3_0
```
