...
updated_at: "2024-08-15 03:44:35.841187"
...
```bash
$ shpc install quay.io/biocontainers/beacon2-import:2.2.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/beacon2-import/2.2.1--pyhdfd78af_0
$ module help quay.io/biocontainers/beacon2-import/2.2.1--pyhdfd78af_0
```
