...
updated_at: "2022-11-09 00:10:17.204162"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hmp2data:1.8.0--r41hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hmp2data/1.8.0--r41hdfd78af_1
$ module help quay.io/biocontainers/bioconductor-hmp2data/1.8.0--r41hdfd78af_1
```
