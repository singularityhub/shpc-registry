...
updated_at: "2025-11-15 03:59:03.476159"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hmp2data:1.20.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hmp2data/1.20.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-hmp2data/1.20.0--r44hdfd78af_0
```
