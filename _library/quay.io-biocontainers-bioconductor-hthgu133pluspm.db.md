...
updated_at: "2023-08-14 03:32:56.195816"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hthgu133pluspm.db:3.13.0--r43hdfd78af_3
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hthgu133pluspm.db/3.13.0--r43hdfd78af_3
$ module help quay.io/biocontainers/bioconductor-hthgu133pluspm.db/3.13.0--r43hdfd78af_3
```
