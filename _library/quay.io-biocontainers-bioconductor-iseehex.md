...
updated_at: "2023-09-09 02:22:07.254178"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-iseehex:1.2.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-iseehex/1.2.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-iseehex/1.2.0--r43hdfd78af_0
```
