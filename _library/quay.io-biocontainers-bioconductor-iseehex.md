...
updated_at: "2025-08-09 04:05:57.986050"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-iseehex:1.8.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-iseehex/1.8.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-iseehex/1.8.0--r44hdfd78af_0
```
