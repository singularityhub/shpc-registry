...
updated_at: "2022-11-09 23:44:57.091118"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-expressionatlas:1.22.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-expressionatlas/1.22.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-expressionatlas/1.22.0--r41hdfd78af_0
```
