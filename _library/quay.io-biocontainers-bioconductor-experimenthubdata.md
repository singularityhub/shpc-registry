...
updated_at: "2022-11-03 00:33:59.987462"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-experimenthubdata:1.8.0--r351_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-experimenthubdata/1.8.0--r351_0
$ module help quay.io/biocontainers/bioconductor-experimenthubdata/1.8.0--r351_0
```
