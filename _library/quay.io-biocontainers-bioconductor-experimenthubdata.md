...
updated_at: "2022-11-21 13:44:57.424227"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-experimenthubdata:1.20.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-experimenthubdata/1.20.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-experimenthubdata/1.20.0--r41hdfd78af_0
```
