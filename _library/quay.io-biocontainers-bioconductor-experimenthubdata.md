...
updated_at: "2026-04-04 04:37:50.716289"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-experimenthubdata:1.36.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-experimenthubdata/1.36.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-experimenthubdata/1.36.0--r45hdfd78af_0
```
