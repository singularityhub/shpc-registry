...
updated_at: "2026-06-04 00:49:53.563337"
latest: "0.40.1--h3be2455_0"
...
```bash
$ shpc install quay.io/biocontainers/breseq:0.40.1--h3be2455_0
```
...
```bash
$ module load quay.io/biocontainers/breseq/0.40.1--h3be2455_0
$ module help quay.io/biocontainers/breseq/0.40.1--h3be2455_0
```
