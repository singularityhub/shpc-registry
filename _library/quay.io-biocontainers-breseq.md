...
updated_at: "2026-09-05 06:48:15.539187"
latest: "0.40.2--h3be2455_0"
...
```bash
$ shpc install quay.io/biocontainers/breseq:0.40.2--h3be2455_0
```
...
```bash
$ module load quay.io/biocontainers/breseq/0.40.2--h3be2455_0
$ module help quay.io/biocontainers/breseq/0.40.2--h3be2455_0
```
