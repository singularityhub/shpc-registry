...
updated_at: "2025-11-28 04:02:21.224995"
latest: "0.39.0--h077b44d_3"
...
```bash
$ shpc install quay.io/biocontainers/breseq:0.39.0--h077b44d_3
```
...
```bash
$ module load quay.io/biocontainers/breseq/0.39.0--h077b44d_3
$ module help quay.io/biocontainers/breseq/0.39.0--h077b44d_3
```
