...
updated_at: "2026-03-21 04:56:12.755330"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-roseq:1.22.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-roseq/1.22.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-roseq/1.22.0--r45hdfd78af_0
```
