...
updated_at: "2025-08-12 03:38:09.960450"
...
```bash
$ shpc install quay.io/biocontainers/hmftools-pave:1.8--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hmftools-pave/1.8--hdfd78af_0
$ module help quay.io/biocontainers/hmftools-pave/1.8--hdfd78af_0
```
