...
updated_at: "2026-07-01 15:49:02.548847"
...
```bash
$ shpc install quay.io/biocontainers/hmftools-pave:1.9--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hmftools-pave/1.9--hdfd78af_0
$ module help quay.io/biocontainers/hmftools-pave/1.9--hdfd78af_0
```
