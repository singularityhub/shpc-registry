...
updated_at: "2025-01-16 02:52:44.035363"
latest: "1.7_beta--hdfd78af_2"
...
```bash
$ shpc install quay.io/biocontainers/hmftools-pave:1.7_beta--hdfd78af_2
```
...
```bash
$ module load quay.io/biocontainers/hmftools-pave/1.7_beta--hdfd78af_2
$ module help quay.io/biocontainers/hmftools-pave/1.7_beta--hdfd78af_2
```
