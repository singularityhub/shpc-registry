...
updated_at: "2023-06-26 03:49:13.014136"
...
```bash
$ shpc install quay.io/biocontainers/braker3:3.0.3--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/braker3/3.0.3--hdfd78af_0
$ module help quay.io/biocontainers/braker3/3.0.3--hdfd78af_0
```
