...
updated_at: "2024-01-01 03:28:41.692235"
...
```bash
$ shpc install quay.io/biocontainers/braker3:3.0.6--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/braker3/3.0.6--hdfd78af_0
$ module help quay.io/biocontainers/braker3/3.0.6--hdfd78af_0
```
