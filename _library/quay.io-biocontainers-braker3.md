...
updated_at: "2024-02-24 02:46:12.537483"
...
```bash
$ shpc install quay.io/biocontainers/braker3:3.0.7--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/braker3/3.0.7--hdfd78af_0
$ module help quay.io/biocontainers/braker3/3.0.7--hdfd78af_0
```
