...
updated_at: "2026-08-31 08:52:01.419185"
...
```bash
$ shpc install quay.io/biocontainers/liana:1.8.1--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/liana/1.8.1--pyhdfd78af_1
$ module help quay.io/biocontainers/liana/1.8.1--pyhdfd78af_1
```
