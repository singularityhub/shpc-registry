...
updated_at: "2026-01-31 04:14:56.045389"
...
```bash
$ shpc install quay.io/biocontainers/liana:1.7.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/liana/1.7.1--pyhdfd78af_0
$ module help quay.io/biocontainers/liana/1.7.1--pyhdfd78af_0
```
