...
updated_at: "2026-06-27 06:36:07.411956"
...
```bash
$ shpc install quay.io/biocontainers/liana:1.7.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/liana/1.7.3--pyhdfd78af_0
$ module help quay.io/biocontainers/liana/1.7.3--pyhdfd78af_0
```
