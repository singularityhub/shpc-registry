...
updated_at: "2026-09-26 07:42:48.811693"
...
```bash
$ shpc install quay.io/biocontainers/liana:2.0.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/liana/2.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/liana/2.0.0--pyhdfd78af_0
```
