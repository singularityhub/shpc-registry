...
updated_at: "2024-11-13 04:13:32.798346"
...
```bash
$ shpc install quay.io/biocontainers/liana:1.4.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/liana/1.4.0--pyhdfd78af_0
$ module help quay.io/biocontainers/liana/1.4.0--pyhdfd78af_0
```
