...
updated_at: "2026-04-04 05:06:31.886353"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-u133x3pcdf:2.18.0--r45hdfd78af_14
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-u133x3pcdf/2.18.0--r45hdfd78af_14
$ module help quay.io/biocontainers/bioconductor-u133x3pcdf/2.18.0--r45hdfd78af_14
```
