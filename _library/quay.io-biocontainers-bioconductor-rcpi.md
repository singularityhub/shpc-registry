...
updated_at: "2025-04-28 04:03:55.694843"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rcpi:1.42.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rcpi/1.42.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rcpi/1.42.0--r44hdfd78af_0
```
