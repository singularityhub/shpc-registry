...
updated_at: "2026-07-02 06:06:35.395580"
...
```bash
$ shpc install quay.io/biocontainers/amplify:2.0.1--py36hdfd78af_2
```
...
```bash
$ module load quay.io/biocontainers/amplify/2.0.1--py36hdfd78af_2
$ module help quay.io/biocontainers/amplify/2.0.1--py36hdfd78af_2
```
