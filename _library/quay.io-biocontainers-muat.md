...
updated_at: "2026-04-05 05:04:12.497561"
latest: "0.1.17--pyh106432d_0"
...
```bash
$ shpc install quay.io/biocontainers/muat:0.1.17--pyh106432d_0
```
...
```bash
$ module load quay.io/biocontainers/muat/0.1.17--pyh106432d_0
$ module help quay.io/biocontainers/muat/0.1.17--pyh106432d_0
```
