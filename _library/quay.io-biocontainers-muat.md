...
updated_at: "2026-05-06 05:35:59.683451"
latest: "0.1.18--pyh106432d_0"
...
```bash
$ shpc install quay.io/biocontainers/muat:0.1.18--pyh106432d_0
```
...
```bash
$ module load quay.io/biocontainers/muat/0.1.18--pyh106432d_0
$ module help quay.io/biocontainers/muat/0.1.18--pyh106432d_0
```
