...
updated_at: "2026-06-20 06:53:14.120857"
latest: "0.1.20--pyh106432d_0"
...
```bash
$ shpc install quay.io/biocontainers/muat:0.1.20--pyh106432d_0
```
...
```bash
$ module load quay.io/biocontainers/muat/0.1.20--pyh106432d_0
$ module help quay.io/biocontainers/muat/0.1.20--pyh106432d_0
```
