...
updated_at: "2026-09-03 07:01:48.403613"
latest: "0.1.27--pyh106432d_0"
...
```bash
$ shpc install quay.io/biocontainers/muat:0.1.27--pyh106432d_0
```
...
```bash
$ module load quay.io/biocontainers/muat/0.1.27--pyh106432d_0
$ module help quay.io/biocontainers/muat/0.1.27--pyh106432d_0
```
