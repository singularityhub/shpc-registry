...
updated_at: "2023-07-31 02:41:34.279708"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-metnet:1.18.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-metnet/1.18.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-metnet/1.18.0--r43hdfd78af_0
```
