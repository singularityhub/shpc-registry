...
updated_at: "2023-01-18 02:51:39.061100"
latest: "2.1.1--hf1761c0_0"
...
```bash
$ shpc install quay.io/biocontainers/cuttlefish:2.1.1--hf1761c0_0
```
...
```bash
$ module load quay.io/biocontainers/cuttlefish/2.1.1--hf1761c0_0
$ module help quay.io/biocontainers/cuttlefish/2.1.1--hf1761c0_0
```
