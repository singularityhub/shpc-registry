...
updated_at: "2024-02-21 02:38:50.977993"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-spatialde:1.8.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-spatialde/1.8.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-spatialde/1.8.0--r43hdfd78af_0
```
