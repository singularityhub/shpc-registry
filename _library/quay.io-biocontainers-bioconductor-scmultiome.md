---
layout: container
name:  "quay.io/biocontainers/bioconductor-scmultiome"
maintainer: "@vsoch"
...
updated_at: "2024-01-21 02:40:18.487809"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-scmultiome
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-scmultiome:1.2.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-scmultiome/1.2.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-scmultiome/1.2.0--r43hdfd78af_0
```
...
#### bioconductor-scmultiome-inspect:
...
#### bioconductor-scmultiome-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-scmultiome-inspect-deffile:
