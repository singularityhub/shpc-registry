...
updated_at: "2026-03-28 05:11:33.677250"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-redseq:1.56.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-redseq/1.56.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-redseq/1.56.0--r45hdfd78af_0
```
