...
updated_at: "2025-04-13 04:28:38.793080"
latest: "0.11.2--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/tower-cli:0.11.2--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/tower-cli/0.11.2--hdfd78af_0
$ module help quay.io/biocontainers/tower-cli/0.11.2--hdfd78af_0
```
