...
updated_at: "2025-08-04 04:32:15.597316"
latest: "0.13.0--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/tower-cli:0.13.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/tower-cli/0.13.0--hdfd78af_0
$ module help quay.io/biocontainers/tower-cli/0.13.0--hdfd78af_0
```
