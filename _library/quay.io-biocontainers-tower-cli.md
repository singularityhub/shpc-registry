...
updated_at: "2026-02-01 04:50:15.229977"
latest: "0.15.0--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/tower-cli:0.15.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/tower-cli/0.15.0--hdfd78af_0
$ module help quay.io/biocontainers/tower-cli/0.15.0--hdfd78af_0
```
