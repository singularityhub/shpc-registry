...
updated_at: "2025-06-28 04:06:41.545231"
latest: "0.12.0--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/tower-cli:0.12.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/tower-cli/0.12.0--hdfd78af_0
$ module help quay.io/biocontainers/tower-cli/0.12.0--hdfd78af_0
```
