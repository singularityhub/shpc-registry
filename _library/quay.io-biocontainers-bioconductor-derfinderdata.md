...
updated_at: "2024-08-04 03:14:22.605508"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-derfinderdata:2.20.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-derfinderdata/2.20.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-derfinderdata/2.20.0--r43hdfd78af_0
```
