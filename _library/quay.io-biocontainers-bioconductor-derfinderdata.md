...
updated_at: "2022-10-29 08:29:40.877230"
...
aliases:
 ...
 - ".bioconductor-derfinderdata-pre-unlink.sh"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-derfinderdata:2.8.1--r40hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-derfinderdata/2.8.1--r40hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-derfinderdata/2.8.1--r40hdfd78af_0
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-derfinderdata-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-derfinderdata-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-derfinderdata-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-derfinderdata-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-derfinderdata-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-derfinderdata-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
