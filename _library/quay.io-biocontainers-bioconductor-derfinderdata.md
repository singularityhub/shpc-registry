...
updated_at: "2026-04-04 05:02:25.319619"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-derfinderdata:2.28.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-derfinderdata/2.28.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-derfinderdata/2.28.0--r45hdfd78af_0
```
