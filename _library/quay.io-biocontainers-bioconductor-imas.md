...
updated_at: "2024-12-09 04:14:51.493086"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-imas:1.26.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-imas/1.26.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-imas/1.26.0--r43hdfd78af_0
```
