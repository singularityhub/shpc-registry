...
updated_at: "2023-11-21 02:46:15.671041"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-imas:1.24.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-imas/1.24.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-imas/1.24.0--r43hdfd78af_0
```
