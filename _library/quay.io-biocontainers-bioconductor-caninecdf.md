...
updated_at: "2026-02-04 04:24:37.276106"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-caninecdf:2.18.0--r44hdfd78af_13
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-caninecdf/2.18.0--r44hdfd78af_13
$ module help quay.io/biocontainers/bioconductor-caninecdf/2.18.0--r44hdfd78af_13
```
