...
updated_at: "2022-10-27 00:44:46.194291"
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-caninecdf-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-caninecdf-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-caninecdf-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-caninecdf-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-caninecdf-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-caninecdf-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
