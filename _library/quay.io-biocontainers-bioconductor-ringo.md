...
updated_at: "2023-09-04 04:28:59.897491"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ringo:1.64.0--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ringo/1.64.0--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-ringo/1.64.0--r43hf17093f_0
```
