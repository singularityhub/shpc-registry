...
updated_at: "2023-08-25 02:49:09.559921"
latest: "1.0.4--py39hf5e1c6e_1"
...
```bash
$ shpc install quay.io/biocontainers/clair3:1.0.4--py39hf5e1c6e_1
```
...
```bash
$ module load quay.io/biocontainers/clair3/1.0.4--py39hf5e1c6e_1
$ module help quay.io/biocontainers/clair3/1.0.4--py39hf5e1c6e_1
```
