...
updated_at: "2023-10-26 03:21:37.585580"
latest: "1.0.4--py39hf5e1c6e_2"
...
```bash
$ shpc install quay.io/biocontainers/clair3:1.0.4--py39hf5e1c6e_2
```
...
```bash
$ module load quay.io/biocontainers/clair3/1.0.4--py39hf5e1c6e_2
$ module help quay.io/biocontainers/clair3/1.0.4--py39hf5e1c6e_2
```
