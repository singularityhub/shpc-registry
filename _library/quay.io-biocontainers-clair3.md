...
updated_at: "2025-05-24 11:11:47.028056"
latest: "1.1.0--py39hd649744_0"
...
```bash
$ shpc install quay.io/biocontainers/clair3:1.1.0--py39hd649744_0
```
...
```bash
$ module load quay.io/biocontainers/clair3/1.1.0--py39hd649744_0
$ module help quay.io/biocontainers/clair3/1.1.0--py39hd649744_0
```
