...
updated_at: "2026-04-18 05:09:18.892852"
latest: "2.0.0--py311hbc58adc_2"
...
```bash
$ shpc install quay.io/biocontainers/clair3:2.0.0--py311hbc58adc_2
```
...
```bash
$ module load quay.io/biocontainers/clair3/2.0.0--py311hbc58adc_2
$ module help quay.io/biocontainers/clair3/2.0.0--py311hbc58adc_2
```
