...
updated_at: "2025-07-04 03:32:24.964757"
latest: "1.1.1--py310h779eee5_0"
...
```bash
$ shpc install quay.io/biocontainers/clair3:1.1.1--py310h779eee5_0
```
...
```bash
$ module load quay.io/biocontainers/clair3/1.1.1--py310h779eee5_0
$ module help quay.io/biocontainers/clair3/1.1.1--py310h779eee5_0
```
