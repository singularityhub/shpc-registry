...
updated_at: "2026-08-25 09:31:11.163546"
latest: "2.0.2--py311hbc58adc_0"
...
```bash
$ shpc install quay.io/biocontainers/clair3:2.0.2--py311hbc58adc_0
```
...
```bash
$ module load quay.io/biocontainers/clair3/2.0.2--py311hbc58adc_0
$ module help quay.io/biocontainers/clair3/2.0.2--py311hbc58adc_0
```
