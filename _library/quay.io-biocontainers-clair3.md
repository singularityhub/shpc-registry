...
updated_at: "2024-02-09 03:29:18.535076"
latest: "1.0.5--py39hf5e1c6e_0"
...
```bash
$ shpc install quay.io/biocontainers/clair3:1.0.5--py39hf5e1c6e_0
```
...
```bash
$ module load quay.io/biocontainers/clair3/1.0.5--py39hf5e1c6e_0
$ module help quay.io/biocontainers/clair3/1.0.5--py39hf5e1c6e_0
```
