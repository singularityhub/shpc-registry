...
updated_at: "2026-09-12 07:51:57.427577"
latest: "2.0.3--py311hbc58adc_0"
...
```bash
$ shpc install quay.io/biocontainers/clair3:2.0.3--py311hbc58adc_0
```
...
```bash
$ module load quay.io/biocontainers/clair3/2.0.3--py311hbc58adc_0
$ module help quay.io/biocontainers/clair3/2.0.3--py311hbc58adc_0
```
