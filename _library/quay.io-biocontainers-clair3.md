...
updated_at: "2024-11-06 02:59:15.122863"
latest: "1.0.10--py39h46983ab_0"
...
```bash
$ shpc install quay.io/biocontainers/clair3:1.0.10--py39h46983ab_0
```
...
```bash
$ module load quay.io/biocontainers/clair3/1.0.10--py39h46983ab_0
$ module help quay.io/biocontainers/clair3/1.0.10--py39h46983ab_0
```
