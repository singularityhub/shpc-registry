...
updated_at: "2023-07-04 03:09:21.242694"
latest: "1.0.2--py39hb9dc472_0"
...
```bash
$ shpc install quay.io/biocontainers/clair3:1.0.2--py39hb9dc472_0
```
...
```bash
$ module load quay.io/biocontainers/clair3/1.0.2--py39hb9dc472_0
$ module help quay.io/biocontainers/clair3/1.0.2--py39hb9dc472_0
```
