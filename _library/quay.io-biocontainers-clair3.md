...
updated_at: "2025-07-31 11:43:59.361246"
latest: "1.1.2--py310h779eee5_0"
...
```bash
$ shpc install quay.io/biocontainers/clair3:1.1.2--py310h779eee5_0
```
...
```bash
$ module load quay.io/biocontainers/clair3/1.1.2--py310h779eee5_0
$ module help quay.io/biocontainers/clair3/1.1.2--py310h779eee5_0
```
