...
updated_at: "2023-12-03 03:10:14.399849"
latest: "1.0.4--py39hf5e1c6e_3"
...
```bash
$ shpc install quay.io/biocontainers/clair3:1.0.4--py39hf5e1c6e_3
```
...
```bash
$ module load quay.io/biocontainers/clair3/1.0.4--py39hf5e1c6e_3
$ module help quay.io/biocontainers/clair3/1.0.4--py39hf5e1c6e_3
```
