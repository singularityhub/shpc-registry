...
updated_at: "2026-06-02 07:01:57.702921"
latest: "2.0.1--py311hbc58adc_0"
...
```bash
$ shpc install quay.io/biocontainers/clair3:2.0.1--py311hbc58adc_0
```
...
```bash
$ module load quay.io/biocontainers/clair3/2.0.1--py311hbc58adc_0
$ module help quay.io/biocontainers/clair3/2.0.1--py311hbc58adc_0
```
