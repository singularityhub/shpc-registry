...
updated_at: "2025-08-28 03:25:22.719471"
latest: "4.3.15--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/searchgui:4.3.15--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/searchgui/4.3.15--hdfd78af_0
$ module help quay.io/biocontainers/searchgui/4.3.15--hdfd78af_0
```
