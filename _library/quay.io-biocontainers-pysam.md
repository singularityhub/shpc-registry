...
updated_at: "2024-07-26 02:36:10.567398"
latest: "0.22.1--py311h1f0e11c_1"
...
```bash
$ shpc install quay.io/biocontainers/pysam:0.22.1--py311h1f0e11c_1
```
...
```bash
$ module load quay.io/biocontainers/pysam/0.22.1--py311h1f0e11c_1
$ module help quay.io/biocontainers/pysam/0.22.1--py311h1f0e11c_1
```
