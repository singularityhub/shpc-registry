...
updated_at: "2026-09-26 07:46:27.052415"
...
```bash
$ shpc install quay.io/biocontainers/pysam:0.24.1--py310h4a09ff2_0
```
...
```bash
$ module load quay.io/biocontainers/pysam/0.24.1--py310h4a09ff2_0
$ module help quay.io/biocontainers/pysam/0.24.1--py310h4a09ff2_0
```
