...
updated_at: "2026-04-29 05:53:55.568760"
latest: "0.23.3--py313h4b224ce_3"
...
```bash
$ shpc install quay.io/biocontainers/pysam:0.23.3--py313h4b224ce_3
```
...
```bash
$ module load quay.io/biocontainers/pysam/0.23.3--py313h4b224ce_3
$ module help quay.io/biocontainers/pysam/0.23.3--py313h4b224ce_3
```
