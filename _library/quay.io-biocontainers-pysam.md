...
updated_at: "2026-06-26 06:45:21.026371"
latest: "0.24.0--py310h4a09ff2_1"
...
```bash
$ shpc install quay.io/biocontainers/pysam:0.24.0--py310h4a09ff2_1
```
...
```bash
$ module load quay.io/biocontainers/pysam/0.24.0--py310h4a09ff2_1
$ module help quay.io/biocontainers/pysam/0.24.0--py310h4a09ff2_1
```
