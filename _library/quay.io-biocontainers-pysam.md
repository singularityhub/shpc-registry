...
updated_at: "2025-08-29 03:41:30.134771"
...
```bash
$ shpc install quay.io/biocontainers/pysam:0.23.3--py39hdd5828d_1
```
...
```bash
$ module load quay.io/biocontainers/pysam/0.23.3--py39hdd5828d_1
$ module help quay.io/biocontainers/pysam/0.23.3--py39hdd5828d_1
```
