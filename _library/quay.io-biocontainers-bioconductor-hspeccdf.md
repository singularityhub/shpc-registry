...
updated_at: "2022-11-03 01:39:18.727808"
latest: "0.99.1--r41hdfd78af_9"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hspeccdf:0.99.1--r41hdfd78af_9
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hspeccdf/0.99.1--r41hdfd78af_9
$ module help quay.io/biocontainers/bioconductor-hspeccdf/0.99.1--r41hdfd78af_9
```
