...
updated_at: "2026-03-29 05:31:38.676709"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ihwpaper:1.38.0--r45ha27e39d_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ihwpaper/1.38.0--r45ha27e39d_0
$ module help quay.io/biocontainers/bioconductor-ihwpaper/1.38.0--r45ha27e39d_0
```
