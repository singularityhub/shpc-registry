...
updated_at: "2022-11-03 01:29:42.656184"
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-ihwpaper-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-ihwpaper-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-ihwpaper-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-ihwpaper-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-ihwpaper-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-ihwpaper-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
