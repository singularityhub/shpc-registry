...
updated_at: "2026-04-04 05:08:49.255469"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hellorangesdata:1.36.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hellorangesdata/1.36.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-hellorangesdata/1.36.0--r45hdfd78af_0
```
