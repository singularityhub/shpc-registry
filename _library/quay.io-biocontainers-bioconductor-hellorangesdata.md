...
updated_at: "2024-08-31 02:45:41.587076"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hellorangesdata:1.28.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hellorangesdata/1.28.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-hellorangesdata/1.28.0--r43hdfd78af_0
```
