...
updated_at: "2022-11-20 01:03:22.395144"
latest: "1.8.0--r351_0"
container_url: "https://biocontainers.pro/tools/bioconductor-hellorangesdata"
aliases:
 - ".bioconductor-hellorangesdata-post-link.sh"
 - ".bioconductor-hellorangesdata-pre-unlink.sh"
 - "wget"
 - "c89"
 - "c99"
versions:
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-hellorangesdata-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-hellorangesdata-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-hellorangesdata-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-hellorangesdata-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-hellorangesdata-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-hellorangesdata-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
