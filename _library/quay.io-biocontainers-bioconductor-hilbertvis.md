...
updated_at: "2026-02-23 06:32:26.762775"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hilbertvis:1.68.0--r45h01b2380_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hilbertvis/1.68.0--r45h01b2380_0
$ module help quay.io/biocontainers/bioconductor-hilbertvis/1.68.0--r45h01b2380_0
```
