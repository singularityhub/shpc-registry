...
updated_at: "2024-11-02 02:51:26.976877"
...
```bash
$ shpc install quay.io/biocontainers/pymsaviz:0.5.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pymsaviz/0.5.0--pyhdfd78af_0
$ module help quay.io/biocontainers/pymsaviz/0.5.0--pyhdfd78af_0
```
