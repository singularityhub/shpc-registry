...
updated_at: "2026-05-24 06:21:14.992834"
latest: "3.1.4--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/orthofinder:3.1.4--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/orthofinder/3.1.4--hdfd78af_0
$ module help quay.io/biocontainers/orthofinder/3.1.4--hdfd78af_0
```
