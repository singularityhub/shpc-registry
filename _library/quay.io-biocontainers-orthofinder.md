...
updated_at: "2026-03-03 05:11:27.522773"
latest: "3.1.3--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/orthofinder:3.1.3--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/orthofinder/3.1.3--hdfd78af_0
$ module help quay.io/biocontainers/orthofinder/3.1.3--hdfd78af_0
```
