...
updated_at: "2026-03-31 04:49:33.873477"
latest: "3.1.3--hdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/orthofinder:3.1.3--hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/orthofinder/3.1.3--hdfd78af_1
$ module help quay.io/biocontainers/orthofinder/3.1.3--hdfd78af_1
```
