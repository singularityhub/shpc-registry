...
updated_at: "2026-06-21 07:12:30.522456"
latest: "3.1.5--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/orthofinder:3.1.5--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/orthofinder/3.1.5--hdfd78af_0
$ module help quay.io/biocontainers/orthofinder/3.1.5--hdfd78af_0
```
