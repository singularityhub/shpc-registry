---
layout: container
name:  "quay.io/biocontainers/r-roll"
maintainer: "@vsoch"
...
updated_at: "2026-03-28 05:02:30.789850"
...
singularity registry hpc automated addition for r-roll
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/r-roll
```
...
#### r-roll-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-roll-inspect-deffile:
