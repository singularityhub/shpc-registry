...
updated_at: "2023-01-27 03:04:12.153685"
...
```bash
$ shpc install quay.io/biocontainers/transgenescan:1.2.1--hec16e2b_3
```
...
```bash
$ module load quay.io/biocontainers/transgenescan/1.2.1--hec16e2b_3
$ module help quay.io/biocontainers/transgenescan/1.2.1--hec16e2b_3
```
