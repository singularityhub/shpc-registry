...
updated_at: "2024-09-03 03:29:33.827503"
latest: "1.13.0--r43h21a89ab_0"
...
```bash
$ shpc install quay.io/biocontainers/r-signac:1.13.0--r43h21a89ab_0
```
...
```bash
$ module load quay.io/biocontainers/r-signac/1.13.0--r43h21a89ab_0
$ module help quay.io/biocontainers/r-signac/1.13.0--r43h21a89ab_0
```
