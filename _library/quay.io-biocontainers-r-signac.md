...
updated_at: "2024-07-01 03:02:41.888153"
latest: "1.12.0--r43h21a89ab_0"
...
```bash
$ shpc install quay.io/biocontainers/r-signac:1.12.0--r43h21a89ab_0
```
...
```bash
$ module load quay.io/biocontainers/r-signac/1.12.0--r43h21a89ab_0
$ module help quay.io/biocontainers/r-signac/1.12.0--r43h21a89ab_0
```
