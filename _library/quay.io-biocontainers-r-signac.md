...
updated_at: "2023-06-06 03:39:29.666857"
latest: "1.9.0--r42hecf12ef_1"
...
```bash
$ shpc install quay.io/biocontainers/r-signac:1.9.0--r42hecf12ef_1
```
...
```bash
$ module load quay.io/biocontainers/r-signac/1.9.0--r42hecf12ef_1
$ module help quay.io/biocontainers/r-signac/1.9.0--r42hecf12ef_1
```
