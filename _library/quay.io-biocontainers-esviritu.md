---
layout: container
name:  "quay.io/biocontainers/esviritu"
maintainer: "@vsoch"
...
updated_at: "2026-03-05 04:46:32.066437"
...
```bash
$ shpc install quay.io/biocontainers/esviritu
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/esviritu:1.1.6--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/esviritu/1.1.6--pyhdfd78af_0
$ module help quay.io/biocontainers/esviritu/1.1.6--pyhdfd78af_0
```
...
#### esviritu-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### esviritu-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/EsViritu
$ podman run --it --rm --entrypoint /usr/local/bin/EsViritu   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/EsViritu   -v ${PWD} -w ${PWD} <container> -c " $@"
```
