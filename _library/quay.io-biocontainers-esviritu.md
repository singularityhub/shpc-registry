...
updated_at: "2023-07-07 03:45:44.486610"
...
```bash
$ shpc install quay.io/biocontainers/esviritu:0.2.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/esviritu/0.2.2--pyhdfd78af_0
$ module help quay.io/biocontainers/esviritu/0.2.2--pyhdfd78af_0
```
