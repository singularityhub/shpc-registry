...
updated_at: "2025-08-17 03:44:35.299653"
...
```bash
$ shpc install quay.io/biocontainers/esviritu:1.0.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/esviritu/1.0.3--pyhdfd78af_0
$ module help quay.io/biocontainers/esviritu/1.0.3--pyhdfd78af_0
```
