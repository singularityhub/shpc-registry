...
updated_at: "2026-01-31 04:57:47.868571"
...
```bash
$ shpc install quay.io/biocontainers/esviritu:1.1.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/esviritu/1.1.2--pyhdfd78af_0
$ module help quay.io/biocontainers/esviritu/1.1.2--pyhdfd78af_0
```
