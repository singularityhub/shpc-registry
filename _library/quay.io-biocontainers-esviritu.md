...
updated_at: "2025-08-02 03:54:16.666898"
...
```bash
$ shpc install quay.io/biocontainers/esviritu:1.0.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/esviritu/1.0.2--pyhdfd78af_0
$ module help quay.io/biocontainers/esviritu/1.0.2--pyhdfd78af_0
```
