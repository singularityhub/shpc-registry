...
updated_at: "2024-04-30 02:45:34.415091"
...
```bash
$ shpc install quay.io/biocontainers/esviritu:0.2.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/esviritu/0.2.3--pyhdfd78af_0
$ module help quay.io/biocontainers/esviritu/0.2.3--pyhdfd78af_0
```
