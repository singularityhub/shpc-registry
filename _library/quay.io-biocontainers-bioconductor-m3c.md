...
updated_at: "2026-04-05 04:59:06.046295"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-m3c:1.32.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-m3c/1.32.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-m3c/1.32.0--r45hdfd78af_0
```
