...
updated_at: "2022-10-29 17:40:42.930082"
latest: "1.8.0--r36_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-m3c:1.8.0--r36_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-m3c/1.8.0--r36_0
$ module help quay.io/biocontainers/bioconductor-m3c/1.8.0--r36_0
```
