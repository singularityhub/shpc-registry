...
updated_at: "2024-09-10 03:32:49.557539"
latest: "1.24.0--r43hdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-m3c:1.24.0--r43hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-m3c/1.24.0--r43hdfd78af_1
$ module help quay.io/biocontainers/bioconductor-m3c/1.24.0--r43hdfd78af_1
```
