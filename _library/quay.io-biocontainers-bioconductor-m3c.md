...
updated_at: "2026-02-03 04:42:08.360174"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-m3c:1.28.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-m3c/1.28.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-m3c/1.28.0--r44hdfd78af_0
```
