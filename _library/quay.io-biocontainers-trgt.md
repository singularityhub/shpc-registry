...
updated_at: "2026-01-23 04:38:08.354417"
...
```bash
$ shpc install quay.io/biocontainers/trgt:5.0.0--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/trgt/5.0.0--h9ee0642_0
$ module help quay.io/biocontainers/trgt/5.0.0--h9ee0642_0
```
