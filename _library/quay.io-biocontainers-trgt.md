...
updated_at: "2025-03-21 03:37:07.653539"
...
```bash
$ shpc install quay.io/biocontainers/trgt:1.4.1--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/trgt/1.4.1--h9ee0642_0
$ module help quay.io/biocontainers/trgt/1.4.1--h9ee0642_0
```
