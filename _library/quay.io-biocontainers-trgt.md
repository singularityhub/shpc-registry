...
updated_at: "2024-02-08 08:16:13.829681"
...
```bash
$ shpc install quay.io/biocontainers/trgt:0.7.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/trgt/0.7.0--hdfd78af_0
$ module help quay.io/biocontainers/trgt/0.7.0--hdfd78af_0
```
