...
updated_at: "2026-09-05 06:49:22.989459"
...
```bash
$ shpc install quay.io/biocontainers/trgt:5.1.0--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/trgt/5.1.0--h9ee0642_0
$ module help quay.io/biocontainers/trgt/5.1.0--h9ee0642_0
```
