...
updated_at: "2025-05-06 03:12:35.550025"
...
```bash
$ shpc install quay.io/biocontainers/trgt:2.0.0--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/trgt/2.0.0--h9ee0642_0
$ module help quay.io/biocontainers/trgt/2.0.0--h9ee0642_0
```
