...
updated_at: "2022-11-07 00:50:49.199480"
latest: "1.4.0--r41hc0cfd56_2"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-fmrs:1.4.0--r41hc0cfd56_2
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-fmrs/1.4.0--r41hc0cfd56_2
$ module help quay.io/biocontainers/bioconductor-fmrs/1.4.0--r41hc0cfd56_2
```
