...
updated_at: "2024-12-07 03:49:21.807403"
latest: "2.2.1--hdbdd923_0"
...
```bash
$ shpc install quay.io/biocontainers/msweep:2.2.1--hdbdd923_0
```
...
```bash
$ module load quay.io/biocontainers/msweep/2.2.1--hdbdd923_0
$ module help quay.io/biocontainers/msweep/2.2.1--hdbdd923_0
```
