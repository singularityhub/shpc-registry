...
updated_at: "2023-08-28 02:50:36.212408"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-causalr:1.32.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-causalr/1.32.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-causalr/1.32.0--r43hdfd78af_0
```
