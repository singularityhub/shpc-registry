...
updated_at: "2026-04-03 15:21:36.013700"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-causalr:1.42.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-causalr/1.42.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-causalr/1.42.0--r45hdfd78af_0
```
