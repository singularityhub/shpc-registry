...
updated_at: "2022-11-02 19:20:21.587518"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-causalr:1.8.0--r3.3.2_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-causalr/1.8.0--r3.3.2_0
$ module help quay.io/biocontainers/bioconductor-causalr/1.8.0--r3.3.2_0
```
