...
updated_at: "2024-10-24 10:52:58.498848"
...
```bash
$ shpc install quay.io/biocontainers/genomad:1.8.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/genomad/1.8.1--pyhdfd78af_0
$ module help quay.io/biocontainers/genomad/1.8.1--pyhdfd78af_0
```
