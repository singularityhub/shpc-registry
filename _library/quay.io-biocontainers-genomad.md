...
updated_at: "2023-08-03 04:17:39.976048"
...
```bash
$ shpc install quay.io/biocontainers/genomad:1.5.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/genomad/1.5.2--pyhdfd78af_0
$ module help quay.io/biocontainers/genomad/1.5.2--pyhdfd78af_0
```
