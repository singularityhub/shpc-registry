...
updated_at: "2023-11-13 02:28:47.228886"
...
```bash
$ shpc install quay.io/biocontainers/genomad:1.7.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/genomad/1.7.1--pyhdfd78af_0
$ module help quay.io/biocontainers/genomad/1.7.1--pyhdfd78af_0
```
