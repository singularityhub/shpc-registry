...
updated_at: "2023-11-06 02:30:42.426348"
...
```bash
$ shpc install quay.io/biocontainers/genomad:1.7.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/genomad/1.7.0--pyhdfd78af_0
$ module help quay.io/biocontainers/genomad/1.7.0--pyhdfd78af_0
```
