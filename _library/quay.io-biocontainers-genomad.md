...
updated_at: "2024-04-05 02:46:18.200779"
...
```bash
$ shpc install quay.io/biocontainers/genomad:1.7.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/genomad/1.7.5--pyhdfd78af_0
$ module help quay.io/biocontainers/genomad/1.7.5--pyhdfd78af_0
```
