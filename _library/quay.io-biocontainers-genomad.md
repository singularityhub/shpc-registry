...
updated_at: "2024-07-28 03:08:37.410564"
...
```bash
$ shpc install quay.io/biocontainers/genomad:1.8.0--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/genomad/1.8.0--pyhdfd78af_1
$ module help quay.io/biocontainers/genomad/1.8.0--pyhdfd78af_1
```
