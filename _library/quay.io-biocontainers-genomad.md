...
updated_at: "2023-12-31 02:39:50.857357"
...
```bash
$ shpc install quay.io/biocontainers/genomad:1.7.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/genomad/1.7.3--pyhdfd78af_0
$ module help quay.io/biocontainers/genomad/1.7.3--pyhdfd78af_0
```
