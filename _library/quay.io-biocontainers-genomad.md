...
updated_at: "2024-02-26 04:07:07.406117"
...
```bash
$ shpc install quay.io/biocontainers/genomad:1.7.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/genomad/1.7.4--pyhdfd78af_0
$ module help quay.io/biocontainers/genomad/1.7.4--pyhdfd78af_0
```
