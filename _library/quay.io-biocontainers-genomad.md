...
updated_at: "2025-08-15 03:49:28.055958"
...
```bash
$ shpc install quay.io/biocontainers/genomad:1.11.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/genomad/1.11.1--pyhdfd78af_0
$ module help quay.io/biocontainers/genomad/1.11.1--pyhdfd78af_0
```
