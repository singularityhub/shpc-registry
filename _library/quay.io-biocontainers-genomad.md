...
updated_at: "2023-09-26 02:24:11.606876"
...
```bash
$ shpc install quay.io/biocontainers/genomad:1.6.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/genomad/1.6.1--pyhdfd78af_0
$ module help quay.io/biocontainers/genomad/1.6.1--pyhdfd78af_0
```
