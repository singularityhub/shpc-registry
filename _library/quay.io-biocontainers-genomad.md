...
updated_at: "2024-06-05 03:07:09.283276"
...
```bash
$ shpc install quay.io/biocontainers/genomad:1.8.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/genomad/1.8.0--pyhdfd78af_0
$ module help quay.io/biocontainers/genomad/1.8.0--pyhdfd78af_0
```
