...
updated_at: "2023-09-03 02:36:07.407656"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-tscan:1.38.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-tscan/1.38.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-tscan/1.38.0--r43hdfd78af_0
```
