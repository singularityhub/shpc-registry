...
updated_at: "2026-03-28 04:35:28.608276"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-bobafit:1.14.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-bobafit/1.14.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-bobafit/1.14.0--r45hdfd78af_0
```
