...
updated_at: "2023-10-19 03:27:24.583844"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-bobafit:1.4.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-bobafit/1.4.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-bobafit/1.4.0--r43hdfd78af_0
```
