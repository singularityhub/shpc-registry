...
updated_at: "2025-11-20 03:50:55.129004"
...
```bash
$ shpc install quay.io/biocontainers/pfp:0.3.9--h20648a7_3
```
...
```bash
$ module load quay.io/biocontainers/pfp/0.3.9--h20648a7_3
$ module help quay.io/biocontainers/pfp/0.3.9--h20648a7_3
```
