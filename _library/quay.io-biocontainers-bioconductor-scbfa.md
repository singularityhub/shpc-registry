...
updated_at: "2025-11-12 03:49:26.885067"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-scbfa:1.20.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-scbfa/1.20.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-scbfa/1.20.0--r44hdfd78af_0
```
