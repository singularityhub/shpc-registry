...
updated_at: "2026-06-02 06:59:38.444069"
...
```bash
$ shpc install quay.io/biocontainers/r-anndata:0.9.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/r-anndata/0.9.0--r45hdfd78af_0
$ module help quay.io/biocontainers/r-anndata/0.9.0--r45hdfd78af_0
```
