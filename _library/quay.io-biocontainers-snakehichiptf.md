---
layout: container
name:  "quay.io/biocontainers/snakehichiptf"
maintainer: "@vsoch"
github: "https://github.com/singularityhub/shpc-registry/blob/main/quay.io/biocontainers/snakehichiptf/container.yaml"
config_url: "https://raw.githubusercontent.com/singularityhub/shpc-registry/main/quay.io/biocontainers/snakehichiptf/container.yaml"
updated_at: "2026-04-21 05:19:03.820057"
latest: "0.1.4--pyhdfd78af_0"
container_url: "https://biocontainers.pro/tools/snakehichiptf"
aliases:
 - "Diffhichip"
 - "Genomesetup"
 - "Snakehichip"
...
versions:
 - "0.1.4--pyhdfd78af_0"
description: "singularity registry hpc automated addition for snakehichiptf"
config: {"url": "https://biocontainers.pro/tools/snakehichiptf", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for snakehichiptf", "latest": {"0.1.4--pyhdfd78af_0": "sha256:13cbddee1e126bdc81b1218a3ec82f4af2c0c4cb53895fee1f0b46a8a16c83d7"}, "tags": {"0.1.4--pyhdfd78af_0": "sha256:13cbddee1e126bdc81b1218a3ec82f4af2c0c4cb53895fee1f0b46a8a16c83d7"}, "docker": "quay.io/biocontainers/snakehichiptf", "aliases": {"Diffhichip": "/usr/local/bin/Diffhichip", "Genomesetup": "/usr/local/bin/Genomesetup", "Snakehichip": "/usr/local/bin/Snakehichip", "TFscprinter": "/usr/local/bin/TFscprinter", "TFtobias": "/usr/local/bin/TFtobias", "snakehichiptf": "/usr/local/bin/snakehichiptf", "snakehichiptf-ui": "/usr/local/bin/snakehichiptf-ui", "phc": "/usr/local/bin/phc", "eido": "/usr/local/bin/eido", "typer": "/usr/local/bin/typer", "rst2html": "/usr/local/bin/rst2html", "rst2html4": "/usr/local/bin/rst2html4", "rst2html5": "/usr/local/bin/rst2html5", "rst2latex": "/usr/local/bin/rst2latex", "rst2man": "/usr/local/bin/rst2man", "rst2odt": "/usr/local/bin/rst2odt", "rst2pseudoxml": "/usr/local/bin/rst2pseudoxml", "rst2s5": "/usr/local/bin/rst2s5", "rst2xetex": "/usr/local/bin/rst2xetex", "rst2xml": "/usr/local/bin/rst2xml", "yte": "/usr/local/bin/yte", "coloredlogs": "/usr/local/bin/coloredlogs", "docutils": "/usr/local/bin/docutils", "pulptest": "/usr/local/bin/pulptest", "snakemake": "/usr/local/bin/snakemake", "cbc": "/usr/local/bin/cbc", "clp": "/usr/local/bin/clp", "humanfriendly": "/usr/local/bin/humanfriendly", "markdown-it": "/usr/local/bin/markdown-it", "jupyter-trust": "/usr/local/bin/jupyter-trust", "tabulate": "/usr/local/bin/tabulate", "jupyter": "/usr/local/bin/jupyter"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/snakehichiptf.
singularity registry hpc automated addition for snakehichiptf
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/snakehichiptf
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/snakehichiptf:0.1.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakehichiptf/0.1.4--pyhdfd78af_0
$ module help quay.io/biocontainers/snakehichiptf/0.1.4--pyhdfd78af_0
```
...
#### snakehichiptf-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### snakehichiptf-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/Diffhichip
$ podman run --it --rm --entrypoint /usr/local/bin/Diffhichip   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/Diffhichip   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/Snakehichip
$ podman run --it --rm --entrypoint /usr/local/bin/Snakehichip   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/Snakehichip   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/TFscprinter
$ podman run --it --rm --entrypoint /usr/local/bin/TFscprinter   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/TFscprinter   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/TFtobias
$ podman run --it --rm --entrypoint /usr/local/bin/TFtobias   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/TFtobias   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/snakehichiptf
$ podman run --it --rm --entrypoint /usr/local/bin/snakehichiptf   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/snakehichiptf   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/snakehichiptf-ui
$ podman run --it --rm --entrypoint /usr/local/bin/snakehichiptf-ui   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/snakehichiptf-ui   -v ${PWD} -w ${PWD} <container> -c " $@"
```
