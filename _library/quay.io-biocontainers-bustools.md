...
updated_at: "2023-12-12 02:54:06.682805"
latest: "0.43.1--h1339bb5_0"
...
```bash
$ shpc install quay.io/biocontainers/bustools:0.43.1--h1339bb5_0
```
...
```bash
$ module load quay.io/biocontainers/bustools/0.43.1--h1339bb5_0
$ module help quay.io/biocontainers/bustools/0.43.1--h1339bb5_0
```
