...
updated_at: "2025-05-26 03:57:02.217706"
latest: "0.45.0--h6f0a7f7_0"
...
```bash
$ shpc install quay.io/biocontainers/bustools:0.45.0--h6f0a7f7_0
```
...
```bash
$ module load quay.io/biocontainers/bustools/0.45.0--h6f0a7f7_0
$ module help quay.io/biocontainers/bustools/0.45.0--h6f0a7f7_0
```
