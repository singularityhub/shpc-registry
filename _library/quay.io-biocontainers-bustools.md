...
updated_at: "2025-12-23 03:50:53.657163"
...
```bash
$ shpc install quay.io/biocontainers/bustools:0.45.1--h6f0a7f7_0
```
...
```bash
$ module load quay.io/biocontainers/bustools/0.45.1--h6f0a7f7_0
$ module help quay.io/biocontainers/bustools/0.45.1--h6f0a7f7_0
```
