...
updated_at: "2023-09-13 02:52:53.410817"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-drugvsdiseasedata:1.36.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-drugvsdiseasedata/1.36.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-drugvsdiseasedata/1.36.0--r43hdfd78af_0
```
