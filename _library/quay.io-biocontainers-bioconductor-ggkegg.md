---
layout: container
name:  "quay.io/biocontainers/bioconductor-ggkegg"
maintainer: "@vsoch"
...
updated_at: "2024-08-12 03:13:17.583090"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ggkegg
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-ggkegg:1.0.2--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ggkegg/1.0.2--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ggkegg/1.0.2--r43hdfd78af_0
```
...
#### bioconductor-ggkegg-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-ggkegg-inspect-deffile:
