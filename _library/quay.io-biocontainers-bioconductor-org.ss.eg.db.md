...
updated_at: "2025-03-24 03:15:37.875230"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-org.ss.eg.db:3.20.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-org.ss.eg.db/3.20.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-org.ss.eg.db/3.20.0--r44hdfd78af_0
```
