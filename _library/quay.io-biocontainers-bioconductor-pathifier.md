...
updated_at: "2023-11-04 02:34:41.088676"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-pathifier:1.38.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-pathifier/1.38.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-pathifier/1.38.0--r43hdfd78af_0
```
