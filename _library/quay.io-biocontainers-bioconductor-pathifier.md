...
updated_at: "2024-01-08 03:30:47.532093"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-pathifier:1.40.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-pathifier/1.40.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-pathifier/1.40.0--r43hdfd78af_0
```
