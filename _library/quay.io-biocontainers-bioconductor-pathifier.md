...
updated_at: "2022-10-29 05:49:09.085308"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-pathifier:1.32.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-pathifier/1.32.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-pathifier/1.32.0--r41hdfd78af_0
```
