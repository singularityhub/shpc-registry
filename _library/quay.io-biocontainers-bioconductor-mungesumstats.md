...
updated_at: "2026-04-03 04:44:04.350955"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mungesumstats:1.18.1--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mungesumstats/1.18.1--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-mungesumstats/1.18.1--r45hdfd78af_0
```
