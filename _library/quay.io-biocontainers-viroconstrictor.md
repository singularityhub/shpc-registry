...
updated_at: "2026-02-05 04:41:36.479315"
...
```bash
$ shpc install quay.io/biocontainers/viroconstrictor:1.6.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/viroconstrictor/1.6.3--pyhdfd78af_0
$ module help quay.io/biocontainers/viroconstrictor/1.6.3--pyhdfd78af_0
```
