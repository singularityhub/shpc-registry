...
updated_at: "2025-10-08 03:24:09.409700"
...
```bash
$ shpc install quay.io/biocontainers/viroconstrictor:1.5.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/viroconstrictor/1.5.5--pyhdfd78af_0
$ module help quay.io/biocontainers/viroconstrictor/1.5.5--pyhdfd78af_0
```
