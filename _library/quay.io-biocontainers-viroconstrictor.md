...
updated_at: "2026-02-19 04:46:27.475217"
...
```bash
$ shpc install quay.io/biocontainers/viroconstrictor:1.6.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/viroconstrictor/1.6.4--pyhdfd78af_0
$ module help quay.io/biocontainers/viroconstrictor/1.6.4--pyhdfd78af_0
```
