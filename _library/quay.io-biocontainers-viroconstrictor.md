...
updated_at: "2025-04-09 03:27:10.341219"
...
```bash
$ shpc install quay.io/biocontainers/viroconstrictor:1.5.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/viroconstrictor/1.5.1--pyhdfd78af_0
$ module help quay.io/biocontainers/viroconstrictor/1.5.1--pyhdfd78af_0
```
