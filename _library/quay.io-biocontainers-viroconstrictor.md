...
updated_at: "2026-04-03 04:57:48.312214"
...
```bash
$ shpc install quay.io/biocontainers/viroconstrictor:1.6.6--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/viroconstrictor/1.6.6--pyhdfd78af_0
$ module help quay.io/biocontainers/viroconstrictor/1.6.6--pyhdfd78af_0
```
