...
updated_at: "2025-08-04 04:59:58.141026"
...
```bash
$ shpc install quay.io/biocontainers/viroconstrictor:1.5.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/viroconstrictor/1.5.4--pyhdfd78af_0
$ module help quay.io/biocontainers/viroconstrictor/1.5.4--pyhdfd78af_0
```
