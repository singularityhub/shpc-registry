...
updated_at: "2025-04-27 03:20:00.974868"
...
```bash
$ shpc install quay.io/biocontainers/viroconstrictor:1.5.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/viroconstrictor/1.5.2--pyhdfd78af_0
$ module help quay.io/biocontainers/viroconstrictor/1.5.2--pyhdfd78af_0
```
