...
updated_at: "2025-02-24 03:12:35.302976"
...
```bash
$ shpc install quay.io/biocontainers/viroconstrictor:1.5.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/viroconstrictor/1.5.0--pyhdfd78af_0
$ module help quay.io/biocontainers/viroconstrictor/1.5.0--pyhdfd78af_0
```
