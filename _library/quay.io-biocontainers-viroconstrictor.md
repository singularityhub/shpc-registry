...
updated_at: "2024-04-12 02:45:14.460080"
latest: "1.4.0--pyhdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/viroconstrictor:1.4.0--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/viroconstrictor/1.4.0--pyhdfd78af_1
$ module help quay.io/biocontainers/viroconstrictor/1.4.0--pyhdfd78af_1
```
