...
updated_at: "2024-12-17 03:51:32.461770"
...
```bash
$ shpc install quay.io/biocontainers/viroconstrictor:1.4.6--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/viroconstrictor/1.4.6--pyhdfd78af_0
$ module help quay.io/biocontainers/viroconstrictor/1.4.6--pyhdfd78af_0
```
