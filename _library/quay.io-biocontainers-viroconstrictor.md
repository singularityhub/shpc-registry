...
updated_at: "2025-12-30 04:04:20.937260"
...
```bash
$ shpc install quay.io/biocontainers/viroconstrictor:1.6.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/viroconstrictor/1.6.1--pyhdfd78af_0
$ module help quay.io/biocontainers/viroconstrictor/1.6.1--pyhdfd78af_0
```
