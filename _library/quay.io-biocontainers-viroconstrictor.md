...
updated_at: "2025-07-06 03:59:32.136794"
...
```bash
$ shpc install quay.io/biocontainers/viroconstrictor:1.5.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/viroconstrictor/1.5.3--pyhdfd78af_0
$ module help quay.io/biocontainers/viroconstrictor/1.5.3--pyhdfd78af_0
```
