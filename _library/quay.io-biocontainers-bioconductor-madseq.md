...
updated_at: "2025-03-21 03:37:33.893928"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-madseq:1.32.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-madseq/1.32.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-madseq/1.32.0--r44hdfd78af_0
```
