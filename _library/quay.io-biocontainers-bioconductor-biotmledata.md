...
updated_at: "2026-04-02 05:00:02.661110"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-biotmledata:1.34.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-biotmledata/1.34.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-biotmledata/1.34.0--r45hdfd78af_0
```
