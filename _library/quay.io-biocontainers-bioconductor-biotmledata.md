...
updated_at: "2024-12-09 03:18:39.344496"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-biotmledata:1.26.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-biotmledata/1.26.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-biotmledata/1.26.0--r43hdfd78af_0
```
