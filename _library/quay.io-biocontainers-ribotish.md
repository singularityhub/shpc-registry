...
updated_at: "2026-01-20 04:12:45.191870"
...
```bash
$ shpc install quay.io/biocontainers/ribotish:0.2.8--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ribotish/0.2.8--pyhdfd78af_0
$ module help quay.io/biocontainers/ribotish/0.2.8--pyhdfd78af_0
```
