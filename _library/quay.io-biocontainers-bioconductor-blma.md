...
updated_at: "2025-01-16 03:17:19.763940"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-blma:1.26.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-blma/1.26.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-blma/1.26.0--r43hdfd78af_0
```
