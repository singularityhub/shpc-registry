...
updated_at: "2025-10-16 03:43:42.293526"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-blma:1.30.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-blma/1.30.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-blma/1.30.0--r44hdfd78af_0
```
