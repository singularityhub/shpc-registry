---
layout: container
name:  "quay.io/biocontainers/bqc"
maintainer: "@vsoch"
...
updated_at: "2026-09-03 07:28:07.452193"
...
singularity registry hpc automated addition for bqc
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/bqc
```
...
```bash
$ singularity exec <container> /usr/local/bin/bqc
$ podman run --it --rm --entrypoint /usr/local/bin/bqc   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/bqc   -v ${PWD} -w ${PWD} <container> -c " $@"
```
