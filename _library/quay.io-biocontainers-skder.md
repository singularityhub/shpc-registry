...
updated_at: "2026-09-21 08:24:03.055356"
...
```bash
$ shpc install quay.io/biocontainers/skder:1.3.8--py311h3cb736e_0
```
...
```bash
$ module load quay.io/biocontainers/skder/1.3.8--py311h3cb736e_0
$ module help quay.io/biocontainers/skder/1.3.8--py311h3cb736e_0
```
