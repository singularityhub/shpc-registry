...
updated_at: "2026-03-24 04:46:11.203549"
latest: "1.3.4--py313hcd54142_2"
...
```bash
$ shpc install quay.io/biocontainers/skder:1.3.4--py313hcd54142_2
```
...
```bash
$ module load quay.io/biocontainers/skder/1.3.4--py313hcd54142_2
$ module help quay.io/biocontainers/skder/1.3.4--py313hcd54142_2
```
