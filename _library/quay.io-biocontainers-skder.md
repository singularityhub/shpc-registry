...
updated_at: "2023-10-12 03:38:03.830984"
latest: "1.0.5--py310h0dbaff4_0"
...
```bash
$ shpc install quay.io/biocontainers/skder:1.0.5--py310h0dbaff4_0
```
...
```bash
$ module load quay.io/biocontainers/skder/1.0.5--py310h0dbaff4_0
$ module help quay.io/biocontainers/skder/1.0.5--py310h0dbaff4_0
```
