...
updated_at: "2024-12-20 03:35:03.240873"
latest: "1.2.8--py312hf731ba3_1"
...
```bash
$ shpc install quay.io/biocontainers/skder:1.2.8--py312hf731ba3_1
```
...
```bash
$ module load quay.io/biocontainers/skder/1.2.8--py312hf731ba3_1
$ module help quay.io/biocontainers/skder/1.2.8--py312hf731ba3_1
```
