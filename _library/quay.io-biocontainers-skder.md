...
updated_at: "2026-07-02 06:04:53.420723"
latest: "1.3.6--py312h9b2995c_0"
...
```bash
$ shpc install quay.io/biocontainers/skder:1.3.6--py312h9b2995c_0
```
...
```bash
$ module load quay.io/biocontainers/skder/1.3.6--py312h9b2995c_0
$ module help quay.io/biocontainers/skder/1.3.6--py312h9b2995c_0
```
