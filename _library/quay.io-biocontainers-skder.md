...
updated_at: "2025-03-28 03:40:15.095754"
latest: "1.2.9--py312hf731ba3_0"
...
```bash
$ shpc install quay.io/biocontainers/skder:1.2.9--py312hf731ba3_0
```
...
```bash
$ module load quay.io/biocontainers/skder/1.2.9--py312hf731ba3_0
$ module help quay.io/biocontainers/skder/1.2.9--py312hf731ba3_0
```
