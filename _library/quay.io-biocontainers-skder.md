...
updated_at: "2024-07-20 03:04:11.512266"
latest: "1.2.3--py311h2a4ad6c_0"
...
```bash
$ shpc install quay.io/biocontainers/skder:1.2.3--py311h2a4ad6c_0
```
...
```bash
$ module load quay.io/biocontainers/skder/1.2.3--py311h2a4ad6c_0
$ module help quay.io/biocontainers/skder/1.2.3--py311h2a4ad6c_0
```
