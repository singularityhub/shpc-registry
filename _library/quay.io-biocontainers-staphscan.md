...
updated_at: "2026-06-23 16:48:34.538521"
...
```bash
$ shpc install quay.io/biocontainers/staphscan:0.3.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/staphscan/0.3.1--pyhdfd78af_0
$ module help quay.io/biocontainers/staphscan/0.3.1--pyhdfd78af_0
```
