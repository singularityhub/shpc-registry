...
updated_at: "2026-05-05 05:45:15.411120"
...
```bash
$ shpc install quay.io/biocontainers/staphscan:0.3.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/staphscan/0.3.0--pyhdfd78af_0
$ module help quay.io/biocontainers/staphscan/0.3.0--pyhdfd78af_0
```
