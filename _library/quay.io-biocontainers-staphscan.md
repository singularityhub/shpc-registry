...
updated_at: "2026-08-26 03:39:25.193823"
...
```bash
$ shpc install quay.io/biocontainers/staphscan:0.4.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/staphscan/0.4.1--pyhdfd78af_0
$ module help quay.io/biocontainers/staphscan/0.4.1--pyhdfd78af_0
```
