---
layout: container
name:  "quay.io/biocontainers/staphscan"
maintainer: "@vsoch"
...
updated_at: "2026-07-20 06:20:17.047624"
...
```bash
$ module load quay.io/biocontainers/staphscan/0.4.0--pyhdfd78af_0
$ module help quay.io/biocontainers/staphscan/0.4.0--pyhdfd78af_0
```
...
#### staphscan-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### staphscan-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/staphscan
$ podman run --it --rm --entrypoint /usr/local/bin/staphscan   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/staphscan   -v ${PWD} -w ${PWD} <container> -c " $@"
```
