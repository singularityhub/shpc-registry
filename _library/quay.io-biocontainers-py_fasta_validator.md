...
updated_at: "2025-03-13 03:29:14.944149"
latest: "0.6--py39h475c85d_5"
...
```bash
$ shpc install quay.io/biocontainers/py_fasta_validator:0.6--py39h475c85d_5
```
...
```bash
$ module load quay.io/biocontainers/py_fasta_validator/0.6--py39h475c85d_5
$ module help quay.io/biocontainers/py_fasta_validator/0.6--py39h475c85d_5
```
