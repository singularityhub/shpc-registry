...
updated_at: "2026-04-03 15:22:43.923485"
latest: "0.6--py311h93bbee8_7"
...
```bash
$ shpc install quay.io/biocontainers/py_fasta_validator:0.6--py311h93bbee8_7
```
...
```bash
$ module load quay.io/biocontainers/py_fasta_validator/0.6--py311h93bbee8_7
$ module help quay.io/biocontainers/py_fasta_validator/0.6--py311h93bbee8_7
```
