...
updated_at: "2025-07-31 11:26:21.378848"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ahmassbank:1.6.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ahmassbank/1.6.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ahmassbank/1.6.0--r44hdfd78af_0
```
