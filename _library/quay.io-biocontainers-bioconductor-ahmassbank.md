...
updated_at: "2024-06-24 02:37:02.239101"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ahmassbank:1.2.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ahmassbank/1.2.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ahmassbank/1.2.0--r43hdfd78af_0
```
