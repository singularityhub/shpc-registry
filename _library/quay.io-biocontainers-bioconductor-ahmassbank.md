...
updated_at: "2023-11-07 03:09:04.471686"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ahmassbank:1.0.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ahmassbank/1.0.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ahmassbank/1.0.0--r43hdfd78af_0
```
