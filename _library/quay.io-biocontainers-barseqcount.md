...
updated_at: "2023-02-23 03:14:16.356470"
...
```bash
$ shpc install quay.io/biocontainers/barseqcount:0.1.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/barseqcount/0.1.3--pyhdfd78af_0
$ module help quay.io/biocontainers/barseqcount/0.1.3--pyhdfd78af_0
```
