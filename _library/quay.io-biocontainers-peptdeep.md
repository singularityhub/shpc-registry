...
updated_at: "2026-08-08 03:39:13.207148"
...
```bash
$ shpc install quay.io/biocontainers/peptdeep:1.5.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/peptdeep/1.5.1--pyhdfd78af_0
$ module help quay.io/biocontainers/peptdeep/1.5.1--pyhdfd78af_0
```
