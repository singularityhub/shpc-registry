...
updated_at: "2026-06-13 06:44:43.107055"
...
```bash
$ shpc install quay.io/biocontainers/peptdeep:1.5.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/peptdeep/1.5.0--pyhdfd78af_0
$ module help quay.io/biocontainers/peptdeep/1.5.0--pyhdfd78af_0
```
