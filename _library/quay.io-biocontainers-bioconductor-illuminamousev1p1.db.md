...
updated_at: "2026-03-27 05:12:06.443399"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-illuminamousev1p1.db:1.26.0--r45hdfd78af_14
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-illuminamousev1p1.db/1.26.0--r45hdfd78af_14
$ module help quay.io/biocontainers/bioconductor-illuminamousev1p1.db/1.26.0--r45hdfd78af_14
```
