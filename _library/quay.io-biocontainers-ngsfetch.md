---
layout: container
name:  "quay.io/biocontainers/ngsfetch"
maintainer: "@vsoch"
...
updated_at: "2025-11-03 04:06:19.087892"
...
singularity registry hpc automated addition for ngsfetch
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/ngsfetch
```
...
#### ngsfetch-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### ngsfetch-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/ngsfetch
$ podman run --it --rm --entrypoint /usr/local/bin/ngsfetch   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/ngsfetch   -v ${PWD} -w ${PWD} <container> -c " $@"
```
