...
updated_at: "2022-10-29 05:33:02.390692"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hireadsprocessor:1.30.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hireadsprocessor/1.30.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-hireadsprocessor/1.30.0--r41hdfd78af_0
```
