...
updated_at: "2022-10-27 01:12:03.234071"
latest: "1.6.6--r3.3.2_1"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-biocparallel:1.6.6--r3.3.2_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-biocparallel/1.6.6--r3.3.2_1
$ module help quay.io/biocontainers/bioconductor-biocparallel/1.6.6--r3.3.2_1
```
