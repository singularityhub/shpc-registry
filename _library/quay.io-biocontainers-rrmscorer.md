---
layout: container
name:  "quay.io/biocontainers/rrmscorer"
maintainer: "@vsoch"
...
updated_at: "2023-09-18 02:56:35.709287"
...
```bash
$ shpc install quay.io/biocontainers/rrmscorer
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/rrmscorer:1.0.8--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/rrmscorer/1.0.8--pyhdfd78af_0
$ module help quay.io/biocontainers/rrmscorer/1.0.8--pyhdfd78af_0
```
...
#### rrmscorer-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### rrmscorer-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/rrmscorer
$ podman run --it --rm --entrypoint /usr/local/bin/rrmscorer   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/rrmscorer   -v ${PWD} -w ${PWD} <container> -c " $@"
```
