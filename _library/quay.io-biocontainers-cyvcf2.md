...
updated_at: "2026-04-04 04:27:34.313091"
latest: "0.32.1--py311h921ead3_0"
...
```bash
$ shpc install quay.io/biocontainers/cyvcf2:0.32.1--py311h921ead3_0
```
...
```bash
$ module load quay.io/biocontainers/cyvcf2/0.32.1--py311h921ead3_0
$ module help quay.io/biocontainers/cyvcf2/0.32.1--py311h921ead3_0
```
