...
updated_at: "2025-11-16 03:47:55.671445"
latest: "0.31.4--py39h3a9e823_0"
...
```bash
$ shpc install quay.io/biocontainers/cyvcf2:0.31.4--py39h3a9e823_0
```
...
```bash
$ module load quay.io/biocontainers/cyvcf2/0.31.4--py39h3a9e823_0
$ module help quay.io/biocontainers/cyvcf2/0.31.4--py39h3a9e823_0
```
