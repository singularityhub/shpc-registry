...
updated_at: "2022-11-02 18:55:14.164132"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-drugvsdisease:2.36.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-drugvsdisease/2.36.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-drugvsdisease/2.36.0--r41hdfd78af_0
```
