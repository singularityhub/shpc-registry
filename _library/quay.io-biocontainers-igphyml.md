...
updated_at: "2026-08-25 09:26:48.739389"
latest: "2.0.0--h65f4b68_0"
...
```bash
$ shpc install quay.io/biocontainers/igphyml:2.0.0--h65f4b68_0
```
...
```bash
$ module load quay.io/biocontainers/igphyml/2.0.0--h65f4b68_0
$ module help quay.io/biocontainers/igphyml/2.0.0--h65f4b68_0
```
