...
updated_at: "2026-06-23 17:05:00.897221"
...
```bash
$ shpc install quay.io/biocontainers/immunotype:1.0.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/immunotype/1.0.4--pyhdfd78af_0
$ module help quay.io/biocontainers/immunotype/1.0.4--pyhdfd78af_0
```
