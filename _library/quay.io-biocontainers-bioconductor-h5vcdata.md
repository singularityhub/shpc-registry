...
updated_at: "2026-03-07 04:19:07.572758"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-h5vcdata:2.30.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-h5vcdata/2.30.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-h5vcdata/2.30.0--r45hdfd78af_0
```
