...
updated_at: "2024-10-26 03:35:36.978559"
latest: "0.4.6--h2bf1ecc_0"
...
```bash
$ shpc install quay.io/biocontainers/pcaone:0.4.6--h2bf1ecc_0
```
...
```bash
$ module load quay.io/biocontainers/pcaone/0.4.6--h2bf1ecc_0
$ module help quay.io/biocontainers/pcaone/0.4.6--h2bf1ecc_0
```
