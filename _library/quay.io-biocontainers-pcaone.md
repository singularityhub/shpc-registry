...
updated_at: "2025-08-14 03:44:19.853038"
latest: "0.5.4--ha628be3_0"
...
```bash
$ shpc install quay.io/biocontainers/pcaone:0.5.4--ha628be3_0
```
...
```bash
$ module load quay.io/biocontainers/pcaone/0.5.4--ha628be3_0
$ module help quay.io/biocontainers/pcaone/0.5.4--ha628be3_0
```
