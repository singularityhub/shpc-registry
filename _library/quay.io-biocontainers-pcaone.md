...
updated_at: "2025-06-20 06:05:46.341279"
latest: "0.5.2--ha628be3_0"
...
```bash
$ shpc install quay.io/biocontainers/pcaone:0.5.2--ha628be3_0
```
...
```bash
$ module load quay.io/biocontainers/pcaone/0.5.2--ha628be3_0
$ module help quay.io/biocontainers/pcaone/0.5.2--ha628be3_0
```
