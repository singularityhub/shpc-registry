...
updated_at: "2024-03-11 02:55:21.490295"
latest: "0.4.3--hf73f384_0"
...
```bash
$ shpc install quay.io/biocontainers/pcaone:0.4.3--hf73f384_0
```
...
```bash
$ module load quay.io/biocontainers/pcaone/0.4.3--hf73f384_0
$ module help quay.io/biocontainers/pcaone/0.4.3--hf73f384_0
```
