...
updated_at: "2025-08-03 04:28:55.498409"
latest: "0.5.3--ha628be3_0"
...
```bash
$ shpc install quay.io/biocontainers/pcaone:0.5.3--ha628be3_0
```
...
```bash
$ module load quay.io/biocontainers/pcaone/0.5.3--ha628be3_0
$ module help quay.io/biocontainers/pcaone/0.5.3--ha628be3_0
```
