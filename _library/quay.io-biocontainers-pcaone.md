...
updated_at: "2025-04-19 03:16:39.608295"
latest: "0.4.8--h2bf1ecc_0"
...
```bash
$ shpc install quay.io/biocontainers/pcaone:0.4.8--h2bf1ecc_0
```
...
```bash
$ module load quay.io/biocontainers/pcaone/0.4.8--h2bf1ecc_0
$ module help quay.io/biocontainers/pcaone/0.4.8--h2bf1ecc_0
```
