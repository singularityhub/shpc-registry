...
updated_at: "2025-04-20 03:13:16.510124"
...
```bash
$ shpc install quay.io/biocontainers/fasten:0.8.5--hc1c3326_0
```
...
```bash
$ module load quay.io/biocontainers/fasten/0.8.5--hc1c3326_0
$ module help quay.io/biocontainers/fasten/0.8.5--hc1c3326_0
```
