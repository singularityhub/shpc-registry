...
updated_at: "2025-01-14 02:57:06.516797"
latest: "0.8.3--h7b50bb2_1"
...
```bash
$ shpc install quay.io/biocontainers/fasten:0.8.3--h7b50bb2_1
```
...
```bash
$ module load quay.io/biocontainers/fasten/0.8.3--h7b50bb2_1
$ module help quay.io/biocontainers/fasten/0.8.3--h7b50bb2_1
```
