...
updated_at: "2026-01-01 07:02:00.681046"
latest: "0.9.0--hc1c3326_0"
...
```bash
$ shpc install quay.io/biocontainers/fasten:0.9.0--hc1c3326_0
```
...
```bash
$ module load quay.io/biocontainers/fasten/0.9.0--hc1c3326_0
$ module help quay.io/biocontainers/fasten/0.9.0--hc1c3326_0
```
