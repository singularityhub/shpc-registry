...
updated_at: "2025-10-18 02:57:35.520262"
...
```bash
$ shpc install quay.io/biocontainers/perl-cgi:4.70--pl5321h7b50bb2_0
```
...
```bash
$ module load quay.io/biocontainers/perl-cgi/4.70--pl5321h7b50bb2_0
$ module help quay.io/biocontainers/perl-cgi/4.70--pl5321h7b50bb2_0
```
