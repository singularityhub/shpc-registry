...
updated_at: "2026-04-05 05:01:37.376612"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-fastqcleaner:1.28.0--r45ha27e39d_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-fastqcleaner/1.28.0--r45ha27e39d_0
$ module help quay.io/biocontainers/bioconductor-fastqcleaner/1.28.0--r45ha27e39d_0
```
