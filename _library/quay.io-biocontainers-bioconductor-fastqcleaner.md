...
updated_at: "2024-03-16 03:02:23.011995"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-fastqcleaner:1.20.0--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-fastqcleaner/1.20.0--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-fastqcleaner/1.20.0--r43hf17093f_0
```
