...
updated_at: "2024-11-28 03:56:34.054285"
latest: "1.0.1--h6f6fda4_2"
...
```bash
$ shpc install quay.io/biocontainers/sambamba:1.0.1--h6f6fda4_2
```
...
```bash
$ module load quay.io/biocontainers/sambamba/1.0.1--h6f6fda4_2
$ module help quay.io/biocontainers/sambamba/1.0.1--h6f6fda4_2
```
