...
updated_at: "2024-07-08 03:16:59.209260"
latest: "1.0.1--h6f6fda4_0"
...
```bash
$ shpc install quay.io/biocontainers/sambamba:1.0.1--h6f6fda4_0
```
...
```bash
$ module load quay.io/biocontainers/sambamba/1.0.1--h6f6fda4_0
$ module help quay.io/biocontainers/sambamba/1.0.1--h6f6fda4_0
```
