...
updated_at: "2023-12-05 02:40:26.312874"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ecolicdf:2.18.0--r43hdfd78af_11
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ecolicdf/2.18.0--r43hdfd78af_11
$ module help quay.io/biocontainers/bioconductor-ecolicdf/2.18.0--r43hdfd78af_11
```
