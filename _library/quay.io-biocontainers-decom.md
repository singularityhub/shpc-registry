...
updated_at: "2024-07-26 02:49:21.346500"
...
```bash
$ shpc install quay.io/biocontainers/decom:0.0.32--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/decom/0.0.32--pyh7cba7a3_0
$ module help quay.io/biocontainers/decom/0.0.32--pyh7cba7a3_0
```
