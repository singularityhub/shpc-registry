...
updated_at: "2026-08-17 03:16:23.811347"
...
```bash
$ shpc install quay.io/biocontainers/cdhit-reader:0.5.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/cdhit-reader/0.5.0--pyhdfd78af_0
$ module help quay.io/biocontainers/cdhit-reader/0.5.0--pyhdfd78af_0
```
