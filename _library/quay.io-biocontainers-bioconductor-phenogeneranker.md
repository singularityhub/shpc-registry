...
updated_at: "2024-07-11 03:32:33.722994"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-phenogeneranker:1.10.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-phenogeneranker/1.10.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-phenogeneranker/1.10.0--r43hdfd78af_0
```
