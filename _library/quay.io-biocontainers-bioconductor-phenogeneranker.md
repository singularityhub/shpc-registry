...
updated_at: "2026-01-02 04:24:03.283041"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-phenogeneranker:1.14.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-phenogeneranker/1.14.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-phenogeneranker/1.14.0--r44hdfd78af_0
```
