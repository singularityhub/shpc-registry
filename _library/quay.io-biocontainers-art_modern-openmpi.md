---
layout: container
name:  "quay.io/biocontainers/art_modern-openmpi"
maintainer: "@vsoch"
...
updated_at: "2026-02-05 04:22:18.764024"
latest: "1.3.3--h572f19f_0"
container_url: "https://biocontainers.pro/tools/art_modern-openmpi"
aliases:
 - "art_modern-mpi"
 - "art_profile_builder-mpi"
 - "ref-cache"
 - "shmemrun"
 - "oshCC"
 - "oshc++"
...
```bash
$ module load quay.io/biocontainers/art_modern-openmpi/1.3.3--h572f19f_0
$ module help quay.io/biocontainers/art_modern-openmpi/1.3.3--h572f19f_0
```
...
#### art_modern-openmpi-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### art_modern-openmpi-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/art_modern-mpi
$ podman run --it --rm --entrypoint /usr/local/bin/art_modern-mpi   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/art_modern-mpi   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/art_profile_builder-mpi
$ podman run --it --rm --entrypoint /usr/local/bin/art_profile_builder-mpi   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/art_profile_builder-mpi   -v ${PWD} -w ${PWD} <container> -c " $@"
```
