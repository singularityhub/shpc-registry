...
updated_at: "2026-03-28 04:56:26.848026"
latest: "1.3.4--hc83d959_0"
...
```bash
$ shpc install quay.io/biocontainers/art_modern-openmpi:1.3.4--hc83d959_0
```
...
```bash
$ module load quay.io/biocontainers/art_modern-openmpi/1.3.4--hc83d959_0
$ module help quay.io/biocontainers/art_modern-openmpi/1.3.4--hc83d959_0
```
