...
updated_at: "2026-08-19 03:29:34.273225"
...
```bash
$ shpc install quay.io/biocontainers/art_modern-openmpi:1.5.1--h7ccb3a4_0
```
...
```bash
$ module load quay.io/biocontainers/art_modern-openmpi/1.5.1--h7ccb3a4_0
$ module help quay.io/biocontainers/art_modern-openmpi/1.5.1--h7ccb3a4_0
```
