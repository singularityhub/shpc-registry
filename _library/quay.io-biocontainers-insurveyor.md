...
updated_at: "2023-07-07 03:29:31.179386"
latest: "1.1.1--h4ac6f70_1"
...
```bash
$ shpc install quay.io/biocontainers/insurveyor:1.1.1--h4ac6f70_1
```
...
```bash
$ module load quay.io/biocontainers/insurveyor/1.1.1--h4ac6f70_1
$ module help quay.io/biocontainers/insurveyor/1.1.1--h4ac6f70_1
```
