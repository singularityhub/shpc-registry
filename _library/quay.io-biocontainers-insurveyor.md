...
updated_at: "2024-04-25 02:27:07.132140"
latest: "1.1.2--h4ac6f70_0"
...
```bash
$ shpc install quay.io/biocontainers/insurveyor:1.1.2--h4ac6f70_0
```
...
```bash
$ module load quay.io/biocontainers/insurveyor/1.1.2--h4ac6f70_0
$ module help quay.io/biocontainers/insurveyor/1.1.2--h4ac6f70_0
```
