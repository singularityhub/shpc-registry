...
updated_at: "2024-10-03 02:54:29.467432"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hs6ug171.db:3.2.3--r43hdfd78af_12
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hs6ug171.db/3.2.3--r43hdfd78af_12
$ module help quay.io/biocontainers/bioconductor-hs6ug171.db/3.2.3--r43hdfd78af_12
```
