...
updated_at: "2026-04-02 04:34:00.966965"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hs6ug171.db:3.2.3--r45hdfd78af_14
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hs6ug171.db/3.2.3--r45hdfd78af_14
$ module help quay.io/biocontainers/bioconductor-hs6ug171.db/3.2.3--r45hdfd78af_14
```
