...
updated_at: "2025-12-05 03:40:03.203781"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-pviz:1.40.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-pviz/1.40.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-pviz/1.40.0--r44hdfd78af_0
```
