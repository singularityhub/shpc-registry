...
updated_at: "2024-10-16 04:03:21.286426"
latest: "0.0.5--py39h9e0f934_9"
...
```bash
$ shpc install quay.io/biocontainers/krbalancing:0.0.5--py39h9e0f934_9
```
...
```bash
$ module load quay.io/biocontainers/krbalancing/0.0.5--py39h9e0f934_9
$ module help quay.io/biocontainers/krbalancing/0.0.5--py39h9e0f934_9
```
