...
updated_at: "2025-08-21 06:33:04.866978"
latest: "0.1.1--h35c04b2_0"
...
```bash
$ shpc install quay.io/biocontainers/teloscope:0.1.1--h35c04b2_0
```
...
```bash
$ module load quay.io/biocontainers/teloscope/0.1.1--h35c04b2_0
$ module help quay.io/biocontainers/teloscope/0.1.1--h35c04b2_0
```
