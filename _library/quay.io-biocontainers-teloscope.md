...
updated_at: "2026-08-17 03:07:45.969950"
latest: "0.1.5--hdabf1b5_1"
...
```bash
$ shpc install quay.io/biocontainers/teloscope:0.1.5--hdabf1b5_1
```
...
```bash
$ module load quay.io/biocontainers/teloscope/0.1.5--hdabf1b5_1
$ module help quay.io/biocontainers/teloscope/0.1.5--hdabf1b5_1
```
