...
updated_at: "2023-11-04 02:30:17.731562"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-txdb.sscrofa.ucsc.susscr3.refgene:3.12.0--r43hdfd78af_6
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-txdb.sscrofa.ucsc.susscr3.refgene/3.12.0--r43hdfd78af_6
$ module help quay.io/biocontainers/bioconductor-txdb.sscrofa.ucsc.susscr3.refgene/3.12.0--r43hdfd78af_6
```
