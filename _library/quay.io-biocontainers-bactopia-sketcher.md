...
updated_at: "2026-04-05 05:20:43.051817"
...
```bash
$ shpc install quay.io/biocontainers/bactopia-sketcher:1.0.3--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bactopia-sketcher/1.0.3--hdfd78af_0
$ module help quay.io/biocontainers/bactopia-sketcher/1.0.3--hdfd78af_0
```
