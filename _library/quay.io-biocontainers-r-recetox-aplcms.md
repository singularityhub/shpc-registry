...
updated_at: "2026-01-31 04:14:18.183944"
latest: "0.14.2--r43hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/r-recetox-aplcms:0.14.2--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/r-recetox-aplcms/0.14.2--r43hdfd78af_0
$ module help quay.io/biocontainers/r-recetox-aplcms/0.14.2--r43hdfd78af_0
```
