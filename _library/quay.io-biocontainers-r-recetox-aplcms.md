...
updated_at: "2026-08-26 03:58:41.262149"
...
```bash
$ shpc install quay.io/biocontainers/r-recetox-aplcms:0.15.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/r-recetox-aplcms/0.15.0--r45hdfd78af_0
$ module help quay.io/biocontainers/r-recetox-aplcms/0.15.0--r45hdfd78af_0
```
