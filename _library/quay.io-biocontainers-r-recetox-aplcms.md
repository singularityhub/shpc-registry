...
updated_at: "2024-11-13 03:34:51.896009"
latest: "0.13.3--r43hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/r-recetox-aplcms:0.13.3--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/r-recetox-aplcms/0.13.3--r43hdfd78af_0
$ module help quay.io/biocontainers/r-recetox-aplcms/0.13.3--r43hdfd78af_0
```
