...
updated_at: "2023-08-01 03:01:39.402748"
latest: "0.12.0--r42hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/r-recetox-aplcms:0.12.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/r-recetox-aplcms/0.12.0--r42hdfd78af_0
$ module help quay.io/biocontainers/r-recetox-aplcms/0.12.0--r42hdfd78af_0
```
