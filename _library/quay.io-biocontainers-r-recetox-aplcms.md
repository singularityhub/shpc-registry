...
updated_at: "2023-01-30 03:29:27.617085"
latest: "0.10.0--r42hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/r-recetox-aplcms:0.10.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/r-recetox-aplcms/0.10.0--r42hdfd78af_0
$ module help quay.io/biocontainers/r-recetox-aplcms/0.10.0--r42hdfd78af_0
```
