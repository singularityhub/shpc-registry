...
updated_at: "2023-06-28 03:46:22.747472"
latest: "0.11.0--r42hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/r-recetox-aplcms:0.11.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/r-recetox-aplcms/0.11.0--r42hdfd78af_0
$ module help quay.io/biocontainers/r-recetox-aplcms/0.11.0--r42hdfd78af_0
```
