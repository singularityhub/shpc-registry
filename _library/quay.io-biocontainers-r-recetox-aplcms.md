...
updated_at: "2024-11-18 17:16:04.433227"
latest: "0.13.4--r43hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/r-recetox-aplcms:0.13.4--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/r-recetox-aplcms/0.13.4--r43hdfd78af_0
$ module help quay.io/biocontainers/r-recetox-aplcms/0.13.4--r43hdfd78af_0
```
