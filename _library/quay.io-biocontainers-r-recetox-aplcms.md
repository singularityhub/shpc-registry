...
updated_at: "2022-11-19 02:08:04.572669"
latest: "0.9.4--r42hdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/r-recetox-aplcms:0.9.4--r42hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/r-recetox-aplcms/0.9.4--r42hdfd78af_1
$ module help quay.io/biocontainers/r-recetox-aplcms/0.9.4--r42hdfd78af_1
```
