...
updated_at: "2024-12-24 03:28:43.950790"
...
```bash
$ shpc install quay.io/biocontainers/melon:0.2.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/melon/0.2.4--pyhdfd78af_0
$ module help quay.io/biocontainers/melon/0.2.4--pyhdfd78af_0
```
