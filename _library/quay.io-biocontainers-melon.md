...
updated_at: "2023-12-04 03:22:41.249792"
...
```bash
$ shpc install quay.io/biocontainers/melon:0.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/melon/0.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/melon/0.1.0--pyhdfd78af_0
```
