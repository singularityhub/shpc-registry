...
updated_at: "2023-10-03 02:49:13.100057"
...
```bash
$ shpc install quay.io/biocontainers/melon:0.0.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/melon/0.0.1--pyhdfd78af_0
$ module help quay.io/biocontainers/melon/0.0.1--pyhdfd78af_0
```
