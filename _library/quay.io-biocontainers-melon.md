...
updated_at: "2024-07-23 02:48:19.880135"
...
```bash
$ shpc install quay.io/biocontainers/melon:0.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/melon/0.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/melon/0.2.0--pyhdfd78af_0
```
