...
updated_at: "2024-02-13 02:53:01.419004"
...
```bash
$ shpc install quay.io/biocontainers/melon:0.1.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/melon/0.1.2--pyhdfd78af_0
$ module help quay.io/biocontainers/melon/0.1.2--pyhdfd78af_0
```
