...
updated_at: "2024-07-05 02:54:42.916242"
...
```bash
$ shpc install quay.io/biocontainers/melon:0.1.6--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/melon/0.1.6--pyhdfd78af_0
$ module help quay.io/biocontainers/melon/0.1.6--pyhdfd78af_0
```
