---
layout: container
name:  "quay.io/biocontainers/melon"
maintainer: "@vsoch"
...
updated_at: "2025-05-20 03:41:42.940097"
...
```bash
$ shpc install quay.io/biocontainers/melon
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/melon:0.3.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/melon/0.3.0--pyhdfd78af_0
$ module help quay.io/biocontainers/melon/0.3.0--pyhdfd78af_0
```
...
#### melon-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### melon-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/melon
$ podman run --it --rm --entrypoint /usr/local/bin/melon   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/melon   -v ${PWD} -w ${PWD} <container> -c " $@"
```
