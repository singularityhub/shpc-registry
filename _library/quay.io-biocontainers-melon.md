...
updated_at: "2024-12-11 03:17:56.758509"
...
```bash
$ shpc install quay.io/biocontainers/melon:0.2.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/melon/0.2.1--pyhdfd78af_0
$ module help quay.io/biocontainers/melon/0.2.1--pyhdfd78af_0
```
