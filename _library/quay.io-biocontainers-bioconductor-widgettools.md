...
updated_at: "2025-10-04 03:34:29.970101"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-widgettools:1.84.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-widgettools/1.84.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-widgettools/1.84.0--r44hdfd78af_0
```
