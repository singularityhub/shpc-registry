...
updated_at: "2025-01-23 03:54:02.736320"
...
```bash
$ shpc install quay.io/biocontainers/hybpiper:2.3.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hybpiper/2.3.2--pyhdfd78af_0
$ module help quay.io/biocontainers/hybpiper/2.3.2--pyhdfd78af_0
```
