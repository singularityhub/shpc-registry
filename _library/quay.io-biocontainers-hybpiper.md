...
updated_at: "2024-08-05 04:39:51.023774"
...
```bash
$ shpc install quay.io/biocontainers/hybpiper:2.1.8--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hybpiper/2.1.8--pyhdfd78af_0
$ module help quay.io/biocontainers/hybpiper/2.1.8--pyhdfd78af_0
```
