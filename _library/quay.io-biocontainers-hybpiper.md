...
updated_at: "2026-01-27 03:52:02.803296"
...
```bash
$ shpc install quay.io/biocontainers/hybpiper:2.3.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hybpiper/2.3.4--pyhdfd78af_0
$ module help quay.io/biocontainers/hybpiper/2.3.4--pyhdfd78af_0
```
