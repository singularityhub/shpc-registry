...
updated_at: "2024-12-05 03:49:36.778304"
...
```bash
$ shpc install quay.io/biocontainers/hybpiper:2.3.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hybpiper/2.3.1--pyhdfd78af_0
$ module help quay.io/biocontainers/hybpiper/2.3.1--pyhdfd78af_0
```
