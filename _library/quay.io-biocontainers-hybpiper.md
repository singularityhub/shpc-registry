...
updated_at: "2024-05-19 02:59:48.924647"
...
```bash
$ shpc install quay.io/biocontainers/hybpiper:2.1.7--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hybpiper/2.1.7--pyhdfd78af_0
$ module help quay.io/biocontainers/hybpiper/2.1.7--pyhdfd78af_0
```
