...
updated_at: "2024-10-24 11:16:44.175027"
...
```bash
$ shpc install quay.io/biocontainers/hybpiper:2.3.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hybpiper/2.3.0--pyhdfd78af_0
$ module help quay.io/biocontainers/hybpiper/2.3.0--pyhdfd78af_0
```
