...
updated_at: "2024-08-31 02:49:53.654896"
...
```bash
$ shpc install quay.io/biocontainers/hybpiper:2.2.0--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/hybpiper/2.2.0--pyhdfd78af_1
$ module help quay.io/biocontainers/hybpiper/2.2.0--pyhdfd78af_1
```
