...
updated_at: "2026-05-16 06:10:27.391954"
...
```bash
$ shpc install quay.io/biocontainers/pmidcite:0.3.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pmidcite/0.3.2--pyhdfd78af_0
$ module help quay.io/biocontainers/pmidcite/0.3.2--pyhdfd78af_0
```
