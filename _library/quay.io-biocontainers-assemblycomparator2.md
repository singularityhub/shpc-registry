...
updated_at: "2024-05-05 02:38:47.727428"
...
```bash
$ shpc install quay.io/biocontainers/assemblycomparator2:2.6.1--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/assemblycomparator2/2.6.1--h9ee0642_0
$ module help quay.io/biocontainers/assemblycomparator2/2.6.1--h9ee0642_0
```
