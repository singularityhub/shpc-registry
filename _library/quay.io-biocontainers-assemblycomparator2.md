...
updated_at: "2024-05-29 02:53:42.882074"
latest: "2.6.2--h9ee0642_0"
...
```bash
$ shpc install quay.io/biocontainers/assemblycomparator2:2.6.2--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/assemblycomparator2/2.6.2--h9ee0642_0
$ module help quay.io/biocontainers/assemblycomparator2/2.6.2--h9ee0642_0
```
