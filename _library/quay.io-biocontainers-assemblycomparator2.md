...
updated_at: "2024-04-02 02:59:45.074927"
latest: "2.5.18--h9ee0642_0"
...
```bash
$ shpc install quay.io/biocontainers/assemblycomparator2:2.5.18--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/assemblycomparator2/2.5.18--h9ee0642_0
$ module help quay.io/biocontainers/assemblycomparator2/2.5.18--h9ee0642_0
```
