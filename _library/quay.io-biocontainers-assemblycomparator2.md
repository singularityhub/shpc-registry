...
updated_at: "2023-11-30 03:04:51.019896"
...
```bash
$ shpc install quay.io/biocontainers/assemblycomparator2:2.5.12--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/assemblycomparator2/2.5.12--h9ee0642_0
$ module help quay.io/biocontainers/assemblycomparator2/2.5.12--h9ee0642_0
```
