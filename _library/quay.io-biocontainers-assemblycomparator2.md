...
updated_at: "2024-02-11 02:30:27.340911"
latest: "2.5.15--h9ee0642_0"
...
```bash
$ shpc install quay.io/biocontainers/assemblycomparator2:2.5.15--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/assemblycomparator2/2.5.15--h9ee0642_0
$ module help quay.io/biocontainers/assemblycomparator2/2.5.15--h9ee0642_0
```
