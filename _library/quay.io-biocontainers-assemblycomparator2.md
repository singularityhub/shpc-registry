...
updated_at: "2023-12-25 02:44:49.102891"
latest: "2.5.14--h9ee0642_0"
...
```bash
$ shpc install quay.io/biocontainers/assemblycomparator2:2.5.14--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/assemblycomparator2/2.5.14--h9ee0642_0
$ module help quay.io/biocontainers/assemblycomparator2/2.5.14--h9ee0642_0
```
