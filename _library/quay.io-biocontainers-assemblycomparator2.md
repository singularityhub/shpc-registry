...
updated_at: "2023-10-12 03:50:41.751626"
latest: "2.5.8--h9ee0642_0"
...
```bash
$ shpc install quay.io/biocontainers/assemblycomparator2:2.5.8--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/assemblycomparator2/2.5.8--h9ee0642_0
$ module help quay.io/biocontainers/assemblycomparator2/2.5.8--h9ee0642_0
```
