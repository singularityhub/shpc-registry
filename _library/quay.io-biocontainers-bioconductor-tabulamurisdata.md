...
updated_at: "2025-07-31 11:07:35.189768"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-tabulamurisdata:1.24.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-tabulamurisdata/1.24.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-tabulamurisdata/1.24.0--r44hdfd78af_0
```
