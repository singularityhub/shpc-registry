...
updated_at: "2023-08-28 03:05:46.912779"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-tabulamurisdata:1.18.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-tabulamurisdata/1.18.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-tabulamurisdata/1.18.0--r43hdfd78af_0
```
