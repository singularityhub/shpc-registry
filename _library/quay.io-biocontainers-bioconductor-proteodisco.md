...
updated_at: "2026-03-28 04:57:08.118483"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-proteodisco:1.16.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-proteodisco/1.16.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-proteodisco/1.16.0--r45hdfd78af_0
```
