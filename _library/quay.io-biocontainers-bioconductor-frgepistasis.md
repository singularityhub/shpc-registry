...
updated_at: "2026-03-21 04:29:48.243875"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-frgepistasis:1.46.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-frgepistasis/1.46.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-frgepistasis/1.46.0--r45hdfd78af_0
```
