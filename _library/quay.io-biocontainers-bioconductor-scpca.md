...
updated_at: "2026-03-28 05:07:34.829955"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-scpca:1.24.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-scpca/1.24.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-scpca/1.24.0--r45hdfd78af_0
```
