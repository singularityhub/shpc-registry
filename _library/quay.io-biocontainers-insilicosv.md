---
layout: container
name:  "quay.io/biocontainers/insilicosv"
maintainer: "@vsoch"
...
updated_at: "2025-05-24 11:26:47.983814"
...
```bash
$ shpc install quay.io/biocontainers/insilicosv
```
...
#### insilicosv-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### insilicosv-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/insilicosv
$ podman run --it --rm --entrypoint /usr/local/bin/insilicosv   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/insilicosv   -v ${PWD} -w ${PWD} <container> -c " $@"
```
