...
updated_at: "2023-09-06 03:11:28.426594"
latest: "1.25.0--r43hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-yapsa:1.25.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-yapsa/1.25.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-yapsa/1.25.0--r43hdfd78af_0
```
