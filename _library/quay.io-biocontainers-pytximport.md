...
updated_at: "2024-10-08 03:04:34.649993"
...
```bash
$ shpc install quay.io/biocontainers/pytximport:0.8.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pytximport/0.8.0--pyhdfd78af_0
$ module help quay.io/biocontainers/pytximport/0.8.0--pyhdfd78af_0
```
