...
updated_at: "2026-04-03 15:54:16.208136"
...
```bash
$ shpc install quay.io/biocontainers/pytximport:0.13.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pytximport/0.13.0--pyhdfd78af_0
$ module help quay.io/biocontainers/pytximport/0.13.0--pyhdfd78af_0
```
