...
updated_at: "2024-11-28 04:01:04.651129"
...
```bash
$ shpc install quay.io/biocontainers/pytximport:0.10.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pytximport/0.10.0--pyhdfd78af_0
$ module help quay.io/biocontainers/pytximport/0.10.0--pyhdfd78af_0
```
