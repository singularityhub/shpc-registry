...
updated_at: "2025-08-11 04:31:41.654192"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hgug4110b.db:3.2.3--r44hdfd78af_13
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hgug4110b.db/3.2.3--r44hdfd78af_13
$ module help quay.io/biocontainers/bioconductor-hgug4110b.db/3.2.3--r44hdfd78af_13
```
