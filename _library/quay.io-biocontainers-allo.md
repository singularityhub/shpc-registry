---
layout: container
name:  "quay.io/biocontainers/allo"
maintainer: "@vsoch"
...
updated_at: "2025-03-10 02:35:07.251815"
...
```bash
$ shpc install quay.io/biocontainers/allo
```
...
#### allo-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### allo-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/allo
$ podman run --it --rm --entrypoint /usr/local/bin/allo   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/allo   -v ${PWD} -w ${PWD} <container> -c " $@"
```
