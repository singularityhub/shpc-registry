---
layout: container
name:  "quay.io/biocontainers/mpralib"
maintainer: "@vsoch"
...
updated_at: "2026-01-11 04:27:12.170148"
...
```bash
$ module load quay.io/biocontainers/mpralib/0.9.0--pyhdfd78af_0
$ module help quay.io/biocontainers/mpralib/0.9.0--pyhdfd78af_0
```
...
#### mpralib-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### mpralib-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/mpralib
$ podman run --it --rm --entrypoint /usr/local/bin/mpralib   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/mpralib   -v ${PWD} -w ${PWD} <container> -c " $@"
```
