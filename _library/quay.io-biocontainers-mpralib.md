...
updated_at: "2026-03-05 05:28:21.324986"
...
```bash
$ shpc install quay.io/biocontainers/mpralib:0.9.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mpralib/0.9.1--pyhdfd78af_0
$ module help quay.io/biocontainers/mpralib/0.9.1--pyhdfd78af_0
```
