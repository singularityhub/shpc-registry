...
updated_at: "2026-03-24 04:35:35.675643"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-guitar:2.26.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-guitar/2.26.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-guitar/2.26.0--r45hdfd78af_0
```
