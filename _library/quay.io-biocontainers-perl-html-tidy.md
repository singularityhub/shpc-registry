...
updated_at: "2026-01-13 04:16:09.135883"
latest: "1.60--pl5321h7b50bb2_7"
...
```bash
$ shpc install quay.io/biocontainers/perl-html-tidy:1.60--pl5321h7b50bb2_7
```
...
```bash
$ module load quay.io/biocontainers/perl-html-tidy/1.60--pl5321h7b50bb2_7
$ module help quay.io/biocontainers/perl-html-tidy/1.60--pl5321h7b50bb2_7
```
