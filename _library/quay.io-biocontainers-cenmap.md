...
updated_at: "2026-01-15 04:30:45.757221"
latest: "1.1.1--h577a1d6_0"
...
```bash
$ shpc install quay.io/biocontainers/cenmap:1.1.1--h577a1d6_0
```
...
```bash
$ module load quay.io/biocontainers/cenmap/1.1.1--h577a1d6_0
$ module help quay.io/biocontainers/cenmap/1.1.1--h577a1d6_0
```
