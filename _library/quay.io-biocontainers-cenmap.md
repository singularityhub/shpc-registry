...
updated_at: "2026-02-02 12:52:47.413634"
...
```bash
$ shpc install quay.io/biocontainers/cenmap:1.2.0--h577a1d6_0
```
...
```bash
$ module load quay.io/biocontainers/cenmap/1.2.0--h577a1d6_0
$ module help quay.io/biocontainers/cenmap/1.2.0--h577a1d6_0
```
