...
updated_at: "2023-01-13 02:59:26.131426"
...
```bash
$ shpc install quay.io/biocontainers/r-deseqanalysis:0.6.6--r42hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/r-deseqanalysis/0.6.6--r42hdfd78af_1
$ module help quay.io/biocontainers/r-deseqanalysis/0.6.6--r42hdfd78af_1
```
