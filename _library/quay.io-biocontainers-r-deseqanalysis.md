...
updated_at: "2023-10-07 02:44:56.370292"
latest: "0.6.12--r43hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/r-deseqanalysis:0.6.12--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/r-deseqanalysis/0.6.12--r43hdfd78af_0
$ module help quay.io/biocontainers/r-deseqanalysis/0.6.12--r43hdfd78af_0
```
