...
updated_at: "2026-09-23 07:34:04.836277"
latest: "0.7.3--r45hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/r-deseqanalysis:0.7.3--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/r-deseqanalysis/0.7.3--r45hdfd78af_0
$ module help quay.io/biocontainers/r-deseqanalysis/0.7.3--r45hdfd78af_0
```
