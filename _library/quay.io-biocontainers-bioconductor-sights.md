...
updated_at: "2025-12-05 03:57:45.075036"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-sights:1.32.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-sights/1.32.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-sights/1.32.0--r44hdfd78af_0
```
