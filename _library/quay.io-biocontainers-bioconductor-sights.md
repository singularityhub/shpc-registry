...
updated_at: "2026-03-10 04:49:52.759946"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-sights:1.36.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-sights/1.36.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-sights/1.36.0--r45hdfd78af_0
```
