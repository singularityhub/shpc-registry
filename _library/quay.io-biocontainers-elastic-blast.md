...
updated_at: "2025-10-13 04:32:18.166247"
...
```bash
$ shpc install quay.io/biocontainers/elastic-blast:1.4.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/elastic-blast/1.4.0--pyhdfd78af_0
$ module help quay.io/biocontainers/elastic-blast/1.4.0--pyhdfd78af_0
```
