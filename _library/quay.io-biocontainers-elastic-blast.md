...
updated_at: "2022-10-27 00:45:56.900763"
...
```bash
$ shpc install quay.io/biocontainers/elastic-blast:0.2.7--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/elastic-blast/0.2.7--pyhdfd78af_0
$ module help quay.io/biocontainers/elastic-blast/0.2.7--pyhdfd78af_0
```
