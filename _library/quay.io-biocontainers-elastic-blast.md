...
updated_at: "2026-01-15 04:32:20.884782"
...
```bash
$ shpc install quay.io/biocontainers/elastic-blast:1.5.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/elastic-blast/1.5.0--pyhdfd78af_0
$ module help quay.io/biocontainers/elastic-blast/1.5.0--pyhdfd78af_0
```
