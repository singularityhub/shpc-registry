...
updated_at: "2023-06-18 03:19:18.981215"
...
```bash
$ shpc install quay.io/biocontainers/elastic-blast:1.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/elastic-blast/1.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/elastic-blast/1.1.0--pyhdfd78af_0
```
