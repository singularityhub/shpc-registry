---
layout: container
name:  "quay.io/biocontainers/enzywizard-clean"
maintainer: "@vsoch"
...
updated_at: "2026-06-29 07:30:16.640390"
...
singularity registry hpc automated addition for enzywizard-clean
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/enzywizard-clean
```
...
#### enzywizard-clean-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### enzywizard-clean-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/enzywizard-clean
$ podman run --it --rm --entrypoint /usr/local/bin/enzywizard-clean   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/enzywizard-clean   -v ${PWD} -w ${PWD} <container> -c " $@"
```
