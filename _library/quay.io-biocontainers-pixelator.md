...
updated_at: "2024-07-29 02:41:15.049466"
...
```bash
$ shpc install quay.io/biocontainers/pixelator:0.17.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pixelator/0.17.1--pyhdfd78af_0
$ module help quay.io/biocontainers/pixelator/0.17.1--pyhdfd78af_0
```
