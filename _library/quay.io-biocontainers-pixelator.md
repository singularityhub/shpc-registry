...
updated_at: "2024-05-16 02:29:08.575631"
...
```bash
$ shpc install quay.io/biocontainers/pixelator:0.16.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pixelator/0.16.2--pyhdfd78af_0
$ module help quay.io/biocontainers/pixelator/0.16.2--pyhdfd78af_0
```
