...
updated_at: "2024-10-31 03:20:41.802324"
...
```bash
$ shpc install quay.io/biocontainers/pixelator:0.18.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pixelator/0.18.2--pyhdfd78af_0
$ module help quay.io/biocontainers/pixelator/0.18.2--pyhdfd78af_0
```
