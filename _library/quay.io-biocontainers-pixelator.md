...
updated_at: "2025-05-27 11:41:41.660895"
...
```bash
$ shpc install quay.io/biocontainers/pixelator:0.20.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pixelator/0.20.1--pyhdfd78af_0
$ module help quay.io/biocontainers/pixelator/0.20.1--pyhdfd78af_0
```
