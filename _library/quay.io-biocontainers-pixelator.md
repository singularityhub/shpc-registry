...
updated_at: "2024-11-08 03:06:05.010880"
...
```bash
$ shpc install quay.io/biocontainers/pixelator:0.18.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pixelator/0.18.3--pyhdfd78af_0
$ module help quay.io/biocontainers/pixelator/0.18.3--pyhdfd78af_0
```
