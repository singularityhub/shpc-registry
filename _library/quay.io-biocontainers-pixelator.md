...
updated_at: "2023-11-04 02:48:12.714322"
latest: "0.14.0--pyh7cba7a3_0"
...
```bash
$ shpc install quay.io/biocontainers/pixelator:0.14.0--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/pixelator/0.14.0--pyh7cba7a3_0
$ module help quay.io/biocontainers/pixelator/0.14.0--pyh7cba7a3_0
```
