...
updated_at: "2023-09-28 03:28:29.480981"
...
```bash
$ shpc install quay.io/biocontainers/pixelator:0.13.1--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/pixelator/0.13.1--pyh7cba7a3_0
$ module help quay.io/biocontainers/pixelator/0.13.1--pyh7cba7a3_0
```
