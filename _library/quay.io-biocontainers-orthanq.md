...
updated_at: "2025-11-16 03:32:25.225059"
latest: "1.17.0--py311h9e5a5df_0"
...
```bash
$ shpc install quay.io/biocontainers/orthanq:1.17.0--py311h9e5a5df_0
```
...
```bash
$ module load quay.io/biocontainers/orthanq/1.17.0--py311h9e5a5df_0
$ module help quay.io/biocontainers/orthanq/1.17.0--py311h9e5a5df_0
```
