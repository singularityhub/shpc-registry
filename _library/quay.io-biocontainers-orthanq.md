...
updated_at: "2025-08-07 09:40:53.844142"
latest: "1.13.0--py312h76457a3_0"
...
```bash
$ shpc install quay.io/biocontainers/orthanq:1.13.0--py312h76457a3_0
```
...
```bash
$ module load quay.io/biocontainers/orthanq/1.13.0--py312h76457a3_0
$ module help quay.io/biocontainers/orthanq/1.13.0--py312h76457a3_0
```
