...
updated_at: "2025-08-20 03:29:39.905305"
latest: "1.14.0--py312h76457a3_0"
...
```bash
$ shpc install quay.io/biocontainers/orthanq:1.14.0--py312h76457a3_0
```
...
```bash
$ module load quay.io/biocontainers/orthanq/1.14.0--py312h76457a3_0
$ module help quay.io/biocontainers/orthanq/1.14.0--py312h76457a3_0
```
