...
updated_at: "2025-11-08 03:17:01.021603"
latest: "1.16.1--py311h9e5a5df_0"
...
```bash
$ shpc install quay.io/biocontainers/orthanq:1.16.1--py311h9e5a5df_0
```
...
```bash
$ module load quay.io/biocontainers/orthanq/1.16.1--py311h9e5a5df_0
$ module help quay.io/biocontainers/orthanq/1.16.1--py311h9e5a5df_0
```
