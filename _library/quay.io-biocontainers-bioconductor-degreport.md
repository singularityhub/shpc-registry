...
updated_at: "2025-04-05 03:07:19.244695"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-degreport:1.42.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-degreport/1.42.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-degreport/1.42.0--r44hdfd78af_0
```
