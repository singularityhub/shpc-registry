...
updated_at: "2022-11-21 13:18:01.343706"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-degreport:1.8.2--r3.3.2_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-degreport/1.8.2--r3.3.2_1
$ module help quay.io/biocontainers/bioconductor-degreport/1.8.2--r3.3.2_1
```
