...
updated_at: "2024-06-24 03:19:39.782124"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-phenstat:2.38.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-phenstat/2.38.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-phenstat/2.38.0--r43hdfd78af_0
```
