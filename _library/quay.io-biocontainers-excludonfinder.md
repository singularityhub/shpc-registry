...
updated_at: "2025-12-12 04:08:23.553725"
...
```bash
$ shpc install quay.io/biocontainers/excludonfinder:0.2.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/excludonfinder/0.2.0--hdfd78af_0
$ module help quay.io/biocontainers/excludonfinder/0.2.0--hdfd78af_0
```
