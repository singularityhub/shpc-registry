...
updated_at: "2024-11-25 03:25:53.188220"
...
```bash
$ shpc install quay.io/biocontainers/svtopovz:0.1.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/svtopovz/0.1.1--pyhdfd78af_0
$ module help quay.io/biocontainers/svtopovz/0.1.1--pyhdfd78af_0
```
