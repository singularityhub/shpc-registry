...
updated_at: "2026-03-30 05:44:34.739481"
...
```bash
$ shpc install quay.io/biocontainers/mkdesigner:0.5.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mkdesigner/0.5.3--pyhdfd78af_0
$ module help quay.io/biocontainers/mkdesigner/0.5.3--pyhdfd78af_0
```
