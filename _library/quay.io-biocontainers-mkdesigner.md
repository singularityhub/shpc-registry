...
updated_at: "2025-09-03 03:37:27.828416"
...
```bash
$ shpc install quay.io/biocontainers/mkdesigner:0.5.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mkdesigner/0.5.2--pyhdfd78af_0
$ module help quay.io/biocontainers/mkdesigner/0.5.2--pyhdfd78af_0
```
