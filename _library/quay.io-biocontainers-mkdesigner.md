...
updated_at: "2023-10-25 02:37:54.671049"
...
```bash
$ shpc install quay.io/biocontainers/mkdesigner:0.3.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mkdesigner/0.3.1--pyhdfd78af_0
$ module help quay.io/biocontainers/mkdesigner/0.3.1--pyhdfd78af_0
```
