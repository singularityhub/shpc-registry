...
updated_at: "2025-08-06 04:21:06.547341"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-demand:1.36.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-demand/1.36.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-demand/1.36.0--r44hdfd78af_0
```
