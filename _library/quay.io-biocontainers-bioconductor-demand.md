...
updated_at: "2023-11-27 02:59:24.766428"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-demand:1.30.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-demand/1.30.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-demand/1.30.0--r43hdfd78af_0
```
