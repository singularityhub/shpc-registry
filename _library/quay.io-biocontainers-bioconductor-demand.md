...
updated_at: "2026-03-05 00:38:13.094628"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-demand:1.40.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-demand/1.40.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-demand/1.40.0--r45hdfd78af_0
```
