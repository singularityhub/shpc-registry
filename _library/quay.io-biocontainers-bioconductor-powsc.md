...
updated_at: "2025-01-01 03:42:43.353850"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-powsc:1.10.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-powsc/1.10.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-powsc/1.10.0--r43hdfd78af_0
```
