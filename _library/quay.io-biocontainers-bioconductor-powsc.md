...
updated_at: "2023-08-28 03:14:54.537019"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-powsc:1.8.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-powsc/1.8.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-powsc/1.8.0--r43hdfd78af_0
```
