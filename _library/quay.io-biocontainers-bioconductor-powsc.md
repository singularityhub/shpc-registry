...
updated_at: "2026-04-03 05:15:53.599645"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-powsc:1.18.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-powsc/1.18.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-powsc/1.18.0--r45hdfd78af_0
```
