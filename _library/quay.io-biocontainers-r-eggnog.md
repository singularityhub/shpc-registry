---
layout: container
name:  "quay.io/biocontainers/r-eggnog"
maintainer: "@vsoch"
...
updated_at: "2026-09-04 08:05:36.042906"
...
```bash
$ shpc install quay.io/biocontainers/r-eggnog
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/r-eggnog:0.3.2--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/r-eggnog/0.3.2--r45hdfd78af_0
$ module help quay.io/biocontainers/r-eggnog/0.3.2--r45hdfd78af_0
```
...
#### r-eggnog-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-eggnog-inspect-deffile:
