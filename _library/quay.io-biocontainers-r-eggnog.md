...
updated_at: "2023-10-25 02:41:04.171727"
latest: "0.2.2--r43hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/r-eggnog:0.2.2--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/r-eggnog/0.2.2--r43hdfd78af_0
$ module help quay.io/biocontainers/r-eggnog/0.2.2--r43hdfd78af_0
```
