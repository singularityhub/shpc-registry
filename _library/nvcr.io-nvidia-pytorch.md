...
updated_at: "2023-08-05 03:30:41.550980"
latest: "23.06-py3"
...
```bash
$ shpc install nvcr.io/nvidia/pytorch:23.06-py3
```
...
```bash
$ module load nvcr.io/nvidia/pytorch/23.06-py3
$ module help nvcr.io/nvidia/pytorch/23.06-py3
```
