...
updated_at: "2024-05-05 03:14:15.200212"
latest: "24.03-py3-igpu"
...
```bash
$ shpc install nvcr.io/nvidia/pytorch:24.03-py3-igpu
```
...
```bash
$ module load nvcr.io/nvidia/pytorch/24.03-py3-igpu
$ module help nvcr.io/nvidia/pytorch/24.03-py3-igpu
```
