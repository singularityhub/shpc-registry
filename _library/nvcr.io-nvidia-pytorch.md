...
updated_at: "2023-05-27 02:32:25.130805"
latest: "23.04-py3"
...
```bash
$ shpc install nvcr.io/nvidia/pytorch:23.04-py3
```
...
```bash
$ module load nvcr.io/nvidia/pytorch/23.04-py3
$ module help nvcr.io/nvidia/pytorch/23.04-py3
```
