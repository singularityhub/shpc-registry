...
updated_at: "2023-08-26 03:10:59.724377"
latest: "23.07-py3"
...
```bash
$ shpc install nvcr.io/nvidia/pytorch:23.07-py3
```
...
```bash
$ module load nvcr.io/nvidia/pytorch/23.07-py3
$ module help nvcr.io/nvidia/pytorch/23.07-py3
```
