...
updated_at: "2023-05-04 02:44:54.728656"
latest: "23.03-py3"
...
```bash
$ shpc install nvcr.io/nvidia/pytorch:23.03-py3
```
...
```bash
$ module load nvcr.io/nvidia/pytorch/23.03-py3
$ module help nvcr.io/nvidia/pytorch/23.03-py3
```
