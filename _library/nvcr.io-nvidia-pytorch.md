...
updated_at: "2022-11-21 14:19:38.701258"
latest: "22.10-py3"
...
```bash
$ shpc install nvcr.io/nvidia/pytorch:22.10-py3
```
...
```bash
$ module load nvcr.io/nvidia/pytorch/22.10-py3
$ module help nvcr.io/nvidia/pytorch/22.10-py3
```
