...
updated_at: "2024-02-09 03:19:13.510143"
latest: "24.01-py3"
...
```bash
$ shpc install nvcr.io/nvidia/pytorch:24.01-py3
```
...
```bash
$ module load nvcr.io/nvidia/pytorch/24.01-py3
$ module help nvcr.io/nvidia/pytorch/24.01-py3
```
