...
updated_at: "2023-03-30 02:37:51.664825"
latest: "23.02-py3"
...
```bash
$ shpc install nvcr.io/nvidia/pytorch:23.02-py3
```
...
```bash
$ module load nvcr.io/nvidia/pytorch/23.02-py3
$ module help nvcr.io/nvidia/pytorch/23.02-py3
```
