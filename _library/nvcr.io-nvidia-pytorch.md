...
updated_at: "2022-11-15 01:14:32.844950"
latest: "22.08-py3"
...
```bash
$ shpc install nvcr.io/nvidia/pytorch:22.08-py3
```
...
```bash
$ module load nvcr.io/nvidia/pytorch/22.08-py3
$ module help nvcr.io/nvidia/pytorch/22.08-py3
```
