...
updated_at: "2023-07-06 03:10:27.464426"
latest: "23.05-py3"
...
```bash
$ shpc install nvcr.io/nvidia/pytorch:23.05-py3
```
...
```bash
$ module load nvcr.io/nvidia/pytorch/23.05-py3
$ module help nvcr.io/nvidia/pytorch/23.05-py3
```
