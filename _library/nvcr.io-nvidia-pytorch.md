...
updated_at: "2023-02-14 02:49:47.839373"
latest: "22.12-py3"
...
```bash
$ shpc install nvcr.io/nvidia/pytorch:22.12-py3
```
...
```bash
$ module load nvcr.io/nvidia/pytorch/22.12-py3
$ module help nvcr.io/nvidia/pytorch/22.12-py3
```
