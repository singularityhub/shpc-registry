...
updated_at: "2023-10-24 02:24:16.104423"
latest: "23.09-py3"
...
```bash
$ shpc install nvcr.io/nvidia/pytorch:23.09-py3
```
...
```bash
$ module load nvcr.io/nvidia/pytorch/23.09-py3
$ module help nvcr.io/nvidia/pytorch/23.09-py3
```
