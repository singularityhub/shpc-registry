---
layout: container
name:  "quay.io/biocontainers/bioconductor-epipwr"
maintainer: "@vsoch"
...
updated_at: "2026-03-14 05:08:21.258057"
...
versions:
 - "1.4.0--r45hdfd78af_0"
description: "singularity registry hpc automated addition for bioconductor-epipwr"
config: {"url": "https://biocontainers.pro/tools/bioconductor-epipwr", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for bioconductor-epipwr", "latest": {"1.4.0--r45hdfd78af_0": "sha256:237726f91f6cc8f36337623beacb41ad37acf523b4541802693c4e87ffc792ed"}, "tags": {"1.4.0--r45hdfd78af_0": "sha256:237726f91f6cc8f36337623beacb41ad37acf523b4541802693c4e87ffc792ed"}, "docker": "quay.io/biocontainers/bioconductor-epipwr", "aliases": {"idle3.14": "/usr/local/bin/idle3.14", "pydoc3.14": "/usr/local/bin/pydoc3.14", "python3.14": "/usr/local/bin/python3.14", "python3.14-config": "/usr/local/bin/python3.14-config", "x86_64-conda-linux-gnu.cfg": "/usr/local/bin/x86_64-conda-linux-gnu.cfg", "installBiocDataPackage.sh": "/usr/local/bin/installBiocDataPackage.sh", "tomlq": "/usr/local/bin/tomlq", "xq": "/usr/local/bin/xq", "yq": "/usr/local/bin/yq", "jq": "/usr/local/bin/jq", "onig-config": "/usr/local/bin/onig-config", "activate-global-python-argcomplete": "/usr/local/bin/activate-global-python-argcomplete", "python-argcomplete-check-easy-install-script": "/usr/local/bin/python-argcomplete-check-easy-install-script", "register-python-argcomplete": "/usr/local/bin/register-python-argcomplete", "hb-info": "/usr/local/bin/hb-info", "tjbench": "/usr/local/bin/tjbench"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/bioconductor-epipwr.
singularity registry hpc automated addition for bioconductor-epipwr
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/bioconductor-epipwr
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-epipwr:1.4.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-epipwr/1.4.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-epipwr/1.4.0--r45hdfd78af_0
```
...
#### bioconductor-epipwr-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-epipwr-inspect-deffile:
