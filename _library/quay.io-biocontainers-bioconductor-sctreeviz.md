...
updated_at: "2025-01-13 03:45:19.826488"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-sctreeviz:1.8.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-sctreeviz/1.8.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-sctreeviz/1.8.0--r43hdfd78af_0
```
