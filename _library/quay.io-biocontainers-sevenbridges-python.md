...
updated_at: "2024-05-06 04:53:13.486291"
latest: "2.11.0--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/sevenbridges-python:2.11.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sevenbridges-python/2.11.0--pyhdfd78af_0
$ module help quay.io/biocontainers/sevenbridges-python/2.11.0--pyhdfd78af_0
```
