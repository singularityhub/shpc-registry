...
updated_at: "2026-01-23 04:15:49.248422"
...
```bash
$ shpc install quay.io/biocontainers/sevenbridges-python:2.11.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sevenbridges-python/2.11.2--pyhdfd78af_0
$ module help quay.io/biocontainers/sevenbridges-python/2.11.2--pyhdfd78af_0
```
