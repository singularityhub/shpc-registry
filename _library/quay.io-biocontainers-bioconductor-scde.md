...
updated_at: "2022-11-21 14:15:38.772877"
latest: "2.22.0--r41hc247a5b_2"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-scde:2.22.0--r41hc247a5b_2
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-scde/2.22.0--r41hc247a5b_2
$ module help quay.io/biocontainers/bioconductor-scde/2.22.0--r41hc247a5b_2
```
