...
updated_at: "2023-12-20 04:02:59.425607"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-iaseq:1.44.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-iaseq/1.44.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-iaseq/1.44.0--r43hdfd78af_0
```
