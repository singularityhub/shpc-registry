...
updated_at: "2026-01-30 04:17:53.947473"
...
```bash
$ shpc install quay.io/biocontainers/scallop2:1.1.2--h5ca1c30_8
```
...
```bash
$ module load quay.io/biocontainers/scallop2/1.1.2--h5ca1c30_8
$ module help quay.io/biocontainers/scallop2/1.1.2--h5ca1c30_8
```
