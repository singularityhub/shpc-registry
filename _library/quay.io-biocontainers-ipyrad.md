...
updated_at: "2025-11-09 03:42:34.634895"
latest: "0.9.107--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/ipyrad:0.9.107--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ipyrad/0.9.107--pyhdfd78af_0
$ module help quay.io/biocontainers/ipyrad/0.9.107--pyhdfd78af_0
```
