...
updated_at: "2026-03-13 05:08:32.332052"
latest: "0.9.108--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/ipyrad:0.9.108--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ipyrad/0.9.108--pyhdfd78af_0
$ module help quay.io/biocontainers/ipyrad/0.9.108--pyhdfd78af_0
```
