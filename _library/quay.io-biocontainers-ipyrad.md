...
updated_at: "2024-03-28 02:37:54.862687"
latest: "0.9.94--pyh7cba7a3_0"
...
```bash
$ shpc install quay.io/biocontainers/ipyrad:0.9.94--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/ipyrad/0.9.94--pyh7cba7a3_0
$ module help quay.io/biocontainers/ipyrad/0.9.94--pyh7cba7a3_0
```
