...
updated_at: "2024-01-01 02:38:12.065280"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rqt:1.28.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rqt/1.28.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rqt/1.28.0--r43hdfd78af_0
```
