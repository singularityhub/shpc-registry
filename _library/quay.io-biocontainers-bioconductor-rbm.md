...
updated_at: "2023-10-02 03:12:42.509070"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rbm:1.32.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rbm/1.32.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rbm/1.32.0--r43hdfd78af_0
```
