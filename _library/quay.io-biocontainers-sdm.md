...
updated_at: "2024-06-04 02:44:16.418580"
latest: "2.17--hdcf5f25_0"
...
```bash
$ shpc install quay.io/biocontainers/sdm:2.17--hdcf5f25_0
```
...
```bash
$ module load quay.io/biocontainers/sdm/2.17--hdcf5f25_0
$ module help quay.io/biocontainers/sdm/2.17--hdcf5f25_0
```
