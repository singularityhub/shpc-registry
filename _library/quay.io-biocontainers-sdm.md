...
updated_at: "2026-03-02 05:10:47.729995"
latest: "3.11--h077b44d_0"
...
```bash
$ shpc install quay.io/biocontainers/sdm:3.11--h077b44d_0
```
...
```bash
$ module load quay.io/biocontainers/sdm/3.11--h077b44d_0
$ module help quay.io/biocontainers/sdm/3.11--h077b44d_0
```
