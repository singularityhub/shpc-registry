...
updated_at: "2024-08-18 02:46:45.628285"
latest: "2.17--hdcf5f25_1"
...
```bash
$ shpc install quay.io/biocontainers/sdm:2.17--hdcf5f25_1
```
...
```bash
$ module load quay.io/biocontainers/sdm/2.17--hdcf5f25_1
$ module help quay.io/biocontainers/sdm/2.17--hdcf5f25_1
```
