...
updated_at: "2023-10-28 02:46:18.096635"
latest: "2.13--hdcf5f25_0"
...
```bash
$ shpc install quay.io/biocontainers/sdm:2.13--hdcf5f25_0
```
...
```bash
$ module load quay.io/biocontainers/sdm/2.13--hdcf5f25_0
$ module help quay.io/biocontainers/sdm/2.13--hdcf5f25_0
```
