...
updated_at: "2026-07-01 06:55:20.799403"
...
```bash
$ shpc install quay.io/biocontainers/sdm:3.37--hf426362_0
```
...
```bash
$ module load quay.io/biocontainers/sdm/3.37--hf426362_0
$ module help quay.io/biocontainers/sdm/3.37--hf426362_0
```
