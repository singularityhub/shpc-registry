...
updated_at: "2025-12-03 03:37:17.694756"
latest: "3.10--h077b44d_0"
...
```bash
$ shpc install quay.io/biocontainers/sdm:3.10--h077b44d_0
```
...
```bash
$ module load quay.io/biocontainers/sdm/3.10--h077b44d_0
$ module help quay.io/biocontainers/sdm/3.10--h077b44d_0
```
