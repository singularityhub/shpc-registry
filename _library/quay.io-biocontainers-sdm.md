...
updated_at: "2023-09-22 02:55:48.921161"
...
```bash
$ shpc install quay.io/biocontainers/sdm:2.10--hdcf5f25_0
```
...
```bash
$ module load quay.io/biocontainers/sdm/2.10--hdcf5f25_0
$ module help quay.io/biocontainers/sdm/2.10--hdcf5f25_0
```
