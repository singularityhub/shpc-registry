...
updated_at: "2026-04-01 05:35:29.905950"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cnorfeeder:1.50.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cnorfeeder/1.50.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-cnorfeeder/1.50.0--r45hdfd78af_0
```
