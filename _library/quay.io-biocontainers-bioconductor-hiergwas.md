...
updated_at: "2026-03-07 04:07:46.660137"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hiergwas:1.40.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hiergwas/1.40.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-hiergwas/1.40.0--r45hdfd78af_0
```
