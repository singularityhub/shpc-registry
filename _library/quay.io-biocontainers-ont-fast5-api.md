...
updated_at: "2024-03-20 02:35:06.294180"
latest: "4.1.3--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/ont-fast5-api:4.1.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ont-fast5-api/4.1.3--pyhdfd78af_0
$ module help quay.io/biocontainers/ont-fast5-api/4.1.3--pyhdfd78af_0
```
