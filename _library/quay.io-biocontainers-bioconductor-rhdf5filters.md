...
updated_at: "2023-12-02 02:56:30.469050"
latest: "1.12.1--r43hf17093f_1"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rhdf5filters:1.12.1--r43hf17093f_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rhdf5filters/1.12.1--r43hf17093f_1
$ module help quay.io/biocontainers/bioconductor-rhdf5filters/1.12.1--r43hf17093f_1
```
