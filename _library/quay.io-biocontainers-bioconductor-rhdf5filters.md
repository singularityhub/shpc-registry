...
updated_at: "2026-03-24 04:58:56.613280"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rhdf5filters:1.22.0--r45ha27e39d_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rhdf5filters/1.22.0--r45ha27e39d_0
$ module help quay.io/biocontainers/bioconductor-rhdf5filters/1.22.0--r45ha27e39d_0
```
