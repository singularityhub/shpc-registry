...
updated_at: "2025-01-31 03:13:42.085671"
latest: "1.18.0--r44h77050f0_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rhdf5filters:1.18.0--r44h77050f0_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rhdf5filters/1.18.0--r44h77050f0_0
$ module help quay.io/biocontainers/bioconductor-rhdf5filters/1.18.0--r44h77050f0_0
```
