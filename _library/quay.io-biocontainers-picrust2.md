...
updated_at: "2024-12-04 03:40:11.514616"
...
```bash
$ shpc install quay.io/biocontainers/picrust2:2.5.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/picrust2/2.5.3--pyhdfd78af_0
$ module help quay.io/biocontainers/picrust2/2.5.3--pyhdfd78af_0
```
