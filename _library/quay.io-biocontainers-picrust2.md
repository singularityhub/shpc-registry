...
updated_at: "2022-10-27 00:59:53.918324"
...
```bash
$ shpc install quay.io/biocontainers/picrust2:2.5.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/picrust2/2.5.0--pyhdfd78af_0
$ module help quay.io/biocontainers/picrust2/2.5.0--pyhdfd78af_0
```
...
```bash
$ singularity exec <container> /usr/local/bin/.picrust2-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.picrust2-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.picrust2-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.picrust2-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.picrust2-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.picrust2-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
