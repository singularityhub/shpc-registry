...
updated_at: "2026-03-07 04:36:56.953358"
latest: "2.6.3--pyhdfd78af_2"
...
```bash
$ shpc install quay.io/biocontainers/picrust2:2.6.3--pyhdfd78af_2
```
...
```bash
$ module load quay.io/biocontainers/picrust2/2.6.3--pyhdfd78af_2
$ module help quay.io/biocontainers/picrust2/2.6.3--pyhdfd78af_2
```
