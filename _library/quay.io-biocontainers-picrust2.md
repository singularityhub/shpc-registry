...
updated_at: "2025-04-22 03:17:43.124675"
...
```bash
$ shpc install quay.io/biocontainers/picrust2:2.6.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/picrust2/2.6.1--pyhdfd78af_0
$ module help quay.io/biocontainers/picrust2/2.6.1--pyhdfd78af_0
```
