...
updated_at: "2025-05-24 03:09:33.694472"
...
```bash
$ shpc install quay.io/biocontainers/picrust2:2.6.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/picrust2/2.6.2--pyhdfd78af_0
$ module help quay.io/biocontainers/picrust2/2.6.2--pyhdfd78af_0
```
