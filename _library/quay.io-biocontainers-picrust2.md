...
updated_at: "2026-02-03 04:59:27.406889"
latest: "2.6.3--pyhdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/picrust2:2.6.3--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/picrust2/2.6.3--pyhdfd78af_1
$ module help quay.io/biocontainers/picrust2/2.6.3--pyhdfd78af_1
```
