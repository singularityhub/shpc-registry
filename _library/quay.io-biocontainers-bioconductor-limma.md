...
updated_at: "2026-03-27 04:41:50.557964"
latest: "3.66.0--r45h01b2380_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-limma:3.66.0--r45h01b2380_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-limma/3.66.0--r45h01b2380_0
$ module help quay.io/biocontainers/bioconductor-limma/3.66.0--r45h01b2380_0
```
