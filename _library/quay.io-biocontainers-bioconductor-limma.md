...
updated_at: "2025-02-16 03:44:31.634068"
latest: "3.62.1--r44h15a9599_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-limma:3.62.1--r44h15a9599_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-limma/3.62.1--r44h15a9599_0
$ module help quay.io/biocontainers/bioconductor-limma/3.62.1--r44h15a9599_0
```
