...
updated_at: "2022-10-29 05:44:47.109744"
latest: "2.58.0--r41hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-nnnorm:2.58.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-nnnorm/2.58.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-nnnorm/2.58.0--r41hdfd78af_0
```
