...
updated_at: "2023-01-31 18:21:39.166253"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-zenith:1.0.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-zenith/1.0.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-zenith/1.0.0--r42hdfd78af_0
```
