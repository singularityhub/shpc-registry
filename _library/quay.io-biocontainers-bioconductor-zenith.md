...
updated_at: "2025-04-08 03:08:33.523045"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-zenith:1.8.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-zenith/1.8.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-zenith/1.8.0--r44hdfd78af_0
```
