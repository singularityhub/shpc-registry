---
layout: container
name:  "quay.io/biocontainers/bioconductor-zenith"
maintainer: "@vsoch"
...
updated_at: "2026-03-28 17:13:48.595601"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-zenith
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-zenith:1.12.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-zenith/1.12.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-zenith/1.12.0--r45hdfd78af_0
```
...
#### bioconductor-zenith-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-zenith-inspect-deffile:
