...
updated_at: "2025-02-28 03:22:15.337454"
latest: "2.13.1--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/comparem2:2.13.1--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/comparem2/2.13.1--hdfd78af_0
$ module help quay.io/biocontainers/comparem2/2.13.1--hdfd78af_0
```
