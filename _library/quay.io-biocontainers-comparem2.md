...
updated_at: "2025-08-09 03:35:42.830388"
...
```bash
$ shpc install quay.io/biocontainers/comparem2:2.14.1--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/comparem2/2.14.1--hdfd78af_0
$ module help quay.io/biocontainers/comparem2/2.14.1--hdfd78af_0
```
