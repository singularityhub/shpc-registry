...
updated_at: "2025-01-30 03:08:36.156115"
latest: "2.12.1--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/comparem2:2.12.1--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/comparem2/2.12.1--hdfd78af_0
$ module help quay.io/biocontainers/comparem2/2.12.1--hdfd78af_0
```
