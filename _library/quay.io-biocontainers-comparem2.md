---
layout: container
name:  "quay.io/biocontainers/comparem2"
maintainer: "@vsoch"
...
updated_at: "2024-12-26 02:52:46.483341"
latest: "2.11.1--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/comparem2
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/comparem2:2.11.1--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/comparem2/2.11.1--hdfd78af_0
$ module help quay.io/biocontainers/comparem2/2.11.1--hdfd78af_0
```
...
#### comparem2-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### comparem2-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/comparem2
$ podman run --it --rm --entrypoint /usr/local/bin/comparem2   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/comparem2   -v ${PWD} -w ${PWD} <container> -c " $@"
```
