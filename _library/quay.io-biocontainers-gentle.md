...
updated_at: "2025-10-31 04:29:17.909759"
...
```bash
$ shpc install quay.io/biocontainers/gentle:1.9.5.alpha1--h229bc75_2
```
...
```bash
$ module load quay.io/biocontainers/gentle/1.9.5.alpha1--h229bc75_2
$ module help quay.io/biocontainers/gentle/1.9.5.alpha1--h229bc75_2
```
