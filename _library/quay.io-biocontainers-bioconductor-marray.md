...
updated_at: "2023-08-08 03:17:46.197571"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-marray:1.78.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-marray/1.78.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-marray/1.78.0--r43hdfd78af_0
```
