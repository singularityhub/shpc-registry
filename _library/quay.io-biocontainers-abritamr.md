...
updated_at: "2024-08-15 03:34:10.918938"
...
```bash
$ shpc install quay.io/biocontainers/abritamr:1.0.18--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/abritamr/1.0.18--pyhdfd78af_0
$ module help quay.io/biocontainers/abritamr/1.0.18--pyhdfd78af_0
```
