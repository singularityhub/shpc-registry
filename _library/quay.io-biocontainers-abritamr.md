...
updated_at: "2024-06-22 02:39:08.898086"
...
```bash
$ shpc install quay.io/biocontainers/abritamr:1.0.17--pyhdfd78af_2
```
...
```bash
$ module load quay.io/biocontainers/abritamr/1.0.17--pyhdfd78af_2
$ module help quay.io/biocontainers/abritamr/1.0.17--pyhdfd78af_2
```
