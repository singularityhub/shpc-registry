...
updated_at: "2025-10-24 03:28:51.323978"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-oncomix:1.28.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-oncomix/1.28.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-oncomix/1.28.0--r44hdfd78af_0
```
