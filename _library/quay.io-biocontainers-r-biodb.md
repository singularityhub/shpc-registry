...
updated_at: "2023-08-11 03:06:28.931954"
latest: "1.2.2--r43h4ac6f70_8"
...
```bash
$ shpc install quay.io/biocontainers/r-biodb:1.2.2--r43h4ac6f70_8
```
...
```bash
$ module load quay.io/biocontainers/r-biodb/1.2.2--r43h4ac6f70_8
$ module help quay.io/biocontainers/r-biodb/1.2.2--r43h4ac6f70_8
```
