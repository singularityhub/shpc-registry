...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mgug4122a.db:3.2.3--r40_9
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mgug4122a.db/3.2.3--r40_9
$ module help quay.io/biocontainers/bioconductor-mgug4122a.db/3.2.3--r40_9
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-mgug4122a.db-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-mgug4122a.db-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-mgug4122a.db-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-mgug4122a.db-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-mgug4122a.db-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-mgug4122a.db-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
