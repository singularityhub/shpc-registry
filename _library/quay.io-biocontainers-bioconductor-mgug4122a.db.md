...
updated_at: "2026-04-05 04:50:13.588774"
latest: "3.2.3--r45hdfd78af_19"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mgug4122a.db:3.2.3--r45hdfd78af_19
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mgug4122a.db/3.2.3--r45hdfd78af_19
$ module help quay.io/biocontainers/bioconductor-mgug4122a.db/3.2.3--r45hdfd78af_19
```
