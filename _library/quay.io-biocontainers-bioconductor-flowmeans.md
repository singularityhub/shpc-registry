...
updated_at: "2026-03-01 04:31:35.715500"
latest: "1.70.0--r45h575d39b_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-flowmeans:1.70.0--r45h575d39b_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-flowmeans/1.70.0--r45h575d39b_0
$ module help quay.io/biocontainers/bioconductor-flowmeans/1.70.0--r45h575d39b_0
```
