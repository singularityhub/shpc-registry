...
updated_at: "2024-04-25 02:32:35.085589"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-faahko:1.42.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-faahko/1.42.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-faahko/1.42.0--r43hdfd78af_0
```
