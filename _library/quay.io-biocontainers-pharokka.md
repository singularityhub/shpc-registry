...
updated_at: "2024-12-22 03:38:51.275480"
...
```bash
$ shpc install quay.io/biocontainers/pharokka:1.7.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pharokka/1.7.4--pyhdfd78af_0
$ module help quay.io/biocontainers/pharokka/1.7.4--pyhdfd78af_0
```
