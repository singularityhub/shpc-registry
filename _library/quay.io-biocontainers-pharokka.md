...
updated_at: "2023-08-07 03:21:18.523441"
...
```bash
$ shpc install quay.io/biocontainers/pharokka:1.3.2--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pharokka/1.3.2--hdfd78af_0
$ module help quay.io/biocontainers/pharokka/1.3.2--hdfd78af_0
```
