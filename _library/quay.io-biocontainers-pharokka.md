...
updated_at: "2025-09-18 06:13:30.745761"
latest: "1.7.5--pyhdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/pharokka:1.7.5--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/pharokka/1.7.5--pyhdfd78af_1
$ module help quay.io/biocontainers/pharokka/1.7.5--pyhdfd78af_1
```
