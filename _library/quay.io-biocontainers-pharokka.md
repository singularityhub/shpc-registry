...
updated_at: "2024-02-08 08:09:17.011108"
...
```bash
$ shpc install quay.io/biocontainers/pharokka:1.6.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pharokka/1.6.1--pyhdfd78af_0
$ module help quay.io/biocontainers/pharokka/1.6.1--pyhdfd78af_0
```
