...
updated_at: "2023-12-18 02:57:47.969111"
...
```bash
$ shpc install quay.io/biocontainers/pharokka:1.5.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pharokka/1.5.1--pyhdfd78af_0
$ module help quay.io/biocontainers/pharokka/1.5.1--pyhdfd78af_0
```
