...
updated_at: "2025-12-26 04:23:30.026393"
...
```bash
$ shpc install quay.io/biocontainers/pharokka:1.8.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pharokka/1.8.2--pyhdfd78af_0
$ module help quay.io/biocontainers/pharokka/1.8.2--pyhdfd78af_0
```
