...
updated_at: "2024-03-28 02:33:44.241835"
...
```bash
$ shpc install quay.io/biocontainers/pharokka:1.7.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pharokka/1.7.0--pyhdfd78af_0
$ module help quay.io/biocontainers/pharokka/1.7.0--pyhdfd78af_0
```
