...
updated_at: "2023-10-20 03:24:53.964644"
...
```bash
$ shpc install quay.io/biocontainers/pharokka:1.4.1--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/pharokka/1.4.1--pyh7cba7a3_0
$ module help quay.io/biocontainers/pharokka/1.4.1--pyh7cba7a3_0
```
