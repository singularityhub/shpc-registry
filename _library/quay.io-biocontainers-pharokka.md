...
updated_at: "2024-06-24 03:28:20.955153"
...
```bash
$ shpc install quay.io/biocontainers/pharokka:1.7.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pharokka/1.7.2--pyhdfd78af_0
$ module help quay.io/biocontainers/pharokka/1.7.2--pyhdfd78af_0
```
