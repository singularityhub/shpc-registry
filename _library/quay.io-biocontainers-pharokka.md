...
updated_at: "2025-04-21 03:59:38.602208"
...
```bash
$ shpc install quay.io/biocontainers/pharokka:1.7.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pharokka/1.7.5--pyhdfd78af_0
$ module help quay.io/biocontainers/pharokka/1.7.5--pyhdfd78af_0
```
