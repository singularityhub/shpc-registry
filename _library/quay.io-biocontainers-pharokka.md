...
updated_at: "2024-04-15 04:15:10.055576"
...
```bash
$ shpc install quay.io/biocontainers/pharokka:1.7.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pharokka/1.7.1--pyhdfd78af_0
$ module help quay.io/biocontainers/pharokka/1.7.1--pyhdfd78af_0
```
