...
updated_at: "2025-10-24 03:49:05.299575"
...
```bash
$ shpc install quay.io/biocontainers/pharokka:1.8.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pharokka/1.8.1--pyhdfd78af_0
$ module help quay.io/biocontainers/pharokka/1.8.1--pyhdfd78af_0
```
