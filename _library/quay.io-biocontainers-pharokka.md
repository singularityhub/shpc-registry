...
updated_at: "2024-11-27 03:45:46.119941"
...
```bash
$ shpc install quay.io/biocontainers/pharokka:1.7.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pharokka/1.7.3--pyhdfd78af_0
$ module help quay.io/biocontainers/pharokka/1.7.3--pyhdfd78af_0
```
