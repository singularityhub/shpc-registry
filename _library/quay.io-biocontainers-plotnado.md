---
layout: container
name:  "quay.io/biocontainers/plotnado"
maintainer: "@vsoch"
...
updated_at: "2026-06-06 16:01:04.166632"
...
singularity registry hpc automated addition for plotnado
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/plotnado
```
...
#### plotnado-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### plotnado-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/plotnado
$ podman run --it --rm --entrypoint /usr/local/bin/plotnado   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/plotnado   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/pyranger
$ podman run --it --rm --entrypoint /usr/local/bin/pyranger   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/pyranger   -v ${PWD} -w ${PWD} <container> -c " $@"
```
