...
updated_at: "2023-07-06 07:00:36.929688"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-diffustats:1.18.0--r42hf17093f_2
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-diffustats/1.18.0--r42hf17093f_2
$ module help quay.io/biocontainers/bioconductor-diffustats/1.18.0--r42hf17093f_2
```
