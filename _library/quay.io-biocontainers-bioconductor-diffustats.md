...
updated_at: "2023-11-13 02:32:10.768346"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-diffustats:1.20.0--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-diffustats/1.20.0--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-diffustats/1.20.0--r43hf17093f_0
```
