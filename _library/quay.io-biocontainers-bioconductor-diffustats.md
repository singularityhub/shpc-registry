...
updated_at: "2022-11-24 23:48:11.159097"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-diffustats:1.14.0--r41hc247a5b_2
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-diffustats/1.14.0--r41hc247a5b_2
$ module help quay.io/biocontainers/bioconductor-diffustats/1.14.0--r41hc247a5b_2
```
