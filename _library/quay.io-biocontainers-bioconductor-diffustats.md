...
updated_at: "2022-11-02 00:16:27.748956"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-diffustats:1.8.0--r40h5f743cb_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-diffustats/1.8.0--r40h5f743cb_0
$ module help quay.io/biocontainers/bioconductor-diffustats/1.8.0--r40h5f743cb_0
```
