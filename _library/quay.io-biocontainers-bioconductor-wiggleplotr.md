...
updated_at: "2022-11-03 00:52:54.877502"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-wiggleplotr:1.8.0--r36_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-wiggleplotr/1.8.0--r36_1
$ module help quay.io/biocontainers/bioconductor-wiggleplotr/1.8.0--r36_1
```
