---
layout: container
name:  "quay.io/biocontainers/httpretty"
maintainer: "@vsoch"
...
updated_at: "2025-11-18 03:35:21.648332"
...
```bash
$ shpc install quay.io/biocontainers/httpretty
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/httpretty:0.8.10--py35_0
```
...
```bash
$ module load quay.io/biocontainers/httpretty/0.8.10--py35_0
$ module help quay.io/biocontainers/httpretty/0.8.10--py35_0
```
...
#### httpretty-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### httpretty-inspect-deffile:
