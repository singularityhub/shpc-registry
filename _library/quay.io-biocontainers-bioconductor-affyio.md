...
updated_at: "2026-03-10 04:45:19.225417"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-affyio:1.80.0--r45h01b2380_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-affyio/1.80.0--r45h01b2380_0
$ module help quay.io/biocontainers/bioconductor-affyio/1.80.0--r45h01b2380_0
```
