...
updated_at: "2024-01-06 02:38:23.947971"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mgu74cprobe:2.18.0--r43hdfd78af_13
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mgu74cprobe/2.18.0--r43hdfd78af_13
$ module help quay.io/biocontainers/bioconductor-mgu74cprobe/2.18.0--r43hdfd78af_13
```
