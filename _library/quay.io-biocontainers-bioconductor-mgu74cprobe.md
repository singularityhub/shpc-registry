...
updated_at: "2023-12-20 02:26:30.267882"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mgu74cprobe:2.18.0--r43hdfd78af_12
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mgu74cprobe/2.18.0--r43hdfd78af_12
$ module help quay.io/biocontainers/bioconductor-mgu74cprobe/2.18.0--r43hdfd78af_12
```
