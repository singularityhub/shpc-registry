...
updated_at: "2023-10-17 02:45:56.066813"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-chipseqdbdata:1.16.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-chipseqdbdata/1.16.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-chipseqdbdata/1.16.0--r43hdfd78af_0
```
