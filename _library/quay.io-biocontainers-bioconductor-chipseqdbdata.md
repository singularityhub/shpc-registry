...
updated_at: "2024-06-03 02:35:53.560007"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-chipseqdbdata:1.18.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-chipseqdbdata/1.18.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-chipseqdbdata/1.18.0--r43hdfd78af_0
```
