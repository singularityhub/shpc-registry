...
updated_at: "2022-10-27 00:59:27.325540"
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-chipseqdbdata-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-chipseqdbdata-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-chipseqdbdata-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-chipseqdbdata-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-chipseqdbdata-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-chipseqdbdata-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
