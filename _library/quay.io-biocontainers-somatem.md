---
layout: container
name:  "quay.io/biocontainers/somatem"
maintainer: "@vsoch"
...
updated_at: "2026-03-25 05:07:36.618687"
...
versions:
 - "0.7.1--hdfd78af_0"
description: "singularity registry hpc automated addition for somatem"
config: {"url": "https://biocontainers.pro/tools/somatem", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for somatem", "latest": {"0.7.1--hdfd78af_0": "sha256:ec20ff56b2399c730beed5841b9ec952cbe9a35358c039fb68b698e999ce6a7d"}, "tags": {"0.7.1--hdfd78af_0": "sha256:ec20ff56b2399c730beed5841b9ec952cbe9a35358c039fb68b698e999ce6a7d"}, "docker": "quay.io/biocontainers/somatem", "aliases": {"micromamba": "/usr/local/bin/micromamba", "somatem": "/usr/local/bin/somatem", "bash": "/usr/local/bin/bash", "bashbug": "/usr/local/bin/bashbug", "nextflow": "/usr/local/bin/nextflow", "basenc": "/usr/local/bin/basenc", "b2sum": "/usr/local/bin/b2sum", "ls": "/usr/local/bin/ls", "base32": "/usr/local/bin/base32", "base64": "/usr/local/bin/base64", "basename": "/usr/local/bin/basename", "cat": "/usr/local/bin/cat", "chcon": "/usr/local/bin/chcon", "chgrp": "/usr/local/bin/chgrp", "chmod": "/usr/local/bin/chmod", "chown": "/usr/local/bin/chown", "chroot": "/usr/local/bin/chroot", "cksum": "/usr/local/bin/cksum", "comm": "/usr/local/bin/comm", "cp": "/usr/local/bin/cp", "csplit": "/usr/local/bin/csplit", "cut": "/usr/local/bin/cut", "date": "/usr/local/bin/date", "dd": "/usr/local/bin/dd", "df": "/usr/local/bin/df", "dir": "/usr/local/bin/dir", "dircolors": "/usr/local/bin/dircolors"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/somatem.
singularity registry hpc automated addition for somatem
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/somatem
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/somatem:0.7.1--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/somatem/0.7.1--hdfd78af_0
$ module help quay.io/biocontainers/somatem/0.7.1--hdfd78af_0
```
...
#### somatem-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### somatem-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/micromamba
$ podman run --it --rm --entrypoint /usr/local/bin/micromamba   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/micromamba   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/somatem
$ podman run --it --rm --entrypoint /usr/local/bin/somatem   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/somatem   -v ${PWD} -w ${PWD} <container> -c " $@"
```
