...
updated_at: "2025-08-15 03:44:28.022110"
latest: "1.4.0--py39hbcbf7aa_0"
...
```bash
$ shpc install quay.io/biocontainers/quatradis:1.4.0--py39hbcbf7aa_0
```
...
```bash
$ module load quay.io/biocontainers/quatradis/1.4.0--py39hbcbf7aa_0
$ module help quay.io/biocontainers/quatradis/1.4.0--py39hbcbf7aa_0
```
