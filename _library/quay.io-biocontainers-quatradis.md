...
updated_at: "2025-01-11 03:25:09.185562"
latest: "1.3.2--py311haab0aaa_1"
...
```bash
$ shpc install quay.io/biocontainers/quatradis:1.3.2--py311haab0aaa_1
```
...
```bash
$ module load quay.io/biocontainers/quatradis/1.3.2--py311haab0aaa_1
$ module help quay.io/biocontainers/quatradis/1.3.2--py311haab0aaa_1
```
