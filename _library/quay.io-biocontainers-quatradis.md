...
updated_at: "2024-04-10 02:46:33.000408"
latest: "1.2.0--py310h031d066_0"
...
```bash
$ shpc install quay.io/biocontainers/quatradis:1.2.0--py310h031d066_0
```
...
```bash
$ module load quay.io/biocontainers/quatradis/1.2.0--py310h031d066_0
$ module help quay.io/biocontainers/quatradis/1.2.0--py310h031d066_0
```
