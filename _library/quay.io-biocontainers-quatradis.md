...
updated_at: "2024-12-24 03:24:36.908772"
latest: "1.3.1--py38h0020b31_0"
...
```bash
$ shpc install quay.io/biocontainers/quatradis:1.3.1--py38h0020b31_0
```
...
```bash
$ module load quay.io/biocontainers/quatradis/1.3.1--py38h0020b31_0
$ module help quay.io/biocontainers/quatradis/1.3.1--py38h0020b31_0
```
