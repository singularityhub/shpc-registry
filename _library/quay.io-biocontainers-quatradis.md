...
updated_at: "2024-06-10 03:02:05.392130"
latest: "1.3.0--py310h031d066_0"
...
```bash
$ shpc install quay.io/biocontainers/quatradis:1.3.0--py310h031d066_0
```
...
```bash
$ module load quay.io/biocontainers/quatradis/1.3.0--py310h031d066_0
$ module help quay.io/biocontainers/quatradis/1.3.0--py310h031d066_0
```
