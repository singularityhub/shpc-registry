...
updated_at: "2025-11-05 03:33:29.826529"
latest: "1.4.0--py312h0fa9677_1"
...
```bash
$ shpc install quay.io/biocontainers/quatradis:1.4.0--py312h0fa9677_1
```
...
```bash
$ module load quay.io/biocontainers/quatradis/1.4.0--py312h0fa9677_1
$ module help quay.io/biocontainers/quatradis/1.4.0--py312h0fa9677_1
```
