...
updated_at: "2025-02-10 03:20:51.864027"
latest: "1.3.3--py39hbcbf7aa_0"
...
```bash
$ shpc install quay.io/biocontainers/quatradis:1.3.3--py39hbcbf7aa_0
```
...
```bash
$ module load quay.io/biocontainers/quatradis/1.3.3--py39hbcbf7aa_0
$ module help quay.io/biocontainers/quatradis/1.3.3--py39hbcbf7aa_0
```
