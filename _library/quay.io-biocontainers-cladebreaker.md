...
updated_at: "2026-07-01 07:20:22.379187"
...
```bash
$ shpc install quay.io/biocontainers/cladebreaker:0.3.1--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/cladebreaker/0.3.1--hdfd78af_0
$ module help quay.io/biocontainers/cladebreaker/0.3.1--hdfd78af_0
```
