---
layout: container
name:  "quay.io/biocontainers/itbins"
maintainer: "@vsoch"
...
updated_at: "2026-03-01 05:02:16.163199"
...
singularity registry hpc automated addition for itbins
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/itbins
```
...
#### itbins-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### itbins-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/itbins
$ podman run --it --rm --entrypoint /usr/local/bin/itbins   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/itbins   -v ${PWD} -w ${PWD} <container> -c " $@"
```
