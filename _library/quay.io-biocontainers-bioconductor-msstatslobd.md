...
updated_at: "2022-10-29 05:58:23.734710"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-msstatslobd:1.2.0--r41hc247a5b_2
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-msstatslobd/1.2.0--r41hc247a5b_2
$ module help quay.io/biocontainers/bioconductor-msstatslobd/1.2.0--r41hc247a5b_2
```
