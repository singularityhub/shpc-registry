...
updated_at: "2026-04-05 05:07:17.135316"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-msstatslobd:1.18.0--r45ha27e39d_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-msstatslobd/1.18.0--r45ha27e39d_0
$ module help quay.io/biocontainers/bioconductor-msstatslobd/1.18.0--r45ha27e39d_0
```
