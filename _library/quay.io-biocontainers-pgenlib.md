...
updated_at: "2026-07-13 05:57:30.128235"
latest: "0.94.1--py312hedfda1a_0"
...
```bash
$ shpc install quay.io/biocontainers/pgenlib:0.94.1--py312hedfda1a_0
```
...
```bash
$ module load quay.io/biocontainers/pgenlib/0.94.1--py312hedfda1a_0
$ module help quay.io/biocontainers/pgenlib/0.94.1--py312hedfda1a_0
```
