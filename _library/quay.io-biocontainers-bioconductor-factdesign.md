...
updated_at: "2023-11-02 03:02:14.386377"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-factdesign:1.76.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-factdesign/1.76.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-factdesign/1.76.0--r43hdfd78af_0
```
