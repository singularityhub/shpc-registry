...
updated_at: "2022-10-27 00:47:34.253789"
latest: "0.0.3.2--py_0"
...
config: {"url": "https://biocontainers.pro/tools/hamip", "maintainer": "@vsoch", "description": "shpc-registry automated BioContainers addition for hamip", "latest": {"0.0.3.2--py_0": "sha256:1af48747c1ad4c2cfe9e212772329b33cfc79400c7de8b7a4506afe4b75d6097"}, "tags": {"0.0.3.2--py_0": "sha256:1af48747c1ad4c2cfe9e212772329b33cfc79400c7de8b7a4506afe4b75d6097"}, "docker": "quay.io/biocontainers/hamip", "aliases": {".moabs-post-link.sh": "/usr/local/bin/.moabs-post-link.sh", "HaMiP": "/usr/local/bin/HaMiP", "LiBis": "/usr/local/bin/LiBis", "bamsort.sh": "/usr/local/bin/bamsort.sh", "bbf": "/usr/local/bin/bbf", "bseqc2": "/usr/local/bin/bseqc2", "bseqc2mbiasplot.R": "/usr/local/bin/bseqc2mbiasplot.R", "bsmap": "/usr/local/bin/bsmap", "fetchChromSizes": "/usr/local/bin/fetchChromSizes", "lut_pdiffCI.dat": "/usr/local/bin/lut_pdiffCI.dat", "lut_pdiffInRegion.dat": "/usr/local/bin/lut_pdiffInRegion.dat", "mcall": "/usr/local/bin/mcall", "mcomp": "/usr/local/bin/mcomp", "moabs": "/usr/local/bin/moabs", "numCI": "/usr/local/bin/numCI", "pefilter": "/usr/local/bin/pefilter", "preprocess_novoalign.sh": "/usr/local/bin/preprocess_novoalign.sh", "redepth.pl": "/usr/local/bin/redepth.pl", "routines.pm": "/usr/local/bin/routines.pm", "template_for_cfg": "/usr/local/bin/template_for_cfg", "template_for_qsub": "/usr/local/bin/template_for_qsub"}}
---
