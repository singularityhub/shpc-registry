...
updated_at: "2025-11-27 03:51:30.005302"
...
```bash
$ shpc install quay.io/biocontainers/python-bioext:0.21.10--py39h8931b72_0
```
...
```bash
$ module load quay.io/biocontainers/python-bioext/0.21.10--py39h8931b72_0
$ module help quay.io/biocontainers/python-bioext/0.21.10--py39h8931b72_0
```
