...
updated_at: "2024-11-07 03:35:31.690875"
latest: "0.21.9--py39h91a4a08_0"
...
```bash
$ shpc install quay.io/biocontainers/python-bioext:0.21.9--py39h91a4a08_0
```
...
```bash
$ module load quay.io/biocontainers/python-bioext/0.21.9--py39h91a4a08_0
$ module help quay.io/biocontainers/python-bioext/0.21.9--py39h91a4a08_0
```
