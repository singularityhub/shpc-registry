---
layout: container
name:  "quay.io/biocontainers/hmftools-qsee"
maintainer: "@vsoch"
github: "https://github.com/singularityhub/shpc-registry/blob/main/quay.io/biocontainers/hmftools-qsee/container.yaml"
config_url: "https://raw.githubusercontent.com/singularityhub/shpc-registry/main/quay.io/biocontainers/hmftools-qsee/container.yaml"
updated_at: "2026-06-28 07:09:07.132136"
latest: "1.0--hdfd78af_0"
container_url: "https://biocontainers.pro/tools/hmftools-qsee"
aliases:
 - "qsee"
 - "fc-genconf"
 - "hb-raster"
...
versions:
 - "1.0--hdfd78af_0"
description: "singularity registry hpc automated addition for hmftools-qsee"
config: {"url": "https://biocontainers.pro/tools/hmftools-qsee", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for hmftools-qsee", "latest": {"1.0--hdfd78af_0": "sha256:a744f8104f768f1b83c11d331bdf2fc7fb90a97fcbd411a47a0237ecee16653e"}, "tags": {"1.0--hdfd78af_0": "sha256:a744f8104f768f1b83c11d331bdf2fc7fb90a97fcbd411a47a0237ecee16653e"}, "docker": "quay.io/biocontainers/hmftools-qsee", "aliases": {"qsee": "/usr/local/bin/qsee", "fc-genconf": "/usr/local/bin/fc-genconf", "hb-raster": "/usr/local/bin/hb-raster", "hb-vector": "/usr/local/bin/hb-vector", "jwebserver": "/usr/local/bin/jwebserver", "jpackage": "/usr/local/bin/jpackage", "cups-config": "/usr/local/bin/cups-config", "ippeveprinter": "/usr/local/bin/ippeveprinter", "ipptool": "/usr/local/bin/ipptool", "x86_64-conda-linux-gnu.cfg": "/usr/local/bin/x86_64-conda-linux-gnu.cfg", "jfr": "/usr/local/bin/jfr", "jdeprscan": "/usr/local/bin/jdeprscan", "jhsdb": "/usr/local/bin/jhsdb", "jimage": "/usr/local/bin/jimage", "jlink": "/usr/local/bin/jlink", "jmod": "/usr/local/bin/jmod", "jshell": "/usr/local/bin/jshell", "aserver": "/usr/local/bin/aserver", "jdeps": "/usr/local/bin/jdeps", "jar": "/usr/local/bin/jar", "jarsigner": "/usr/local/bin/jarsigner", "java": "/usr/local/bin/java", "javac": "/usr/local/bin/javac", "javadoc": "/usr/local/bin/javadoc", "javap": "/usr/local/bin/javap", "jcmd": "/usr/local/bin/jcmd"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/hmftools-qsee.
singularity registry hpc automated addition for hmftools-qsee
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/hmftools-qsee
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/hmftools-qsee:1.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hmftools-qsee/1.0--hdfd78af_0
$ module help quay.io/biocontainers/hmftools-qsee/1.0--hdfd78af_0
```
...
#### hmftools-qsee-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### hmftools-qsee-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/qsee
$ podman run --it --rm --entrypoint /usr/local/bin/qsee   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/qsee   -v ${PWD} -w ${PWD} <container> -c " $@"
```
