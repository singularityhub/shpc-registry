...
updated_at: "2026-01-26 04:40:06.947726"
...
```bash
$ shpc install quay.io/biocontainers/pybedtools:0.12.0--py310h275bdba_0
```
...
```bash
$ module load quay.io/biocontainers/pybedtools/0.12.0--py310h275bdba_0
$ module help quay.io/biocontainers/pybedtools/0.12.0--py310h275bdba_0
```
