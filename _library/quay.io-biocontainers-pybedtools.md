...
updated_at: "2024-11-08 03:12:43.134116"
latest: "0.10.0--py311hc849397_2"
...
```bash
$ shpc install quay.io/biocontainers/pybedtools:0.10.0--py311hc849397_2
```
...
```bash
$ module load quay.io/biocontainers/pybedtools/0.10.0--py311hc849397_2
$ module help quay.io/biocontainers/pybedtools/0.10.0--py311hc849397_2
```
