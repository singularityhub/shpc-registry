...
updated_at: "2026-09-04 07:25:48.483301"
latest: "0.12.1--py311h9a0eb59_0"
...
```bash
$ shpc install quay.io/biocontainers/pybedtools:0.12.1--py311h9a0eb59_0
```
...
```bash
$ module load quay.io/biocontainers/pybedtools/0.12.1--py311h9a0eb59_0
$ module help quay.io/biocontainers/pybedtools/0.12.1--py311h9a0eb59_0
```
