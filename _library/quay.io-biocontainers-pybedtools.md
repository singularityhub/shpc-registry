...
updated_at: "2026-07-02 06:49:18.519347"
latest: "0.12.0--py312hedfda1a_1"
...
```bash
$ shpc install quay.io/biocontainers/pybedtools:0.12.0--py312hedfda1a_1
```
...
```bash
$ module load quay.io/biocontainers/pybedtools/0.12.0--py312hedfda1a_1
$ module help quay.io/biocontainers/pybedtools/0.12.0--py312hedfda1a_1
```
