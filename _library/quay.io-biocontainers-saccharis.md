...
updated_at: "2024-08-12 03:57:56.180229"
...
```bash
$ shpc install quay.io/biocontainers/saccharis:2.0.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/saccharis/2.0.1--pyhdfd78af_0
$ module help quay.io/biocontainers/saccharis/2.0.1--pyhdfd78af_0
```
