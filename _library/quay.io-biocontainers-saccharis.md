...
updated_at: "2024-10-07 03:25:57.049073"
latest: "2.0.1.dev21--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/saccharis:2.0.1.dev21--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/saccharis/2.0.1.dev21--pyhdfd78af_0
$ module help quay.io/biocontainers/saccharis/2.0.1.dev21--pyhdfd78af_0
```
