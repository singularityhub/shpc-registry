...
updated_at: "2025-04-08 03:48:45.162209"
latest: "0.24.3--py312hf3590f5_1"
...
```bash
$ shpc install quay.io/biocontainers/fwdpy11:0.24.3--py312hf3590f5_1
```
...
```bash
$ module load quay.io/biocontainers/fwdpy11/0.24.3--py312hf3590f5_1
$ module help quay.io/biocontainers/fwdpy11/0.24.3--py312hf3590f5_1
```
