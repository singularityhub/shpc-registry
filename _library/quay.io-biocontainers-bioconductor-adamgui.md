...
updated_at: "2022-11-21 13:16:40.510058"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-adamgui:1.10.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-adamgui/1.10.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-adamgui/1.10.0--r41hdfd78af_0
```
