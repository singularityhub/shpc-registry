...
updated_at: "2023-12-10 02:55:36.386829"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-adamgui:1.16.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-adamgui/1.16.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-adamgui/1.16.0--r43hdfd78af_0
```
