...
updated_at: "2023-09-22 03:09:40.299849"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-arabidopsis.db0:3.17.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-arabidopsis.db0/3.17.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-arabidopsis.db0/3.17.0--r43hdfd78af_0
```
