...
updated_at: "2025-12-27 04:09:14.206462"
...
```bash
$ shpc install quay.io/biocontainers/hybran:1.9--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hybran/1.9--pyhdfd78af_0
$ module help quay.io/biocontainers/hybran/1.9--pyhdfd78af_0
```
