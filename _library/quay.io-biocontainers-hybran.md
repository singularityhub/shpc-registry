...
updated_at: "2026-02-28 04:29:20.691254"
...
```bash
$ shpc install quay.io/biocontainers/hybran:1.10--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hybran/1.10--pyhdfd78af_0
$ module help quay.io/biocontainers/hybran/1.10--pyhdfd78af_0
```
