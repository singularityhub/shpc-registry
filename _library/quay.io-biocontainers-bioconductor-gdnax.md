---
layout: container
name:  "quay.io/biocontainers/bioconductor-gdnax"
maintainer: "@vsoch"
...
updated_at: "2024-05-27 03:53:47.706974"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gdnax
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-gdnax:1.0.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gdnax/1.0.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-gdnax/1.0.0--r43hdfd78af_0
```
...
#### bioconductor-gdnax-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-gdnax-inspect-deffile:
