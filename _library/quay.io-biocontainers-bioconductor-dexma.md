...
updated_at: "2023-12-11 02:39:22.668177"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-dexma:1.8.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-dexma/1.8.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-dexma/1.8.0--r43hdfd78af_0
```
