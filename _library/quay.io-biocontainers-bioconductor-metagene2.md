...
updated_at: "2026-04-04 04:38:00.672397"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-metagene2:1.26.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-metagene2/1.26.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-metagene2/1.26.0--r45hdfd78af_0
```
