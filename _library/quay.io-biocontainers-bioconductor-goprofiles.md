...
updated_at: "2024-04-08 02:34:55.565449"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-goprofiles:1.64.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-goprofiles/1.64.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-goprofiles/1.64.0--r43hdfd78af_0
```
