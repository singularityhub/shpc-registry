...
updated_at: "2024-01-21 03:17:49.685415"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-canineprobe:2.18.0--r43hdfd78af_12
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-canineprobe/2.18.0--r43hdfd78af_12
$ module help quay.io/biocontainers/bioconductor-canineprobe/2.18.0--r43hdfd78af_12
```
