...
updated_at: "2024-07-15 03:35:42.746530"
latest: "1.1.0--py311h591056c_1"
...
```bash
$ shpc install quay.io/biocontainers/pyslow5:1.1.0--py311h591056c_1
```
...
```bash
$ module load quay.io/biocontainers/pyslow5/1.1.0--py311h591056c_1
$ module help quay.io/biocontainers/pyslow5/1.1.0--py311h591056c_1
```
