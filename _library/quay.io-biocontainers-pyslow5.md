...
updated_at: "2025-04-10 03:28:44.204499"
latest: "1.3.0--py310h9fea4d1_2"
...
```bash
$ shpc install quay.io/biocontainers/pyslow5:1.3.0--py310h9fea4d1_2
```
...
```bash
$ module load quay.io/biocontainers/pyslow5/1.3.0--py310h9fea4d1_2
$ module help quay.io/biocontainers/pyslow5/1.3.0--py310h9fea4d1_2
```
