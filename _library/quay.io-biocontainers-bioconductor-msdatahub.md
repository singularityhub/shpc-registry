---
layout: container
name:  "quay.io/biocontainers/bioconductor-msdatahub"
maintainer: "@vsoch"
...
updated_at: "2024-11-15 03:07:35.365078"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-msdatahub
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-msdatahub:1.2.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-msdatahub/1.2.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-msdatahub/1.2.0--r43hdfd78af_0
```
...
#### bioconductor-msdatahub-inspect:
...
#### bioconductor-msdatahub-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-msdatahub-inspect-deffile:
