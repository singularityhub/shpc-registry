...
updated_at: "2026-03-10 04:30:10.257108"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-pgca:1.34.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-pgca/1.34.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-pgca/1.34.0--r45hdfd78af_0
```
