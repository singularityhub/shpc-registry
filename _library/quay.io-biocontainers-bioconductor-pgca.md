...
updated_at: "2022-11-06 00:48:55.162430"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-pgca:1.18.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-pgca/1.18.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-pgca/1.18.0--r41hdfd78af_0
```
