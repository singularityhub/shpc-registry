...
updated_at: "2022-11-05 00:41:27.996812"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-pgca:1.8.0--r36_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-pgca/1.8.0--r36_1
$ module help quay.io/biocontainers/bioconductor-pgca/1.8.0--r36_1
```
