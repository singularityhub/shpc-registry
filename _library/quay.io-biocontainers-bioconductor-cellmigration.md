...
updated_at: "2023-12-10 03:07:55.380536"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cellmigration:1.8.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cellmigration/1.8.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-cellmigration/1.8.0--r43hdfd78af_0
```
