...
updated_at: "2023-09-18 03:03:22.187840"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-factr:1.2.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-factr/1.2.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-factr/1.2.0--r43hdfd78af_0
```
