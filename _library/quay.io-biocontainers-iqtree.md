...
updated_at: "2026-06-12 07:24:32.440167"
latest: "3.1.1--hde5307d_1"
...
```bash
$ shpc install quay.io/biocontainers/iqtree:3.1.1--hde5307d_1
```
...
```bash
$ module load quay.io/biocontainers/iqtree/3.1.1--hde5307d_1
$ module help quay.io/biocontainers/iqtree/3.1.1--hde5307d_1
```
