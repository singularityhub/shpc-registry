...
updated_at: "2023-12-14 03:22:26.563867"
latest: "2.2.5--h21ec9f0_0"
...
```bash
$ shpc install quay.io/biocontainers/iqtree:2.2.5--h21ec9f0_0
```
...
```bash
$ module load quay.io/biocontainers/iqtree/2.2.5--h21ec9f0_0
$ module help quay.io/biocontainers/iqtree/2.2.5--h21ec9f0_0
```
