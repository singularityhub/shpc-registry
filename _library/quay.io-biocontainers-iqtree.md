...
updated_at: "2024-06-22 02:39:02.655828"
latest: "2.3.4--hdcf5f25_2"
...
```bash
$ shpc install quay.io/biocontainers/iqtree:2.3.4--hdcf5f25_2
```
...
```bash
$ module load quay.io/biocontainers/iqtree/2.3.4--hdcf5f25_2
$ module help quay.io/biocontainers/iqtree/2.3.4--hdcf5f25_2
```
