...
updated_at: "2025-02-20 03:22:52.508687"
latest: "2.4.0--h503566f_0"
...
```bash
$ shpc install quay.io/biocontainers/iqtree:2.4.0--h503566f_0
```
...
```bash
$ module load quay.io/biocontainers/iqtree/2.4.0--h503566f_0
$ module help quay.io/biocontainers/iqtree/2.4.0--h503566f_0
```
