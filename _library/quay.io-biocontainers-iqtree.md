...
updated_at: "2023-08-19 02:26:22.424883"
latest: "2.2.3--h21ec9f0_0"
...
```bash
$ shpc install quay.io/biocontainers/iqtree:2.2.3--h21ec9f0_0
```
...
```bash
$ module load quay.io/biocontainers/iqtree/2.2.3--h21ec9f0_0
$ module help quay.io/biocontainers/iqtree/2.2.3--h21ec9f0_0
```
