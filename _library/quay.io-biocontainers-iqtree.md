...
updated_at: "2026-06-27 06:35:39.662446"
latest: "3.1.2--h8471819_0"
...
```bash
$ shpc install quay.io/biocontainers/iqtree:3.1.2--h8471819_0
```
...
```bash
$ module load quay.io/biocontainers/iqtree/3.1.2--h8471819_0
$ module help quay.io/biocontainers/iqtree/3.1.2--h8471819_0
```
