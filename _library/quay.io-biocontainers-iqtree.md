...
updated_at: "2026-08-21 03:17:45.897038"
...
```bash
$ shpc install quay.io/biocontainers/iqtree:3.1.3--h8471819_0
```
...
```bash
$ module load quay.io/biocontainers/iqtree/3.1.3--h8471819_0
$ module help quay.io/biocontainers/iqtree/3.1.3--h8471819_0
```
