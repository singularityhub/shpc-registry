...
updated_at: "2024-08-01 03:26:48.848023"
latest: "2.3.5--hdcf5f25_1"
...
```bash
$ shpc install quay.io/biocontainers/iqtree:2.3.5--hdcf5f25_1
```
...
```bash
$ module load quay.io/biocontainers/iqtree/2.3.5--hdcf5f25_1
$ module help quay.io/biocontainers/iqtree/2.3.5--hdcf5f25_1
```
