---
layout: container
name:  "quay.io/biocontainers/rcx-tk"
maintainer: "@vsoch"
...
updated_at: "2026-06-25 06:39:18.667286"
latest: "0.3.1--pyh1f0d9b5_0"
...
```bash
$ shpc install quay.io/biocontainers/rcx-tk
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/rcx-tk:0.3.1--pyh1f0d9b5_0
```
...
```bash
$ module load quay.io/biocontainers/rcx-tk/0.3.1--pyh1f0d9b5_0
$ module help quay.io/biocontainers/rcx-tk/0.3.1--pyh1f0d9b5_0
```
...
#### rcx-tk-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### rcx-tk-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/rcx_tk
$ podman run --it --rm --entrypoint /usr/local/bin/rcx_tk   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/rcx_tk   -v ${PWD} -w ${PWD} <container> -c " $@"
```
