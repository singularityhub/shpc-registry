...
updated_at: "2026-01-06 03:43:56.478639"
...
```bash
$ shpc install quay.io/biocontainers/ervdetective:1.0.9--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/ervdetective/1.0.9--pyhdfd78af_1
$ module help quay.io/biocontainers/ervdetective/1.0.9--pyhdfd78af_1
```
