---
layout: container
name:  "quay.io/biocontainers/ntsm"
maintainer: "@vsoch"
...
updated_at: "2025-10-13 04:26:50.841595"
...
singularity registry hpc automated addition for ntsm
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/ntsm
```
...
#### ntsm-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### ntsm-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/ntsmCount
$ podman run --it --rm --entrypoint /usr/local/bin/ntsmCount   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/ntsmCount   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/ntsmEval
$ podman run --it --rm --entrypoint /usr/local/bin/ntsmEval   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/ntsmEval   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/ntsmSiteGen
$ podman run --it --rm --entrypoint /usr/local/bin/ntsmSiteGen   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/ntsmSiteGen   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/ntsmVCF
$ podman run --it --rm --entrypoint /usr/local/bin/ntsmVCF   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/ntsmVCF   -v ${PWD} -w ${PWD} <container> -c " $@"
```
