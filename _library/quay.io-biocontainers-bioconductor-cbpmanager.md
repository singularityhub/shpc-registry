...
updated_at: "2023-11-27 03:31:54.084589"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cbpmanager:1.8.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cbpmanager/1.8.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-cbpmanager/1.8.0--r43hdfd78af_0
```
