...
updated_at: "2025-04-22 03:22:27.783334"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-bigmelon:1.32.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-bigmelon/1.32.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-bigmelon/1.32.0--r44hdfd78af_0
```
