...
updated_at: "2024-07-25 03:10:53.251055"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-bigmelon:1.28.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-bigmelon/1.28.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-bigmelon/1.28.0--r43hdfd78af_0
```
