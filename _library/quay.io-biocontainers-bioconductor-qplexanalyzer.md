...
updated_at: "2026-03-28 05:19:03.877421"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-qplexanalyzer:1.28.2--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-qplexanalyzer/1.28.2--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-qplexanalyzer/1.28.2--r45hdfd78af_0
```
