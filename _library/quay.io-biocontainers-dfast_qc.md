...
updated_at: "2023-01-22 03:55:34.230409"
...
```bash
$ shpc install quay.io/biocontainers/dfast_qc:0.5.1--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/dfast_qc/0.5.1--hdfd78af_0
$ module help quay.io/biocontainers/dfast_qc/0.5.1--hdfd78af_0
```
