...
updated_at: "2024-09-09 06:11:51.091517"
...
```bash
$ shpc install quay.io/biocontainers/dfast_qc:1.0.4--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/dfast_qc/1.0.4--hdfd78af_0
$ module help quay.io/biocontainers/dfast_qc/1.0.4--hdfd78af_0
```
