...
updated_at: "2026-06-19 07:35:20.810325"
...
```bash
$ shpc install quay.io/biocontainers/dfast_qc:1.1.1--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/dfast_qc/1.1.1--hdfd78af_0
$ module help quay.io/biocontainers/dfast_qc/1.1.1--hdfd78af_0
```
