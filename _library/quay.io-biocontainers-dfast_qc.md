...
updated_at: "2025-08-08 03:48:40.344384"
...
```bash
$ shpc install quay.io/biocontainers/dfast_qc:1.0.7--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/dfast_qc/1.0.7--hdfd78af_0
$ module help quay.io/biocontainers/dfast_qc/1.0.7--hdfd78af_0
```
