...
updated_at: "2024-07-18 04:13:42.792941"
...
```bash
$ shpc install quay.io/biocontainers/dfast_qc:1.0.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/dfast_qc/1.0.0--hdfd78af_0
$ module help quay.io/biocontainers/dfast_qc/1.0.0--hdfd78af_0
```
