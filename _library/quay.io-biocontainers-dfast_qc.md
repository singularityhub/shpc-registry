...
updated_at: "2024-08-19 03:01:13.669205"
...
```bash
$ shpc install quay.io/biocontainers/dfast_qc:1.0.2--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/dfast_qc/1.0.2--hdfd78af_0
$ module help quay.io/biocontainers/dfast_qc/1.0.2--hdfd78af_0
```
