...
updated_at: "2025-03-15 03:36:19.390399"
...
```bash
$ shpc install quay.io/biocontainers/dfast_qc:1.0.6--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/dfast_qc/1.0.6--hdfd78af_0
$ module help quay.io/biocontainers/dfast_qc/1.0.6--hdfd78af_0
```
