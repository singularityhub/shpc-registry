...
updated_at: "2024-12-03 03:25:20.015178"
...
```bash
$ shpc install quay.io/biocontainers/dfast_qc:1.0.5--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/dfast_qc/1.0.5--hdfd78af_0
$ module help quay.io/biocontainers/dfast_qc/1.0.5--hdfd78af_0
```
