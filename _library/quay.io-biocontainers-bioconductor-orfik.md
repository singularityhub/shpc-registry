...
updated_at: "2023-05-25 02:41:32.664508"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-orfik:1.18.0--r42hf17093f_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-orfik/1.18.0--r42hf17093f_1
$ module help quay.io/biocontainers/bioconductor-orfik/1.18.0--r42hf17093f_1
```
