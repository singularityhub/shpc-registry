---
layout: container
name:  "quay.io/biocontainers/smetana"
maintainer: "@vsoch"
...
updated_at: "2024-10-21 02:58:02.548938"
...
```bash
$ shpc install quay.io/biocontainers/smetana
```
...
#### smetana-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### smetana-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/smetana
$ podman run --it --rm --entrypoint /usr/local/bin/smetana   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/smetana   -v ${PWD} -w ${PWD} <container> -c " $@"
```
