...
updated_at: "2022-11-05 00:05:57.594760"
latest: "1.0.3--r41hc247a5b_1"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mosbi:1.0.3--r41hc247a5b_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mosbi/1.0.3--r41hc247a5b_1
$ module help quay.io/biocontainers/bioconductor-mosbi/1.0.3--r41hc247a5b_1
```
