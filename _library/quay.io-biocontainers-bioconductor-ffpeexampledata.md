...
updated_at: "2024-02-03 02:49:05.443214"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ffpeexampledata:1.40.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ffpeexampledata/1.40.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ffpeexampledata/1.40.0--r43hdfd78af_0
```
