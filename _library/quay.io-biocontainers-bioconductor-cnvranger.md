...
updated_at: "2026-03-20 05:01:01.969267"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cnvranger:1.26.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cnvranger/1.26.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-cnvranger/1.26.0--r45hdfd78af_0
```
