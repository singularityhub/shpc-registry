...
updated_at: "2024-07-29 17:31:02.353077"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cnvranger:1.18.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cnvranger/1.18.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-cnvranger/1.18.0--r43hdfd78af_0
```
