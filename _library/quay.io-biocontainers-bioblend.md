...
updated_at: "2025-08-23 03:29:09.185236"
...
```bash
$ shpc install quay.io/biocontainers/bioblend:1.6.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioblend/1.6.0--pyhdfd78af_0
$ module help quay.io/biocontainers/bioblend/1.6.0--pyhdfd78af_0
```
