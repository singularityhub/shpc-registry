---
layout: container
name:  "quay.io/biocontainers/bioblend"
maintainer: "@vsoch"
...
updated_at: "2025-05-01 07:23:00.875853"
...
```bash
$ shpc install quay.io/biocontainers/bioblend
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioblend:1.5.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioblend/1.5.0--pyhdfd78af_0
$ module help quay.io/biocontainers/bioblend/1.5.0--pyhdfd78af_0
```
...
#### bioblend-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioblend-inspect-deffile:
