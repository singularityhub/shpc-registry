...
updated_at: "2024-03-23 02:41:39.742183"
...
```bash
$ shpc install quay.io/biocontainers/bioblend:1.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioblend/1.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/bioblend/1.2.0--pyhdfd78af_0
```
