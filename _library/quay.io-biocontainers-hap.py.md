...
updated_at: "2022-10-27 00:50:59.381657"
latest: "0.3.7--py27_1"
...
```bash
$ shpc install quay.io/biocontainers/hap.py:0.3.7--py27_1
```
...
```bash
$ module load quay.io/biocontainers/hap.py/0.3.7--py27_1
$ module help quay.io/biocontainers/hap.py/0.3.7--py27_1
```
