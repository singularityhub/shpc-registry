...
updated_at: "2023-11-25 03:01:35.930135"
latest: "1.1.38--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/viralmsa:1.1.38--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/viralmsa/1.1.38--hdfd78af_0
$ module help quay.io/biocontainers/viralmsa/1.1.38--hdfd78af_0
```
