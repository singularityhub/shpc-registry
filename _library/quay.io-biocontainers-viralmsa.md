...
updated_at: "2023-11-08 02:53:18.533442"
latest: "1.1.35--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/viralmsa:1.1.35--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/viralmsa/1.1.35--hdfd78af_0
$ module help quay.io/biocontainers/viralmsa/1.1.35--hdfd78af_0
```
