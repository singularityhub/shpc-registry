...
updated_at: "2025-10-16 03:32:36.912353"
latest: "1.1.45--hdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/viralmsa:1.1.45--hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/viralmsa/1.1.45--hdfd78af_1
$ module help quay.io/biocontainers/viralmsa/1.1.45--hdfd78af_1
```
