...
updated_at: "2024-01-03 02:45:47.469153"
...
```bash
$ shpc install quay.io/biocontainers/viralmsa:1.1.40--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/viralmsa/1.1.40--hdfd78af_0
$ module help quay.io/biocontainers/viralmsa/1.1.40--hdfd78af_0
```
