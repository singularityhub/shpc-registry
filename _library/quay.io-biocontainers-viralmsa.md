...
updated_at: "2025-12-29 04:39:51.228645"
latest: "1.1.46--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/viralmsa:1.1.46--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/viralmsa/1.1.46--hdfd78af_0
$ module help quay.io/biocontainers/viralmsa/1.1.46--hdfd78af_0
```
