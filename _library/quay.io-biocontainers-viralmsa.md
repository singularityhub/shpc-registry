...
updated_at: "2024-02-03 02:29:09.223381"
latest: "1.1.41--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/viralmsa:1.1.41--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/viralmsa/1.1.41--hdfd78af_0
$ module help quay.io/biocontainers/viralmsa/1.1.41--hdfd78af_0
```
