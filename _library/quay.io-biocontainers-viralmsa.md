...
updated_at: "2024-03-10 03:04:12.509612"
latest: "1.1.44--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/viralmsa:1.1.44--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/viralmsa/1.1.44--hdfd78af_0
$ module help quay.io/biocontainers/viralmsa/1.1.44--hdfd78af_0
```
