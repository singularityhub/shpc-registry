...
updated_at: "2026-06-27 06:45:00.242184"
latest: "1.1.48--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/viralmsa:1.1.48--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/viralmsa/1.1.48--hdfd78af_0
$ module help quay.io/biocontainers/viralmsa/1.1.48--hdfd78af_0
```
