...
updated_at: "2024-02-10 02:47:05.421628"
latest: "1.1.43--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/viralmsa:1.1.43--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/viralmsa/1.1.43--hdfd78af_0
$ module help quay.io/biocontainers/viralmsa/1.1.43--hdfd78af_0
```
