...
updated_at: "2025-07-28 09:07:18.481427"
latest: "1.1.45--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/viralmsa:1.1.45--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/viralmsa/1.1.45--hdfd78af_0
$ module help quay.io/biocontainers/viralmsa/1.1.45--hdfd78af_0
```
