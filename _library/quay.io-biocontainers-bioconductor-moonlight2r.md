...
updated_at: "2025-01-10 02:59:25.490565"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-moonlight2r:1.4.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-moonlight2r/1.4.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-moonlight2r/1.4.0--r44hdfd78af_0
```
