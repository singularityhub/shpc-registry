...
updated_at: "2024-01-03 02:47:20.305013"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-moonlight2r:1.0.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-moonlight2r/1.0.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-moonlight2r/1.0.0--r43hdfd78af_0
```
