...
updated_at: "2026-03-18 04:49:17.051938"
...
```bash
$ shpc install quay.io/biocontainers/ms2deepscore:2.7.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ms2deepscore/2.7.2--pyhdfd78af_0
$ module help quay.io/biocontainers/ms2deepscore/2.7.2--pyhdfd78af_0
```
