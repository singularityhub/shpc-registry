...
updated_at: "2025-02-07 02:57:14.603818"
...
```bash
$ shpc install quay.io/biocontainers/ms2deepscore:2.5.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ms2deepscore/2.5.0--pyhdfd78af_0
$ module help quay.io/biocontainers/ms2deepscore/2.5.0--pyhdfd78af_0
```
