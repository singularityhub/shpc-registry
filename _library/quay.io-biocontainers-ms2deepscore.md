...
updated_at: "2023-07-04 03:20:14.238487"
...
```bash
$ shpc install quay.io/biocontainers/ms2deepscore:0.4.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ms2deepscore/0.4.0--pyhdfd78af_0
$ module help quay.io/biocontainers/ms2deepscore/0.4.0--pyhdfd78af_0
```
