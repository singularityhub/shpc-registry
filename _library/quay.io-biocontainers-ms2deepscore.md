...
updated_at: "2025-10-31 04:04:10.906823"
...
```bash
$ shpc install quay.io/biocontainers/ms2deepscore:2.5.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ms2deepscore/2.5.4--pyhdfd78af_0
$ module help quay.io/biocontainers/ms2deepscore/2.5.4--pyhdfd78af_0
```
