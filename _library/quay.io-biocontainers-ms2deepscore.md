...
updated_at: "2025-04-09 03:19:50.107401"
...
```bash
$ shpc install quay.io/biocontainers/ms2deepscore:2.5.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ms2deepscore/2.5.1--pyhdfd78af_0
$ module help quay.io/biocontainers/ms2deepscore/2.5.1--pyhdfd78af_0
```
