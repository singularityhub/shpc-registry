---
layout: container
name:  "quay.io/biocontainers/ms2deepscore"
maintainer: "@vsoch"
...
updated_at: "2026-09-26 07:13:57.362325"
...
```bash
$ shpc install quay.io/biocontainers/ms2deepscore
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/ms2deepscore:2.9.0--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/ms2deepscore/2.9.0--pyhdfd78af_1
$ module help quay.io/biocontainers/ms2deepscore/2.9.0--pyhdfd78af_1
```
...
#### ms2deepscore-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### ms2deepscore-inspect-deffile:
