...
updated_at: "2025-12-09 04:12:55.728443"
...
```bash
$ shpc install quay.io/biocontainers/ms2deepscore:2.5.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ms2deepscore/2.5.5--pyhdfd78af_0
$ module help quay.io/biocontainers/ms2deepscore/2.5.5--pyhdfd78af_0
```
