...
updated_at: "2026-01-10 04:17:43.873832"
...
```bash
$ shpc install quay.io/biocontainers/ms2deepscore:2.6.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ms2deepscore/2.6.0--pyhdfd78af_0
$ module help quay.io/biocontainers/ms2deepscore/2.6.0--pyhdfd78af_0
```
