...
updated_at: "2025-05-27 11:14:12.227525"
...
```bash
$ shpc install quay.io/biocontainers/ms2deepscore:2.5.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ms2deepscore/2.5.2--pyhdfd78af_0
$ module help quay.io/biocontainers/ms2deepscore/2.5.2--pyhdfd78af_0
```
