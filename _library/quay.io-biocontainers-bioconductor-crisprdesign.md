...
updated_at: "2026-04-05 04:53:40.056681"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-crisprdesign:1.12.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-crisprdesign/1.12.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-crisprdesign/1.12.0--r45hdfd78af_0
```
