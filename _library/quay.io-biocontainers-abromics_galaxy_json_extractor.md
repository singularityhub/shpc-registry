...
updated_at: "2023-09-04 03:23:59.193702"
latest: "0.6--pyh7cba7a3_0"
...
```bash
$ shpc install quay.io/biocontainers/abromics_galaxy_json_extractor:0.6--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/abromics_galaxy_json_extractor/0.6--pyh7cba7a3_0
$ module help quay.io/biocontainers/abromics_galaxy_json_extractor/0.6--pyh7cba7a3_0
```
