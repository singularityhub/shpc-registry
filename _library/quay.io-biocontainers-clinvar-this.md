...
updated_at: "2024-09-12 17:20:05.464496"
...
```bash
$ shpc install quay.io/biocontainers/clinvar-this:0.17.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/clinvar-this/0.17.1--pyhdfd78af_0
$ module help quay.io/biocontainers/clinvar-this/0.17.1--pyhdfd78af_0
```
