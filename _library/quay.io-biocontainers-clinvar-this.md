...
updated_at: "2024-06-24 03:10:18.584082"
...
```bash
$ shpc install quay.io/biocontainers/clinvar-this:0.17.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/clinvar-this/0.17.0--pyhdfd78af_0
$ module help quay.io/biocontainers/clinvar-this/0.17.0--pyhdfd78af_0
```
