...
updated_at: "2026-06-16 08:04:45.379253"
...
```bash
$ shpc install quay.io/biocontainers/clinvar-this:0.18.5--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/clinvar-this/0.18.5--pyhdfd78af_1
$ module help quay.io/biocontainers/clinvar-this/0.18.5--pyhdfd78af_1
```
