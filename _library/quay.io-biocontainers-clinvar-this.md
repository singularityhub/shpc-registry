...
updated_at: "2024-12-19 03:33:04.848248"
...
```bash
$ shpc install quay.io/biocontainers/clinvar-this:0.18.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/clinvar-this/0.18.3--pyhdfd78af_0
$ module help quay.io/biocontainers/clinvar-this/0.18.3--pyhdfd78af_0
```
