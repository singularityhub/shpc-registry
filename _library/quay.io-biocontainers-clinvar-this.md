...
updated_at: "2024-09-24 03:38:14.834966"
...
```bash
$ shpc install quay.io/biocontainers/clinvar-this:0.18.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/clinvar-this/0.18.2--pyhdfd78af_0
$ module help quay.io/biocontainers/clinvar-this/0.18.2--pyhdfd78af_0
```
