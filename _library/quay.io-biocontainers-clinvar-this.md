...
updated_at: "2024-01-18 03:01:40.379080"
latest: "0.14.6--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/clinvar-this:0.14.6--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/clinvar-this/0.14.6--pyhdfd78af_0
$ module help quay.io/biocontainers/clinvar-this/0.14.6--pyhdfd78af_0
```
