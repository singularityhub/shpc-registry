...
updated_at: "2024-08-30 03:11:36.287599"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-openstats:1.14.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-openstats/1.14.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-openstats/1.14.0--r43hdfd78af_0
```
