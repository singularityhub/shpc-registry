...
updated_at: "2025-04-21 04:37:53.321574"
...
```bash
$ shpc install quay.io/biocontainers/magneto:1.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/magneto/1.3--pyhdfd78af_0
$ module help quay.io/biocontainers/magneto/1.3--pyhdfd78af_0
```
