...
updated_at: "2026-05-21 06:32:16.120350"
...
```bash
$ shpc install quay.io/biocontainers/magneto:1.5.2--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/magneto/1.5.2--pyhdfd78af_1
$ module help quay.io/biocontainers/magneto/1.5.2--pyhdfd78af_1
```
