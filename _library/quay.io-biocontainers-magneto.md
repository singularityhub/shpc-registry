...
updated_at: "2025-08-03 04:19:05.883226"
latest: "1.3--pyhdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/magneto:1.3--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/magneto/1.3--pyhdfd78af_1
$ module help quay.io/biocontainers/magneto/1.3--pyhdfd78af_1
```
