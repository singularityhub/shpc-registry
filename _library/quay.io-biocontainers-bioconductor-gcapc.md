...
updated_at: "2023-10-01 02:32:16.902361"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gcapc:1.24.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gcapc/1.24.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-gcapc/1.24.0--r43hdfd78af_0
```
