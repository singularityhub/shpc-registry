...
updated_at: "2024-09-21 03:21:47.083425"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gcapc:1.26.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gcapc/1.26.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-gcapc/1.26.0--r43hdfd78af_0
```
