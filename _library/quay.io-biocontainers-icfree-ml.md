...
updated_at: "2025-03-01 03:14:05.874684"
...
```bash
$ shpc install quay.io/biocontainers/icfree-ml:2.9.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/icfree-ml/2.9.0--pyhdfd78af_0
$ module help quay.io/biocontainers/icfree-ml/2.9.0--pyhdfd78af_0
```
