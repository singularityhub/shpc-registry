...
updated_at: "2025-01-08 03:26:21.264261"
...
```bash
$ shpc install quay.io/biocontainers/icfree-ml:2.7.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/icfree-ml/2.7.0--pyhdfd78af_0
$ module help quay.io/biocontainers/icfree-ml/2.7.0--pyhdfd78af_0
```
