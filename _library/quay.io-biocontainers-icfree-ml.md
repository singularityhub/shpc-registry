...
updated_at: "2025-01-28 03:23:38.762163"
...
```bash
$ shpc install quay.io/biocontainers/icfree-ml:2.8.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/icfree-ml/2.8.0--pyhdfd78af_0
$ module help quay.io/biocontainers/icfree-ml/2.8.0--pyhdfd78af_0
```
