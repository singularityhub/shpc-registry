---
layout: container
name:  "quay.io/biocontainers/igua"
maintainer: "@vsoch"
...
updated_at: "2025-10-11 03:13:08.628581"
...
singularity registry hpc automated addition for igua
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/igua
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/igua:0.1.0--py310hec43fc7_0
```
...
```bash
$ module load quay.io/biocontainers/igua/0.1.0--py310hec43fc7_0
$ module help quay.io/biocontainers/igua/0.1.0--py310hec43fc7_0
```
...
#### igua-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### igua-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/igua
$ podman run --it --rm --entrypoint /usr/local/bin/igua   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/igua   -v ${PWD} -w ${PWD} <container> -c " $@"
```
