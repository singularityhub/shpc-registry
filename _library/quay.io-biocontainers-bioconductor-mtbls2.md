...
updated_at: "2025-09-04 03:44:15.784895"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mtbls2:1.36.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mtbls2/1.36.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-mtbls2/1.36.0--r44hdfd78af_0
```
