...
updated_at: "2026-05-27 06:43:46.011647"
latest: "1.1.11--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/flexynesis:1.1.11--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/flexynesis/1.1.11--pyhdfd78af_0
$ module help quay.io/biocontainers/flexynesis/1.1.11--pyhdfd78af_0
```
