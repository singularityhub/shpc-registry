...
updated_at: "2026-03-02 04:34:49.796751"
...
```bash
$ shpc install quay.io/biocontainers/flexynesis:1.1.7--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/flexynesis/1.1.7--pyhdfd78af_0
$ module help quay.io/biocontainers/flexynesis/1.1.7--pyhdfd78af_0
```
