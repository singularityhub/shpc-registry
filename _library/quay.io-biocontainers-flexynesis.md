...
updated_at: "2025-05-08 05:47:17.273498"
...
```bash
$ shpc install quay.io/biocontainers/flexynesis:0.2.17--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/flexynesis/0.2.17--pyhdfd78af_0
$ module help quay.io/biocontainers/flexynesis/0.2.17--pyhdfd78af_0
```
