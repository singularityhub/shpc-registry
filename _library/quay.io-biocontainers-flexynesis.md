...
updated_at: "2026-04-29 05:40:23.603765"
...
```bash
$ shpc install quay.io/biocontainers/flexynesis:1.1.10--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/flexynesis/1.1.10--pyhdfd78af_0
$ module help quay.io/biocontainers/flexynesis/1.1.10--pyhdfd78af_0
```
