...
updated_at: "2025-09-22 03:10:58.474296"
...
```bash
$ shpc install quay.io/biocontainers/flexynesis:0.2.20--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/flexynesis/0.2.20--pyhdfd78af_0
$ module help quay.io/biocontainers/flexynesis/0.2.20--pyhdfd78af_0
```
