...
updated_at: "2025-05-27 03:38:30.861168"
...
```bash
$ shpc install quay.io/biocontainers/flexynesis:0.2.18--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/flexynesis/0.2.18--pyhdfd78af_0
$ module help quay.io/biocontainers/flexynesis/0.2.18--pyhdfd78af_0
```
