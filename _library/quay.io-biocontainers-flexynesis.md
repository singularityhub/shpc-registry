---
layout: container
name:  "quay.io/biocontainers/flexynesis"
maintainer: "@vsoch"
...
updated_at: "2026-06-30 06:55:09.183508"
latest: "1.1.14--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/flexynesis
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/flexynesis:1.1.14--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/flexynesis/1.1.14--pyhdfd78af_0
$ module help quay.io/biocontainers/flexynesis/1.1.14--pyhdfd78af_0
```
...
#### flexynesis-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### flexynesis-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/flexynesis
$ podman run --it --rm --entrypoint /usr/local/bin/flexynesis   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/flexynesis   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/flexynesis-cli
$ podman run --it --rm --entrypoint /usr/local/bin/flexynesis-cli   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/flexynesis-cli   -v ${PWD} -w ${PWD} <container> -c " $@"
```
