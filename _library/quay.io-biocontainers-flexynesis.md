...
updated_at: "2025-03-06 03:55:42.308859"
...
```bash
$ shpc install quay.io/biocontainers/flexynesis:0.2.16--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/flexynesis/0.2.16--pyhdfd78af_0
$ module help quay.io/biocontainers/flexynesis/0.2.16--pyhdfd78af_0
```
