...
updated_at: "2026-01-28 03:49:33.136447"
...
```bash
$ shpc install quay.io/biocontainers/flexynesis:1.1.6--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/flexynesis/1.1.6--pyhdfd78af_0
$ module help quay.io/biocontainers/flexynesis/1.1.6--pyhdfd78af_0
```
