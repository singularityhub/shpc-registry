...
updated_at: "2026-03-26 04:55:35.857651"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gars:1.30.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gars/1.30.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-gars/1.30.0--r45hdfd78af_0
```
