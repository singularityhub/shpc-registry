...
updated_at: "2024-03-03 02:36:31.955943"
latest: "1.4.1.0--hf48d1a7_0"
...
```bash
$ shpc install quay.io/biocontainers/poseidon-trident:1.4.1.0--hf48d1a7_0
```
...
```bash
$ module load quay.io/biocontainers/poseidon-trident/1.4.1.0--hf48d1a7_0
$ module help quay.io/biocontainers/poseidon-trident/1.4.1.0--hf48d1a7_0
```
