...
updated_at: "2024-10-17 03:03:34.377880"
latest: "1.5.4.0--hf48d1a7_0"
...
```bash
$ shpc install quay.io/biocontainers/poseidon-trident:1.5.4.0--hf48d1a7_0
```
...
```bash
$ module load quay.io/biocontainers/poseidon-trident/1.5.4.0--hf48d1a7_0
$ module help quay.io/biocontainers/poseidon-trident/1.5.4.0--hf48d1a7_0
```
