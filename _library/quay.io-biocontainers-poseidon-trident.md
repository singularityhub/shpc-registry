...
updated_at: "2024-07-03 02:50:14.088105"
latest: "1.5.0.1--hf48d1a7_0"
...
```bash
$ shpc install quay.io/biocontainers/poseidon-trident:1.5.0.1--hf48d1a7_0
```
...
```bash
$ module load quay.io/biocontainers/poseidon-trident/1.5.0.1--hf48d1a7_0
$ module help quay.io/biocontainers/poseidon-trident/1.5.0.1--hf48d1a7_0
```
