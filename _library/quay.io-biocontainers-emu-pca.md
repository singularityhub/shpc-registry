...
updated_at: "2026-05-28 15:21:06.700008"
...
```bash
$ shpc install quay.io/biocontainers/emu-pca:1.6.0--py312h6e8b409_0
```
...
```bash
$ module load quay.io/biocontainers/emu-pca/1.6.0--py312h6e8b409_0
$ module help quay.io/biocontainers/emu-pca/1.6.0--py312h6e8b409_0
```
