...
updated_at: "2026-01-06 04:30:54.886996"
latest: "1.5.0--py310h20b60a1_0"
...
```bash
$ shpc install quay.io/biocontainers/emu-pca:1.5.0--py310h20b60a1_0
```
...
```bash
$ module load quay.io/biocontainers/emu-pca/1.5.0--py310h20b60a1_0
$ module help quay.io/biocontainers/emu-pca/1.5.0--py310h20b60a1_0
```
