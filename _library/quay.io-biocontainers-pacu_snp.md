---
layout: container
name:  "quay.io/biocontainers/pacu_snp"
maintainer: "@vsoch"
...
updated_at: "2026-01-22 04:17:34.705192"
latest: "0.0.7--pyhdfd78af_0"
container_url: "https://biocontainers.pro/tools/pacu_snp"
aliases:
 - "PACU"
 - "PACU_map"
 - "count_recombinations_per_gene.py"
 - "extract_gubbins_clade.py"
 - "figtree"
 - "generate_files_for_clade_analysis.py"
...
```bash
$ shpc install quay.io/biocontainers/pacu_snp
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/pacu_snp:0.0.7--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pacu_snp/0.0.7--pyhdfd78af_0
$ module help quay.io/biocontainers/pacu_snp/0.0.7--pyhdfd78af_0
```
...
#### pacu_snp-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### pacu_snp-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/PACU
$ podman run --it --rm --entrypoint /usr/local/bin/PACU   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/PACU   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/PACU_map
$ podman run --it --rm --entrypoint /usr/local/bin/PACU_map   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/PACU_map   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/count_recombinations_per_gene.py
$ podman run --it --rm --entrypoint /usr/local/bin/count_recombinations_per_gene.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/count_recombinations_per_gene.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/generate_files_for_clade_analysis.py
$ podman run --it --rm --entrypoint /usr/local/bin/generate_files_for_clade_analysis.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/generate_files_for_clade_analysis.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/plot_gubbins.R
$ podman run --it --rm --entrypoint /usr/local/bin/plot_gubbins.R   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/plot_gubbins.R   -v ${PWD} -w ${PWD} <container> -c " $@"
```
