...
updated_at: "2024-12-18 02:59:23.571908"
...
```bash
$ shpc install quay.io/biocontainers/pacu_snp:0.0.6--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pacu_snp/0.0.6--pyhdfd78af_0
$ module help quay.io/biocontainers/pacu_snp/0.0.6--pyhdfd78af_0
```
