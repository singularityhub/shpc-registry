...
updated_at: "2024-04-25 02:59:07.683915"
...
```bash
$ shpc install quay.io/biocontainers/biobb_pdb_tools:4.1.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_pdb_tools/4.1.1--pyhdfd78af_0
$ module help quay.io/biocontainers/biobb_pdb_tools/4.1.1--pyhdfd78af_0
```
