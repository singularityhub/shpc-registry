...
updated_at: "2024-11-21 03:41:01.557817"
...
```bash
$ shpc install quay.io/biocontainers/biobb_pdb_tools:4.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_pdb_tools/4.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/biobb_pdb_tools/4.2.0--pyhdfd78af_0
```
