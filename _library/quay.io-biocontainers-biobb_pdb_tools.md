...
updated_at: "2023-12-31 02:51:22.028957"
...
```bash
$ shpc install quay.io/biocontainers/biobb_pdb_tools:4.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_pdb_tools/4.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/biobb_pdb_tools/4.1.0--pyhdfd78af_0
```
