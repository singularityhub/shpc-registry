...
updated_at: "2025-05-21 03:18:16.474651"
...
```bash
$ shpc install quay.io/biocontainers/biobb_pdb_tools:5.0.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_pdb_tools/5.0.1--pyhdfd78af_0
$ module help quay.io/biocontainers/biobb_pdb_tools/5.0.1--pyhdfd78af_0
```
