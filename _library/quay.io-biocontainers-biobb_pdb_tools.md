...
updated_at: "2025-07-26 04:15:57.782386"
...
```bash
$ shpc install quay.io/biocontainers/biobb_pdb_tools:5.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_pdb_tools/5.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/biobb_pdb_tools/5.1.0--pyhdfd78af_0
```
