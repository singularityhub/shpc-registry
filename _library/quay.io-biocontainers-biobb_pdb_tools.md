...
updated_at: "2025-03-26 03:22:55.139682"
...
```bash
$ shpc install quay.io/biocontainers/biobb_pdb_tools:5.0.0--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/biobb_pdb_tools/5.0.0--pyhdfd78af_1
$ module help quay.io/biocontainers/biobb_pdb_tools/5.0.0--pyhdfd78af_1
```
...
#### biobb_pdb_tools-inspect-runscript:
