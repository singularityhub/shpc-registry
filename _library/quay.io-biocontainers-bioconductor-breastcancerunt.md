...
updated_at: "2026-03-30 06:07:25.030998"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-breastcancerunt:1.48.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-breastcancerunt/1.48.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-breastcancerunt/1.48.0--r45hdfd78af_0
```
