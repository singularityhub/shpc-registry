...
updated_at: "2022-10-29 05:30:22.940927"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-breastcancerunt:1.32.0--r41hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-breastcancerunt/1.32.0--r41hdfd78af_1
$ module help quay.io/biocontainers/bioconductor-breastcancerunt/1.32.0--r41hdfd78af_1
```
