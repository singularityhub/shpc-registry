...
updated_at: "2023-12-02 02:53:54.508545"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-breastcancerunt:1.38.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-breastcancerunt/1.38.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-breastcancerunt/1.38.0--r43hdfd78af_0
```
