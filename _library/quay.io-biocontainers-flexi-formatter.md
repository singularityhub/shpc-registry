---
layout: container
name:  "quay.io/biocontainers/flexi-formatter"
maintainer: "@vsoch"
...
updated_at: "2024-09-11 03:14:43.654296"
...
```bash
$ shpc install quay.io/biocontainers/flexi-formatter
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/flexi-formatter:0.0.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/flexi-formatter/0.0.1--pyhdfd78af_0
$ module help quay.io/biocontainers/flexi-formatter/0.0.1--pyhdfd78af_0
```
...
#### flexi-formatter-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### flexi-formatter-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/flexi_formatter
$ podman run --it --rm --entrypoint /usr/local/bin/flexi_formatter   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/flexi_formatter   -v ${PWD} -w ${PWD} <container> -c " $@"
```
