...
updated_at: "2022-11-07 00:44:33.634994"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-deeppincs:1.2.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-deeppincs/1.2.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-deeppincs/1.2.0--r41hdfd78af_0
```
