...
updated_at: "2026-04-04 04:37:35.798177"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-deeppincs:1.18.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-deeppincs/1.18.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-deeppincs/1.18.0--r45hdfd78af_0
```
