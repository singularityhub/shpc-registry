...
updated_at: "2026-06-23 06:55:21.744418"
latest: "4.3--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/hmftools-amber:4.3--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hmftools-amber/4.3--hdfd78af_0
$ module help quay.io/biocontainers/hmftools-amber/4.3--hdfd78af_0
```
