...
updated_at: "2024-12-07 01:52:15.319635"
...
```bash
$ shpc install quay.io/biocontainers/hmftools-amber:4.1_beta--hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/hmftools-amber/4.1_beta--hdfd78af_1
$ module help quay.io/biocontainers/hmftools-amber/4.1_beta--hdfd78af_1
```
