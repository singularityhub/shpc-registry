...
updated_at: "2026-08-21 15:43:51.443423"
latest: "0.3.0.5--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/mirmachine:0.3.0.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mirmachine/0.3.0.5--pyhdfd78af_0
$ module help quay.io/biocontainers/mirmachine/0.3.0.5--pyhdfd78af_0
```
