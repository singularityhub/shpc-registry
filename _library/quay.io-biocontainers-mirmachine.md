...
updated_at: "2026-04-02 04:46:52.377523"
latest: "0.3.0.3--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/mirmachine:0.3.0.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mirmachine/0.3.0.3--pyhdfd78af_0
$ module help quay.io/biocontainers/mirmachine/0.3.0.3--pyhdfd78af_0
```
