...
updated_at: "2026-07-02 06:50:17.648753"
latest: "0.3.0.4--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/mirmachine:0.3.0.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mirmachine/0.3.0.4--pyhdfd78af_0
$ module help quay.io/biocontainers/mirmachine/0.3.0.4--pyhdfd78af_0
```
