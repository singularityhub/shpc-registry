...
updated_at: "2025-04-06 03:53:02.151235"
...
```bash
$ shpc install quay.io/biocontainers/samrefiner:1.4.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/samrefiner/1.4.1--pyhdfd78af_0
$ module help quay.io/biocontainers/samrefiner/1.4.1--pyhdfd78af_0
```
