...
updated_at: "2026-03-15 05:06:12.135824"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rprotobuflib:2.22.0--r45ha27e39d_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rprotobuflib/2.22.0--r45ha27e39d_0
$ module help quay.io/biocontainers/bioconductor-rprotobuflib/2.22.0--r45ha27e39d_0
```
