...
updated_at: "2023-09-16 23:54:32.368569"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rprotobuflib:2.12.0--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rprotobuflib/2.12.0--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-rprotobuflib/2.12.0--r43hf17093f_0
```
