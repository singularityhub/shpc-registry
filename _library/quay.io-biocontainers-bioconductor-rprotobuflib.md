...
updated_at: "2023-06-29 03:37:59.091985"
latest: "2.10.0--r42hf17093f_2"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rprotobuflib:2.10.0--r42hf17093f_2
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rprotobuflib/2.10.0--r42hf17093f_2
$ module help quay.io/biocontainers/bioconductor-rprotobuflib/2.10.0--r42hf17093f_2
```
