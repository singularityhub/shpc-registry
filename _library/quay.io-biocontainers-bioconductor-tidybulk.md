...
updated_at: "2023-12-17 02:58:44.956451"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-tidybulk:1.12.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-tidybulk/1.12.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-tidybulk/1.12.0--r43hdfd78af_0
```
