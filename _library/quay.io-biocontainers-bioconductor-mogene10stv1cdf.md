...
updated_at: "2024-12-03 04:25:33.770225"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mogene10stv1cdf:2.18.0--r43hdfd78af_12
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mogene10stv1cdf/2.18.0--r43hdfd78af_12
$ module help quay.io/biocontainers/bioconductor-mogene10stv1cdf/2.18.0--r43hdfd78af_12
```
