...
updated_at: "2026-03-30 06:14:01.809969"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-affixcan:1.28.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-affixcan/1.28.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-affixcan/1.28.0--r45hdfd78af_0
```
