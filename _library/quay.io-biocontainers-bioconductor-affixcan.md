...
updated_at: "2022-10-29 18:04:44.430462"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-affixcan:1.8.0--r40hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-affixcan/1.8.0--r40hdfd78af_1
$ module help quay.io/biocontainers/bioconductor-affixcan/1.8.0--r40hdfd78af_1
```
