...
updated_at: "2025-03-31 03:38:21.760317"
...
```bash
$ shpc install quay.io/biocontainers/submission-excel2xml:3.3--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/submission-excel2xml/3.3--hdfd78af_0
$ module help quay.io/biocontainers/submission-excel2xml/3.3--hdfd78af_0
```
