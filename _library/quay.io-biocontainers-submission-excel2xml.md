...
updated_at: "2025-08-03 04:43:27.301071"
latest: "3.5--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/submission-excel2xml:3.5--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/submission-excel2xml/3.5--hdfd78af_0
$ module help quay.io/biocontainers/submission-excel2xml/3.5--hdfd78af_0
```
