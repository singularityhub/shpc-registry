...
updated_at: "2024-03-06 02:45:49.303863"
...
```bash
$ shpc install quay.io/biocontainers/submission-excel2xml:2.5--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/submission-excel2xml/2.5--hdfd78af_0
$ module help quay.io/biocontainers/submission-excel2xml/2.5--hdfd78af_0
```
