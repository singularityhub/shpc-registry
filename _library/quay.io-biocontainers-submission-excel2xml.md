...
updated_at: "2023-12-17 02:44:30.973606"
latest: "2.0.0--hf0b54c8_0"
...
```bash
$ shpc install quay.io/biocontainers/submission-excel2xml:2.0.0--hf0b54c8_0
```
...
```bash
$ module load quay.io/biocontainers/submission-excel2xml/2.0.0--hf0b54c8_0
$ module help quay.io/biocontainers/submission-excel2xml/2.0.0--hf0b54c8_0
```
