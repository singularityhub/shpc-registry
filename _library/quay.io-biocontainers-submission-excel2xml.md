...
updated_at: "2025-12-18 04:16:57.358844"
...
```bash
$ shpc install quay.io/biocontainers/submission-excel2xml:3.6.2--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/submission-excel2xml/3.6.2--hdfd78af_0
$ module help quay.io/biocontainers/submission-excel2xml/3.6.2--hdfd78af_0
```
