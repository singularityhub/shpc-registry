...
updated_at: "2025-02-17 02:56:40.879950"
latest: "3.2--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/submission-excel2xml:3.2--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/submission-excel2xml/3.2--hdfd78af_0
$ module help quay.io/biocontainers/submission-excel2xml/3.2--hdfd78af_0
```
