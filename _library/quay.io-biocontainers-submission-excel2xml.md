...
updated_at: "2025-06-18 03:37:04.551375"
latest: "3.4--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/submission-excel2xml:3.4--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/submission-excel2xml/3.4--hdfd78af_0
$ module help quay.io/biocontainers/submission-excel2xml/3.4--hdfd78af_0
```
