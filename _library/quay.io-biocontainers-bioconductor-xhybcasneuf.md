...
updated_at: "2022-10-27 00:40:20.157519"
...
aliases:
 ...
 - ".bioconductor-xhybcasneuf-post-link.sh"
 - ".bioconductor-xhybcasneuf-pre-unlink.sh"
versions:
 - "1.32.0--r41hdfd78af_1"
description: "shpc-registry automated BioContainers addition for bioconductor-xhybcasneuf"
config: {"url": "https://biocontainers.pro/tools/bioconductor-xhybcasneuf", "maintainer": "@vsoch", "description": "shpc-registry automated BioContainers addition for bioconductor-xhybcasneuf", "latest": {"1.32.0--r41hdfd78af_1": "sha256:77ebdc528a4e8df041d1b68eef0a084fe7f8b32a1f7ed253da2e1a0aca29c65a"}, "tags": {"1.32.0--r41hdfd78af_1": "sha256:77ebdc528a4e8df041d1b68eef0a084fe7f8b32a1f7ed253da2e1a0aca29c65a"}, "docker": "quay.io/biocontainers/bioconductor-xhybcasneuf", "aliases": {".bioconductor-ath1121501cdf-post-link.sh": "/usr/local/bin/.bioconductor-ath1121501cdf-post-link.sh", ".bioconductor-ath1121501cdf-pre-unlink.sh": "/usr/local/bin/.bioconductor-ath1121501cdf-pre-unlink.sh", ".bioconductor-tinesath1cdf-post-link.sh": "/usr/local/bin/.bioconductor-tinesath1cdf-post-link.sh", ".bioconductor-tinesath1cdf-pre-unlink.sh": "/usr/local/bin/.bioconductor-tinesath1cdf-pre-unlink.sh", ".bioconductor-xhybcasneuf-post-link.sh": "/usr/local/bin/.bioconductor-xhybcasneuf-post-link.sh", ".bioconductor-xhybcasneuf-pre-unlink.sh": "/usr/local/bin/.bioconductor-xhybcasneuf-pre-unlink.sh"}}
---
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-xhybcasneuf:1.32.0--r41hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-xhybcasneuf/1.32.0--r41hdfd78af_1
$ module help quay.io/biocontainers/bioconductor-xhybcasneuf/1.32.0--r41hdfd78af_1
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-xhybcasneuf-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-xhybcasneuf-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-xhybcasneuf-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-xhybcasneuf-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-xhybcasneuf-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-xhybcasneuf-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
