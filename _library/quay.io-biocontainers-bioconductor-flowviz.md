...
updated_at: "2026-03-19 05:06:13.425811"
latest: "1.74.0--r45hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-flowviz:1.74.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-flowviz/1.74.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-flowviz/1.74.0--r45hdfd78af_0
```
