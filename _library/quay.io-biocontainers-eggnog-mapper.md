...
updated_at: "2025-07-31 03:59:49.616032"
latest: "2.1.13--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/eggnog-mapper:2.1.13--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/eggnog-mapper/2.1.13--pyhdfd78af_0
$ module help quay.io/biocontainers/eggnog-mapper/2.1.13--pyhdfd78af_0
```
