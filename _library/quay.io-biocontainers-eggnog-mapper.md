...
updated_at: "2025-02-13 03:18:59.390446"
latest: "2.1.12--pyhdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/eggnog-mapper:2.1.12--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/eggnog-mapper/2.1.12--pyhdfd78af_1
$ module help quay.io/biocontainers/eggnog-mapper/2.1.12--pyhdfd78af_1
```
