...
updated_at: "2026-08-13 05:08:25.209691"
latest: "2.1.15--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/eggnog-mapper:2.1.15--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/eggnog-mapper/2.1.15--pyhdfd78af_0
$ module help quay.io/biocontainers/eggnog-mapper/2.1.15--pyhdfd78af_0
```
