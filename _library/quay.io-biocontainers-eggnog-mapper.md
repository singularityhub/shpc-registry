...
updated_at: "2025-05-01 07:01:09.497393"
latest: "2.1.12--pyhdfd78af_2"
...
```bash
$ shpc install quay.io/biocontainers/eggnog-mapper:2.1.12--pyhdfd78af_2
```
...
```bash
$ module load quay.io/biocontainers/eggnog-mapper/2.1.12--pyhdfd78af_2
$ module help quay.io/biocontainers/eggnog-mapper/2.1.12--pyhdfd78af_2
```
