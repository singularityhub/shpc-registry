...
updated_at: "2026-03-05 04:31:34.467350"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rgraph2js:1.38.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rgraph2js/1.38.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rgraph2js/1.38.0--r45hdfd78af_0
```
