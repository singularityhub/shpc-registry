---
layout: container
name:  "quay.io/biocontainers/ilesta"
maintainer: "@vsoch"
...
updated_at: "2026-03-03 05:04:30.050144"
...
singularity registry hpc automated addition for ilesta
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/ilesta
```
...
#### ilesta-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### ilesta-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/Ilesta
$ podman run --it --rm --entrypoint /usr/local/bin/Ilesta   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/Ilesta   -v ${PWD} -w ${PWD} <container> -c " $@"
```
