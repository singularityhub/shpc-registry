...
updated_at: "2025-11-21 15:45:11.516322"
...
```bash
$ shpc install quay.io/biocontainers/msmetaenhancer:0.4.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/msmetaenhancer/0.4.1--pyhdfd78af_0
$ module help quay.io/biocontainers/msmetaenhancer/0.4.1--pyhdfd78af_0
```
