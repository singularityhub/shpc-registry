...
updated_at: "2026-05-29 06:24:38.428601"
...
```bash
$ shpc install quay.io/biocontainers/msmetaenhancer:0.5.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/msmetaenhancer/0.5.1--pyhdfd78af_0
$ module help quay.io/biocontainers/msmetaenhancer/0.5.1--pyhdfd78af_0
```
