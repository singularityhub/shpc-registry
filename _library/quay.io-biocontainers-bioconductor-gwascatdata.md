...
updated_at: "2026-03-20 00:14:47.342810"
latest: "0.99.6--r45hdfd78af_7"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gwascatdata:0.99.6--r45hdfd78af_7
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gwascatdata/0.99.6--r45hdfd78af_7
$ module help quay.io/biocontainers/bioconductor-gwascatdata/0.99.6--r45hdfd78af_7
```
