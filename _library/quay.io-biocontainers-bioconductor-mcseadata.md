...
updated_at: "2026-04-02 05:02:41.195105"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mcseadata:1.30.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mcseadata/1.30.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-mcseadata/1.30.0--r45hdfd78af_0
```
