...
updated_at: "2022-10-29 08:21:40.975931"
latest: "6.8.0--r36_1"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mixomics:6.8.0--r36_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mixomics/6.8.0--r36_1
$ module help quay.io/biocontainers/bioconductor-mixomics/6.8.0--r36_1
```
