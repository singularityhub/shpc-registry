...
updated_at: "2024-04-21 02:40:19.330850"
latest: "6.26.0--r43hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mixomics:6.26.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mixomics/6.26.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-mixomics/6.26.0--r43hdfd78af_0
```
