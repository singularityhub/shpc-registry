...
updated_at: "2023-12-26 02:49:46.088374"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mixomics:6.24.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mixomics/6.24.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-mixomics/6.24.0--r43hdfd78af_0
```
