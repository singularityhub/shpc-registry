...
updated_at: "2025-01-21 03:30:17.079363"
...
```bash
$ shpc install quay.io/biocontainers/flexiformatter:1.0.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/flexiformatter/1.0.2--pyhdfd78af_0
$ module help quay.io/biocontainers/flexiformatter/1.0.2--pyhdfd78af_0
```
