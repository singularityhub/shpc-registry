...
updated_at: "2025-01-19 03:27:37.190456"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-org.sc.sgd.db:3.20.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-org.sc.sgd.db/3.20.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-org.sc.sgd.db/3.20.0--r44hdfd78af_0
```
