...
updated_at: "2025-05-27 12:29:20.360724"
latest: "3.9.3--py311h93dcfea_0"
...
```bash
$ shpc install quay.io/biocontainers/tiddit:3.9.3--py311h93dcfea_0
```
...
```bash
$ module load quay.io/biocontainers/tiddit/3.9.3--py311h93dcfea_0
$ module help quay.io/biocontainers/tiddit/3.9.3--py311h93dcfea_0
```
