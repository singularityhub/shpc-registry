...
updated_at: "2025-04-05 03:36:29.932094"
latest: "3.9.2--py39hff726c5_0"
...
```bash
$ shpc install quay.io/biocontainers/tiddit:3.9.2--py39hff726c5_0
```
...
```bash
$ module load quay.io/biocontainers/tiddit/3.9.2--py39hff726c5_0
$ module help quay.io/biocontainers/tiddit/3.9.2--py39hff726c5_0
```
