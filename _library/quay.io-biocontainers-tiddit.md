...
updated_at: "2025-01-16 03:18:34.777755"
latest: "3.9.0--py311h93dcfea_0"
...
```bash
$ shpc install quay.io/biocontainers/tiddit:3.9.0--py311h93dcfea_0
```
...
```bash
$ module load quay.io/biocontainers/tiddit/3.9.0--py311h93dcfea_0
$ module help quay.io/biocontainers/tiddit/3.9.0--py311h93dcfea_0
```
