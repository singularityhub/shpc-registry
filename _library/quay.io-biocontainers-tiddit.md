...
updated_at: "2026-04-05 05:26:55.587999"
latest: "3.9.5--py313h5a5ac1a_0"
...
```bash
$ shpc install quay.io/biocontainers/tiddit:3.9.5--py313h5a5ac1a_0
```
...
```bash
$ module load quay.io/biocontainers/tiddit/3.9.5--py313h5a5ac1a_0
$ module help quay.io/biocontainers/tiddit/3.9.5--py313h5a5ac1a_0
```
