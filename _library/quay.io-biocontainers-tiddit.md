...
updated_at: "2026-08-27 23:47:33.671699"
latest: "3.9.7--py312hfcd9dac_0"
...
```bash
$ shpc install quay.io/biocontainers/tiddit:3.9.7--py312hfcd9dac_0
```
...
```bash
$ module load quay.io/biocontainers/tiddit/3.9.7--py312hfcd9dac_0
$ module help quay.io/biocontainers/tiddit/3.9.7--py312hfcd9dac_0
```
