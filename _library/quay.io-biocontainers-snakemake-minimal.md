...
updated_at: "2025-08-07 09:41:25.883852"
latest: "9.9.0--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/snakemake-minimal:9.9.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake-minimal/9.9.0--pyhdfd78af_0
$ module help quay.io/biocontainers/snakemake-minimal/9.9.0--pyhdfd78af_0
```
