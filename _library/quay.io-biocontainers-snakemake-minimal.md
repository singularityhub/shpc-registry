...
updated_at: "2025-12-16 04:04:50.751171"
latest: "9.14.1--pyhdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/snakemake-minimal:9.14.1--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/snakemake-minimal/9.14.1--pyhdfd78af_1
$ module help quay.io/biocontainers/snakemake-minimal/9.14.1--pyhdfd78af_1
```
