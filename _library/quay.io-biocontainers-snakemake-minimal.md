...
updated_at: "2025-07-31 03:59:15.310335"
...
```bash
$ shpc install quay.io/biocontainers/snakemake-minimal:9.7.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake-minimal/9.7.1--pyhdfd78af_0
$ module help quay.io/biocontainers/snakemake-minimal/9.7.1--pyhdfd78af_0
```
