...
updated_at: "2025-05-14 03:28:09.049970"
...
```bash
$ shpc install quay.io/biocontainers/snakemake-minimal:9.3.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake-minimal/9.3.3--pyhdfd78af_0
$ module help quay.io/biocontainers/snakemake-minimal/9.3.3--pyhdfd78af_0
```
