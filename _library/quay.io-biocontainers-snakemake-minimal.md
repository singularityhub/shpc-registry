...
updated_at: "2025-11-08 03:42:27.673481"
latest: "9.13.5--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/snakemake-minimal:9.13.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake-minimal/9.13.5--pyhdfd78af_0
$ module help quay.io/biocontainers/snakemake-minimal/9.13.5--pyhdfd78af_0
```
