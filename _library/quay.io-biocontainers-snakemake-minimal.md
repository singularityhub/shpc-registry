...
updated_at: "2024-10-29 03:43:18.884154"
latest: "8.20.5--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/snakemake-minimal:8.20.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake-minimal/8.20.5--pyhdfd78af_0
$ module help quay.io/biocontainers/snakemake-minimal/8.20.5--pyhdfd78af_0
```
