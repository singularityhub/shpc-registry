...
updated_at: "2025-10-20 03:28:45.024107"
latest: "9.12.0--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/snakemake-minimal:9.12.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake-minimal/9.12.0--pyhdfd78af_0
$ module help quay.io/biocontainers/snakemake-minimal/9.12.0--pyhdfd78af_0
```
