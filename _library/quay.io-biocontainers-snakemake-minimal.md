...
updated_at: "2025-06-13 03:37:07.580795"
latest: "9.5.1--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/snakemake-minimal:9.5.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake-minimal/9.5.1--pyhdfd78af_0
$ module help quay.io/biocontainers/snakemake-minimal/9.5.1--pyhdfd78af_0
```
