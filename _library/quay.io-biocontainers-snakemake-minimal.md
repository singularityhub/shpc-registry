...
updated_at: "2025-02-20 03:13:35.037231"
latest: "8.27.1--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/snakemake-minimal:8.27.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake-minimal/8.27.1--pyhdfd78af_0
$ module help quay.io/biocontainers/snakemake-minimal/8.27.1--pyhdfd78af_0
```
