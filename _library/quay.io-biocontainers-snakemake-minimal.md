...
updated_at: "2026-01-14 04:29:13.960334"
latest: "9.14.5--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/snakemake-minimal:9.14.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake-minimal/9.14.5--pyhdfd78af_0
$ module help quay.io/biocontainers/snakemake-minimal/9.14.5--pyhdfd78af_0
```
