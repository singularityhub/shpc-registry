...
updated_at: "2026-02-07 04:48:09.718864"
...
```bash
$ shpc install quay.io/biocontainers/snakemake-minimal:9.16.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake-minimal/9.16.3--pyhdfd78af_0
$ module help quay.io/biocontainers/snakemake-minimal/9.16.3--pyhdfd78af_0
```
