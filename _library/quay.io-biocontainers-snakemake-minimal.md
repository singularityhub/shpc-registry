...
updated_at: "2025-02-02 03:10:03.815860"
latest: "8.26.0--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/snakemake-minimal:8.26.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake-minimal/8.26.0--pyhdfd78af_0
$ module help quay.io/biocontainers/snakemake-minimal/8.26.0--pyhdfd78af_0
```
