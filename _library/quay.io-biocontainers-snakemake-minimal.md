...
updated_at: "2024-11-23 03:36:34.370898"
latest: "8.25.2--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/snakemake-minimal:8.25.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake-minimal/8.25.2--pyhdfd78af_0
$ module help quay.io/biocontainers/snakemake-minimal/8.25.2--pyhdfd78af_0
```
