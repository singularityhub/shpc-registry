...
updated_at: "2025-03-15 03:20:48.925648"
latest: "8.29.2--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/snakemake-minimal:8.29.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake-minimal/8.29.2--pyhdfd78af_0
$ module help quay.io/biocontainers/snakemake-minimal/8.29.2--pyhdfd78af_0
```
