...
updated_at: "2024-05-28 02:43:49.361903"
latest: "8.11.3--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/snakemake-minimal:8.11.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake-minimal/8.11.3--pyhdfd78af_0
$ module help quay.io/biocontainers/snakemake-minimal/8.11.3--pyhdfd78af_0
```
