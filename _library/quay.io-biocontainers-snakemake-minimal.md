...
updated_at: "2025-09-25 07:55:17.429578"
latest: "9.10.1--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/snakemake-minimal:9.10.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake-minimal/9.10.1--pyhdfd78af_0
$ module help quay.io/biocontainers/snakemake-minimal/9.10.1--pyhdfd78af_0
```
