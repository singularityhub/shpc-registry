...
updated_at: "2024-12-19 03:40:52.910772"
latest: "8.25.5--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/snakemake-minimal:8.25.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake-minimal/8.25.5--pyhdfd78af_0
$ module help quay.io/biocontainers/snakemake-minimal/8.25.5--pyhdfd78af_0
```
