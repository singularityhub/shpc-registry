---
layout: container
name:  "quay.io/biocontainers/pycoverm"
maintainer: "@vsoch"
...
updated_at: "2025-10-02 03:29:20.240929"
...
singularity registry hpc automated addition for pycoverm
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/pycoverm
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/pycoverm:0.6.2--py310h34483ff_0
```
...
```bash
$ module load quay.io/biocontainers/pycoverm/0.6.2--py310h34483ff_0
$ module help quay.io/biocontainers/pycoverm/0.6.2--py310h34483ff_0
```
...
#### pycoverm-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### pycoverm-inspect-deffile:
