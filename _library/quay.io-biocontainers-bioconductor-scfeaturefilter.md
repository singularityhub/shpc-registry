...
updated_at: "2023-10-22 03:16:47.267422"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-scfeaturefilter:1.20.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-scfeaturefilter/1.20.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-scfeaturefilter/1.20.0--r43hdfd78af_0
```
