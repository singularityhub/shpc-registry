...
updated_at: "2025-11-15 03:49:38.188503"
latest: "1.3.9.6--h3e6c209_8"
...
```bash
$ shpc install quay.io/biocontainers/moabs:1.3.9.6--h3e6c209_8
```
...
```bash
$ module load quay.io/biocontainers/moabs/1.3.9.6--h3e6c209_8
$ module help quay.io/biocontainers/moabs/1.3.9.6--h3e6c209_8
```
