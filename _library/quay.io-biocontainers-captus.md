...
updated_at: "2025-11-30 04:28:12.217050"
latest: "1.6.1--pyh05cac1d_0"
...
```bash
$ shpc install quay.io/biocontainers/captus:1.6.1--pyh05cac1d_0
```
...
```bash
$ module load quay.io/biocontainers/captus/1.6.1--pyh05cac1d_0
$ module help quay.io/biocontainers/captus/1.6.1--pyh05cac1d_0
```
