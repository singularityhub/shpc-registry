...
updated_at: "2023-10-24 03:15:00.482684"
latest: "0.9.97--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/captus:0.9.97--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/captus/0.9.97--pyhdfd78af_0
$ module help quay.io/biocontainers/captus/0.9.97--pyhdfd78af_0
```
