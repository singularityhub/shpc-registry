...
updated_at: "2025-04-24 03:56:27.966997"
...
```bash
$ shpc install quay.io/biocontainers/captus:1.3.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/captus/1.3.2--pyhdfd78af_0
$ module help quay.io/biocontainers/captus/1.3.2--pyhdfd78af_0
```
