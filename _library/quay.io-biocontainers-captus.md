...
updated_at: "2025-09-17 03:22:00.984195"
latest: "1.5.4--pyh05cac1d_0"
...
```bash
$ shpc install quay.io/biocontainers/captus:1.5.4--pyh05cac1d_0
```
...
```bash
$ module load quay.io/biocontainers/captus/1.5.4--pyh05cac1d_0
$ module help quay.io/biocontainers/captus/1.5.4--pyh05cac1d_0
```
