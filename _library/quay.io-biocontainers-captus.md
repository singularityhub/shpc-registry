...
updated_at: "2025-08-01 11:00:16.226840"
latest: "1.5.1--pyh05cac1d_0"
...
```bash
$ shpc install quay.io/biocontainers/captus:1.5.1--pyh05cac1d_0
```
...
```bash
$ module load quay.io/biocontainers/captus/1.5.1--pyh05cac1d_0
$ module help quay.io/biocontainers/captus/1.5.1--pyh05cac1d_0
```
