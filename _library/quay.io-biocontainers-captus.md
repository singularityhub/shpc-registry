...
updated_at: "2025-07-26 04:10:01.903935"
latest: "1.4.8--pyh05cac1d_0"
...
```bash
$ shpc install quay.io/biocontainers/captus:1.4.8--pyh05cac1d_0
```
...
```bash
$ module load quay.io/biocontainers/captus/1.4.8--pyh05cac1d_0
$ module help quay.io/biocontainers/captus/1.4.8--pyh05cac1d_0
```
