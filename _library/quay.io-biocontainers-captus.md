...
updated_at: "2024-12-23 03:21:18.383896"
...
```bash
$ shpc install quay.io/biocontainers/captus:1.0.1--pyhdfd78af_2
```
...
```bash
$ module load quay.io/biocontainers/captus/1.0.1--pyhdfd78af_2
$ module help quay.io/biocontainers/captus/1.0.1--pyhdfd78af_2
```
