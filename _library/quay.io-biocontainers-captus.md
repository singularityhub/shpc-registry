...
updated_at: "2025-10-10 03:51:38.085784"
latest: "1.5.9--pyh05cac1d_0"
...
```bash
$ shpc install quay.io/biocontainers/captus:1.5.9--pyh05cac1d_0
```
...
```bash
$ module load quay.io/biocontainers/captus/1.5.9--pyh05cac1d_0
$ module help quay.io/biocontainers/captus/1.5.9--pyh05cac1d_0
```
