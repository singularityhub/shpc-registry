...
updated_at: "2026-03-28 17:17:03.329667"
latest: "1.6.5--pyh05cac1d_0"
...
```bash
$ shpc install quay.io/biocontainers/captus:1.6.5--pyh05cac1d_0
```
...
```bash
$ module load quay.io/biocontainers/captus/1.6.5--pyh05cac1d_0
$ module help quay.io/biocontainers/captus/1.6.5--pyh05cac1d_0
```
