...
updated_at: "2026-03-22 05:00:38.597778"
latest: "1.6.3--pyh05cac1d_0"
...
```bash
$ shpc install quay.io/biocontainers/captus:1.6.3--pyh05cac1d_0
```
...
```bash
$ module load quay.io/biocontainers/captus/1.6.3--pyh05cac1d_0
$ module help quay.io/biocontainers/captus/1.6.3--pyh05cac1d_0
```
