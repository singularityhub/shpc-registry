...
updated_at: "2025-11-16 04:06:39.189045"
latest: "1.6.0--pyh05cac1d_0"
...
```bash
$ shpc install quay.io/biocontainers/captus:1.6.0--pyh05cac1d_0
```
...
```bash
$ module load quay.io/biocontainers/captus/1.6.0--pyh05cac1d_0
$ module help quay.io/biocontainers/captus/1.6.0--pyh05cac1d_0
```
