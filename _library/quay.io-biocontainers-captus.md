...
updated_at: "2026-08-19 03:51:48.184411"
latest: "1.6.6--pyh05cac1d_0"
...
```bash
$ shpc install quay.io/biocontainers/captus:1.6.6--pyh05cac1d_0
```
...
```bash
$ module load quay.io/biocontainers/captus/1.6.6--pyh05cac1d_0
$ module help quay.io/biocontainers/captus/1.6.6--pyh05cac1d_0
```
