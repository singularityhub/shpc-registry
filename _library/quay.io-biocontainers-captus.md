...
updated_at: "2023-08-29 03:00:38.778456"
latest: "0.9.96--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/captus:0.9.96--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/captus/0.9.96--pyhdfd78af_0
$ module help quay.io/biocontainers/captus/0.9.96--pyhdfd78af_0
```
