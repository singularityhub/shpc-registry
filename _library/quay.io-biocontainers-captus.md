...
updated_at: "2025-05-27 03:46:39.125559"
latest: "1.4.7--pyh05cac1d_0"
...
```bash
$ shpc install quay.io/biocontainers/captus:1.4.7--pyh05cac1d_0
```
...
```bash
$ module load quay.io/biocontainers/captus/1.4.7--pyh05cac1d_0
$ module help quay.io/biocontainers/captus/1.4.7--pyh05cac1d_0
```
