...
updated_at: "2025-05-17 03:43:08.740316"
latest: "1.4.0--pyh05cac1d_0"
...
```bash
$ shpc install quay.io/biocontainers/captus:1.4.0--pyh05cac1d_0
```
...
```bash
$ module load quay.io/biocontainers/captus/1.4.0--pyh05cac1d_0
$ module help quay.io/biocontainers/captus/1.4.0--pyh05cac1d_0
```
