...
updated_at: "2023-12-01 03:07:33.742026"
latest: "1.2--py_0"
...
```bash
$ shpc install quay.io/biocontainers/geosketch:1.2--py_0
```
...
```bash
$ module load quay.io/biocontainers/geosketch/1.2--py_0
$ module help quay.io/biocontainers/geosketch/1.2--py_0
```
