...
updated_at: "2026-03-13 04:48:55.589843"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-celeganscdf:2.18.0--r45hdfd78af_14
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-celeganscdf/2.18.0--r45hdfd78af_14
$ module help quay.io/biocontainers/bioconductor-celeganscdf/2.18.0--r45hdfd78af_14
```
