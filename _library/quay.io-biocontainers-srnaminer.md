...
updated_at: "2023-10-05 03:48:00.641168"
...
```bash
$ shpc install quay.io/biocontainers/srnaminer:1.0.9--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/srnaminer/1.0.9--pyhdfd78af_0
$ module help quay.io/biocontainers/srnaminer/1.0.9--pyhdfd78af_0
```
