...
updated_at: "2023-06-25 03:54:54.183681"
...
```bash
$ shpc install quay.io/biocontainers/srnaminer:1.0.7--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/srnaminer/1.0.7--pyhdfd78af_0
$ module help quay.io/biocontainers/srnaminer/1.0.7--pyhdfd78af_0
```
