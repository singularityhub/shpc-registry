...
updated_at: "2023-10-23 03:07:26.928681"
...
```bash
$ shpc install quay.io/biocontainers/srnaminer:1.1.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/srnaminer/1.1.1--pyhdfd78af_0
$ module help quay.io/biocontainers/srnaminer/1.1.1--pyhdfd78af_0
```
