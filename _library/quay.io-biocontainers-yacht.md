---
layout: container
name:  "quay.io/biocontainers/yacht"
maintainer: "@vsoch"
...
updated_at: "2024-11-19 03:11:29.146192"
latest: "1.2.3--pyhdc42f0e_0"
...
```bash
$ shpc install quay.io/biocontainers/yacht
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/yacht:1.2.3--pyhdc42f0e_0
```
...
```bash
$ module load quay.io/biocontainers/yacht/1.2.3--pyhdc42f0e_0
$ module help quay.io/biocontainers/yacht/1.2.3--pyhdc42f0e_0
```
...
#### yacht-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### yacht-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/yacht
$ podman run --it --rm --entrypoint /usr/local/bin/yacht   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/yacht   -v ${PWD} -w ${PWD} <container> -c " $@"
```
