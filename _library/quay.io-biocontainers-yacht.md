...
updated_at: "2024-02-10 02:46:35.847755"
...
```bash
$ shpc install quay.io/biocontainers/yacht:1.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/yacht/1.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/yacht/1.1.0--pyhdfd78af_0
```
