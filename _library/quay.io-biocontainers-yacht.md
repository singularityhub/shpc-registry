...
updated_at: "2024-03-27 02:47:22.067896"
latest: "1.2.1--pyhca03a8a_0"
...
```bash
$ shpc install quay.io/biocontainers/yacht:1.2.1--pyhca03a8a_0
```
...
```bash
$ module load quay.io/biocontainers/yacht/1.2.1--pyhca03a8a_0
$ module help quay.io/biocontainers/yacht/1.2.1--pyhca03a8a_0
```
