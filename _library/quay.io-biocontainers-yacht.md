...
updated_at: "2024-08-08 03:54:46.661665"
latest: "1.2.2--pyhca03a8a_0"
...
```bash
$ shpc install quay.io/biocontainers/yacht:1.2.2--pyhca03a8a_0
```
...
```bash
$ module load quay.io/biocontainers/yacht/1.2.2--pyhca03a8a_0
$ module help quay.io/biocontainers/yacht/1.2.2--pyhca03a8a_0
```
