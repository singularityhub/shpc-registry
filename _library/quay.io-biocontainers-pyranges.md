...
updated_at: "2025-04-24 03:50:19.424855"
...
```bash
$ shpc install quay.io/biocontainers/pyranges:0.1.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pyranges/0.1.4--pyhdfd78af_0
$ module help quay.io/biocontainers/pyranges/0.1.4--pyhdfd78af_0
```
