...
updated_at: "2023-06-10 02:59:17.659088"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mfa:1.20.0--r42hf17093f_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mfa/1.20.0--r42hf17093f_1
$ module help quay.io/biocontainers/bioconductor-mfa/1.20.0--r42hf17093f_1
```
