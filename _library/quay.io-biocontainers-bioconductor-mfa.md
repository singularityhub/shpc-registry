...
updated_at: "2022-10-29 05:49:39.465546"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mfa:1.8.0--r36he1b5a44_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mfa/1.8.0--r36he1b5a44_0
$ module help quay.io/biocontainers/bioconductor-mfa/1.8.0--r36he1b5a44_0
```
