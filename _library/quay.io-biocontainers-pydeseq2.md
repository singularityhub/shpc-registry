...
updated_at: "2024-05-16 02:37:40.025394"
...
```bash
$ shpc install quay.io/biocontainers/pydeseq2:0.4.9--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pydeseq2/0.4.9--pyhdfd78af_0
$ module help quay.io/biocontainers/pydeseq2/0.4.9--pyhdfd78af_0
```
