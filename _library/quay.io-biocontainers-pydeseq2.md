...
updated_at: "2024-05-06 03:01:52.978098"
...
```bash
$ shpc install quay.io/biocontainers/pydeseq2:0.4.8--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pydeseq2/0.4.8--pyhdfd78af_0
$ module help quay.io/biocontainers/pydeseq2/0.4.8--pyhdfd78af_0
```
