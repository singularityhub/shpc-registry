...
updated_at: "2023-10-02 03:23:55.987018"
...
```bash
$ shpc install quay.io/biocontainers/pydeseq2:0.4.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pydeseq2/0.4.0--pyhdfd78af_0
$ module help quay.io/biocontainers/pydeseq2/0.4.0--pyhdfd78af_0
```
