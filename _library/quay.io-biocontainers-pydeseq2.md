...
updated_at: "2025-05-19 03:50:27.066738"
...
```bash
$ shpc install quay.io/biocontainers/pydeseq2:0.5.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pydeseq2/0.5.1--pyhdfd78af_0
$ module help quay.io/biocontainers/pydeseq2/0.5.1--pyhdfd78af_0
```
