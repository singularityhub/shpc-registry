...
updated_at: "2024-01-28 02:30:32.311945"
...
```bash
$ shpc install quay.io/biocontainers/pydeseq2:0.4.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pydeseq2/0.4.4--pyhdfd78af_0
$ module help quay.io/biocontainers/pydeseq2/0.4.4--pyhdfd78af_0
```
