...
updated_at: "2025-11-06 03:22:52.609804"
...
```bash
$ shpc install quay.io/biocontainers/pydeseq2:0.5.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pydeseq2/0.5.2--pyhdfd78af_0
$ module help quay.io/biocontainers/pydeseq2/0.5.2--pyhdfd78af_0
```
