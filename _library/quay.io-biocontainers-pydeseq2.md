...
updated_at: "2024-07-29 02:42:08.783194"
...
```bash
$ shpc install quay.io/biocontainers/pydeseq2:0.4.10--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pydeseq2/0.4.10--pyhdfd78af_0
$ module help quay.io/biocontainers/pydeseq2/0.4.10--pyhdfd78af_0
```
