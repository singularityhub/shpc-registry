...
updated_at: "2023-11-06 03:08:30.909777"
...
```bash
$ shpc install quay.io/biocontainers/pydeseq2:0.4.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pydeseq2/0.4.1--pyhdfd78af_0
$ module help quay.io/biocontainers/pydeseq2/0.4.1--pyhdfd78af_0
```
