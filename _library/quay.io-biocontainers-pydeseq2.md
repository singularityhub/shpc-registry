...
updated_at: "2023-08-18 02:30:37.570044"
...
```bash
$ shpc install quay.io/biocontainers/pydeseq2:0.3.6--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pydeseq2/0.3.6--pyhdfd78af_0
$ module help quay.io/biocontainers/pydeseq2/0.3.6--pyhdfd78af_0
```
