...
updated_at: "2024-10-03 03:24:45.207128"
latest: "0.4.11--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/pydeseq2:0.4.11--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pydeseq2/0.4.11--pyhdfd78af_0
$ module help quay.io/biocontainers/pydeseq2/0.4.11--pyhdfd78af_0
```
