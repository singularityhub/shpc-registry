...
updated_at: "2023-05-18 02:50:55.620248"
...
```bash
$ shpc install quay.io/biocontainers/pydeseq2:0.3.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pydeseq2/0.3.3--pyhdfd78af_0
$ module help quay.io/biocontainers/pydeseq2/0.3.3--pyhdfd78af_0
```
