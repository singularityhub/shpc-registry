...
updated_at: "2024-03-19 02:36:16.900199"
...
```bash
$ shpc install quay.io/biocontainers/pydeseq2:0.4.7--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pydeseq2/0.4.7--pyhdfd78af_0
$ module help quay.io/biocontainers/pydeseq2/0.4.7--pyhdfd78af_0
```
