...
updated_at: "2025-01-24 03:30:50.768230"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-heatmaps:1.30.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-heatmaps/1.30.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-heatmaps/1.30.0--r44hdfd78af_0
```
