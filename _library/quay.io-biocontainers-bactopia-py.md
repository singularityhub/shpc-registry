...
updated_at: "2023-07-16 03:31:19.503070"
...
```bash
$ shpc install quay.io/biocontainers/bactopia-py:1.0.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bactopia-py/1.0.4--pyhdfd78af_0
$ module help quay.io/biocontainers/bactopia-py/1.0.4--pyhdfd78af_0
```
