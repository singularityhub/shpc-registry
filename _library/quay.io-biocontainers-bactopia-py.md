...
updated_at: "2026-09-04 07:50:32.034395"
...
```bash
$ shpc install quay.io/biocontainers/bactopia-py:2.4.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bactopia-py/2.4.2--pyhdfd78af_0
$ module help quay.io/biocontainers/bactopia-py/2.4.2--pyhdfd78af_0
```
