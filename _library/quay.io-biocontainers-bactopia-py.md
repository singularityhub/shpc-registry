...
updated_at: "2026-08-30 08:32:29.815504"
...
```bash
$ shpc install quay.io/biocontainers/bactopia-py:2.3.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bactopia-py/2.3.0--pyhdfd78af_0
$ module help quay.io/biocontainers/bactopia-py/2.3.0--pyhdfd78af_0
```
