...
updated_at: "2023-09-12 02:45:30.403151"
...
```bash
$ shpc install quay.io/biocontainers/bactopia-py:1.0.7--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bactopia-py/1.0.7--pyhdfd78af_0
$ module help quay.io/biocontainers/bactopia-py/1.0.7--pyhdfd78af_0
```
