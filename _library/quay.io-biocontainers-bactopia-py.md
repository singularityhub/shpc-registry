...
updated_at: "2025-08-04 04:34:38.838048"
...
```bash
$ shpc install quay.io/biocontainers/bactopia-py:1.5.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bactopia-py/1.5.0--pyhdfd78af_0
$ module help quay.io/biocontainers/bactopia-py/1.5.0--pyhdfd78af_0
```
