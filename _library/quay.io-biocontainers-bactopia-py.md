...
updated_at: "2026-04-05 04:46:02.889275"
...
```bash
$ shpc install quay.io/biocontainers/bactopia-py:2.0.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bactopia-py/2.0.1--pyhdfd78af_0
$ module help quay.io/biocontainers/bactopia-py/2.0.1--pyhdfd78af_0
```
