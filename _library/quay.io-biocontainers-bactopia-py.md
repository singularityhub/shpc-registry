...
updated_at: "2026-06-22 07:49:04.842443"
...
```bash
$ shpc install quay.io/biocontainers/bactopia-py:2.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bactopia-py/2.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/bactopia-py/2.2.0--pyhdfd78af_0
```
