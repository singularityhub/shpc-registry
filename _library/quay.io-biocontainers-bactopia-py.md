...
updated_at: "2023-12-19 02:40:43.173419"
...
```bash
$ shpc install quay.io/biocontainers/bactopia-py:1.0.8--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bactopia-py/1.0.8--pyhdfd78af_0
$ module help quay.io/biocontainers/bactopia-py/1.0.8--pyhdfd78af_0
```
