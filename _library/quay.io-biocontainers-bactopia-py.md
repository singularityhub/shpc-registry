...
updated_at: "2025-08-24 04:10:19.027804"
...
```bash
$ shpc install quay.io/biocontainers/bactopia-py:1.6.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bactopia-py/1.6.1--pyhdfd78af_0
$ module help quay.io/biocontainers/bactopia-py/1.6.1--pyhdfd78af_0
```
