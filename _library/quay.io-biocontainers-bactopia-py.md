...
updated_at: "2025-10-09 03:28:12.809703"
...
```bash
$ shpc install quay.io/biocontainers/bactopia-py:1.7.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bactopia-py/1.7.0--pyhdfd78af_0
$ module help quay.io/biocontainers/bactopia-py/1.7.0--pyhdfd78af_0
```
