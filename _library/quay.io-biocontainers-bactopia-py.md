...
updated_at: "2024-04-22 03:02:07.676375"
...
```bash
$ shpc install quay.io/biocontainers/bactopia-py:1.0.9--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bactopia-py/1.0.9--pyhdfd78af_0
$ module help quay.io/biocontainers/bactopia-py/1.0.9--pyhdfd78af_0
```
