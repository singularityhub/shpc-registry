---
layout: container
name:  "quay.io/biocontainers/fjord"
maintainer: "@vsoch"
...
updated_at: "2026-05-01 06:29:17.243859"
...
versions:
 - "1.0.0--hdfd78af_0"
description: "singularity registry hpc automated addition for fjord"
config: {"url": "https://biocontainers.pro/tools/fjord", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for fjord", "latest": {"1.0.0--hdfd78af_0": "sha256:53d582dd3c979056d0f66035ec7a619e2d64dbcab28521e6da5801f9313ff16f"}, "tags": {"1.0.0--hdfd78af_0": "sha256:53d582dd3c979056d0f66035ec7a619e2d64dbcab28521e6da5801f9313ff16f"}, "docker": "quay.io/biocontainers/fjord", "aliases": {"fjord": "/usr/local/bin/fjord", "x-mapper": "/usr/local/bin/x-mapper", "bash": "/usr/local/bin/bash", "bashbug": "/usr/local/bin/bashbug", "archive-nlmnlp": "/usr/local/bin/archive-nlmnlp", "archive-pids": "/usr/local/bin/archive-pids", "download-flatfile": "/usr/local/bin/download-flatfile", "ecollect": "/usr/local/bin/ecollect", "gbf2facds": "/usr/local/bin/gbf2facds", "gbf2tbl": "/usr/local/bin/gbf2tbl", "gff-sort": "/usr/local/bin/gff-sort", "gff2xml": "/usr/local/bin/gff2xml", "pair-at-a-time": "/usr/local/bin/pair-at-a-time", "print-missing-subranges": "/usr/local/bin/print-missing-subranges", "sort-by-length": "/usr/local/bin/sort-by-length", "xcommon.sh": "/usr/local/bin/xcommon.sh", "xfetch": "/usr/local/bin/xfetch", "xfetch.ini": "/usr/local/bin/xfetch.ini", "xfilter": "/usr/local/bin/xfilter", "xinfo": "/usr/local/bin/xinfo", "xlink": "/usr/local/bin/xlink", "xlink.ini": "/usr/local/bin/xlink.ini", "xsearch": "/usr/local/bin/xsearch", "vsearch": "/usr/local/bin/vsearch", "hb-raster": "/usr/local/bin/hb-raster", "hb-vector": "/usr/local/bin/hb-vector", "bsmp2info": "/usr/local/bin/bsmp2info"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/fjord.
singularity registry hpc automated addition for fjord
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/fjord
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/fjord:1.0.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/fjord/1.0.0--hdfd78af_0
$ module help quay.io/biocontainers/fjord/1.0.0--hdfd78af_0
```
...
#### fjord-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### fjord-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/fjord
$ podman run --it --rm --entrypoint /usr/local/bin/fjord   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/fjord   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/x-mapper
$ podman run --it --rm --entrypoint /usr/local/bin/x-mapper   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/x-mapper   -v ${PWD} -w ${PWD} <container> -c " $@"
```
