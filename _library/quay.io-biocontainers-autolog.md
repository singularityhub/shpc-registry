---
layout: container
name:  "quay.io/biocontainers/autolog"
maintainer: "@vsoch"
...
updated_at: "2024-04-01 04:22:39.484122"
latest: "0.2--py_0"
...
```bash
$ shpc install quay.io/biocontainers/autolog
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/autolog:0.2--py_0
```
...
```bash
$ module load quay.io/biocontainers/autolog/0.2--py_0
$ module help quay.io/biocontainers/autolog/0.2--py_0
```
...
#### autolog-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### autolog-inspect-deffile:
