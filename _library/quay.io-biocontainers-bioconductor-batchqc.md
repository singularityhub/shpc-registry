...
updated_at: "2023-10-13 03:15:26.147267"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-batchqc:1.28.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-batchqc/1.28.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-batchqc/1.28.0--r43hdfd78af_0
```
