...
updated_at: "2024-08-29 11:14:08.673052"
latest: "1.2--py311h9f068be_8"
...
```bash
$ shpc install quay.io/biocontainers/plek:1.2--py311h9f068be_8
```
...
```bash
$ module load quay.io/biocontainers/plek/1.2--py311h9f068be_8
$ module help quay.io/biocontainers/plek/1.2--py311h9f068be_8
```
