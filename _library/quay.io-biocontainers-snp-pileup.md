...
updated_at: "2024-12-03 03:39:12.494119"
latest: "0.6.2--hdbdd923_7"
...
```bash
$ shpc install quay.io/biocontainers/snp-pileup:0.6.2--hdbdd923_7
```
...
```bash
$ module load quay.io/biocontainers/snp-pileup/0.6.2--hdbdd923_7
$ module help quay.io/biocontainers/snp-pileup/0.6.2--hdbdd923_7
```
