...
updated_at: "2023-02-08 03:24:47.096554"
latest: "1.10.0--r42hdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-structtoolbox:1.10.0--r42hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-structtoolbox/1.10.0--r42hdfd78af_1
$ module help quay.io/biocontainers/bioconductor-structtoolbox/1.10.0--r42hdfd78af_1
```
