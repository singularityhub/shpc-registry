...
updated_at: "2025-06-26 04:46:52.747875"
...
```bash
$ shpc install quay.io/biocontainers/latch:2.65.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/latch/2.65.1--pyhdfd78af_0
$ module help quay.io/biocontainers/latch/2.65.1--pyhdfd78af_0
```
