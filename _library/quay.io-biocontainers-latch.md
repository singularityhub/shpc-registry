...
updated_at: "2025-05-24 03:30:09.666524"
latest: "2.62.1--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/latch:2.62.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/latch/2.62.1--pyhdfd78af_0
$ module help quay.io/biocontainers/latch/2.62.1--pyhdfd78af_0
```
