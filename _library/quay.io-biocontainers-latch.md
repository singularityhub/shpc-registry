...
updated_at: "2026-08-16 04:08:56.537167"
latest: "2.76.8--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/latch:2.76.8--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/latch/2.76.8--pyhdfd78af_0
$ module help quay.io/biocontainers/latch/2.76.8--pyhdfd78af_0
```
