...
updated_at: "2026-08-25 03:59:28.422146"
latest: "2.77.0--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/latch:2.77.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/latch/2.77.0--pyhdfd78af_0
$ module help quay.io/biocontainers/latch/2.77.0--pyhdfd78af_0
```
