...
updated_at: "2025-08-07 10:05:20.827690"
latest: "2.65.2--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/latch:2.65.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/latch/2.65.2--pyhdfd78af_0
$ module help quay.io/biocontainers/latch/2.65.2--pyhdfd78af_0
```
