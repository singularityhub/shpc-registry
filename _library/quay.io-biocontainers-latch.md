...
updated_at: "2026-06-29 06:53:28.104563"
latest: "2.76.3--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/latch:2.76.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/latch/2.76.3--pyhdfd78af_0
$ module help quay.io/biocontainers/latch/2.76.3--pyhdfd78af_0
```
