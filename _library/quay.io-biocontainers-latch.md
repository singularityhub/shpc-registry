...
updated_at: "2025-10-21 03:35:42.867037"
latest: "2.67.5--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/latch:2.67.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/latch/2.67.5--pyhdfd78af_0
$ module help quay.io/biocontainers/latch/2.67.5--pyhdfd78af_0
```
