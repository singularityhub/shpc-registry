...
updated_at: "2025-04-22 03:40:04.608564"
latest: "2.61.0--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/latch:2.61.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/latch/2.61.0--pyhdfd78af_0
$ module help quay.io/biocontainers/latch/2.61.0--pyhdfd78af_0
```
