...
updated_at: "2025-09-01 03:58:11.456936"
latest: "2.66.3--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/latch:2.66.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/latch/2.66.3--pyhdfd78af_0
$ module help quay.io/biocontainers/latch/2.66.3--pyhdfd78af_0
```
