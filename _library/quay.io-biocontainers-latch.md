...
updated_at: "2026-05-26 22:02:07.749693"
latest: "2.72.2--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/latch:2.72.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/latch/2.72.2--pyhdfd78af_0
$ module help quay.io/biocontainers/latch/2.72.2--pyhdfd78af_0
```
