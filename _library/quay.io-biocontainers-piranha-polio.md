...
updated_at: "2025-03-06 04:12:07.097727"
...
```bash
$ shpc install quay.io/biocontainers/piranha-polio:1.4.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/piranha-polio/1.4.2--pyhdfd78af_0
$ module help quay.io/biocontainers/piranha-polio/1.4.2--pyhdfd78af_0
```
