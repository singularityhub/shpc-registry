...
updated_at: "2023-09-13 02:24:54.189967"
...
```bash
$ shpc install quay.io/biocontainers/piranha-polio:1.0.12--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/piranha-polio/1.0.12--pyhdfd78af_0
$ module help quay.io/biocontainers/piranha-polio/1.0.12--pyhdfd78af_0
```
