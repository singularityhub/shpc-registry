...
updated_at: "2024-03-19 02:25:38.384585"
...
```bash
$ shpc install quay.io/biocontainers/piranha-polio:1.2.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/piranha-polio/1.2.2--pyhdfd78af_0
$ module help quay.io/biocontainers/piranha-polio/1.2.2--pyhdfd78af_0
```
