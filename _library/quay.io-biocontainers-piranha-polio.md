...
updated_at: "2024-08-08 03:01:09.946874"
...
```bash
$ shpc install quay.io/biocontainers/piranha-polio:1.2.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/piranha-polio/1.2.5--pyhdfd78af_0
$ module help quay.io/biocontainers/piranha-polio/1.2.5--pyhdfd78af_0
```
