...
updated_at: "2024-07-04 04:09:11.730937"
...
```bash
$ shpc install quay.io/biocontainers/piranha-polio:1.2.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/piranha-polio/1.2.3--pyhdfd78af_0
$ module help quay.io/biocontainers/piranha-polio/1.2.3--pyhdfd78af_0
```
