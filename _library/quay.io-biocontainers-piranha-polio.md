...
updated_at: "2024-12-13 03:40:53.734750"
...
```bash
$ shpc install quay.io/biocontainers/piranha-polio:1.3.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/piranha-polio/1.3.1--pyhdfd78af_0
$ module help quay.io/biocontainers/piranha-polio/1.3.1--pyhdfd78af_0
```
