...
updated_at: "2023-11-05 02:45:58.420572"
...
```bash
$ shpc install quay.io/biocontainers/piranha-polio:1.0.13--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/piranha-polio/1.0.13--pyhdfd78af_0
$ module help quay.io/biocontainers/piranha-polio/1.0.13--pyhdfd78af_0
```
