...
updated_at: "2025-05-25 03:32:10.121567"
...
```bash
$ shpc install quay.io/biocontainers/piranha-polio:1.5.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/piranha-polio/1.5.2--pyhdfd78af_0
$ module help quay.io/biocontainers/piranha-polio/1.5.2--pyhdfd78af_0
```
