...
updated_at: "2024-09-15 03:11:21.986648"
...
```bash
$ shpc install quay.io/biocontainers/piranha-polio:1.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/piranha-polio/1.3--pyhdfd78af_0
$ module help quay.io/biocontainers/piranha-polio/1.3--pyhdfd78af_0
```
