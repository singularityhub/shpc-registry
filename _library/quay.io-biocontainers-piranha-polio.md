...
updated_at: "2023-12-08 03:08:16.418181"
...
```bash
$ shpc install quay.io/biocontainers/piranha-polio:1.2.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/piranha-polio/1.2.1--pyhdfd78af_0
$ module help quay.io/biocontainers/piranha-polio/1.2.1--pyhdfd78af_0
```
