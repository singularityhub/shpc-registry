...
updated_at: "2025-08-24 04:00:25.101088"
...
```bash
$ shpc install quay.io/biocontainers/piranha-polio:1.5.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/piranha-polio/1.5.3--pyhdfd78af_0
$ module help quay.io/biocontainers/piranha-polio/1.5.3--pyhdfd78af_0
```
