...
updated_at: "2025-04-19 03:40:11.195409"
...
```bash
$ shpc install quay.io/biocontainers/piranha-polio:1.5.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/piranha-polio/1.5.1--pyhdfd78af_0
$ module help quay.io/biocontainers/piranha-polio/1.5.1--pyhdfd78af_0
```
