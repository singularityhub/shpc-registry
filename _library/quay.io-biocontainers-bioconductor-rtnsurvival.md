...
updated_at: "2023-09-26 03:25:38.281722"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rtnsurvival:1.24.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rtnsurvival/1.24.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rtnsurvival/1.24.0--r43hdfd78af_0
```
