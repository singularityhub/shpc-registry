...
updated_at: "2025-03-02 03:00:18.176766"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rtnsurvival:1.30.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rtnsurvival/1.30.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rtnsurvival/1.30.0--r44hdfd78af_0
```
