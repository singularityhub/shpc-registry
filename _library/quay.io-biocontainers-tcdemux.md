...
updated_at: "2024-07-29 17:08:04.297072"
latest: "0.0.26--pyhdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/tcdemux:0.0.26--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/tcdemux/0.0.26--pyhdfd78af_1
$ module help quay.io/biocontainers/tcdemux/0.0.26--pyhdfd78af_1
```
