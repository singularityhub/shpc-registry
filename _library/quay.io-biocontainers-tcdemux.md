...
updated_at: "2023-09-22 04:39:31.934914"
...
```bash
$ shpc install quay.io/biocontainers/tcdemux:0.0.13--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/tcdemux/0.0.13--pyhdfd78af_0
$ module help quay.io/biocontainers/tcdemux/0.0.13--pyhdfd78af_0
```
