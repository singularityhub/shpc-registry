...
updated_at: "2024-07-17 03:17:01.090673"
...
```bash
$ shpc install quay.io/biocontainers/tcdemux:0.0.25--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/tcdemux/0.0.25--pyhdfd78af_1
$ module help quay.io/biocontainers/tcdemux/0.0.25--pyhdfd78af_1
```
