...
updated_at: "2026-03-23 04:40:00.843948"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cnvpanelizer:1.42.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cnvpanelizer/1.42.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-cnvpanelizer/1.42.0--r45hdfd78af_0
```
