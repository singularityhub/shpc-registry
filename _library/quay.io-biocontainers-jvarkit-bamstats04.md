---
layout: container
name:  "quay.io/biocontainers/jvarkit-bamstats04"
maintainer: "@vsoch"
...
updated_at: "2023-10-25 02:38:34.682957"
...
```bash
$ shpc install quay.io/biocontainers/jvarkit-bamstats04
```
...
#### jvarkit-bamstats04-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### jvarkit-bamstats04-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/bamstats04.sh
$ podman run --it --rm --entrypoint /usr/local/bin/bamstats04.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/bamstats04.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
