...
updated_at: "2026-06-16 07:58:11.779730"
...
```bash
$ shpc install quay.io/biocontainers/genin2:2.1.6--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/genin2/2.1.6--pyhdfd78af_0
$ module help quay.io/biocontainers/genin2/2.1.6--pyhdfd78af_0
```
