...
updated_at: "2026-03-28 17:17:48.559136"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-affymoe4302expr:1.48.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-affymoe4302expr/1.48.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-affymoe4302expr/1.48.0--r45hdfd78af_0
```
