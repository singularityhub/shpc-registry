...
updated_at: "2026-08-31 08:30:10.890587"
...
```bash
$ shpc install quay.io/biocontainers/nerpa:2.1.0--hd63eeec_1
```
...
```bash
$ module load quay.io/biocontainers/nerpa/2.1.0--hd63eeec_1
$ module help quay.io/biocontainers/nerpa/2.1.0--hd63eeec_1
```
