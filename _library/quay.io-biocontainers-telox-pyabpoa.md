---
layout: container
name:  "quay.io/biocontainers/telox-pyabpoa"
maintainer: "@vsoch"
...
updated_at: "2026-09-02 07:25:39.136390"
...
singularity registry hpc automated addition for telox-pyabpoa
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/telox-pyabpoa
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/telox-pyabpoa:1.5.6.post1--py310hfe4f656_0
```
...
```bash
$ module load quay.io/biocontainers/telox-pyabpoa/1.5.6.post1--py310hfe4f656_0
$ module help quay.io/biocontainers/telox-pyabpoa/1.5.6.post1--py310hfe4f656_0
```
...
#### telox-pyabpoa-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### telox-pyabpoa-inspect-deffile:
