...
updated_at: "2026-04-05 05:12:30.074654"
...
```bash
$ shpc install quay.io/biocontainers/checkm-genome:1.2.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/checkm-genome/1.2.5--pyhdfd78af_0
$ module help quay.io/biocontainers/checkm-genome/1.2.5--pyhdfd78af_0
```
