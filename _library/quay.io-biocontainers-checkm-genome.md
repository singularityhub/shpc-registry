...
updated_at: "2025-09-09 03:39:13.783966"
...
```bash
$ shpc install quay.io/biocontainers/checkm-genome:1.2.4--pyhdfd78af_2
```
...
```bash
$ module load quay.io/biocontainers/checkm-genome/1.2.4--pyhdfd78af_2
$ module help quay.io/biocontainers/checkm-genome/1.2.4--pyhdfd78af_2
```
