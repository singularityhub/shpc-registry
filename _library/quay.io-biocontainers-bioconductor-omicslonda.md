...
updated_at: "2022-11-05 00:53:11.092011"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-omicslonda:1.8.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-omicslonda/1.8.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-omicslonda/1.8.0--r41hdfd78af_0
```
