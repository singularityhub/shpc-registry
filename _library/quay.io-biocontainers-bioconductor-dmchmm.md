...
updated_at: "2025-05-16 03:49:07.367189"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-dmchmm:1.28.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-dmchmm/1.28.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-dmchmm/1.28.0--r44hdfd78af_0
```
