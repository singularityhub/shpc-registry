...
updated_at: "2023-09-23 02:26:27.008643"
latest: "3.19.1--r43hf17093f_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cogaps:3.19.1--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cogaps/3.19.1--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-cogaps/3.19.1--r43hf17093f_0
```
