...
updated_at: "2022-11-20 00:09:49.976906"
latest: "3.8.0--r40h5f743cb_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cogaps:3.8.0--r40h5f743cb_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cogaps/3.8.0--r40h5f743cb_0
$ module help quay.io/biocontainers/bioconductor-cogaps/3.8.0--r40h5f743cb_0
```
