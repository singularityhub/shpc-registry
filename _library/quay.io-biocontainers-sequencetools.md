...
updated_at: "2024-09-17 02:59:39.854989"
...
```bash
$ shpc install quay.io/biocontainers/sequencetools:1.5.4.0--hf48d1a7_0
```
...
```bash
$ module load quay.io/biocontainers/sequencetools/1.5.4.0--hf48d1a7_0
$ module help quay.io/biocontainers/sequencetools/1.5.4.0--hf48d1a7_0
```
