---
layout: container
name:  "quay.io/biocontainers/perl-bio-kmer"
maintainer: "@vsoch"
...
updated_at: "2025-09-11 03:25:27.445845"
...
aliases:
 ...
 - "makemat"
versions:
 - "0.55--pl5321h031d066_0"
description: "singularity registry hpc automated addition for perl-bio-kmer"
config: {"url": "https://biocontainers.pro/tools/perl-bio-kmer", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for perl-bio-kmer", "latest": {"0.55--pl5321h031d066_0": "sha256:4d89f8003d7470e6cf0b9718f271eb5cd3f69a35880e4541a5815d8079b6a1c0"}, "tags": {"0.55--pl5321h031d066_0": "sha256:4d89f8003d7470e6cf0b9718f271eb5cd3f69a35880e4541a5815d8079b6a1c0"}, "docker": "quay.io/biocontainers/perl-bio-kmer", "aliases": {"DrawGram.jar": "/usr/local/bin/DrawGram.jar", "DrawTree.jar": "/usr/local/bin/DrawTree.jar", "TMscore": "/usr/local/bin/TMscore", "archive-ncbinlp": "/usr/local/bin/archive-ncbinlp", "archive-nihocc": "/usr/local/bin/archive-nihocc", "archive-nmcds": "/usr/local/bin/archive-nmcds", "archive-pmc": "/usr/local/bin/archive-pmc", "archive-taxonomy": "/usr/local/bin/archive-taxonomy", "args2slice": "/usr/local/bin/args2slice", "asn2ref": "/usr/local/bin/asn2ref", "blst2gm": "/usr/local/bin/blst2gm", "bstats": "/usr/local/bin/bstats", "cit2pmid": "/usr/local/bin/cit2pmid", "clique": "/usr/local/bin/clique", "combine-uid-lists": "/usr/local/bin/combine-uid-lists", "comppair": "/usr/local/bin/comppair", "consense": "/usr/local/bin/consense", "contml": "/usr/local/bin/contml", "contrast": "/usr/local/bin/contrast", "conus_compare": "/usr/local/bin/conus_compare", "conus_train": "/usr/local/bin/conus_train", "dca": "/usr/local/bin/dca", "dialign-tx": "/usr/local/bin/dialign-tx", "difference-uid-lists": "/usr/local/bin/difference-uid-lists", "dnacomp": "/usr/local/bin/dnacomp", "dnadist": "/usr/local/bin/dnadist", "dnainvar": "/usr/local/bin/dnainvar", "dnaml": "/usr/local/bin/dnaml", "dnamlk": "/usr/local/bin/dnamlk", "dnamove": "/usr/local/bin/dnamove", "dnapars": "/usr/local/bin/dnapars", "dnapenny": "/usr/local/bin/dnapenny", "dollop": "/usr/local/bin/dollop", "dolmove": "/usr/local/bin/dolmove", "dolpenny": "/usr/local/bin/dolpenny", "download-pmc": "/usr/local/bin/download-pmc", "drawgram": "/usr/local/bin/drawgram", "drawgram_gui": "/usr/local/bin/drawgram_gui", "drawtree": "/usr/local/bin/drawtree", "drawtree_gui": "/usr/local/bin/drawtree_gui", "ds2pme": "/usr/local/bin/ds2pme", "fakealigner": "/usr/local/bin/fakealigner", "faketree": "/usr/local/bin/faketree", "famsa": "/usr/local/bin/famsa", "fasttreeMP": "/usr/local/bin/fasttreeMP", "fetch-local": "/usr/local/bin/fetch-local", "fetch-nmcds": "/usr/local/bin/fetch-nmcds", "fetch-pmc": "/usr/local/bin/fetch-pmc", "fetch-taxonomy": "/usr/local/bin/fetch-taxonomy", "filter-genbank": "/usr/local/bin/filter-genbank", "filter-record": "/usr/local/bin/filter-record", "fitch": "/usr/local/bin/fitch", "gbf2fsa": "/usr/local/bin/gbf2fsa", "gbf2ref": "/usr/local/bin/gbf2ref", "gendist": "/usr/local/bin/gendist", "gi-compile-repository": "/usr/local/bin/gi-compile-repository", "gi-decompile-typelib": "/usr/local/bin/gi-decompile-typelib", "gi-inspect-typelib": "/usr/local/bin/gi-inspect-typelib", "gm2ranges": "/usr/local/bin/gm2ranges", "gm2segs": "/usr/local/bin/gm2segs", "hmmeralign": "/usr/local/bin/hmmeralign", "hmmerbuild": "/usr/local/bin/hmmerbuild", "hyperopt-mongo-worker": "/usr/local/bin/hyperopt-mongo-worker", "ini2xml": "/usr/local/bin/ini2xml", "jsonl2xml": "/usr/local/bin/jsonl2xml", "just-first-key": "/usr/local/bin/just-first-key", "kalign": "/usr/local/bin/kalign", "kitsch": "/usr/local/bin/kitsch", "mix": "/usr/local/bin/mix", "move": "/usr/local/bin/move", "mustang": "/usr/local/bin/mustang", "neighbor": "/usr/local/bin/neighbor", "nhance.sh": "/usr/local/bin/nhance.sh", "opal.jar": "/usr/local/bin/opal.jar", "pModel": "/usr/local/bin/pModel", "padaligner": "/usr/local/bin/padaligner", "pars": "/usr/local/bin/pars", "penny": "/usr/local/bin/penny", "phylip": "/usr/local/bin/phylip", "pma2apa": "/usr/local/bin/pma2apa", "pma2pme": "/usr/local/bin/pma2pme", "pmc2bioc": "/usr/local/bin/pmc2bioc", "pmc2info": "/usr/local/bin/pmc2info", "probcons": "/usr/local/bin/probcons", "probconsRNA": "/usr/local/bin/probconsRNA", "proml": "/usr/local/bin/proml", "promlk": "/usr/local/bin/promlk", "protdist": "/usr/local/bin/protdist", "protpars": "/usr/local/bin/protpars", "quote-grouped-elements": "/usr/local/bin/quote-grouped-elements", "randtree": "/usr/local/bin/randtree", "raxml": "/usr/local/bin/raxml", "raxmlp": "/usr/local/bin/raxmlp", "rbs": "/usr/local/bin/rbs", "rdbg": "/usr/local/bin/rdbg", "ref2pmid": "/usr/local/bin/ref2pmid", "refseq-nm-cds": "/usr/local/bin/refseq-nm-cds", "restdist": "/usr/local/bin/restdist", "restml": "/usr/local/bin/restml", "retree": "/usr/local/bin/retree", "run_pasta.py": "/usr/local/bin/run_pasta.py", "run_pasta_gui.py": "/usr/local/bin/run_pasta_gui.py", "run_seqtools.py": "/usr/local/bin/run_seqtools.py", "sap": "/usr/local/bin/sap", "scn2xml": "/usr/local/bin/scn2xml", "scompare": "/usr/local/bin/scompare", "seqboot": "/usr/local/bin/seqboot", "sfold": "/usr/local/bin/sfold", "strain_ml": "/usr/local/bin/strain_ml", "stream-local": "/usr/local/bin/stream-local", "test-pmc-index": "/usr/local/bin/test-pmc-index", "toml2xml": "/usr/local/bin/toml2xml", "treedist": "/usr/local/bin/treedist", "typeprof": "/usr/local/bin/typeprof", "yaml2xml": "/usr/local/bin/yaml2xml", "TMalign": "/usr/local/bin/TMalign", "make_pscores.pl": "/usr/local/bin/make_pscores.pl", "racc": "/usr/local/bin/racc", "poa": "/usr/local/bin/poa", "prank": "/usr/local/bin/prank", "bundle": "/usr/local/bin/bundle", "bundler": "/usr/local/bin/bundler", "RNAmultifold": "/usr/local/bin/RNAmultifold", "gdbm_dump": "/usr/local/bin/gdbm_dump", "gdbm_load": "/usr/local/bin/gdbm_load", "gdbmtool": "/usr/local/bin/gdbmtool", "clustalo": "/usr/local/bin/clustalo", "bl2seq": "/usr/local/bin/bl2seq", "blastall": "/usr/local/bin/blastall", "blastclust": "/usr/local/bin/blastclust", "blastpgp": "/usr/local/bin/blastpgp", "copymat": "/usr/local/bin/copymat", "erb": "/usr/local/bin/erb", "fastacmd": "/usr/local/bin/fastacmd", "formatdb": "/usr/local/bin/formatdb", "formatrpsdb": "/usr/local/bin/formatrpsdb", "gem": "/usr/local/bin/gem", "impala": "/usr/local/bin/impala", "irb": "/usr/local/bin/irb", "makemat": "/usr/local/bin/makemat"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/perl-bio-kmer.
singularity registry hpc automated addition for perl-bio-kmer
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/perl-bio-kmer
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/perl-bio-kmer:0.55--pl5321h031d066_0
```
...
```bash
$ module load quay.io/biocontainers/perl-bio-kmer/0.55--pl5321h031d066_0
$ module help quay.io/biocontainers/perl-bio-kmer/0.55--pl5321h031d066_0
```
...
#### perl-bio-kmer-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### perl-bio-kmer-inspect-deffile:
