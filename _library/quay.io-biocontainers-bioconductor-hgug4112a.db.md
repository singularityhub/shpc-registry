...
updated_at: "2023-12-06 02:45:26.511914"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hgug4112a.db:3.2.3--r43hdfd78af_11
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hgug4112a.db/3.2.3--r43hdfd78af_11
$ module help quay.io/biocontainers/bioconductor-hgug4112a.db/3.2.3--r43hdfd78af_11
```
