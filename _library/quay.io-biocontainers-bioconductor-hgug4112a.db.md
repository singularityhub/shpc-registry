...
updated_at: "2024-07-04 04:25:01.689640"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hgug4112a.db:3.2.3--r43hdfd78af_12
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hgug4112a.db/3.2.3--r43hdfd78af_12
$ module help quay.io/biocontainers/bioconductor-hgug4112a.db/3.2.3--r43hdfd78af_12
```
