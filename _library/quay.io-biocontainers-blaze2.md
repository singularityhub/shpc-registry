---
layout: container
name:  "quay.io/biocontainers/blaze2"
maintainer: "@vsoch"
...
updated_at: "2024-09-02 04:47:08.610367"
...
```bash
$ shpc install quay.io/biocontainers/blaze2
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/blaze2:2.2.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/blaze2/2.2.1--pyhdfd78af_0
$ module help quay.io/biocontainers/blaze2/2.2.1--pyhdfd78af_0
```
...
#### blaze2-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### blaze2-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/blaze
$ podman run --it --rm --entrypoint /usr/local/bin/blaze   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/blaze   -v ${PWD} -w ${PWD} <container> -c " $@"
```
