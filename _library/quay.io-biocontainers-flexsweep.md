...
updated_at: "2026-06-05 07:12:14.845043"
...
```bash
$ shpc install quay.io/biocontainers/flexsweep:1.9.2--py312ha711ca7_0
```
...
```bash
$ module load quay.io/biocontainers/flexsweep/1.9.2--py312ha711ca7_0
$ module help quay.io/biocontainers/flexsweep/1.9.2--py312ha711ca7_0
```
