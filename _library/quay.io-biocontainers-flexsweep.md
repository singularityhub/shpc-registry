---
layout: container
name:  "quay.io/biocontainers/flexsweep"
maintainer: "@vsoch"
...
updated_at: "2026-08-28 14:44:07.034921"
latest: "2.0--py312ha711ca7_0"
...
```bash
$ shpc install quay.io/biocontainers/flexsweep
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/flexsweep:2.0--py312ha711ca7_0
```
...
```bash
$ module load quay.io/biocontainers/flexsweep/2.0--py312ha711ca7_0
$ module help quay.io/biocontainers/flexsweep/2.0--py312ha711ca7_0
```
...
#### flexsweep-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### flexsweep-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/flexsweep
$ podman run --it --rm --entrypoint /usr/local/bin/flexsweep   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/flexsweep   -v ${PWD} -w ${PWD} <container> -c " $@"
```
