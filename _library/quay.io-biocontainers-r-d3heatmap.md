---
layout: container
name:  "quay.io/biocontainers/r-d3heatmap"
maintainer: "@vsoch"
...
updated_at: "2023-07-30 03:05:11.723741"
...
```bash
$ shpc install quay.io/biocontainers/r-d3heatmap
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/r-d3heatmap:0.6.1.1--r3.3.2_0
```
...
```bash
$ module load quay.io/biocontainers/r-d3heatmap/0.6.1.1--r3.3.2_0
$ module help quay.io/biocontainers/r-d3heatmap/0.6.1.1--r3.3.2_0
```
...
#### r-d3heatmap-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-d3heatmap-inspect-deffile:
