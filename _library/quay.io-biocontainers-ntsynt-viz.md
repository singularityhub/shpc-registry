...
updated_at: "2026-06-28 06:49:26.116009"
...
```bash
$ shpc install quay.io/biocontainers/ntsynt-viz:1.0.7--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ntsynt-viz/1.0.7--hdfd78af_0
$ module help quay.io/biocontainers/ntsynt-viz/1.0.7--hdfd78af_0
```
