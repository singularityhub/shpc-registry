...
updated_at: "2026-09-18 07:17:41.046892"
...
```bash
$ shpc install quay.io/biocontainers/ntsynt-viz:1.1.2--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ntsynt-viz/1.1.2--hdfd78af_0
$ module help quay.io/biocontainers/ntsynt-viz/1.1.2--hdfd78af_0
```
