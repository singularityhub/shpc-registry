...
updated_at: "2026-05-07 06:14:18.753213"
...
```bash
$ shpc install quay.io/biocontainers/ntsynt-viz:1.0.4--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ntsynt-viz/1.0.4--hdfd78af_0
$ module help quay.io/biocontainers/ntsynt-viz/1.0.4--hdfd78af_0
```
