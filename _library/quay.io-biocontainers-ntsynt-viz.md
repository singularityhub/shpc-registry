...
updated_at: "2026-09-02 07:22:19.478896"
...
```bash
$ shpc install quay.io/biocontainers/ntsynt-viz:1.1.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ntsynt-viz/1.1.0--hdfd78af_0
$ module help quay.io/biocontainers/ntsynt-viz/1.1.0--hdfd78af_0
```
