---
layout: container
name:  "quay.io/biocontainers/kcounter"
maintainer: "@vsoch"
...
updated_at: "2026-06-14 06:50:50.780202"
latest: "0.1.2--py310hce5ca29_0"
...
```bash
$ shpc install quay.io/biocontainers/kcounter
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/kcounter:0.1.2--py310hce5ca29_0
```
...
```bash
$ module load quay.io/biocontainers/kcounter/0.1.2--py310hce5ca29_0
$ module help quay.io/biocontainers/kcounter/0.1.2--py310hce5ca29_0
```
...
#### kcounter-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### kcounter-inspect-deffile:
