...
updated_at: "2025-12-13 03:28:01.413946"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-geotcgadata:2.6.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-geotcgadata/2.6.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-geotcgadata/2.6.0--r44hdfd78af_0
```
