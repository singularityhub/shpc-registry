---
layout: container
name:  "quay.io/biocontainers/bioconductor-geotcgadata"
maintainer: "@vsoch"
...
updated_at: "2026-03-16 05:21:31.544812"
latest: "2.10.0--r45hdfd78af_0"
...
versions:
 ...
 - "2.2.0--r43hdfd78af_0"
 - "2.6.0--r44hdfd78af_0"
 - "2.10.0--r45hdfd78af_0"
description: "singularity registry hpc automated addition for bioconductor-geotcgadata"
config: {"url": "https://biocontainers.pro/tools/bioconductor-geotcgadata", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for bioconductor-geotcgadata", "latest": {"2.10.0--r45hdfd78af_0": "sha256:69d9cf1b19dddda49dcddecba9397c1ba6e4b451fd8d58c7275abbb026b038a3"}, "tags": {"2.0.0--r43hdfd78af_0": "sha256:9a8f86d539b093bd6ec2fa2ae1e30efe1de542e13d6fd35526072256a5343956", "2.2.0--r43hdfd78af_0": "sha256:2c597a02bc47cc729891e8884bb688fae7ada4afdad5d0ce3265d12db4c02226", "2.6.0--r44hdfd78af_0": "sha256:0693c6dbe6131da17e9fd06dcdfc41987af4a7f8ffc7a4f3d992b3405f29ede3", "2.10.0--r45hdfd78af_0": "sha256:69d9cf1b19dddda49dcddecba9397c1ba6e4b451fd8d58c7275abbb026b038a3"}, "docker": "quay.io/biocontainers/bioconductor-geotcgadata", "aliases": {"hb-info": "/usr/local/bin/hb-info", "tjbench": "/usr/local/bin/tjbench", "2to3-3.11": "/usr/local/bin/2to3-3.11", "idle3.11": "/usr/local/bin/idle3.11", "pydoc3.11": "/usr/local/bin/pydoc3.11", "python3.11": "/usr/local/bin/python3.11", "python3.11-config": "/usr/local/bin/python3.11-config", "installBiocDataPackage.sh": "/usr/local/bin/installBiocDataPackage.sh", "tomlq": "/usr/local/bin/tomlq", "xq": "/usr/local/bin/xq", "yq": "/usr/local/bin/yq", "jq": "/usr/local/bin/jq", "onig-config": "/usr/local/bin/onig-config", "activate-global-python-argcomplete": "/usr/local/bin/activate-global-python-argcomplete", "python-argcomplete-check-easy-install-script": "/usr/local/bin/python-argcomplete-check-easy-install-script", "register-python-argcomplete": "/usr/local/bin/register-python-argcomplete", "python3.1": "/usr/local/bin/python3.1"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/bioconductor-geotcgadata.
singularity registry hpc automated addition for bioconductor-geotcgadata
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/bioconductor-geotcgadata
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-geotcgadata:2.10.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-geotcgadata/2.10.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-geotcgadata/2.10.0--r45hdfd78af_0
```
...
#### bioconductor-geotcgadata-shell:
...
#### bioconductor-geotcgadata-inspect:
...
#### bioconductor-geotcgadata-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-geotcgadata-inspect-deffile:
