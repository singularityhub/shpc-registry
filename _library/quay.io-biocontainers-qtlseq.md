...
updated_at: "2026-03-30 06:28:15.309681"
...
```bash
$ shpc install quay.io/biocontainers/qtlseq:2.3.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/qtlseq/2.3.0--pyhdfd78af_0
$ module help quay.io/biocontainers/qtlseq/2.3.0--pyhdfd78af_0
```
