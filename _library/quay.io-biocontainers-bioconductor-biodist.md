...
updated_at: "2024-04-25 03:06:07.849176"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-biodist:1.74.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-biodist/1.74.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-biodist/1.74.0--r43hdfd78af_0
```
