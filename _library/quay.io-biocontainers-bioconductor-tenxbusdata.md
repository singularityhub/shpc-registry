...
updated_at: "2022-11-04 00:26:03.634642"
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-tenxbusdata-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-tenxbusdata-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-tenxbusdata-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-tenxbusdata-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-tenxbusdata-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-tenxbusdata-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
