...
updated_at: "2023-09-11 02:28:15.377551"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-tenxbusdata:1.14.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-tenxbusdata/1.14.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-tenxbusdata/1.14.0--r43hdfd78af_0
```
