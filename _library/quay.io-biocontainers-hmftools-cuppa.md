...
updated_at: "2026-07-02 06:54:45.410260"
latest: "2.5.1--py311r42hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/hmftools-cuppa:2.5.1--py311r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hmftools-cuppa/2.5.1--py311r42hdfd78af_0
$ module help quay.io/biocontainers/hmftools-cuppa/2.5.1--py311r42hdfd78af_0
```
