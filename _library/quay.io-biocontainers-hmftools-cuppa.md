...
updated_at: "2026-01-09 03:54:44.059542"
...
```bash
$ shpc install quay.io/biocontainers/hmftools-cuppa:2.4--py311r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hmftools-cuppa/2.4--py311r42hdfd78af_0
$ module help quay.io/biocontainers/hmftools-cuppa/2.4--py311r42hdfd78af_0
```
