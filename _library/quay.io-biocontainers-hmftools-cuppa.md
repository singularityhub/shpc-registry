...
updated_at: "2024-05-09 03:00:54.948419"
latest: "1.8.1--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/hmftools-cuppa:1.8.1--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hmftools-cuppa/1.8.1--hdfd78af_0
$ module help quay.io/biocontainers/hmftools-cuppa/1.8.1--hdfd78af_0
```
