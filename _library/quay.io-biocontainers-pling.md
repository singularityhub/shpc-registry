...
updated_at: "2026-05-07 06:29:01.925043"
...
```bash
$ shpc install quay.io/biocontainers/pling:3.0.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pling/3.0.1--pyhdfd78af_0
$ module help quay.io/biocontainers/pling/3.0.1--pyhdfd78af_0
```
