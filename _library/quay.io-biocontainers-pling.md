...
updated_at: "2026-03-30 06:19:52.111183"
...
```bash
$ shpc install quay.io/biocontainers/pling:2.0.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pling/2.0.2--pyhdfd78af_0
$ module help quay.io/biocontainers/pling/2.0.2--pyhdfd78af_0
```
