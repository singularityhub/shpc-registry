...
updated_at: "2026-03-24 05:16:32.038260"
latest: "2.12.0--r45hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ancombc:2.12.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ancombc/2.12.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ancombc/2.12.0--r45hdfd78af_0
```
