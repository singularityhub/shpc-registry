...
updated_at: "2026-05-17 06:13:05.913576"
latest: "3.14"
...
```bash
$ shpc install quay.io/biocontainers/python:3.14
```
...
```bash
$ module load quay.io/biocontainers/python/3.14
$ module help quay.io/biocontainers/python/3.14
```
