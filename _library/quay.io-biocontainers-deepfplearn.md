---
layout: container
name:  "quay.io/biocontainers/deepfplearn"
maintainer: "@vsoch"
...
updated_at: "2025-09-28 03:34:05.938588"
latest: "2.1--pyh42286b9_1"
...
```bash
$ shpc install quay.io/biocontainers/deepfplearn
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/deepfplearn:2.1--pyh42286b9_1
```
...
```bash
$ module load quay.io/biocontainers/deepfplearn/2.1--pyh42286b9_1
$ module help quay.io/biocontainers/deepfplearn/2.1--pyh42286b9_1
```
...
#### deepfplearn-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### deepfplearn-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/dfpl
$ podman run --it --rm --entrypoint /usr/local/bin/dfpl   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/dfpl   -v ${PWD} -w ${PWD} <container> -c " $@"
```
