...
updated_at: "2026-03-24 04:24:26.432795"
...
```bash
$ shpc install quay.io/biocontainers/biobb_cmip:5.2.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_cmip/5.2.3--pyhdfd78af_0
$ module help quay.io/biocontainers/biobb_cmip/5.2.3--pyhdfd78af_0
```
