...
updated_at: "2025-03-23 03:39:52.615207"
...
```bash
$ shpc install quay.io/biocontainers/biobb_cmip:5.0.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_cmip/5.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/biobb_cmip/5.0.0--pyhdfd78af_0
```
