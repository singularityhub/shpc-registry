...
updated_at: "2026-02-05 04:47:42.315741"
...
```bash
$ shpc install quay.io/biocontainers/biobb_cmip:5.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_cmip/5.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/biobb_cmip/5.2.0--pyhdfd78af_0
```
