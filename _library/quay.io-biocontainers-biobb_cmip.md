...
updated_at: "2026-01-06 04:11:42.076561"
...
```bash
$ shpc install quay.io/biocontainers/biobb_cmip:5.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_cmip/5.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/biobb_cmip/5.1.0--pyhdfd78af_0
```
