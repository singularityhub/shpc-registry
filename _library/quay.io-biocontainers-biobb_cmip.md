...
updated_at: "2023-08-22 03:13:06.668465"
...
```bash
$ shpc install quay.io/biocontainers/biobb_cmip:4.0.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_cmip/4.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/biobb_cmip/4.0.0--pyhdfd78af_0
```
