...
updated_at: "2026-08-22 03:49:20.588982"
...
```bash
$ shpc install quay.io/biocontainers/biobb_cmip:5.3.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_cmip/5.3.0--pyhdfd78af_0
$ module help quay.io/biocontainers/biobb_cmip/5.3.0--pyhdfd78af_0
```
