...
updated_at: "2024-07-29 03:04:54.163814"
...
```bash
$ shpc install quay.io/biocontainers/biobb_cmip:4.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_cmip/4.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/biobb_cmip/4.2.0--pyhdfd78af_0
```
