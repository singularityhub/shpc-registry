...
updated_at: "2026-03-01 04:27:00.887857"
...
```bash
$ shpc install quay.io/biocontainers/biobb_cmip:5.2.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_cmip/5.2.2--pyhdfd78af_0
$ module help quay.io/biocontainers/biobb_cmip/5.2.2--pyhdfd78af_0
```
