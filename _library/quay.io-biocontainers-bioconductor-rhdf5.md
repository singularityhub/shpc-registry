...
updated_at: "2025-04-17 04:28:56.701370"
latest: "2.50.0--r44h77050f0_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rhdf5:2.50.0--r44h77050f0_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rhdf5/2.50.0--r44h77050f0_0
$ module help quay.io/biocontainers/bioconductor-rhdf5/2.50.0--r44h77050f0_0
```
