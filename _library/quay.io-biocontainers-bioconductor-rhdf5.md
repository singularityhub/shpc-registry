...
updated_at: "2026-02-22 05:13:01.180616"
latest: "2.54.1--r45h882589e_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rhdf5:2.54.1--r45h882589e_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rhdf5/2.54.1--r45h882589e_0
$ module help quay.io/biocontainers/bioconductor-rhdf5/2.54.1--r45h882589e_0
```
