...
updated_at: "2023-12-06 02:54:50.624058"
latest: "2.44.0--r43hf17093f_1"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rhdf5:2.44.0--r43hf17093f_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rhdf5/2.44.0--r43hf17093f_1
$ module help quay.io/biocontainers/bioconductor-rhdf5/2.44.0--r43hf17093f_1
```
