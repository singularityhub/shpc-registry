...
updated_at: "2025-07-31 11:52:29.751036"
...
```bash
$ shpc install quay.io/biocontainers/sigprofilermatrixgenerator:1.3.3--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/sigprofilermatrixgenerator/1.3.3--pyhdfd78af_1
$ module help quay.io/biocontainers/sigprofilermatrixgenerator/1.3.3--pyhdfd78af_1
```
