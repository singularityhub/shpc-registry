...
updated_at: "2025-05-08 05:28:52.485576"
...
```bash
$ shpc install quay.io/biocontainers/sigprofilermatrixgenerator:1.3.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sigprofilermatrixgenerator/1.3.3--pyhdfd78af_0
$ module help quay.io/biocontainers/sigprofilermatrixgenerator/1.3.3--pyhdfd78af_0
```
