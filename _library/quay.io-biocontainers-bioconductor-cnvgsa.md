...
updated_at: "2022-10-29 05:54:26.341602"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cnvgsa:1.38.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cnvgsa/1.38.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-cnvgsa/1.38.0--r41hdfd78af_0
```
