...
updated_at: "2023-11-06 03:34:35.699332"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cnvgsa:1.44.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cnvgsa/1.44.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-cnvgsa/1.44.0--r43hdfd78af_0
```
