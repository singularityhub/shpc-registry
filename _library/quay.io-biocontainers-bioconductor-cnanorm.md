...
updated_at: "2025-08-29 03:09:20.471149"
latest: "1.52.0--r44h4d5c4aa_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cnanorm:1.52.0--r44h4d5c4aa_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cnanorm/1.52.0--r44h4d5c4aa_0
$ module help quay.io/biocontainers/bioconductor-cnanorm/1.52.0--r44h4d5c4aa_0
```
