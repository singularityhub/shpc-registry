...
updated_at: "2026-03-15 04:42:49.690344"
latest: "1.56.0--r45h63f16b7_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cnanorm:1.56.0--r45h63f16b7_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cnanorm/1.56.0--r45h63f16b7_0
$ module help quay.io/biocontainers/bioconductor-cnanorm/1.56.0--r45h63f16b7_0
```
