...
updated_at: "2023-10-20 03:08:07.698054"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-intomics:1.0.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-intomics/1.0.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-intomics/1.0.0--r43hdfd78af_0
```
