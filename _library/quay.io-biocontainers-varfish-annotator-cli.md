...
updated_at: "2023-02-12 03:11:57.607423"
latest: "0.30--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/varfish-annotator-cli:0.30--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/varfish-annotator-cli/0.30--hdfd78af_0
$ module help quay.io/biocontainers/varfish-annotator-cli/0.30--hdfd78af_0
```
