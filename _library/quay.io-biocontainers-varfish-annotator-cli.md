...
updated_at: "2023-01-12 03:08:38.832032"
latest: "0.28--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/varfish-annotator-cli:0.28--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/varfish-annotator-cli/0.28--hdfd78af_0
$ module help quay.io/biocontainers/varfish-annotator-cli/0.28--hdfd78af_0
```
