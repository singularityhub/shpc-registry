...
updated_at: "2022-11-03 00:44:14.626208"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-asafe:1.8.0--r351_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-asafe/1.8.0--r351_0
$ module help quay.io/biocontainers/bioconductor-asafe/1.8.0--r351_0
```
