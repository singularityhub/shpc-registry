...
updated_at: "2026-03-22 04:27:47.624850"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-asafe:1.36.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-asafe/1.36.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-asafe/1.36.0--r45hdfd78af_0
```
