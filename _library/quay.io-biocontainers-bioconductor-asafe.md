...
updated_at: "2023-12-03 03:00:54.245086"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-asafe:1.26.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-asafe/1.26.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-asafe/1.26.0--r43hdfd78af_0
```
