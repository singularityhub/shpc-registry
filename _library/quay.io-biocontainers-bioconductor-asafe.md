...
updated_at: "2022-11-09 00:08:11.537167"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-asafe:1.20.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-asafe/1.20.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-asafe/1.20.0--r41hdfd78af_0
```
