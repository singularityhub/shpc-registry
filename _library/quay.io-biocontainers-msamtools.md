...
updated_at: "2026-09-26 07:18:15.332498"
...
```bash
$ shpc install quay.io/biocontainers/msamtools:1.2.0--h118bc1c_0
```
...
```bash
$ module load quay.io/biocontainers/msamtools/1.2.0--h118bc1c_0
$ module help quay.io/biocontainers/msamtools/1.2.0--h118bc1c_0
```
