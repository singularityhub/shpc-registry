---
layout: container
name:  "quay.io/biocontainers/bioconductor-crupr"
maintainer: "@vsoch"
...
updated_at: "2026-03-25 05:09:32.713065"
...
versions:
 - "1.2.0--r45hdfd78af_0"
description: "singularity registry hpc automated addition for bioconductor-crupr"
config: {"url": "https://biocontainers.pro/tools/bioconductor-crupr", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for bioconductor-crupr", "latest": {"1.2.0--r45hdfd78af_0": "sha256:873f46a2cae403a10e6f7c2fb5ccd310e607bc5f34ca5353bc81598946c0fead"}, "tags": {"1.2.0--r45hdfd78af_0": "sha256:873f46a2cae403a10e6f7c2fb5ccd310e607bc5f34ca5353bc81598946c0fead"}, "docker": "quay.io/biocontainers/bioconductor-crupr", "aliases": {"idle3.14": "/usr/local/bin/idle3.14", "pydoc3.14": "/usr/local/bin/pydoc3.14", "python3.14": "/usr/local/bin/python3.14", "python3.14-config": "/usr/local/bin/python3.14-config", "x86_64-conda-linux-gnu.cfg": "/usr/local/bin/x86_64-conda-linux-gnu.cfg", "installBiocDataPackage.sh": "/usr/local/bin/installBiocDataPackage.sh", "tomlq": "/usr/local/bin/tomlq", "xq": "/usr/local/bin/xq", "yq": "/usr/local/bin/yq", "jq": "/usr/local/bin/jq", "onig-config": "/usr/local/bin/onig-config", "activate-global-python-argcomplete": "/usr/local/bin/activate-global-python-argcomplete", "python-argcomplete-check-easy-install-script": "/usr/local/bin/python-argcomplete-check-easy-install-script", "register-python-argcomplete": "/usr/local/bin/register-python-argcomplete", "hb-info": "/usr/local/bin/hb-info", "tjbench": "/usr/local/bin/tjbench"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/bioconductor-crupr.
singularity registry hpc automated addition for bioconductor-crupr
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/bioconductor-crupr
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-crupr:1.2.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-crupr/1.2.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-crupr/1.2.0--r45hdfd78af_0
```
...
#### bioconductor-crupr-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-crupr-inspect-deffile:
