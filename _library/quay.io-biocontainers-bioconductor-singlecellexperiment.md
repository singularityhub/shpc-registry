...
updated_at: "2026-04-03 05:10:49.211652"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-singlecellexperiment:1.32.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-singlecellexperiment/1.32.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-singlecellexperiment/1.32.0--r45hdfd78af_0
```
