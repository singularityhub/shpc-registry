...
updated_at: "2023-10-30 03:12:42.775360"
latest: "2.64.0--r43h7c4fd5e_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-glad:2.64.0--r43h7c4fd5e_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-glad/2.64.0--r43h7c4fd5e_0
$ module help quay.io/biocontainers/bioconductor-glad/2.64.0--r43h7c4fd5e_0
```
