...
updated_at: "2026-03-27 04:38:32.623795"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-glad:2.74.0--r45h1ca3914_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-glad/2.74.0--r45h1ca3914_0
$ module help quay.io/biocontainers/bioconductor-glad/2.74.0--r45h1ca3914_0
```
