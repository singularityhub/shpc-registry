...
updated_at: "2026-05-25 06:45:28.242901"
latest: "0.10.5--h4349ce8_0"
...
```bash
$ shpc install quay.io/biocontainers/aardvark:0.10.5--h4349ce8_0
```
...
```bash
$ module load quay.io/biocontainers/aardvark/0.10.5--h4349ce8_0
$ module help quay.io/biocontainers/aardvark/0.10.5--h4349ce8_0
```
