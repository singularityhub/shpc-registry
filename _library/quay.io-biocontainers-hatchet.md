...
updated_at: "2026-03-10 04:41:24.854977"
latest: "2.2.0--py312h248b54c_0"
...
```bash
$ shpc install quay.io/biocontainers/hatchet:2.2.0--py312h248b54c_0
```
...
```bash
$ module load quay.io/biocontainers/hatchet/2.2.0--py312h248b54c_0
$ module help quay.io/biocontainers/hatchet/2.2.0--py312h248b54c_0
```
