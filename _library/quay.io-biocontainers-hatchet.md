...
updated_at: "2024-12-02 03:35:35.160417"
latest: "2.1.0--py310h84f13bb_0"
...
```bash
$ shpc install quay.io/biocontainers/hatchet:2.1.0--py310h84f13bb_0
```
...
```bash
$ module load quay.io/biocontainers/hatchet/2.1.0--py310h84f13bb_0
$ module help quay.io/biocontainers/hatchet/2.1.0--py310h84f13bb_0
```
