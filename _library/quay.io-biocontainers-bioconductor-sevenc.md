...
updated_at: "2024-05-07 02:47:22.325783"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-sevenc:1.22.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-sevenc/1.22.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-sevenc/1.22.0--r43hdfd78af_0
```
