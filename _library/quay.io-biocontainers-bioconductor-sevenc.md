...
updated_at: "2025-01-21 02:49:10.158640"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-sevenc:1.26.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-sevenc/1.26.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-sevenc/1.26.0--r44hdfd78af_0
```
