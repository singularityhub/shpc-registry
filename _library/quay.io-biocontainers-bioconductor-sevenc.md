...
updated_at: "2022-11-26 14:19:06.911613"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-sevenc:1.14.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-sevenc/1.14.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-sevenc/1.14.0--r41hdfd78af_0
```
