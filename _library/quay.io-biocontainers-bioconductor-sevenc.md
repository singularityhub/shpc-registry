...
updated_at: "2022-11-03 00:26:51.862625"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-sevenc:1.8.0--r40_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-sevenc/1.8.0--r40_0
$ module help quay.io/biocontainers/bioconductor-sevenc/1.8.0--r40_0
```
