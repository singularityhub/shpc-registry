...
updated_at: "2026-03-28 05:00:49.028911"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rtn:2.34.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rtn/2.34.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rtn/2.34.0--r45hdfd78af_0
```
