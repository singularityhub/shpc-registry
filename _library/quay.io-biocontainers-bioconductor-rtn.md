...
updated_at: "2023-02-05 03:15:32.996644"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rtn:2.22.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rtn/2.22.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rtn/2.22.0--r42hdfd78af_0
```
