...
updated_at: "2023-10-02 03:14:41.468619"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rtn:2.24.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rtn/2.24.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rtn/2.24.0--r43hdfd78af_0
```
