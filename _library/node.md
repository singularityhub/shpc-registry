...
updated_at: "2023-12-06 02:29:00.530959"
latest: "21-alpine3.18"
...
```bash
$ shpc install node:21-alpine3.18
```
...
```bash
$ module load node/21-alpine3.18
$ module help node/21-alpine3.18
```
