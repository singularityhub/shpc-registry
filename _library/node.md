...
updated_at: "2024-12-26 03:53:24.263737"
latest: "23-alpine3.20"
...
```bash
$ shpc install node:23-alpine3.20
```
...
```bash
$ module load node/23-alpine3.20
$ module help node/23-alpine3.20
```
