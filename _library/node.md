...
updated_at: "2024-07-04 04:28:01.068078"
latest: "22-alpine3.20"
...
```bash
$ shpc install node:22-alpine3.20
```
...
```bash
$ module load node/22-alpine3.20
$ module help node/22-alpine3.20
```
