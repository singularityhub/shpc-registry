...
updated_at: "2022-12-12 03:58:05.404967"
latest: "19-alpine3.16"
...
```bash
$ shpc install node:19-alpine3.16
```
...
```bash
$ module load node/19-alpine3.16
$ module help node/19-alpine3.16
```
