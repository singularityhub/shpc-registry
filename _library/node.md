...
updated_at: "2026-01-05 06:34:48.127317"
...
```bash
$ shpc install node:25-alpine3.23
```
...
```bash
$ module load node/25-alpine3.23
$ module help node/25-alpine3.23
```
