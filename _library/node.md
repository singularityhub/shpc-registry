...
updated_at: "2023-01-14 03:34:20.235942"
latest: "19-alpine3.17"
...
```bash
$ shpc install node:19-alpine3.17
```
...
```bash
$ module load node/19-alpine3.17
$ module help node/19-alpine3.17
```
