...
updated_at: "2023-05-07 02:37:11.448862"
latest: "20-alpine3.17"
...
```bash
$ shpc install node:20-alpine3.17
```
...
```bash
$ module load node/20-alpine3.17
$ module help node/20-alpine3.17
```
