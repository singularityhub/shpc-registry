...
updated_at: "2025-12-05 04:14:40.486676"
latest: "25-alpine3.22"
...
```bash
$ shpc install node:25-alpine3.22
```
...
```bash
$ module load node/25-alpine3.22
$ module help node/25-alpine3.22
```
