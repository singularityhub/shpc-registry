...
updated_at: "2024-05-11 03:11:49.469249"
latest: "22-alpine3.19"
...
```bash
$ shpc install node:22-alpine3.19
```
...
```bash
$ module load node/22-alpine3.19
$ module help node/22-alpine3.19
```
