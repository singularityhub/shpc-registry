...
updated_at: "2025-10-26 03:40:41.806673"
latest: "0.11.1--py313h366bbf7_2"
...
```bash
$ shpc install quay.io/biocontainers/pyhmmer:0.11.1--py313h366bbf7_2
```
...
```bash
$ module load quay.io/biocontainers/pyhmmer/0.11.1--py313h366bbf7_2
$ module help quay.io/biocontainers/pyhmmer/0.11.1--py313h366bbf7_2
```
