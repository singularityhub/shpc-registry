...
updated_at: "2026-08-30 08:28:13.993823"
latest: "0.12.2--py313hd978853_0"
...
```bash
$ shpc install quay.io/biocontainers/pyhmmer:0.12.2--py313hd978853_0
```
...
```bash
$ module load quay.io/biocontainers/pyhmmer/0.12.2--py313hd978853_0
$ module help quay.io/biocontainers/pyhmmer/0.12.2--py313hd978853_0
```
