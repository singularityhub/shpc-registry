...
updated_at: "2026-01-20 04:15:42.710570"
latest: "0.11.4--py311haab0aaa_0"
...
```bash
$ shpc install quay.io/biocontainers/pyhmmer:0.11.4--py311haab0aaa_0
```
...
```bash
$ module load quay.io/biocontainers/pyhmmer/0.11.4--py311haab0aaa_0
$ module help quay.io/biocontainers/pyhmmer/0.11.4--py311haab0aaa_0
```
