...
updated_at: "2024-08-13 02:56:22.879002"
latest: "0.10.14--py39hff71179_0"
...
```bash
$ shpc install quay.io/biocontainers/pyhmmer:0.10.14--py39hff71179_0
```
...
```bash
$ module load quay.io/biocontainers/pyhmmer/0.10.14--py39hff71179_0
$ module help quay.io/biocontainers/pyhmmer/0.10.14--py39hff71179_0
```
