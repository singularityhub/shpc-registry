...
updated_at: "2024-05-27 03:16:50.013186"
latest: "0.10.12--py39hf95cd2a_0"
...
```bash
$ shpc install quay.io/biocontainers/pyhmmer:0.10.12--py39hf95cd2a_0
```
...
```bash
$ module load quay.io/biocontainers/pyhmmer/0.10.12--py39hf95cd2a_0
$ module help quay.io/biocontainers/pyhmmer/0.10.12--py39hf95cd2a_0
```
