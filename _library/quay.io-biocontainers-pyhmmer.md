...
updated_at: "2025-12-16 03:55:30.894964"
latest: "0.11.2--py312h0fa9677_0"
...
```bash
$ shpc install quay.io/biocontainers/pyhmmer:0.11.2--py312h0fa9677_0
```
...
```bash
$ module load quay.io/biocontainers/pyhmmer/0.11.2--py312h0fa9677_0
$ module help quay.io/biocontainers/pyhmmer/0.11.2--py312h0fa9677_0
```
