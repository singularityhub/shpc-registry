...
updated_at: "2025-01-01 03:36:44.967504"
latest: "0.10.15--py310h1fe012e_1"
...
```bash
$ shpc install quay.io/biocontainers/pyhmmer:0.10.15--py310h1fe012e_1
```
...
```bash
$ module load quay.io/biocontainers/pyhmmer/0.10.15--py310h1fe012e_1
$ module help quay.io/biocontainers/pyhmmer/0.10.15--py310h1fe012e_1
```
