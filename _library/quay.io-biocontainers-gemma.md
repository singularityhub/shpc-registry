...
updated_at: "2026-06-03 07:02:33.868472"
...
```bash
$ shpc install quay.io/biocontainers/gemma:0.98.5--h38cc83e_1
```
...
```bash
$ module load quay.io/biocontainers/gemma/0.98.5--h38cc83e_1
$ module help quay.io/biocontainers/gemma/0.98.5--h38cc83e_1
```
