...
updated_at: "2024-04-24 02:33:21.513120"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ompbam:1.6.0--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ompbam/1.6.0--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-ompbam/1.6.0--r43hf17093f_0
```
