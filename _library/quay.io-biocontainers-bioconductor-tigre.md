...
updated_at: "2023-07-20 03:02:57.540721"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-tigre:1.52.0--r42ha9d7317_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-tigre/1.52.0--r42ha9d7317_1
$ module help quay.io/biocontainers/bioconductor-tigre/1.52.0--r42ha9d7317_1
```
