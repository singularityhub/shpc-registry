...
updated_at: "2024-12-23 03:19:28.944655"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-h10kcod.db:3.4.0--r43hdfd78af_12
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-h10kcod.db/3.4.0--r43hdfd78af_12
$ module help quay.io/biocontainers/bioconductor-h10kcod.db/3.4.0--r43hdfd78af_12
```
