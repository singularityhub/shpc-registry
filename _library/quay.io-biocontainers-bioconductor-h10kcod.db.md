...
updated_at: "2026-04-04 04:37:21.908175"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-h10kcod.db:3.4.0--r45hdfd78af_14
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-h10kcod.db/3.4.0--r45hdfd78af_14
$ module help quay.io/biocontainers/bioconductor-h10kcod.db/3.4.0--r45hdfd78af_14
```
