...
updated_at: "2022-10-27 01:04:19.488571"
latest: "5.5.0--pl5321hdfd78af_5"
...
```bash
$ shpc install quay.io/biocontainers/transdecoder:5.5.0--pl5321hdfd78af_5
```
...
```bash
$ module load quay.io/biocontainers/transdecoder/5.5.0--pl5321hdfd78af_5
$ module help quay.io/biocontainers/transdecoder/5.5.0--pl5321hdfd78af_5
```
