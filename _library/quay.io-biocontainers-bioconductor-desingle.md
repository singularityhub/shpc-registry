...
updated_at: "2024-10-29 02:57:07.703637"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-desingle:1.22.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-desingle/1.22.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-desingle/1.22.0--r43hdfd78af_0
```
