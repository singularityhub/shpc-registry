...
updated_at: "2026-03-13 17:15:55.874695"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-desingle:1.30.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-desingle/1.30.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-desingle/1.30.0--r45hdfd78af_0
```
