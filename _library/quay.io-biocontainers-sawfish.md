...
updated_at: "2026-04-05 05:21:21.833419"
...
```bash
$ shpc install quay.io/biocontainers/sawfish:2.2.1--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/sawfish/2.2.1--h9ee0642_0
$ module help quay.io/biocontainers/sawfish/2.2.1--h9ee0642_0
```
