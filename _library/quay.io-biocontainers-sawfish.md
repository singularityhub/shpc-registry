...
updated_at: "2025-08-07 04:40:15.726050"
latest: "2.0.3--h9ee0642_0"
...
```bash
$ shpc install quay.io/biocontainers/sawfish:2.0.3--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/sawfish/2.0.3--h9ee0642_0
$ module help quay.io/biocontainers/sawfish/2.0.3--h9ee0642_0
```
