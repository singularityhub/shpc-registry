...
updated_at: "2025-12-08 04:47:13.258717"
latest: "2.1.1--h9ee0642_0"
...
```bash
$ shpc install quay.io/biocontainers/sawfish:2.1.1--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/sawfish/2.1.1--h9ee0642_0
$ module help quay.io/biocontainers/sawfish/2.1.1--h9ee0642_0
```
