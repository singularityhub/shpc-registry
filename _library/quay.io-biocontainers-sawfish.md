...
updated_at: "2025-06-26 04:05:52.487092"
...
```bash
$ shpc install quay.io/biocontainers/sawfish:2.0.0--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/sawfish/2.0.0--h9ee0642_0
$ module help quay.io/biocontainers/sawfish/2.0.0--h9ee0642_0
```
