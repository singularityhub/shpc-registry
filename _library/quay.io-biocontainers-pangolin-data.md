...
updated_at: "2024-06-13 02:52:42.023975"
latest: "1.27--pyh7cba7a3_0"
...
```bash
$ shpc install quay.io/biocontainers/pangolin-data:1.27--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/pangolin-data/1.27--pyh7cba7a3_0
$ module help quay.io/biocontainers/pangolin-data/1.27--pyh7cba7a3_0
```
