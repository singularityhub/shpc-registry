...
updated_at: "2024-03-06 02:34:14.971979"
latest: "1.25.1--pyh7cba7a3_0"
...
```bash
$ shpc install quay.io/biocontainers/pangolin-data:1.25.1--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/pangolin-data/1.25.1--pyh7cba7a3_0
$ module help quay.io/biocontainers/pangolin-data/1.25.1--pyh7cba7a3_0
```
