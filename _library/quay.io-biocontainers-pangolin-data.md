...
updated_at: "2024-05-06 02:54:46.837179"
latest: "1.26--pyh7cba7a3_0"
...
```bash
$ shpc install quay.io/biocontainers/pangolin-data:1.26--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/pangolin-data/1.26--pyh7cba7a3_0
$ module help quay.io/biocontainers/pangolin-data/1.26--pyh7cba7a3_0
```
