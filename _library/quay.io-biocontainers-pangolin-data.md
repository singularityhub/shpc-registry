...
updated_at: "2026-09-21 08:38:13.335356"
latest: "1.40--pyh106432d_0"
...
```bash
$ shpc install quay.io/biocontainers/pangolin-data:1.40--pyh106432d_0
```
...
```bash
$ module load quay.io/biocontainers/pangolin-data/1.40--pyh106432d_0
$ module help quay.io/biocontainers/pangolin-data/1.40--pyh106432d_0
```
