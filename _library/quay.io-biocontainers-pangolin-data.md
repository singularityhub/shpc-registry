...
updated_at: "2023-09-18 02:37:34.405383"
latest: "1.22--pyh7cba7a3_0"
...
```bash
$ shpc install quay.io/biocontainers/pangolin-data:1.22--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/pangolin-data/1.22--pyh7cba7a3_0
$ module help quay.io/biocontainers/pangolin-data/1.22--pyh7cba7a3_0
```
