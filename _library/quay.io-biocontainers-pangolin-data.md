...
updated_at: "2023-12-09 03:01:44.062303"
latest: "1.23.1--pyh7cba7a3_0"
...
```bash
$ shpc install quay.io/biocontainers/pangolin-data:1.23.1--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/pangolin-data/1.23.1--pyh7cba7a3_0
$ module help quay.io/biocontainers/pangolin-data/1.23.1--pyh7cba7a3_0
```
