...
updated_at: "2026-06-27 06:06:22.122270"
latest: "1.39--pyh106432d_0"
...
```bash
$ shpc install quay.io/biocontainers/pangolin-data:1.39--pyh106432d_0
```
...
```bash
$ module load quay.io/biocontainers/pangolin-data/1.39--pyh106432d_0
$ module help quay.io/biocontainers/pangolin-data/1.39--pyh106432d_0
```
