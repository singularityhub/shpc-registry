...
updated_at: "2026-03-19 05:15:30.131968"
latest: "1.37.1--pyh106432d_0"
...
```bash
$ shpc install quay.io/biocontainers/pangolin-data:1.37.1--pyh106432d_0
```
...
```bash
$ module load quay.io/biocontainers/pangolin-data/1.37.1--pyh106432d_0
$ module help quay.io/biocontainers/pangolin-data/1.37.1--pyh106432d_0
```
