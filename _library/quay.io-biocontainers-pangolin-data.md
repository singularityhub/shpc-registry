...
updated_at: "2026-06-06 06:34:54.974504"
latest: "1.38--pyh106432d_0"
...
```bash
$ shpc install quay.io/biocontainers/pangolin-data:1.38--pyh106432d_0
```
...
```bash
$ module load quay.io/biocontainers/pangolin-data/1.38--pyh106432d_0
$ module help quay.io/biocontainers/pangolin-data/1.38--pyh106432d_0
```
