...
updated_at: "2024-05-24 02:47:45.258056"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cosmiq:1.36.0--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cosmiq/1.36.0--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-cosmiq/1.36.0--r43hf17093f_0
```
