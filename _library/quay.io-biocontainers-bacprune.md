---
layout: container
name:  "quay.io/biocontainers/bacprune"
maintainer: "@vsoch"
...
updated_at: "2026-05-08 05:30:27.300016"
...
singularity registry hpc automated addition for bacprune
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/bacprune
```
...
#### bacprune-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bacprune-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/bacprune
$ podman run --it --rm --entrypoint /usr/local/bin/bacprune   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/bacprune   -v ${PWD} -w ${PWD} <container> -c " $@"
```
