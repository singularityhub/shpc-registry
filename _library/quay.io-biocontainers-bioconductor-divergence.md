...
updated_at: "2026-03-23 05:26:52.010471"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-divergence:1.26.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-divergence/1.26.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-divergence/1.26.0--r45hdfd78af_0
```
