...
updated_at: "2023-12-30 04:39:13.669875"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ssrch:1.16.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ssrch/1.16.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ssrch/1.16.0--r43hdfd78af_0
```
