...
updated_at: "2026-03-25 04:59:08.130916"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-qdnaseq.mm10:1.40.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-qdnaseq.mm10/1.40.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-qdnaseq.mm10/1.40.0--r45hdfd78af_0
```
