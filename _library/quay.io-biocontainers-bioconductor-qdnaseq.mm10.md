...
updated_at: "2023-08-23 03:20:38.067217"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-qdnaseq.mm10:1.30.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-qdnaseq.mm10/1.30.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-qdnaseq.mm10/1.30.0--r43hdfd78af_0
```
