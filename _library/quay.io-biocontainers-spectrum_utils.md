...
updated_at: "2025-12-22 05:25:32.179427"
...
```bash
$ shpc install quay.io/biocontainers/spectrum_utils:0.5.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/spectrum_utils/0.5.0--pyhdfd78af_0
$ module help quay.io/biocontainers/spectrum_utils/0.5.0--pyhdfd78af_0
```
