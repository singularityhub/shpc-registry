...
updated_at: "2023-08-29 03:46:05.651982"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cftools:1.0.0--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cftools/1.0.0--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-cftools/1.0.0--r43hf17093f_0
```
