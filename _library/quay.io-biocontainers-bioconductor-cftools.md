...
updated_at: "2024-09-02 04:30:18.998890"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cftools:1.2.0--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cftools/1.2.0--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-cftools/1.2.0--r43hf17093f_0
```
