...
updated_at: "2023-11-18 02:58:36.868865"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rgu34bcdf:2.18.0--r43hdfd78af_11
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rgu34bcdf/2.18.0--r43hdfd78af_11
$ module help quay.io/biocontainers/bioconductor-rgu34bcdf/2.18.0--r43hdfd78af_11
```
