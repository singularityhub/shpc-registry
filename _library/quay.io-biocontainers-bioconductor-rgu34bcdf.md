...
updated_at: "2026-04-04 04:56:11.600106"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rgu34bcdf:2.18.0--r45hdfd78af_14
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rgu34bcdf/2.18.0--r45hdfd78af_14
$ module help quay.io/biocontainers/bioconductor-rgu34bcdf/2.18.0--r45hdfd78af_14
```
