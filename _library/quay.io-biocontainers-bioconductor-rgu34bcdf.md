...
updated_at: "2024-10-31 03:49:29.300039"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rgu34bcdf:2.18.0--r43hdfd78af_12
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rgu34bcdf/2.18.0--r43hdfd78af_12
$ module help quay.io/biocontainers/bioconductor-rgu34bcdf/2.18.0--r43hdfd78af_12
```
