...
updated_at: "2023-05-23 03:16:18.419874"
latest: "0.2.5_RN--py311r42hec16e2b_4"
...
```bash
$ shpc install quay.io/biocontainers/smudgeplot_rn:0.2.5_RN--py311r42hec16e2b_4
```
...
```bash
$ module load quay.io/biocontainers/smudgeplot_rn/0.2.5_RN--py311r42hec16e2b_4
$ module help quay.io/biocontainers/smudgeplot_rn/0.2.5_RN--py311r42hec16e2b_4
```
