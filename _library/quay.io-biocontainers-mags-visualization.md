...
updated_at: "2026-02-18 04:30:54.279966"
...
```bash
$ shpc install quay.io/biocontainers/mags-visualization:0.0.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mags-visualization/0.0.2--pyhdfd78af_0
$ module help quay.io/biocontainers/mags-visualization/0.0.2--pyhdfd78af_0
```
