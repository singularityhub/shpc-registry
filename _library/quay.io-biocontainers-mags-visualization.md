---
layout: container
name:  "quay.io/biocontainers/mags-visualization"
maintainer: "@vsoch"
...
updated_at: "2026-07-02 06:06:46.256158"
...
```bash
$ module load quay.io/biocontainers/mags-visualization/0.0.11--pyhdfd78af_0
$ module help quay.io/biocontainers/mags-visualization/0.0.11--pyhdfd78af_0
```
...
#### mags-visualization-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### mags-visualization-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/mags-visualization
$ podman run --it --rm --entrypoint /usr/local/bin/mags-visualization   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/mags-visualization   -v ${PWD} -w ${PWD} <container> -c " $@"
```
