...
updated_at: "2025-11-10 04:07:01.039759"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-multiwgcna:1.4.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-multiwgcna/1.4.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-multiwgcna/1.4.0--r44hdfd78af_0
```
