---
layout: container
name:  "quay.io/biocontainers/bioconductor-multiwgcna"
maintainer: "@vsoch"
github: "https://github.com/singularityhub/shpc-registry/blob/main/quay.io/biocontainers/bioconductor-multiwgcna/container.yaml"
config_url: "https://raw.githubusercontent.com/singularityhub/shpc-registry/main/quay.io/biocontainers/bioconductor-multiwgcna/container.yaml"
updated_at: "2026-03-28 05:07:38.095758"
latest: "1.7.0--r45hdfd78af_0"
container_url: "https://biocontainers.pro/tools/bioconductor-multiwgcna"
aliases:
 - "pcre2posix_test"
 - "2to3-3.12"
 - "idle3.12"
...
versions:
 ...
 - "1.4.0--r44hdfd78af_0"
 - "1.7.0--r45hdfd78af_0"
description: "singularity registry hpc automated addition for bioconductor-multiwgcna"
config: {"url": "https://biocontainers.pro/tools/bioconductor-multiwgcna", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for bioconductor-multiwgcna", "latest": {"1.7.0--r45hdfd78af_0": "sha256:8077ada582babcd8fd12f419f1fe89fe63b0992bf2435d605c7deed822828b0d"}, "tags": {"1.0.0--r43hdfd78af_0": "sha256:94e3ba9b64d6311cfa98b225048a260f913f324f606df448446fecb26270dc1a", "1.4.0--r44hdfd78af_0": "sha256:61ddad3695946968c8e5b97aa82f25e9bbd29b6df40542ef837097e13f67fd3c", "1.7.0--r45hdfd78af_0": "sha256:8077ada582babcd8fd12f419f1fe89fe63b0992bf2435d605c7deed822828b0d"}, "docker": "quay.io/biocontainers/bioconductor-multiwgcna", "aliases": {"pcre2posix_test": "/usr/local/bin/pcre2posix_test", "2to3-3.12": "/usr/local/bin/2to3-3.12", "idle3.12": "/usr/local/bin/idle3.12", "pydoc3.12": "/usr/local/bin/pydoc3.12", "python3.12": "/usr/local/bin/python3.12", "python3.12-config": "/usr/local/bin/python3.12-config", "hb-info": "/usr/local/bin/hb-info", "glpsol": "/usr/local/bin/glpsol", "installBiocDataPackage.sh": "/usr/local/bin/installBiocDataPackage.sh", "tjbench": "/usr/local/bin/tjbench", "tomlq": "/usr/local/bin/tomlq", "xq": "/usr/local/bin/xq", "yq": "/usr/local/bin/yq", "jq": "/usr/local/bin/jq", "onig-config": "/usr/local/bin/onig-config", "activate-global-python-argcomplete": "/usr/local/bin/activate-global-python-argcomplete", "python-argcomplete-check-easy-install-script": "/usr/local/bin/python-argcomplete-check-easy-install-script", "register-python-argcomplete": "/usr/local/bin/register-python-argcomplete", "pandoc": "/usr/local/bin/pandoc"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/bioconductor-multiwgcna.
singularity registry hpc automated addition for bioconductor-multiwgcna
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/bioconductor-multiwgcna
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-multiwgcna:1.7.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-multiwgcna/1.7.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-multiwgcna/1.7.0--r45hdfd78af_0
```
...
#### bioconductor-multiwgcna-inspect:
...
#### bioconductor-multiwgcna-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-multiwgcna-inspect-deffile:
