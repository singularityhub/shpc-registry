...
updated_at: "2024-09-20 03:47:56.146317"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-multiwgcna:1.0.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-multiwgcna/1.0.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-multiwgcna/1.0.0--r43hdfd78af_0
```
