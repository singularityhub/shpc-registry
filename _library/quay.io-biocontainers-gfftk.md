...
updated_at: "2026-06-07 06:41:02.370423"
...
```bash
$ shpc install quay.io/biocontainers/gfftk:26.5.22--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/gfftk/26.5.22--pyhdfd78af_0
$ module help quay.io/biocontainers/gfftk/26.5.22--pyhdfd78af_0
```
