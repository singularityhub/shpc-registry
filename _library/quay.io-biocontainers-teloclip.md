...
updated_at: "2026-04-05 04:46:23.639015"
...
```bash
$ shpc install quay.io/biocontainers/teloclip:0.3.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/teloclip/0.3.4--pyhdfd78af_0
$ module help quay.io/biocontainers/teloclip/0.3.4--pyhdfd78af_0
```
