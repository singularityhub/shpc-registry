...
updated_at: "2026-09-03 07:32:24.495453"
...
```bash
$ shpc install quay.io/biocontainers/teloclip:0.4.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/teloclip/0.4.0--pyhdfd78af_0
$ module help quay.io/biocontainers/teloclip/0.4.0--pyhdfd78af_0
```
