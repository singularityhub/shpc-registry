---
layout: container
name:  "quay.io/biocontainers/iprophit"
maintainer: "@vsoch"
...
updated_at: "2026-03-30 06:08:40.263042"
...
singularity registry hpc automated addition for iprophit
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/iprophit
```
...
#### iprophit-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### iprophit-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/iprophit
$ podman run --it --rm --entrypoint /usr/local/bin/iprophit   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/iprophit   -v ${PWD} -w ${PWD} <container> -c " $@"
```
