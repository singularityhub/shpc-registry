...
updated_at: "2024-12-26 03:41:00.428487"
...
```bash
$ shpc install quay.io/biocontainers/seismic-rna:0.22.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/seismic-rna/0.22.1--pyhdfd78af_0
$ module help quay.io/biocontainers/seismic-rna/0.22.1--pyhdfd78af_0
```
