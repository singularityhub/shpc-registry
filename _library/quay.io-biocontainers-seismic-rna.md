...
updated_at: "2024-10-28 03:31:40.499294"
...
```bash
$ shpc install quay.io/biocontainers/seismic-rna:0.21.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/seismic-rna/0.21.0--pyhdfd78af_0
$ module help quay.io/biocontainers/seismic-rna/0.21.0--pyhdfd78af_0
```
