...
updated_at: "2025-09-16 03:02:15.370788"
latest: "0.24.2--py311haab0aaa_0"
...
```bash
$ shpc install quay.io/biocontainers/seismic-rna:0.24.2--py311haab0aaa_0
```
...
```bash
$ module load quay.io/biocontainers/seismic-rna/0.24.2--py311haab0aaa_0
$ module help quay.io/biocontainers/seismic-rna/0.24.2--py311haab0aaa_0
```
