...
updated_at: "2025-02-27 02:57:49.754910"
latest: "0.23.1--py311haab0aaa_0"
...
```bash
$ shpc install quay.io/biocontainers/seismic-rna:0.23.1--py311haab0aaa_0
```
...
```bash
$ module load quay.io/biocontainers/seismic-rna/0.23.1--py311haab0aaa_0
$ module help quay.io/biocontainers/seismic-rna/0.23.1--py311haab0aaa_0
```
