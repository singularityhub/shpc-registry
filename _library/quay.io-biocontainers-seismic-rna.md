...
updated_at: "2026-03-21 04:35:45.958175"
latest: "0.24.4--py311haab0aaa_0"
...
```bash
$ shpc install quay.io/biocontainers/seismic-rna:0.24.4--py311haab0aaa_0
```
...
```bash
$ module load quay.io/biocontainers/seismic-rna/0.24.4--py311haab0aaa_0
$ module help quay.io/biocontainers/seismic-rna/0.24.4--py311haab0aaa_0
```
