...
updated_at: "2025-12-25 04:03:51.766140"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cfdnakit:1.4.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cfdnakit/1.4.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-cfdnakit/1.4.0--r44hdfd78af_0
```
