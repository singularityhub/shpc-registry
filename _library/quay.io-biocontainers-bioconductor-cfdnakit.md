...
updated_at: "2024-01-10 23:54:24.070319"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cfdnakit:1.0.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cfdnakit/1.0.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-cfdnakit/1.0.0--r43hdfd78af_0
```
