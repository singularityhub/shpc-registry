...
updated_at: "2026-09-23 07:44:02.815308"
...
```bash
$ shpc install quay.io/biocontainers/commec:2.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/commec/2.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/commec/2.1.0--pyhdfd78af_0
```
