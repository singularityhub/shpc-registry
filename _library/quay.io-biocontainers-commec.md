...
updated_at: "2026-08-25 09:57:51.380833"
...
```bash
$ shpc install quay.io/biocontainers/commec:2.0.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/commec/2.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/commec/2.0.0--pyhdfd78af_0
```
