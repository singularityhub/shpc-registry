...
updated_at: "2026-06-23 07:00:57.658544"
...
```bash
$ shpc install quay.io/biocontainers/commec:1.0.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/commec/1.0.5--pyhdfd78af_0
$ module help quay.io/biocontainers/commec/1.0.5--pyhdfd78af_0
```
