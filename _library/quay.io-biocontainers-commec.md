...
updated_at: "2024-12-05 03:52:38.846343"
...
```bash
$ shpc install quay.io/biocontainers/commec:0.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/commec/0.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/commec/0.2.0--pyhdfd78af_0
```
