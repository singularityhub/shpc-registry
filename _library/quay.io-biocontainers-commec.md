...
updated_at: "2026-06-01 07:12:23.221187"
...
```bash
$ shpc install quay.io/biocontainers/commec:1.0.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/commec/1.0.4--pyhdfd78af_0
$ module help quay.io/biocontainers/commec/1.0.4--pyhdfd78af_0
```
