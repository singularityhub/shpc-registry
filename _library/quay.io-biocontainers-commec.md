...
updated_at: "2026-03-24 05:14:45.626745"
...
```bash
$ shpc install quay.io/biocontainers/commec:1.0.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/commec/1.0.3--pyhdfd78af_0
$ module help quay.io/biocontainers/commec/1.0.3--pyhdfd78af_0
```
