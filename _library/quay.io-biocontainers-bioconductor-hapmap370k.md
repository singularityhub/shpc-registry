...
updated_at: "2026-04-01 05:28:50.976171"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hapmap370k:1.0.1--r45hdfd78af_14
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hapmap370k/1.0.1--r45hdfd78af_14
$ module help quay.io/biocontainers/bioconductor-hapmap370k/1.0.1--r45hdfd78af_14
```
