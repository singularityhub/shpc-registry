...
updated_at: "2026-03-27 05:15:05.032404"
...
```bash
$ shpc install quay.io/biocontainers/dartunifrac:0.3.0--h3dc2dae_0
```
...
```bash
$ module load quay.io/biocontainers/dartunifrac/0.3.0--h3dc2dae_0
$ module help quay.io/biocontainers/dartunifrac/0.3.0--h3dc2dae_0
```
