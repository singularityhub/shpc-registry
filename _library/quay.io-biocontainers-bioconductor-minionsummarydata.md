...
updated_at: "2022-11-02 00:25:43.162233"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-minionsummarydata:1.24.0--r41hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-minionsummarydata/1.24.0--r41hdfd78af_1
$ module help quay.io/biocontainers/bioconductor-minionsummarydata/1.24.0--r41hdfd78af_1
```
