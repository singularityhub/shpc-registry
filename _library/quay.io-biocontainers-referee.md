---
layout: container
name:  "quay.io/biocontainers/referee"
maintainer: "@vsoch"
...
updated_at: "2024-03-08 02:27:49.473649"
...
```bash
$ module load quay.io/biocontainers/referee/1.2--hdfd78af_0
$ module help quay.io/biocontainers/referee/1.2--hdfd78af_0
```
...
#### referee-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### referee-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/referee.py
$ podman run --it --rm --entrypoint /usr/local/bin/referee.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/referee.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
