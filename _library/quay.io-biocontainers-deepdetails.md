...
updated_at: "2025-04-17 04:27:17.117768"
latest: "0.0.1rc1--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/deepdetails:0.0.1rc1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/deepdetails/0.0.1rc1--pyhdfd78af_0
$ module help quay.io/biocontainers/deepdetails/0.0.1rc1--pyhdfd78af_0
```
