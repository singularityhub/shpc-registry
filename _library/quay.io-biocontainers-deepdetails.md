...
updated_at: "2026-08-15 03:02:52.052647"
latest: "1.0.0rc1--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/deepdetails:1.0.0rc1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/deepdetails/1.0.0rc1--pyhdfd78af_0
$ module help quay.io/biocontainers/deepdetails/1.0.0rc1--pyhdfd78af_0
```
