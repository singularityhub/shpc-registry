...
updated_at: "2025-12-27 04:15:07.968909"
latest: "2.2.0--py39hbcbf7aa_1"
...
```bash
$ shpc install quay.io/biocontainers/primer3-py:2.2.0--py39hbcbf7aa_1
```
...
```bash
$ module load quay.io/biocontainers/primer3-py/2.2.0--py39hbcbf7aa_1
$ module help quay.io/biocontainers/primer3-py/2.2.0--py39hbcbf7aa_1
```
