...
updated_at: "2024-07-04 02:51:12.647742"
latest: "2.0.3--py312hf67a6ed_2"
...
```bash
$ shpc install quay.io/biocontainers/primer3-py:2.0.3--py312hf67a6ed_2
```
...
```bash
$ module load quay.io/biocontainers/primer3-py/2.0.3--py312hf67a6ed_2
$ module help quay.io/biocontainers/primer3-py/2.0.3--py312hf67a6ed_2
```
