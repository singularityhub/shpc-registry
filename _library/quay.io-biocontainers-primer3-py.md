...
updated_at: "2024-06-01 02:37:19.076682"
latest: "2.0.3--py39hf95cd2a_1"
...
```bash
$ shpc install quay.io/biocontainers/primer3-py:2.0.3--py39hf95cd2a_1
```
...
```bash
$ module load quay.io/biocontainers/primer3-py/2.0.3--py39hf95cd2a_1
$ module help quay.io/biocontainers/primer3-py/2.0.3--py39hf95cd2a_1
```
