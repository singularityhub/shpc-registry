...
updated_at: "2026-01-21 04:37:30.647863"
latest: "2.3.0--py312h0fa9677_0"
...
```bash
$ shpc install quay.io/biocontainers/primer3-py:2.3.0--py312h0fa9677_0
```
...
```bash
$ module load quay.io/biocontainers/primer3-py/2.3.0--py312h0fa9677_0
$ module help quay.io/biocontainers/primer3-py/2.3.0--py312h0fa9677_0
```
