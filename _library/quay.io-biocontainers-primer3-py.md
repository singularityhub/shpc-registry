...
updated_at: "2026-06-11 15:50:37.468434"
latest: "2.3.0--py312hfabe715_1"
...
```bash
$ shpc install quay.io/biocontainers/primer3-py:2.3.0--py312hfabe715_1
```
...
```bash
$ module load quay.io/biocontainers/primer3-py/2.3.0--py312hfabe715_1
$ module help quay.io/biocontainers/primer3-py/2.3.0--py312hfabe715_1
```
