...
updated_at: "2026-07-01 07:03:12.566774"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mgu74bcdf:2.18.0--r45hdfd78af_14
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mgu74bcdf/2.18.0--r45hdfd78af_14
$ module help quay.io/biocontainers/bioconductor-mgu74bcdf/2.18.0--r45hdfd78af_14
```
