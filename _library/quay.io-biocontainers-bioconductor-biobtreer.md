...
updated_at: "2022-10-29 05:43:15.574291"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-biobtreer:1.6.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-biobtreer/1.6.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-biobtreer/1.6.0--r41hdfd78af_0
```
