...
updated_at: "2026-03-23 05:58:53.238160"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-biobtreer:1.22.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-biobtreer/1.22.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-biobtreer/1.22.0--r45hdfd78af_0
```
