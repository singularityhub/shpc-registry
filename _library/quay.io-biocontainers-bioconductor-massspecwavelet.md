...
updated_at: "2026-03-07 04:13:50.547664"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-massspecwavelet:1.76.0--r45h01b2380_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-massspecwavelet/1.76.0--r45h01b2380_0
$ module help quay.io/biocontainers/bioconductor-massspecwavelet/1.76.0--r45h01b2380_0
```
