...
updated_at: "2026-03-29 05:26:31.783385"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-usort:1.36.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-usort/1.36.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-usort/1.36.0--r45hdfd78af_0
```
