...
updated_at: "2024-12-22 03:00:07.629081"
latest: "4.3.0--py312h090a2e0_4"
...
```bash
$ shpc install quay.io/biocontainers/rmats:4.3.0--py312h090a2e0_4
```
...
```bash
$ module load quay.io/biocontainers/rmats/4.3.0--py312h090a2e0_4
$ module help quay.io/biocontainers/rmats/4.3.0--py312h090a2e0_4
```
