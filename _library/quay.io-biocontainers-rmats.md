...
updated_at: "2026-08-17 03:58:13.650320"
...
```bash
$ shpc install quay.io/biocontainers/rmats:4.4.0--py312h34de56a_0
```
...
```bash
$ module load quay.io/biocontainers/rmats/4.4.0--py312h34de56a_0
$ module help quay.io/biocontainers/rmats/4.4.0--py312h34de56a_0
```
