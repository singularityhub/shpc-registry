...
updated_at: "2023-12-19 02:49:29.704510"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-kodata:1.26.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-kodata/1.26.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-kodata/1.26.0--r43hdfd78af_0
```
