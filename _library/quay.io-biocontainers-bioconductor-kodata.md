...
updated_at: "2023-03-11 03:19:11.354395"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-kodata:1.24.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-kodata/1.24.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-kodata/1.24.0--r42hdfd78af_0
```
