...
updated_at: "2026-04-17 05:27:54.926395"
...
```bash
$ shpc install quay.io/biocontainers/hlafreq:0.0.6--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hlafreq/0.0.6--pyhdfd78af_0
$ module help quay.io/biocontainers/hlafreq/0.0.6--pyhdfd78af_0
```
