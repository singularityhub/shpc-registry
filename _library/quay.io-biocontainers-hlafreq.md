...
updated_at: "2023-07-27 02:29:44.157679"
...
```bash
$ shpc install quay.io/biocontainers/hlafreq:0.0.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hlafreq/0.0.2--pyhdfd78af_0
$ module help quay.io/biocontainers/hlafreq/0.0.2--pyhdfd78af_0
```
