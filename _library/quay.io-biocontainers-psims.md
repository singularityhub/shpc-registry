...
updated_at: "2024-08-22 19:42:45.163731"
...
```bash
$ shpc install quay.io/biocontainers/psims:1.3.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/psims/1.3.3--pyhdfd78af_0
$ module help quay.io/biocontainers/psims/1.3.3--pyhdfd78af_0
```
