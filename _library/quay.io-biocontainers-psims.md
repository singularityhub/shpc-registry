...
updated_at: "2023-11-13 03:08:05.402527"
...
```bash
$ shpc install quay.io/biocontainers/psims:1.3.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/psims/1.3.1--pyhdfd78af_0
$ module help quay.io/biocontainers/psims/1.3.1--pyhdfd78af_0
```
