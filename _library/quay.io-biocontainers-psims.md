...
updated_at: "2025-02-04 03:28:39.699870"
...
```bash
$ shpc install quay.io/biocontainers/psims:1.3.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/psims/1.3.4--pyhdfd78af_0
$ module help quay.io/biocontainers/psims/1.3.4--pyhdfd78af_0
```
