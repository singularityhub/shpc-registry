...
updated_at: "2024-05-07 02:45:05.705982"
...
```bash
$ shpc install quay.io/biocontainers/psims:1.3.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/psims/1.3.2--pyhdfd78af_0
$ module help quay.io/biocontainers/psims/1.3.2--pyhdfd78af_0
```
