...
updated_at: "2023-09-19 03:02:28.876190"
latest: "1.2.7--pyh7cba7a3_0"
...
```bash
$ shpc install quay.io/biocontainers/psims:1.2.7--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/psims/1.2.7--pyh7cba7a3_0
$ module help quay.io/biocontainers/psims/1.2.7--pyh7cba7a3_0
```
