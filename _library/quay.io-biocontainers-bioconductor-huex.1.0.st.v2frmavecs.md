...
updated_at: "2026-04-04 05:01:20.294354"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-huex.1.0.st.v2frmavecs:1.1.0--r45hdfd78af_14
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-huex.1.0.st.v2frmavecs/1.1.0--r45hdfd78af_14
$ module help quay.io/biocontainers/bioconductor-huex.1.0.st.v2frmavecs/1.1.0--r45hdfd78af_14
```
