...
updated_at: "2023-10-26 02:56:15.628488"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-imman:1.20.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-imman/1.20.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-imman/1.20.0--r43hdfd78af_0
```
