...
updated_at: "2026-05-21 06:27:13.892501"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-imman:1.30.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-imman/1.30.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-imman/1.30.0--r45hdfd78af_0
```
