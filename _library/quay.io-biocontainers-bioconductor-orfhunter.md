...
updated_at: "2023-11-14 02:49:13.388790"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-orfhunter:1.8.0--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-orfhunter/1.8.0--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-orfhunter/1.8.0--r43hf17093f_0
```
