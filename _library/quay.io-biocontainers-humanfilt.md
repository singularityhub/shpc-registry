...
updated_at: "2025-10-17 03:37:26.525132"
...
```bash
$ shpc install quay.io/biocontainers/humanfilt:0.1.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/humanfilt/0.1.1--pyhdfd78af_0
$ module help quay.io/biocontainers/humanfilt/0.1.1--pyhdfd78af_0
```
