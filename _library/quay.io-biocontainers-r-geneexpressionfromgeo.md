...
updated_at: "2025-12-08 05:27:24.492209"
latest: "1.2--r44h3121a25_0"
...
```bash
$ shpc install quay.io/biocontainers/r-geneexpressionfromgeo:1.2--r44h3121a25_0
```
...
```bash
$ module load quay.io/biocontainers/r-geneexpressionfromgeo/1.2--r44h3121a25_0
$ module help quay.io/biocontainers/r-geneexpressionfromgeo/1.2--r44h3121a25_0
```
