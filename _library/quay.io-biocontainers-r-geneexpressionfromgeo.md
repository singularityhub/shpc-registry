...
updated_at: "2025-03-02 03:06:09.036459"
latest: "0.9--r44h3121a25_3"
...
```bash
$ shpc install quay.io/biocontainers/r-geneexpressionfromgeo:0.9--r44h3121a25_3
```
...
```bash
$ module load quay.io/biocontainers/r-geneexpressionfromgeo/0.9--r44h3121a25_3
$ module help quay.io/biocontainers/r-geneexpressionfromgeo/0.9--r44h3121a25_3
```
