...
updated_at: "2026-02-03 05:02:19.231754"
latest: "1.3--r44h3121a25_0"
...
```bash
$ shpc install quay.io/biocontainers/r-geneexpressionfromgeo:1.3--r44h3121a25_0
```
...
```bash
$ module load quay.io/biocontainers/r-geneexpressionfromgeo/1.3--r44h3121a25_0
$ module help quay.io/biocontainers/r-geneexpressionfromgeo/1.3--r44h3121a25_0
```
