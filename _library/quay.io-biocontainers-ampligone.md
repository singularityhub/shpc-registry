...
updated_at: "2026-01-12 03:58:14.637249"
...
```bash
$ shpc install quay.io/biocontainers/ampligone:2.0.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ampligone/2.0.2--pyhdfd78af_0
$ module help quay.io/biocontainers/ampligone/2.0.2--pyhdfd78af_0
```
