...
updated_at: "2023-12-23 02:58:37.615881"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-anota:1.48.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-anota/1.48.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-anota/1.48.0--r43hdfd78af_0
```
