...
updated_at: "2025-05-19 03:32:48.534780"
...
```bash
$ shpc install quay.io/biocontainers/hmftools-sv-prep:1.2.4--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hmftools-sv-prep/1.2.4--hdfd78af_0
$ module help quay.io/biocontainers/hmftools-sv-prep/1.2.4--hdfd78af_0
```
