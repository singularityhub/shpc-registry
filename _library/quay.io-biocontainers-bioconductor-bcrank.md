...
updated_at: "2026-04-02 05:13:03.940720"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-bcrank:1.72.0--r45h01b2380_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-bcrank/1.72.0--r45h01b2380_0
$ module help quay.io/biocontainers/bioconductor-bcrank/1.72.0--r45h01b2380_0
```
