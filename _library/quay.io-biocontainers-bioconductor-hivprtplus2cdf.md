...
updated_at: "2026-01-31 04:20:51.959430"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hivprtplus2cdf:2.18.0--r44hdfd78af_13
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hivprtplus2cdf/2.18.0--r44hdfd78af_13
$ module help quay.io/biocontainers/bioconductor-hivprtplus2cdf/2.18.0--r44hdfd78af_13
```
