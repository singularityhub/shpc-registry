...
updated_at: "2025-10-09 03:24:52.716173"
latest: "0.51.1--h2b92561_2"
...
```bash
$ shpc install quay.io/biocontainers/kallisto:0.51.1--h2b92561_2
```
...
```bash
$ module load quay.io/biocontainers/kallisto/0.51.1--h2b92561_2
$ module help quay.io/biocontainers/kallisto/0.51.1--h2b92561_2
```
