...
updated_at: "2026-06-16 07:58:06.490770"
latest: "0.52.0--h13ff97a_0"
...
```bash
$ shpc install quay.io/biocontainers/kallisto:0.52.0--h13ff97a_0
```
...
```bash
$ module load quay.io/biocontainers/kallisto/0.52.0--h13ff97a_0
$ module help quay.io/biocontainers/kallisto/0.52.0--h13ff97a_0
```
