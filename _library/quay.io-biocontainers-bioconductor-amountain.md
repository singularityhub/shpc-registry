...
updated_at: "2026-03-26 05:14:05.793772"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-amountain:1.36.0--r45h57f0213_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-amountain/1.36.0--r45h57f0213_0
$ module help quay.io/biocontainers/bioconductor-amountain/1.36.0--r45h57f0213_0
```
