...
updated_at: "2022-11-04 00:22:27.337606"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-amountain:1.8.0--r351ha21c8aa_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-amountain/1.8.0--r351ha21c8aa_0
$ module help quay.io/biocontainers/bioconductor-amountain/1.8.0--r351ha21c8aa_0
```
