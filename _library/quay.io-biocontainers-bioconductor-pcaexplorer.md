...
updated_at: "2024-04-09 02:50:29.492822"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-pcaexplorer:2.28.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-pcaexplorer/2.28.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-pcaexplorer/2.28.0--r43hdfd78af_0
```
