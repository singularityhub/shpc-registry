...
updated_at: "2026-03-26 05:22:45.942007"
latest: "3.4.0--r45hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-pcaexplorer:3.4.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-pcaexplorer/3.4.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-pcaexplorer/3.4.0--r45hdfd78af_0
```
