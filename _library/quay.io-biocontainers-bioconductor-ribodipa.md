...
updated_at: "2023-07-06 03:53:09.528606"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ribodipa:1.6.0--r42hf17093f_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ribodipa/1.6.0--r42hf17093f_1
$ module help quay.io/biocontainers/bioconductor-ribodipa/1.6.0--r42hf17093f_1
```
