...
updated_at: "2025-05-08 03:20:56.441051"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ballgown:2.38.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ballgown/2.38.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ballgown/2.38.0--r44hdfd78af_0
```
