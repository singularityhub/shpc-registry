...
updated_at: "2025-10-22 04:05:30.723817"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-breastcancerupp:1.44.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-breastcancerupp/1.44.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-breastcancerupp/1.44.0--r44hdfd78af_0
```
