...
updated_at: "2025-08-12 03:26:59.131907"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-smite:1.34.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-smite/1.34.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-smite/1.34.0--r44hdfd78af_0
```
