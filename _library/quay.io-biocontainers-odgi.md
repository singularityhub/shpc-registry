...
updated_at: "2025-05-08 05:12:28.118664"
latest: "0.9.1--py39h475c85d_0"
...
```bash
$ shpc install quay.io/biocontainers/odgi:0.9.1--py39h475c85d_0
```
...
```bash
$ module load quay.io/biocontainers/odgi/0.9.1--py39h475c85d_0
$ module help quay.io/biocontainers/odgi/0.9.1--py39h475c85d_0
```
