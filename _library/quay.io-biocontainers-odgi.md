...
updated_at: "2024-12-19 03:26:30.919652"
...
```bash
$ shpc install quay.io/biocontainers/odgi:0.9.0--py312h5e9d817_1
```
...
```bash
$ module load quay.io/biocontainers/odgi/0.9.0--py312h5e9d817_1
$ module help quay.io/biocontainers/odgi/0.9.0--py312h5e9d817_1
```
