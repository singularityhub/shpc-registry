...
updated_at: "2024-06-27 02:50:19.243910"
latest: "0.8.6--py310hdf79db3_1"
...
```bash
$ shpc install quay.io/biocontainers/odgi:0.8.6--py310hdf79db3_1
```
...
```bash
$ module load quay.io/biocontainers/odgi/0.8.6--py310hdf79db3_1
$ module help quay.io/biocontainers/odgi/0.8.6--py310hdf79db3_1
```
