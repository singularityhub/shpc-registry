...
updated_at: "2025-05-23 03:42:09.171064"
latest: "0.9.2--py39h475c85d_0"
...
```bash
$ shpc install quay.io/biocontainers/odgi:0.9.2--py39h475c85d_0
```
...
```bash
$ module load quay.io/biocontainers/odgi/0.9.2--py39h475c85d_0
$ module help quay.io/biocontainers/odgi/0.9.2--py39h475c85d_0
```
