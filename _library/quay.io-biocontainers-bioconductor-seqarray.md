...
updated_at: "2024-08-11 03:25:04.195073"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-seqarray:1.42.4--r43hf17093f_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-seqarray/1.42.4--r43hf17093f_1
$ module help quay.io/biocontainers/bioconductor-seqarray/1.42.4--r43hf17093f_1
```
