...
updated_at: "2022-10-29 05:52:47.356507"
latest: "1.8.2--r351_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ggcyto:1.8.2--r351_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ggcyto/1.8.2--r351_0
$ module help quay.io/biocontainers/bioconductor-ggcyto/1.8.2--r351_0
```
