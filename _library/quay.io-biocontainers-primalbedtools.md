...
updated_at: "2025-08-15 05:55:21.938301"
...
```bash
$ shpc install quay.io/biocontainers/primalbedtools:0.9--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/primalbedtools/0.9--pyhdfd78af_0
$ module help quay.io/biocontainers/primalbedtools/0.9--pyhdfd78af_0
```
