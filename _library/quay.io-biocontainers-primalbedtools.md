...
updated_at: "2026-08-22 03:26:27.540141"
...
```bash
$ shpc install quay.io/biocontainers/primalbedtools:1.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/primalbedtools/1.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/primalbedtools/1.1.0--pyhdfd78af_0
```
