...
updated_at: "2025-01-08 03:12:19.492821"
...
```bash
$ shpc install quay.io/biocontainers/libopenms:3.2.0--haddbca4_5
```
...
```bash
$ module load quay.io/biocontainers/libopenms/3.2.0--haddbca4_5
$ module help quay.io/biocontainers/libopenms/3.2.0--haddbca4_5
```
