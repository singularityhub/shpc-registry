...
updated_at: "2025-05-26 03:50:21.983051"
latest: "3.4.0--hc77a4c7_0"
...
```bash
$ shpc install quay.io/biocontainers/libopenms:3.4.0--hc77a4c7_0
```
...
```bash
$ module load quay.io/biocontainers/libopenms/3.4.0--hc77a4c7_0
$ module help quay.io/biocontainers/libopenms/3.4.0--hc77a4c7_0
```
