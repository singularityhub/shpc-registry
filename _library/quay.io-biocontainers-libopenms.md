...
updated_at: "2025-01-22 03:26:09.775500"
latest: "3.3.0--h0656172_6"
...
```bash
$ shpc install quay.io/biocontainers/libopenms:3.3.0--h0656172_6
```
...
```bash
$ module load quay.io/biocontainers/libopenms/3.3.0--h0656172_6
$ module help quay.io/biocontainers/libopenms/3.3.0--h0656172_6
```
