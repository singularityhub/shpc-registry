...
updated_at: "2024-10-04 03:11:00.748521"
...
```bash
$ shpc install quay.io/biocontainers/libopenms:3.2.0--haddbca4_4
```
...
```bash
$ module load quay.io/biocontainers/libopenms/3.2.0--haddbca4_4
$ module help quay.io/biocontainers/libopenms/3.2.0--haddbca4_4
```
