...
updated_at: "2025-08-13 03:46:32.707033"
...
```bash
$ shpc install quay.io/biocontainers/libopenms:3.4.1--heb594b5_0
```
...
```bash
$ module load quay.io/biocontainers/libopenms/3.4.1--heb594b5_0
$ module help quay.io/biocontainers/libopenms/3.4.1--heb594b5_0
```
