...
updated_at: "2025-05-14 03:50:30.255120"
...
```bash
$ shpc install quay.io/biocontainers/libopenms:3.3.0--h0656172_8
```
...
```bash
$ module load quay.io/biocontainers/libopenms/3.3.0--h0656172_8
$ module help quay.io/biocontainers/libopenms/3.3.0--h0656172_8
```
