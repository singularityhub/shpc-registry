...
updated_at: "2023-12-25 03:00:17.940486"
...
```bash
$ shpc install quay.io/biocontainers/libopenms:3.1.0--h8964181_3
```
...
```bash
$ module load quay.io/biocontainers/libopenms/3.1.0--h8964181_3
$ module help quay.io/biocontainers/libopenms/3.1.0--h8964181_3
```
