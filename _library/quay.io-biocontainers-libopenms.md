...
updated_at: "2023-11-03 03:06:16.155391"
...
```bash
$ shpc install quay.io/biocontainers/libopenms:3.0.0--h8964181_1
```
...
```bash
$ module load quay.io/biocontainers/libopenms/3.0.0--h8964181_1
$ module help quay.io/biocontainers/libopenms/3.0.0--h8964181_1
```
