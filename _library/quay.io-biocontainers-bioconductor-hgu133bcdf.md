...
updated_at: "2023-12-09 03:11:14.621049"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hgu133bcdf:2.18.0--r43hdfd78af_11
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hgu133bcdf/2.18.0--r43hdfd78af_11
$ module help quay.io/biocontainers/bioconductor-hgu133bcdf/2.18.0--r43hdfd78af_11
```
