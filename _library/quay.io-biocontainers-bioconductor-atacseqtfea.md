...
updated_at: "2025-04-10 03:31:12.477457"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-atacseqtfea:1.8.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-atacseqtfea/1.8.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-atacseqtfea/1.8.0--r44hdfd78af_0
```
