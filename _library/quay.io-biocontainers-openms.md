...
updated_at: "2026-02-01 05:19:16.755863"
latest: "3.5.0--h78fb946_0"
...
```bash
$ shpc install quay.io/biocontainers/openms:3.5.0--h78fb946_0
```
...
```bash
$ module load quay.io/biocontainers/openms/3.5.0--h78fb946_0
$ module help quay.io/biocontainers/openms/3.5.0--h78fb946_0
```
