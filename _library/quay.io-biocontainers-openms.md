...
updated_at: "2024-09-09 06:09:14.129683"
...
```bash
$ shpc install quay.io/biocontainers/openms:3.1.0--h191ead1_4
```
...
```bash
$ module load quay.io/biocontainers/openms/3.1.0--h191ead1_4
$ module help quay.io/biocontainers/openms/3.1.0--h191ead1_4
```
