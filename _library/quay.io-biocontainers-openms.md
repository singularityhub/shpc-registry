...
updated_at: "2024-12-03 04:07:42.017738"
latest: "3.2.0--haddbca4_5"
...
```bash
$ shpc install quay.io/biocontainers/openms:3.2.0--haddbca4_5
```
...
```bash
$ module load quay.io/biocontainers/openms/3.2.0--haddbca4_5
$ module help quay.io/biocontainers/openms/3.2.0--haddbca4_5
```
