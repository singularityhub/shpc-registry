...
updated_at: "2026-04-04 05:16:37.975348"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rnamodr:1.24.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rnamodr/1.24.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rnamodr/1.24.0--r45hdfd78af_0
```
