---
layout: container
name:  "quay.io/biocontainers/bioconductor-despace"
maintainer: "@vsoch"
...
updated_at: "2023-10-21 02:30:17.946264"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-despace
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-despace:1.0.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-despace/1.0.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-despace/1.0.0--r43hdfd78af_0
```
...
#### bioconductor-despace-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-despace-inspect-deffile:
