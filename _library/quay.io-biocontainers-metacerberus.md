...
updated_at: "2023-09-18 03:20:58.230135"
latest: "1.1--pyhdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/metacerberus:1.1--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/metacerberus/1.1--pyhdfd78af_1
$ module help quay.io/biocontainers/metacerberus/1.1--pyhdfd78af_1
```
