...
updated_at: "2023-08-10 02:53:20.777871"
...
```bash
$ shpc install quay.io/biocontainers/metacerberus:1.0--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/metacerberus/1.0--pyhdfd78af_1
$ module help quay.io/biocontainers/metacerberus/1.0--pyhdfd78af_1
```
