...
updated_at: "2026-06-26 06:25:57.019133"
...
```bash
$ shpc install quay.io/biocontainers/metacerberus:1.4.0--pyhdfd78af_2
```
...
```bash
$ module load quay.io/biocontainers/metacerberus/1.4.0--pyhdfd78af_2
$ module help quay.io/biocontainers/metacerberus/1.4.0--pyhdfd78af_2
```
