...
updated_at: "2024-07-04 04:06:27.405662"
...
```bash
$ shpc install quay.io/biocontainers/metacerberus:1.3.0--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/metacerberus/1.3.0--pyhdfd78af_1
$ module help quay.io/biocontainers/metacerberus/1.3.0--pyhdfd78af_1
```
