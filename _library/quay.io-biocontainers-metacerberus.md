...
updated_at: "2025-05-19 03:41:38.419421"
...
```bash
$ shpc install quay.io/biocontainers/metacerberus:1.4.0--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/metacerberus/1.4.0--pyhdfd78af_1
$ module help quay.io/biocontainers/metacerberus/1.4.0--pyhdfd78af_1
```
