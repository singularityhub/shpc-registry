...
updated_at: "2026-03-27 05:19:21.982514"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-plotgardener:1.16.0--r45ha27e39d_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-plotgardener/1.16.0--r45ha27e39d_0
$ module help quay.io/biocontainers/bioconductor-plotgardener/1.16.0--r45ha27e39d_0
```
