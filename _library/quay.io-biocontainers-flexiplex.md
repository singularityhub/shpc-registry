...
updated_at: "2024-03-04 03:28:48.266426"
...
```bash
$ shpc install quay.io/biocontainers/flexiplex:1.01--py39h1f90b4d_0
```
...
```bash
$ module load quay.io/biocontainers/flexiplex/1.01--py39h1f90b4d_0
$ module help quay.io/biocontainers/flexiplex/1.01--py39h1f90b4d_0
```
