---
layout: container
name:  "quay.io/biocontainers/flexiplex"
maintainer: "@vsoch"
...
updated_at: "2025-10-09 04:49:55.693108"
latest: "1.02.5--py313h9948957_1"
...
```bash
$ shpc install quay.io/biocontainers/flexiplex
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/flexiplex:1.02.5--py313h9948957_1
```
...
```bash
$ module load quay.io/biocontainers/flexiplex/1.02.5--py313h9948957_1
$ module help quay.io/biocontainers/flexiplex/1.02.5--py313h9948957_1
```
...
#### flexiplex-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### flexiplex-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/flexiplex
$ podman run --it --rm --entrypoint /usr/local/bin/flexiplex   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/flexiplex   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/flexiplex-filter
$ podman run --it --rm --entrypoint /usr/local/bin/flexiplex-filter   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/flexiplex-filter   -v ${PWD} -w ${PWD} <container> -c " $@"
```
