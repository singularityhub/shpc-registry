...
updated_at: "2025-04-30 03:45:59.931189"
...
```bash
$ shpc install quay.io/biocontainers/repeatmodeler:2.0.6--pl5321hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/repeatmodeler/2.0.6--pl5321hdfd78af_0
$ module help quay.io/biocontainers/repeatmodeler/2.0.6--pl5321hdfd78af_0
```
