...
updated_at: "2024-02-09 02:20:19.822487"
latest: "21.07-tensorflow-py3"
...
```bash
$ shpc install nvcr.io/nvidia/digits:21.07-tensorflow-py3
```
...
```bash
$ module load nvcr.io/nvidia/digits/21.07-tensorflow-py3
$ module help nvcr.io/nvidia/digits/21.07-tensorflow-py3
```
