...
updated_at: "2026-03-27 04:48:46.157004"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-tcgamethylation450k:1.46.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-tcgamethylation450k/1.46.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-tcgamethylation450k/1.46.0--r45hdfd78af_0
```
