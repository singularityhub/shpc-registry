...
updated_at: "2026-05-24 06:52:20.422193"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-adsplit:1.80.0--r45ha27e39d_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-adsplit/1.80.0--r45ha27e39d_0
$ module help quay.io/biocontainers/bioconductor-adsplit/1.80.0--r45ha27e39d_0
```
