...
updated_at: "2023-10-12 03:09:26.112708"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-autonomics:1.8.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-autonomics/1.8.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-autonomics/1.8.0--r43hdfd78af_0
```
