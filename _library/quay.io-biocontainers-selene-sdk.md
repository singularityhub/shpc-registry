...
updated_at: "2025-12-20 03:25:05.205864"
...
```bash
$ shpc install quay.io/biocontainers/selene-sdk:0.6.0--py312h0fa9677_2
```
...
```bash
$ module load quay.io/biocontainers/selene-sdk/0.6.0--py312h0fa9677_2
$ module help quay.io/biocontainers/selene-sdk/0.6.0--py312h0fa9677_2
```
