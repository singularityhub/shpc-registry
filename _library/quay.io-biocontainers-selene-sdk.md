...
updated_at: "2024-07-22 02:49:17.836250"
latest: "0.5.0--py312h1f1cfbb_5"
...
```bash
$ shpc install quay.io/biocontainers/selene-sdk:0.5.0--py312h1f1cfbb_5
```
...
```bash
$ module load quay.io/biocontainers/selene-sdk/0.5.0--py312h1f1cfbb_5
$ module help quay.io/biocontainers/selene-sdk/0.5.0--py312h1f1cfbb_5
```
