...
updated_at: "2026-02-02 04:28:53.034356"
...
```bash
$ shpc install quay.io/biocontainers/metasbt:0.1.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/metasbt/0.1.5--pyhdfd78af_0
$ module help quay.io/biocontainers/metasbt/0.1.5--pyhdfd78af_0
```
