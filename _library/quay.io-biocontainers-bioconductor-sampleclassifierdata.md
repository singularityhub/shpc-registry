...
updated_at: "2023-10-15 03:06:47.350797"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-sampleclassifierdata:1.24.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-sampleclassifierdata/1.24.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-sampleclassifierdata/1.24.0--r43hdfd78af_0
```
