...
updated_at: "2024-09-09 03:37:08.756581"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-sampleclassifierdata:1.26.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-sampleclassifierdata/1.26.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-sampleclassifierdata/1.26.0--r43hdfd78af_0
```
