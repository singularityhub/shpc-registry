...
updated_at: "2026-03-30 06:19:48.876319"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-sampleclassifierdata:1.34.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-sampleclassifierdata/1.34.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-sampleclassifierdata/1.34.0--r45hdfd78af_0
```
