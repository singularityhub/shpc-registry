---
layout: container
name:  "quay.io/biocontainers/sierra-local"
maintainer: "@vsoch"
...
updated_at: "2025-12-18 04:06:33.076329"
...
singularity registry hpc automated addition for sierra-local
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/sierra-local
```
...
#### sierra-local-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### sierra-local-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/sierralocal
$ podman run --it --rm --entrypoint /usr/local/bin/sierralocal   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/sierralocal   -v ${PWD} -w ${PWD} <container> -c " $@"
```
