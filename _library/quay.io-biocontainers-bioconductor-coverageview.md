...
updated_at: "2026-04-05 05:01:31.647874"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-coverageview:1.48.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-coverageview/1.48.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-coverageview/1.48.0--r45hdfd78af_0
```
