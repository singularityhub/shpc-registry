...
updated_at: "2025-05-13 03:22:34.317851"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hicontacts:1.8.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hicontacts/1.8.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-hicontacts/1.8.0--r44hdfd78af_0
```
