...
updated_at: "2026-03-19 04:29:30.647394"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hicontacts:1.12.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hicontacts/1.12.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-hicontacts/1.12.0--r45hdfd78af_0
```
