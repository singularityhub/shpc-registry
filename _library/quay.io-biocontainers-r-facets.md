...
updated_at: "2024-11-14 02:53:05.978533"
latest: "0.6.2--r43haf399aa_5"
...
```bash
$ shpc install quay.io/biocontainers/r-facets:0.6.2--r43haf399aa_5
```
...
```bash
$ module load quay.io/biocontainers/r-facets/0.6.2--r43haf399aa_5
$ module help quay.io/biocontainers/r-facets/0.6.2--r43haf399aa_5
```
