...
updated_at: "2025-08-14 04:04:31.488233"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mirlab:1.36.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mirlab/1.36.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-mirlab/1.36.0--r44hdfd78af_0
```
