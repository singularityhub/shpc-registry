...
updated_at: "2023-09-18 02:45:43.799997"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mirlab:1.30.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mirlab/1.30.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-mirlab/1.30.0--r43hdfd78af_0
```
