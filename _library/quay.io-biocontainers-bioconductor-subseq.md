...
updated_at: "2026-03-16 05:04:39.474812"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-subseq:1.40.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-subseq/1.40.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-subseq/1.40.0--r45hdfd78af_0
```
