...
updated_at: "2025-08-30 03:06:16.210017"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-subseq:1.36.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-subseq/1.36.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-subseq/1.36.0--r44hdfd78af_0
```
