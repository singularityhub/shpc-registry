...
updated_at: "2023-09-14 03:21:08.342519"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-subseq:1.30.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-subseq/1.30.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-subseq/1.30.0--r43hdfd78af_0
```
