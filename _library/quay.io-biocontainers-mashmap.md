...
updated_at: "2024-11-26 03:24:22.900292"
latest: "3.1.3--h07ea13f_1"
...
```bash
$ shpc install quay.io/biocontainers/mashmap:3.1.3--h07ea13f_1
```
...
```bash
$ module load quay.io/biocontainers/mashmap/3.1.3--h07ea13f_1
$ module help quay.io/biocontainers/mashmap/3.1.3--h07ea13f_1
```
