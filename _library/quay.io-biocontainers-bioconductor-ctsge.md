...
updated_at: "2023-08-24 02:35:50.022947"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ctsge:1.26.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ctsge/1.26.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ctsge/1.26.0--r43hdfd78af_0
```
