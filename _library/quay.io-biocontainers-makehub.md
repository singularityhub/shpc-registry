...
updated_at: "2023-06-29 03:37:20.974749"
...
```bash
$ shpc install quay.io/biocontainers/makehub:1.0.6--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/makehub/1.0.6--hdfd78af_0
$ module help quay.io/biocontainers/makehub/1.0.6--hdfd78af_0
```
