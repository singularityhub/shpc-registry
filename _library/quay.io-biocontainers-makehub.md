...
updated_at: "2023-07-21 02:56:59.923998"
...
```bash
$ shpc install quay.io/biocontainers/makehub:1.0.7--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/makehub/1.0.7--hdfd78af_0
$ module help quay.io/biocontainers/makehub/1.0.7--hdfd78af_0
```
