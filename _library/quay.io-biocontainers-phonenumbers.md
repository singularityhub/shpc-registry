---
layout: container
name:  "quay.io/biocontainers/phonenumbers"
maintainer: "@vsoch"
...
updated_at: "2022-10-29 05:43:19.348867"
latest: "7.2.4--py35_0"
...
```bash
$ shpc install quay.io/biocontainers/phonenumbers
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/phonenumbers:7.2.4--py35_0
```
...
```bash
$ module load quay.io/biocontainers/phonenumbers/7.2.4--py35_0
$ module help quay.io/biocontainers/phonenumbers/7.2.4--py35_0
```
...
#### phonenumbers-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### phonenumbers-inspect-deffile:
