...
updated_at: "2026-04-02 05:29:16.935278"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gofuncr:1.30.0--r45ha27e39d_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gofuncr/1.30.0--r45ha27e39d_0
$ module help quay.io/biocontainers/bioconductor-gofuncr/1.30.0--r45ha27e39d_0
```
