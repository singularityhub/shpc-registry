...
updated_at: "2026-01-28 04:42:28.859375"
...
```bash
$ shpc install quay.io/biocontainers/altex-be:1.0.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/altex-be/1.0.5--pyhdfd78af_0
$ module help quay.io/biocontainers/altex-be/1.0.5--pyhdfd78af_0
```
