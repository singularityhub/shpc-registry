...
updated_at: "2026-04-03 04:48:54.979007"
...
```bash
$ shpc install quay.io/biocontainers/altex-be:1.0.6--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/altex-be/1.0.6--pyhdfd78af_0
$ module help quay.io/biocontainers/altex-be/1.0.6--pyhdfd78af_0
```
