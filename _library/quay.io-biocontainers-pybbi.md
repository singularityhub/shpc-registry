...
updated_at: "2024-07-23 03:15:36.528376"
latest: "0.4.0--py38h23c55b0_1"
...
```bash
$ shpc install quay.io/biocontainers/pybbi:0.4.0--py38h23c55b0_1
```
...
```bash
$ module load quay.io/biocontainers/pybbi/0.4.0--py38h23c55b0_1
$ module help quay.io/biocontainers/pybbi/0.4.0--py38h23c55b0_1
```
