...
updated_at: "2024-01-21 03:03:52.642406"
...
```bash
$ shpc install quay.io/biocontainers/pybbi:0.3.6--py39h60093d5_0
```
...
```bash
$ module load quay.io/biocontainers/pybbi/0.3.6--py39h60093d5_0
$ module help quay.io/biocontainers/pybbi/0.3.6--py39h60093d5_0
```
