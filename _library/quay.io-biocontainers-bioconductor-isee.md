...
updated_at: "2023-08-09 02:58:31.733965"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-isee:2.12.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-isee/2.12.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-isee/2.12.0--r43hdfd78af_0
```
