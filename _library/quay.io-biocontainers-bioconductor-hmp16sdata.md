...
updated_at: "2026-03-30 05:45:16.781049"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hmp16sdata:1.30.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hmp16sdata/1.30.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-hmp16sdata/1.30.0--r45hdfd78af_0
```
