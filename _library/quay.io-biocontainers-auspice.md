...
updated_at: "2023-10-26 04:15:55.306365"
latest: "2.49.0--hdbdd923_0"
...
```bash
$ shpc install quay.io/biocontainers/auspice:2.49.0--hdbdd923_0
```
...
```bash
$ module load quay.io/biocontainers/auspice/2.49.0--hdbdd923_0
$ module help quay.io/biocontainers/auspice/2.49.0--hdbdd923_0
```
