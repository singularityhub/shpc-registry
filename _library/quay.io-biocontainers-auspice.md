...
updated_at: "2026-01-15 04:20:54.605657"
latest: "2.66.0--h503566f_2"
...
```bash
$ shpc install quay.io/biocontainers/auspice:2.66.0--h503566f_2
```
...
```bash
$ module load quay.io/biocontainers/auspice/2.66.0--h503566f_2
$ module help quay.io/biocontainers/auspice/2.66.0--h503566f_2
```
