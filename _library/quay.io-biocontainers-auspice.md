...
updated_at: "2023-09-06 02:50:34.009241"
latest: "2.48.0--hdbdd923_0"
...
```bash
$ shpc install quay.io/biocontainers/auspice:2.48.0--hdbdd923_0
```
...
```bash
$ module load quay.io/biocontainers/auspice/2.48.0--hdbdd923_0
$ module help quay.io/biocontainers/auspice/2.48.0--hdbdd923_0
```
