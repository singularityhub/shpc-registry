...
updated_at: "2025-07-29 04:35:24.029107"
latest: "2.63.0--h9aeec6d_0"
...
```bash
$ shpc install quay.io/biocontainers/auspice:2.63.0--h9aeec6d_0
```
...
```bash
$ module load quay.io/biocontainers/auspice/2.63.0--h9aeec6d_0
$ module help quay.io/biocontainers/auspice/2.63.0--h9aeec6d_0
```
