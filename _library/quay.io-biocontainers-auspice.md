...
updated_at: "2023-07-17 03:29:51.952224"
latest: "2.46.0--hdbdd923_2"
...
```bash
$ shpc install quay.io/biocontainers/auspice:2.46.0--hdbdd923_2
```
...
```bash
$ module load quay.io/biocontainers/auspice/2.46.0--hdbdd923_2
$ module help quay.io/biocontainers/auspice/2.46.0--hdbdd923_2
```
