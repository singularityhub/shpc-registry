...
updated_at: "2025-09-05 03:03:59.159694"
latest: "2.65.0--h9aeec6d_0"
...
```bash
$ shpc install quay.io/biocontainers/auspice:2.65.0--h9aeec6d_0
```
...
```bash
$ module load quay.io/biocontainers/auspice/2.65.0--h9aeec6d_0
$ module help quay.io/biocontainers/auspice/2.65.0--h9aeec6d_0
```
