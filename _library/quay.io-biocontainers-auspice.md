...
updated_at: "2025-10-20 03:36:28.624604"
latest: "2.66.0--h9aeec6d_0"
...
```bash
$ shpc install quay.io/biocontainers/auspice:2.66.0--h9aeec6d_0
```
...
```bash
$ module load quay.io/biocontainers/auspice/2.66.0--h9aeec6d_0
$ module help quay.io/biocontainers/auspice/2.66.0--h9aeec6d_0
```
