...
updated_at: "2023-06-19 03:25:01.981029"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-eir:1.38.0--r42hf17093f_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-eir/1.38.0--r42hf17093f_1
$ module help quay.io/biocontainers/bioconductor-eir/1.38.0--r42hf17093f_1
```
