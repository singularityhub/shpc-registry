...
updated_at: "2024-12-07 02:13:24.746370"
...
```bash
$ shpc install quay.io/biocontainers/seurat-scripts:4.4.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/seurat-scripts/4.4.0--hdfd78af_0
$ module help quay.io/biocontainers/seurat-scripts/4.4.0--hdfd78af_0
```
