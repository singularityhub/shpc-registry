...
updated_at: "2025-10-05 03:45:41.058725"
...
```bash
$ shpc install quay.io/biocontainers/sdeper:1.6.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sdeper/1.6.4--pyhdfd78af_0
$ module help quay.io/biocontainers/sdeper/1.6.4--pyhdfd78af_0
```
