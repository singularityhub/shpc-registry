...
updated_at: "2026-09-17 08:00:19.372635"
...
```bash
$ shpc install quay.io/biocontainers/sdeper:2.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sdeper/2.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/sdeper/2.1.0--pyhdfd78af_0
```
