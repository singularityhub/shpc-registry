...
updated_at: "2026-08-27 23:26:39.212158"
...
```bash
$ shpc install quay.io/biocontainers/sdeper:2.0.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sdeper/2.0.2--pyhdfd78af_0
$ module help quay.io/biocontainers/sdeper/2.0.2--pyhdfd78af_0
```
