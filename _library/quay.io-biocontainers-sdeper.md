...
updated_at: "2026-02-02 05:02:29.645469"
...
```bash
$ shpc install quay.io/biocontainers/sdeper:1.7.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sdeper/1.7.1--pyhdfd78af_0
$ module help quay.io/biocontainers/sdeper/1.7.1--pyhdfd78af_0
```
