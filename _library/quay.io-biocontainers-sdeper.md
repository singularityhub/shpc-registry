...
updated_at: "2024-07-01 03:11:35.844107"
...
```bash
$ shpc install quay.io/biocontainers/sdeper:1.3.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sdeper/1.3.1--pyhdfd78af_0
$ module help quay.io/biocontainers/sdeper/1.3.1--pyhdfd78af_0
```
