...
updated_at: "2026-03-29 05:09:35.501887"
...
```bash
$ shpc install quay.io/biocontainers/sdeper:2.0.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sdeper/2.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/sdeper/2.0.0--pyhdfd78af_0
```
