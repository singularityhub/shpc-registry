...
updated_at: "2026-03-19 05:06:46.514018"
...
```bash
$ shpc install quay.io/biocontainers/gxf2bed:0.3.2--ha6fb395_0
```
...
```bash
$ module load quay.io/biocontainers/gxf2bed/0.3.2--ha6fb395_0
$ module help quay.io/biocontainers/gxf2bed/0.3.2--ha6fb395_0
```
