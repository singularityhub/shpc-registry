...
updated_at: "2025-08-24 04:09:00.915913"
...
```bash
$ shpc install quay.io/biocontainers/parebrick:0.5.7--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/parebrick/0.5.7--pyhdfd78af_0
$ module help quay.io/biocontainers/parebrick/0.5.7--pyhdfd78af_0
```
