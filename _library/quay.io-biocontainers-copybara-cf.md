---
layout: container
name:  "quay.io/biocontainers/copybara-cf"
maintainer: "@vsoch"
...
updated_at: "2026-04-27 05:53:52.256871"
...
versions:
 - "0.1.0--pyhdfd78af_0"
description: "singularity registry hpc automated addition for copybara-cf"
config: {"url": "https://biocontainers.pro/tools/copybara-cf", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for copybara-cf", "latest": {"0.1.0--pyhdfd78af_0": "sha256:791df0207641c3a49216ecd22072262fc96c4038f7f4d931f762cbb6a6d88515"}, "tags": {"0.1.0--pyhdfd78af_0": "sha256:791df0207641c3a49216ecd22072262fc96c4038f7f4d931f762cbb6a6d88515"}, "docker": "quay.io/biocontainers/copybara-cf", "aliases": {"copybara": "/usr/local/bin/copybara", "qconvex": "/usr/local/bin/qconvex", "qdelaunay": "/usr/local/bin/qdelaunay", "qhalf": "/usr/local/bin/qhalf", "qhull": "/usr/local/bin/qhull", "qvoronoi": "/usr/local/bin/qvoronoi", "rbox": "/usr/local/bin/rbox", "shiftBed": "/usr/local/bin/shiftBed", "annotateBed": "/usr/local/bin/annotateBed", "bamToBed": "/usr/local/bin/bamToBed", "bamToFastq": "/usr/local/bin/bamToFastq", "bed12ToBed6": "/usr/local/bin/bed12ToBed6", "bedToBam": "/usr/local/bin/bedToBam", "bedToIgv": "/usr/local/bin/bedToIgv", "bedpeToBam": "/usr/local/bin/bedpeToBam", "bedtools": "/usr/local/bin/bedtools", "closestBed": "/usr/local/bin/closestBed", "clusterBed": "/usr/local/bin/clusterBed", "complementBed": "/usr/local/bin/complementBed", "coverageBed": "/usr/local/bin/coverageBed", "expandCols": "/usr/local/bin/expandCols", "fastaFromBed": "/usr/local/bin/fastaFromBed", "flankBed": "/usr/local/bin/flankBed", "genomeCoverageBed": "/usr/local/bin/genomeCoverageBed", "getOverlap": "/usr/local/bin/getOverlap", "groupBy": "/usr/local/bin/groupBy"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/copybara-cf.
singularity registry hpc automated addition for copybara-cf
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/copybara-cf
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/copybara-cf:0.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/copybara-cf/0.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/copybara-cf/0.1.0--pyhdfd78af_0
```
...
#### copybara-cf-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### copybara-cf-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/copybara
$ podman run --it --rm --entrypoint /usr/local/bin/copybara   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/copybara   -v ${PWD} -w ${PWD} <container> -c " $@"
```
