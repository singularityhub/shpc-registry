...
updated_at: "2026-06-25 06:10:38.359763"
latest: "2.14--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/illumina-utils:2.14--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/illumina-utils/2.14--pyhdfd78af_0
$ module help quay.io/biocontainers/illumina-utils/2.14--pyhdfd78af_0
```
