...
updated_at: "2024-04-20 02:48:02.058107"
latest: "0.3.7--h4349ce8_0"
...
```bash
$ shpc install quay.io/biocontainers/ska2:0.3.7--h4349ce8_0
```
...
```bash
$ module load quay.io/biocontainers/ska2/0.3.7--h4349ce8_0
$ module help quay.io/biocontainers/ska2/0.3.7--h4349ce8_0
```
