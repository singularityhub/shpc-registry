...
updated_at: "2023-12-04 02:46:37.453394"
latest: "0.3.4--h4349ce8_0"
...
```bash
$ shpc install quay.io/biocontainers/ska2:0.3.4--h4349ce8_0
```
...
```bash
$ module load quay.io/biocontainers/ska2/0.3.4--h4349ce8_0
$ module help quay.io/biocontainers/ska2/0.3.4--h4349ce8_0
```
