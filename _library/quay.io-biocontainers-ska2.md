...
updated_at: "2024-03-23 03:02:25.631365"
latest: "0.3.6--h4349ce8_0"
...
```bash
$ shpc install quay.io/biocontainers/ska2:0.3.6--h4349ce8_0
```
...
```bash
$ module load quay.io/biocontainers/ska2/0.3.6--h4349ce8_0
$ module help quay.io/biocontainers/ska2/0.3.6--h4349ce8_0
```
