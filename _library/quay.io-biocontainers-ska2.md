...
updated_at: "2024-07-19 03:01:25.205664"
latest: "0.3.8--h4349ce8_0"
...
```bash
$ shpc install quay.io/biocontainers/ska2:0.3.8--h4349ce8_0
```
...
```bash
$ module load quay.io/biocontainers/ska2/0.3.8--h4349ce8_0
$ module help quay.io/biocontainers/ska2/0.3.8--h4349ce8_0
```
