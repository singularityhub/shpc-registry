...
updated_at: "2024-05-12 02:55:43.926471"
latest: "0.3.7--h4349ce8_1"
...
```bash
$ shpc install quay.io/biocontainers/ska2:0.3.7--h4349ce8_1
```
...
```bash
$ module load quay.io/biocontainers/ska2/0.3.7--h4349ce8_1
$ module help quay.io/biocontainers/ska2/0.3.7--h4349ce8_1
```
