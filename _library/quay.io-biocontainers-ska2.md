...
updated_at: "2026-01-23 04:12:52.640354"
latest: "0.5.1--h4349ce8_0"
...
```bash
$ shpc install quay.io/biocontainers/ska2:0.5.1--h4349ce8_0
```
...
```bash
$ module load quay.io/biocontainers/ska2/0.5.1--h4349ce8_0
$ module help quay.io/biocontainers/ska2/0.5.1--h4349ce8_0
```
