...
updated_at: "2026-01-06 04:07:15.353467"
...
```bash
$ shpc install quay.io/biocontainers/ska2:0.5.0--h4349ce8_0
```
...
```bash
$ module load quay.io/biocontainers/ska2/0.5.0--h4349ce8_0
$ module help quay.io/biocontainers/ska2/0.5.0--h4349ce8_0
```
