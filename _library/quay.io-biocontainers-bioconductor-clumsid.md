...
updated_at: "2026-03-30 05:24:14.780682"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-clumsid:1.26.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-clumsid/1.26.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-clumsid/1.26.0--r45hdfd78af_0
```
