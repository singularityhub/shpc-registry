...
updated_at: "2023-08-28 08:51:06.280816"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-clumsid:1.16.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-clumsid/1.16.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-clumsid/1.16.0--r43hdfd78af_0
```
