...
updated_at: "2024-01-08 03:49:28.062452"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hgu95bprobe:2.18.0--r43hdfd78af_12
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hgu95bprobe/2.18.0--r43hdfd78af_12
$ module help quay.io/biocontainers/bioconductor-hgu95bprobe/2.18.0--r43hdfd78af_12
```
