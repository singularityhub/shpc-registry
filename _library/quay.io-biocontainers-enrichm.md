...
updated_at: "2026-01-28 04:40:28.536526"
...
```bash
$ shpc install quay.io/biocontainers/enrichm:0.6.6--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/enrichm/0.6.6--pyhdfd78af_0
$ module help quay.io/biocontainers/enrichm/0.6.6--pyhdfd78af_0
```
