...
updated_at: "2026-08-21 18:27:48.899098"
...
```bash
$ shpc install quay.io/biocontainers/enrichm:0.6.10--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/enrichm/0.6.10--pyhdfd78af_0
$ module help quay.io/biocontainers/enrichm/0.6.10--pyhdfd78af_0
```
