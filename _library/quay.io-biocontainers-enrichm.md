...
updated_at: "2026-04-23 05:07:55.433207"
...
```bash
$ shpc install quay.io/biocontainers/enrichm:0.6.8--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/enrichm/0.6.8--pyhdfd78af_0
$ module help quay.io/biocontainers/enrichm/0.6.8--pyhdfd78af_0
```
