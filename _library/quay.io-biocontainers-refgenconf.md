...
updated_at: "2026-04-17 05:20:20.023248"
...
```bash
$ shpc install quay.io/biocontainers/refgenconf:0.13.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/refgenconf/0.13.1--pyhdfd78af_0
$ module help quay.io/biocontainers/refgenconf/0.13.1--pyhdfd78af_0
```
