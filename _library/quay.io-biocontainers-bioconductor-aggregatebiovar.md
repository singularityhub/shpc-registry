...
updated_at: "2026-04-03 16:00:28.825451"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-aggregatebiovar:1.20.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-aggregatebiovar/1.20.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-aggregatebiovar/1.20.0--r45hdfd78af_0
```
