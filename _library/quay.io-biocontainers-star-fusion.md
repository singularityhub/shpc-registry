...
updated_at: "2025-10-26 03:48:08.778906"
...
```bash
$ shpc install quay.io/biocontainers/star-fusion:1.15.1--hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/star-fusion/1.15.1--hdfd78af_1
$ module help quay.io/biocontainers/star-fusion/1.15.1--hdfd78af_1
```
