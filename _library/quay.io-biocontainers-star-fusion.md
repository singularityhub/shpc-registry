...
updated_at: "2024-12-19 05:03:35.624426"
latest: "1.14.0--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/star-fusion:1.14.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/star-fusion/1.14.0--hdfd78af_0
$ module help quay.io/biocontainers/star-fusion/1.14.0--hdfd78af_0
```
