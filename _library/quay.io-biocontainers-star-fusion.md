...
updated_at: "2023-01-21 03:18:32.347319"
...
```bash
$ shpc install quay.io/biocontainers/star-fusion:1.11.1--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/star-fusion/1.11.1--hdfd78af_0
$ module help quay.io/biocontainers/star-fusion/1.11.1--hdfd78af_0
```
