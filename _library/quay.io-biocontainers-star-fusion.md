...
updated_at: "2025-04-22 03:50:48.552354"
latest: "1.14.0--hdfd78af_2"
...
```bash
$ shpc install quay.io/biocontainers/star-fusion:1.14.0--hdfd78af_2
```
...
```bash
$ module load quay.io/biocontainers/star-fusion/1.14.0--hdfd78af_2
$ module help quay.io/biocontainers/star-fusion/1.14.0--hdfd78af_2
```
