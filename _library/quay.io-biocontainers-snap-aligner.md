...
updated_at: "2024-09-10 03:08:11.292182"
latest: "2.0.3--hdcf5f25_3"
...
```bash
$ shpc install quay.io/biocontainers/snap-aligner:2.0.3--hdcf5f25_3
```
...
```bash
$ module load quay.io/biocontainers/snap-aligner/2.0.3--hdcf5f25_3
$ module help quay.io/biocontainers/snap-aligner/2.0.3--hdcf5f25_3
```
