...
updated_at: "2026-09-24 08:08:15.807191"
...
```bash
$ shpc install quay.io/biocontainers/snap-aligner:2.0.5--h3be2455_3
```
...
```bash
$ module load quay.io/biocontainers/snap-aligner/2.0.5--h3be2455_3
$ module help quay.io/biocontainers/snap-aligner/2.0.5--h3be2455_3
```
