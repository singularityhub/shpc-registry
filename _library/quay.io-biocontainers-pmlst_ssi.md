---
layout: container
name:  "quay.io/biocontainers/pmlst_ssi"
maintainer: "@vsoch"
...
updated_at: "2026-06-23 06:37:25.384726"
...
versions:
 - "2.1.1--pyhdfd78af_0"
description: "singularity registry hpc automated addition for pmlst_ssi"
config: {"url": "https://biocontainers.pro/tools/pmlst_ssi", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for pmlst_ssi", "latest": {"2.1.1--pyhdfd78af_0": "sha256:714ddb6f2ba5f50ea41c994aefe2d41c518e04f92a25283198641ffe8b8249db"}, "tags": {"2.1.1--pyhdfd78af_0": "sha256:714ddb6f2ba5f50ea41c994aefe2d41c518e04f92a25283198641ffe8b8249db"}, "docker": "quay.io/biocontainers/pmlst_ssi", "aliases": {"pmlst": "/usr/local/bin/pmlst", "pmlst-download-db": "/usr/local/bin/pmlst-download-db", "pmlst.py": "/usr/local/bin/pmlst.py", "kma": "/usr/local/bin/kma", "kma_index": "/usr/local/bin/kma_index", "kma_shm": "/usr/local/bin/kma_shm", "kma_update": "/usr/local/bin/kma_update", "archive-nlmnlp": "/usr/local/bin/archive-nlmnlp", "archive-pids": "/usr/local/bin/archive-pids", "download-flatfile": "/usr/local/bin/download-flatfile", "ecollect": "/usr/local/bin/ecollect", "gbf2facds": "/usr/local/bin/gbf2facds", "gbf2tbl": "/usr/local/bin/gbf2tbl", "gff-sort": "/usr/local/bin/gff-sort", "gff2xml": "/usr/local/bin/gff2xml", "pair-at-a-time": "/usr/local/bin/pair-at-a-time", "print-missing-subranges": "/usr/local/bin/print-missing-subranges", "sort-by-length": "/usr/local/bin/sort-by-length", "xcommon.sh": "/usr/local/bin/xcommon.sh", "xfetch": "/usr/local/bin/xfetch", "xfetch.ini": "/usr/local/bin/xfetch.ini", "xfilter": "/usr/local/bin/xfilter", "xinfo": "/usr/local/bin/xinfo", "xlink": "/usr/local/bin/xlink", "xlink.ini": "/usr/local/bin/xlink.ini", "xsearch": "/usr/local/bin/xsearch", "bsmp2info": "/usr/local/bin/bsmp2info", "fsa2xml": "/usr/local/bin/fsa2xml"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/pmlst_ssi.
singularity registry hpc automated addition for pmlst_ssi
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/pmlst_ssi
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/pmlst_ssi:2.1.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pmlst_ssi/2.1.1--pyhdfd78af_0
$ module help quay.io/biocontainers/pmlst_ssi/2.1.1--pyhdfd78af_0
```
...
#### pmlst_ssi-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### pmlst_ssi-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/pmlst
$ podman run --it --rm --entrypoint /usr/local/bin/pmlst   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/pmlst   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/pmlst-download-db
$ podman run --it --rm --entrypoint /usr/local/bin/pmlst-download-db   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/pmlst-download-db   -v ${PWD} -w ${PWD} <container> -c " $@"
```
