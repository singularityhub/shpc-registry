...
updated_at: "2024-02-23 02:59:40.962532"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-egad:1.30.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-egad/1.30.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-egad/1.30.0--r43hdfd78af_0
```
