...
updated_at: "2024-02-20 02:23:01.194469"
latest: "4.0--py312hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/msfragger:4.0--py312hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/msfragger/4.0--py312hdfd78af_0
$ module help quay.io/biocontainers/msfragger/4.0--py312hdfd78af_0
```
