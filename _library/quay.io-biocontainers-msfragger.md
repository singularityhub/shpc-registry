...
updated_at: "2025-09-10 03:25:17.104592"
...
```bash
$ shpc install quay.io/biocontainers/msfragger:4.2--py311hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/msfragger/4.2--py311hdfd78af_0
$ module help quay.io/biocontainers/msfragger/4.2--py311hdfd78af_0
```
