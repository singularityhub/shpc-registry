...
updated_at: "2025-09-20 03:31:30.442760"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mouse430a2probe:2.18.0--r44hdfd78af_13
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mouse430a2probe/2.18.0--r44hdfd78af_13
$ module help quay.io/biocontainers/bioconductor-mouse430a2probe/2.18.0--r44hdfd78af_13
```
