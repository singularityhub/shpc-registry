...
updated_at: "2026-05-02 05:47:15.027699"
...
```bash
$ shpc install quay.io/biocontainers/bio2zarr:0.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bio2zarr/0.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/bio2zarr/0.2.0--pyhdfd78af_0
```
