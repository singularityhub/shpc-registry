...
updated_at: "2026-07-01 06:58:02.221729"
...
```bash
$ shpc install quay.io/biocontainers/bio2zarr:0.2.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bio2zarr/0.2.1--pyhdfd78af_0
$ module help quay.io/biocontainers/bio2zarr/0.2.1--pyhdfd78af_0
```
