...
updated_at: "2026-03-20 04:19:15.452026"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-interest:1.34.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-interest/1.34.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-interest/1.34.0--r45hdfd78af_0
```
