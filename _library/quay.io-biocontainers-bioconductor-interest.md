...
updated_at: "2023-09-18 02:23:11.301639"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-interest:1.24.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-interest/1.24.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-interest/1.24.0--r43hdfd78af_0
```
