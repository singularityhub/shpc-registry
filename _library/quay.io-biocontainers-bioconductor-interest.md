...
updated_at: "2024-10-30 03:38:59.475465"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-interest:1.26.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-interest/1.26.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-interest/1.26.0--r43hdfd78af_0
```
