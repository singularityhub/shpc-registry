...
updated_at: "2024-08-31 03:21:25.452877"
latest: "1.98.0--r43hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-sbmlr:1.98.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-sbmlr/1.98.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-sbmlr/1.98.0--r43hdfd78af_0
```
