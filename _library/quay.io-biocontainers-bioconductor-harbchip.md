...
updated_at: "2026-03-23 05:03:41.533179"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-harbchip:1.48.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-harbchip/1.48.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-harbchip/1.48.0--r45hdfd78af_0
```
