...
updated_at: "2022-11-22 00:58:53.156519"
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-harbchip-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-harbchip-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-harbchip-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-harbchip-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-harbchip-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-harbchip-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
