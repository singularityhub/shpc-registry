...
updated_at: "2026-09-21 08:42:40.851448"
latest: "0.413.0--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/dxpy:0.413.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/dxpy/0.413.0--pyhdfd78af_0
$ module help quay.io/biocontainers/dxpy/0.413.0--pyhdfd78af_0
```
