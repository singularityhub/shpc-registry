...
updated_at: "2025-09-15 03:21:43.153258"
latest: "0.398.0--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/dxpy:0.398.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/dxpy/0.398.0--pyhdfd78af_0
$ module help quay.io/biocontainers/dxpy/0.398.0--pyhdfd78af_0
```
