...
updated_at: "2026-05-17 06:28:27.129788"
latest: "0.408.2--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/dxpy:0.408.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/dxpy/0.408.2--pyhdfd78af_0
$ module help quay.io/biocontainers/dxpy/0.408.2--pyhdfd78af_0
```
