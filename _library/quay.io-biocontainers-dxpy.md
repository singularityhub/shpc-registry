...
updated_at: "2025-10-29 03:58:33.160495"
latest: "0.399.1--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/dxpy:0.399.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/dxpy/0.399.1--pyhdfd78af_0
$ module help quay.io/biocontainers/dxpy/0.399.1--pyhdfd78af_0
```
