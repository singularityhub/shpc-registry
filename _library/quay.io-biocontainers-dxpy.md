...
updated_at: "2025-08-08 04:19:36.262208"
...
```bash
$ shpc install quay.io/biocontainers/dxpy:0.396.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/dxpy/0.396.0--pyhdfd78af_0
$ module help quay.io/biocontainers/dxpy/0.396.0--pyhdfd78af_0
```
