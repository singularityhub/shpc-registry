...
updated_at: "2025-04-16 03:40:20.818953"
latest: "0.394.0--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/dxpy:0.394.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/dxpy/0.394.0--pyhdfd78af_0
$ module help quay.io/biocontainers/dxpy/0.394.0--pyhdfd78af_0
```
