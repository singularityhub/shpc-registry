...
updated_at: "2025-03-19 03:31:45.069541"
latest: "0.392.0--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/dxpy:0.392.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/dxpy/0.392.0--pyhdfd78af_0
$ module help quay.io/biocontainers/dxpy/0.392.0--pyhdfd78af_0
```
