...
updated_at: "2025-08-24 03:42:36.616817"
latest: "0.397.0--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/dxpy:0.397.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/dxpy/0.397.0--pyhdfd78af_0
$ module help quay.io/biocontainers/dxpy/0.397.0--pyhdfd78af_0
```
