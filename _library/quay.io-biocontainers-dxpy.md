...
updated_at: "2026-07-15 05:31:11.273019"
latest: "0.409.0--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/dxpy:0.409.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/dxpy/0.409.0--pyhdfd78af_0
$ module help quay.io/biocontainers/dxpy/0.409.0--pyhdfd78af_0
```
