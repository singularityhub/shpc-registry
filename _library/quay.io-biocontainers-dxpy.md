...
updated_at: "2025-12-11 04:08:31.673068"
latest: "0.400.1--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/dxpy:0.400.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/dxpy/0.400.1--pyhdfd78af_0
$ module help quay.io/biocontainers/dxpy/0.400.1--pyhdfd78af_0
```
