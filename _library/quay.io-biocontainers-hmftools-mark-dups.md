...
updated_at: "2024-05-11 02:46:32.577824"
...
```bash
$ shpc install quay.io/biocontainers/hmftools-mark-dups:1.1.5--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hmftools-mark-dups/1.1.5--hdfd78af_0
$ module help quay.io/biocontainers/hmftools-mark-dups/1.1.5--hdfd78af_0
```
