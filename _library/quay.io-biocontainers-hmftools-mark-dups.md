...
updated_at: "2024-04-27 02:46:11.512256"
...
```bash
$ shpc install quay.io/biocontainers/hmftools-mark-dups:1.1.3--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hmftools-mark-dups/1.1.3--hdfd78af_0
$ module help quay.io/biocontainers/hmftools-mark-dups/1.1.3--hdfd78af_0
```
