...
updated_at: "2024-09-10 03:29:49.262467"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-masigpro:1.74.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-masigpro/1.74.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-masigpro/1.74.0--r43hdfd78af_0
```
