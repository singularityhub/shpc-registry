...
updated_at: "2025-08-23 03:23:15.640940"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-tenxplore:1.28.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-tenxplore/1.28.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-tenxplore/1.28.0--r44hdfd78af_0
```
