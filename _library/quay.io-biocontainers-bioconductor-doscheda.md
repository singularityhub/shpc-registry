...
updated_at: "2026-01-21 04:17:26.874126"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-doscheda:1.28.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-doscheda/1.28.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-doscheda/1.28.0--r44hdfd78af_0
```
