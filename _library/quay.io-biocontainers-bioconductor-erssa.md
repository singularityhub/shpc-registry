...
updated_at: "2023-09-03 03:26:22.739324"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-erssa:1.18.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-erssa/1.18.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-erssa/1.18.0--r43hdfd78af_0
```
