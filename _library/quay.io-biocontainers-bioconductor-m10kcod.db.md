...
updated_at: "2022-11-02 18:40:05.734878"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-m10kcod.db:3.4.0--r41hdfd78af_9
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-m10kcod.db/3.4.0--r41hdfd78af_9
$ module help quay.io/biocontainers/bioconductor-m10kcod.db/3.4.0--r41hdfd78af_9
```
