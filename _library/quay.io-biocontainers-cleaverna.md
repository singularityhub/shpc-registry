---
layout: container
name:  "quay.io/biocontainers/cleaverna"
maintainer: "@vsoch"
...
updated_at: "2026-08-22 03:20:05.332963"
...
```bash
$ module load quay.io/biocontainers/cleaverna/1.0.4--pyhdfd78af_0
$ module help quay.io/biocontainers/cleaverna/1.0.4--pyhdfd78af_0
```
...
#### cleaverna-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### cleaverna-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/cleaverna
$ podman run --it --rm --entrypoint /usr/local/bin/cleaverna   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/cleaverna   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/feature
$ podman run --it --rm --entrypoint /usr/local/bin/feature   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/feature   -v ${PWD} -w ${PWD} <container> -c " $@"
```
