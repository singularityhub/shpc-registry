...
updated_at: "2026-03-20 05:07:45.882206"
...
```bash
$ shpc install quay.io/biocontainers/gecco:0.10.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/gecco/0.10.2--pyhdfd78af_0
$ module help quay.io/biocontainers/gecco/0.10.2--pyhdfd78af_0
```
