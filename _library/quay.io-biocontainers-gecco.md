...
updated_at: "2026-09-26 07:13:00.763402"
...
```bash
$ shpc install quay.io/biocontainers/gecco:0.11.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/gecco/0.11.0--pyhdfd78af_0
$ module help quay.io/biocontainers/gecco/0.11.0--pyhdfd78af_0
```
