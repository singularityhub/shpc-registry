...
updated_at: "2026-03-30 05:27:52.792747"
...
```bash
$ shpc install quay.io/biocontainers/gecco:0.10.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/gecco/0.10.3--pyhdfd78af_0
$ module help quay.io/biocontainers/gecco/0.10.3--pyhdfd78af_0
```
