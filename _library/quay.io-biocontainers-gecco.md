...
updated_at: "2026-05-28 15:36:35.894024"
latest: "0.10.3--pyhdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/gecco:0.10.3--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/gecco/0.10.3--pyhdfd78af_1
$ module help quay.io/biocontainers/gecco/0.10.3--pyhdfd78af_1
```
