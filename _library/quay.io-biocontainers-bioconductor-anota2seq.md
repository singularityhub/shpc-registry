...
updated_at: "2026-06-30 06:26:24.655757"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-anota2seq:1.32.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-anota2seq/1.32.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-anota2seq/1.32.0--r45hdfd78af_0
```
