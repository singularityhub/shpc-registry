...
updated_at: "2024-12-15 03:20:27.350432"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-anota2seq:1.24.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-anota2seq/1.24.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-anota2seq/1.24.0--r43hdfd78af_0
```
