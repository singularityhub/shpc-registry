...
updated_at: "2024-02-05 02:55:23.464367"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-sconify:1.22.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-sconify/1.22.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-sconify/1.22.0--r43hdfd78af_0
```
