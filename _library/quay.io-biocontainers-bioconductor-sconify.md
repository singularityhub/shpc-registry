...
updated_at: "2023-08-23 02:43:03.984282"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-sconify:1.20.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-sconify/1.20.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-sconify/1.20.0--r43hdfd78af_0
```
