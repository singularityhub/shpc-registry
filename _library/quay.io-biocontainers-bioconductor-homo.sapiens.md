...
updated_at: "2026-03-22 04:49:49.638025"
latest: "1.3.1--r45hdfd78af_18"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-homo.sapiens:1.3.1--r45hdfd78af_18
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-homo.sapiens/1.3.1--r45hdfd78af_18
$ module help quay.io/biocontainers/bioconductor-homo.sapiens/1.3.1--r45hdfd78af_18
```
