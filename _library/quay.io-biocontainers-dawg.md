...
updated_at: "2022-10-27 00:19:43.340330"
...
```bash
$ shpc install quay.io/biocontainers/dawg:2.0.beta1--gsl2.2_boost1.64_0
```
...
```bash
$ module load quay.io/biocontainers/dawg/2.0.beta1--gsl2.2_boost1.64_0
$ module help quay.io/biocontainers/dawg/2.0.beta1--gsl2.2_boost1.64_0
```
