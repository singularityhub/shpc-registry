...
updated_at: "2023-12-29 02:34:27.888444"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-chipseeker:1.36.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-chipseeker/1.36.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-chipseeker/1.36.0--r43hdfd78af_0
```
