...
updated_at: "2025-08-10 04:32:05.824807"
latest: "1.3.4--py312hdcc493e_4"
...
```bash
$ shpc install quay.io/biocontainers/parasail-python:1.3.4--py312hdcc493e_4
```
...
```bash
$ module load quay.io/biocontainers/parasail-python/1.3.4--py312hdcc493e_4
$ module help quay.io/biocontainers/parasail-python/1.3.4--py312hdcc493e_4
```
