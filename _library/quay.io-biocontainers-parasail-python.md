...
updated_at: "2026-06-05 06:38:25.725748"
...
```bash
$ shpc install quay.io/biocontainers/parasail-python:1.3.4--py313h5565187_6
```
...
```bash
$ module load quay.io/biocontainers/parasail-python/1.3.4--py313h5565187_6
$ module help quay.io/biocontainers/parasail-python/1.3.4--py313h5565187_6
```
