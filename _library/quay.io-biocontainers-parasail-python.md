...
updated_at: "2025-01-04 02:55:18.861299"
latest: "1.3.4--py39h746d604_3"
...
```bash
$ shpc install quay.io/biocontainers/parasail-python:1.3.4--py39h746d604_3
```
...
```bash
$ module load quay.io/biocontainers/parasail-python/1.3.4--py39h746d604_3
$ module help quay.io/biocontainers/parasail-python/1.3.4--py39h746d604_3
```
