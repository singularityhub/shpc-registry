...
updated_at: "2023-08-16 02:21:56.801848"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-yeast2probe:2.18.0--r43hdfd78af_12
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-yeast2probe/2.18.0--r43hdfd78af_12
$ module help quay.io/biocontainers/bioconductor-yeast2probe/2.18.0--r43hdfd78af_12
```
