...
updated_at: "2022-10-29 08:09:45.116856"
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-yeast2probe-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-yeast2probe-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-yeast2probe-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-yeast2probe-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-yeast2probe-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-yeast2probe-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
