...
updated_at: "2024-05-25 03:09:13.281238"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hdf5array:1.30.0--r43ha9d7317_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hdf5array/1.30.0--r43ha9d7317_1
$ module help quay.io/biocontainers/bioconductor-hdf5array/1.30.0--r43ha9d7317_1
```
