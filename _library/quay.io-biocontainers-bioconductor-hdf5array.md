...
updated_at: "2023-06-21 03:17:56.079852"
latest: "1.26.0--r42h58c1800_2"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hdf5array:1.26.0--r42h58c1800_2
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hdf5array/1.26.0--r42h58c1800_2
$ module help quay.io/biocontainers/bioconductor-hdf5array/1.26.0--r42h58c1800_2
```
