...
updated_at: "2026-03-23 05:33:31.831683"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hdf5array:1.38.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hdf5array/1.38.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-hdf5array/1.38.0--r45hdfd78af_0
```
