...
updated_at: "2024-08-17 02:44:26.197862"
latest: "3.2.3--hdcf5f25_0"
...
```bash
$ shpc install quay.io/biocontainers/abismal:3.2.3--hdcf5f25_0
```
...
```bash
$ module load quay.io/biocontainers/abismal/3.2.3--hdcf5f25_0
$ module help quay.io/biocontainers/abismal/3.2.3--hdcf5f25_0
```
