...
updated_at: "2023-09-20 02:33:54.305391"
latest: "3.2.0--h84372a0_0"
...
```bash
$ shpc install quay.io/biocontainers/abismal:3.2.0--h84372a0_0
```
...
```bash
$ module load quay.io/biocontainers/abismal/3.2.0--h84372a0_0
$ module help quay.io/biocontainers/abismal/3.2.0--h84372a0_0
```
