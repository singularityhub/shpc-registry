...
updated_at: "2026-06-16 07:55:04.252939"
latest: "2.0.0--py314hc52dbad_0"
...
```bash
$ shpc install quay.io/biocontainers/harmonypy:2.0.0--py314hc52dbad_0
```
...
```bash
$ module load quay.io/biocontainers/harmonypy/2.0.0--py314hc52dbad_0
$ module help quay.io/biocontainers/harmonypy/2.0.0--py314hc52dbad_0
```
