...
updated_at: "2026-06-27 06:02:58.575470"
...
```bash
$ shpc install quay.io/biocontainers/aviary:0.13.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/aviary/0.13.0--pyhdfd78af_0
$ module help quay.io/biocontainers/aviary/0.13.0--pyhdfd78af_0
```
