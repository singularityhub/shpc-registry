...
updated_at: "2026-09-26 07:33:38.940195"
...
```bash
$ shpc install quay.io/biocontainers/aviary:0.13.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/aviary/0.13.3--pyhdfd78af_0
$ module help quay.io/biocontainers/aviary/0.13.3--pyhdfd78af_0
```
