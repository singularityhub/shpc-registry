...
updated_at: "2023-10-13 03:03:18.620249"
...
```bash
$ shpc install quay.io/biocontainers/aviary:0.7.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/aviary/0.7.2--pyhdfd78af_0
$ module help quay.io/biocontainers/aviary/0.7.2--pyhdfd78af_0
```
