...
updated_at: "2025-10-21 03:23:46.829700"
...
```bash
$ shpc install quay.io/biocontainers/aviary:0.12.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/aviary/0.12.0--pyhdfd78af_0
$ module help quay.io/biocontainers/aviary/0.12.0--pyhdfd78af_0
```
