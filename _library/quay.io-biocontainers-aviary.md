...
updated_at: "2023-09-25 02:26:05.255568"
...
```bash
$ shpc install quay.io/biocontainers/aviary:0.7.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/aviary/0.7.0--pyhdfd78af_0
$ module help quay.io/biocontainers/aviary/0.7.0--pyhdfd78af_0
```
