...
updated_at: "2024-04-25 03:00:05.588171"
...
```bash
$ shpc install quay.io/biocontainers/aviary:0.9.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/aviary/0.9.0--pyhdfd78af_0
$ module help quay.io/biocontainers/aviary/0.9.0--pyhdfd78af_0
```
