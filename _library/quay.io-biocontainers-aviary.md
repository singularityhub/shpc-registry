...
updated_at: "2024-09-15 02:55:48.447407"
...
```bash
$ shpc install quay.io/biocontainers/aviary:0.9.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/aviary/0.9.1--pyhdfd78af_0
$ module help quay.io/biocontainers/aviary/0.9.1--pyhdfd78af_0
```
