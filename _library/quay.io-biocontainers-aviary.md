...
updated_at: "2025-04-09 03:49:05.862676"
...
```bash
$ shpc install quay.io/biocontainers/aviary:0.11.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/aviary/0.11.1--pyhdfd78af_0
$ module help quay.io/biocontainers/aviary/0.11.1--pyhdfd78af_0
```
