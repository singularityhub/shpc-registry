...
updated_at: "2023-11-17 02:59:17.273034"
...
```bash
$ shpc install quay.io/biocontainers/aviary:0.8.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/aviary/0.8.2--pyhdfd78af_0
$ module help quay.io/biocontainers/aviary/0.8.2--pyhdfd78af_0
```
