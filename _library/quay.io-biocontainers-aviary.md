...
updated_at: "2024-11-18 16:50:24.585795"
...
```bash
$ shpc install quay.io/biocontainers/aviary:0.9.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/aviary/0.9.2--pyhdfd78af_0
$ module help quay.io/biocontainers/aviary/0.9.2--pyhdfd78af_0
```
