...
updated_at: "2026-07-30 05:35:41.085578"
...
```bash
$ shpc install quay.io/biocontainers/aviary:0.13.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/aviary/0.13.2--pyhdfd78af_0
$ module help quay.io/biocontainers/aviary/0.13.2--pyhdfd78af_0
```
