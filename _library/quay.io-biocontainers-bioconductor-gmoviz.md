...
updated_at: "2025-09-01 04:05:47.007646"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gmoviz:1.18.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gmoviz/1.18.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-gmoviz/1.18.0--r44hdfd78af_0
```
