...
updated_at: "2026-07-01 07:19:14.545397"
latest: "26.6.21--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/funannotate2:26.6.21--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/funannotate2/26.6.21--pyhdfd78af_0
$ module help quay.io/biocontainers/funannotate2/26.6.21--pyhdfd78af_0
```
