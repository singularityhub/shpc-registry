---
layout: container
name:  "quay.io/biocontainers/neoloop"
maintainer: "@vsoch"
...
aliases:
 ...
 - "streamer_1d"
versions:
 - "0.4.3.post2--pyhdfd78af_0"
description: "singularity registry hpc automated addition for neoloop"
config: {"url": "https://biocontainers.pro/tools/neoloop", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for neoloop", "latest": {"0.4.3.post2--pyhdfd78af_0": "sha256:71f2acb1330cd61786bae1308b214681cc455bb970e22b83e18b9eae9035ead1"}, "tags": {"0.4.3.post2--pyhdfd78af_0": "sha256:71f2acb1330cd61786bae1308b214681cc455bb970e22b83e18b9eae9035ead1"}, "docker": "quay.io/biocontainers/neoloop", "aliases": {"add_prefix_to_cool.py": "/usr/local/bin/add_prefix_to_cool.py", "assemble-complexSVs": "/usr/local/bin/assemble-complexSVs", "calculate-cnv": "/usr/local/bin/calculate-cnv", "calfea": "/usr/local/bin/calfea", "cmtime": "/usr/local/bin/cmtime", "correct-cnv": "/usr/local/bin/correct-cnv", "domaincaller": "/usr/local/bin/domaincaller", "get_gprof": "/usr/local/bin/get_gprof", "h5fuse.sh": "/usr/local/bin/h5fuse.sh", "hitad": "/usr/local/bin/hitad", "ib_acme": "/usr/local/bin/ib_acme", "ibv_asyncwatch": "/usr/local/bin/ibv_asyncwatch", "ibv_devices": "/usr/local/bin/ibv_devices", "ibv_devinfo": "/usr/local/bin/ibv_devinfo", "ibv_rc_pingpong": "/usr/local/bin/ibv_rc_pingpong", "ibv_srq_pingpong": "/usr/local/bin/ibv_srq_pingpong", "ibv_uc_pingpong": "/usr/local/bin/ibv_uc_pingpong", "ibv_ud_pingpong": "/usr/local/bin/ibv_ud_pingpong", "ibv_xsrq_pingpong": "/usr/local/bin/ibv_xsrq_pingpong", "isort": "/usr/local/bin/isort", "isort-identify-imports": "/usr/local/bin/isort-identify-imports", "mckey": "/usr/local/bin/mckey", "neoloop-caller": "/usr/local/bin/neoloop-caller", "neotad-caller": "/usr/local/bin/neotad-caller", "output-DI": "/usr/local/bin/output-DI", "plot-cnv": "/usr/local/bin/plot-cnv", "prepare-SV-breakpoints.py": "/usr/local/bin/prepare-SV-breakpoints.py", "protoc-24.3.0": "/usr/local/bin/protoc-24.3.0", "pyensembl": "/usr/local/bin/pyensembl", "pylint": "/usr/local/bin/pylint", "pylint-config": "/usr/local/bin/pylint-config", "pyreverse": "/usr/local/bin/pyreverse", "rcopy": "/usr/local/bin/rcopy", "rdma_client": "/usr/local/bin/rdma_client", "rdma_server": "/usr/local/bin/rdma_server", "rdma_xclient": "/usr/local/bin/rdma_xclient", "rdma_xserver": "/usr/local/bin/rdma_xserver", "riostream": "/usr/local/bin/riostream", "rping": "/usr/local/bin/rping", "rstream": "/usr/local/bin/rstream", "searchSVbyGene": "/usr/local/bin/searchSVbyGene", "segment-cnv": "/usr/local/bin/segment-cnv", "simulate-cnv": "/usr/local/bin/simulate-cnv", "symilar": "/usr/local/bin/symilar", "tad-plot": "/usr/local/bin/tad-plot", "ucmatose": "/usr/local/bin/ucmatose", "udaddy": "/usr/local/bin/udaddy", "udpong": "/usr/local/bin/udpong", "io_demo": "/usr/local/bin/io_demo", "ucx_info": "/usr/local/bin/ucx_info", "ucx_perftest": "/usr/local/bin/ucx_perftest", "ucx_read_profile": "/usr/local/bin/ucx_read_profile", "dask": "/usr/local/bin/dask", "elastipubsub5": "/usr/local/bin/elastipubsub5", "mqtt5_app": "/usr/local/bin/mqtt5_app", "mqtt5_canary": "/usr/local/bin/mqtt5_canary", "mqtt5canary": "/usr/local/bin/mqtt5canary", "produce_x_platform_fuzz_corpus": "/usr/local/bin/produce_x_platform_fuzz_corpus", "run_x_platform_fuzz_corpus": "/usr/local/bin/run_x_platform_fuzz_corpus", "cooler": "/usr/local/bin/cooler", "bam2pairs": "/usr/local/bin/bam2pairs", "column_remover.pl": "/usr/local/bin/column_remover.pl", "duplicate_header_remover.pl": "/usr/local/bin/duplicate_header_remover.pl", "fragment_4dnpairs.pl": "/usr/local/bin/fragment_4dnpairs.pl", "juicer_shortform2pairs.pl": "/usr/local/bin/juicer_shortform2pairs.pl", "merge-pairs.sh": "/usr/local/bin/merge-pairs.sh", "merged_nodup2pairs.pl": "/usr/local/bin/merged_nodup2pairs.pl", "old_merged_nodup2pairs.pl": "/usr/local/bin/old_merged_nodup2pairs.pl", "pairix": "/usr/local/bin/pairix", "pairs_merger": "/usr/local/bin/pairs_merger", "process_merged_nodup.sh": "/usr/local/bin/process_merged_nodup.sh", "process_old_merged_nodup.sh": "/usr/local/bin/process_old_merged_nodup.sh", "streamer_1d": "/usr/local/bin/streamer_1d"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/neoloop.
singularity registry hpc automated addition for neoloop
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/neoloop
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/neoloop:0.4.3.post2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/neoloop/0.4.3.post2--pyhdfd78af_0
$ module help quay.io/biocontainers/neoloop/0.4.3.post2--pyhdfd78af_0
```
...
#### neoloop-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### neoloop-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/add_prefix_to_cool.py
$ podman run --it --rm --entrypoint /usr/local/bin/add_prefix_to_cool.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/add_prefix_to_cool.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/assemble-complexSVs
$ podman run --it --rm --entrypoint /usr/local/bin/assemble-complexSVs   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/assemble-complexSVs   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/calculate-cnv
$ podman run --it --rm --entrypoint /usr/local/bin/calculate-cnv   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/calculate-cnv   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/calfea
$ podman run --it --rm --entrypoint /usr/local/bin/calfea   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/calfea   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/correct-cnv
$ podman run --it --rm --entrypoint /usr/local/bin/correct-cnv   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/correct-cnv   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/domaincaller
$ podman run --it --rm --entrypoint /usr/local/bin/domaincaller   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/domaincaller   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/hitad
$ podman run --it --rm --entrypoint /usr/local/bin/hitad   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/hitad   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/neoloop-caller
$ podman run --it --rm --entrypoint /usr/local/bin/neoloop-caller   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/neoloop-caller   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/neotad-caller
$ podman run --it --rm --entrypoint /usr/local/bin/neotad-caller   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/neotad-caller   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/output-DI
$ podman run --it --rm --entrypoint /usr/local/bin/output-DI   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/output-DI   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/plot-cnv
$ podman run --it --rm --entrypoint /usr/local/bin/plot-cnv   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/plot-cnv   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/prepare-SV-breakpoints.py
$ podman run --it --rm --entrypoint /usr/local/bin/prepare-SV-breakpoints.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/prepare-SV-breakpoints.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/searchSVbyGene
$ podman run --it --rm --entrypoint /usr/local/bin/searchSVbyGene   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/searchSVbyGene   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/segment-cnv
$ podman run --it --rm --entrypoint /usr/local/bin/segment-cnv   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/segment-cnv   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/simulate-cnv
$ podman run --it --rm --entrypoint /usr/local/bin/simulate-cnv   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/simulate-cnv   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/tad-plot
$ podman run --it --rm --entrypoint /usr/local/bin/tad-plot   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/tad-plot   -v ${PWD} -w ${PWD} <container> -c " $@"
```
