...
updated_at: "2025-02-20 03:32:17.840532"
...
```bash
$ shpc install quay.io/biocontainers/scmidas:0.1.7--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/scmidas/0.1.7--pyhdfd78af_0
$ module help quay.io/biocontainers/scmidas/0.1.7--pyhdfd78af_0
```
