...
updated_at: "2025-01-20 03:19:49.537449"
...
```bash
$ shpc install quay.io/biocontainers/scmidas:0.1.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/scmidas/0.1.4--pyhdfd78af_0
$ module help quay.io/biocontainers/scmidas/0.1.4--pyhdfd78af_0
```
