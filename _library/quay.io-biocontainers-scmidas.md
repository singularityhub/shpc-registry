...
updated_at: "2026-01-18 04:13:42.823728"
...
```bash
$ shpc install quay.io/biocontainers/scmidas:0.1.15--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/scmidas/0.1.15--pyhdfd78af_0
$ module help quay.io/biocontainers/scmidas/0.1.15--pyhdfd78af_0
```
