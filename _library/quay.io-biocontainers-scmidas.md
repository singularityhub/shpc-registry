...
updated_at: "2026-05-23 06:07:03.564461"
...
```bash
$ shpc install quay.io/biocontainers/scmidas:0.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/scmidas/0.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/scmidas/0.2.0--pyhdfd78af_0
```
