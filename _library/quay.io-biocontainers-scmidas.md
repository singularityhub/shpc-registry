...
updated_at: "2026-06-17 07:48:29.483950"
...
```bash
$ shpc install quay.io/biocontainers/scmidas:0.3.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/scmidas/0.3.0--pyhdfd78af_0
$ module help quay.io/biocontainers/scmidas/0.3.0--pyhdfd78af_0
```
