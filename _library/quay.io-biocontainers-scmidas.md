...
updated_at: "2026-04-26 05:44:48.485159"
latest: "0.1.17--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/scmidas:0.1.17--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/scmidas/0.1.17--pyhdfd78af_0
$ module help quay.io/biocontainers/scmidas/0.1.17--pyhdfd78af_0
```
