...
updated_at: "2023-12-23 02:56:11.541695"
...
```bash
$ shpc install quay.io/biocontainers/compleasm:0.2.4--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/compleasm/0.2.4--pyh7cba7a3_0
$ module help quay.io/biocontainers/compleasm/0.2.4--pyh7cba7a3_0
```
