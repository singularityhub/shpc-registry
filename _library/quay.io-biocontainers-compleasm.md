...
updated_at: "2026-09-05 07:24:34.560465"
...
```bash
$ shpc install quay.io/biocontainers/compleasm:0.2.9--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/compleasm/0.2.9--pyhdfd78af_0
$ module help quay.io/biocontainers/compleasm/0.2.9--pyhdfd78af_0
```
