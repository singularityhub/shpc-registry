...
updated_at: "2026-07-01 15:06:08.204341"
...
```bash
$ shpc install quay.io/biocontainers/metaquantome:2.0.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/metaquantome/2.0.4--pyhdfd78af_0
$ module help quay.io/biocontainers/metaquantome/2.0.4--pyhdfd78af_0
```
