---
layout: container
name:  "quay.io/biocontainers/bioconductor-raids"
maintainer: "@vsoch"
github: "https://github.com/singularityhub/shpc-registry/blob/main/quay.io/biocontainers/bioconductor-raids/container.yaml"
config_url: "https://raw.githubusercontent.com/singularityhub/shpc-registry/main/quay.io/biocontainers/bioconductor-raids/container.yaml"
updated_at: "2025-01-26 02:57:18.128372"
latest: "1.0.0--r43hdfd78af_0"
container_url: "https://biocontainers.pro/tools/bioconductor-raids"
aliases:
 - "pcre2posix_test"
 - "2to3-3.12"
 - "idle3.12"
...
versions:
 - "1.0.0--r43hdfd78af_0"
description: "singularity registry hpc automated addition for bioconductor-raids"
config: {"url": "https://biocontainers.pro/tools/bioconductor-raids", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for bioconductor-raids", "latest": {"1.0.0--r43hdfd78af_0": "sha256:85b0631a13ce86a9b34f385ed4a43f97d44431c6c748ea825fe3908dbbc192c5"}, "tags": {"1.0.0--r43hdfd78af_0": "sha256:85b0631a13ce86a9b34f385ed4a43f97d44431c6c748ea825fe3908dbbc192c5"}, "docker": "quay.io/biocontainers/bioconductor-raids", "aliases": {"pcre2posix_test": "/usr/local/bin/pcre2posix_test", "2to3-3.12": "/usr/local/bin/2to3-3.12", "idle3.12": "/usr/local/bin/idle3.12", "pydoc3.12": "/usr/local/bin/pydoc3.12", "python3.12": "/usr/local/bin/python3.12", "python3.12-config": "/usr/local/bin/python3.12-config", "hb-info": "/usr/local/bin/hb-info", "glpsol": "/usr/local/bin/glpsol", "installBiocDataPackage.sh": "/usr/local/bin/installBiocDataPackage.sh", "tjbench": "/usr/local/bin/tjbench", "tomlq": "/usr/local/bin/tomlq", "xq": "/usr/local/bin/xq", "yq": "/usr/local/bin/yq", "jq": "/usr/local/bin/jq", "onig-config": "/usr/local/bin/onig-config", "activate-global-python-argcomplete": "/usr/local/bin/activate-global-python-argcomplete", "python-argcomplete-check-easy-install-script": "/usr/local/bin/python-argcomplete-check-easy-install-script", "register-python-argcomplete": "/usr/local/bin/register-python-argcomplete"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/bioconductor-raids.
singularity registry hpc automated addition for bioconductor-raids
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/bioconductor-raids
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-raids:1.0.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-raids/1.0.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-raids/1.0.0--r43hdfd78af_0
```
...
#### bioconductor-raids-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-raids-inspect-deffile:
