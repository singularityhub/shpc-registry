...
updated_at: "2025-05-02 03:38:14.350540"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-compounddb:1.10.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-compounddb/1.10.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-compounddb/1.10.0--r44hdfd78af_0
```
