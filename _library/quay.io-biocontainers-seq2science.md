...
updated_at: "2023-09-04 02:38:10.034472"
...
```bash
$ shpc install quay.io/biocontainers/seq2science:1.0.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/seq2science/1.0.3--pyhdfd78af_0
$ module help quay.io/biocontainers/seq2science/1.0.3--pyhdfd78af_0
```
