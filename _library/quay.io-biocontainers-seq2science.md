...
updated_at: "2023-11-27 02:57:53.610799"
...
```bash
$ shpc install quay.io/biocontainers/seq2science:1.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/seq2science/1.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/seq2science/1.2.0--pyhdfd78af_0
```
