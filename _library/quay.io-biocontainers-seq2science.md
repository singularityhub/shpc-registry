...
updated_at: "2023-09-16 23:38:25.880837"
...
```bash
$ shpc install quay.io/biocontainers/seq2science:1.0.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/seq2science/1.0.4--pyhdfd78af_0
$ module help quay.io/biocontainers/seq2science/1.0.4--pyhdfd78af_0
```
