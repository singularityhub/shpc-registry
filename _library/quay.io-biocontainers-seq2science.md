...
updated_at: "2023-06-12 05:08:50.019274"
...
```bash
$ shpc install quay.io/biocontainers/seq2science:1.0.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/seq2science/1.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/seq2science/1.0.0--pyhdfd78af_0
```
