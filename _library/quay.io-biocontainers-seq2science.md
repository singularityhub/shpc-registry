...
updated_at: "2023-07-31 02:42:41.314764"
...
```bash
$ shpc install quay.io/biocontainers/seq2science:1.0.0--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/seq2science/1.0.0--pyhdfd78af_1
$ module help quay.io/biocontainers/seq2science/1.0.0--pyhdfd78af_1
```
