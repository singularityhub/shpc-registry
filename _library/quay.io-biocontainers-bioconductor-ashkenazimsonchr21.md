...
updated_at: "2026-05-09 06:46:05.965009"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ashkenazimsonchr21:1.40.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ashkenazimsonchr21/1.40.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ashkenazimsonchr21/1.40.0--r45hdfd78af_0
```
