...
updated_at: "2024-04-01 02:41:26.567863"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hu35ksubdprobe:2.18.0--r43hdfd78af_12
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hu35ksubdprobe/2.18.0--r43hdfd78af_12
$ module help quay.io/biocontainers/bioconductor-hu35ksubdprobe/2.18.0--r43hdfd78af_12
```
