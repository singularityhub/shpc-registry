...
updated_at: "2025-10-10 03:57:16.714561"
latest: "9.1.4"
...
```bash
$ shpc install elasticsearch:9.1.4
```
...
```bash
$ module load elasticsearch/9.1.4
$ module help elasticsearch/9.1.4
```
