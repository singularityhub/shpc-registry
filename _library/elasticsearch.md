...
updated_at: "2024-01-20 03:13:13.009525"
latest: "8.11.3"
...
```bash
$ shpc install elasticsearch:8.11.3
```
...
```bash
$ module load elasticsearch/8.11.3
$ module help elasticsearch/8.11.3
```
