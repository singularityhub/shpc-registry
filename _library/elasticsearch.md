...
updated_at: "2026-08-19 03:59:20.240611"
latest: "9.4.3"
...
```bash
$ shpc install elasticsearch:9.4.3
```
...
```bash
$ module load elasticsearch/9.4.3
$ module help elasticsearch/9.4.3
```
