...
updated_at: "2023-07-05 03:01:30.490275"
latest: "8.8.1"
...
```bash
$ shpc install elasticsearch:8.8.1
```
...
```bash
$ module load elasticsearch/8.8.1
$ module help elasticsearch/8.8.1
```
