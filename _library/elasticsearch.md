...
updated_at: "2024-04-14 04:01:58.514479"
latest: "8.12.2"
...
```bash
$ shpc install elasticsearch:8.12.2
```
...
```bash
$ module load elasticsearch/8.12.2
$ module help elasticsearch/8.12.2
```
