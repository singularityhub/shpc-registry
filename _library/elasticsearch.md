...
updated_at: "2026-03-05 04:33:16.870073"
latest: "9.3.0"
...
```bash
$ shpc install elasticsearch:9.3.0
```
...
```bash
$ module load elasticsearch/9.3.0
$ module help elasticsearch/9.3.0
```
