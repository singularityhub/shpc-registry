...
updated_at: "2023-01-23 03:40:55.090865"
latest: "8.6.0"
...
```bash
$ shpc install elasticsearch:8.6.0
```
...
```bash
$ module load elasticsearch/8.6.0
$ module help elasticsearch/8.6.0
```
