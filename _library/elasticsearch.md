...
updated_at: "2025-08-08 03:46:20.667551"
latest: "9.0.3"
...
```bash
$ shpc install elasticsearch:9.0.3
```
...
```bash
$ module load elasticsearch/9.0.3
$ module help elasticsearch/9.0.3
```
