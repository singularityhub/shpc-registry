...
updated_at: "2025-05-24 11:59:00.579867"
latest: "9.0.1"
...
```bash
$ shpc install elasticsearch:9.0.1
```
...
```bash
$ module load elasticsearch/9.0.1
$ module help elasticsearch/9.0.1
```
