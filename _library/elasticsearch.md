...
updated_at: "2025-04-10 03:51:36.875885"
latest: "8.17.3"
...
```bash
$ shpc install elasticsearch:8.17.3
```
...
```bash
$ module load elasticsearch/8.17.3
$ module help elasticsearch/8.17.3
```
