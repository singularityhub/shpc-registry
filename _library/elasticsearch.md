...
updated_at: "2025-11-01 04:06:35.623963"
latest: "9.1.5"
...
```bash
$ shpc install elasticsearch:9.1.5
```
...
```bash
$ module load elasticsearch/9.1.5
$ module help elasticsearch/9.1.5
```
