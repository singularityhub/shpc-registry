...
updated_at: "2026-02-05 05:10:35.711946"
latest: "9.2.4"
...
```bash
$ shpc install elasticsearch:9.2.4
```
...
```bash
$ module load elasticsearch/9.2.4
$ module help elasticsearch/9.2.4
```
