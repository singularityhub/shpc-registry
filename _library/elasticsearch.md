...
updated_at: "2023-01-18 03:43:55.852915"
latest: "8.5.3"
...
```bash
$ shpc install elasticsearch:8.5.3
```
...
```bash
$ module load elasticsearch/8.5.3
$ module help elasticsearch/8.5.3
```
