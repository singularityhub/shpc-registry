...
updated_at: "2024-08-24 02:37:56.633007"
latest: "8.15.0"
...
```bash
$ shpc install elasticsearch:8.15.0
```
...
```bash
$ module load elasticsearch/8.15.0
$ module help elasticsearch/8.15.0
```
