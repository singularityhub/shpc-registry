...
updated_at: "2024-07-01 03:36:24.563882"
latest: "8.14.1"
...
```bash
$ shpc install elasticsearch:8.14.1
```
...
```bash
$ module load elasticsearch/8.14.1
$ module help elasticsearch/8.14.1
```
