...
updated_at: "2023-03-22 03:35:48.741709"
latest: "8.6.2"
...
```bash
$ shpc install elasticsearch:8.6.2
```
...
```bash
$ module load elasticsearch/8.6.2
$ module help elasticsearch/8.6.2
```
