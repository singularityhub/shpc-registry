...
updated_at: "2024-01-26 03:14:11.686933"
latest: "8.12.0"
...
```bash
$ shpc install elasticsearch:8.12.0
```
...
```bash
$ module load elasticsearch/8.12.0
$ module help elasticsearch/8.12.0
```
