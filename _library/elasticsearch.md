...
updated_at: "2024-08-12 03:09:38.607783"
latest: "8.14.3"
...
```bash
$ shpc install elasticsearch:8.14.3
```
...
```bash
$ module load elasticsearch/8.14.3
$ module help elasticsearch/8.14.3
```
