...
updated_at: "2024-03-14 03:05:37.455031"
latest: "8.12.1"
...
```bash
$ shpc install elasticsearch:8.12.1
```
...
```bash
$ module load elasticsearch/8.12.1
$ module help elasticsearch/8.12.1
```
