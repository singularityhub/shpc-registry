...
updated_at: "2026-06-12 07:39:32.542161"
latest: "9.4.1"
...
```bash
$ shpc install elasticsearch:9.4.1
```
...
```bash
$ module load elasticsearch/9.4.1
$ module help elasticsearch/9.4.1
```
