...
updated_at: "2026-06-29 07:43:40.731362"
latest: "9.4.2"
...
```bash
$ shpc install elasticsearch:9.4.2
```
...
```bash
$ module load elasticsearch/9.4.2
$ module help elasticsearch/9.4.2
```
