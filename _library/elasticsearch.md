...
updated_at: "2025-03-14 03:46:42.819364"
latest: "8.17.2"
...
```bash
$ shpc install elasticsearch:8.17.2
```
...
```bash
$ module load elasticsearch/8.17.2
$ module help elasticsearch/8.17.2
```
