...
updated_at: "2026-04-02 05:30:34.226102"
latest: "9.3.2"
...
```bash
$ shpc install elasticsearch:9.3.2
```
...
```bash
$ module load elasticsearch/9.3.2
$ module help elasticsearch/9.3.2
```
