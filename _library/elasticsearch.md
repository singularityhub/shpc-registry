...
updated_at: "2025-07-03 19:18:18.991106"
latest: "9.0.2"
...
```bash
$ shpc install elasticsearch:9.0.2
```
...
```bash
$ module load elasticsearch/9.0.2
$ module help elasticsearch/9.0.2
```
