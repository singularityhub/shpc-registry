...
updated_at: "2023-10-09 03:30:55.065614"
latest: "8.10.1"
...
```bash
$ shpc install elasticsearch:8.10.1
```
...
```bash
$ module load elasticsearch/8.10.1
$ module help elasticsearch/8.10.1
```
