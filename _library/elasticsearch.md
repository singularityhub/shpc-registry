...
updated_at: "2024-09-26 11:05:13.585385"
latest: "8.15.1"
...
```bash
$ shpc install elasticsearch:8.15.1
```
...
```bash
$ module load elasticsearch/8.15.1
$ module help elasticsearch/8.15.1
```
