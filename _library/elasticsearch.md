...
updated_at: "2025-09-11 03:01:43.089481"
latest: "9.1.2"
...
```bash
$ shpc install elasticsearch:9.1.2
```
...
```bash
$ module load elasticsearch/9.1.2
$ module help elasticsearch/9.1.2
```
