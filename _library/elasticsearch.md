...
updated_at: "2025-01-08 07:15:19.660495"
latest: "8.17.0"
...
```bash
$ shpc install elasticsearch:8.17.0
```
...
```bash
$ module load elasticsearch/8.17.0
$ module help elasticsearch/8.17.0
```
