...
updated_at: "2024-11-20 03:47:19.847371"
latest: "8.15.3"
...
```bash
$ shpc install elasticsearch:8.15.3
```
...
```bash
$ module load elasticsearch/8.15.3
$ module help elasticsearch/8.15.3
```
