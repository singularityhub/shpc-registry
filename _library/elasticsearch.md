...
updated_at: "2025-12-11 05:02:07.702725"
latest: "9.2.1"
...
```bash
$ shpc install elasticsearch:9.2.1
```
...
```bash
$ module load elasticsearch/9.2.1
$ module help elasticsearch/9.2.1
```
