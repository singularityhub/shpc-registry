...
updated_at: "2025-04-28 04:10:22.574584"
latest: "8.18.0"
...
```bash
$ shpc install elasticsearch:8.18.0
```
...
```bash
$ module load elasticsearch/8.18.0
$ module help elasticsearch/8.18.0
```
