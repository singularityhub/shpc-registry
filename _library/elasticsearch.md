...
updated_at: "2024-06-16 03:23:55.115236"
latest: "8.13.4"
...
```bash
$ shpc install elasticsearch:8.13.4
```
...
```bash
$ module load elasticsearch/8.13.4
$ module help elasticsearch/8.13.4
```
