...
updated_at: "2026-09-23 07:30:38.890853"
latest: "9.5.3"
...
```bash
$ shpc install elasticsearch:9.5.3
```
...
```bash
$ module load elasticsearch/9.5.3
$ module help elasticsearch/9.5.3
```
