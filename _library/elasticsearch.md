...
updated_at: "2024-05-13 03:33:34.093248"
latest: "8.13.0"
...
```bash
$ shpc install elasticsearch:8.13.0
```
...
```bash
$ module load elasticsearch/8.13.0
$ module help elasticsearch/8.13.0
```
