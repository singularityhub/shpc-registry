...
updated_at: "2023-05-01 03:08:21.411015"
latest: "8.7.0"
...
```bash
$ shpc install elasticsearch:8.7.0
```
...
```bash
$ module load elasticsearch/8.7.0
$ module help elasticsearch/8.7.0
```
