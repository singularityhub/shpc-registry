...
updated_at: "2024-11-24 03:50:31.262012"
latest: "8.16.0"
...
```bash
$ shpc install elasticsearch:8.16.0
```
...
```bash
$ module load elasticsearch/8.16.0
$ module help elasticsearch/8.16.0
```
