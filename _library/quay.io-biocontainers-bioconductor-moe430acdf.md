...
updated_at: "2023-12-08 02:49:33.420540"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-moe430acdf:2.18.0--r43hdfd78af_12
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-moe430acdf/2.18.0--r43hdfd78af_12
$ module help quay.io/biocontainers/bioconductor-moe430acdf/2.18.0--r43hdfd78af_12
```
