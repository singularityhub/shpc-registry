...
updated_at: "2026-08-28 14:18:56.503434"
...
```bash
$ shpc install quay.io/biocontainers/paragone:1.1.5--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/paragone/1.1.5--pyhdfd78af_1
$ module help quay.io/biocontainers/paragone/1.1.5--pyhdfd78af_1
```
