...
updated_at: "2026-06-16 08:10:48.140110"
...
```bash
$ shpc install quay.io/biocontainers/paragone:1.1.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/paragone/1.1.5--pyhdfd78af_0
$ module help quay.io/biocontainers/paragone/1.1.5--pyhdfd78af_0
```
