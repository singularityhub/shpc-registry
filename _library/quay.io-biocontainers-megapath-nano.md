...
updated_at: "2023-02-22 03:16:38.425441"
...
```bash
$ shpc install quay.io/biocontainers/megapath-nano:1.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/megapath-nano/1.0--hdfd78af_0
$ module help quay.io/biocontainers/megapath-nano/1.0--hdfd78af_0
```
