...
updated_at: "2023-07-22 02:50:49.453813"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-metcirc:1.30.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-metcirc/1.30.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-metcirc/1.30.0--r43hdfd78af_0
```
