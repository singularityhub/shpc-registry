...
updated_at: "2026-01-27 04:04:05.546936"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-metcirc:1.36.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-metcirc/1.36.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-metcirc/1.36.0--r44hdfd78af_0
```
