...
updated_at: "2026-05-31 06:35:39.993531"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-metcirc:1.40.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-metcirc/1.40.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-metcirc/1.40.0--r45hdfd78af_0
```
