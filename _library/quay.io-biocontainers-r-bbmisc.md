---
layout: container
name:  "quay.io/biocontainers/r-bbmisc"
maintainer: "@vsoch"
...
updated_at: "2025-04-20 03:34:55.651713"
...
```bash
$ shpc install quay.io/biocontainers/r-bbmisc
```
...
#### r-bbmisc-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-bbmisc-inspect-deffile:
