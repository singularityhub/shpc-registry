---
layout: container
name:  "quay.io/biocontainers/lamps"
maintainer: "@vsoch"
...
updated_at: "2025-08-10 04:35:57.180829"
...
```bash
$ shpc install quay.io/biocontainers/lamps
```
...
#### lamps-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### lamps-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/lamp
$ podman run --it --rm --entrypoint /usr/local/bin/lamp   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/lamp   -v ${PWD} -w ${PWD} <container> -c " $@"
```
