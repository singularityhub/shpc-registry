...
updated_at: "2024-11-01 03:01:36.238116"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-flowploidy:1.28.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-flowploidy/1.28.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-flowploidy/1.28.0--r43hdfd78af_0
```
