...
updated_at: "2022-10-27 00:34:47.696286"
latest: "1.8.0--r351_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-flowploidy:1.8.0--r351_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-flowploidy/1.8.0--r351_0
$ module help quay.io/biocontainers/bioconductor-flowploidy/1.8.0--r351_0
```
