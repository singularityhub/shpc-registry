...
updated_at: "2025-04-24 03:32:19.491476"
latest: "0.3.3--h4d20210_1"
...
```bash
$ shpc install quay.io/biocontainers/dicey:0.3.3--h4d20210_1
```
...
```bash
$ module load quay.io/biocontainers/dicey/0.3.3--h4d20210_1
$ module help quay.io/biocontainers/dicey/0.3.3--h4d20210_1
```
