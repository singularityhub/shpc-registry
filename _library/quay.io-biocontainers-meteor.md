...
updated_at: "2025-05-08 03:33:17.165040"
...
```bash
$ shpc install quay.io/biocontainers/meteor:2.0.18--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/meteor/2.0.18--pyhdfd78af_0
$ module help quay.io/biocontainers/meteor/2.0.18--pyhdfd78af_0
```
