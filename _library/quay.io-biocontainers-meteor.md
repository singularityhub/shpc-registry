...
updated_at: "2024-05-25 02:38:10.040784"
...
```bash
$ shpc install quay.io/biocontainers/meteor:2.0.9--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/meteor/2.0.9--pyhdfd78af_0
$ module help quay.io/biocontainers/meteor/2.0.9--pyhdfd78af_0
```
