...
updated_at: "2025-01-30 02:49:32.378238"
...
```bash
$ shpc install quay.io/biocontainers/meteor:2.0.17--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/meteor/2.0.17--pyhdfd78af_0
$ module help quay.io/biocontainers/meteor/2.0.17--pyhdfd78af_0
```
