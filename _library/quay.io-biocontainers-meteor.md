...
updated_at: "2024-09-30 04:51:49.348463"
...
```bash
$ shpc install quay.io/biocontainers/meteor:2.0.16--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/meteor/2.0.16--pyhdfd78af_0
$ module help quay.io/biocontainers/meteor/2.0.16--pyhdfd78af_0
```
