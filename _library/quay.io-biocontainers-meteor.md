...
updated_at: "2025-12-11 04:04:51.994223"
...
```bash
$ shpc install quay.io/biocontainers/meteor:2.0.21--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/meteor/2.0.21--pyhdfd78af_0
$ module help quay.io/biocontainers/meteor/2.0.21--pyhdfd78af_0
```
