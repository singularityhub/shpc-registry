...
updated_at: "2025-09-28 03:47:37.323213"
...
```bash
$ shpc install quay.io/biocontainers/meteor:2.0.20--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/meteor/2.0.20--pyhdfd78af_0
$ module help quay.io/biocontainers/meteor/2.0.20--pyhdfd78af_0
```
