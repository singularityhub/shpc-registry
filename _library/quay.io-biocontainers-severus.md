...
updated_at: "2025-04-24 03:44:06.211865"
...
```bash
$ shpc install quay.io/biocontainers/severus:1.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/severus/1.4--pyhdfd78af_0
$ module help quay.io/biocontainers/severus/1.4--pyhdfd78af_0
```
