...
updated_at: "2024-09-02 02:49:26.666839"
...
```bash
$ shpc install quay.io/biocontainers/severus:1.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/severus/1.1--pyhdfd78af_0
$ module help quay.io/biocontainers/severus/1.1--pyhdfd78af_0
```
