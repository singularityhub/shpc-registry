...
updated_at: "2025-10-11 03:26:15.755139"
...
```bash
$ shpc install quay.io/biocontainers/severus:1.6--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/severus/1.6--pyhdfd78af_0
$ module help quay.io/biocontainers/severus/1.6--pyhdfd78af_0
```
