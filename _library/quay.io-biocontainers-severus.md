...
updated_at: "2024-05-03 02:29:23.744043"
...
```bash
$ shpc install quay.io/biocontainers/severus:1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/severus/1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/severus/1.0--pyhdfd78af_0
```
