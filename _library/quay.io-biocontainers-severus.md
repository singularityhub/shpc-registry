...
updated_at: "2025-05-20 03:22:36.706077"
...
```bash
$ shpc install quay.io/biocontainers/severus:1.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/severus/1.5--pyhdfd78af_0
$ module help quay.io/biocontainers/severus/1.5--pyhdfd78af_0
```
