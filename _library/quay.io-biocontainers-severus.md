---
layout: container
name:  "quay.io/biocontainers/severus"
maintainer: "@vsoch"
...
updated_at: "2026-03-31 05:20:06.498544"
...
```bash
$ shpc install quay.io/biocontainers/severus
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/severus:1.7--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/severus/1.7--pyhdfd78af_0
$ module help quay.io/biocontainers/severus/1.7--pyhdfd78af_0
```
...
#### severus-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### severus-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/severus
$ podman run --it --rm --entrypoint /usr/local/bin/severus   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/severus   -v ${PWD} -w ${PWD} <container> -c " $@"
```
