...
updated_at: "2026-04-05 04:41:43.458628"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-breakpointrdata:1.28.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-breakpointrdata/1.28.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-breakpointrdata/1.28.0--r45hdfd78af_0
```
