...
updated_at: "2025-09-08 04:53:19.398514"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-breakpointrdata:1.24.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-breakpointrdata/1.24.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-breakpointrdata/1.24.0--r44hdfd78af_0
```
