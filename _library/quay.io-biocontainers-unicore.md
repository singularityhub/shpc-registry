...
updated_at: "2025-01-22 03:12:45.324363"
latest: "1.0.2--h7ef3eeb_0"
...
```bash
$ shpc install quay.io/biocontainers/unicore:1.0.2--h7ef3eeb_0
```
...
```bash
$ module load quay.io/biocontainers/unicore/1.0.2--h7ef3eeb_0
$ module help quay.io/biocontainers/unicore/1.0.2--h7ef3eeb_0
```
