...
updated_at: "2025-01-11 03:37:17.942655"
latest: "1.0.1--h7ef3eeb_0"
...
```bash
$ shpc install quay.io/biocontainers/unicore:1.0.1--h7ef3eeb_0
```
...
```bash
$ module load quay.io/biocontainers/unicore/1.0.1--h7ef3eeb_0
$ module help quay.io/biocontainers/unicore/1.0.1--h7ef3eeb_0
```
