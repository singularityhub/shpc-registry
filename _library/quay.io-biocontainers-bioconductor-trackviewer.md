...
updated_at: "2026-05-17 06:35:49.452776"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-trackviewer:1.46.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-trackviewer/1.46.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-trackviewer/1.46.0--r45hdfd78af_0
```
