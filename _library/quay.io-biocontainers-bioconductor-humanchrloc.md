...
updated_at: "2026-03-21 04:40:11.524057"
latest: "2.1.6--r45hdfd78af_14"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-humanchrloc:2.1.6--r45hdfd78af_14
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-humanchrloc/2.1.6--r45hdfd78af_14
$ module help quay.io/biocontainers/bioconductor-humanchrloc/2.1.6--r45hdfd78af_14
```
