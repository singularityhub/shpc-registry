...
updated_at: "2022-11-07 01:04:07.094874"
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-humanchrloc-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-humanchrloc-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-humanchrloc-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-humanchrloc-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-humanchrloc-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-humanchrloc-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
