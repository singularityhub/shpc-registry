---
layout: container
name:  "quay.io/biocontainers/bioconductor-ifaa"
maintainer: "@vsoch"
...
updated_at: "2024-11-10 03:37:55.523037"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ifaa
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-ifaa:1.4.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ifaa/1.4.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ifaa/1.4.0--r43hdfd78af_0
```
...
#### bioconductor-ifaa-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-ifaa-inspect-deffile:
