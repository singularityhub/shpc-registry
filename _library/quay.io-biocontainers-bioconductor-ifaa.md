...
updated_at: "2023-12-09 03:02:56.740101"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ifaa:1.2.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ifaa/1.2.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ifaa/1.2.0--r43hdfd78af_0
```
