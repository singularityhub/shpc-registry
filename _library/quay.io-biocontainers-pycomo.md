...
updated_at: "2026-04-04 05:19:26.844666"
...
```bash
$ shpc install quay.io/biocontainers/pycomo:0.3.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pycomo/0.3.0--pyhdfd78af_0
$ module help quay.io/biocontainers/pycomo/0.3.0--pyhdfd78af_0
```
