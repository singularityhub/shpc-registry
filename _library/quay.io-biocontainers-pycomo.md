...
updated_at: "2024-11-29 03:19:18.024532"
...
```bash
$ shpc install quay.io/biocontainers/pycomo:0.2.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pycomo/0.2.5--pyhdfd78af_0
$ module help quay.io/biocontainers/pycomo/0.2.5--pyhdfd78af_0
```
