...
updated_at: "2025-02-19 03:30:18.513543"
...
```bash
$ shpc install quay.io/biocontainers/pycomo:0.2.6--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pycomo/0.2.6--pyhdfd78af_0
$ module help quay.io/biocontainers/pycomo/0.2.6--pyhdfd78af_0
```
