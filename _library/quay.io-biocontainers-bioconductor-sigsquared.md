...
updated_at: "2025-03-06 03:07:31.096509"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-sigsquared:1.38.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-sigsquared/1.38.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-sigsquared/1.38.0--r44hdfd78af_0
```
