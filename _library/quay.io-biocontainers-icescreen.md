...
updated_at: "2025-09-27 03:44:33.606988"
latest: "1.3.3--py312h7e72e81_0"
...
```bash
$ shpc install quay.io/biocontainers/icescreen:1.3.3--py312h7e72e81_0
```
...
```bash
$ module load quay.io/biocontainers/icescreen/1.3.3--py312h7e72e81_0
$ module help quay.io/biocontainers/icescreen/1.3.3--py312h7e72e81_0
```
