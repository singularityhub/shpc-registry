...
updated_at: "2023-05-19 03:01:11.285088"
latest: "1.2.0--py310h7cba7a3_0"
...
```bash
$ shpc install quay.io/biocontainers/icescreen:1.2.0--py310h7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/icescreen/1.2.0--py310h7cba7a3_0
$ module help quay.io/biocontainers/icescreen/1.2.0--py310h7cba7a3_0
```
