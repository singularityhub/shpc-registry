...
updated_at: "2024-02-15 02:30:13.402353"
latest: "1.3.1--py310h7cba7a3_0"
...
```bash
$ shpc install quay.io/biocontainers/icescreen:1.3.1--py310h7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/icescreen/1.3.1--py310h7cba7a3_0
$ module help quay.io/biocontainers/icescreen/1.3.1--py310h7cba7a3_0
```
