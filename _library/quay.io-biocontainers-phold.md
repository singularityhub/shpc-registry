...
updated_at: "2025-09-21 03:34:27.374645"
...
```bash
$ shpc install quay.io/biocontainers/phold:1.0.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/phold/1.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/phold/1.0.0--pyhdfd78af_0
```
