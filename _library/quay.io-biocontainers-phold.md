...
updated_at: "2024-03-11 02:54:26.858022"
...
```bash
$ shpc install quay.io/biocontainers/phold:0.1.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/phold/0.1.2--pyhdfd78af_0
$ module help quay.io/biocontainers/phold/0.1.2--pyhdfd78af_0
```
