...
updated_at: "2024-07-27 03:11:59.092346"
...
```bash
$ shpc install quay.io/biocontainers/phold:0.1.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/phold/0.1.4--pyhdfd78af_0
$ module help quay.io/biocontainers/phold/0.1.4--pyhdfd78af_0
```
