...
updated_at: "2024-12-27 03:27:50.669221"
...
```bash
$ shpc install quay.io/biocontainers/phold:0.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/phold/0.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/phold/0.2.0--pyhdfd78af_0
```
