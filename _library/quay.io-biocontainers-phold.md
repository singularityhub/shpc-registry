...
updated_at: "2026-02-06 04:53:05.328852"
...
```bash
$ shpc install quay.io/biocontainers/phold:1.2.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/phold/1.2.2--pyhdfd78af_0
$ module help quay.io/biocontainers/phold/1.2.2--pyhdfd78af_0
```
