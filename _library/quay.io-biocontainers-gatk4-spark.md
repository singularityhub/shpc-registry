...
updated_at: "2025-03-06 03:20:27.249178"
latest: "4.6.1.0--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/gatk4-spark:4.6.1.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/gatk4-spark/4.6.1.0--hdfd78af_0
$ module help quay.io/biocontainers/gatk4-spark/4.6.1.0--hdfd78af_0
```
