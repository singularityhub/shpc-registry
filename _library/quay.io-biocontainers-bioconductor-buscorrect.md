...
updated_at: "2024-10-13 11:11:55.246290"
latest: "1.20.0--r43ha9d7317_1"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-buscorrect:1.20.0--r43ha9d7317_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-buscorrect/1.20.0--r43ha9d7317_1
$ module help quay.io/biocontainers/bioconductor-buscorrect/1.20.0--r43ha9d7317_1
```
