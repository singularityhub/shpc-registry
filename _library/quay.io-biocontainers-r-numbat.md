...
updated_at: "2025-12-08 03:35:08.226071"
latest: "1.5.1--r44h40dc89f_0"
...
```bash
$ shpc install quay.io/biocontainers/r-numbat:1.5.1--r44h40dc89f_0
```
...
```bash
$ module load quay.io/biocontainers/r-numbat/1.5.1--r44h40dc89f_0
$ module help quay.io/biocontainers/r-numbat/1.5.1--r44h40dc89f_0
```
