---
layout: container
name:  "quay.io/biocontainers/r-numbat"
maintainer: "@vsoch"
...
updated_at: "2026-03-09 04:26:21.172355"
...
versions:
 ...
 - "1.5.1--r44h40dc89f_0"
 - "1.5.2--r44h40dc89f_0"
description: "singularity registry hpc automated addition for r-numbat"
config: {"url": "https://biocontainers.pro/tools/r-numbat", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for r-numbat", "latest": {"1.5.2--r44h40dc89f_0": "sha256:3e18d7fb86b6ead410ffa46e009f80b345c5b34f15fd09b22559e5bc7c1df698"}, "tags": {"1.4.2--r44h40dc89f_0": "sha256:57b1c310dbf89162633e408ca9b96a5202d7663fd9fbe70105bd483cf6ceac2d", "1.5.1--r44h40dc89f_0": "sha256:d9fe36700c9f6c1640e604c4d809963023d180532f38e4fc8f07144739163972", "1.5.2--r44h40dc89f_0": "sha256:3e18d7fb86b6ead410ffa46e009f80b345c5b34f15fd09b22559e5bc7c1df698"}, "docker": "quay.io/biocontainers/r-numbat", "aliases": {"idle3.14": "/usr/local/bin/idle3.14", "pydoc3.14": "/usr/local/bin/pydoc3.14", "python3.14": "/usr/local/bin/python3.14", "python3.14-config": "/usr/local/bin/python3.14-config", "x86_64-conda-linux-gnu.cfg": "/usr/local/bin/x86_64-conda-linux-gnu.cfg", "hwloc-gather-cpuid": "/usr/local/bin/hwloc-gather-cpuid", "hwloc-annotate": "/usr/local/bin/hwloc-annotate", "hwloc-bind": "/usr/local/bin/hwloc-bind", "hwloc-calc": "/usr/local/bin/hwloc-calc", "hwloc-compress-dir": "/usr/local/bin/hwloc-compress-dir", "hwloc-diff": "/usr/local/bin/hwloc-diff", "hwloc-distrib": "/usr/local/bin/hwloc-distrib", "hwloc-gather-topology": "/usr/local/bin/hwloc-gather-topology", "hwloc-info": "/usr/local/bin/hwloc-info", "hwloc-ls": "/usr/local/bin/hwloc-ls", "hwloc-patch": "/usr/local/bin/hwloc-patch", "hwloc-ps": "/usr/local/bin/hwloc-ps", "lstopo": "/usr/local/bin/lstopo", "lstopo-no-graphics": "/usr/local/bin/lstopo-no-graphics", "glpsol": "/usr/local/bin/glpsol", "installBiocDataPackage.sh": "/usr/local/bin/installBiocDataPackage.sh", "tomlq": "/usr/local/bin/tomlq", "xq": "/usr/local/bin/xq", "yq": "/usr/local/bin/yq", "jq": "/usr/local/bin/jq", "onig-config": "/usr/local/bin/onig-config", "activate-global-python-argcomplete": "/usr/local/bin/activate-global-python-argcomplete", "python-argcomplete-check-easy-install-script": "/usr/local/bin/python-argcomplete-check-easy-install-script", "register-python-argcomplete": "/usr/local/bin/register-python-argcomplete"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/r-numbat.
singularity registry hpc automated addition for r-numbat
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/r-numbat
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/r-numbat:1.5.2--r44h40dc89f_0
```
...
```bash
$ module load quay.io/biocontainers/r-numbat/1.5.2--r44h40dc89f_0
$ module help quay.io/biocontainers/r-numbat/1.5.2--r44h40dc89f_0
```
...
#### r-numbat-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-numbat-inspect-deffile:
