...
updated_at: "2025-10-22 03:24:25.047616"
latest: "1.4.2--r44h40dc89f_0"
...
```bash
$ shpc install quay.io/biocontainers/r-numbat:1.4.2--r44h40dc89f_0
```
...
```bash
$ module load quay.io/biocontainers/r-numbat/1.4.2--r44h40dc89f_0
$ module help quay.io/biocontainers/r-numbat/1.4.2--r44h40dc89f_0
```
