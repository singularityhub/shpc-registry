...
updated_at: "2026-09-03 07:16:48.780580"
...
```bash
$ shpc install quay.io/biocontainers/kcftools:0.4.0--hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/kcftools/0.4.0--hdfd78af_1
$ module help quay.io/biocontainers/kcftools/0.4.0--hdfd78af_1
```
