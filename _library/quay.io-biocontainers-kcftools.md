...
updated_at: "2025-06-09 04:19:30.145595"
...
```bash
$ shpc install quay.io/biocontainers/kcftools:0.0.1--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/kcftools/0.0.1--hdfd78af_0
$ module help quay.io/biocontainers/kcftools/0.0.1--hdfd78af_0
```
