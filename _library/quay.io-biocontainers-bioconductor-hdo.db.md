...
updated_at: "2024-05-21 03:26:49.212026"
latest: "0.99.1--r43hdfd78af_2"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hdo.db:0.99.1--r43hdfd78af_2
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hdo.db/0.99.1--r43hdfd78af_2
$ module help quay.io/biocontainers/bioconductor-hdo.db/0.99.1--r43hdfd78af_2
```
