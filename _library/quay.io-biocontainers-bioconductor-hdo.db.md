...
updated_at: "2025-05-27 11:39:55.629182"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hdo.db:1.0.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hdo.db/1.0.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-hdo.db/1.0.0--r44hdfd78af_0
```
