...
updated_at: "2023-11-06 02:57:56.359321"
latest: "0.99.1--r43hdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hdo.db:0.99.1--r43hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hdo.db/0.99.1--r43hdfd78af_1
$ module help quay.io/biocontainers/bioconductor-hdo.db/0.99.1--r43hdfd78af_1
```
