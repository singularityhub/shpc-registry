...
updated_at: "2024-01-16 03:11:19.626767"
...
```bash
$ shpc install quay.io/biocontainers/biobb_pmx:4.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_pmx/4.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/biobb_pmx/4.1.0--pyhdfd78af_0
```
