...
updated_at: "2026-06-24 06:19:09.310869"
...
```bash
$ shpc install quay.io/biocontainers/biobb_pmx:5.2.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_pmx/5.2.2--pyhdfd78af_0
$ module help quay.io/biocontainers/biobb_pmx/5.2.2--pyhdfd78af_0
```
