...
updated_at: "2024-08-29 11:23:21.277231"
...
```bash
$ shpc install quay.io/biocontainers/biobb_pmx:4.2.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_pmx/4.2.1--pyhdfd78af_0
$ module help quay.io/biocontainers/biobb_pmx/4.2.1--pyhdfd78af_0
```
