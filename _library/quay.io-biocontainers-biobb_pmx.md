...
updated_at: "2026-08-21 03:14:18.333786"
...
```bash
$ shpc install quay.io/biocontainers/biobb_pmx:5.3.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_pmx/5.3.0--pyhdfd78af_0
$ module help quay.io/biocontainers/biobb_pmx/5.3.0--pyhdfd78af_0
```
