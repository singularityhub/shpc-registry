...
updated_at: "2023-10-25 03:01:03.558044"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ampaffyexample:1.40.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ampaffyexample/1.40.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ampaffyexample/1.40.0--r43hdfd78af_0
```
