...
updated_at: "2022-11-21 00:43:55.407332"
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-genomewidesnp5crlmm-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-genomewidesnp5crlmm-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-genomewidesnp5crlmm-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-genomewidesnp5crlmm-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-genomewidesnp5crlmm-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-genomewidesnp5crlmm-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
