...
updated_at: "2024-12-30 03:07:13.935361"
...
```bash
$ shpc install quay.io/biocontainers/moni:0.2.2--py310h3d55dab_0
```
...
```bash
$ module load quay.io/biocontainers/moni/0.2.2--py310h3d55dab_0
$ module help quay.io/biocontainers/moni/0.2.2--py310h3d55dab_0
```
