...
updated_at: "2026-05-24 06:28:18.527853"
latest: "2.1.2--hd63eeec_0"
...
```bash
$ shpc install quay.io/biocontainers/mbgc:2.1.2--hd63eeec_0
```
...
```bash
$ module load quay.io/biocontainers/mbgc/2.1.2--hd63eeec_0
$ module help quay.io/biocontainers/mbgc/2.1.2--hd63eeec_0
```
