...
updated_at: "2026-06-26 06:41:44.431538"
latest: "2.1.5--hc52dbad_0"
...
```bash
$ shpc install quay.io/biocontainers/mbgc:2.1.5--hc52dbad_0
```
...
```bash
$ module load quay.io/biocontainers/mbgc/2.1.5--hc52dbad_0
$ module help quay.io/biocontainers/mbgc/2.1.5--hc52dbad_0
```
