...
updated_at: "2026-03-22 04:44:02.835694"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-tenxvisiumdata:1.18.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-tenxvisiumdata/1.18.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-tenxvisiumdata/1.18.0--r45hdfd78af_0
```
