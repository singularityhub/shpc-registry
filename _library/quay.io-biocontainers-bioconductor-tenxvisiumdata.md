...
updated_at: "2024-04-11 02:25:23.657094"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-tenxvisiumdata:1.10.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-tenxvisiumdata/1.10.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-tenxvisiumdata/1.10.0--r43hdfd78af_0
```
