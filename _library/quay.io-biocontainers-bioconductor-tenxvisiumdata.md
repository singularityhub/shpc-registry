...
updated_at: "2022-10-27 00:51:34.873062"
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-tenxvisiumdata-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-tenxvisiumdata-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-tenxvisiumdata-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-tenxvisiumdata-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-tenxvisiumdata-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-tenxvisiumdata-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
