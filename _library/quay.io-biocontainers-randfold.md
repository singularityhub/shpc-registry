...
updated_at: "2025-11-11 03:28:27.853486"
latest: "2.0.1--h7b50bb2_9"
...
```bash
$ shpc install quay.io/biocontainers/randfold:2.0.1--h7b50bb2_9
```
...
```bash
$ module load quay.io/biocontainers/randfold/2.0.1--h7b50bb2_9
$ module help quay.io/biocontainers/randfold/2.0.1--h7b50bb2_9
```
