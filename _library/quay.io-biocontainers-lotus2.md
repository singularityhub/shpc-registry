...
updated_at: "2023-11-22 02:46:42.134890"
latest: "2.28.1--hdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/lotus2:2.28.1--hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/lotus2/2.28.1--hdfd78af_1
$ module help quay.io/biocontainers/lotus2/2.28.1--hdfd78af_1
```
