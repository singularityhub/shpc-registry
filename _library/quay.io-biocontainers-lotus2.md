...
updated_at: "2023-03-13 03:13:56.985221"
latest: "2.24--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/lotus2:2.24--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/lotus2/2.24--hdfd78af_0
$ module help quay.io/biocontainers/lotus2/2.24--hdfd78af_0
```
