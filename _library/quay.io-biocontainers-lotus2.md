...
updated_at: "2024-03-12 02:25:52.276387"
latest: "2.32--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/lotus2:2.32--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/lotus2/2.32--hdfd78af_0
$ module help quay.io/biocontainers/lotus2/2.32--hdfd78af_0
```
