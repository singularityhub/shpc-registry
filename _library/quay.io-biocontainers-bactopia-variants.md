...
updated_at: "2026-06-11 07:32:10.497255"
...
```bash
$ shpc install quay.io/biocontainers/bactopia-variants:1.0.4--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bactopia-variants/1.0.4--hdfd78af_0
$ module help quay.io/biocontainers/bactopia-variants/1.0.4--hdfd78af_0
```
