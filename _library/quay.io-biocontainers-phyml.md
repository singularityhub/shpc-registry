...
updated_at: "2024-09-08 03:29:58.959424"
latest: "3.3.20220408--h37cc20f_2"
...
```bash
$ shpc install quay.io/biocontainers/phyml:3.3.20220408--h37cc20f_2
```
...
```bash
$ module load quay.io/biocontainers/phyml/3.3.20220408--h37cc20f_2
$ module help quay.io/biocontainers/phyml/3.3.20220408--h37cc20f_2
```
