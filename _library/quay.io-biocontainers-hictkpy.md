...
updated_at: "2024-11-30 03:21:46.189983"
latest: "1.0.0--py310h9424a8c_0"
...
```bash
$ shpc install quay.io/biocontainers/hictkpy:1.0.0--py310h9424a8c_0
```
...
```bash
$ module load quay.io/biocontainers/hictkpy/1.0.0--py310h9424a8c_0
$ module help quay.io/biocontainers/hictkpy/1.0.0--py310h9424a8c_0
```
