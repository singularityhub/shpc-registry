...
updated_at: "2026-03-29 05:21:48.489601"
...
```bash
$ shpc install quay.io/biocontainers/hictkpy:1.4.0--py311hc52fe03_4
```
...
```bash
$ module load quay.io/biocontainers/hictkpy/1.4.0--py311hc52fe03_4
$ module help quay.io/biocontainers/hictkpy/1.4.0--py311hc52fe03_4
```
