...
updated_at: "2023-11-23 03:58:29.318603"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mbkmeans:1.16.0--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mbkmeans/1.16.0--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-mbkmeans/1.16.0--r43hf17093f_0
```
