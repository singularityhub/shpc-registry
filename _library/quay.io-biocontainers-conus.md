...
updated_at: "2025-03-06 03:35:35.636610"
...
```bash
$ shpc install quay.io/biocontainers/conus:1.0--h7b50bb2_6
```
...
```bash
$ module load quay.io/biocontainers/conus/1.0--h7b50bb2_6
$ module help quay.io/biocontainers/conus/1.0--h7b50bb2_6
```
