...
updated_at: "2026-03-31 04:38:35.034061"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hgu133b.db:3.13.0--r45hdfd78af_6
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hgu133b.db/3.13.0--r45hdfd78af_6
$ module help quay.io/biocontainers/bioconductor-hgu133b.db/3.13.0--r45hdfd78af_6
```
