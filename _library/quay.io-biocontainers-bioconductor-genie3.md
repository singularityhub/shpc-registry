...
updated_at: "2026-03-09 04:30:37.657524"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-genie3:1.32.0--r45h01b2380_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-genie3/1.32.0--r45h01b2380_0
$ module help quay.io/biocontainers/bioconductor-genie3/1.32.0--r45h01b2380_0
```
