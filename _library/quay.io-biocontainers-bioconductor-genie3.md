...
updated_at: "2023-05-22 03:00:10.463823"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-genie3:1.20.0--r42hc0cfd56_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-genie3/1.20.0--r42hc0cfd56_1
$ module help quay.io/biocontainers/bioconductor-genie3/1.20.0--r42hc0cfd56_1
```
