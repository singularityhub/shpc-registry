...
updated_at: "2024-07-16 03:07:35.636988"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gg4way:1.0.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gg4way/1.0.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-gg4way/1.0.0--r43hdfd78af_0
```
