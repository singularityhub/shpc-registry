...
updated_at: "2025-12-17 04:00:16.139869"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gg4way:1.4.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gg4way/1.4.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-gg4way/1.4.0--r44hdfd78af_0
```
