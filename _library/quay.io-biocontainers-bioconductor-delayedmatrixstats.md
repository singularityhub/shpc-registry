...
updated_at: "2024-11-28 04:13:23.746845"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-delayedmatrixstats:1.24.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-delayedmatrixstats/1.24.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-delayedmatrixstats/1.24.0--r43hdfd78af_0
```
