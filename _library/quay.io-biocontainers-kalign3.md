...
updated_at: "2023-12-07 02:38:49.866407"
...
```bash
$ shpc install quay.io/biocontainers/kalign3:3.3.5--hdbdd923_0
```
...
```bash
$ module load quay.io/biocontainers/kalign3/3.3.5--hdbdd923_0
$ module help quay.io/biocontainers/kalign3/3.3.5--hdbdd923_0
```
