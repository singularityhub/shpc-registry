...
updated_at: "2023-09-12 02:44:31.855780"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gdcrnatools:1.20.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gdcrnatools/1.20.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-gdcrnatools/1.20.0--r43hdfd78af_0
```
