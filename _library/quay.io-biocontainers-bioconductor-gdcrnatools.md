...
updated_at: "2026-04-05 05:25:38.791116"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gdcrnatools:1.30.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gdcrnatools/1.30.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-gdcrnatools/1.30.0--r45hdfd78af_0
```
