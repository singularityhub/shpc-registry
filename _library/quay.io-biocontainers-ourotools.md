---
layout: container
name:  "quay.io/biocontainers/ourotools"
maintainer: "@vsoch"
...
updated_at: "2025-05-25 03:52:08.394882"
...
versions:
 - "0.2.8--pyhdfd78af_0"
description: "singularity registry hpc automated addition for ourotools"
config: {"url": "https://biocontainers.pro/tools/ourotools", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for ourotools", "latest": {"0.2.8--pyhdfd78af_0": "sha256:83a84f851d322dd862aa1ff0ad9448493b77d6a49dd52292bc375cb0adc07e23"}, "tags": {"0.2.8--pyhdfd78af_0": "sha256:83a84f851d322dd862aa1ff0ad9448493b77d6a49dd52292bc375cb0adc07e23"}, "docker": "quay.io/biocontainers/ourotools", "aliases": {"h5fuse": "/usr/local/bin/h5fuse", "ourotools": "/usr/local/bin/ourotools", "minimap2.py": "/usr/local/bin/minimap2.py", "x86_64-conda-linux-gnu.cfg": "/usr/local/bin/x86_64-conda-linux-gnu.cfg", "scanpy": "/usr/local/bin/scanpy", "annot-tsv": "/usr/local/bin/annot-tsv", "qconvex": "/usr/local/bin/qconvex", "qdelaunay": "/usr/local/bin/qdelaunay", "qhalf": "/usr/local/bin/qhalf", "qhull": "/usr/local/bin/qhull", "qvoronoi": "/usr/local/bin/qvoronoi", "rbox": "/usr/local/bin/rbox", "hwloc-gather-cpuid": "/usr/local/bin/hwloc-gather-cpuid", "hwloc-annotate": "/usr/local/bin/hwloc-annotate", "hwloc-bind": "/usr/local/bin/hwloc-bind", "hwloc-calc": "/usr/local/bin/hwloc-calc", "hwloc-compress-dir": "/usr/local/bin/hwloc-compress-dir", "hwloc-diff": "/usr/local/bin/hwloc-diff", "hwloc-distrib": "/usr/local/bin/hwloc-distrib", "hwloc-gather-topology": "/usr/local/bin/hwloc-gather-topology", "hwloc-info": "/usr/local/bin/hwloc-info", "hwloc-ls": "/usr/local/bin/hwloc-ls", "hwloc-patch": "/usr/local/bin/hwloc-patch", "hwloc-ps": "/usr/local/bin/hwloc-ps", "lstopo": "/usr/local/bin/lstopo", "lstopo-no-graphics": "/usr/local/bin/lstopo-no-graphics", "h5delete": "/usr/local/bin/h5delete"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/ourotools.
singularity registry hpc automated addition for ourotools
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/ourotools
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/ourotools:0.2.8--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ourotools/0.2.8--pyhdfd78af_0
$ module help quay.io/biocontainers/ourotools/0.2.8--pyhdfd78af_0
```
...
#### ourotools-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### ourotools-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/ourotools
$ podman run --it --rm --entrypoint /usr/local/bin/ourotools   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/ourotools   -v ${PWD} -w ${PWD} <container> -c " $@"
```
