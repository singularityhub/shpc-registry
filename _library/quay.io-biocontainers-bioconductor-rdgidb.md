...
updated_at: "2023-09-16 02:23:03.818082"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rdgidb:1.26.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rdgidb/1.26.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rdgidb/1.26.0--r43hdfd78af_0
```
