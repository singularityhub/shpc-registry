...
updated_at: "2022-11-09 00:48:45.814645"
latest: "1.8.0--r36_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-dep:1.8.0--r36_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-dep/1.8.0--r36_0
$ module help quay.io/biocontainers/bioconductor-dep/1.8.0--r36_0
```
