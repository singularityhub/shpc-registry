...
updated_at: "2026-04-01 05:29:00.663680"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-dep:1.32.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-dep/1.32.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-dep/1.32.0--r45hdfd78af_0
```
