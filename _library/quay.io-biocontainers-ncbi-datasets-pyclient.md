...
updated_at: "2026-09-23 08:02:23.387206"
latest: "18.36.0--pyh106432d_0"
...
```bash
$ shpc install quay.io/biocontainers/ncbi-datasets-pyclient:18.36.0--pyh106432d_0
```
...
```bash
$ module load quay.io/biocontainers/ncbi-datasets-pyclient/18.36.0--pyh106432d_0
$ module help quay.io/biocontainers/ncbi-datasets-pyclient/18.36.0--pyh106432d_0
```
