...
updated_at: "2026-09-03 07:29:37.973100"
latest: "18.35.0--pyh106432d_0"
...
```bash
$ shpc install quay.io/biocontainers/ncbi-datasets-pyclient:18.35.0--pyh106432d_0
```
...
```bash
$ module load quay.io/biocontainers/ncbi-datasets-pyclient/18.35.0--pyh106432d_0
$ module help quay.io/biocontainers/ncbi-datasets-pyclient/18.35.0--pyh106432d_0
```
