...
updated_at: "2026-02-17 18:18:26.928886"
latest: "18.17.1--pyh106432d_0"
...
```bash
$ shpc install quay.io/biocontainers/ncbi-datasets-pyclient:18.17.1--pyh106432d_0
```
...
```bash
$ module load quay.io/biocontainers/ncbi-datasets-pyclient/18.17.1--pyh106432d_0
$ module help quay.io/biocontainers/ncbi-datasets-pyclient/18.17.1--pyh106432d_0
```
