...
updated_at: "2026-07-30 06:08:10.681529"
latest: "18.33.1--pyh106432d_0"
...
```bash
$ shpc install quay.io/biocontainers/ncbi-datasets-pyclient:18.33.1--pyh106432d_0
```
...
```bash
$ module load quay.io/biocontainers/ncbi-datasets-pyclient/18.33.1--pyh106432d_0
$ module help quay.io/biocontainers/ncbi-datasets-pyclient/18.33.1--pyh106432d_0
```
