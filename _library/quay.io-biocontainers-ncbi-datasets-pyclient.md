...
updated_at: "2026-04-22 05:41:19.194521"
latest: "18.23.0--pyh106432d_0"
...
```bash
$ shpc install quay.io/biocontainers/ncbi-datasets-pyclient:18.23.0--pyh106432d_0
```
...
```bash
$ module load quay.io/biocontainers/ncbi-datasets-pyclient/18.23.0--pyh106432d_0
$ module help quay.io/biocontainers/ncbi-datasets-pyclient/18.23.0--pyh106432d_0
```
