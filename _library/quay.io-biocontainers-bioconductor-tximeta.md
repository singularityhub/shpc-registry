...
updated_at: "2026-03-24 05:11:26.743608"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-tximeta:1.28.2--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-tximeta/1.28.2--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-tximeta/1.28.2--r45hdfd78af_0
```
