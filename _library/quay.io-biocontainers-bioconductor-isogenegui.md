---
layout: container
name:  "quay.io/biocontainers/bioconductor-isogenegui"
maintainer: "@vsoch"
...
updated_at: "2025-12-03 04:10:43.001498"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-isogenegui
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-isogenegui:2.30.0--r41hc247a5b_2
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-isogenegui/2.30.0--r41hc247a5b_2
$ module help quay.io/biocontainers/bioconductor-isogenegui/2.30.0--r41hc247a5b_2
```
...
#### bioconductor-isogenegui-inspect:
...
#### bioconductor-isogenegui-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-isogenegui-inspect-deffile:
