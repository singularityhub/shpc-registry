...
updated_at: "2022-11-21 13:55:03.220766"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-venndetail:1.8.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-venndetail/1.8.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-venndetail/1.8.0--r41hdfd78af_0
```
