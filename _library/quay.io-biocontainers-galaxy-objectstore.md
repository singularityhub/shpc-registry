...
updated_at: "2024-09-29 03:01:39.734342"
...
```bash
$ shpc install quay.io/biocontainers/galaxy-objectstore:24.1.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/galaxy-objectstore/24.1.1--pyhdfd78af_0
$ module help quay.io/biocontainers/galaxy-objectstore/24.1.1--pyhdfd78af_0
```
