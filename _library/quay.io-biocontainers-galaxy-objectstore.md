...
updated_at: "2025-05-01 04:01:48.448796"
...
```bash
$ shpc install quay.io/biocontainers/galaxy-objectstore:24.2.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/galaxy-objectstore/24.2.3--pyhdfd78af_0
$ module help quay.io/biocontainers/galaxy-objectstore/24.2.3--pyhdfd78af_0
```
