...
updated_at: "2025-11-18 03:53:41.997446"
...
```bash
$ shpc install quay.io/biocontainers/galaxy-objectstore:25.0.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/galaxy-objectstore/25.0.3--pyhdfd78af_0
$ module help quay.io/biocontainers/galaxy-objectstore/25.0.3--pyhdfd78af_0
```
