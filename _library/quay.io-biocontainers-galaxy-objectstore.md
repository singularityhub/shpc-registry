...
updated_at: "2026-09-02 07:28:22.820416"
...
```bash
$ shpc install quay.io/biocontainers/galaxy-objectstore:26.1.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/galaxy-objectstore/26.1.1--pyhdfd78af_0
$ module help quay.io/biocontainers/galaxy-objectstore/26.1.1--pyhdfd78af_0
```
