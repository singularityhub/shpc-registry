...
updated_at: "2025-08-03 04:43:08.520961"
...
```bash
$ shpc install quay.io/biocontainers/galaxy-objectstore:25.0.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/galaxy-objectstore/25.0.1--pyhdfd78af_0
$ module help quay.io/biocontainers/galaxy-objectstore/25.0.1--pyhdfd78af_0
```
