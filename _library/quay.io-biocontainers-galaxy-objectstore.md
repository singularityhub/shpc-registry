...
updated_at: "2024-11-10 03:39:24.587171"
...
```bash
$ shpc install quay.io/biocontainers/galaxy-objectstore:24.1.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/galaxy-objectstore/24.1.2--pyhdfd78af_0
$ module help quay.io/biocontainers/galaxy-objectstore/24.1.2--pyhdfd78af_0
```
