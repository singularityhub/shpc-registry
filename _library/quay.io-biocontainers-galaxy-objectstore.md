...
updated_at: "2024-02-05 02:32:23.531077"
latest: "23.1.4--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/galaxy-objectstore:23.1.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/galaxy-objectstore/23.1.4--pyhdfd78af_0
$ module help quay.io/biocontainers/galaxy-objectstore/23.1.4--pyhdfd78af_0
```
