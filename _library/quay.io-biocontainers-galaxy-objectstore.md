...
updated_at: "2025-09-30 03:35:47.604418"
...
```bash
$ shpc install quay.io/biocontainers/galaxy-objectstore:25.0.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/galaxy-objectstore/25.0.2--pyhdfd78af_0
$ module help quay.io/biocontainers/galaxy-objectstore/25.0.2--pyhdfd78af_0
```
