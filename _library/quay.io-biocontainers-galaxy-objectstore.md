...
updated_at: "2023-12-21 02:32:49.402740"
latest: "23.1.3--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/galaxy-objectstore:23.1.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/galaxy-objectstore/23.1.3--pyhdfd78af_0
$ module help quay.io/biocontainers/galaxy-objectstore/23.1.3--pyhdfd78af_0
```
