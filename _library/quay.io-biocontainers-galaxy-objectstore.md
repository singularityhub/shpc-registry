...
updated_at: "2023-12-04 03:55:50.772232"
latest: "23.1.1--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/galaxy-objectstore:23.1.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/galaxy-objectstore/23.1.1--pyhdfd78af_0
$ module help quay.io/biocontainers/galaxy-objectstore/23.1.1--pyhdfd78af_0
```
