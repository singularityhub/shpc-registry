...
updated_at: "2026-06-04 00:46:54.052136"
...
```bash
$ shpc install quay.io/biocontainers/galaxy-objectstore:25.1.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/galaxy-objectstore/25.1.2--pyhdfd78af_0
$ module help quay.io/biocontainers/galaxy-objectstore/25.1.2--pyhdfd78af_0
```
