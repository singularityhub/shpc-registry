...
updated_at: "2024-11-23 03:39:41.516958"
...
```bash
$ shpc install quay.io/biocontainers/galaxy-objectstore:24.1.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/galaxy-objectstore/24.1.3--pyhdfd78af_0
$ module help quay.io/biocontainers/galaxy-objectstore/24.1.3--pyhdfd78af_0
```
