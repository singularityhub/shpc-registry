...
updated_at: "2024-12-24 03:34:25.844327"
...
```bash
$ shpc install quay.io/biocontainers/galaxy-objectstore:24.1.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/galaxy-objectstore/24.1.4--pyhdfd78af_0
$ module help quay.io/biocontainers/galaxy-objectstore/24.1.4--pyhdfd78af_0
```
