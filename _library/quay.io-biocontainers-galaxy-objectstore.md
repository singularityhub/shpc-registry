...
updated_at: "2026-01-26 04:58:15.618232"
...
```bash
$ shpc install quay.io/biocontainers/galaxy-objectstore:25.0.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/galaxy-objectstore/25.0.4--pyhdfd78af_0
$ module help quay.io/biocontainers/galaxy-objectstore/25.0.4--pyhdfd78af_0
```
