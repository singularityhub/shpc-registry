...
updated_at: "2026-04-04 05:09:52.099695"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-drosgenome1.db:3.13.0--r45hdfd78af_6
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-drosgenome1.db/3.13.0--r45hdfd78af_6
$ module help quay.io/biocontainers/bioconductor-drosgenome1.db/3.13.0--r45hdfd78af_6
```
