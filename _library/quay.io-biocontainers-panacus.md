...
updated_at: "2024-12-14 03:46:47.257705"
latest: "0.2.5--h715e4b3_0"
...
```bash
$ shpc install quay.io/biocontainers/panacus:0.2.5--h715e4b3_0
```
...
```bash
$ module load quay.io/biocontainers/panacus/0.2.5--h715e4b3_0
$ module help quay.io/biocontainers/panacus/0.2.5--h715e4b3_0
```
