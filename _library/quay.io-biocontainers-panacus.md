---
layout: container
name:  "quay.io/biocontainers/panacus"
maintainer: "@vsoch"
...
updated_at: "2025-11-27 03:27:56.131629"
...
config: {"url": "https://biocontainers.pro/tools/panacus", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for panacus", "latest": {"0.4.1--hc1c3326_0": "sha256:0ec877fd0954933658d9b3a4131d65d672c20f9df0cbbdf95862113ff38b96a3"}, "tags": {"0.2--hec16e2b_0": "sha256:f3e1a7d43d4694a287483512a7190f611193486ea91913ffe0e64e156d803bff", "0.2.1--h031d066_0": "sha256:24d5008ebfc7f57512c371365b2fb42e054a0e55d9743d59c34cf040c182dd5a", "0.2.2--h031d066_0": "sha256:93f803bf44ed3e511a4ed4ef6fc0de925ac59d0ac05dee581bbd831e1d1525db", "0.2.3--h031d066_0": "sha256:6bb5d172dd4c1197c7a662d01b57475ffc35b4ce0a1384ecb4ee3be76c964947", "0.2.4--h715e4b3_2": "sha256:536b9829c3ccbbded15a31ba9235b399a913ce10a831fdc092f0109b80b6700b", "0.2.5--h715e4b3_0": "sha256:55170afe4a01559c82d4ec2855966ac596f209b5b3a7a6bd37a2e796b064239d", "0.2.5--hc1c3326_1": "sha256:297aaeded61fdd54252ed0b887b4f4536773ae455ca9feaebe7457291d9c0dc9", "0.3.0.2--hc1c3326_0": "sha256:5e26c0d82ab33cffe646d843868cbd49c5d6e5bfaaa807c4ca41ad8ba7d868d0", "0.3.3--hc1c3326_0": "sha256:6ecac73a8deb4ccafd121de4bc87ad30c16b02a5aa9704cbb0fd6b3efb675c45", "0.4.1--hc1c3326_0": "sha256:0ec877fd0954933658d9b3a4131d65d672c20f9df0cbbdf95862113ff38b96a3"}, "docker": "quay.io/biocontainers/panacus", "aliases": {"panacus": "/usr/local/bin/panacus", "panacus-visualize": "/usr/local/bin/panacus-visualize", "tjbench": "/usr/local/bin/tjbench", "f2py3.11": "/usr/local/bin/f2py3.11", "2to3-3.11": "/usr/local/bin/2to3-3.11", "idle3.11": "/usr/local/bin/idle3.11", "pydoc3.11": "/usr/local/bin/pydoc3.11", "python3.11": "/usr/local/bin/python3.11", "python3.11-config": "/usr/local/bin/python3.11-config", "fonttools": "/usr/local/bin/fonttools", "pyftmerge": "/usr/local/bin/pyftmerge", "pyftsubset": "/usr/local/bin/pyftsubset", "ttx": "/usr/local/bin/ttx", "brotli": "/usr/local/bin/brotli", "normalizer": "/usr/local/bin/normalizer", "opj_compress": "/usr/local/bin/opj_compress", "opj_decompress": "/usr/local/bin/opj_decompress", "opj_dump": "/usr/local/bin/opj_dump", "python3.1": "/usr/local/bin/python3.1", "jpgicc": "/usr/local/bin/jpgicc", "linkicc": "/usr/local/bin/linkicc", "psicc": "/usr/local/bin/psicc", "tificc": "/usr/local/bin/tificc", "transicc": "/usr/local/bin/transicc"}}
---
...
```bash
$ shpc install quay.io/biocontainers/panacus
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/panacus:0.4.1--hc1c3326_0
```
...
```bash
$ module load quay.io/biocontainers/panacus/0.4.1--hc1c3326_0
$ module help quay.io/biocontainers/panacus/0.4.1--hc1c3326_0
```
...
#### panacus-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### panacus-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/panacus
$ podman run --it --rm --entrypoint /usr/local/bin/panacus   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/panacus   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/panacus-visualize
$ podman run --it --rm --entrypoint /usr/local/bin/panacus-visualize   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/panacus-visualize   -v ${PWD} -w ${PWD} <container> -c " $@"
```
