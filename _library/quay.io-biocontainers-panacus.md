...
updated_at: "2024-10-17 03:38:00.920251"
latest: "0.2.4--h715e4b3_2"
...
```bash
$ shpc install quay.io/biocontainers/panacus:0.2.4--h715e4b3_2
```
...
```bash
$ module load quay.io/biocontainers/panacus/0.2.4--h715e4b3_2
$ module help quay.io/biocontainers/panacus/0.2.4--h715e4b3_2
```
