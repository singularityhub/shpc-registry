...
updated_at: "2026-03-24 04:49:36.196797"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-scoreinvhap:1.32.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-scoreinvhap/1.32.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-scoreinvhap/1.32.0--r45hdfd78af_0
```
