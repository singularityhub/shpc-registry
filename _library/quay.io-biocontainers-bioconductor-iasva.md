...
updated_at: "2022-11-21 13:36:06.476489"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-iasva:1.12.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-iasva/1.12.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-iasva/1.12.0--r41hdfd78af_0
```
