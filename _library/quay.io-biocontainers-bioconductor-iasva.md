...
updated_at: "2025-08-07 10:10:38.642430"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-iasva:1.24.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-iasva/1.24.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-iasva/1.24.0--r44hdfd78af_0
```
