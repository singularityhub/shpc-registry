...
updated_at: "2025-04-23 03:34:06.372981"
latest: "0.2.0--h78e4899_0"
...
```bash
$ shpc install quay.io/biocontainers/taxor:0.2.0--h78e4899_0
```
...
```bash
$ module load quay.io/biocontainers/taxor/0.2.0--h78e4899_0
$ module help quay.io/biocontainers/taxor/0.2.0--h78e4899_0
```
