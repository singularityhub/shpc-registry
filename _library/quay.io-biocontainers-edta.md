...
updated_at: "2023-12-24 02:58:41.234258"
...
```bash
$ shpc install quay.io/biocontainers/edta:2.1.0--hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/edta/2.1.0--hdfd78af_1
$ module help quay.io/biocontainers/edta/2.1.0--hdfd78af_1
```
