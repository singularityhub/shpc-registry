...
updated_at: "2026-03-31 05:14:43.596312"
...
```bash
$ shpc install quay.io/biocontainers/edta:2.3.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/edta/2.3.0--hdfd78af_0
$ module help quay.io/biocontainers/edta/2.3.0--hdfd78af_0
```
