...
updated_at: "2026-04-04 05:21:37.821002"
latest: "4.5.3"
...
```bash
$ shpc install rocker/tidyverse:4.5.3
```
...
```bash
$ module load rocker/tidyverse/4.5.3
$ module help rocker/tidyverse/4.5.3
```
