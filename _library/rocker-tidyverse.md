...
updated_at: "2025-05-27 03:12:38.579089"
latest: "4.5.0"
...
```bash
$ shpc install rocker/tidyverse:4.5.0
```
...
```bash
$ module load rocker/tidyverse/4.5.0
$ module help rocker/tidyverse/4.5.0
```
