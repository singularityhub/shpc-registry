...
updated_at: "2025-03-23 03:04:25.656474"
latest: "4.4.3"
...
```bash
$ shpc install rocker/tidyverse:4.4.3
```
...
```bash
$ module load rocker/tidyverse/4.4.3
$ module help rocker/tidyverse/4.4.3
```
