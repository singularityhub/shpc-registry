...
updated_at: "2025-10-21 03:59:57.554869"
latest: "4.5.1"
...
```bash
$ shpc install rocker/tidyverse:4.5.1
```
...
```bash
$ module load rocker/tidyverse/4.5.1
$ module help rocker/tidyverse/4.5.1
```
