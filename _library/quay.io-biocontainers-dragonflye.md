...
updated_at: "2024-01-19 03:06:11.866589"
...
```bash
$ shpc install quay.io/biocontainers/dragonflye:1.1.2--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/dragonflye/1.1.2--hdfd78af_0
$ module help quay.io/biocontainers/dragonflye/1.1.2--hdfd78af_0
```
