...
updated_at: "2022-11-20 00:44:22.558811"
latest: "1.0.13--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/dragonflye:1.0.13--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/dragonflye/1.0.13--hdfd78af_0
$ module help quay.io/biocontainers/dragonflye/1.0.13--hdfd78af_0
```
