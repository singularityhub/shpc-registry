...
updated_at: "2024-05-07 02:34:05.738476"
...
```bash
$ shpc install quay.io/biocontainers/dragonflye:1.2.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/dragonflye/1.2.0--hdfd78af_0
$ module help quay.io/biocontainers/dragonflye/1.2.0--hdfd78af_0
```
