...
updated_at: "2025-10-23 03:42:54.244113"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-maizecdf:2.18.0--r44hdfd78af_13
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-maizecdf/2.18.0--r44hdfd78af_13
$ module help quay.io/biocontainers/bioconductor-maizecdf/2.18.0--r44hdfd78af_13
```
