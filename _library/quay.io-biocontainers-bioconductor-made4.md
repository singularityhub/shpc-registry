...
updated_at: "2023-10-20 02:32:35.405721"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-made4:1.74.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-made4/1.74.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-made4/1.74.0--r43hdfd78af_0
```
