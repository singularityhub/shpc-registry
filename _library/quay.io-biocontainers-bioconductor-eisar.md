...
updated_at: "2026-03-26 04:43:02.979912"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-eisar:1.22.1--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-eisar/1.22.1--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-eisar/1.22.1--r45hdfd78af_0
```
