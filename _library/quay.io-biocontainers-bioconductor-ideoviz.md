...
updated_at: "2022-10-29 05:49:28.569262"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ideoviz:1.30.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ideoviz/1.30.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ideoviz/1.30.0--r41hdfd78af_0
```
