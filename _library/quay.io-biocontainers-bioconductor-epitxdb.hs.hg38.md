...
updated_at: "2026-03-29 05:36:09.501321"
latest: "0.99.7--r45hdfd78af_9"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-epitxdb.hs.hg38:0.99.7--r45hdfd78af_9
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-epitxdb.hs.hg38/0.99.7--r45hdfd78af_9
$ module help quay.io/biocontainers/bioconductor-epitxdb.hs.hg38/0.99.7--r45hdfd78af_9
```
