...
updated_at: "2026-08-15 03:41:37.775551"
latest: "1.24--h9dcdb79_1"
...
```bash
$ shpc install quay.io/biocontainers/samtools:1.24--h9dcdb79_1
```
...
```bash
$ module load quay.io/biocontainers/samtools/1.24--h9dcdb79_1
$ module help quay.io/biocontainers/samtools/1.24--h9dcdb79_1
```
