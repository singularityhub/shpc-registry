...
updated_at: "2026-01-04 04:10:19.936879"
latest: "1.23--h96c455f_0"
...
```bash
$ shpc install quay.io/biocontainers/samtools:1.23--h96c455f_0
```
...
```bash
$ module load quay.io/biocontainers/samtools/1.23--h96c455f_0
$ module help quay.io/biocontainers/samtools/1.23--h96c455f_0
```
