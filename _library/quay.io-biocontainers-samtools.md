...
updated_at: "2025-07-03 03:32:23.586658"
latest: "1.22--h96c455f_0"
...
```bash
$ shpc install quay.io/biocontainers/samtools:1.22--h96c455f_0
```
...
```bash
$ module load quay.io/biocontainers/samtools/1.22--h96c455f_0
$ module help quay.io/biocontainers/samtools/1.22--h96c455f_0
```
