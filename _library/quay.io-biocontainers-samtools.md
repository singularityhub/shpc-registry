...
updated_at: "2024-03-18 23:44:45.061868"
latest: "1.19.2--h50ea8bc_1"
...
```bash
$ shpc install quay.io/biocontainers/samtools:1.19.2--h50ea8bc_1
```
...
```bash
$ module load quay.io/biocontainers/samtools/1.19.2--h50ea8bc_1
$ module help quay.io/biocontainers/samtools/1.19.2--h50ea8bc_1
```
