...
updated_at: "2024-04-05 02:54:30.580616"
...
```bash
$ shpc install quay.io/biocontainers/snakemake-executor-plugin-googlebatch:0.3.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake-executor-plugin-googlebatch/0.3.0--pyhdfd78af_0
$ module help quay.io/biocontainers/snakemake-executor-plugin-googlebatch/0.3.0--pyhdfd78af_0
```
