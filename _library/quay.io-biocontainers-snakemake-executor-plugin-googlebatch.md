...
updated_at: "2026-01-20 04:07:24.621853"
...
```bash
$ shpc install quay.io/biocontainers/snakemake-executor-plugin-googlebatch:0.5.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake-executor-plugin-googlebatch/0.5.1--pyhdfd78af_0
$ module help quay.io/biocontainers/snakemake-executor-plugin-googlebatch/0.5.1--pyhdfd78af_0
```
