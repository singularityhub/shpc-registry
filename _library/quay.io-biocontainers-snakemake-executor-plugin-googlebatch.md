...
updated_at: "2024-04-21 03:05:14.971026"
...
```bash
$ shpc install quay.io/biocontainers/snakemake-executor-plugin-googlebatch:0.3.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake-executor-plugin-googlebatch/0.3.3--pyhdfd78af_0
$ module help quay.io/biocontainers/snakemake-executor-plugin-googlebatch/0.3.3--pyhdfd78af_0
```
