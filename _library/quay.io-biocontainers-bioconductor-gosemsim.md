...
updated_at: "2023-07-07 03:23:28.363927"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gosemsim:2.24.0--r42hf17093f_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gosemsim/2.24.0--r42hf17093f_1
$ module help quay.io/biocontainers/bioconductor-gosemsim/2.24.0--r42hf17093f_1
```
