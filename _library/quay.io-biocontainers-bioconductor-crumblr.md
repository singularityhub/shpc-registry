---
layout: container
name:  "quay.io/biocontainers/bioconductor-crumblr"
maintainer: "@vsoch"
...
updated_at: "2026-03-23 05:32:26.580233"
...
versions:
 - "1.2.0--r45hdfd78af_0"
description: "singularity registry hpc automated addition for bioconductor-crumblr"
config: {"url": "https://biocontainers.pro/tools/bioconductor-crumblr", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for bioconductor-crumblr", "latest": {"1.2.0--r45hdfd78af_0": "sha256:b65d45b0a80c1678654b0fdc6b870997a949badaa26e200cde66b543c494f18e"}, "tags": {"1.2.0--r45hdfd78af_0": "sha256:b65d45b0a80c1678654b0fdc6b870997a949badaa26e200cde66b543c494f18e"}, "docker": "quay.io/biocontainers/bioconductor-crumblr", "aliases": {"pandoc-lua": "/usr/local/bin/pandoc-lua", "pandoc-server": "/usr/local/bin/pandoc-server", "idle3.14": "/usr/local/bin/idle3.14", "pydoc3.14": "/usr/local/bin/pydoc3.14", "python3.14": "/usr/local/bin/python3.14", "python3.14-config": "/usr/local/bin/python3.14-config", "hwloc-gather-cpuid": "/usr/local/bin/hwloc-gather-cpuid", "x86_64-conda-linux-gnu.cfg": "/usr/local/bin/x86_64-conda-linux-gnu.cfg", "hwloc-annotate": "/usr/local/bin/hwloc-annotate", "hwloc-bind": "/usr/local/bin/hwloc-bind", "hwloc-calc": "/usr/local/bin/hwloc-calc", "hwloc-compress-dir": "/usr/local/bin/hwloc-compress-dir", "hwloc-diff": "/usr/local/bin/hwloc-diff", "hwloc-distrib": "/usr/local/bin/hwloc-distrib", "hwloc-gather-topology": "/usr/local/bin/hwloc-gather-topology", "hwloc-info": "/usr/local/bin/hwloc-info", "hwloc-ls": "/usr/local/bin/hwloc-ls", "hwloc-patch": "/usr/local/bin/hwloc-patch", "hwloc-ps": "/usr/local/bin/hwloc-ps", "lstopo": "/usr/local/bin/lstopo", "lstopo-no-graphics": "/usr/local/bin/lstopo-no-graphics", "pandoc": "/usr/local/bin/pandoc", "numpy-config": "/usr/local/bin/numpy-config", "hb-info": "/usr/local/bin/hb-info", "tjbench": "/usr/local/bin/tjbench"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/bioconductor-crumblr.
singularity registry hpc automated addition for bioconductor-crumblr
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/bioconductor-crumblr
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-crumblr:1.2.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-crumblr/1.2.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-crumblr/1.2.0--r45hdfd78af_0
```
...
#### bioconductor-crumblr-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-crumblr-inspect-deffile:
