...
updated_at: "2025-09-02 03:31:38.437807"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-diffcoexp:1.26.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-diffcoexp/1.26.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-diffcoexp/1.26.0--r44hdfd78af_0
```
