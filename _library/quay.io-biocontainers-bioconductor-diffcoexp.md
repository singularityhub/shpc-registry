...
updated_at: "2026-03-17 04:36:05.237311"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-diffcoexp:1.30.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-diffcoexp/1.30.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-diffcoexp/1.30.0--r45hdfd78af_0
```
