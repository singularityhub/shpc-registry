...
updated_at: "2023-08-14 03:28:05.929212"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-diffcoexp:1.20.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-diffcoexp/1.20.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-diffcoexp/1.20.0--r43hdfd78af_0
```
