...
updated_at: "2022-11-13 00:23:50.350494"
latest: "1.8.0--r40_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-diffcoexp:1.8.0--r40_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-diffcoexp/1.8.0--r40_0
$ module help quay.io/biocontainers/bioconductor-diffcoexp/1.8.0--r40_0
```
