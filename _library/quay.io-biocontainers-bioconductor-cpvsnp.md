...
updated_at: "2026-04-02 05:04:51.349905"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cpvsnp:1.42.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cpvsnp/1.42.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-cpvsnp/1.42.0--r45hdfd78af_0
```
