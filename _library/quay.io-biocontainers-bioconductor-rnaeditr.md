...
updated_at: "2023-12-24 02:49:40.825560"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rnaeditr:1.12.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rnaeditr/1.12.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rnaeditr/1.12.0--r43hdfd78af_0
```
