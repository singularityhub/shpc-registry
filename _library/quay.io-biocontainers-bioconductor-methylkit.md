...
updated_at: "2024-09-15 03:23:34.214613"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-methylkit:1.28.0--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-methylkit/1.28.0--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-methylkit/1.28.0--r43hf17093f_0
```
