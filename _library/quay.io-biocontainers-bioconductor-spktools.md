...
updated_at: "2023-10-16 02:28:40.786806"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-spktools:1.56.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-spktools/1.56.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-spktools/1.56.0--r43hdfd78af_0
```
