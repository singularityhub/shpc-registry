...
updated_at: "2022-11-26 13:31:03.542195"
latest: "3.1.1"
...
```bash
$ shpc install ghcr.io/autamus/htop:3.1.1
```
...
```bash
$ module load ghcr.io/autamus/htop/3.1.1
$ module help ghcr.io/autamus/htop/3.1.1
```
