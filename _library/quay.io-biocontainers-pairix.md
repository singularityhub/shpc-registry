...
updated_at: "2024-04-27 02:55:55.587958"
latest: "0.3.8--py39h3d4b85c_0"
...
```bash
$ shpc install quay.io/biocontainers/pairix:0.3.8--py39h3d4b85c_0
```
...
```bash
$ module load quay.io/biocontainers/pairix/0.3.8--py39h3d4b85c_0
$ module help quay.io/biocontainers/pairix/0.3.8--py39h3d4b85c_0
```
