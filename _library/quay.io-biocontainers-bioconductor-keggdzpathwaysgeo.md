...
updated_at: "2023-10-11 03:10:46.526457"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-keggdzpathwaysgeo:1.38.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-keggdzpathwaysgeo/1.38.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-keggdzpathwaysgeo/1.38.0--r43hdfd78af_0
```
