...
updated_at: "2025-02-17 03:16:35.713452"
latest: "1.2.9--py39hbcbf7aa_3"
...
```bash
$ shpc install quay.io/biocontainers/ultraplex:1.2.9--py39hbcbf7aa_3
```
...
```bash
$ module load quay.io/biocontainers/ultraplex/1.2.9--py39hbcbf7aa_3
$ module help quay.io/biocontainers/ultraplex/1.2.9--py39hbcbf7aa_3
```
