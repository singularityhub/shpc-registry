...
updated_at: "2024-04-11 02:45:34.996147"
latest: "1.3.1--py39haa23e8e_0"
...
```bash
$ shpc install quay.io/biocontainers/longreadsum:1.3.1--py39haa23e8e_0
```
...
```bash
$ module load quay.io/biocontainers/longreadsum/1.3.1--py39haa23e8e_0
$ module help quay.io/biocontainers/longreadsum/1.3.1--py39haa23e8e_0
```
