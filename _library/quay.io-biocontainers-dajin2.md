...
updated_at: "2024-02-23 02:54:04.986882"
...
```bash
$ shpc install quay.io/biocontainers/dajin2:0.4.0--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/dajin2/0.4.0--pyh7cba7a3_0
$ module help quay.io/biocontainers/dajin2/0.4.0--pyh7cba7a3_0
```
