...
updated_at: "2025-05-20 03:27:54.532756"
...
```bash
$ shpc install quay.io/biocontainers/dajin2:0.6.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/dajin2/0.6.1--pyhdfd78af_0
$ module help quay.io/biocontainers/dajin2/0.6.1--pyhdfd78af_0
```
