...
updated_at: "2025-10-18 03:10:41.882617"
...
```bash
$ shpc install quay.io/biocontainers/dajin2:0.7.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/dajin2/0.7.2--pyhdfd78af_0
$ module help quay.io/biocontainers/dajin2/0.7.2--pyhdfd78af_0
```
