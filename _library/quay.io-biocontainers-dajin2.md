...
updated_at: "2024-08-14 02:46:23.824949"
...
```bash
$ shpc install quay.io/biocontainers/dajin2:0.5.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/dajin2/0.5.4--pyhdfd78af_0
$ module help quay.io/biocontainers/dajin2/0.5.4--pyhdfd78af_0
```
