...
updated_at: "2025-01-14 03:27:02.655986"
...
```bash
$ shpc install quay.io/biocontainers/dajin2:0.5.6--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/dajin2/0.5.6--pyhdfd78af_0
$ module help quay.io/biocontainers/dajin2/0.5.6--pyhdfd78af_0
```
