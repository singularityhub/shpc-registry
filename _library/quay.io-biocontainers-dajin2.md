...
updated_at: "2025-03-08 02:40:30.202513"
...
```bash
$ shpc install quay.io/biocontainers/dajin2:0.6.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/dajin2/0.6.0--pyhdfd78af_0
$ module help quay.io/biocontainers/dajin2/0.6.0--pyhdfd78af_0
```
