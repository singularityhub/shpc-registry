...
updated_at: "2024-11-13 04:42:51.445874"
latest: "0.5.5.1--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/dajin2:0.5.5.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/dajin2/0.5.5.1--pyhdfd78af_0
$ module help quay.io/biocontainers/dajin2/0.5.5.1--pyhdfd78af_0
```
