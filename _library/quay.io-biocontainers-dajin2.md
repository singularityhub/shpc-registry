...
updated_at: "2024-05-22 03:12:17.857077"
latest: "0.4.5--pyh7cba7a3_0"
...
```bash
$ shpc install quay.io/biocontainers/dajin2:0.4.5--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/dajin2/0.4.5--pyh7cba7a3_0
$ module help quay.io/biocontainers/dajin2/0.4.5--pyh7cba7a3_0
```
