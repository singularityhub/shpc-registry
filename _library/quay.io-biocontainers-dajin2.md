...
updated_at: "2026-03-11 04:26:21.231996"
...
```bash
$ shpc install quay.io/biocontainers/dajin2:0.9.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/dajin2/0.9.0--pyhdfd78af_0
$ module help quay.io/biocontainers/dajin2/0.9.0--pyhdfd78af_0
```
