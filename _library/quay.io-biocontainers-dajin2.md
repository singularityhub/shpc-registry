...
updated_at: "2023-10-05 03:48:22.811170"
...
```bash
$ shpc install quay.io/biocontainers/dajin2:0.3.1--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/dajin2/0.3.1--pyh7cba7a3_0
$ module help quay.io/biocontainers/dajin2/0.3.1--pyh7cba7a3_0
```
