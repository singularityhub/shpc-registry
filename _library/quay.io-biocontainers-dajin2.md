...
updated_at: "2024-07-23 02:52:38.118641"
...
```bash
$ shpc install quay.io/biocontainers/dajin2:0.5.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/dajin2/0.5.1--pyhdfd78af_0
$ module help quay.io/biocontainers/dajin2/0.5.1--pyhdfd78af_0
```
