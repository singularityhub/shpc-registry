...
updated_at: "2026-01-03 03:50:12.526283"
...
```bash
$ shpc install quay.io/biocontainers/dajin2:0.7.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/dajin2/0.7.4--pyhdfd78af_0
$ module help quay.io/biocontainers/dajin2/0.7.4--pyhdfd78af_0
```
