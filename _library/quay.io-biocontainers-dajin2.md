...
updated_at: "2024-03-30 02:51:02.404997"
...
```bash
$ shpc install quay.io/biocontainers/dajin2:0.4.2--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/dajin2/0.4.2--pyh7cba7a3_0
$ module help quay.io/biocontainers/dajin2/0.4.2--pyh7cba7a3_0
```
