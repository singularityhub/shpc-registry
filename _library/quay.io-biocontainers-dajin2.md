...
updated_at: "2024-05-29 03:16:04.675505"
latest: "0.4.6--pyh7cba7a3_0"
...
```bash
$ shpc install quay.io/biocontainers/dajin2:0.4.6--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/dajin2/0.4.6--pyh7cba7a3_0
$ module help quay.io/biocontainers/dajin2/0.4.6--pyh7cba7a3_0
```
