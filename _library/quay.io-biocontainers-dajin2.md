...
updated_at: "2025-08-22 03:23:38.649932"
...
```bash
$ shpc install quay.io/biocontainers/dajin2:0.7.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/dajin2/0.7.1--pyhdfd78af_0
$ module help quay.io/biocontainers/dajin2/0.7.1--pyhdfd78af_0
```
