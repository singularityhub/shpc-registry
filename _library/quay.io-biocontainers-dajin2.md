...
updated_at: "2025-12-17 03:48:38.421573"
...
```bash
$ shpc install quay.io/biocontainers/dajin2:0.7.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/dajin2/0.7.3--pyhdfd78af_0
$ module help quay.io/biocontainers/dajin2/0.7.3--pyhdfd78af_0
```
