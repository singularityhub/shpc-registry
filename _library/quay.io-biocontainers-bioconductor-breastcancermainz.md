...
updated_at: "2026-04-04 04:57:04.468976"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-breastcancermainz:1.48.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-breastcancermainz/1.48.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-breastcancermainz/1.48.0--r45hdfd78af_0
```
