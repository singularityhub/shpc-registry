...
updated_at: "2023-09-24 03:02:24.733852"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-breastcancermainz:1.38.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-breastcancermainz/1.38.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-breastcancermainz/1.38.0--r43hdfd78af_0
```
