...
updated_at: "2026-09-23 07:50:52.983104"
...
```bash
$ shpc install quay.io/biocontainers/r-acidgsea:0.9.2--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/r-acidgsea/0.9.2--r45hdfd78af_0
$ module help quay.io/biocontainers/r-acidgsea/0.9.2--r45hdfd78af_0
```
