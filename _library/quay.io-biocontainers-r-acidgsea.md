...
updated_at: "2025-10-25 03:34:51.711827"
latest: "0.9.1--r44hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/r-acidgsea:0.9.1--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/r-acidgsea/0.9.1--r44hdfd78af_0
$ module help quay.io/biocontainers/r-acidgsea/0.9.1--r44hdfd78af_0
```
