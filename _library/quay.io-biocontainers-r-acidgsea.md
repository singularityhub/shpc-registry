...
updated_at: "2023-09-07 02:24:39.844068"
...
```bash
$ shpc install quay.io/biocontainers/r-acidgsea:0.8.9--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/r-acidgsea/0.8.9--r43hdfd78af_0
$ module help quay.io/biocontainers/r-acidgsea/0.8.9--r43hdfd78af_0
```
