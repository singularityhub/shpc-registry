...
updated_at: "2023-11-04 02:38:50.622603"
...
```bash
$ shpc install quay.io/biocontainers/hicstuff:3.2.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hicstuff/3.2.1--pyhdfd78af_0
$ module help quay.io/biocontainers/hicstuff/3.2.1--pyhdfd78af_0
```
