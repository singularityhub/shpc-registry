...
updated_at: "2025-11-20 03:19:56.101724"
...
```bash
$ shpc install quay.io/biocontainers/hicstuff:3.2.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hicstuff/3.2.4--pyhdfd78af_0
$ module help quay.io/biocontainers/hicstuff/3.2.4--pyhdfd78af_0
```
