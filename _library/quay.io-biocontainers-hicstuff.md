...
updated_at: "2023-05-14 02:35:25.272148"
...
```bash
$ shpc install quay.io/biocontainers/hicstuff:3.1.5--pyhdfd78af_2
```
...
```bash
$ module load quay.io/biocontainers/hicstuff/3.1.5--pyhdfd78af_2
$ module help quay.io/biocontainers/hicstuff/3.1.5--pyhdfd78af_2
```
