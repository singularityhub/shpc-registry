...
updated_at: "2023-08-31 02:48:27.483418"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hdcytodata:1.20.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hdcytodata/1.20.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-hdcytodata/1.20.0--r43hdfd78af_0
```
