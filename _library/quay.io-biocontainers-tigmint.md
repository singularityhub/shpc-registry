...
updated_at: "2023-01-19 03:33:56.846383"
latest: "1.2.8--py39h6935b12_0"
...
```bash
$ shpc install quay.io/biocontainers/tigmint:1.2.8--py39h6935b12_0
```
...
```bash
$ module load quay.io/biocontainers/tigmint/1.2.8--py39h6935b12_0
$ module help quay.io/biocontainers/tigmint/1.2.8--py39h6935b12_0
```
