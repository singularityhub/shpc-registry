...
updated_at: "2026-02-06 04:30:31.414794"
latest: "2.0.1--py310h3e1df6f_1"
...
```bash
$ shpc install quay.io/biocontainers/pantax:2.0.1--py310h3e1df6f_1
```
...
```bash
$ module load quay.io/biocontainers/pantax/2.0.1--py310h3e1df6f_1
$ module help quay.io/biocontainers/pantax/2.0.1--py310h3e1df6f_1
```
