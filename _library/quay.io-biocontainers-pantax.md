...
updated_at: "2024-10-14 17:34:51.559072"
...
```bash
$ shpc install quay.io/biocontainers/pantax:1.0.2--py310h4349ce8_0
```
...
```bash
$ module load quay.io/biocontainers/pantax/1.0.2--py310h4349ce8_0
$ module help quay.io/biocontainers/pantax/1.0.2--py310h4349ce8_0
```
