...
updated_at: "2026-01-05 06:18:09.464259"
...
```bash
$ shpc install quay.io/biocontainers/comebin:1.0.4--hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/comebin/1.0.4--hdfd78af_1
$ module help quay.io/biocontainers/comebin/1.0.4--hdfd78af_1
```
