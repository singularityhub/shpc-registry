...
updated_at: "2026-08-23 03:20:14.846451"
...
```bash
$ shpc install quay.io/biocontainers/pyjess:0.10.1--py311h26ae33e_0
```
...
```bash
$ module load quay.io/biocontainers/pyjess/0.10.1--py311h26ae33e_0
$ module help quay.io/biocontainers/pyjess/0.10.1--py311h26ae33e_0
```
