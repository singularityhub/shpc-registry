...
updated_at: "2022-11-01 03:53:00.959708"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-proteomm:1.8.0--r40hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-proteomm/1.8.0--r40hdfd78af_1
$ module help quay.io/biocontainers/bioconductor-proteomm/1.8.0--r40hdfd78af_1
```
