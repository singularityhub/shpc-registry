...
updated_at: "2022-11-25 00:34:43.219098"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-proteomm:1.12.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-proteomm/1.12.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-proteomm/1.12.0--r41hdfd78af_0
```
