...
updated_at: "2025-03-26 03:19:11.274583"
latest: "2.0.8--h577a1d6_0"
...
```bash
$ shpc install quay.io/biocontainers/subread:2.0.8--h577a1d6_0
```
...
```bash
$ module load quay.io/biocontainers/subread/2.0.8--h577a1d6_0
$ module help quay.io/biocontainers/subread/2.0.8--h577a1d6_0
```
