...
updated_at: "2026-01-25 04:06:33.854903"
latest: "2.1.1--h577a1d6_0"
...
```bash
$ shpc install quay.io/biocontainers/subread:2.1.1--h577a1d6_0
```
...
```bash
$ module load quay.io/biocontainers/subread/2.1.1--h577a1d6_0
$ module help quay.io/biocontainers/subread/2.1.1--h577a1d6_0
```
