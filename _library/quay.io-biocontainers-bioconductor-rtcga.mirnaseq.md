...
updated_at: "2023-03-07 03:37:22.439536"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rtcga.mirnaseq:1.25.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rtcga.mirnaseq/1.25.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rtcga.mirnaseq/1.25.0--r42hdfd78af_0
```
