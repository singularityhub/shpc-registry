...
updated_at: "2025-12-31 03:40:17.664504"
...
```bash
$ shpc install quay.io/biocontainers/prinseq-plus-plus:1.2.4--h077b44d_8
```
...
```bash
$ module load quay.io/biocontainers/prinseq-plus-plus/1.2.4--h077b44d_8
$ module help quay.io/biocontainers/prinseq-plus-plus/1.2.4--h077b44d_8
```
