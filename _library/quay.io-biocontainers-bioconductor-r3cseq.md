...
updated_at: "2026-03-28 17:09:18.978469"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-r3cseq:1.56.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-r3cseq/1.56.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-r3cseq/1.56.0--r45hdfd78af_0
```
