---
layout: container
name:  "quay.io/biocontainers/cifi"
maintainer: "@vsoch"
...
updated_at: "2026-03-13 16:27:52.055852"
...
singularity registry hpc automated addition for cifi
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/cifi
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/cifi:0.2.3--py310hfc0ef84_0
```
...
```bash
$ module load quay.io/biocontainers/cifi/0.2.3--py310hfc0ef84_0
$ module help quay.io/biocontainers/cifi/0.2.3--py310hfc0ef84_0
```
...
#### cifi-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### cifi-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/cifi
$ podman run --it --rm --entrypoint /usr/local/bin/cifi   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/cifi   -v ${PWD} -w ${PWD} <container> -c " $@"
```
