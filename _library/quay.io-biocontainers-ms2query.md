...
updated_at: "2023-12-21 02:35:07.211317"
...
```bash
$ shpc install quay.io/biocontainers/ms2query:1.2.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ms2query/1.2.3--pyhdfd78af_0
$ module help quay.io/biocontainers/ms2query/1.2.3--pyhdfd78af_0
```
