...
updated_at: "2023-06-10 03:08:46.883403"
...
```bash
$ shpc install quay.io/biocontainers/ms2query:1.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ms2query/1.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/ms2query/1.2.0--pyhdfd78af_0
```
