...
updated_at: "2024-07-21 03:21:01.287435"
...
```bash
$ shpc install quay.io/biocontainers/ms2query:1.5.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ms2query/1.5.0--pyhdfd78af_0
$ module help quay.io/biocontainers/ms2query/1.5.0--pyhdfd78af_0
```
