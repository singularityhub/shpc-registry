...
updated_at: "2023-10-12 03:33:44.099952"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-msgbsr:1.24.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-msgbsr/1.24.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-msgbsr/1.24.0--r43hdfd78af_0
```
