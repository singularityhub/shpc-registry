...
updated_at: "2024-12-18 03:01:34.883220"
...
```bash
$ shpc install quay.io/biocontainers/varfish-cli:0.6.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/varfish-cli/0.6.4--pyhdfd78af_0
$ module help quay.io/biocontainers/varfish-cli/0.6.4--pyhdfd78af_0
```
