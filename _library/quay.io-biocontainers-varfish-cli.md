...
updated_at: "2023-07-01 03:15:05.435911"
...
```bash
$ shpc install quay.io/biocontainers/varfish-cli:0.5.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/varfish-cli/0.5.2--pyhdfd78af_0
$ module help quay.io/biocontainers/varfish-cli/0.5.2--pyhdfd78af_0
```
