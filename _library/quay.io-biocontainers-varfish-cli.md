...
updated_at: "2026-01-31 04:46:22.300897"
...
```bash
$ shpc install quay.io/biocontainers/varfish-cli:0.7.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/varfish-cli/0.7.0--pyhdfd78af_0
$ module help quay.io/biocontainers/varfish-cli/0.7.0--pyhdfd78af_0
```
