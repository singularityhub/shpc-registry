...
updated_at: "2024-07-04 02:39:58.965016"
latest: "0.2.26--pyh7cba7a3_0"
...
```bash
$ shpc install quay.io/biocontainers/nda-tools:0.2.26--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/nda-tools/0.2.26--pyh7cba7a3_0
$ module help quay.io/biocontainers/nda-tools/0.2.26--pyh7cba7a3_0
```
