...
updated_at: "2025-05-22 03:59:26.978525"
...
```bash
$ shpc install quay.io/biocontainers/nda-tools:0.4.0--pyh7e72e81_0
```
...
```bash
$ module load quay.io/biocontainers/nda-tools/0.4.0--pyh7e72e81_0
$ module help quay.io/biocontainers/nda-tools/0.4.0--pyh7e72e81_0
```
