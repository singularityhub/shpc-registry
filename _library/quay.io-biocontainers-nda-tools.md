...
updated_at: "2025-09-03 03:20:55.991549"
...
```bash
$ shpc install quay.io/biocontainers/nda-tools:0.5.0--pyh7e72e81_0
```
...
```bash
$ module load quay.io/biocontainers/nda-tools/0.5.0--pyh7e72e81_0
$ module help quay.io/biocontainers/nda-tools/0.5.0--pyh7e72e81_0
```
