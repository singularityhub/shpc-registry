---
layout: container
name:  "quay.io/biocontainers/molamola"
maintainer: "@vsoch"
...
updated_at: "2026-09-22 08:03:14.106895"
...
```bash
$ module load quay.io/biocontainers/molamola/0.6.0--pyhdfd78af_0
$ module help quay.io/biocontainers/molamola/0.6.0--pyhdfd78af_0
```
...
#### molamola-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### molamola-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/molamola
$ podman run --it --rm --entrypoint /usr/local/bin/molamola   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/molamola   -v ${PWD} -w ${PWD} <container> -c " $@"
```
