---
layout: container
name:  "quay.io/biocontainers/djinn"
maintainer: "@vsoch"
...
updated_at: "2025-11-08 03:11:29.653935"
...
```bash
$ module load quay.io/biocontainers/djinn/1.0.1--pyhdfd78af_0
$ module help quay.io/biocontainers/djinn/1.0.1--pyhdfd78af_0
```
...
#### djinn-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### djinn-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/djinn
$ podman run --it --rm --entrypoint /usr/local/bin/djinn   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/djinn   -v ${PWD} -w ${PWD} <container> -c " $@"
```
