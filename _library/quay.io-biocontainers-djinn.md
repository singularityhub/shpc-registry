...
updated_at: "2026-06-27 06:31:27.021885"
...
```bash
$ shpc install quay.io/biocontainers/djinn:2.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/djinn/2.5--pyhdfd78af_0
$ module help quay.io/biocontainers/djinn/2.5--pyhdfd78af_0
```
