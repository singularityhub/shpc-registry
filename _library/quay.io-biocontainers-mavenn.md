...
updated_at: "2026-01-20 04:09:48.171700"
...
```bash
$ shpc install quay.io/biocontainers/mavenn:1.1.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mavenn/1.1.3--pyhdfd78af_0
$ module help quay.io/biocontainers/mavenn/1.1.3--pyhdfd78af_0
```
