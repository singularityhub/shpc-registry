...
updated_at: "2026-03-24 05:05:05.971755"
...
```bash
$ shpc install quay.io/biocontainers/mavenn:1.1.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mavenn/1.1.4--pyhdfd78af_0
$ module help quay.io/biocontainers/mavenn/1.1.4--pyhdfd78af_0
```
