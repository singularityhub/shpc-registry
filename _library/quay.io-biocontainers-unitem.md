...
updated_at: "2023-04-10 03:02:59.324629"
...
```bash
$ shpc install quay.io/biocontainers/unitem:1.2.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/unitem/1.2.5--pyhdfd78af_0
$ module help quay.io/biocontainers/unitem/1.2.5--pyhdfd78af_0
```
