...
updated_at: "2024-05-30 04:38:33.779069"
...
```bash
$ shpc install quay.io/biocontainers/unitem:1.2.6--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/unitem/1.2.6--pyhdfd78af_0
$ module help quay.io/biocontainers/unitem/1.2.6--pyhdfd78af_0
```
