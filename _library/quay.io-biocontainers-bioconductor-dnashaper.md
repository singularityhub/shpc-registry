...
updated_at: "2026-04-04 04:23:19.662857"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-dnashaper:1.38.0--r45ha27e39d_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-dnashaper/1.38.0--r45ha27e39d_0
$ module help quay.io/biocontainers/bioconductor-dnashaper/1.38.0--r45ha27e39d_0
```
