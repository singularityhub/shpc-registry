...
updated_at: "2024-01-16 02:53:24.127430"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-msqc1:1.30.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-msqc1/1.30.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-msqc1/1.30.0--r43hdfd78af_0
```
