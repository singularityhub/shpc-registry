...
updated_at: "2023-12-09 02:49:36.167906"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-awst:1.8.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-awst/1.8.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-awst/1.8.0--r43hdfd78af_0
```
