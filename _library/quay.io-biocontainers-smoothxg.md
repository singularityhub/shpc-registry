...
updated_at: "2026-02-01 05:04:26.551055"
...
```bash
$ shpc install quay.io/biocontainers/smoothxg:0.8.2--h2fa790d_1
```
...
```bash
$ module load quay.io/biocontainers/smoothxg/0.8.2--h2fa790d_1
$ module help quay.io/biocontainers/smoothxg/0.8.2--h2fa790d_1
```
