...
updated_at: "2024-11-05 03:09:35.044282"
latest: "0.8.0--h40c17d1_0"
...
```bash
$ shpc install quay.io/biocontainers/smoothxg:0.8.0--h40c17d1_0
```
...
```bash
$ module load quay.io/biocontainers/smoothxg/0.8.0--h40c17d1_0
$ module help quay.io/biocontainers/smoothxg/0.8.0--h40c17d1_0
```
