...
updated_at: "2024-09-07 03:16:37.352809"
latest: "0.7.4--h40c17d1_0"
...
```bash
$ shpc install quay.io/biocontainers/smoothxg:0.7.4--h40c17d1_0
```
...
```bash
$ module load quay.io/biocontainers/smoothxg/0.7.4--h40c17d1_0
$ module help quay.io/biocontainers/smoothxg/0.7.4--h40c17d1_0
```
