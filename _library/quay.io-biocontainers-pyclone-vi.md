...
updated_at: "2026-03-10 04:54:10.018699"
...
```bash
$ shpc install quay.io/biocontainers/pyclone-vi:0.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pyclone-vi/0.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/pyclone-vi/0.2.0--pyhdfd78af_0
```
