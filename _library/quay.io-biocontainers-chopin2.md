...
updated_at: "2025-08-17 03:45:02.900341"
latest: "1.0.9.post1"
...
```bash
$ shpc install quay.io/biocontainers/chopin2:1.0.9.post1
```
...
```bash
$ module load quay.io/biocontainers/chopin2/1.0.9.post1
$ module help quay.io/biocontainers/chopin2/1.0.9.post1
```
