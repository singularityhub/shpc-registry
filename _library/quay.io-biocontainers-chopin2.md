...
updated_at: "2024-05-29 03:15:00.298056"
latest: "1.0.8.post1"
...
```bash
$ shpc install quay.io/biocontainers/chopin2:1.0.8.post1
```
...
```bash
$ module load quay.io/biocontainers/chopin2/1.0.8.post1
$ module help quay.io/biocontainers/chopin2/1.0.8.post1
```
