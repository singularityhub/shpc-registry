...
updated_at: "2023-07-17 03:40:00.775344"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gcatest:1.28.0--r42ha9d7317_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gcatest/1.28.0--r42ha9d7317_1
$ module help quay.io/biocontainers/bioconductor-gcatest/1.28.0--r42ha9d7317_1
```
