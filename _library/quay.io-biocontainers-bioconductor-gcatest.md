...
updated_at: "2023-09-02 03:13:03.052107"
latest: "2.0.7--r43hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gcatest:2.0.7--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gcatest/2.0.7--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-gcatest/2.0.7--r43hdfd78af_0
```
