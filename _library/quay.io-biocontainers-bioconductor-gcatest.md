...
updated_at: "2026-03-03 05:10:24.108926"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gcatest:2.10.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gcatest/2.10.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-gcatest/2.10.0--r45hdfd78af_0
```
