...
updated_at: "2025-04-03 03:01:24.346334"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-deconvr:1.12.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-deconvr/1.12.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-deconvr/1.12.0--r44hdfd78af_0
```
