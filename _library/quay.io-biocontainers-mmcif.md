...
updated_at: "2026-01-19 04:12:55.830317"
...
```bash
$ shpc install quay.io/biocontainers/mmcif:1.1.0--py310h8ea774a_0
```
...
```bash
$ module load quay.io/biocontainers/mmcif/1.1.0--py310h8ea774a_0
$ module help quay.io/biocontainers/mmcif/1.1.0--py310h8ea774a_0
```
