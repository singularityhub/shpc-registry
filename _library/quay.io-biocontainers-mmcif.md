...
updated_at: "2025-12-03 03:39:47.268821"
latest: "1.0.0--py311h8ddd9a4_0"
...
```bash
$ shpc install quay.io/biocontainers/mmcif:1.0.0--py311h8ddd9a4_0
```
...
```bash
$ module load quay.io/biocontainers/mmcif/1.0.0--py311h8ddd9a4_0
$ module help quay.io/biocontainers/mmcif/1.0.0--py311h8ddd9a4_0
```
