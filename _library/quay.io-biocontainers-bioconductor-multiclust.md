...
updated_at: "2022-11-05 00:14:31.402590"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-multiclust:1.8.2--r3.4.1_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-multiclust/1.8.2--r3.4.1_0
$ module help quay.io/biocontainers/bioconductor-multiclust/1.8.2--r3.4.1_0
```
