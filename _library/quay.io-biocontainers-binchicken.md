...
updated_at: "2025-09-29 03:31:19.934330"
...
```bash
$ shpc install quay.io/biocontainers/binchicken:0.13.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/binchicken/0.13.4--pyhdfd78af_0
$ module help quay.io/biocontainers/binchicken/0.13.4--pyhdfd78af_0
```
