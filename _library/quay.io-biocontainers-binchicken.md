...
updated_at: "2025-09-11 05:29:04.059767"
...
```bash
$ shpc install quay.io/biocontainers/binchicken:0.13.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/binchicken/0.13.0--pyhdfd78af_0
$ module help quay.io/biocontainers/binchicken/0.13.0--pyhdfd78af_0
```
