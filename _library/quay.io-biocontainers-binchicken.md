---
layout: container
name:  "quay.io/biocontainers/binchicken"
maintainer: "@vsoch"
...
updated_at: "2026-09-16 07:50:03.723016"
...
versions:
 ...
 - "0.14.1--pyhdfd78af_0"
 - "0.15.0--pyhdfd78af_0"
description: "singularity registry hpc automated addition for binchicken"
config: {"url": "https://biocontainers.pro/tools/binchicken", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for binchicken", "latest": {"0.15.0--pyhdfd78af_0": "sha256:aa9785a7efd12610452a0f4cd6642ac3906029427484f8504ba9c356240685e5"}, "tags": {"0.10.0--pyhdfd78af_0": "sha256:81ae87b0316acc59615df7cfa4c3a75828f65d463c26cbff2d4434a267a35137", "0.10.3--pyhdfd78af_0": "sha256:ff873efb7941bc5f218ed517b8f30f56f19f2d51a167275281784456e019aa7d", "0.12.6--pyhdfd78af_1": "sha256:7bf2b2484b8897ae7006eb962a82d09b06a30fbefa685b71b9c1d9efcfe3aaf7", "0.11.0--pyhdfd78af_0": "sha256:a6fd9bfbef4976d0e448db978975619061bbef4ea80ac32ff4ec2c3e71f31292", "0.10.5--pyhdfd78af_0": "sha256:cfcc861efec97e5f269ff3355fcb2c8300f860dd73e809e9375064267d2fb146", "0.12.11--pyhdfd78af_0": "sha256:9c3ac18708420f794ce160b189f09768232012571916ca15cd04dee928d1460e", "0.13.0--pyhdfd78af_0": "sha256:bce48872568b680164682b9216dd4daacea52fd733e4a044d8cf121a3bbe9ae3", "0.13.4--pyhdfd78af_0": "sha256:543a2d3afcb5668ca0019a2143aba3f0ad09dec240490893ffab8cb931faaf6b", "0.13.5--pyhdfd78af_0": "sha256:a4617d6f86587b9dd2b9179a11d83a5025dfe0dfd92ebb070913e6e4e7a48970", "0.14.1--pyhdfd78af_0": "sha256:b9fb5e2b66574d593459f2cd1fb9b0e6783f1bce16b9784d14459f0714618608", "0.15.0--pyhdfd78af_0": "sha256:aa9785a7efd12610452a0f4cd6642ac3906029427484f8504ba9c356240685e5"}, "docker": "quay.io/biocontainers/binchicken", "aliases": {"binchicken": "/usr/local/bin/binchicken", "cmtime": "/usr/local/bin/cmtime", "eido": "/usr/local/bin/eido", "genl-ctrl-list": "/usr/local/bin/genl-ctrl-list", "ib_acme": "/usr/local/bin/ib_acme", "ibis": "/usr/local/bin/ibis", "ibv_asyncwatch": "/usr/local/bin/ibv_asyncwatch", "ibv_devices": "/usr/local/bin/ibv_devices", "ibv_devinfo": "/usr/local/bin/ibv_devinfo", "ibv_rc_pingpong": "/usr/local/bin/ibv_rc_pingpong", "ibv_srq_pingpong": "/usr/local/bin/ibv_srq_pingpong", "ibv_uc_pingpong": "/usr/local/bin/ibv_uc_pingpong", "ibv_ud_pingpong": "/usr/local/bin/ibv_ud_pingpong", "ibv_xsrq_pingpong": "/usr/local/bin/ibv_xsrq_pingpong", "idiag-socket-details": "/usr/local/bin/idiag-socket-details", "jsondiff": "/usr/local/bin/jsondiff", "jsonpatch": "/usr/local/bin/jsonpatch", "jsonpointer": "/usr/local/bin/jsonpointer", "mckey": "/usr/local/bin/mckey", "nf-ct-add": "/usr/local/bin/nf-ct-add", "nf-ct-events": "/usr/local/bin/nf-ct-events", "nf-ct-list": "/usr/local/bin/nf-ct-list", "nf-exp-add": "/usr/local/bin/nf-exp-add", "nf-exp-delete": "/usr/local/bin/nf-exp-delete", "nf-exp-list": "/usr/local/bin/nf-exp-list", "nf-log": "/usr/local/bin/nf-log", "nf-monitor": "/usr/local/bin/nf-monitor", "nf-queue": "/usr/local/bin/nf-queue", "nl-addr-add": "/usr/local/bin/nl-addr-add", "nl-addr-delete": "/usr/local/bin/nl-addr-delete", "nl-addr-list": "/usr/local/bin/nl-addr-list", "nl-class-add": "/usr/local/bin/nl-class-add", "nl-class-delete": "/usr/local/bin/nl-class-delete", "nl-class-list": "/usr/local/bin/nl-class-list", "nl-classid-lookup": "/usr/local/bin/nl-classid-lookup", "nl-cls-add": "/usr/local/bin/nl-cls-add", "nl-cls-delete": "/usr/local/bin/nl-cls-delete", "nl-cls-list": "/usr/local/bin/nl-cls-list", "nl-fib-lookup": "/usr/local/bin/nl-fib-lookup", "nl-link-enslave": "/usr/local/bin/nl-link-enslave", "nl-link-ifindex2name": "/usr/local/bin/nl-link-ifindex2name", "nl-link-list": "/usr/local/bin/nl-link-list", "nl-link-name2ifindex": "/usr/local/bin/nl-link-name2ifindex", "nl-link-release": "/usr/local/bin/nl-link-release", "nl-link-set": "/usr/local/bin/nl-link-set", "nl-link-stats": "/usr/local/bin/nl-link-stats", "nl-list-caches": "/usr/local/bin/nl-list-caches", "nl-list-sockets": "/usr/local/bin/nl-list-sockets", "nl-monitor": "/usr/local/bin/nl-monitor", "nl-neigh-add": "/usr/local/bin/nl-neigh-add", "nl-neigh-delete": "/usr/local/bin/nl-neigh-delete", "nl-neigh-list": "/usr/local/bin/nl-neigh-list", "nl-neightbl-list": "/usr/local/bin/nl-neightbl-list", "nl-nh-list": "/usr/local/bin/nl-nh-list", "nl-pktloc-lookup": "/usr/local/bin/nl-pktloc-lookup", "nl-qdisc-add": "/usr/local/bin/nl-qdisc-add", "nl-qdisc-delete": "/usr/local/bin/nl-qdisc-delete", "nl-qdisc-list": "/usr/local/bin/nl-qdisc-list", "nl-route-add": "/usr/local/bin/nl-route-add", "nl-route-delete": "/usr/local/bin/nl-route-delete", "nl-route-get": "/usr/local/bin/nl-route-get", "nl-route-list": "/usr/local/bin/nl-route-list", "nl-rule-list": "/usr/local/bin/nl-rule-list", "nl-tctree-list": "/usr/local/bin/nl-tctree-list", "nl-util-addr": "/usr/local/bin/nl-util-addr", "protoc-24.4.0": "/usr/local/bin/protoc-24.4.0", "rcopy": "/usr/local/bin/rcopy", "rdma_client": "/usr/local/bin/rdma_client", "rdma_server": "/usr/local/bin/rdma_server", "rdma_xclient": "/usr/local/bin/rdma_xclient", "rdma_xserver": "/usr/local/bin/rdma_xserver", "riostream": "/usr/local/bin/riostream", "rping": "/usr/local/bin/rping", "rstream": "/usr/local/bin/rstream", "ucmatose": "/usr/local/bin/ucmatose", "udaddy": "/usr/local/bin/udaddy", "udpong": "/usr/local/bin/udpong", "io_demo": "/usr/local/bin/io_demo", "ucx_info": "/usr/local/bin/ucx_info", "ucx_perftest": "/usr/local/bin/ucx_perftest", "ucx_read_profile": "/usr/local/bin/ucx_read_profile", "mamba-package": "/usr/local/bin/mamba-package", "elastipubsub5": "/usr/local/bin/elastipubsub5", "mqtt5_app": "/usr/local/bin/mqtt5_app", "mqtt5_canary": "/usr/local/bin/mqtt5_canary", "mqtt5canary": "/usr/local/bin/mqtt5canary", "conda2solv": "/usr/local/bin/conda2solv", "dumpsolv": "/usr/local/bin/dumpsolv", "installcheck": "/usr/local/bin/installcheck", "mamba": "/usr/local/bin/mamba", "mergesolv": "/usr/local/bin/mergesolv", "repo2solv": "/usr/local/bin/repo2solv", "testsolv": "/usr/local/bin/testsolv", "produce_x_platform_fuzz_corpus": "/usr/local/bin/produce_x_platform_fuzz_corpus", "run_x_platform_fuzz_corpus": "/usr/local/bin/run_x_platform_fuzz_corpus", "bsdcat": "/usr/local/bin/bsdcat", "bsdcpio": "/usr/local/bin/bsdcpio", "bsdtar": "/usr/local/bin/bsdtar", "conda-env": "/usr/local/bin/conda-env", "cph": "/usr/local/bin/cph", "elasticurl": "/usr/local/bin/elasticurl", "elasticurl_cpp": "/usr/local/bin/elasticurl_cpp"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/binchicken.
singularity registry hpc automated addition for binchicken
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/binchicken
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/binchicken:0.15.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/binchicken/0.15.0--pyhdfd78af_0
$ module help quay.io/biocontainers/binchicken/0.15.0--pyhdfd78af_0
```
...
#### binchicken-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### binchicken-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/binchicken
$ podman run --it --rm --entrypoint /usr/local/bin/binchicken   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/binchicken   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/ibis
$ podman run --it --rm --entrypoint /usr/local/bin/ibis   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/ibis   -v ${PWD} -w ${PWD} <container> -c " $@"
```
