...
updated_at: "2026-08-16 03:23:10.998508"
...
```bash
$ shpc install quay.io/biocontainers/binchicken:0.14.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/binchicken/0.14.1--pyhdfd78af_0
$ module help quay.io/biocontainers/binchicken/0.14.1--pyhdfd78af_0
```
