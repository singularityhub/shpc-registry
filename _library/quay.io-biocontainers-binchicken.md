...
updated_at: "2024-01-10 02:42:33.075510"
...
```bash
$ shpc install quay.io/biocontainers/binchicken:0.10.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/binchicken/0.10.0--pyhdfd78af_0
$ module help quay.io/biocontainers/binchicken/0.10.0--pyhdfd78af_0
```
