...
updated_at: "2024-10-26 03:34:07.164873"
...
```bash
$ shpc install quay.io/biocontainers/binchicken:0.10.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/binchicken/0.10.3--pyhdfd78af_0
$ module help quay.io/biocontainers/binchicken/0.10.3--pyhdfd78af_0
```
