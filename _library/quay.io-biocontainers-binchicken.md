...
updated_at: "2025-08-06 03:58:20.421839"
...
```bash
$ shpc install quay.io/biocontainers/binchicken:0.12.11--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/binchicken/0.12.11--pyhdfd78af_0
$ module help quay.io/biocontainers/binchicken/0.12.11--pyhdfd78af_0
```
