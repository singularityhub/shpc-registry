...
updated_at: "2025-12-29 04:42:45.939289"
...
```bash
$ shpc install quay.io/biocontainers/binchicken:0.13.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/binchicken/0.13.5--pyhdfd78af_0
$ module help quay.io/biocontainers/binchicken/0.13.5--pyhdfd78af_0
```
