...
updated_at: "2026-03-28 05:14:54.065544"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-elmer.data:2.34.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-elmer.data/2.34.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-elmer.data/2.34.0--r45hdfd78af_0
```
