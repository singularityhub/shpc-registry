...
updated_at: "2026-09-17 07:55:23.506764"
...
```bash
$ shpc install quay.io/biocontainers/spacna:0.1.1--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/spacna/0.1.1--hdfd78af_0
$ module help quay.io/biocontainers/spacna/0.1.1--hdfd78af_0
```
