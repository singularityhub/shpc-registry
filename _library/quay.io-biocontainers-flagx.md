---
layout: container
name:  "quay.io/biocontainers/flagx"
maintainer: "@vsoch"
...
updated_at: "2026-07-01 07:21:41.545547"
...
```bash
$ module load quay.io/biocontainers/flagx/0.2.1--pyhdfd78af_0
$ module help quay.io/biocontainers/flagx/0.2.1--pyhdfd78af_0
```
...
#### flagx-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### flagx-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/flagx
$ podman run --it --rm --entrypoint /usr/local/bin/flagx   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/flagx   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/nbproject
$ podman run --it --rm --entrypoint /usr/local/bin/nbproject   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/nbproject   -v ${PWD} -w ${PWD} <container> -c " $@"
```
