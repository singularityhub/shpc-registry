...
updated_at: "2025-02-21 03:19:22.242025"
...
```bash
$ shpc install quay.io/biocontainers/fgsv:0.2.1--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/fgsv/0.2.1--hdfd78af_0
$ module help quay.io/biocontainers/fgsv/0.2.1--hdfd78af_0
```
