...
updated_at: "2025-10-31 03:29:54.676609"
latest: "0.2.1--hdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/fgsv:0.2.1--hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/fgsv/0.2.1--hdfd78af_1
$ module help quay.io/biocontainers/fgsv/0.2.1--hdfd78af_1
```
