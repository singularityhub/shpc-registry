...
updated_at: "2024-06-27 03:48:34.460585"
...
```bash
$ shpc install quay.io/biocontainers/fgsv:0.2.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/fgsv/0.2.0--hdfd78af_0
$ module help quay.io/biocontainers/fgsv/0.2.0--hdfd78af_0
```
