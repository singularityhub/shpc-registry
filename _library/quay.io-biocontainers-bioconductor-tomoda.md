...
updated_at: "2022-10-29 05:42:12.120404"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-tomoda:1.4.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-tomoda/1.4.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-tomoda/1.4.0--r41hdfd78af_0
```
