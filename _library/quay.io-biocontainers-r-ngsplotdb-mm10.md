---
layout: container
name:  "quay.io/biocontainers/r-ngsplotdb-mm10"
maintainer: "@vsoch"
github: "https://github.com/singularityhub/shpc-registry/blob/main/quay.io/biocontainers/r-ngsplotdb-mm10/container.yaml"
config_url: "https://raw.githubusercontent.com//singularityhub/shpc-registry/main/quay.io/biocontainers/r-ngsplotdb-mm10/container.yaml"
updated_at: "2022-10-27 00:35:17.529474"
latest: "3.00--hdfd78af_7"
container_url: "https://biocontainers.pro/tools/r-ngsplotdb-mm10"
aliases:
 - ".r-ngsplotdb-mm10-post-link.sh"
 - ".r-ngsplotdb-mm10-pre-unlink.sh"
 - "ExtractGName.R"
 - "alt_reg_cufflinks"
 - "alter2bed.pl"
 - "combine_diff.pl"
...
```bash
$ module load quay.io/biocontainers/r-ngsplotdb-mm10/3.00--hdfd78af_7
$ module help quay.io/biocontainers/r-ngsplotdb-mm10/3.00--hdfd78af_7
```
...
#### r-ngsplotdb-mm10-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-ngsplotdb-mm10-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/.r-ngsplotdb-mm10-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.r-ngsplotdb-mm10-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.r-ngsplotdb-mm10-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.r-ngsplotdb-mm10-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.r-ngsplotdb-mm10-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.r-ngsplotdb-mm10-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
