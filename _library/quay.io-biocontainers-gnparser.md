...
updated_at: "2024-10-26 03:04:50.436859"
latest: "1.10.3--he881be0_1"
...
```bash
$ shpc install quay.io/biocontainers/gnparser:1.10.3--he881be0_1
```
...
```bash
$ module load quay.io/biocontainers/gnparser/1.10.3--he881be0_1
$ module help quay.io/biocontainers/gnparser/1.10.3--he881be0_1
```
