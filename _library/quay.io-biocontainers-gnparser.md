...
updated_at: "2025-05-05 04:02:30.214789"
latest: "1.11.6--he881be0_0"
...
```bash
$ shpc install quay.io/biocontainers/gnparser:1.11.6--he881be0_0
```
...
```bash
$ module load quay.io/biocontainers/gnparser/1.11.6--he881be0_0
$ module help quay.io/biocontainers/gnparser/1.11.6--he881be0_0
```
