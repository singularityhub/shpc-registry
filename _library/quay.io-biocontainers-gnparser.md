...
updated_at: "2026-05-20 06:11:35.800453"
latest: "1.15.0--he881be0_0"
...
```bash
$ shpc install quay.io/biocontainers/gnparser:1.15.0--he881be0_0
```
...
```bash
$ module load quay.io/biocontainers/gnparser/1.15.0--he881be0_0
$ module help quay.io/biocontainers/gnparser/1.15.0--he881be0_0
```
