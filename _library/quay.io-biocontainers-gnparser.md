...
updated_at: "2025-02-08 03:25:47.938937"
latest: "1.11.1--he881be0_0"
...
```bash
$ shpc install quay.io/biocontainers/gnparser:1.11.1--he881be0_0
```
...
```bash
$ module load quay.io/biocontainers/gnparser/1.11.1--he881be0_0
$ module help quay.io/biocontainers/gnparser/1.11.1--he881be0_0
```
