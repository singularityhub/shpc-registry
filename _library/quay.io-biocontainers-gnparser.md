...
updated_at: "2025-08-29 03:31:34.214412"
latest: "1.11.8--he881be0_0"
...
```bash
$ shpc install quay.io/biocontainers/gnparser:1.11.8--he881be0_0
```
...
```bash
$ module load quay.io/biocontainers/gnparser/1.11.8--he881be0_0
$ module help quay.io/biocontainers/gnparser/1.11.8--he881be0_0
```
