...
updated_at: "2026-01-20 04:37:16.406700"
latest: "1.14.2--he881be0_0"
...
```bash
$ shpc install quay.io/biocontainers/gnparser:1.14.2--he881be0_0
```
...
```bash
$ module load quay.io/biocontainers/gnparser/1.14.2--he881be0_0
$ module help quay.io/biocontainers/gnparser/1.14.2--he881be0_0
```
