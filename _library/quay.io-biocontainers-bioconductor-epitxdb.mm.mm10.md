...
updated_at: "2022-10-29 18:09:30.851937"
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-epitxdb.mm.mm10-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-epitxdb.mm.mm10-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-epitxdb.mm.mm10-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-epitxdb.mm.mm10-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-epitxdb.mm.mm10-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-epitxdb.mm.mm10-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
