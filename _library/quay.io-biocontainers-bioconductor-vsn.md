...
updated_at: "2022-10-29 05:47:19.380176"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-vsn:3.62.0--r41hc0cfd56_2
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-vsn/3.62.0--r41hc0cfd56_2
$ module help quay.io/biocontainers/bioconductor-vsn/3.62.0--r41hc0cfd56_2
```
