...
updated_at: "2026-03-19 05:18:38.674480"
latest: "1.52.0--r45h57f0213_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-dirichletmultinomial:1.52.0--r45h57f0213_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-dirichletmultinomial/1.52.0--r45h57f0213_0
$ module help quay.io/biocontainers/bioconductor-dirichletmultinomial/1.52.0--r45h57f0213_0
```
