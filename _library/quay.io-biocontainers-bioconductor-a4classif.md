...
updated_at: "2023-09-04 04:03:32.379540"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-a4classif:1.48.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-a4classif/1.48.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-a4classif/1.48.0--r43hdfd78af_0
```
