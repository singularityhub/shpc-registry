...
updated_at: "2022-11-28 00:17:59.555036"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-crossmeta:1.20.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-crossmeta/1.20.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-crossmeta/1.20.0--r41hdfd78af_0
```
