...
updated_at: "2023-09-02 02:42:52.627835"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-crossmeta:1.26.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-crossmeta/1.26.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-crossmeta/1.26.0--r43hdfd78af_0
```
