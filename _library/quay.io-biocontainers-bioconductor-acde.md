...
updated_at: "2023-07-29 03:15:59.231420"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-acde:1.30.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-acde/1.30.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-acde/1.30.0--r43hdfd78af_0
```
