...
updated_at: "2026-03-23 05:48:26.536911"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-acde:1.40.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-acde/1.40.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-acde/1.40.0--r45hdfd78af_0
```
