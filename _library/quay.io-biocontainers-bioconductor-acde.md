...
updated_at: "2024-11-14 03:26:02.957611"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-acde:1.32.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-acde/1.32.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-acde/1.32.0--r43hdfd78af_0
```
