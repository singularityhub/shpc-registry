...
updated_at: "2024-02-25 02:48:55.597617"
latest: "2.3.9--pyh7cba7a3_0"
...
```bash
$ shpc install quay.io/biocontainers/pyensembl:2.3.9--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/pyensembl/2.3.9--pyh7cba7a3_0
$ module help quay.io/biocontainers/pyensembl/2.3.9--pyh7cba7a3_0
```
