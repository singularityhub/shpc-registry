...
updated_at: "2026-07-25 05:31:32.542250"
...
```bash
$ shpc install quay.io/biocontainers/pyensembl:2.10.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pyensembl/2.10.4--pyhdfd78af_0
$ module help quay.io/biocontainers/pyensembl/2.10.4--pyhdfd78af_0
```
