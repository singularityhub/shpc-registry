...
updated_at: "2023-10-03 02:35:19.928790"
...
```bash
$ shpc install quay.io/biocontainers/pyensembl:2.2.9--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/pyensembl/2.2.9--pyh7cba7a3_0
$ module help quay.io/biocontainers/pyensembl/2.2.9--pyh7cba7a3_0
```
