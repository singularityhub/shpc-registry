...
updated_at: "2026-04-13 06:08:23.859207"
latest: "2.6.2--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/pyensembl:2.6.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pyensembl/2.6.2--pyhdfd78af_0
$ module help quay.io/biocontainers/pyensembl/2.6.2--pyhdfd78af_0
```
