...
updated_at: "2026-06-22 07:55:50.519300"
latest: "2.6.7--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/pyensembl:2.6.7--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pyensembl/2.6.7--pyhdfd78af_0
$ module help quay.io/biocontainers/pyensembl/2.6.7--pyhdfd78af_0
```
