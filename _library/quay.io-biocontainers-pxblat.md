...
updated_at: "2026-01-15 03:53:36.077085"
latest: "1.2.8--py310h275bdba_0"
...
```bash
$ shpc install quay.io/biocontainers/pxblat:1.2.8--py310h275bdba_0
```
...
```bash
$ module load quay.io/biocontainers/pxblat/1.2.8--py310h275bdba_0
$ module help quay.io/biocontainers/pxblat/1.2.8--py310h275bdba_0
```
