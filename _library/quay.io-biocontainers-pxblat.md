...
updated_at: "2025-11-06 03:56:06.924885"
latest: "1.2.1--py39h475c85d_1"
...
```bash
$ shpc install quay.io/biocontainers/pxblat:1.2.1--py39h475c85d_1
```
...
```bash
$ module load quay.io/biocontainers/pxblat/1.2.1--py39h475c85d_1
$ module help quay.io/biocontainers/pxblat/1.2.1--py39h475c85d_1
```
