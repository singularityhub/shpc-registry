...
updated_at: "2026-02-25 04:32:53.109547"
...
```bash
$ shpc install quay.io/biocontainers/pxblat:1.2.8--py311h93bbee8_1
```
...
```bash
$ module load quay.io/biocontainers/pxblat/1.2.8--py311h93bbee8_1
$ module help quay.io/biocontainers/pxblat/1.2.8--py311h93bbee8_1
```
