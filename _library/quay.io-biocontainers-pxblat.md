...
updated_at: "2023-12-20 02:45:52.835902"
latest: "1.1.10--py310h0dbaff4_0"
...
```bash
$ shpc install quay.io/biocontainers/pxblat:1.1.10--py310h0dbaff4_0
```
...
```bash
$ module load quay.io/biocontainers/pxblat/1.1.10--py310h0dbaff4_0
$ module help quay.io/biocontainers/pxblat/1.1.10--py310h0dbaff4_0
```
