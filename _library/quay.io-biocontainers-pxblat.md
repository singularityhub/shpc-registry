...
updated_at: "2024-04-12 02:28:01.910579"
latest: "1.1.20--py310h0dbaff4_0"
...
```bash
$ shpc install quay.io/biocontainers/pxblat:1.1.20--py310h0dbaff4_0
```
...
```bash
$ module load quay.io/biocontainers/pxblat/1.1.20--py310h0dbaff4_0
$ module help quay.io/biocontainers/pxblat/1.1.20--py310h0dbaff4_0
```
