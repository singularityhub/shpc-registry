...
updated_at: "2025-04-14 03:37:26.944949"
latest: "1.3.0--r44hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-tumourmethdata:1.3.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-tumourmethdata/1.3.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-tumourmethdata/1.3.0--r44hdfd78af_0
```
