...
updated_at: "2024-02-07 02:40:53.789825"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-tumourmethdata:1.0.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-tumourmethdata/1.0.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-tumourmethdata/1.0.0--r43hdfd78af_0
```
