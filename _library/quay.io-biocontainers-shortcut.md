---
layout: container
name:  "quay.io/biocontainers/shortcut"
maintainer: "@vsoch"
...
updated_at: "2025-10-13 03:13:31.305368"
...
singularity registry hpc automated addition for shortcut
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/shortcut
```
...
#### shortcut-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### shortcut-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/ShortCut
$ podman run --it --rm --entrypoint /usr/local/bin/ShortCut   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/ShortCut   -v ${PWD} -w ${PWD} <container> -c " $@"
```
