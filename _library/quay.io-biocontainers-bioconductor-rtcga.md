...
updated_at: "2024-11-04 03:41:38.661396"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rtcga:1.32.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rtcga/1.32.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rtcga/1.32.0--r43hdfd78af_0
```
