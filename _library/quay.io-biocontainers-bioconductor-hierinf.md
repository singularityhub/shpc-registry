...
updated_at: "2025-07-27 04:38:15.004392"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hierinf:1.24.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hierinf/1.24.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-hierinf/1.24.0--r44hdfd78af_0
```
