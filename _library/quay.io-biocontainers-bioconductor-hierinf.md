...
updated_at: "2024-03-18 23:30:20.727019"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hierinf:1.20.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hierinf/1.20.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-hierinf/1.20.0--r43hdfd78af_0
```
