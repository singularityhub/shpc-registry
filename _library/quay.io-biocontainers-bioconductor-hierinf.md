...
updated_at: "2022-11-02 18:57:48.618022"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hierinf:1.8.0--r40hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hierinf/1.8.0--r40hdfd78af_1
$ module help quay.io/biocontainers/bioconductor-hierinf/1.8.0--r40hdfd78af_1
```
