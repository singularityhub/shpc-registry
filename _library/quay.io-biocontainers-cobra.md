...
updated_at: "2022-10-29 17:55:44.697661"
latest: "0.4.0b6--py35_0"
...
```bash
$ shpc install quay.io/biocontainers/cobra:0.4.0b6--py35_0
```
...
```bash
$ module load quay.io/biocontainers/cobra/0.4.0b6--py35_0
$ module help quay.io/biocontainers/cobra/0.4.0b6--py35_0
```
