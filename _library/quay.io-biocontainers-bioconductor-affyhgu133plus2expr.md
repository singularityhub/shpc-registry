...
updated_at: "2024-12-06 03:06:25.229927"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-affyhgu133plus2expr:1.36.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-affyhgu133plus2expr/1.36.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-affyhgu133plus2expr/1.36.0--r43hdfd78af_0
```
