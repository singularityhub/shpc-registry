...
updated_at: "2023-08-21 02:25:11.926932"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hgu95aprobe:2.18.0--r43hdfd78af_11
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hgu95aprobe/2.18.0--r43hdfd78af_11
$ module help quay.io/biocontainers/bioconductor-hgu95aprobe/2.18.0--r43hdfd78af_11
```
