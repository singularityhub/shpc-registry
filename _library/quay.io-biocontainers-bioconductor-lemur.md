---
layout: container
name:  "quay.io/biocontainers/bioconductor-lemur"
maintainer: "@vsoch"
...
updated_at: "2024-09-03 03:19:29.476876"
latest: "1.0.4--r43hf17093f_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-lemur
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-lemur:1.0.4--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-lemur/1.0.4--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-lemur/1.0.4--r43hf17093f_0
```
...
#### bioconductor-lemur-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-lemur-inspect-deffile:
