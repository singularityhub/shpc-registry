---
layout: container
name:  "quay.io/biocontainers/logan_blaster"
maintainer: "@vsoch"
...
updated_at: "2026-06-11 07:27:58.389152"
...
singularity registry hpc automated addition for logan_blaster
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/logan_blaster
```
...
#### logan_blaster-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### logan_blaster-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/logan_blaster
$ podman run --it --rm --entrypoint /usr/local/bin/logan_blaster   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/logan_blaster   -v ${PWD} -w ${PWD} <container> -c " $@"
```
