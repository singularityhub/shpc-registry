...
updated_at: "2023-07-31 03:18:37.065226"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-r4rna:1.28.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-r4rna/1.28.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-r4rna/1.28.0--r43hdfd78af_0
```
