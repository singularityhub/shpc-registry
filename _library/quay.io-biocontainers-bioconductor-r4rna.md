...
updated_at: "2026-03-27 05:33:04.966736"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-r4rna:1.38.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-r4rna/1.38.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-r4rna/1.38.0--r45hdfd78af_0
```
