...
updated_at: "2026-05-01 06:00:43.960584"
...
```bash
$ shpc install quay.io/biocontainers/pybedgraph:0.5.43--py312hfffc319_7
```
...
```bash
$ module load quay.io/biocontainers/pybedgraph/0.5.43--py312hfffc319_7
$ module help quay.io/biocontainers/pybedgraph/0.5.43--py312hfffc319_7
```
