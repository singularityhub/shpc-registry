---
layout: container
name:  "quay.io/biocontainers/irida-staramr-results"
maintainer: "@vsoch"
...
updated_at: "2024-06-11 03:18:04.993079"
...
```bash
$ shpc install quay.io/biocontainers/irida-staramr-results
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/irida-staramr-results:0.3.1--pyh5e36f6f_0
```
...
```bash
$ module load quay.io/biocontainers/irida-staramr-results/0.3.1--pyh5e36f6f_0
$ module help quay.io/biocontainers/irida-staramr-results/0.3.1--pyh5e36f6f_0
```
...
#### irida-staramr-results-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### irida-staramr-results-inspect-deffile:
