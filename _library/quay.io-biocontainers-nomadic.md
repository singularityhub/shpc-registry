...
updated_at: "2025-08-28 12:37:43.068535"
...
```bash
$ shpc install quay.io/biocontainers/nomadic:0.5.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/nomadic/0.5.0--pyhdfd78af_0
$ module help quay.io/biocontainers/nomadic/0.5.0--pyhdfd78af_0
```
