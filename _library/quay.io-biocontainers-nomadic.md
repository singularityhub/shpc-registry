...
updated_at: "2025-08-11 03:55:28.769058"
...
```bash
$ shpc install quay.io/biocontainers/nomadic:0.4.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/nomadic/0.4.0--pyhdfd78af_0
$ module help quay.io/biocontainers/nomadic/0.4.0--pyhdfd78af_0
```
