...
updated_at: "2026-05-28 06:50:47.894649"
...
```bash
$ shpc install quay.io/biocontainers/nomadic:0.8.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/nomadic/0.8.0--pyhdfd78af_0
$ module help quay.io/biocontainers/nomadic/0.8.0--pyhdfd78af_0
```
