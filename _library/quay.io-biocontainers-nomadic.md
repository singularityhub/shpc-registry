...
updated_at: "2026-02-05 04:30:03.105281"
...
```bash
$ shpc install quay.io/biocontainers/nomadic:0.7.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/nomadic/0.7.2--pyhdfd78af_0
$ module help quay.io/biocontainers/nomadic/0.7.2--pyhdfd78af_0
```
