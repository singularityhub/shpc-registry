...
updated_at: "2026-08-31 08:53:26.638090"
...
```bash
$ shpc install quay.io/biocontainers/nomadic:0.8.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/nomadic/0.8.1--pyhdfd78af_0
$ module help quay.io/biocontainers/nomadic/0.8.1--pyhdfd78af_0
```
