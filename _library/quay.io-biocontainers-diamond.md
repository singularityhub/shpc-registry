...
updated_at: "2026-03-29 05:07:18.982329"
latest: "2.1.24--hf93d47f_0"
...
```bash
$ shpc install quay.io/biocontainers/diamond:2.1.24--hf93d47f_0
```
...
```bash
$ module load quay.io/biocontainers/diamond/2.1.24--hf93d47f_0
$ module help quay.io/biocontainers/diamond/2.1.24--hf93d47f_0
```
