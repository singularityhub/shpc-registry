...
updated_at: "2025-01-13 03:25:28.534026"
...
```bash
$ shpc install quay.io/biocontainers/diamond:2.1.10--h5ca1c30_3
```
...
```bash
$ module load quay.io/biocontainers/diamond/2.1.10--h5ca1c30_3
$ module help quay.io/biocontainers/diamond/2.1.10--h5ca1c30_3
```
