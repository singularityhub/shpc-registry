...
updated_at: "2026-03-20 04:35:45.229791"
latest: "2.1.23--hf93d47f_0"
...
```bash
$ shpc install quay.io/biocontainers/diamond:2.1.23--hf93d47f_0
```
...
```bash
$ module load quay.io/biocontainers/diamond/2.1.23--hf93d47f_0
$ module help quay.io/biocontainers/diamond/2.1.23--hf93d47f_0
```
