...
updated_at: "2026-01-05 04:44:29.014560"
latest: "2.1.17--h13889ed_0"
...
```bash
$ shpc install quay.io/biocontainers/diamond:2.1.17--h13889ed_0
```
...
```bash
$ module load quay.io/biocontainers/diamond/2.1.17--h13889ed_0
$ module help quay.io/biocontainers/diamond/2.1.17--h13889ed_0
```
