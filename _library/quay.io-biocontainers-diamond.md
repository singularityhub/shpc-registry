...
updated_at: "2025-12-23 04:19:51.301742"
latest: "2.1.16--h13889ed_0"
...
```bash
$ shpc install quay.io/biocontainers/diamond:2.1.16--h13889ed_0
```
...
```bash
$ module load quay.io/biocontainers/diamond/2.1.16--h13889ed_0
$ module help quay.io/biocontainers/diamond/2.1.16--h13889ed_0
```
