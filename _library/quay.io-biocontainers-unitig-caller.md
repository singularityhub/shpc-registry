...
updated_at: "2025-10-23 03:56:04.359153"
...
```bash
$ shpc install quay.io/biocontainers/unitig-caller:1.3.1--py311heec5c76_1
```
...
```bash
$ module load quay.io/biocontainers/unitig-caller/1.3.1--py311heec5c76_1
$ module help quay.io/biocontainers/unitig-caller/1.3.1--py311heec5c76_1
```
