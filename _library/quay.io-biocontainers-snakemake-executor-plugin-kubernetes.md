...
updated_at: "2025-08-07 10:03:45.703207"
...
```bash
$ shpc install quay.io/biocontainers/snakemake-executor-plugin-kubernetes:0.4.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake-executor-plugin-kubernetes/0.4.2--pyhdfd78af_0
$ module help quay.io/biocontainers/snakemake-executor-plugin-kubernetes/0.4.2--pyhdfd78af_0
```
