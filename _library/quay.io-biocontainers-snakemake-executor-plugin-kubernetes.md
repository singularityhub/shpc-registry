...
updated_at: "2024-08-27 03:13:59.963780"
...
```bash
$ shpc install quay.io/biocontainers/snakemake-executor-plugin-kubernetes:0.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake-executor-plugin-kubernetes/0.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/snakemake-executor-plugin-kubernetes/0.2.0--pyhdfd78af_0
```
