...
updated_at: "2025-04-30 03:48:22.205870"
...
```bash
$ shpc install quay.io/biocontainers/snakemake-executor-plugin-kubernetes:0.4.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake-executor-plugin-kubernetes/0.4.0--pyhdfd78af_0
$ module help quay.io/biocontainers/snakemake-executor-plugin-kubernetes/0.4.0--pyhdfd78af_0
```
