...
updated_at: "2025-02-12 03:32:22.390265"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-regutools:1.18.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-regutools/1.18.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-regutools/1.18.0--r44hdfd78af_0
```
