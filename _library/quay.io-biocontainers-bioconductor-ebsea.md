...
updated_at: "2026-03-25 05:13:45.057714"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ebsea:1.38.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ebsea/1.38.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ebsea/1.38.0--r45hdfd78af_0
```
