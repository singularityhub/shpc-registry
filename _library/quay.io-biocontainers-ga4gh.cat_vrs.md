---
layout: container
name:  "quay.io/biocontainers/ga4gh.cat_vrs"
maintainer: "@vsoch"
...
updated_at: "2026-06-24 06:41:27.785518"
...
```bash
$ module load quay.io/biocontainers/ga4gh.cat_vrs/0.7.2--pyhdfd78af_0
$ module help quay.io/biocontainers/ga4gh.cat_vrs/0.7.2--pyhdfd78af_0
```
...
#### ga4gh.cat_vrs-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### ga4gh.cat_vrs-inspect-deffile:
