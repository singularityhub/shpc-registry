...
updated_at: "2024-01-20 02:48:38.507692"
...
```bash
$ shpc install quay.io/biocontainers/pbfusion:0.4.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pbfusion/0.4.0--hdfd78af_0
$ module help quay.io/biocontainers/pbfusion/0.4.0--hdfd78af_0
```
