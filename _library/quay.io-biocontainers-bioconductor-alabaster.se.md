---
layout: container
name:  "quay.io/biocontainers/bioconductor-alabaster.se"
maintainer: "@vsoch"
...
updated_at: "2024-09-04 02:48:09.225599"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-alabaster.se
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-alabaster.se:1.2.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-alabaster.se/1.2.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-alabaster.se/1.2.0--r43hdfd78af_0
```
...
#### bioconductor-alabaster.se-shell:
...
#### bioconductor-alabaster.se-exec:
...
#### bioconductor-alabaster.se-inspect:
...
#### bioconductor-alabaster.se-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-alabaster.se-inspect-deffile:
