...
updated_at: "2023-09-18 02:27:34.311454"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-alabaster.se:1.0.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-alabaster.se/1.0.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-alabaster.se/1.0.0--r43hdfd78af_0
```
