...
updated_at: "2022-11-27 12:29:03.583819"
latest: "8.0.92--1"
...
```bash
$ shpc install quay.io/biocontainers/java-jdk:8.0.92--1
```
...
```bash
$ module load quay.io/biocontainers/java-jdk/8.0.92--1
$ module help quay.io/biocontainers/java-jdk/8.0.92--1
```
