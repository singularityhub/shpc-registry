...
updated_at: "2026-03-02 04:25:51.598413"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-lola:1.40.1--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-lola/1.40.1--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-lola/1.40.1--r45hdfd78af_0
```
