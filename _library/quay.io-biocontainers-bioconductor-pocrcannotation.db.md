...
updated_at: "2026-03-28 05:12:42.402100"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-pocrcannotation.db:3.2.3--r45hdfd78af_14
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-pocrcannotation.db/3.2.3--r45hdfd78af_14
$ module help quay.io/biocontainers/bioconductor-pocrcannotation.db/3.2.3--r45hdfd78af_14
```
