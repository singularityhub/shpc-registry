...
updated_at: "2023-05-22 03:15:51.410229"
latest: "0.7.5--h96c1cfd_0"
...
```bash
$ shpc install quay.io/biocontainers/tracy:0.7.5--h96c1cfd_0
```
...
```bash
$ module load quay.io/biocontainers/tracy/0.7.5--h96c1cfd_0
$ module help quay.io/biocontainers/tracy/0.7.5--h96c1cfd_0
```
