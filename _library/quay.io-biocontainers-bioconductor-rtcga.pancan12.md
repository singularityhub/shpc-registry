...
updated_at: "2025-04-12 03:45:24.596303"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rtcga.pancan12:1.34.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rtcga.pancan12/1.34.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rtcga.pancan12/1.34.0--r44hdfd78af_0
```
