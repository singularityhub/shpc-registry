...
updated_at: "2022-11-02 00:30:50.426659"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-italicsdata:2.32.0--r41hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-italicsdata/2.32.0--r41hdfd78af_1
$ module help quay.io/biocontainers/bioconductor-italicsdata/2.32.0--r41hdfd78af_1
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-italicsdata-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-italicsdata-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-italicsdata-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-italicsdata-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-italicsdata-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-italicsdata-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
