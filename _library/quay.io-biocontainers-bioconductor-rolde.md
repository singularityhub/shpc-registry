...
updated_at: "2026-03-16 05:12:12.060202"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rolde:1.14.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rolde/1.14.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rolde/1.14.0--r45hdfd78af_0
```
