...
updated_at: "2025-01-23 03:30:13.453140"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rolde:1.10.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rolde/1.10.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rolde/1.10.0--r44hdfd78af_0
```
