...
updated_at: "2025-12-21 03:58:00.748755"
latest: "0.8.0--py312hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/shiba:0.8.0--py312hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/shiba/0.8.0--py312hdfd78af_0
$ module help quay.io/biocontainers/shiba/0.8.0--py312hdfd78af_0
```
