...
updated_at: "2025-12-31 03:53:28.777772"
latest: "0.8.1--py312hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/shiba:0.8.1--py312hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/shiba/0.8.1--py312hdfd78af_0
$ module help quay.io/biocontainers/shiba/0.8.1--py312hdfd78af_0
```
