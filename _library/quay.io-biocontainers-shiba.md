...
updated_at: "2026-03-20 04:55:17.108577"
...
```bash
$ shpc install quay.io/biocontainers/shiba:0.8.2--py312hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/shiba/0.8.2--py312hdfd78af_0
$ module help quay.io/biocontainers/shiba/0.8.2--py312hdfd78af_0
```
