...
updated_at: "2025-05-24 03:14:06.537215"
latest: "0.6.1--py313hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/shiba:0.6.1--py313hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/shiba/0.6.1--py313hdfd78af_0
$ module help quay.io/biocontainers/shiba/0.6.1--py313hdfd78af_0
```
