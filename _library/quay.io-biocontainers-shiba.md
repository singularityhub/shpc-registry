...
updated_at: "2025-07-28 04:07:17.376698"
latest: "0.6.2--py313hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/shiba:0.6.2--py313hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/shiba/0.6.2--py313hdfd78af_0
$ module help quay.io/biocontainers/shiba/0.6.2--py313hdfd78af_0
```
