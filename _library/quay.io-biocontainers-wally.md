...
updated_at: "2024-04-17 02:40:08.236981"
latest: "0.5.8--h6b1aa3f_2"
...
```bash
$ shpc install quay.io/biocontainers/wally:0.5.8--h6b1aa3f_2
```
...
```bash
$ module load quay.io/biocontainers/wally/0.5.8--h6b1aa3f_2
$ module help quay.io/biocontainers/wally/0.5.8--h6b1aa3f_2
```
