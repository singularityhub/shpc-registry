...
updated_at: "2026-03-05 00:50:09.671787"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-drivernet:1.50.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-drivernet/1.50.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-drivernet/1.50.0--r45hdfd78af_0
```
