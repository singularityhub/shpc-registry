...
updated_at: "2023-12-09 03:04:11.758694"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-bumpymatrix:1.8.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-bumpymatrix/1.8.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-bumpymatrix/1.8.0--r43hdfd78af_0
```
