...
updated_at: "2022-11-10 00:10:04.330891"
...
```bash
$ shpc install quay.io/biocontainers/pomoxis:0.3.10--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pomoxis/0.3.10--pyhdfd78af_0
$ module help quay.io/biocontainers/pomoxis/0.3.10--pyhdfd78af_0
```
