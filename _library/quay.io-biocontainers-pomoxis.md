...
updated_at: "2022-10-27 00:55:37.584117"
...
```bash
$ shpc install quay.io/biocontainers/pomoxis:0.3.9--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pomoxis/0.3.9--pyhdfd78af_0
$ module help quay.io/biocontainers/pomoxis/0.3.9--pyhdfd78af_0
```
