...
updated_at: "2026-07-01 15:09:12.297569"
...
```bash
$ shpc install quay.io/biocontainers/pomoxis:0.4.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pomoxis/0.4.1--pyhdfd78af_0
$ module help quay.io/biocontainers/pomoxis/0.4.1--pyhdfd78af_0
```
