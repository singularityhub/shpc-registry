...
updated_at: "2026-08-16 03:51:54.764661"
...
```bash
$ shpc install quay.io/biocontainers/pomoxis:0.4.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pomoxis/0.4.2--pyhdfd78af_0
$ module help quay.io/biocontainers/pomoxis/0.4.2--pyhdfd78af_0
```
