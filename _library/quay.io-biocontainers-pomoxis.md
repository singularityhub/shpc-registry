...
updated_at: "2023-12-23 02:50:38.421704"
...
```bash
$ shpc install quay.io/biocontainers/pomoxis:0.3.13--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pomoxis/0.3.13--pyhdfd78af_0
$ module help quay.io/biocontainers/pomoxis/0.3.13--pyhdfd78af_0
```
