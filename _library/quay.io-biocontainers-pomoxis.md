...
updated_at: "2026-04-29 05:47:09.753154"
...
```bash
$ shpc install quay.io/biocontainers/pomoxis:0.4.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pomoxis/0.4.0--pyhdfd78af_0
$ module help quay.io/biocontainers/pomoxis/0.4.0--pyhdfd78af_0
```
