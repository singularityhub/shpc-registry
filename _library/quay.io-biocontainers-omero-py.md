...
updated_at: "2022-10-27 00:56:22.243605"
latest: "5.9.1--py_0"
...
```bash
$ shpc install quay.io/biocontainers/omero-py:5.9.1--py_0
```
...
```bash
$ module load quay.io/biocontainers/omero-py/5.9.1--py_0
$ module help quay.io/biocontainers/omero-py/5.9.1--py_0
```
