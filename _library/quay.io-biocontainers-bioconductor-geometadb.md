...
updated_at: "2026-03-03 05:03:04.815062"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-geometadb:1.72.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-geometadb/1.72.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-geometadb/1.72.0--r45hdfd78af_0
```
