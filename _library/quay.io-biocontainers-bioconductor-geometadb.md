...
updated_at: "2022-11-06 00:33:59.950759"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-geometadb:1.56.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-geometadb/1.56.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-geometadb/1.56.0--r41hdfd78af_0
```
