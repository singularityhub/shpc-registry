...
updated_at: "2023-09-18 02:39:13.888919"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-netprior:1.26.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-netprior/1.26.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-netprior/1.26.0--r43hdfd78af_0
```
