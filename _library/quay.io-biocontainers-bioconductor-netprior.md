...
updated_at: "2022-11-12 00:18:56.889340"
latest: "1.8.1--r351_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-netprior:1.8.1--r351_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-netprior/1.8.1--r351_0
$ module help quay.io/biocontainers/bioconductor-netprior/1.8.1--r351_0
```
