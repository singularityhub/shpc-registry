...
updated_at: "2025-12-19 04:00:25.475889"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-netprior:1.32.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-netprior/1.32.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-netprior/1.32.0--r44hdfd78af_0
```
