...
updated_at: "2026-02-23 05:02:38.694840"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-netprior:1.36.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-netprior/1.36.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-netprior/1.36.0--r45hdfd78af_0
```
