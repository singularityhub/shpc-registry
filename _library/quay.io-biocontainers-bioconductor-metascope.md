---
layout: container
name:  "quay.io/biocontainers/bioconductor-metascope"
maintainer: "@vsoch"
...
updated_at: "2026-03-27 04:42:23.632660"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-metascope
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-metascope:1.10.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-metascope/1.10.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-metascope/1.10.0--r45hdfd78af_0
```
...
#### bioconductor-metascope-inspect:
...
#### bioconductor-metascope-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-metascope-inspect-deffile:
