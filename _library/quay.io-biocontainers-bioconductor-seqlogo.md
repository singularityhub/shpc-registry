...
updated_at: "2023-09-28 03:35:42.370474"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-seqlogo:1.66.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-seqlogo/1.66.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-seqlogo/1.66.0--r43hdfd78af_0
```
