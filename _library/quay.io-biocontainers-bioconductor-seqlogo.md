...
updated_at: "2026-03-25 05:16:01.993108"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-seqlogo:1.76.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-seqlogo/1.76.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-seqlogo/1.76.0--r45hdfd78af_0
```
