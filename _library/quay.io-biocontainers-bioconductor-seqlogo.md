...
updated_at: "2024-05-02 03:06:24.946559"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-seqlogo:1.68.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-seqlogo/1.68.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-seqlogo/1.68.0--r43hdfd78af_0
```
