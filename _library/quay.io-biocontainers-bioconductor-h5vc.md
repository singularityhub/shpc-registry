...
updated_at: "2023-08-03 03:19:07.143964"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-h5vc:2.32.0--r42hf17093f_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-h5vc/2.32.0--r42hf17093f_1
$ module help quay.io/biocontainers/bioconductor-h5vc/2.32.0--r42hf17093f_1
```
