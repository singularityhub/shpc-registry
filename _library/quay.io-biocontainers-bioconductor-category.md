...
updated_at: "2023-09-14 03:10:13.430132"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-category:2.66.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-category/2.66.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-category/2.66.0--r43hdfd78af_0
```
