...
updated_at: "2023-11-14 02:45:07.863254"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rat2302probe:2.18.0--r43hdfd78af_11
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rat2302probe/2.18.0--r43hdfd78af_11
$ module help quay.io/biocontainers/bioconductor-rat2302probe/2.18.0--r43hdfd78af_11
```
