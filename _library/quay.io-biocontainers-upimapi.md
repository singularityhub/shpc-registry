...
updated_at: "2023-06-26 04:04:38.561650"
latest: "1.10.0--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/upimapi:1.10.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/upimapi/1.10.0--hdfd78af_0
$ module help quay.io/biocontainers/upimapi/1.10.0--hdfd78af_0
```
