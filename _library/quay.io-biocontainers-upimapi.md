...
updated_at: "2025-11-28 03:21:36.853273"
latest: "1.13.3--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/upimapi:1.13.3--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/upimapi/1.13.3--hdfd78af_0
$ module help quay.io/biocontainers/upimapi/1.13.3--hdfd78af_0
```
