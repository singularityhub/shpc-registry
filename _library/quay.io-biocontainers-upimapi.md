...
updated_at: "2023-07-24 05:22:24.740684"
latest: "1.11.2--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/upimapi:1.11.2--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/upimapi/1.11.2--hdfd78af_0
$ module help quay.io/biocontainers/upimapi/1.11.2--hdfd78af_0
```
