...
updated_at: "2023-05-14 03:18:27.392528"
latest: "1.9.0--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/upimapi:1.9.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/upimapi/1.9.0--hdfd78af_0
$ module help quay.io/biocontainers/upimapi/1.9.0--hdfd78af_0
```
