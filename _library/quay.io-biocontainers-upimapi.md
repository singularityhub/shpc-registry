...
updated_at: "2023-01-30 03:14:46.622353"
latest: "1.8.10--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/upimapi:1.8.10--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/upimapi/1.8.10--hdfd78af_0
$ module help quay.io/biocontainers/upimapi/1.8.10--hdfd78af_0
```
