...
updated_at: "2024-01-27 02:53:18.014199"
latest: "1.12.2--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/upimapi:1.12.2--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/upimapi/1.12.2--hdfd78af_0
$ module help quay.io/biocontainers/upimapi/1.12.2--hdfd78af_0
```
