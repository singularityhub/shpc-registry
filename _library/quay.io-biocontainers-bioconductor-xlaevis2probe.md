...
updated_at: "2024-03-25 03:07:18.688515"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-xlaevis2probe:2.18.0--r43hdfd78af_12
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-xlaevis2probe/2.18.0--r43hdfd78af_12
$ module help quay.io/biocontainers/bioconductor-xlaevis2probe/2.18.0--r43hdfd78af_12
```
