...
updated_at: "2026-09-23 07:40:02.923059"
latest: "1.25--hc52dbad_1"
...
```bash
$ shpc install quay.io/biocontainers/aster:1.25--hc52dbad_1
```
...
```bash
$ module load quay.io/biocontainers/aster/1.25--hc52dbad_1
$ module help quay.io/biocontainers/aster/1.25--hc52dbad_1
```
