...
updated_at: "2026-06-06 06:35:01.985139"
latest: "1.25--hc52dbad_0"
...
```bash
$ shpc install quay.io/biocontainers/aster:1.25--hc52dbad_0
```
...
```bash
$ module load quay.io/biocontainers/aster/1.25--hc52dbad_0
$ module help quay.io/biocontainers/aster/1.25--hc52dbad_0
```
