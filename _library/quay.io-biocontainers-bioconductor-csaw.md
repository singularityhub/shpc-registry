...
updated_at: "2024-03-31 02:54:35.598161"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-csaw:1.36.0--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-csaw/1.36.0--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-csaw/1.36.0--r43hf17093f_0
```
