---
layout: container
name:  "quay.io/biocontainers/enzywizard-pocket"
maintainer: "@vsoch"
...
updated_at: "2026-09-17 08:00:00.590079"
...
```bash
$ module load quay.io/biocontainers/enzywizard-pocket/1.0.3--pyhdfd78af_0
$ module help quay.io/biocontainers/enzywizard-pocket/1.0.3--pyhdfd78af_0
```
...
#### enzywizard-pocket-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### enzywizard-pocket-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/enzywizard-pocket
$ podman run --it --rm --entrypoint /usr/local/bin/enzywizard-pocket   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/enzywizard-pocket   -v ${PWD} -w ${PWD} <container> -c " $@"
```
