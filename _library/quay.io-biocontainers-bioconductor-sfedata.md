...
updated_at: "2023-12-08 03:12:00.735604"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-sfedata:1.2.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-sfedata/1.2.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-sfedata/1.2.0--r43hdfd78af_0
```
