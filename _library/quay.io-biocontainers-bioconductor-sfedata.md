...
updated_at: "2026-01-02 04:19:57.754302"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-sfedata:1.4.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-sfedata/1.4.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-sfedata/1.4.0--r43hdfd78af_0
```
