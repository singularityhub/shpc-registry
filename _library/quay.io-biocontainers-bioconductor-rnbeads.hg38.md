...
updated_at: "2023-08-21 02:24:50.555402"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rnbeads.hg38:1.32.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rnbeads.hg38/1.32.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rnbeads.hg38/1.32.0--r43hdfd78af_0
```
