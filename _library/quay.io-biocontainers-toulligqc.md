...
updated_at: "2026-03-04 04:33:04.179703"
...
```bash
$ shpc install quay.io/biocontainers/toulligqc:2.8--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/toulligqc/2.8--pyhdfd78af_0
$ module help quay.io/biocontainers/toulligqc/2.8--pyhdfd78af_0
```
