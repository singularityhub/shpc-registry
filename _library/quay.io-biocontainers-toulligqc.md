...
updated_at: "2023-04-28 03:08:49.650469"
...
```bash
$ shpc install quay.io/biocontainers/toulligqc:2.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/toulligqc/2.3--pyhdfd78af_0
$ module help quay.io/biocontainers/toulligqc/2.3--pyhdfd78af_0
```
