...
updated_at: "2025-12-31 04:21:09.847325"
...
```bash
$ shpc install quay.io/biocontainers/toulligqc:2.7.1--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/toulligqc/2.7.1--pyhdfd78af_1
$ module help quay.io/biocontainers/toulligqc/2.7.1--pyhdfd78af_1
```
