...
updated_at: "2024-11-04 08:33:49.119902"
...
```bash
$ shpc install quay.io/biocontainers/toulligqc:2.5.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/toulligqc/2.5.2--pyhdfd78af_0
$ module help quay.io/biocontainers/toulligqc/2.5.2--pyhdfd78af_0
```
