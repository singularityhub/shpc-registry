...
updated_at: "2026-03-31 05:24:19.671765"
latest: "2.8.4--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/toulligqc:2.8.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/toulligqc/2.8.4--pyhdfd78af_0
$ module help quay.io/biocontainers/toulligqc/2.8.4--pyhdfd78af_0
```
