...
updated_at: "2026-06-25 06:23:51.238729"
latest: "2.8.4--pyhdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/toulligqc:2.8.4--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/toulligqc/2.8.4--pyhdfd78af_1
$ module help quay.io/biocontainers/toulligqc/2.8.4--pyhdfd78af_1
```
