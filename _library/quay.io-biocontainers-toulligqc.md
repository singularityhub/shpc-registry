...
updated_at: "2026-08-22 03:17:38.217230"
...
```bash
$ shpc install quay.io/biocontainers/toulligqc:2.9.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/toulligqc/2.9.1--pyhdfd78af_0
$ module help quay.io/biocontainers/toulligqc/2.9.1--pyhdfd78af_0
```
