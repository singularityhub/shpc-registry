...
updated_at: "2024-02-22 02:59:10.378037"
latest: "2.5--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/toulligqc:2.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/toulligqc/2.5--pyhdfd78af_0
$ module help quay.io/biocontainers/toulligqc/2.5--pyhdfd78af_0
```
