...
updated_at: "2022-10-29 05:32:27.961431"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-randrotation:1.6.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-randrotation/1.6.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-randrotation/1.6.0--r41hdfd78af_0
```
