...
updated_at: "2026-04-02 04:33:45.272250"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-randrotation:1.22.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-randrotation/1.22.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-randrotation/1.22.0--r45hdfd78af_0
```
