...
updated_at: "2025-03-30 03:34:02.640000"
...
```bash
$ shpc install quay.io/biocontainers/ntm-profiler:0.6.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ntm-profiler/0.6.0--pyhdfd78af_0
$ module help quay.io/biocontainers/ntm-profiler/0.6.0--pyhdfd78af_0
```
