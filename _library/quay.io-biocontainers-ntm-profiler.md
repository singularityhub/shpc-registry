...
updated_at: "2026-01-07 03:58:00.284462"
...
```bash
$ shpc install quay.io/biocontainers/ntm-profiler:0.8.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ntm-profiler/0.8.0--pyhdfd78af_0
$ module help quay.io/biocontainers/ntm-profiler/0.8.0--pyhdfd78af_0
```
