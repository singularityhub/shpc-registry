...
updated_at: "2025-05-15 04:25:58.787754"
...
```bash
$ shpc install quay.io/biocontainers/ntm-profiler:0.6.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ntm-profiler/0.6.1--pyhdfd78af_0
$ module help quay.io/biocontainers/ntm-profiler/0.6.1--pyhdfd78af_0
```
