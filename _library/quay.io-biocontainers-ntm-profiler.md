...
updated_at: "2026-05-05 05:41:23.302876"
...
```bash
$ shpc install quay.io/biocontainers/ntm-profiler:0.8.1--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/ntm-profiler/0.8.1--pyhdfd78af_1
$ module help quay.io/biocontainers/ntm-profiler/0.8.1--pyhdfd78af_1
```
