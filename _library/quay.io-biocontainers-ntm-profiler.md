...
updated_at: "2026-03-04 04:25:43.337798"
...
```bash
$ shpc install quay.io/biocontainers/ntm-profiler:0.8.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ntm-profiler/0.8.1--pyhdfd78af_0
$ module help quay.io/biocontainers/ntm-profiler/0.8.1--pyhdfd78af_0
```
