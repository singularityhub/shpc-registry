...
updated_at: "2026-07-01 07:03:44.197668"
...
```bash
$ shpc install quay.io/biocontainers/ntm-profiler:0.8.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ntm-profiler/0.8.2--pyhdfd78af_0
$ module help quay.io/biocontainers/ntm-profiler/0.8.2--pyhdfd78af_0
```
