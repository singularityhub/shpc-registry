---
layout: container
name:  "quay.io/biocontainers/r-cellosaurus"
maintainer: "@vsoch"
...
updated_at: "2023-08-10 02:36:47.019347"
latest: "0.5.4--r43hdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/r-cellosaurus
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/r-cellosaurus:0.5.4--r43hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/r-cellosaurus/0.5.4--r43hdfd78af_1
$ module help quay.io/biocontainers/r-cellosaurus/0.5.4--r43hdfd78af_1
```
...
#### r-cellosaurus-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-cellosaurus-inspect-deffile:
