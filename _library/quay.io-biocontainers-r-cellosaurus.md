...
updated_at: "2023-04-12 03:00:34.648447"
latest: "0.5.2--r42hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/r-cellosaurus:0.5.2--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/r-cellosaurus/0.5.2--r42hdfd78af_0
$ module help quay.io/biocontainers/r-cellosaurus/0.5.2--r42hdfd78af_0
```
