...
updated_at: "2023-09-16 03:07:24.012708"
latest: "0.6.0--r43hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/r-cellosaurus:0.6.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/r-cellosaurus/0.6.0--r43hdfd78af_0
$ module help quay.io/biocontainers/r-cellosaurus/0.6.0--r43hdfd78af_0
```
