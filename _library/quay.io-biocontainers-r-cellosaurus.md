...
updated_at: "2023-07-13 03:28:54.888745"
latest: "0.5.3--r42hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/r-cellosaurus:0.5.3--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/r-cellosaurus/0.5.3--r42hdfd78af_0
$ module help quay.io/biocontainers/r-cellosaurus/0.5.3--r42hdfd78af_0
```
