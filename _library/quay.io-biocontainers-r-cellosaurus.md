...
updated_at: "2026-09-05 07:11:38.976270"
latest: "0.8.5--r45hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/r-cellosaurus:0.8.5--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/r-cellosaurus/0.8.5--r45hdfd78af_0
$ module help quay.io/biocontainers/r-cellosaurus/0.8.5--r45hdfd78af_0
```
