...
updated_at: "2026-09-24 07:36:01.028660"
...
```bash
$ shpc install quay.io/biocontainers/minimac4:4.1.6--h33c104e_2
```
...
```bash
$ module load quay.io/biocontainers/minimac4/4.1.6--h33c104e_2
$ module help quay.io/biocontainers/minimac4/4.1.6--h33c104e_2
```
