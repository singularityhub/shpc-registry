...
updated_at: "2024-08-20 03:23:50.525421"
latest: "0.7.0--py311h9f068be_1"
...
```bash
$ shpc install quay.io/biocontainers/pytrimal:0.7.0--py311h9f068be_1
```
...
```bash
$ module load quay.io/biocontainers/pytrimal/0.7.0--py311h9f068be_1
$ module help quay.io/biocontainers/pytrimal/0.7.0--py311h9f068be_1
```
