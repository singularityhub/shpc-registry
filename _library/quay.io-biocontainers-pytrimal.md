...
updated_at: "2024-09-21 03:26:42.250006"
latest: "0.8.0--py311h9f068be_0"
...
```bash
$ shpc install quay.io/biocontainers/pytrimal:0.8.0--py311h9f068be_0
```
...
```bash
$ module load quay.io/biocontainers/pytrimal/0.8.0--py311h9f068be_0
$ module help quay.io/biocontainers/pytrimal/0.8.0--py311h9f068be_0
```
