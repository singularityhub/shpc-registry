...
updated_at: "2023-08-30 02:34:08.143132"
...
```bash
$ shpc install quay.io/biocontainers/pytrimal:0.7.0--py39he10ea66_0
```
...
```bash
$ module load quay.io/biocontainers/pytrimal/0.7.0--py39he10ea66_0
$ module help quay.io/biocontainers/pytrimal/0.7.0--py39he10ea66_0
```
