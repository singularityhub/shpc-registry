...
updated_at: "2026-05-22 06:56:59.539309"
...
```bash
$ shpc install quay.io/biocontainers/atol-qc-raw-ont:0.2.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/atol-qc-raw-ont/0.2.1--pyhdfd78af_0
$ module help quay.io/biocontainers/atol-qc-raw-ont/0.2.1--pyhdfd78af_0
```
