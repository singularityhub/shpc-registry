...
updated_at: "2024-01-15 03:03:57.470253"
...
```bash
$ shpc install quay.io/biocontainers/mosca:2.2.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mosca/2.2.0--hdfd78af_0
$ module help quay.io/biocontainers/mosca/2.2.0--hdfd78af_0
```
