...
updated_at: "2023-12-20 03:44:33.638002"
...
```bash
$ shpc install quay.io/biocontainers/mosca:2.1.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mosca/2.1.0--hdfd78af_0
$ module help quay.io/biocontainers/mosca/2.1.0--hdfd78af_0
```
