...
updated_at: "2025-12-19 03:42:00.193665"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-illuminamousev1.db:1.26.0--r44hdfd78af_13
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-illuminamousev1.db/1.26.0--r44hdfd78af_13
$ module help quay.io/biocontainers/bioconductor-illuminamousev1.db/1.26.0--r44hdfd78af_13
```
