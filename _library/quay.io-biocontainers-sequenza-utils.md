...
updated_at: "2024-10-21 03:46:32.918004"
latest: "3.0.0--py312h719dbc0_7"
...
```bash
$ shpc install quay.io/biocontainers/sequenza-utils:3.0.0--py312h719dbc0_7
```
...
```bash
$ module load quay.io/biocontainers/sequenza-utils/3.0.0--py312h719dbc0_7
$ module help quay.io/biocontainers/sequenza-utils/3.0.0--py312h719dbc0_7
```
