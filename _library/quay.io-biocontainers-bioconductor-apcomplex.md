...
updated_at: "2022-10-29 05:33:22.135724"
latest: "2.60.0--r41hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-apcomplex:2.60.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-apcomplex/2.60.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-apcomplex/2.60.0--r41hdfd78af_0
```
