---
layout: container
name:  "quay.io/biocontainers/hesslab-gambit"
maintainer: "@vsoch"
...
updated_at: "2026-01-26 04:32:10.742720"
latest: "0.5.1--py39hbcbf7aa_1"
...
```bash
$ shpc install quay.io/biocontainers/hesslab-gambit
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/hesslab-gambit:0.5.1--py39hbcbf7aa_1
```
...
```bash
$ module load quay.io/biocontainers/hesslab-gambit/0.5.1--py39hbcbf7aa_1
$ module help quay.io/biocontainers/hesslab-gambit/0.5.1--py39hbcbf7aa_1
```
...
#### hesslab-gambit-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### hesslab-gambit-inspect-deffile:
