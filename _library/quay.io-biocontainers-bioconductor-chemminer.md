...
updated_at: "2024-06-22 02:37:06.755529"
latest: "3.54.0--r43hf17093f_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-chemminer:3.54.0--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-chemminer/3.54.0--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-chemminer/3.54.0--r43hf17093f_0
```
