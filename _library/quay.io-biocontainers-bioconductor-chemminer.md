...
updated_at: "2023-11-10 02:26:32.297337"
latest: "3.52.0--r43hf17093f_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-chemminer:3.52.0--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-chemminer/3.52.0--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-chemminer/3.52.0--r43hf17093f_0
```
