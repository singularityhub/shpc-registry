...
updated_at: "2026-03-26 05:32:08.886006"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-tissueenrich:1.30.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-tissueenrich/1.30.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-tissueenrich/1.30.0--r45hdfd78af_0
```
