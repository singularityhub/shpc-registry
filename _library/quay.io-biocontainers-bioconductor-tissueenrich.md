---
layout: container
name:  "quay.io/biocontainers/bioconductor-tissueenrich"
maintainer: "@vsoch"
...
updated_at: "2023-11-30 02:57:06.339921"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-tissueenrich
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-tissueenrich:1.20.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-tissueenrich/1.20.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-tissueenrich/1.20.0--r43hdfd78af_0
```
...
#### bioconductor-tissueenrich-shell:
...
#### bioconductor-tissueenrich-exec:
...
#### bioconductor-tissueenrich-inspect:
...
#### bioconductor-tissueenrich-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-tissueenrich-inspect-deffile:
