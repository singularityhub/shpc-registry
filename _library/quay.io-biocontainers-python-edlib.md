...
updated_at: "2024-07-15 02:42:09.169069"
latest: "1.3.9--py311h2a4ad6c_7"
...
```bash
$ shpc install quay.io/biocontainers/python-edlib:1.3.9--py311h2a4ad6c_7
```
...
```bash
$ module load quay.io/biocontainers/python-edlib/1.3.9--py311h2a4ad6c_7
$ module help quay.io/biocontainers/python-edlib/1.3.9--py311h2a4ad6c_7
```
