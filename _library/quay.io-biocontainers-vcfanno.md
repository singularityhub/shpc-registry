...
updated_at: "2026-06-06 15:52:21.063771"
latest: "0.3.8--h1079eea_0"
...
```bash
$ shpc install quay.io/biocontainers/vcfanno:0.3.8--h1079eea_0
```
...
```bash
$ module load quay.io/biocontainers/vcfanno/0.3.8--h1079eea_0
$ module help quay.io/biocontainers/vcfanno/0.3.8--h1079eea_0
```
