...
updated_at: "2026-07-01 15:41:47.961460"
latest: "0.3.9--h1079eea_0"
...
```bash
$ shpc install quay.io/biocontainers/vcfanno:0.3.9--h1079eea_0
```
...
```bash
$ module load quay.io/biocontainers/vcfanno/0.3.9--h1079eea_0
$ module help quay.io/biocontainers/vcfanno/0.3.9--h1079eea_0
```
