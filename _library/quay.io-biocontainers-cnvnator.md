...
updated_at: "2022-10-27 00:59:34.348861"
...
```bash
$ shpc install quay.io/biocontainers/cnvnator:0.4.1--py310h0cf855d_6
```
...
```bash
$ module load quay.io/biocontainers/cnvnator/0.4.1--py310h0cf855d_6
$ module help quay.io/biocontainers/cnvnator/0.4.1--py310h0cf855d_6
```
