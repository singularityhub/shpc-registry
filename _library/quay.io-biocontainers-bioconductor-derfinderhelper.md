...
updated_at: "2026-04-03 15:55:30.429436"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-derfinderhelper:1.44.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-derfinderhelper/1.44.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-derfinderhelper/1.44.0--r45hdfd78af_0
```
