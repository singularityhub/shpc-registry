...
updated_at: "2025-11-26 03:31:18.588284"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-debrowser:1.34.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-debrowser/1.34.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-debrowser/1.34.0--r44hdfd78af_0
```
