...
updated_at: "2026-09-26 07:51:27.099169"
latest: "0.7.21--pyh1f0d9b5_0"
...
```bash
$ shpc install quay.io/biocontainers/rolypoly-tk:0.7.21--pyh1f0d9b5_0
```
...
```bash
$ module load quay.io/biocontainers/rolypoly-tk/0.7.21--pyh1f0d9b5_0
$ module help quay.io/biocontainers/rolypoly-tk/0.7.21--pyh1f0d9b5_0
```
