...
updated_at: "2026-03-05 04:55:43.340308"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-preprocesscore:1.72.0--r45h01b2380_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-preprocesscore/1.72.0--r45h01b2380_0
$ module help quay.io/biocontainers/bioconductor-preprocesscore/1.72.0--r45h01b2380_0
```
