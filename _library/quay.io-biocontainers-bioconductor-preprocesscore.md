...
updated_at: "2024-12-27 03:13:20.633603"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-preprocesscore:1.68.0--r44h3df3fcb_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-preprocesscore/1.68.0--r44h3df3fcb_0
$ module help quay.io/biocontainers/bioconductor-preprocesscore/1.68.0--r44h3df3fcb_0
```
