...
updated_at: "2025-11-08 03:43:05.088370"
latest: "1.54.0--r44h3df3fcb_1"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-biovizbase:1.54.0--r44h3df3fcb_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-biovizbase/1.54.0--r44h3df3fcb_1
$ module help quay.io/biocontainers/bioconductor-biovizbase/1.54.0--r44h3df3fcb_1
```
