...
updated_at: "2024-02-26 03:36:05.223977"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-bionar:1.4.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-bionar/1.4.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-bionar/1.4.0--r43hdfd78af_0
```
