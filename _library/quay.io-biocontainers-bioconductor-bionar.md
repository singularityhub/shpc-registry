...
updated_at: "2023-11-10 02:49:13.921510"
latest: "1.2.4--r43hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-bionar:1.2.4--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-bionar/1.2.4--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-bionar/1.2.4--r43hdfd78af_0
```
