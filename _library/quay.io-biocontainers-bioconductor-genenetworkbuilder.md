...
updated_at: "2023-06-02 03:21:44.647689"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-genenetworkbuilder:1.40.0--r42hf17093f_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-genenetworkbuilder/1.40.0--r42hf17093f_1
$ module help quay.io/biocontainers/bioconductor-genenetworkbuilder/1.40.0--r42hf17093f_1
```
