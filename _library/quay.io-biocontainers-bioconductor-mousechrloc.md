...
updated_at: "2026-04-05 05:03:23.157023"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mousechrloc:2.1.6--r45hdfd78af_14
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mousechrloc/2.1.6--r45hdfd78af_14
$ module help quay.io/biocontainers/bioconductor-mousechrloc/2.1.6--r45hdfd78af_14
```
