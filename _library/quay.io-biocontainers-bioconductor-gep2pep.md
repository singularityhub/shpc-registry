...
updated_at: "2022-10-29 18:28:10.462419"
latest: "1.8.0--r40_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gep2pep:1.8.0--r40_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gep2pep/1.8.0--r40_0
$ module help quay.io/biocontainers/bioconductor-gep2pep/1.8.0--r40_0
```
