...
updated_at: "2025-03-06 03:40:47.590755"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gep2pep:1.26.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gep2pep/1.26.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-gep2pep/1.26.0--r44hdfd78af_0
```
