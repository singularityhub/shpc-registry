...
updated_at: "2026-04-04 04:32:32.332421"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gep2pep:1.30.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gep2pep/1.30.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-gep2pep/1.30.0--r45hdfd78af_0
```
