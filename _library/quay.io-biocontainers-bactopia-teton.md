...
updated_at: "2024-10-30 16:04:16.201500"
...
```bash
$ shpc install quay.io/biocontainers/bactopia-teton:1.1.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bactopia-teton/1.1.0--hdfd78af_0
$ module help quay.io/biocontainers/bactopia-teton/1.1.0--hdfd78af_0
```
