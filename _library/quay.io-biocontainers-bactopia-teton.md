...
updated_at: "2026-04-04 05:20:01.619814"
...
```bash
$ shpc install quay.io/biocontainers/bactopia-teton:1.1.2--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bactopia-teton/1.1.2--hdfd78af_0
$ module help quay.io/biocontainers/bactopia-teton/1.1.2--hdfd78af_0
```
