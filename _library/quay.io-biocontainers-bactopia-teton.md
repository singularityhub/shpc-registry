...
updated_at: "2024-09-03 03:29:20.260712"
...
```bash
$ shpc install quay.io/biocontainers/bactopia-teton:1.0.4--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bactopia-teton/1.0.4--hdfd78af_0
$ module help quay.io/biocontainers/bactopia-teton/1.0.4--hdfd78af_0
```
