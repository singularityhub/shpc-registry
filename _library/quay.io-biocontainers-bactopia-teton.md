...
updated_at: "2026-06-07 06:57:01.699463"
...
```bash
$ shpc install quay.io/biocontainers/bactopia-teton:1.1.4--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bactopia-teton/1.1.4--hdfd78af_0
$ module help quay.io/biocontainers/bactopia-teton/1.1.4--hdfd78af_0
```
