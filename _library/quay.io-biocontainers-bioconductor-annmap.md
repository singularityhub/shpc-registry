...
updated_at: "2022-11-19 01:50:43.680292"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-annmap:1.36.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-annmap/1.36.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-annmap/1.36.0--r41hdfd78af_0
```
