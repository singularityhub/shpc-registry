...
updated_at: "2026-03-26 04:44:12.438602"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-annmap:1.52.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-annmap/1.52.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-annmap/1.52.0--r45hdfd78af_0
```
