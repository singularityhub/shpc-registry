...
updated_at: "2025-09-10 03:04:52.620956"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-annmap:1.48.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-annmap/1.48.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-annmap/1.48.0--r44hdfd78af_0
```
