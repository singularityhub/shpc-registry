...
updated_at: "2023-09-28 03:37:07.858747"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-txcutr:1.6.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-txcutr/1.6.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-txcutr/1.6.0--r43hdfd78af_0
```
