...
updated_at: "2026-03-29 05:35:29.579079"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-txcutr:1.16.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-txcutr/1.16.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-txcutr/1.16.0--r45hdfd78af_0
```
