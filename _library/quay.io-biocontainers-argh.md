---
layout: container
name:  "quay.io/biocontainers/argh"
maintainer: "@vsoch"
...
updated_at: "2024-06-27 03:15:31.954959"
...
```bash
$ shpc install quay.io/biocontainers/argh
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/argh:0.26.2--py36_0
```
...
```bash
$ module load quay.io/biocontainers/argh/0.26.2--py36_0
$ module help quay.io/biocontainers/argh/0.26.2--py36_0
```
...
#### argh-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### argh-inspect-deffile:
