...
updated_at: "2026-03-19 04:58:56.528021"
...
```bash
$ shpc install quay.io/biocontainers/hymet:1.3.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hymet/1.3.0--hdfd78af_0
$ module help quay.io/biocontainers/hymet/1.3.0--hdfd78af_0
```
