---
layout: container
name:  "quay.io/biocontainers/peek-bio"
maintainer: "@vsoch"
...
updated_at: "2026-06-08 06:48:24.172441"
...
singularity registry hpc automated addition for peek-bio
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/peek-bio
```
...
#### peek-bio-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### peek-bio-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/peek
$ podman run --it --rm --entrypoint /usr/local/bin/peek   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/peek   -v ${PWD} -w ${PWD} <container> -c " $@"
```
