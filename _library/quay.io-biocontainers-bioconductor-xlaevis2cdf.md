...
updated_at: "2024-07-11 03:18:18.400901"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-xlaevis2cdf:2.18.0--r43hdfd78af_12
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-xlaevis2cdf/2.18.0--r43hdfd78af_12
$ module help quay.io/biocontainers/bioconductor-xlaevis2cdf/2.18.0--r43hdfd78af_12
```
