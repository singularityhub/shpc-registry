...
updated_at: "2026-05-14 06:16:47.372937"
...
```bash
$ shpc install quay.io/biocontainers/pneumo-typer:2.0.2--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pneumo-typer/2.0.2--hdfd78af_0
$ module help quay.io/biocontainers/pneumo-typer/2.0.2--hdfd78af_0
```
