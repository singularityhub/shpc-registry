...
updated_at: "2026-03-30 05:45:04.647561"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-org.bt.eg.db:3.22.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-org.bt.eg.db/3.22.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-org.bt.eg.db/3.22.0--r45hdfd78af_0
```
