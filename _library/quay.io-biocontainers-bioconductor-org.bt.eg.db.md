...
updated_at: "2022-10-27 01:15:32.753889"
latest: "3.8.2--r36_1"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-org.bt.eg.db:3.8.2--r36_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-org.bt.eg.db/3.8.2--r36_1
$ module help quay.io/biocontainers/bioconductor-org.bt.eg.db/3.8.2--r36_1
```
