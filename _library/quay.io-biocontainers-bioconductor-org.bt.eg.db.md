...
updated_at: "2022-11-17 03:44:51.426913"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-org.bt.eg.db:3.14.0--r41hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-org.bt.eg.db/3.14.0--r41hdfd78af_1
$ module help quay.io/biocontainers/bioconductor-org.bt.eg.db/3.14.0--r41hdfd78af_1
```
