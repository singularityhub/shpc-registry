...
updated_at: "2025-08-16 03:33:36.045421"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-org.bt.eg.db:3.20.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-org.bt.eg.db/3.20.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-org.bt.eg.db/3.20.0--r44hdfd78af_0
```
