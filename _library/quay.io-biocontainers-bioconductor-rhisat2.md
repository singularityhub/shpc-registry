...
updated_at: "2022-10-29 18:08:46.485446"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rhisat2:1.8.0--r41h399db7b_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rhisat2/1.8.0--r41h399db7b_0
$ module help quay.io/biocontainers/bioconductor-rhisat2/1.8.0--r41h399db7b_0
```
