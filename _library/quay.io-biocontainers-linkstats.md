---
layout: container
name:  "quay.io/biocontainers/linkstats"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:21:09.161986"
latest: "0.1.3--py38ha7cf762_4"
...
```bash
$ shpc install quay.io/biocontainers/linkstats
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/linkstats:0.1.3--py38ha7cf762_4
```
...
```bash
$ module load quay.io/biocontainers/linkstats/0.1.3--py38ha7cf762_4
$ module help quay.io/biocontainers/linkstats/0.1.3--py38ha7cf762_4
```
...
#### linkstats-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### linkstats-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/LinkStats
$ podman run --it --rm --entrypoint /usr/local/bin/LinkStats   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/LinkStats   -v ${PWD} -w ${PWD} <container> -c " $@"
```
