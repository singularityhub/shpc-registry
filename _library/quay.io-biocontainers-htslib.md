...
updated_at: "2024-07-01 03:07:10.602500"
latest: "1.20--h5efdd21_1"
...
```bash
$ shpc install quay.io/biocontainers/htslib:1.20--h5efdd21_1
```
...
```bash
$ module load quay.io/biocontainers/htslib/1.20--h5efdd21_1
$ module help quay.io/biocontainers/htslib/1.20--h5efdd21_1
```
