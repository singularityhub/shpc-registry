...
updated_at: "2023-05-03 02:39:22.067122"
latest: "1.17--h6bc39ce_0"
...
```bash
$ shpc install quay.io/biocontainers/htslib:1.17--h6bc39ce_0
```
...
```bash
$ module load quay.io/biocontainers/htslib/1.17--h6bc39ce_0
$ module help quay.io/biocontainers/htslib/1.17--h6bc39ce_0
```
