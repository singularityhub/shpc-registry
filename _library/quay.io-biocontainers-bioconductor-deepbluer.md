...
updated_at: "2022-11-07 00:47:04.300738"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-deepbluer:1.20.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-deepbluer/1.20.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-deepbluer/1.20.0--r41hdfd78af_0
```
