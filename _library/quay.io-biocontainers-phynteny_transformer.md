...
updated_at: "2026-06-12 06:48:02.640385"
...
```bash
$ shpc install quay.io/biocontainers/phynteny_transformer:0.1.3--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/phynteny_transformer/0.1.3--pyhdfd78af_1
$ module help quay.io/biocontainers/phynteny_transformer/0.1.3--pyhdfd78af_1
```
