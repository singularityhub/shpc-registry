...
updated_at: "2026-03-27 05:17:32.847994"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cocoa:2.24.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cocoa/2.24.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-cocoa/2.24.0--r45hdfd78af_0
```
