...
updated_at: "2025-11-02 03:19:04.823365"
latest: "3.3.2--r44h3121a25_0"
...
```bash
$ shpc install quay.io/biocontainers/r-aroma.core:3.3.2--r44h3121a25_0
```
...
```bash
$ module load quay.io/biocontainers/r-aroma.core/3.3.2--r44h3121a25_0
$ module help quay.io/biocontainers/r-aroma.core/3.3.2--r44h3121a25_0
```
