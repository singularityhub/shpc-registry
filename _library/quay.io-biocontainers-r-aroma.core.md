...
updated_at: "2026-03-21 04:22:04.274784"
latest: "3.3.2--r45h3121a25_1"
...
```bash
$ shpc install quay.io/biocontainers/r-aroma.core:3.3.2--r45h3121a25_1
```
...
```bash
$ module load quay.io/biocontainers/r-aroma.core/3.3.2--r45h3121a25_1
$ module help quay.io/biocontainers/r-aroma.core/3.3.2--r45h3121a25_1
```
