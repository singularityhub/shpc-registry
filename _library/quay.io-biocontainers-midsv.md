...
updated_at: "2023-09-06 02:51:42.667923"
...
```bash
$ shpc install quay.io/biocontainers/midsv:0.10.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/midsv/0.10.2--pyhdfd78af_0
$ module help quay.io/biocontainers/midsv/0.10.2--pyhdfd78af_0
```
