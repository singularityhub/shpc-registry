...
updated_at: "2024-05-28 02:45:09.378606"
...
```bash
$ shpc install quay.io/biocontainers/midsv:0.11.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/midsv/0.11.0--pyhdfd78af_0
$ module help quay.io/biocontainers/midsv/0.11.0--pyhdfd78af_0
```
