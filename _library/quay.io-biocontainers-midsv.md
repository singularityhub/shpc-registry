...
updated_at: "2023-08-13 03:06:33.169195"
...
```bash
$ shpc install quay.io/biocontainers/midsv:0.10.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/midsv/0.10.0--pyhdfd78af_0
$ module help quay.io/biocontainers/midsv/0.10.0--pyhdfd78af_0
```
