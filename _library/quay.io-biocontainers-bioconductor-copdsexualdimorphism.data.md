...
updated_at: "2026-03-25 04:51:22.855830"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-copdsexualdimorphism.data:1.46.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-copdsexualdimorphism.data/1.46.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-copdsexualdimorphism.data/1.46.0--r45hdfd78af_0
```
