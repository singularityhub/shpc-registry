...
updated_at: "2026-04-02 05:24:29.866124"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-htratfocuscdf:2.18.0--r45hdfd78af_14
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-htratfocuscdf/2.18.0--r45hdfd78af_14
$ module help quay.io/biocontainers/bioconductor-htratfocuscdf/2.18.0--r45hdfd78af_14
```
