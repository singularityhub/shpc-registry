...
updated_at: "2022-10-29 07:50:21.440413"
latest: "1.8.0--r36_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-tnt:1.8.0--r36_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-tnt/1.8.0--r36_0
$ module help quay.io/biocontainers/bioconductor-tnt/1.8.0--r36_0
```
