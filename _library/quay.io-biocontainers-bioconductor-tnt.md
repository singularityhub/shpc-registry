...
updated_at: "2024-04-22 03:07:53.294105"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-tnt:1.24.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-tnt/1.24.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-tnt/1.24.0--r43hdfd78af_0
```
