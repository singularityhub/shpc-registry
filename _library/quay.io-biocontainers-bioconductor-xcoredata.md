...
updated_at: "2025-07-28 09:15:17.907854"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-xcoredata:1.10.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-xcoredata/1.10.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-xcoredata/1.10.0--r44hdfd78af_0
```
