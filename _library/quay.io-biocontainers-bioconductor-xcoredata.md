...
updated_at: "2026-03-24 04:57:35.422402"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-xcoredata:1.14.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-xcoredata/1.14.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-xcoredata/1.14.0--r45hdfd78af_0
```
