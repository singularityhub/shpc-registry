...
updated_at: "2024-07-31 02:39:42.910241"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-xcoredata:1.6.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-xcoredata/1.6.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-xcoredata/1.6.0--r43hdfd78af_0
```
