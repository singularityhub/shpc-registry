...
updated_at: "2022-11-16 00:33:30.851513"
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-vitisviniferacdf-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-vitisviniferacdf-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-vitisviniferacdf-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-vitisviniferacdf-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-vitisviniferacdf-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-vitisviniferacdf-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
