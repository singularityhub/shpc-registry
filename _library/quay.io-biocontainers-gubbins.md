...
updated_at: "2025-01-03 03:25:49.859983"
latest: "3.4--py39pl5321h577a1d6_1"
...
```bash
$ shpc install quay.io/biocontainers/gubbins:3.4--py39pl5321h577a1d6_1
```
...
```bash
$ module load quay.io/biocontainers/gubbins/3.4--py39pl5321h577a1d6_1
$ module help quay.io/biocontainers/gubbins/3.4--py39pl5321h577a1d6_1
```
