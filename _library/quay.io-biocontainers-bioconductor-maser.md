...
updated_at: "2024-12-18 03:05:58.158138"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-maser:1.20.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-maser/1.20.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-maser/1.20.0--r43hdfd78af_0
```
