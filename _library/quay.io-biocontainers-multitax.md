...
updated_at: "2026-06-05 06:35:19.697440"
...
```bash
$ shpc install quay.io/biocontainers/multitax:1.6.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/multitax/1.6.0--pyhdfd78af_0
$ module help quay.io/biocontainers/multitax/1.6.0--pyhdfd78af_0
```
