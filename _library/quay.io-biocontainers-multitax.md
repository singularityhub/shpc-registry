...
updated_at: "2026-01-21 04:31:42.645004"
...
```bash
$ shpc install quay.io/biocontainers/multitax:1.3.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/multitax/1.3.2--pyhdfd78af_0
$ module help quay.io/biocontainers/multitax/1.3.2--pyhdfd78af_0
```
