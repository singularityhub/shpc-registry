---
layout: container
name:  "quay.io/biocontainers/bioconductor-tenet.annotationhub"
maintainer: "@vsoch"
...
updated_at: "2026-04-05 05:27:04.061113"
...
versions:
 - "1.1.0--r45hdfd78af_0"
description: "singularity registry hpc automated addition for bioconductor-tenet.annotationhub"
config: {"url": "https://biocontainers.pro/tools/bioconductor-tenet.annotationhub", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for bioconductor-tenet.annotationhub", "latest": {"1.1.0--r45hdfd78af_0": "sha256:48233d2f859d515a81e11d4497c7c559d1dfc387a7b58cad676ea00e898f1117"}, "tags": {"1.1.0--r45hdfd78af_0": "sha256:48233d2f859d515a81e11d4497c7c559d1dfc387a7b58cad676ea00e898f1117"}, "docker": "quay.io/biocontainers/bioconductor-tenet.annotationhub", "aliases": {"idle3.14": "/usr/local/bin/idle3.14", "pydoc3.14": "/usr/local/bin/pydoc3.14", "python3.14": "/usr/local/bin/python3.14", "python3.14-config": "/usr/local/bin/python3.14-config", "x86_64-conda-linux-gnu.cfg": "/usr/local/bin/x86_64-conda-linux-gnu.cfg", "installBiocDataPackage.sh": "/usr/local/bin/installBiocDataPackage.sh", "tomlq": "/usr/local/bin/tomlq", "xq": "/usr/local/bin/xq", "yq": "/usr/local/bin/yq", "jq": "/usr/local/bin/jq", "onig-config": "/usr/local/bin/onig-config", "activate-global-python-argcomplete": "/usr/local/bin/activate-global-python-argcomplete", "python-argcomplete-check-easy-install-script": "/usr/local/bin/python-argcomplete-check-easy-install-script", "register-python-argcomplete": "/usr/local/bin/register-python-argcomplete", "hb-info": "/usr/local/bin/hb-info"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/bioconductor-tenet.annotationhub.
singularity registry hpc automated addition for bioconductor-tenet.annotationhub
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/bioconductor-tenet.annotationhub
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-tenet.annotationhub:1.1.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-tenet.annotationhub/1.1.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-tenet.annotationhub/1.1.0--r45hdfd78af_0
```
...
#### bioconductor-tenet.annotationhub-run:
...
#### bioconductor-tenet.annotationhub-shell:
...
#### bioconductor-tenet.annotationhub-exec:
...
#### bioconductor-tenet.annotationhub-inspect:
...
#### bioconductor-tenet.annotationhub-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-tenet.annotationhub-inspect-deffile:
