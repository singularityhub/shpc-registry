...
updated_at: "2026-09-18 07:19:02.680361"
latest: "0.23.2--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/methplotlib:0.23.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/methplotlib/0.23.2--pyhdfd78af_0
$ module help quay.io/biocontainers/methplotlib/0.23.2--pyhdfd78af_0
```
