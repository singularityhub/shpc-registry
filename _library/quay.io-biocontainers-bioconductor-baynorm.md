...
updated_at: "2026-03-14 04:51:48.850098"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-baynorm:1.28.0--r45ha27e39d_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-baynorm/1.28.0--r45ha27e39d_0
$ module help quay.io/biocontainers/bioconductor-baynorm/1.28.0--r45ha27e39d_0
```
