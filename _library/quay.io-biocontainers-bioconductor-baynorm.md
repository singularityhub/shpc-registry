...
updated_at: "2024-11-28 03:55:43.106334"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-baynorm:1.20.0--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-baynorm/1.20.0--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-baynorm/1.20.0--r43hf17093f_0
```
