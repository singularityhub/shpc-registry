...
updated_at: "2026-05-29 07:03:44.092693"
...
```bash
$ shpc install quay.io/biocontainers/ampcombi:3.0.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ampcombi/3.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/ampcombi/3.0.0--pyhdfd78af_0
```
