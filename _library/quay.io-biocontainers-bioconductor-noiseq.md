...
updated_at: "2022-10-29 05:42:43.332893"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-noiseq:2.38.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-noiseq/2.38.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-noiseq/2.38.0--r41hdfd78af_0
```
