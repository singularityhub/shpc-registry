...
updated_at: "2026-03-04 05:06:40.743829"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-noiseq:2.54.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-noiseq/2.54.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-noiseq/2.54.0--r45hdfd78af_0
```
