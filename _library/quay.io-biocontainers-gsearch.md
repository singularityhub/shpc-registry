...
updated_at: "2026-03-01 05:03:35.261035"
latest: "0.3.4--hafc0c1d_0"
...
```bash
$ shpc install quay.io/biocontainers/gsearch:0.3.4--hafc0c1d_0
```
...
```bash
$ module load quay.io/biocontainers/gsearch/0.3.4--hafc0c1d_0
$ module help quay.io/biocontainers/gsearch/0.3.4--hafc0c1d_0
```
