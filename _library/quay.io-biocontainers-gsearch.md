...
updated_at: "2024-11-17 03:21:33.438449"
latest: "0.2.2--hdbdd923_0"
...
```bash
$ shpc install quay.io/biocontainers/gsearch:0.2.2--hdbdd923_0
```
...
```bash
$ module load quay.io/biocontainers/gsearch/0.2.2--hdbdd923_0
$ module help quay.io/biocontainers/gsearch/0.2.2--hdbdd923_0
```
