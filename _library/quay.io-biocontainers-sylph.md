...
updated_at: "2023-12-08 02:55:51.803149"
...
```bash
$ shpc install quay.io/biocontainers/sylph:0.4.0--h4ac6f70_0
```
...
```bash
$ module load quay.io/biocontainers/sylph/0.4.0--h4ac6f70_0
$ module help quay.io/biocontainers/sylph/0.4.0--h4ac6f70_0
```
