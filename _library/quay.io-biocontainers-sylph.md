...
updated_at: "2023-12-23 02:33:58.710371"
...
```bash
$ shpc install quay.io/biocontainers/sylph:0.4.1--h4ac6f70_0
```
...
```bash
$ module load quay.io/biocontainers/sylph/0.4.1--h4ac6f70_0
$ module help quay.io/biocontainers/sylph/0.4.1--h4ac6f70_0
```
