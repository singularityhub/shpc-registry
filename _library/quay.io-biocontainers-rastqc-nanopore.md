---
layout: container
name:  "quay.io/biocontainers/rastqc-nanopore"
maintainer: "@vsoch"
...
updated_at: "2026-06-03 07:35:54.431699"
...
singularity registry hpc automated addition for rastqc-nanopore
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/rastqc-nanopore
```
...
#### rastqc-nanopore-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### rastqc-nanopore-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/rastqc-nanopore
$ podman run --it --rm --entrypoint /usr/local/bin/rastqc-nanopore   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/rastqc-nanopore   -v ${PWD} -w ${PWD} <container> -c " $@"
```
