...
updated_at: "2022-11-17 03:41:38.787690"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gostats:2.60.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gostats/2.60.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-gostats/2.60.0--r41hdfd78af_0
```
