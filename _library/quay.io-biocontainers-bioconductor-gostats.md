...
updated_at: "2025-02-22 02:50:26.308708"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gostats:2.72.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gostats/2.72.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-gostats/2.72.0--r44hdfd78af_0
```
