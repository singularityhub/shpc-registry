...
updated_at: "2026-07-02 06:10:08.299617"
...
```bash
$ shpc install quay.io/biocontainers/breaktracer:0.3.1--h3752d28_0
```
...
```bash
$ module load quay.io/biocontainers/breaktracer/0.3.1--h3752d28_0
$ module help quay.io/biocontainers/breaktracer/0.3.1--h3752d28_0
```
