...
updated_at: "2024-07-23 02:55:01.265634"
latest: "1.8.3--h43eeafb_1"
...
```bash
$ shpc install quay.io/biocontainers/raven-assembler:1.8.3--h43eeafb_1
```
...
```bash
$ module load quay.io/biocontainers/raven-assembler/1.8.3--h43eeafb_1
$ module help quay.io/biocontainers/raven-assembler/1.8.3--h43eeafb_1
```
