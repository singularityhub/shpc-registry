...
updated_at: "2026-03-27 04:49:16.384494"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-iggeneusage:1.24.0--r45ha27e39d_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-iggeneusage/1.24.0--r45ha27e39d_0
$ module help quay.io/biocontainers/bioconductor-iggeneusage/1.24.0--r45ha27e39d_0
```
