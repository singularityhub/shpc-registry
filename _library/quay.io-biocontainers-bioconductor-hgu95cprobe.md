...
updated_at: "2026-03-28 17:22:44.548225"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hgu95cprobe:2.18.0--r45hdfd78af_14
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hgu95cprobe/2.18.0--r45hdfd78af_14
$ module help quay.io/biocontainers/bioconductor-hgu95cprobe/2.18.0--r45hdfd78af_14
```
