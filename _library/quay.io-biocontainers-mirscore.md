...
updated_at: "2026-08-21 03:20:49.886403"
...
```bash
$ shpc install quay.io/biocontainers/mirscore:0.3.7--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mirscore/0.3.7--hdfd78af_0
$ module help quay.io/biocontainers/mirscore/0.3.7--hdfd78af_0
```
