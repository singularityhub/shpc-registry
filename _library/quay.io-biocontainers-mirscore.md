...
updated_at: "2024-12-14 03:11:54.404457"
...
```bash
$ shpc install quay.io/biocontainers/mirscore:0.3.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mirscore/0.3.0--hdfd78af_0
$ module help quay.io/biocontainers/mirscore/0.3.0--hdfd78af_0
```
