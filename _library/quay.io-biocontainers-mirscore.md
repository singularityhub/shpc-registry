...
updated_at: "2024-12-31 03:31:28.030534"
...
```bash
$ shpc install quay.io/biocontainers/mirscore:0.3.1--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mirscore/0.3.1--hdfd78af_0
$ module help quay.io/biocontainers/mirscore/0.3.1--hdfd78af_0
```
