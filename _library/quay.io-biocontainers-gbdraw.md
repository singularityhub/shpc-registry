...
updated_at: "2025-11-26 03:44:43.029763"
...
```bash
$ shpc install quay.io/biocontainers/gbdraw:0.6.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/gbdraw/0.6.0--pyhdfd78af_0
$ module help quay.io/biocontainers/gbdraw/0.6.0--pyhdfd78af_0
```
