...
updated_at: "2025-01-03 03:10:00.264289"
...
```bash
$ shpc install quay.io/biocontainers/pbpigeon:1.3.0--h4ac6f70_0
```
...
```bash
$ module load quay.io/biocontainers/pbpigeon/1.3.0--h4ac6f70_0
$ module help quay.io/biocontainers/pbpigeon/1.3.0--h4ac6f70_0
```
