...
updated_at: "2026-07-14 05:37:29.600341"
...
```bash
$ shpc install quay.io/biocontainers/pbpigeon:26.2.0--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/pbpigeon/26.2.0--h9ee0642_0
$ module help quay.io/biocontainers/pbpigeon/26.2.0--h9ee0642_0
```
