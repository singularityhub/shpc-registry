...
updated_at: "2023-09-08 03:10:48.613979"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rtrm:1.38.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rtrm/1.38.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rtrm/1.38.0--r43hdfd78af_0
```
