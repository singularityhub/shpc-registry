...
updated_at: "2024-10-07 16:35:18.718603"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cafe:1.38.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cafe/1.38.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-cafe/1.38.0--r43hdfd78af_0
```
