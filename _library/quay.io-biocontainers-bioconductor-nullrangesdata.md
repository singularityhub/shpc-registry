...
updated_at: "2022-11-03 01:21:32.664522"
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-nullrangesdata-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-nullrangesdata-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-nullrangesdata-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-nullrangesdata-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-nullrangesdata-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-nullrangesdata-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
