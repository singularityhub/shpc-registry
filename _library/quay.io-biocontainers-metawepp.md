...
updated_at: "2026-08-27 23:27:22.401951"
...
```bash
$ shpc install quay.io/biocontainers/metawepp:0.2.0--hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/metawepp/0.2.0--hdfd78af_1
$ module help quay.io/biocontainers/metawepp/0.2.0--hdfd78af_1
```
