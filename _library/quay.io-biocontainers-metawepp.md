...
updated_at: "2026-07-11 06:19:24.022211"
...
```bash
$ shpc install quay.io/biocontainers/metawepp:0.2.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/metawepp/0.2.0--hdfd78af_0
$ module help quay.io/biocontainers/metawepp/0.2.0--hdfd78af_0
```
