---
layout: container
name:  "quay.io/biocontainers/pcne"
maintainer: "@vsoch"
...
updated_at: "2026-07-01 06:45:34.650696"
...
```bash
$ module load quay.io/biocontainers/pcne/3.3.1--hdfd78af_0
$ module help quay.io/biocontainers/pcne/3.3.1--hdfd78af_0
```
...
#### pcne-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### pcne-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/PCNE.R
$ podman run --it --rm --entrypoint /usr/local/bin/PCNE.R   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/PCNE.R   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/pcne
$ podman run --it --rm --entrypoint /usr/local/bin/pcne   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/pcne   -v ${PWD} -w ${PWD} <container> -c " $@"
```
