...
updated_at: "2026-04-15 05:28:30.521103"
...
```bash
$ shpc install quay.io/biocontainers/pcne:3.2.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pcne/3.2.0--hdfd78af_0
$ module help quay.io/biocontainers/pcne/3.2.0--hdfd78af_0
```
