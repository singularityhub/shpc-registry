...
updated_at: "2025-12-19 05:50:21.816043"
...
```bash
$ shpc install quay.io/biocontainers/automappa:2.2.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/automappa/2.2.1--pyhdfd78af_0
$ module help quay.io/biocontainers/automappa/2.2.1--pyhdfd78af_0
```
