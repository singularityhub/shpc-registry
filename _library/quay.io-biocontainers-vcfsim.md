...
updated_at: "2026-03-18 04:37:52.732728"
latest: "1.0.28.alpha--pyh84cbfca_0"
...
```bash
$ shpc install quay.io/biocontainers/vcfsim:1.0.28.alpha--pyh84cbfca_0
```
...
```bash
$ module load quay.io/biocontainers/vcfsim/1.0.28.alpha--pyh84cbfca_0
$ module help quay.io/biocontainers/vcfsim/1.0.28.alpha--pyh84cbfca_0
```
