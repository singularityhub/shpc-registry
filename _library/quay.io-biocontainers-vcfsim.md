...
updated_at: "2024-07-24 03:04:18.106997"
latest: "1.0.12.alpha--pyhdc42f0e_0"
...
```bash
$ shpc install quay.io/biocontainers/vcfsim:1.0.12.alpha--pyhdc42f0e_0
```
...
```bash
$ module load quay.io/biocontainers/vcfsim/1.0.12.alpha--pyhdc42f0e_0
$ module help quay.io/biocontainers/vcfsim/1.0.12.alpha--pyhdc42f0e_0
```
