...
updated_at: "2026-02-02 04:40:24.649123"
latest: "1.0.27.alpha--pyhdc42f0e_0"
...
```bash
$ shpc install quay.io/biocontainers/vcfsim:1.0.27.alpha--pyhdc42f0e_0
```
...
```bash
$ module load quay.io/biocontainers/vcfsim/1.0.27.alpha--pyhdc42f0e_0
$ module help quay.io/biocontainers/vcfsim/1.0.27.alpha--pyhdc42f0e_0
```
