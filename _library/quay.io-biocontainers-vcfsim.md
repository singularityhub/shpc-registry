...
updated_at: "2026-06-18 07:04:16.037539"
latest: "1.1.0.alpha--pyh84cbfca_0"
...
```bash
$ shpc install quay.io/biocontainers/vcfsim:1.1.0.alpha--pyh84cbfca_0
```
...
```bash
$ module load quay.io/biocontainers/vcfsim/1.1.0.alpha--pyh84cbfca_0
$ module help quay.io/biocontainers/vcfsim/1.1.0.alpha--pyh84cbfca_0
```
