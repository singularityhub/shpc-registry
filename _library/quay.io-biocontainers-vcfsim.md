...
updated_at: "2026-09-23 07:46:26.785779"
latest: "1.2.2--pyh84cbfca_0"
...
```bash
$ shpc install quay.io/biocontainers/vcfsim:1.2.2--pyh84cbfca_0
```
...
```bash
$ module load quay.io/biocontainers/vcfsim/1.2.2--pyh84cbfca_0
$ module help quay.io/biocontainers/vcfsim/1.2.2--pyh84cbfca_0
```
