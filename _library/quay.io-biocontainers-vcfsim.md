...
updated_at: "2025-12-27 03:38:49.585502"
latest: "1.0.25.alpha--pyhdc42f0e_0"
...
```bash
$ shpc install quay.io/biocontainers/vcfsim:1.0.25.alpha--pyhdc42f0e_0
```
...
```bash
$ module load quay.io/biocontainers/vcfsim/1.0.25.alpha--pyhdc42f0e_0
$ module help quay.io/biocontainers/vcfsim/1.0.25.alpha--pyhdc42f0e_0
```
