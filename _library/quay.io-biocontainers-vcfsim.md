...
updated_at: "2024-02-09 03:44:39.760871"
latest: "1.0.8.alpha--pyhca03a8a_0"
...
```bash
$ shpc install quay.io/biocontainers/vcfsim:1.0.8.alpha--pyhca03a8a_0
```
...
```bash
$ module load quay.io/biocontainers/vcfsim/1.0.8.alpha--pyhca03a8a_0
$ module help quay.io/biocontainers/vcfsim/1.0.8.alpha--pyhca03a8a_0
```
