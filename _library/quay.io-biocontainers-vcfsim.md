...
updated_at: "2025-09-30 03:12:12.219166"
latest: "1.0.24.alpha--pyhdc42f0e_0"
...
```bash
$ shpc install quay.io/biocontainers/vcfsim:1.0.24.alpha--pyhdc42f0e_0
```
...
```bash
$ module load quay.io/biocontainers/vcfsim/1.0.24.alpha--pyhdc42f0e_0
$ module help quay.io/biocontainers/vcfsim/1.0.24.alpha--pyhdc42f0e_0
```
