...
updated_at: "2026-08-08 03:52:39.571370"
latest: "1.2.0--pyh84cbfca_0"
...
```bash
$ shpc install quay.io/biocontainers/vcfsim:1.2.0--pyh84cbfca_0
```
...
```bash
$ module load quay.io/biocontainers/vcfsim/1.2.0--pyh84cbfca_0
$ module help quay.io/biocontainers/vcfsim/1.2.0--pyh84cbfca_0
```
