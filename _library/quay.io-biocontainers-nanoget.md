...
updated_at: "2026-06-29 07:39:19.953866"
latest: "1.19.5--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/nanoget:1.19.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/nanoget/1.19.5--pyhdfd78af_0
$ module help quay.io/biocontainers/nanoget/1.19.5--pyhdfd78af_0
```
