...
updated_at: "2023-12-27 02:44:36.163018"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hthgu133b.db:3.13.0--r43hdfd78af_3
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hthgu133b.db/3.13.0--r43hdfd78af_3
$ module help quay.io/biocontainers/bioconductor-hthgu133b.db/3.13.0--r43hdfd78af_3
```
