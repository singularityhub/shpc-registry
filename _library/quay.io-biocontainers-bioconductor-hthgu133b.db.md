...
updated_at: "2025-03-22 03:03:46.947975"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hthgu133b.db:3.13.0--r44hdfd78af_5
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hthgu133b.db/3.13.0--r44hdfd78af_5
$ module help quay.io/biocontainers/bioconductor-hthgu133b.db/3.13.0--r44hdfd78af_5
```
