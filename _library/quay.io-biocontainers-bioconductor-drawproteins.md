...
updated_at: "2023-10-05 03:36:15.774356"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-drawproteins:1.20.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-drawproteins/1.20.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-drawproteins/1.20.0--r43hdfd78af_0
```
