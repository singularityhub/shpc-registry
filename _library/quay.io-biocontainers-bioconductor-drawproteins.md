...
updated_at: "2026-02-04 04:52:52.666625"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-drawproteins:1.26.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-drawproteins/1.26.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-drawproteins/1.26.0--r44hdfd78af_0
```
