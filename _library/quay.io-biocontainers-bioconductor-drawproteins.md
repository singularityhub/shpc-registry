...
updated_at: "2022-10-29 08:22:25.234305"
latest: "1.8.0--r40_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-drawproteins:1.8.0--r40_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-drawproteins/1.8.0--r40_0
$ module help quay.io/biocontainers/bioconductor-drawproteins/1.8.0--r40_0
```
