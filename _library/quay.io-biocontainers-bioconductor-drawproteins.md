...
updated_at: "2026-03-21 04:48:37.934255"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-drawproteins:1.30.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-drawproteins/1.30.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-drawproteins/1.30.0--r45hdfd78af_0
```
