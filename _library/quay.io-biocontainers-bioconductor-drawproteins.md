...
updated_at: "2022-11-27 12:33:50.510997"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-drawproteins:1.14.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-drawproteins/1.14.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-drawproteins/1.14.0--r41hdfd78af_0
```
