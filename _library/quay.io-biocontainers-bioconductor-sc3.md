...
updated_at: "2023-07-17 03:18:09.116622"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-sc3:1.26.0--r42hf17093f_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-sc3/1.26.0--r42hf17093f_1
$ module help quay.io/biocontainers/bioconductor-sc3/1.26.0--r42hf17093f_1
```
