...
updated_at: "2022-11-05 00:30:02.554587"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-sc3:1.8.0--r351hfc679d8_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-sc3/1.8.0--r351hfc679d8_0
$ module help quay.io/biocontainers/bioconductor-sc3/1.8.0--r351hfc679d8_0
```
