...
updated_at: "2023-10-07 03:11:23.986533"
latest: "1.28.3--r43hf17093f_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-sc3:1.28.3--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-sc3/1.28.3--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-sc3/1.28.3--r43hf17093f_0
```
