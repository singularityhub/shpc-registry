...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hsagilentdesign026652.db:3.2.3--r41hdfd78af_9
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hsagilentdesign026652.db/3.2.3--r41hdfd78af_9
$ module help quay.io/biocontainers/bioconductor-hsagilentdesign026652.db/3.2.3--r41hdfd78af_9
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-hsagilentdesign026652.db-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-hsagilentdesign026652.db-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-hsagilentdesign026652.db-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-hsagilentdesign026652.db-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-hsagilentdesign026652.db-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-hsagilentdesign026652.db-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
