...
updated_at: "2026-03-17 04:32:06.982210"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hsagilentdesign026652.db:3.2.3--r45hdfd78af_14
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hsagilentdesign026652.db/3.2.3--r45hdfd78af_14
$ module help quay.io/biocontainers/bioconductor-hsagilentdesign026652.db/3.2.3--r45hdfd78af_14
```
