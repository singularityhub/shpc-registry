...
updated_at: "2022-10-29 05:35:54.052440"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-genomicinteractions:1.28.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-genomicinteractions/1.28.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-genomicinteractions/1.28.0--r41hdfd78af_0
```
