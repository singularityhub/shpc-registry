---
layout: container
name:  "quay.io/biocontainers/enzywizard-mut-batch"
maintainer: "@vsoch"
github: "https://github.com/singularityhub/shpc-registry/blob/main/quay.io/biocontainers/enzywizard-mut-batch/container.yaml"
config_url: "https://raw.githubusercontent.com/singularityhub/shpc-registry/main/quay.io/biocontainers/enzywizard-mut-batch/container.yaml"
updated_at: "2026-09-26 07:16:11.137313"
latest: "1.0.3--pyhdfd78af_0"
container_url: "https://biocontainers.pro/tools/enzywizard-mut-batch"
aliases:
...
```bash
$ module load quay.io/biocontainers/enzywizard-mut-batch/1.0.3--pyhdfd78af_0
$ module help quay.io/biocontainers/enzywizard-mut-batch/1.0.3--pyhdfd78af_0
```
...
#### enzywizard-mut-batch-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### enzywizard-mut-batch-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/enzywizard-mut-batch
$ podman run --it --rm --entrypoint /usr/local/bin/enzywizard-mut-batch   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/enzywizard-mut-batch   -v ${PWD} -w ${PWD} <container> -c " $@"
```
