...
updated_at: "2026-01-16 04:30:10.330620"
...
```bash
$ shpc install quay.io/biocontainers/snakemake-storage-plugin-irods:0.3.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake-storage-plugin-irods/0.3.1--pyhdfd78af_0
$ module help quay.io/biocontainers/snakemake-storage-plugin-irods/0.3.1--pyhdfd78af_0
```
