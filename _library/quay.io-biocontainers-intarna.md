...
updated_at: "2024-09-01 03:10:32.286586"
...
```bash
$ shpc install quay.io/biocontainers/intarna:3.4.0--pl5321hdcf5f25_2
```
...
```bash
$ module load quay.io/biocontainers/intarna/3.4.0--pl5321hdcf5f25_2
$ module help quay.io/biocontainers/intarna/3.4.0--pl5321hdcf5f25_2
```
