...
updated_at: "2024-05-16 02:29:30.852832"
latest: "3.4.0--pl5321h21ec9f0_1"
...
```bash
$ shpc install quay.io/biocontainers/intarna:3.4.0--pl5321h21ec9f0_1
```
...
```bash
$ module load quay.io/biocontainers/intarna/3.4.0--pl5321h21ec9f0_1
$ module help quay.io/biocontainers/intarna/3.4.0--pl5321h21ec9f0_1
```
