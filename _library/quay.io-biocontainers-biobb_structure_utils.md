...
updated_at: "2026-08-29 09:02:11.909463"
...
```bash
$ shpc install quay.io/biocontainers/biobb_structure_utils:5.3.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_structure_utils/5.3.0--pyhdfd78af_0
$ module help quay.io/biocontainers/biobb_structure_utils/5.3.0--pyhdfd78af_0
```
