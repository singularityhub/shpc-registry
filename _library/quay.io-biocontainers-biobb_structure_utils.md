...
updated_at: "2026-03-28 04:56:06.922482"
...
```bash
$ shpc install quay.io/biocontainers/biobb_structure_utils:5.2.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_structure_utils/5.2.1--pyhdfd78af_0
$ module help quay.io/biocontainers/biobb_structure_utils/5.2.1--pyhdfd78af_0
```
