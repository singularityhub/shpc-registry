...
updated_at: "2026-03-20 04:30:58.542499"
...
```bash
$ shpc install quay.io/biocontainers/biobb_structure_utils:5.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_structure_utils/5.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/biobb_structure_utils/5.2.0--pyhdfd78af_0
```
