...
updated_at: "2024-01-10 08:48:34.810661"
...
```bash
$ shpc install quay.io/biocontainers/biobb_structure_utils:4.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_structure_utils/4.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/biobb_structure_utils/4.1.0--pyhdfd78af_0
```
