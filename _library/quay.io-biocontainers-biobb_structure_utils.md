...
updated_at: "2024-08-18 03:16:26.905057"
...
```bash
$ shpc install quay.io/biocontainers/biobb_structure_utils:4.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_structure_utils/4.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/biobb_structure_utils/4.2.0--pyhdfd78af_0
```
