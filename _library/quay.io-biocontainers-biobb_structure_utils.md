...
updated_at: "2025-01-01 03:26:17.398930"
...
```bash
$ shpc install quay.io/biocontainers/biobb_structure_utils:5.0.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_structure_utils/5.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/biobb_structure_utils/5.0.0--pyhdfd78af_0
```
