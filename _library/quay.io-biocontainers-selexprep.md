---
layout: container
name:  "quay.io/biocontainers/selexprep"
maintainer: "@vsoch"
...
updated_at: "2026-09-14 07:44:52.478706"
...
```bash
$ module load quay.io/biocontainers/selexprep/0.4.1--pyhdfd78af_0
$ module help quay.io/biocontainers/selexprep/0.4.1--pyhdfd78af_0
```
...
#### selexprep-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### selexprep-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/selexprep
$ podman run --it --rm --entrypoint /usr/local/bin/selexprep   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/selexprep   -v ${PWD} -w ${PWD} <container> -c " $@"
```
