...
updated_at: "2026-09-01 07:32:51.415328"
...
```bash
$ shpc install quay.io/biocontainers/selexprep:0.4.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/selexprep/0.4.0--pyhdfd78af_0
$ module help quay.io/biocontainers/selexprep/0.4.0--pyhdfd78af_0
```
