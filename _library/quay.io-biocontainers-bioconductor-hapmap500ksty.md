...
updated_at: "2024-05-24 02:52:13.013185"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hapmap500ksty:1.44.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hapmap500ksty/1.44.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-hapmap500ksty/1.44.0--r43hdfd78af_0
```
