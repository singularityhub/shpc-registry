...
updated_at: "2025-11-13 03:24:20.942899"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hapmap500ksty:1.48.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hapmap500ksty/1.48.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-hapmap500ksty/1.48.0--r44hdfd78af_0
```
