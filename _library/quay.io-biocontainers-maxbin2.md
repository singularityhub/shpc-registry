...
updated_at: "2025-04-19 03:01:08.069953"
...
```bash
$ shpc install quay.io/biocontainers/maxbin2:2.2.7--h503566f_7
```
...
```bash
$ module load quay.io/biocontainers/maxbin2/2.2.7--h503566f_7
$ module help quay.io/biocontainers/maxbin2/2.2.7--h503566f_7
```
