---
layout: container
name:  "quay.io/biocontainers/bioconductor-hoodscanr"
maintainer: "@vsoch"
...
updated_at: "2026-04-04 04:44:02.262107"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hoodscanr
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-hoodscanr:1.8.0--r45ha27e39d_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hoodscanr/1.8.0--r45ha27e39d_0
$ module help quay.io/biocontainers/bioconductor-hoodscanr/1.8.0--r45ha27e39d_0
```
...
#### bioconductor-hoodscanr-inspect:
...
#### bioconductor-hoodscanr-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-hoodscanr-inspect-deffile:
