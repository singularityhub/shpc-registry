...
updated_at: "2023-09-18 02:34:02.726759"
...
```bash
$ shpc install quay.io/biocontainers/taxpasta:0.6.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/taxpasta/0.6.0--pyhdfd78af_0
$ module help quay.io/biocontainers/taxpasta/0.6.0--pyhdfd78af_0
```
