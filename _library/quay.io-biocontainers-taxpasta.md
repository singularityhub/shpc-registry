...
updated_at: "2023-02-11 02:55:04.286485"
...
```bash
$ shpc install quay.io/biocontainers/taxpasta:0.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/taxpasta/0.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/taxpasta/0.1.0--pyhdfd78af_0
```
