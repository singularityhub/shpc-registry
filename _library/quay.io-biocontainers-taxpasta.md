...
updated_at: "2025-12-19 03:52:27.362009"
...
```bash
$ shpc install quay.io/biocontainers/taxpasta:0.7.0--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/taxpasta/0.7.0--pyhdfd78af_1
$ module help quay.io/biocontainers/taxpasta/0.7.0--pyhdfd78af_1
```
