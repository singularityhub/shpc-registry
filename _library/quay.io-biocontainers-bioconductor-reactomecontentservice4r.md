...
updated_at: "2023-10-04 02:34:05.375814"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-reactomecontentservice4r:1.8.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-reactomecontentservice4r/1.8.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-reactomecontentservice4r/1.8.0--r43hdfd78af_0
```
