...
updated_at: "2026-03-23 05:18:23.628855"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-pogos:1.30.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-pogos/1.30.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-pogos/1.30.0--r45hdfd78af_0
```
