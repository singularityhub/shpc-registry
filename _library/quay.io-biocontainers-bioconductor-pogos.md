...
updated_at: "2025-03-22 03:42:53.694513"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-pogos:1.26.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-pogos/1.26.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-pogos/1.26.0--r44hdfd78af_0
```
