...
updated_at: "2022-11-02 19:15:42.038568"
latest: "1.8.0--r40_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-pogos:1.8.0--r40_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-pogos/1.8.0--r40_0
$ module help quay.io/biocontainers/bioconductor-pogos/1.8.0--r40_0
```
