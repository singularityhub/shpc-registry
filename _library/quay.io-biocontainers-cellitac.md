---
layout: container
name:  "quay.io/biocontainers/cellitac"
maintainer: "@vsoch"
...
updated_at: "2026-09-03 07:11:09.093267"
...
```bash
$ module load quay.io/biocontainers/cellitac/2.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/cellitac/2.0.0--pyhdfd78af_0
```
...
#### cellitac-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### cellitac-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/cellitac
$ podman run --it --rm --entrypoint /usr/local/bin/cellitac   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/cellitac   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/cellitac-model
$ podman run --it --rm --entrypoint /usr/local/bin/cellitac-model   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/cellitac-model   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/cellitac-preprocess
$ podman run --it --rm --entrypoint /usr/local/bin/cellitac-preprocess   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/cellitac-preprocess   -v ${PWD} -w ${PWD} <container> -c " $@"
```
