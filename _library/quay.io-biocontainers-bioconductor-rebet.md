...
updated_at: "2025-08-20 03:55:16.757302"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rebet:1.24.0--r44h3df3fcb_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rebet/1.24.0--r44h3df3fcb_0
$ module help quay.io/biocontainers/bioconductor-rebet/1.24.0--r44h3df3fcb_0
```
