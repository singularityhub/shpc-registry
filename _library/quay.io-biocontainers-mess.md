...
updated_at: "2025-05-09 03:15:09.159489"
...
```bash
$ shpc install quay.io/biocontainers/mess:0.11.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mess/0.11.0--pyhdfd78af_0
$ module help quay.io/biocontainers/mess/0.11.0--pyhdfd78af_0
```
