...
updated_at: "2026-01-21 04:05:59.568823"
...
```bash
$ shpc install quay.io/biocontainers/mess:0.12.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mess/0.12.0--pyhdfd78af_0
$ module help quay.io/biocontainers/mess/0.12.0--pyhdfd78af_0
```
