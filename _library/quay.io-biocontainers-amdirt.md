...
updated_at: "2025-03-02 03:14:34.347624"
...
```bash
$ shpc install quay.io/biocontainers/amdirt:1.6.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/amdirt/1.6.5--pyhdfd78af_0
$ module help quay.io/biocontainers/amdirt/1.6.5--pyhdfd78af_0
```
