...
updated_at: "2024-07-22 03:09:11.009746"
...
```bash
$ shpc install quay.io/biocontainers/amdirt:1.6.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/amdirt/1.6.1--pyhdfd78af_0
$ module help quay.io/biocontainers/amdirt/1.6.1--pyhdfd78af_0
```
