...
updated_at: "2026-03-13 04:58:54.039744"
...
```bash
$ shpc install quay.io/biocontainers/amdirt:1.7.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/amdirt/1.7.1--pyhdfd78af_0
$ module help quay.io/biocontainers/amdirt/1.7.1--pyhdfd78af_0
```
