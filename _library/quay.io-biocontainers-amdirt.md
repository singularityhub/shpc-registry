...
updated_at: "2024-11-18 16:50:39.656304"
...
```bash
$ shpc install quay.io/biocontainers/amdirt:1.6.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/amdirt/1.6.2--pyhdfd78af_0
$ module help quay.io/biocontainers/amdirt/1.6.2--pyhdfd78af_0
```
