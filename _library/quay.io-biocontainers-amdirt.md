...
updated_at: "2023-05-09 02:45:24.394430"
...
```bash
$ shpc install quay.io/biocontainers/amdirt:1.4.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/amdirt/1.4.3--pyhdfd78af_0
$ module help quay.io/biocontainers/amdirt/1.4.3--pyhdfd78af_0
```
