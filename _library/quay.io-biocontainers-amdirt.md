...
updated_at: "2026-01-21 04:14:24.800300"
...
```bash
$ shpc install quay.io/biocontainers/amdirt:1.7.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/amdirt/1.7.0--pyhdfd78af_0
$ module help quay.io/biocontainers/amdirt/1.7.0--pyhdfd78af_0
```
