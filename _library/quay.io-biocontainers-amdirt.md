...
updated_at: "2024-06-22 02:42:46.726599"
...
```bash
$ shpc install quay.io/biocontainers/amdirt:1.6.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/amdirt/1.6.0--pyhdfd78af_0
$ module help quay.io/biocontainers/amdirt/1.6.0--pyhdfd78af_0
```
