...
updated_at: "2022-11-05 00:29:46.856347"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-bioqc:1.8.0--r341hfc679d8_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-bioqc/1.8.0--r341hfc679d8_0
$ module help quay.io/biocontainers/bioconductor-bioqc/1.8.0--r341hfc679d8_0
```
