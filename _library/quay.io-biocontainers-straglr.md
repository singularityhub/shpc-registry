...
updated_at: "2024-09-20 03:23:29.845645"
...
```bash
$ shpc install quay.io/biocontainers/straglr:1.5.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/straglr/1.5.1--pyhdfd78af_0
$ module help quay.io/biocontainers/straglr/1.5.1--pyhdfd78af_0
```
