...
updated_at: "2024-05-27 03:43:05.636654"
...
```bash
$ shpc install quay.io/biocontainers/straglr:1.5.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/straglr/1.5.0--pyhdfd78af_0
$ module help quay.io/biocontainers/straglr/1.5.0--pyhdfd78af_0
```
