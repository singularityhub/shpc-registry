...
updated_at: "2025-08-02 04:13:54.860883"
...
```bash
$ shpc install quay.io/biocontainers/straglr:1.5.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/straglr/1.5.4--pyhdfd78af_0
$ module help quay.io/biocontainers/straglr/1.5.4--pyhdfd78af_0
```
