...
updated_at: "2024-02-25 02:38:10.208278"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rnbeads.mm9:1.34.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rnbeads.mm9/1.34.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rnbeads.mm9/1.34.0--r43hdfd78af_0
```
