...
updated_at: "2024-08-10 03:03:08.997320"
latest: "1.18.0--py311hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/el_gato:1.18.0--py311hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/el_gato/1.18.0--py311hdfd78af_0
$ module help quay.io/biocontainers/el_gato/1.18.0--py311hdfd78af_0
```
