...
updated_at: "2024-09-09 02:57:46.984933"
latest: "1.19.0--py311hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/el_gato:1.19.0--py311hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/el_gato/1.19.0--py311hdfd78af_0
$ module help quay.io/biocontainers/el_gato/1.19.0--py311hdfd78af_0
```
