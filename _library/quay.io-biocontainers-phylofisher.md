...
updated_at: "2024-10-27 03:13:16.742508"
...
```bash
$ shpc install quay.io/biocontainers/phylofisher:1.2.14--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/phylofisher/1.2.14--pyhdfd78af_0
$ module help quay.io/biocontainers/phylofisher/1.2.14--pyhdfd78af_0
```
