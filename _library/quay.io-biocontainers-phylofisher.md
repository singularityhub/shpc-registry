...
updated_at: "2023-07-24 03:20:59.901441"
...
```bash
$ shpc install quay.io/biocontainers/phylofisher:1.2.9--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/phylofisher/1.2.9--pyhdfd78af_0
$ module help quay.io/biocontainers/phylofisher/1.2.9--pyhdfd78af_0
```
