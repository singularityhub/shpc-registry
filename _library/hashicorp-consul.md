...
updated_at: "2026-08-16 04:10:27.642417"
latest: "2.0.0-rc1"
...
```bash
$ shpc install hashicorp/consul:2.0.0-rc1
```
...
```bash
$ module load hashicorp/consul/2.0.0-rc1
$ module help hashicorp/consul/2.0.0-rc1
```
