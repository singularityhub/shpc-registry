...
updated_at: "2023-11-11 03:16:42.154246"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-tximportdata:1.28.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-tximportdata/1.28.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-tximportdata/1.28.0--r43hdfd78af_0
```
