...
updated_at: "2024-07-10 02:41:07.938523"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-clippda:1.52.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-clippda/1.52.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-clippda/1.52.0--r43hdfd78af_0
```
