...
updated_at: "2026-09-25 08:05:32.849513"
...
```bash
$ shpc install quay.io/biocontainers/oxbreaker:1.2.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/oxbreaker/1.2.3--pyhdfd78af_0
$ module help quay.io/biocontainers/oxbreaker/1.2.3--pyhdfd78af_0
```
