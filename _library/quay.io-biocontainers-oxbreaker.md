...
updated_at: "2026-08-26 03:21:35.503437"
...
```bash
$ shpc install quay.io/biocontainers/oxbreaker:1.2.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/oxbreaker/1.2.1--pyhdfd78af_0
$ module help quay.io/biocontainers/oxbreaker/1.2.1--pyhdfd78af_0
```
