...
updated_at: "2023-07-13 03:42:07.223690"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gosim:1.36.0--r42hf17093f_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gosim/1.36.0--r42hf17093f_1
$ module help quay.io/biocontainers/bioconductor-gosim/1.36.0--r42hf17093f_1
```
