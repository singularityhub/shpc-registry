...
updated_at: "2026-02-23 04:38:17.544824"
latest: "3.6.1--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/emu:3.6.1--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/emu/3.6.1--hdfd78af_0
$ module help quay.io/biocontainers/emu/3.6.1--hdfd78af_0
```
