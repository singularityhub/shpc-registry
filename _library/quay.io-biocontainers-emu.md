...
updated_at: "2026-01-22 04:01:48.922241"
latest: "3.5.5--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/emu:3.5.5--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/emu/3.5.5--hdfd78af_0
$ module help quay.io/biocontainers/emu/3.5.5--hdfd78af_0
```
