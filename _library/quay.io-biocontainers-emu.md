...
updated_at: "2025-11-21 03:24:40.405027"
latest: "3.5.4--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/emu:3.5.4--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/emu/3.5.4--hdfd78af_0
$ module help quay.io/biocontainers/emu/3.5.4--hdfd78af_0
```
