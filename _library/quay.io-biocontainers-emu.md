...
updated_at: "2025-11-14 04:45:41.339675"
latest: "3.5.3--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/emu:3.5.3--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/emu/3.5.3--hdfd78af_0
$ module help quay.io/biocontainers/emu/3.5.3--hdfd78af_0
```
