...
updated_at: "2026-03-30 06:29:49.895823"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-qplexdata:1.27.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-qplexdata/1.27.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-qplexdata/1.27.0--r45hdfd78af_0
```
