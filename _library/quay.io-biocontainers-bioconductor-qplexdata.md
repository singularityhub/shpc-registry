...
updated_at: "2024-11-13 03:11:47.136696"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-qplexdata:1.20.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-qplexdata/1.20.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-qplexdata/1.20.0--r43hdfd78af_0
```
