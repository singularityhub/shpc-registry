...
updated_at: "2022-10-27 00:55:50.912292"
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-qplexdata-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-qplexdata-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-qplexdata-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-qplexdata-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-qplexdata-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-qplexdata-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
