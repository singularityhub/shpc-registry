...
updated_at: "2024-11-09 03:28:01.619873"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-openprimerui:1.24.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-openprimerui/1.24.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-openprimerui/1.24.0--r43hdfd78af_0
```
