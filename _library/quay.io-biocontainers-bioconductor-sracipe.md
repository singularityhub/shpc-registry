...
updated_at: "2022-11-10 00:13:33.341419"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-sracipe:1.8.0--r41h399db7b_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-sracipe/1.8.0--r41h399db7b_0
$ module help quay.io/biocontainers/bioconductor-sracipe/1.8.0--r41h399db7b_0
```
