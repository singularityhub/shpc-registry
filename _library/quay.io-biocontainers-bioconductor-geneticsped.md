...
updated_at: "2026-03-31 05:16:09.942749"
latest: "1.72.0--r45h9e4a190_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-geneticsped:1.72.0--r45h9e4a190_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-geneticsped/1.72.0--r45h9e4a190_0
$ module help quay.io/biocontainers/bioconductor-geneticsped/1.72.0--r45h9e4a190_0
```
