...
updated_at: "2023-07-05 03:02:31.318386"
latest: "1.60.0--r42ha1e849b_1"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-geneticsped:1.60.0--r42ha1e849b_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-geneticsped/1.60.0--r42ha1e849b_1
$ module help quay.io/biocontainers/bioconductor-geneticsped/1.60.0--r42ha1e849b_1
```
