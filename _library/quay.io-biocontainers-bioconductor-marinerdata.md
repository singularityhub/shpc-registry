...
updated_at: "2026-01-01 04:00:19.772317"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-marinerdata:1.6.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-marinerdata/1.6.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-marinerdata/1.6.0--r44hdfd78af_0
```
