...
updated_at: "2023-09-21 03:04:44.518696"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-marinerdata:1.0.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-marinerdata/1.0.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-marinerdata/1.0.0--r43hdfd78af_0
```
