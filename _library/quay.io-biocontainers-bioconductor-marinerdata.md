...
updated_at: "2024-09-09 03:06:55.679944"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-marinerdata:1.2.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-marinerdata/1.2.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-marinerdata/1.2.0--r43hdfd78af_0
```
