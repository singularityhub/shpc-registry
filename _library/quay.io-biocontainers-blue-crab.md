...
updated_at: "2026-09-23 07:35:37.055595"
...
```bash
$ shpc install quay.io/biocontainers/blue-crab:0.6.0--pyh05cac1d_0
```
...
```bash
$ module load quay.io/biocontainers/blue-crab/0.6.0--pyh05cac1d_0
$ module help quay.io/biocontainers/blue-crab/0.6.0--pyh05cac1d_0
```
