...
updated_at: "2023-07-10 03:53:37.037342"
latest: "1.8.0--r42ha9d7317_1"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-metabcombiner:1.8.0--r42ha9d7317_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-metabcombiner/1.8.0--r42ha9d7317_1
$ module help quay.io/biocontainers/bioconductor-metabcombiner/1.8.0--r42ha9d7317_1
```
