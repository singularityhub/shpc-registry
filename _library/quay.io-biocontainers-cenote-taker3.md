...
updated_at: "2025-09-29 04:09:33.079509"
...
```bash
$ shpc install quay.io/biocontainers/cenote-taker3:3.4.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/cenote-taker3/3.4.1--pyhdfd78af_0
$ module help quay.io/biocontainers/cenote-taker3/3.4.1--pyhdfd78af_0
```
