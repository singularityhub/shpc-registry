...
updated_at: "2026-01-30 04:20:14.593180"
...
```bash
$ shpc install quay.io/biocontainers/cenote-taker3:3.4.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/cenote-taker3/3.4.3--pyhdfd78af_0
$ module help quay.io/biocontainers/cenote-taker3/3.4.3--pyhdfd78af_0
```
