...
updated_at: "2024-08-10 02:49:41.886288"
latest: "3.3.1--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/cenote-taker3:3.3.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/cenote-taker3/3.3.1--pyhdfd78af_0
$ module help quay.io/biocontainers/cenote-taker3/3.3.1--pyhdfd78af_0
```
