...
updated_at: "2026-03-25 04:56:32.709478"
...
```bash
$ shpc install quay.io/biocontainers/cenote-taker3:3.4.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/cenote-taker3/3.4.4--pyhdfd78af_0
$ module help quay.io/biocontainers/cenote-taker3/3.4.4--pyhdfd78af_0
```
