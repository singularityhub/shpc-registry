...
updated_at: "2024-02-15 02:29:12.430934"
...
```bash
$ shpc install quay.io/biocontainers/cenote-taker3:3.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/cenote-taker3/3.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/cenote-taker3/3.2.0--pyhdfd78af_0
```
