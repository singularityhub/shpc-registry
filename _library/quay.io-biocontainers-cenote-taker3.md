...
updated_at: "2024-02-27 02:27:39.328343"
...
```bash
$ shpc install quay.io/biocontainers/cenote-taker3:3.2.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/cenote-taker3/3.2.1--pyhdfd78af_0
$ module help quay.io/biocontainers/cenote-taker3/3.2.1--pyhdfd78af_0
```
