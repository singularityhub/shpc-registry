...
updated_at: "2025-11-07 03:21:30.427656"
...
```bash
$ shpc install quay.io/biocontainers/cenote-taker3:3.4.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/cenote-taker3/3.4.2--pyhdfd78af_0
$ module help quay.io/biocontainers/cenote-taker3/3.4.2--pyhdfd78af_0
```
