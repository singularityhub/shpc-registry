...
updated_at: "2025-02-15 03:35:58.754387"
latest: "3.3.2--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/cenote-taker3:3.3.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/cenote-taker3/3.3.2--pyhdfd78af_0
$ module help quay.io/biocontainers/cenote-taker3/3.3.2--pyhdfd78af_0
```
