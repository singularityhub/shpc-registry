...
updated_at: "2026-03-25 05:22:37.808769"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-txdb.drerio.ucsc.danrer11.refgene:3.4.6--r45hdfd78af_13
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-txdb.drerio.ucsc.danrer11.refgene/3.4.6--r45hdfd78af_13
$ module help quay.io/biocontainers/bioconductor-txdb.drerio.ucsc.danrer11.refgene/3.4.6--r45hdfd78af_13
```
