...
updated_at: "2025-11-17 04:53:27.575746"
latest: "0.3.6.1--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/konezumiaid:0.3.6.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/konezumiaid/0.3.6.1--pyhdfd78af_0
$ module help quay.io/biocontainers/konezumiaid/0.3.6.1--pyhdfd78af_0
```
