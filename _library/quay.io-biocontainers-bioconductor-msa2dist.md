...
updated_at: "2024-09-20 03:13:06.070307"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-msa2dist:1.6.0--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-msa2dist/1.6.0--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-msa2dist/1.6.0--r43hf17093f_0
```
