...
updated_at: "2026-03-02 05:25:04.549979"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-msa2dist:1.14.0--r45ha27e39d_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-msa2dist/1.14.0--r45ha27e39d_0
$ module help quay.io/biocontainers/bioconductor-msa2dist/1.14.0--r45ha27e39d_0
```
