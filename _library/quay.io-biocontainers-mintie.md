...
updated_at: "2025-11-21 15:40:17.852834"
...
```bash
$ shpc install quay.io/biocontainers/mintie:0.4.3--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mintie/0.4.3--hdfd78af_0
$ module help quay.io/biocontainers/mintie/0.4.3--hdfd78af_0
```
