...
updated_at: "2024-05-27 03:13:17.446254"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-heebodata:1.40.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-heebodata/1.40.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-heebodata/1.40.0--r43hdfd78af_0
```
