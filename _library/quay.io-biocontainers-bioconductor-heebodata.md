...
updated_at: "2026-04-05 05:12:51.254284"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-heebodata:1.48.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-heebodata/1.48.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-heebodata/1.48.0--r45hdfd78af_0
```
