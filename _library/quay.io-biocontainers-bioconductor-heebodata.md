...
updated_at: "2022-10-29 08:24:06.972160"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-heebodata:1.32.0--r41hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-heebodata/1.32.0--r41hdfd78af_1
$ module help quay.io/biocontainers/bioconductor-heebodata/1.32.0--r41hdfd78af_1
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-heebodata-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-heebodata-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-heebodata-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-heebodata-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-heebodata-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-heebodata-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
