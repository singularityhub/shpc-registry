...
updated_at: "2024-07-21 02:50:41.561237"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ioniser:2.26.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ioniser/2.26.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ioniser/2.26.0--r43hdfd78af_0
```
