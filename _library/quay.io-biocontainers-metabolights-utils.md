...
updated_at: "2025-04-04 03:40:55.580576"
...
```bash
$ shpc install quay.io/biocontainers/metabolights-utils:1.4.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/metabolights-utils/1.4.2--pyhdfd78af_0
$ module help quay.io/biocontainers/metabolights-utils/1.4.2--pyhdfd78af_0
```
