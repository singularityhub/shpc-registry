...
updated_at: "2025-05-21 03:55:04.252109"
...
```bash
$ shpc install quay.io/biocontainers/metabolights-utils:1.4.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/metabolights-utils/1.4.3--pyhdfd78af_0
$ module help quay.io/biocontainers/metabolights-utils/1.4.3--pyhdfd78af_0
```
