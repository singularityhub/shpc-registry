...
updated_at: "2025-12-29 04:14:29.801201"
...
```bash
$ shpc install quay.io/biocontainers/metabolights-utils:1.4.9--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/metabolights-utils/1.4.9--pyhdfd78af_0
$ module help quay.io/biocontainers/metabolights-utils/1.4.9--pyhdfd78af_0
```
