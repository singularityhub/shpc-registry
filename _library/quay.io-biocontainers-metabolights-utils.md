...
updated_at: "2024-10-31 03:32:22.377345"
...
```bash
$ shpc install quay.io/biocontainers/metabolights-utils:1.1.10--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/metabolights-utils/1.1.10--pyhdfd78af_0
$ module help quay.io/biocontainers/metabolights-utils/1.1.10--pyhdfd78af_0
```
