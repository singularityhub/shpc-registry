...
updated_at: "2025-02-26 03:02:20.943092"
...
```bash
$ shpc install quay.io/biocontainers/metabolights-utils:1.3.12--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/metabolights-utils/1.3.12--pyhdfd78af_0
$ module help quay.io/biocontainers/metabolights-utils/1.3.12--pyhdfd78af_0
```
