...
updated_at: "2024-10-06 03:11:53.152175"
...
```bash
$ shpc install quay.io/biocontainers/metabolights-utils:1.1.6--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/metabolights-utils/1.1.6--pyhdfd78af_0
$ module help quay.io/biocontainers/metabolights-utils/1.1.6--pyhdfd78af_0
```
