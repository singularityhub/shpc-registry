...
updated_at: "2024-12-05 03:31:59.368086"
...
```bash
$ shpc install quay.io/biocontainers/metabolights-utils:1.2.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/metabolights-utils/1.2.2--pyhdfd78af_0
$ module help quay.io/biocontainers/metabolights-utils/1.2.2--pyhdfd78af_0
```
