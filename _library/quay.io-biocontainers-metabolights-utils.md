...
updated_at: "2025-10-02 03:21:00.648114"
...
```bash
$ shpc install quay.io/biocontainers/metabolights-utils:1.4.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/metabolights-utils/1.4.4--pyhdfd78af_0
$ module help quay.io/biocontainers/metabolights-utils/1.4.4--pyhdfd78af_0
```
