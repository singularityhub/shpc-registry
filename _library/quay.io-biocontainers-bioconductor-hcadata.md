...
updated_at: "2023-08-25 03:14:46.113518"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hcadata:1.16.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hcadata/1.16.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-hcadata/1.16.0--r43hdfd78af_0
```
