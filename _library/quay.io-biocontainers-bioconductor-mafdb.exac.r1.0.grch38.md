...
updated_at: "2023-11-12 02:52:20.868343"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mafdb.exac.r1.0.grch38:3.10.0--r43hdfd78af_8
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mafdb.exac.r1.0.grch38/3.10.0--r43hdfd78af_8
$ module help quay.io/biocontainers/bioconductor-mafdb.exac.r1.0.grch38/3.10.0--r43hdfd78af_8
```
