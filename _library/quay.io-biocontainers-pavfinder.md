...
updated_at: "2026-05-27 06:52:18.932617"
...
```bash
$ shpc install quay.io/biocontainers/pavfinder:1.8.5--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/pavfinder/1.8.5--pyhdfd78af_1
$ module help quay.io/biocontainers/pavfinder/1.8.5--pyhdfd78af_1
```
