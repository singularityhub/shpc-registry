...
updated_at: "2022-11-01 03:24:27.158357"
...
```bash
$ shpc install quay.io/biocontainers/apollo:4.2.9--pyh3252c3a_0
```
...
```bash
$ module load quay.io/biocontainers/apollo/4.2.9--pyh3252c3a_0
$ module help quay.io/biocontainers/apollo/4.2.9--pyh3252c3a_0
```
