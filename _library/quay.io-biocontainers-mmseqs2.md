...
updated_at: "2025-01-15 02:50:32.353068"
latest: "16.747c6--pl5321hd6d6fdc_1"
...
```bash
$ shpc install quay.io/biocontainers/mmseqs2:16.747c6--pl5321hd6d6fdc_1
```
...
```bash
$ module load quay.io/biocontainers/mmseqs2/16.747c6--pl5321hd6d6fdc_1
$ module help quay.io/biocontainers/mmseqs2/16.747c6--pl5321hd6d6fdc_1
```
