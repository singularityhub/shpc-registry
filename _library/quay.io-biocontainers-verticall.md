---
layout: container
name:  "quay.io/biocontainers/verticall"
maintainer: "@vsoch"
...
updated_at: "2025-09-23 03:11:38.437548"
...
```bash
$ shpc install quay.io/biocontainers/verticall
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/verticall:0.4.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/verticall/0.4.3--pyhdfd78af_0
$ module help quay.io/biocontainers/verticall/0.4.3--pyhdfd78af_0
```
...
#### verticall-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### verticall-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/verticall
$ podman run --it --rm --entrypoint /usr/local/bin/verticall   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/verticall   -v ${PWD} -w ${PWD} <container> -c " $@"
```
