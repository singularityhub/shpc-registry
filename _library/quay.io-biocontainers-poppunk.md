...
updated_at: "2026-04-05 04:50:07.386668"
latest: "2.7.8--py310h4d0eb5b_0"
...
```bash
$ shpc install quay.io/biocontainers/poppunk:2.7.8--py310h4d0eb5b_0
```
...
```bash
$ module load quay.io/biocontainers/poppunk/2.7.8--py310h4d0eb5b_0
$ module help quay.io/biocontainers/poppunk/2.7.8--py310h4d0eb5b_0
```
