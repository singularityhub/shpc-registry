...
updated_at: "2024-08-27 06:35:19.261260"
latest: "2.6.7--py39hb59753c_0"
...
```bash
$ shpc install quay.io/biocontainers/poppunk:2.6.7--py39hb59753c_0
```
...
```bash
$ module load quay.io/biocontainers/poppunk/2.6.7--py39hb59753c_0
$ module help quay.io/biocontainers/poppunk/2.6.7--py39hb59753c_0
```
