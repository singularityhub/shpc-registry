...
updated_at: "2025-04-05 03:08:01.788136"
latest: "2.7.2--py310h4d0eb5b_2"
...
```bash
$ shpc install quay.io/biocontainers/poppunk:2.7.2--py310h4d0eb5b_2
```
...
```bash
$ module load quay.io/biocontainers/poppunk/2.7.2--py310h4d0eb5b_2
$ module help quay.io/biocontainers/poppunk/2.7.2--py310h4d0eb5b_2
```
