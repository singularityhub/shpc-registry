...
updated_at: "2022-10-27 01:14:30.060300"
latest: "2.5.0--py39h8884e85_0"
...
```bash
$ shpc install quay.io/biocontainers/poppunk:2.5.0--py39h8884e85_0
```
...
```bash
$ module load quay.io/biocontainers/poppunk/2.5.0--py39h8884e85_0
$ module help quay.io/biocontainers/poppunk/2.5.0--py39h8884e85_0
```
...
```bash
$ singularity exec <container> /usr/local/bin/.gtk3-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.gtk3-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.gtk3-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
