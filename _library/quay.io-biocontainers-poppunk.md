...
updated_at: "2025-01-18 03:03:16.844620"
latest: "2.7.2--py312hc15d307_1"
...
```bash
$ shpc install quay.io/biocontainers/poppunk:2.7.2--py312hc15d307_1
```
...
```bash
$ module load quay.io/biocontainers/poppunk/2.7.2--py312hc15d307_1
$ module help quay.io/biocontainers/poppunk/2.7.2--py312hc15d307_1
```
