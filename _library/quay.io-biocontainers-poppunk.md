...
updated_at: "2024-12-13 03:30:54.333195"
latest: "2.7.2--py312hda6a541_0"
...
```bash
$ shpc install quay.io/biocontainers/poppunk:2.7.2--py312hda6a541_0
```
...
```bash
$ module load quay.io/biocontainers/poppunk/2.7.2--py312hda6a541_0
$ module help quay.io/biocontainers/poppunk/2.7.2--py312hda6a541_0
```
