...
updated_at: "2025-08-07 10:11:51.534706"
latest: "2.7.6--py39h5b13545_0"
...
```bash
$ shpc install quay.io/biocontainers/poppunk:2.7.6--py39h5b13545_0
```
...
```bash
$ module load quay.io/biocontainers/poppunk/2.7.6--py39h5b13545_0
$ module help quay.io/biocontainers/poppunk/2.7.6--py39h5b13545_0
```
