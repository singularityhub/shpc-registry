...
updated_at: "2024-07-11 02:37:45.204727"
latest: "2.6.5--py312h2f68563_1"
...
```bash
$ shpc install quay.io/biocontainers/poppunk:2.6.5--py312h2f68563_1
```
...
```bash
$ module load quay.io/biocontainers/poppunk/2.6.5--py312h2f68563_1
$ module help quay.io/biocontainers/poppunk/2.6.5--py312h2f68563_1
```
