...
updated_at: "2023-09-08 02:46:30.357479"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cllmethylation:1.20.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cllmethylation/1.20.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-cllmethylation/1.20.0--r43hdfd78af_0
```
