...
updated_at: "2022-10-29 05:48:28.979687"
latest: "5.1.0.1--r41h3121a25_0"
...
```bash
$ shpc install quay.io/biocontainers/r-coloc:5.1.0.1--r41h3121a25_0
```
...
```bash
$ module load quay.io/biocontainers/r-coloc/5.1.0.1--r41h3121a25_0
$ module help quay.io/biocontainers/r-coloc/5.1.0.1--r41h3121a25_0
```
