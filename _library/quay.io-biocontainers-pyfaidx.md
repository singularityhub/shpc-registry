...
updated_at: "2024-09-12 17:04:31.968604"
latest: "0.8.1.2--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/pyfaidx:0.8.1.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pyfaidx/0.8.1.2--pyhdfd78af_0
$ module help quay.io/biocontainers/pyfaidx/0.8.1.2--pyhdfd78af_0
```
