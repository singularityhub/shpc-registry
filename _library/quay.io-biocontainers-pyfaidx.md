...
updated_at: "2026-06-13 07:10:36.359355"
...
```bash
$ shpc install quay.io/biocontainers/pyfaidx:0.9.0.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pyfaidx/0.9.0.4--pyhdfd78af_0
$ module help quay.io/biocontainers/pyfaidx/0.9.0.4--pyhdfd78af_0
```
