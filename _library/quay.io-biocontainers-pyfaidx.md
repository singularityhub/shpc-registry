...
updated_at: "2026-02-07 04:49:05.641026"
latest: "0.9.0.3--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/pyfaidx:0.9.0.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pyfaidx/0.9.0.3--pyhdfd78af_0
$ module help quay.io/biocontainers/pyfaidx/0.9.0.3--pyhdfd78af_0
```
