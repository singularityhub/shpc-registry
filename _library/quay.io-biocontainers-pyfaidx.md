...
updated_at: "2024-03-03 02:55:54.087199"
latest: "0.8.1.1--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/pyfaidx:0.8.1.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pyfaidx/0.8.1.1--pyhdfd78af_0
$ module help quay.io/biocontainers/pyfaidx/0.8.1.1--pyhdfd78af_0
```
