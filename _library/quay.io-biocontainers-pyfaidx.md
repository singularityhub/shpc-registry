...
updated_at: "2025-09-01 03:28:42.353880"
...
```bash
$ shpc install quay.io/biocontainers/pyfaidx:0.8.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pyfaidx/0.8.2--pyhdfd78af_0
$ module help quay.io/biocontainers/pyfaidx/0.8.2--pyhdfd78af_0
```
