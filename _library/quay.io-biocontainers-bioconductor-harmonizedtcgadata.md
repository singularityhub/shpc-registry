...
updated_at: "2022-11-15 00:08:06.971239"
latest: "1.8.0--r36_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-harmonizedtcgadata:1.8.0--r36_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-harmonizedtcgadata/1.8.0--r36_0
$ module help quay.io/biocontainers/bioconductor-harmonizedtcgadata/1.8.0--r36_0
```
