...
updated_at: "2024-09-30 04:39:36.634124"
latest: "1.23.0--r43hf17093f_1"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-bnbc:1.23.0--r43hf17093f_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-bnbc/1.23.0--r43hf17093f_1
$ module help quay.io/biocontainers/bioconductor-bnbc/1.23.0--r43hf17093f_1
```
