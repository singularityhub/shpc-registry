...
updated_at: "2024-01-15 02:58:03.184341"
latest: "1.23.0--r43hf17093f_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-bnbc:1.23.0--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-bnbc/1.23.0--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-bnbc/1.23.0--r43hf17093f_0
```
