...
updated_at: "2023-12-30 02:49:48.457136"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-bnbc:1.22.0--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-bnbc/1.22.0--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-bnbc/1.22.0--r43hf17093f_0
```
