...
updated_at: "2022-11-23 00:59:53.303506"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-affycomp:1.70.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-affycomp/1.70.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-affycomp/1.70.0--r41hdfd78af_0
```
