...
updated_at: "2022-11-08 00:40:35.907772"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-moe430bprobe:2.18.0--r41hdfd78af_10
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-moe430bprobe/2.18.0--r41hdfd78af_10
$ module help quay.io/biocontainers/bioconductor-moe430bprobe/2.18.0--r41hdfd78af_10
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-moe430bprobe-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-moe430bprobe-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-moe430bprobe-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-moe430bprobe-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-moe430bprobe-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-moe430bprobe-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
