...
updated_at: "2023-10-23 02:37:01.929080"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-sigspack:1.14.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-sigspack/1.14.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-sigspack/1.14.0--r43hdfd78af_0
```
