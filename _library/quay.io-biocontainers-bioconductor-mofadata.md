...
updated_at: "2022-10-27 01:02:34.404297"
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-mofadata-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-mofadata-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-mofadata-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-mofadata-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-mofadata-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-mofadata-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
