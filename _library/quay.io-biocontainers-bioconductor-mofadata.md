...
updated_at: "2023-09-25 02:59:12.049359"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mofadata:1.16.1--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mofadata/1.16.1--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-mofadata/1.16.1--r43hdfd78af_0
```
