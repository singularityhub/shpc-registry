...
updated_at: "2025-04-18 03:04:16.116037"
...
```bash
$ shpc install quay.io/biocontainers/changeo:1.3.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/changeo/1.3.1--pyhdfd78af_0
$ module help quay.io/biocontainers/changeo/1.3.1--pyhdfd78af_0
```
