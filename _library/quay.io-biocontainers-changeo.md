...
updated_at: "2026-09-17 07:45:19.142588"
...
```bash
$ shpc install quay.io/biocontainers/changeo:1.3.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/changeo/1.3.5--pyhdfd78af_0
$ module help quay.io/biocontainers/changeo/1.3.5--pyhdfd78af_0
```
