...
updated_at: "2025-10-03 03:31:06.276350"
...
```bash
$ shpc install quay.io/biocontainers/changeo:1.3.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/changeo/1.3.4--pyhdfd78af_0
$ module help quay.io/biocontainers/changeo/1.3.4--pyhdfd78af_0
```
