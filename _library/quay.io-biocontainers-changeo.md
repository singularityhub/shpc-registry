...
updated_at: "2022-11-03 00:43:29.020953"
...
```bash
$ shpc install quay.io/biocontainers/changeo:1.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/changeo/1.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/changeo/1.2.0--pyhdfd78af_0
```
