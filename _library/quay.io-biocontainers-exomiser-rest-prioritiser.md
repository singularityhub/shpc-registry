...
updated_at: "2025-01-19 03:14:28.687585"
latest: "14.1.0--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/exomiser-rest-prioritiser:14.1.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/exomiser-rest-prioritiser/14.1.0--hdfd78af_0
$ module help quay.io/biocontainers/exomiser-rest-prioritiser/14.1.0--hdfd78af_0
```
