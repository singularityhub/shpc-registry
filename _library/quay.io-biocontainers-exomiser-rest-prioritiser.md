...
updated_at: "2026-06-27 06:04:36.522787"
latest: "15.1.0--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/exomiser-rest-prioritiser:15.1.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/exomiser-rest-prioritiser/15.1.0--hdfd78af_0
$ module help quay.io/biocontainers/exomiser-rest-prioritiser/15.1.0--hdfd78af_0
```
