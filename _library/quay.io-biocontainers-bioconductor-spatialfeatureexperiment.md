...
updated_at: "2023-08-21 02:44:51.232891"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-spatialfeatureexperiment:1.2.1--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-spatialfeatureexperiment/1.2.1--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-spatialfeatureexperiment/1.2.1--r43hdfd78af_0
```
