...
updated_at: "2026-04-03 15:44:30.533565"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-spatialfeatureexperiment:1.12.1--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-spatialfeatureexperiment/1.12.1--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-spatialfeatureexperiment/1.12.1--r45hdfd78af_0
```
