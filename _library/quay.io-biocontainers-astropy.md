...
updated_at: "2025-09-01 04:49:31.423121"
latest: "6.1.7"
...
```bash
$ shpc install quay.io/biocontainers/astropy:6.1.7
```
...
```bash
$ module load quay.io/biocontainers/astropy/6.1.7
$ module help quay.io/biocontainers/astropy/6.1.7
```
