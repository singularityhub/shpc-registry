...
updated_at: "2026-04-01 04:54:48.057124"
latest: "0.1.16--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/mpra-data-access-portal:0.1.16--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mpra-data-access-portal/0.1.16--hdfd78af_0
$ module help quay.io/biocontainers/mpra-data-access-portal/0.1.16--hdfd78af_0
```
