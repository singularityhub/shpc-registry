---
layout: container
name:  "quay.io/biocontainers/bioconductor-genomicplot"
maintainer: "@vsoch"
...
updated_at: "2024-11-26 03:05:14.001675"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-genomicplot
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-genomicplot:1.0.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-genomicplot/1.0.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-genomicplot/1.0.0--r43hdfd78af_0
```
...
#### bioconductor-genomicplot-shell:
...
#### bioconductor-genomicplot-inspect:
...
#### bioconductor-genomicplot-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-genomicplot-inspect-deffile:
