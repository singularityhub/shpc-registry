...
updated_at: "2024-03-17 02:24:15.112152"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-confessdata:1.30.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-confessdata/1.30.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-confessdata/1.30.0--r43hdfd78af_0
```
