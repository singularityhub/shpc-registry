...
updated_at: "2025-04-19 03:17:31.106735"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hgu95acdf:2.18.0--r44hdfd78af_13
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hgu95acdf/2.18.0--r44hdfd78af_13
$ module help quay.io/biocontainers/bioconductor-hgu95acdf/2.18.0--r44hdfd78af_13
```
