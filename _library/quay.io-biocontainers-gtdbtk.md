...
updated_at: "2025-03-09 02:50:07.540331"
latest: "2.4.0--pyhdfd78af_2"
...
```bash
$ shpc install quay.io/biocontainers/gtdbtk:2.4.0--pyhdfd78af_2
```
...
```bash
$ module load quay.io/biocontainers/gtdbtk/2.4.0--pyhdfd78af_2
$ module help quay.io/biocontainers/gtdbtk/2.4.0--pyhdfd78af_2
```
