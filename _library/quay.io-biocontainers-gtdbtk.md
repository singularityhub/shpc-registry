...
updated_at: "2026-02-03 04:51:20.038616"
...
```bash
$ shpc install quay.io/biocontainers/gtdbtk:2.6.1--pyh1f0d9b5_2
```
...
```bash
$ module load quay.io/biocontainers/gtdbtk/2.6.1--pyh1f0d9b5_2
$ module help quay.io/biocontainers/gtdbtk/2.6.1--pyh1f0d9b5_2
```
