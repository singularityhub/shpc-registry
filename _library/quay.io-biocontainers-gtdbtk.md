...
updated_at: "2026-08-26 03:36:47.994522"
latest: "2.7.2--pyhdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/gtdbtk:2.7.2--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/gtdbtk/2.7.2--pyhdfd78af_1
$ module help quay.io/biocontainers/gtdbtk/2.7.2--pyhdfd78af_1
```
