...
updated_at: "2024-03-22 03:03:41.072486"
...
```bash
$ shpc install quay.io/biocontainers/gtdbtk:2.3.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/gtdbtk/2.3.2--pyhdfd78af_0
$ module help quay.io/biocontainers/gtdbtk/2.3.2--pyhdfd78af_0
```
