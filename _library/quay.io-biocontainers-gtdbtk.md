...
updated_at: "2026-01-05 06:11:52.457763"
latest: "2.6.1--pyh1f0d9b5_0"
...
```bash
$ shpc install quay.io/biocontainers/gtdbtk:2.6.1--pyh1f0d9b5_0
```
...
```bash
$ module load quay.io/biocontainers/gtdbtk/2.6.1--pyh1f0d9b5_0
$ module help quay.io/biocontainers/gtdbtk/2.6.1--pyh1f0d9b5_0
```
