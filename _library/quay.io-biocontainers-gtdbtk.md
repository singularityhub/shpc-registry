...
updated_at: "2024-07-28 02:49:26.321310"
...
```bash
$ shpc install quay.io/biocontainers/gtdbtk:2.4.0--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/gtdbtk/2.4.0--pyhdfd78af_1
$ module help quay.io/biocontainers/gtdbtk/2.4.0--pyhdfd78af_1
```
