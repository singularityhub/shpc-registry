...
updated_at: "2026-03-31 04:39:07.976984"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-seqsqc:1.32.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-seqsqc/1.32.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-seqsqc/1.32.0--r45hdfd78af_0
```
