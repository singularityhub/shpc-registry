...
updated_at: "2025-10-21 03:11:45.590107"
...
```bash
$ shpc install quay.io/biocontainers/sopa:2.1.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sopa/2.1.4--pyhdfd78af_0
$ module help quay.io/biocontainers/sopa/2.1.4--pyhdfd78af_0
```
