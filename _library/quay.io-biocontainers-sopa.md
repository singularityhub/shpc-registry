...
updated_at: "2025-05-27 12:44:12.719254"
...
```bash
$ shpc install quay.io/biocontainers/sopa:2.0.6--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sopa/2.0.6--pyhdfd78af_0
$ module help quay.io/biocontainers/sopa/2.0.6--pyhdfd78af_0
```
