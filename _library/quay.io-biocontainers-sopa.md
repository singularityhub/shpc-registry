...
updated_at: "2026-09-22 07:55:31.549042"
...
```bash
$ shpc install quay.io/biocontainers/sopa:2.2.11--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sopa/2.2.11--pyhdfd78af_0
$ module help quay.io/biocontainers/sopa/2.2.11--pyhdfd78af_0
```
