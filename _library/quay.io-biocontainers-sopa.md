...
updated_at: "2025-12-15 03:49:10.172525"
...
```bash
$ shpc install quay.io/biocontainers/sopa:2.1.10--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sopa/2.1.10--pyhdfd78af_0
$ module help quay.io/biocontainers/sopa/2.1.10--pyhdfd78af_0
```
