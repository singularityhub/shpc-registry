...
updated_at: "2025-09-23 03:06:12.381371"
...
```bash
$ shpc install quay.io/biocontainers/sopa:2.1.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sopa/2.1.3--pyhdfd78af_0
$ module help quay.io/biocontainers/sopa/2.1.3--pyhdfd78af_0
```
