...
updated_at: "2026-05-20 06:45:10.464366"
latest: "2.2.6--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/sopa:2.2.6--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sopa/2.2.6--pyhdfd78af_0
$ module help quay.io/biocontainers/sopa/2.2.6--pyhdfd78af_0
```
