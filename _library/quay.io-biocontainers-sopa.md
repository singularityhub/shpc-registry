...
updated_at: "2026-06-26 06:30:40.571250"
...
```bash
$ shpc install quay.io/biocontainers/sopa:2.2.8--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sopa/2.2.8--pyhdfd78af_0
$ module help quay.io/biocontainers/sopa/2.2.8--pyhdfd78af_0
```
