...
updated_at: "2025-12-11 04:12:30.293752"
...
```bash
$ shpc install quay.io/biocontainers/sopa:2.1.6--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sopa/2.1.6--pyhdfd78af_0
$ module help quay.io/biocontainers/sopa/2.1.6--pyhdfd78af_0
```
