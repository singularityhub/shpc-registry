...
updated_at: "2026-04-23 19:40:54.051881"
...
```bash
$ shpc install quay.io/biocontainers/sopa:2.2.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sopa/2.2.5--pyhdfd78af_0
$ module help quay.io/biocontainers/sopa/2.2.5--pyhdfd78af_0
```
