...
updated_at: "2026-08-16 03:54:08.446842"
latest: "2.2.10--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/sopa:2.2.10--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sopa/2.2.10--pyhdfd78af_0
$ module help quay.io/biocontainers/sopa/2.2.10--pyhdfd78af_0
```
