...
updated_at: "2026-07-26 05:41:47.687532"
...
```bash
$ shpc install quay.io/biocontainers/sopa:2.2.9--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sopa/2.2.9--pyhdfd78af_0
$ module help quay.io/biocontainers/sopa/2.2.9--pyhdfd78af_0
```
