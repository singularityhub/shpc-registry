...
updated_at: "2026-02-05 04:21:36.391814"
...
```bash
$ shpc install quay.io/biocontainers/sopa:2.1.11--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sopa/2.1.11--pyhdfd78af_0
$ module help quay.io/biocontainers/sopa/2.1.11--pyhdfd78af_0
```
