...
updated_at: "2025-07-05 03:49:44.694227"
...
```bash
$ shpc install quay.io/biocontainers/sopa:2.0.7--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sopa/2.0.7--pyhdfd78af_0
$ module help quay.io/biocontainers/sopa/2.0.7--pyhdfd78af_0
```
