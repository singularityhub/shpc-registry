...
updated_at: "2025-04-16 05:01:22.297341"
latest: "1.04.45--h7b50bb2_0"
...
```bash
$ shpc install quay.io/biocontainers/lastz:1.04.45--h7b50bb2_0
```
...
```bash
$ module load quay.io/biocontainers/lastz/1.04.45--h7b50bb2_0
$ module help quay.io/biocontainers/lastz/1.04.45--h7b50bb2_0
```
