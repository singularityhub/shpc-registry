...
updated_at: "2026-03-29 04:49:43.399819"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-iseede:1.8.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-iseede/1.8.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-iseede/1.8.0--r45hdfd78af_0
```
