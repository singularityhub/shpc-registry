...
updated_at: "2022-10-27 00:25:28.755015"
...
aliases:
 ...
 - ".bioconductor-tcgawgbsdata.hg19-pre-unlink.sh"
versions:
 - "1.8.0--r40hdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-tcgawgbsdata.hg19:1.8.0--r40hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-tcgawgbsdata.hg19/1.8.0--r40hdfd78af_1
$ module help quay.io/biocontainers/bioconductor-tcgawgbsdata.hg19/1.8.0--r40hdfd78af_1
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-tcgawgbsdata.hg19-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-tcgawgbsdata.hg19-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-tcgawgbsdata.hg19-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-tcgawgbsdata.hg19-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-tcgawgbsdata.hg19-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-tcgawgbsdata.hg19-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
