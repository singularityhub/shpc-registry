...
updated_at: "2024-02-04 03:09:45.137397"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-synlet:2.2.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-synlet/2.2.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-synlet/2.2.0--r43hdfd78af_0
```
