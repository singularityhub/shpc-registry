...
updated_at: "2026-03-01 05:04:45.721855"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-synlet:2.10.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-synlet/2.10.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-synlet/2.10.0--r45hdfd78af_0
```
