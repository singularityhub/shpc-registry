...
updated_at: "2025-03-25 03:04:15.146103"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-omicsprint:1.26.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-omicsprint/1.26.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-omicsprint/1.26.0--r44hdfd78af_0
```
