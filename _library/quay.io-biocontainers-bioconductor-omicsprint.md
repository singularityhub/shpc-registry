...
updated_at: "2023-11-23 02:31:48.531480"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-omicsprint:1.20.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-omicsprint/1.20.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-omicsprint/1.20.0--r43hdfd78af_0
```
