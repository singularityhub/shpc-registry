...
updated_at: "2024-03-07 00:06:01.562141"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-omicsprint:1.22.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-omicsprint/1.22.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-omicsprint/1.22.0--r43hdfd78af_0
```
