---
layout: container
name:  "quay.io/biocontainers/bioconductor-cigarillo"
maintainer: "@vsoch"
...
updated_at: "2026-03-20 04:49:35.148550"
...
singularity registry hpc automated addition for bioconductor-cigarillo
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/bioconductor-cigarillo
```
...
#### bioconductor-cigarillo-inspect:
...
#### bioconductor-cigarillo-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-cigarillo-inspect-deffile:
