...
updated_at: "2026-06-15 07:48:55.629975"
...
```bash
$ shpc install quay.io/biocontainers/zipstrain:0.9.14--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/zipstrain/0.9.14--pyhdfd78af_0
$ module help quay.io/biocontainers/zipstrain/0.9.14--pyhdfd78af_0
```
