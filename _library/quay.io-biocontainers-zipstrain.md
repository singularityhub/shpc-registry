...
updated_at: "2026-02-17 05:46:25.992197"
...
```bash
$ shpc install quay.io/biocontainers/zipstrain:0.4.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/zipstrain/0.4.2--pyhdfd78af_0
$ module help quay.io/biocontainers/zipstrain/0.4.2--pyhdfd78af_0
```
