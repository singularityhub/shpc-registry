...
updated_at: "2026-08-13 04:21:44.814977"
...
```bash
$ shpc install quay.io/biocontainers/zipstrain:0.11.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/zipstrain/0.11.1--pyhdfd78af_0
$ module help quay.io/biocontainers/zipstrain/0.11.1--pyhdfd78af_0
```
