...
updated_at: "2025-12-01 05:44:30.314430"
...
```bash
$ shpc install quay.io/biocontainers/zipstrain:0.1.7--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/zipstrain/0.1.7--pyhdfd78af_0
$ module help quay.io/biocontainers/zipstrain/0.1.7--pyhdfd78af_0
```
