...
updated_at: "2026-05-12 06:24:55.997662"
...
```bash
$ shpc install quay.io/biocontainers/zipstrain:0.7.6--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/zipstrain/0.7.6--pyhdfd78af_0
$ module help quay.io/biocontainers/zipstrain/0.7.6--pyhdfd78af_0
```
