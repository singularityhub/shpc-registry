...
updated_at: "2026-06-25 06:34:19.054525"
...
```bash
$ shpc install quay.io/biocontainers/zipstrain:0.9.21--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/zipstrain/0.9.21--pyhdfd78af_0
$ module help quay.io/biocontainers/zipstrain/0.9.21--pyhdfd78af_0
```
