...
updated_at: "2022-10-29 08:05:49.264140"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-messina:1.30.0--r41hc247a5b_2
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-messina/1.30.0--r41hc247a5b_2
$ module help quay.io/biocontainers/bioconductor-messina/1.30.0--r41hc247a5b_2
```
