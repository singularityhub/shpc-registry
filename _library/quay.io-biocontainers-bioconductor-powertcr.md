...
updated_at: "2026-03-13 17:14:50.574383"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-powertcr:1.30.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-powertcr/1.30.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-powertcr/1.30.0--r45hdfd78af_0
```
