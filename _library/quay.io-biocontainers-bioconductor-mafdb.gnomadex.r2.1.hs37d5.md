...
updated_at: "2022-10-29 18:04:43.319309"
latest: "3.8.0--r36_2"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mafdb.gnomadex.r2.1.hs37d5:3.8.0--r36_2
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mafdb.gnomadex.r2.1.hs37d5/3.8.0--r36_2
$ module help quay.io/biocontainers/bioconductor-mafdb.gnomadex.r2.1.hs37d5/3.8.0--r36_2
```
