...
updated_at: "2026-03-21 05:05:15.572251"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mafdb.gnomadex.r2.1.hs37d5:3.10.0--r45hdfd78af_11
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mafdb.gnomadex.r2.1.hs37d5/3.10.0--r45hdfd78af_11
$ module help quay.io/biocontainers/bioconductor-mafdb.gnomadex.r2.1.hs37d5/3.10.0--r45hdfd78af_11
```
