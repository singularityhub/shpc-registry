...
updated_at: "2023-07-09 03:30:46.749481"
latest: "1.50.0--r42hba55f59_1"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hyperdraw:1.50.0--r42hba55f59_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hyperdraw/1.50.0--r42hba55f59_1
$ module help quay.io/biocontainers/bioconductor-hyperdraw/1.50.0--r42hba55f59_1
```
