...
updated_at: "2026-02-27 04:56:12.746800"
latest: "1.62.0--r45hef64f4b_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hyperdraw:1.62.0--r45hef64f4b_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hyperdraw/1.62.0--r45hef64f4b_0
$ module help quay.io/biocontainers/bioconductor-hyperdraw/1.62.0--r45hef64f4b_0
```
