...
updated_at: "2022-10-27 00:54:10.322324"
latest: "0.1.4--py27_0"
...
```bash
$ shpc install quay.io/biocontainers/myriad
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/myriad:0.1.4--py27_0
```
...
```bash
$ module load quay.io/biocontainers/myriad/0.1.4--py27_0
$ module help quay.io/biocontainers/myriad/0.1.4--py27_0
```
...
#### myriad-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### myriad-inspect-deffile:
