---
layout: container
name:  "quay.io/biocontainers/cawlign"
maintainer: "@vsoch"
...
updated_at: "2026-01-24 04:01:12.290233"
latest: "0.1.16--he91c24d_0"
...
```bash
$ shpc install quay.io/biocontainers/cawlign
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/cawlign:0.1.16--he91c24d_0
```
...
```bash
$ module load quay.io/biocontainers/cawlign/0.1.16--he91c24d_0
$ module help quay.io/biocontainers/cawlign/0.1.16--he91c24d_0
```
...
#### cawlign-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### cawlign-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/cawlign
$ podman run --it --rm --entrypoint /usr/local/bin/cawlign   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/cawlign   -v ${PWD} -w ${PWD} <container> -c " $@"
```
