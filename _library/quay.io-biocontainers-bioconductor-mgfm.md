...
updated_at: "2022-11-25 00:16:31.855395"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mgfm:1.28.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mgfm/1.28.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-mgfm/1.28.0--r41hdfd78af_0
```
