...
updated_at: "2026-04-01 05:06:50.921339"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mgfm:1.44.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mgfm/1.44.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-mgfm/1.44.0--r45hdfd78af_0
```
