...
updated_at: "2025-04-16 05:10:18.577870"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mgfm:1.40.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mgfm/1.40.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-mgfm/1.40.0--r44hdfd78af_0
```
