...
updated_at: "2025-02-23 02:55:10.710692"
...
```bash
$ shpc install quay.io/pawsey/pytorch:2.6.0-rocm6.2.2
```
...
```bash
$ module load quay.io/pawsey/pytorch/2.6.0-rocm6.2.2
$ module help quay.io/pawsey/pytorch/2.6.0-rocm6.2.2
```
