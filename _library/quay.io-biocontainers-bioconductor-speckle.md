---
layout: container
name:  "quay.io/biocontainers/bioconductor-speckle"
maintainer: "@vsoch"
...
updated_at: "2023-08-06 03:10:13.991936"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-speckle
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-speckle:1.0.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-speckle/1.0.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-speckle/1.0.0--r43hdfd78af_0
```
...
#### bioconductor-speckle-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-speckle-inspect-deffile:
