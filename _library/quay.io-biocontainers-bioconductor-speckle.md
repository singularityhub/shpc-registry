...
updated_at: "2024-12-03 03:08:36.819740"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-speckle:1.2.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-speckle/1.2.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-speckle/1.2.0--r43hdfd78af_0
```
