...
updated_at: "2025-09-27 03:38:53.755622"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ecoliprobe:2.18.0--r44hdfd78af_13
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ecoliprobe/2.18.0--r44hdfd78af_13
$ module help quay.io/biocontainers/bioconductor-ecoliprobe/2.18.0--r44hdfd78af_13
```
