...
updated_at: "2023-10-07 03:16:39.236045"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-flowtrans:1.52.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-flowtrans/1.52.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-flowtrans/1.52.0--r43hdfd78af_0
```
