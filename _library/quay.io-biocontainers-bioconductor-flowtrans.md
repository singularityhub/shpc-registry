...
updated_at: "2022-10-29 05:48:44.723190"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-flowtrans:1.46.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-flowtrans/1.46.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-flowtrans/1.46.0--r41hdfd78af_0
```
