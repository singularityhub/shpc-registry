---
layout: container
name:  "quay.io/biocontainers/r-heattree"
maintainer: "@vsoch"
...
updated_at: "2026-04-05 04:48:32.352358"
...
singularity registry hpc automated addition for r-heattree
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/r-heattree
```
...
#### r-heattree-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-heattree-inspect-deffile:
