...
updated_at: "2022-10-29 05:30:21.319053"
...
```bash
$ shpc install quay.io/biocontainers/hhsuite:v3.2.0--py36pl526hf484d3e_0
```
...
```bash
$ module load quay.io/biocontainers/hhsuite/v3.2.0--py36pl526hf484d3e_0
$ module help quay.io/biocontainers/hhsuite/v3.2.0--py36pl526hf484d3e_0
```
