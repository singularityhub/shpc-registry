...
updated_at: "2023-07-09 03:34:23.937603"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-esatac:1.20.0--r42hf17093f_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-esatac/1.20.0--r42hf17093f_1
$ module help quay.io/biocontainers/bioconductor-esatac/1.20.0--r42hf17093f_1
```
