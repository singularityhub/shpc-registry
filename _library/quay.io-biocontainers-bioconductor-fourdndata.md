...
updated_at: "2023-12-04 03:24:10.863679"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-fourdndata:1.0.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-fourdndata/1.0.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-fourdndata/1.0.0--r43hdfd78af_0
```
