---
layout: container
name:  "quay.io/biocontainers/bioconductor-fourdndata"
maintainer: "@vsoch"
...
updated_at: "2026-03-27 05:00:49.140640"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-fourdndata
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-fourdndata:1.10.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-fourdndata/1.10.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-fourdndata/1.10.0--r45hdfd78af_0
```
...
#### bioconductor-fourdndata-inspect:
...
#### bioconductor-fourdndata-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-fourdndata-inspect-deffile:
