...
updated_at: "2022-10-29 05:46:35.501611"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-setools:1.8.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-setools/1.8.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-setools/1.8.0--r41hdfd78af_0
```
