...
updated_at: "2024-03-13 02:23:42.240641"
latest: "2.16.0rc0"
...
```bash
$ shpc install tensorflow/tensorflow:2.16.0rc0
```
...
```bash
$ module load tensorflow/tensorflow/2.16.0rc0
$ module help tensorflow/tensorflow/2.16.0rc0
```
