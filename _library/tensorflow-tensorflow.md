...
updated_at: "2023-10-09 03:29:07.008800"
latest: "2.14.0rc1"
...
```bash
$ shpc install tensorflow/tensorflow:2.14.0rc1
```
...
```bash
$ module load tensorflow/tensorflow/2.14.0rc1
$ module help tensorflow/tensorflow/2.14.0rc1
```
