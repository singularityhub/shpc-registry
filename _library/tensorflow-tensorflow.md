...
updated_at: "2024-08-20 03:25:55.288737"
latest: "2.17.0rc1"
...
```bash
$ shpc install tensorflow/tensorflow:2.17.0rc1
```
...
```bash
$ module load tensorflow/tensorflow/2.17.0rc1
$ module help tensorflow/tensorflow/2.17.0rc1
```
