...
updated_at: "2025-10-23 03:07:24.547004"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ctrap:1.24.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ctrap/1.24.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ctrap/1.24.0--r44hdfd78af_0
```
