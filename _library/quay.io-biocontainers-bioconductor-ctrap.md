...
updated_at: "2026-03-31 04:53:10.530785"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ctrap:1.28.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ctrap/1.28.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ctrap/1.28.0--r45hdfd78af_0
```
