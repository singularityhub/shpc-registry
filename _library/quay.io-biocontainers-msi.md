...
updated_at: "2025-09-11 05:28:30.096152"
...
```bash
$ shpc install quay.io/biocontainers/msi:0.3.8--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/msi/0.3.8--hdfd78af_0
$ module help quay.io/biocontainers/msi/0.3.8--hdfd78af_0
```
