...
updated_at: "2025-10-17 03:09:54.012272"
latest: "1.5.0--py310ha6711e0_1"
...
```bash
$ shpc install quay.io/biocontainers/advntr:1.5.0--py310ha6711e0_1
```
...
```bash
$ module load quay.io/biocontainers/advntr/1.5.0--py310ha6711e0_1
$ module help quay.io/biocontainers/advntr/1.5.0--py310ha6711e0_1
```
