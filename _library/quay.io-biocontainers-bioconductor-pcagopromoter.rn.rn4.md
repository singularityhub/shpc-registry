...
updated_at: "2022-11-14 23:58:13.469460"
latest: "1.26.0--r40hdfd78af_1"
container_url: "https://biocontainers.pro/tools/bioconductor-pcagopromoter.rn.rn4"
aliases:
 - ".bioconductor-pcagopromoter.rn.rn4-post-link.sh"
 - ".bioconductor-pcagopromoter.rn.rn4-pre-unlink.sh"
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-pcagopromoter.rn.rn4-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-pcagopromoter.rn.rn4-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-pcagopromoter.rn.rn4-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-pcagopromoter.rn.rn4-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-pcagopromoter.rn.rn4-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-pcagopromoter.rn.rn4-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
