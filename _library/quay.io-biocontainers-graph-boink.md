...
updated_at: "2022-10-27 00:55:53.467809"
latest: "0.9.1--py38h8b12597_0"
...
```bash
$ shpc install quay.io/biocontainers/graph-boink:0.9.1--py38h8b12597_0
```
...
```bash
$ module load quay.io/biocontainers/graph-boink/0.9.1--py38h8b12597_0
$ module help quay.io/biocontainers/graph-boink/0.9.1--py38h8b12597_0
```
