...
updated_at: "2024-11-19 03:16:11.021758"
latest: "4.0_beta--hdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/hmftools-sage:4.0_beta--hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/hmftools-sage/4.0_beta--hdfd78af_1
$ module help quay.io/biocontainers/hmftools-sage/4.0_beta--hdfd78af_1
```
