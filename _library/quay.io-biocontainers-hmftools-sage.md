...
updated_at: "2026-04-03 16:00:24.677675"
...
```bash
$ shpc install quay.io/biocontainers/hmftools-sage:4.2--hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/hmftools-sage/4.2--hdfd78af_1
$ module help quay.io/biocontainers/hmftools-sage/4.2--hdfd78af_1
```
