...
updated_at: "2026-06-30 06:28:02.484193"
...
```bash
$ shpc install quay.io/biocontainers/hmftools-sage:5.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hmftools-sage/5.0--hdfd78af_0
$ module help quay.io/biocontainers/hmftools-sage/5.0--hdfd78af_0
```
