...
updated_at: "2026-01-13 03:49:50.200571"
...
```bash
$ shpc install quay.io/biocontainers/hmftools-sage:4.2--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hmftools-sage/4.2--hdfd78af_0
$ module help quay.io/biocontainers/hmftools-sage/4.2--hdfd78af_0
```
