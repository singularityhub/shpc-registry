...
updated_at: "2022-11-22 01:27:08.190022"
...
```bash
$ shpc install quay.io/biocontainers/vadr:1.5--pl5321hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/vadr/1.5--pl5321hdfd78af_0
$ module help quay.io/biocontainers/vadr/1.5--pl5321hdfd78af_0
```
...
```bash
$ singularity exec <container> /usr/local/bin/.vadr-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.vadr-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.vadr-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
