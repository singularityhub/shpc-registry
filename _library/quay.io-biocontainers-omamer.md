...
updated_at: "2025-03-19 03:23:52.445094"
...
```bash
$ shpc install quay.io/biocontainers/omamer:2.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/omamer/2.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/omamer/2.1.0--pyhdfd78af_0
```
