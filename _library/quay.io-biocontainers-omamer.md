...
updated_at: "2024-04-20 03:00:58.016867"
...
```bash
$ shpc install quay.io/biocontainers/omamer:2.0.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/omamer/2.0.3--pyhdfd78af_0
$ module help quay.io/biocontainers/omamer/2.0.3--pyhdfd78af_0
```
