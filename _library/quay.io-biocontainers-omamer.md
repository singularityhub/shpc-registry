...
updated_at: "2025-07-30 03:50:59.382961"
latest: "2.1.0--pyhdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/omamer:2.1.0--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/omamer/2.1.0--pyhdfd78af_1
$ module help quay.io/biocontainers/omamer/2.1.0--pyhdfd78af_1
```
