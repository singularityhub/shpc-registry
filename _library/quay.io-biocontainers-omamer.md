...
updated_at: "2024-08-06 03:17:31.950509"
...
```bash
$ shpc install quay.io/biocontainers/omamer:2.0.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/omamer/2.0.4--pyhdfd78af_0
$ module help quay.io/biocontainers/omamer/2.0.4--pyhdfd78af_0
```
