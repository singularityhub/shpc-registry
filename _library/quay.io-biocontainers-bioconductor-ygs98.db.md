...
updated_at: "2022-10-27 00:29:02.869920"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ygs98.db:3.2.3--r41hdfd78af_7
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ygs98.db/3.2.3--r41hdfd78af_7
$ module help quay.io/biocontainers/bioconductor-ygs98.db/3.2.3--r41hdfd78af_7
```
