---
layout: container
name:  "quay.io/biocontainers/xmlbuilder"
maintainer: "@vsoch"
...
updated_at: "2025-08-24 03:48:03.073355"
latest: "1.0--py27_1"
...
```bash
$ shpc install quay.io/biocontainers/xmlbuilder
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/xmlbuilder:1.0--py27_1
```
...
```bash
$ module load quay.io/biocontainers/xmlbuilder/1.0--py27_1
$ module help quay.io/biocontainers/xmlbuilder/1.0--py27_1
```
...
#### xmlbuilder-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### xmlbuilder-inspect-deffile:
