...
updated_at: "2025-12-07 04:21:19.225329"
latest: "1.4.2--py310h1fe012e_1"
...
```bash
$ shpc install quay.io/biocontainers/pytrf:1.4.2--py310h1fe012e_1
```
...
```bash
$ module load quay.io/biocontainers/pytrf/1.4.2--py310h1fe012e_1
$ module help quay.io/biocontainers/pytrf/1.4.2--py310h1fe012e_1
```
