...
updated_at: "2025-10-06 06:39:26.085949"
latest: "1.4.2--py39hbcbf7aa_0"
...
```bash
$ shpc install quay.io/biocontainers/pytrf:1.4.2--py39hbcbf7aa_0
```
...
```bash
$ module load quay.io/biocontainers/pytrf/1.4.2--py39hbcbf7aa_0
$ module help quay.io/biocontainers/pytrf/1.4.2--py39hbcbf7aa_0
```
