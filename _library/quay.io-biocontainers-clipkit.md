...
updated_at: "2025-08-06 04:00:27.417545"
...
```bash
$ shpc install quay.io/biocontainers/clipkit:2.4.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/clipkit/2.4.1--pyhdfd78af_0
$ module help quay.io/biocontainers/clipkit/2.4.1--pyhdfd78af_0
```
