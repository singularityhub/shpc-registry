...
updated_at: "2023-12-04 03:33:55.110931"
...
```bash
$ shpc install quay.io/biocontainers/clipkit:2.1.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/clipkit/2.1.1--pyhdfd78af_0
$ module help quay.io/biocontainers/clipkit/2.1.1--pyhdfd78af_0
```
