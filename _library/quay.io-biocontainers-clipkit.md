...
updated_at: "2023-08-20 02:20:40.972492"
...
```bash
$ shpc install quay.io/biocontainers/clipkit:2.0.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/clipkit/2.0.1--pyhdfd78af_0
$ module help quay.io/biocontainers/clipkit/2.0.1--pyhdfd78af_0
```
