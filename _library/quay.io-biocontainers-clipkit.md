...
updated_at: "2024-08-05 03:05:54.703342"
...
```bash
$ shpc install quay.io/biocontainers/clipkit:2.3.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/clipkit/2.3.0--pyhdfd78af_0
$ module help quay.io/biocontainers/clipkit/2.3.0--pyhdfd78af_0
```
