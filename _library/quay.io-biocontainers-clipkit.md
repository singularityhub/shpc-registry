...
updated_at: "2023-05-15 02:57:23.562272"
...
```bash
$ shpc install quay.io/biocontainers/clipkit:1.4.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/clipkit/1.4.1--pyhdfd78af_0
$ module help quay.io/biocontainers/clipkit/1.4.1--pyhdfd78af_0
```
