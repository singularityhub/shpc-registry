...
updated_at: "2024-04-04 03:48:41.102759"
...
```bash
$ shpc install quay.io/biocontainers/primerforge:0.7.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/primerforge/0.7.4--pyhdfd78af_0
$ module help quay.io/biocontainers/primerforge/0.7.4--pyhdfd78af_0
```
