...
updated_at: "2026-03-09 04:31:24.058482"
latest: "3.22.0--r45h01b2380_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-lea:3.22.0--r45h01b2380_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-lea/3.22.0--r45h01b2380_0
$ module help quay.io/biocontainers/bioconductor-lea/3.22.0--r45h01b2380_0
```
