...
updated_at: "2022-11-03 00:56:06.394153"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-onassis:1.8.0--r36_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-onassis/1.8.0--r36_1
$ module help quay.io/biocontainers/bioconductor-onassis/1.8.0--r36_1
```
