...
updated_at: "2025-11-14 03:38:52.022569"
...
```bash
$ shpc install quay.io/biocontainers/edentity:1.5.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/edentity/1.5.2--pyhdfd78af_0
$ module help quay.io/biocontainers/edentity/1.5.2--pyhdfd78af_0
```
