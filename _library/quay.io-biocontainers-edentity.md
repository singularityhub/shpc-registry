...
updated_at: "2026-09-03 07:09:22.827841"
latest: "1.5.9--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/edentity:1.5.9--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/edentity/1.5.9--pyhdfd78af_0
$ module help quay.io/biocontainers/edentity/1.5.9--pyhdfd78af_0
```
