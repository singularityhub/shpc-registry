...
updated_at: "2025-06-29 04:11:30.072489"
...
```bash
$ shpc install quay.io/biocontainers/edentity:1.4.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/edentity/1.4.5--pyhdfd78af_0
$ module help quay.io/biocontainers/edentity/1.4.5--pyhdfd78af_0
```
