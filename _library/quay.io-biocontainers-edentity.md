...
updated_at: "2026-06-26 02:10:28.287179"
latest: "1.5.8--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/edentity:1.5.8--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/edentity/1.5.8--pyhdfd78af_0
$ module help quay.io/biocontainers/edentity/1.5.8--pyhdfd78af_0
```
