...
updated_at: "2026-06-06 15:56:54.685775"
...
```bash
$ shpc install quay.io/biocontainers/edentity:1.5.7--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/edentity/1.5.7--pyhdfd78af_0
$ module help quay.io/biocontainers/edentity/1.5.7--pyhdfd78af_0
```
