...
updated_at: "2026-09-26 07:41:19.836705"
...
```bash
$ shpc install quay.io/biocontainers/edentity:1.6.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/edentity/1.6.0--pyhdfd78af_0
$ module help quay.io/biocontainers/edentity/1.6.0--pyhdfd78af_0
```
