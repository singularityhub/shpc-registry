...
updated_at: "2026-02-05 04:40:30.678805"
...
```bash
$ shpc install quay.io/biocontainers/edentity:1.5.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/edentity/1.5.3--pyhdfd78af_0
$ module help quay.io/biocontainers/edentity/1.5.3--pyhdfd78af_0
```
