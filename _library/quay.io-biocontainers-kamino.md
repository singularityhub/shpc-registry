...
updated_at: "2026-09-22 08:01:37.415361"
...
```bash
$ shpc install quay.io/biocontainers/kamino:2.2.0--hab7d0fd_0
```
...
```bash
$ module load quay.io/biocontainers/kamino/2.2.0--hab7d0fd_0
$ module help quay.io/biocontainers/kamino/2.2.0--hab7d0fd_0
```
