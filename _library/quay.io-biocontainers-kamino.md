...
updated_at: "2026-08-14 04:14:33.334973"
...
```bash
$ shpc install quay.io/biocontainers/kamino:2.0.0--hab7d0fd_0
```
...
```bash
$ module load quay.io/biocontainers/kamino/2.0.0--hab7d0fd_0
$ module help quay.io/biocontainers/kamino/2.0.0--hab7d0fd_0
```
