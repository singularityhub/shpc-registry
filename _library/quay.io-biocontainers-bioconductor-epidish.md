...
updated_at: "2026-04-05 05:23:27.272135"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-epidish:2.26.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-epidish/2.26.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-epidish/2.26.0--r45hdfd78af_0
```
