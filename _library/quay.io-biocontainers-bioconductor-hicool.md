...
updated_at: "2024-10-25 03:41:41.838856"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hicool:1.2.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hicool/1.2.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-hicool/1.2.0--r43hdfd78af_0
```
