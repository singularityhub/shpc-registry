...
updated_at: "2022-10-29 17:48:54.434969"
latest: "1.0.5--r36_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-panther.db:1.0.5--r36_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-panther.db/1.0.5--r36_0
$ module help quay.io/biocontainers/bioconductor-panther.db/1.0.5--r36_0
```
