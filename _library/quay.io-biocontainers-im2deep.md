...
updated_at: "2026-02-04 04:38:41.726378"
...
```bash
$ shpc install quay.io/biocontainers/im2deep:1.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/im2deep/1.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/im2deep/1.2.0--pyhdfd78af_0
```
