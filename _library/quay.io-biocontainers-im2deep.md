...
updated_at: "2025-02-15 03:31:13.854181"
...
```bash
$ shpc install quay.io/biocontainers/im2deep:0.3.1--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/im2deep/0.3.1--pyhdfd78af_1
$ module help quay.io/biocontainers/im2deep/0.3.1--pyhdfd78af_1
```
