...
updated_at: "2024-09-27 03:18:26.805920"
...
```bash
$ shpc install quay.io/biocontainers/im2deep:0.1.9--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/im2deep/0.1.9--pyhdfd78af_0
$ module help quay.io/biocontainers/im2deep/0.1.9--pyhdfd78af_0
```
