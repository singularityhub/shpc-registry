...
updated_at: "2025-09-01 03:31:11.270224"
...
```bash
$ shpc install quay.io/biocontainers/im2deep:1.0.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/im2deep/1.0.3--pyhdfd78af_0
$ module help quay.io/biocontainers/im2deep/1.0.3--pyhdfd78af_0
```
