...
updated_at: "2025-03-09 02:46:53.669938"
...
```bash
$ shpc install quay.io/biocontainers/im2deep:1.0.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/im2deep/1.0.2--pyhdfd78af_0
$ module help quay.io/biocontainers/im2deep/1.0.2--pyhdfd78af_0
```
