...
updated_at: "2026-08-04 05:44:42.920058"
...
```bash
$ shpc install quay.io/biocontainers/im2deep:2.0.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/im2deep/2.0.2--pyhdfd78af_0
$ module help quay.io/biocontainers/im2deep/2.0.2--pyhdfd78af_0
```
