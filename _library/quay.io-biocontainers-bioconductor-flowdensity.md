...
updated_at: "2024-11-18 16:49:59.538422"
latest: "1.36.1--r43h92aedd1_1"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-flowdensity:1.36.1--r43h92aedd1_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-flowdensity/1.36.1--r43h92aedd1_1
$ module help quay.io/biocontainers/bioconductor-flowdensity/1.36.1--r43h92aedd1_1
```
