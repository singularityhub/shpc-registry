...
updated_at: "2023-09-02 03:12:30.130262"
latest: "1.34.0--r43hf0b54c8_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-flowdensity:1.34.0--r43hf0b54c8_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-flowdensity/1.34.0--r43hf0b54c8_0
$ module help quay.io/biocontainers/bioconductor-flowdensity/1.34.0--r43hf0b54c8_0
```
