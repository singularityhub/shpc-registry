...
updated_at: "2026-02-26 05:07:53.746171"
latest: "1.44.0--r45h6f29ec1_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-flowdensity:1.44.0--r45h6f29ec1_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-flowdensity/1.44.0--r45h6f29ec1_0
$ module help quay.io/biocontainers/bioconductor-flowdensity/1.44.0--r45h6f29ec1_0
```
