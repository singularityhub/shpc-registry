...
updated_at: "2024-02-28 02:46:15.507234"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-flowdensity:1.36.1--r43hf0b54c8_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-flowdensity/1.36.1--r43hf0b54c8_0
$ module help quay.io/biocontainers/bioconductor-flowdensity/1.36.1--r43hf0b54c8_0
```
