---
layout: container
name:  "quay.io/biocontainers/h5max"
maintainer: "@vsoch"
...
updated_at: "2026-02-25 05:00:22.272507"
...
versions:
 - "0.3.4--pyhdfd78af_0"
description: "singularity registry hpc automated addition for h5max"
config: {"url": "https://biocontainers.pro/tools/h5max", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for h5max", "latest": {"0.3.4--pyhdfd78af_0": "sha256:464999ca5b2771d5aad5bae7b22d993eb3b0a17882a583cfdef9fdd0b67db06c"}, "tags": {"0.3.4--pyhdfd78af_0": "sha256:464999ca5b2771d5aad5bae7b22d993eb3b0a17882a583cfdef9fdd0b67db06c"}, "docker": "quay.io/biocontainers/h5max", "aliases": {"h5fuse": "/usr/local/bin/h5fuse", "idle3.14": "/usr/local/bin/idle3.14", "pydoc3.14": "/usr/local/bin/pydoc3.14", "python3.14": "/usr/local/bin/python3.14", "python3.14-config": "/usr/local/bin/python3.14-config", "h5delete": "/usr/local/bin/h5delete", "numpy-config": "/usr/local/bin/numpy-config", "h5fc": "/usr/local/bin/h5fc", "gif2h5": "/usr/local/bin/gif2h5", "h52gif": "/usr/local/bin/h52gif", "h5c++": "/usr/local/bin/h5c++", "h5cc": "/usr/local/bin/h5cc", "h5clear": "/usr/local/bin/h5clear", "h5format_convert": "/usr/local/bin/h5format_convert", "h5watch": "/usr/local/bin/h5watch", "h5redeploy": "/usr/local/bin/h5redeploy", "h5copy": "/usr/local/bin/h5copy", "h5debug": "/usr/local/bin/h5debug", "h5diff": "/usr/local/bin/h5diff", "h5import": "/usr/local/bin/h5import", "h5jam": "/usr/local/bin/h5jam", "h5ls": "/usr/local/bin/h5ls", "h5mkgrp": "/usr/local/bin/h5mkgrp", "h5perf_serial": "/usr/local/bin/h5perf_serial", "h5repack": "/usr/local/bin/h5repack"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/h5max.
singularity registry hpc automated addition for h5max
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/h5max
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/h5max:0.3.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/h5max/0.3.4--pyhdfd78af_0
$ module help quay.io/biocontainers/h5max/0.3.4--pyhdfd78af_0
```
...
#### h5max-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### h5max-inspect-deffile:
