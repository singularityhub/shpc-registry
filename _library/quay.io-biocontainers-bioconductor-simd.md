...
updated_at: "2023-07-04 03:53:20.906001"
latest: "1.16.0--r42ha9d7317_1"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-simd:1.16.0--r42ha9d7317_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-simd/1.16.0--r42ha9d7317_1
$ module help quay.io/biocontainers/bioconductor-simd/1.16.0--r42ha9d7317_1
```
