...
updated_at: "2025-04-13 04:46:37.507859"
latest: "1.42.0--r44h15a9599_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cner:1.42.0--r44h15a9599_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cner/1.42.0--r44h15a9599_0
$ module help quay.io/biocontainers/bioconductor-cner/1.42.0--r44h15a9599_0
```
