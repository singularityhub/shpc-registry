...
updated_at: "2024-05-02 02:50:07.325816"
latest: "2.7.11b--h43eeafb_1"
...
```bash
$ shpc install quay.io/biocontainers/star:2.7.11b--h43eeafb_1
```
...
```bash
$ module load quay.io/biocontainers/star/2.7.11b--h43eeafb_1
$ module help quay.io/biocontainers/star/2.7.11b--h43eeafb_1
```
