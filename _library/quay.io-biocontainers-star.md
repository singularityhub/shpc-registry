...
updated_at: "2024-12-02 03:40:33.580688"
latest: "2.7.11b--h43eeafb_2"
...
```bash
$ shpc install quay.io/biocontainers/star:2.7.11b--h43eeafb_2
```
...
```bash
$ module load quay.io/biocontainers/star/2.7.11b--h43eeafb_2
$ module help quay.io/biocontainers/star/2.7.11b--h43eeafb_2
```
