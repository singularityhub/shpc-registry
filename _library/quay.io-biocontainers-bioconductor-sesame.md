...
updated_at: "2023-08-05 03:08:47.404888"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-sesame:1.16.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-sesame/1.16.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-sesame/1.16.0--r42hdfd78af_0
```
