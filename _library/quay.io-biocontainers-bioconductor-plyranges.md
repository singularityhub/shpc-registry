...
updated_at: "2023-04-27 02:53:28.285260"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-plyranges:1.18.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-plyranges/1.18.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-plyranges/1.18.0--r42hdfd78af_0
```
