...
updated_at: "2026-04-01 05:42:33.892234"
latest: "1.30.1--r45hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-plyranges:1.30.1--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-plyranges/1.30.1--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-plyranges/1.30.1--r45hdfd78af_0
```
