...
updated_at: "2023-08-11 02:59:21.918000"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-plyranges:1.20.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-plyranges/1.20.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-plyranges/1.20.0--r43hdfd78af_0
```
