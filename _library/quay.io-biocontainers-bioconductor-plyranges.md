...
updated_at: "2022-11-05 00:01:41.836692"
latest: "1.8.0--r40_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-plyranges:1.8.0--r40_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-plyranges/1.8.0--r40_0
$ module help quay.io/biocontainers/bioconductor-plyranges/1.8.0--r40_0
```
