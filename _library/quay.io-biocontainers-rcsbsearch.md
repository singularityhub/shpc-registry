---
layout: container
name:  "quay.io/biocontainers/rcsbsearch"
maintainer: "@vsoch"
...
updated_at: "2023-01-16 02:49:22.387907"
...
```bash
$ shpc install quay.io/biocontainers/rcsbsearch
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/rcsbsearch:0.2.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/rcsbsearch/0.2.3--pyhdfd78af_0
$ module help quay.io/biocontainers/rcsbsearch/0.2.3--pyhdfd78af_0
```
...
#### rcsbsearch-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### rcsbsearch-inspect-deffile:
