...
updated_at: "2022-10-29 05:59:15.761090"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-normalize450k:1.22.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-normalize450k/1.22.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-normalize450k/1.22.0--r41hdfd78af_0
```
