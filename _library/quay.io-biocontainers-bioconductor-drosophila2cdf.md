...
updated_at: "2024-05-27 03:07:09.512052"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-drosophila2cdf:2.18.0--r43hdfd78af_12
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-drosophila2cdf/2.18.0--r43hdfd78af_12
$ module help quay.io/biocontainers/bioconductor-drosophila2cdf/2.18.0--r43hdfd78af_12
```
