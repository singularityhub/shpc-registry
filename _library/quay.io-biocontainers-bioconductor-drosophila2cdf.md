...
updated_at: "2023-10-21 02:35:00.918881"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-drosophila2cdf:2.18.0--r43hdfd78af_11
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-drosophila2cdf/2.18.0--r43hdfd78af_11
$ module help quay.io/biocontainers/bioconductor-drosophila2cdf/2.18.0--r43hdfd78af_11
```
