...
updated_at: "2026-04-04 04:47:46.495335"
...
```bash
$ shpc install quay.io/biocontainers/mhcflurry:2.2.0--pyh106432d_0
```
...
```bash
$ module load quay.io/biocontainers/mhcflurry/2.2.0--pyh106432d_0
$ module help quay.io/biocontainers/mhcflurry/2.2.0--pyh106432d_0
```
