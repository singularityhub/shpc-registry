...
updated_at: "2024-06-30 02:52:26.454767"
...
```bash
$ shpc install quay.io/biocontainers/mhcflurry:2.1.1--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/mhcflurry/2.1.1--pyh7cba7a3_0
$ module help quay.io/biocontainers/mhcflurry/2.1.1--pyh7cba7a3_0
```
