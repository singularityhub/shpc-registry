...
updated_at: "2026-06-12 07:31:14.846834"
...
```bash
$ shpc install quay.io/biocontainers/mhcflurry:2.2.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mhcflurry/2.2.1--pyhdfd78af_0
$ module help quay.io/biocontainers/mhcflurry/2.2.1--pyhdfd78af_0
```
