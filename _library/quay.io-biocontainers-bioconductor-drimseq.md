...
updated_at: "2026-01-20 04:00:04.509376"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-drimseq:1.34.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-drimseq/1.34.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-drimseq/1.34.0--r44hdfd78af_0
```
