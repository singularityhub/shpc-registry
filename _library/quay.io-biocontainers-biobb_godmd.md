...
updated_at: "2023-08-28 03:09:42.761830"
...
```bash
$ shpc install quay.io/biocontainers/biobb_godmd:4.0.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_godmd/4.0.2--pyhdfd78af_0
$ module help quay.io/biocontainers/biobb_godmd/4.0.2--pyhdfd78af_0
```
