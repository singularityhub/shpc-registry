...
updated_at: "2026-04-05 05:15:29.164467"
...
```bash
$ shpc install quay.io/biocontainers/biobb_godmd:5.2.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_godmd/5.2.1--pyhdfd78af_0
$ module help quay.io/biocontainers/biobb_godmd/5.2.1--pyhdfd78af_0
```
