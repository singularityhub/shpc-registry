...
updated_at: "2026-04-02 05:13:12.244862"
latest: "5.2.0--pyhdfd78af_3"
...
```bash
$ shpc install quay.io/biocontainers/biobb_godmd:5.2.0--pyhdfd78af_3
```
...
```bash
$ module load quay.io/biocontainers/biobb_godmd/5.2.0--pyhdfd78af_3
$ module help quay.io/biocontainers/biobb_godmd/5.2.0--pyhdfd78af_3
```
