...
updated_at: "2024-11-19 03:17:31.336467"
...
```bash
$ shpc install quay.io/biocontainers/biobb_godmd:4.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_godmd/4.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/biobb_godmd/4.2.0--pyhdfd78af_0
```
