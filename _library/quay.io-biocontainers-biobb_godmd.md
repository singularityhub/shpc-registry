...
updated_at: "2024-01-15 03:32:36.563994"
...
```bash
$ shpc install quay.io/biocontainers/biobb_godmd:4.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_godmd/4.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/biobb_godmd/4.1.0--pyhdfd78af_0
```
