...
updated_at: "2026-08-21 19:11:04.320357"
...
```bash
$ shpc install quay.io/biocontainers/biobb_godmd:5.3.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_godmd/5.3.0--pyhdfd78af_0
$ module help quay.io/biocontainers/biobb_godmd/5.3.0--pyhdfd78af_0
```
