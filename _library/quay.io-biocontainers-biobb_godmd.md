...
updated_at: "2026-01-28 04:07:56.698445"
...
```bash
$ shpc install quay.io/biocontainers/biobb_godmd:5.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_godmd/5.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/biobb_godmd/5.2.0--pyhdfd78af_0
```
