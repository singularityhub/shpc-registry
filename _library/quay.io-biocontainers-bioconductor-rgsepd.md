...
updated_at: "2025-08-04 04:24:39.767195"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rgsepd:1.38.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rgsepd/1.38.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rgsepd/1.38.0--r44hdfd78af_0
```
