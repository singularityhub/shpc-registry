...
updated_at: "2026-09-05 06:56:27.903159"
latest: "0.9.5.0--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/sanntis:0.9.5.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sanntis/0.9.5.0--pyhdfd78af_0
$ module help quay.io/biocontainers/sanntis/0.9.5.0--pyhdfd78af_0
```
