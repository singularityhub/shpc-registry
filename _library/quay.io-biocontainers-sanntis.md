...
updated_at: "2023-08-22 02:24:37.576740"
latest: "0.9.3.2--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/sanntis:0.9.3.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sanntis/0.9.3.2--pyhdfd78af_0
$ module help quay.io/biocontainers/sanntis/0.9.3.2--pyhdfd78af_0
```
