...
updated_at: "2025-03-23 03:29:45.195523"
latest: "0.9.4.0--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/sanntis:0.9.4.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sanntis/0.9.4.0--pyhdfd78af_0
$ module help quay.io/biocontainers/sanntis/0.9.4.0--pyhdfd78af_0
```
