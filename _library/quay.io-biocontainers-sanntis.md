...
updated_at: "2024-01-11 03:52:06.258630"
latest: "0.9.3.4--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/sanntis:0.9.3.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sanntis/0.9.3.4--pyhdfd78af_0
$ module help quay.io/biocontainers/sanntis/0.9.3.4--pyhdfd78af_0
```
