...
updated_at: "2023-04-15 02:55:58.896536"
...
```bash
$ shpc install quay.io/biocontainers/sanntis:0.9.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/sanntis/0.9.1--pyhdfd78af_0
$ module help quay.io/biocontainers/sanntis/0.9.1--pyhdfd78af_0
```
