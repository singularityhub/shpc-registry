...
updated_at: "2023-10-23 03:14:37.649420"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hthgu133afrmavecs:1.3.0--r43hdfd78af_11
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hthgu133afrmavecs/1.3.0--r43hdfd78af_11
$ module help quay.io/biocontainers/bioconductor-hthgu133afrmavecs/1.3.0--r43hdfd78af_11
```
