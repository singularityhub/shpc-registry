...
updated_at: "2025-04-29 03:42:52.834650"
latest: "0.9.1--pyhdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/pytaxonkit:0.9.1--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/pytaxonkit/0.9.1--pyhdfd78af_1
$ module help quay.io/biocontainers/pytaxonkit/0.9.1--pyhdfd78af_1
```
