---
layout: container
name:  "quay.io/biocontainers/assaycode"
maintainer: "@vsoch"
...
updated_at: "2026-08-06 05:32:03.804363"
...
singularity registry hpc automated addition for assaycode
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/assaycode
```
...
#### assaycode-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### assaycode-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/assaycode
$ podman run --it --rm --entrypoint /usr/local/bin/assaycode   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/assaycode   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/dotmatch
$ podman run --it --rm --entrypoint /usr/local/bin/dotmatch   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/dotmatch   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/quickdna
$ podman run --it --rm --entrypoint /usr/local/bin/quickdna   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/quickdna   -v ${PWD} -w ${PWD} <container> -c " $@"
```
