...
updated_at: "2024-06-01 03:19:29.701301"
latest: "1.0.22--h8b853e6_5"
...
```bash
$ shpc install quay.io/biocontainers/gsalign:1.0.22--h8b853e6_5
```
...
```bash
$ module load quay.io/biocontainers/gsalign/1.0.22--h8b853e6_5
$ module help quay.io/biocontainers/gsalign/1.0.22--h8b853e6_5
```
