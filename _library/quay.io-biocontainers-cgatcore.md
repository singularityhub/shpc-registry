...
updated_at: "2024-06-07 02:47:19.135359"
latest: "0.6.16--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/cgatcore:0.6.16--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/cgatcore/0.6.16--pyhdfd78af_0
$ module help quay.io/biocontainers/cgatcore/0.6.16--pyhdfd78af_0
```
