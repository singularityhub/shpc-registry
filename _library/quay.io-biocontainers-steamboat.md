---
layout: container
name:  "quay.io/biocontainers/steamboat"
maintainer: "@vsoch"
...
updated_at: "2025-08-01 11:00:18.581929"
...
```bash
$ shpc install quay.io/biocontainers/steamboat
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/steamboat:1.0.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/steamboat/1.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/steamboat/1.0.0--pyhdfd78af_0
```
...
#### steamboat-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### steamboat-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/gisaid-batch
$ podman run --it --rm --entrypoint /usr/local/bin/gisaid-batch   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/gisaid-batch   -v ${PWD} -w ${PWD} <container> -c " $@"
```
