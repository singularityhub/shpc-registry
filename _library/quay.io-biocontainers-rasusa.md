...
updated_at: "2026-05-11 06:23:53.392221"
latest: "4.0.0--h54198d6_0"
...
```bash
$ shpc install quay.io/biocontainers/rasusa:4.0.0--h54198d6_0
```
...
```bash
$ module load quay.io/biocontainers/rasusa/4.0.0--h54198d6_0
$ module help quay.io/biocontainers/rasusa/4.0.0--h54198d6_0
```
