...
updated_at: "2026-02-26 05:15:06.856971"
latest: "3.0.0--h54198d6_0"
...
```bash
$ shpc install quay.io/biocontainers/rasusa:3.0.0--h54198d6_0
```
...
```bash
$ module load quay.io/biocontainers/rasusa/3.0.0--h54198d6_0
$ module help quay.io/biocontainers/rasusa/3.0.0--h54198d6_0
```
