...
updated_at: "2025-09-08 03:35:23.148986"
latest: "2.1.1--hc1c3326_0"
...
```bash
$ shpc install quay.io/biocontainers/rasusa:2.1.1--hc1c3326_0
```
...
```bash
$ module load quay.io/biocontainers/rasusa/2.1.1--hc1c3326_0
$ module help quay.io/biocontainers/rasusa/2.1.1--hc1c3326_0
```
