...
updated_at: "2024-10-24 03:39:22.202310"
latest: "2.1.0--h715e4b3_0"
...
```bash
$ shpc install quay.io/biocontainers/rasusa:2.1.0--h715e4b3_0
```
...
```bash
$ module load quay.io/biocontainers/rasusa/2.1.0--h715e4b3_0
$ module help quay.io/biocontainers/rasusa/2.1.0--h715e4b3_0
```
