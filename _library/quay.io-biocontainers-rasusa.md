...
updated_at: "2025-11-09 03:20:02.693340"
...
```bash
$ shpc install quay.io/biocontainers/rasusa:2.2.2--hc1c3326_0
```
...
```bash
$ module load quay.io/biocontainers/rasusa/2.2.2--hc1c3326_0
$ module help quay.io/biocontainers/rasusa/2.2.2--hc1c3326_0
```
