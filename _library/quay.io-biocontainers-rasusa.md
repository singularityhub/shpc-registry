...
updated_at: "2024-07-27 02:43:03.576031"
latest: "2.0.0--h715e4b3_2"
...
```bash
$ shpc install quay.io/biocontainers/rasusa:2.0.0--h715e4b3_2
```
...
```bash
$ module load quay.io/biocontainers/rasusa/2.0.0--h715e4b3_2
$ module help quay.io/biocontainers/rasusa/2.0.0--h715e4b3_2
```
