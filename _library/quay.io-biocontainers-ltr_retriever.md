...
updated_at: "2024-09-06 03:21:33.199491"
...
```bash
$ shpc install quay.io/biocontainers/ltr_retriever:3.0.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ltr_retriever/3.0.0--hdfd78af_0
$ module help quay.io/biocontainers/ltr_retriever/3.0.0--hdfd78af_0
```
