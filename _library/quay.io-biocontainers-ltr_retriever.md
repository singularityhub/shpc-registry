...
updated_at: "2026-03-31 04:55:17.891574"
...
```bash
$ shpc install quay.io/biocontainers/ltr_retriever:3.0.5--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ltr_retriever/3.0.5--hdfd78af_0
$ module help quay.io/biocontainers/ltr_retriever/3.0.5--hdfd78af_0
```
