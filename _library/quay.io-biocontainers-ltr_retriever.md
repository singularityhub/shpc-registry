...
updated_at: "2025-04-24 03:31:21.389610"
...
```bash
$ shpc install quay.io/biocontainers/ltr_retriever:3.0.2--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ltr_retriever/3.0.2--hdfd78af_0
$ module help quay.io/biocontainers/ltr_retriever/3.0.2--hdfd78af_0
```
