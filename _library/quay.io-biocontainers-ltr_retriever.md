...
updated_at: "2025-03-30 03:32:34.395983"
...
```bash
$ shpc install quay.io/biocontainers/ltr_retriever:3.0.1--hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/ltr_retriever/3.0.1--hdfd78af_1
$ module help quay.io/biocontainers/ltr_retriever/3.0.1--hdfd78af_1
```
