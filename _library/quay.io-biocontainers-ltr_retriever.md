...
updated_at: "2024-10-28 03:03:01.429161"
...
```bash
$ shpc install quay.io/biocontainers/ltr_retriever:3.0.1--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ltr_retriever/3.0.1--hdfd78af_0
$ module help quay.io/biocontainers/ltr_retriever/3.0.1--hdfd78af_0
```
