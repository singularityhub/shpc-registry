...
updated_at: "2025-09-20 03:16:10.633759"
latest: "3.0.4--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/ltr_retriever:3.0.4--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ltr_retriever/3.0.4--hdfd78af_0
$ module help quay.io/biocontainers/ltr_retriever/3.0.4--hdfd78af_0
```
