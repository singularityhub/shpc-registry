---
layout: container
name:  "quay.io/biocontainers/syngap"
maintainer: "@vsoch"
...
updated_at: "2024-03-25 02:47:24.287579"
latest: "1.1.1--h086e186_0"
...
```bash
$ shpc install quay.io/biocontainers/syngap
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/syngap:1.1.1--h086e186_0
```
...
```bash
$ module load quay.io/biocontainers/syngap/1.1.1--h086e186_0
$ module help quay.io/biocontainers/syngap/1.1.1--h086e186_0
```
...
#### syngap-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### syngap-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/SynGAP.py
$ podman run --it --rm --entrypoint /usr/local/bin/SynGAP.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/SynGAP.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/custom.py
$ podman run --it --rm --entrypoint /usr/local/bin/custom.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/custom.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/dual.py
$ podman run --it --rm --entrypoint /usr/local/bin/dual.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/dual.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/evi.py
$ podman run --it --rm --entrypoint /usr/local/bin/evi.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/evi.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/eviplot.py
$ podman run --it --rm --entrypoint /usr/local/bin/eviplot.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/eviplot.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/genepair.py
$ podman run --it --rm --entrypoint /usr/local/bin/genepair.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/genepair.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/protoc-gen-mypy
$ podman run --it --rm --entrypoint /usr/local/bin/protoc-gen-mypy   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/protoc-gen-mypy   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/protoc-gen-mypy_grpc
$ podman run --it --rm --entrypoint /usr/local/bin/protoc-gen-mypy_grpc   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/protoc-gen-mypy_grpc   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/syngap
$ podman run --it --rm --entrypoint /usr/local/bin/syngap   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/syngap   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/triple.py
$ podman run --it --rm --entrypoint /usr/local/bin/triple.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/triple.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
