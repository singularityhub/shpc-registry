...
updated_at: "2026-06-20 06:29:24.012148"
latest: "6.0.8--pyh05cac1d_0"
...
```bash
$ shpc install quay.io/biocontainers/rgi:6.0.8--pyh05cac1d_0
```
...
```bash
$ module load quay.io/biocontainers/rgi/6.0.8--pyh05cac1d_0
$ module help quay.io/biocontainers/rgi/6.0.8--pyh05cac1d_0
```
