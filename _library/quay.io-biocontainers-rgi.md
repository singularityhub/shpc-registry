...
updated_at: "2025-02-28 03:39:41.880343"
...
```bash
$ shpc install quay.io/biocontainers/rgi:6.0.3--pyha8f3691_1
```
...
```bash
$ module load quay.io/biocontainers/rgi/6.0.3--pyha8f3691_1
$ module help quay.io/biocontainers/rgi/6.0.3--pyha8f3691_1
```
