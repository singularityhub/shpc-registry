...
updated_at: "2025-12-17 03:55:59.345281"
latest: "6.0.5--pyh05cac1d_0"
...
```bash
$ shpc install quay.io/biocontainers/rgi:6.0.5--pyh05cac1d_0
```
...
```bash
$ module load quay.io/biocontainers/rgi/6.0.5--pyh05cac1d_0
$ module help quay.io/biocontainers/rgi/6.0.5--pyh05cac1d_0
```
