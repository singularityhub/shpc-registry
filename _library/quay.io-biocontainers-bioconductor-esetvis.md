...
updated_at: "2026-03-29 04:47:33.160102"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-esetvis:1.36.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-esetvis/1.36.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-esetvis/1.36.0--r45hdfd78af_0
```
