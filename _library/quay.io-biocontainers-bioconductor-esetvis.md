...
updated_at: "2022-10-29 05:46:12.630675"
latest: "1.8.0--r351_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-esetvis:1.8.0--r351_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-esetvis/1.8.0--r351_0
$ module help quay.io/biocontainers/bioconductor-esetvis/1.8.0--r351_0
```
