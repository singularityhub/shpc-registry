...
updated_at: "2026-04-03 05:27:23.043922"
latest: "0.9.4--h7f5d12c_0"
...
```bash
$ shpc install quay.io/biocontainers/oarfish:0.9.4--h7f5d12c_0
```
...
```bash
$ module load quay.io/biocontainers/oarfish/0.9.4--h7f5d12c_0
$ module help quay.io/biocontainers/oarfish/0.9.4--h7f5d12c_0
```
