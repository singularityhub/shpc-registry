...
updated_at: "2026-03-08 04:41:36.612371"
latest: "0.9.3--h5ca1c30_0"
...
```bash
$ shpc install quay.io/biocontainers/oarfish:0.9.3--h5ca1c30_0
```
...
```bash
$ module load quay.io/biocontainers/oarfish/0.9.3--h5ca1c30_0
$ module help quay.io/biocontainers/oarfish/0.9.3--h5ca1c30_0
```
