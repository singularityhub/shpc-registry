...
updated_at: "2026-02-04 04:51:51.172529"
latest: "0.9.2--h5ca1c30_0"
...
```bash
$ shpc install quay.io/biocontainers/oarfish:0.9.2--h5ca1c30_0
```
...
```bash
$ module load quay.io/biocontainers/oarfish/0.9.2--h5ca1c30_0
$ module help quay.io/biocontainers/oarfish/0.9.2--h5ca1c30_0
```
