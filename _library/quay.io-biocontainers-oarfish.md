...
updated_at: "2026-08-28 14:10:46.881378"
...
```bash
$ shpc install quay.io/biocontainers/oarfish:0.10.3--hd727d2a_0
```
...
```bash
$ module load quay.io/biocontainers/oarfish/0.10.3--hd727d2a_0
$ module help quay.io/biocontainers/oarfish/0.10.3--hd727d2a_0
```
