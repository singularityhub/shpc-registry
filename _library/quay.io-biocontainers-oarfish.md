...
updated_at: "2024-10-17 18:44:56.893990"
latest: "0.6.2--hc9368f3_0"
...
```bash
$ shpc install quay.io/biocontainers/oarfish:0.6.2--hc9368f3_0
```
...
```bash
$ module load quay.io/biocontainers/oarfish/0.6.2--hc9368f3_0
$ module help quay.io/biocontainers/oarfish/0.6.2--hc9368f3_0
```
