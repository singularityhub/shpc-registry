...
updated_at: "2025-06-29 03:46:11.568307"
latest: "0.8.1--h5ca1c30_0"
...
```bash
$ shpc install quay.io/biocontainers/oarfish:0.8.1--h5ca1c30_0
```
...
```bash
$ module load quay.io/biocontainers/oarfish/0.8.1--h5ca1c30_0
$ module help quay.io/biocontainers/oarfish/0.8.1--h5ca1c30_0
```
