...
updated_at: "2026-03-30 04:57:59.004363"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ssnappy:1.14.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ssnappy/1.14.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ssnappy/1.14.0--r45hdfd78af_0
```
