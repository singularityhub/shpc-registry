...
updated_at: "2024-01-26 02:58:43.889886"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ssnappy:1.6.1--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ssnappy/1.6.1--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ssnappy/1.6.1--r43hdfd78af_0
```
