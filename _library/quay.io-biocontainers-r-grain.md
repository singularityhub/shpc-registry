...
updated_at: "2023-09-16 23:46:03.623041"
latest: "1.3.14--r43h21a89ab_0"
...
```bash
$ shpc install quay.io/biocontainers/r-grain:1.3.14--r43h21a89ab_0
```
...
```bash
$ module load quay.io/biocontainers/r-grain/1.3.14--r43h21a89ab_0
$ module help quay.io/biocontainers/r-grain/1.3.14--r43h21a89ab_0
```
