...
updated_at: "2023-11-29 02:40:23.352855"
latest: "1.4.0--r43h21a89ab_0"
...
```bash
$ shpc install quay.io/biocontainers/r-grain:1.4.0--r43h21a89ab_0
```
...
```bash
$ module load quay.io/biocontainers/r-grain/1.4.0--r43h21a89ab_0
$ module help quay.io/biocontainers/r-grain/1.4.0--r43h21a89ab_0
```
