...
updated_at: "2023-08-19 03:07:41.286068"
latest: "1.3.13--r43h21a89ab_3"
...
```bash
$ shpc install quay.io/biocontainers/r-grain:1.3.13--r43h21a89ab_3
```
...
```bash
$ module load quay.io/biocontainers/r-grain/1.3.13--r43h21a89ab_3
$ module help quay.io/biocontainers/r-grain/1.3.13--r43h21a89ab_3
```
