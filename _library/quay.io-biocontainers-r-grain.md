...
updated_at: "2024-11-05 03:06:03.892220"
latest: "1.4.2--r43h21a89ab_1"
...
```bash
$ shpc install quay.io/biocontainers/r-grain:1.4.2--r43h21a89ab_1
```
...
```bash
$ module load quay.io/biocontainers/r-grain/1.4.2--r43h21a89ab_1
$ module help quay.io/biocontainers/r-grain/1.4.2--r43h21a89ab_1
```
