...
updated_at: "2025-05-03 03:34:32.497535"
...
```bash
$ shpc install quay.io/biocontainers/r-grain:1.4.5--r44h40dc89f_1
```
...
```bash
$ module load quay.io/biocontainers/r-grain/1.4.5--r44h40dc89f_1
$ module help quay.io/biocontainers/r-grain/1.4.5--r44h40dc89f_1
```
