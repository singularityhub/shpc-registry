...
updated_at: "2022-10-29 05:30:17.626273"
latest: "0.3.9--np113py35_0"
...
config: {"url": "https://biocontainers.pro/tools/pybigwig", "maintainer": "@vsoch", "description": "shpc-registry automated BioContainers addition for pybigwig", "latest": {"0.3.9--np113py35_0": "sha256:8e51b54cea226b58287f1a5639bb5da0da65a39fac5bf99f7660d8552cae1534"}, "tags": {"0.3.9--np113py35_0": "sha256:8e51b54cea226b58287f1a5639bb5da0da65a39fac5bf99f7660d8552cae1534"}, "docker": "quay.io/biocontainers/pybigwig", "aliases": {"2to3-3.5": "/usr/local/bin/2to3-3.5", "idle3.5": "/usr/local/bin/idle3.5", "ncurses5-config": "/usr/local/bin/ncurses5-config", "ncursesw5-config": "/usr/local/bin/ncursesw5-config", "pydoc3.5": "/usr/local/bin/pydoc3.5", "python3.5": "/usr/local/bin/python3.5", "python3.5-config": "/usr/local/bin/python3.5-config", "python3.5m": "/usr/local/bin/python3.5m", "python3.5m-config": "/usr/local/bin/python3.5m-config", "pyvenv": "/usr/local/bin/pyvenv"}}
---
...
```bash
$ shpc install quay.io/biocontainers/pybigwig:0.3.9--np113py35_0
```
...
```bash
$ module load quay.io/biocontainers/pybigwig/0.3.9--np113py35_0
$ module help quay.io/biocontainers/pybigwig/0.3.9--np113py35_0
```
