...
updated_at: "2026-06-20 06:55:39.309804"
latest: "0.3.25--py312hca67b4d_1"
...
```bash
$ shpc install quay.io/biocontainers/pybigwig:0.3.25--py312hca67b4d_1
```
...
```bash
$ module load quay.io/biocontainers/pybigwig/0.3.25--py312hca67b4d_1
$ module help quay.io/biocontainers/pybigwig/0.3.25--py312hca67b4d_1
```
