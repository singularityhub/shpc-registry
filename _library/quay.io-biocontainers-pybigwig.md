...
updated_at: "2026-01-29 04:20:41.279169"
latest: "0.3.25--py39h956d262_0"
...
```bash
$ shpc install quay.io/biocontainers/pybigwig:0.3.25--py39h956d262_0
```
...
```bash
$ module load quay.io/biocontainers/pybigwig/0.3.25--py39h956d262_0
$ module help quay.io/biocontainers/pybigwig/0.3.25--py39h956d262_0
```
