...
updated_at: "2025-04-25 03:31:19.065774"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ihw:1.34.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ihw/1.34.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ihw/1.34.0--r44hdfd78af_0
```
