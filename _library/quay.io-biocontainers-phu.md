...
updated_at: "2026-04-04 05:10:07.711897"
...
```bash
$ shpc install quay.io/biocontainers/phu:0.5.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/phu/0.5.0--pyhdfd78af_0
$ module help quay.io/biocontainers/phu/0.5.0--pyhdfd78af_0
```
