...
updated_at: "2026-08-21 04:00:43.132031"
...
```bash
$ shpc install quay.io/biocontainers/bactopia:4.1.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bactopia/4.1.0--hdfd78af_0
$ module help quay.io/biocontainers/bactopia/4.1.0--hdfd78af_0
```
