...
updated_at: "2026-06-04 00:40:30.865096"
...
```bash
$ shpc install quay.io/biocontainers/bactopia:4.0.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bactopia/4.0.0--hdfd78af_0
$ module help quay.io/biocontainers/bactopia/4.0.0--hdfd78af_0
```
