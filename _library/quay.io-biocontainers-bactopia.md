...
updated_at: "2025-05-27 11:15:11.794590"
...
```bash
$ shpc install quay.io/biocontainers/bactopia:3.2.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bactopia/3.2.0--hdfd78af_0
$ module help quay.io/biocontainers/bactopia/3.2.0--hdfd78af_0
```
