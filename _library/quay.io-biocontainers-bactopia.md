...
updated_at: "2023-12-20 03:47:54.484099"
...
```bash
$ shpc install quay.io/biocontainers/bactopia:3.0.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bactopia/3.0.0--hdfd78af_0
$ module help quay.io/biocontainers/bactopia/3.0.0--hdfd78af_0
```
