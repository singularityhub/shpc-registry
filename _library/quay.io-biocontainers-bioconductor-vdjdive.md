...
updated_at: "2023-11-05 03:05:48.329432"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-vdjdive:1.2.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-vdjdive/1.2.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-vdjdive/1.2.0--r43hdfd78af_0
```
