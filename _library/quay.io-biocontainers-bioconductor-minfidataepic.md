...
updated_at: "2025-04-08 03:48:56.172537"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-minfidataepic:1.32.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-minfidataepic/1.32.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-minfidataepic/1.32.0--r44hdfd78af_0
```
