...
updated_at: "2026-04-04 05:15:25.694823"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-methimpute:1.32.0--r45ha27e39d_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-methimpute/1.32.0--r45ha27e39d_0
$ module help quay.io/biocontainers/bioconductor-methimpute/1.32.0--r45ha27e39d_0
```
