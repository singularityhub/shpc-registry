...
updated_at: "2024-10-07 03:18:29.123497"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-methimpute:1.24.0--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-methimpute/1.24.0--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-methimpute/1.24.0--r43hf17093f_0
```
