...
updated_at: "2023-07-13 04:04:40.346330"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-methimpute:1.20.0--r42hf17093f_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-methimpute/1.20.0--r42hf17093f_1
$ module help quay.io/biocontainers/bioconductor-methimpute/1.20.0--r42hf17093f_1
```
