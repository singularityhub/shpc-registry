---
layout: container
name:  "quay.io/biocontainers/markerrepo"
maintainer: "@vsoch"
...
updated_at: "2026-02-19 07:22:52.396455"
...
singularity registry hpc automated addition for markerrepo
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/markerrepo
```
...
#### markerrepo-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### markerrepo-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/apybiomart
$ podman run --it --rm --entrypoint /usr/local/bin/apybiomart   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/apybiomart   -v ${PWD} -w ${PWD} <container> -c " $@"
```
