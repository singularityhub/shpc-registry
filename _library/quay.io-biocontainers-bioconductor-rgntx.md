...
updated_at: "2026-03-22 05:01:47.899202"
latest: "1.11.1--r45hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rgntx:1.11.1--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rgntx/1.11.1--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rgntx/1.11.1--r45hdfd78af_0
```
