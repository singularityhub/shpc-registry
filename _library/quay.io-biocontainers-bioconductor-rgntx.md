...
updated_at: "2025-04-16 05:26:32.118554"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rgntx:1.8.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rgntx/1.8.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rgntx/1.8.0--r44hdfd78af_0
```
