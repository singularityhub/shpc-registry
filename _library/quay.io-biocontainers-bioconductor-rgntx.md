...
updated_at: "2024-10-26 03:15:53.345512"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rgntx:1.2.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rgntx/1.2.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rgntx/1.2.0--r43hdfd78af_0
```
