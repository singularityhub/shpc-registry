...
updated_at: "2023-09-25 03:22:03.771499"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ndexr:1.22.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ndexr/1.22.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ndexr/1.22.0--r43hdfd78af_0
```
