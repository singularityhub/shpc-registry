...
updated_at: "2026-08-30 08:28:34.514851"
...
```bash
$ shpc install quay.io/biocontainers/pylocuszoom:2.1.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pylocuszoom/2.1.1--pyhdfd78af_0
$ module help quay.io/biocontainers/pylocuszoom/2.1.1--pyhdfd78af_0
```
