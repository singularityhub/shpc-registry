...
updated_at: "2026-02-03 04:57:10.099914"
...
```bash
$ shpc install quay.io/biocontainers/seqsero2s:1.1.4--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/seqsero2s/1.1.4--pyhdfd78af_1
$ module help quay.io/biocontainers/seqsero2s/1.1.4--pyhdfd78af_1
```
