...
updated_at: "2026-01-03 04:02:11.332997"
...
```bash
$ shpc install quay.io/biocontainers/seqsero2s:1.1.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/seqsero2s/1.1.4--pyhdfd78af_0
$ module help quay.io/biocontainers/seqsero2s/1.1.4--pyhdfd78af_0
```
