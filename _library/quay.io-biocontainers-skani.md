...
updated_at: "2025-10-12 03:53:50.519885"
...
```bash
$ shpc install quay.io/biocontainers/skani:0.3.0--ha6fb395_0
```
...
```bash
$ module load quay.io/biocontainers/skani/0.3.0--ha6fb395_0
$ module help quay.io/biocontainers/skani/0.3.0--ha6fb395_0
```
