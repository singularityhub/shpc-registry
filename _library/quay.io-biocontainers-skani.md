...
updated_at: "2023-10-10 02:53:41.567998"
...
```bash
$ shpc install quay.io/biocontainers/skani:0.1.5--h4ac6f70_0
```
...
```bash
$ module load quay.io/biocontainers/skani/0.1.5--h4ac6f70_0
$ module help quay.io/biocontainers/skani/0.1.5--h4ac6f70_0
```
