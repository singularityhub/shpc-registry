...
updated_at: "2023-07-30 02:54:45.225640"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rnainteractmapk:1.38.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rnainteractmapk/1.38.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rnainteractmapk/1.38.0--r43hdfd78af_0
```
