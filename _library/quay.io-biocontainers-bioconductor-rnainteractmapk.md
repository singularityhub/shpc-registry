...
updated_at: "2024-11-11 03:34:33.723584"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rnainteractmapk:1.40.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rnainteractmapk/1.40.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rnainteractmapk/1.40.0--r43hdfd78af_0
```
