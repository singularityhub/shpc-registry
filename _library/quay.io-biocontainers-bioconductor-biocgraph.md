...
updated_at: "2026-03-23 05:02:52.305418"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-biocgraph:1.72.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-biocgraph/1.72.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-biocgraph/1.72.0--r45hdfd78af_0
```
