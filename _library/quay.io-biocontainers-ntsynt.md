...
updated_at: "2024-02-14 02:40:34.764078"
latest: "1.0.0--py39h1f90b4d_0"
...
```bash
$ shpc install quay.io/biocontainers/ntsynt:1.0.0--py39h1f90b4d_0
```
...
```bash
$ module load quay.io/biocontainers/ntsynt/1.0.0--py39h1f90b4d_0
$ module help quay.io/biocontainers/ntsynt/1.0.0--py39h1f90b4d_0
```
