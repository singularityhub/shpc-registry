...
updated_at: "2025-01-06 03:14:40.170157"
latest: "1.0.2--py38h2123bcc_0"
...
```bash
$ shpc install quay.io/biocontainers/ntsynt:1.0.2--py38h2123bcc_0
```
...
```bash
$ module load quay.io/biocontainers/ntsynt/1.0.2--py38h2123bcc_0
$ module help quay.io/biocontainers/ntsynt/1.0.2--py38h2123bcc_0
```
