...
updated_at: "2026-06-29 07:22:35.817472"
latest: "1.0.8--py311h3cb736e_0"
...
```bash
$ shpc install quay.io/biocontainers/ntsynt:1.0.8--py311h3cb736e_0
```
...
```bash
$ module load quay.io/biocontainers/ntsynt/1.0.8--py311h3cb736e_0
$ module help quay.io/biocontainers/ntsynt/1.0.8--py311h3cb736e_0
```
