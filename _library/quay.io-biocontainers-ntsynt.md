...
updated_at: "2024-08-06 03:10:00.779307"
latest: "1.0.1--py311h2a4ad6c_2"
...
```bash
$ shpc install quay.io/biocontainers/ntsynt:1.0.1--py311h2a4ad6c_2
```
...
```bash
$ module load quay.io/biocontainers/ntsynt/1.0.1--py311h2a4ad6c_2
$ module help quay.io/biocontainers/ntsynt/1.0.1--py311h2a4ad6c_2
```
