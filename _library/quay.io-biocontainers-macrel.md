...
updated_at: "2026-08-12 04:37:53.309015"
...
```bash
$ shpc install quay.io/biocontainers/macrel:1.6.1--pyh106432d_0
```
...
```bash
$ module load quay.io/biocontainers/macrel/1.6.1--pyh106432d_0
$ module help quay.io/biocontainers/macrel/1.6.1--pyh106432d_0
```
