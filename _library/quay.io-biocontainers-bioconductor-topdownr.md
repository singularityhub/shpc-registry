...
updated_at: "2026-03-24 04:46:17.490530"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-topdownr:1.32.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-topdownr/1.32.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-topdownr/1.32.0--r45hdfd78af_0
```
