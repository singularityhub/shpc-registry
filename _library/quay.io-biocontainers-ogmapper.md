---
layout: container
name:  "quay.io/biocontainers/ogmapper"
maintainer: "@vsoch"
...
updated_at: "2026-01-02 03:57:15.017813"
...
singularity registry hpc automated addition for ogmapper
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/ogmapper
```
...
#### ogmapper-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### ogmapper-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/ogmapper
$ podman run --it --rm --entrypoint /usr/local/bin/ogmapper   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/ogmapper   -v ${PWD} -w ${PWD} <container> -c " $@"
```
