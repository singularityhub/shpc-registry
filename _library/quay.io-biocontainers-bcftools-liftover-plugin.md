---
layout: container
name:  "quay.io/biocontainers/bcftools-liftover-plugin"
maintainer: "@vsoch"
...
updated_at: "2025-11-11 03:28:12.464482"
...
```bash
$ shpc install quay.io/biocontainers/bcftools-liftover-plugin
```
...
#### bcftools-liftover-plugin-shell:
...
#### bcftools-liftover-plugin-inspect:
...
#### bcftools-liftover-plugin-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bcftools-liftover-plugin-inspect-deffile:
