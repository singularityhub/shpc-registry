...
updated_at: "2026-04-03 15:14:40.010233"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-resolve:1.12.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-resolve/1.12.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-resolve/1.12.0--r45hdfd78af_0
```
