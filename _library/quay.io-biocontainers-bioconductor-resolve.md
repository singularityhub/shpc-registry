...
updated_at: "2023-09-20 03:12:00.021742"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-resolve:1.2.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-resolve/1.2.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-resolve/1.2.0--r43hdfd78af_0
```
