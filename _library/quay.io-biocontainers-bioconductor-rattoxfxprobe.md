...
updated_at: "2026-04-05 04:48:55.808474"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rattoxfxprobe:2.18.0--r45hdfd78af_15
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rattoxfxprobe/2.18.0--r45hdfd78af_15
$ module help quay.io/biocontainers/bioconductor-rattoxfxprobe/2.18.0--r45hdfd78af_15
```
