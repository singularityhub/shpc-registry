...
updated_at: "2025-03-08 02:55:15.017607"
latest: "1.26.0--r44h77050f0_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-dropletutils:1.26.0--r44h77050f0_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-dropletutils/1.26.0--r44h77050f0_0
$ module help quay.io/biocontainers/bioconductor-dropletutils/1.26.0--r44h77050f0_0
```
