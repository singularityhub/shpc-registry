...
updated_at: "2023-06-29 03:55:16.687145"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-dropletutils:1.18.0--r42hf17093f_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-dropletutils/1.18.0--r42hf17093f_1
$ module help quay.io/biocontainers/bioconductor-dropletutils/1.18.0--r42hf17093f_1
```
