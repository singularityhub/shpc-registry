...
updated_at: "2026-03-28 17:05:26.509059"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-dropletutils:1.30.0--r45ha27e39d_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-dropletutils/1.30.0--r45ha27e39d_0
$ module help quay.io/biocontainers/bioconductor-dropletutils/1.30.0--r45ha27e39d_0
```
