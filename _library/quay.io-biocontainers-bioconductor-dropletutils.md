...
updated_at: "2023-08-04 02:50:46.010559"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-dropletutils:1.20.0--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-dropletutils/1.20.0--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-dropletutils/1.20.0--r43hf17093f_0
```
