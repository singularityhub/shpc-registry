...
updated_at: "2025-07-26 03:47:36.831118"
latest: "1.26.0--r44h77050f0_1"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-dropletutils:1.26.0--r44h77050f0_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-dropletutils/1.26.0--r44h77050f0_1
$ module help quay.io/biocontainers/bioconductor-dropletutils/1.26.0--r44h77050f0_1
```
