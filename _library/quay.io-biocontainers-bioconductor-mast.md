...
updated_at: "2026-03-16 05:18:35.689915"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mast:1.36.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mast/1.36.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-mast/1.36.0--r45hdfd78af_0
```
