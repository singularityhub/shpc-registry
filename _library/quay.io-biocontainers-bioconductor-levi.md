...
updated_at: "2022-11-05 00:36:04.923893"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-levi:1.8.0--r40h399db7b_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-levi/1.8.0--r40h399db7b_1
$ module help quay.io/biocontainers/bioconductor-levi/1.8.0--r40h399db7b_1
```
