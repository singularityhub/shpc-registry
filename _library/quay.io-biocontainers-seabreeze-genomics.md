---
layout: container
name:  "quay.io/biocontainers/seabreeze-genomics"
maintainer: "@vsoch"
...
updated_at: "2025-10-21 03:21:19.246754"
...
singularity registry hpc automated addition for seabreeze-genomics
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/seabreeze-genomics
```
...
#### seabreeze-genomics-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### seabreeze-genomics-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/seabreeze
$ podman run --it --rm --entrypoint /usr/local/bin/seabreeze   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/seabreeze   -v ${PWD} -w ${PWD} <container> -c " $@"
```
