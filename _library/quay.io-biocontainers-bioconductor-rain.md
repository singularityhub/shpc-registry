...
updated_at: "2025-03-24 03:13:15.537801"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rain:1.40.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rain/1.40.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rain/1.40.0--r44hdfd78af_0
```
