...
updated_at: "2025-01-01 03:37:01.356674"
latest: "1.8.1--r44hdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/r-oncopharmadb:1.8.1--r44hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/r-oncopharmadb/1.8.1--r44hdfd78af_1
$ module help quay.io/biocontainers/r-oncopharmadb/1.8.1--r44hdfd78af_1
```
