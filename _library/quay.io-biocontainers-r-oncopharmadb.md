...
updated_at: "2025-03-06 03:40:21.522760"
latest: "1.8.7--r44hdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/r-oncopharmadb:1.8.7--r44hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/r-oncopharmadb/1.8.7--r44hdfd78af_1
$ module help quay.io/biocontainers/r-oncopharmadb/1.8.7--r44hdfd78af_1
```
