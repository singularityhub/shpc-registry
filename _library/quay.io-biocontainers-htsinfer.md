...
updated_at: "2024-01-29 02:56:36.744532"
...
```bash
$ shpc install quay.io/biocontainers/htsinfer:0.9.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/htsinfer/0.9.0--pyhdfd78af_0
$ module help quay.io/biocontainers/htsinfer/0.9.0--pyhdfd78af_0
```
