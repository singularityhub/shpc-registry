...
updated_at: "2024-08-01 02:42:55.855400"
...
```bash
$ shpc install quay.io/biocontainers/idba:1.1.3--pl5321h719dbc0_3
```
...
```bash
$ module load quay.io/biocontainers/idba/1.1.3--pl5321h719dbc0_3
$ module help quay.io/biocontainers/idba/1.1.3--pl5321h719dbc0_3
```
