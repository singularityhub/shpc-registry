...
updated_at: "2026-03-31 05:28:04.223089"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-recount:1.36.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-recount/1.36.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-recount/1.36.0--r45hdfd78af_0
```
