...
updated_at: "2023-11-26 02:45:08.845362"
latest: "4.1.3--hdcf5f25_0"
...
```bash
$ shpc install quay.io/biocontainers/spoa:4.1.3--hdcf5f25_0
```
...
```bash
$ module load quay.io/biocontainers/spoa/4.1.3--hdcf5f25_0
$ module help quay.io/biocontainers/spoa/4.1.3--hdcf5f25_0
```
