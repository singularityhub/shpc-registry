...
updated_at: "2023-11-01 02:56:27.930275"
latest: "4.1.2--hdcf5f25_0"
...
```bash
$ shpc install quay.io/biocontainers/spoa:4.1.2--hdcf5f25_0
```
...
```bash
$ module load quay.io/biocontainers/spoa/4.1.2--hdcf5f25_0
$ module help quay.io/biocontainers/spoa/4.1.2--hdcf5f25_0
```
