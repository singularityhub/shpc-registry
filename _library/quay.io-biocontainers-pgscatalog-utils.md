...
updated_at: "2026-02-02 12:11:11.834867"
...
```bash
$ shpc install quay.io/biocontainers/pgscatalog-utils:2.0.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pgscatalog-utils/2.0.2--pyhdfd78af_0
$ module help quay.io/biocontainers/pgscatalog-utils/2.0.2--pyhdfd78af_0
```
