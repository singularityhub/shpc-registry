...
updated_at: "2024-08-10 02:47:07.161416"
...
```bash
$ shpc install quay.io/biocontainers/pgscatalog-utils:1.1.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pgscatalog-utils/1.1.2--pyhdfd78af_0
$ module help quay.io/biocontainers/pgscatalog-utils/1.1.2--pyhdfd78af_0
```
