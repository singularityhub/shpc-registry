...
updated_at: "2024-11-19 03:07:48.285562"
...
```bash
$ shpc install quay.io/biocontainers/pgscatalog-utils:1.4.1--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/pgscatalog-utils/1.4.1--pyhdfd78af_1
$ module help quay.io/biocontainers/pgscatalog-utils/1.4.1--pyhdfd78af_1
```
