...
updated_at: "2024-09-18 03:30:41.676531"
...
```bash
$ shpc install quay.io/biocontainers/pgscatalog-utils:1.3.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pgscatalog-utils/1.3.1--pyhdfd78af_0
$ module help quay.io/biocontainers/pgscatalog-utils/1.3.1--pyhdfd78af_0
```
