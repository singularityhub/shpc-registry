...
updated_at: "2025-05-08 03:57:43.444427"
...
```bash
$ shpc install quay.io/biocontainers/pgscatalog-utils:1.4.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pgscatalog-utils/1.4.4--pyhdfd78af_0
$ module help quay.io/biocontainers/pgscatalog-utils/1.4.4--pyhdfd78af_0
```
