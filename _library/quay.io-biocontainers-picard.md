...
updated_at: "2026-09-04 07:14:59.999548"
...
```bash
$ shpc install quay.io/biocontainers/picard:3.5.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/picard/3.5.0--hdfd78af_0
$ module help quay.io/biocontainers/picard/3.5.0--hdfd78af_0
```
