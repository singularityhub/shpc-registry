...
updated_at: "2026-04-30 08:56:31.734640"
...
```bash
$ shpc install quay.io/biocontainers/treetime:0.12.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/treetime/0.12.0--pyhdfd78af_0
$ module help quay.io/biocontainers/treetime/0.12.0--pyhdfd78af_0
```
