...
updated_at: "2024-08-04 02:39:57.320039"
latest: "0.11.3--pyhdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/treetime:0.11.3--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/treetime/0.11.3--pyhdfd78af_1
$ module help quay.io/biocontainers/treetime/0.11.3--pyhdfd78af_1
```
