...
updated_at: "2023-11-19 03:13:57.611208"
...
```bash
$ shpc install quay.io/biocontainers/treetime:0.11.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/treetime/0.11.1--pyhdfd78af_0
$ module help quay.io/biocontainers/treetime/0.11.1--pyhdfd78af_0
```
