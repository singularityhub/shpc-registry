...
updated_at: "2026-06-18 07:44:55.781672"
...
```bash
$ shpc install quay.io/biocontainers/treetime:0.12.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/treetime/0.12.1--pyhdfd78af_0
$ module help quay.io/biocontainers/treetime/0.12.1--pyhdfd78af_0
```
