...
updated_at: "2024-01-25 02:58:15.863201"
...
```bash
$ shpc install quay.io/biocontainers/treetime:0.11.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/treetime/0.11.2--pyhdfd78af_0
$ module help quay.io/biocontainers/treetime/0.11.2--pyhdfd78af_0
```
