...
updated_at: "2024-07-12 02:55:06.991784"
...
```bash
$ shpc install quay.io/biocontainers/treetime:0.11.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/treetime/0.11.3--pyhdfd78af_0
$ module help quay.io/biocontainers/treetime/0.11.3--pyhdfd78af_0
```
