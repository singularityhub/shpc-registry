---
layout: container
name:  "quay.io/biocontainers/pod5"
maintainer: "@vsoch"
...
updated_at: "2024-10-23 03:07:43.595435"
...
```bash
$ shpc install quay.io/biocontainers/pod5
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/pod5:0.3.15--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pod5/0.3.15--pyhdfd78af_0
$ module help quay.io/biocontainers/pod5/0.3.15--pyhdfd78af_0
```
...
#### pod5-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### pod5-inspect-deffile:
