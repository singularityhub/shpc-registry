...
updated_at: "2026-04-05 04:57:58.728699"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-somaticadata:1.48.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-somaticadata/1.48.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-somaticadata/1.48.0--r45hdfd78af_0
```
