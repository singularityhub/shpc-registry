...
updated_at: "2023-10-13 02:32:26.907347"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-somaticadata:1.38.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-somaticadata/1.38.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-somaticadata/1.38.0--r43hdfd78af_0
```
