...
updated_at: "2024-08-13 03:22:48.430706"
...
```bash
$ shpc install quay.io/biocontainers/synapseclient:4.4.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/synapseclient/4.4.0--pyhdfd78af_0
$ module help quay.io/biocontainers/synapseclient/4.4.0--pyhdfd78af_0
```
