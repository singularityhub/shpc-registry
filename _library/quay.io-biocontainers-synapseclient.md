...
updated_at: "2024-08-08 03:19:55.074078"
...
```bash
$ shpc install quay.io/biocontainers/synapseclient:4.3.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/synapseclient/4.3.0--pyhdfd78af_0
$ module help quay.io/biocontainers/synapseclient/4.3.0--pyhdfd78af_0
```
