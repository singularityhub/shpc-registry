...
updated_at: "2023-09-17 02:58:48.508647"
...
```bash
$ shpc install quay.io/biocontainers/synapseclient:3.0.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/synapseclient/3.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/synapseclient/3.0.0--pyhdfd78af_0
```
