...
updated_at: "2025-04-03 03:42:31.184610"
latest: "0.5.13--py39hbcbf7aa_0"
...
```bash
$ shpc install quay.io/biocontainers/iced:0.5.13--py39hbcbf7aa_0
```
...
```bash
$ module load quay.io/biocontainers/iced/0.5.13--py39hbcbf7aa_0
$ module help quay.io/biocontainers/iced/0.5.13--py39hbcbf7aa_0
```
