...
updated_at: "2025-10-27 04:02:57.260410"
latest: "0.6.0--py312h0fa9677_0"
...
```bash
$ shpc install quay.io/biocontainers/iced:0.6.0--py312h0fa9677_0
```
...
```bash
$ module load quay.io/biocontainers/iced/0.6.0--py312h0fa9677_0
$ module help quay.io/biocontainers/iced/0.6.0--py312h0fa9677_0
```
