...
updated_at: "2025-05-01 03:43:00.148409"
latest: "6.6.3--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/tb-profiler:6.6.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/tb-profiler/6.6.3--pyhdfd78af_0
$ module help quay.io/biocontainers/tb-profiler/6.6.3--pyhdfd78af_0
```
