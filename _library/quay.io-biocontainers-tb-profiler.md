...
updated_at: "2025-04-01 03:30:07.280140"
latest: "6.6.2--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/tb-profiler:6.6.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/tb-profiler/6.6.2--pyhdfd78af_0
$ module help quay.io/biocontainers/tb-profiler/6.6.2--pyhdfd78af_0
```
