...
updated_at: "2025-08-05 03:51:42.336538"
latest: "6.6.4--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/tb-profiler:6.6.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/tb-profiler/6.6.4--pyhdfd78af_0
$ module help quay.io/biocontainers/tb-profiler/6.6.4--pyhdfd78af_0
```
