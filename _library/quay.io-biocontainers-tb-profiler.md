...
updated_at: "2024-10-25 03:20:54.085102"
latest: "6.3.0--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/tb-profiler:6.3.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/tb-profiler/6.3.0--pyhdfd78af_0
$ module help quay.io/biocontainers/tb-profiler/6.3.0--pyhdfd78af_0
```
