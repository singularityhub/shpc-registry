...
updated_at: "2026-02-06 04:57:56.690362"
latest: "6.6.6--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/tb-profiler:6.6.6--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/tb-profiler/6.6.6--pyhdfd78af_0
$ module help quay.io/biocontainers/tb-profiler/6.6.6--pyhdfd78af_0
```
