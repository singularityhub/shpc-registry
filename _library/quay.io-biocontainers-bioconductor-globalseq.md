...
updated_at: "2023-11-29 02:30:16.423837"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-globalseq:1.28.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-globalseq/1.28.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-globalseq/1.28.0--r43hdfd78af_0
```
