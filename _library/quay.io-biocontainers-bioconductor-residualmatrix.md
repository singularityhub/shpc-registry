...
updated_at: "2026-03-29 05:36:22.003037"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-residualmatrix:1.20.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-residualmatrix/1.20.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-residualmatrix/1.20.0--r45hdfd78af_0
```
