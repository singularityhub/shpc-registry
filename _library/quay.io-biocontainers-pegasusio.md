...
updated_at: "2026-09-04 07:22:58.815830"
latest: "0.11.0--py313hab16a5f_0"
...
```bash
$ shpc install quay.io/biocontainers/pegasusio:0.11.0--py313hab16a5f_0
```
...
```bash
$ module load quay.io/biocontainers/pegasusio/0.11.0--py313hab16a5f_0
$ module help quay.io/biocontainers/pegasusio/0.11.0--py313hab16a5f_0
```
