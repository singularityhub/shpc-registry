...
updated_at: "2023-10-26 03:21:12.260274"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-beachmat:2.16.0--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-beachmat/2.16.0--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-beachmat/2.16.0--r43hf17093f_0
```
