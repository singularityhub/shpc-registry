...
updated_at: "2026-04-04 04:28:45.254117"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-beachmat:2.26.0--r45ha27e39d_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-beachmat/2.26.0--r45ha27e39d_0
$ module help quay.io/biocontainers/bioconductor-beachmat/2.26.0--r45ha27e39d_0
```
