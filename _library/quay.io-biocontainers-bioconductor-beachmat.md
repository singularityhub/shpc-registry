...
updated_at: "2024-01-08 03:26:03.397917"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-beachmat:2.18.0--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-beachmat/2.18.0--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-beachmat/2.18.0--r43hf17093f_0
```
