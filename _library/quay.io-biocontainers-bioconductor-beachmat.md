...
updated_at: "2023-06-13 03:09:21.042739"
latest: "2.14.0--r42hf17093f_1"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-beachmat:2.14.0--r42hf17093f_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-beachmat/2.14.0--r42hf17093f_1
$ module help quay.io/biocontainers/bioconductor-beachmat/2.14.0--r42hf17093f_1
```
