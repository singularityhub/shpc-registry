---
layout: container
name:  "quay.io/biocontainers/mofapy2"
maintainer: "@vsoch"
...
updated_at: "2026-09-16 07:24:53.751430"
...
```bash
$ shpc install quay.io/biocontainers/mofapy2
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/mofapy2:0.7.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mofapy2/0.7.5--pyhdfd78af_0
$ module help quay.io/biocontainers/mofapy2/0.7.5--pyhdfd78af_0
```
...
#### mofapy2-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### mofapy2-inspect-deffile:
