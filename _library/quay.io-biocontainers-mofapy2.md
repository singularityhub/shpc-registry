...
updated_at: "2026-06-24 06:38:41.421724"
...
```bash
$ shpc install quay.io/biocontainers/mofapy2:0.7.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mofapy2/0.7.4--pyhdfd78af_0
$ module help quay.io/biocontainers/mofapy2/0.7.4--pyhdfd78af_0
```
