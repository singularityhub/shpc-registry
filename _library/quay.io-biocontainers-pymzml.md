...
updated_at: "2024-04-04 02:36:11.758982"
latest: "2.5.6--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/pymzml:2.5.6--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pymzml/2.5.6--pyhdfd78af_0
$ module help quay.io/biocontainers/pymzml/2.5.6--pyhdfd78af_0
```
