...
updated_at: "2024-05-06 02:50:50.277535"
latest: "2.5.9--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/pymzml:2.5.9--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pymzml/2.5.9--pyhdfd78af_0
$ module help quay.io/biocontainers/pymzml/2.5.9--pyhdfd78af_0
```
