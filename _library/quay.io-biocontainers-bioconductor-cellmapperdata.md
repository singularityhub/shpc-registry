...
updated_at: "2023-09-17 00:09:53.636309"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cellmapperdata:1.26.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cellmapperdata/1.26.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-cellmapperdata/1.26.0--r43hdfd78af_0
```
