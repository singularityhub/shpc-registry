...
updated_at: "2025-08-20 03:38:56.677842"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cellmapperdata:1.32.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cellmapperdata/1.32.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-cellmapperdata/1.32.0--r44hdfd78af_0
```
