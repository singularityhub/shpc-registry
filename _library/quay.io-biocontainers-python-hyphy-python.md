...
updated_at: "2024-08-08 04:00:53.302354"
latest: "0.1.12--py310h3a3b00a_1"
...
```bash
$ shpc install quay.io/biocontainers/python-hyphy-python:0.1.12--py310h3a3b00a_1
```
...
```bash
$ module load quay.io/biocontainers/python-hyphy-python/0.1.12--py310h3a3b00a_1
$ module help quay.io/biocontainers/python-hyphy-python/0.1.12--py310h3a3b00a_1
```
