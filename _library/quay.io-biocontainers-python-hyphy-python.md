...
updated_at: "2024-11-07 08:32:51.998149"
latest: "0.1.12--py311h76ae45d_2"
...
```bash
$ shpc install quay.io/biocontainers/python-hyphy-python:0.1.12--py311h76ae45d_2
```
...
```bash
$ module load quay.io/biocontainers/python-hyphy-python/0.1.12--py311h76ae45d_2
$ module help quay.io/biocontainers/python-hyphy-python/0.1.12--py311h76ae45d_2
```
