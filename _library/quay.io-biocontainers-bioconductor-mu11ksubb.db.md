...
updated_at: "2024-07-17 03:21:29.974296"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mu11ksubb.db:3.13.0--r43hdfd78af_4
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mu11ksubb.db/3.13.0--r43hdfd78af_4
$ module help quay.io/biocontainers/bioconductor-mu11ksubb.db/3.13.0--r43hdfd78af_4
```
