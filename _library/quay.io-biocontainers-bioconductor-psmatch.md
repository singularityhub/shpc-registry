---
layout: container
name:  "quay.io/biocontainers/bioconductor-psmatch"
maintainer: "@vsoch"
...
updated_at: "2026-04-05 04:51:26.899752"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-psmatch
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-psmatch:1.14.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-psmatch/1.14.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-psmatch/1.14.0--r45hdfd78af_0
```
...
#### bioconductor-psmatch-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-psmatch-inspect-deffile:
