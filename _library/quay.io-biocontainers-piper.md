...
updated_at: "2026-06-13 07:09:00.982355"
...
```bash
$ shpc install quay.io/biocontainers/piper:0.15.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/piper/0.15.1--pyhdfd78af_0
$ module help quay.io/biocontainers/piper/0.15.1--pyhdfd78af_0
```
