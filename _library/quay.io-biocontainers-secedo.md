...
updated_at: "2026-01-12 04:27:17.298069"
latest: "1.0.7--ha041835_4"
...
```bash
$ shpc install quay.io/biocontainers/secedo:1.0.7--ha041835_4
```
...
```bash
$ module load quay.io/biocontainers/secedo/1.0.7--ha041835_4
$ module help quay.io/biocontainers/secedo/1.0.7--ha041835_4
```
