...
updated_at: "2026-03-27 04:55:27.896594"
...
```bash
$ shpc install quay.io/biocontainers/nanomonsv:0.8.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/nanomonsv/0.8.2--pyhdfd78af_0
$ module help quay.io/biocontainers/nanomonsv/0.8.2--pyhdfd78af_0
```
