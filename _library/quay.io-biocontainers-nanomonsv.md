...
updated_at: "2026-01-30 04:48:20.149699"
...
```bash
$ shpc install quay.io/biocontainers/nanomonsv:0.8.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/nanomonsv/0.8.1--pyhdfd78af_0
$ module help quay.io/biocontainers/nanomonsv/0.8.1--pyhdfd78af_0
```
