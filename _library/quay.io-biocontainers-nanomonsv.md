...
updated_at: "2026-05-29 07:10:52.390356"
...
```bash
$ shpc install quay.io/biocontainers/nanomonsv:0.9.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/nanomonsv/0.9.0--pyhdfd78af_0
$ module help quay.io/biocontainers/nanomonsv/0.9.0--pyhdfd78af_0
```
