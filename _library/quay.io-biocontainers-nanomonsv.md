...
updated_at: "2023-05-26 02:43:00.762399"
...
```bash
$ shpc install quay.io/biocontainers/nanomonsv:0.5.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/nanomonsv/0.5.1--pyhdfd78af_0
$ module help quay.io/biocontainers/nanomonsv/0.5.1--pyhdfd78af_0
```
