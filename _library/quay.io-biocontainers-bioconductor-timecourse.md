...
updated_at: "2023-11-07 02:56:20.537659"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-timecourse:1.72.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-timecourse/1.72.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-timecourse/1.72.0--r43hdfd78af_0
```
