...
updated_at: "2025-09-18 03:38:14.835606"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-raggedexperiment:1.30.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-raggedexperiment/1.30.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-raggedexperiment/1.30.0--r44hdfd78af_0
```
