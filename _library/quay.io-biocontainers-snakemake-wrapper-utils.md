...
updated_at: "2026-08-06 05:23:53.504784"
...
```bash
$ shpc install quay.io/biocontainers/snakemake-wrapper-utils:0.9.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake-wrapper-utils/0.9.0--pyhdfd78af_0
$ module help quay.io/biocontainers/snakemake-wrapper-utils/0.9.0--pyhdfd78af_0
```
