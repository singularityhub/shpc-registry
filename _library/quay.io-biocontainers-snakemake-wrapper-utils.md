...
updated_at: "2023-07-18 03:38:32.091385"
...
```bash
$ shpc install quay.io/biocontainers/snakemake-wrapper-utils:0.6.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake-wrapper-utils/0.6.0--pyhdfd78af_0
$ module help quay.io/biocontainers/snakemake-wrapper-utils/0.6.0--pyhdfd78af_0
```
