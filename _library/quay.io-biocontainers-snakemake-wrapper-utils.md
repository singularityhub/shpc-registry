...
updated_at: "2023-04-09 03:16:39.350769"
...
```bash
$ shpc install quay.io/biocontainers/snakemake-wrapper-utils:0.5.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake-wrapper-utils/0.5.2--pyhdfd78af_0
$ module help quay.io/biocontainers/snakemake-wrapper-utils/0.5.2--pyhdfd78af_0
```
