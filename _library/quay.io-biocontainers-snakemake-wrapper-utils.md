...
updated_at: "2023-05-29 04:26:12.919102"
...
```bash
$ shpc install quay.io/biocontainers/snakemake-wrapper-utils:0.5.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake-wrapper-utils/0.5.3--pyhdfd78af_0
$ module help quay.io/biocontainers/snakemake-wrapper-utils/0.5.3--pyhdfd78af_0
```
