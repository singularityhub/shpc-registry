...
updated_at: "2026-03-20 00:31:03.373237"
latest: "0.1.5.2--h9f2696a_0"
...
```bash
$ shpc install quay.io/biocontainers/wepp:0.1.5.2--h9f2696a_0
```
...
```bash
$ module load quay.io/biocontainers/wepp/0.1.5.2--h9f2696a_0
$ module help quay.io/biocontainers/wepp/0.1.5.2--h9f2696a_0
```
