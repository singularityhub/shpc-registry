...
updated_at: "2026-05-06 22:10:15.759896"
latest: "0.1.5.4--py311h41363dc_0"
...
```bash
$ shpc install quay.io/biocontainers/wepp:0.1.5.4--py311h41363dc_0
```
...
```bash
$ module load quay.io/biocontainers/wepp/0.1.5.4--py311h41363dc_0
$ module help quay.io/biocontainers/wepp/0.1.5.4--py311h41363dc_0
```
