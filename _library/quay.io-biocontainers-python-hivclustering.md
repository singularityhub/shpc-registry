...
updated_at: "2023-09-04 04:34:16.449136"
latest: "1.6.7--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/python-hivclustering:1.6.7--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/python-hivclustering/1.6.7--pyhdfd78af_0
$ module help quay.io/biocontainers/python-hivclustering/1.6.7--pyhdfd78af_0
```
