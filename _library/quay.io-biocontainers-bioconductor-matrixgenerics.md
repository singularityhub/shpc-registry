...
updated_at: "2024-05-26 02:41:51.604060"
latest: "1.14.0--r43hdfd78af_2"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-matrixgenerics:1.14.0--r43hdfd78af_2
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-matrixgenerics/1.14.0--r43hdfd78af_2
$ module help quay.io/biocontainers/bioconductor-matrixgenerics/1.14.0--r43hdfd78af_2
```
