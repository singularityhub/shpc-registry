...
updated_at: "2026-04-05 05:18:43.609901"
latest: "1.22.0--r45hdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-matrixgenerics:1.22.0--r45hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-matrixgenerics/1.22.0--r45hdfd78af_1
$ module help quay.io/biocontainers/bioconductor-matrixgenerics/1.22.0--r45hdfd78af_1
```
