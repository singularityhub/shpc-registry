...
updated_at: "2023-10-08 02:30:21.261071"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-pcxn:2.22.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-pcxn/2.22.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-pcxn/2.22.0--r43hdfd78af_0
```
