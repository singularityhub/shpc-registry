...
updated_at: "2026-04-04 04:50:08.806010"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-scclassify:1.22.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-scclassify/1.22.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-scclassify/1.22.0--r45hdfd78af_0
```
