...
```bash
$ shpc install quay.io/biocontainers/bioconductor-moe430bcdf:2.18.0--r41hdfd78af_9
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-moe430bcdf/2.18.0--r41hdfd78af_9
$ module help quay.io/biocontainers/bioconductor-moe430bcdf/2.18.0--r41hdfd78af_9
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-moe430bcdf-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-moe430bcdf-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-moe430bcdf-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-moe430bcdf-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-moe430bcdf-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-moe430bcdf-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
