...
updated_at: "2023-09-19 03:08:36.842923"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ogre:1.4.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ogre/1.4.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ogre/1.4.0--r43hdfd78af_0
```
