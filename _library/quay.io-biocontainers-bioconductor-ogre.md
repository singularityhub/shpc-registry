...
updated_at: "2025-01-07 03:12:26.098939"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ogre:1.6.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ogre/1.6.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ogre/1.6.0--r43hdfd78af_0
```
