...
updated_at: "2023-11-26 03:05:42.037273"
...
```bash
$ shpc install quay.io/biocontainers/perl-minion:10.25--pl5321hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/perl-minion/10.25--pl5321hdfd78af_0
$ module help quay.io/biocontainers/perl-minion/10.25--pl5321hdfd78af_0
```
