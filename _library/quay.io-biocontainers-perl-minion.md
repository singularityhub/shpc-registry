...
updated_at: "2024-04-22 03:04:19.696093"
latest: "10.29--pl5321hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/perl-minion:10.29--pl5321hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/perl-minion/10.29--pl5321hdfd78af_0
$ module help quay.io/biocontainers/perl-minion/10.29--pl5321hdfd78af_0
```
