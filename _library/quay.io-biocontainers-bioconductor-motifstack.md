...
updated_at: "2025-02-05 03:04:40.231853"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-motifstack:1.46.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-motifstack/1.46.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-motifstack/1.46.0--r43hdfd78af_0
```
