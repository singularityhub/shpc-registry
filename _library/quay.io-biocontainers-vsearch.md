...
updated_at: "2026-06-06 06:50:50.874985"
latest: "2.31.0--hd2be7a0_0"
...
```bash
$ shpc install quay.io/biocontainers/vsearch:2.31.0--hd2be7a0_0
```
...
```bash
$ module load quay.io/biocontainers/vsearch/2.31.0--hd2be7a0_0
$ module help quay.io/biocontainers/vsearch/2.31.0--hd2be7a0_0
```
