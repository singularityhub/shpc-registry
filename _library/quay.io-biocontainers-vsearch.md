...
updated_at: "2025-11-20 03:36:29.402439"
latest: "2.30.1--hd6d6fdc_0"
...
```bash
$ shpc install quay.io/biocontainers/vsearch:2.30.1--hd6d6fdc_0
```
...
```bash
$ module load quay.io/biocontainers/vsearch/2.30.1--hd6d6fdc_0
$ module help quay.io/biocontainers/vsearch/2.30.1--hd6d6fdc_0
```
