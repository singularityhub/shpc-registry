...
updated_at: "2026-02-04 04:41:15.287857"
latest: "2.30.4--hd6d6fdc_0"
...
```bash
$ shpc install quay.io/biocontainers/vsearch:2.30.4--hd6d6fdc_0
```
...
```bash
$ module load quay.io/biocontainers/vsearch/2.30.4--hd6d6fdc_0
$ module help quay.io/biocontainers/vsearch/2.30.4--hd6d6fdc_0
```
