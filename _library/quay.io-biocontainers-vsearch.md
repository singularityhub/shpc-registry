...
updated_at: "2026-01-06 04:08:36.977724"
latest: "2.30.2--hd6d6fdc_0"
...
```bash
$ shpc install quay.io/biocontainers/vsearch:2.30.2--hd6d6fdc_0
```
...
```bash
$ module load quay.io/biocontainers/vsearch/2.30.2--hd6d6fdc_0
$ module help quay.io/biocontainers/vsearch/2.30.2--hd6d6fdc_0
```
