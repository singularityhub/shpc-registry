...
updated_at: "2026-04-04 04:52:04.119780"
latest: "2.30.6--h0bb26bb_0"
...
```bash
$ shpc install quay.io/biocontainers/vsearch:2.30.6--h0bb26bb_0
```
...
```bash
$ module load quay.io/biocontainers/vsearch/2.30.6--h0bb26bb_0
$ module help quay.io/biocontainers/vsearch/2.30.6--h0bb26bb_0
```
