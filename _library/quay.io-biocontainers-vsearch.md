...
updated_at: "2024-11-12 02:57:37.551363"
latest: "2.29.1--h6a68c12_0"
...
```bash
$ shpc install quay.io/biocontainers/vsearch:2.29.1--h6a68c12_0
```
...
```bash
$ module load quay.io/biocontainers/vsearch/2.29.1--h6a68c12_0
$ module help quay.io/biocontainers/vsearch/2.29.1--h6a68c12_0
```
