...
updated_at: "2025-02-05 03:25:22.012684"
latest: "2.29.3--hd6d6fdc_0"
...
```bash
$ shpc install quay.io/biocontainers/vsearch:2.29.3--hd6d6fdc_0
```
...
```bash
$ module load quay.io/biocontainers/vsearch/2.29.3--hd6d6fdc_0
$ module help quay.io/biocontainers/vsearch/2.29.3--hd6d6fdc_0
```
