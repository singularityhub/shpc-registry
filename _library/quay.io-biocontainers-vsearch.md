...
updated_at: "2024-06-10 02:52:31.114595"
...
```bash
$ shpc install quay.io/biocontainers/vsearch:2.28.1--h6a68c12_0
```
...
```bash
$ module load quay.io/biocontainers/vsearch/2.28.1--h6a68c12_0
$ module help quay.io/biocontainers/vsearch/2.28.1--h6a68c12_0
```
