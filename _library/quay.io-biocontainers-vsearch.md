...
updated_at: "2024-10-07 16:52:07.168623"
latest: "2.29.0--h6a68c12_0"
...
```bash
$ shpc install quay.io/biocontainers/vsearch:2.29.0--h6a68c12_0
```
...
```bash
$ module load quay.io/biocontainers/vsearch/2.29.0--h6a68c12_0
$ module help quay.io/biocontainers/vsearch/2.29.0--h6a68c12_0
```
