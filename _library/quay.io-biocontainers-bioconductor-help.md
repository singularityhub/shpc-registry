...
updated_at: "2024-08-29 11:28:46.276220"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-help:1.60.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-help/1.60.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-help/1.60.0--r43hdfd78af_0
```
