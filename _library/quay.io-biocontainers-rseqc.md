...
updated_at: "2024-11-18 16:43:26.698310"
...
```bash
$ shpc install quay.io/biocontainers/rseqc:5.0.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/rseqc/5.0.4--pyhdfd78af_0
$ module help quay.io/biocontainers/rseqc/5.0.4--pyhdfd78af_0
```
