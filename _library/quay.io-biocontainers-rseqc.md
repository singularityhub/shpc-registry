...
updated_at: "2026-09-02 07:25:05.713394"
...
```bash
$ shpc install quay.io/biocontainers/rseqc:5.0.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/rseqc/5.0.5--pyhdfd78af_0
$ module help quay.io/biocontainers/rseqc/5.0.5--pyhdfd78af_0
```
