...
updated_at: "2023-11-16 03:25:21.281341"
latest: "5.0.3--py310h4b81fae_0"
...
```bash
$ shpc install quay.io/biocontainers/rseqc:5.0.3--py310h4b81fae_0
```
...
```bash
$ module load quay.io/biocontainers/rseqc/5.0.3--py310h4b81fae_0
$ module help quay.io/biocontainers/rseqc/5.0.3--py310h4b81fae_0
```
