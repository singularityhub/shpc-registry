...
updated_at: "2026-01-29 04:40:38.163443"
...
```bash
$ shpc install quay.io/biocontainers/rseqc:5.0.4--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/rseqc/5.0.4--pyhdfd78af_1
$ module help quay.io/biocontainers/rseqc/5.0.4--pyhdfd78af_1
```
