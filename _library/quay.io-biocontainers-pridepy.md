...
updated_at: "2026-05-25 07:06:11.143194"
...
```bash
$ shpc install quay.io/biocontainers/pridepy:0.0.15--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pridepy/0.0.15--pyhdfd78af_0
$ module help quay.io/biocontainers/pridepy/0.0.15--pyhdfd78af_0
```
