---
layout: container
name:  "quay.io/biocontainers/pridepy"
maintainer: "@vsoch"
...
updated_at: "2026-06-26 06:43:00.743390"
...
```bash
$ module load quay.io/biocontainers/pridepy/0.0.16--pyhdfd78af_0
$ module help quay.io/biocontainers/pridepy/0.0.16--pyhdfd78af_0
```
...
#### pridepy-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### pridepy-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/pridepy
$ podman run --it --rm --entrypoint /usr/local/bin/pridepy   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/pridepy   -v ${PWD} -w ${PWD} <container> -c " $@"
```
