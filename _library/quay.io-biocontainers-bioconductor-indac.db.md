...
updated_at: "2022-10-27 00:58:53.444022"
latest: "3.2.3--r41hdfd78af_9"
container_url: "https://biocontainers.pro/tools/bioconductor-indac.db"
aliases:
 - ".bioconductor-indac.db-post-link.sh"
 - ".bioconductor-indac.db-pre-unlink.sh"
...
config: {"url": "https://biocontainers.pro/tools/bioconductor-indac.db", "maintainer": "@vsoch", "description": "shpc-registry automated BioContainers addition for bioconductor-indac.db", "latest": {"3.2.3--r41hdfd78af_9": "sha256:7b5422bed32c3aacb02169bead5c7efd1f657d0735a196a4ae48bf9208e834ee"}, "tags": {"3.2.3--r41hdfd78af_9": "sha256:7b5422bed32c3aacb02169bead5c7efd1f657d0735a196a4ae48bf9208e834ee"}, "docker": "quay.io/biocontainers/bioconductor-indac.db", "aliases": {".bioconductor-indac.db-post-link.sh": "/usr/local/bin/.bioconductor-indac.db-post-link.sh", ".bioconductor-indac.db-pre-unlink.sh": "/usr/local/bin/.bioconductor-indac.db-pre-unlink.sh", ".bioconductor-org.dm.eg.db-post-link.sh": "/usr/local/bin/.bioconductor-org.dm.eg.db-post-link.sh", ".bioconductor-org.dm.eg.db-pre-unlink.sh": "/usr/local/bin/.bioconductor-org.dm.eg.db-pre-unlink.sh"}}
---
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-indac.db:3.2.3--r41hdfd78af_9
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-indac.db/3.2.3--r41hdfd78af_9
$ module help quay.io/biocontainers/bioconductor-indac.db/3.2.3--r41hdfd78af_9
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-indac.db-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-indac.db-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-indac.db-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-indac.db-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-indac.db-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-indac.db-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
