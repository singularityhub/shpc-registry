...
updated_at: "2025-11-02 03:52:59.835727"
...
```bash
$ shpc install quay.io/biocontainers/isoquant:3.9.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/isoquant/3.9.0--hdfd78af_0
$ module help quay.io/biocontainers/isoquant/3.9.0--hdfd78af_0
```
