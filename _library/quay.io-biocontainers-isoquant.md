...
updated_at: "2026-03-28 17:20:49.451506"
latest: "3.12.2--pyh106432d_0"
...
```bash
$ shpc install quay.io/biocontainers/isoquant:3.12.2--pyh106432d_0
```
...
```bash
$ module load quay.io/biocontainers/isoquant/3.12.2--pyh106432d_0
$ module help quay.io/biocontainers/isoquant/3.12.2--pyh106432d_0
```
