...
updated_at: "2025-01-08 03:04:48.857366"
...
```bash
$ shpc install quay.io/biocontainers/isoquant:3.6.2--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/isoquant/3.6.2--hdfd78af_0
$ module help quay.io/biocontainers/isoquant/3.6.2--hdfd78af_0
```
