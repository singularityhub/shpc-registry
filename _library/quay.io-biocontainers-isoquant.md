...
updated_at: "2024-09-08 02:50:42.958952"
...
```bash
$ shpc install quay.io/biocontainers/isoquant:3.5.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/isoquant/3.5.0--hdfd78af_0
$ module help quay.io/biocontainers/isoquant/3.5.0--hdfd78af_0
```
