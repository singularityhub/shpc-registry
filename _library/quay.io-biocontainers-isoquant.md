...
updated_at: "2024-10-03 03:05:23.616901"
...
```bash
$ shpc install quay.io/biocontainers/isoquant:3.6.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/isoquant/3.6.0--hdfd78af_0
$ module help quay.io/biocontainers/isoquant/3.6.0--hdfd78af_0
```
