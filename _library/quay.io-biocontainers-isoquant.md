...
updated_at: "2025-07-28 09:47:19.123915"
...
```bash
$ shpc install quay.io/biocontainers/isoquant:3.7.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/isoquant/3.7.0--hdfd78af_0
$ module help quay.io/biocontainers/isoquant/3.7.0--hdfd78af_0
```
