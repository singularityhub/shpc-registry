...
updated_at: "2025-03-28 03:23:41.910428"
latest: "3.6.3--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/isoquant:3.6.3--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/isoquant/3.6.3--hdfd78af_0
$ module help quay.io/biocontainers/isoquant/3.6.3--hdfd78af_0
```
