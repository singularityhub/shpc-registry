...
updated_at: "2025-12-08 05:19:59.711959"
...
```bash
$ shpc install quay.io/biocontainers/isoquant:3.10.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/isoquant/3.10.0--hdfd78af_0
$ module help quay.io/biocontainers/isoquant/3.10.0--hdfd78af_0
```
