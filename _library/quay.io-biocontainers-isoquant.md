...
updated_at: "2026-06-27 06:36:01.237877"
latest: "3.13.1--pyh106432d_0"
...
```bash
$ shpc install quay.io/biocontainers/isoquant:3.13.1--pyh106432d_0
```
...
```bash
$ module load quay.io/biocontainers/isoquant/3.13.1--pyh106432d_0
$ module help quay.io/biocontainers/isoquant/3.13.1--pyh106432d_0
```
