...
updated_at: "2024-05-27 03:14:40.810689"
...
```bash
$ shpc install quay.io/biocontainers/isoquant:3.4.1--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/isoquant/3.4.1--hdfd78af_0
$ module help quay.io/biocontainers/isoquant/3.4.1--hdfd78af_0
```
