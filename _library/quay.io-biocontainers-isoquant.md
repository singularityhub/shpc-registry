...
updated_at: "2025-09-25 03:27:16.599061"
...
```bash
$ shpc install quay.io/biocontainers/isoquant:3.7.1--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/isoquant/3.7.1--hdfd78af_0
$ module help quay.io/biocontainers/isoquant/3.7.1--hdfd78af_0
```
