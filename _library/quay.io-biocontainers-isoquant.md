...
updated_at: "2024-08-22 19:28:44.503901"
...
```bash
$ shpc install quay.io/biocontainers/isoquant:3.4.2--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/isoquant/3.4.2--hdfd78af_0
$ module help quay.io/biocontainers/isoquant/3.4.2--hdfd78af_0
```
