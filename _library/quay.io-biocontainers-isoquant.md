...
updated_at: "2024-11-23 03:24:07.581028"
...
```bash
$ shpc install quay.io/biocontainers/isoquant:3.6.1--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/isoquant/3.6.1--hdfd78af_0
$ module help quay.io/biocontainers/isoquant/3.6.1--hdfd78af_0
```
