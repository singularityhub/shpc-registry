...
updated_at: "2024-03-17 02:53:27.241589"
...
```bash
$ shpc install quay.io/biocontainers/fragpipe:20.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/fragpipe/20.0--hdfd78af_0
$ module help quay.io/biocontainers/fragpipe/20.0--hdfd78af_0
```
