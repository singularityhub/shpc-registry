...
updated_at: "2024-05-27 03:27:53.848711"
latest: "20.0--hdfd78af_2"
...
```bash
$ shpc install quay.io/biocontainers/fragpipe:20.0--hdfd78af_2
```
...
```bash
$ module load quay.io/biocontainers/fragpipe/20.0--hdfd78af_2
$ module help quay.io/biocontainers/fragpipe/20.0--hdfd78af_2
```
