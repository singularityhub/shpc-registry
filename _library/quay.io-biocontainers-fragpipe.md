...
updated_at: "2026-09-16 08:14:46.421433"
...
```bash
$ shpc install quay.io/biocontainers/fragpipe:24.0--hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/fragpipe/24.0--hdfd78af_1
$ module help quay.io/biocontainers/fragpipe/24.0--hdfd78af_1
```
