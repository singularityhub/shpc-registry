...
updated_at: "2025-07-06 03:52:13.358226"
latest: "23.0--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/fragpipe:23.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/fragpipe/23.0--hdfd78af_0
$ module help quay.io/biocontainers/fragpipe/23.0--hdfd78af_0
```
