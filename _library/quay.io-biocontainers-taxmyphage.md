...
updated_at: "2024-01-10 02:36:00.040039"
...
```bash
$ shpc install quay.io/biocontainers/taxmyphage:0.2.6--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/taxmyphage/0.2.6--pyhdfd78af_0
$ module help quay.io/biocontainers/taxmyphage/0.2.6--pyhdfd78af_0
```
