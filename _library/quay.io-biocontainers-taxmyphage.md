...
updated_at: "2025-05-01 03:32:21.037651"
...
```bash
$ shpc install quay.io/biocontainers/taxmyphage:0.3.6--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/taxmyphage/0.3.6--pyhdfd78af_0
$ module help quay.io/biocontainers/taxmyphage/0.3.6--pyhdfd78af_0
```
