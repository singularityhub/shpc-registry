...
updated_at: "2024-03-24 02:29:08.115838"
...
```bash
$ shpc install quay.io/biocontainers/taxmyphage:0.2.8--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/taxmyphage/0.2.8--pyhdfd78af_0
$ module help quay.io/biocontainers/taxmyphage/0.2.8--pyhdfd78af_0
```
