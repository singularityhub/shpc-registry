...
updated_at: "2024-02-05 03:11:16.170478"
...
```bash
$ shpc install quay.io/biocontainers/taxmyphage:0.2.7--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/taxmyphage/0.2.7--pyhdfd78af_0
$ module help quay.io/biocontainers/taxmyphage/0.2.7--pyhdfd78af_0
```
