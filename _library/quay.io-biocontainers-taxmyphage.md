...
updated_at: "2025-03-12 03:20:26.712453"
...
```bash
$ shpc install quay.io/biocontainers/taxmyphage:0.3.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/taxmyphage/0.3.4--pyhdfd78af_0
$ module help quay.io/biocontainers/taxmyphage/0.3.4--pyhdfd78af_0
```
