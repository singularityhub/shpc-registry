...
updated_at: "2022-10-29 08:17:40.712647"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-vbmp:1.62.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-vbmp/1.62.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-vbmp/1.62.0--r41hdfd78af_0
```
