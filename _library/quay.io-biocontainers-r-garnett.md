...
updated_at: "2022-11-05 00:05:11.783826"
...
```bash
$ shpc install quay.io/biocontainers/r-garnett:0.2.8--r41hdfd78af_3
```
...
```bash
$ module load quay.io/biocontainers/r-garnett/0.2.8--r41hdfd78af_3
$ module help quay.io/biocontainers/r-garnett/0.2.8--r41hdfd78af_3
```
