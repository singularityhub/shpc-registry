---
layout: container
name:  "quay.io/biocontainers/foldtree"
maintainer: "@vsoch"
...
updated_at: "2026-02-26 04:46:35.807379"
latest: "1.1.0rc2--pyh106432d_0"
...
```bash
$ module load quay.io/biocontainers/foldtree/1.1.0rc2--pyh106432d_0
$ module help quay.io/biocontainers/foldtree/1.1.0rc2--pyh106432d_0
```
...
#### foldtree-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### foldtree-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/apisearch
$ podman run --it --rm --entrypoint /usr/local/bin/apisearch   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/apisearch   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/foldtree
$ podman run --it --rm --entrypoint /usr/local/bin/foldtree   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/foldtree   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/pyfoldtree
$ podman run --it --rm --entrypoint /usr/local/bin/pyfoldtree   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/pyfoldtree   -v ${PWD} -w ${PWD} <container> -c " $@"
```
