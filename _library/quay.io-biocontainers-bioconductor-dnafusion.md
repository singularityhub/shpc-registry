...
updated_at: "2024-03-25 03:04:06.500632"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-dnafusion:1.4.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-dnafusion/1.4.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-dnafusion/1.4.0--r43hdfd78af_0
```
