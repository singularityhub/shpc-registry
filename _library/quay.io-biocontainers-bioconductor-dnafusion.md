...
updated_at: "2025-12-09 03:55:53.790448"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-dnafusion:1.8.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-dnafusion/1.8.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-dnafusion/1.8.0--r44hdfd78af_0
```
