...
updated_at: "2024-08-07 03:11:40.484517"
latest: "1.0.1--py312r43hf67a6ed_1"
...
```bash
$ shpc install quay.io/biocontainers/strainr2:1.0.1--py312r43hf67a6ed_1
```
...
```bash
$ module load quay.io/biocontainers/strainr2/1.0.1--py312r43hf67a6ed_1
$ module help quay.io/biocontainers/strainr2/1.0.1--py312r43hf67a6ed_1
```
