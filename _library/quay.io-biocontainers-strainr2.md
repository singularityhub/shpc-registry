...
updated_at: "2025-10-22 03:32:15.766145"
latest: "2.3.0--r44h577a1d6_0"
...
```bash
$ shpc install quay.io/biocontainers/strainr2:2.3.0--r44h577a1d6_0
```
...
```bash
$ module load quay.io/biocontainers/strainr2/2.3.0--r44h577a1d6_0
$ module help quay.io/biocontainers/strainr2/2.3.0--r44h577a1d6_0
```
