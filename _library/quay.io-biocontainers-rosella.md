...
updated_at: "2024-04-18 03:19:08.885598"
...
```bash
$ shpc install quay.io/biocontainers/rosella:0.5.3--h8e1a5b0_0
```
...
```bash
$ module load quay.io/biocontainers/rosella/0.5.3--h8e1a5b0_0
$ module help quay.io/biocontainers/rosella/0.5.3--h8e1a5b0_0
```
