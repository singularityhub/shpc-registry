...
updated_at: "2024-09-20 03:04:53.417221"
latest: "0.5.4--h8e1a5b0_0"
...
```bash
$ shpc install quay.io/biocontainers/rosella:0.5.4--h8e1a5b0_0
```
...
```bash
$ module load quay.io/biocontainers/rosella/0.5.4--h8e1a5b0_0
$ module help quay.io/biocontainers/rosella/0.5.4--h8e1a5b0_0
```
