...
updated_at: "2024-01-03 02:34:49.184685"
latest: "0.5.1--h8e1a5b0_0"
...
```bash
$ shpc install quay.io/biocontainers/rosella:0.5.1--h8e1a5b0_0
```
...
```bash
$ module load quay.io/biocontainers/rosella/0.5.1--h8e1a5b0_0
$ module help quay.io/biocontainers/rosella/0.5.1--h8e1a5b0_0
```
