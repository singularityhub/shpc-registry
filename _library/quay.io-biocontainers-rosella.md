...
updated_at: "2024-01-27 03:05:10.486660"
latest: "0.5.2--h8e1a5b0_0"
...
```bash
$ shpc install quay.io/biocontainers/rosella:0.5.2--h8e1a5b0_0
```
...
```bash
$ module load quay.io/biocontainers/rosella/0.5.2--h8e1a5b0_0
$ module help quay.io/biocontainers/rosella/0.5.2--h8e1a5b0_0
```
