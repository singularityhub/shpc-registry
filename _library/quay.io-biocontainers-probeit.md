...
updated_at: "2024-11-07 08:22:26.372808"
latest: "2.2--py38hfe239e1_3"
...
```bash
$ shpc install quay.io/biocontainers/probeit:2.2--py38hfe239e1_3
```
...
```bash
$ module load quay.io/biocontainers/probeit/2.2--py38hfe239e1_3
$ module help quay.io/biocontainers/probeit/2.2--py38hfe239e1_3
```
