...
updated_at: "2023-02-07 02:50:18.733305"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-pumadata:2.34.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-pumadata/2.34.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-pumadata/2.34.0--r42hdfd78af_0
```
