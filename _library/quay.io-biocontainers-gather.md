---
layout: container
name:  "quay.io/biocontainers/gather"
maintainer: "@vsoch"
...
updated_at: "2025-11-02 03:54:20.408743"
...
```bash
$ module load quay.io/biocontainers/gather/0.1.0--pyh7e72e81_0
$ module help quay.io/biocontainers/gather/0.1.0--pyh7e72e81_0
```
...
#### gather-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### gather-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/10x-asm
$ podman run --it --rm --entrypoint /usr/local/bin/10x-asm   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/10x-asm   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/sc-asm
$ podman run --it --rm --entrypoint /usr/local/bin/sc-asm   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/sc-asm   -v ${PWD} -w ${PWD} <container> -c " $@"
```
