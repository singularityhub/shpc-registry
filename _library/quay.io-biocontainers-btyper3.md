...
updated_at: "2022-12-08 03:19:28.776693"
...
```bash
$ shpc install quay.io/biocontainers/btyper3:3.3.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/btyper3/3.3.3--pyhdfd78af_0
$ module help quay.io/biocontainers/btyper3/3.3.3--pyhdfd78af_0
```
