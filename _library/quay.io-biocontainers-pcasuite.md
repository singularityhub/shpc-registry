...
updated_at: "2024-01-09 02:48:22.807188"
...
```bash
$ shpc install quay.io/biocontainers/pcasuite:1.0.0--h27c8258_3
```
...
```bash
$ module load quay.io/biocontainers/pcasuite/1.0.0--h27c8258_3
$ module help quay.io/biocontainers/pcasuite/1.0.0--h27c8258_3
```
