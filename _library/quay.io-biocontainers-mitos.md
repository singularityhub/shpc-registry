...
updated_at: "2024-04-04 02:26:05.961462"
latest: "2.1.7--pyhdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/mitos:2.1.7--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/mitos/2.1.7--pyhdfd78af_1
$ module help quay.io/biocontainers/mitos/2.1.7--pyhdfd78af_1
```
