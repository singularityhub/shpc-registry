...
updated_at: "2026-01-02 04:26:00.936565"
...
```bash
$ shpc install quay.io/biocontainers/mitos:2.1.10--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mitos/2.1.10--pyhdfd78af_0
$ module help quay.io/biocontainers/mitos/2.1.10--pyhdfd78af_0
```
