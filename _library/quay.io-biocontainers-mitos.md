...
updated_at: "2024-02-26 03:42:08.523070"
...
```bash
$ shpc install quay.io/biocontainers/mitos:2.1.7--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mitos/2.1.7--pyhdfd78af_0
$ module help quay.io/biocontainers/mitos/2.1.7--pyhdfd78af_0
```
