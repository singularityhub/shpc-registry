...
updated_at: "2025-11-24 04:10:38.418396"
latest: "2.1.9--pyhdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/mitos:2.1.9--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/mitos/2.1.9--pyhdfd78af_1
$ module help quay.io/biocontainers/mitos/2.1.9--pyhdfd78af_1
```
