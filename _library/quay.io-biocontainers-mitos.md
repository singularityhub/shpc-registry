...
updated_at: "2024-01-22 03:38:03.693973"
latest: "2.1.6--pyhdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/mitos:2.1.6--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/mitos/2.1.6--pyhdfd78af_1
$ module help quay.io/biocontainers/mitos/2.1.6--pyhdfd78af_1
```
