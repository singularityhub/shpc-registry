...
updated_at: "2023-12-26 02:25:26.161522"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-sevenbridges:1.30.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-sevenbridges/1.30.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-sevenbridges/1.30.0--r43hdfd78af_0
```
