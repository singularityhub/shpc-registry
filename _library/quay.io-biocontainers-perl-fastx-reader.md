...
updated_at: "2023-01-23 03:27:59.734650"
latest: "1.9.0--pl5321hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/perl-fastx-reader:1.9.0--pl5321hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/perl-fastx-reader/1.9.0--pl5321hdfd78af_0
$ module help quay.io/biocontainers/perl-fastx-reader/1.9.0--pl5321hdfd78af_0
```
