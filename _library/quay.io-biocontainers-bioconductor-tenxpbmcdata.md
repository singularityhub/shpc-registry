...
updated_at: "2025-12-17 16:08:43.345862"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-tenxpbmcdata:1.24.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-tenxpbmcdata/1.24.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-tenxpbmcdata/1.24.0--r44hdfd78af_0
```
