...
updated_at: "2025-12-08 03:44:53.699119"
latest: "0.1.4--py39h918f1d6_7"
...
```bash
$ shpc install quay.io/biocontainers/samsum:0.1.4--py39h918f1d6_7
```
...
```bash
$ module load quay.io/biocontainers/samsum/0.1.4--py39h918f1d6_7
$ module help quay.io/biocontainers/samsum/0.1.4--py39h918f1d6_7
```
