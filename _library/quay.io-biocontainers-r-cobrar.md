...
updated_at: "2026-04-05 05:19:25.469489"
latest: "0.2.4--r45hd63eeec_0"
...
```bash
$ shpc install quay.io/biocontainers/r-cobrar:0.2.4--r45hd63eeec_0
```
...
```bash
$ module load quay.io/biocontainers/r-cobrar/0.2.4--r45hd63eeec_0
$ module help quay.io/biocontainers/r-cobrar/0.2.4--r45hd63eeec_0
```
