...
updated_at: "2022-11-04 00:33:06.715403"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-nucpos:1.8.0--r40hacda110_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-nucpos/1.8.0--r40hacda110_1
$ module help quay.io/biocontainers/bioconductor-nucpos/1.8.0--r40hacda110_1
```
