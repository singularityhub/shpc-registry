...
updated_at: "2026-03-29 05:08:07.725253"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-nucpos:1.28.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-nucpos/1.28.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-nucpos/1.28.0--r45hdfd78af_0
```
