...
updated_at: "2025-09-25 03:56:48.261910"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-dupradar:1.38.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-dupradar/1.38.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-dupradar/1.38.0--r44hdfd78af_0
```
