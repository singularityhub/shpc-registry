...
updated_at: "2025-03-21 03:02:22.521967"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-dupradar:1.36.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-dupradar/1.36.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-dupradar/1.36.0--r44hdfd78af_0
```
