...
updated_at: "2023-12-10 02:41:55.521857"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-dupradar:1.30.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-dupradar/1.30.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-dupradar/1.30.0--r43hdfd78af_0
```
