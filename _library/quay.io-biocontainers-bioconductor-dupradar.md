...
updated_at: "2026-04-05 04:44:09.977219"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-dupradar:1.40.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-dupradar/1.40.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-dupradar/1.40.0--r45hdfd78af_0
```
