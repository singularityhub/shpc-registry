...
updated_at: "2023-10-26 03:03:28.720145"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cormotif:1.46.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cormotif/1.46.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-cormotif/1.46.0--r43hdfd78af_0
```
