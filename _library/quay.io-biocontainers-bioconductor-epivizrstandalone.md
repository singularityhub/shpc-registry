...
updated_at: "2024-01-18 02:37:20.662149"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-epivizrstandalone:1.30.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-epivizrstandalone/1.30.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-epivizrstandalone/1.30.0--r43hdfd78af_0
```
