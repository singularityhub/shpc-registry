...
updated_at: "2026-03-24 04:33:11.074376"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-epivizrstandalone:1.38.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-epivizrstandalone/1.38.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-epivizrstandalone/1.38.0--r45hdfd78af_0
```
