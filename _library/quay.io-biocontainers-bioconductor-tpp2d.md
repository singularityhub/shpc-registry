...
updated_at: "2025-08-15 05:36:01.281168"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-tpp2d:1.22.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-tpp2d/1.22.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-tpp2d/1.22.0--r44hdfd78af_0
```
