...
updated_at: "2026-01-30 05:00:49.903255"
...
```bash
$ shpc install quay.io/biocontainers/varpubs:0.5.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/varpubs/0.5.0--pyhdfd78af_0
$ module help quay.io/biocontainers/varpubs/0.5.0--pyhdfd78af_0
```
