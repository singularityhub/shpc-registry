...
updated_at: "2023-09-02 03:06:16.641292"
latest: "1.1--hdcf5f25_0"
...
```bash
$ shpc install quay.io/biocontainers/ribotin:1.1--hdcf5f25_0
```
...
```bash
$ module load quay.io/biocontainers/ribotin/1.1--hdcf5f25_0
$ module help quay.io/biocontainers/ribotin/1.1--hdcf5f25_0
```
