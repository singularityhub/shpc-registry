...
updated_at: "2024-03-14 02:54:04.359719"
latest: "1.2--hdcf5f25_1"
...
```bash
$ shpc install quay.io/biocontainers/ribotin:1.2--hdcf5f25_1
```
...
```bash
$ module load quay.io/biocontainers/ribotin/1.2--hdcf5f25_1
$ module help quay.io/biocontainers/ribotin/1.2--hdcf5f25_1
```
