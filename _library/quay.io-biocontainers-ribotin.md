...
updated_at: "2025-09-05 03:47:28.730844"
...
```bash
$ shpc install quay.io/biocontainers/ribotin:1.5--h077b44d_0
```
...
```bash
$ module load quay.io/biocontainers/ribotin/1.5--h077b44d_0
$ module help quay.io/biocontainers/ribotin/1.5--h077b44d_0
```
