...
updated_at: "2023-08-01 03:13:43.328649"
latest: "1.0--hdcf5f25_0"
...
```bash
$ shpc install quay.io/biocontainers/ribotin:1.0--hdcf5f25_0
```
...
```bash
$ module load quay.io/biocontainers/ribotin/1.0--hdcf5f25_0
$ module help quay.io/biocontainers/ribotin/1.0--hdcf5f25_0
```
