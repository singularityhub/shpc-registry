...
updated_at: "2023-12-15 03:04:40.288402"
latest: "1.2--hdcf5f25_0"
...
```bash
$ shpc install quay.io/biocontainers/ribotin:1.2--hdcf5f25_0
```
...
```bash
$ module load quay.io/biocontainers/ribotin/1.2--hdcf5f25_0
$ module help quay.io/biocontainers/ribotin/1.2--hdcf5f25_0
```
