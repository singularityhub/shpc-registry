...
updated_at: "2025-08-01 10:17:44.867576"
latest: "2.6--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/cpstools:2.6--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/cpstools/2.6--pyhdfd78af_0
$ module help quay.io/biocontainers/cpstools/2.6--pyhdfd78af_0
```
