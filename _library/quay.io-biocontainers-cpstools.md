...
updated_at: "2025-05-15 03:17:00.872705"
...
```bash
$ shpc install quay.io/biocontainers/cpstools:2.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/cpstools/2.5--pyhdfd78af_0
$ module help quay.io/biocontainers/cpstools/2.5--pyhdfd78af_0
```
