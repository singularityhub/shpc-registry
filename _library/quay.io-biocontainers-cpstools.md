...
updated_at: "2025-02-25 03:06:45.586852"
...
```bash
$ shpc install quay.io/biocontainers/cpstools:2.0.9--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/cpstools/2.0.9--pyhdfd78af_0
$ module help quay.io/biocontainers/cpstools/2.0.9--pyhdfd78af_0
```
