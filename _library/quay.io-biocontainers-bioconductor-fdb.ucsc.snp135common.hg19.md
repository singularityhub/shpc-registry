...
updated_at: "2025-01-20 03:50:51.168333"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-fdb.ucsc.snp135common.hg19:1.0.0--r44hdfd78af_13
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-fdb.ucsc.snp135common.hg19/1.0.0--r44hdfd78af_13
$ module help quay.io/biocontainers/bioconductor-fdb.ucsc.snp135common.hg19/1.0.0--r44hdfd78af_13
```
