...
updated_at: "2023-07-09 03:42:20.379583"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-graper:1.14.0--r42hf17093f_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-graper/1.14.0--r42hf17093f_1
$ module help quay.io/biocontainers/bioconductor-graper/1.14.0--r42hf17093f_1
```
