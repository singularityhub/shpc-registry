...
updated_at: "2023-10-05 03:03:40.512839"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-vanillaice:1.62.0--r43ha9d7317_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-vanillaice/1.62.0--r43ha9d7317_0
$ module help quay.io/biocontainers/bioconductor-vanillaice/1.62.0--r43ha9d7317_0
```
