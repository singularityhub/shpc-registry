...
updated_at: "2024-01-18 02:49:53.641821"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-chipexoqualexample:1.26.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-chipexoqualexample/1.26.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-chipexoqualexample/1.26.0--r43hdfd78af_0
```
