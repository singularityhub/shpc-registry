...
updated_at: "2025-07-30 03:51:32.488858"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-chipexoqualexample:1.30.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-chipexoqualexample/1.30.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-chipexoqualexample/1.30.0--r44hdfd78af_0
```
