...
```bash
$ shpc install quay.io/biocontainers/bioconductor-chipexoqualexample:1.8.0--r36_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-chipexoqualexample/1.8.0--r36_1
$ module help quay.io/biocontainers/bioconductor-chipexoqualexample/1.8.0--r36_1
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-chipexoqualexample-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-chipexoqualexample-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-chipexoqualexample-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-chipexoqualexample-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-chipexoqualexample-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-chipexoqualexample-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
