...
updated_at: "2026-04-05 05:10:05.022119"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-chipexoqualexample:1.34.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-chipexoqualexample/1.34.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-chipexoqualexample/1.34.0--r45hdfd78af_0
```
