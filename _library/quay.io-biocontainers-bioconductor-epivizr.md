...
updated_at: "2026-02-06 04:36:18.951336"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-epivizr:2.36.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-epivizr/2.36.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-epivizr/2.36.0--r44hdfd78af_0
```
