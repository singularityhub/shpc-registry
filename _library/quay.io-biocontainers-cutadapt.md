...
updated_at: "2024-06-25 02:57:02.048072"
latest: "4.9--py310h7c593f9_0"
...
```bash
$ shpc install quay.io/biocontainers/cutadapt:4.9--py310h7c593f9_0
```
...
```bash
$ module load quay.io/biocontainers/cutadapt/4.9--py310h7c593f9_0
$ module help quay.io/biocontainers/cutadapt/4.9--py310h7c593f9_0
```
