...
updated_at: "2024-11-08 03:02:39.931229"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rtcga.mrna:1.30.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rtcga.mrna/1.30.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rtcga.mrna/1.30.0--r43hdfd78af_0
```
