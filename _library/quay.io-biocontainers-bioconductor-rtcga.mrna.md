...
updated_at: "2025-04-17 03:11:07.884159"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rtcga.mrna:1.34.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rtcga.mrna/1.34.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rtcga.mrna/1.34.0--r44hdfd78af_0
```
