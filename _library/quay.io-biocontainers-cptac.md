...
updated_at: "2024-02-24 02:49:55.542719"
latest: "1.5.11--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/cptac:1.5.11--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/cptac/1.5.11--pyhdfd78af_0
$ module help quay.io/biocontainers/cptac/1.5.11--pyhdfd78af_0
```
