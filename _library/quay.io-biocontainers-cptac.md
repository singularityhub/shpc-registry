...
updated_at: "2023-12-29 02:22:26.250833"
latest: "1.5.10--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/cptac:1.5.10--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/cptac/1.5.10--pyhdfd78af_0
$ module help quay.io/biocontainers/cptac/1.5.10--pyhdfd78af_0
```
