...
updated_at: "2023-11-19 02:35:39.433743"
...
```bash
$ shpc install quay.io/biocontainers/cptac:1.5.7--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/cptac/1.5.7--pyhdfd78af_0
$ module help quay.io/biocontainers/cptac/1.5.7--pyhdfd78af_0
```
