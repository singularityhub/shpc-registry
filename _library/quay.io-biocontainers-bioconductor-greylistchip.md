...
updated_at: "2023-11-03 02:28:18.635324"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-greylistchip:1.32.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-greylistchip/1.32.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-greylistchip/1.32.0--r43hdfd78af_0
```
