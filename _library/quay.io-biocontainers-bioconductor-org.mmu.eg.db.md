...
updated_at: "2026-04-03 05:19:06.879179"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-org.mmu.eg.db:3.22.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-org.mmu.eg.db/3.22.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-org.mmu.eg.db/3.22.0--r45hdfd78af_0
```
