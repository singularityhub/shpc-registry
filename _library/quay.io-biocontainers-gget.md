...
updated_at: "2022-11-27 23:56:13.516134"
...
```bash
$ shpc install quay.io/biocontainers/gget:0.3.9--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/gget/0.3.9--pyhdfd78af_0
$ module help quay.io/biocontainers/gget/0.3.9--pyhdfd78af_0
```
