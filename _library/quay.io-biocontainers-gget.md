...
updated_at: "2023-12-30 04:21:18.864833"
...
```bash
$ shpc install quay.io/biocontainers/gget:0.28.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/gget/0.28.2--pyhdfd78af_0
$ module help quay.io/biocontainers/gget/0.28.2--pyhdfd78af_0
```
