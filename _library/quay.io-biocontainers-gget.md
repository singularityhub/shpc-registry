...
updated_at: "2023-01-17 03:22:45.055896"
...
```bash
$ shpc install quay.io/biocontainers/gget:0.27.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/gget/0.27.0--pyhdfd78af_0
$ module help quay.io/biocontainers/gget/0.27.0--pyhdfd78af_0
```
