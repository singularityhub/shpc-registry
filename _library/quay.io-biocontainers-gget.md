...
updated_at: "2026-01-23 04:40:01.604502"
...
```bash
$ shpc install quay.io/biocontainers/gget:0.29.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/gget/0.29.0--pyhdfd78af_0
$ module help quay.io/biocontainers/gget/0.29.0--pyhdfd78af_0
```
