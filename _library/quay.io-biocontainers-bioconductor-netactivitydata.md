...
updated_at: "2024-01-06 03:01:08.374985"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-netactivitydata:1.4.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-netactivitydata/1.4.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-netactivitydata/1.4.0--r43hdfd78af_0
```
