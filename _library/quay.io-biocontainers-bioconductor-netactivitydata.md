...
updated_at: "2025-05-11 03:46:19.748772"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-netactivitydata:1.8.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-netactivitydata/1.8.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-netactivitydata/1.8.0--r44hdfd78af_0
```
