...
updated_at: "2023-11-27 02:54:36.573332"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-netactivitydata:1.2.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-netactivitydata/1.2.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-netactivitydata/1.2.0--r43hdfd78af_0
```
