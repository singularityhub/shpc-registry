...
updated_at: "2024-06-21 03:16:03.539911"
latest: "2.2.36--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/deeplc:2.2.36--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/deeplc/2.2.36--pyhdfd78af_0
$ module help quay.io/biocontainers/deeplc/2.2.36--pyhdfd78af_0
```
