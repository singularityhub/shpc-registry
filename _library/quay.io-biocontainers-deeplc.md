...
updated_at: "2023-09-22 04:05:29.150226"
latest: "2.2.14--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/deeplc:2.2.14--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/deeplc/2.2.14--pyhdfd78af_0
$ module help quay.io/biocontainers/deeplc/2.2.14--pyhdfd78af_0
```
