...
updated_at: "2023-08-03 03:35:36.378327"
...
```bash
$ shpc install quay.io/biocontainers/deeplc:2.2.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/deeplc/2.2.4--pyhdfd78af_0
$ module help quay.io/biocontainers/deeplc/2.2.4--pyhdfd78af_0
```
