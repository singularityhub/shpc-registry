...
updated_at: "2024-10-30 03:31:28.211976"
latest: "3.0.8--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/deeplc:3.0.8--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/deeplc/3.0.8--pyhdfd78af_0
$ module help quay.io/biocontainers/deeplc/3.0.8--pyhdfd78af_0
```
