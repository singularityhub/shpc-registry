...
updated_at: "2023-08-28 04:00:32.271715"
...
```bash
$ shpc install quay.io/biocontainers/deeplc:2.2.9--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/deeplc/2.2.9--pyhdfd78af_0
$ module help quay.io/biocontainers/deeplc/2.2.9--pyhdfd78af_0
```
