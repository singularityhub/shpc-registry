...
updated_at: "2024-04-18 03:32:15.694665"
latest: "2.2.27--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/deeplc:2.2.27--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/deeplc/2.2.27--pyhdfd78af_0
$ module help quay.io/biocontainers/deeplc/2.2.27--pyhdfd78af_0
```
