...
updated_at: "2025-02-04 03:25:10.524412"
...
```bash
$ shpc install quay.io/biocontainers/deeplc:3.1.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/deeplc/3.1.3--pyhdfd78af_0
$ module help quay.io/biocontainers/deeplc/3.1.3--pyhdfd78af_0
```
