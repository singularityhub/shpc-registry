...
updated_at: "2024-08-24 02:47:59.372821"
...
```bash
$ shpc install quay.io/biocontainers/deeplc:3.0.6--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/deeplc/3.0.6--pyhdfd78af_0
$ module help quay.io/biocontainers/deeplc/3.0.6--pyhdfd78af_0
```
