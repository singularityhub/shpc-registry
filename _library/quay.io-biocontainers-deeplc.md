...
updated_at: "2024-07-10 02:42:37.892873"
latest: "2.2.38--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/deeplc:2.2.38--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/deeplc/2.2.38--pyhdfd78af_0
$ module help quay.io/biocontainers/deeplc/2.2.38--pyhdfd78af_0
```
