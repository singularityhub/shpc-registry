...
updated_at: "2025-02-11 03:30:37.352262"
latest: "3.1.7--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/deeplc:3.1.7--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/deeplc/3.1.7--pyhdfd78af_0
$ module help quay.io/biocontainers/deeplc/3.1.7--pyhdfd78af_0
```
