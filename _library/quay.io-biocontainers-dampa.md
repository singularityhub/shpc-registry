...
updated_at: "2025-05-20 03:26:12.174790"
...
```bash
$ shpc install quay.io/biocontainers/dampa:0.1.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/dampa/0.1.1--pyhdfd78af_0
$ module help quay.io/biocontainers/dampa/0.1.1--pyhdfd78af_0
```
