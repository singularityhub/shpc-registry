---
layout: container
name:  "quay.io/biocontainers/dampa"
maintainer: "@vsoch"
...
updated_at: "2026-08-27 12:56:42.408117"
...
```bash
$ module load quay.io/biocontainers/dampa/0.3.0--pyhdfd78af_0
$ module help quay.io/biocontainers/dampa/0.3.0--pyhdfd78af_0
```
...
#### dampa-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### dampa-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/dampa
$ podman run --it --rm --entrypoint /usr/local/bin/dampa   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/dampa   -v ${PWD} -w ${PWD} <container> -c " $@"
```
