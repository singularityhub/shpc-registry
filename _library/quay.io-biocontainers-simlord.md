...
updated_at: "2025-12-12 03:52:16.879661"
...
```bash
$ shpc install quay.io/biocontainers/simlord:1.0.4--py39hbcbf7aa_5
```
...
```bash
$ module load quay.io/biocontainers/simlord/1.0.4--py39hbcbf7aa_5
$ module help quay.io/biocontainers/simlord/1.0.4--py39hbcbf7aa_5
```
