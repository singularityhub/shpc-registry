...
updated_at: "2022-10-29 05:36:57.066717"
latest: "1.56.2--r41hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-annotationdbi:1.56.2--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-annotationdbi/1.56.2--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-annotationdbi/1.56.2--r41hdfd78af_0
```
