...
updated_at: "2024-05-16 03:14:08.363518"
latest: "4.4.0"
...
```bash
$ shpc install rocker/rstudio:4.4.0
```
...
```bash
$ module load rocker/rstudio/4.4.0
$ module help rocker/rstudio/4.4.0
```
