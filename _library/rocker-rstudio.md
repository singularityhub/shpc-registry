...
updated_at: "2026-09-26 07:12:51.759773"
latest: "4.6.1"
...
```bash
$ shpc install rocker/rstudio:4.6.1
```
...
```bash
$ module load rocker/rstudio/4.6.1
$ module help rocker/rstudio/4.6.1
```
