...
updated_at: "2024-09-14 02:43:20.630393"
latest: "4.4.1"
...
```bash
$ shpc install rocker/rstudio:4.4.1
```
...
```bash
$ module load rocker/rstudio/4.4.1
$ module help rocker/rstudio/4.4.1
```
