...
updated_at: "2025-03-28 03:02:04.349414"
latest: "4.4.3"
...
```bash
$ shpc install rocker/rstudio:4.4.3
```
...
```bash
$ module load rocker/rstudio/4.4.3
$ module help rocker/rstudio/4.4.3
```
