...
updated_at: "2026-04-26 05:14:10.011262"
latest: "4.6.0"
...
```bash
$ shpc install rocker/rstudio:4.6.0
```
...
```bash
$ module load rocker/rstudio/4.6.0
$ module help rocker/rstudio/4.6.0
```
