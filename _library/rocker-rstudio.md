...
updated_at: "2026-01-08 04:34:28.280398"
latest: "4.5.2"
...
```bash
$ shpc install rocker/rstudio:4.5.2
```
...
```bash
$ module load rocker/rstudio/4.5.2
$ module help rocker/rstudio/4.5.2
```
