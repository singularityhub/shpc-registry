...
updated_at: "2026-04-03 16:12:49.436421"
latest: "4.5.3"
...
```bash
$ shpc install rocker/rstudio:4.5.3
```
...
```bash
$ module load rocker/rstudio/4.5.3
$ module help rocker/rstudio/4.5.3
```
