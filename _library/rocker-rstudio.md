...
updated_at: "2024-12-31 03:38:10.697889"
latest: "4.4.2"
...
```bash
$ shpc install rocker/rstudio:4.4.2
```
...
```bash
$ module load rocker/rstudio/4.4.2
$ module help rocker/rstudio/4.4.2
```
