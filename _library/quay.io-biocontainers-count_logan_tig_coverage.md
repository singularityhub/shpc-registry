---
layout: container
name:  "quay.io/biocontainers/count_logan_tig_coverage"
maintainer: "@vsoch"
...
updated_at: "2026-07-01 07:16:03.843846"
...
singularity registry hpc automated addition for count_logan_tig_coverage
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/count_logan_tig_coverage
```
...
#### count_logan_tig_coverage-shell:
...
#### count_logan_tig_coverage-inspect:
...
#### count_logan_tig_coverage-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### count_logan_tig_coverage-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/count_logan_tig_coverage
$ podman run --it --rm --entrypoint /usr/local/bin/count_logan_tig_coverage   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/count_logan_tig_coverage   -v ${PWD} -w ${PWD} <container> -c " $@"
```
