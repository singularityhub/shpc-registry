...
updated_at: "2023-10-31 02:57:17.470914"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mirna10cdf:2.18.0--r43hdfd78af_11
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mirna10cdf/2.18.0--r43hdfd78af_11
$ module help quay.io/biocontainers/bioconductor-mirna10cdf/2.18.0--r43hdfd78af_11
```
