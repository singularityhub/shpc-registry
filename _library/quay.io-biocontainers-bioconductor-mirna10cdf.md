...
updated_at: "2025-02-28 03:17:14.423648"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mirna10cdf:2.18.0--r44hdfd78af_13
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mirna10cdf/2.18.0--r44hdfd78af_13
$ module help quay.io/biocontainers/bioconductor-mirna10cdf/2.18.0--r44hdfd78af_13
```
