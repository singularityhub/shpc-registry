...
updated_at: "2022-11-02 00:22:51.687441"
...
```bash
$ shpc install quay.io/biocontainers/cgat-daisy:0.1.9--pyh5e36f6f_2
```
...
```bash
$ module load quay.io/biocontainers/cgat-daisy/0.1.9--pyh5e36f6f_2
$ module help quay.io/biocontainers/cgat-daisy/0.1.9--pyh5e36f6f_2
```
