...
updated_at: "2025-05-13 03:24:03.270223"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-tcgacrcmrna:1.26.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-tcgacrcmrna/1.26.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-tcgacrcmrna/1.26.0--r44hdfd78af_0
```
