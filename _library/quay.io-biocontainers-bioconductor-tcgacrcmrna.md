...
updated_at: "2026-03-29 05:05:00.480141"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-tcgacrcmrna:1.30.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-tcgacrcmrna/1.30.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-tcgacrcmrna/1.30.0--r45hdfd78af_0
```
