---
layout: container
name:  "quay.io/biocontainers/openspliceai"
maintainer: "@vsoch"
...
updated_at: "2026-06-24 06:54:48.821015"
...
singularity registry hpc automated addition for openspliceai
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/openspliceai
```
...
#### openspliceai-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### openspliceai-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/openspliceai
$ podman run --it --rm --entrypoint /usr/local/bin/openspliceai   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/openspliceai   -v ${PWD} -w ${PWD} <container> -c " $@"
```
