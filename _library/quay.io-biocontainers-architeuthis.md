...
updated_at: "2026-01-19 03:59:19.133168"
...
```bash
$ shpc install quay.io/biocontainers/architeuthis:0.4.0--he881be0_0
```
...
```bash
$ module load quay.io/biocontainers/architeuthis/0.4.0--he881be0_0
$ module help quay.io/biocontainers/architeuthis/0.4.0--he881be0_0
```
