...
updated_at: "2026-02-26 05:05:36.627888"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-colonca:1.52.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-colonca/1.52.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-colonca/1.52.0--r45hdfd78af_0
```
