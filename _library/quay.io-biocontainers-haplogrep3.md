---
layout: container
name:  "quay.io/biocontainers/haplogrep3"
maintainer: "@vsoch"
...
updated_at: "2025-11-27 03:56:01.485246"
...
singularity registry hpc automated addition for haplogrep3
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/haplogrep3
```
...
#### haplogrep3-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### haplogrep3-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/haplogrep3
$ podman run --it --rm --entrypoint /usr/local/bin/haplogrep3   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/haplogrep3   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/haplogrep3.jar
$ podman run --it --rm --entrypoint /usr/local/bin/haplogrep3.jar   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/haplogrep3.jar   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/haplogrep3.yaml
$ podman run --it --rm --entrypoint /usr/local/bin/haplogrep3.yaml   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/haplogrep3.yaml   -v ${PWD} -w ${PWD} <container> -c " $@"
```
