...
updated_at: "2026-09-24 07:52:37.254523"
...
```bash
$ shpc install quay.io/biocontainers/mmaseq:2.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mmaseq/2.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/mmaseq/2.2.0--pyhdfd78af_0
```
