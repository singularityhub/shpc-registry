...
updated_at: "2026-06-23 16:43:28.590685"
...
```bash
$ shpc install quay.io/biocontainers/ashlar:1.20.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ashlar/1.20.0--pyhdfd78af_0
$ module help quay.io/biocontainers/ashlar/1.20.0--pyhdfd78af_0
```
