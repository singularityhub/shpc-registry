...
updated_at: "2025-05-19 03:48:38.615157"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gsbenchmark:1.26.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gsbenchmark/1.26.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-gsbenchmark/1.26.0--r44hdfd78af_0
```
