...
updated_at: "2024-04-13 02:39:01.059330"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gsbenchmark:1.22.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gsbenchmark/1.22.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-gsbenchmark/1.22.0--r43hdfd78af_0
```
