...
updated_at: "2026-03-20 00:34:58.277386"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gsbenchmark:1.30.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gsbenchmark/1.30.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-gsbenchmark/1.30.0--r45hdfd78af_0
```
