...
updated_at: "2024-04-29 03:02:33.101262"
latest: "1.6.5--py310h3db02ab_0"
...
```bash
$ shpc install quay.io/biocontainers/genometools-genometools:1.6.5--py310h3db02ab_0
```
...
```bash
$ module load quay.io/biocontainers/genometools-genometools/1.6.5--py310h3db02ab_0
$ module help quay.io/biocontainers/genometools-genometools/1.6.5--py310h3db02ab_0
```
