...
updated_at: "2024-05-26 02:54:29.306838"
latest: "1.6.5--py38hf7b97cc_1"
...
```bash
$ shpc install quay.io/biocontainers/genometools-genometools:1.6.5--py38hf7b97cc_1
```
...
```bash
$ module load quay.io/biocontainers/genometools-genometools/1.6.5--py38hf7b97cc_1
$ module help quay.io/biocontainers/genometools-genometools/1.6.5--py38hf7b97cc_1
```
