...
updated_at: "2022-12-05 03:04:30.896245"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cll:1.34.0--r41hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cll/1.34.0--r41hdfd78af_1
$ module help quay.io/biocontainers/bioconductor-cll/1.34.0--r41hdfd78af_1
```
