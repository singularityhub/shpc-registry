...
updated_at: "2025-11-18 03:53:20.135602"
...
```bash
$ shpc install quay.io/biocontainers/flair:2.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/flair/2.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/flair/2.2.0--pyhdfd78af_0
```
