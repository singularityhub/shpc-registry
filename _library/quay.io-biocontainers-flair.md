...
updated_at: "2026-01-02 04:21:25.235126"
...
```bash
$ shpc install quay.io/biocontainers/flair:3.0.0b1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/flair/3.0.0b1--pyhdfd78af_0
$ module help quay.io/biocontainers/flair/3.0.0b1--pyhdfd78af_0
```
