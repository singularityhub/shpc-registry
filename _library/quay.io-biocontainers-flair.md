...
updated_at: "2026-08-27 23:42:24.881320"
...
```bash
$ shpc install quay.io/biocontainers/flair:3.0.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/flair/3.0.1--pyhdfd78af_0
$ module help quay.io/biocontainers/flair/3.0.1--pyhdfd78af_0
```
