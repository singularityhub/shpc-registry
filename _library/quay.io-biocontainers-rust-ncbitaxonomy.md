...
updated_at: "2026-05-30 06:23:54.132578"
latest: "1.1.0--h0902eb3_0"
...
```bash
$ shpc install quay.io/biocontainers/rust-ncbitaxonomy:1.1.0--h0902eb3_0
```
...
```bash
$ module load quay.io/biocontainers/rust-ncbitaxonomy/1.1.0--h0902eb3_0
$ module help quay.io/biocontainers/rust-ncbitaxonomy/1.1.0--h0902eb3_0
```
