...
updated_at: "2025-08-28 12:20:25.011660"
...
```bash
$ shpc install quay.io/biocontainers/clumppling:0.3.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/clumppling/0.3.2--pyhdfd78af_0
$ module help quay.io/biocontainers/clumppling/0.3.2--pyhdfd78af_0
```
