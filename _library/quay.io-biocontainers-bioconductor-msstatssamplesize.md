...
updated_at: "2022-11-16 00:17:17.245323"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-msstatssamplesize:1.8.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-msstatssamplesize/1.8.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-msstatssamplesize/1.8.0--r41hdfd78af_0
```
