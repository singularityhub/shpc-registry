...
updated_at: "2026-09-05 07:02:44.777755"
latest: "2.0.3--r45h3121a25_0"
...
```bash
$ shpc install quay.io/biocontainers/r-ic10:2.0.3--r45h3121a25_0
```
...
```bash
$ module load quay.io/biocontainers/r-ic10/2.0.3--r45h3121a25_0
$ module help quay.io/biocontainers/r-ic10/2.0.3--r45h3121a25_0
```
