...
updated_at: "2023-07-23 02:43:54.782272"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-differentialregulation:1.2.0--r42hf17093f_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-differentialregulation/1.2.0--r42hf17093f_1
$ module help quay.io/biocontainers/bioconductor-differentialregulation/1.2.0--r42hf17093f_1
```
