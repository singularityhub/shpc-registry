...
updated_at: "2023-10-24 02:49:50.159414"
latest: "1.4.2--r43hf17093f_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-differentialregulation:1.4.2--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-differentialregulation/1.4.2--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-differentialregulation/1.4.2--r43hf17093f_0
```
