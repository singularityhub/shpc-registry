...
updated_at: "2026-02-15 04:37:20.391867"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hapmapsnp6:1.52.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hapmapsnp6/1.52.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-hapmapsnp6/1.52.0--r45hdfd78af_0
```
