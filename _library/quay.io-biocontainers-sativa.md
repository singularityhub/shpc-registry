---
layout: container
name:  "quay.io/biocontainers/sativa"
maintainer: "@vsoch"
...
updated_at: "2025-05-18 03:38:35.182659"
...
```bash
$ shpc install quay.io/biocontainers/sativa
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/sativa:0.9.3--py312h031d066_0
```
...
```bash
$ module load quay.io/biocontainers/sativa/0.9.3--py312h031d066_0
$ module help quay.io/biocontainers/sativa/0.9.3--py312h031d066_0
```
...
#### sativa-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### sativa-inspect-deffile:
