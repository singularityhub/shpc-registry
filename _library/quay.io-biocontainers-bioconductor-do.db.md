...
updated_at: "2024-05-29 03:14:50.729418"
latest: "2.9--r43hdfd78af_16"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-do.db:2.9--r43hdfd78af_16
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-do.db/2.9--r43hdfd78af_16
$ module help quay.io/biocontainers/bioconductor-do.db/2.9--r43hdfd78af_16
```
