...
updated_at: "2026-04-05 05:20:04.873479"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-spqndata:1.22.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-spqndata/1.22.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-spqndata/1.22.0--r45hdfd78af_0
```
