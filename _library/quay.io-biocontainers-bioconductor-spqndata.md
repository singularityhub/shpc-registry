...
updated_at: "2023-09-12 02:43:27.983845"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-spqndata:1.12.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-spqndata/1.12.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-spqndata/1.12.0--r43hdfd78af_0
```
