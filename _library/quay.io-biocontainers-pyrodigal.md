...
updated_at: "2024-09-02 03:04:00.240064"
latest: "3.5.1--py312hf67a6ed_1"
...
```bash
$ shpc install quay.io/biocontainers/pyrodigal:3.5.1--py312hf67a6ed_1
```
...
```bash
$ module load quay.io/biocontainers/pyrodigal/3.5.1--py312hf67a6ed_1
$ module help quay.io/biocontainers/pyrodigal/3.5.1--py312hf67a6ed_1
```
