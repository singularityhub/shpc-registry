...
updated_at: "2024-12-12 04:24:10.188458"
latest: "3.6.3--py311hdad781d_0"
...
```bash
$ shpc install quay.io/biocontainers/pyrodigal:3.6.3--py311hdad781d_0
```
...
```bash
$ module load quay.io/biocontainers/pyrodigal/3.6.3--py311hdad781d_0
$ module help quay.io/biocontainers/pyrodigal/3.6.3--py311hdad781d_0
```
