...
updated_at: "2026-03-21 04:44:13.498972"
...
```bash
$ shpc install quay.io/biocontainers/pyrodigal:3.7.1--py312h247cb63_1
```
...
```bash
$ module load quay.io/biocontainers/pyrodigal/3.7.1--py312h247cb63_1
$ module help quay.io/biocontainers/pyrodigal/3.7.1--py312h247cb63_1
```
