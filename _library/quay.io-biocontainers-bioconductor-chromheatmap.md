...
updated_at: "2026-03-29 04:53:26.551737"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-chromheatmap:1.64.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-chromheatmap/1.64.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-chromheatmap/1.64.0--r45hdfd78af_0
```
