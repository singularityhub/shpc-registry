---
layout: container
name:  "quay.io/biocontainers/enzywizard-dock"
maintainer: "@vsoch"
github: "https://github.com/singularityhub/shpc-registry/blob/main/quay.io/biocontainers/enzywizard-dock/container.yaml"
config_url: "https://raw.githubusercontent.com/singularityhub/shpc-registry/main/quay.io/biocontainers/enzywizard-dock/container.yaml"
updated_at: "2026-07-01 06:46:04.736285"
latest: "1.0.2--pyhdfd78af_0"
container_url: "https://biocontainers.pro/tools/enzywizard-dock"
aliases:
 - "enzywizard-dock"
 - "mk_export.py"
...
versions:
 - "1.0.2--pyhdfd78af_0"
description: "singularity registry hpc automated addition for enzywizard-dock"
config: {"url": "https://biocontainers.pro/tools/enzywizard-dock", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for enzywizard-dock", "latest": {"1.0.2--pyhdfd78af_0": "sha256:12f866555739789d100cb90a3e317aefda280d76a855d1b8320273d608eb27de"}, "tags": {"1.0.2--pyhdfd78af_0": "sha256:12f866555739789d100cb90a3e317aefda280d76a855d1b8320273d608eb27de"}, "docker": "quay.io/biocontainers/enzywizard-dock", "aliases": {"enzywizard-dock": "/usr/local/bin/enzywizard-dock", "mk_export.py": "/usr/local/bin/mk_export.py", "mk_prepare_ligand.py": "/usr/local/bin/mk_prepare_ligand.py", "mk_prepare_receptor.py": "/usr/local/bin/mk_prepare_receptor.py", "msms": "/usr/local/bin/msms", "pyvol": "/usr/local/bin/pyvol", "trimesh": "/usr/local/bin/trimesh", "vina": "/usr/local/bin/vina", "vina_split": "/usr/local/bin/vina_split", "fc-genconf": "/usr/local/bin/fc-genconf", "ldapadd": "/usr/local/bin/ldapadd", "ldapcompare": "/usr/local/bin/ldapcompare", "ldapdelete": "/usr/local/bin/ldapdelete", "ldapexop": "/usr/local/bin/ldapexop", "ldapmodify": "/usr/local/bin/ldapmodify", "ldapmodrdn": "/usr/local/bin/ldapmodrdn", "ldappasswd": "/usr/local/bin/ldappasswd", "ldapsearch": "/usr/local/bin/ldapsearch", "ldapurl": "/usr/local/bin/ldapurl", "ldapvc": "/usr/local/bin/ldapvc", "ldapwhoami": "/usr/local/bin/ldapwhoami", "pg_config": "/usr/local/bin/pg_config", "idle3.14": "/usr/local/bin/idle3.14", "pydoc3.14": "/usr/local/bin/pydoc3.14", "python3.14": "/usr/local/bin/python3.14", "python3.14-config": "/usr/local/bin/python3.14-config", "qconvex": "/usr/local/bin/qconvex", "qdelaunay": "/usr/local/bin/qdelaunay", "qhalf": "/usr/local/bin/qhalf", "qhull": "/usr/local/bin/qhull", "qvoronoi": "/usr/local/bin/qvoronoi", "rbox": "/usr/local/bin/rbox", "numpy-config": "/usr/local/bin/numpy-config", "fonttools": "/usr/local/bin/fonttools"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/enzywizard-dock.
singularity registry hpc automated addition for enzywizard-dock
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/enzywizard-dock
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/enzywizard-dock:1.0.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/enzywizard-dock/1.0.2--pyhdfd78af_0
$ module help quay.io/biocontainers/enzywizard-dock/1.0.2--pyhdfd78af_0
```
...
#### enzywizard-dock-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### enzywizard-dock-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/enzywizard-dock
$ podman run --it --rm --entrypoint /usr/local/bin/enzywizard-dock   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/enzywizard-dock   -v ${PWD} -w ${PWD} <container> -c " $@"
```
