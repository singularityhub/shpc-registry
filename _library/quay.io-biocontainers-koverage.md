---
layout: container
name:  "quay.io/biocontainers/koverage"
maintainer: "@vsoch"
...
updated_at: "2024-06-09 03:19:25.828894"
...
```bash
$ shpc install quay.io/biocontainers/koverage
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/koverage:0.1.11--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/koverage/0.1.11--pyhdfd78af_0
$ module help quay.io/biocontainers/koverage/0.1.11--pyhdfd78af_0
```
...
#### koverage-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### koverage-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/koverage
$ podman run --it --rm --entrypoint /usr/local/bin/koverage   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/koverage   -v ${PWD} -w ${PWD} <container> -c " $@"
```
