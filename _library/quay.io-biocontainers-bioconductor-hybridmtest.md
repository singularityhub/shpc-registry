...
updated_at: "2023-11-03 02:52:01.003013"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hybridmtest:1.44.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hybridmtest/1.44.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-hybridmtest/1.44.0--r43hdfd78af_0
```
