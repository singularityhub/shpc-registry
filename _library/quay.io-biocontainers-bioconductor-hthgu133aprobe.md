...
updated_at: "2026-03-23 04:47:50.595220"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hthgu133aprobe:2.18.0--r45hdfd78af_14
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hthgu133aprobe/2.18.0--r45hdfd78af_14
$ module help quay.io/biocontainers/bioconductor-hthgu133aprobe/2.18.0--r45hdfd78af_14
```
