...
updated_at: "2024-05-02 03:34:40.754015"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-splicewiz:1.4.0--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-splicewiz/1.4.0--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-splicewiz/1.4.0--r43hf17093f_0
```
