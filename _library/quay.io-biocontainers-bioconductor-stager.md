...
updated_at: "2022-10-29 05:55:05.984127"
latest: "1.8.0--r36_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-stager:1.8.0--r36_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-stager/1.8.0--r36_0
$ module help quay.io/biocontainers/bioconductor-stager/1.8.0--r36_0
```
