...
updated_at: "2025-05-08 05:45:36.505531"
...
```bash
$ shpc install quay.io/biocontainers/hmftools-cider:1.0.3--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hmftools-cider/1.0.3--hdfd78af_0
$ module help quay.io/biocontainers/hmftools-cider/1.0.3--hdfd78af_0
```
