...
updated_at: "2025-06-12 03:48:44.532359"
...
```bash
$ shpc install quay.io/biocontainers/ampliconsuite:1.3.8--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ampliconsuite/1.3.8--pyhdfd78af_0
$ module help quay.io/biocontainers/ampliconsuite/1.3.8--pyhdfd78af_0
```
