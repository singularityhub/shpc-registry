...
updated_at: "2024-06-22 03:00:19.672676"
...
```bash
$ shpc install quay.io/biocontainers/ampliconsuite:1.3.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ampliconsuite/1.3.2--pyhdfd78af_0
$ module help quay.io/biocontainers/ampliconsuite/1.3.2--pyhdfd78af_0
```
