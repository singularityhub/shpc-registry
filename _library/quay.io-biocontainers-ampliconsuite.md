...
updated_at: "2026-02-07 04:32:09.618935"
...
```bash
$ shpc install quay.io/biocontainers/ampliconsuite:1.5.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ampliconsuite/1.5.0--pyhdfd78af_0
$ module help quay.io/biocontainers/ampliconsuite/1.5.0--pyhdfd78af_0
```
