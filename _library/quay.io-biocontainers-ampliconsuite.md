...
updated_at: "2024-01-27 03:01:17.038538"
...
```bash
$ shpc install quay.io/biocontainers/ampliconsuite:1.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ampliconsuite/1.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/ampliconsuite/1.2.0--pyhdfd78af_0
```
