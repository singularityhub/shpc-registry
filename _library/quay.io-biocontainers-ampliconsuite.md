...
updated_at: "2025-12-29 04:38:07.058159"
...
```bash
$ shpc install quay.io/biocontainers/ampliconsuite:1.4.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ampliconsuite/1.4.0--pyhdfd78af_0
$ module help quay.io/biocontainers/ampliconsuite/1.4.0--pyhdfd78af_0
```
