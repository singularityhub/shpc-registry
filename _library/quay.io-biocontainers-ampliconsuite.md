...
updated_at: "2023-12-10 02:55:02.793050"
...
```bash
$ shpc install quay.io/biocontainers/ampliconsuite:1.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ampliconsuite/1.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/ampliconsuite/1.1.0--pyhdfd78af_0
```
