...
updated_at: "2026-03-23 05:22:34.220047"
...
```bash
$ shpc install quay.io/biocontainers/ampliconsuite:1.5.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ampliconsuite/1.5.1--pyhdfd78af_0
$ module help quay.io/biocontainers/ampliconsuite/1.5.1--pyhdfd78af_0
```
