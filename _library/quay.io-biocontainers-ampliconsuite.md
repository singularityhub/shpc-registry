...
updated_at: "2024-12-15 04:13:57.720475"
...
```bash
$ shpc install quay.io/biocontainers/ampliconsuite:1.3.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ampliconsuite/1.3.4--pyhdfd78af_0
$ module help quay.io/biocontainers/ampliconsuite/1.3.4--pyhdfd78af_0
```
