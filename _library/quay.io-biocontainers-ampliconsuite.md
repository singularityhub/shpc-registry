...
updated_at: "2024-05-25 02:31:19.433233"
...
```bash
$ shpc install quay.io/biocontainers/ampliconsuite:1.3.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ampliconsuite/1.3.1--pyhdfd78af_0
$ module help quay.io/biocontainers/ampliconsuite/1.3.1--pyhdfd78af_0
```
