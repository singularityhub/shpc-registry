...
updated_at: "2024-07-18 04:07:22.881384"
...
```bash
$ shpc install quay.io/biocontainers/ampliconsuite:1.3.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ampliconsuite/1.3.3--pyhdfd78af_0
$ module help quay.io/biocontainers/ampliconsuite/1.3.3--pyhdfd78af_0
```
