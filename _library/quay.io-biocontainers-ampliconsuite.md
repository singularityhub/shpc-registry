...
updated_at: "2025-07-31 11:36:06.196356"
...
```bash
$ shpc install quay.io/biocontainers/ampliconsuite:1.3.9--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ampliconsuite/1.3.9--pyhdfd78af_0
$ module help quay.io/biocontainers/ampliconsuite/1.3.9--pyhdfd78af_0
```
