...
updated_at: "2026-04-02 04:41:57.749820"
...
```bash
$ shpc install quay.io/biocontainers/ampliconsuite:1.5.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ampliconsuite/1.5.2--pyhdfd78af_0
$ module help quay.io/biocontainers/ampliconsuite/1.5.2--pyhdfd78af_0
```
