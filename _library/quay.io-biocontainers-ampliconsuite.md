...
updated_at: "2026-06-26 06:35:44.026392"
...
```bash
$ shpc install quay.io/biocontainers/ampliconsuite:1.5.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ampliconsuite/1.5.3--pyhdfd78af_0
$ module help quay.io/biocontainers/ampliconsuite/1.5.3--pyhdfd78af_0
```
