...
updated_at: "2022-10-27 00:26:09.510623"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-spidermir:1.8.2--r3.4.1_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-spidermir/1.8.2--r3.4.1_0
$ module help quay.io/biocontainers/bioconductor-spidermir/1.8.2--r3.4.1_0
```
