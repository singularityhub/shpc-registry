...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-ensdb.rnorvegicus.v79-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-ensdb.rnorvegicus.v79-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-ensdb.rnorvegicus.v79-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-ensdb.rnorvegicus.v79-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-ensdb.rnorvegicus.v79-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-ensdb.rnorvegicus.v79-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
