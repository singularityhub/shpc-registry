...
updated_at: "2026-03-13 05:04:10.764045"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-recoup:1.38.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-recoup/1.38.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-recoup/1.38.0--r45hdfd78af_0
```
