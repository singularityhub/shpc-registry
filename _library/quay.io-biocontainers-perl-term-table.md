...
updated_at: "2024-12-29 03:32:29.696063"
latest: "0.023--pl5321hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/perl-term-table:0.023--pl5321hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/perl-term-table/0.023--pl5321hdfd78af_0
$ module help quay.io/biocontainers/perl-term-table/0.023--pl5321hdfd78af_0
```
