...
updated_at: "2023-10-10 02:36:08.986766"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-scifer:1.2.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-scifer/1.2.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-scifer/1.2.0--r43hdfd78af_0
```
