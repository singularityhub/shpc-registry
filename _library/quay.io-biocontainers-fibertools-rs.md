...
updated_at: "2025-02-18 03:04:07.295336"
latest: "0.6.2--h3b373d1_0"
...
```bash
$ shpc install quay.io/biocontainers/fibertools-rs:0.6.2--h3b373d1_0
```
...
```bash
$ module load quay.io/biocontainers/fibertools-rs/0.6.2--h3b373d1_0
$ module help quay.io/biocontainers/fibertools-rs/0.6.2--h3b373d1_0
```
