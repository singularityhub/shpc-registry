...
updated_at: "2025-12-04 03:29:19.304099"
latest: "0.8.0--h3b373d1_0"
...
```bash
$ shpc install quay.io/biocontainers/fibertools-rs:0.8.0--h3b373d1_0
```
...
```bash
$ module load quay.io/biocontainers/fibertools-rs/0.8.0--h3b373d1_0
$ module help quay.io/biocontainers/fibertools-rs/0.8.0--h3b373d1_0
```
