...
updated_at: "2026-01-09 03:50:10.886975"
latest: "0.8.1--h3b373d1_0"
...
```bash
$ shpc install quay.io/biocontainers/fibertools-rs:0.8.1--h3b373d1_0
```
...
```bash
$ module load quay.io/biocontainers/fibertools-rs/0.8.1--h3b373d1_0
$ module help quay.io/biocontainers/fibertools-rs/0.8.1--h3b373d1_0
```
