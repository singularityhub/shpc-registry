...
updated_at: "2026-06-22 07:33:53.180841"
latest: "0.9.0--h270025b_0"
...
```bash
$ shpc install quay.io/biocontainers/fibertools-rs:0.9.0--h270025b_0
```
...
```bash
$ module load quay.io/biocontainers/fibertools-rs/0.9.0--h270025b_0
$ module help quay.io/biocontainers/fibertools-rs/0.9.0--h270025b_0
```
