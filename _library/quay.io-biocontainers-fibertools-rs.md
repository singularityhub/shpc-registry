...
updated_at: "2024-04-22 02:32:08.516133"
latest: "0.4.2--h95980b9_0"
...
```bash
$ shpc install quay.io/biocontainers/fibertools-rs:0.4.2--h95980b9_0
```
...
```bash
$ module load quay.io/biocontainers/fibertools-rs/0.4.2--h95980b9_0
$ module help quay.io/biocontainers/fibertools-rs/0.4.2--h95980b9_0
```
