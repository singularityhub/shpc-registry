...
updated_at: "2024-09-04 02:51:17.188117"
latest: "0.5.3--h588a25a_0"
...
```bash
$ shpc install quay.io/biocontainers/fibertools-rs:0.5.3--h588a25a_0
```
...
```bash
$ module load quay.io/biocontainers/fibertools-rs/0.5.3--h588a25a_0
$ module help quay.io/biocontainers/fibertools-rs/0.5.3--h588a25a_0
```
