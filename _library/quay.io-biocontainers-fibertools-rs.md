...
updated_at: "2026-08-21 16:20:20.752631"
...
```bash
$ shpc install quay.io/biocontainers/fibertools-rs:0.13.0--h270025b_0
```
...
```bash
$ module load quay.io/biocontainers/fibertools-rs/0.13.0--h270025b_0
$ module help quay.io/biocontainers/fibertools-rs/0.13.0--h270025b_0
```
