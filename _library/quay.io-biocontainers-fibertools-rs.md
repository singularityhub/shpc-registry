...
updated_at: "2024-04-18 02:30:37.845185"
latest: "0.3.9--h95980b9_0"
...
```bash
$ shpc install quay.io/biocontainers/fibertools-rs:0.3.9--h95980b9_0
```
...
```bash
$ module load quay.io/biocontainers/fibertools-rs/0.3.9--h95980b9_0
$ module help quay.io/biocontainers/fibertools-rs/0.3.9--h95980b9_0
```
