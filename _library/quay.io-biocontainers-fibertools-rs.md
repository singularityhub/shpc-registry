...
updated_at: "2024-03-10 02:45:03.563624"
latest: "0.3.8--h95980b9_0"
...
```bash
$ shpc install quay.io/biocontainers/fibertools-rs:0.3.8--h95980b9_0
```
...
```bash
$ module load quay.io/biocontainers/fibertools-rs/0.3.8--h95980b9_0
$ module help quay.io/biocontainers/fibertools-rs/0.3.8--h95980b9_0
```
