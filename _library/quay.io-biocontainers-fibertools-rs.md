...
updated_at: "2023-06-29 03:36:51.276572"
latest: "0.2.2--h2c7573f_0"
...
```bash
$ shpc install quay.io/biocontainers/fibertools-rs:0.2.2--h2c7573f_0
```
...
```bash
$ module load quay.io/biocontainers/fibertools-rs/0.2.2--h2c7573f_0
$ module help quay.io/biocontainers/fibertools-rs/0.2.2--h2c7573f_0
```
