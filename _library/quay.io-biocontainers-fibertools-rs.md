...
updated_at: "2024-08-01 03:34:10.383382"
latest: "0.4.2--h588a25a_1"
...
```bash
$ shpc install quay.io/biocontainers/fibertools-rs:0.4.2--h588a25a_1
```
...
```bash
$ module load quay.io/biocontainers/fibertools-rs/0.4.2--h588a25a_1
$ module help quay.io/biocontainers/fibertools-rs/0.4.2--h588a25a_1
```
