...
updated_at: "2026-03-02 04:26:48.155885"
latest: "0.8.2--h3b373d1_0"
...
```bash
$ shpc install quay.io/biocontainers/fibertools-rs:0.8.2--h3b373d1_0
```
...
```bash
$ module load quay.io/biocontainers/fibertools-rs/0.8.2--h3b373d1_0
$ module help quay.io/biocontainers/fibertools-rs/0.8.2--h3b373d1_0
```
