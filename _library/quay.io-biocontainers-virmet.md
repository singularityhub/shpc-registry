...
updated_at: "2026-01-27 04:23:42.174206"
...
```bash
$ shpc install quay.io/biocontainers/virmet:2.0.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/virmet/2.0.1--pyhdfd78af_0
$ module help quay.io/biocontainers/virmet/2.0.1--pyhdfd78af_0
```
