...
updated_at: "2025-12-09 03:52:56.397508"
...
```bash
$ shpc install quay.io/biocontainers/virmet:2.0.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/virmet/2.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/virmet/2.0.0--pyhdfd78af_0
```
