...
updated_at: "2026-01-14 04:22:42.521635"
...
```bash
$ shpc install quay.io/biocontainers/virmet:2.0.0--pyhdfd78af_2
```
...
```bash
$ module load quay.io/biocontainers/virmet/2.0.0--pyhdfd78af_2
$ module help quay.io/biocontainers/virmet/2.0.0--pyhdfd78af_2
```
