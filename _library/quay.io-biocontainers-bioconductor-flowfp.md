...
updated_at: "2024-05-07 02:43:39.559385"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-flowfp:1.60.0--r43ha9d7317_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-flowfp/1.60.0--r43ha9d7317_0
$ module help quay.io/biocontainers/bioconductor-flowfp/1.60.0--r43ha9d7317_0
```
