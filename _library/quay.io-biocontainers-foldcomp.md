...
updated_at: "2026-03-28 16:45:38.254197"
latest: "1.0.0--h7f5d12c_0"
...
```bash
$ shpc install quay.io/biocontainers/foldcomp:1.0.0--h7f5d12c_0
```
...
```bash
$ module load quay.io/biocontainers/foldcomp/1.0.0--h7f5d12c_0
$ module help quay.io/biocontainers/foldcomp/1.0.0--h7f5d12c_0
```
