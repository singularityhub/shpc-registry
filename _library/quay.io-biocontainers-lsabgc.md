...
updated_at: "2025-10-06 03:40:14.616295"
...
```bash
$ shpc install quay.io/biocontainers/lsabgc:1.1.9--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/lsabgc/1.1.9--pyhdfd78af_0
$ module help quay.io/biocontainers/lsabgc/1.1.9--pyhdfd78af_0
```
