...
updated_at: "2025-09-05 03:20:32.923093"
...
```bash
$ shpc install quay.io/biocontainers/lsabgc:1.1.7--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/lsabgc/1.1.7--pyhdfd78af_1
$ module help quay.io/biocontainers/lsabgc/1.1.7--pyhdfd78af_1
```
