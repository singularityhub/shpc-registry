...
updated_at: "2025-12-08 05:24:05.822665"
...
```bash
$ shpc install quay.io/biocontainers/lsabgc:1.1.10--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/lsabgc/1.1.10--pyhdfd78af_0
$ module help quay.io/biocontainers/lsabgc/1.1.10--pyhdfd78af_0
```
