...
updated_at: "2025-11-25 03:35:34.971880"
latest: "0.1.1--py311ha96b9cd_5"
...
```bash
$ shpc install quay.io/biocontainers/nrpys:0.1.1--py311ha96b9cd_5
```
...
```bash
$ module load quay.io/biocontainers/nrpys/0.1.1--py311ha96b9cd_5
$ module help quay.io/biocontainers/nrpys/0.1.1--py311ha96b9cd_5
```
