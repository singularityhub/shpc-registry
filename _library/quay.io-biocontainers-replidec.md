...
updated_at: "2026-09-18 07:59:27.544129"
...
```bash
$ shpc install quay.io/biocontainers/replidec:0.3.6--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/replidec/0.3.6--pyhdfd78af_0
$ module help quay.io/biocontainers/replidec/0.3.6--pyhdfd78af_0
```
