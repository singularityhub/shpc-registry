...
updated_at: "2026-03-28 16:49:00.810968"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-deepsnv:1.56.0--r45ha27e39d_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-deepsnv/1.56.0--r45ha27e39d_0
$ module help quay.io/biocontainers/bioconductor-deepsnv/1.56.0--r45ha27e39d_0
```
