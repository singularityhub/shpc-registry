...
updated_at: "2025-02-28 03:37:20.451104"
latest: "1.52.0--r44h77050f0_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-deepsnv:1.52.0--r44h77050f0_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-deepsnv/1.52.0--r44h77050f0_0
$ module help quay.io/biocontainers/bioconductor-deepsnv/1.52.0--r44h77050f0_0
```
