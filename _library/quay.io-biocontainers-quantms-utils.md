...
updated_at: "2024-07-29 17:25:13.991477"
...
```bash
$ shpc install quay.io/biocontainers/quantms-utils:0.0.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/quantms-utils/0.0.2--pyhdfd78af_0
$ module help quay.io/biocontainers/quantms-utils/0.0.2--pyhdfd78af_0
```
