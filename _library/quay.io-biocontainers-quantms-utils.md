...
updated_at: "2026-06-07 06:53:20.683933"
...
```bash
$ shpc install quay.io/biocontainers/quantms-utils:0.0.30--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/quantms-utils/0.0.30--pyhdfd78af_0
$ module help quay.io/biocontainers/quantms-utils/0.0.30--pyhdfd78af_0
```
