...
updated_at: "2024-08-28 03:16:23.998005"
...
```bash
$ shpc install quay.io/biocontainers/quantms-utils:0.0.9--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/quantms-utils/0.0.9--pyhdfd78af_0
$ module help quay.io/biocontainers/quantms-utils/0.0.9--pyhdfd78af_0
```
