...
updated_at: "2026-04-02 05:21:57.326038"
latest: "0.0.25--pyh106432d_0"
...
```bash
$ shpc install quay.io/biocontainers/quantms-utils:0.0.25--pyh106432d_0
```
...
```bash
$ module load quay.io/biocontainers/quantms-utils/0.0.25--pyh106432d_0
$ module help quay.io/biocontainers/quantms-utils/0.0.25--pyh106432d_0
```
