...
updated_at: "2024-11-06 03:35:16.855618"
...
```bash
$ shpc install quay.io/biocontainers/quantms-utils:0.0.11--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/quantms-utils/0.0.11--pyhdfd78af_0
$ module help quay.io/biocontainers/quantms-utils/0.0.11--pyhdfd78af_0
```
