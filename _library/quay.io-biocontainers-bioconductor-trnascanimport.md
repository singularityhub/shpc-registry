...
updated_at: "2026-04-03 15:15:34.619429"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-trnascanimport:1.30.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-trnascanimport/1.30.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-trnascanimport/1.30.0--r45hdfd78af_0
```
