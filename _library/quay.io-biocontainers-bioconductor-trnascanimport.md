...
updated_at: "2025-02-13 03:34:34.915129"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-trnascanimport:1.26.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-trnascanimport/1.26.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-trnascanimport/1.26.0--r44hdfd78af_0
```
