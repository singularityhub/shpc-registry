...
updated_at: "2025-12-28 04:37:56.141945"
...
```bash
$ shpc install quay.io/biocontainers/nf-core:3.5.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/nf-core/3.5.1--pyhdfd78af_0
$ module help quay.io/biocontainers/nf-core/3.5.1--pyhdfd78af_0
```
