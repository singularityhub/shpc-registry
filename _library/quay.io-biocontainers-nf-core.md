...
updated_at: "2023-12-02 02:41:36.830901"
latest: "2.10--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/nf-core:2.10--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/nf-core/2.10--pyhdfd78af_0
$ module help quay.io/biocontainers/nf-core/2.10--pyhdfd78af_0
```
