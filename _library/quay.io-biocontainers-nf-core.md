...
updated_at: "2024-06-15 03:19:05.483096"
latest: "2.14.1--pyhdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/nf-core:2.14.1--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/nf-core/2.14.1--pyhdfd78af_1
$ module help quay.io/biocontainers/nf-core/2.14.1--pyhdfd78af_1
```
