...
updated_at: "2025-09-28 03:55:32.111663"
...
```bash
$ shpc install quay.io/biocontainers/nf-core:3.3.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/nf-core/3.3.2--pyhdfd78af_0
$ module help quay.io/biocontainers/nf-core/3.3.2--pyhdfd78af_0
```
