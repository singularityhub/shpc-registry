...
updated_at: "2025-04-13 04:35:56.835558"
...
```bash
$ shpc install quay.io/biocontainers/nf-core:3.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/nf-core/3.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/nf-core/3.2.0--pyhdfd78af_0
```
