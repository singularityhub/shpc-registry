...
updated_at: "2025-11-17 04:06:02.581372"
...
```bash
$ shpc install quay.io/biocontainers/nf-core:3.4.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/nf-core/3.4.1--pyhdfd78af_0
$ module help quay.io/biocontainers/nf-core/3.4.1--pyhdfd78af_0
```
