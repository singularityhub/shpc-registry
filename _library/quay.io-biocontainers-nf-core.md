...
updated_at: "2026-02-06 05:03:29.132645"
latest: "3.5.2--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/nf-core:3.5.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/nf-core/3.5.2--pyhdfd78af_0
$ module help quay.io/biocontainers/nf-core/3.5.2--pyhdfd78af_0
```
