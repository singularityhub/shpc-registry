...
updated_at: "2024-02-12 03:22:54.347775"
latest: "2.12.1--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/nf-core:2.12.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/nf-core/2.12.1--pyhdfd78af_0
$ module help quay.io/biocontainers/nf-core/2.12.1--pyhdfd78af_0
```
