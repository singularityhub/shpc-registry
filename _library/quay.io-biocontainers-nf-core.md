...
updated_at: "2025-01-02 03:22:30.414162"
...
```bash
$ shpc install quay.io/biocontainers/nf-core:3.0.2--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/nf-core/3.0.2--pyhdfd78af_1
$ module help quay.io/biocontainers/nf-core/3.0.2--pyhdfd78af_1
```
