...
updated_at: "2025-05-12 03:55:16.418211"
...
```bash
$ shpc install quay.io/biocontainers/nf-core:3.2.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/nf-core/3.2.1--pyhdfd78af_0
$ module help quay.io/biocontainers/nf-core/3.2.1--pyhdfd78af_0
```
