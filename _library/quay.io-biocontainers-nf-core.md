...
updated_at: "2024-01-22 03:12:02.151243"
...
```bash
$ shpc install quay.io/biocontainers/nf-core:2.11.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/nf-core/2.11.1--pyhdfd78af_0
$ module help quay.io/biocontainers/nf-core/2.11.1--pyhdfd78af_0
```
