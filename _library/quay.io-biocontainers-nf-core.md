...
updated_at: "2025-08-02 03:34:30.306684"
...
```bash
$ shpc install quay.io/biocontainers/nf-core:3.3.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/nf-core/3.3.1--pyhdfd78af_0
$ module help quay.io/biocontainers/nf-core/3.3.1--pyhdfd78af_0
```
