...
updated_at: "2023-08-28 02:58:32.758223"
latest: "2.9--pyh7cba7a3_0"
...
```bash
$ shpc install quay.io/biocontainers/nf-core:2.9--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/nf-core/2.9--pyh7cba7a3_0
$ module help quay.io/biocontainers/nf-core/2.9--pyh7cba7a3_0
```
