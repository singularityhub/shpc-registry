...
updated_at: "2025-08-31 03:14:12.502937"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-singlemoleculefootprintingdata:1.14.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-singlemoleculefootprintingdata/1.14.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-singlemoleculefootprintingdata/1.14.0--r44hdfd78af_0
```
