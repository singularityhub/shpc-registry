...
updated_at: "2026-03-28 04:33:47.146240"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-viper:1.44.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-viper/1.44.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-viper/1.44.0--r45hdfd78af_0
```
