...
updated_at: "2024-08-05 02:50:29.058048"
latest: "1.1.5--py39hff71179_2"
...
```bash
$ shpc install quay.io/biocontainers/umi_tools:1.1.5--py39hff71179_2
```
...
```bash
$ module load quay.io/biocontainers/umi_tools/1.1.5--py39hff71179_2
$ module help quay.io/biocontainers/umi_tools/1.1.5--py39hff71179_2
```
