...
updated_at: "2023-11-08 02:33:42.633983"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-alevinqc:1.16.0--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-alevinqc/1.16.0--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-alevinqc/1.16.0--r43hf17093f_0
```
