...
updated_at: "2026-03-05 05:07:19.201809"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-pasillabamsubset:0.48.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-pasillabamsubset/0.48.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-pasillabamsubset/0.48.0--r45hdfd78af_0
```
