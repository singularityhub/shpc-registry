...
updated_at: "2024-10-30 03:36:50.732164"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-tmixclust:1.24.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-tmixclust/1.24.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-tmixclust/1.24.0--r43hdfd78af_0
```
