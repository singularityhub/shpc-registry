...
updated_at: "2024-02-12 03:18:38.830155"
...
```bash
$ shpc install quay.io/biocontainers/segmetrics:1.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/segmetrics/1.4--pyhdfd78af_0
$ module help quay.io/biocontainers/segmetrics/1.4--pyhdfd78af_0
```
