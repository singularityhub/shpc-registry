...
updated_at: "2026-04-05 05:26:47.634956"
...
```bash
$ shpc install quay.io/biocontainers/segmetrics:1.6.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/segmetrics/1.6.0--pyhdfd78af_0
$ module help quay.io/biocontainers/segmetrics/1.6.0--pyhdfd78af_0
```
