...
updated_at: "2025-01-23 03:54:06.169555"
...
```bash
$ shpc install quay.io/biocontainers/segmetrics:1.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/segmetrics/1.5--pyhdfd78af_0
$ module help quay.io/biocontainers/segmetrics/1.5--pyhdfd78af_0
```
