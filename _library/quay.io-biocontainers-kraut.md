---
layout: container
name:  "quay.io/biocontainers/kraut"
maintainer: "@vsoch"
...
updated_at: "2026-08-25 03:27:08.747149"
...
```bash
$ module load quay.io/biocontainers/kraut/0.7.0--pyhdfd78af_0
$ module help quay.io/biocontainers/kraut/0.7.0--pyhdfd78af_0
```
...
#### kraut-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### kraut-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/kraut
$ podman run --it --rm --entrypoint /usr/local/bin/kraut   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/kraut   -v ${PWD} -w ${PWD} <container> -c " $@"
```
