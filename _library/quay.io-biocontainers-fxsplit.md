---
layout: container
name:  "quay.io/biocontainers/fxsplit"
maintainer: "@vsoch"
...
updated_at: "2026-04-04 05:18:08.257340"
...
singularity registry hpc automated addition for fxsplit
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/fxsplit
```
...
#### fxsplit-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### fxsplit-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/fxsplit
$ podman run --it --rm --entrypoint /usr/local/bin/fxsplit   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/fxsplit   -v ${PWD} -w ${PWD} <container> -c " $@"
```
