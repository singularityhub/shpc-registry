---
layout: container
name:  "quay.io/biocontainers/starcatpy"
maintainer: "@vsoch"
...
updated_at: "2026-03-28 04:38:17.314871"
latest: "1.0.10--pyh106432d_0"
...
```bash
$ shpc install quay.io/biocontainers/starcatpy
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/starcatpy:1.0.10--pyh106432d_0
```
...
```bash
$ module load quay.io/biocontainers/starcatpy/1.0.10--pyh106432d_0
$ module help quay.io/biocontainers/starcatpy/1.0.10--pyh106432d_0
```
...
#### starcatpy-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### starcatpy-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/starcat
$ podman run --it --rm --entrypoint /usr/local/bin/starcat   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/starcat   -v ${PWD} -w ${PWD} <container> -c " $@"
```
