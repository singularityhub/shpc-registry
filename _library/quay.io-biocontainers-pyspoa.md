...
updated_at: "2026-03-11 04:25:11.976232"
latest: "0.3.2--py313h7fbb527_1"
...
```bash
$ shpc install quay.io/biocontainers/pyspoa:0.3.2--py313h7fbb527_1
```
...
```bash
$ module load quay.io/biocontainers/pyspoa/0.3.2--py313h7fbb527_1
$ module help quay.io/biocontainers/pyspoa/0.3.2--py313h7fbb527_1
```
