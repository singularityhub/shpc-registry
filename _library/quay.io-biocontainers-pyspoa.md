...
updated_at: "2024-07-08 02:47:47.075443"
latest: "0.2.1--py38hd638cd3_2"
...
```bash
$ shpc install quay.io/biocontainers/pyspoa:0.2.1--py38hd638cd3_2
```
...
```bash
$ module load quay.io/biocontainers/pyspoa/0.2.1--py38hd638cd3_2
$ module help quay.io/biocontainers/pyspoa/0.2.1--py38hd638cd3_2
```
