...
updated_at: "2024-09-30 03:44:29.328798"
...
```bash
$ shpc install quay.io/biocontainers/ensembl-utils:0.5.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ensembl-utils/0.5.0--pyhdfd78af_0
$ module help quay.io/biocontainers/ensembl-utils/0.5.0--pyhdfd78af_0
```
