...
updated_at: "2026-03-31 05:36:26.038108"
...
```bash
$ shpc install quay.io/biocontainers/ensembl-utils:0.9.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ensembl-utils/0.9.0--pyhdfd78af_0
$ module help quay.io/biocontainers/ensembl-utils/0.9.0--pyhdfd78af_0
```
