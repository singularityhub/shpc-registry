...
updated_at: "2025-05-07 03:25:39.403010"
...
```bash
$ shpc install quay.io/biocontainers/ensembl-utils:0.7.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ensembl-utils/0.7.0--pyhdfd78af_0
$ module help quay.io/biocontainers/ensembl-utils/0.7.0--pyhdfd78af_0
```
