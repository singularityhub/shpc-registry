...
updated_at: "2026-05-28 15:54:23.480442"
...
```bash
$ shpc install quay.io/biocontainers/ensembl-utils:0.9.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ensembl-utils/0.9.1--pyhdfd78af_0
$ module help quay.io/biocontainers/ensembl-utils/0.9.1--pyhdfd78af_0
```
