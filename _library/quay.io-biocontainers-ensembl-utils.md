...
updated_at: "2026-06-25 06:54:34.188352"
...
```bash
$ shpc install quay.io/biocontainers/ensembl-utils:0.9.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ensembl-utils/0.9.2--pyhdfd78af_0
$ module help quay.io/biocontainers/ensembl-utils/0.9.2--pyhdfd78af_0
```
