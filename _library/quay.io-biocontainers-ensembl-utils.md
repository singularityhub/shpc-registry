...
updated_at: "2026-07-25 07:44:03.393786"
...
```bash
$ shpc install quay.io/biocontainers/ensembl-utils:1.0.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ensembl-utils/1.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/ensembl-utils/1.0.0--pyhdfd78af_0
```
