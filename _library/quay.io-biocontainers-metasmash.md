...
updated_at: "2026-07-28 05:47:36.495329"
...
```bash
$ shpc install quay.io/biocontainers/metasmash:0.1.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/metasmash/0.1.4--pyhdfd78af_0
$ module help quay.io/biocontainers/metasmash/0.1.4--pyhdfd78af_0
```
