...
updated_at: "2026-07-01 15:11:11.166795"
...
```bash
$ shpc install quay.io/biocontainers/metasmash:0.1.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/metasmash/0.1.3--pyhdfd78af_0
$ module help quay.io/biocontainers/metasmash/0.1.3--pyhdfd78af_0
```
