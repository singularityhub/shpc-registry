...
updated_at: "2024-03-17 02:27:02.525404"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cftoolsdata:1.0.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cftoolsdata/1.0.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-cftoolsdata/1.0.0--r43hdfd78af_0
```
