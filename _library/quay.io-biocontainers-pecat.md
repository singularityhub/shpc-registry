...
updated_at: "2025-10-26 03:20:31.175506"
latest: "0.0.3--hdb21b49_2"
...
```bash
$ shpc install quay.io/biocontainers/pecat:0.0.3--hdb21b49_2
```
...
```bash
$ module load quay.io/biocontainers/pecat/0.0.3--hdb21b49_2
$ module help quay.io/biocontainers/pecat/0.0.3--hdb21b49_2
```
