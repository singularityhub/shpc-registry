...
updated_at: "2025-06-23 03:51:19.118787"
...
```bash
$ shpc install mariadb:12.0-noble-rc
```
...
```bash
$ module load mariadb/12.0-noble-rc
$ module help mariadb/12.0-noble-rc
```
