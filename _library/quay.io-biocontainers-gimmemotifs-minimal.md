...
updated_at: "2026-05-26 06:22:47.057926"
...
```bash
$ shpc install quay.io/biocontainers/gimmemotifs-minimal:0.18.2--py312hfabe715_1
```
...
```bash
$ module load quay.io/biocontainers/gimmemotifs-minimal/0.18.2--py312hfabe715_1
$ module help quay.io/biocontainers/gimmemotifs-minimal/0.18.2--py312hfabe715_1
```
