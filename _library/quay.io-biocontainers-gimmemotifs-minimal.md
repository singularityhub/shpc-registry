...
updated_at: "2026-01-21 03:51:21.169159"
latest: "0.18.1--py39hbcbf7aa_0"
...
```bash
$ shpc install quay.io/biocontainers/gimmemotifs-minimal:0.18.1--py39hbcbf7aa_0
```
...
```bash
$ module load quay.io/biocontainers/gimmemotifs-minimal/0.18.1--py39hbcbf7aa_0
$ module help quay.io/biocontainers/gimmemotifs-minimal/0.18.1--py39hbcbf7aa_0
```
