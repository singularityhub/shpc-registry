...
updated_at: "2025-09-01 04:02:41.828514"
latest: "0.18.0--py39hbcbf7aa_7"
...
```bash
$ shpc install quay.io/biocontainers/gimmemotifs-minimal:0.18.0--py39hbcbf7aa_7
```
...
```bash
$ module load quay.io/biocontainers/gimmemotifs-minimal/0.18.0--py39hbcbf7aa_7
$ module help quay.io/biocontainers/gimmemotifs-minimal/0.18.0--py39hbcbf7aa_7
```
