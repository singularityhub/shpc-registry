...
updated_at: "2026-06-29 06:59:15.046865"
latest: "0.18.4--py310h6813faf_0"
...
```bash
$ shpc install quay.io/biocontainers/gimmemotifs-minimal:0.18.4--py310h6813faf_0
```
...
```bash
$ module load quay.io/biocontainers/gimmemotifs-minimal/0.18.4--py310h6813faf_0
$ module help quay.io/biocontainers/gimmemotifs-minimal/0.18.4--py310h6813faf_0
```
