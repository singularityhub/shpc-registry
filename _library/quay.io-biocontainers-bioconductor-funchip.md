...
updated_at: "2022-11-05 00:07:00.882700"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-funchip:1.8.0--r351hf484d3e_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-funchip/1.8.0--r351hf484d3e_0
$ module help quay.io/biocontainers/bioconductor-funchip/1.8.0--r351hf484d3e_0
```
