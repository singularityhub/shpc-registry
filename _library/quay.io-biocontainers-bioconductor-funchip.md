...
updated_at: "2023-10-02 03:27:21.313327"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-funchip:1.26.0--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-funchip/1.26.0--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-funchip/1.26.0--r43hf17093f_0
```
