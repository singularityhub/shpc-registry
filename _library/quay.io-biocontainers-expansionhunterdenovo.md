...
updated_at: "2025-10-03 03:43:29.607896"
latest: "0.9.0--h6ac36c1_10"
...
```bash
$ shpc install quay.io/biocontainers/expansionhunterdenovo:0.9.0--h6ac36c1_10
```
...
```bash
$ module load quay.io/biocontainers/expansionhunterdenovo/0.9.0--h6ac36c1_10
$ module help quay.io/biocontainers/expansionhunterdenovo/0.9.0--h6ac36c1_10
```
