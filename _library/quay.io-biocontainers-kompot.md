...
updated_at: "2026-06-04 06:59:21.968610"
...
```bash
$ shpc install quay.io/biocontainers/kompot:0.7.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/kompot/0.7.0--pyhdfd78af_0
$ module help quay.io/biocontainers/kompot/0.7.0--pyhdfd78af_0
```
