...
updated_at: "2026-08-27 23:41:05.995065"
...
```bash
$ shpc install quay.io/biocontainers/kompot:0.8.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/kompot/0.8.0--pyhdfd78af_0
$ module help quay.io/biocontainers/kompot/0.8.0--pyhdfd78af_0
```
