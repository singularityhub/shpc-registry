...
updated_at: "2026-04-05 04:48:18.625505"
...
```bash
$ shpc install quay.io/biocontainers/kompot:0.6.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/kompot/0.6.3--pyhdfd78af_0
$ module help quay.io/biocontainers/kompot/0.6.3--pyhdfd78af_0
```
