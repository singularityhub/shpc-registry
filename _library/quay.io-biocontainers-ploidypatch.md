---
layout: container
name:  "quay.io/biocontainers/ploidypatch"
maintainer: "@vsoch"
...
updated_at: "2026-08-26 03:43:30.882523"
...
singularity registry hpc automated addition for ploidypatch
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/ploidypatch
```
...
#### ploidypatch-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### ploidypatch-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/ploidypatch
$ podman run --it --rm --entrypoint /usr/local/bin/ploidypatch   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/ploidypatch   -v ${PWD} -w ${PWD} <container> -c " $@"
```
