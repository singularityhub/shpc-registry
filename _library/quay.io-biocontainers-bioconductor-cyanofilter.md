...
updated_at: "2022-11-02 00:28:14.883564"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cyanofilter:1.2.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cyanofilter/1.2.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-cyanofilter/1.2.0--r41hdfd78af_0
```
