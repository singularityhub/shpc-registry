...
updated_at: "2026-03-25 05:00:16.067489"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-consensusde:1.28.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-consensusde/1.28.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-consensusde/1.28.0--r45hdfd78af_0
```
