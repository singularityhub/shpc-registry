...
updated_at: "2024-09-30 03:28:41.640868"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-consensusde:1.20.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-consensusde/1.20.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-consensusde/1.20.0--r43hdfd78af_0
```
