...
updated_at: "2023-09-01 02:36:40.153037"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-signaturesearch:1.14.0--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-signaturesearch/1.14.0--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-signaturesearch/1.14.0--r43hf17093f_0
```
