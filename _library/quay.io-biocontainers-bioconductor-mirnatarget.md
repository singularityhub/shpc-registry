...
updated_at: "2023-11-13 02:36:42.444534"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mirnatarget:1.38.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mirnatarget/1.38.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-mirnatarget/1.38.0--r43hdfd78af_0
```
