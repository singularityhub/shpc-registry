...
updated_at: "2024-06-07 03:01:32.821125"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-sctgif:1.16.0--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-sctgif/1.16.0--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-sctgif/1.16.0--r43hf17093f_0
```
