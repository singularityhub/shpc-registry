...
updated_at: "2024-06-05 02:32:19.090907"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-deqms:1.20.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-deqms/1.20.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-deqms/1.20.0--r43hdfd78af_0
```
