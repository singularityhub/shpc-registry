...
updated_at: "2022-10-29 08:06:41.309736"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-deqms:1.8.0--r40hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-deqms/1.8.0--r40hdfd78af_1
$ module help quay.io/biocontainers/bioconductor-deqms/1.8.0--r40hdfd78af_1
```
