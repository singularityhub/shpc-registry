...
updated_at: "2026-04-05 04:40:10.096983"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-deqms:1.28.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-deqms/1.28.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-deqms/1.28.0--r45hdfd78af_0
```
