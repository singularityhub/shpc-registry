...
updated_at: "2023-11-22 03:05:38.532869"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-tloh:1.8.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-tloh/1.8.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-tloh/1.8.0--r43hdfd78af_0
```
