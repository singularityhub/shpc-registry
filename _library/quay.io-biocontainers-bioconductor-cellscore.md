...
updated_at: "2024-08-14 03:07:06.040869"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cellscore:1.22.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cellscore/1.22.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-cellscore/1.22.0--r43hdfd78af_0
```
