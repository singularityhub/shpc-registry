...
updated_at: "2023-10-28 02:45:08.160271"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cellscore:1.20.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cellscore/1.20.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-cellscore/1.20.0--r43hdfd78af_0
```
