...
updated_at: "2025-05-03 03:51:15.791134"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-nnsvg:1.10.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-nnsvg/1.10.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-nnsvg/1.10.0--r44hdfd78af_0
```
