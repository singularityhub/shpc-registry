...
updated_at: "2026-04-05 05:11:41.528064"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-nnsvg:1.14.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-nnsvg/1.14.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-nnsvg/1.14.0--r45hdfd78af_0
```
