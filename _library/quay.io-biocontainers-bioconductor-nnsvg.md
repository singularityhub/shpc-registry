...
updated_at: "2024-07-30 03:22:14.093753"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-nnsvg:1.6.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-nnsvg/1.6.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-nnsvg/1.6.0--r43hdfd78af_0
```
