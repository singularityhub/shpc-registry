...
updated_at: "2024-02-28 02:34:12.754563"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gseabenchmarker:1.22.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gseabenchmarker/1.22.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-gseabenchmarker/1.22.0--r43hdfd78af_0
```
