...
updated_at: "2026-01-26 04:50:14.427243"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gseabenchmarker:1.26.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gseabenchmarker/1.26.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-gseabenchmarker/1.26.0--r44hdfd78af_0
```
