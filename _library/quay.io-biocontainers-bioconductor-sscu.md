...
updated_at: "2026-04-03 15:17:18.164054"
latest: "2.40.0--r45hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-sscu:2.40.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-sscu/2.40.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-sscu/2.40.0--r45hdfd78af_0
```
