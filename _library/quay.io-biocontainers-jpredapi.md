---
layout: container
name:  "quay.io/biocontainers/jpredapi"
maintainer: "@vsoch"
...
updated_at: "2022-10-27 00:56:42.311030"
latest: "1.5.6--py_0"
...
```bash
$ shpc install quay.io/biocontainers/jpredapi
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/jpredapi:1.5.6--py_0
```
...
```bash
$ module load quay.io/biocontainers/jpredapi/1.5.6--py_0
$ module help quay.io/biocontainers/jpredapi/1.5.6--py_0
```
...
#### jpredapi-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### jpredapi-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/jpredapi
$ podman run --it --rm --entrypoint /usr/local/bin/jpredapi   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/jpredapi   -v ${PWD} -w ${PWD} <container> -c " $@"
```
