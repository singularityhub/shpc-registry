...
updated_at: "2026-01-30 05:02:28.311093"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-combi:1.18.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-combi/1.18.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-combi/1.18.0--r44hdfd78af_0
```
