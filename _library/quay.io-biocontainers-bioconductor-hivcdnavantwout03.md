...
updated_at: "2026-03-30 05:20:12.249522"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hivcdnavantwout03:1.50.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hivcdnavantwout03/1.50.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-hivcdnavantwout03/1.50.0--r45hdfd78af_0
```
