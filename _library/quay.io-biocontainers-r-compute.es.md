---
layout: container
name:  "quay.io/biocontainers/r-compute.es"
maintainer: "@vsoch"
...
updated_at: "2023-08-03 03:31:24.408562"
...
```bash
$ shpc install quay.io/biocontainers/r-compute.es
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/r-compute.es:0.2_4--r3.2.2_0
```
...
```bash
$ module load quay.io/biocontainers/r-compute.es/0.2_4--r3.2.2_0
$ module help quay.io/biocontainers/r-compute.es/0.2_4--r3.2.2_0
```
...
#### r-compute.es-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-compute.es-inspect-deffile:
