...
updated_at: "2025-12-30 04:07:23.425651"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ga4ghshiny:1.28.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ga4ghshiny/1.28.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ga4ghshiny/1.28.0--r44hdfd78af_0
```
