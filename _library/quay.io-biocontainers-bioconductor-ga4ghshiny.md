...
updated_at: "2024-06-05 02:45:18.600709"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ga4ghshiny:1.24.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ga4ghshiny/1.24.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ga4ghshiny/1.24.0--r43hdfd78af_0
```
