...
updated_at: "2026-03-31 05:17:33.989392"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ga4ghshiny:1.32.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ga4ghshiny/1.32.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ga4ghshiny/1.32.0--r45hdfd78af_0
```
