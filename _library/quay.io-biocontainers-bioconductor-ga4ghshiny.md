...
updated_at: "2022-10-29 07:44:48.757382"
latest: "1.8.0--r36_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ga4ghshiny:1.8.0--r36_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ga4ghshiny/1.8.0--r36_0
$ module help quay.io/biocontainers/bioconductor-ga4ghshiny/1.8.0--r36_0
```
