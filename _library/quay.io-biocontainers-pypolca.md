...
updated_at: "2026-09-19 07:17:34.012742"
...
```bash
$ shpc install quay.io/biocontainers/pypolca:0.5.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pypolca/0.5.0--pyhdfd78af_0
$ module help quay.io/biocontainers/pypolca/0.5.0--pyhdfd78af_0
```
