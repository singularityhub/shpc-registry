...
updated_at: "2022-10-29 05:57:32.307628"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-bumphunter:1.36.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-bumphunter/1.36.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-bumphunter/1.36.0--r41hdfd78af_0
```
