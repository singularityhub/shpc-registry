...
updated_at: "2026-03-30 05:57:23.323110"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mlseq:2.28.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mlseq/2.28.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-mlseq/2.28.0--r45hdfd78af_0
```
