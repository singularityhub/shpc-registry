...
updated_at: "2024-11-17 03:04:41.805896"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mlseq:2.20.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mlseq/2.20.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-mlseq/2.20.0--r43hdfd78af_0
```
