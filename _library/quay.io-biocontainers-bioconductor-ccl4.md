...
updated_at: "2023-11-27 03:39:13.116605"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ccl4:1.38.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ccl4/1.38.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ccl4/1.38.0--r43hdfd78af_0
```
