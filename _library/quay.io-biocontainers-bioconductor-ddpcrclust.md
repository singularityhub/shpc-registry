...
updated_at: "2026-04-03 05:28:00.405021"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ddpcrclust:1.30.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ddpcrclust/1.30.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ddpcrclust/1.30.0--r45hdfd78af_0
```
