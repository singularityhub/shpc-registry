---
layout: container
name:  "quay.io/biocontainers/bioconductor-alabaster.files"
maintainer: "@vsoch"
...
updated_at: "2026-03-29 04:51:53.244041"
...
versions:
 ...
 - "1.4.0--r44hdfd78af_0"
 - "1.8.0--r45hdfd78af_0"
description: "singularity registry hpc automated addition for bioconductor-alabaster.files"
config: {"url": "https://biocontainers.pro/tools/bioconductor-alabaster.files", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for bioconductor-alabaster.files", "latest": {"1.8.0--r45hdfd78af_0": "sha256:ebecfd80e06f5f212c124c1533298c9b72107b2a3c1109fe5fc7a3e85dea7544"}, "tags": {"1.0.0--r43hdfd78af_0": "sha256:94f468198fb799f6ad6e5194969fc0c83f52b736fe5c43ad88c291bbe7a5ff62", "1.4.0--r44hdfd78af_0": "sha256:cb883421f77e177c1da0232a3a51e7c5bb497eb117d0f5b6dc0aed3c4f97fd99", "1.8.0--r45hdfd78af_0": "sha256:ebecfd80e06f5f212c124c1533298c9b72107b2a3c1109fe5fc7a3e85dea7544"}, "docker": "quay.io/biocontainers/bioconductor-alabaster.files", "aliases": {"pcre2posix_test": "/usr/local/bin/pcre2posix_test", "2to3-3.12": "/usr/local/bin/2to3-3.12", "idle3.12": "/usr/local/bin/idle3.12", "pydoc3.12": "/usr/local/bin/pydoc3.12", "python3.12": "/usr/local/bin/python3.12", "python3.12-config": "/usr/local/bin/python3.12-config", "hb-info": "/usr/local/bin/hb-info", "installBiocDataPackage.sh": "/usr/local/bin/installBiocDataPackage.sh", "tjbench": "/usr/local/bin/tjbench", "tomlq": "/usr/local/bin/tomlq", "xq": "/usr/local/bin/xq", "yq": "/usr/local/bin/yq", "jq": "/usr/local/bin/jq", "onig-config": "/usr/local/bin/onig-config", "activate-global-python-argcomplete": "/usr/local/bin/activate-global-python-argcomplete", "python-argcomplete-check-easy-install-script": "/usr/local/bin/python-argcomplete-check-easy-install-script", "register-python-argcomplete": "/usr/local/bin/register-python-argcomplete"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/bioconductor-alabaster.files.
singularity registry hpc automated addition for bioconductor-alabaster.files
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/bioconductor-alabaster.files
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-alabaster.files:1.8.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-alabaster.files/1.8.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-alabaster.files/1.8.0--r45hdfd78af_0
```
...
#### bioconductor-alabaster.files-run:
...
#### bioconductor-alabaster.files-shell:
...
#### bioconductor-alabaster.files-exec:
...
#### bioconductor-alabaster.files-inspect:
...
#### bioconductor-alabaster.files-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-alabaster.files-inspect-deffile:
