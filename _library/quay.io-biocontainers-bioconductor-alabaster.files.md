...
updated_at: "2024-07-03 03:02:49.198961"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-alabaster.files:1.0.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-alabaster.files/1.0.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-alabaster.files/1.0.0--r43hdfd78af_0
```
