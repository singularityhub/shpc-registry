...
updated_at: "2025-02-08 02:58:45.450862"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-alabaster.files:1.4.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-alabaster.files/1.4.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-alabaster.files/1.4.0--r44hdfd78af_0
```
