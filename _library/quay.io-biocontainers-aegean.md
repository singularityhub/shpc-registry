...
updated_at: "2025-03-02 03:45:28.411704"
latest: "0.16.0--h71bfec9_5"
...
```bash
$ shpc install quay.io/biocontainers/aegean:0.16.0--h71bfec9_5
```
...
```bash
$ module load quay.io/biocontainers/aegean/0.16.0--h71bfec9_5
$ module help quay.io/biocontainers/aegean/0.16.0--h71bfec9_5
```
