...
updated_at: "2026-03-26 05:19:27.768084"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-arrayexpress:1.70.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-arrayexpress/1.70.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-arrayexpress/1.70.0--r45hdfd78af_0
```
