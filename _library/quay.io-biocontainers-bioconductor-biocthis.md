...
updated_at: "2022-10-29 05:40:45.321891"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-biocthis:1.4.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-biocthis/1.4.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-biocthis/1.4.0--r41hdfd78af_0
```
