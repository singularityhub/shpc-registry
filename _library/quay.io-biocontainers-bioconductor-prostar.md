...
updated_at: "2024-05-09 03:11:51.947725"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-prostar:1.34.3--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-prostar/1.34.3--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-prostar/1.34.3--r43hdfd78af_0
```
