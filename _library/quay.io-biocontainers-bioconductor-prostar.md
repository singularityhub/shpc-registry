...
updated_at: "2025-04-26 03:11:59.852365"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-prostar:1.38.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-prostar/1.38.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-prostar/1.38.0--r44hdfd78af_0
```
