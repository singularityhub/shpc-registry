...
updated_at: "2023-09-04 03:58:12.222404"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-prostar:1.32.1--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-prostar/1.32.1--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-prostar/1.32.1--r43hdfd78af_0
```
