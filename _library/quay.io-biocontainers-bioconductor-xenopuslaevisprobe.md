...
updated_at: "2022-11-21 13:43:31.571338"
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-xenopuslaevisprobe-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-xenopuslaevisprobe-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-xenopuslaevisprobe-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-xenopuslaevisprobe-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-xenopuslaevisprobe-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-xenopuslaevisprobe-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
