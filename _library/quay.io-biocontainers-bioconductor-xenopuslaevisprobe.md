...
updated_at: "2026-03-13 05:03:35.573670"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-xenopuslaevisprobe:2.18.0--r45hdfd78af_14
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-xenopuslaevisprobe/2.18.0--r45hdfd78af_14
$ module help quay.io/biocontainers/bioconductor-xenopuslaevisprobe/2.18.0--r45hdfd78af_14
```
