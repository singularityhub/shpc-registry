...
updated_at: "2023-10-31 02:25:53.379148"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gwasurvivr:1.18.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gwasurvivr/1.18.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-gwasurvivr/1.18.0--r43hdfd78af_0
```
