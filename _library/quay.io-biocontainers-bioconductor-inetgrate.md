...
updated_at: "2024-04-17 03:03:33.218523"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-inetgrate:1.0.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-inetgrate/1.0.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-inetgrate/1.0.0--r43hdfd78af_0
```
