---
layout: container
name:  "quay.io/biocontainers/bioconductor-inetgrate"
maintainer: "@vsoch"
github: "https://github.com/singularityhub/shpc-registry/blob/main/quay.io/biocontainers/bioconductor-inetgrate/container.yaml"
config_url: "https://raw.githubusercontent.com/singularityhub/shpc-registry/main/quay.io/biocontainers/bioconductor-inetgrate/container.yaml"
updated_at: "2025-03-26 03:34:25.032411"
latest: "1.4.0--r44hdfd78af_0"
container_url: "https://biocontainers.pro/tools/bioconductor-inetgrate"
aliases:
 - "pcre2posix_test"
 - "2to3-3.12"
 - "idle3.12"
...
```bash
$ module load quay.io/biocontainers/bioconductor-inetgrate/1.4.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-inetgrate/1.4.0--r44hdfd78af_0
```
...
#### bioconductor-inetgrate-inspect:
...
#### bioconductor-inetgrate-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-inetgrate-inspect-deffile:
