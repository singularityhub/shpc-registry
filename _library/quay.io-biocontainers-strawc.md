...
updated_at: "2025-02-02 03:01:57.439267"
latest: "0.0.2.1--py39hd112c11_5"
...
```bash
$ shpc install quay.io/biocontainers/strawc:0.0.2.1--py39hd112c11_5
```
...
```bash
$ module load quay.io/biocontainers/strawc/0.0.2.1--py39hd112c11_5
$ module help quay.io/biocontainers/strawc/0.0.2.1--py39hd112c11_5
```
