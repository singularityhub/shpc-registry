...
updated_at: "2025-02-21 03:14:20.637972"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-makecdfenv:1.82.0--r44h3df3fcb_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-makecdfenv/1.82.0--r44h3df3fcb_0
$ module help quay.io/biocontainers/bioconductor-makecdfenv/1.82.0--r44h3df3fcb_0
```
