...
updated_at: "2023-08-25 03:28:05.591375"
latest: "1.76.0--r43ha9d7317_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-makecdfenv:1.76.0--r43ha9d7317_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-makecdfenv/1.76.0--r43ha9d7317_0
$ module help quay.io/biocontainers/bioconductor-makecdfenv/1.76.0--r43ha9d7317_0
```
