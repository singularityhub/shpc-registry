...
updated_at: "2024-12-09 03:08:11.666938"
latest: "2.3.10--h103dbdd_0"
...
```bash
$ shpc install quay.io/biocontainers/abyss:2.3.10--h103dbdd_0
```
...
```bash
$ module load quay.io/biocontainers/abyss/2.3.10--h103dbdd_0
$ module help quay.io/biocontainers/abyss/2.3.10--h103dbdd_0
```
