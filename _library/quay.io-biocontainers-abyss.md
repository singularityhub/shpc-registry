...
updated_at: "2024-09-05 02:45:21.375596"
latest: "2.3.8--h103dbdd_1"
...
```bash
$ shpc install quay.io/biocontainers/abyss:2.3.8--h103dbdd_1
```
...
```bash
$ module load quay.io/biocontainers/abyss/2.3.8--h103dbdd_1
$ module help quay.io/biocontainers/abyss/2.3.8--h103dbdd_1
```
