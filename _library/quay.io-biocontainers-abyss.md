...
updated_at: "2024-08-02 03:21:44.806806"
latest: "2.3.8--h103dbdd_0"
...
```bash
$ shpc install quay.io/biocontainers/abyss:2.3.8--h103dbdd_0
```
...
```bash
$ module load quay.io/biocontainers/abyss/2.3.8--h103dbdd_0
$ module help quay.io/biocontainers/abyss/2.3.8--h103dbdd_0
```
