...
updated_at: "2024-11-15 02:59:24.812299"
latest: "2.3.9--h103dbdd_0"
...
```bash
$ shpc install quay.io/biocontainers/abyss:2.3.9--h103dbdd_0
```
...
```bash
$ module load quay.io/biocontainers/abyss/2.3.9--h103dbdd_0
$ module help quay.io/biocontainers/abyss/2.3.9--h103dbdd_0
```
