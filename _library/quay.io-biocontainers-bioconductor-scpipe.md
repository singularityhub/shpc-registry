...
updated_at: "2026-03-26 05:33:31.139917"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-scpipe:2.10.0--r45ha27e39d_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-scpipe/2.10.0--r45ha27e39d_0
$ module help quay.io/biocontainers/bioconductor-scpipe/2.10.0--r45ha27e39d_0
```
