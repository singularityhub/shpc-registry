---
layout: container
name:  "quay.io/biocontainers/janook"
maintainer: "@vsoch"
github: "https://github.com/singularityhub/shpc-registry/blob/main/quay.io/biocontainers/janook/container.yaml"
config_url: "https://raw.githubusercontent.com/singularityhub/shpc-registry/main/quay.io/biocontainers/janook/container.yaml"
updated_at: "2026-09-04 07:53:47.593608"
latest: "9.0.0--hdfd78af_0"
container_url: "https://biocontainers.pro/tools/janook"
aliases:
 - "janook"
 - "jnativescan"
 - "fc-genconf"
...
versions:
 - "9.0.0--hdfd78af_0"
description: "singularity registry hpc automated addition for janook"
config: {"url": "https://biocontainers.pro/tools/janook", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for janook", "latest": {"9.0.0--hdfd78af_0": "sha256:b91389d72d302c286f3f1664379e16e26f25bc2852e5e70a58fb2a054a128021"}, "tags": {"9.0.0--hdfd78af_0": "sha256:b91389d72d302c286f3f1664379e16e26f25bc2852e5e70a58fb2a054a128021"}, "docker": "quay.io/biocontainers/janook", "aliases": {"janook": "/usr/local/bin/janook", "jnativescan": "/usr/local/bin/jnativescan", "fc-genconf": "/usr/local/bin/fc-genconf", "hb-raster": "/usr/local/bin/hb-raster", "hb-vector": "/usr/local/bin/hb-vector", "jwebserver": "/usr/local/bin/jwebserver", "jpackage": "/usr/local/bin/jpackage", "cups-config": "/usr/local/bin/cups-config", "ippeveprinter": "/usr/local/bin/ippeveprinter", "ipptool": "/usr/local/bin/ipptool", "jfr": "/usr/local/bin/jfr", "jdeprscan": "/usr/local/bin/jdeprscan", "jhsdb": "/usr/local/bin/jhsdb", "jimage": "/usr/local/bin/jimage", "jlink": "/usr/local/bin/jlink", "jmod": "/usr/local/bin/jmod", "jshell": "/usr/local/bin/jshell", "aserver": "/usr/local/bin/aserver", "jdeps": "/usr/local/bin/jdeps", "jar": "/usr/local/bin/jar", "jarsigner": "/usr/local/bin/jarsigner", "java": "/usr/local/bin/java", "javac": "/usr/local/bin/javac", "javadoc": "/usr/local/bin/javadoc", "javap": "/usr/local/bin/javap", "jcmd": "/usr/local/bin/jcmd"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/janook.
singularity registry hpc automated addition for janook
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/janook
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/janook:9.0.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/janook/9.0.0--hdfd78af_0
$ module help quay.io/biocontainers/janook/9.0.0--hdfd78af_0
```
...
#### janook-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### janook-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/janook
$ podman run --it --rm --entrypoint /usr/local/bin/janook   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/janook   -v ${PWD} -w ${PWD} <container> -c " $@"
```
