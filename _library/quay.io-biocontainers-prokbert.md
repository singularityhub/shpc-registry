...
updated_at: "2025-02-07 03:06:53.410370"
...
```bash
$ shpc install quay.io/biocontainers/prokbert:0.0.46--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/prokbert/0.0.46--pyhdfd78af_0
$ module help quay.io/biocontainers/prokbert/0.0.46--pyhdfd78af_0
```
