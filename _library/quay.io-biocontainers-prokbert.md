...
updated_at: "2025-08-31 03:12:05.551269"
...
```bash
$ shpc install quay.io/biocontainers/prokbert:0.0.48--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/prokbert/0.0.48--pyhdfd78af_0
$ module help quay.io/biocontainers/prokbert/0.0.48--pyhdfd78af_0
```
