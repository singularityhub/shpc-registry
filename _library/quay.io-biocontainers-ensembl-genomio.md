...
updated_at: "2025-10-30 03:37:49.211175"
...
```bash
$ shpc install quay.io/biocontainers/ensembl-genomio:1.6.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ensembl-genomio/1.6.2--pyhdfd78af_0
$ module help quay.io/biocontainers/ensembl-genomio/1.6.2--pyhdfd78af_0
```
...
#### ensembl-genomio-inspect-runscript:
