...
updated_at: "2026-08-07 04:38:03.149832"
...
```bash
$ shpc install quay.io/biocontainers/ensembl-genomio:1.7.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ensembl-genomio/1.7.0--pyhdfd78af_0
$ module help quay.io/biocontainers/ensembl-genomio/1.7.0--pyhdfd78af_0
```
