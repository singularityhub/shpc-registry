...
updated_at: "2026-07-01 06:38:07.824578"
latest: "0.2.5--h5eaa155_0"
...
```bash
$ shpc install quay.io/biocontainers/mentalist:0.2.5--h5eaa155_0
```
...
```bash
$ module load quay.io/biocontainers/mentalist/0.2.5--h5eaa155_0
$ module help quay.io/biocontainers/mentalist/0.2.5--h5eaa155_0
```
