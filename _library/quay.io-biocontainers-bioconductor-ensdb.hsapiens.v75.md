...
updated_at: "2022-11-03 23:50:44.598961"
latest: "2.99.0--r40hdfd78af_9"
container_url: "https://biocontainers.pro/tools/bioconductor-ensdb.hsapiens.v75"
aliases:
 - ".bioconductor-ensdb.hsapiens.v75-post-link.sh"
 - ".bioconductor-ensdb.hsapiens.v75-pre-unlink.sh"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ensdb.hsapiens.v75:2.99.0--r40hdfd78af_9
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ensdb.hsapiens.v75/2.99.0--r40hdfd78af_9
$ module help quay.io/biocontainers/bioconductor-ensdb.hsapiens.v75/2.99.0--r40hdfd78af_9
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-ensdb.hsapiens.v75-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-ensdb.hsapiens.v75-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-ensdb.hsapiens.v75-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-ensdb.hsapiens.v75-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-ensdb.hsapiens.v75-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-ensdb.hsapiens.v75-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
