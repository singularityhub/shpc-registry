...
updated_at: "2024-04-30 02:49:21.680830"
latest: "1.1.5--py39h1f90b4d_0"
...
```bash
$ shpc install quay.io/biocontainers/scib:1.1.5--py39h1f90b4d_0
```
...
```bash
$ module load quay.io/biocontainers/scib/1.1.5--py39h1f90b4d_0
$ module help quay.io/biocontainers/scib/1.1.5--py39h1f90b4d_0
```
