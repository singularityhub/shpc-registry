...
updated_at: "2024-04-21 02:51:05.897174"
latest: "1.1.4--py38h2494328_0"
...
```bash
$ shpc install quay.io/biocontainers/scib:1.1.4--py38h2494328_0
```
...
```bash
$ module load quay.io/biocontainers/scib/1.1.4--py38h2494328_0
$ module help quay.io/biocontainers/scib/1.1.4--py38h2494328_0
```
