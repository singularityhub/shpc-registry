...
updated_at: "2024-11-14 04:27:13.001524"
...
```bash
$ shpc install quay.io/biocontainers/scib:1.1.5--py311h2a4ad6c_1
```
...
```bash
$ module load quay.io/biocontainers/scib/1.1.5--py311h2a4ad6c_1
$ module help quay.io/biocontainers/scib/1.1.5--py311h2a4ad6c_1
```
