...
updated_at: "2024-01-08 02:46:03.062597"
latest: "0.7.6--r43hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/r-acidgenerics:0.7.6--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/r-acidgenerics/0.7.6--r43hdfd78af_0
$ module help quay.io/biocontainers/r-acidgenerics/0.7.6--r43hdfd78af_0
```
