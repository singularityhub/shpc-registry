...
updated_at: "2025-04-27 03:18:39.249161"
latest: "0.7.9--r44hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/r-acidgenerics:0.7.9--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/r-acidgenerics/0.7.9--r44hdfd78af_0
$ module help quay.io/biocontainers/r-acidgenerics/0.7.9--r44hdfd78af_0
```
