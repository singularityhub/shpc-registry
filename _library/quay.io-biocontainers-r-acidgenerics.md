...
updated_at: "2024-04-16 02:35:17.366401"
latest: "0.7.7--r43hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/r-acidgenerics:0.7.7--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/r-acidgenerics/0.7.7--r43hdfd78af_0
$ module help quay.io/biocontainers/r-acidgenerics/0.7.7--r43hdfd78af_0
```
