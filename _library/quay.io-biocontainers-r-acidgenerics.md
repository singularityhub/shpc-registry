...
updated_at: "2023-11-19 02:47:17.231871"
...
```bash
$ shpc install quay.io/biocontainers/r-acidgenerics:0.7.3--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/r-acidgenerics/0.7.3--r43hdfd78af_0
$ module help quay.io/biocontainers/r-acidgenerics/0.7.3--r43hdfd78af_0
```
