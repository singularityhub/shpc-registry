...
updated_at: "2026-09-02 07:35:27.560007"
latest: "0.7.11--r45hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/r-acidgenerics:0.7.11--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/r-acidgenerics/0.7.11--r45hdfd78af_0
$ module help quay.io/biocontainers/r-acidgenerics/0.7.11--r45hdfd78af_0
```
