...
updated_at: "2026-01-25 04:31:44.380438"
latest: "0.7.10--r44hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/r-acidgenerics:0.7.10--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/r-acidgenerics/0.7.10--r44hdfd78af_0
$ module help quay.io/biocontainers/r-acidgenerics/0.7.10--r44hdfd78af_0
```
