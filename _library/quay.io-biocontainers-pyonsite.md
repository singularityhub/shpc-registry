...
updated_at: "2026-08-25 09:39:24.395082"
...
```bash
$ shpc install quay.io/biocontainers/pyonsite:0.0.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pyonsite/0.0.5--pyhdfd78af_0
$ module help quay.io/biocontainers/pyonsite/0.0.5--pyhdfd78af_0
```
