...
updated_at: "2025-10-02 03:46:18.570759"
...
```bash
$ shpc install quay.io/biocontainers/plinder:0.2.25--pyhdfd78af_3
```
...
```bash
$ module load quay.io/biocontainers/plinder/0.2.25--pyhdfd78af_3
$ module help quay.io/biocontainers/plinder/0.2.25--pyhdfd78af_3
```
