...
updated_at: "2022-11-13 00:35:56.970554"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-metavizr:1.18.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-metavizr/1.18.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-metavizr/1.18.0--r41hdfd78af_0
```
