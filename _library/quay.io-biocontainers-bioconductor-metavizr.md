...
updated_at: "2022-11-05 00:49:46.256109"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-metavizr:1.8.0--r36_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-metavizr/1.8.0--r36_1
$ module help quay.io/biocontainers/bioconductor-metavizr/1.8.0--r36_1
```
