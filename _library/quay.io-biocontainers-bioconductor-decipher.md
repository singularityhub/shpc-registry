...
updated_at: "2023-06-22 03:28:07.360864"
latest: "2.26.0--r42ha9d7317_1"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-decipher:2.26.0--r42ha9d7317_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-decipher/2.26.0--r42ha9d7317_1
$ module help quay.io/biocontainers/bioconductor-decipher/2.26.0--r42ha9d7317_1
```
