...
updated_at: "2022-11-03 00:37:42.714988"
...
```bash
$ shpc install quay.io/biocontainers/cdna_cupcake:9.1.1--py37hc1659b7_0
```
...
```bash
$ module load quay.io/biocontainers/cdna_cupcake/9.1.1--py37hc1659b7_0
$ module help quay.io/biocontainers/cdna_cupcake/9.1.1--py37hc1659b7_0
```
