...
updated_at: "2025-08-21 06:26:58.595127"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-qsutils:1.24.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-qsutils/1.24.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-qsutils/1.24.0--r44hdfd78af_0
```
