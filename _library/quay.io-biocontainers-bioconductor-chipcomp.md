...
updated_at: "2024-01-05 02:41:06.932768"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-chipcomp:1.30.0--r43ha9d7317_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-chipcomp/1.30.0--r43ha9d7317_0
$ module help quay.io/biocontainers/bioconductor-chipcomp/1.30.0--r43ha9d7317_0
```
