...
updated_at: "2026-03-30 06:19:36.763217"
latest: "1.40.0--r45h01b2380_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-chipcomp:1.40.0--r45h01b2380_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-chipcomp/1.40.0--r45h01b2380_0
$ module help quay.io/biocontainers/bioconductor-chipcomp/1.40.0--r45h01b2380_0
```
