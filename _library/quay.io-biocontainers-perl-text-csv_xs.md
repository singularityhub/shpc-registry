---
layout: container
name:  "quay.io/biocontainers/perl-text-csv_xs"
maintainer: "@vsoch"
...
updated_at: "2022-10-29 05:53:58.621211"
...
```bash
$ shpc install quay.io/biocontainers/perl-text-csv_xs
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/perl-text-csv_xs:1.48--pl5321hec16e2b_0
```
...
```bash
$ module load quay.io/biocontainers/perl-text-csv_xs/1.48--pl5321hec16e2b_0
$ module help quay.io/biocontainers/perl-text-csv_xs/1.48--pl5321hec16e2b_0
```
...
#### perl-text-csv_xs-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### perl-text-csv_xs-inspect-deffile:
