...
updated_at: "2022-11-09 00:12:55.848881"
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-partheenmetadata.db-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-partheenmetadata.db-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-partheenmetadata.db-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-partheenmetadata.db-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-partheenmetadata.db-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-partheenmetadata.db-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
