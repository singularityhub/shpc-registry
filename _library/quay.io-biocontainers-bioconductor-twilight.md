...
updated_at: "2026-04-05 05:09:36.822732"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-twilight:1.86.0--r45h01b2380_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-twilight/1.86.0--r45h01b2380_0
$ module help quay.io/biocontainers/bioconductor-twilight/1.86.0--r45h01b2380_0
```
