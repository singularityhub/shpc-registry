...
updated_at: "2025-12-04 03:45:06.597293"
latest: "0.25.3--ha9dfd29_0"
...
```bash
$ shpc install quay.io/biocontainers/fastq_utils:0.25.3--ha9dfd29_0
```
...
```bash
$ module load quay.io/biocontainers/fastq_utils/0.25.3--ha9dfd29_0
$ module help quay.io/biocontainers/fastq_utils/0.25.3--ha9dfd29_0
```
