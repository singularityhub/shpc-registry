...
updated_at: "2025-08-26 03:50:47.520879"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-panomir:1.10.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-panomir/1.10.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-panomir/1.10.0--r44hdfd78af_0
```
