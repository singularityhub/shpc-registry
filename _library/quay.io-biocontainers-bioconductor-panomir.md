...
updated_at: "2023-12-21 02:31:50.570845"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-panomir:1.4.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-panomir/1.4.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-panomir/1.4.0--r43hdfd78af_0
```
