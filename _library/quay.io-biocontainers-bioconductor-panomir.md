...
updated_at: "2024-12-27 03:03:49.935095"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-panomir:1.6.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-panomir/1.6.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-panomir/1.6.0--r43hdfd78af_0
```
