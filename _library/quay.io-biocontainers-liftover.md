...
updated_at: "2026-01-19 05:10:43.870610"
latest: "1.3.3--py310h275bdba_0"
...
```bash
$ shpc install quay.io/biocontainers/liftover:1.3.3--py310h275bdba_0
```
...
```bash
$ module load quay.io/biocontainers/liftover/1.3.3--py310h275bdba_0
$ module help quay.io/biocontainers/liftover/1.3.3--py310h275bdba_0
```
