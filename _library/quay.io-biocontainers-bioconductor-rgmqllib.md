...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rgmqllib:1.9.0--r40_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rgmqllib/1.9.0--r40_0
$ module help quay.io/biocontainers/bioconductor-rgmqllib/1.9.0--r40_0
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-rgmqllib-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-rgmqllib-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-rgmqllib-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-rgmqllib-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-rgmqllib-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-rgmqllib-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
