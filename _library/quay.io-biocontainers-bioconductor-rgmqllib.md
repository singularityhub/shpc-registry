...
updated_at: "2025-11-08 03:08:22.655465"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rgmqllib:1.26.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rgmqllib/1.26.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rgmqllib/1.26.0--r44hdfd78af_0
```
