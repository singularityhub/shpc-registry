...
updated_at: "2022-10-29 05:40:55.130502"
latest: "1.8.0--r36_1"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-semisup:1.8.0--r36_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-semisup/1.8.0--r36_1
$ module help quay.io/biocontainers/bioconductor-semisup/1.8.0--r36_1
```
