...
updated_at: "2024-12-11 03:09:39.863108"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-semisup:1.26.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-semisup/1.26.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-semisup/1.26.0--r43hdfd78af_0
```
