...
updated_at: "2023-08-27 02:22:50.243898"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-semisup:1.24.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-semisup/1.24.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-semisup/1.24.0--r43hdfd78af_0
```
