...
updated_at: "2022-11-13 00:24:33.891190"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-dmrseq:1.14.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-dmrseq/1.14.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-dmrseq/1.14.0--r41hdfd78af_0
```
