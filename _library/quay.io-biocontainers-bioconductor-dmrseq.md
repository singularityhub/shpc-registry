...
updated_at: "2025-09-18 06:17:57.350383"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-dmrseq:1.26.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-dmrseq/1.26.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-dmrseq/1.26.0--r44hdfd78af_0
```
