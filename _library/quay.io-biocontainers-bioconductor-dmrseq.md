...
updated_at: "2022-11-05 00:38:38.340009"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-dmrseq:1.8.0--r40_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-dmrseq/1.8.0--r40_0
$ module help quay.io/biocontainers/bioconductor-dmrseq/1.8.0--r40_0
```
