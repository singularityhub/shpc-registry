...
updated_at: "2026-03-30 06:24:42.977492"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-nugomm1a520177.db:3.4.0--r45hdfd78af_14
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-nugomm1a520177.db/3.4.0--r45hdfd78af_14
$ module help quay.io/biocontainers/bioconductor-nugomm1a520177.db/3.4.0--r45hdfd78af_14
```
