...
updated_at: "2026-06-14 07:20:16.412205"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-consensusov:1.32.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-consensusov/1.32.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-consensusov/1.32.0--r45hdfd78af_0
```
