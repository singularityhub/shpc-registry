...
updated_at: "2025-02-14 03:17:44.773337"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-consensusov:1.24.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-consensusov/1.24.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-consensusov/1.24.0--r43hdfd78af_0
```
