...
updated_at: "2023-01-23 03:38:59.506052"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-snadata:1.44.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-snadata/1.44.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-snadata/1.44.0--r42hdfd78af_0
```
