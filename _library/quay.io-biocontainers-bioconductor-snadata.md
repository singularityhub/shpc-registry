...
updated_at: "2023-12-30 02:36:13.254868"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-snadata:1.46.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-snadata/1.46.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-snadata/1.46.0--r43hdfd78af_0
```
