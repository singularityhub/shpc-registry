...
updated_at: "2026-03-14 04:50:52.294510"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-snadata:1.56.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-snadata/1.56.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-snadata/1.56.0--r45hdfd78af_0
```
