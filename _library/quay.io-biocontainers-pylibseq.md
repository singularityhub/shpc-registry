...
updated_at: "2023-08-24 02:57:39.847131"
...
```bash
$ shpc install quay.io/biocontainers/pylibseq:0.2.3--py310h30d9df9_6
```
...
```bash
$ module load quay.io/biocontainers/pylibseq/0.2.3--py310h30d9df9_6
$ module help quay.io/biocontainers/pylibseq/0.2.3--py310h30d9df9_6
```
