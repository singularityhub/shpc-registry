---
layout: container
name:  "quay.io/biocontainers/derip2"
maintainer: "@vsoch"
...
updated_at: "2025-04-25 03:54:39.146023"
...
```bash
$ shpc install quay.io/biocontainers/derip2
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/derip2:0.4.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/derip2/0.4.0--pyhdfd78af_0
$ module help quay.io/biocontainers/derip2/0.4.0--pyhdfd78af_0
```
...
#### derip2-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### derip2-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/derip2
$ podman run --it --rm --entrypoint /usr/local/bin/derip2   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/derip2   -v ${PWD} -w ${PWD} <container> -c " $@"
```
