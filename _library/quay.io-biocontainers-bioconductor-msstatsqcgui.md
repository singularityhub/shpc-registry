...
updated_at: "2022-11-06 00:46:44.107458"
latest: "1.8.0--r40_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-msstatsqcgui:1.8.0--r40_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-msstatsqcgui/1.8.0--r40_0
$ module help quay.io/biocontainers/bioconductor-msstatsqcgui/1.8.0--r40_0
```
