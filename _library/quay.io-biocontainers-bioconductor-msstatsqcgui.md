...
updated_at: "2026-03-21 04:27:20.863135"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-msstatsqcgui:1.30.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-msstatsqcgui/1.30.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-msstatsqcgui/1.30.0--r45hdfd78af_0
```
