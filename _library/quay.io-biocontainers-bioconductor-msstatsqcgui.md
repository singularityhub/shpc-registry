...
updated_at: "2023-12-09 02:46:43.856422"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-msstatsqcgui:1.20.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-msstatsqcgui/1.20.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-msstatsqcgui/1.20.0--r43hdfd78af_0
```
