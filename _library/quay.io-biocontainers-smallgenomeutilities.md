...
updated_at: "2022-10-27 00:52:58.735852"
...
```bash
$ shpc install quay.io/biocontainers/smallgenomeutilities:0.3.8--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/smallgenomeutilities/0.3.8--pyhdfd78af_0
$ module help quay.io/biocontainers/smallgenomeutilities/0.3.8--pyhdfd78af_0
```
