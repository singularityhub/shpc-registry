...
updated_at: "2024-09-12 17:24:41.679934"
latest: "1.0.24--h4ac6f70_0"
...
```bash
$ shpc install quay.io/biocontainers/ncbi-stxtyper:1.0.24--h4ac6f70_0
```
...
```bash
$ module load quay.io/biocontainers/ncbi-stxtyper/1.0.24--h4ac6f70_0
$ module help quay.io/biocontainers/ncbi-stxtyper/1.0.24--h4ac6f70_0
```
