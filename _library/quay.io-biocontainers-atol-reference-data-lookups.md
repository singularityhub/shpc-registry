---
layout: container
name:  "quay.io/biocontainers/atol-reference-data-lookups"
maintainer: "@vsoch"
...
updated_at: "2026-06-09 08:31:27.962298"
...
```bash
$ module load quay.io/biocontainers/atol-reference-data-lookups/0.4.1--pyhdfd78af_0
$ module help quay.io/biocontainers/atol-reference-data-lookups/0.4.1--pyhdfd78af_0
```
...
#### atol-reference-data-lookups-run:
...
#### atol-reference-data-lookups-shell:
...
#### atol-reference-data-lookups-exec:
...
#### atol-reference-data-lookups-inspect:
...
#### atol-reference-data-lookups-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### atol-reference-data-lookups-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/atol-reference-data-lookups
$ podman run --it --rm --entrypoint /usr/local/bin/atol-reference-data-lookups   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/atol-reference-data-lookups   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/get-remote-files
$ podman run --it --rm --entrypoint /usr/local/bin/get-remote-files   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/get-remote-files   -v ${PWD} -w ${PWD} <container> -c " $@"
```
