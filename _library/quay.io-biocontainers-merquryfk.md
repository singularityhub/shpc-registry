...
updated_at: "2025-09-23 04:49:32.742708"
latest: "1.1.2--h71df26d_0"
...
```bash
$ shpc install quay.io/biocontainers/merquryfk:1.1.2--h71df26d_0
```
...
```bash
$ module load quay.io/biocontainers/merquryfk/1.1.2--h71df26d_0
$ module help quay.io/biocontainers/merquryfk/1.1.2--h71df26d_0
```
