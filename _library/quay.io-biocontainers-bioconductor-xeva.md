...
updated_at: "2026-03-26 05:33:47.317266"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-xeva:1.26.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-xeva/1.26.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-xeva/1.26.0--r45hdfd78af_0
```
