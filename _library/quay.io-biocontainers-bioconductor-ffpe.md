...
updated_at: "2026-03-21 05:03:33.282007"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ffpe:1.54.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ffpe/1.54.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ffpe/1.54.0--r45hdfd78af_0
```
