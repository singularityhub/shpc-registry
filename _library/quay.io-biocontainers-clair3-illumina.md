...
updated_at: "2025-08-17 04:00:09.351543"
latest: "1.2.0--h2987a09_0"
...
```bash
$ shpc install quay.io/biocontainers/clair3-illumina:1.2.0--h2987a09_0
```
...
```bash
$ module load quay.io/biocontainers/clair3-illumina/1.2.0--h2987a09_0
$ module help quay.io/biocontainers/clair3-illumina/1.2.0--h2987a09_0
```
