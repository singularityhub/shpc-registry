...
updated_at: "2025-07-30 04:02:32.441147"
latest: "1.1.1--h2987a09_0"
...
```bash
$ shpc install quay.io/biocontainers/clair3-illumina:1.1.1--h2987a09_0
```
...
```bash
$ module load quay.io/biocontainers/clair3-illumina/1.1.1--h2987a09_0
$ module help quay.io/biocontainers/clair3-illumina/1.1.1--h2987a09_0
```
