...
updated_at: "2023-05-30 03:20:49.168807"
latest: "1.0.1--h2df963e_0"
...
```bash
$ shpc install quay.io/biocontainers/clair3-illumina:1.0.1--h2df963e_0
```
...
```bash
$ module load quay.io/biocontainers/clair3-illumina/1.0.1--h2df963e_0
$ module help quay.io/biocontainers/clair3-illumina/1.0.1--h2df963e_0
```
