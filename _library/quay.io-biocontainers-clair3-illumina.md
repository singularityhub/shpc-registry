...
updated_at: "2024-02-14 02:23:26.242350"
latest: "1.0.5--h376f1d3_0"
...
```bash
$ shpc install quay.io/biocontainers/clair3-illumina:1.0.5--h376f1d3_0
```
...
```bash
$ module load quay.io/biocontainers/clair3-illumina/1.0.5--h376f1d3_0
$ module help quay.io/biocontainers/clair3-illumina/1.0.5--h376f1d3_0
```
