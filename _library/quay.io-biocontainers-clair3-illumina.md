...
updated_at: "2025-03-15 03:13:19.539146"
latest: "1.0.10--h2987a09_1"
...
```bash
$ shpc install quay.io/biocontainers/clair3-illumina:1.0.10--h2987a09_1
```
...
```bash
$ module load quay.io/biocontainers/clair3-illumina/1.0.10--h2987a09_1
$ module help quay.io/biocontainers/clair3-illumina/1.0.10--h2987a09_1
```
