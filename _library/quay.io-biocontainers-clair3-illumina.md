...
updated_at: "2024-06-14 02:49:31.974105"
latest: "1.0.8--h376f1d3_0"
...
```bash
$ shpc install quay.io/biocontainers/clair3-illumina:1.0.8--h376f1d3_0
```
...
```bash
$ module load quay.io/biocontainers/clair3-illumina/1.0.8--h376f1d3_0
$ module help quay.io/biocontainers/clair3-illumina/1.0.8--h376f1d3_0
```
