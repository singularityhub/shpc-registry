...
updated_at: "2024-04-21 03:02:57.783229"
latest: "1.0.6--h376f1d3_0"
...
```bash
$ shpc install quay.io/biocontainers/clair3-illumina:1.0.6--h376f1d3_0
```
...
```bash
$ module load quay.io/biocontainers/clair3-illumina/1.0.6--h376f1d3_0
$ module help quay.io/biocontainers/clair3-illumina/1.0.6--h376f1d3_0
```
