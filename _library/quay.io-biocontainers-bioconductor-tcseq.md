...
updated_at: "2023-12-31 03:13:05.378891"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-tcseq:1.26.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-tcseq/1.26.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-tcseq/1.26.0--r43hdfd78af_0
```
