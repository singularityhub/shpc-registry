...
updated_at: "2026-03-21 05:07:00.928928"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-tcseq:1.34.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-tcseq/1.34.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-tcseq/1.34.0--r45hdfd78af_0
```
