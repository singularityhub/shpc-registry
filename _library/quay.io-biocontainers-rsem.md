...
updated_at: "2022-10-27 00:54:23.836210"
...
```bash
$ shpc install quay.io/biocontainers/rsem:1.3.3--pl5321ha04fe3b_5
```
...
```bash
$ module load quay.io/biocontainers/rsem/1.3.3--pl5321ha04fe3b_5
$ module help quay.io/biocontainers/rsem/1.3.3--pl5321ha04fe3b_5
```
