...
updated_at: "2022-11-07 23:50:33.598270"
latest: "2.8.0--r351_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rarevariantvis:2.8.0--r351_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rarevariantvis/2.8.0--r351_0
$ module help quay.io/biocontainers/bioconductor-rarevariantvis/2.8.0--r351_0
```
