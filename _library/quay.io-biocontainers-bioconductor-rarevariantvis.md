...
updated_at: "2026-03-28 16:36:22.266855"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rarevariantvis:2.38.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rarevariantvis/2.38.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rarevariantvis/2.38.0--r45hdfd78af_0
```
