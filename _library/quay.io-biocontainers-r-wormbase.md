...
updated_at: "2025-08-30 03:21:57.379852"
...
```bash
$ shpc install quay.io/biocontainers/r-wormbase:0.5.0--r44hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/r-wormbase/0.5.0--r44hdfd78af_1
$ module help quay.io/biocontainers/r-wormbase/0.5.0--r44hdfd78af_1
```
