...
updated_at: "2023-10-05 02:55:42.490035"
...
```bash
$ shpc install quay.io/biocontainers/r-wormbase:0.4.2--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/r-wormbase/0.4.2--r43hdfd78af_0
$ module help quay.io/biocontainers/r-wormbase/0.4.2--r43hdfd78af_0
```
