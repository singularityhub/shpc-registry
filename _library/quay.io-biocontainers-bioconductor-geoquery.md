...
updated_at: "2022-10-29 05:39:24.914937"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-geoquery:2.62.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-geoquery/2.62.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-geoquery/2.62.0--r41hdfd78af_0
```
