---
layout: container
name:  "quay.io/biocontainers/pyimagingmspec"
maintainer: "@vsoch"
...
updated_at: "2023-05-12 02:54:27.030706"
latest: "0.1.4--py_1"
...
```bash
$ shpc install quay.io/biocontainers/pyimagingmspec
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/pyimagingmspec:0.1.4--py_1
```
...
```bash
$ module load quay.io/biocontainers/pyimagingmspec/0.1.4--py_1
$ module help quay.io/biocontainers/pyimagingmspec/0.1.4--py_1
```
...
#### pyimagingmspec-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### pyimagingmspec-inspect-deffile:
