...
updated_at: "2024-08-24 03:17:13.964206"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-islet:1.4.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-islet/1.4.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-islet/1.4.0--r43hdfd78af_0
```
