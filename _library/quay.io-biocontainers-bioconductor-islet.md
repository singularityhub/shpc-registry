...
updated_at: "2025-12-04 03:44:51.334777"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-islet:1.8.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-islet/1.8.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-islet/1.8.0--r44hdfd78af_0
```
