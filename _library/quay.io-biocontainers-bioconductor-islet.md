...
updated_at: "2023-08-02 02:52:59.429548"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-islet:1.2.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-islet/1.2.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-islet/1.2.0--r43hdfd78af_0
```
