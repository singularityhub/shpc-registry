---
layout: container
name:  "quay.io/biocontainers/r-fastica"
maintainer: "@vsoch"
...
updated_at: "2025-03-26 03:48:47.493297"
...
```bash
$ shpc install quay.io/biocontainers/r-fastica
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/r-fastica:1.2_0--r3.3.1_0
```
...
```bash
$ module load quay.io/biocontainers/r-fastica/1.2_0--r3.3.1_0
$ module help quay.io/biocontainers/r-fastica/1.2_0--r3.3.1_0
```
...
#### r-fastica-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-fastica-inspect-deffile:
