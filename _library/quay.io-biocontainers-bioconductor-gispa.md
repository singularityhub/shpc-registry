...
updated_at: "2024-06-05 02:57:38.182811"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gispa:1.26.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gispa/1.26.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-gispa/1.26.0--r43hdfd78af_0
```
