...
updated_at: "2023-08-16 02:51:12.236154"
latest: "2.4.41--h4ac6f70_1"
...
```bash
$ shpc install quay.io/biocontainers/bedops:2.4.41--h4ac6f70_1
```
...
```bash
$ module load quay.io/biocontainers/bedops/2.4.41--h4ac6f70_1
$ module help quay.io/biocontainers/bedops/2.4.41--h4ac6f70_1
```
