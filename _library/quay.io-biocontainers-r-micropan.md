---
layout: container
name:  "quay.io/biocontainers/r-micropan"
maintainer: "@vsoch"
...
updated_at: "2025-07-28 03:57:58.576371"
...
```bash
$ shpc install quay.io/biocontainers/r-micropan
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/r-micropan:1.2--r351h29659fb_1
```
...
```bash
$ module load quay.io/biocontainers/r-micropan/1.2--r351h29659fb_1
$ module help quay.io/biocontainers/r-micropan/1.2--r351h29659fb_1
```
...
#### r-micropan-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-micropan-inspect-deffile:
