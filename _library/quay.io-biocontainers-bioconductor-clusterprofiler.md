...
updated_at: "2026-04-05 05:17:48.946112"
latest: "4.18.4--r45hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-clusterprofiler:4.18.4--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-clusterprofiler/4.18.4--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-clusterprofiler/4.18.4--r45hdfd78af_0
```
