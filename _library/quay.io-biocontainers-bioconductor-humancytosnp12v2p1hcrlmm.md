...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-humancytosnp12v2p1hcrlmm-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-humancytosnp12v2p1hcrlmm-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-humancytosnp12v2p1hcrlmm-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-humancytosnp12v2p1hcrlmm-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-humancytosnp12v2p1hcrlmm-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-humancytosnp12v2p1hcrlmm-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
