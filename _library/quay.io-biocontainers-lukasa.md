...
updated_at: "2022-12-05 02:52:22.743749"
latest: "0.14.1--py310hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/lukasa:0.14.1--py310hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/lukasa/0.14.1--py310hdfd78af_0
$ module help quay.io/biocontainers/lukasa/0.14.1--py310hdfd78af_0
```
