...
updated_at: "2026-03-30 05:29:02.504218"
latest: "1.40.0--r45h575d39b_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-icheck:1.40.0--r45h575d39b_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-icheck/1.40.0--r45h575d39b_0
$ module help quay.io/biocontainers/bioconductor-icheck/1.40.0--r45h575d39b_0
```
