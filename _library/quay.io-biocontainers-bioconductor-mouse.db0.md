...
updated_at: "2023-12-04 02:43:49.824875"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mouse.db0:3.17.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mouse.db0/3.17.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-mouse.db0/3.17.0--r43hdfd78af_0
```
