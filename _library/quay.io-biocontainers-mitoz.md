...
updated_at: "2025-08-22 03:38:24.663689"
...
```bash
$ shpc install quay.io/biocontainers/mitoz:3.6--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/mitoz/3.6--pyhdfd78af_1
$ module help quay.io/biocontainers/mitoz/3.6--pyhdfd78af_1
```
