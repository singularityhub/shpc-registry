...
updated_at: "2023-05-08 03:51:20.776413"
...
```bash
$ shpc install quay.io/biocontainers/mitoz:3.6--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mitoz/3.6--pyhdfd78af_0
$ module help quay.io/biocontainers/mitoz/3.6--pyhdfd78af_0
```
