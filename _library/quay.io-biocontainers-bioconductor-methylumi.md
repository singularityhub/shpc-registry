...
updated_at: "2023-11-04 02:54:40.075104"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-methylumi:2.46.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-methylumi/2.46.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-methylumi/2.46.0--r43hdfd78af_0
```
