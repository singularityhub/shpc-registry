...
updated_at: "2026-04-04 04:42:06.791433"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-methylumi:2.56.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-methylumi/2.56.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-methylumi/2.56.0--r45hdfd78af_0
```
