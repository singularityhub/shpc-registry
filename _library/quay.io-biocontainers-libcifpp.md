...
updated_at: "2026-02-26 04:58:33.986110"
latest: "9.0.6--hddb1751_1"
...
```bash
$ shpc install quay.io/biocontainers/libcifpp:9.0.6--hddb1751_1
```
...
```bash
$ module load quay.io/biocontainers/libcifpp/9.0.6--hddb1751_1
$ module help quay.io/biocontainers/libcifpp/9.0.6--hddb1751_1
```
