...
updated_at: "2025-05-23 03:30:25.678992"
latest: "8.0.1--h077b44d_0"
...
```bash
$ shpc install quay.io/biocontainers/libcifpp:8.0.1--h077b44d_0
```
...
```bash
$ module load quay.io/biocontainers/libcifpp/8.0.1--h077b44d_0
$ module help quay.io/biocontainers/libcifpp/8.0.1--h077b44d_0
```
