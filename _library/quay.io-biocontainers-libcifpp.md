...
updated_at: "2026-05-06 06:12:44.058747"
latest: "10.0.3--hd57855b_0"
...
```bash
$ shpc install quay.io/biocontainers/libcifpp:10.0.3--hd57855b_0
```
...
```bash
$ module load quay.io/biocontainers/libcifpp/10.0.3--hd57855b_0
$ module help quay.io/biocontainers/libcifpp/10.0.3--hd57855b_0
```
