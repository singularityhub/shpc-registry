...
updated_at: "2026-03-24 04:46:32.172117"
latest: "10.0.0--hd57855b_0"
...
```bash
$ shpc install quay.io/biocontainers/libcifpp:10.0.0--hd57855b_0
```
...
```bash
$ module load quay.io/biocontainers/libcifpp/10.0.0--hd57855b_0
$ module help quay.io/biocontainers/libcifpp/10.0.0--hd57855b_0
```
