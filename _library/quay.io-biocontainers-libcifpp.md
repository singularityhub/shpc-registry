...
updated_at: "2025-05-17 03:26:58.694128"
latest: "8.0.0--h077b44d_1"
...
```bash
$ shpc install quay.io/biocontainers/libcifpp:8.0.0--h077b44d_1
```
...
```bash
$ module load quay.io/biocontainers/libcifpp/8.0.0--h077b44d_1
$ module help quay.io/biocontainers/libcifpp/8.0.0--h077b44d_1
```
