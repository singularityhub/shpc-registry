...
updated_at: "2024-11-13 03:24:29.189566"
latest: "7.0.7--h43eeafb_0"
...
```bash
$ shpc install quay.io/biocontainers/libcifpp:7.0.7--h43eeafb_0
```
...
```bash
$ module load quay.io/biocontainers/libcifpp/7.0.7--h43eeafb_0
$ module help quay.io/biocontainers/libcifpp/7.0.7--h43eeafb_0
```
