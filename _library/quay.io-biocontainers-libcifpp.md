...
updated_at: "2025-08-26 03:52:59.983661"
latest: "8.0.1--h077b44d_5"
...
```bash
$ shpc install quay.io/biocontainers/libcifpp:8.0.1--h077b44d_5
```
...
```bash
$ module load quay.io/biocontainers/libcifpp/8.0.1--h077b44d_5
$ module help quay.io/biocontainers/libcifpp/8.0.1--h077b44d_5
```
