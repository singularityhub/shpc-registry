...
updated_at: "2025-03-16 03:15:39.250604"
latest: "7.0.9--h5ca1c30_0"
...
```bash
$ shpc install quay.io/biocontainers/libcifpp:7.0.9--h5ca1c30_0
```
...
```bash
$ module load quay.io/biocontainers/libcifpp/7.0.9--h5ca1c30_0
$ module help quay.io/biocontainers/libcifpp/7.0.9--h5ca1c30_0
```
