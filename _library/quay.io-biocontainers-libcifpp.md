...
updated_at: "2026-05-26 06:46:03.713520"
latest: "10.0.4--hd57855b_0"
...
```bash
$ shpc install quay.io/biocontainers/libcifpp:10.0.4--hd57855b_0
```
...
```bash
$ module load quay.io/biocontainers/libcifpp/10.0.4--hd57855b_0
$ module help quay.io/biocontainers/libcifpp/10.0.4--hd57855b_0
```
