...
updated_at: "2026-03-02 04:20:10.114265"
latest: "1.39.0--r45hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-timerquant:1.39.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-timerquant/1.39.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-timerquant/1.39.0--r45hdfd78af_0
```
