---
layout: container
name:  "quay.io/biocontainers/bioconductor-biochubsshiny"
maintainer: "@vsoch"
...
updated_at: "2023-12-07 03:03:48.078041"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-biochubsshiny
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-biochubsshiny:1.0.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-biochubsshiny/1.0.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-biochubsshiny/1.0.0--r43hdfd78af_0
```
...
#### bioconductor-biochubsshiny-run:
...
#### bioconductor-biochubsshiny-shell:
...
#### bioconductor-biochubsshiny-exec:
...
#### bioconductor-biochubsshiny-inspect:
...
#### bioconductor-biochubsshiny-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-biochubsshiny-inspect-deffile:
