...
updated_at: "2026-03-31 05:32:52.685108"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-animalcules:1.26.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-animalcules/1.26.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-animalcules/1.26.0--r45hdfd78af_0
```
