...
updated_at: "2023-05-29 04:34:34.315060"
...
```bash
$ shpc install quay.io/biocontainers/pyroe:0.9.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pyroe/0.9.2--pyhdfd78af_0
$ module help quay.io/biocontainers/pyroe/0.9.2--pyhdfd78af_0
```
