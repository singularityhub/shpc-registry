...
updated_at: "2023-05-06 02:50:18.466203"
...
```bash
$ shpc install quay.io/biocontainers/pyroe:0.9.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pyroe/0.9.1--pyhdfd78af_0
$ module help quay.io/biocontainers/pyroe/0.9.1--pyhdfd78af_0
```
