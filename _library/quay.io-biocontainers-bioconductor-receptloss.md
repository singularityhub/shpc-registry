...
updated_at: "2023-11-16 03:30:11.810761"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-receptloss:1.12.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-receptloss/1.12.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-receptloss/1.12.0--r43hdfd78af_0
```
