...
updated_at: "2025-08-28 03:22:51.858756"
latest: "1.5--h127010d_0"
...
```bash
$ shpc install quay.io/biocontainers/unifrac-binaries:1.5--h127010d_0
```
...
```bash
$ module load quay.io/biocontainers/unifrac-binaries/1.5--h127010d_0
$ module help quay.io/biocontainers/unifrac-binaries/1.5--h127010d_0
```
