...
updated_at: "2026-03-02 05:09:53.170883"
...
```bash
$ shpc install quay.io/biocontainers/bygul:1.0.7--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bygul/1.0.7--pyhdfd78af_0
$ module help quay.io/biocontainers/bygul/1.0.7--pyhdfd78af_0
```
