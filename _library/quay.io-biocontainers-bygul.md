...
updated_at: "2025-07-26 03:48:04.327100"
...
```bash
$ shpc install quay.io/biocontainers/bygul:1.0.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bygul/1.0.5--pyhdfd78af_0
$ module help quay.io/biocontainers/bygul/1.0.5--pyhdfd78af_0
```
