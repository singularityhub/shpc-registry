...
updated_at: "2026-05-29 06:59:17.229075"
...
```bash
$ shpc install quay.io/biocontainers/bygul:3.0.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bygul/3.0.1--pyhdfd78af_0
$ module help quay.io/biocontainers/bygul/3.0.1--pyhdfd78af_0
```
