...
updated_at: "2026-06-18 07:38:35.795508"
...
```bash
$ shpc install quay.io/biocontainers/bygul:3.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bygul/3.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/bygul/3.2.0--pyhdfd78af_0
```
