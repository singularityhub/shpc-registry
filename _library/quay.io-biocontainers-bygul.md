...
updated_at: "2026-09-03 07:27:59.246449"
...
```bash
$ shpc install quay.io/biocontainers/bygul:4.0.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bygul/4.0.1--pyhdfd78af_0
$ module help quay.io/biocontainers/bygul/4.0.1--pyhdfd78af_0
```
