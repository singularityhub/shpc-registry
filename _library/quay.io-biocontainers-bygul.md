...
updated_at: "2026-01-26 05:02:58.921164"
...
```bash
$ shpc install quay.io/biocontainers/bygul:1.0.6--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bygul/1.0.6--pyhdfd78af_0
$ module help quay.io/biocontainers/bygul/1.0.6--pyhdfd78af_0
```
