...
updated_at: "2026-05-12 06:29:26.130775"
...
```bash
$ shpc install quay.io/biocontainers/bygul:3.0.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bygul/3.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/bygul/3.0.0--pyhdfd78af_0
```
