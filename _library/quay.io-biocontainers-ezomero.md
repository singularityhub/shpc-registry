...
updated_at: "2025-02-02 02:56:05.534024"
...
```bash
$ shpc install quay.io/biocontainers/ezomero:3.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ezomero/3.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/ezomero/3.1.0--pyhdfd78af_0
```
