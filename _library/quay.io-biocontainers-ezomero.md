...
updated_at: "2024-02-06 02:26:51.427482"
...
```bash
$ shpc install quay.io/biocontainers/ezomero:2.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ezomero/2.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/ezomero/2.1.0--pyhdfd78af_0
```
