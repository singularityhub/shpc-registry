...
updated_at: "2026-03-24 04:45:48.702346"
...
```bash
$ shpc install quay.io/biocontainers/ezomero:3.2.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ezomero/3.2.3--pyhdfd78af_0
$ module help quay.io/biocontainers/ezomero/3.2.3--pyhdfd78af_0
```
