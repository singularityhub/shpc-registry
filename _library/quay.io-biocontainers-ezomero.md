---
layout: container
name:  "quay.io/biocontainers/ezomero"
maintainer: "@vsoch"
...
updated_at: "2025-03-23 03:22:26.365535"
...
```bash
$ shpc install quay.io/biocontainers/ezomero
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/ezomero:3.1.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ezomero/3.1.1--pyhdfd78af_0
$ module help quay.io/biocontainers/ezomero/3.1.1--pyhdfd78af_0
```
...
#### ezomero-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### ezomero-inspect-deffile:
