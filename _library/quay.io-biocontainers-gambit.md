...
updated_at: "2025-10-10 03:19:48.031597"
...
```bash
$ shpc install quay.io/biocontainers/gambit:1.1.0--py39hbcbf7aa_2
```
...
```bash
$ module load quay.io/biocontainers/gambit/1.1.0--py39hbcbf7aa_2
$ module help quay.io/biocontainers/gambit/1.1.0--py39hbcbf7aa_2
```
