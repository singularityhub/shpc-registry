---
layout: container
name:  "quay.io/biocontainers/gambit"
maintainer: "@vsoch"
...
updated_at: "2026-08-22 03:47:17.724064"
latest: "1.2.0--py312hfabe715_0"
...
```bash
$ shpc install quay.io/biocontainers/gambit
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/gambit:1.2.0--py312hfabe715_0
```
...
```bash
$ module load quay.io/biocontainers/gambit/1.2.0--py312hfabe715_0
$ module help quay.io/biocontainers/gambit/1.2.0--py312hfabe715_0
```
...
#### gambit-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### gambit-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/gambit
$ podman run --it --rm --entrypoint /usr/local/bin/gambit   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/gambit   -v ${PWD} -w ${PWD} <container> -c " $@"
```
