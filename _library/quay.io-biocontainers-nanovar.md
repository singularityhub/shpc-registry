...
updated_at: "2024-11-16 03:22:02.608067"
...
```bash
$ shpc install quay.io/biocontainers/nanovar:1.8.1--py39hff71179_0
```
...
```bash
$ module load quay.io/biocontainers/nanovar/1.8.1--py39hff71179_0
$ module help quay.io/biocontainers/nanovar/1.8.1--py39hff71179_0
```
