...
updated_at: "2026-08-29 08:56:33.084701"
latest: "4.4.46--h93cc2b8_0"
...
```bash
$ shpc install quay.io/biocontainers/obitools4:4.4.46--h93cc2b8_0
```
...
```bash
$ module load quay.io/biocontainers/obitools4/4.4.46--h93cc2b8_0
$ module help quay.io/biocontainers/obitools4/4.4.46--h93cc2b8_0
```
