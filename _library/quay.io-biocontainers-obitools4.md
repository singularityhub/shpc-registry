...
updated_at: "2026-09-09 07:36:56.634160"
latest: "4.5.0--h93cc2b8_0"
...
```bash
$ shpc install quay.io/biocontainers/obitools4:4.5.0--h93cc2b8_0
```
...
```bash
$ module load quay.io/biocontainers/obitools4/4.5.0--h93cc2b8_0
$ module help quay.io/biocontainers/obitools4/4.5.0--h93cc2b8_0
```
