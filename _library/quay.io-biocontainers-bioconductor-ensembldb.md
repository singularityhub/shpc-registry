...
updated_at: "2025-10-20 03:58:24.507972"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ensembldb:2.30.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ensembldb/2.30.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ensembldb/2.30.0--r44hdfd78af_0
```
