...
updated_at: "2026-04-05 04:57:28.958724"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ensembldb:2.34.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ensembldb/2.34.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ensembldb/2.34.0--r45hdfd78af_0
```
