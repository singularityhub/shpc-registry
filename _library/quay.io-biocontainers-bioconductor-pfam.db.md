...
updated_at: "2026-03-16 04:59:29.192471"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-pfam.db:3.22.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-pfam.db/3.22.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-pfam.db/3.22.0--r45hdfd78af_0
```
