...
updated_at: "2024-08-04 03:26:28.507961"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-pfam.db:3.18.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-pfam.db/3.18.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-pfam.db/3.18.0--r43hdfd78af_0
```
