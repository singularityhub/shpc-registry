...
updated_at: "2025-03-14 03:39:39.143551"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-pfam.db:3.20.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-pfam.db/3.20.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-pfam.db/3.20.0--r44hdfd78af_0
```
