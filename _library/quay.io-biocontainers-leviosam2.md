...
updated_at: "2023-10-01 02:53:27.842762"
...
```bash
$ shpc install quay.io/biocontainers/leviosam2:0.4.1--h4ac6f70_0
```
...
```bash
$ module load quay.io/biocontainers/leviosam2/0.4.1--h4ac6f70_0
$ module help quay.io/biocontainers/leviosam2/0.4.1--h4ac6f70_0
```
