...
updated_at: "2024-10-26 03:14:25.422767"
latest: "0.5.0--h4ac6f70_0"
...
```bash
$ shpc install quay.io/biocontainers/leviosam2:0.5.0--h4ac6f70_0
```
...
```bash
$ module load quay.io/biocontainers/leviosam2/0.5.0--h4ac6f70_0
$ module help quay.io/biocontainers/leviosam2/0.5.0--h4ac6f70_0
```
