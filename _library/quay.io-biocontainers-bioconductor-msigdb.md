...
updated_at: "2025-03-28 03:43:30.606695"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-msigdb:1.14.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-msigdb/1.14.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-msigdb/1.14.0--r44hdfd78af_0
```
