---
layout: container
name:  "quay.io/biocontainers/hyplas"
maintainer: "@vsoch"
...
updated_at: "2025-10-02 03:01:25.522433"
...
singularity registry hpc automated addition for hyplas
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/hyplas
```
...
#### hyplas-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### hyplas-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/hyplas
$ podman run --it --rm --entrypoint /usr/local/bin/hyplas   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/hyplas   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/innotin
$ podman run --it --rm --entrypoint /usr/local/bin/innotin   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/innotin   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/select_missing_reads
$ podman run --it --rm --entrypoint /usr/local/bin/select_missing_reads   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/select_missing_reads   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/split_plasmid_reads
$ podman run --it --rm --entrypoint /usr/local/bin/split_plasmid_reads   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/split_plasmid_reads   -v ${PWD} -w ${PWD} <container> -c " $@"
```
