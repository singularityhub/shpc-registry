...
updated_at: "2026-05-12 06:13:23.145961"
...
```bash
$ shpc install quay.io/biocontainers/methylartist:1.5.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/methylartist/1.5.4--pyhdfd78af_0
$ module help quay.io/biocontainers/methylartist/1.5.4--pyhdfd78af_0
```
