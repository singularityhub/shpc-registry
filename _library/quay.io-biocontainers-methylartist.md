...
updated_at: "2024-04-04 03:05:32.362199"
...
```bash
$ shpc install quay.io/biocontainers/methylartist:1.2.11--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/methylartist/1.2.11--pyhdfd78af_0
$ module help quay.io/biocontainers/methylartist/1.2.11--pyhdfd78af_0
```
