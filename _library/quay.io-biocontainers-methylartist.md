...
updated_at: "2024-04-22 02:27:16.756986"
...
```bash
$ shpc install quay.io/biocontainers/methylartist:1.3.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/methylartist/1.3.0--pyhdfd78af_0
$ module help quay.io/biocontainers/methylartist/1.3.0--pyhdfd78af_0
```
