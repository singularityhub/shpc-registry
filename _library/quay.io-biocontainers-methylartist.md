...
updated_at: "2026-02-07 04:51:22.543198"
...
```bash
$ shpc install quay.io/biocontainers/methylartist:1.5.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/methylartist/1.5.3--pyhdfd78af_0
$ module help quay.io/biocontainers/methylartist/1.5.3--pyhdfd78af_0
```
