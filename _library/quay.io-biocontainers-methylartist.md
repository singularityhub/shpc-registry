...
updated_at: "2025-06-20 03:20:07.501665"
...
```bash
$ shpc install quay.io/biocontainers/methylartist:1.5.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/methylartist/1.5.0--pyhdfd78af_0
$ module help quay.io/biocontainers/methylartist/1.5.0--pyhdfd78af_0
```
