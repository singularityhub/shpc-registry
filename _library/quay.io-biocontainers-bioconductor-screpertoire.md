...
updated_at: "2023-09-30 02:43:06.579967"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-screpertoire:1.10.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-screpertoire/1.10.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-screpertoire/1.10.0--r43hdfd78af_0
```
