---
layout: container
name:  "quay.io/biocontainers/snk-cli"
maintainer: "@vsoch"
...
updated_at: "2026-08-24 04:05:01.311287"
...
```bash
$ shpc install quay.io/biocontainers/snk-cli
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/snk-cli:0.8.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snk-cli/0.8.0--pyhdfd78af_0
$ module help quay.io/biocontainers/snk-cli/0.8.0--pyhdfd78af_0
```
...
#### snk-cli-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### snk-cli-inspect-deffile:
