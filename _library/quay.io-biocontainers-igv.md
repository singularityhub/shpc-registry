...
updated_at: "2025-08-25 04:00:18.727714"
latest: "2.19.4--h33ea123_0"
...
```bash
$ shpc install quay.io/biocontainers/igv:2.19.4--h33ea123_0
```
...
```bash
$ module load quay.io/biocontainers/igv/2.19.4--h33ea123_0
$ module help quay.io/biocontainers/igv/2.19.4--h33ea123_0
```
