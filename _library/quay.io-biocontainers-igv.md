...
updated_at: "2025-02-23 03:32:08.090138"
latest: "2.19.1--hdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/igv:2.19.1--hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/igv/2.19.1--hdfd78af_1
$ module help quay.io/biocontainers/igv/2.19.1--hdfd78af_1
```
