...
updated_at: "2026-03-18 05:16:57.241590"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-scry:1.22.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-scry/1.22.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-scry/1.22.0--r45hdfd78af_0
```
