...
updated_at: "2025-03-27 03:59:51.784460"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-somascan.db:0.99.10--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-somascan.db/0.99.10--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-somascan.db/0.99.10--r44hdfd78af_0
```
