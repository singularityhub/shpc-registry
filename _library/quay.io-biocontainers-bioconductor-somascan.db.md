...
updated_at: "2024-02-26 03:41:45.560920"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-somascan.db:0.99.7--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-somascan.db/0.99.7--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-somascan.db/0.99.7--r43hdfd78af_0
```
