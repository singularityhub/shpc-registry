...
updated_at: "2025-12-17 16:05:45.263633"
...
```bash
$ shpc install quay.io/biocontainers/semibin:2.2.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/semibin/2.2.1--pyhdfd78af_0
$ module help quay.io/biocontainers/semibin/2.2.1--pyhdfd78af_0
```
