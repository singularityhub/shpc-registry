...
updated_at: "2025-11-28 03:50:33.340304"
...
```bash
$ shpc install quay.io/biocontainers/semibin:2.2.0--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/semibin/2.2.0--pyhdfd78af_1
$ module help quay.io/biocontainers/semibin/2.2.0--pyhdfd78af_1
```
