...
updated_at: "2024-07-20 02:44:05.860497"
...
```bash
$ shpc install quay.io/biocontainers/semibin:2.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/semibin/2.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/semibin/2.1.0--pyhdfd78af_0
```
