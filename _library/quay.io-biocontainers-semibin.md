...
updated_at: "2026-07-02 06:21:28.462054"
...
```bash
$ shpc install quay.io/biocontainers/semibin:2.3.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/semibin/2.3.0--pyhdfd78af_0
$ module help quay.io/biocontainers/semibin/2.3.0--pyhdfd78af_0
```
