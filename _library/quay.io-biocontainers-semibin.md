...
updated_at: "2023-02-09 03:32:22.247629"
...
```bash
$ shpc install quay.io/biocontainers/semibin:1.4.0--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/semibin/1.4.0--pyh7cba7a3_0
$ module help quay.io/biocontainers/semibin/1.4.0--pyh7cba7a3_0
```
