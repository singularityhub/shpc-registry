...
updated_at: "2026-08-14 04:35:00.677482"
...
```bash
$ shpc install quay.io/biocontainers/semibin:2.4.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/semibin/2.4.1--pyhdfd78af_0
$ module help quay.io/biocontainers/semibin/2.4.1--pyhdfd78af_0
```
