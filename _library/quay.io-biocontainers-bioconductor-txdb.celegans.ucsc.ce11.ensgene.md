...
updated_at: "2022-10-27 00:57:25.993888"
latest: "3.4.6--r36_2"
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-txdb.celegans.ucsc.ce11.ensgene-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-txdb.celegans.ucsc.ce11.ensgene-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-txdb.celegans.ucsc.ce11.ensgene-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-txdb.celegans.ucsc.ce11.ensgene-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-txdb.celegans.ucsc.ce11.ensgene-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-txdb.celegans.ucsc.ce11.ensgene-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
