...
updated_at: "2025-12-25 04:25:05.063078"
latest: "hamtv0.3.5--h5ca1c30_0"
...
```bash
$ shpc install quay.io/biocontainers/hifiasm_meta:hamtv0.3.5--h5ca1c30_0
```
...
```bash
$ module load quay.io/biocontainers/hifiasm_meta/hamtv0.3.5--h5ca1c30_0
$ module help quay.io/biocontainers/hifiasm_meta/hamtv0.3.5--h5ca1c30_0
```
