...
updated_at: "2025-03-20 04:34:29.973507"
latest: "hamtv0.3.2--h5ca1c30_2"
...
```bash
$ shpc install quay.io/biocontainers/hifiasm_meta:hamtv0.3.2--h5ca1c30_2
```
...
```bash
$ module load quay.io/biocontainers/hifiasm_meta/hamtv0.3.2--h5ca1c30_2
$ module help quay.io/biocontainers/hifiasm_meta/hamtv0.3.2--h5ca1c30_2
```
