...
updated_at: "2024-11-04 03:33:18.957399"
latest: "hamtv0.3.2--h43eeafb_1"
...
```bash
$ shpc install quay.io/biocontainers/hifiasm_meta:hamtv0.3.2--h43eeafb_1
```
...
```bash
$ module load quay.io/biocontainers/hifiasm_meta/hamtv0.3.2--h43eeafb_1
$ module help quay.io/biocontainers/hifiasm_meta/hamtv0.3.2--h43eeafb_1
```
