...
updated_at: "2026-02-23 06:27:57.867298"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-epivizrserver:1.38.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-epivizrserver/1.38.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-epivizrserver/1.38.0--r45hdfd78af_0
```
