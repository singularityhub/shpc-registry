...
updated_at: "2024-03-25 02:26:56.925991"
...
```bash
$ shpc install quay.io/biocontainers/toil:6.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/toil/6.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/toil/6.1.0--pyhdfd78af_0
```
