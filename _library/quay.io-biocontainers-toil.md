...
updated_at: "2024-02-18 02:33:47.454686"
...
```bash
$ shpc install quay.io/biocontainers/toil:6.0.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/toil/6.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/toil/6.0.0--pyhdfd78af_0
```
