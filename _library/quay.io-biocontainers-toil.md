...
updated_at: "2023-08-07 02:35:59.865535"
latest: "5.11.0--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/toil:5.11.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/toil/5.11.0--pyhdfd78af_0
$ module help quay.io/biocontainers/toil/5.11.0--pyhdfd78af_0
```
