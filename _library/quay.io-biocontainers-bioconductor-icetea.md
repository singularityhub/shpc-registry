...
updated_at: "2026-07-01 06:45:19.702595"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-icetea:1.28.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-icetea/1.28.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-icetea/1.28.0--r45hdfd78af_0
```
