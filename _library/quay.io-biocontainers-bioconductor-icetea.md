...
updated_at: "2025-05-01 07:04:01.143372"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-icetea:1.24.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-icetea/1.24.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-icetea/1.24.0--r44hdfd78af_0
```
