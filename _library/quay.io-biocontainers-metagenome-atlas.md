...
updated_at: "2023-05-25 02:52:42.717143"
latest: "2.15.2--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/metagenome-atlas:2.15.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/metagenome-atlas/2.15.2--pyhdfd78af_0
$ module help quay.io/biocontainers/metagenome-atlas/2.15.2--pyhdfd78af_0
```
