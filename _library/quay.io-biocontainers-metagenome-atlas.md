...
updated_at: "2023-05-03 02:43:27.986777"
...
```bash
$ shpc install quay.io/biocontainers/metagenome-atlas:2.15.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/metagenome-atlas/2.15.0--pyhdfd78af_0
$ module help quay.io/biocontainers/metagenome-atlas/2.15.0--pyhdfd78af_0
```
