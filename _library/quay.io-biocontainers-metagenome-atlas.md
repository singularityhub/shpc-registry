...
updated_at: "2023-01-14 03:04:03.095821"
...
```bash
$ shpc install quay.io/biocontainers/metagenome-atlas:2.13.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/metagenome-atlas/2.13.1--pyhdfd78af_0
$ module help quay.io/biocontainers/metagenome-atlas/2.13.1--pyhdfd78af_0
```
