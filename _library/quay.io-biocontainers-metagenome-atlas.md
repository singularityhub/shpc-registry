...
updated_at: "2026-01-22 04:45:01.762482"
latest: "19.0.1--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/metagenome-atlas:19.0.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/metagenome-atlas/19.0.1--pyhdfd78af_0
$ module help quay.io/biocontainers/metagenome-atlas/19.0.1--pyhdfd78af_0
```
