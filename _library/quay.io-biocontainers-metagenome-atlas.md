...
updated_at: "2023-02-23 03:13:39.232559"
latest: "2.14.0--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/metagenome-atlas:2.14.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/metagenome-atlas/2.14.0--pyhdfd78af_0
$ module help quay.io/biocontainers/metagenome-atlas/2.14.0--pyhdfd78af_0
```
