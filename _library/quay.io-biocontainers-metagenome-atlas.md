...
updated_at: "2024-05-28 02:31:13.003432"
...
```bash
$ shpc install quay.io/biocontainers/metagenome-atlas:2.18.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/metagenome-atlas/2.18.1--pyhdfd78af_0
$ module help quay.io/biocontainers/metagenome-atlas/2.18.1--pyhdfd78af_0
```
