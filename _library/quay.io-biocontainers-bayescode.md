...
updated_at: "2023-09-19 02:41:29.007642"
latest: "1.3.0--hdbdd923_0"
...
```bash
$ shpc install quay.io/biocontainers/bayescode:1.3.0--hdbdd923_0
```
...
```bash
$ module load quay.io/biocontainers/bayescode/1.3.0--hdbdd923_0
$ module help quay.io/biocontainers/bayescode/1.3.0--hdbdd923_0
```
