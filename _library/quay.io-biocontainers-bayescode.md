...
updated_at: "2023-11-10 02:38:22.127051"
latest: "1.3.1--hdbdd923_0"
...
```bash
$ shpc install quay.io/biocontainers/bayescode:1.3.1--hdbdd923_0
```
...
```bash
$ module load quay.io/biocontainers/bayescode/1.3.1--hdbdd923_0
$ module help quay.io/biocontainers/bayescode/1.3.1--hdbdd923_0
```
