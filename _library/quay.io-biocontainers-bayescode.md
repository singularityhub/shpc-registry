...
updated_at: "2025-03-20 04:32:23.393640"
...
```bash
$ shpc install quay.io/biocontainers/bayescode:1.3.3--h503566f_1
```
...
```bash
$ module load quay.io/biocontainers/bayescode/1.3.3--h503566f_1
$ module help quay.io/biocontainers/bayescode/1.3.3--h503566f_1
```
