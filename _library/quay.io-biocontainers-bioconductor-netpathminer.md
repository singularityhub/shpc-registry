...
updated_at: "2025-09-01 05:02:28.308802"
latest: "1.42.0--r44h0ce4ec3_1"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-netpathminer:1.42.0--r44h0ce4ec3_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-netpathminer/1.42.0--r44h0ce4ec3_1
$ module help quay.io/biocontainers/bioconductor-netpathminer/1.42.0--r44h0ce4ec3_1
```
