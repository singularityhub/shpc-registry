...
updated_at: "2024-10-30 16:04:46.238229"
latest: "1.38.0--r43h306fc42_2"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-netpathminer:1.38.0--r43h306fc42_2
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-netpathminer/1.38.0--r43h306fc42_2
$ module help quay.io/biocontainers/bioconductor-netpathminer/1.38.0--r43h306fc42_2
```
