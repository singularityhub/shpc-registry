...
updated_at: "2026-01-26 04:48:06.976276"
...
```bash
$ shpc install quay.io/biocontainers/pmx_biobb:5.2.2--py312h2e53e4c_0
```
...
```bash
$ module load quay.io/biocontainers/pmx_biobb/5.2.2--py312h2e53e4c_0
$ module help quay.io/biocontainers/pmx_biobb/5.2.2--py312h2e53e4c_0
```
