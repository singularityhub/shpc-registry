---
layout: container
name:  "quay.io/biocontainers/bioconductor-hpo.db"
maintainer: "@vsoch"
github: "https://github.com/singularityhub/shpc-registry/blob/main/quay.io/biocontainers/bioconductor-hpo.db/container.yaml"
config_url: "https://raw.githubusercontent.com/singularityhub/shpc-registry/main/quay.io/biocontainers/bioconductor-hpo.db/container.yaml"
updated_at: "2025-02-03 03:13:47.140976"
latest: "0.99.2--r43hdfd78af_0"
container_url: "https://biocontainers.pro/tools/bioconductor-hpo.db"
aliases:
 - "pcre2posix_test"
 - "2to3-3.12"
 - "idle3.12"
...
```bash
$ module load quay.io/biocontainers/bioconductor-hpo.db/0.99.2--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-hpo.db/0.99.2--r43hdfd78af_0
```
...
#### bioconductor-hpo.db-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-hpo.db-inspect-deffile:
