...
updated_at: "2025-06-21 03:40:18.378939"
latest: "24.2.4--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/galaxy-job-execution:24.2.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/galaxy-job-execution/24.2.4--pyhdfd78af_0
$ module help quay.io/biocontainers/galaxy-job-execution/24.2.4--pyhdfd78af_0
```
