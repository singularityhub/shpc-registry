...
updated_at: "2025-10-19 03:38:02.272951"
...
```bash
$ shpc install quay.io/biocontainers/galaxy-job-execution:25.0.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/galaxy-job-execution/25.0.3--pyhdfd78af_0
$ module help quay.io/biocontainers/galaxy-job-execution/25.0.3--pyhdfd78af_0
```
