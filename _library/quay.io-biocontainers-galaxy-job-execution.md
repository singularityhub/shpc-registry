...
updated_at: "2025-08-04 04:36:28.803543"
...
```bash
$ shpc install quay.io/biocontainers/galaxy-job-execution:25.0.1--pyh7e72e81_0
```
...
```bash
$ module load quay.io/biocontainers/galaxy-job-execution/25.0.1--pyh7e72e81_0
$ module help quay.io/biocontainers/galaxy-job-execution/25.0.1--pyh7e72e81_0
```
