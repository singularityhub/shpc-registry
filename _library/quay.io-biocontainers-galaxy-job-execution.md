...
updated_at: "2025-09-02 03:11:32.751966"
...
```bash
$ shpc install quay.io/biocontainers/galaxy-job-execution:25.0.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/galaxy-job-execution/25.0.2--pyhdfd78af_0
$ module help quay.io/biocontainers/galaxy-job-execution/25.0.2--pyhdfd78af_0
```
