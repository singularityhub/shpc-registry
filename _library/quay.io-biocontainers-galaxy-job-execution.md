---
layout: container
name:  "quay.io/biocontainers/galaxy-job-execution"
maintainer: "@vsoch"
...
updated_at: "2026-01-04 04:17:04.199461"
...
aliases:
 ...
 - "galaxy-container-monitor"
 - "galaxy-load-objects"
 - "galaxy-manage-db"
 - "galaxy-prune-histories"
 - "galaxy-set-metadata"
 - "galaxy-tool-test"
 - "galaxy-tool-test-case-validation"
 - "galaxy-tool-upgrade-advisor"
 - "gx-fastq-combiner"
 - "gx-fastq-filter"
 - "gx-fastq-groomer"
...
versions:
 ...
 - "25.0.3--pyhdfd78af_0"
 - "25.0.4--pyhdfd78af_0"
description: "singularity registry hpc automated addition for galaxy-job-execution"
config: {"url": "https://biocontainers.pro/tools/galaxy-job-execution", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for galaxy-job-execution", "latest": {"25.0.4--pyhdfd78af_0": "sha256:4e81af68560c53fa293341bab4efaa23905fc5d36cb7ea6b6bd40d602b0ce681"}, "tags": {"24.2.4--pyhdfd78af_0": "sha256:dab643515ffdf586dfa4785710876ac5be4ba325d3a21edb65ac507314e37fb9", "25.0.1--pyh7e72e81_0": "sha256:0f665729dfa9489428808e3b70c3b1e54f644ba475098db32a018f167e39feeb", "25.0.2--pyhdfd78af_0": "sha256:88829e4328b502966d7f1e623fb092a3f365829daeadad54816a66b62d8ffb7a", "25.0.3--pyhdfd78af_0": "sha256:66201ed2b1ac95b30c519d00369c3906679cdfc4aa1efc9dd32754254eaea764", "25.0.4--pyhdfd78af_0": "sha256:4e81af68560c53fa293341bab4efaa23905fc5d36cb7ea6b6bd40d602b0ce681"}, "docker": "quay.io/biocontainers/galaxy-job-execution", "aliases": {"bagit.py": "/usr/local/bin/bagit.py", "bagit_profile.py": "/usr/local/bin/bagit_profile.py", "bdbag": "/usr/local/bin/bdbag", "bdbag-utils": "/usr/local/bin/bdbag-utils", "email_validator": "/usr/local/bin/email_validator", "flu": "/usr/local/bin/flu", "flu_precommit": "/usr/local/bin/flu_precommit", "galaxy-build-objects": "/usr/local/bin/galaxy-build-objects", "galaxy-container-monitor": "/usr/local/bin/galaxy-container-monitor", "galaxy-load-objects": "/usr/local/bin/galaxy-load-objects", "galaxy-manage-db": "/usr/local/bin/galaxy-manage-db", "galaxy-prune-histories": "/usr/local/bin/galaxy-prune-histories", "galaxy-set-metadata": "/usr/local/bin/galaxy-set-metadata", "galaxy-tool-test": "/usr/local/bin/galaxy-tool-test", "galaxy-tool-test-case-validation": "/usr/local/bin/galaxy-tool-test-case-validation", "galaxy-tool-upgrade-advisor": "/usr/local/bin/galaxy-tool-upgrade-advisor", "gx-fastq-combiner": "/usr/local/bin/gx-fastq-combiner", "gx-fastq-filter": "/usr/local/bin/gx-fastq-filter", "gx-fastq-groomer": "/usr/local/bin/gx-fastq-groomer", "gx-fastq-manipulation": "/usr/local/bin/gx-fastq-manipulation", "gx-fastq-masker-by-quality": "/usr/local/bin/gx-fastq-masker-by-quality", "gx-fastq-paired-end-deinterlacer": "/usr/local/bin/gx-fastq-paired-end-deinterlacer", "gx-fastq-paired-end-interlacer": "/usr/local/bin/gx-fastq-paired-end-interlacer", "gx-fastq-paired-end-joiner": "/usr/local/bin/gx-fastq-paired-end-joiner", "gx-fastq-paired-end-splitter": "/usr/local/bin/gx-fastq-paired-end-splitter", "gx-fastq-stats": "/usr/local/bin/gx-fastq-stats", "gx-fastq-to-fasta": "/usr/local/bin/gx-fastq-to-fasta", "gx-fastq-to-tabular": "/usr/local/bin/gx-fastq-to-tabular", "gx-fastq-trimmer": "/usr/local/bin/gx-fastq-trimmer", "gx-fastq-trimmer-by-quality": "/usr/local/bin/gx-fastq-trimmer-by-quality", "mrcfile-header": "/usr/local/bin/mrcfile-header", "mrcfile-validate": "/usr/local/bin/mrcfile-validate", "mulled-build": "/usr/local/bin/mulled-build", "mulled-build-channel": "/usr/local/bin/mulled-build-channel", "mulled-build-files": "/usr/local/bin/mulled-build-files", "mulled-build-tool": "/usr/local/bin/mulled-build-tool", "mulled-hash": "/usr/local/bin/mulled-hash", "mulled-list": "/usr/local/bin/mulled-list", "mulled-search": "/usr/local/bin/mulled-search", "mulled-update-singularity-containers": "/usr/local/bin/mulled-update-singularity-containers", "rocrate": "/usr/local/bin/rocrate", "validate-test-format": "/usr/local/bin/validate-test-format", "alembic": "/usr/local/bin/alembic", "cheetah": "/usr/local/bin/cheetah", "cheetah-analyze": "/usr/local/bin/cheetah-analyze", "cheetah-compile": "/usr/local/bin/cheetah-compile", "h5fuse": "/usr/local/bin/h5fuse", "rst2html": "/usr/local/bin/rst2html", "rst2html4": "/usr/local/bin/rst2html4", "rst2html5": "/usr/local/bin/rst2html5", "rst2latex": "/usr/local/bin/rst2latex", "rst2man": "/usr/local/bin/rst2man", "rst2odt": "/usr/local/bin/rst2odt", "rst2pseudoxml": "/usr/local/bin/rst2pseudoxml", "rst2s5": "/usr/local/bin/rst2s5", "rst2xetex": "/usr/local/bin/rst2xetex", "rst2xml": "/usr/local/bin/rst2xml", "tiff2fsspec": "/usr/local/bin/tiff2fsspec", "tiffcomment": "/usr/local/bin/tiffcomment", "mako-render": "/usr/local/bin/mako-render", "SvtAv1EncApp": "/usr/local/bin/SvtAv1EncApp", "cbrunsli": "/usr/local/bin/cbrunsli", "dbrunsli": "/usr/local/bin/dbrunsli", "imagecodecs": "/usr/local/bin/imagecodecs", "zfp": "/usr/local/bin/zfp", "zopfli": "/usr/local/bin/zopfli", "zopflipng": "/usr/local/bin/zopflipng"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/galaxy-job-execution.
singularity registry hpc automated addition for galaxy-job-execution
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/galaxy-job-execution
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/galaxy-job-execution:25.0.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/galaxy-job-execution/25.0.4--pyhdfd78af_0
$ module help quay.io/biocontainers/galaxy-job-execution/25.0.4--pyhdfd78af_0
```
...
#### galaxy-job-execution-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### galaxy-job-execution-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/flu
$ podman run --it --rm --entrypoint /usr/local/bin/flu   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/flu   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/flu_precommit
$ podman run --it --rm --entrypoint /usr/local/bin/flu_precommit   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/flu_precommit   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/galaxy-container-monitor
$ podman run --it --rm --entrypoint /usr/local/bin/galaxy-container-monitor   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/galaxy-container-monitor   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/galaxy-load-objects
$ podman run --it --rm --entrypoint /usr/local/bin/galaxy-load-objects   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/galaxy-load-objects   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/galaxy-prune-histories
$ podman run --it --rm --entrypoint /usr/local/bin/galaxy-prune-histories   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/galaxy-prune-histories   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/galaxy-set-metadata
$ podman run --it --rm --entrypoint /usr/local/bin/galaxy-set-metadata   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/galaxy-set-metadata   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/galaxy-tool-test-case-validation
$ podman run --it --rm --entrypoint /usr/local/bin/galaxy-tool-test-case-validation   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/galaxy-tool-test-case-validation   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/galaxy-tool-upgrade-advisor
$ podman run --it --rm --entrypoint /usr/local/bin/galaxy-tool-upgrade-advisor   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/galaxy-tool-upgrade-advisor   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/validate-test-format
$ podman run --it --rm --entrypoint /usr/local/bin/validate-test-format   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/validate-test-format   -v ${PWD} -w ${PWD} <container> -c " $@"
```
