...
updated_at: "2025-12-18 03:56:46.784889"
latest: "0.9.0--py311hc1104ee_0"
...
```bash
$ shpc install quay.io/biocontainers/inmoose:0.9.0--py311hc1104ee_0
```
...
```bash
$ module load quay.io/biocontainers/inmoose/0.9.0--py311hc1104ee_0
$ module help quay.io/biocontainers/inmoose/0.9.0--py311hc1104ee_0
```
