...
updated_at: "2026-02-07 04:41:58.447703"
...
```bash
$ shpc install quay.io/biocontainers/inmoose:0.9.1--py311hc1104ee_0
```
...
```bash
$ module load quay.io/biocontainers/inmoose/0.9.1--py311hc1104ee_0
$ module help quay.io/biocontainers/inmoose/0.9.1--py311hc1104ee_0
```
