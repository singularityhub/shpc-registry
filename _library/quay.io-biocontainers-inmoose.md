...
updated_at: "2025-06-20 03:25:16.934207"
latest: "0.7.6--py310ha6711e0_0"
...
```bash
$ shpc install quay.io/biocontainers/inmoose:0.7.6--py310ha6711e0_0
```
...
```bash
$ module load quay.io/biocontainers/inmoose/0.7.6--py310ha6711e0_0
$ module help quay.io/biocontainers/inmoose/0.7.6--py310ha6711e0_0
```
