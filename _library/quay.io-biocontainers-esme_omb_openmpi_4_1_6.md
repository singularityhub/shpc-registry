---
layout: container
name:  "quay.io/biocontainers/esme_omb_openmpi_4_1_6"
maintainer: "@vsoch"
github: "https://github.com/singularityhub/shpc-registry/blob/main/quay.io/biocontainers/esme_omb_openmpi_4_1_6/container.yaml"
config_url: "https://raw.githubusercontent.com/singularityhub/shpc-registry/main/quay.io/biocontainers/esme_omb_openmpi_4_1_6/container.yaml"
updated_at: "2025-10-01 03:36:29.926569"
latest: "7.5--hc84d7b2_0"
container_url: "https://biocontainers.pro/tools/esme_omb_openmpi_4_1_6"
aliases:
 - "shmemrun"
 - "oshCC"
 - "oshc++"
...
versions:
 - "7.5--hc84d7b2_0"
description: "singularity registry hpc automated addition for esme_omb_openmpi_4_1_6"
config: {"url": "https://biocontainers.pro/tools/esme_omb_openmpi_4_1_6", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for esme_omb_openmpi_4_1_6", "latest": {"7.5--hc84d7b2_0": "sha256:f2f1c4e79d0b3a0af6e72a3e06e335c20267087cee4bc21c6b2a968d144dd344"}, "tags": {"7.5--hc84d7b2_0": "sha256:f2f1c4e79d0b3a0af6e72a3e06e335c20267087cee4bc21c6b2a968d144dd344"}, "docker": "quay.io/biocontainers/esme_omb_openmpi_4_1_6", "aliases": {"shmemrun": "/usr/local/bin/shmemrun", "oshCC": "/usr/local/bin/oshCC", "oshc++": "/usr/local/bin/oshc++", "oshcxx": "/usr/local/bin/oshcxx", "shmemCC": "/usr/local/bin/shmemCC", "shmemc++": "/usr/local/bin/shmemc++", "shmemcxx": "/usr/local/bin/shmemcxx", "oshcc": "/usr/local/bin/oshcc", "oshfort": "/usr/local/bin/oshfort", "oshmem_info": "/usr/local/bin/oshmem_info", "oshrun": "/usr/local/bin/oshrun", "shmemcc": "/usr/local/bin/shmemcc", "shmemfort": "/usr/local/bin/shmemfort", "aggregate_profile.pl": "/usr/local/bin/aggregate_profile.pl", "profile2mat.pl": "/usr/local/bin/profile2mat.pl", "ompi-clean": "/usr/local/bin/ompi-clean", "ompi-server": "/usr/local/bin/ompi-server", "orte-clean": "/usr/local/bin/orte-clean", "orte-info": "/usr/local/bin/orte-info", "orte-server": "/usr/local/bin/orte-server", "ortecc": "/usr/local/bin/ortecc", "orted": "/usr/local/bin/orted", "orterun": "/usr/local/bin/orterun", "mpiCC": "/usr/local/bin/mpiCC", "ompi_info": "/usr/local/bin/ompi_info"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/esme_omb_openmpi_4_1_6.
singularity registry hpc automated addition for esme_omb_openmpi_4_1_6
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/esme_omb_openmpi_4_1_6
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/esme_omb_openmpi_4_1_6:7.5--hc84d7b2_0
```
...
```bash
$ module load quay.io/biocontainers/esme_omb_openmpi_4_1_6/7.5--hc84d7b2_0
$ module help quay.io/biocontainers/esme_omb_openmpi_4_1_6/7.5--hc84d7b2_0
```
...
#### esme_omb_openmpi_4_1_6-inspect:
...
#### esme_omb_openmpi_4_1_6-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### esme_omb_openmpi_4_1_6-inspect-deffile:
