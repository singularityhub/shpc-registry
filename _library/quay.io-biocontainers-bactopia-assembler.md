...
updated_at: "2023-08-17 03:00:11.024590"
...
```bash
$ shpc install quay.io/biocontainers/bactopia-assembler:1.0.2--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bactopia-assembler/1.0.2--hdfd78af_0
$ module help quay.io/biocontainers/bactopia-assembler/1.0.2--hdfd78af_0
```
