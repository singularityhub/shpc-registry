...
updated_at: "2026-01-01 04:01:02.430505"
...
```bash
$ shpc install quay.io/biocontainers/bactopia-assembler:1.0.4--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bactopia-assembler/1.0.4--hdfd78af_0
$ module help quay.io/biocontainers/bactopia-assembler/1.0.4--hdfd78af_0
```
