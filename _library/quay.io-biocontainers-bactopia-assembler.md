...
updated_at: "2026-06-06 15:58:01.730902"
...
```bash
$ shpc install quay.io/biocontainers/bactopia-assembler:1.0.5--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bactopia-assembler/1.0.5--hdfd78af_0
$ module help quay.io/biocontainers/bactopia-assembler/1.0.5--hdfd78af_0
```
