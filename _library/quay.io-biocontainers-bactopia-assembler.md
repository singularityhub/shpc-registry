...
updated_at: "2024-10-07 03:10:59.218750"
...
```bash
$ shpc install quay.io/biocontainers/bactopia-assembler:1.0.3--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bactopia-assembler/1.0.3--hdfd78af_0
$ module help quay.io/biocontainers/bactopia-assembler/1.0.3--hdfd78af_0
```
