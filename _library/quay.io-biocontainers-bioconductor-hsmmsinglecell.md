...
updated_at: "2024-07-08 03:14:30.996151"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hsmmsinglecell:1.22.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hsmmsinglecell/1.22.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-hsmmsinglecell/1.22.0--r43hdfd78af_0
```
