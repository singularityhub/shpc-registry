...
updated_at: "2022-10-27 00:32:16.716019"
latest: "1.9.0--r40_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hsmmsinglecell:1.9.0--r40_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hsmmsinglecell/1.9.0--r40_0
$ module help quay.io/biocontainers/bioconductor-hsmmsinglecell/1.9.0--r40_0
```
