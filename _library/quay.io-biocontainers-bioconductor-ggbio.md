...
updated_at: "2022-11-03 00:55:10.711878"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ggbio:1.42.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ggbio/1.42.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ggbio/1.42.0--r41hdfd78af_0
```
