...
updated_at: "2026-08-29 09:37:00.599293"
...
```bash
$ shpc install quay.io/biocontainers/biobb_model:5.3.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_model/5.3.0--pyhdfd78af_0
$ module help quay.io/biocontainers/biobb_model/5.3.0--pyhdfd78af_0
```
