...
updated_at: "2026-05-31 06:52:07.253893"
...
```bash
$ shpc install quay.io/biocontainers/biobb_model:5.2.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_model/5.2.1--pyhdfd78af_0
$ module help quay.io/biocontainers/biobb_model/5.2.1--pyhdfd78af_0
```
