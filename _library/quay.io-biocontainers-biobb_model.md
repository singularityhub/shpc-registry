...
updated_at: "2023-09-11 02:40:21.174546"
...
```bash
$ shpc install quay.io/biocontainers/biobb_model:4.0.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_model/4.0.1--pyhdfd78af_0
$ module help quay.io/biocontainers/biobb_model/4.0.1--pyhdfd78af_0
```
