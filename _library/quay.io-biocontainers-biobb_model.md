...
updated_at: "2024-06-17 02:49:17.593288"
...
```bash
$ shpc install quay.io/biocontainers/biobb_model:4.2.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_model/4.2.1--pyhdfd78af_0
$ module help quay.io/biocontainers/biobb_model/4.2.1--pyhdfd78af_0
```
