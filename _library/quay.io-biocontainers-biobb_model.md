...
updated_at: "2023-05-26 02:51:30.679340"
...
```bash
$ shpc install quay.io/biocontainers/biobb_model:4.0.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_model/4.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/biobb_model/4.0.0--pyhdfd78af_0
```
