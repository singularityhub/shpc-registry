...
updated_at: "2026-01-31 04:53:49.015765"
...
```bash
$ shpc install quay.io/biocontainers/biobb_model:5.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_model/5.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/biobb_model/5.2.0--pyhdfd78af_0
```
