...
updated_at: "2024-05-06 04:18:56.464978"
...
```bash
$ shpc install quay.io/biocontainers/biobb_model:4.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_model/4.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/biobb_model/4.1.0--pyhdfd78af_0
```
