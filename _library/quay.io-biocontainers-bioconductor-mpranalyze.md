...
updated_at: "2025-01-14 02:57:22.409798"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mpranalyze:1.24.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mpranalyze/1.24.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-mpranalyze/1.24.0--r44hdfd78af_0
```
