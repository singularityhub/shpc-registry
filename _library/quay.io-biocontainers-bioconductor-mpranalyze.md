...
updated_at: "2026-03-27 05:20:22.083434"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mpranalyze:1.28.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mpranalyze/1.28.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-mpranalyze/1.28.0--r45hdfd78af_0
```
