...
updated_at: "2025-02-09 03:29:36.339060"
latest: "4.18.0--r44h77050f0_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-flowworkspace:4.18.0--r44h77050f0_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-flowworkspace/4.18.0--r44h77050f0_0
$ module help quay.io/biocontainers/bioconductor-flowworkspace/4.18.0--r44h77050f0_0
```
