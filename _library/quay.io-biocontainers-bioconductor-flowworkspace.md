...
updated_at: "2025-04-25 02:33:21.549323"
latest: "4.18.0--r44h77050f0_1"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-flowworkspace:4.18.0--r44h77050f0_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-flowworkspace/4.18.0--r44h77050f0_1
$ module help quay.io/biocontainers/bioconductor-flowworkspace/4.18.0--r44h77050f0_1
```
