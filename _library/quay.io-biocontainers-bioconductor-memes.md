...
updated_at: "2024-08-05 04:25:15.628894"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-memes:1.10.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-memes/1.10.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-memes/1.10.0--r43hdfd78af_0
```
