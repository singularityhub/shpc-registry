...
updated_at: "2023-11-03 02:37:31.389942"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hermes:1.4.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hermes/1.4.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-hermes/1.4.0--r43hdfd78af_0
```
