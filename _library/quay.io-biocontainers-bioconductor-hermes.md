...
updated_at: "2026-01-04 04:37:50.358861"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hermes:1.10.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hermes/1.10.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-hermes/1.10.0--r44hdfd78af_0
```
