...
updated_at: "2023-12-31 03:07:32.900655"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hermes:1.6.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hermes/1.6.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-hermes/1.6.0--r43hdfd78af_0
```
