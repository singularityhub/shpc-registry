...
updated_at: "2024-04-18 03:01:04.331964"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ivygapse:1.24.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ivygapse/1.24.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ivygapse/1.24.0--r43hdfd78af_0
```
