...
updated_at: "2026-02-18 04:51:05.752759"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-prostatecancerstockholm:1.38.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-prostatecancerstockholm/1.38.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-prostatecancerstockholm/1.38.0--r45hdfd78af_0
```
