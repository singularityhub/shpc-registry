...
updated_at: "2025-05-14 03:21:01.376321"
...
```bash
$ shpc install quay.io/biocontainers/hmftools-teal:1.3.3--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hmftools-teal/1.3.3--hdfd78af_0
$ module help quay.io/biocontainers/hmftools-teal/1.3.3--hdfd78af_0
```
