---
layout: container
name:  "quay.io/biocontainers/hmftools-teal"
maintainer: "@vsoch"
...
updated_at: "2025-08-05 04:16:55.922675"
...
```bash
$ module load quay.io/biocontainers/hmftools-teal/1.3.5--hdfd78af_0
$ module help quay.io/biocontainers/hmftools-teal/1.3.5--hdfd78af_0
```
...
#### hmftools-teal-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### hmftools-teal-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/teal
$ podman run --it --rm --entrypoint /usr/local/bin/teal   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/teal   -v ${PWD} -w ${PWD} <container> -c " $@"
```
