...
updated_at: "2024-09-16 04:09:24.736613"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-biobroom:1.34.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-biobroom/1.34.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-biobroom/1.34.0--r43hdfd78af_0
```
