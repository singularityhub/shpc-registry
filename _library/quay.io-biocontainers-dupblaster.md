---
layout: container
name:  "quay.io/biocontainers/dupblaster"
maintainer: "@vsoch"
...
updated_at: "2026-06-22 01:51:43.228816"
...
singularity registry hpc automated addition for dupblaster
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/dupblaster
```
...
#### dupblaster-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### dupblaster-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/dupblaster
$ podman run --it --rm --entrypoint /usr/local/bin/dupblaster   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/dupblaster   -v ${PWD} -w ${PWD} <container> -c " $@"
```
