...
updated_at: "2024-04-12 02:57:38.853305"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-xmapbridge:1.60.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-xmapbridge/1.60.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-xmapbridge/1.60.0--r43hdfd78af_0
```
