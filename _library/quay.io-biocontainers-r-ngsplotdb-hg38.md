...
updated_at: "2022-11-08 00:31:13.298223"
...
```bash
$ singularity exec <container> /usr/local/bin/.r-ngsplotdb-hg38-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.r-ngsplotdb-hg38-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.r-ngsplotdb-hg38-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.r-ngsplotdb-hg38-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.r-ngsplotdb-hg38-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.r-ngsplotdb-hg38-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
