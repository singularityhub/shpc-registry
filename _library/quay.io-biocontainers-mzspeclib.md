---
layout: container
name:  "quay.io/biocontainers/mzspeclib"
maintainer: "@vsoch"
...
updated_at: "2025-11-21 15:44:53.255282"
...
```bash
$ shpc install quay.io/biocontainers/mzspeclib
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/mzspeclib:1.0.7--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mzspeclib/1.0.7--pyhdfd78af_0
$ module help quay.io/biocontainers/mzspeclib/1.0.7--pyhdfd78af_0
```
...
#### mzspeclib-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### mzspeclib-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/mzspeclib
$ podman run --it --rm --entrypoint /usr/local/bin/mzspeclib   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/mzspeclib   -v ${PWD} -w ${PWD} <container> -c " $@"
```
