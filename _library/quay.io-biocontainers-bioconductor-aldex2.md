...
updated_at: "2025-01-08 07:01:11.003744"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-aldex2:1.34.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-aldex2/1.34.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-aldex2/1.34.0--r43hdfd78af_0
```
