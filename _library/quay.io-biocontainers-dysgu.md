...
updated_at: "2023-10-02 03:17:50.258842"
latest: "1.6.0--py310h770aed0_0"
...
```bash
$ shpc install quay.io/biocontainers/dysgu:1.6.0--py310h770aed0_0
```
...
```bash
$ module load quay.io/biocontainers/dysgu/1.6.0--py310h770aed0_0
$ module help quay.io/biocontainers/dysgu/1.6.0--py310h770aed0_0
```
