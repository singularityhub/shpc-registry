...
updated_at: "2025-03-04 03:43:18.427297"
latest: "1.7.0--py310h0b8f69d_1"
...
```bash
$ shpc install quay.io/biocontainers/dysgu:1.7.0--py310h0b8f69d_1
```
...
```bash
$ module load quay.io/biocontainers/dysgu/1.7.0--py310h0b8f69d_1
$ module help quay.io/biocontainers/dysgu/1.7.0--py310h0b8f69d_1
```
