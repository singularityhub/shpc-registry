...
updated_at: "2023-10-26 02:59:11.656379"
latest: "1.6.1--py310h770aed0_0"
...
```bash
$ shpc install quay.io/biocontainers/dysgu:1.6.1--py310h770aed0_0
```
...
```bash
$ module load quay.io/biocontainers/dysgu/1.6.1--py310h770aed0_0
$ module help quay.io/biocontainers/dysgu/1.6.1--py310h770aed0_0
```
