...
updated_at: "2024-10-28 03:22:42.492188"
latest: "1.6.7--py38hbf64fdb_0"
...
```bash
$ shpc install quay.io/biocontainers/dysgu:1.6.7--py38hbf64fdb_0
```
...
```bash
$ module load quay.io/biocontainers/dysgu/1.6.7--py38hbf64fdb_0
$ module help quay.io/biocontainers/dysgu/1.6.7--py38hbf64fdb_0
```
