...
updated_at: "2024-04-27 03:06:13.272969"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-bluster:1.12.0--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-bluster/1.12.0--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-bluster/1.12.0--r43hf17093f_0
```
