...
updated_at: "2026-02-23 04:49:21.474573"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cqn:1.56.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cqn/1.56.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-cqn/1.56.0--r45hdfd78af_0
```
