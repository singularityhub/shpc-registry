---
layout: container
name:  "quay.io/biocontainers/finaletoolkit"
maintainer: "@vsoch"
...
updated_at: "2026-09-04 07:24:22.652153"
...
```bash
$ module load quay.io/biocontainers/finaletoolkit/1.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/finaletoolkit/1.1.0--pyhdfd78af_0
```
...
#### finaletoolkit-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### finaletoolkit-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/finaletoolkit
$ podman run --it --rm --entrypoint /usr/local/bin/finaletoolkit   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/finaletoolkit   -v ${PWD} -w ${PWD} <container> -c " $@"
```
