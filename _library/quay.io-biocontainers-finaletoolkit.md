...
updated_at: "2026-07-28 05:41:45.035214"
...
```bash
$ shpc install quay.io/biocontainers/finaletoolkit:1.0.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/finaletoolkit/1.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/finaletoolkit/1.0.0--pyhdfd78af_0
```
