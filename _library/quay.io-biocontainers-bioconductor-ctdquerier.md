...
updated_at: "2022-10-29 05:30:47.492061"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ctdquerier:2.2.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ctdquerier/2.2.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ctdquerier/2.2.0--r41hdfd78af_0
```
