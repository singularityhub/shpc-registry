...
updated_at: "2025-02-18 03:00:27.190152"
...
```bash
$ shpc install quay.io/biocontainers/calisp:3.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/calisp/3.1--pyhdfd78af_0
$ module help quay.io/biocontainers/calisp/3.1--pyhdfd78af_0
```
