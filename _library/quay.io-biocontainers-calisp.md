...
updated_at: "2023-08-21 03:05:35.408590"
latest: "3.0.12--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/calisp:3.0.12--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/calisp/3.0.12--pyhdfd78af_0
$ module help quay.io/biocontainers/calisp/3.0.12--pyhdfd78af_0
```
