...
updated_at: "2024-08-20 03:19:26.677339"
...
```bash
$ shpc install quay.io/biocontainers/calisp:3.0.13--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/calisp/3.0.13--pyhdfd78af_0
$ module help quay.io/biocontainers/calisp/3.0.13--pyhdfd78af_0
```
