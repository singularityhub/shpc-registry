---
layout: container
name:  "quay.io/biocontainers/calisp"
maintainer: "@vsoch"
...
updated_at: "2023-06-21 03:04:24.918025"
latest: "3.0.11--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/calisp
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/calisp:3.0.11--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/calisp/3.0.11--pyhdfd78af_0
$ module help quay.io/biocontainers/calisp/3.0.11--pyhdfd78af_0
```
...
#### calisp-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### calisp-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/calisp
$ podman run --it --rm --entrypoint /usr/local/bin/calisp   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/calisp   -v ${PWD} -w ${PWD} <container> -c " $@"
```
