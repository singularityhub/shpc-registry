...
updated_at: "2024-11-28 03:14:15.686987"
...
```bash
$ shpc install quay.io/biocontainers/giatools:0.3.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/giatools/0.3.1--pyhdfd78af_0
$ module help quay.io/biocontainers/giatools/0.3.1--pyhdfd78af_0
```
