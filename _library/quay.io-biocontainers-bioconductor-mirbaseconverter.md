...
updated_at: "2025-12-05 03:46:22.225463"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mirbaseconverter:1.30.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mirbaseconverter/1.30.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-mirbaseconverter/1.30.0--r44hdfd78af_0
```
