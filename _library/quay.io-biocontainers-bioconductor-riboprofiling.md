...
updated_at: "2022-11-11 00:52:53.312690"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-riboprofiling:1.24.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-riboprofiling/1.24.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-riboprofiling/1.24.0--r41hdfd78af_0
```
