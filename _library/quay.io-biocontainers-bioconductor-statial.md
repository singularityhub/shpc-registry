...
updated_at: "2023-08-03 03:08:08.056957"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-statial:1.2.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-statial/1.2.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-statial/1.2.0--r43hdfd78af_0
```
