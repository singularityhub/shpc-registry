...
updated_at: "2025-02-04 02:56:19.721033"
latest: "3.0.10"
...
```bash
$ shpc install quay.io/biocontainers/cellpose:3.0.10
```
...
```bash
$ module load quay.io/biocontainers/cellpose/3.0.10
$ module help quay.io/biocontainers/cellpose/3.0.10
```
