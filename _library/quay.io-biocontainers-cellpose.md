...
updated_at: "2026-01-25 04:11:27.847251"
latest: "4.0.7"
...
```bash
$ shpc install quay.io/biocontainers/cellpose:4.0.7
```
...
```bash
$ module load quay.io/biocontainers/cellpose/4.0.7
$ module help quay.io/biocontainers/cellpose/4.0.7
```
