...
updated_at: "2025-08-17 03:38:42.613178"
latest: "3.1.0"
...
```bash
$ shpc install quay.io/biocontainers/cellpose:3.1.0
```
...
```bash
$ module load quay.io/biocontainers/cellpose/3.1.0
$ module help quay.io/biocontainers/cellpose/3.1.0
```
