---
layout: container
name:  "quay.io/biocontainers/cellpose"
maintainer: "@vsoch"
...
updated_at: "2026-02-02 12:19:01.008740"
latest: "4.0.8"
...
config: {"url": "https://biocontainers.pro/tools/cellpose", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for cellpose", "latest": {"4.0.8": "sha256:65ff39e191759b458733f3652edcc6f8678da4a2c00d5e5696fd6a911447740f"}, "tags": {"3.0.8": "sha256:4ab1d822dbb32848fd1bfbecf24580556938bfd8a9f37d9ef05bef7874cee92a", "3.0.10": "sha256:a74a4cb494bc733002dbab3a03d425d3e7aed650a2e4d9958671f87f0e1994c3", "3.1.0": "sha256:0467d7909d00e522402a2393479970e8da82b5ce1a5ee633de643821e728a64a", "3.0.11": "sha256:a658ad4029199d799a46e373f7641b5edbe5f418cce9316323ce70ef1290c06c", "4.0.7": "sha256:2d9d58d2b2bea5b5b429ae08376f4b17ee2344f339bfed2a023bdd962df18463", "4.0.8": "sha256:65ff39e191759b458733f3652edcc6f8678da4a2c00d5e5696fd6a911447740f"}, "docker": "quay.io/biocontainers/cellpose", "aliases": {"androiddeployqt6": "/usr/local/bin/androiddeployqt6", "asn1Coding": "/usr/local/bin/asn1Coding", "asn1Decoding": "/usr/local/bin/asn1Decoding", "asn1Parser": "/usr/local/bin/asn1Parser", "assistant6": "/usr/local/bin/assistant6", "cellpose": "/usr/local/bin/cellpose", "cllayerinfo": "/usr/local/bin/cllayerinfo", "designer6": "/usr/local/bin/designer6", "exr2aces": "/usr/local/bin/exr2aces", "exrenvmap": "/usr/local/bin/exrenvmap", "exrheader": "/usr/local/bin/exrheader", "exrinfo": "/usr/local/bin/exrinfo", "exrmakepreview": "/usr/local/bin/exrmakepreview", "exrmaketiled": "/usr/local/bin/exrmaketiled", "exrmultipart": "/usr/local/bin/exrmultipart", "exrmultiview": "/usr/local/bin/exrmultiview", "exrstdattr": "/usr/local/bin/exrstdattr", "ffmpeg": "/usr/local/bin/ffmpeg", "ffprobe": "/usr/local/bin/ffprobe", "gi-compile-repository": "/usr/local/bin/gi-compile-repository", "gi-decompile-typelib": "/usr/local/bin/gi-decompile-typelib", "gi-inspect-typelib": "/usr/local/bin/gi-inspect-typelib", "h264dec": "/usr/local/bin/h264dec", "h264enc": "/usr/local/bin/h264enc", "imgcmp": "/usr/local/bin/imgcmp", "imginfo": "/usr/local/bin/imginfo", "jasper": "/usr/local/bin/jasper", "jiv": "/usr/local/bin/jiv", "linguist6": "/usr/local/bin/linguist6", "opencv_annotation": "/usr/local/bin/opencv_annotation", "opencv_interactive-calibration": "/usr/local/bin/opencv_interactive-calibration", "opencv_model_diagnostics": "/usr/local/bin/opencv_model_diagnostics", "opencv_version": "/usr/local/bin/opencv_version", "opencv_visualisation": "/usr/local/bin/opencv_visualisation", "opencv_waldboost_detector": "/usr/local/bin/opencv_waldboost_detector", "p11-kit": "/usr/local/bin/p11-kit", "p11tool": "/usr/local/bin/p11tool", "pixeltool6": "/usr/local/bin/pixeltool6", "protoc-25.3.0": "/usr/local/bin/protoc-25.3.0", "qdbus6": "/usr/local/bin/qdbus6", "qdbusviewer6": "/usr/local/bin/qdbusviewer6", "qdistancefieldgenerator6": "/usr/local/bin/qdistancefieldgenerator6", "qdoc6": "/usr/local/bin/qdoc6", "qmake6": "/usr/local/bin/qmake6", "qml6": "/usr/local/bin/qml6", "qmleasing6": "/usr/local/bin/qmleasing6", "qmlls6": "/usr/local/bin/qmlls6", "qmlpreview6": "/usr/local/bin/qmlpreview6", "qmlscene6": "/usr/local/bin/qmlscene6", "qt6.conf": "/usr/local/bin/qt6.conf", "qtdiag6": "/usr/local/bin/qtdiag6", "qtplugininfo6": "/usr/local/bin/qtplugininfo6", "qtpy": "/usr/local/bin/qtpy", "rav1e": "/usr/local/bin/rav1e", "roifile": "/usr/local/bin/roifile", "setup_vars_opencv4.sh": "/usr/local/bin/setup_vars_opencv4.sh", "torch_shm_manager": "/usr/local/bin/torch_shm_manager", "trust": "/usr/local/bin/trust", "vpxdec": "/usr/local/bin/vpxdec", "vpxenc": "/usr/local/bin/vpxenc", "x264": "/usr/local/bin/x264", "x265": "/usr/local/bin/x265", "SvtAv1DecApp": "/usr/local/bin/SvtAv1DecApp", "SvtAv1EncApp": "/usr/local/bin/SvtAv1EncApp", "dav1d": "/usr/local/bin/dav1d", "tiff2fsspec": "/usr/local/bin/tiff2fsspec", "aomdec": "/usr/local/bin/aomdec", "aomenc": "/usr/local/bin/aomenc", "dask": "/usr/local/bin/dask", "tiffcomment": "/usr/local/bin/tiffcomment", "JxrDecApp": "/usr/local/bin/JxrDecApp", "JxrEncApp": "/usr/local/bin/JxrEncApp", "cbrunsli": "/usr/local/bin/cbrunsli", "dbrunsli": "/usr/local/bin/dbrunsli", "imagecodecs": "/usr/local/bin/imagecodecs", "lsm2bin": "/usr/local/bin/lsm2bin", "tifffile": "/usr/local/bin/tifffile", "zfp": "/usr/local/bin/zfp", "zopfli": "/usr/local/bin/zopfli", "zopflipng": "/usr/local/bin/zopflipng", "imageio_download_bin": "/usr/local/bin/imageio_download_bin", "imageio_remove_bin": "/usr/local/bin/imageio_remove_bin", "skivi": "/usr/local/bin/skivi", "h5tools_test_utils": "/usr/local/bin/h5tools_test_utils", "mpg123": "/usr/local/bin/mpg123", "mpg123-id3dump": "/usr/local/bin/mpg123-id3dump", "mpg123-strip": "/usr/local/bin/mpg123-strip"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/cellpose.
singularity registry hpc automated addition for cellpose
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/cellpose
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/cellpose:4.0.8
```
...
```bash
$ module load quay.io/biocontainers/cellpose/4.0.8
$ module help quay.io/biocontainers/cellpose/4.0.8
```
...
#### cellpose-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### cellpose-inspect-deffile:
