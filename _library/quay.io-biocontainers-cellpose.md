...
updated_at: "2024-06-17 03:18:27.035510"
latest: "3.0.8"
...
```bash
$ shpc install quay.io/biocontainers/cellpose:3.0.8
```
...
```bash
$ module load quay.io/biocontainers/cellpose/3.0.8
$ module help quay.io/biocontainers/cellpose/3.0.8
```
