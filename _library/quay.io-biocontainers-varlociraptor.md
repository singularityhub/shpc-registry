...
updated_at: "2025-03-12 05:03:54.772708"
latest: "8.6.1--ha8ac579_0"
...
```bash
$ shpc install quay.io/biocontainers/varlociraptor:8.6.1--ha8ac579_0
```
...
```bash
$ module load quay.io/biocontainers/varlociraptor/8.6.1--ha8ac579_0
$ module help quay.io/biocontainers/varlociraptor/8.6.1--ha8ac579_0
```
