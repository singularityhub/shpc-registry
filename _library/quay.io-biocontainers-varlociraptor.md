...
updated_at: "2025-10-24 03:18:05.022832"
latest: "8.8.1--ha8ac579_0"
...
```bash
$ shpc install quay.io/biocontainers/varlociraptor:8.8.1--ha8ac579_0
```
...
```bash
$ module load quay.io/biocontainers/varlociraptor/8.8.1--ha8ac579_0
$ module help quay.io/biocontainers/varlociraptor/8.8.1--ha8ac579_0
```
