...
updated_at: "2025-01-14 03:14:59.068472"
latest: "8.5.1--ha8ac579_0"
...
```bash
$ shpc install quay.io/biocontainers/varlociraptor:8.5.1--ha8ac579_0
```
...
```bash
$ module load quay.io/biocontainers/varlociraptor/8.5.1--ha8ac579_0
$ module help quay.io/biocontainers/varlociraptor/8.5.1--ha8ac579_0
```
