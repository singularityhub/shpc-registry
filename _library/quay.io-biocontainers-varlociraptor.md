...
updated_at: "2025-01-21 03:16:49.921071"
latest: "8.6.0--ha8ac579_0"
...
```bash
$ shpc install quay.io/biocontainers/varlociraptor:8.6.0--ha8ac579_0
```
...
```bash
$ module load quay.io/biocontainers/varlociraptor/8.6.0--ha8ac579_0
$ module help quay.io/biocontainers/varlociraptor/8.6.0--ha8ac579_0
```
