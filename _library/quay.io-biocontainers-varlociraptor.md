...
updated_at: "2026-01-21 04:04:23.970730"
latest: "8.9.3--ha8ac579_0"
...
```bash
$ shpc install quay.io/biocontainers/varlociraptor:8.9.3--ha8ac579_0
```
...
```bash
$ module load quay.io/biocontainers/varlociraptor/8.9.3--ha8ac579_0
$ module help quay.io/biocontainers/varlociraptor/8.9.3--ha8ac579_0
```
