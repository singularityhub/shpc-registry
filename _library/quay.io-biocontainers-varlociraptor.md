...
updated_at: "2025-12-04 03:39:48.461697"
latest: "8.9.0--ha8ac579_0"
...
```bash
$ shpc install quay.io/biocontainers/varlociraptor:8.9.0--ha8ac579_0
```
...
```bash
$ module load quay.io/biocontainers/varlociraptor/8.9.0--ha8ac579_0
$ module help quay.io/biocontainers/varlociraptor/8.9.0--ha8ac579_0
```
