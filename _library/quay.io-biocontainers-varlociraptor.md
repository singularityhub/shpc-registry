...
updated_at: "2025-06-23 03:55:06.548246"
latest: "8.7.3--ha8ac579_0"
...
```bash
$ shpc install quay.io/biocontainers/varlociraptor:8.7.3--ha8ac579_0
```
...
```bash
$ module load quay.io/biocontainers/varlociraptor/8.7.3--ha8ac579_0
$ module help quay.io/biocontainers/varlociraptor/8.7.3--ha8ac579_0
```
