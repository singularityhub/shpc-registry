...
updated_at: "2025-05-27 03:19:45.107204"
latest: "8.7.1--ha8ac579_0"
...
```bash
$ shpc install quay.io/biocontainers/varlociraptor:8.7.1--ha8ac579_0
```
...
```bash
$ module load quay.io/biocontainers/varlociraptor/8.7.1--ha8ac579_0
$ module help quay.io/biocontainers/varlociraptor/8.7.1--ha8ac579_0
```
