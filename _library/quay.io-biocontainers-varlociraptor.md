...
updated_at: "2025-12-19 05:16:15.147503"
latest: "8.9.1--ha8ac579_0"
...
```bash
$ shpc install quay.io/biocontainers/varlociraptor:8.9.1--ha8ac579_0
```
...
```bash
$ module load quay.io/biocontainers/varlociraptor/8.9.1--ha8ac579_0
$ module help quay.io/biocontainers/varlociraptor/8.9.1--ha8ac579_0
```
