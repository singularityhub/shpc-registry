...
updated_at: "2026-07-30 06:10:05.468050"
...
```bash
$ shpc install quay.io/biocontainers/lrzip:0.651--hd53768a_2
```
...
```bash
$ module load quay.io/biocontainers/lrzip/0.651--hd53768a_2
$ module help quay.io/biocontainers/lrzip/0.651--hd53768a_2
```
