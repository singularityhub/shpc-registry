...
updated_at: "2022-12-05 04:01:44.717967"
...
```bash
$ shpc install quay.io/biocontainers/ciriquant:1.1.2--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/ciriquant/1.1.2--pyhdfd78af_1
$ module help quay.io/biocontainers/ciriquant/1.1.2--pyhdfd78af_1
```
