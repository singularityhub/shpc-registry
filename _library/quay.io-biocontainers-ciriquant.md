...
updated_at: "2025-09-04 03:45:32.272483"
...
```bash
$ shpc install quay.io/biocontainers/ciriquant:1.1.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ciriquant/1.1.3--pyhdfd78af_0
$ module help quay.io/biocontainers/ciriquant/1.1.3--pyhdfd78af_0
```
