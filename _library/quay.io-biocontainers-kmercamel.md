...
updated_at: "2026-08-29 08:59:17.476332"
latest: "2.3.1--h9ecd042_0"
...
```bash
$ shpc install quay.io/biocontainers/kmercamel:2.3.1--h9ecd042_0
```
...
```bash
$ module load quay.io/biocontainers/kmercamel/2.3.1--h9ecd042_0
$ module help quay.io/biocontainers/kmercamel/2.3.1--h9ecd042_0
```
