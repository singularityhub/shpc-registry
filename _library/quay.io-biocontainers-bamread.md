...
updated_at: "2025-05-26 04:05:15.471490"
latest: "0.0.18--py310h1fe012e_0"
...
```bash
$ shpc install quay.io/biocontainers/bamread:0.0.18--py310h1fe012e_0
```
...
```bash
$ module load quay.io/biocontainers/bamread/0.0.18--py310h1fe012e_0
$ module help quay.io/biocontainers/bamread/0.0.18--py310h1fe012e_0
```
