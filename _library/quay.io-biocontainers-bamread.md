...
updated_at: "2022-10-27 01:09:44.747410"
...
```bash
$ shpc install quay.io/biocontainers/bamread:0.0.9--py37h8902056_1
```
...
```bash
$ module load quay.io/biocontainers/bamread/0.0.9--py37h8902056_1
$ module help quay.io/biocontainers/bamread/0.0.9--py37h8902056_1
```
