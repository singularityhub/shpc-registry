...
updated_at: "2023-09-18 02:56:01.855210"
latest: "0.0.16--py39hbf8eff0_0"
...
```bash
$ shpc install quay.io/biocontainers/bamread:0.0.16--py39hbf8eff0_0
```
...
```bash
$ module load quay.io/biocontainers/bamread/0.0.16--py39hbf8eff0_0
$ module help quay.io/biocontainers/bamread/0.0.16--py39hbf8eff0_0
```
