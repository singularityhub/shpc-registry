...
updated_at: "2026-03-25 04:53:03.631173"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hgu95eprobe:2.18.0--r45hdfd78af_14
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hgu95eprobe/2.18.0--r45hdfd78af_14
$ module help quay.io/biocontainers/bioconductor-hgu95eprobe/2.18.0--r45hdfd78af_14
```
