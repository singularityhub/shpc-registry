...
updated_at: "2025-08-07 04:24:41.244452"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hgu95eprobe:2.18.0--r44hdfd78af_13
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hgu95eprobe/2.18.0--r44hdfd78af_13
$ module help quay.io/biocontainers/bioconductor-hgu95eprobe/2.18.0--r44hdfd78af_13
```
