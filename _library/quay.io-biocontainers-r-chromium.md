---
layout: container
name:  "quay.io/biocontainers/r-chromium"
maintainer: "@vsoch"
...
updated_at: "2023-05-19 03:15:49.853742"
latest: "0.2.1--r42hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/r-chromium
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/r-chromium:0.2.1--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/r-chromium/0.2.1--r42hdfd78af_0
$ module help quay.io/biocontainers/r-chromium/0.2.1--r42hdfd78af_0
```
...
#### r-chromium-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-chromium-inspect-deffile:
