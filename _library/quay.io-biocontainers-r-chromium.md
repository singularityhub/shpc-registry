...
updated_at: "2024-07-14 03:04:09.395199"
latest: "0.3.0--r43hdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/r-chromium:0.3.0--r43hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/r-chromium/0.3.0--r43hdfd78af_1
$ module help quay.io/biocontainers/r-chromium/0.3.0--r43hdfd78af_1
```
