...
updated_at: "2022-10-29 05:58:02.615451"
latest: "0.0.15--r41h73dbb54_0"
...
```bash
$ shpc install quay.io/biocontainers/r-restfulr:0.0.15--r41h73dbb54_0
```
...
```bash
$ module load quay.io/biocontainers/r-restfulr/0.0.15--r41h73dbb54_0
$ module help quay.io/biocontainers/r-restfulr/0.0.15--r41h73dbb54_0
```
