...
updated_at: "2026-07-02 06:26:10.891538"
latest: "0.0.17--r45hcdf289b_0"
...
```bash
$ shpc install quay.io/biocontainers/r-restfulr:0.0.17--r45hcdf289b_0
```
...
```bash
$ module load quay.io/biocontainers/r-restfulr/0.0.17--r45hcdf289b_0
$ module help quay.io/biocontainers/r-restfulr/0.0.17--r45hcdf289b_0
```
