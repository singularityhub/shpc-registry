...
updated_at: "2026-03-03 04:48:37.157713"
latest: "0.0.16--r45hf7ecca6_1"
...
```bash
$ shpc install quay.io/biocontainers/r-restfulr:0.0.16--r45hf7ecca6_1
```
...
```bash
$ module load quay.io/biocontainers/r-restfulr/0.0.16--r45hf7ecca6_1
$ module help quay.io/biocontainers/r-restfulr/0.0.16--r45hf7ecca6_1
```
