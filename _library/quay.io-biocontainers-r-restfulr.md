...
updated_at: "2025-05-27 11:19:20.183502"
latest: "0.0.15--r44h5ef9028_6"
...
```bash
$ shpc install quay.io/biocontainers/r-restfulr:0.0.15--r44h5ef9028_6
```
...
```bash
$ module load quay.io/biocontainers/r-restfulr/0.0.15--r44h5ef9028_6
$ module help quay.io/biocontainers/r-restfulr/0.0.15--r44h5ef9028_6
```
