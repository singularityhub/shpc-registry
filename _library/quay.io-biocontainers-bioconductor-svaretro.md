...
updated_at: "2023-08-07 03:10:34.595470"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-svaretro:1.6.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-svaretro/1.6.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-svaretro/1.6.0--r43hdfd78af_0
```
