...
updated_at: "2026-03-29 05:31:17.329065"
...
```bash
$ shpc install quay.io/biocontainers/diting:2.0.1--pyh106432d_1
```
...
```bash
$ module load quay.io/biocontainers/diting/2.0.1--pyh106432d_1
$ module help quay.io/biocontainers/diting/2.0.1--pyh106432d_1
```
