...
updated_at: "2026-03-28 17:18:06.836997"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-experimenthub:3.0.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-experimenthub/3.0.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-experimenthub/3.0.0--r45hdfd78af_0
```
