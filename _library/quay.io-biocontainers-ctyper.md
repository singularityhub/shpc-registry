---
layout: container
name:  "quay.io/biocontainers/ctyper"
maintainer: "@vsoch"
...
updated_at: "2025-05-24 03:37:48.773365"
...
```bash
$ shpc install quay.io/biocontainers/ctyper
```
...
#### ctyper-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### ctyper-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/ctyper
$ podman run --it --rm --entrypoint /usr/local/bin/ctyper   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/ctyper   -v ${PWD} -w ${PWD} <container> -c " $@"
```
