...
updated_at: "2023-12-15 02:40:48.728171"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-msstatsqc:2.18.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-msstatsqc/2.18.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-msstatsqc/2.18.0--r43hdfd78af_0
```
