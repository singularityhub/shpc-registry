...
updated_at: "2026-04-02 04:39:30.150160"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-msstatsqc:2.28.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-msstatsqc/2.28.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-msstatsqc/2.28.0--r45hdfd78af_0
```
