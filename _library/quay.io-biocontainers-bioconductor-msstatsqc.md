...
updated_at: "2025-12-01 05:10:46.512033"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-msstatsqc:2.24.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-msstatsqc/2.24.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-msstatsqc/2.24.0--r44hdfd78af_0
```
