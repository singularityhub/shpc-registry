...
updated_at: "2025-06-03 03:28:10.810778"
latest: "0.16--h577a1d6_0"
...
```bash
$ shpc install quay.io/biocontainers/miniprot:0.16--h577a1d6_0
```
...
```bash
$ module load quay.io/biocontainers/miniprot/0.16--h577a1d6_0
$ module help quay.io/biocontainers/miniprot/0.16--h577a1d6_0
```
