...
updated_at: "2025-02-01 03:26:32.812570"
latest: "0.13--h577a1d6_2"
...
```bash
$ shpc install quay.io/biocontainers/miniprot:0.13--h577a1d6_2
```
...
```bash
$ module load quay.io/biocontainers/miniprot/0.13--h577a1d6_2
$ module help quay.io/biocontainers/miniprot/0.13--h577a1d6_2
```
