...
updated_at: "2026-04-01 05:28:35.767778"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-circrnaprofiler:1.24.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-circrnaprofiler/1.24.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-circrnaprofiler/1.24.0--r45hdfd78af_0
```
