...
updated_at: "2022-11-16 00:17:25.627958"
latest: "3.13.0--r41hdfd78af_2"
container_url: "https://biocontainers.pro/tools/bioconductor-txdb.hsapiens.ucsc.hg38.refgene"
aliases:
 - ".bioconductor-txdb.hsapiens.ucsc.hg38.refgene-post-link.sh"
 - ".bioconductor-txdb.hsapiens.ucsc.hg38.refgene-pre-unlink.sh"
versions:
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-txdb.hsapiens.ucsc.hg38.refgene-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-txdb.hsapiens.ucsc.hg38.refgene-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-txdb.hsapiens.ucsc.hg38.refgene-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-txdb.hsapiens.ucsc.hg38.refgene-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-txdb.hsapiens.ucsc.hg38.refgene-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-txdb.hsapiens.ucsc.hg38.refgene-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
