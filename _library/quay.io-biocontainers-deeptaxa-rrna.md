---
layout: container
name:  "quay.io/biocontainers/deeptaxa-rrna"
maintainer: "@vsoch"
...
updated_at: "2026-06-26 06:52:56.854702"
...
singularity registry hpc automated addition for deeptaxa-rrna
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/deeptaxa-rrna
```
...
#### deeptaxa-rrna-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### deeptaxa-rrna-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/deeptaxa
$ podman run --it --rm --entrypoint /usr/local/bin/deeptaxa   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/deeptaxa   -v ${PWD} -w ${PWD} <container> -c " $@"
```
