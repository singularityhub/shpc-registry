...
updated_at: "2025-01-07 03:34:57.945840"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-covrna:1.28.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-covrna/1.28.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-covrna/1.28.0--r43hdfd78af_0
```
