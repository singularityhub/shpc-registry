...
updated_at: "2022-11-09 00:00:04.738739"
...
```bash
$ shpc install quay.io/biocontainers/galaxyxml:0.4.9--pyh864c0ab_1
```
...
```bash
$ module load quay.io/biocontainers/galaxyxml/0.4.9--pyh864c0ab_1
$ module help quay.io/biocontainers/galaxyxml/0.4.9--pyh864c0ab_1
```
