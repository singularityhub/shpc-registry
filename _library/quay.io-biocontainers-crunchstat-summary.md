...
updated_at: "2026-03-26 05:26:55.603679"
...
```bash
$ shpc install quay.io/biocontainers/crunchstat-summary:3.2.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/crunchstat-summary/3.2.1--pyhdfd78af_0
$ module help quay.io/biocontainers/crunchstat-summary/3.2.1--pyhdfd78af_0
```
