...
updated_at: "2026-07-01 15:13:19.481461"
...
```bash
$ shpc install quay.io/biocontainers/pgscatalog.core:1.1.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pgscatalog.core/1.1.1--pyhdfd78af_0
$ module help quay.io/biocontainers/pgscatalog.core/1.1.1--pyhdfd78af_0
```
