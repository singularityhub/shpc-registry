...
updated_at: "2026-02-01 04:53:28.402144"
...
```bash
$ shpc install quay.io/biocontainers/pgscatalog.core:1.0.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pgscatalog.core/1.0.2--pyhdfd78af_0
$ module help quay.io/biocontainers/pgscatalog.core/1.0.2--pyhdfd78af_0
```
