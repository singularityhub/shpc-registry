...
updated_at: "2024-10-05 03:31:50.166463"
...
```bash
$ shpc install quay.io/biocontainers/pgscatalog.core:0.2.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pgscatalog.core/0.2.1--pyhdfd78af_0
$ module help quay.io/biocontainers/pgscatalog.core/0.2.1--pyhdfd78af_0
```
