...
updated_at: "2022-11-20 00:57:01.298501"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ecoli2.db:3.13.0--r41hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ecoli2.db/3.13.0--r41hdfd78af_1
$ module help quay.io/biocontainers/bioconductor-ecoli2.db/3.13.0--r41hdfd78af_1
```
