...
updated_at: "2024-09-16 03:44:29.291854"
latest: "0.5.2--h715e4b3_0"
...
```bash
$ shpc install quay.io/biocontainers/bigtools:0.5.2--h715e4b3_0
```
...
```bash
$ module load quay.io/biocontainers/bigtools/0.5.2--h715e4b3_0
$ module help quay.io/biocontainers/bigtools/0.5.2--h715e4b3_0
```
