...
updated_at: "2024-11-14 03:08:52.754724"
latest: "0.5.3--h715e4b3_0"
...
```bash
$ shpc install quay.io/biocontainers/bigtools:0.5.3--h715e4b3_0
```
...
```bash
$ module load quay.io/biocontainers/bigtools/0.5.3--h715e4b3_0
$ module help quay.io/biocontainers/bigtools/0.5.3--h715e4b3_0
```
