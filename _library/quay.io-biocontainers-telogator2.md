---
layout: container
name:  "quay.io/biocontainers/telogator2"
maintainer: "@vsoch"
...
updated_at: "2025-12-22 04:18:04.318029"
...
singularity registry hpc automated addition for telogator2
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/telogator2
```
...
#### telogator2-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### telogator2-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/telogator2
$ podman run --it --rm --entrypoint /usr/local/bin/telogator2   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/telogator2   -v ${PWD} -w ${PWD} <container> -c " $@"
```
