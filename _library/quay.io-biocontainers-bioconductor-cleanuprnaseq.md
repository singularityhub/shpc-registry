---
layout: container
name:  "quay.io/biocontainers/bioconductor-cleanuprnaseq"
maintainer: "@vsoch"
github: "https://github.com/singularityhub/shpc-registry/blob/main/quay.io/biocontainers/bioconductor-cleanuprnaseq/container.yaml"
config_url: "https://raw.githubusercontent.com/singularityhub/shpc-registry/main/quay.io/biocontainers/bioconductor-cleanuprnaseq/container.yaml"
updated_at: "2025-12-16 03:59:02.303739"
latest: "1.0.0--r44hdfd78af_0"
container_url: "https://biocontainers.pro/tools/bioconductor-cleanuprnaseq"
aliases:
 - "pandoc-lua"
...
versions:
 - "1.0.0--r44hdfd78af_0"
description: "singularity registry hpc automated addition for bioconductor-cleanuprnaseq"
config: {"url": "https://biocontainers.pro/tools/bioconductor-cleanuprnaseq", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for bioconductor-cleanuprnaseq", "latest": {"1.0.0--r44hdfd78af_0": "sha256:617ca523bf787b93775ccb7a6bd45090097892ca565cc8512d34d9300d4dd098"}, "tags": {"1.0.0--r44hdfd78af_0": "sha256:617ca523bf787b93775ccb7a6bd45090097892ca565cc8512d34d9300d4dd098"}, "docker": "quay.io/biocontainers/bioconductor-cleanuprnaseq", "aliases": {"pandoc-lua": "/usr/local/bin/pandoc-lua", "x86_64-conda-linux-gnu.cfg": "/usr/local/bin/x86_64-conda-linux-gnu.cfg", "idle3.13": "/usr/local/bin/idle3.13", "pydoc3.13": "/usr/local/bin/pydoc3.13", "python3.13": "/usr/local/bin/python3.13", "python3.13-config": "/usr/local/bin/python3.13-config", "pandoc-server": "/usr/local/bin/pandoc-server", "installBiocDataPackage.sh": "/usr/local/bin/installBiocDataPackage.sh", "tomlq": "/usr/local/bin/tomlq", "xq": "/usr/local/bin/xq", "yq": "/usr/local/bin/yq", "jq": "/usr/local/bin/jq", "onig-config": "/usr/local/bin/onig-config", "pandoc": "/usr/local/bin/pandoc", "hb-info": "/usr/local/bin/hb-info", "activate-global-python-argcomplete": "/usr/local/bin/activate-global-python-argcomplete", "python-argcomplete-check-easy-install-script": "/usr/local/bin/python-argcomplete-check-easy-install-script", "register-python-argcomplete": "/usr/local/bin/register-python-argcomplete", "tjbench": "/usr/local/bin/tjbench"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/bioconductor-cleanuprnaseq.
singularity registry hpc automated addition for bioconductor-cleanuprnaseq
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/bioconductor-cleanuprnaseq
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-cleanuprnaseq:1.0.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cleanuprnaseq/1.0.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-cleanuprnaseq/1.0.0--r44hdfd78af_0
```
...
#### bioconductor-cleanuprnaseq-run:
...
#### bioconductor-cleanuprnaseq-shell:
...
#### bioconductor-cleanuprnaseq-exec:
...
#### bioconductor-cleanuprnaseq-inspect:
...
#### bioconductor-cleanuprnaseq-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-cleanuprnaseq-inspect-deffile:
