...
updated_at: "2023-11-02 03:36:50.902769"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-topconfects:1.16.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-topconfects/1.16.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-topconfects/1.16.0--r43hdfd78af_0
```
