...
updated_at: "2022-10-27 00:19:55.793841"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-assessorfdata:1.8.0--r40hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-assessorfdata/1.8.0--r40hdfd78af_1
$ module help quay.io/biocontainers/bioconductor-assessorfdata/1.8.0--r40hdfd78af_1
```
