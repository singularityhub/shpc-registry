...
updated_at: "2026-03-20 00:44:16.380524"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-assessorfdata:1.28.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-assessorfdata/1.28.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-assessorfdata/1.28.0--r45hdfd78af_0
```
