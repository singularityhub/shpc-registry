---
layout: container
name:  "quay.io/biocontainers/nuclease"
maintainer: "@vsoch"
...
updated_at: "2026-08-22 03:34:30.842279"
...
singularity registry hpc automated addition for nuclease
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/nuclease
```
...
#### nuclease-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### nuclease-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/nuclease
$ podman run --it --rm --entrypoint /usr/local/bin/nuclease   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/nuclease   -v ${PWD} -w ${PWD} <container> -c " $@"
```
