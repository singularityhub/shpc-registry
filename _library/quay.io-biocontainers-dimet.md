...
updated_at: "2024-03-27 02:48:06.061305"
...
```bash
$ shpc install quay.io/biocontainers/dimet:0.2.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/dimet/0.2.2--pyhdfd78af_0
$ module help quay.io/biocontainers/dimet/0.2.2--pyhdfd78af_0
```
