...
updated_at: "2024-03-07 00:11:50.400138"
...
```bash
$ shpc install quay.io/biocontainers/dimet:0.2.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/dimet/0.2.1--pyhdfd78af_0
$ module help quay.io/biocontainers/dimet/0.2.1--pyhdfd78af_0
```
