...
updated_at: "2023-08-23 03:00:22.756485"
...
```bash
$ shpc install quay.io/biocontainers/dimet:0.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/dimet/0.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/dimet/0.1.0--pyhdfd78af_0
```
