---
layout: container
name:  "quay.io/biocontainers/hmftools-sigs"
maintainer: "@vsoch"
...
updated_at: "2023-03-29 03:34:52.304246"
...
```bash
$ shpc install quay.io/biocontainers/hmftools-sigs
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/hmftools-sigs:1.1--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hmftools-sigs/1.1--hdfd78af_0
$ module help quay.io/biocontainers/hmftools-sigs/1.1--hdfd78af_0
```
...
#### hmftools-sigs-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### hmftools-sigs-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/sigs
$ podman run --it --rm --entrypoint /usr/local/bin/sigs   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/sigs   -v ${PWD} -w ${PWD} <container> -c " $@"
```
