---
layout: container
name:  "quay.io/biocontainers/reactome-cli"
maintainer: "@vsoch"
...
updated_at: "2025-09-07 03:15:38.942070"
...
singularity registry hpc automated addition for reactome-cli
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/reactome-cli
```
...
#### reactome-cli-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### reactome-cli-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/reactome
$ podman run --it --rm --entrypoint /usr/local/bin/reactome   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/reactome   -v ${PWD} -w ${PWD} <container> -c " $@"
```
