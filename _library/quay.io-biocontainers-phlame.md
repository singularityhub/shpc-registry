---
layout: container
name:  "quay.io/biocontainers/phlame"
maintainer: "@vsoch"
...
updated_at: "2025-08-03 04:12:42.269410"
...
singularity registry hpc automated addition for phlame
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/phlame
```
...
#### phlame-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### phlame-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/phlame
$ podman run --it --rm --entrypoint /usr/local/bin/phlame   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/phlame   -v ${PWD} -w ${PWD} <container> -c " $@"
```
