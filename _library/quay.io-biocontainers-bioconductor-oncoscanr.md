...
updated_at: "2025-09-14 03:27:04.976198"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-oncoscanr:1.8.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-oncoscanr/1.8.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-oncoscanr/1.8.0--r44hdfd78af_0
```
