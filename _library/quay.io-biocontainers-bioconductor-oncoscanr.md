...
updated_at: "2026-03-15 05:10:22.980844"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-oncoscanr:1.12.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-oncoscanr/1.12.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-oncoscanr/1.12.0--r45hdfd78af_0
```
