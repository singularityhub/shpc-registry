...
updated_at: "2023-04-28 02:58:35.213974"
...
```bash
$ shpc install quay.io/biocontainers/ngsderive:3.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ngsderive/3.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/ngsderive/3.1.0--pyhdfd78af_0
```
