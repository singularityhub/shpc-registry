...
updated_at: "2024-01-01 02:57:46.184727"
...
```bash
$ shpc install quay.io/biocontainers/ngsderive:3.3.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ngsderive/3.3.2--pyhdfd78af_0
$ module help quay.io/biocontainers/ngsderive/3.3.2--pyhdfd78af_0
```
