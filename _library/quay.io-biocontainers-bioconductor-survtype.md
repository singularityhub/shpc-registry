...
updated_at: "2025-07-29 04:01:26.087020"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-survtype:1.22.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-survtype/1.22.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-survtype/1.22.0--r44hdfd78af_0
```
