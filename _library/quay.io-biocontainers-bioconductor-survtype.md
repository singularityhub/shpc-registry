...
updated_at: "2026-03-25 04:49:16.965939"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-survtype:1.26.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-survtype/1.26.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-survtype/1.26.0--r45hdfd78af_0
```
