...
updated_at: "2026-04-05 05:30:49.806818"
latest: "4-alpine3.23"
...
```bash
$ shpc install ruby:4-alpine3.23
```
...
```bash
$ module load ruby/4-alpine3.23
$ module help ruby/4-alpine3.23
```
