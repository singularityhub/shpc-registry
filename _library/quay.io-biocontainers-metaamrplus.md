...
updated_at: "2026-09-02 06:57:53.822917"
latest: "1.5.2--py314hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/metaamrplus:1.5.2--py314hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/metaamrplus/1.5.2--py314hdfd78af_0
$ module help quay.io/biocontainers/metaamrplus/1.5.2--py314hdfd78af_0
```
