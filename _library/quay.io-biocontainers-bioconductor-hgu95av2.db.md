...
updated_at: "2024-05-02 02:50:07.859786"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hgu95av2.db:3.13.0--r43hdfd78af_4
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hgu95av2.db/3.13.0--r43hdfd78af_4
$ module help quay.io/biocontainers/bioconductor-hgu95av2.db/3.13.0--r43hdfd78af_4
```
