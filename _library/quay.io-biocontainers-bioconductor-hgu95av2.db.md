...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hgu95av2.db:3.2.3--r40hdfd78af_9
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hgu95av2.db/3.2.3--r40hdfd78af_9
$ module help quay.io/biocontainers/bioconductor-hgu95av2.db/3.2.3--r40hdfd78af_9
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-hgu95av2.db-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-hgu95av2.db-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-hgu95av2.db-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-hgu95av2.db-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-hgu95av2.db-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-hgu95av2.db-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
