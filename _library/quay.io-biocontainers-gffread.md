...
updated_at: "2026-04-30 08:20:04.307496"
...
```bash
$ shpc install quay.io/biocontainers/gffread:0.12.9--hf426362_0
```
...
```bash
$ module load quay.io/biocontainers/gffread/0.12.9--hf426362_0
$ module help quay.io/biocontainers/gffread/0.12.9--hf426362_0
```
