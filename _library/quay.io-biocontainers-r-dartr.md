...
updated_at: "2022-11-02 19:00:50.764809"
latest: "2.0.4--r41h3121a25_0"
...
```bash
$ shpc install quay.io/biocontainers/r-dartr:2.0.4--r41h3121a25_0
```
...
```bash
$ module load quay.io/biocontainers/r-dartr/2.0.4--r41h3121a25_0
$ module help quay.io/biocontainers/r-dartr/2.0.4--r41h3121a25_0
```
