...
updated_at: "2025-12-30 04:11:50.668368"
latest: "2.9.9.5--r44heae9e1c_0"
...
```bash
$ shpc install quay.io/biocontainers/r-dartr:2.9.9.5--r44heae9e1c_0
```
...
```bash
$ module load quay.io/biocontainers/r-dartr/2.9.9.5--r44heae9e1c_0
$ module help quay.io/biocontainers/r-dartr/2.9.9.5--r44heae9e1c_0
```
