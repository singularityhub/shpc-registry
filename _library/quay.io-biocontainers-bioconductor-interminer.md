...
updated_at: "2025-01-27 07:15:10.949319"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-interminer:1.24.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-interminer/1.24.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-interminer/1.24.0--r43hdfd78af_0
```
