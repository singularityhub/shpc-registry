...
updated_at: "2023-11-07 03:16:14.138865"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-interminer:1.22.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-interminer/1.22.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-interminer/1.22.0--r43hdfd78af_0
```
