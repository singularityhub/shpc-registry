...
updated_at: "2026-09-23 08:03:01.656705"
...
```bash
$ shpc install quay.io/biocontainers/tracs:1.1.4--py312h0c6b66a_0
```
...
```bash
$ module load quay.io/biocontainers/tracs/1.1.4--py312h0c6b66a_0
$ module help quay.io/biocontainers/tracs/1.1.4--py312h0c6b66a_0
```
