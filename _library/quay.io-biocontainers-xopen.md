---
layout: container
name:  "quay.io/biocontainers/xopen"
maintainer: "@vsoch"
...
updated_at: "2023-12-05 03:15:09.999642"
latest: "0.7.3--py_0"
...
```bash
$ shpc install quay.io/biocontainers/xopen
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/xopen:0.7.3--py_0
```
...
```bash
$ module load quay.io/biocontainers/xopen/0.7.3--py_0
$ module help quay.io/biocontainers/xopen/0.7.3--py_0
```
...
#### xopen-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### xopen-inspect-deffile:
