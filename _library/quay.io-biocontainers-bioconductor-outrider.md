...
updated_at: "2023-12-09 02:58:35.151797"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-outrider:1.18.1--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-outrider/1.18.1--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-outrider/1.18.1--r43hf17093f_0
```
