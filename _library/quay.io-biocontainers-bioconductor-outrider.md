...
updated_at: "2024-01-01 02:44:55.590505"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-outrider:1.20.0--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-outrider/1.20.0--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-outrider/1.20.0--r43hf17093f_0
```
