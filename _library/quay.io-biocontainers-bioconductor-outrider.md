...
updated_at: "2024-08-03 02:53:01.878579"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-outrider:1.20.1--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-outrider/1.20.1--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-outrider/1.20.1--r43hf17093f_0
```
