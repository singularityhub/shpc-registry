---
layout: container
name:  "quay.io/biocontainers/hmftools-gene-utils"
maintainer: "@vsoch"
...
updated_at: "2025-09-07 03:06:35.420539"
...
singularity registry hpc automated addition for hmftools-gene-utils
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/hmftools-gene-utils
```
...
#### hmftools-gene-utils-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### hmftools-gene-utils-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/gene-utils
$ podman run --it --rm --entrypoint /usr/local/bin/gene-utils   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/gene-utils   -v ${PWD} -w ${PWD} <container> -c " $@"
```
