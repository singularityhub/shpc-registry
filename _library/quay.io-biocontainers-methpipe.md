...
updated_at: "2025-09-16 03:28:46.292604"
...
```bash
$ shpc install quay.io/biocontainers/methpipe:5.0.1--h76b9af2_6
```
...
```bash
$ module load quay.io/biocontainers/methpipe/5.0.1--h76b9af2_6
$ module help quay.io/biocontainers/methpipe/5.0.1--h76b9af2_6
```
