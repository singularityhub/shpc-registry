---
layout: container
name:  "quay.io/biocontainers/primers"
maintainer: "@vsoch"
...
updated_at: "2025-12-14 04:35:34.376437"
...
```bash
$ shpc install quay.io/biocontainers/primers
```
...
#### primers-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### primers-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/primers
$ podman run --it --rm --entrypoint /usr/local/bin/primers   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/primers   -v ${PWD} -w ${PWD} <container> -c " $@"
```
