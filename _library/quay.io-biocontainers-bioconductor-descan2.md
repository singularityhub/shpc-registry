...
updated_at: "2024-01-16 02:43:36.053704"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-descan2:1.22.0--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-descan2/1.22.0--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-descan2/1.22.0--r43hf17093f_0
```
