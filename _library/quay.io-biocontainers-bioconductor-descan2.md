...
updated_at: "2024-12-30 02:57:08.926403"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-descan2:1.22.0--r43hf17093f_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-descan2/1.22.0--r43hf17093f_1
$ module help quay.io/biocontainers/bioconductor-descan2/1.22.0--r43hf17093f_1
```
