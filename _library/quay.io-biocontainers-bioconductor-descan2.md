...
updated_at: "2023-07-14 03:16:35.343246"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-descan2:1.18.0--r42hf17093f_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-descan2/1.18.0--r42hf17093f_1
$ module help quay.io/biocontainers/bioconductor-descan2/1.18.0--r42hf17093f_1
```
