...
updated_at: "2022-11-18 01:17:57.860144"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-descan2:1.8.0--r40h5f743cb_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-descan2/1.8.0--r40h5f743cb_0
$ module help quay.io/biocontainers/bioconductor-descan2/1.8.0--r40h5f743cb_0
```
