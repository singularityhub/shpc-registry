...
updated_at: "2023-08-10 03:38:59.439696"
latest: "1.20.1--r43hf17093f_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-descan2:1.20.1--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-descan2/1.20.1--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-descan2/1.20.1--r43hf17093f_0
```
