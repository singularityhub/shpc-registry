...
updated_at: "2023-11-15 03:07:42.327231"
latest: "0.7--py39hf5e1c6e_0"
...
```bash
$ shpc install quay.io/biocontainers/clair3-trio:0.7--py39hf5e1c6e_0
```
...
```bash
$ module load quay.io/biocontainers/clair3-trio/0.7--py39hf5e1c6e_0
$ module help quay.io/biocontainers/clair3-trio/0.7--py39hf5e1c6e_0
```
