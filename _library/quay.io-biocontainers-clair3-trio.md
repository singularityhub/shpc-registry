...
updated_at: "2024-09-20 03:21:24.031617"
latest: "0.7--py39h46983ab_1"
...
```bash
$ shpc install quay.io/biocontainers/clair3-trio:0.7--py39h46983ab_1
```
...
```bash
$ module load quay.io/biocontainers/clair3-trio/0.7--py39h46983ab_1
$ module help quay.io/biocontainers/clair3-trio/0.7--py39h46983ab_1
```
