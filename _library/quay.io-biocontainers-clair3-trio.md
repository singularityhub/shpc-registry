...
updated_at: "2023-07-07 03:17:42.296403"
latest: "0.6--py39h8492097_1"
...
```bash
$ shpc install quay.io/biocontainers/clair3-trio:0.6--py39h8492097_1
```
...
```bash
$ module load quay.io/biocontainers/clair3-trio/0.6--py39h8492097_1
$ module help quay.io/biocontainers/clair3-trio/0.6--py39h8492097_1
```
