...
updated_at: "2025-04-25 02:15:37.153541"
...
```bash
$ shpc install quay.io/biocontainers/zdb:1.3.5--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/zdb/1.3.5--hdfd78af_0
$ module help quay.io/biocontainers/zdb/1.3.5--hdfd78af_0
```
