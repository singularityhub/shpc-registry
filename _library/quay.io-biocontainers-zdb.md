...
updated_at: "2024-07-29 17:08:39.177255"
...
```bash
$ shpc install quay.io/biocontainers/zdb:1.3.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/zdb/1.3.0--hdfd78af_0
$ module help quay.io/biocontainers/zdb/1.3.0--hdfd78af_0
```
