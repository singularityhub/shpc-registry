...
updated_at: "2026-06-16 07:36:56.835376"
latest: "1.3.12--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/zdb:1.3.12--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/zdb/1.3.12--hdfd78af_0
$ module help quay.io/biocontainers/zdb/1.3.12--hdfd78af_0
```
