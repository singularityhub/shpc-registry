...
updated_at: "2026-01-14 04:03:50.502820"
latest: "1.3.11--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/zdb:1.3.11--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/zdb/1.3.11--hdfd78af_0
$ module help quay.io/biocontainers/zdb/1.3.11--hdfd78af_0
```
