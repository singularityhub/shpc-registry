...
updated_at: "2025-11-02 03:30:52.587227"
latest: "1.3.10--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/zdb:1.3.10--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/zdb/1.3.10--hdfd78af_0
$ module help quay.io/biocontainers/zdb/1.3.10--hdfd78af_0
```
