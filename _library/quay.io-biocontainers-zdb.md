...
updated_at: "2023-04-06 02:53:26.203315"
...
```bash
$ shpc install quay.io/biocontainers/zdb:1.0.7--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/zdb/1.0.7--hdfd78af_0
$ module help quay.io/biocontainers/zdb/1.0.7--hdfd78af_0
```
