...
updated_at: "2024-12-15 03:20:10.211891"
...
```bash
$ shpc install quay.io/biocontainers/zdb:1.3.4--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/zdb/1.3.4--hdfd78af_0
$ module help quay.io/biocontainers/zdb/1.3.4--hdfd78af_0
```
