...
updated_at: "2024-02-19 02:32:56.597266"
...
```bash
$ shpc install quay.io/biocontainers/zdb:1.2.3--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/zdb/1.2.3--hdfd78af_0
$ module help quay.io/biocontainers/zdb/1.2.3--hdfd78af_0
```
