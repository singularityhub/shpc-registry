...
updated_at: "2023-12-18 02:39:02.280462"
...
```bash
$ shpc install quay.io/biocontainers/zdb:1.2.1--hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/zdb/1.2.1--hdfd78af_1
$ module help quay.io/biocontainers/zdb/1.2.1--hdfd78af_1
```
