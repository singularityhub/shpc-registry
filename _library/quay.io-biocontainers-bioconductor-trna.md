...
updated_at: "2025-08-01 04:38:07.948697"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-trna:1.24.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-trna/1.24.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-trna/1.24.0--r44hdfd78af_0
```
