...
updated_at: "2023-11-23 03:37:55.221840"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-synapter:2.24.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-synapter/2.24.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-synapter/2.24.0--r43hdfd78af_0
```
