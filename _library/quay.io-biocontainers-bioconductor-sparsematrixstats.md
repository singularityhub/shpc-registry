...
updated_at: "2024-10-02 03:34:19.356142"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-sparsematrixstats:1.14.0--r43hf17093f_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-sparsematrixstats/1.14.0--r43hf17093f_1
$ module help quay.io/biocontainers/bioconductor-sparsematrixstats/1.14.0--r43hf17093f_1
```
