...
updated_at: "2026-03-26 05:29:59.609622"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ldblock:1.40.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ldblock/1.40.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ldblock/1.40.0--r45hdfd78af_0
```
