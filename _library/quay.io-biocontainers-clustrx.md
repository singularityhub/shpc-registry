---
layout: container
name:  "quay.io/biocontainers/clustrx"
maintainer: "@vsoch"
...
updated_at: "2026-06-28 06:49:15.442478"
...
versions:
 - "1.0.1--pyhdfd78af_0"
description: "singularity registry hpc automated addition for clustrx"
config: {"url": "https://biocontainers.pro/tools/clustrx", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for clustrx", "latest": {"1.0.1--pyhdfd78af_0": "sha256:c381df52f54a49971dba16047df6ddaf9f17035fed3d459ae100759901d61890"}, "tags": {"1.0.1--pyhdfd78af_0": "sha256:c381df52f54a49971dba16047df6ddaf9f17035fed3d459ae100759901d61890"}, "docker": "quay.io/biocontainers/clustrx", "aliases": {"clustrx": "/usr/local/bin/clustrx", "gawk-5.4.0": "/usr/local/bin/gawk-5.4.0", "igraph": "/usr/local/bin/igraph", "gawkbug": "/usr/local/bin/gawkbug", "mafft-sparsecore.rb": "/usr/local/bin/mafft-sparsecore.rb", "einsi": "/usr/local/bin/einsi", "fftns": "/usr/local/bin/fftns", "fftnsi": "/usr/local/bin/fftnsi", "ginsi": "/usr/local/bin/ginsi", "linsi": "/usr/local/bin/linsi", "mafft-distance": "/usr/local/bin/mafft-distance", "mafft-einsi": "/usr/local/bin/mafft-einsi", "mafft-fftns": "/usr/local/bin/mafft-fftns", "mafft-fftnsi": "/usr/local/bin/mafft-fftnsi", "mafft-ginsi": "/usr/local/bin/mafft-ginsi", "mafft-homologs.rb": "/usr/local/bin/mafft-homologs.rb", "mafft-linsi": "/usr/local/bin/mafft-linsi", "mafft-nwns": "/usr/local/bin/mafft-nwns", "mafft-nwnsi": "/usr/local/bin/mafft-nwnsi", "mafft-profile": "/usr/local/bin/mafft-profile", "mafft-qinsi": "/usr/local/bin/mafft-qinsi", "mafft-xinsi": "/usr/local/bin/mafft-xinsi", "nwns": "/usr/local/bin/nwns", "nwnsi": "/usr/local/bin/nwnsi", "mafft": "/usr/local/bin/mafft", "gawk": "/usr/local/bin/gawk", "awk": "/usr/local/bin/awk"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/clustrx.
singularity registry hpc automated addition for clustrx
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/clustrx
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/clustrx:1.0.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/clustrx/1.0.1--pyhdfd78af_0
$ module help quay.io/biocontainers/clustrx/1.0.1--pyhdfd78af_0
```
...
#### clustrx-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### clustrx-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/clustrx
$ podman run --it --rm --entrypoint /usr/local/bin/clustrx   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/clustrx   -v ${PWD} -w ${PWD} <container> -c " $@"
```
