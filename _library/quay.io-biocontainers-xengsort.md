...
updated_at: "2023-12-09 02:54:55.659149"
...
```bash
$ shpc install quay.io/biocontainers/xengsort:2.0.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/xengsort/2.0.2--pyhdfd78af_0
$ module help quay.io/biocontainers/xengsort/2.0.2--pyhdfd78af_0
```
