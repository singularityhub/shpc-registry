...
updated_at: "2024-01-01 02:46:02.558046"
...
```bash
$ shpc install quay.io/biocontainers/xengsort:2.0.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/xengsort/2.0.3--pyhdfd78af_0
$ module help quay.io/biocontainers/xengsort/2.0.3--pyhdfd78af_0
```
