...
updated_at: "2026-06-07 06:35:51.554198"
...
```bash
$ shpc install quay.io/biocontainers/xengsort:2.2.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/xengsort/2.2.1--pyhdfd78af_0
$ module help quay.io/biocontainers/xengsort/2.2.1--pyhdfd78af_0
```
