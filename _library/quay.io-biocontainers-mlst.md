...
updated_at: "2026-06-30 06:16:02.212492"
latest: "2.34.0--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/mlst:2.34.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mlst/2.34.0--hdfd78af_0
$ module help quay.io/biocontainers/mlst/2.34.0--hdfd78af_0
```
