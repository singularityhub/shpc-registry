...
updated_at: "2026-01-01 04:02:44.699232"
latest: "2.25.0--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/mlst:2.25.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mlst/2.25.0--hdfd78af_0
$ module help quay.io/biocontainers/mlst/2.25.0--hdfd78af_0
```
