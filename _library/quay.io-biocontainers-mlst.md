...
updated_at: "2026-02-01 04:41:10.969823"
latest: "2.32.2--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/mlst:2.32.2--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mlst/2.32.2--hdfd78af_0
$ module help quay.io/biocontainers/mlst/2.32.2--hdfd78af_0
```
