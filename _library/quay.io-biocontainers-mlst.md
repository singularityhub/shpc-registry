...
updated_at: "2026-05-17 06:19:01.580342"
latest: "2.33.1--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/mlst:2.33.1--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mlst/2.33.1--hdfd78af_0
$ module help quay.io/biocontainers/mlst/2.33.1--hdfd78af_0
```
