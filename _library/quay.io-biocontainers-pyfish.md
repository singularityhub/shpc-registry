...
updated_at: "2026-06-07 07:20:00.324083"
...
```bash
$ shpc install quay.io/biocontainers/pyfish:1.1.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pyfish/1.1.1--pyhdfd78af_0
$ module help quay.io/biocontainers/pyfish/1.1.1--pyhdfd78af_0
```
