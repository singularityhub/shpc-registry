...
updated_at: "2026-06-29 07:08:17.370539"
...
```bash
$ shpc install quay.io/biocontainers/pyfish:1.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pyfish/1.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/pyfish/1.2.0--pyhdfd78af_0
```
