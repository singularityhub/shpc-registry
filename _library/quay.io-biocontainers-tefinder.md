...
updated_at: "2026-06-30 06:21:21.184063"
...
```bash
$ shpc install quay.io/biocontainers/tefinder:2.32--hd63eeec_2
```
...
```bash
$ module load quay.io/biocontainers/tefinder/2.32--hd63eeec_2
$ module help quay.io/biocontainers/tefinder/2.32--hd63eeec_2
```
