---
layout: container
name:  "quay.io/biocontainers/darkprofiler"
maintainer: "@vsoch"
...
updated_at: "2026-06-26 02:05:20.882386"
...
```bash
$ module load quay.io/biocontainers/darkprofiler/0.3.1--pyhdfd78af_0
$ module help quay.io/biocontainers/darkprofiler/0.3.1--pyhdfd78af_0
```
...
#### darkprofiler-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### darkprofiler-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/darkprofiler
$ podman run --it --rm --entrypoint /usr/local/bin/darkprofiler   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/darkprofiler   -v ${PWD} -w ${PWD} <container> -c " $@"
```
