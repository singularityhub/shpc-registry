...
updated_at: "2025-12-11 03:37:58.063812"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-motifcounter:1.30.0--r44h3df3fcb_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-motifcounter/1.30.0--r44h3df3fcb_0
$ module help quay.io/biocontainers/bioconductor-motifcounter/1.30.0--r44h3df3fcb_0
```
