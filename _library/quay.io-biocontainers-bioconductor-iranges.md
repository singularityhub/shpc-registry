...
updated_at: "2025-02-03 03:35:44.186707"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-iranges:2.40.0--r44h3df3fcb_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-iranges/2.40.0--r44h3df3fcb_0
$ module help quay.io/biocontainers/bioconductor-iranges/2.40.0--r44h3df3fcb_0
```
