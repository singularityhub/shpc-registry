...
updated_at: "2024-08-11 03:19:42.624100"
latest: "2.36.0--r43ha9d7317_2"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-iranges:2.36.0--r43ha9d7317_2
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-iranges/2.36.0--r43ha9d7317_2
$ module help quay.io/biocontainers/bioconductor-iranges/2.36.0--r43ha9d7317_2
```
