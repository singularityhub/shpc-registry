...
updated_at: "2023-11-16 03:09:14.424212"
latest: "2.34.1--r43ha9d7317_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-iranges:2.34.1--r43ha9d7317_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-iranges/2.34.1--r43ha9d7317_0
$ module help quay.io/biocontainers/bioconductor-iranges/2.34.1--r43ha9d7317_0
```
