...
updated_at: "2025-09-16 04:23:12.635292"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-iranges:2.40.0--r44h3df3fcb_2
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-iranges/2.40.0--r44h3df3fcb_2
$ module help quay.io/biocontainers/bioconductor-iranges/2.40.0--r44h3df3fcb_2
```
