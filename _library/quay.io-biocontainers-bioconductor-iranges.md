...
updated_at: "2026-01-28 04:17:20.879023"
latest: "2.44.0--r45h3df3fcb_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-iranges:2.44.0--r45h3df3fcb_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-iranges/2.44.0--r45h3df3fcb_0
$ module help quay.io/biocontainers/bioconductor-iranges/2.44.0--r45h3df3fcb_0
```
