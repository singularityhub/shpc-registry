...
updated_at: "2023-07-13 03:43:08.694898"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-iranges:2.32.0--r42ha9d7317_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-iranges/2.32.0--r42ha9d7317_1
$ module help quay.io/biocontainers/bioconductor-iranges/2.32.0--r42ha9d7317_1
```
