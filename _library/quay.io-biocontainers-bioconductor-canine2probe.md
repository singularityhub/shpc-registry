...
updated_at: "2024-10-30 15:38:34.732552"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-canine2probe:2.18.0--r43hdfd78af_12
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-canine2probe/2.18.0--r43hdfd78af_12
$ module help quay.io/biocontainers/bioconductor-canine2probe/2.18.0--r43hdfd78af_12
```
