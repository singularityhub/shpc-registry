...
updated_at: "2023-07-14 03:34:02.855387"
latest: "3.20.0--r42hf17093f_1"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-xcms:3.20.0--r42hf17093f_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-xcms/3.20.0--r42hf17093f_1
$ module help quay.io/biocontainers/bioconductor-xcms/3.20.0--r42hf17093f_1
```
