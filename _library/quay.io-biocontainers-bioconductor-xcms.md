...
updated_at: "2023-08-10 03:36:56.815036"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-xcms:3.22.0--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-xcms/3.22.0--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-xcms/3.22.0--r43hf17093f_0
```
