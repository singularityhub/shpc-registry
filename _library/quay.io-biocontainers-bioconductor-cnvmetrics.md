...
updated_at: "2026-03-29 04:45:22.561136"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cnvmetrics:1.14.2--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cnvmetrics/1.14.2--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-cnvmetrics/1.14.2--r45hdfd78af_0
```
