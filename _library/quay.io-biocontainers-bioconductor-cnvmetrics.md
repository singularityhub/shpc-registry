...
updated_at: "2023-10-06 03:23:56.178274"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cnvmetrics:1.4.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cnvmetrics/1.4.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-cnvmetrics/1.4.0--r43hdfd78af_0
```
