...
updated_at: "2026-04-23 05:41:55.723208"
...
```bash
$ shpc install quay.io/biocontainers/sam2lca:1.1.4--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/sam2lca/1.1.4--pyhdfd78af_1
$ module help quay.io/biocontainers/sam2lca/1.1.4--pyhdfd78af_1
```
