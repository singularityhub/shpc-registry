---
layout: container
name:  "quay.io/biocontainers/cmat"
maintainer: "@vsoch"
...
updated_at: "2024-06-29 03:19:13.125730"
...
aliases:
 ...
 - "df"
versions:
 - "3.1.0--py38hdfd78af_0"
description: "singularity registry hpc automated addition for cmat"
config: {"url": "https://biocontainers.pro/tools/cmat", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for cmat", "latest": {"3.1.0--py38hdfd78af_0": "sha256:9187a6c7e380b32ef54665ae1ffe83ab663d23066f4747ed28342f25ad0f3bb4"}, "tags": {"3.1.0--py38hdfd78af_0": "sha256:9187a6c7e380b32ef54665ae1ffe83ab663d23066f4747ed28342f25ad0f3bb4"}, "docker": "quay.io/biocontainers/cmat", "aliases": {"VERSION": "/usr/local/bin/VERSION", "cmat": "/usr/local/bin/cmat", "coveralls": "/usr/local/bin/coveralls", "jwebserver": "/usr/local/bin/jwebserver", "nextflow.bak": "/usr/local/bin/nextflow.bak", "nextflow": "/usr/local/bin/nextflow", "coverage": "/usr/local/bin/coverage", "pcre2posix_test": "/usr/local/bin/pcre2posix_test", "basenc": "/usr/local/bin/basenc", "b2sum": "/usr/local/bin/b2sum", "ls": "/usr/local/bin/ls", "base32": "/usr/local/bin/base32", "base64": "/usr/local/bin/base64", "basename": "/usr/local/bin/basename", "cat": "/usr/local/bin/cat", "chcon": "/usr/local/bin/chcon", "chgrp": "/usr/local/bin/chgrp", "chmod": "/usr/local/bin/chmod", "chown": "/usr/local/bin/chown", "chroot": "/usr/local/bin/chroot", "cksum": "/usr/local/bin/cksum", "comm": "/usr/local/bin/comm", "cp": "/usr/local/bin/cp", "csplit": "/usr/local/bin/csplit", "cut": "/usr/local/bin/cut", "date": "/usr/local/bin/date", "dd": "/usr/local/bin/dd", "df": "/usr/local/bin/df"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/cmat.
singularity registry hpc automated addition for cmat
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/cmat
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/cmat:3.1.0--py38hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/cmat/3.1.0--py38hdfd78af_0
$ module help quay.io/biocontainers/cmat/3.1.0--py38hdfd78af_0
```
...
#### cmat-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### cmat-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/VERSION
$ podman run --it --rm --entrypoint /usr/local/bin/VERSION   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/VERSION   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/cmat
$ podman run --it --rm --entrypoint /usr/local/bin/cmat   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/cmat   -v ${PWD} -w ${PWD} <container> -c " $@"
```
