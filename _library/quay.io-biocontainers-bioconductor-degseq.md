...
updated_at: "2023-08-21 02:29:54.837283"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-degseq:1.54.0--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-degseq/1.54.0--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-degseq/1.54.0--r43hf17093f_0
```
