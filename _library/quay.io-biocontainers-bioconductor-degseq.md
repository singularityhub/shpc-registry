...
updated_at: "2023-06-20 03:15:49.462580"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-degseq:1.52.0--r42hf17093f_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-degseq/1.52.0--r42hf17093f_1
$ module help quay.io/biocontainers/bioconductor-degseq/1.52.0--r42hf17093f_1
```
