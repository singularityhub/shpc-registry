...
updated_at: "2023-11-05 02:40:42.043392"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-plpe:1.60.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-plpe/1.60.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-plpe/1.60.0--r43hdfd78af_0
```
