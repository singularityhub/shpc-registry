---
layout: container
name:  "quay.io/biocontainers/blastdbbuilder"
maintainer: "@vsoch"
...
updated_at: "2026-06-30 06:33:45.928651"
...
singularity registry hpc automated addition for blastdbbuilder
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/blastdbbuilder
```
...
#### blastdbbuilder-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### blastdbbuilder-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/blastdbbuilder
$ podman run --it --rm --entrypoint /usr/local/bin/blastdbbuilder   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/blastdbbuilder   -v ${PWD} -w ${PWD} <container> -c " $@"
```
