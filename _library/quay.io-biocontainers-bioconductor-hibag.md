...
updated_at: "2022-10-29 05:42:38.540731"
latest: "1.30.2--r41hc247a5b_1"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hibag:1.30.2--r41hc247a5b_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hibag/1.30.2--r41hc247a5b_1
$ module help quay.io/biocontainers/bioconductor-hibag/1.30.2--r41hc247a5b_1
```
