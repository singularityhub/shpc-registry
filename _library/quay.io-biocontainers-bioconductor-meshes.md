...
updated_at: "2025-09-17 03:26:23.288816"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-meshes:1.32.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-meshes/1.32.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-meshes/1.32.0--r44hdfd78af_0
```
