...
updated_at: "2026-08-27 23:56:40.040995"
...
```bash
$ shpc install quay.io/biocontainers/metalcoordanalysis:0.2.15--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/metalcoordanalysis/0.2.15--pyhdfd78af_0
$ module help quay.io/biocontainers/metalcoordanalysis/0.2.15--pyhdfd78af_0
```
