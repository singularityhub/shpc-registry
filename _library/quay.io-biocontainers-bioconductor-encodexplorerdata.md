...
updated_at: "2022-10-29 17:39:41.608388"
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-encodexplorerdata-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-encodexplorerdata-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-encodexplorerdata-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-encodexplorerdata-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-encodexplorerdata-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-encodexplorerdata-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
