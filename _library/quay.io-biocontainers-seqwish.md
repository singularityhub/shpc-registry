...
updated_at: "2024-10-08 03:23:34.576112"
latest: "0.7.10--h43eeafb_1"
...
```bash
$ shpc install quay.io/biocontainers/seqwish:0.7.10--h43eeafb_1
```
...
```bash
$ module load quay.io/biocontainers/seqwish/0.7.10--h43eeafb_1
$ module help quay.io/biocontainers/seqwish/0.7.10--h43eeafb_1
```
