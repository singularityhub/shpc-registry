...
updated_at: "2026-04-05 05:25:54.717778"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-kegglincs:1.36.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-kegglincs/1.36.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-kegglincs/1.36.0--r45hdfd78af_0
```
