...
updated_at: "2022-11-28 00:14:43.684559"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-kegglincs:1.20.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-kegglincs/1.20.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-kegglincs/1.20.0--r41hdfd78af_0
```
