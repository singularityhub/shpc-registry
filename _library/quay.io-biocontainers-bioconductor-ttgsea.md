...
updated_at: "2022-10-29 05:32:35.084539"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ttgsea:1.2.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ttgsea/1.2.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ttgsea/1.2.0--r41hdfd78af_0
```
