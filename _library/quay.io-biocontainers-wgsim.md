...
updated_at: "2025-01-14 03:10:03.004750"
...
```bash
$ shpc install quay.io/biocontainers/wgsim:1.0--h577a1d6_8
```
...
```bash
$ module load quay.io/biocontainers/wgsim/1.0--h577a1d6_8
$ module help quay.io/biocontainers/wgsim/1.0--h577a1d6_8
```
