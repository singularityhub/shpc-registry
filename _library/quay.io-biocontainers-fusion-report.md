...
updated_at: "2026-01-29 04:57:12.630364"
latest: "4.0.1--py313hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/fusion-report:4.0.1--py313hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/fusion-report/4.0.1--py313hdfd78af_0
$ module help quay.io/biocontainers/fusion-report/4.0.1--py313hdfd78af_0
```
