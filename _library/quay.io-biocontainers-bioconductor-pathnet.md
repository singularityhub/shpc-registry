...
updated_at: "2026-03-04 04:45:49.386667"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-pathnet:1.50.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-pathnet/1.50.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-pathnet/1.50.0--r45hdfd78af_0
```
