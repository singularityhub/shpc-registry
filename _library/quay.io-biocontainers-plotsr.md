...
updated_at: "2026-08-04 05:26:11.090202"
...
```bash
$ shpc install quay.io/biocontainers/plotsr:1.2.0--pyhcca532d_0
```
...
```bash
$ module load quay.io/biocontainers/plotsr/1.2.0--pyhcca532d_0
$ module help quay.io/biocontainers/plotsr/1.2.0--pyhcca532d_0
```
