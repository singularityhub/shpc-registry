...
updated_at: "2023-06-07 03:53:30.133405"
...
```bash
$ shpc install quay.io/biocontainers/r-acidgenomes:0.5.0--r42hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/r-acidgenomes/0.5.0--r42hdfd78af_1
$ module help quay.io/biocontainers/r-acidgenomes/0.5.0--r42hdfd78af_1
```
