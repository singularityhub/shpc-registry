...
updated_at: "2025-02-02 03:20:17.156719"
latest: "0.7.2--r44hdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/r-acidgenomes:0.7.2--r44hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/r-acidgenomes/0.7.2--r44hdfd78af_1
$ module help quay.io/biocontainers/r-acidgenomes/0.7.2--r44hdfd78af_1
```
