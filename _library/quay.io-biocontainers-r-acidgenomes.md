...
updated_at: "2026-09-01 08:13:33.925167"
latest: "0.8.1--r45hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/r-acidgenomes:0.8.1--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/r-acidgenomes/0.8.1--r45hdfd78af_0
$ module help quay.io/biocontainers/r-acidgenomes/0.8.1--r45hdfd78af_0
```
