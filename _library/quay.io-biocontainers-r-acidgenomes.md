...
updated_at: "2023-05-12 03:02:13.177513"
latest: "0.5.0--r42hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/r-acidgenomes:0.5.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/r-acidgenomes/0.5.0--r42hdfd78af_0
$ module help quay.io/biocontainers/r-acidgenomes/0.5.0--r42hdfd78af_0
```
