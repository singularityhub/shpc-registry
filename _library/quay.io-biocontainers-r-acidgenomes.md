...
updated_at: "2024-02-22 02:34:47.822109"
...
```bash
$ shpc install quay.io/biocontainers/r-acidgenomes:0.7.2--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/r-acidgenomes/0.7.2--r43hdfd78af_0
$ module help quay.io/biocontainers/r-acidgenomes/0.7.2--r43hdfd78af_0
```
