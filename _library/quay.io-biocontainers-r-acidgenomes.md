...
updated_at: "2025-04-28 03:41:30.171281"
latest: "0.7.3--r44hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/r-acidgenomes:0.7.3--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/r-acidgenomes/0.7.3--r44hdfd78af_0
$ module help quay.io/biocontainers/r-acidgenomes/0.7.3--r44hdfd78af_0
```
