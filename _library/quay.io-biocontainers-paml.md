...
updated_at: "2022-12-01 02:19:11.363868"
latest: "4.9--hec16e2b_7"
...
```bash
$ shpc install quay.io/biocontainers/paml:4.9--hec16e2b_7
```
...
```bash
$ module load quay.io/biocontainers/paml/4.9--hec16e2b_7
$ module help quay.io/biocontainers/paml/4.9--hec16e2b_7
```
