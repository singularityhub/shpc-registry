---
layout: container
name:  "quay.io/biocontainers/kestrel"
maintainer: "@vsoch"
github: "https://github.com/singularityhub/shpc-registry/blob/main/quay.io/biocontainers/kestrel/container.yaml"
config_url: "https://raw.githubusercontent.com/singularityhub/shpc-registry/main/quay.io/biocontainers/kestrel/container.yaml"
updated_at: "2025-05-26 04:03:55.536922"
latest: "1.0.3--hdfd78af_0"
container_url: "https://biocontainers.pro/tools/kestrel"
aliases:
 - "kestrel"
 - "jwebserver"
 - "jpackage"
...
versions:
 - "1.0.3--hdfd78af_0"
description: "singularity registry hpc automated addition for kestrel"
config: {"url": "https://biocontainers.pro/tools/kestrel", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for kestrel", "latest": {"1.0.3--hdfd78af_0": "sha256:142347b53b28f128685e576890dde7393e33594d8288deba31b46a327433ec6f"}, "tags": {"1.0.3--hdfd78af_0": "sha256:142347b53b28f128685e576890dde7393e33594d8288deba31b46a327433ec6f"}, "docker": "quay.io/biocontainers/kestrel", "aliases": {"kestrel": "/usr/local/bin/kestrel", "jwebserver": "/usr/local/bin/jwebserver", "jpackage": "/usr/local/bin/jpackage", "cups-config": "/usr/local/bin/cups-config", "ippeveprinter": "/usr/local/bin/ippeveprinter", "ipptool": "/usr/local/bin/ipptool", "hb-info": "/usr/local/bin/hb-info", "jfr": "/usr/local/bin/jfr", "jdeprscan": "/usr/local/bin/jdeprscan", "jhsdb": "/usr/local/bin/jhsdb", "jimage": "/usr/local/bin/jimage", "jlink": "/usr/local/bin/jlink", "jmod": "/usr/local/bin/jmod", "jshell": "/usr/local/bin/jshell", "aserver": "/usr/local/bin/aserver", "tjbench": "/usr/local/bin/tjbench", "jdeps": "/usr/local/bin/jdeps", "jar": "/usr/local/bin/jar", "jarsigner": "/usr/local/bin/jarsigner", "java": "/usr/local/bin/java", "javac": "/usr/local/bin/javac", "javadoc": "/usr/local/bin/javadoc", "javap": "/usr/local/bin/javap", "jcmd": "/usr/local/bin/jcmd", "jconsole": "/usr/local/bin/jconsole", "jdb": "/usr/local/bin/jdb"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/kestrel.
singularity registry hpc automated addition for kestrel
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/kestrel
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/kestrel:1.0.3--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/kestrel/1.0.3--hdfd78af_0
$ module help quay.io/biocontainers/kestrel/1.0.3--hdfd78af_0
```
...
#### kestrel-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### kestrel-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/kestrel
$ podman run --it --rm --entrypoint /usr/local/bin/kestrel   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/kestrel   -v ${PWD} -w ${PWD} <container> -c " $@"
```
