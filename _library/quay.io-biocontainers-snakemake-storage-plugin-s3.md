...
updated_at: "2025-07-31 03:55:38.723439"
...
```bash
$ shpc install quay.io/biocontainers/snakemake-storage-plugin-s3:0.3.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakemake-storage-plugin-s3/0.3.3--pyhdfd78af_0
$ module help quay.io/biocontainers/snakemake-storage-plugin-s3/0.3.3--pyhdfd78af_0
```
