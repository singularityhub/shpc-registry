...
updated_at: "2024-01-22 02:54:38.571136"
...
```bash
$ shpc install quay.io/biocontainers/snakemake-storage-plugin-s3:0.2.8--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/snakemake-storage-plugin-s3/0.2.8--pyhdfd78af_1
$ module help quay.io/biocontainers/snakemake-storage-plugin-s3/0.2.8--pyhdfd78af_1
```
