...
updated_at: "2026-07-25 06:59:50.473343"
...
```bash
$ shpc install quay.io/biocontainers/vcfclick:0.8.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/vcfclick/0.8.1--pyhdfd78af_0
$ module help quay.io/biocontainers/vcfclick/0.8.1--pyhdfd78af_0
```
