...
updated_at: "2023-03-04 02:47:44.410776"
latest: "1.2.2--py39h2add14b_0"
...
```bash
$ shpc install quay.io/biocontainers/resmico:1.2.2--py39h2add14b_0
```
...
```bash
$ module load quay.io/biocontainers/resmico/1.2.2--py39h2add14b_0
$ module help quay.io/biocontainers/resmico/1.2.2--py39h2add14b_0
```
