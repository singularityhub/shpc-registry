...
updated_at: "2024-02-21 02:29:04.344324"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-msnbase:2.28.1--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-msnbase/2.28.1--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-msnbase/2.28.1--r43hf17093f_0
```
