...
updated_at: "2023-06-26 04:02:07.767113"
latest: "2.24.0--r42hf17093f_1"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-msnbase:2.24.0--r42hf17093f_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-msnbase/2.24.0--r42hf17093f_1
$ module help quay.io/biocontainers/bioconductor-msnbase/2.24.0--r42hf17093f_1
```
