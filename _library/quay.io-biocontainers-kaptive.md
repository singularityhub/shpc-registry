...
updated_at: "2024-07-25 03:07:02.642301"
latest: "3.0.0b5--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/kaptive:3.0.0b5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/kaptive/3.0.0b5--pyhdfd78af_0
$ module help quay.io/biocontainers/kaptive/3.0.0b5--pyhdfd78af_0
```
