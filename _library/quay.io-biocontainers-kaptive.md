...
updated_at: "2025-05-24 11:23:06.445053"
...
```bash
$ shpc install quay.io/biocontainers/kaptive:3.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/kaptive/3.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/kaptive/3.1.0--pyhdfd78af_0
```
