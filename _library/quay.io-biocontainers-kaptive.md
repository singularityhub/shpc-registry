...
updated_at: "2026-08-08 04:07:58.918779"
...
```bash
$ shpc install quay.io/biocontainers/kaptive:3.2.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/kaptive/3.2.2--pyhdfd78af_0
$ module help quay.io/biocontainers/kaptive/3.2.2--pyhdfd78af_0
```
