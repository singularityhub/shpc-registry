...
updated_at: "2024-05-27 03:53:38.567777"
...
```bash
$ shpc install quay.io/biocontainers/kaptive:3.0.0b1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/kaptive/3.0.0b1--pyhdfd78af_0
$ module help quay.io/biocontainers/kaptive/3.0.0b1--pyhdfd78af_0
```
