...
updated_at: "2023-05-04 03:27:16.497595"
latest: "2.0.6--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/kaptive:2.0.6--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/kaptive/2.0.6--hdfd78af_0
$ module help quay.io/biocontainers/kaptive/2.0.6--hdfd78af_0
```
