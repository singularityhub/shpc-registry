...
updated_at: "2026-09-26 07:18:31.604752"
...
```bash
$ shpc install quay.io/biocontainers/kaptive:3.3.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/kaptive/3.3.2--pyhdfd78af_0
$ module help quay.io/biocontainers/kaptive/3.3.2--pyhdfd78af_0
```
