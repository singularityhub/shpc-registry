...
updated_at: "2026-09-03 07:31:52.982414"
latest: "0.7.1--hec9b1f2_0"
...
```bash
$ shpc install quay.io/biocontainers/polypolish:0.7.1--hec9b1f2_0
```
...
```bash
$ module load quay.io/biocontainers/polypolish/0.7.1--hec9b1f2_0
$ module help quay.io/biocontainers/polypolish/0.7.1--hec9b1f2_0
```
