---
layout: container
name:  "quay.io/biocontainers/bioconductor-trident"
maintainer: "@vsoch"
github: "https://github.com/singularityhub/shpc-registry/blob/main/quay.io/biocontainers/bioconductor-trident/container.yaml"
config_url: "https://raw.githubusercontent.com/singularityhub/shpc-registry/main/quay.io/biocontainers/bioconductor-trident/container.yaml"
updated_at: "2026-04-05 04:39:39.981339"
latest: "1.2.0--r45hdfd78af_0"
container_url: "https://biocontainers.pro/tools/bioconductor-trident"
aliases:
 - "hwloc-gather-cpuid"
 - "hwloc-annotate"
 - "hwloc-bind"
...
versions:
 - "1.2.0--r45hdfd78af_0"
description: "singularity registry hpc automated addition for bioconductor-trident"
config: {"url": "https://biocontainers.pro/tools/bioconductor-trident", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for bioconductor-trident", "latest": {"1.2.0--r45hdfd78af_0": "sha256:86a55a6335e0c6f15703a8263737c4293f6f910412e587000e83b5baba5a369e"}, "tags": {"1.2.0--r45hdfd78af_0": "sha256:86a55a6335e0c6f15703a8263737c4293f6f910412e587000e83b5baba5a369e"}, "docker": "quay.io/biocontainers/bioconductor-trident", "aliases": {"hwloc-gather-cpuid": "/usr/local/bin/hwloc-gather-cpuid", "hwloc-annotate": "/usr/local/bin/hwloc-annotate", "hwloc-bind": "/usr/local/bin/hwloc-bind", "hwloc-calc": "/usr/local/bin/hwloc-calc", "hwloc-compress-dir": "/usr/local/bin/hwloc-compress-dir", "hwloc-diff": "/usr/local/bin/hwloc-diff", "hwloc-distrib": "/usr/local/bin/hwloc-distrib", "hwloc-gather-topology": "/usr/local/bin/hwloc-gather-topology", "hwloc-info": "/usr/local/bin/hwloc-info", "hwloc-ls": "/usr/local/bin/hwloc-ls", "hwloc-patch": "/usr/local/bin/hwloc-patch", "hwloc-ps": "/usr/local/bin/hwloc-ps", "lstopo": "/usr/local/bin/lstopo", "lstopo-no-graphics": "/usr/local/bin/lstopo-no-graphics", "x86_64-conda-linux-gnu.cfg": "/usr/local/bin/x86_64-conda-linux-gnu.cfg", "hb-info": "/usr/local/bin/hb-info"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/bioconductor-trident.
singularity registry hpc automated addition for bioconductor-trident
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/bioconductor-trident
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-trident:1.2.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-trident/1.2.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-trident/1.2.0--r45hdfd78af_0
```
...
#### bioconductor-trident-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-trident-inspect-deffile:
