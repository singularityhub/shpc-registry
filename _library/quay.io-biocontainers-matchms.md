...
updated_at: "2023-12-14 02:39:19.333406"
latest: "0.24.0--pyhdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/matchms:0.24.0--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/matchms/0.24.0--pyhdfd78af_1
$ module help quay.io/biocontainers/matchms/0.24.0--pyhdfd78af_1
```
