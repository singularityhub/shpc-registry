...
updated_at: "2025-09-29 03:27:23.513582"
latest: "0.30.2--pyhdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/matchms:0.30.2--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/matchms/0.30.2--pyhdfd78af_1
$ module help quay.io/biocontainers/matchms/0.30.2--pyhdfd78af_1
```
