...
updated_at: "2026-05-01 05:45:34.399129"
latest: "0.32.0--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/matchms:0.32.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/matchms/0.32.0--pyhdfd78af_0
$ module help quay.io/biocontainers/matchms/0.32.0--pyhdfd78af_0
```
