...
updated_at: "2024-11-19 03:05:27.703439"
latest: "0.27.0--pyhdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/matchms:0.27.0--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/matchms/0.27.0--pyhdfd78af_1
$ module help quay.io/biocontainers/matchms/0.27.0--pyhdfd78af_1
```
