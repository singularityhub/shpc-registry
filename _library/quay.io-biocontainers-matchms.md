...
updated_at: "2024-06-11 05:44:47.711201"
latest: "0.25.0--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/matchms:0.25.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/matchms/0.25.0--pyhdfd78af_0
$ module help quay.io/biocontainers/matchms/0.25.0--pyhdfd78af_0
```
