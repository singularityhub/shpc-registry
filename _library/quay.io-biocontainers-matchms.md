...
updated_at: "2025-06-09 03:36:02.666072"
latest: "0.30.0--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/matchms:0.30.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/matchms/0.30.0--pyhdfd78af_0
$ module help quay.io/biocontainers/matchms/0.30.0--pyhdfd78af_0
```
