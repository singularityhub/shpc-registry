...
updated_at: "2026-09-01 08:03:34.647336"
latest: "0.33.1--pyhdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/matchms:0.33.1--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/matchms/0.33.1--pyhdfd78af_1
$ module help quay.io/biocontainers/matchms/0.33.1--pyhdfd78af_1
```
