...
updated_at: "2026-06-23 06:54:31.267836"
...
```bash
$ shpc install quay.io/biocontainers/matchms:0.33.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/matchms/0.33.0--pyhdfd78af_0
$ module help quay.io/biocontainers/matchms/0.33.0--pyhdfd78af_0
```
