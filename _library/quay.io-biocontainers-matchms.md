...
updated_at: "2024-02-06 02:40:03.479341"
...
```bash
$ shpc install quay.io/biocontainers/matchms:0.24.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/matchms/0.24.1--pyhdfd78af_0
$ module help quay.io/biocontainers/matchms/0.24.1--pyhdfd78af_0
```
