...
updated_at: "2025-07-31 04:03:03.637301"
latest: "0.30.2--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/matchms:0.30.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/matchms/0.30.2--pyhdfd78af_0
$ module help quay.io/biocontainers/matchms/0.30.2--pyhdfd78af_0
```
