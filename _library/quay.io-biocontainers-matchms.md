...
updated_at: "2024-05-25 03:14:13.435774"
latest: "0.24.4--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/matchms:0.24.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/matchms/0.24.4--pyhdfd78af_0
$ module help quay.io/biocontainers/matchms/0.24.4--pyhdfd78af_0
```
