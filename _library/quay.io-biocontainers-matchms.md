...
updated_at: "2024-04-04 02:56:17.820671"
latest: "0.24.2--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/matchms:0.24.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/matchms/0.24.2--pyhdfd78af_0
$ module help quay.io/biocontainers/matchms/0.24.2--pyhdfd78af_0
```
