...
updated_at: "2026-01-24 04:01:04.562054"
...
```bash
$ shpc install quay.io/biocontainers/matchms:0.31.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/matchms/0.31.0--pyhdfd78af_0
$ module help quay.io/biocontainers/matchms/0.31.0--pyhdfd78af_0
```
