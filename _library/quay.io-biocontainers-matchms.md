...
updated_at: "2023-11-13 02:41:27.872253"
latest: "0.23.1--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/matchms:0.23.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/matchms/0.23.1--pyhdfd78af_0
$ module help quay.io/biocontainers/matchms/0.23.1--pyhdfd78af_0
```
