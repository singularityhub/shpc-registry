...
updated_at: "2023-08-28 03:16:39.574751"
latest: "0.21.1--pyh7cba7a3_1"
...
```bash
$ shpc install quay.io/biocontainers/matchms:0.21.1--pyh7cba7a3_1
```
...
```bash
$ module load quay.io/biocontainers/matchms/0.21.1--pyh7cba7a3_1
$ module help quay.io/biocontainers/matchms/0.21.1--pyh7cba7a3_1
```
