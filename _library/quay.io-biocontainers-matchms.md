...
updated_at: "2026-07-01 07:21:32.827815"
...
```bash
$ shpc install quay.io/biocontainers/matchms:0.33.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/matchms/0.33.1--pyhdfd78af_0
$ module help quay.io/biocontainers/matchms/0.33.1--pyhdfd78af_0
```
