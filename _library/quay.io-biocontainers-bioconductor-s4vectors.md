...
updated_at: "2026-09-26 07:33:13.378167"
latest: "0.50.3--r45h262fe30_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-s4vectors:0.50.3--r45h262fe30_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-s4vectors/0.50.3--r45h262fe30_0
$ module help quay.io/biocontainers/bioconductor-s4vectors/0.50.3--r45h262fe30_0
```
