...
updated_at: "2024-05-25 02:29:55.615094"
latest: "0.40.2--r43ha9d7317_1"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-s4vectors:0.40.2--r43ha9d7317_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-s4vectors/0.40.2--r43ha9d7317_1
$ module help quay.io/biocontainers/bioconductor-s4vectors/0.40.2--r43ha9d7317_1
```
