...
updated_at: "2023-10-05 03:03:52.832032"
latest: "0.38.1--r43ha9d7317_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-s4vectors:0.38.1--r43ha9d7317_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-s4vectors/0.38.1--r43ha9d7317_0
$ module help quay.io/biocontainers/bioconductor-s4vectors/0.38.1--r43ha9d7317_0
```
