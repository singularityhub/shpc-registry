...
updated_at: "2026-02-01 04:43:16.054843"
latest: "0.48.0--r45h3df3fcb_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-s4vectors:0.48.0--r45h3df3fcb_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-s4vectors/0.48.0--r45h3df3fcb_0
$ module help quay.io/biocontainers/bioconductor-s4vectors/0.48.0--r45h3df3fcb_0
```
