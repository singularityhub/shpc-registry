...
updated_at: "2026-03-28 17:13:55.196977"
latest: "0.48.0--r45h01b2380_1"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-s4vectors:0.48.0--r45h01b2380_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-s4vectors/0.48.0--r45h01b2380_1
$ module help quay.io/biocontainers/bioconductor-s4vectors/0.48.0--r45h01b2380_1
```
