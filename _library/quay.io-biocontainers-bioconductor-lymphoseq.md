...
updated_at: "2023-07-13 03:47:33.560242"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-lymphoseq:1.28.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-lymphoseq/1.28.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-lymphoseq/1.28.0--r43hdfd78af_0
```
