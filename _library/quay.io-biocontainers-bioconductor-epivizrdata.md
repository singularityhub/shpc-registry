...
updated_at: "2024-08-12 03:19:00.493379"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-epivizrdata:1.30.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-epivizrdata/1.30.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-epivizrdata/1.30.0--r43hdfd78af_0
```
