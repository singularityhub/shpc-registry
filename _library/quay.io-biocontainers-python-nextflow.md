...
updated_at: "2026-03-24 05:01:55.303645"
latest: "0.13.0--pyh106432d_0"
...
```bash
$ shpc install quay.io/biocontainers/python-nextflow:0.13.0--pyh106432d_0
```
...
```bash
$ module load quay.io/biocontainers/python-nextflow/0.13.0--pyh106432d_0
$ module help quay.io/biocontainers/python-nextflow/0.13.0--pyh106432d_0
```
