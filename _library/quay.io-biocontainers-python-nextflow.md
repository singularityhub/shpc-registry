...
updated_at: "2026-07-01 15:17:41.391360"
latest: "0.13.1--pyh106432d_0"
...
```bash
$ shpc install quay.io/biocontainers/python-nextflow:0.13.1--pyh106432d_0
```
...
```bash
$ module load quay.io/biocontainers/python-nextflow/0.13.1--pyh106432d_0
$ module help quay.io/biocontainers/python-nextflow/0.13.1--pyh106432d_0
```
