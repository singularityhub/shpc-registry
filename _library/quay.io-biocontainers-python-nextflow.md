...
updated_at: "2023-07-25 03:24:43.844251"
...
```bash
$ shpc install quay.io/biocontainers/python-nextflow:0.6.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/python-nextflow/0.6.1--pyhdfd78af_0
$ module help quay.io/biocontainers/python-nextflow/0.6.1--pyhdfd78af_0
```
