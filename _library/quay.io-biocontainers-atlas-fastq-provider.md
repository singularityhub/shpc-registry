...
updated_at: "2022-10-29 05:40:24.024506"
latest: "0.4.4--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/atlas-fastq-provider:0.4.4--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/atlas-fastq-provider/0.4.4--hdfd78af_0
$ module help quay.io/biocontainers/atlas-fastq-provider/0.4.4--hdfd78af_0
```
