...
updated_at: "2026-03-20 00:22:17.179632"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-org.gg.eg.db:3.22.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-org.gg.eg.db/3.22.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-org.gg.eg.db/3.22.0--r45hdfd78af_0
```
