...
updated_at: "2024-08-22 03:21:25.565899"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-org.gg.eg.db:3.18.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-org.gg.eg.db/3.18.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-org.gg.eg.db/3.18.0--r43hdfd78af_0
```
