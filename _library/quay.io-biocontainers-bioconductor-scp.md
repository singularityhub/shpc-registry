...
updated_at: "2026-04-04 04:47:00.646610"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-scp:1.20.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-scp/1.20.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-scp/1.20.0--r45hdfd78af_0
```
