...
updated_at: "2023-12-04 03:02:29.523246"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-scp:1.10.1--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-scp/1.10.1--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-scp/1.10.1--r43hdfd78af_0
```
