...
updated_at: "2024-08-18 02:41:04.237652"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-scp:1.12.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-scp/1.12.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-scp/1.12.0--r43hdfd78af_0
```
