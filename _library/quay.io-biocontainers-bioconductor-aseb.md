...
updated_at: "2023-06-29 03:24:20.802372"
latest: "1.42.0--r42hf17093f_2"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-aseb:1.42.0--r42hf17093f_2
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-aseb/1.42.0--r42hf17093f_2
$ module help quay.io/biocontainers/bioconductor-aseb/1.42.0--r42hf17093f_2
```
