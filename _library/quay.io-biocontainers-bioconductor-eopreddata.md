---
layout: container
name:  "quay.io/biocontainers/bioconductor-eopreddata"
maintainer: "@vsoch"
...
updated_at: "2026-03-13 05:05:08.325370"
...
versions:
 - "1.4.0--r45hdfd78af_0"
description: "singularity registry hpc automated addition for bioconductor-eopreddata"
config: {"url": "https://biocontainers.pro/tools/bioconductor-eopreddata", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for bioconductor-eopreddata", "latest": {"1.4.0--r45hdfd78af_0": "sha256:8f2485fac08acaa0a23c393a5108735609d70d1ad93d69f883e970d2bd7dc38c"}, "tags": {"1.4.0--r45hdfd78af_0": "sha256:8f2485fac08acaa0a23c393a5108735609d70d1ad93d69f883e970d2bd7dc38c"}, "docker": "quay.io/biocontainers/bioconductor-eopreddata", "aliases": {"idle3.14": "/usr/local/bin/idle3.14", "pydoc3.14": "/usr/local/bin/pydoc3.14", "python3.14": "/usr/local/bin/python3.14", "python3.14-config": "/usr/local/bin/python3.14-config", "x86_64-conda-linux-gnu.cfg": "/usr/local/bin/x86_64-conda-linux-gnu.cfg", "installBiocDataPackage.sh": "/usr/local/bin/installBiocDataPackage.sh", "tomlq": "/usr/local/bin/tomlq", "xq": "/usr/local/bin/xq", "yq": "/usr/local/bin/yq", "jq": "/usr/local/bin/jq", "onig-config": "/usr/local/bin/onig-config", "activate-global-python-argcomplete": "/usr/local/bin/activate-global-python-argcomplete", "python-argcomplete-check-easy-install-script": "/usr/local/bin/python-argcomplete-check-easy-install-script", "register-python-argcomplete": "/usr/local/bin/register-python-argcomplete", "hb-info": "/usr/local/bin/hb-info", "tjbench": "/usr/local/bin/tjbench"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/bioconductor-eopreddata.
singularity registry hpc automated addition for bioconductor-eopreddata
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/bioconductor-eopreddata
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-eopreddata:1.4.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-eopreddata/1.4.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-eopreddata/1.4.0--r45hdfd78af_0
```
...
#### bioconductor-eopreddata-inspect:
...
#### bioconductor-eopreddata-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-eopreddata-inspect-deffile:
