...
updated_at: "2024-08-13 02:46:47.286723"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-msstats:4.10.0--r43hf17093f_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-msstats/4.10.0--r43hf17093f_1
$ module help quay.io/biocontainers/bioconductor-msstats/4.10.0--r43hf17093f_1
```
