...
updated_at: "2023-12-09 02:49:49.337320"
latest: "4.8.3--r43hf17093f_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-msstats:4.8.3--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-msstats/4.8.3--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-msstats/4.8.3--r43hf17093f_0
```
