...
updated_at: "2023-12-17 03:04:54.168769"
latest: "4.10.0--r43hf17093f_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-msstats:4.10.0--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-msstats/4.10.0--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-msstats/4.10.0--r43hf17093f_0
```
