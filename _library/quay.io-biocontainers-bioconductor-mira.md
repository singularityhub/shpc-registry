...
updated_at: "2024-11-17 03:21:50.751355"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mira:1.24.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mira/1.24.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-mira/1.24.0--r43hdfd78af_0
```
