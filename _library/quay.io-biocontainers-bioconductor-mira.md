...
updated_at: "2025-05-07 03:35:48.528060"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mira:1.28.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mira/1.28.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-mira/1.28.0--r44hdfd78af_0
```
