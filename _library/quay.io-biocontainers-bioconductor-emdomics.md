...
updated_at: "2026-04-05 05:17:29.475667"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-emdomics:2.40.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-emdomics/2.40.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-emdomics/2.40.0--r45hdfd78af_0
```
