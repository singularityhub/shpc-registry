...
updated_at: "2022-11-03 01:16:43.381578"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-emdomics:2.24.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-emdomics/2.24.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-emdomics/2.24.0--r41hdfd78af_0
```
