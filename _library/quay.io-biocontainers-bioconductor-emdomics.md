...
updated_at: "2023-02-22 03:06:51.216294"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-emdomics:2.28.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-emdomics/2.28.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-emdomics/2.28.0--r42hdfd78af_0
```
