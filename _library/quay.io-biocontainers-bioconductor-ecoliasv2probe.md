...
updated_at: "2026-04-03 15:13:02.172158"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ecoliasv2probe:2.18.0--r45hdfd78af_14
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ecoliasv2probe/2.18.0--r45hdfd78af_14
$ module help quay.io/biocontainers/bioconductor-ecoliasv2probe/2.18.0--r45hdfd78af_14
```
