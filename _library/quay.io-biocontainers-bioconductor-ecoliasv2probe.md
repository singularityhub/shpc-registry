...
updated_at: "2025-10-01 04:02:15.941006"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ecoliasv2probe:2.18.0--r44hdfd78af_13
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ecoliasv2probe/2.18.0--r44hdfd78af_13
$ module help quay.io/biocontainers/bioconductor-ecoliasv2probe/2.18.0--r44hdfd78af_13
```
