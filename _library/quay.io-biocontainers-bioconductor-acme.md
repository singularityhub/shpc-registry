...
updated_at: "2024-04-20 02:59:40.994586"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-acme:2.58.0--r43ha9d7317_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-acme/2.58.0--r43ha9d7317_0
$ module help quay.io/biocontainers/bioconductor-acme/2.58.0--r43ha9d7317_0
```
