...
updated_at: "2025-11-28 03:57:48.954464"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-org.ce.eg.db:3.20.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-org.ce.eg.db/3.20.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-org.ce.eg.db/3.20.0--r44hdfd78af_0
```
