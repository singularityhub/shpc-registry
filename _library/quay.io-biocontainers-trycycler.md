...
updated_at: "2026-01-09 04:15:44.619504"
...
```bash
$ shpc install quay.io/biocontainers/trycycler:0.5.6--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/trycycler/0.5.6--pyhdfd78af_0
$ module help quay.io/biocontainers/trycycler/0.5.6--pyhdfd78af_0
```
