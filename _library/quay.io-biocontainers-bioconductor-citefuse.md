...
updated_at: "2026-04-05 04:46:00.188509"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-citefuse:1.22.0--r45ha27e39d_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-citefuse/1.22.0--r45ha27e39d_0
$ module help quay.io/biocontainers/bioconductor-citefuse/1.22.0--r45ha27e39d_0
```
