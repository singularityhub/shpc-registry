...
updated_at: "2024-04-16 02:52:33.910913"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-citefuse:1.14.0--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-citefuse/1.14.0--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-citefuse/1.14.0--r43hf17093f_0
```
