...
updated_at: "2026-04-02 05:17:44.137628"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-multimed:2.32.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-multimed/2.32.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-multimed/2.32.0--r45hdfd78af_0
```
