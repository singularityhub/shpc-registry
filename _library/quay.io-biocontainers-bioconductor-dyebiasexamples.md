...
updated_at: "2022-11-15 00:21:00.143318"
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-dyebiasexamples-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-dyebiasexamples-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-dyebiasexamples-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-dyebiasexamples-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-dyebiasexamples-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-dyebiasexamples-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
