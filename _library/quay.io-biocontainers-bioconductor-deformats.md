...
updated_at: "2026-01-26 04:24:00.518485"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-deformats:1.34.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-deformats/1.34.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-deformats/1.34.0--r44hdfd78af_0
```
