...
updated_at: "2024-12-05 03:25:18.037779"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-deformats:1.30.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-deformats/1.30.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-deformats/1.30.0--r43hdfd78af_0
```
