...
updated_at: "2026-03-19 05:12:25.743670"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-uncoverapplib:1.20.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-uncoverapplib/1.20.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-uncoverapplib/1.20.0--r45hdfd78af_0
```
