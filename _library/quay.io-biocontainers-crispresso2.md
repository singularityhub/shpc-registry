...
updated_at: "2024-07-24 03:17:55.901858"
latest: "2.3.1--py39h24fbfe6_1"
...
```bash
$ shpc install quay.io/biocontainers/crispresso2:2.3.1--py39h24fbfe6_1
```
...
```bash
$ module load quay.io/biocontainers/crispresso2/2.3.1--py39h24fbfe6_1
$ module help quay.io/biocontainers/crispresso2/2.3.1--py39h24fbfe6_1
```
