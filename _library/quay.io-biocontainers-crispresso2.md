...
updated_at: "2025-04-21 04:46:27.541789"
latest: "2.3.2--py39hff726c5_0"
...
```bash
$ shpc install quay.io/biocontainers/crispresso2:2.3.2--py39hff726c5_0
```
...
```bash
$ module load quay.io/biocontainers/crispresso2/2.3.2--py39hff726c5_0
$ module help quay.io/biocontainers/crispresso2/2.3.2--py39hff726c5_0
```
