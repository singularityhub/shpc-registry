...
updated_at: "2025-12-11 04:48:22.711331"
latest: "2.3.3--py39hff726c5_0"
...
```bash
$ shpc install quay.io/biocontainers/crispresso2:2.3.3--py39hff726c5_0
```
...
```bash
$ module load quay.io/biocontainers/crispresso2/2.3.3--py39hff726c5_0
$ module help quay.io/biocontainers/crispresso2/2.3.3--py39hff726c5_0
```
