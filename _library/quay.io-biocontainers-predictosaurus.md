...
updated_at: "2025-09-16 03:33:10.108236"
latest: "0.4.2--hcb96839_0"
...
```bash
$ shpc install quay.io/biocontainers/predictosaurus:0.4.2--hcb96839_0
```
...
```bash
$ module load quay.io/biocontainers/predictosaurus/0.4.2--hcb96839_0
$ module help quay.io/biocontainers/predictosaurus/0.4.2--hcb96839_0
```
