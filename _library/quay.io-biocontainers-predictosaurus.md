...
updated_at: "2026-05-09 07:04:35.868917"
latest: "0.10.5--hbcba35e_0"
...
```bash
$ shpc install quay.io/biocontainers/predictosaurus:0.10.5--hbcba35e_0
```
...
```bash
$ module load quay.io/biocontainers/predictosaurus/0.10.5--hbcba35e_0
$ module help quay.io/biocontainers/predictosaurus/0.10.5--hbcba35e_0
```
