...
updated_at: "2025-02-17 03:35:02.800713"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-org.at.tair.db:3.20.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-org.at.tair.db/3.20.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-org.at.tair.db/3.20.0--r44hdfd78af_0
```
