...
updated_at: "2026-06-24 06:20:39.025981"
...
```bash
$ shpc install quay.io/biocontainers/methbat:1.1.0--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/methbat/1.1.0--h9ee0642_0
$ module help quay.io/biocontainers/methbat/1.1.0--h9ee0642_0
```
