...
updated_at: "2026-01-24 03:55:01.034934"
...
```bash
$ shpc install quay.io/biocontainers/methbat:0.17.0--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/methbat/0.17.0--h9ee0642_0
$ module help quay.io/biocontainers/methbat/0.17.0--h9ee0642_0
```
