...
updated_at: "2025-12-10 03:40:47.603808"
latest: "0.16.1--h9ee0642_0"
...
```bash
$ shpc install quay.io/biocontainers/methbat:0.16.1--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/methbat/0.16.1--h9ee0642_0
$ module help quay.io/biocontainers/methbat/0.16.1--h9ee0642_0
```
