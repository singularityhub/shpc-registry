...
updated_at: "2025-09-11 03:21:27.206903"
...
```bash
$ shpc install quay.io/biocontainers/methbat:0.14.2--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/methbat/0.14.2--h9ee0642_0
$ module help quay.io/biocontainers/methbat/0.14.2--h9ee0642_0
```
