...
updated_at: "2026-03-27 04:38:56.132792"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ngsreports:2.12.1--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ngsreports/2.12.1--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ngsreports/2.12.1--r45hdfd78af_0
```
