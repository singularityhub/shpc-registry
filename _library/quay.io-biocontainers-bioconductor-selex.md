...
updated_at: "2025-11-23 04:01:25.980421"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-selex:1.38.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-selex/1.38.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-selex/1.38.0--r44hdfd78af_0
```
