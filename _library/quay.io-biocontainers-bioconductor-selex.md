---
layout: container
name:  "quay.io/biocontainers/bioconductor-selex"
maintainer: "@vsoch"
...
updated_at: "2026-04-05 05:05:41.123959"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-selex
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-selex:1.42.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-selex/1.42.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-selex/1.42.0--r45hdfd78af_0
```
...
#### bioconductor-selex-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-selex-inspect-deffile:
