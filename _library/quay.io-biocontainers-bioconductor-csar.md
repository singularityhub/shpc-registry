...
updated_at: "2024-02-07 02:21:52.987023"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-csar:1.54.0--r43ha9d7317_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-csar/1.54.0--r43ha9d7317_0
$ module help quay.io/biocontainers/bioconductor-csar/1.54.0--r43ha9d7317_0
```
