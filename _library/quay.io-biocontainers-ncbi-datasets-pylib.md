...
updated_at: "2023-10-07 02:40:22.695397"
latest: "15.19.1--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/ncbi-datasets-pylib:15.19.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ncbi-datasets-pylib/15.19.1--pyhdfd78af_0
$ module help quay.io/biocontainers/ncbi-datasets-pylib/15.19.1--pyhdfd78af_0
```
