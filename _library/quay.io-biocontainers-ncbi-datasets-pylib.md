...
updated_at: "2024-02-11 02:57:54.632897"
latest: "16.3.0--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/ncbi-datasets-pylib:16.3.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ncbi-datasets-pylib/16.3.0--pyhdfd78af_0
$ module help quay.io/biocontainers/ncbi-datasets-pylib/16.3.0--pyhdfd78af_0
```
