...
updated_at: "2023-09-13 02:36:35.085686"
latest: "15.13.0--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/ncbi-datasets-pylib:15.13.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ncbi-datasets-pylib/15.13.0--pyhdfd78af_0
$ module help quay.io/biocontainers/ncbi-datasets-pylib/15.13.0--pyhdfd78af_0
```
