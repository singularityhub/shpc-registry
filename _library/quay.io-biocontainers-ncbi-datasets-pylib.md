...
updated_at: "2024-04-25 03:08:12.287986"
latest: "16.6.0--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/ncbi-datasets-pylib:16.6.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ncbi-datasets-pylib/16.6.0--pyhdfd78af_0
$ module help quay.io/biocontainers/ncbi-datasets-pylib/16.6.0--pyhdfd78af_0
```
