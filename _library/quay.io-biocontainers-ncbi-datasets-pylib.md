...
updated_at: "2023-12-09 02:38:29.925818"
latest: "15.29.0--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/ncbi-datasets-pylib:15.29.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ncbi-datasets-pylib/15.29.0--pyhdfd78af_0
$ module help quay.io/biocontainers/ncbi-datasets-pylib/15.29.0--pyhdfd78af_0
```
