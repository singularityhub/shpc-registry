...
updated_at: "2024-01-15 03:00:32.590323"
latest: "16.0.0--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/ncbi-datasets-pylib:16.0.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ncbi-datasets-pylib/16.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/ncbi-datasets-pylib/16.0.0--pyhdfd78af_0
```
