...
updated_at: "2023-11-13 03:03:13.731619"
latest: "15.24.0--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/ncbi-datasets-pylib:15.24.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ncbi-datasets-pylib/15.24.0--pyhdfd78af_0
$ module help quay.io/biocontainers/ncbi-datasets-pylib/15.24.0--pyhdfd78af_0
```
