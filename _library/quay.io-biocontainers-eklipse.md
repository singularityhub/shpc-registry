...
updated_at: "2026-06-24 06:22:16.569288"
...
```bash
$ shpc install quay.io/biocontainers/eklipse:1.8--hdfd78af_6
```
...
```bash
$ module load quay.io/biocontainers/eklipse/1.8--hdfd78af_6
$ module help quay.io/biocontainers/eklipse/1.8--hdfd78af_6
```
