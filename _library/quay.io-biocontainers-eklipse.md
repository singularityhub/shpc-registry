...
updated_at: "2026-04-25 05:01:46.051041"
...
```bash
$ shpc install quay.io/biocontainers/eklipse:1.8--hdfd78af_5
```
...
```bash
$ module load quay.io/biocontainers/eklipse/1.8--hdfd78af_5
$ module help quay.io/biocontainers/eklipse/1.8--hdfd78af_5
```
