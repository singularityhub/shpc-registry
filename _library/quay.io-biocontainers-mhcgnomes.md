...
updated_at: "2026-04-21 05:38:57.442669"
latest: "3.31.1--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/mhcgnomes:3.31.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mhcgnomes/3.31.1--pyhdfd78af_0
$ module help quay.io/biocontainers/mhcgnomes/3.31.1--pyhdfd78af_0
```
