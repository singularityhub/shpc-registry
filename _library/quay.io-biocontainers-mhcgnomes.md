...
updated_at: "2026-09-05 06:48:55.737954"
latest: "3.33.4--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/mhcgnomes:3.33.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mhcgnomes/3.33.4--pyhdfd78af_0
$ module help quay.io/biocontainers/mhcgnomes/3.33.4--pyhdfd78af_0
```
