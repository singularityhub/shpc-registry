...
updated_at: "2026-09-17 07:20:30.382898"
...
```bash
$ shpc install quay.io/biocontainers/mhcgnomes:3.64.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mhcgnomes/3.64.2--pyhdfd78af_0
$ module help quay.io/biocontainers/mhcgnomes/3.64.2--pyhdfd78af_0
```
