...
updated_at: "2026-04-30 05:50:20.319050"
latest: "1.29.4771--h2e9e3d7_0"
...
```bash
$ shpc install quay.io/biocontainers/voronota:1.29.4771--h2e9e3d7_0
```
...
```bash
$ module load quay.io/biocontainers/voronota/1.29.4771--h2e9e3d7_0
$ module help quay.io/biocontainers/voronota/1.29.4771--h2e9e3d7_0
```
