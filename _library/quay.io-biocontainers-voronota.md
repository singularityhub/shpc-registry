...
updated_at: "2026-09-22 08:18:00.584524"
latest: "1.29.4816--h2e9e3d7_0"
...
```bash
$ shpc install quay.io/biocontainers/voronota:1.29.4816--h2e9e3d7_0
```
...
```bash
$ module load quay.io/biocontainers/voronota/1.29.4816--h2e9e3d7_0
$ module help quay.io/biocontainers/voronota/1.29.4816--h2e9e3d7_0
```
