...
updated_at: "2026-06-17 07:55:46.846686"
latest: "1.29.4781--h2e9e3d7_0"
...
```bash
$ shpc install quay.io/biocontainers/voronota:1.29.4781--h2e9e3d7_0
```
...
```bash
$ module load quay.io/biocontainers/voronota/1.29.4781--h2e9e3d7_0
$ module help quay.io/biocontainers/voronota/1.29.4781--h2e9e3d7_0
```
