...
updated_at: "2026-08-23 03:30:13.068417"
latest: "1.29.4812--h2e9e3d7_0"
...
```bash
$ shpc install quay.io/biocontainers/voronota:1.29.4812--h2e9e3d7_0
```
...
```bash
$ module load quay.io/biocontainers/voronota/1.29.4812--h2e9e3d7_0
$ module help quay.io/biocontainers/voronota/1.29.4812--h2e9e3d7_0
```
