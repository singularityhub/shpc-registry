...
updated_at: "2026-08-27 12:45:58.508157"
latest: "3.16.2--pyh84cbfca_0"
...
```bash
$ shpc install quay.io/biocontainers/biobb_structure_checking:3.16.2--pyh84cbfca_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_structure_checking/3.16.2--pyh84cbfca_0
$ module help quay.io/biocontainers/biobb_structure_checking/3.16.2--pyh84cbfca_0
```
