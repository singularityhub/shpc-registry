...
updated_at: "2023-07-10 03:45:15.797712"
...
```bash
$ shpc install quay.io/biocontainers/biobb_structure_checking:3.13.0--pyhca03a8a_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_structure_checking/3.13.0--pyhca03a8a_0
$ module help quay.io/biocontainers/biobb_structure_checking/3.13.0--pyhca03a8a_0
```
