...
updated_at: "2025-08-26 03:38:40.598776"
latest: "3.15.6--pyhdc42f0e_0"
...
```bash
$ shpc install quay.io/biocontainers/biobb_structure_checking:3.15.6--pyhdc42f0e_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_structure_checking/3.15.6--pyhdc42f0e_0
$ module help quay.io/biocontainers/biobb_structure_checking/3.15.6--pyhdc42f0e_0
```
