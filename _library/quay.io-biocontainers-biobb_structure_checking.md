...
updated_at: "2023-08-23 02:39:31.643016"
latest: "3.13.3--pyhca03a8a_0"
...
```bash
$ shpc install quay.io/biocontainers/biobb_structure_checking:3.13.3--pyhca03a8a_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_structure_checking/3.13.3--pyhca03a8a_0
$ module help quay.io/biocontainers/biobb_structure_checking/3.13.3--pyhca03a8a_0
```
