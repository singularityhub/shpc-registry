...
updated_at: "2024-09-23 03:14:05.968314"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-suprahex:1.40.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-suprahex/1.40.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-suprahex/1.40.0--r43hdfd78af_0
```
