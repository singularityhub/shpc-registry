...
updated_at: "2024-10-15 03:08:45.593354"
latest: "0.41.0--hb3cd794_0"
...
```bash
$ shpc install quay.io/biocontainers/annonars:0.41.0--hb3cd794_0
```
...
```bash
$ module load quay.io/biocontainers/annonars/0.41.0--hb3cd794_0
$ module help quay.io/biocontainers/annonars/0.41.0--hb3cd794_0
```
