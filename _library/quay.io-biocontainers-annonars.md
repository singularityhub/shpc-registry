...
updated_at: "2024-01-10 23:32:28.320926"
latest: "0.31.2--hb3cd794_0"
...
```bash
$ shpc install quay.io/biocontainers/annonars:0.31.2--hb3cd794_0
```
...
```bash
$ module load quay.io/biocontainers/annonars/0.31.2--hb3cd794_0
$ module help quay.io/biocontainers/annonars/0.31.2--hb3cd794_0
```
