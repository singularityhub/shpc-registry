...
updated_at: "2026-09-24 07:40:51.434659"
...
```bash
$ shpc install quay.io/biocontainers/annonars:0.45.0--h3628714_0
```
...
```bash
$ module load quay.io/biocontainers/annonars/0.45.0--h3628714_0
$ module help quay.io/biocontainers/annonars/0.45.0--h3628714_0
```
