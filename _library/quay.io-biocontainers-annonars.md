...
updated_at: "2024-02-25 02:29:39.342526"
latest: "0.34.1--hb3cd794_0"
...
```bash
$ shpc install quay.io/biocontainers/annonars:0.34.1--hb3cd794_0
```
...
```bash
$ module load quay.io/biocontainers/annonars/0.34.1--hb3cd794_0
$ module help quay.io/biocontainers/annonars/0.34.1--hb3cd794_0
```
