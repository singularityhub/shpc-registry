...
updated_at: "2023-12-20 03:15:53.350596"
latest: "0.29.2--hb3cd794_0"
...
```bash
$ shpc install quay.io/biocontainers/annonars:0.29.2--hb3cd794_0
```
...
```bash
$ module load quay.io/biocontainers/annonars/0.29.2--hb3cd794_0
$ module help quay.io/biocontainers/annonars/0.29.2--hb3cd794_0
```
