...
updated_at: "2024-01-27 02:36:52.379193"
latest: "0.34.0--hb3cd794_0"
...
```bash
$ shpc install quay.io/biocontainers/annonars:0.34.0--hb3cd794_0
```
...
```bash
$ module load quay.io/biocontainers/annonars/0.34.0--hb3cd794_0
$ module help quay.io/biocontainers/annonars/0.34.0--hb3cd794_0
```
