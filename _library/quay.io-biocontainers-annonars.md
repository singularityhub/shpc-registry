...
updated_at: "2024-05-02 03:02:48.366750"
latest: "0.36.1--hb3cd794_1"
...
```bash
$ shpc install quay.io/biocontainers/annonars:0.36.1--hb3cd794_1
```
...
```bash
$ module load quay.io/biocontainers/annonars/0.36.1--hb3cd794_1
$ module help quay.io/biocontainers/annonars/0.36.1--hb3cd794_1
```
