...
updated_at: "2023-10-19 03:02:06.019602"
latest: "0.20.0--hb3cd794_0"
...
```bash
$ shpc install quay.io/biocontainers/annonars:0.20.0--hb3cd794_0
```
...
```bash
$ module load quay.io/biocontainers/annonars/0.20.0--hb3cd794_0
$ module help quay.io/biocontainers/annonars/0.20.0--hb3cd794_0
```
