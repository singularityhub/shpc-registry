...
updated_at: "2024-07-14 03:11:50.482689"
latest: "0.39.0--hb3cd794_0"
...
```bash
$ shpc install quay.io/biocontainers/annonars:0.39.0--hb3cd794_0
```
...
```bash
$ module load quay.io/biocontainers/annonars/0.39.0--hb3cd794_0
$ module help quay.io/biocontainers/annonars/0.39.0--hb3cd794_0
```
