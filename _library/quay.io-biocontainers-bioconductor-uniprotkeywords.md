...
updated_at: "2023-07-16 03:28:24.979082"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-uniprotkeywords:0.99.4--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-uniprotkeywords/0.99.4--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-uniprotkeywords/0.99.4--r42hdfd78af_0
```
