...
updated_at: "2026-03-28 05:01:07.489053"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-decomptumor2sig:2.26.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-decomptumor2sig/2.26.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-decomptumor2sig/2.26.0--r45hdfd78af_0
```
