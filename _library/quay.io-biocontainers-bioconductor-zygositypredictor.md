---
layout: container
name:  "quay.io/biocontainers/bioconductor-zygositypredictor"
maintainer: "@vsoch"
...
updated_at: "2026-04-03 05:04:17.744742"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-zygositypredictor
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-zygositypredictor:1.10.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-zygositypredictor/1.10.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-zygositypredictor/1.10.0--r45hdfd78af_0
```
...
#### bioconductor-zygositypredictor-run:
...
#### bioconductor-zygositypredictor-shell:
...
#### bioconductor-zygositypredictor-exec:
...
#### bioconductor-zygositypredictor-inspect:
...
#### bioconductor-zygositypredictor-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-zygositypredictor-inspect-deffile:
