...
updated_at: "2023-11-15 03:00:51.120265"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-zygositypredictor:1.0.3--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-zygositypredictor/1.0.3--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-zygositypredictor/1.0.3--r43hdfd78af_0
```
