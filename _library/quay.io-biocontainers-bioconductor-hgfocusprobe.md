...
updated_at: "2026-03-23 05:39:31.804505"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hgfocusprobe:2.18.0--r45hdfd78af_14
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hgfocusprobe/2.18.0--r45hdfd78af_14
$ module help quay.io/biocontainers/bioconductor-hgfocusprobe/2.18.0--r45hdfd78af_14
```
