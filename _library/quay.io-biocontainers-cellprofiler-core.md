...
updated_at: "2026-03-28 05:03:13.665262"
...
```bash
$ shpc install quay.io/biocontainers/cellprofiler-core:4.2.8.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/cellprofiler-core/4.2.8.1--pyhdfd78af_0
$ module help quay.io/biocontainers/cellprofiler-core/4.2.8.1--pyhdfd78af_0
```
