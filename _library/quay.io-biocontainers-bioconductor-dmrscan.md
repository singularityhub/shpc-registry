...
updated_at: "2026-03-28 17:18:07.733747"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-dmrscan:1.32.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-dmrscan/1.32.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-dmrscan/1.32.0--r45hdfd78af_0
```
