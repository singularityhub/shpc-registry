...
updated_at: "2022-11-06 00:27:54.314254"
latest: "1.8.0--r351_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-dmrscan:1.8.0--r351_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-dmrscan/1.8.0--r351_0
$ module help quay.io/biocontainers/bioconductor-dmrscan/1.8.0--r351_0
```
