---
layout: container
name:  "quay.io/biocontainers/vine-phylo"
maintainer: "@vsoch"
...
updated_at: "2026-08-21 03:43:27.057157"
...
```bash
$ module load quay.io/biocontainers/vine-phylo/0.3.5--h3ffd07f_0
$ module help quay.io/biocontainers/vine-phylo/0.3.5--h3ffd07f_0
```
...
#### vine-phylo-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### vine-phylo-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/crisprLnl
$ podman run --it --rm --entrypoint /usr/local/bin/crisprLnl   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/crisprLnl   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/evalTrees
$ podman run --it --rm --entrypoint /usr/local/bin/evalTrees   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/evalTrees   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/vine
$ podman run --it --rm --entrypoint /usr/local/bin/vine   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/vine   -v ${PWD} -w ${PWD} <container> -c " $@"
```
