...
updated_at: "2023-06-29 03:44:16.583542"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-immunoclust:1.30.0--r42hf17093f_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-immunoclust/1.30.0--r42hf17093f_1
$ module help quay.io/biocontainers/bioconductor-immunoclust/1.30.0--r42hf17093f_1
```
