...
updated_at: "2022-11-21 13:05:37.411530"
latest: "0.99.11--r41hdfd78af_9"
container_url: "https://biocontainers.pro/tools/bioconductor-snplocs.hsapiens.dbsnp141.grch38"
aliases:
 - ".bioconductor-snplocs.hsapiens.dbsnp141.grch38-post-link.sh"
 - ".bioconductor-snplocs.hsapiens.dbsnp141.grch38-pre-unlink.sh"
versions:
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-snplocs.hsapiens.dbsnp141.grch38-post-link.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-snplocs.hsapiens.dbsnp141.grch38-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-snplocs.hsapiens.dbsnp141.grch38-post-link.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/.bioconductor-snplocs.hsapiens.dbsnp141.grch38-pre-unlink.sh
$ podman run --it --rm --entrypoint /usr/local/bin/.bioconductor-snplocs.hsapiens.dbsnp141.grch38-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/.bioconductor-snplocs.hsapiens.dbsnp141.grch38-pre-unlink.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
