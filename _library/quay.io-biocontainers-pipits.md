...
updated_at: "2025-12-05 04:04:47.140019"
latest: "4.0--pyhdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/pipits:4.0--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/pipits/4.0--pyhdfd78af_1
$ module help quay.io/biocontainers/pipits/4.0--pyhdfd78af_1
```
