...
updated_at: "2024-12-18 03:26:15.449681"
...
```bash
$ shpc install quay.io/biocontainers/pipits:3.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pipits/3.1--pyhdfd78af_0
$ module help quay.io/biocontainers/pipits/3.1--pyhdfd78af_0
```
