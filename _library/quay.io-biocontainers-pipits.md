...
updated_at: "2022-11-21 13:46:58.979833"
...
```bash
$ shpc install quay.io/biocontainers/pipits:2.8--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pipits/2.8--pyhdfd78af_0
$ module help quay.io/biocontainers/pipits/2.8--pyhdfd78af_0
```
