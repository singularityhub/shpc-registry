...
updated_at: "2025-10-02 03:00:17.448189"
latest: "1.0.20--h06902ac_1"
...
```bash
$ shpc install quay.io/biocontainers/graphaligner:1.0.20--h06902ac_1
```
...
```bash
$ module load quay.io/biocontainers/graphaligner/1.0.20--h06902ac_1
$ module help quay.io/biocontainers/graphaligner/1.0.20--h06902ac_1
```
