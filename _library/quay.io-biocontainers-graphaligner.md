...
updated_at: "2024-02-28 02:25:31.737835"
latest: "1.0.19--h21ec9f0_0"
...
```bash
$ shpc install quay.io/biocontainers/graphaligner:1.0.19--h21ec9f0_0
```
...
```bash
$ module load quay.io/biocontainers/graphaligner/1.0.19--h21ec9f0_0
$ module help quay.io/biocontainers/graphaligner/1.0.19--h21ec9f0_0
```
