...
updated_at: "2022-11-06 00:32:58.548792"
latest: "1.9.0--r40_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-zebrafishrnaseq:1.9.0--r40_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-zebrafishrnaseq/1.9.0--r40_0
$ module help quay.io/biocontainers/bioconductor-zebrafishrnaseq/1.9.0--r40_0
```
