...
updated_at: "2025-03-03 03:00:46.909365"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-zebrafishrnaseq:1.26.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-zebrafishrnaseq/1.26.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-zebrafishrnaseq/1.26.0--r44hdfd78af_0
```
