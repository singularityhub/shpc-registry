...
updated_at: "2026-04-03 05:14:20.110024"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-zebrafishrnaseq:1.30.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-zebrafishrnaseq/1.30.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-zebrafishrnaseq/1.30.0--r45hdfd78af_0
```
