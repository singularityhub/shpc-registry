...
updated_at: "2022-11-03 01:34:30.217353"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-qusage:2.28.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-qusage/2.28.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-qusage/2.28.0--r41hdfd78af_0
```
