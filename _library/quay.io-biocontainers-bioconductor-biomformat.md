...
updated_at: "2025-10-06 03:12:35.467776"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-biomformat:1.34.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-biomformat/1.34.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-biomformat/1.34.0--r44hdfd78af_0
```
