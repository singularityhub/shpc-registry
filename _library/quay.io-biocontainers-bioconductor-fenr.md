...
updated_at: "2024-09-24 03:32:39.170420"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-fenr:1.0.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-fenr/1.0.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-fenr/1.0.0--r43hdfd78af_0
```
