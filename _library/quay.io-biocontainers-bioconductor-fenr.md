...
updated_at: "2026-02-19 04:40:40.248821"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-fenr:1.8.1--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-fenr/1.8.1--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-fenr/1.8.1--r45hdfd78af_0
```
