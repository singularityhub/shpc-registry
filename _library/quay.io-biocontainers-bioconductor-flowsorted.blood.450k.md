...
updated_at: "2023-11-09 02:35:39.183257"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-flowsorted.blood.450k:1.38.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-flowsorted.blood.450k/1.38.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-flowsorted.blood.450k/1.38.0--r43hdfd78af_0
```
