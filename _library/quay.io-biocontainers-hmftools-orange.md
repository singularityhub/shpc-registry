...
updated_at: "2025-07-31 11:55:39.340683"
...
```bash
$ shpc install quay.io/biocontainers/hmftools-orange:4.0.1--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hmftools-orange/4.0.1--hdfd78af_0
$ module help quay.io/biocontainers/hmftools-orange/4.0.1--hdfd78af_0
```
