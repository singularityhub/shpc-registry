...
updated_at: "2024-05-04 03:01:55.847663"
...
```bash
$ shpc install quay.io/biocontainers/hmftools-orange:3.3.1--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hmftools-orange/3.3.1--hdfd78af_0
$ module help quay.io/biocontainers/hmftools-orange/3.3.1--hdfd78af_0
```
