---
layout: container
name:  "quay.io/biocontainers/hmftools-orange"
maintainer: "@vsoch"
...
updated_at: "2026-09-18 07:15:28.996994"
latest: "5.0.1--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/hmftools-orange
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/hmftools-orange:5.0.1--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hmftools-orange/5.0.1--hdfd78af_0
$ module help quay.io/biocontainers/hmftools-orange/5.0.1--hdfd78af_0
```
...
#### hmftools-orange-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### hmftools-orange-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/orange
$ podman run --it --rm --entrypoint /usr/local/bin/orange   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/orange   -v ${PWD} -w ${PWD} <container> -c " $@"
```
