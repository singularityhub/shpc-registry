...
updated_at: "2024-03-22 02:32:04.322139"
...
```bash
$ shpc install quay.io/biocontainers/hmftools-orange:3.3.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hmftools-orange/3.3.0--hdfd78af_0
$ module help quay.io/biocontainers/hmftools-orange/3.3.0--hdfd78af_0
```
