...
updated_at: "2024-11-02 03:29:54.829747"
latest: "3.7.1_beta--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/hmftools-orange:3.7.1_beta--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hmftools-orange/3.7.1_beta--hdfd78af_0
$ module help quay.io/biocontainers/hmftools-orange/3.7.1_beta--hdfd78af_0
```
