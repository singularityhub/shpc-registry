...
updated_at: "2024-07-14 02:49:31.190329"
...
```bash
$ shpc install quay.io/biocontainers/hmftools-orange:3.6.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hmftools-orange/3.6.0--hdfd78af_0
$ module help quay.io/biocontainers/hmftools-orange/3.6.0--hdfd78af_0
```
