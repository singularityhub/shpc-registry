...
updated_at: "2024-09-21 03:19:49.598378"
...
```bash
$ shpc install quay.io/biocontainers/hmftools-orange:3.7.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hmftools-orange/3.7.0--hdfd78af_0
$ module help quay.io/biocontainers/hmftools-orange/3.7.0--hdfd78af_0
```
