...
updated_at: "2024-02-01 02:50:04.761660"
...
```bash
$ shpc install quay.io/biocontainers/hmftools-orange:3.0.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hmftools-orange/3.0.0--hdfd78af_0
$ module help quay.io/biocontainers/hmftools-orange/3.0.0--hdfd78af_0
```
