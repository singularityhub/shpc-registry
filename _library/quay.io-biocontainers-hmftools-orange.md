...
updated_at: "2024-12-03 03:46:25.564411"
latest: "3.7.1_beta--hdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/hmftools-orange:3.7.1_beta--hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/hmftools-orange/3.7.1_beta--hdfd78af_1
$ module help quay.io/biocontainers/hmftools-orange/3.7.1_beta--hdfd78af_1
```
