...
updated_at: "2025-12-24 03:54:32.621096"
...
```bash
$ shpc install quay.io/biocontainers/hmftools-orange:4.1.2--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hmftools-orange/4.1.2--hdfd78af_0
$ module help quay.io/biocontainers/hmftools-orange/4.1.2--hdfd78af_0
```
