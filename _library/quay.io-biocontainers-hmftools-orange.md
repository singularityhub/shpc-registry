...
updated_at: "2026-07-29 05:50:10.945142"
...
```bash
$ shpc install quay.io/biocontainers/hmftools-orange:5.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hmftools-orange/5.0--hdfd78af_0
$ module help quay.io/biocontainers/hmftools-orange/5.0--hdfd78af_0
```
