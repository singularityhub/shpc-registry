...
updated_at: "2026-04-04 04:27:05.042161"
latest: "4.1.3--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/hmftools-orange:4.1.3--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hmftools-orange/4.1.3--hdfd78af_0
$ module help quay.io/biocontainers/hmftools-orange/4.1.3--hdfd78af_0
```
