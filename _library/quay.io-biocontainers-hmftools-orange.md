...
updated_at: "2025-10-29 03:43:56.759947"
...
```bash
$ shpc install quay.io/biocontainers/hmftools-orange:4.1--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hmftools-orange/4.1--hdfd78af_0
$ module help quay.io/biocontainers/hmftools-orange/4.1--hdfd78af_0
```
