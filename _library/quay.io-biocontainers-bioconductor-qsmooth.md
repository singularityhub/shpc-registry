...
updated_at: "2022-11-05 00:26:14.161393"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-qsmooth:1.8.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-qsmooth/1.8.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-qsmooth/1.8.0--r41hdfd78af_0
```
