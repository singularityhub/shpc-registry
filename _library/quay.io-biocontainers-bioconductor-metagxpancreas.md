...
updated_at: "2025-05-01 03:21:21.099619"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-metagxpancreas:1.26.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-metagxpancreas/1.26.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-metagxpancreas/1.26.0--r44hdfd78af_0
```
