...
updated_at: "2026-03-04 04:16:42.260779"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-metagxpancreas:1.30.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-metagxpancreas/1.30.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-metagxpancreas/1.30.0--r45hdfd78af_0
```
