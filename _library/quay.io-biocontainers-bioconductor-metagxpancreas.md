...
updated_at: "2023-08-24 02:40:52.545838"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-metagxpancreas:1.20.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-metagxpancreas/1.20.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-metagxpancreas/1.20.0--r43hdfd78af_0
```
