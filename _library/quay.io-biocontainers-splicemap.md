...
updated_at: "2023-06-19 03:22:56.883422"
...
```bash
$ shpc install quay.io/biocontainers/splicemap:3.3.5.2--h4ac6f70_5
```
...
```bash
$ module load quay.io/biocontainers/splicemap/3.3.5.2--h4ac6f70_5
$ module help quay.io/biocontainers/splicemap/3.3.5.2--h4ac6f70_5
```
