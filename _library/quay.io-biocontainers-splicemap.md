...
updated_at: "2022-10-27 01:07:09.800368"
latest: "3.3.5.2--h9f5acd7_4"
...
```bash
$ shpc install quay.io/biocontainers/splicemap:3.3.5.2--h9f5acd7_4
```
...
```bash
$ module load quay.io/biocontainers/splicemap/3.3.5.2--h9f5acd7_4
$ module help quay.io/biocontainers/splicemap/3.3.5.2--h9f5acd7_4
```
