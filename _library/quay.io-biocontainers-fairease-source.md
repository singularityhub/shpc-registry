...
updated_at: "2026-01-19 04:56:58.053177"
...
```bash
$ shpc install quay.io/biocontainers/fairease-source:1.4.6--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/fairease-source/1.4.6--pyhdfd78af_0
$ module help quay.io/biocontainers/fairease-source/1.4.6--pyhdfd78af_0
```
