...
updated_at: "2023-10-23 02:49:23.994166"
...
```bash
$ shpc install quay.io/biocontainers/recognizer:1.9.3--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/recognizer/1.9.3--hdfd78af_0
$ module help quay.io/biocontainers/recognizer/1.9.3--hdfd78af_0
```
