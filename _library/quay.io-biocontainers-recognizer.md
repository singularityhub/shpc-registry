...
updated_at: "2023-10-07 03:08:00.054089"
latest: "1.9.2--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/recognizer:1.9.2--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/recognizer/1.9.2--hdfd78af_0
$ module help quay.io/biocontainers/recognizer/1.9.2--hdfd78af_0
```
