...
updated_at: "2024-05-07 02:53:55.928739"
...
```bash
$ shpc install quay.io/biocontainers/recognizer:1.9.4--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/recognizer/1.9.4--hdfd78af_0
$ module help quay.io/biocontainers/recognizer/1.9.4--hdfd78af_0
```
