...
updated_at: "2024-09-12 03:04:00.368469"
latest: "1.10.1--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/recognizer:1.10.1--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/recognizer/1.10.1--hdfd78af_0
$ module help quay.io/biocontainers/recognizer/1.10.1--hdfd78af_0
```
