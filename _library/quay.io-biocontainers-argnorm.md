...
updated_at: "2025-05-25 03:26:20.799969"
...
```bash
$ shpc install quay.io/biocontainers/argnorm:1.0.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/argnorm/1.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/argnorm/1.0.0--pyhdfd78af_0
```
