...
updated_at: "2025-05-10 03:30:51.536842"
...
```bash
$ shpc install quay.io/biocontainers/argnorm:0.8.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/argnorm/0.8.0--pyhdfd78af_0
$ module help quay.io/biocontainers/argnorm/0.8.0--pyhdfd78af_0
```
