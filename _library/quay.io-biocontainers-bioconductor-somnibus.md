...
updated_at: "2023-10-02 03:30:37.270536"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-somnibus:1.7.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-somnibus/1.7.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-somnibus/1.7.0--r43hdfd78af_0
```
