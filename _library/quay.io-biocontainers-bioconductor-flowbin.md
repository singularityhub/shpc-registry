...
updated_at: "2026-03-14 04:17:02.345856"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-flowbin:1.46.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-flowbin/1.46.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-flowbin/1.46.0--r45hdfd78af_0
```
