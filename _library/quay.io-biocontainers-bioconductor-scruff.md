...
updated_at: "2026-03-28 05:17:04.735683"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-scruff:1.28.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-scruff/1.28.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-scruff/1.28.0--r45hdfd78af_0
```
