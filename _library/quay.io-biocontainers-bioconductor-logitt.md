...
updated_at: "2023-01-14 02:46:30.449871"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-logitt:1.56.0--r42hc0cfd56_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-logitt/1.56.0--r42hc0cfd56_0
$ module help quay.io/biocontainers/bioconductor-logitt/1.56.0--r42hc0cfd56_0
```
