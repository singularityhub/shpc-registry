...
updated_at: "2022-11-01 03:34:03.152959"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-logitt:1.52.0--r41hc0cfd56_2
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-logitt/1.52.0--r41hc0cfd56_2
$ module help quay.io/biocontainers/bioconductor-logitt/1.52.0--r41hc0cfd56_2
```
