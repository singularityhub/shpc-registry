...
updated_at: "2026-06-04 07:27:02.456020"
...
```bash
$ shpc install quay.io/biocontainers/phageflow:0.2.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/phageflow/0.2.2--pyhdfd78af_0
$ module help quay.io/biocontainers/phageflow/0.2.2--pyhdfd78af_0
```
