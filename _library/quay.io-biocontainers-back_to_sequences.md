---
layout: container
name:  "quay.io/biocontainers/back_to_sequences"
maintainer: "@vsoch"
...
updated_at: "2026-06-10 06:39:22.556218"
...
singularity registry hpc automated addition for back_to_sequences
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/back_to_sequences
```
...
#### back_to_sequences-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### back_to_sequences-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/back_to_sequences
$ podman run --it --rm --entrypoint /usr/local/bin/back_to_sequences   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/back_to_sequences   -v ${PWD} -w ${PWD} <container> -c " $@"
```
