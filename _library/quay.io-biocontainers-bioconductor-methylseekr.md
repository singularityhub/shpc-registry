...
updated_at: "2026-05-25 06:58:11.605710"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-methylseekr:1.50.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-methylseekr/1.50.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-methylseekr/1.50.0--r45hdfd78af_0
```
