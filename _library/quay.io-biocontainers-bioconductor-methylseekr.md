...
updated_at: "2023-09-14 03:00:06.494007"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-methylseekr:1.40.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-methylseekr/1.40.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-methylseekr/1.40.0--r43hdfd78af_0
```
