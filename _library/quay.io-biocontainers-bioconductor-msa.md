...
updated_at: "2023-08-21 02:36:38.671602"
latest: "1.32.0--r43hc247a5b_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-msa:1.32.0--r43hc247a5b_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-msa/1.32.0--r43hc247a5b_0
$ module help quay.io/biocontainers/bioconductor-msa/1.32.0--r43hc247a5b_0
```
