...
updated_at: "2023-08-26 02:39:47.590254"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-guideseq:1.30.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-guideseq/1.30.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-guideseq/1.30.0--r43hdfd78af_0
```
