...
updated_at: "2022-11-01 03:40:35.829698"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hgu95a.db:3.2.3--r41hdfd78af_7
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hgu95a.db/3.2.3--r41hdfd78af_7
$ module help quay.io/biocontainers/bioconductor-hgu95a.db/3.2.3--r41hdfd78af_7
```
