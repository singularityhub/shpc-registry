...
updated_at: "2024-09-16 03:27:51.574068"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hgu95a.db:3.13.0--r43hdfd78af_4
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hgu95a.db/3.13.0--r43hdfd78af_4
$ module help quay.io/biocontainers/bioconductor-hgu95a.db/3.13.0--r43hdfd78af_4
```
