...
updated_at: "2025-10-30 03:53:36.148088"
...
```bash
$ shpc install quay.io/biocontainers/cytoscape:3.10.4--he65b2d3_0
```
...
```bash
$ module load quay.io/biocontainers/cytoscape/3.10.4--he65b2d3_0
$ module help quay.io/biocontainers/cytoscape/3.10.4--he65b2d3_0
```
