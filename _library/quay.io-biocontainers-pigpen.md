...
updated_at: "2025-05-25 03:51:51.144896"
...
```bash
$ shpc install quay.io/biocontainers/pigpen:0.0.8--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pigpen/0.0.8--pyhdfd78af_0
$ module help quay.io/biocontainers/pigpen/0.0.8--pyhdfd78af_0
```
