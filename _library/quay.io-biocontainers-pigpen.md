...
updated_at: "2025-04-23 03:06:59.008927"
latest: "0.0.6--pyhdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/pigpen:0.0.6--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/pigpen/0.0.6--pyhdfd78af_1
$ module help quay.io/biocontainers/pigpen/0.0.6--pyhdfd78af_1
```
