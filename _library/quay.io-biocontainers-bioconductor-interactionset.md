...
updated_at: "2023-09-11 03:14:27.419802"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-interactionset:1.26.0--r42hf17093f_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-interactionset/1.26.0--r42hf17093f_1
$ module help quay.io/biocontainers/bioconductor-interactionset/1.26.0--r42hf17093f_1
```
