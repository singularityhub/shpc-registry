...
updated_at: "2024-07-05 02:52:43.510076"
latest: "1.0.2--r43hf17093f_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ggsc:1.0.2--r43hf17093f_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ggsc/1.0.2--r43hf17093f_0
$ module help quay.io/biocontainers/bioconductor-ggsc/1.0.2--r43hf17093f_0
```
