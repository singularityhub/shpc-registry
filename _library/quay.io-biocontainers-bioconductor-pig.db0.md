...
updated_at: "2026-01-05 06:15:27.151188"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-pig.db0:3.20.0--r44hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-pig.db0/3.20.0--r44hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-pig.db0/3.20.0--r44hdfd78af_0
```
