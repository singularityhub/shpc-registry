...
updated_at: "2025-10-25 03:21:03.920926"
...
```bash
$ shpc install quay.io/biocontainers/grzctl:0.6.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/grzctl/0.6.0--pyhdfd78af_0
$ module help quay.io/biocontainers/grzctl/0.6.0--pyhdfd78af_0
```
