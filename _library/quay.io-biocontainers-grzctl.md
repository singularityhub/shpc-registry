...
updated_at: "2026-08-14 07:32:18.375584"
...
```bash
$ shpc install quay.io/biocontainers/grzctl:2.1.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/grzctl/2.1.4--pyhdfd78af_0
$ module help quay.io/biocontainers/grzctl/2.1.4--pyhdfd78af_0
```
