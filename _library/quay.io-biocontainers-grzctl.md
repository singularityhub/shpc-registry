...
updated_at: "2026-09-03 07:17:03.937063"
...
```bash
$ shpc install quay.io/biocontainers/grzctl:4.0.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/grzctl/4.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/grzctl/4.0.0--pyhdfd78af_0
```
