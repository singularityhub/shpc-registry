...
updated_at: "2026-06-28 06:44:38.232906"
...
```bash
$ shpc install quay.io/biocontainers/grzctl:2.1.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/grzctl/2.1.1--pyhdfd78af_0
$ module help quay.io/biocontainers/grzctl/2.1.1--pyhdfd78af_0
```
