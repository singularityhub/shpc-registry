...
updated_at: "2024-05-25 03:09:53.505573"
latest: "2.4.0--r43h3121a25_0"
...
```bash
$ shpc install quay.io/biocontainers/r-pathfindr:2.4.0--r43h3121a25_0
```
...
```bash
$ module load quay.io/biocontainers/r-pathfindr/2.4.0--r43h3121a25_0
$ module help quay.io/biocontainers/r-pathfindr/2.4.0--r43h3121a25_0
```
