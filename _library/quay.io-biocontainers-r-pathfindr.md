...
updated_at: "2024-04-01 03:56:31.112546"
...
```bash
$ shpc install quay.io/biocontainers/r-pathfindr:2.3.1--r43h3342da4_0
```
...
```bash
$ module load quay.io/biocontainers/r-pathfindr/2.3.1--r43h3342da4_0
$ module help quay.io/biocontainers/r-pathfindr/2.3.1--r43h3342da4_0
```
