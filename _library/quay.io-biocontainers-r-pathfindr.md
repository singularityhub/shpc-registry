...
updated_at: "2023-09-30 03:03:25.073616"
latest: "2.2.0--r43h3342da4_0"
...
```bash
$ shpc install quay.io/biocontainers/r-pathfindr:2.2.0--r43h3342da4_0
```
...
```bash
$ module load quay.io/biocontainers/r-pathfindr/2.2.0--r43h3342da4_0
$ module help quay.io/biocontainers/r-pathfindr/2.2.0--r43h3342da4_0
```
