...
updated_at: "2026-08-15 03:21:05.705014"
latest: "3.0.2--r45h3121a25_0"
...
```bash
$ shpc install quay.io/biocontainers/r-pathfindr:3.0.2--r45h3121a25_0
```
...
```bash
$ module load quay.io/biocontainers/r-pathfindr/3.0.2--r45h3121a25_0
$ module help quay.io/biocontainers/r-pathfindr/3.0.2--r45h3121a25_0
```
