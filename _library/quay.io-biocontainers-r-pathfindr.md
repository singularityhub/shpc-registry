...
updated_at: "2024-01-10 08:57:41.159054"
latest: "2.3.0--r43h3342da4_0"
...
```bash
$ shpc install quay.io/biocontainers/r-pathfindr:2.3.0--r43h3342da4_0
```
...
```bash
$ module load quay.io/biocontainers/r-pathfindr/2.3.0--r43h3342da4_0
$ module help quay.io/biocontainers/r-pathfindr/2.3.0--r43h3342da4_0
```
