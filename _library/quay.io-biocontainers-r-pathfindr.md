...
updated_at: "2026-04-05 04:43:42.775992"
latest: "2.7.0--r44h3121a25_0"
...
```bash
$ shpc install quay.io/biocontainers/r-pathfindr:2.7.0--r44h3121a25_0
```
...
```bash
$ module load quay.io/biocontainers/r-pathfindr/2.7.0--r44h3121a25_0
$ module help quay.io/biocontainers/r-pathfindr/2.7.0--r44h3121a25_0
```
