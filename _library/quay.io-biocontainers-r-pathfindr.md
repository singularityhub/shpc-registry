...
updated_at: "2025-12-11 04:48:06.305896"
latest: "2.6.0--r44h3121a25_0"
...
```bash
$ shpc install quay.io/biocontainers/r-pathfindr:2.6.0--r44h3121a25_0
```
...
```bash
$ module load quay.io/biocontainers/r-pathfindr/2.6.0--r44h3121a25_0
$ module help quay.io/biocontainers/r-pathfindr/2.6.0--r44h3121a25_0
```
