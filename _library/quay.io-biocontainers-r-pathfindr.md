...
updated_at: "2025-07-27 04:36:14.524300"
latest: "2.5.0--r44h3121a25_0"
...
```bash
$ shpc install quay.io/biocontainers/r-pathfindr:2.5.0--r44h3121a25_0
```
...
```bash
$ module load quay.io/biocontainers/r-pathfindr/2.5.0--r44h3121a25_0
$ module help quay.io/biocontainers/r-pathfindr/2.5.0--r44h3121a25_0
```
