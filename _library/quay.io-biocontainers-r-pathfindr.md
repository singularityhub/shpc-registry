...
updated_at: "2025-08-16 03:34:43.480009"
latest: "2.5.1--r44h3121a25_0"
...
```bash
$ shpc install quay.io/biocontainers/r-pathfindr:2.5.1--r44h3121a25_0
```
...
```bash
$ module load quay.io/biocontainers/r-pathfindr/2.5.1--r44h3121a25_0
$ module help quay.io/biocontainers/r-pathfindr/2.5.1--r44h3121a25_0
```
