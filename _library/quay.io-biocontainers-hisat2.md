...
updated_at: "2024-12-20 03:31:40.496348"
...
```bash
$ shpc install quay.io/biocontainers/hisat2:2.2.1--hdbdd923_7
```
...
```bash
$ module load quay.io/biocontainers/hisat2/2.2.1--hdbdd923_7
$ module help quay.io/biocontainers/hisat2/2.2.1--hdbdd923_7
```
