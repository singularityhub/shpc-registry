...
updated_at: "2024-07-21 02:41:48.567841"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-dart:1.50.0--r43hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-dart/1.50.0--r43hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-dart/1.50.0--r43hdfd78af_0
```
