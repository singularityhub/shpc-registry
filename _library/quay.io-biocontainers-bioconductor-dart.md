...
updated_at: "2026-03-09 04:49:38.401740"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-dart:1.58.0--r45hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-dart/1.58.0--r45hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-dart/1.58.0--r45hdfd78af_0
```
