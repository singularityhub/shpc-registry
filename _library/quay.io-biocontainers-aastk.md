---
layout: container
name:  "quay.io/biocontainers/aastk"
maintainer: "@vsoch"
...
updated_at: "2026-04-02 05:18:58.814529"
...
singularity registry hpc automated addition for aastk
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/aastk
```
...
#### aastk-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### aastk-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/aastk
$ podman run --it --rm --entrypoint /usr/local/bin/aastk   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/aastk   -v ${PWD} -w ${PWD} <container> -c " $@"
```
