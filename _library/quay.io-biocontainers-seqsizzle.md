...
updated_at: "2025-09-14 03:07:06.475179"
...
```bash
$ shpc install quay.io/biocontainers/seqsizzle:0.3.0--h790517f_0
```
...
```bash
$ module load quay.io/biocontainers/seqsizzle/0.3.0--h790517f_0
$ module help quay.io/biocontainers/seqsizzle/0.3.0--h790517f_0
```
