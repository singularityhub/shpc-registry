...
updated_at: "2022-11-01 03:12:27.166816"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-megadepth:1.4.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-megadepth/1.4.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-megadepth/1.4.0--r41hdfd78af_0
```
