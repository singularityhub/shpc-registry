...
updated_at: "2024-10-14 03:18:15.154804"
...
```bash
$ shpc install quay.io/biocontainers/wisecondorx:1.2.9--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/wisecondorx/1.2.9--pyhdfd78af_0
$ module help quay.io/biocontainers/wisecondorx/1.2.9--pyhdfd78af_0
```
