...
updated_at: "2026-04-04 05:16:04.972860"
...
```bash
$ shpc install quay.io/biocontainers/wisecondorx:1.3.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/wisecondorx/1.3.0--pyhdfd78af_0
$ module help quay.io/biocontainers/wisecondorx/1.3.0--pyhdfd78af_0
```
